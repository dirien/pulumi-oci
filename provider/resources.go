...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			"oci_analytics_analytics_instance":                        {Tok: makeResource(ociMod, "AnalyticsAnalyticsInstance")},
			"oci_analytics_analytics_instance_private_access_channel": {Tok: makeResource(ociMod, "AnalyticsAnalyticsInstancePrivateAccessChannel")},
			"oci_analytics_analytics_instance_vanity_url":             {Tok: makeResource(ociMod, "AnalyticsAnalyticsInstanceVanityUrl")},
			"oci_apigateway_api":                                      {Tok: makeResource(ociMod, "ApigatewayApi")},
			"oci_apigateway_certificate":                              {Tok: makeResource(ociMod, "ApigatewayCertificate")},
			"oci_apigateway_deployment":                               {Tok: makeResource(ociMod, "ApigatewayDeployment")},
			"oci_apigateway_gateway":                                  {Tok: makeResource(ociMod, "ApigatewayGateway")},
			"oci_apm_apm_domain":                                      {Tok: makeResource(ociMod, "ApmApmDomain")},
			"oci_apm_synthetics_monitor":                              {Tok: makeResource(ociMod, "ApmSyntheticsMonitor")},
			"oci_apm_synthetics_script":                               {Tok: makeResource(ociMod, "ApmSyntheticsScript")},
			"oci_artifacts_container_configuration":                   {Tok: makeResource(ociMod, "ArtifactsContainerConfiguration")},
			"oci_artifacts_container_image_signature":                 {Tok: makeResource(ociMod, "ArtifactsContainerImageSignature")},
			"oci_artifacts_container_repository":                      {Tok: makeResource(ociMod, "ArtifactsContainerRepository")},
			"oci_artifacts_generic_artifact":                          {Tok: makeResource(ociMod, "ArtifactsGenericArtifact")},
			"oci_artifacts_repository":                                {Tok: makeResource(ociMod, "ArtifactsRepository")},
			"oci_audit_configuration":                                 {Tok: makeResource(ociMod, "AuditConfiguration")},
			"oci_autoscaling_auto_scaling_configuration":              {Tok: makeResource(ociMod, "AutoscalingAutoScalingConfiguration")},
			"oci_bastion_bastion":                                     {Tok: makeResource(ociMod, "BastionBastion")},
			"oci_bastion_session":                                     {Tok: makeResource(ociMod, "BastionSession")},
			"oci_bds_auto_scaling_configuration":                      {Tok: makeResource(ociMod, "BdsAutoScalingConfiguration")},
			"oci_bds_bds_instance":                                    {Tok: makeResource(ociMod, "BdsBdsInstance")},
			"oci_blockchain_blockchain_platform":                      {Tok: makeResource(ociMod, "BlockchainBlockchainPlatform")},
			"oci_blockchain_osn":                                      {Tok: makeResource(ociMod, "BlockchainOsn")},
			"oci_blockchain_peer":                                     {Tok: makeResource(ociMod, "BlockchainPeer")},
			"oci_budget_alert_rule":                                   {Tok: makeResource(ociMod, "BudgetAlertRule")},
			"oci_budget_budget":                                       {Tok: makeResource(ociMod, "BudgetBudget")},
			"oci_cloud_guard_cloud_guard_configuration":               {Tok: makeResource(ociMod, "CloudGuardCloudGuardConfiguration")},
			"oci_cloud_guard_data_mask_rule":                          {Tok: makeResource(ociMod, "CloudGuardDataMaskRule")},
			"oci_cloud_guard_detector_recipe":                         {Tok: makeResource(ociMod, "CloudGuardDetectorRecipe")},
			"oci_cloud_guard_managed_list":                            {Tok: makeResource(ociMod, "CloudGuardManagedList")},
			"oci_cloud_guard_responder_recipe":                        {Tok: makeResource(ociMod, "CloudGuardResponderRecipe")},
			"oci_cloud_guard_target":                                  {Tok: makeResource(ociMod, "CloudGuardTarget")},
			"oci_containerengine_cluster":                             {Tok: makeResource(ociMod, "ContainerengineCluster")},
			"oci_containerengine_node_pool":                           {Tok: makeResource(ociMod, "ContainerengineNodePool")},
			"oci_core_app_catalog_listing_resource_version_agreement": {Tok: makeResource(ociMod, "CoreAppCatalogListingResourceVersionAgreement")},
			"oci_core_app_catalog_subscription":                       {Tok: makeResource(ociMod, "CoreAppCatalogSubscription")},
			"oci_core_boot_volume":                                    {Tok: makeResource(ociMod, "CoreBootVolume")},
			"oci_core_boot_volume_backup":                             {Tok: makeResource(ociMod, "CoreBootVolumeBackup")},
			"oci_core_cluster_network":                                {Tok: makeResource(ociMod, "CoreClusterNetwork")},
			"oci_core_compute_capacity_reservation":                   {Tok: makeResource(ociMod, "CoreComputeCapacityReservation")},
			"oci_core_compute_image_capability_schema":                {Tok: makeResource(ociMod, "CoreComputeImageCapabilitySchema")},
			"oci_core_console_history":                                {Tok: makeResource(ociMod, "CoreConsoleHistory")},
			"oci_core_cpe":                                            {Tok: makeResource(ociMod, "CoreCpe")},
			"oci_core_cross_connect":                                  {Tok: makeResource(ociMod, "CoreCrossConnect")},
			"oci_core_cross_connect_group":                            {Tok: makeResource(ociMod, "CoreCrossConnectGroup")},
			"oci_core_dedicated_vm_host":                              {Tok: makeResource(ociMod, "CoreDedicatedVmHost")},
			"oci_core_default_dhcp_options":                           {Tok: makeResource(ociMod, "CoreDefaultDhcpOptions")},
			"oci_core_default_route_table":                            {Tok: makeResource(ociMod, "CoreDefaultRouteTable")},
			"oci_core_default_security_list":                          {Tok: makeResource(ociMod, "CoreDefaultSecurityList")},
			"oci_core_dhcp_options":                                   {Tok: makeResource(ociMod, "CoreDhcpOptions")},
			"oci_core_drg":                                            {Tok: makeResource(ociMod, "CoreDrg")},
			"oci_core_drg_attachment":                                 {Tok: makeResource(ociMod, "CoreDrgAttachment")},
			"oci_core_drg_attachment_management":                      {Tok: makeResource(ociMod, "CoreDrgAttachmentManagement")},
			"oci_core_drg_attachments_list":                           {Tok: makeResource(ociMod, "CoreDrgAttachmentsList")},
			"oci_core_drg_route_distribution":                         {Tok: makeResource(ociMod, "CoreDrgRouteDistribution")},
			"oci_core_drg_route_distribution_statement":               {Tok: makeResource(ociMod, "CoreDrgRouteDistributionStatement")},
			"oci_core_drg_route_table":                                {Tok: makeResource(ociMod, "CoreDrgRouteTable")},
			"oci_core_drg_route_table_route_rule":                     {Tok: makeResource(ociMod, "CoreDrgRouteTableRouteRule")},
			"oci_core_image":                                          {Tok: makeResource(ociMod, "CoreImage")},
			"oci_core_instance":                                       {Tok: makeResource(ociMod, "CoreInstance")},
			"oci_core_instance_configuration":                         {Tok: makeResource(ociMod, "CoreInstanceConfiguration")},
			"oci_core_instance_console_connection":                    {Tok: makeResource(ociMod, "CoreInstanceConsoleConnection")},
			"oci_core_instance_pool":                                  {Tok: makeResource(ociMod, "CoreInstancePool")},
			"oci_core_instance_pool_instance":                         {Tok: makeResource(ociMod, "CoreInstancePoolInstance")},
			"oci_core_internet_gateway":                               {Tok: makeResource(ociMod, "CoreInternetGateway")},
			"oci_core_ipsec":                                          {Tok: makeResource(ociMod, "CoreIpsec")},
			"oci_core_ipsec_connection_tunnel_management":             {Tok: makeResource(ociMod, "CoreIpsecConnectionTunnelManagement")},
			"oci_core_ipv6":                                           {Tok: makeResource(ociMod, "CoreIpv6")},
			"oci_core_listing_resource_version_agreement":             {Tok: makeResource(ociMod, "CoreListingResourceVersionAgreement")},
			"oci_core_local_peering_gateway":                          {Tok: makeResource(ociMod, "CoreLocalPeeringGateway")},
			"oci_core_nat_gateway":                                    {Tok: makeResource(ociMod, "CoreNatGateway")},
			"oci_core_network_security_group":                         {Tok: makeResource(ociMod, "CoreNetworkSecurityGroup")},
			"oci_core_network_security_group_security_rule":           {Tok: makeResource(ociMod, "CoreNetworkSecurityGroupSecurityRule")},
			"oci_core_private_ip":                                     {Tok: makeResource(ociMod, "CorePrivateIp")},
			"oci_core_public_ip":                                      {Tok: makeResource(ociMod, "CorePublicIp")},
			"oci_core_public_ip_pool":                                 {Tok: makeResource(ociMod, "CorePublicIpPool")},
			"oci_core_public_ip_pool_capacity":                        {Tok: makeResource(ociMod, "CorePublicIpPoolCapacity")},
			"oci_core_remote_peering_connection":                      {Tok: makeResource(ociMod, "CoreRemotePeeringConnection")},
			"oci_core_route_table":                                    {Tok: makeResource(ociMod, "CoreRouteTable")},
			"oci_core_route_table_attachment":                         {Tok: makeResource(ociMod, "CoreRouteTableAttachment")},
			"oci_core_security_list":                                  {Tok: makeResource(ociMod, "CoreSecurityList")},
			"oci_core_service_gateway":                                {Tok: makeResource(ociMod, "CoreServiceGateway")},
			"oci_core_shape_management":                               {Tok: makeResource(ociMod, "CoreShapeManagement")},
			"oci_core_subnet":                                         {Tok: makeResource(ociMod, "CoreSubnet")},
			"oci_core_vcn":                                            {Tok: makeResource(ociMod, "CoreVcn")},
			"oci_core_virtual_circuit":                                {Tok: makeResource(ociMod, "CoreVirtualCircuit")},
			"oci_core_virtual_network":                                {Tok: makeResource(ociMod, "CoreVirtualNetwork")},
			"oci_core_vlan":                                           {Tok: makeResource(ociMod, "CoreVlan")},
			"oci_core_vnic_attachment":                                {Tok: makeResource(ociMod, "CoreVnicAttachment")},
			"oci_core_volume":                                         {Tok: makeResource(ociMod, "CoreVolume")},
			"oci_core_volume_attachment":                              {Tok: makeResource(ociMod, "CoreVolumeAttachment")},
			"oci_core_volume_backup":                                  {Tok: makeResource(ociMod, "CoreVolumeBackup")},
			"oci_core_volume_backup_policy":                           {Tok: makeResource(ociMod, "CoreVolumeBackupPolicy")},
			"oci_core_volume_backup_policy_assignment":                {Tok: makeResource(ociMod, "CoreVolumeBackupPolicyAssignment")},
			"oci_core_volume_group":                                   {Tok: makeResource(ociMod, "CoreVolumeGroup")},
			"oci_core_volume_group_backup":                            {Tok: makeResource(ociMod, "CoreVolumeGroupBackup")},
			"oci_data_safe_data_safe_configuration":                   {Tok: makeResource(ociMod, "DataSafeDataSafeConfiguration")},
			"oci_data_safe_data_safe_private_endpoint":                {Tok: makeResource(ociMod, "DataSafeDataSafePrivateEndpoint")},
			"oci_data_safe_on_prem_connector":                         {Tok: makeResource(ociMod, "DataSafeOnPremConnector")},
			"oci_data_safe_target_database":                           {Tok: makeResource(ociMod, "DataSafeTargetDatabase")},
			"oci_database_autonomous_container_database":              {Tok: makeResource(ociMod, "DatabaseAutonomousContainerDatabase")},
			"oci_database_autonomous_container_database_dataguard_association_operation":  {Tok: makeResource(ociMod, "DatabaseAutonomousContainerDatabaseDataguardAssociationOperation")},
			"oci_database_autonomous_database":                                            {Tok: makeResource(ociMod, "DatabaseAutonomousDatabase")},
			"oci_database_autonomous_database_backup":                                     {Tok: makeResource(ociMod, "DatabaseAutonomousDatabaseBackup")},
			"oci_database_autonomous_database_instance_wallet_management":                 {Tok: makeResource(ociMod, "DatabaseAutonomousDatabaseInstanceWalletManagement")},
			"oci_database_autonomous_database_regional_wallet_management":                 {Tok: makeResource(ociMod, "DatabaseAutonomousDatabaseRegionalWalletManagement")},
			"oci_database_autonomous_database_wallet":                                     {Tok: makeResource(ociMod, "DatabaseAutonomousDatabaseWallet")},
			"oci_database_autonomous_exadata_infrastructure":                              {Tok: makeResource(ociMod, "DatabaseAutonomousExadataInfrastructure")},
			"oci_database_autonomous_vm_cluster":                                          {Tok: makeResource(ociMod, "DatabaseAutonomousVmCluster")},
			"oci_database_backup":                                                         {Tok: makeResource(ociMod, "DatabaseBackup")},
			"oci_database_backup_destination":                                             {Tok: makeResource(ociMod, "DatabaseBackupDestination")},
			"oci_database_cloud_exadata_infrastructure":                                   {Tok: makeResource(ociMod, "DatabaseCloudExadataInfrastructure")},
			"oci_database_cloud_vm_cluster":                                               {Tok: makeResource(ociMod, "DatabaseCloudVmCluster")},
			"oci_database_data_guard_association":                                         {Tok: makeResource(ociMod, "DatabaseDataGuardAssociation")},
			"oci_database_database":                                                       {Tok: makeResource(ociMod, "DatabaseDatabase")},
			"oci_database_database_software_image":                                        {Tok: makeResource(ociMod, "DatabaseDatabaseSoftwareImage")},
			"oci_database_database_upgrade":                                               {Tok: makeResource(ociMod, "DatabaseDatabaseUpgrade")},
			"oci_database_db_home":                                                        {Tok: makeResource(ociMod, "DatabaseDbHome")},
			"oci_database_db_node_console_connection":                                     {Tok: makeResource(ociMod, "DatabaseDbNodeConsoleConnection")},
			"oci_database_db_system":                                                      {Tok: makeResource(ociMod, "DatabaseDbSystem")},
			"oci_database_exadata_infrastructure":                                         {Tok: makeResource(ociMod, "DatabaseExadataInfrastructure")},
			"oci_database_exadata_infrastructure_storage":                                 {Tok: makeResource(ociMod, "DatabaseExadataInfrastructureStorage")},
			"oci_database_exadata_iorm_config":                                            {Tok: makeResource(ociMod, "DatabaseExadataIormConfig")},
			"oci_database_external_container_database":                                    {Tok: makeResource(ociMod, "DatabaseExternalContainerDatabase")},
			"oci_database_external_container_database_management":                         {Tok: makeResource(ociMod, "DatabaseExternalContainerDatabaseManagement")},
			"oci_database_external_database_connector":                                    {Tok: makeResource(ociMod, "DatabaseExternalDatabaseConnector")},
			"oci_database_external_non_container_database":                                {Tok: makeResource(ociMod, "DatabaseExternalNonContainerDatabase")},
			"oci_database_external_non_container_database_management":                     {Tok: makeResource(ociMod, "DatabaseExternalNonContainerDatabaseManagement")},
			"oci_database_external_non_container_database_operations_insights_management": {Tok: makeResource(ociMod, "DatabaseExternalNonContainerDatabaseOperationsInsightsManagement")},
			"oci_database_external_pluggable_database":                                    {Tok: makeResource(ociMod, "DatabaseExternalPluggableDatabase")},
			"oci_database_external_pluggable_database_management":                         {Tok: makeResource(ociMod, "DatabaseExternalPluggableDatabaseManagement")},
			"oci_database_external_pluggable_database_operations_insights_management":     {Tok: makeResource(ociMod, "DatabaseExternalPluggableDatabaseOperationsInsightsManagement")},
			"oci_database_key_store":                                                      {Tok: makeResource(ociMod, "DatabaseKeyStore")},
			"oci_database_maintenance_run":                                                {Tok: makeResource(ociMod, "DatabaseMaintenanceRun")},
			"oci_database_management_managed_database_group":                              {Tok: makeResource(ociMod, "DatabaseManagementManagedDatabaseGroup")},
			"oci_database_management_managed_databases_change_database_parameter":         {Tok: makeResource(ociMod, "DatabaseManagementManagedDatabasesChangeDatabaseParameter")},
			"oci_database_management_managed_databases_reset_database_parameter":          {Tok: makeResource(ociMod, "DatabaseManagementManagedDatabasesResetDatabaseParameter")},
			"oci_database_migration":                                                      {Tok: makeResource(ociMod, "DatabaseMigration")},
			"oci_database_migration_agent":                                                {Tok: makeResource(ociMod, "DatabaseMigrationAgent")},
			"oci_database_migration_connection":                                           {Tok: makeResource(ociMod, "DatabaseMigrationConnection")},
			"oci_database_migration_job":                                                  {Tok: makeResource(ociMod, "DatabaseMigrationJob")},
			"oci_database_migration_migration":                                            {Tok: makeResource(ociMod, "DatabaseMigrationMigration")},
			"oci_database_pluggable_database":                                             {Tok: makeResource(ociMod, "DatabasePluggableDatabase")},
			"oci_database_pluggable_databases_local_clone":                                {Tok: makeResource(ociMod, "DatabasePluggableDatabasesLocalClone")},
			"oci_database_pluggable_databases_remote_clone":                               {Tok: makeResource(ociMod, "DatabasePluggableDatabasesRemoteClone")},
			"oci_database_vm_cluster":                                                     {Tok: makeResource(ociMod, "DatabaseVmCluster")},
			"oci_database_vm_cluster_network":                                             {Tok: makeResource(ociMod, "DatabaseVmClusterNetwork")},
			"oci_datacatalog_catalog":                                                     {Tok: makeResource(ociMod, "DatacatalogCatalog")},
			"oci_datacatalog_catalog_private_endpoint":                                    {Tok: makeResource(ociMod, "DatacatalogCatalogPrivateEndpoint")},
			"oci_datacatalog_connection":                                                  {Tok: makeResource(ociMod, "DatacatalogConnection")},
			"oci_datacatalog_data_asset":                                                  {Tok: makeResource(ociMod, "DatacatalogDataAsset")},
			"oci_datacatalog_metastore":                                                   {Tok: makeResource(ociMod, "DatacatalogMetastore")},
			"oci_dataflow_application":                                                    {Tok: makeResource(ociMod, "DataflowApplication")},
			"oci_dataflow_invoke_run":                                                     {Tok: makeResource(ociMod, "DataflowInvokeRun")},
			"oci_dataflow_private_endpoint":                                               {Tok: makeResource(ociMod, "DataflowPrivateEndpoint")},
			"oci_dataintegration_workspace":                                               {Tok: makeResource(ociMod, "DataintegrationWorkspace")},
			"oci_datascience_model":                                                       {Tok: makeResource(ociMod, "DatascienceModel")},
			"oci_datascience_model_deployment":                                            {Tok: makeResource(ociMod, "DatascienceModelDeployment")},
			"oci_datascience_model_provenance":                                            {Tok: makeResource(ociMod, "DatascienceModelProvenance")},
			"oci_datascience_notebook_session":                                            {Tok: makeResource(ociMod, "DatascienceNotebookSession")},
			"oci_datascience_project":                                                     {Tok: makeResource(ociMod, "DatascienceProject")},
			"oci_devops_deploy_artifact":                                                  {Tok: makeResource(ociMod, "DevopsDeployArtifact")},
			"oci_devops_deploy_environment":                                               {Tok: makeResource(ociMod, "DevopsDeployEnvironment")},
			"oci_devops_deploy_pipeline":                                                  {Tok: makeResource(ociMod, "DevopsDeployPipeline")},
			"oci_devops_deploy_stage":                                                     {Tok: makeResource(ociMod, "DevopsDeployStage")},
			"oci_devops_deployment":                                                       {Tok: makeResource(ociMod, "DevopsDeployment")},
			"oci_devops_project":                                                          {Tok: makeResource(ociMod, "DevopsProject")},
			"oci_dns_record":                                                              {Tok: makeResource(ociMod, "DnsRecord")},
			"oci_dns_resolver":                                                            {Tok: makeResource(ociMod, "DnsResolver")},
			"oci_dns_resolver_endpoint":                                                   {Tok: makeResource(ociMod, "DnsResolverEndpoint")},
			"oci_dns_rrset":                                                               {Tok: makeResource(ociMod, "DnsRrset")},
			"oci_dns_steering_policy":                                                     {Tok: makeResource(ociMod, "DnsSteeringPolicy")},
			"oci_dns_steering_policy_attachment":                                          {Tok: makeResource(ociMod, "DnsSteeringPolicyAttachment")},
			"oci_dns_tsig_key":                                                            {Tok: makeResource(ociMod, "DnsTsigKey")},
			"oci_dns_view":                                                                {Tok: makeResource(ociMod, "DnsView")},
			"oci_dns_zone":                                                                {Tok: makeResource(ociMod, "DnsZone")},
			"oci_email_dkim":                                                              {Tok: makeResource(ociMod, "EmailDkim")},
			"oci_email_email_domain":                                                      {Tok: makeResource(ociMod, "EmailEmailDomain")},
			"oci_email_sender":                                                            {Tok: makeResource(ociMod, "EmailSender")},
			"oci_email_suppression":                                                       {Tok: makeResource(ociMod, "EmailSuppression")},
			"oci_events_rule":                                                             {Tok: makeResource(ociMod, "EventsRule")},
			"oci_file_storage_export":                                                     {Tok: makeResource(ociMod, "FileStorageExport")},
			"oci_file_storage_export_set":                                                 {Tok: makeResource(ociMod, "FileStorageExportSet")},
			"oci_file_storage_file_system":                                                {Tok: makeResource(ociMod, "FileStorageFileSystem")},
			"oci_file_storage_mount_target":                                               {Tok: makeResource(ociMod, "FileStorageMountTarget")},
			"oci_file_storage_snapshot":                                                   {Tok: makeResource(ociMod, "FileStorageSnapshot")},
			"oci_functions_application":                                                   {Tok: makeResource(ociMod, "FunctionsApplication")},
			"oci_functions_function":                                                      {Tok: makeResource(ociMod, "FunctionsFunction")},
			"oci_functions_invoke_function":                                               {Tok: makeResource(ociMod, "FunctionsInvokeFunction")},
			"oci_generic_artifacts_content_artifact_by_path":                              {Tok: makeResource(ociMod, "GenericArtifactsContentArtifactByPath")},
			"oci_golden_gate_database_registration":                                       {Tok: makeResource(ociMod, "GoldenGateDatabaseRegistration")},
			"oci_golden_gate_deployment":                                                  {Tok: makeResource(ociMod, "GoldenGateDeployment")},
			"oci_golden_gate_deployment_backup":                                           {Tok: makeResource(ociMod, "GoldenGateDeploymentBackup")},
			"oci_health_checks_http_monitor":                                              {Tok: makeResource(ociMod, "HealthChecksHttpMonitor")},
			"oci_health_checks_http_probe":                                                {Tok: makeResource(ociMod, "HealthChecksHttpProbe")},
			"oci_health_checks_ping_monitor":                                              {Tok: makeResource(ociMod, "HealthChecksPingMonitor")},
			"oci_health_checks_ping_probe":                                                {Tok: makeResource(ociMod, "HealthChecksPingProbe")},
			"oci_identity_api_key":                                                        {Tok: makeResource(ociMod, "IdentityApiKey")},
			"oci_identity_auth_token":                                                     {Tok: makeResource(ociMod, "IdentityAuthToken")},
			"oci_identity_authentication_policy":                                          {Tok: makeResource(ociMod, "IdentityAuthenticationPolicy")},
			"oci_identity_compartment":                                                    {Tok: makeResource(ociMod, "IdentityCompartment")},
			"oci_identity_customer_secret_key":                                            {Tok: makeResource(ociMod, "IdentityCustomerSecretKey")},
			"oci_identity_dynamic_group":                                                  {Tok: makeResource(ociMod, "IdentityDynamicGroup")},
			"oci_identity_group":                                                          {Tok: makeResource(ociMod, "IdentityGroup")},
			"oci_identity_identity_provider":                                              {Tok: makeResource(ociMod, "IdentityIdentityProvider")},
			"oci_identity_idp_group_mapping":                                              {Tok: makeResource(ociMod, "IdentityIdpGroupMapping")},
			"oci_identity_network_source":                                                 {Tok: makeResource(ociMod, "IdentityNetworkSource")},
			"oci_identity_policy":                                                         {Tok: makeResource(ociMod, "IdentityPolicy")},
			"oci_identity_smtp_credential":                                                {Tok: makeResource(ociMod, "IdentitySmtpCredential")},
			"oci_identity_swift_password":                                                 {Tok: makeResource(ociMod, "IdentitySwiftPassword")},
			"oci_identity_tag":                                                            {Tok: makeResource(ociMod, "IdentityTag")},
			"oci_identity_tag_default":                                                    {Tok: makeResource(ociMod, "IdentityTagDefault")},
			"oci_identity_tag_namespace":                                                  {Tok: makeResource(ociMod, "IdentityTagNamespace")},
			"oci_identity_ui_password":                                                    {Tok: makeResource(ociMod, "IdentityUiPassword")},
			"oci_identity_user":                                                           {Tok: makeResource(ociMod, "IdentityUser")},
			"oci_identity_user_capabilities_management":                                   {Tok: makeResource(ociMod, "IdentityUserCapabilitiesManagement")},
			"oci_identity_user_group_membership":                                          {Tok: makeResource(ociMod, "IdentityUserGroupMembership")},
			"oci_integration_integration_instance":                                        {Tok: makeResource(ociMod, "IntegrationIntegrationInstance")},
			"oci_jms_fleet":                                                               {Tok: makeResource(ociMod, "JmsFleet")},
			"oci_kms_encrypted_data":                                                      {Tok: makeResource(ociMod, "KmsEncryptedData")},
			"oci_kms_generated_key":                                                       {Tok: makeResource(ociMod, "KmsGeneratedKey")},
			"oci_kms_key":                                                                 {Tok: makeResource(ociMod, "KmsKey")},
			"oci_kms_key_version":                                                         {Tok: makeResource(ociMod, "KmsKeyVersion")},
			"oci_kms_sign":                                                                {Tok: makeResource(ociMod, "KmsSign")},
			"oci_kms_vault":                                                               {Tok: makeResource(ociMod, "KmsVault")},
			"oci_kms_vault_replication":                                                   {Tok: makeResource(ociMod, "KmsVaultReplication")},
			"oci_kms_verify":                                                              {Tok: makeResource(ociMod, "KmsVerify")},
			"oci_limits_quota":                                                            {Tok: makeResource(ociMod, "LimitsQuota")},
			"oci_load_balancer":                                                           {Tok: makeResource(ociMod, "LoadBalancer")},
			"oci_load_balancer_backend":                                                   {Tok: makeResource(ociMod, "LoadBalancerBackend")},
			"oci_load_balancer_backend_set":                                               {Tok: makeResource(ociMod, "LoadBalancerBackendSet")},
			//"oci_load_balancer_backendset":                                                {Tok: makeResource(ociMod, "LoadBalancerBackendset")},
			"oci_load_balancer_certificate":                          {Tok: makeResource(ociMod, "LoadBalancerCertificate")},
			"oci_load_balancer_hostname":                             {Tok: makeResource(ociMod, "LoadBalancerHostname")},
			"oci_load_balancer_listener":                             {Tok: makeResource(ociMod, "LoadBalancerListener")},
			"oci_load_balancer_load_balancer":                        {Tok: makeResource(ociMod, "LoadBalancerLoadBalancer")},
			"oci_load_balancer_load_balancer_routing_policy":         {Tok: makeResource(ociMod, "LoadBalancerLoadBalancerRoutingPolicy")},
			"oci_load_balancer_path_route_set":                       {Tok: makeResource(ociMod, "LoadBalancerPathRouteSet")},
			"oci_load_balancer_rule_set":                             {Tok: makeResource(ociMod, "LoadBalancerRuleSet")},
			"oci_load_balancer_ssl_cipher_suite":                     {Tok: makeResource(ociMod, "LoadBalancerSslCipherSuite")},
			"oci_log_analytics_log_analytics_entity":                 {Tok: makeResource(ociMod, "LogAnalyticsLogAnalyticsEntity")},
			"oci_log_analytics_log_analytics_log_group":              {Tok: makeResource(ociMod, "LogAnalyticsLogAnalyticsLogGroup")},
			"oci_log_analytics_log_analytics_object_collection_rule": {Tok: makeResource(ociMod, "LogAnalyticsLogAnalyticsObjectCollectionRule")},
			"oci_log_analytics_namespace":                            {Tok: makeResource(ociMod, "LogAnalyticsNamespace")},
			"oci_logging_log":                                        {Tok: makeResource(ociMod, "LoggingLog")},
			"oci_logging_log_group":                                  {Tok: makeResource(ociMod, "LoggingLogGroup")},
			"oci_logging_log_saved_search":                           {Tok: makeResource(ociMod, "LoggingLogSavedSearch")},
			"oci_logging_unified_agent_configuration":                {Tok: makeResource(ociMod, "LoggingUnifiedAgentConfiguration")},
			"oci_management_agent_management_agent":                  {Tok: makeResource(ociMod, "ManagementAgentManagementAgent")},
			"oci_management_agent_management_agent_install_key":      {Tok: makeResource(ociMod, "ManagementAgentManagementAgentInstallKey")},
			"oci_management_dashboard_management_dashboards_import":  {Tok: makeResource(ociMod, "ManagementDashboardManagementDashboardsImport")},
			"oci_marketplace_accepted_agreement":                     {Tok: makeResource(ociMod, "MarketplaceAcceptedAgreement")},
			"oci_marketplace_listing_package_agreement":              {Tok: makeResource(ociMod, "MarketplaceListingPackageAgreement")},
			"oci_marketplace_publication":                            {Tok: makeResource(ociMod, "MarketplacePublication")},
			"oci_metering_computation_custom_table":                  {Tok: makeResource(ociMod, "MeteringComputationCustomTable")},
			"oci_metering_computation_query":                         {Tok: makeResource(ociMod, "MeteringComputationQuery")},
			"oci_metering_computation_usage":                         {Tok: makeResource(ociMod, "MeteringComputationUsage")},
			"oci_monitoring_alarm":                                   {Tok: makeResource(ociMod, "MonitoringAlarm")},
			"oci_mysql_analytics_cluster":                            {Tok: makeResource(ociMod, "MysqlAnalyticsCluster")},
			"oci_mysql_channel":                                      {Tok: makeResource(ociMod, "MysqlChannel")},
			"oci_mysql_heat_wave_cluster":                            {Tok: makeResource(ociMod, "MysqlHeatWaveCluster")},
			"oci_mysql_mysql_backup":                                 {Tok: makeResource(ociMod, "MysqlMysqlBackup")},
			"oci_mysql_mysql_db_system":                              {Tok: makeResource(ociMod, "MysqlMysqlDbSystem")},
			"oci_network_load_balancer_backend":                      {Tok: makeResource(ociMod, "NetworkLoadBalancerBackend")},
			"oci_network_load_balancer_backend_set":                  {Tok: makeResource(ociMod, "NetworkLoadBalancerBackendSet")},
			"oci_network_load_balancer_listener":                     {Tok: makeResource(ociMod, "NetworkLoadBalancerListener")},
			"oci_network_load_balancer_network_load_balancer":        {Tok: makeResource(ociMod, "NetworkLoadBalancerNetworkLoadBalancer")},
			"oci_nosql_index":                                        {Tok: makeResource(ociMod, "NosqlIndex")},
			"oci_nosql_table":                                        {Tok: makeResource(ociMod, "NosqlTable")},
			"oci_objectstorage_bucket":                               {Tok: makeResource(ociMod, "ObjectstorageBucket")},
			"oci_objectstorage_namespace_metadata":                   {Tok: makeResource(ociMod, "ObjectstorageNamespaceMetadata")},
			"oci_objectstorage_object":                               {Tok: makeResource(ociMod, "ObjectstorageObject")},
			"oci_objectstorage_object_lifecycle_policy":              {Tok: makeResource(ociMod, "ObjectstorageObjectLifecyclePolicy")},
			"oci_objectstorage_preauthrequest":                       {Tok: makeResource(ociMod, "ObjectstoragePreauthrequest")},
			"oci_objectstorage_replication_policy":                   {Tok: makeResource(ociMod, "ObjectstorageReplicationPolicy")},
			"oci_oce_oce_instance":                                   {Tok: makeResource(ociMod, "OceOceInstance")},
			"oci_ocvp_esxi_host":                                     {Tok: makeResource(ociMod, "OcvpEsxiHost")},
			"oci_ocvp_sddc":                                          {Tok: makeResource(ociMod, "OcvpSddc")},
			"oci_oda_oda_instance":                                   {Tok: makeResource(ociMod, "OdaOdaInstance")},
			"oci_ons_notification_topic":                             {Tok: makeResource(ociMod, "OnsNotificationTopic")},
			"oci_ons_subscription":                                   {Tok: makeResource(ociMod, "OnsSubscription")},
			"oci_opsi_database_insight":                              {Tok: makeResource(ociMod, "OpsiDatabaseInsight")},
			"oci_opsi_enterprise_manager_bridge":                     {Tok: makeResource(ociMod, "OpsiEnterpriseManagerBridge")},
			"oci_opsi_host_insight":                                  {Tok: makeResource(ociMod, "OpsiHostInsight")},
			"oci_optimizer_enrollment_status":                        {Tok: makeResource(ociMod, "OptimizerEnrollmentStatus")},
			"oci_optimizer_profile":                                  {Tok: makeResource(ociMod, "OptimizerProfile")},
			"oci_optimizer_recommendation":                           {Tok: makeResource(ociMod, "OptimizerRecommendation")},
			"oci_optimizer_resource_action":                          {Tok: makeResource(ociMod, "OptimizerResourceAction")},
			"oci_osmanagement_managed_instance_group":                {Tok: makeResource(ociMod, "OsmanagementManagedInstanceGroup")},
			"oci_osmanagement_managed_instance_management":           {Tok: makeResource(ociMod, "OsmanagementManagedInstanceManagement")},
			"oci_osmanagement_software_source":                       {Tok: makeResource(ociMod, "OsmanagementSoftwareSource")},
			"oci_sch_service_connector":                              {Tok: makeResource(ociMod, "SchServiceConnector")},
			"oci_service_catalog_private_application":                {Tok: makeResource(ociMod, "ServiceCatalogPrivateApplication")},
			"oci_service_catalog_service_catalog":                    {Tok: makeResource(ociMod, "ServiceCatalogServiceCatalog")},
			"oci_service_catalog_service_catalog_association":        {Tok: makeResource(ociMod, "ServiceCatalogServiceCatalogAssociation")},
			"oci_streaming_connect_harness":                          {Tok: makeResource(ociMod, "StreamingConnectHarness")},
			"oci_streaming_stream":                                   {Tok: makeResource(ociMod, "StreamingStream")},
			"oci_streaming_stream_pool":                              {Tok: makeResource(ociMod, "StreamingStreamPool")},
			"oci_vulnerability_scanning_host_scan_recipe":            {Tok: makeResource(ociMod, "VulnerabilityScanningHostScanRecipe")},
			"oci_vulnerability_scanning_host_scan_target":            {Tok: makeResource(ociMod, "VulnerabilityScanningHostScanTarget")},
			"oci_waas_address_list":                                  {Tok: makeResource(ociMod, "WaasAddressList")},
			"oci_waas_certificate":                                   {Tok: makeResource(ociMod, "WaasCertificate")},
			"oci_waas_custom_protection_rule":                        {Tok: makeResource(ociMod, "WaasCustomProtectionRule")},
			"oci_waas_http_redirect":                                 {Tok: makeResource(ociMod, "WaasHttpRedirect")},
			"oci_waas_protection_rule":                               {Tok: makeResource(ociMod, "WaasProtectionRule")},
			"oci_waas_purge_cache":                                   {Tok: makeResource(ociMod, "WaasPurgeCache")},
			"oci_waas_waas_policy":                                   {Tok: makeResource(ociMod, "WaasWaasPolicy")},
		},
