 ...
 *
 * const testUnifiedAgentConfiguration = new oci.LoggingUnifiedAgentConfiguration("testUnifiedAgentConfiguration", {
...
export class LoggingUnifiedAgentConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly groupAssociation!: pulumi.Output<outputs.LoggingUnifiedAgentConfigurationGroupAssociation>;
    /**
    ...
    constructor(name: string, argsOrState?: LoggingUnifiedAgentConfigurationArgs | LoggingUnifiedAgentConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoggingUnifiedAgentConfiguration.__pulumiType, name, inputs, opts);
    }
}
