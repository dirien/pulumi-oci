 ...
 *
 * const testCloudExadataInfrastructure = new oci.DatabaseCloudExadataInfrastructure("testCloudExadataInfrastructure", {
...
export class DatabaseCloudExadataInfrastructure extends pulumi.CustomResource {
     ...
     */
    public readonly customerContacts!: pulumi.Output<outputs.DatabaseCloudExadataInfrastructureCustomerContact[]>;
    /**
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<outputs.DatabaseCloudExadataInfrastructureMaintenanceWindow>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseCloudExadataInfrastructureArgs | DatabaseCloudExadataInfrastructureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseCloudExadataInfrastructure.__pulumiType, name, inputs, opts);
    }
}
