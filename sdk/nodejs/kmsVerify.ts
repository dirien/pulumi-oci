 ...
 *
 * const testVerify = new oci.KmsVerify("testVerify", {
...
export class KmsVerify extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: KmsVerifyArgs | KmsVerifyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["isSignatureValid"] = state ? state.isSignatureValid : undefined;
            ...
            inputs["isSignatureValid"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(KmsVerify.__pulumiType, name, inputs, opts);
    }
}
