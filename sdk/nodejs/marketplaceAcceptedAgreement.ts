 ...
 *
 * const testAcceptedAgreement = new oci.MarketplaceAcceptedAgreement("testAcceptedAgreement", {
...
export class MarketplaceAcceptedAgreement extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: MarketplaceAcceptedAgreementArgs | MarketplaceAcceptedAgreementState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MarketplaceAcceptedAgreement.__pulumiType, name, inputs, opts);
    }
}
