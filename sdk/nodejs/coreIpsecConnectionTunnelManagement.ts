 ...
 *
 * const testIpSecConnectionTunnel = new oci.CoreIpsecConnectionTunnelManagement("testIpSecConnectionTunnel", {
...
export class CoreIpsecConnectionTunnelManagement extends pulumi.CustomResource {
     ...
     */
    public readonly bgpSessionInfos!: pulumi.Output<outputs.CoreIpsecConnectionTunnelManagementBgpSessionInfo[]>;
    /**
     ...
     */
    public readonly encryptionDomainConfig!: pulumi.Output<outputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: CoreIpsecConnectionTunnelManagementArgs | CoreIpsecConnectionTunnelManagementState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CoreIpsecConnectionTunnelManagement.__pulumiType, name, inputs, opts);
    }
}
...
export interface CoreIpsecConnectionTunnelManagementState {
     ...
     * Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
     */
    bgpSessionInfos?: pulumi.Input<pulumi.Input<inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfo>[]>;
    /**
     * The OCID of the compartment containing the tunnel.
     */
