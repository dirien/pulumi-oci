 ...
 *
 * const testVirtualCircuit = new oci.CoreVirtualCircuit("testVirtualCircuit", {
...
export class CoreVirtualCircuit extends pulumi.CustomResource {
     ...
     */
    public readonly crossConnectMappings!: pulumi.Output<outputs.CoreVirtualCircuitCrossConnectMapping[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CoreVirtualCircuitArgs | CoreVirtualCircuitState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CoreVirtualCircuit.__pulumiType, name, inputs, opts);
    }
}
