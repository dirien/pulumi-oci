 ...
 *
 * const testTarget = new oci.CloudGuardTarget("testTarget", {
...
export class CloudGuardTarget extends pulumi.CustomResource {
     ...
     */
    public readonly targetDetectorRecipes!: pulumi.Output<outputs.CloudGuardTargetTargetDetectorRecipe[]>;
    /**
     ...
     */
    public readonly targetResponderRecipes!: pulumi.Output<outputs.CloudGuardTargetTargetResponderRecipe[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudGuardTargetArgs | CloudGuardTargetState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CloudGuardTarget.__pulumiType, name, inputs, opts);
    }
}
