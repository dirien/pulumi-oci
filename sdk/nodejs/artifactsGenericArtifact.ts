 ...
 *
 * const testGenericArtifact = new oci.ArtifactsGenericArtifact("testGenericArtifact", {
...
export class ArtifactsGenericArtifact extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ArtifactsGenericArtifactArgs | ArtifactsGenericArtifactState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ArtifactsGenericArtifact.__pulumiType, name, inputs, opts);
    }
}
