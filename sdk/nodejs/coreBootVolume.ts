 ...
 *
 * const testBootVolume = new oci.CoreBootVolume("testBootVolume", {
...
export class CoreBootVolume extends pulumi.CustomResource {
     ...
     */
    public readonly bootVolumeReplicas!: pulumi.Output<outputs.CoreBootVolumeBootVolumeReplica[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CoreBootVolumeArgs | CoreBootVolumeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["bootVolumeReplicas"] = state ? state.bootVolumeReplicas : undefined;
            inputs["bootVolumeReplicasDeletion"] = state ? state.bootVolumeReplicasDeletion : undefined;
            ...
            inputs["bootVolumeReplicas"] = args ? args.bootVolumeReplicas : undefined;
            inputs["bootVolumeReplicasDeletion"] = args ? args.bootVolumeReplicasDeletion : undefined;
        ...
        super(CoreBootVolume.__pulumiType, name, inputs, opts);
    }
}
