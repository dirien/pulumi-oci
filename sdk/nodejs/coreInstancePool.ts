 ...
 *
 * const testInstancePool = new oci.CoreInstancePool("testInstancePool", {
...
export class CoreInstancePool extends pulumi.CustomResource {
     ...
     */
    public readonly loadBalancers!: pulumi.Output<outputs.CoreInstancePoolLoadBalancer[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CoreInstancePoolArgs | CoreInstancePoolState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["actualSize"] = state ? state.actualSize : undefined;
            ...
            inputs["placementConfigurations"] = state ? state.placementConfigurations : undefined;
            ...
            inputs["instanceConfigurationId"] = args ? args.instanceConfigurationId : undefined;
            inputs["loadBalancers"] = args ? args.loadBalancers : undefined;
            inputs["placementConfigurations"] = args ? args.placementConfigurations : undefined;
            inputs["size"] = args ? args.size : undefined;
            inputs["state"] = args ? args.state : undefined;
            inputs["actualSize"] = undefined /*out*/;
            inputs["timeCreated"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(CoreInstancePool.__pulumiType, name, inputs, opts);
    }
}
