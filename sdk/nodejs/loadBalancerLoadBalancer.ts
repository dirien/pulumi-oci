 ...
 *
 * const testLoadBalancer = new oci.LoadBalancerLoadBalancer("testLoadBalancer", {
...
export class LoadBalancerLoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly shapeDetails!: pulumi.Output<outputs.LoadBalancerLoadBalancerShapeDetails>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadBalancerLoadBalancerArgs | LoadBalancerLoadBalancerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancerLoadBalancer.__pulumiType, name, inputs, opts);
    }
}
