 ...
 *
 * const testInstance = oci.GetCoreInstance({
...
export interface GetCoreInstanceResult {
     ...
     */
    readonly agentConfig: outputs.GetCoreInstanceAgentConfig;
    /**
     * Options for defining the availabiity of a VM instance after a maintenance event that impacts the underlying hardware.
     */
    readonly availabilityConfig: outputs.GetCoreInstanceAvailabilityConfig;
    /**
    ...
    readonly createVnicDetails: outputs.GetCoreInstanceCreateVnicDetails;
    /**
     ...
     */
    readonly instanceOptions: outputs.GetCoreInstanceInstanceOptions;
    /**
     ...
     */
    readonly launchOptions: outputs.GetCoreInstanceLaunchOptions;
    /**
     ...
     */
    readonly platformConfig: outputs.GetCoreInstancePlatformConfig;
    /**
     * (Optional) Configuration options for preemptible instances.
     */
    readonly preemptibleInstanceConfig: outputs.GetCoreInstancePreemptibleInstanceConfig;
    /**
     ...
     */
    readonly shapeConfig: outputs.GetCoreInstanceShapeConfig;
    readonly sourceDetails: outputs.GetCoreInstanceSourceDetails;
    /**
