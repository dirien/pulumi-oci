 ...
 *
 * const testBdsInstance = new oci.BdsBdsInstance("testBdsInstance", {
...
export class BdsBdsInstance extends pulumi.CustomResource {
     ...
     */
    public readonly cloudSqlDetails!: pulumi.Output<outputs.BdsBdsInstanceCloudSqlDetails>;
    /**
     ...
     */
    public /*out*/ readonly clusterDetails!: pulumi.Output<outputs.BdsBdsInstanceClusterDetails>;
    /**
     ...
     */
    public readonly networkConfig!: pulumi.Output<outputs.BdsBdsInstanceNetworkConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: BdsBdsInstanceArgs | BdsBdsInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BdsBdsInstance.__pulumiType, name, inputs, opts);
    }
}
...
export interface BdsBdsInstanceState {
     ...
     * The information about added Cloud SQL capability
     */
    cloudSqlDetails?: pulumi.Input<inputs.BdsBdsInstanceCloudSqlDetails>;
    /**
     * Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
     */
     ...
     * Specific info about a Hadoop cluster
     */
    clusterDetails?: pulumi.Input<inputs.BdsBdsInstanceClusterDetails>;
    /**
     * The SSH public key used to authenticate the cluster connection.
     */
