 ...
 *
 * const testVault = new oci.KmsVault("testVault", {
...
export class KmsVault extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly replicaDetails!: pulumi.Output<outputs.KmsVaultReplicaDetails>;
    /**
    ...
    constructor(name: string, argsOrState?: KmsVaultArgs | KmsVaultState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KmsVault.__pulumiType, name, inputs, opts);
    }
}
...
export interface KmsVaultState {
     ...
     * Vault replica details
     */
    replicaDetails?: pulumi.Input<inputs.KmsVaultReplicaDetails>;
    /**
     * (Updatable) Details where vault was backed up.
     */
