 ...
 *
 * const testCustomProtectionRule = new oci.WaasCustomProtectionRule("testCustomProtectionRule", {
...
export class WaasCustomProtectionRule extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WaasCustomProtectionRuleArgs | WaasCustomProtectionRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["modSecurityRuleIds"] = state ? state.modSecurityRuleIds : undefined;
            ...
            inputs["modSecurityRuleIds"] = undefined /*out*/;
        ...
        super(WaasCustomProtectionRule.__pulumiType, name, inputs, opts);
    }
}
