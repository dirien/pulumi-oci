 ...
 *
 * const testNotificationTopic = new oci.OnsNotificationTopic("testNotificationTopic", {
...
export class OnsNotificationTopic extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: OnsNotificationTopicArgs | OnsNotificationTopicState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["shortTopicId"] = state ? state.shortTopicId : undefined;
            ...
            inputs["shortTopicId"] = undefined /*out*/;
            inputs["state"] = undefined /*out*/;
            inputs["timeCreated"] = undefined /*out*/;
            inputs["topicId"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(OnsNotificationTopic.__pulumiType, name, inputs, opts);
    }
}
