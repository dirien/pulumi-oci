 ...
 *
 * const testEsxiHosts = oci.ocvp.getEsxiHosts({
 ...
 * ```
 */
export function getEsxiHosts(args?: GetEsxiHostsArgs, opts?: pulumi.InvokeOptions): Promise<GetEsxiHostsResult> {
    args = args || {};
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("oci:ocvp/getEsxiHosts:getEsxiHosts", {
 ...
 */
export interface GetEsxiHostsArgs {
    /**
     ...
     */
    displayName?: string;
    filters?: inputs.ocvp.GetEsxiHostsFilter[];
    /**
 ...
 */
export interface GetEsxiHostsResult {
    /**
     ...
     */
    readonly esxiHostCollections: outputs.ocvp.GetEsxiHostsEsxiHostCollection[];
    readonly filters?: outputs.ocvp.GetEsxiHostsFilter[];
    /**
