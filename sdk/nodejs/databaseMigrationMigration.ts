 ...
 *
 * const testMigration = new oci.DatabaseMigrationMigration("testMigration", {
...
export class DatabaseMigrationMigration extends pulumi.CustomResource {
     ...
     */
    public readonly dataTransferMediumDetails!: pulumi.Output<outputs.DatabaseMigrationMigrationDataTransferMediumDetails>;
    /**
     * (Updatable) Optional settings for Datapump Export and Import jobs
     */
    public readonly datapumpSettings!: pulumi.Output<outputs.DatabaseMigrationMigrationDatapumpSettings>;
    /**
     ...
     */
    public readonly excludeObjects!: pulumi.Output<outputs.DatabaseMigrationMigrationExcludeObject[]>;
    /**
     ...
     */
    public readonly goldenGateDetails!: pulumi.Output<outputs.DatabaseMigrationMigrationGoldenGateDetails>;
    /**
     ...
     */
    public readonly vaultDetails!: pulumi.Output<outputs.DatabaseMigrationMigrationVaultDetails>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseMigrationMigrationArgs | DatabaseMigrationMigrationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseMigrationMigration.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabaseMigrationMigrationState {
     ...
     * (Updatable) Optional settings for Datapump Export and Import jobs
     */
    datapumpSettings?: pulumi.Input<inputs.DatabaseMigrationMigrationDatapumpSettings>;
    /**
     * (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
     */
     ...
     * (Updatable) Details about Oracle GoldenGate Microservices. Required for online logical migration.
     */
    goldenGateDetails?: pulumi.Input<inputs.DatabaseMigrationMigrationGoldenGateDetails>;
    /**
     * Additional status related to the execution and current state of the Migration.
     */
     ...
     * (Updatable) Oracle Cloud Infrastructure Vault details to store migration and connection credentials secrets
     */
    vaultDetails?: pulumi.Input<inputs.DatabaseMigrationMigrationVaultDetails>;
    /**
     * Name of a migration phase. The Job will wait after executing this phase until the Resume Job endpoint is called.
     */
