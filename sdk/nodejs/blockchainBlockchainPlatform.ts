 ...
 *
 * const testBlockchainPlatform = new oci.BlockchainBlockchainPlatform("testBlockchainPlatform", {
...
export class BlockchainBlockchainPlatform extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly componentDetails!: pulumi.Output<outputs.BlockchainBlockchainPlatformComponentDetails>;
    /**
     ...
     */
    public readonly replicas!: pulumi.Output<outputs.BlockchainBlockchainPlatformReplicas>;
    /**
    ...
    constructor(name: string, argsOrState?: BlockchainBlockchainPlatformArgs | BlockchainBlockchainPlatformState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BlockchainBlockchainPlatform.__pulumiType, name, inputs, opts);
    }
}
...
export interface BlockchainBlockchainPlatformState {
     ...
     * Blockchain Platform component details.
     */
    componentDetails?: pulumi.Input<inputs.BlockchainBlockchainPlatformComponentDetails>;
    /**
     * Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
     */
