...
export interface GetTargetDatabaseResult {
     ...
     */
    readonly connectionOption: outputs.datasafe.GetTargetDatabaseConnectionOption;
    /**
     * The database credentials required for Data Safe to connect to the database.
     */
    readonly credentials: outputs.datasafe.GetTargetDatabaseCredentials;
    /**
     ...
     */
    readonly databaseDetails: outputs.datasafe.GetTargetDatabaseDatabaseDetails;
    /**
     ...
     */
    readonly tlsConfig: outputs.datasafe.GetTargetDatabaseTlsConfig;
}
