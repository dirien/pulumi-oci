 ...
 *
 * const testDeployStage = new oci.DevopsDeployStage("testDeployStage", {
...
export class DevopsDeployStage extends pulumi.CustomResource {
     ...
     */
    public readonly approvalPolicy!: pulumi.Output<outputs.DevopsDeployStageApprovalPolicy>;
    /**
     * (Updatable) Collection of backend environment IP addresses.
     */
    public readonly blueBackendIps!: pulumi.Output<outputs.DevopsDeployStageBlueBackendIps>;
    /**
     ...
     */
    public readonly failurePolicy!: pulumi.Output<outputs.DevopsDeployStageFailurePolicy>;
    /**
     ...
     * (Updatable) Collection of backend environment IP addresses.
     */
    public readonly greenBackendIps!: pulumi.Output<outputs.DevopsDeployStageGreenBackendIps>;
    /**
     ...
     */
    public readonly loadBalancerConfig!: pulumi.Output<outputs.DevopsDeployStageLoadBalancerConfig>;
    /**
     ...
     */
    public readonly rollbackPolicy!: pulumi.Output<outputs.DevopsDeployStageRollbackPolicy>;
    /**
     * (Updatable) Description of rollout policy for load balancer traffic shift stage.
     */
    public readonly rolloutPolicy!: pulumi.Output<outputs.DevopsDeployStageRolloutPolicy>;
    /**
     ...
     */
    public readonly waitCriteria!: pulumi.Output<outputs.DevopsDeployStageWaitCriteria>;
    ...
    constructor(name: string, argsOrState?: DevopsDeployStageArgs | DevopsDeployStageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DevopsDeployStage.__pulumiType, name, inputs, opts);
    }
}
