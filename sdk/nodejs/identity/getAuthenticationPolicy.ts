...
export interface GetAuthenticationPolicyResult {
     ...
     */
    readonly networkPolicy: outputs.identity.GetAuthenticationPolicyNetworkPolicy;
    /**
     * Password policy, currently set for the given compartment.
     */
    readonly passwordPolicy: outputs.identity.GetAuthenticationPolicyPasswordPolicy;
}
