 ...
 *
 * const testSubnet = new oci.CoreSubnet("testSubnet", {
...
export class CoreSubnet extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreSubnetArgs | CoreSubnetState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["ipv6virtualRouterIp"] = state ? state.ipv6virtualRouterIp : undefined;
            inputs["prohibitInternetIngress"] = state ? state.prohibitInternetIngress : undefined;
            inputs["prohibitPublicIpOnVnic"] = state ? state.prohibitPublicIpOnVnic : undefined;
            inputs["routeTableId"] = state ? state.routeTableId : undefined;
            inputs["securityListIds"] = state ? state.securityListIds : undefined;
            inputs["state"] = state ? state.state : undefined;
            inputs["subnetDomainName"] = state ? state.subnetDomainName : undefined;
            inputs["timeCreated"] = state ? state.timeCreated : undefined;
            inputs["vcnId"] = state ? state.vcnId : undefined;
            inputs["virtualRouterIp"] = state ? state.virtualRouterIp : undefined;
            inputs["virtualRouterMac"] = state ? state.virtualRouterMac : undefined;
        } else {
            ...
            inputs["prohibitInternetIngress"] = args ? args.prohibitInternetIngress : undefined;
            inputs["prohibitPublicIpOnVnic"] = args ? args.prohibitPublicIpOnVnic : undefined;
            inputs["routeTableId"] = args ? args.routeTableId : undefined;
            inputs["securityListIds"] = args ? args.securityListIds : undefined;
            inputs["vcnId"] = args ? args.vcnId : undefined;
            inputs["ipv6virtualRouterIp"] = undefined /*out*/;
            inputs["state"] = undefined /*out*/;
            inputs["subnetDomainName"] = undefined /*out*/;
            inputs["timeCreated"] = undefined /*out*/;
            inputs["virtualRouterIp"] = undefined /*out*/;
            inputs["virtualRouterMac"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(CoreSubnet.__pulumiType, name, inputs, opts);
    }
}
