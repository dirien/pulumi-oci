...
export interface GetKmsKeyResult {
     ...
     */
    readonly keyShape: outputs.GetKmsKeyKeyShape;
     ...
     * Key replica details
     */
    readonly replicaDetails: outputs.GetKmsKeyReplicaDetails;
    /**
     * Details where key was backed up.
     */
    readonly restoreFromFile: outputs.GetKmsKeyRestoreFromFile;
    /**
     * Details where key was backed up
     */
    readonly restoreFromObjectStore: outputs.GetKmsKeyRestoreFromObjectStore;
    /**
