...
export class Script extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly monitorStatusCountMap!: pulumi.Output<outputs.apmsynthetics.ScriptMonitorStatusCountMap>;
    /**
...
export interface ScriptState {
     ...
     * Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
     */
    monitorStatusCountMap?: pulumi.Input<inputs.apmsynthetics.ScriptMonitorStatusCountMap>;
    /**
     * (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
     */
