 ...
 *
 * const testPluggableDatabase = new oci.DatabasePluggableDatabase("testPluggableDatabase", {
...
export class DatabasePluggableDatabase extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectionStrings!: pulumi.Output<outputs.DatabasePluggableDatabaseConnectionStrings>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabasePluggableDatabaseArgs | DatabasePluggableDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabasePluggableDatabase.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabasePluggableDatabaseState {
     ...
     * Connection strings to connect to an Oracle Pluggable Database.
     */
    connectionStrings?: pulumi.Input<inputs.DatabasePluggableDatabaseConnectionStrings>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB
     */
