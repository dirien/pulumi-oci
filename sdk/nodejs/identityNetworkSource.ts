 ...
 *
 * const testNetworkSource = new oci.IdentityNetworkSource("testNetworkSource", {
...
export class IdentityNetworkSource extends pulumi.CustomResource {
     ...
     */
    public readonly virtualSourceLists!: pulumi.Output<outputs.IdentityNetworkSourceVirtualSourceList[]>;
    ...
    constructor(name: string, argsOrState?: IdentityNetworkSourceArgs | IdentityNetworkSourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(IdentityNetworkSource.__pulumiType, name, inputs, opts);
    }
}
