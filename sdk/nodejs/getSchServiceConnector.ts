 ...
 *
 * const testServiceConnector = oci.GetSchServiceConnector({
...
export interface GetSchServiceConnectorResult {
     ...
     */
    readonly source: outputs.GetSchServiceConnectorSource;
    /**
     ...
     */
    readonly target: outputs.GetSchServiceConnectorTarget;
    /**
     * The list of tasks.
     */
