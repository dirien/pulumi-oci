 ...
 *
 * const testFunction = new oci.FunctionsFunction("testFunction", {
...
export class FunctionsFunction extends pulumi.CustomResource {
     ...
     */
    public readonly traceConfig!: pulumi.Output<outputs.FunctionsFunctionTraceConfig>;
    ...
    constructor(name: string, argsOrState?: FunctionsFunctionArgs | FunctionsFunctionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FunctionsFunction.__pulumiType, name, inputs, opts);
    }
}
