...
export class DevopsDeployment extends pulumi.CustomResource {
     ...
     */
    public readonly deployArtifactOverrideArguments!: pulumi.Output<outputs.DevopsDeploymentDeployArtifactOverrideArguments>;
    /**
     * List of all artifacts used in the pipeline.
     */
    public /*out*/ readonly deployPipelineArtifacts!: pulumi.Output<outputs.DevopsDeploymentDeployPipelineArtifacts>;
    /**
     * List of all environments used in the pipeline.
     */
    public /*out*/ readonly deployPipelineEnvironments!: pulumi.Output<outputs.DevopsDeploymentDeployPipelineEnvironments>;
    /**
     ...
     */
    public readonly deploymentArguments!: pulumi.Output<outputs.DevopsDeploymentDeploymentArguments>;
    /**
     * The execution progress details of a deployment.
     */
    public /*out*/ readonly deploymentExecutionProgress!: pulumi.Output<outputs.DevopsDeploymentDeploymentExecutionProgress>;
    /**
    ...
    constructor(name: string, argsOrState?: DevopsDeploymentArgs | DevopsDeploymentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["deployArtifactOverrideArguments"] = state ? state.deployArtifactOverrideArguments : undefined;
            inputs["deployPipelineArtifacts"] = state ? state.deployPipelineArtifacts : undefined;
            inputs["deployPipelineEnvironments"] = state ? state.deployPipelineEnvironments : undefined;
            inputs["deployPipelineId"] = state ? state.deployPipelineId : undefined;
            inputs["deployStageId"] = state ? state.deployStageId : undefined;
            inputs["deploymentArguments"] = state ? state.deploymentArguments : undefined;
            inputs["deploymentExecutionProgress"] = state ? state.deploymentExecutionProgress : undefined;
            ...
            inputs["previousDeploymentId"] = state ? state.previousDeploymentId : undefined;
            ...
            inputs["deployArtifactOverrideArguments"] = args ? args.deployArtifactOverrideArguments : undefined;
            inputs["deployPipelineId"] = args ? args.deployPipelineId : undefined;
            inputs["deployStageId"] = args ? args.deployStageId : undefined;
            inputs["deploymentArguments"] = args ? args.deploymentArguments : undefined;
            inputs["deploymentType"] = args ? args.deploymentType : undefined;
            inputs["displayName"] = args ? args.displayName : undefined;
            inputs["freeformTags"] = args ? args.freeformTags : undefined;
            inputs["previousDeploymentId"] = args ? args.previousDeploymentId : undefined;
            inputs["compartmentId"] = undefined /*out*/;
            inputs["deployPipelineArtifacts"] = undefined /*out*/;
            inputs["deployPipelineEnvironments"] = undefined /*out*/;
            inputs["deploymentExecutionProgress"] = undefined /*out*/;
        ...
        super(DevopsDeployment.__pulumiType, name, inputs, opts);
    }
}
...
export interface DevopsDeploymentState {
     ...
     * List of all artifacts used in the pipeline.
     */
    deployPipelineArtifacts?: pulumi.Input<inputs.DevopsDeploymentDeployPipelineArtifacts>;
    /**
     * List of all environments used in the pipeline.
     */
    deployPipelineEnvironments?: pulumi.Input<inputs.DevopsDeploymentDeployPipelineEnvironments>;
    /**
     * The OCID of a pipeline.
     */
     ...
     * The execution progress details of a deployment.
     */
    deploymentExecutionProgress?: pulumi.Input<inputs.DevopsDeploymentDeploymentExecutionProgress>;
    /**
     * (Updatable) Specifies type for this deployment.
     */
