 ...
 *
 * const testBackend = new oci.NetworkLoadBalancerBackend("testBackend", {
...
export class NetworkLoadBalancerBackend extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: NetworkLoadBalancerBackendArgs | NetworkLoadBalancerBackendState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["isBackup"] = state ? state.isBackup : undefined;
            inputs["isDrain"] = state ? state.isDrain : undefined;
            inputs["isOffline"] = state ? state.isOffline : undefined;
            ...
            inputs["isBackup"] = args ? args.isBackup : undefined;
            inputs["isDrain"] = args ? args.isDrain : undefined;
            inputs["isOffline"] = args ? args.isOffline : undefined;
        ...
        super(NetworkLoadBalancerBackend.__pulumiType, name, inputs, opts);
    }
}
