 ...
 *
 * const testCpe = new oci.CoreCpe("testCpe", {
...
export class CoreCpe extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreCpeArgs | CoreCpeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["cpeDeviceShapeId"] = state ? state.cpeDeviceShapeId : undefined;
            ...
            inputs["cpeDeviceShapeId"] = args ? args.cpeDeviceShapeId : undefined;
        ...
        super(CoreCpe.__pulumiType, name, inputs, opts);
    }
}
