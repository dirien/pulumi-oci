 ...
 *
 * const testGateway = new oci.ApigatewayGateway("testGateway", {
...
export class ApigatewayGateway extends pulumi.CustomResource {
     ...
     */
    public readonly responseCacheDetails!: pulumi.Output<outputs.ApigatewayGatewayResponseCacheDetails>;
    /**
    ...
    constructor(name: string, argsOrState?: ApigatewayGatewayArgs | ApigatewayGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApigatewayGateway.__pulumiType, name, inputs, opts);
    }
}
