 ...
 *
 * const testServiceConnector = new oci.SchServiceConnector("testServiceConnector", {
...
export class SchServiceConnector extends pulumi.CustomResource {
     ...
     */
    public readonly tasks!: pulumi.Output<outputs.SchServiceConnectorTask[]>;
    /**
    ...
    constructor(name: string, argsOrState?: SchServiceConnectorArgs | SchServiceConnectorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SchServiceConnector.__pulumiType, name, inputs, opts);
    }
}
