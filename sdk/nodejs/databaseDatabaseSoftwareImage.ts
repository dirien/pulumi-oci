 ...
 *
 * const testDatabaseSoftwareImage = new oci.DatabaseDatabaseSoftwareImage("testDatabaseSoftwareImage", {
...
export class DatabaseDatabaseSoftwareImage extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: DatabaseDatabaseSoftwareImageArgs | DatabaseDatabaseSoftwareImageState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseDatabaseSoftwareImage.__pulumiType, name, inputs, opts);
    }
}
