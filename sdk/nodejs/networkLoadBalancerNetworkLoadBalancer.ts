 ...
 *
 * const testNetworkLoadBalancer = new oci.NetworkLoadBalancerNetworkLoadBalancer("testNetworkLoadBalancer", {
...
export class NetworkLoadBalancerNetworkLoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly reservedIps!: pulumi.Output<outputs.NetworkLoadBalancerNetworkLoadBalancerReservedIp[]>;
    /**
    ...
    constructor(name: string, argsOrState?: NetworkLoadBalancerNetworkLoadBalancerArgs | NetworkLoadBalancerNetworkLoadBalancerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["isPreserveSourceDestination"] = state ? state.isPreserveSourceDestination : undefined;
            ...
            inputs["isPreserveSourceDestination"] = args ? args.isPreserveSourceDestination : undefined;
        ...
        super(NetworkLoadBalancerNetworkLoadBalancer.__pulumiType, name, inputs, opts);
    }
}
