 ...
 *
 * const testPluggableDatabasesRemoteClone = new oci.DatabasePluggableDatabasesRemoteClone("testPluggableDatabasesRemoteClone", {
...
export class DatabasePluggableDatabasesRemoteClone extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectionStrings!: pulumi.Output<outputs.DatabasePluggableDatabasesRemoteCloneConnectionStrings>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabasePluggableDatabasesRemoteCloneArgs | DatabasePluggableDatabasesRemoteCloneState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["sourceContainerDbAdminPassword"] = state ? state.sourceContainerDbAdminPassword : undefined;
            inputs["state"] = state ? state.state : undefined;
            inputs["targetContainerDatabaseId"] = state ? state.targetContainerDatabaseId : undefined;
            ...
            inputs["sourceContainerDbAdminPassword"] = args ? args.sourceContainerDbAdminPassword : undefined;
            inputs["targetContainerDatabaseId"] = args ? args.targetContainerDatabaseId : undefined;
        ...
        super(DatabasePluggableDatabasesRemoteClone.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabasePluggableDatabasesRemoteCloneState {
     ...
     * Connection strings to connect to an Oracle Pluggable Database.
     */
    connectionStrings?: pulumi.Input<inputs.DatabasePluggableDatabasesRemoteCloneConnectionStrings>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
     */
