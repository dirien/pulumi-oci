...
export class DeployPipeline extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly deployPipelineArtifacts!: pulumi.Output<outputs.devops.DeployPipelineDeployPipelineArtifacts>;
    /**
     * List of all environments used in the pipeline.
     */
    public /*out*/ readonly deployPipelineEnvironments!: pulumi.Output<outputs.devops.DeployPipelineDeployPipelineEnvironments>;
    /**
    ...
    constructor(name: string, argsOrState?: DeployPipelineArgs | DeployPipelineState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DeployPipeline.__pulumiType, name, inputs, opts);
    }
}
...
export interface DeployPipelineState {
     ...
     * List of all artifacts used in the pipeline.
     */
    deployPipelineArtifacts?: pulumi.Input<inputs.devops.DeployPipelineDeployPipelineArtifacts>;
    /**
     * List of all environments used in the pipeline.
     */
    deployPipelineEnvironments?: pulumi.Input<inputs.devops.DeployPipelineDeployPipelineEnvironments>;
    /**
     * (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
     */
