 ...
 *
 * const testListener = new oci.LoadBalancerListener("testListener", {
...
export class LoadBalancerListener extends pulumi.CustomResource {
     ...
     */
    public readonly connectionConfiguration!: pulumi.Output<outputs.LoadBalancerListenerConnectionConfiguration>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadBalancerListenerArgs | LoadBalancerListenerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoadBalancerListener.__pulumiType, name, inputs, opts);
    }
}
