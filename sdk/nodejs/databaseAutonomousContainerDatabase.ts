 ...
 *
 * const testAutonomousContainerDatabase = new oci.DatabaseAutonomousContainerDatabase("testAutonomousContainerDatabase", {
...
export class DatabaseAutonomousContainerDatabase extends pulumi.CustomResource {
     ...
     */
    public readonly backupConfig!: pulumi.Output<outputs.DatabaseAutonomousContainerDatabaseBackupConfig>;
    /**
     ...
     */
    public /*out*/ readonly maintenanceWindow!: pulumi.Output<outputs.DatabaseAutonomousContainerDatabaseMaintenanceWindow>;
    /**
    ...
    public readonly peerAutonomousContainerDatabaseBackupConfig!: pulumi.Output<outputs.DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseAutonomousContainerDatabaseArgs | DatabaseAutonomousContainerDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseAutonomousContainerDatabase.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabaseAutonomousContainerDatabaseState {
     ...
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    maintenanceWindow?: pulumi.Input<inputs.DatabaseAutonomousContainerDatabaseMaintenanceWindow>;
    /**
     * (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
