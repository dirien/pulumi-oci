 ...
 *
 * const testLogAnalyticsObjectCollectionRule = new oci.LogAnalyticsLogAnalyticsObjectCollectionRule("testLogAnalyticsObjectCollectionRule", {
...
export class LogAnalyticsLogAnalyticsObjectCollectionRule extends pulumi.CustomResource {
     ...
     */
    public readonly overrides!: pulumi.Output<outputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverride[]>;
    /**
    ...
    constructor(name: string, argsOrState?: LogAnalyticsLogAnalyticsObjectCollectionRuleArgs | LogAnalyticsLogAnalyticsObjectCollectionRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LogAnalyticsLogAnalyticsObjectCollectionRule.__pulumiType, name, inputs, opts);
    }
}
