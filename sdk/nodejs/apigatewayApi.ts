 ...
 *
 * const testApi = new oci.ApigatewayApi("testApi", {
...
export class ApigatewayApi extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ApigatewayApiArgs | ApigatewayApiState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["validationResults"] = state ? state.validationResults : undefined;
        } else {
            ...
            inputs["specificationType"] = undefined /*out*/;
        ...
        super(ApigatewayApi.__pulumiType, name, inputs, opts);
    }
}
