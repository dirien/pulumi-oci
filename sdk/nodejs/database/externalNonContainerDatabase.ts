...
export class ExternalNonContainerDatabase extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly databaseManagementConfig!: pulumi.Output<outputs.database.ExternalNonContainerDatabaseDatabaseManagementConfig>;
    /**
     ...
     */
    public /*out*/ readonly operationsInsightsConfig!: pulumi.Output<outputs.database.ExternalNonContainerDatabaseOperationsInsightsConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: ExternalNonContainerDatabaseArgs | ExternalNonContainerDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ExternalNonContainerDatabase.__pulumiType, name, inputs, opts);
    }
}
...
export interface ExternalNonContainerDatabaseState {
     ...
     * The configuration of the Database Management service.
     */
    databaseManagementConfig?: pulumi.Input<inputs.database.ExternalNonContainerDatabaseDatabaseManagementConfig>;
    /**
     * The Oracle Database version.
     */
     ...
     * The configuration of Operations Insights for the external database
     */
    operationsInsightsConfig?: pulumi.Input<inputs.database.ExternalNonContainerDatabaseOperationsInsightsConfig>;
    /**
     * The current state of the Oracle Cloud Infrastructure external database resource.
     */
