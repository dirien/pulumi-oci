 ...
 *
 * const testMigration = new oci.database.Migration("testMigration", {dbSystemId: oci_database_db_system.test_db_system.id});
 * ```
 *
 * ## Import
 *
...
export class Migration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'oci:database/migration:Migration';
     ...
     */
    public /*out*/ readonly additionalMigrations!: pulumi.Output<outputs.database.MigrationAdditionalMigration[]>;
    /**
...
export interface MigrationState {
     ...
     * The details of addtional resources related to the migration.
     */
    additionalMigrations?: pulumi.Input<pulumi.Input<inputs.database.MigrationAdditionalMigration>[]>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Exadata infrastructure.
     */
