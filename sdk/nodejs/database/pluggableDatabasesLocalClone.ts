...
export class PluggableDatabasesLocalClone extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectionStrings!: pulumi.Output<outputs.database.PluggableDatabasesLocalCloneConnectionStrings>;
    /**
    ...
    constructor(name: string, argsOrState?: PluggableDatabasesLocalCloneArgs | PluggableDatabasesLocalCloneState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PluggableDatabasesLocalClone.__pulumiType, name, inputs, opts);
    }
}
...
export interface PluggableDatabasesLocalCloneState {
     ...
     * Connection strings to connect to an Oracle Pluggable Database.
     */
    connectionStrings?: pulumi.Input<inputs.database.PluggableDatabasesLocalCloneConnectionStrings>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
     */
