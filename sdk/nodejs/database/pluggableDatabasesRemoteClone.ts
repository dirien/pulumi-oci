...
export class PluggableDatabasesRemoteClone extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectionStrings!: pulumi.Output<outputs.database.PluggableDatabasesRemoteCloneConnectionStrings>;
    /**
    ...
    constructor(name: string, argsOrState?: PluggableDatabasesRemoteCloneArgs | PluggableDatabasesRemoteCloneState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PluggableDatabasesRemoteClone.__pulumiType, name, inputs, opts);
    }
}
...
export interface PluggableDatabasesRemoteCloneState {
     ...
     * Connection strings to connect to an Oracle Pluggable Database.
     */
    connectionStrings?: pulumi.Input<inputs.database.PluggableDatabasesRemoteCloneConnectionStrings>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
     */
