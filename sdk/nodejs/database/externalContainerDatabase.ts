...
export class ExternalContainerDatabase extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly databaseManagementConfig!: pulumi.Output<outputs.database.ExternalContainerDatabaseDatabaseManagementConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: ExternalContainerDatabaseArgs | ExternalContainerDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ExternalContainerDatabase.__pulumiType, name, inputs, opts);
    }
}
...
export interface ExternalContainerDatabaseState {
     ...
     * The configuration of the Database Management service.
     */
    databaseManagementConfig?: pulumi.Input<inputs.database.ExternalContainerDatabaseDatabaseManagementConfig>;
    /**
     * The Oracle Database version.
     */
