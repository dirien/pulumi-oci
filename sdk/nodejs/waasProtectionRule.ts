 ...
 *
 * const testProtectionRule = new oci.WaasProtectionRule("testProtectionRule", {
...
export class WaasProtectionRule extends pulumi.CustomResource {
     ...
     */
    public readonly exclusions!: pulumi.Output<outputs.WaasProtectionRuleExclusion[]>;
    /**
    ...
    constructor(name: string, argsOrState?: WaasProtectionRuleArgs | WaasProtectionRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WaasProtectionRule.__pulumiType, name, inputs, opts);
    }
}
