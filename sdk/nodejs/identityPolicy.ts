 ...
 *
 * const testPolicy = new oci.IdentityPolicy("testPolicy", {
...
export class IdentityPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: IdentityPolicyArgs | IdentityPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["lastUpdateETag"] = state ? state.lastUpdateETag : undefined;
            inputs["name"] = state ? state.name : undefined;
            inputs["policyHash"] = state ? state.policyHash : undefined;
            inputs["state"] = state ? state.state : undefined;
            inputs["statements"] = state ? state.statements : undefined;
            inputs["timeCreated"] = state ? state.timeCreated : undefined;
            inputs["versionDate"] = state ? state.versionDate : undefined;
        } else {
            ...
            inputs["versionDate"] = args ? args.versionDate : undefined;
            inputs["ETag"] = undefined /*out*/;
            inputs["inactiveState"] = undefined /*out*/;
            inputs["lastUpdateETag"] = undefined /*out*/;
            inputs["policyHash"] = undefined /*out*/;
