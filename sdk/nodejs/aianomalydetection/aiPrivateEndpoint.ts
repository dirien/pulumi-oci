...
export class AiPrivateEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: AiPrivateEndpointArgs | AiPrivateEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["attachedDataAssets"] = state ? state.attachedDataAssets : undefined;
            ...
            inputs["attachedDataAssets"] = undefined /*out*/;
        ...
        super(AiPrivateEndpoint.__pulumiType, name, inputs, opts);
    }
}
