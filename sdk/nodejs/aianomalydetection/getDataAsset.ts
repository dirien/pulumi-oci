 ...
 *
 * const testDataAsset = oci.aianomalydetection.getDataAsset({
...
export function getDataAsset(args: GetDataAssetArgs, opts?: pulumi.InvokeOptions): Promise<GetDataAssetResult> {
    ...
    return pulumi.runtime.invoke("oci:aianomalydetection/getDataAsset:getDataAsset", {
...
export interface GetDataAssetResult {
     ...
     */
    readonly dataSourceDetails: outputs.aianomalydetection.GetDataAssetDataSourceDetails;
    /**
