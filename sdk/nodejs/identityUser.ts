 ...
 *
 * const testUser = new oci.IdentityUser("testUser", {
...
export class IdentityUser extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly capabilities!: pulumi.Output<outputs.IdentityUserCapabilities>;
    /**
    ...
    constructor(name: string, argsOrState?: IdentityUserArgs | IdentityUserState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["externalIdentifier"] = state ? state.externalIdentifier : undefined;
            ...
            inputs["lastSuccessfulLoginTime"] = state ? state.lastSuccessfulLoginTime : undefined;
            inputs["name"] = state ? state.name : undefined;
            inputs["previousSuccessfulLoginTime"] = state ? state.previousSuccessfulLoginTime : undefined;
            ...
            inputs["emailVerified"] = undefined /*out*/;
            inputs["externalIdentifier"] = undefined /*out*/;
            inputs["identityProviderId"] = undefined /*out*/;
            inputs["inactiveState"] = undefined /*out*/;
            inputs["lastSuccessfulLoginTime"] = undefined /*out*/;
            inputs["previousSuccessfulLoginTime"] = undefined /*out*/;
        ...
        super(IdentityUser.__pulumiType, name, inputs, opts);
    }
}
...
export interface IdentityUserState {
     ...
     * Properties indicating how the user is allowed to authenticate.
     */
    capabilities?: pulumi.Input<inputs.IdentityUserCapabilities>;
    /**
     * The OCID of the tenancy containing the user.
     */
