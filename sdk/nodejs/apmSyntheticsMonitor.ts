 ...
 *
 * const testMonitor = new oci.ApmSyntheticsMonitor("testMonitor", {
...
export class ApmSyntheticsMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.ApmSyntheticsMonitorConfiguration>;
    /**
     ...
     */
    public readonly scriptParameters!: pulumi.Output<outputs.ApmSyntheticsMonitorScriptParameter[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ApmSyntheticsMonitorArgs | ApmSyntheticsMonitorState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApmSyntheticsMonitor.__pulumiType, name, inputs, opts);
    }
}
