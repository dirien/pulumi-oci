...
export class PrivateApplication extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly logo!: pulumi.Output<outputs.servicecatalog.PrivateApplicationLogo>;
    /**
    ...
    constructor(name: string, argsOrState?: PrivateApplicationArgs | PrivateApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(PrivateApplication.__pulumiType, name, inputs, opts);
    }
}
...
export interface PrivateApplicationState {
     ...
     * The model for uploaded binary data, like logos and images.
     */
    logo?: pulumi.Input<inputs.servicecatalog.PrivateApplicationLogo>;
    /**
     * (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
     */
