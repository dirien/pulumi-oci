 ...
 *
 * const testWaasPolicy = new oci.WaasWaasPolicy("testWaasPolicy", {
...
export class WaasWaasPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly originGroups!: pulumi.Output<outputs.WaasWaasPolicyOriginGroup[]>;
    /**
     ...
     */
    public readonly origins!: pulumi.Output<outputs.WaasWaasPolicyOrigin[]>;
    /**
     * (Updatable) The configuration details for the WAAS policy.
     */
    public readonly policyConfig!: pulumi.Output<outputs.WaasWaasPolicyPolicyConfig>;
    /**
     ...
     */
    public readonly wafConfig!: pulumi.Output<outputs.WaasWaasPolicyWafConfig>;
    ...
    constructor(name: string, argsOrState?: WaasWaasPolicyArgs | WaasWaasPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(WaasWaasPolicy.__pulumiType, name, inputs, opts);
    }
}
