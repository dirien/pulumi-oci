 ...
 *
 * const testZone = new oci.DnsZone("testZone", {
...
export class DnsZone extends pulumi.CustomResource {
     ...
     */
    public readonly externalMasters!: pulumi.Output<outputs.DnsZoneExternalMaster[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DnsZoneArgs | DnsZoneState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["externalMasters"] = state ? state.externalMasters : undefined;
            ...
            inputs["externalMasters"] = args ? args.externalMasters : undefined;
