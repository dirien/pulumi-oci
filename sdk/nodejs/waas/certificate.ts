...
export class Certificate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly issuerName!: pulumi.Output<outputs.waas.CertificateIssuerName>;
    /**
     ...
     */
    public /*out*/ readonly publicKeyInfo!: pulumi.Output<outputs.waas.CertificatePublicKeyInfo>;
    /**
     ...
     */
    public /*out*/ readonly subjectName!: pulumi.Output<outputs.waas.CertificateSubjectName>;
    /**
...
export interface CertificateState {
     ...
     * The issuer of the certificate.
     */
    issuerName?: pulumi.Input<inputs.waas.CertificateIssuerName>;
    /**
     * The private key of the SSL certificate.
     */
     ...
     * Information about the public key and the algorithm used by the public key.
     */
    publicKeyInfo?: pulumi.Input<inputs.waas.CertificatePublicKeyInfo>;
    /**
     * A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
     */
     ...
     * The entity to be secured by the certificate.
     */
    subjectName?: pulumi.Input<inputs.waas.CertificateSubjectName>;
    /**
     * The date and time the certificate was created, expressed in RFC 3339 timestamp format.
     */
