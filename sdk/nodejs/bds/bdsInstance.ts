 ...
 *
 * const testBdsInstance = new oci.bds.BdsInstance("testBdsInstance", {
...
export class BdsInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'oci:bds/bdsInstance:BdsInstance';
     ...
     */
    public readonly cloudSqlDetails!: pulumi.Output<outputs.bds.BdsInstanceCloudSqlDetails>;
    /**
     ...
     */
    public /*out*/ readonly clusterDetails!: pulumi.Output<outputs.bds.BdsInstanceClusterDetails>;
    /**
    ...
    public readonly masterNode!: pulumi.Output<outputs.bds.BdsInstanceMasterNode>;
    /**
     * Additional configuration of the user's network.
     */
    public readonly networkConfig!: pulumi.Output<outputs.bds.BdsInstanceNetworkConfig>;
    /**
     * The list of nodes in the Big Data Service cluster.
     */
    public /*out*/ readonly nodes!: pulumi.Output<outputs.bds.BdsInstanceNode[]>;
    /**
    ...
    public readonly utilNode!: pulumi.Output<outputs.bds.BdsInstanceUtilNode>;
    public readonly workerNode!: pulumi.Output<outputs.bds.BdsInstanceWorkerNode>;
    ...
    constructor(name: string, argsOrState?: BdsInstanceArgs | BdsInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["cloudSqlDetails"] = state ? state.cloudSqlDetails : undefined;
            inputs["clusterAdminPassword"] = state ? state.clusterAdminPassword : undefined;
            inputs["clusterDetails"] = state ? state.clusterDetails : undefined;
            ...
            inputs["isCloudSqlConfigured"] = state ? state.isCloudSqlConfigured : undefined;
            inputs["isHighAvailability"] = state ? state.isHighAvailability : undefined;
            inputs["isSecure"] = state ? state.isSecure : undefined;
            inputs["masterNode"] = state ? state.masterNode : undefined;
            ...
            inputs["utilNode"] = state ? state.utilNode : undefined;
            inputs["workerNode"] = state ? state.workerNode : undefined;
        } else {
            ...
            inputs["cloudSqlDetails"] = args ? args.cloudSqlDetails : undefined;
            ...
            inputs["isCloudSqlConfigured"] = args ? args.isCloudSqlConfigured : undefined;
            inputs["isHighAvailability"] = args ? args.isHighAvailability : undefined;
            inputs["isSecure"] = args ? args.isSecure : undefined;
            inputs["masterNode"] = args ? args.masterNode : undefined;
            inputs["networkConfig"] = args ? args.networkConfig : undefined;
            inputs["utilNode"] = args ? args.utilNode : undefined;
            inputs["workerNode"] = args ? args.workerNode : undefined;
            inputs["clusterDetails"] = undefined /*out*/;
        ...
        super(BdsInstance.__pulumiType, name, inputs, opts);
    }
}
...
export interface BdsInstanceState {
     ...
     * The information about added Cloud SQL capability
     */
    cloudSqlDetails?: pulumi.Input<inputs.bds.BdsInstanceCloudSqlDetails>;
    /**
     * Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
     */
     ...
     * Specific info about a Hadoop cluster
     */
    clusterDetails?: pulumi.Input<inputs.bds.BdsInstanceClusterDetails>;
    /**
     * The SSH public key used to authenticate the cluster connection.
     */
    ...
    masterNode?: pulumi.Input<inputs.bds.BdsInstanceMasterNode>;
    /**
     * Additional configuration of the user's network.
     */
    networkConfig?: pulumi.Input<inputs.bds.BdsInstanceNetworkConfig>;
    /**
     * The list of nodes in the Big Data Service cluster.
     */
    nodes?: pulumi.Input<pulumi.Input<inputs.bds.BdsInstanceNode>[]>;
    /**
     * The number of nodes that form the cluster.
     */
    ...
    utilNode?: pulumi.Input<inputs.bds.BdsInstanceUtilNode>;
    workerNode?: pulumi.Input<inputs.bds.BdsInstanceWorkerNode>;
}
