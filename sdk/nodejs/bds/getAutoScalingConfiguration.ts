 ...
 *
 * const testAutoScalingConfiguration = oci.bds.getAutoScalingConfiguration({
...
export function getAutoScalingConfiguration(args: GetAutoScalingConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetAutoScalingConfigurationResult> {
    ...
    return pulumi.runtime.invoke("oci:bds/getAutoScalingConfiguration:getAutoScalingConfiguration", {
...
export interface GetAutoScalingConfigurationResult {
     ...
     */
    readonly policy: outputs.bds.GetAutoScalingConfigurationPolicy;
    /**
