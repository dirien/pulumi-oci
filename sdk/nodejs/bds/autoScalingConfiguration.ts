 ...
 *
 * const testAutoScalingConfiguration = new oci.bds.AutoScalingConfiguration("testAutoScalingConfiguration", {
...
export class AutoScalingConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'oci:bds/autoScalingConfiguration:AutoScalingConfiguration';
     ...
     */
    public readonly policy!: pulumi.Output<outputs.bds.AutoScalingConfigurationPolicy>;
    /**
...
export interface AutoScalingConfigurationState {
     ...
     * (Updatable) Policy definitions for the autoscale configuration.
     */
    policy?: pulumi.Input<inputs.bds.AutoScalingConfigurationPolicy>;
    /**
     * The state of the autoscale configuration.
     */
