...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly endpoints!: pulumi.Output<outputs.containerengine.ClusterEndpoints>;
    /**
     ...
     */
    public /*out*/ readonly metadata!: pulumi.Output<outputs.containerengine.ClusterMetadata>;
    /**
...
export interface ClusterState {
     ...
     * Endpoints served up by the cluster masters.
     */
    endpoints?: pulumi.Input<inputs.containerengine.ClusterEndpoints>;
    /**
     * (Updatable) The image verification policy for signature validation. Once a policy is created and enabled with one or more kms keys, the policy will ensure all images deployed has been signed with the key(s) attached to the policy.
     */
     ...
     * Metadata about the cluster.
     */
    metadata?: pulumi.Input<inputs.containerengine.ClusterMetadata>;
    /**
     * (Updatable) The name of the cluster. Avoid entering confidential information.
     */
