...
export class NodePool extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly nodeSource!: pulumi.Output<outputs.containerengine.NodePoolNodeSource>;
    /**
...
export interface NodePoolState {
     ...
     * Deprecated. see `nodeSourceDetails`. Source running on the nodes in the node pool.
     */
    nodeSource?: pulumi.Input<inputs.containerengine.NodePoolNodeSource>;
    /**
     * (Updatable) Specify the source to use to launch nodes in the node pool. Currently, image is the only supported source.
     */
