 ...
 *
 * const testAppCatalogSubscription = new oci.CoreAppCatalogSubscription("testAppCatalogSubscription", {
...
export class CoreAppCatalogSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreAppCatalogSubscriptionArgs | CoreAppCatalogSubscriptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CoreAppCatalogSubscription.__pulumiType, name, inputs, opts);
    }
}
