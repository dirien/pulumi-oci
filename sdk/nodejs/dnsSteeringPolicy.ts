 ...
 *
 * const testSteeringPolicy = new oci.DnsSteeringPolicy("testSteeringPolicy", {
...
export class DnsSteeringPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly answers!: pulumi.Output<outputs.DnsSteeringPolicyAnswer[]>;
    /**
     ...
     */
    public readonly rules!: pulumi.Output<outputs.DnsSteeringPolicyRule[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DnsSteeringPolicyArgs | DnsSteeringPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DnsSteeringPolicy.__pulumiType, name, inputs, opts);
    }
}
