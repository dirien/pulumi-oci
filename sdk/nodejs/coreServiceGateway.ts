 ...
 *
 * const testServiceGateway = new oci.CoreServiceGateway("testServiceGateway", {
...
export class CoreServiceGateway extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreServiceGatewayArgs | CoreServiceGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["blockTraffic"] = undefined /*out*/;
        ...
        super(CoreServiceGateway.__pulumiType, name, inputs, opts);
    }
}
