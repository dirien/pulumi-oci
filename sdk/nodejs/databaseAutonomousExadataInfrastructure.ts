 ...
 *
 * const testAutonomousExadataInfrastructure = new oci.DatabaseAutonomousExadataInfrastructure("testAutonomousExadataInfrastructure", {
...
export class DatabaseAutonomousExadataInfrastructure extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly maintenanceWindow!: pulumi.Output<outputs.DatabaseAutonomousExadataInfrastructureMaintenanceWindow>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseAutonomousExadataInfrastructureArgs | DatabaseAutonomousExadataInfrastructureState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseAutonomousExadataInfrastructure.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabaseAutonomousExadataInfrastructureState {
     ...
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    maintenanceWindow?: pulumi.Input<inputs.DatabaseAutonomousExadataInfrastructureMaintenanceWindow>;
    /**
     * (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
