 ...
 *
 * const testProfile = new oci.OptimizerProfile("testProfile", {
...
export class OptimizerProfile extends pulumi.CustomResource {
     ...
     */
    public readonly targetCompartments!: pulumi.Output<outputs.OptimizerProfileTargetCompartments>;
    /**
     * (Updatable) Optional. The target tags supported by a profile override for a recommendation.
     */
    public readonly targetTags!: pulumi.Output<outputs.OptimizerProfileTargetTags>;
    /**
    ...
    constructor(name: string, argsOrState?: OptimizerProfileArgs | OptimizerProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OptimizerProfile.__pulumiType, name, inputs, opts);
    }
}
