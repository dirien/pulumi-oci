 ...
 *
 * const testNamespace = new oci.LogAnalyticsNamespace("testNamespace", {
...
export class LogAnalyticsNamespace extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LogAnalyticsNamespaceArgs | LogAnalyticsNamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["isOnboarded"] = state ? state.isOnboarded : undefined;
            ...
            inputs["isOnboarded"] = args ? args.isOnboarded : undefined;
            inputs["namespace"] = args ? args.namespace : undefined;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(LogAnalyticsNamespace.__pulumiType, name, inputs, opts);
    }
}
