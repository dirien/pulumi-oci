 ...
 *
 * const testApplication = new oci.DataflowApplication("testApplication", {
...
export class DataflowApplication extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.DataflowApplicationParameter[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DataflowApplicationArgs | DataflowApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["fileUri"] = args ? args.fileUri : undefined;
            ...
            inputs["privateEndpointId"] = args ? args.privateEndpointId : undefined;
        ...
        super(DataflowApplication.__pulumiType, name, inputs, opts);
    }
}
