...
export interface GetInstanceResult {
     ...
     */
    readonly agentConfig: outputs.core.GetInstanceAgentConfig;
    /**
     * Options for defining the availabiity of a VM instance after a maintenance event that impacts the underlying hardware.
     */
    readonly availabilityConfig: outputs.core.GetInstanceAvailabilityConfig;
    /**
    ...
    readonly createVnicDetails: outputs.core.GetInstanceCreateVnicDetails;
    /**
     ...
     */
    readonly instanceOptions: outputs.core.GetInstanceInstanceOptions;
    /**
     ...
     */
    readonly launchOptions: outputs.core.GetInstanceLaunchOptions;
    /**
     ...
     */
    readonly platformConfig: outputs.core.GetInstancePlatformConfig;
    /**
     * (Optional) Configuration options for preemptible instances.
     */
    readonly preemptibleInstanceConfig: outputs.core.GetInstancePreemptibleInstanceConfig;
    /**
     ...
     */
    readonly shapeConfig: outputs.core.GetInstanceShapeConfig;
    readonly sourceDetails: outputs.core.GetInstanceSourceDetails;
    /**
