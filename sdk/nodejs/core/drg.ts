...
export class Drg extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly defaultDrgRouteTables!: pulumi.Output<outputs.core.DrgDefaultDrgRouteTables>;
    /**
    ...
    constructor(name: string, argsOrState?: DrgArgs | DrgState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Drg.__pulumiType, name, inputs, opts);
    }
}
...
export interface DrgState {
     ...
     * The default DRG route table for this DRG. Each network type has a default DRG route table.
     */
    defaultDrgRouteTables?: pulumi.Input<inputs.core.DrgDefaultDrgRouteTables>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this DRG's default export route distribution for the DRG attachments.
     */
