 ...
 *
 * const testDrgRouteTable = oci.core.getDrgRouteTable({
 *     drgRouteTableId: oci_core_drg_route_table.test_drg_route_table.id,
 * });
 * ```
 */
export function getDrgRouteTable(args: GetDrgRouteTableArgs, opts?: pulumi.InvokeOptions): Promise<GetDrgRouteTableResult> {
    if (!opts) {
        opts = {}
    }
    ...
    return pulumi.runtime.invoke("oci:core/getDrgRouteTable:getDrgRouteTable", {
 ...
 */
export interface GetDrgRouteTableArgs {
    /**
 ...
 */
export interface GetDrgRouteTableResult {
    /**
