 ...
 *
 * const testVolumeBackup = new oci.CoreVolumeBackup("testVolumeBackup", {
...
export class CoreVolumeBackup extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreVolumeBackupArgs | CoreVolumeBackupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["sourceVolumeBackupId"] = state ? state.sourceVolumeBackupId : undefined;
            ...
            inputs["sourceVolumeBackupId"] = undefined /*out*/;
        ...
        super(CoreVolumeBackup.__pulumiType, name, inputs, opts);
    }
}
