 ...
 *
 * const testVault = oci.GetKmsVault({
...
export interface GetKmsVaultResult {
     ...
     */
    readonly replicaDetails: outputs.GetKmsVaultReplicaDetails;
    /**
     * Details where vault was backed up.
     */
    readonly restoreFromFile: outputs.GetKmsVaultRestoreFromFile;
    /**
     * Details where vault was backed up
     */
    readonly restoreFromObjectStore: outputs.GetKmsVaultRestoreFromObjectStore;
    /**
