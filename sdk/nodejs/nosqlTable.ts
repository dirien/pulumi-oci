 ...
 *
 * const testTable = new oci.NosqlTable("testTable", {
...
export class NosqlTable extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly schema!: pulumi.Output<outputs.NosqlTableSchema>;
    /**
     ...
     */
    public readonly tableLimits!: pulumi.Output<outputs.NosqlTableTableLimits>;
    /**
    ...
    constructor(name: string, argsOrState?: NosqlTableArgs | NosqlTableState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(NosqlTable.__pulumiType, name, inputs, opts);
    }
}
...
export interface NosqlTableState {
     ...
     * The table schema information as a JSON object.
     */
    schema?: pulumi.Input<inputs.NosqlTableSchema>;
    /**
     * The state of a table.
     */
