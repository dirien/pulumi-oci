...
export class DatabaseDbSystem extends pulumi.CustomResource {
     ...
     */
    public readonly dbSystemOptions!: pulumi.Output<outputs.DatabaseDbSystemDbSystemOptions>;
    /**
     ...
     */
    public /*out*/ readonly iormConfigCache!: pulumi.Output<outputs.DatabaseDbSystemIormConfigCache>;
    /**
     ...
     */
    public /*out*/ readonly maintenanceWindow!: pulumi.Output<outputs.DatabaseDbSystemMaintenanceWindow>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseDbSystemArgs | DatabaseDbSystemState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(DatabaseDbSystem.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabaseDbSystemState {
     ...
     * The IORM settings of the Exadata DB system.
     */
    iormConfigCache?: pulumi.Input<inputs.DatabaseDbSystemIormConfigCache>;
    /**
     * The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.
     */
     ...
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    maintenanceWindow?: pulumi.Input<inputs.DatabaseDbSystemMaintenanceWindow>;
    /**
     * (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
