 ...
 *
 * const testBucket = new oci.objectstorage.ObjectstorageBucket("testBucket", {
...
export class ObjectstorageBucket extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'oci:objectstorage/objectstorageBucket:ObjectstorageBucket';
     ...
     */
    public readonly retentionRules!: pulumi.Output<outputs.objectstorage.ObjectstorageBucketRetentionRule[] | undefined>;
    /**
...
export interface ObjectstorageBucketState {
     ...
     * (Updatable) Creates a new retention rule in the specified bucket. The new rule will take effect typically within 30 seconds. Note that a maximum of 100 rules are supported on a bucket.
     */
    retentionRules?: pulumi.Input<pulumi.Input<inputs.objectstorage.ObjectstorageBucketRetentionRule>[]>;
    /**
     * The type of storage tier of this bucket. A bucket is set to 'Standard' tier by default, which means the bucket will be put in the standard storage tier. When 'Archive' tier type is set explicitly, the bucket is put in the Archive Storage tier. The 'storageTier' property is immutable after bucket is created.
     */
