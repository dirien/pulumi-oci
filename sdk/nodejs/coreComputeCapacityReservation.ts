 ...
 *
 * const testComputeCapacityReservation = new oci.CoreComputeCapacityReservation("testComputeCapacityReservation", {
...
export class CoreComputeCapacityReservation extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CoreComputeCapacityReservationArgs | CoreComputeCapacityReservationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["instanceReservationConfigs"] = state ? state.instanceReservationConfigs : undefined;
            inputs["isDefaultReservation"] = state ? state.isDefaultReservation : undefined;
            inputs["reservedInstanceCount"] = state ? state.reservedInstanceCount : undefined;
            inputs["state"] = state ? state.state : undefined;
            inputs["timeCreated"] = state ? state.timeCreated : undefined;
            inputs["timeUpdated"] = state ? state.timeUpdated : undefined;
            inputs["usedInstanceCount"] = state ? state.usedInstanceCount : undefined;
        } else {
            ...
            inputs["instanceReservationConfigs"] = args ? args.instanceReservationConfigs : undefined;
            inputs["isDefaultReservation"] = args ? args.isDefaultReservation : undefined;
            inputs["reservedInstanceCount"] = undefined /*out*/;
            inputs["state"] = undefined /*out*/;
            inputs["timeCreated"] = undefined /*out*/;
            inputs["timeUpdated"] = undefined /*out*/;
            inputs["usedInstanceCount"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(CoreComputeCapacityReservation.__pulumiType, name, inputs, opts);
    }
}
