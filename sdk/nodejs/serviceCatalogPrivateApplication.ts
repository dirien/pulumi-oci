 ...
 *
 * const testPrivateApplication = new oci.ServiceCatalogPrivateApplication("testPrivateApplication", {
...
export class ServiceCatalogPrivateApplication extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly logo!: pulumi.Output<outputs.ServiceCatalogPrivateApplicationLogo>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceCatalogPrivateApplicationArgs | ServiceCatalogPrivateApplicationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["logoFileBase64encoded"] = state ? state.logoFileBase64encoded : undefined;
            ...
            inputs["logoFileBase64encoded"] = args ? args.logoFileBase64encoded : undefined;
        ...
        super(ServiceCatalogPrivateApplication.__pulumiType, name, inputs, opts);
    }
}
...
export interface ServiceCatalogPrivateApplicationState {
     ...
     * The model for uploaded binary data, like logos and images.
     */
    logo?: pulumi.Input<inputs.ServiceCatalogPrivateApplicationLogo>;
    /**
     * (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
     */
