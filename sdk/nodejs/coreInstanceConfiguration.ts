 ...
 *
 * const testInstanceConfiguration = new oci.CoreInstanceConfiguration("testInstanceConfiguration", {
...
export class CoreInstanceConfiguration extends pulumi.CustomResource {
    ...
    public readonly instanceDetails!: pulumi.Output<outputs.CoreInstanceConfigurationInstanceDetails>;
    /**
    ...
    constructor(name: string, argsOrState?: CoreInstanceConfigurationArgs | CoreInstanceConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["deferredFields"] = state ? state.deferredFields : undefined;
            inputs["definedTags"] = state ? state.definedTags : undefined;
            inputs["displayName"] = state ? state.displayName : undefined;
            inputs["freeformTags"] = state ? state.freeformTags : undefined;
            inputs["instanceDetails"] = state ? state.instanceDetails : undefined;
            ...
            inputs["instanceDetails"] = args ? args.instanceDetails : undefined;
            inputs["instanceId"] = args ? args.instanceId : undefined;
            inputs["source"] = args ? args.source : undefined;
            inputs["deferredFields"] = undefined /*out*/;
            inputs["timeCreated"] = undefined /*out*/;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(CoreInstanceConfiguration.__pulumiType, name, inputs, opts);
    }
}
