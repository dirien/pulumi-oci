 ...
 *
 * const testPrivateIp = new oci.CorePrivateIp("testPrivateIp", {
 *     definedTags: {
...
export class CorePrivateIp extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: CorePrivateIpArgs | CorePrivateIpState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["isReserved"] = state ? state.isReserved : undefined;
        ...
        super(CorePrivateIp.__pulumiType, name, inputs, opts);
    }
}
