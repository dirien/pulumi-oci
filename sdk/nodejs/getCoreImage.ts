 ...
 *
 * const testImage = oci.GetCoreImage({
...
export interface GetCoreImageResult {
     ...
     */
    readonly agentFeatures: outputs.GetCoreImageAgentFeatures;
    /**
    ...
    readonly imageSourceDetails: outputs.GetCoreImageImageSourceDetails;
     ...
     */
    readonly launchOptions: outputs.GetCoreImageLaunchOptions;
    /**
