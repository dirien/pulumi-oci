 ...
 *
 * const testHttpRedirect = new oci.WaasHttpRedirect("testHttpRedirect", {
...
export class WaasHttpRedirect extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: WaasHttpRedirectArgs | WaasHttpRedirectState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["responseCode"] = state ? state.responseCode : undefined;
            ...
            inputs["responseCode"] = args ? args.responseCode : undefined;
        ...
        super(WaasHttpRedirect.__pulumiType, name, inputs, opts);
    }
}
