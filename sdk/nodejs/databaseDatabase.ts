 ...
 *
 * const testDatabase = new oci.DatabaseDatabase("testDatabase", {
 *     database: {
...
export class DatabaseDatabase extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectionStrings!: pulumi.Output<outputs.DatabaseDatabaseConnectionStrings>;
    /**
     ...
     */
    public /*out*/ readonly dbBackupConfig!: pulumi.Output<outputs.DatabaseDatabaseDbBackupConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: DatabaseDatabaseArgs | DatabaseDatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["kmsKeyMigration"] = state ? state.kmsKeyMigration : undefined;
            inputs["kmsKeyRotation"] = state ? state.kmsKeyRotation : undefined;
            ...
            inputs["dbHomeId"] = args ? args.dbHomeId : undefined;
            inputs["dbVersion"] = args ? args.dbVersion : undefined;
            inputs["kmsKeyId"] = args ? args.kmsKeyId : undefined;
            inputs["kmsKeyMigration"] = args ? args.kmsKeyMigration : undefined;
            inputs["kmsKeyRotation"] = args ? args.kmsKeyRotation : undefined;
        ...
        super(DatabaseDatabase.__pulumiType, name, inputs, opts);
    }
}
...
export interface DatabaseDatabaseState {
     ...
     * The Connection strings used to connect to the Oracle Database.
     */
    connectionStrings?: pulumi.Input<inputs.DatabaseDatabaseConnectionStrings>;
    /**
     * (Updatable) Details for creating a database.
     */
     ...
     * (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
     */
    dbBackupConfig?: pulumi.Input<inputs.DatabaseDatabaseDbBackupConfig>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
     */
