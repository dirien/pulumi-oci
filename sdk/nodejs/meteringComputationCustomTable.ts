 ...
 *
 * const testCustomTable = new oci.MeteringComputationCustomTable("testCustomTable", {
...
export class MeteringComputationCustomTable extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: MeteringComputationCustomTableArgs | MeteringComputationCustomTableState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["savedCustomTable"] = state ? state.savedCustomTable : undefined;
            inputs["savedReportId"] = state ? state.savedReportId : undefined;
        } else {
            ...
            inputs["savedCustomTable"] = args ? args.savedCustomTable : undefined;
            inputs["savedReportId"] = args ? args.savedReportId : undefined;
        }
        if (!opts.version) {
            opts = pulumi.mergeOptions(opts, { version: utilities.getVersion()});
        }
        super(MeteringComputationCustomTable.__pulumiType, name, inputs, opts);
    }
}
