...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVcn = new Oci.CoreVcn("testVcn", new Oci.CoreVcnArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreVcn:CoreVcn")]
    public partial class CoreVcn : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreVcn(string name, CoreVcnArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreVcn:CoreVcn", name, args ?? new CoreVcnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreVcn(string name, Input<string> id, CoreVcnState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreVcn:CoreVcn", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreVcn Get(string name, Input<string> id, CoreVcnState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreVcn(name, id, state, options);
        }
    }

    public sealed class CoreVcnArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// **Deprecated.** Do *not* set this value. Use `cidrBlocks` instead. Example: `10.0.0.0/16`
        /// </summary>
    ...
    public sealed class CoreVcnState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// **Deprecated.** Do *not* set this value. Use `cidrBlocks` instead. Example: `10.0.0.0/16`
        /// </summary>
