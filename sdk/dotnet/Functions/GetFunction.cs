...
namespace Pulumi.Oci.Functions
{
    public static class GetFunction
    {
        ...
        public static Task<GetFunctionResult> InvokeAsync(GetFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFunctionResult>("oci:functions/getFunction:getFunction", args ?? new GetFunctionArgs(), options.WithVersion());
    }
    ...
    public sealed class GetFunctionResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetFunctionTraceConfigResult TraceConfig;
        ...
        private GetFunctionResult(
            ...
            Outputs.GetFunctionTraceConfigResult traceConfig)
        {
