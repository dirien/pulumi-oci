...
namespace Pulumi.Oci.Identity
{
    public static class GetCompartment
    {
        ...
        public static Task<GetCompartmentResult> InvokeAsync(GetCompartmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCompartmentResult>("oci:identity/getCompartment:getCompartment", args ?? new GetCompartmentArgs(), options.WithVersion());
    }
