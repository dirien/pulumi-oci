...
namespace Pulumi.Oci.Identity
{
    public static class GetTagNamespaces
    {
        ...
        public static Task<GetTagNamespacesResult> InvokeAsync(GetTagNamespacesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagNamespacesResult>("oci:identity/getTagNamespaces:getTagNamespaces", args ?? new GetTagNamespacesArgs(), options.WithVersion());
    }
