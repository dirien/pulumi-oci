...
namespace Pulumi.Oci.Identity
{
    public static class GetCostTrackingTags
    {
        ...
        public static Task<GetCostTrackingTagsResult> InvokeAsync(GetCostTrackingTagsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCostTrackingTagsResult>("oci:identity/getCostTrackingTags:getCostTrackingTags", args ?? new GetCostTrackingTagsArgs(), options.WithVersion());
    }
