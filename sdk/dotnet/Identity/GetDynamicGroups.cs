...
namespace Pulumi.Oci.Identity
{
    public static class GetDynamicGroups
    {
        ...
        public static Task<GetDynamicGroupsResult> InvokeAsync(GetDynamicGroupsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDynamicGroupsResult>("oci:identity/getDynamicGroups:getDynamicGroups", args ?? new GetDynamicGroupsArgs(), options.WithVersion());
    }
