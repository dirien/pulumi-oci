...
namespace Pulumi.Oci.Identity
{
    public static class GetFaultDomains
    {
        ...
        public static Task<GetFaultDomainsResult> InvokeAsync(GetFaultDomainsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFaultDomainsResult>("oci:identity/getFaultDomains:getFaultDomains", args ?? new GetFaultDomainsArgs(), options.WithVersion());
    }
