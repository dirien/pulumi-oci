...
namespace Pulumi.Oci.Identity
{
    public static class GetRegionSubscriptions
    {
        ...
        public static Task<GetRegionSubscriptionsResult> InvokeAsync(GetRegionSubscriptionsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRegionSubscriptionsResult>("oci:identity/getRegionSubscriptions:getRegionSubscriptions", args ?? new GetRegionSubscriptionsArgs(), options.WithVersion());
    }
