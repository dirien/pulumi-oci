...
namespace Pulumi.Oci.Identity
{
    public static class GetAvailabilityDomain
    {
        ...
        public static Task<GetAvailabilityDomainResult> InvokeAsync(GetAvailabilityDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAvailabilityDomainResult>("oci:identity/getAvailabilityDomain:getAvailabilityDomain", args ?? new GetAvailabilityDomainArgs(), options.WithVersion());
    }
