...
namespace Pulumi.Oci.Identity
{
    public static class GetCompartments
    {
        ...
        public static Task<GetCompartmentsResult> InvokeAsync(GetCompartmentsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCompartmentsResult>("oci:identity/getCompartments:getCompartments", args ?? new GetCompartmentsArgs(), options.WithVersion());
    }
