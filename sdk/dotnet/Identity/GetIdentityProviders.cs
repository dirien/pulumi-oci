...
namespace Pulumi.Oci.Identity
{
    public static class GetIdentityProviders
    {
        ...
        public static Task<GetIdentityProvidersResult> InvokeAsync(GetIdentityProvidersArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityProvidersResult>("oci:identity/getIdentityProviders:getIdentityProviders", args ?? new GetIdentityProvidersArgs(), options.WithVersion());
    }
