...
namespace Pulumi.Oci.Identity
{
    public static class GetTag
    {
        ...
        public static Task<GetTagResult> InvokeAsync(GetTagArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetTagResult>("oci:identity/getTag:getTag", args ?? new GetTagArgs(), options.WithVersion());
    }
    ...
    public sealed class GetTagResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetTagValidatorResult Validator;
        ...
        private GetTagResult(
            ...
            Outputs.GetTagValidatorResult validator)
        {
