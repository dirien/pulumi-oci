...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testIndex = new Oci.NosqlIndex("testIndex", new Oci.NosqlIndexArgs
    ///         {
    ///             Keys = 
    ///             {
    ///                 new Oci.Inputs.NosqlIndexKeyArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/nosqlIndex:NosqlIndex")]
    public partial class NosqlIndex : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("keys")]
        public Output<ImmutableArray<Outputs.NosqlIndexKey>> Keys { get; private set; } = null!;
        ...
        public NosqlIndex(string name, NosqlIndexArgs args, CustomResourceOptions? options = null)
            : base("oci:index/nosqlIndex:NosqlIndex", name, args ?? new NosqlIndexArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NosqlIndex(string name, Input<string> id, NosqlIndexState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/nosqlIndex:NosqlIndex", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NosqlIndex Get(string name, Input<string> id, NosqlIndexState? state = null, CustomResourceOptions? options = null)
        {
            return new NosqlIndex(name, id, state, options);
        }
    }

    public sealed class NosqlIndexArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the table's compartment.  Required if the tableNameOrId path parameter is a table name. Optional if tableNameOrId is an OCID.  If tableNameOrId is an OCID, and compartmentId is supplied, the latter must match the identified table's compartmentId.
        /// </summary>
        ...
        private InputList<Inputs.NosqlIndexKeyArgs>? _keys;

        /// <summary>
        /// A set of keys for a secondary index.
        /// </summary>
        public InputList<Inputs.NosqlIndexKeyArgs> Keys
        {
            get => _keys ?? (_keys = new InputList<Inputs.NosqlIndexKeyArgs>());
            set => _keys = value;
        }
        ...
        public NosqlIndexArgs()
        {
        }
    }

    public sealed class NosqlIndexState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the table's compartment.  Required if the tableNameOrId path parameter is a table name. Optional if tableNameOrId is an OCID.  If tableNameOrId is an OCID, and compartmentId is supplied, the latter must match the identified table's compartmentId.
        /// </summary>
        ...
        [Input("keys")]
        private InputList<Inputs.NosqlIndexKeyGetArgs>? _keys;

        /// <summary>
        /// A set of keys for a secondary index.
        /// </summary>
        public InputList<Inputs.NosqlIndexKeyGetArgs> Keys
        {
            get => _keys ?? (_keys = new InputList<Inputs.NosqlIndexKeyGetArgs>());
            set => _keys = value;
        }
