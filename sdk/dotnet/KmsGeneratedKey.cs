...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testGeneratedKey = new Oci.KmsGeneratedKey("testGeneratedKey", new Oci.KmsGeneratedKeyArgs
    ///         {
    ///             CryptoEndpoint = @var.Generated_key_crypto_endpoint,
    ///             IncludePlaintextKey = @var.Generated_key_include_plaintext_key,
    ///             KeyId = oci_kms_key.Test_key.Id,
    ///             KeyShape = new Oci.Inputs.KmsGeneratedKeyKeyShapeArgs
    ///             {
    ...
    /// </summary>
    [OciResourceType("oci:index/kmsGeneratedKey:KmsGeneratedKey")]
    public partial class KmsGeneratedKey : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("keyShape")]
        public Output<Outputs.KmsGeneratedKeyKeyShape> KeyShape { get; private set; } = null!;
        ...
        public KmsGeneratedKey(string name, KmsGeneratedKeyArgs args, CustomResourceOptions? options = null)
            : base("oci:index/kmsGeneratedKey:KmsGeneratedKey", name, args ?? new KmsGeneratedKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KmsGeneratedKey(string name, Input<string> id, KmsGeneratedKeyState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/kmsGeneratedKey:KmsGeneratedKey", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KmsGeneratedKey Get(string name, Input<string> id, KmsGeneratedKeyState? state = null, CustomResourceOptions? options = null)
        {
            return new KmsGeneratedKey(name, id, state, options);
        }
    }

    public sealed class KmsGeneratedKeyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.KmsGeneratedKeyKeyShapeArgs> KeyShape { get; set; } = null!;
        ...
        public KmsGeneratedKeyArgs()
        {
        }
    }

    public sealed class KmsGeneratedKeyState : Pulumi.ResourceArgs
    {
        [Input("associatedData")]
        private InputMap<object>? _associatedData;
        ...
        /// </summary>
        [Input("keyShape")]
        public Input<Inputs.KmsGeneratedKeyKeyShapeGetArgs>? KeyShape { get; set; }
