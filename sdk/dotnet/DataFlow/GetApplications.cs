...
namespace Pulumi.Oci.DataFlow
{
    public static class GetApplications
    {
        ...
        public static Task<GetApplicationsResult> InvokeAsync(GetApplicationsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApplicationsResult>("oci:dataflow/getApplications:getApplications", args ?? new GetApplicationsArgs(), options.WithVersion());
    }
