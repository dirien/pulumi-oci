...
namespace Pulumi.Oci.DataFlow
{
    public static class GetPrivateEndpoints
    {
        ...
        public static Task<GetPrivateEndpointsResult> InvokeAsync(GetPrivateEndpointsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateEndpointsResult>("oci:dataflow/getPrivateEndpoints:getPrivateEndpoints", args ?? new GetPrivateEndpointsArgs(), options.WithVersion());
    }
