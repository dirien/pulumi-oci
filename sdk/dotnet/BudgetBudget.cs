...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBudget = new Oci.BudgetBudget("testBudget", new Oci.BudgetBudgetArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/budgetBudget:BudgetBudget")]
    public partial class BudgetBudget : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public BudgetBudget(string name, BudgetBudgetArgs args, CustomResourceOptions? options = null)
            : base("oci:index/budgetBudget:BudgetBudget", name, args ?? new BudgetBudgetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetBudget(string name, Input<string> id, BudgetBudgetState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/budgetBudget:BudgetBudget", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BudgetBudget Get(string name, Input<string> id, BudgetBudgetState? state = null, CustomResourceOptions? options = null)
        {
            return new BudgetBudget(name, id, state, options);
        }
    }

    public sealed class BudgetBudgetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The amount of the budget expressed as a whole number in the currency of the customer's rate card.
        /// </summary>
        ...
        public BudgetBudgetArgs()
        {
        }
    }

    public sealed class BudgetBudgetState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The actual spend in currency for the current budget cycle
        /// </summary>
