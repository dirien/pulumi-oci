...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPrivateApplication = new Oci.ServiceCatalogPrivateApplication("testPrivateApplication", new Oci.ServiceCatalogPrivateApplicationArgs
    ///         {
    ///             CompartmentId = @var.Compartment_id,
    ///             DisplayName = @var.Private_application_display_name,
    ///             PackageDetails = new Oci.Inputs.ServiceCatalogPrivateApplicationPackageDetailsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/serviceCatalogPrivateApplication:ServiceCatalogPrivateApplication")]
    public partial class ServiceCatalogPrivateApplication : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("logo")]
        public Output<Outputs.ServiceCatalogPrivateApplicationLogo> Logo { get; private set; } = null!;
        ...
        public Output<Outputs.ServiceCatalogPrivateApplicationPackageDetails> PackageDetails { get; private set; } = null!;
        ...
        public ServiceCatalogPrivateApplication(string name, ServiceCatalogPrivateApplicationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/serviceCatalogPrivateApplication:ServiceCatalogPrivateApplication", name, args ?? new ServiceCatalogPrivateApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceCatalogPrivateApplication(string name, Input<string> id, ServiceCatalogPrivateApplicationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/serviceCatalogPrivateApplication:ServiceCatalogPrivateApplication", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceCatalogPrivateApplication Get(string name, Input<string> id, ServiceCatalogPrivateApplicationState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceCatalogPrivateApplication(name, id, state, options);
        }
    }

    public sealed class ServiceCatalogPrivateApplicationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the private application.
        /// </summary>
        ...
        public Input<Inputs.ServiceCatalogPrivateApplicationPackageDetailsArgs> PackageDetails { get; set; } = null!;
        ...
        public ServiceCatalogPrivateApplicationArgs()
        {
        }
    }

    public sealed class ServiceCatalogPrivateApplicationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the private application.
        /// </summary>
        ...
        /// </summary>
        [Input("logo")]
        public Input<Inputs.ServiceCatalogPrivateApplicationLogoGetArgs>? Logo { get; set; }
        ...
        public Input<Inputs.ServiceCatalogPrivateApplicationPackageDetailsGetArgs>? PackageDetails { get; set; }
        ...
        public ServiceCatalogPrivateApplicationState()
        {
        }
    }
}
