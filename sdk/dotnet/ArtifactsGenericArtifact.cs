...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testGenericArtifact = new Oci.ArtifactsGenericArtifact("testGenericArtifact", new Oci.ArtifactsGenericArtifactArgs
    ///         {
    ...
    /// </summary>
    [OciResourceType("oci:index/artifactsGenericArtifact:ArtifactsGenericArtifact")]
    public partial class ArtifactsGenericArtifact : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ArtifactsGenericArtifact(string name, ArtifactsGenericArtifactArgs args, CustomResourceOptions? options = null)
            : base("oci:index/artifactsGenericArtifact:ArtifactsGenericArtifact", name, args ?? new ArtifactsGenericArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactsGenericArtifact(string name, Input<string> id, ArtifactsGenericArtifactState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/artifactsGenericArtifact:ArtifactsGenericArtifact", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ArtifactsGenericArtifact Get(string name, Input<string> id, ArtifactsGenericArtifactState? state = null, CustomResourceOptions? options = null)
        {
            return new ArtifactsGenericArtifact(name, id, state, options);
        }
    }

    public sealed class ArtifactsGenericArtifactArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the artifact.  Example: `ocid1.genericartifact.oc1..exampleuniqueID`
        /// </summary>
        ...
        public ArtifactsGenericArtifactArgs()
        {
        }
    }

    public sealed class ArtifactsGenericArtifactState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the artifact.  Example: `ocid1.genericartifact.oc1..exampleuniqueID`
        /// </summary>
        ...
        public ArtifactsGenericArtifactState()
        {
        }
    }
}
