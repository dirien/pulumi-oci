...
{
    public static class GetCorePublicIps
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testPublicIps = Output.Create(Oci.GetCorePublicIps.InvokeAsync(new Oci.GetCorePublicIpsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCorePublicIpsResult> InvokeAsync(GetCorePublicIpsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCorePublicIpsResult>("oci:index/getCorePublicIps:GetCorePublicIps", args ?? new GetCorePublicIpsArgs(), options.WithVersion());
    }


    public sealed class GetCorePublicIpsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetCorePublicIpsFilterArgs>? _filters;
        public List<Inputs.GetCorePublicIpsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetCorePublicIpsFilterArgs>());
            set => _filters = value;
        }
    ...
    [OutputType]
    public sealed class GetCorePublicIpsResult
    {
        /// <summary>
        ...
        public readonly ImmutableArray<Outputs.GetCorePublicIpsFilterResult> Filters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCorePublicIpsPublicIpResult> PublicIps;
        /// <summary>
        /// Whether the public IP is regional or specific to a particular availability domain.
        ...
        [OutputConstructor]
        private GetCorePublicIpsResult(
            string? availabilityDomain,

            string compartmentId,

            ImmutableArray<Outputs.GetCorePublicIpsFilterResult> filters,
            ...
            ImmutableArray<Outputs.GetCorePublicIpsPublicIpResult> publicIps,
