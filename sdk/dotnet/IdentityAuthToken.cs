...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAuthToken = new Oci.IdentityAuthToken("testAuthToken", new Oci.IdentityAuthTokenArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityAuthToken:IdentityAuthToken")]
    public partial class IdentityAuthToken : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityAuthToken(string name, IdentityAuthTokenArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityAuthToken:IdentityAuthToken", name, args ?? new IdentityAuthTokenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityAuthToken(string name, Input<string> id, IdentityAuthTokenState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityAuthToken:IdentityAuthToken", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityAuthToken Get(string name, Input<string> id, IdentityAuthTokenState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityAuthToken(name, id, state, options);
        }
    }

    public sealed class IdentityAuthTokenArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the auth token during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentityAuthTokenArgs()
        {
        }
    }

    public sealed class IdentityAuthTokenState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the auth token during creation. Does not have to be unique, and it's changeable.
        /// </summary>
