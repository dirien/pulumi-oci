...
namespace Pulumi.Oci
{
    ...
    /// 
    /// ** IMPORTANT **
    /// Destroying `the oci.CoreIpsecConnectionTunnelManagement` leaves the resource in its existing state. It will not destroy the tunnel and it will not return the tunnel to its default values.
    /// 
    /// ## Example Usage
    /// 
    /// ```csharp
    ...
    ///     public MyStack()
    ///     {
    ///         var testIpSecConnectionTunnel = new Oci.CoreIpsecConnectionTunnelManagement("testIpSecConnectionTunnel", new Oci.CoreIpsecConnectionTunnelManagementArgs
    ///         {
    ...
    ///             BgpSessionInfos = 
    ///             {
    ///                 new Oci.Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs
    ///                 {
    ...
    ///             EncryptionDomainConfig = new Oci.Inputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreIpsecConnectionTunnelManagement:CoreIpsecConnectionTunnelManagement")]
    public partial class CoreIpsecConnectionTunnelManagement : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CoreIpsecConnectionTunnelManagementBgpSessionInfo>> BgpSessionInfos { get; private set; } = null!;
        ...
        public Output<Outputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfig> EncryptionDomainConfig { get; private set; } = null!;
        ...
        public CoreIpsecConnectionTunnelManagement(string name, CoreIpsecConnectionTunnelManagementArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreIpsecConnectionTunnelManagement:CoreIpsecConnectionTunnelManagement", name, args ?? new CoreIpsecConnectionTunnelManagementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreIpsecConnectionTunnelManagement(string name, Input<string> id, CoreIpsecConnectionTunnelManagementState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreIpsecConnectionTunnelManagement:CoreIpsecConnectionTunnelManagement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreIpsecConnectionTunnelManagement Get(string name, Input<string> id, CoreIpsecConnectionTunnelManagementState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreIpsecConnectionTunnelManagement(name, id, state, options);
        }
    }

    public sealed class CoreIpsecConnectionTunnelManagementArgs : Pulumi.ResourceArgs
    {
        [Input("bgpSessionInfos")]
        private InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs>? _bgpSessionInfos;

        /// <summary>
        /// Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
        /// </summary>
        public InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs> BgpSessionInfos
        {
            get => _bgpSessionInfos ?? (_bgpSessionInfos = new InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs>());
        ...
        public Input<Inputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs>? EncryptionDomainConfig { get; set; }
        ...
        public CoreIpsecConnectionTunnelManagementArgs()
        {
        }
    }

    public sealed class CoreIpsecConnectionTunnelManagementState : Pulumi.ResourceArgs
    {
        [Input("bgpSessionInfos")]
        private InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoGetArgs>? _bgpSessionInfos;

        /// <summary>
        /// Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
        /// </summary>
        public InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoGetArgs> BgpSessionInfos
        {
            get => _bgpSessionInfos ?? (_bgpSessionInfos = new InputList<Inputs.CoreIpsecConnectionTunnelManagementBgpSessionInfoGetArgs>());
            set => _bgpSessionInfos = value;
        }
        ...
        /// </summary>
        [Input("encryptionDomainConfig")]
        public Input<Inputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfigGetArgs>? EncryptionDomainConfig { get; set; }
        ...
        public CoreIpsecConnectionTunnelManagementState()
        {
        }
    }
}
