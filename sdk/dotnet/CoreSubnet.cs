...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSubnet = new Oci.CoreSubnet("testSubnet", new Oci.CoreSubnetArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreSubnet:CoreSubnet")]
    public partial class CoreSubnet : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreSubnet(string name, CoreSubnetArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreSubnet:CoreSubnet", name, args ?? new CoreSubnetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreSubnet(string name, Input<string> id, CoreSubnetState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreSubnet:CoreSubnet", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreSubnet Get(string name, Input<string> id, CoreSubnetState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreSubnet(name, id, state, options);
        }
    }

    public sealed class CoreSubnetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Controls whether the subnet is regional or specific to an availability domain. Oracle recommends creating regional subnets because they're more flexible and make it easier to implement failover across availability domains. Originally, AD-specific subnets were the only kind available to use.
        /// </summary>
        ...
        public CoreSubnetArgs()
        {
        }
    }

    public sealed class CoreSubnetState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Controls whether the subnet is regional or specific to an availability domain. Oracle recommends creating regional subnets because they're more flexible and make it easier to implement failover across availability domains. Originally, AD-specific subnets were the only kind available to use.
        /// </summary>
