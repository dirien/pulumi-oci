...
{
    public static class GetApmApmDomain
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testApmDomain = Output.Create(Oci.GetApmApmDomain.InvokeAsync(new Oci.GetApmApmDomainArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetApmApmDomainResult> InvokeAsync(GetApmApmDomainArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApmApmDomainResult>("oci:index/getApmApmDomain:GetApmApmDomain", args ?? new GetApmApmDomainArgs(), options.WithVersion());
    }


    public sealed class GetApmApmDomainArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetApmApmDomainResult
    {
