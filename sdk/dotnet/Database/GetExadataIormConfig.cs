...
namespace Pulumi.Oci.Database
{
    public static class GetExadataIormConfig
    {
        ...
        public static Task<GetExadataIormConfigResult> InvokeAsync(GetExadataIormConfigArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExadataIormConfigResult>("oci:database/getExadataIormConfig:getExadataIormConfig", args ?? new GetExadataIormConfigArgs(), options.WithVersion());
    }
