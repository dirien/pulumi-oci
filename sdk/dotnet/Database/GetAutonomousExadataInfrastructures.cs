...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousExadataInfrastructures
    {
        ...
        public static Task<GetAutonomousExadataInfrastructuresResult> InvokeAsync(GetAutonomousExadataInfrastructuresArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousExadataInfrastructuresResult>("oci:database/getAutonomousExadataInfrastructures:getAutonomousExadataInfrastructures", args ?? new GetAutonomousExadataInfrastructuresArgs(), options.WithVersion());
    }
