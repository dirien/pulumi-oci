...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousDatabasesClones
    {
        ...
        public static Task<GetAutonomousDatabasesClonesResult> InvokeAsync(GetAutonomousDatabasesClonesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousDatabasesClonesResult>("oci:database/getAutonomousDatabasesClones:getAutonomousDatabasesClones", args ?? new GetAutonomousDatabasesClonesArgs(), options.WithVersion());
    }
