...
namespace Pulumi.Oci.Database
{
    public static class GetPluggableDatabase
    {
        ...
        public static Task<GetPluggableDatabaseResult> InvokeAsync(GetPluggableDatabaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPluggableDatabaseResult>("oci:database/getPluggableDatabase:getPluggableDatabase", args ?? new GetPluggableDatabaseArgs(), options.WithVersion());
    }
    ...
    public sealed class GetPluggableDatabaseResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetPluggableDatabaseConnectionStringsResult ConnectionStrings;
        /// <summary>
        ...
        private GetPluggableDatabaseResult(
            ...
            Outputs.GetPluggableDatabaseConnectionStringsResult connectionStrings,
