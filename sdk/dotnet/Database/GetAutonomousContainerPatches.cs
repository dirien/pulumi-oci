...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousContainerPatches
    {
        ...
        public static Task<GetAutonomousContainerPatchesResult> InvokeAsync(GetAutonomousContainerPatchesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousContainerPatchesResult>("oci:database/getAutonomousContainerPatches:getAutonomousContainerPatches", args ?? new GetAutonomousContainerPatchesArgs(), options.WithVersion());
    }
