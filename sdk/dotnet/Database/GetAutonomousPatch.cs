...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousPatch
    {
        ...
        public static Task<GetAutonomousPatchResult> InvokeAsync(GetAutonomousPatchArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousPatchResult>("oci:database/getAutonomousPatch:getAutonomousPatch", args ?? new GetAutonomousPatchArgs(), options.WithVersion());
    }
