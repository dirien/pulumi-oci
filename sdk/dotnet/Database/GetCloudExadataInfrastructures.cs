...
namespace Pulumi.Oci.Database
{
    public static class GetCloudExadataInfrastructures
    {
        ...
        public static Task<GetCloudExadataInfrastructuresResult> InvokeAsync(GetCloudExadataInfrastructuresArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudExadataInfrastructuresResult>("oci:database/getCloudExadataInfrastructures:getCloudExadataInfrastructures", args ?? new GetCloudExadataInfrastructuresArgs(), options.WithVersion());
    }
