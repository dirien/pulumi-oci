...
namespace Pulumi.Oci.Database
{
    public static class GetDatabaseUpgradeHistoryEntries
    {
        ...
        public static Task<GetDatabaseUpgradeHistoryEntriesResult> InvokeAsync(GetDatabaseUpgradeHistoryEntriesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseUpgradeHistoryEntriesResult>("oci:database/getDatabaseUpgradeHistoryEntries:getDatabaseUpgradeHistoryEntries", args ?? new GetDatabaseUpgradeHistoryEntriesArgs(), options.WithVersion());
    }
