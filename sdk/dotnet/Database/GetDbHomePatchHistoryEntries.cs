...
namespace Pulumi.Oci.Database
{
    public static class GetDbHomePatchHistoryEntries
    {
        ...
        public static Task<GetDbHomePatchHistoryEntriesResult> InvokeAsync(GetDbHomePatchHistoryEntriesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDbHomePatchHistoryEntriesResult>("oci:database/getDbHomePatchHistoryEntries:getDbHomePatchHistoryEntries", args ?? new GetDbHomePatchHistoryEntriesArgs(), options.WithVersion());
    }
