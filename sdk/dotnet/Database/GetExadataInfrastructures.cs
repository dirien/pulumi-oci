...
namespace Pulumi.Oci.Database
{
    public static class GetExadataInfrastructures
    {
        ...
        public static Task<GetExadataInfrastructuresResult> InvokeAsync(GetExadataInfrastructuresArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExadataInfrastructuresResult>("oci:database/getExadataInfrastructures:getExadataInfrastructures", args ?? new GetExadataInfrastructuresArgs(), options.WithVersion());
    }
