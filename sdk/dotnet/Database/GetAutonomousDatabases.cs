...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousDatabases
    {
        ...
        public static Task<GetAutonomousDatabasesResult> InvokeAsync(GetAutonomousDatabasesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousDatabasesResult>("oci:database/getAutonomousDatabases:getAutonomousDatabases", args ?? new GetAutonomousDatabasesArgs(), options.WithVersion());
    }
