...
namespace Pulumi.Oci.Database
{
    public static class GetVmClusterUpdateHistoryEntry
    {
        ...
        public static Task<GetVmClusterUpdateHistoryEntryResult> InvokeAsync(GetVmClusterUpdateHistoryEntryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVmClusterUpdateHistoryEntryResult>("oci:database/getVmClusterUpdateHistoryEntry:getVmClusterUpdateHistoryEntry", args ?? new GetVmClusterUpdateHistoryEntryArgs(), options.WithVersion());
    }
