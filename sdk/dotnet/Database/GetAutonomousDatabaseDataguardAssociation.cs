...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousDatabaseDataguardAssociation
    {
        ...
        public static Task<GetAutonomousDatabaseDataguardAssociationResult> InvokeAsync(GetAutonomousDatabaseDataguardAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousDatabaseDataguardAssociationResult>("oci:database/getAutonomousDatabaseDataguardAssociation:getAutonomousDatabaseDataguardAssociation", args ?? new GetAutonomousDatabaseDataguardAssociationArgs(), options.WithVersion());
    }
