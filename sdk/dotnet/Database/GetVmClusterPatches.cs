...
namespace Pulumi.Oci.Database
{
    public static class GetVmClusterPatches
    {
        ...
        public static Task<GetVmClusterPatchesResult> InvokeAsync(GetVmClusterPatchesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVmClusterPatchesResult>("oci:database/getVmClusterPatches:getVmClusterPatches", args ?? new GetVmClusterPatchesArgs(), options.WithVersion());
    }
