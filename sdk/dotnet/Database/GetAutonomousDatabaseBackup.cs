...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousDatabaseBackup
    {
        ...
        public static Task<GetAutonomousDatabaseBackupResult> InvokeAsync(GetAutonomousDatabaseBackupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousDatabaseBackupResult>("oci:database/getAutonomousDatabaseBackup:getAutonomousDatabaseBackup", args ?? new GetAutonomousDatabaseBackupArgs(), options.WithVersion());
    }
