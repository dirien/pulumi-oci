...
namespace Pulumi.Oci.Database
{
    public static class GetAutonomousContainerDatabaseDataguardAssociation
    {
        ...
        public static Task<GetAutonomousContainerDatabaseDataguardAssociationResult> InvokeAsync(GetAutonomousContainerDatabaseDataguardAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutonomousContainerDatabaseDataguardAssociationResult>("oci:database/getAutonomousContainerDatabaseDataguardAssociation:getAutonomousContainerDatabaseDataguardAssociation", args ?? new GetAutonomousContainerDatabaseDataguardAssociationArgs(), options.WithVersion());
    }
