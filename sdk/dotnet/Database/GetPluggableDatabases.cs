...
namespace Pulumi.Oci.Database
{
    public static class GetPluggableDatabases
    {
        ...
        public static Task<GetPluggableDatabasesResult> InvokeAsync(GetPluggableDatabasesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPluggableDatabasesResult>("oci:database/getPluggableDatabases:getPluggableDatabases", args ?? new GetPluggableDatabasesArgs(), options.WithVersion());
    }
