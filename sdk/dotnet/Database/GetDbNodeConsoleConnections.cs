...
namespace Pulumi.Oci.Database
{
    public static class GetDbNodeConsoleConnections
    {
        ...
        public static Task<GetDbNodeConsoleConnectionsResult> InvokeAsync(GetDbNodeConsoleConnectionsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDbNodeConsoleConnectionsResult>("oci:database/getDbNodeConsoleConnections:getDbNodeConsoleConnections", args ?? new GetDbNodeConsoleConnectionsArgs(), options.WithVersion());
    }
