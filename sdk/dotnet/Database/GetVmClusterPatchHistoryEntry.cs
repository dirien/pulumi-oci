...
namespace Pulumi.Oci.Database
{
    public static class GetVmClusterPatchHistoryEntry
    {
        ...
        public static Task<GetVmClusterPatchHistoryEntryResult> InvokeAsync(GetVmClusterPatchHistoryEntryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVmClusterPatchHistoryEntryResult>("oci:database/getVmClusterPatchHistoryEntry:getVmClusterPatchHistoryEntry", args ?? new GetVmClusterPatchHistoryEntryArgs(), options.WithVersion());
    }
