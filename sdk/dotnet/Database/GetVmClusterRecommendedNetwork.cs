...
namespace Pulumi.Oci.Database
{
    public static class GetVmClusterRecommendedNetwork
    {
        ...
        public static Task<GetVmClusterRecommendedNetworkResult> InvokeAsync(GetVmClusterRecommendedNetworkArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVmClusterRecommendedNetworkResult>("oci:database/getVmClusterRecommendedNetwork:getVmClusterRecommendedNetwork", args ?? new GetVmClusterRecommendedNetworkArgs(), options.WithVersion());
    }
