...
namespace Pulumi.Oci.Database
{
    public static class GetExternalDatabaseConnectors
    {
        ...
        public static Task<GetExternalDatabaseConnectorsResult> InvokeAsync(GetExternalDatabaseConnectorsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetExternalDatabaseConnectorsResult>("oci:database/getExternalDatabaseConnectors:getExternalDatabaseConnectors", args ?? new GetExternalDatabaseConnectorsArgs(), options.WithVersion());
    }
