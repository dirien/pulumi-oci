...
namespace Pulumi.Oci.Database
{
    public static class GetVmClusterUpdates
    {
        ...
        public static Task<GetVmClusterUpdatesResult> InvokeAsync(GetVmClusterUpdatesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVmClusterUpdatesResult>("oci:database/getVmClusterUpdates:getVmClusterUpdates", args ?? new GetVmClusterUpdatesArgs(), options.WithVersion());
    }
