...
namespace Pulumi.Oci.Database
{
    public static class GetDataGuardAssociation
    {
        ...
        public static Task<GetDataGuardAssociationResult> InvokeAsync(GetDataGuardAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataGuardAssociationResult>("oci:database/getDataGuardAssociation:getDataGuardAssociation", args ?? new GetDataGuardAssociationArgs(), options.WithVersion());
    }
