...
namespace Pulumi.Oci.Database
{
    public static class GetMaintenanceRuns
    {
        ...
        public static Task<GetMaintenanceRunsResult> InvokeAsync(GetMaintenanceRunsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMaintenanceRunsResult>("oci:database/getMaintenanceRuns:getMaintenanceRuns", args ?? new GetMaintenanceRunsArgs(), options.WithVersion());
    }
