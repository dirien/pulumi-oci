...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class BdsAutoScalingConfigurationPolicyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.BdsAutoScalingConfigurationPolicyRuleArgs>? _rules;

        /// <summary>
        /// (Updatable) The list of rules for autoscaling. If an action has multiple rules, the last rule in the array will be applied.
        /// </summary>
        public InputList<Inputs.BdsAutoScalingConfigurationPolicyRuleArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.BdsAutoScalingConfigurationPolicyRuleArgs>());
            set => _rules = value;
        }

        public BdsAutoScalingConfigurationPolicyArgs()
        {
        }
    }
}
