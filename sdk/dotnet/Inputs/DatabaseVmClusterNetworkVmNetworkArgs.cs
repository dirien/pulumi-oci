...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseVmClusterNetworkVmNetworkArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DatabaseVmClusterNetworkVmNetworkNodeArgs>? _nodes;

        /// <summary>
        /// (Updatable) The list of node details.
        /// </summary>
        public InputList<Inputs.DatabaseVmClusterNetworkVmNetworkNodeArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.DatabaseVmClusterNetworkVmNetworkNodeArgs>());
            set => _nodes = value;
        }
        ...
        public DatabaseVmClusterNetworkVmNetworkArgs()
        {
        }
    }
}
