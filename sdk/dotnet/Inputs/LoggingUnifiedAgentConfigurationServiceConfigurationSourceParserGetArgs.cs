...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable)
        /// </summary>
        ...
        [Input("patterns")]
        private InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternGetArgs>? _patterns;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternGetArgs> Patterns
        {
            get => _patterns ?? (_patterns = new InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternGetArgs>());
            set => _patterns = value;
        }
        ...
        public LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserGetArgs()
        {
        }
    }
}
