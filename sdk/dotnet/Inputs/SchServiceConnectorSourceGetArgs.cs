...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class SchServiceConnectorSourceGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("cursor")]
        public Input<Inputs.SchServiceConnectorSourceCursorGetArgs>? Cursor { get; set; }
        ...
        [Input("logSources")]
        private InputList<Inputs.SchServiceConnectorSourceLogSourceGetArgs>? _logSources;

        /// <summary>
        /// (Updatable) The resources affected by this work request.
        /// </summary>
        public InputList<Inputs.SchServiceConnectorSourceLogSourceGetArgs> LogSources
        {
            get => _logSources ?? (_logSources = new InputList<Inputs.SchServiceConnectorSourceLogSourceGetArgs>());
        ...
        public SchServiceConnectorSourceGetArgs()
        {
        }
    }
}
