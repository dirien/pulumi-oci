...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigHumanInteractionChallengeGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsGetArgs>? ChallengeSettings { get; set; }
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderGetArgs>? SetHttpHeader { get; set; }

        public WaasWaasPolicyWafConfigHumanInteractionChallengeGetArgs()
        {
        }
    }
}
