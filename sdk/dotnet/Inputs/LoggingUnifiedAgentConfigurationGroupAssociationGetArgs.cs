...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoggingUnifiedAgentConfigurationGroupAssociationGetArgs : Pulumi.ResourceArgs
    {
        [Input("groupLists")]
        ...
        public LoggingUnifiedAgentConfigurationGroupAssociationGetArgs()
        {
        }
    }
}
