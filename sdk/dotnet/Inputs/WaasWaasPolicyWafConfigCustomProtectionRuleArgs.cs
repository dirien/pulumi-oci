...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigCustomProtectionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionArgs>? _exclusions;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionArgs>());
        ...
        public WaasWaasPolicyWafConfigCustomProtectionRuleArgs()
        {
        }
    }
}
