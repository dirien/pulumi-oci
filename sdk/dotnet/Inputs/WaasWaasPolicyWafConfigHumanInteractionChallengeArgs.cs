...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigHumanInteractionChallengeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsArgs>? ChallengeSettings { get; set; }
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderArgs>? SetHttpHeader { get; set; }

        public WaasWaasPolicyWafConfigHumanInteractionChallengeArgs()
        {
        }
    }
}
