...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreClusterNetworkInstancePoolGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("loadBalancers")]
        private InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerGetArgs>? _loadBalancers;

        /// <summary>
        /// The load balancers attached to the instance pool.
        /// </summary>
        public InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerGetArgs> LoadBalancers
        {
            get => _loadBalancers ?? (_loadBalancers = new InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerGetArgs>());
            set => _loadBalancers = value;
        }

        [Input("placementConfigurations")]
        private InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationGetArgs>? _placementConfigurations;

        /// <summary>
        /// The placement configurations for the instance pool.
        /// </summary>
        public InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationGetArgs> PlacementConfigurations
        {
            get => _placementConfigurations ?? (_placementConfigurations = new InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationGetArgs>());
        ...
        public CoreClusterNetworkInstancePoolGetArgs()
        {
        }
    }
}
