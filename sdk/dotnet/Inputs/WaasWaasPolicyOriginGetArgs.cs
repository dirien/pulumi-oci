...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyOriginGetArgs : Pulumi.ResourceArgs
    {
        [Input("customHeaders")]
        private InputList<Inputs.WaasWaasPolicyOriginCustomHeaderGetArgs>? _customHeaders;

        /// <summary>
        /// (Updatable) A list of HTTP headers to forward to your origin.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyOriginCustomHeaderGetArgs> CustomHeaders
        {
            get => _customHeaders ?? (_customHeaders = new InputList<Inputs.WaasWaasPolicyOriginCustomHeaderGetArgs>());
        ...
        public WaasWaasPolicyOriginGetArgs()
        {
        }
    }
}
