...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class MeteringComputationCustomTableSavedCustomTableGetArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("groupByTags")]
        private InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagGetArgs>? _groupByTags;
        ...
        /// </summary>
        public InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagGetArgs> GroupByTags
        {
            get => _groupByTags ?? (_groupByTags = new InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagGetArgs>());
        ...
        public MeteringComputationCustomTableSavedCustomTableGetArgs()
        {
        }
    }
}
