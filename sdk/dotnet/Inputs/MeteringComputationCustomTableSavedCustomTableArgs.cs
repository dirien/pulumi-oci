...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class MeteringComputationCustomTableSavedCustomTableArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("groupByTags")]
        private InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagArgs>? _groupByTags;
        ...
        /// </summary>
        public InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagArgs> GroupByTags
        {
            get => _groupByTags ?? (_groupByTags = new InputList<Inputs.MeteringComputationCustomTableSavedCustomTableGroupByTagArgs>());
        ...
        public MeteringComputationCustomTableSavedCustomTableArgs()
        {
        }
    }
}
