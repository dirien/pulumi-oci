...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationArgs : Pulumi.ResourceArgs
    {
        [Input("audiences")]
        ...
        /// </summary>
        [Input("publicKeys")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationPublicKeysArgs>? PublicKeys { get; set; }
        ...
        [Input("verifyClaims")]
        private InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimArgs>? _verifyClaims;

        /// <summary>
        /// (Updatable) A list of claims which should be validated to consider the token valid.
        /// </summary>
        public InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimArgs> VerifyClaims
        {
            get => _verifyClaims ?? (_verifyClaims = new InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimArgs>());
            set => _verifyClaims = value;
        }

        public ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationArgs()
        {
        }
    }
}
