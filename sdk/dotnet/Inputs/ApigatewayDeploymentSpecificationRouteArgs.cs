...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRouteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The backend to forward requests to.
        /// </summary>
        [Input("backend", required: true)]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteBackendArgs> Backend { get; set; } = null!;

        /// <summary>
        /// (Updatable) Policies controlling the pushing of logs to Oracle Cloud Infrastructure Public Logging.
        /// </summary>
        [Input("loggingPolicies")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteLoggingPoliciesArgs>? LoggingPolicies { get; set; }
        ...
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteRequestPoliciesArgs>? RequestPolicies { get; set; }

        /// <summary>
        /// (Updatable) Behavior applied to any responses sent by the API for requests on this route.
        /// </summary>
        [Input("responsePolicies")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteResponsePoliciesArgs>? ResponsePolicies { get; set; }

        public ApigatewayDeploymentSpecificationRouteArgs()
        {
        }
    }
}
