...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayGatewayResponseCacheDetailsGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("servers")]
        private InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerGetArgs>? _servers;

        /// <summary>
        /// (Updatable) The set of cache store members to connect to. At present only a single server is supported.
        /// </summary>
        public InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerGetArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerGetArgs>());
            set => _servers = value;
        }
        ...
        public ApigatewayGatewayResponseCacheDetailsGetArgs()
        {
        }
    }
}
