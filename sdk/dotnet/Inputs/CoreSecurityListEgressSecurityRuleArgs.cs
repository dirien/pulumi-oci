...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreSecurityListEgressSecurityRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("icmpOptions")]
        public Input<Inputs.CoreSecurityListEgressSecurityRuleIcmpOptionsArgs>? IcmpOptions { get; set; }
        ...
        /// </summary>
        [Input("tcpOptions")]
        public Input<Inputs.CoreSecurityListEgressSecurityRuleTcpOptionsArgs>? TcpOptions { get; set; }
        ...
        /// </summary>
        [Input("udpOptions")]
        public Input<Inputs.CoreSecurityListEgressSecurityRuleUdpOptionsArgs>? UdpOptions { get; set; }

        public CoreSecurityListEgressSecurityRuleArgs()
        {
        }
    }
}
