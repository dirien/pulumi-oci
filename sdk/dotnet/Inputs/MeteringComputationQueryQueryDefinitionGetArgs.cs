...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class MeteringComputationQueryQueryDefinitionGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The common fields for Cost Analysis UI rendering.
        /// </summary>
        [Input("costAnalysisUi", required: true)]
        public Input<Inputs.MeteringComputationQueryQueryDefinitionCostAnalysisUiGetArgs> CostAnalysisUi { get; set; } = null!;
        ...
        public Input<Inputs.MeteringComputationQueryQueryDefinitionReportQueryGetArgs> ReportQuery { get; set; } = null!;
        ...
        public MeteringComputationQueryQueryDefinitionGetArgs()
        {
        }
    }
}
