...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreInstancePoolPlacementConfigurationGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetGetArgs>? _secondaryVnicSubnets;

        /// <summary>
        /// (Updatable) The set of secondary VNIC data for instances in the pool.
        /// </summary>
        public InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetGetArgs> SecondaryVnicSubnets
        {
            get => _secondaryVnicSubnets ?? (_secondaryVnicSubnets = new InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetGetArgs>());
            set => _secondaryVnicSubnets = value;
        }

        public CoreInstancePoolPlacementConfigurationGetArgs()
        {
        }
    }
}
