...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigGetArgs : Pulumi.ResourceArgs
    {
        [Input("accessRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleGetArgs>? _accessRules;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleGetArgs> AccessRules
        {
            get => _accessRules ?? (_accessRules = new InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleGetArgs>());
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigAddressRateLimitingGetArgs>? AddressRateLimiting { get; set; }

        [Input("cachingRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleGetArgs>? _cachingRules;

        /// <summary>
        /// (Updatable) A list of caching rules applied to the web application.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleGetArgs> CachingRules
        {
            get => _cachingRules ?? (_cachingRules = new InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleGetArgs>());
            set => _cachingRules = value;
        }

        [Input("captchas")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCaptchaGetArgs>? _captchas;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCaptchaGetArgs> Captchas
        {
            get => _captchas ?? (_captchas = new InputList<Inputs.WaasWaasPolicyWafConfigCaptchaGetArgs>());
            set => _captchas = value;
        }

        [Input("customProtectionRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleGetArgs>? _customProtectionRules;

        /// <summary>
        /// (Updatable) A list of the custom protection rule OCIDs and their actions.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleGetArgs> CustomProtectionRules
        {
            get => _customProtectionRules ?? (_customProtectionRules = new InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleGetArgs>());
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigDeviceFingerprintChallengeGetArgs>? DeviceFingerprintChallenge { get; set; }
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeGetArgs>? HumanInteractionChallenge { get; set; }
        ...
        /// </summary>
        [Input("jsChallenge")]
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeGetArgs>? JsChallenge { get; set; }
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigProtectionSettingsGetArgs>? ProtectionSettings { get; set; }

        [Input("whitelists")]
        private InputList<Inputs.WaasWaasPolicyWafConfigWhitelistGetArgs>? _whitelists;

        /// <summary>
        /// (Updatable) A list of IP addresses that bypass the Web Application Firewall.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigWhitelistGetArgs> Whitelists
        {
            get => _whitelists ?? (_whitelists = new InputList<Inputs.WaasWaasPolicyWafConfigWhitelistGetArgs>());
            set => _whitelists = value;
        }

        public WaasWaasPolicyWafConfigGetArgs()
        {
        }
    }
}
