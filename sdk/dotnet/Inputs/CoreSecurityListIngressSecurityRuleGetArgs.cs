...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreSecurityListIngressSecurityRuleGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("icmpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleIcmpOptionsGetArgs>? IcmpOptions { get; set; }
        ...
        /// </summary>
        [Input("tcpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleTcpOptionsGetArgs>? TcpOptions { get; set; }
        ...
        /// </summary>
        [Input("udpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleUdpOptionsGetArgs>? UdpOptions { get; set; }

        public CoreSecurityListIngressSecurityRuleGetArgs()
        {
        }
    }
}
