...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class MysqlChannelSourceGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.MysqlChannelSourceSslCaCertificateGetArgs>? SslCaCertificate { get; set; }
        ...
        public MysqlChannelSourceGetArgs()
        {
        }
    }
}
