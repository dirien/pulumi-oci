...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreInstanceAgentConfigArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CoreInstanceAgentConfigPluginsConfigArgs>? _pluginsConfigs;

        /// <summary>
        /// (Updatable) The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.CoreInstanceAgentConfigPluginsConfigArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.CoreInstanceAgentConfigPluginsConfigArgs>());
            set => _pluginsConfigs = value;
        }

        public CoreInstanceAgentConfigArgs()
        {
        }
    }
}
