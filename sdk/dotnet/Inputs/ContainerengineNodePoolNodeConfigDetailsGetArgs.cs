...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ContainerengineNodePoolNodeConfigDetailsGetArgs : Pulumi.ResourceArgs
    {
        [Input("nsgIds")]
        ...
        private InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigGetArgs>? _placementConfigs;
        ...
        /// </summary>
        public InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigGetArgs> PlacementConfigs
        {
            get => _placementConfigs ?? (_placementConfigs = new InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigGetArgs>());
        ...
        public ContainerengineNodePoolNodeConfigDetailsGetArgs()
        {
        }
    }
}
