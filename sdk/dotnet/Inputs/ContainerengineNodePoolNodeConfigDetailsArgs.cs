...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ContainerengineNodePoolNodeConfigDetailsArgs : Pulumi.ResourceArgs
    {
        [Input("nsgIds")]
        ...
        private InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigArgs>? _placementConfigs;
        ...
        /// </summary>
        public InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigArgs> PlacementConfigs
        {
            get => _placementConfigs ?? (_placementConfigs = new InputList<Inputs.ContainerengineNodePoolNodeConfigDetailsPlacementConfigArgs>());
        ...
        public ContainerengineNodePoolNodeConfigDetailsArgs()
        {
        }
    }
}
