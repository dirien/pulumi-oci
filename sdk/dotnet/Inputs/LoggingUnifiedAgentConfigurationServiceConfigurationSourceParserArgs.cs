...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable)
        /// </summary>
        ...
        [Input("patterns")]
        private InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternArgs>? _patterns;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternArgs> Patterns
        {
            get => _patterns ?? (_patterns = new InputList<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternArgs>());
            set => _patterns = value;
        }
        ...
        public LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserArgs()
        {
        }
    }
}
