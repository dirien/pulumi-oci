...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoadBalancerPathRouteSetPathRouteGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.LoadBalancerPathRouteSetPathRoutePathMatchTypeGetArgs> PathMatchType { get; set; } = null!;

        public LoadBalancerPathRouteSetPathRouteGetArgs()
        {
        }
    }
}
