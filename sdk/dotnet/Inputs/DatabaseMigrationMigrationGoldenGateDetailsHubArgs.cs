...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseMigrationMigrationGoldenGateDetailsHubArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubRestAdminCredentialsArgs> RestAdminCredentials { get; set; } = null!;

        /// <summary>
        /// (Updatable) Database Admin Credentials details.
        /// </summary>
        [Input("sourceContainerDbAdminCredentials")]
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubSourceContainerDbAdminCredentialsArgs>? SourceContainerDbAdminCredentials { get; set; }

        /// <summary>
        /// (Updatable) Database Admin Credentials details.
        /// </summary>
        [Input("sourceDbAdminCredentials", required: true)]
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubSourceDbAdminCredentialsArgs> SourceDbAdminCredentials { get; set; } = null!;
        ...
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubTargetDbAdminCredentialsArgs> TargetDbAdminCredentials { get; set; } = null!;
        ...
        public DatabaseMigrationMigrationGoldenGateDetailsHubArgs()
        {
        }
    }
}
