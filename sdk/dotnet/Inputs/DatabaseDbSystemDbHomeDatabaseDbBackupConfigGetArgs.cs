...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseDbSystemDbHomeDatabaseDbBackupConfigGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailGetArgs>? _backupDestinationDetails;

        /// <summary>
        /// (Updatable) Backup destination details.
        /// </summary>
        public InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailGetArgs> BackupDestinationDetails
        {
            get => _backupDestinationDetails ?? (_backupDestinationDetails = new InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailGetArgs>());
        ...
        public DatabaseDbSystemDbHomeDatabaseDbBackupConfigGetArgs()
        {
        }
    }
}
