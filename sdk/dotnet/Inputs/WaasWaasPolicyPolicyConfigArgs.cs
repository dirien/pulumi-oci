...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyPolicyConfigArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("healthChecks")]
        public Input<Inputs.WaasWaasPolicyPolicyConfigHealthChecksArgs>? HealthChecks { get; set; }
        ...
        public Input<Inputs.WaasWaasPolicyPolicyConfigLoadBalancingMethodArgs>? LoadBalancingMethod { get; set; }
        ...
        public WaasWaasPolicyPolicyConfigArgs()
        {
        }
    }
}
