...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ContainerengineNodePoolNodeGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("error")]
        public Input<Inputs.ContainerengineNodePoolNodeErrorGetArgs>? Error { get; set; }
        ...
        public ContainerengineNodePoolNodeGetArgs()
        {
        }
    }
}
