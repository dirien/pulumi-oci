...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayGatewayResponseCacheDetailsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("servers")]
        private InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerArgs>? _servers;

        /// <summary>
        /// (Updatable) The set of cache store members to connect to. At present only a single server is supported.
        /// </summary>
        public InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.ApigatewayGatewayResponseCacheDetailsServerArgs>());
            set => _servers = value;
        }
        ...
        public ApigatewayGatewayResponseCacheDetailsArgs()
        {
        }
    }
}
