...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseMigrationMigrationDatapumpSettingsGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsDataPumpParametersGetArgs>? DataPumpParameters { get; set; }
        ...
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsExportDirectoryObjectGetArgs>? ExportDirectoryObject { get; set; }

        /// <summary>
        /// (Updatable) Directory object details, used to define either import or export directory objects in Data Pump Settings. Import directory is required for Non-Autonomous target connections. If specified for an autonomous target, it will show an error. Export directory will error if there are database link details specified.
        /// </summary>
        [Input("importDirectoryObject")]
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsImportDirectoryObjectGetArgs>? ImportDirectoryObject { get; set; }
        ...
        private InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapGetArgs>? _metadataRemaps;
        ...
        /// </summary>
        public InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapGetArgs> MetadataRemaps
        {
            get => _metadataRemaps ?? (_metadataRemaps = new InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapGetArgs>());
            set => _metadataRemaps = value;
        }

        public DatabaseMigrationMigrationDatapumpSettingsGetArgs()
        {
        }
    }
}
