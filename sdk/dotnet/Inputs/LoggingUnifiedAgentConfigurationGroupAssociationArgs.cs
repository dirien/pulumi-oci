...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoggingUnifiedAgentConfigurationGroupAssociationArgs : Pulumi.ResourceArgs
    {
        [Input("groupLists")]
        ...
        public LoggingUnifiedAgentConfigurationGroupAssociationArgs()
        {
        }
    }
}
