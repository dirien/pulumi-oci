...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseMigrationMigrationGoldenGateDetailsHubGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubRestAdminCredentialsGetArgs> RestAdminCredentials { get; set; } = null!;

        /// <summary>
        /// (Updatable) Database Admin Credentials details.
        /// </summary>
        [Input("sourceContainerDbAdminCredentials")]
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubSourceContainerDbAdminCredentialsGetArgs>? SourceContainerDbAdminCredentials { get; set; }

        /// <summary>
        /// (Updatable) Database Admin Credentials details.
        /// </summary>
        [Input("sourceDbAdminCredentials", required: true)]
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubSourceDbAdminCredentialsGetArgs> SourceDbAdminCredentials { get; set; } = null!;
        ...
        public Input<Inputs.DatabaseMigrationMigrationGoldenGateDetailsHubTargetDbAdminCredentialsGetArgs> TargetDbAdminCredentials { get; set; } = null!;
        ...
        public DatabaseMigrationMigrationGoldenGateDetailsHubGetArgs()
        {
        }
    }
}
