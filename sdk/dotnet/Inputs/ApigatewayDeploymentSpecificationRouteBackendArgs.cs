...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRouteBackendArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("headers")]
        private InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderArgs>? _headers;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderArgs>());
            set => _headers = value;
        }
        ...
        public ApigatewayDeploymentSpecificationRouteBackendArgs()
        {
        }
    }
}
