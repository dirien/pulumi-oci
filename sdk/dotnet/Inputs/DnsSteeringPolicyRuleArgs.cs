...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DnsSteeringPolicyRuleArgs : Pulumi.ResourceArgs
    {
        [Input("cases")]
        private InputList<Inputs.DnsSteeringPolicyRuleCaseArgs>? _cases;
        ...
        /// </summary>
        public InputList<Inputs.DnsSteeringPolicyRuleCaseArgs> Cases
        {
            get => _cases ?? (_cases = new InputList<Inputs.DnsSteeringPolicyRuleCaseArgs>());
            set => _cases = value;
        }

        [Input("defaultAnswerDatas")]
        private InputList<Inputs.DnsSteeringPolicyRuleDefaultAnswerDataArgs>? _defaultAnswerDatas;
        ...
        /// </summary>
        public InputList<Inputs.DnsSteeringPolicyRuleDefaultAnswerDataArgs> DefaultAnswerDatas
        {
            get => _defaultAnswerDatas ?? (_defaultAnswerDatas = new InputList<Inputs.DnsSteeringPolicyRuleDefaultAnswerDataArgs>());
        ...
        public DnsSteeringPolicyRuleArgs()
        {
        }
    }
}
