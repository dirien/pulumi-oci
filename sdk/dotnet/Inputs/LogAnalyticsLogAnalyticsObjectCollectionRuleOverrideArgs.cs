...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs : Pulumi.ResourceArgs
    {
        [Input("matchType")]
        ...
        public LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs()
        {
        }
    }
}
