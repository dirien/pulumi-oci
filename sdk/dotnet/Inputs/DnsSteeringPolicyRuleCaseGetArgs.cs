...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DnsSteeringPolicyRuleCaseGetArgs : Pulumi.ResourceArgs
    {
        [Input("answerDatas")]
        private InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataGetArgs>? _answerDatas;

        /// <summary>
        /// An array of `SteeringPolicyPriorityAnswerData` objects.
        /// </summary>
        public InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataGetArgs> AnswerDatas
        {
            get => _answerDatas ?? (_answerDatas = new InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataGetArgs>());
        ...
        public DnsSteeringPolicyRuleCaseGetArgs()
        {
        }
    }
}
