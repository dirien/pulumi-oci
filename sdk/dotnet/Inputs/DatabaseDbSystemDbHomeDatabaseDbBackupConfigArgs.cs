...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseDbSystemDbHomeDatabaseDbBackupConfigArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs>? _backupDestinationDetails;

        /// <summary>
        /// (Updatable) Backup destination details.
        /// </summary>
        public InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs> BackupDestinationDetails
        {
            get => _backupDestinationDetails ?? (_backupDestinationDetails = new InputList<Inputs.DatabaseDbSystemDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs>());
        ...
        public DatabaseDbSystemDbHomeDatabaseDbBackupConfigArgs()
        {
        }
    }
}
