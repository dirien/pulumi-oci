...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreInstancePoolPlacementConfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetArgs>? _secondaryVnicSubnets;

        /// <summary>
        /// (Updatable) The set of secondary VNIC data for instances in the pool.
        /// </summary>
        public InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetArgs> SecondaryVnicSubnets
        {
            get => _secondaryVnicSubnets ?? (_secondaryVnicSubnets = new InputList<Inputs.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetArgs>());
            set => _secondaryVnicSubnets = value;
        }

        public CoreInstancePoolPlacementConfigurationArgs()
        {
        }
    }
}
