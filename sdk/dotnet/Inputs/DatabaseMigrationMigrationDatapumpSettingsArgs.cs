...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseMigrationMigrationDatapumpSettingsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsDataPumpParametersArgs>? DataPumpParameters { get; set; }
        ...
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsExportDirectoryObjectArgs>? ExportDirectoryObject { get; set; }

        /// <summary>
        /// (Updatable) Directory object details, used to define either import or export directory objects in Data Pump Settings. Import directory is required for Non-Autonomous target connections. If specified for an autonomous target, it will show an error. Export directory will error if there are database link details specified.
        /// </summary>
        [Input("importDirectoryObject")]
        public Input<Inputs.DatabaseMigrationMigrationDatapumpSettingsImportDirectoryObjectArgs>? ImportDirectoryObject { get; set; }
        ...
        private InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapArgs>? _metadataRemaps;
        ...
        /// </summary>
        public InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapArgs> MetadataRemaps
        {
            get => _metadataRemaps ?? (_metadataRemaps = new InputList<Inputs.DatabaseMigrationMigrationDatapumpSettingsMetadataRemapArgs>());
            set => _metadataRemaps = value;
        }

        public DatabaseMigrationMigrationDatapumpSettingsArgs()
        {
        }
    }
}
