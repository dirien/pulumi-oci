...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseDbSystemMaintenanceWindowArgs : Pulumi.ResourceArgs
    {
        [Input("daysOfWeeks")]
        private InputList<Inputs.DatabaseDbSystemMaintenanceWindowDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DatabaseDbSystemMaintenanceWindowDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DatabaseDbSystemMaintenanceWindowDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DatabaseDbSystemMaintenanceWindowMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DatabaseDbSystemMaintenanceWindowMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DatabaseDbSystemMaintenanceWindowMonthArgs>());
            set => _months = value;
        }
        ...
        public DatabaseDbSystemMaintenanceWindowArgs()
        {
        }
    }
}
