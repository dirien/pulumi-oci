...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreInstanceAgentConfigGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CoreInstanceAgentConfigPluginsConfigGetArgs>? _pluginsConfigs;

        /// <summary>
        /// (Updatable) The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.CoreInstanceAgentConfigPluginsConfigGetArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.CoreInstanceAgentConfigPluginsConfigGetArgs>());
            set => _pluginsConfigs = value;
        }

        public CoreInstanceAgentConfigGetArgs()
        {
        }
    }
}
