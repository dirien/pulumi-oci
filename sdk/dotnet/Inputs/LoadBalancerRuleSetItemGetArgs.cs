...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoadBalancerRuleSetItemGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Inputs.LoadBalancerRuleSetItemConditionGetArgs>? _conditions;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.LoadBalancerRuleSetItemConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.LoadBalancerRuleSetItemConditionGetArgs>());
        ...
        /// </summary>
        [Input("redirectUri")]
        public Input<Inputs.LoadBalancerRuleSetItemRedirectUriGetArgs>? RedirectUri { get; set; }
        ...
        public LoadBalancerRuleSetItemGetArgs()
        {
        }
    }
}
