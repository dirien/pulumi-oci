...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApmSyntheticsMonitorConfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsArgs>? ReqAuthenticationDetails { get; set; }
        ...
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderArgs>? _requestHeaders;

        /// <summary>
        /// (Updatable) List of request headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderArgs> RequestHeaders
        {
            get => _requestHeaders ?? (_requestHeaders = new InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderArgs>());
        ...
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamArgs>? _requestQueryParams;

        /// <summary>
        /// (Updatable) List of request query params. Example: `[{"paramName": "sortOrder", "paramValue": "asc"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamArgs> RequestQueryParams
        {
            get => _requestQueryParams ?? (_requestQueryParams = new InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamArgs>());
        ...
        [Input("verifyTexts")]
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextArgs>? _verifyTexts;
        ...
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextArgs> VerifyTexts
        {
            get => _verifyTexts ?? (_verifyTexts = new InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextArgs>());
            set => _verifyTexts = value;
        }

        public ApmSyntheticsMonitorConfigurationArgs()
        {
        }
    }
}
