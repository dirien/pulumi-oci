...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoadBalancerRuleSetItemArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("conditions")]
        private InputList<Inputs.LoadBalancerRuleSetItemConditionArgs>? _conditions;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.LoadBalancerRuleSetItemConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.LoadBalancerRuleSetItemConditionArgs>());
        ...
        /// </summary>
        [Input("redirectUri")]
        public Input<Inputs.LoadBalancerRuleSetItemRedirectUriArgs>? RedirectUri { get; set; }
        ...
        public LoadBalancerRuleSetItemArgs()
        {
        }
    }
}
