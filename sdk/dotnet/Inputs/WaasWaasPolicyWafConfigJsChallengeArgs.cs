...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigJsChallengeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeChallengeSettingsArgs>? ChallengeSettings { get; set; }

        [Input("criterias")]
        private InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaArgs>? _criterias;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaArgs>());
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeSetHttpHeaderArgs>? SetHttpHeader { get; set; }

        public WaasWaasPolicyWafConfigJsChallengeArgs()
        {
        }
    }
}
