...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreSecurityListIngressSecurityRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("icmpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleIcmpOptionsArgs>? IcmpOptions { get; set; }
        ...
        /// </summary>
        [Input("tcpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleTcpOptionsArgs>? TcpOptions { get; set; }
        ...
        /// </summary>
        [Input("udpOptions")]
        public Input<Inputs.CoreSecurityListIngressSecurityRuleUdpOptionsArgs>? UdpOptions { get; set; }

        public CoreSecurityListIngressSecurityRuleArgs()
        {
        }
    }
}
