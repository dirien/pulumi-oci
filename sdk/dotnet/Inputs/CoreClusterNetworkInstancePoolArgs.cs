...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreClusterNetworkInstancePoolArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("loadBalancers")]
        private InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerArgs>? _loadBalancers;

        /// <summary>
        /// The load balancers attached to the instance pool.
        /// </summary>
        public InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerArgs> LoadBalancers
        {
            get => _loadBalancers ?? (_loadBalancers = new InputList<Inputs.CoreClusterNetworkInstancePoolLoadBalancerArgs>());
            set => _loadBalancers = value;
        }

        [Input("placementConfigurations")]
        private InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationArgs>? _placementConfigurations;

        /// <summary>
        /// The placement configurations for the instance pool.
        /// </summary>
        public InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationArgs> PlacementConfigurations
        {
            get => _placementConfigurations ?? (_placementConfigurations = new InputList<Inputs.CoreClusterNetworkInstancePoolPlacementConfigurationArgs>());
        ...
        public CoreClusterNetworkInstancePoolArgs()
        {
        }
    }
}
