...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsGetArgs : Pulumi.ResourceArgs
    {
        [Input("authHeaders")]
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs>? _authHeaders;

        /// <summary>
        /// (Updatable) List of authentication headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs> AuthHeaders
        {
            get => _authHeaders ?? (_authHeaders = new InputList<Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs>());
        ...
        public ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsGetArgs()
        {
        }
    }
}
