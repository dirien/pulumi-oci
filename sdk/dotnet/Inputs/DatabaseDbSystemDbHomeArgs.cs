...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseDbSystemDbHomeArgs : Pulumi.ResourceArgs
    {
        [Input("createAsync")]
        ...
        public Input<Inputs.DatabaseDbSystemDbHomeDatabaseArgs> Database { get; set; } = null!;
        ...
        public DatabaseDbSystemDbHomeArgs()
        {
        }
    }
}
