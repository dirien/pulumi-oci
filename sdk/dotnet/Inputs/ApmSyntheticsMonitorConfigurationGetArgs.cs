...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApmSyntheticsMonitorConfigurationGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsGetArgs>? ReqAuthenticationDetails { get; set; }
        ...
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderGetArgs>? _requestHeaders;

        /// <summary>
        /// (Updatable) List of request headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderGetArgs> RequestHeaders
        {
            get => _requestHeaders ?? (_requestHeaders = new InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderGetArgs>());
        ...
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamGetArgs>? _requestQueryParams;

        /// <summary>
        /// (Updatable) List of request query params. Example: `[{"paramName": "sortOrder", "paramValue": "asc"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamGetArgs> RequestQueryParams
        {
            get => _requestQueryParams ?? (_requestQueryParams = new InputList<Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamGetArgs>());
        ...
        [Input("verifyTexts")]
        private InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextGetArgs>? _verifyTexts;
        ...
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextGetArgs> VerifyTexts
        {
            get => _verifyTexts ?? (_verifyTexts = new InputList<Inputs.ApmSyntheticsMonitorConfigurationVerifyTextGetArgs>());
            set => _verifyTexts = value;
        }

        public ApmSyntheticsMonitorConfigurationGetArgs()
        {
        }
    }
}
