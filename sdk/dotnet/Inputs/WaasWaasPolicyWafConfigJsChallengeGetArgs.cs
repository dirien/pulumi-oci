...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigJsChallengeGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeChallengeSettingsGetArgs>? ChallengeSettings { get; set; }

        [Input("criterias")]
        private InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaGetArgs>? _criterias;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaGetArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.WaasWaasPolicyWafConfigJsChallengeCriteriaGetArgs>());
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeSetHttpHeaderGetArgs>? SetHttpHeader { get; set; }

        public WaasWaasPolicyWafConfigJsChallengeGetArgs()
        {
        }
    }
}
