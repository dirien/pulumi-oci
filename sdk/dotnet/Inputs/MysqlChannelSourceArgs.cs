...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class MysqlChannelSourceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.MysqlChannelSourceSslCaCertificateArgs>? SslCaCertificate { get; set; }
