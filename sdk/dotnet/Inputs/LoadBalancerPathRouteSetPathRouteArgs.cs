...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class LoadBalancerPathRouteSetPathRouteArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.LoadBalancerPathRouteSetPathRoutePathMatchTypeArgs> PathMatchType { get; set; } = null!;

        public LoadBalancerPathRouteSetPathRouteArgs()
        {
        }
    }
}
