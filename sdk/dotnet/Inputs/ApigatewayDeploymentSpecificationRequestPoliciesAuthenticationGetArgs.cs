...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationGetArgs : Pulumi.ResourceArgs
    {
        [Input("audiences")]
        ...
        /// </summary>
        [Input("publicKeys")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationPublicKeysGetArgs>? PublicKeys { get; set; }
        ...
        [Input("verifyClaims")]
        private InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimGetArgs>? _verifyClaims;

        /// <summary>
        /// (Updatable) A list of claims which should be validated to consider the token valid.
        /// </summary>
        public InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimGetArgs> VerifyClaims
        {
            get => _verifyClaims ?? (_verifyClaims = new InputList<Inputs.ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationVerifyClaimGetArgs>());
            set => _verifyClaims = value;
        }

        public ApigatewayDeploymentSpecificationRequestPoliciesAuthenticationGetArgs()
        {
        }
    }
}
