...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DatabaseDbSystemDbHomeGetArgs : Pulumi.ResourceArgs
    {
        [Input("createAsync")]
        ...
        public Input<Inputs.DatabaseDbSystemDbHomeDatabaseGetArgs> Database { get; set; } = null!;
        ...
        public DatabaseDbSystemDbHomeGetArgs()
        {
        }
    }
}
