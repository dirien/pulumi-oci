...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigCustomProtectionRuleGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs>? _exclusions;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs>());
        ...
        public WaasWaasPolicyWafConfigCustomProtectionRuleGetArgs()
        {
        }
    }
}
