...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class DnsSteeringPolicyRuleCaseArgs : Pulumi.ResourceArgs
    {
        [Input("answerDatas")]
        private InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataArgs>? _answerDatas;

        /// <summary>
        /// An array of `SteeringPolicyPriorityAnswerData` objects.
        /// </summary>
        public InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataArgs> AnswerDatas
        {
            get => _answerDatas ?? (_answerDatas = new InputList<Inputs.DnsSteeringPolicyRuleCaseAnswerDataArgs>());
        ...
        public DnsSteeringPolicyRuleCaseArgs()
        {
        }
    }
}
