...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRouteBackendGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("headers")]
        private InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderGetArgs>? _headers;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderGetArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.ApigatewayDeploymentSpecificationRouteBackendHeaderGetArgs>());
            set => _headers = value;
        }
        ...
        public ApigatewayDeploymentSpecificationRouteBackendGetArgs()
        {
        }
    }
}
