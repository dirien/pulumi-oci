...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class CoreInstanceConfigurationInstanceDetailsLaunchDetailsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration options for the Oracle Cloud Agent software running on the instance.
        /// </summary>
        [Input("agentConfig")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsAgentConfigArgs>? AgentConfig { get; set; }

        /// <summary>
        /// Options for defining the availabiity of a VM instance after a maintenance event that impacts the underlying hardware.
        /// </summary>
        [Input("availabilityConfig")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsAvailabilityConfigArgs>? AvailabilityConfig { get; set; }
        ...
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsCreateVnicDetailsArgs>? CreateVnicDetails { get; set; }
        ...
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptionsArgs>? InstanceOptions { get; set; }
        ...
        /// </summary>
        [Input("launchOptions")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsLaunchOptionsArgs>? LaunchOptions { get; set; }
        ...
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsPlatformConfigArgs>? PlatformConfig { get; set; }

        /// <summary>
        /// Configuration options for preemptible instances.
        /// </summary>
        [Input("preemptibleInstanceConfig")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsPreemptibleInstanceConfigArgs>? PreemptibleInstanceConfig { get; set; }
        ...
        /// </summary>
        [Input("shapeConfig")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsShapeConfigArgs>? ShapeConfig { get; set; }

        [Input("sourceDetails")]
        public Input<Inputs.CoreInstanceConfigurationInstanceDetailsLaunchDetailsSourceDetailsArgs>? SourceDetails { get; set; }

        public CoreInstanceConfigurationInstanceDetailsLaunchDetailsArgs()
        {
        }
    }
}
