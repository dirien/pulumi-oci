...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyWafConfigArgs : Pulumi.ResourceArgs
    {
        [Input("accessRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleArgs>? _accessRules;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleArgs> AccessRules
        {
            get => _accessRules ?? (_accessRules = new InputList<Inputs.WaasWaasPolicyWafConfigAccessRuleArgs>());
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigAddressRateLimitingArgs>? AddressRateLimiting { get; set; }

        [Input("cachingRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleArgs>? _cachingRules;

        /// <summary>
        /// (Updatable) A list of caching rules applied to the web application.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleArgs> CachingRules
        {
            get => _cachingRules ?? (_cachingRules = new InputList<Inputs.WaasWaasPolicyWafConfigCachingRuleArgs>());
            set => _cachingRules = value;
        }

        [Input("captchas")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCaptchaArgs>? _captchas;
        ...
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCaptchaArgs> Captchas
        {
            get => _captchas ?? (_captchas = new InputList<Inputs.WaasWaasPolicyWafConfigCaptchaArgs>());
            set => _captchas = value;
        }

        [Input("customProtectionRules")]
        private InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleArgs>? _customProtectionRules;

        /// <summary>
        /// (Updatable) A list of the custom protection rule OCIDs and their actions.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleArgs> CustomProtectionRules
        {
            get => _customProtectionRules ?? (_customProtectionRules = new InputList<Inputs.WaasWaasPolicyWafConfigCustomProtectionRuleArgs>());
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigDeviceFingerprintChallengeArgs>? DeviceFingerprintChallenge { get; set; }
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigHumanInteractionChallengeArgs>? HumanInteractionChallenge { get; set; }
        ...
        /// </summary>
        [Input("jsChallenge")]
        public Input<Inputs.WaasWaasPolicyWafConfigJsChallengeArgs>? JsChallenge { get; set; }
        ...
        public Input<Inputs.WaasWaasPolicyWafConfigProtectionSettingsArgs>? ProtectionSettings { get; set; }

        [Input("whitelists")]
        private InputList<Inputs.WaasWaasPolicyWafConfigWhitelistArgs>? _whitelists;

        /// <summary>
        /// (Updatable) A list of IP addresses that bypass the Web Application Firewall.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyWafConfigWhitelistArgs> Whitelists
        {
            get => _whitelists ?? (_whitelists = new InputList<Inputs.WaasWaasPolicyWafConfigWhitelistArgs>());
            set => _whitelists = value;
        }

        public WaasWaasPolicyWafConfigArgs()
        {
        }
    }
}
