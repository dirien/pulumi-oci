...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class ApigatewayDeploymentSpecificationRouteGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The backend to forward requests to.
        /// </summary>
        [Input("backend", required: true)]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteBackendGetArgs> Backend { get; set; } = null!;

        /// <summary>
        /// (Updatable) Policies controlling the pushing of logs to Oracle Cloud Infrastructure Public Logging.
        /// </summary>
        [Input("loggingPolicies")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteLoggingPoliciesGetArgs>? LoggingPolicies { get; set; }
        ...
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteRequestPoliciesGetArgs>? RequestPolicies { get; set; }

        /// <summary>
        /// (Updatable) Behavior applied to any responses sent by the API for requests on this route.
        /// </summary>
        [Input("responsePolicies")]
        public Input<Inputs.ApigatewayDeploymentSpecificationRouteResponsePoliciesGetArgs>? ResponsePolicies { get; set; }

        public ApigatewayDeploymentSpecificationRouteGetArgs()
        {
        }
    }
}
