...
namespace Pulumi.Oci.Inputs
{
    ...
    public sealed class WaasWaasPolicyOriginArgs : Pulumi.ResourceArgs
    {
        [Input("customHeaders")]
        private InputList<Inputs.WaasWaasPolicyOriginCustomHeaderArgs>? _customHeaders;

        /// <summary>
        /// (Updatable) A list of HTTP headers to forward to your origin.
        /// </summary>
        public InputList<Inputs.WaasWaasPolicyOriginCustomHeaderArgs> CustomHeaders
        {
            get => _customHeaders ?? (_customHeaders = new InputList<Inputs.WaasWaasPolicyOriginCustomHeaderArgs>());
        ...
        public WaasWaasPolicyOriginArgs()
        {
        }
    }
}
