...
{
    public static class GetCoreAppCatalogListingResourceVersion
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testAppCatalogListingResourceVersion = Output.Create(Oci.GetCoreAppCatalogListingResourceVersion.InvokeAsync(new Oci.GetCoreAppCatalogListingResourceVersionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreAppCatalogListingResourceVersionResult> InvokeAsync(GetCoreAppCatalogListingResourceVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreAppCatalogListingResourceVersionResult>("oci:index/getCoreAppCatalogListingResourceVersion:GetCoreAppCatalogListingResourceVersion", args ?? new GetCoreAppCatalogListingResourceVersionArgs(), options.WithVersion());
    }


    public sealed class GetCoreAppCatalogListingResourceVersionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreAppCatalogListingResourceVersionArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreAppCatalogListingResourceVersionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreAppCatalogListingResourceVersionResult(
