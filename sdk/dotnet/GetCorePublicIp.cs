...
{
    public static class GetCorePublicIp
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testOciCorePublicIpById = Output.Create(Oci.GetCorePublicIp.InvokeAsync(new Oci.GetCorePublicIpArgs
        ///         {
        ...
        ///     public MyStack()
        ///     {
        ///         var testOciCorePublicIpByPrivateIpId = Output.Create(Oci.GetCorePublicIp.InvokeAsync(new Oci.GetCorePublicIpArgs
        ///         {
        ...
        ///     public MyStack()
        ///     {
        ///         var testOciCorePublicIpByIp = Output.Create(Oci.GetCorePublicIp.InvokeAsync(new Oci.GetCorePublicIpArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCorePublicIpResult> InvokeAsync(GetCorePublicIpArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCorePublicIpResult>("oci:index/getCorePublicIp:GetCorePublicIp", args ?? new GetCorePublicIpArgs(), options.WithVersion());
    }


    public sealed class GetCorePublicIpArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCorePublicIpResult
    {
        /// <summary>
