...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testNatGateway = new Oci.CoreNatGateway("testNatGateway", new Oci.CoreNatGatewayArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreNatGateway:CoreNatGateway")]
    public partial class CoreNatGateway : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreNatGateway(string name, CoreNatGatewayArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreNatGateway:CoreNatGateway", name, args ?? new CoreNatGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreNatGateway(string name, Input<string> id, CoreNatGatewayState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreNatGateway:CoreNatGateway", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreNatGateway Get(string name, Input<string> id, CoreNatGatewayState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreNatGateway(name, id, state, options);
        }
    }

    public sealed class CoreNatGatewayArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Whether the NAT gateway blocks traffic through it. The default is `false`.  Example: `true`
        /// </summary>
        ...
        public CoreNatGatewayArgs()
        {
        }
    }

    public sealed class CoreNatGatewayState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Whether the NAT gateway blocks traffic through it. The default is `false`.  Example: `true`
        /// </summary>
