...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVirtualCircuit = new Oci.CoreVirtualCircuit("testVirtualCircuit", new Oci.CoreVirtualCircuitArgs
    ///         {
    ...
    ///             {
    ///                 new Oci.Inputs.CoreVirtualCircuitCrossConnectMappingArgs
    ///                 {
    ...
    ///             PublicPrefixes = 
    ///             {
    ///                 new Oci.Inputs.CoreVirtualCircuitPublicPrefixArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreVirtualCircuit:CoreVirtualCircuit")]
    public partial class CoreVirtualCircuit : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CoreVirtualCircuitCrossConnectMapping>> CrossConnectMappings { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.CoreVirtualCircuitPublicPrefix>> PublicPrefixes { get; private set; } = null!;
        ...
        public CoreVirtualCircuit(string name, CoreVirtualCircuitArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreVirtualCircuit:CoreVirtualCircuit", name, args ?? new CoreVirtualCircuitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreVirtualCircuit(string name, Input<string> id, CoreVirtualCircuitState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreVirtualCircuit:CoreVirtualCircuit", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreVirtualCircuit Get(string name, Input<string> id, CoreVirtualCircuitState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreVirtualCircuit(name, id, state, options);
        }
    }

    public sealed class CoreVirtualCircuitArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The provisioned data rate of the connection. To get a list of the available bandwidth levels (that is, shapes), see [ListFastConnectProviderServiceVirtualCircuitBandwidthShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/FastConnectProviderService/ListFastConnectProviderVirtualCircuitBandwidthShapes).  Example: `10 Gbps`
        /// </summary>
        ...
        private InputList<Inputs.CoreVirtualCircuitCrossConnectMappingArgs>? _crossConnectMappings;

        /// <summary>
        /// (Updatable) Create a `CrossConnectMapping` for each cross-connect or cross-connect group this virtual circuit will run on.
        /// </summary>
        public InputList<Inputs.CoreVirtualCircuitCrossConnectMappingArgs> CrossConnectMappings
        {
            get => _crossConnectMappings ?? (_crossConnectMappings = new InputList<Inputs.CoreVirtualCircuitCrossConnectMappingArgs>());
        ...
        private InputList<Inputs.CoreVirtualCircuitPublicPrefixArgs>? _publicPrefixes;

        /// <summary>
        /// (Updatable) For a public virtual circuit. The public IP prefixes (CIDRs) the customer wants to advertise across the connection.
        /// </summary>
        public InputList<Inputs.CoreVirtualCircuitPublicPrefixArgs> PublicPrefixes
        {
            get => _publicPrefixes ?? (_publicPrefixes = new InputList<Inputs.CoreVirtualCircuitPublicPrefixArgs>());
        ...
        public CoreVirtualCircuitArgs()
        {
        }
    }

    public sealed class CoreVirtualCircuitState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The provisioned data rate of the connection. To get a list of the available bandwidth levels (that is, shapes), see [ListFastConnectProviderServiceVirtualCircuitBandwidthShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/FastConnectProviderService/ListFastConnectProviderVirtualCircuitBandwidthShapes).  Example: `10 Gbps`
        /// </summary>
        ...
        [Input("crossConnectMappings")]
        private InputList<Inputs.CoreVirtualCircuitCrossConnectMappingGetArgs>? _crossConnectMappings;

        /// <summary>
        /// (Updatable) Create a `CrossConnectMapping` for each cross-connect or cross-connect group this virtual circuit will run on.
        /// </summary>
        public InputList<Inputs.CoreVirtualCircuitCrossConnectMappingGetArgs> CrossConnectMappings
        {
            get => _crossConnectMappings ?? (_crossConnectMappings = new InputList<Inputs.CoreVirtualCircuitCrossConnectMappingGetArgs>());
            set => _crossConnectMappings = value;
        }
        ...
        [Input("publicPrefixes")]
        private InputList<Inputs.CoreVirtualCircuitPublicPrefixGetArgs>? _publicPrefixes;

        /// <summary>
        /// (Updatable) For a public virtual circuit. The public IP prefixes (CIDRs) the customer wants to advertise across the connection.
        /// </summary>
        public InputList<Inputs.CoreVirtualCircuitPublicPrefixGetArgs> PublicPrefixes
        {
            get => _publicPrefixes ?? (_publicPrefixes = new InputList<Inputs.CoreVirtualCircuitPublicPrefixGetArgs>());
            set => _publicPrefixes = value;
        }
        ...
        public CoreVirtualCircuitState()
        {
        }
    }
}
