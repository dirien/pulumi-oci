...
namespace Pulumi.Oci.Blockchain
{
    public static class GetPeer
    {
        ...
        public static Task<GetPeerResult> InvokeAsync(GetPeerArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPeerResult>("oci:blockchain/getPeer:getPeer", args ?? new GetPeerArgs(), options.WithVersion());
    }
    ...
    public sealed class GetPeerResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetPeerOcpuAllocationParamResult OcpuAllocationParam;
        ...
        private GetPeerResult(
            ...
            Outputs.GetPeerOcpuAllocationParamResult ocpuAllocationParam,
