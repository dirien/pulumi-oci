...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDrg = new Oci.CoreDrg("testDrg", new Oci.CoreDrgArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDrg:CoreDrg")]
    public partial class CoreDrg : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.CoreDrgDefaultDrgRouteTables> DefaultDrgRouteTables { get; private set; } = null!;
        ...
        public CoreDrg(string name, CoreDrgArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDrg:CoreDrg", name, args ?? new CoreDrgArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDrg(string name, Input<string> id, CoreDrgState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDrg:CoreDrg", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDrg Get(string name, Input<string> id, CoreDrgState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDrg(name, id, state, options);
        }
    }

    public sealed class CoreDrgArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the DRG.
        /// </summary>
    ...
    public sealed class CoreDrgState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the DRG.
        /// </summary>
        ...
        public Input<Inputs.CoreDrgDefaultDrgRouteTablesGetArgs>? DefaultDrgRouteTables { get; set; }
