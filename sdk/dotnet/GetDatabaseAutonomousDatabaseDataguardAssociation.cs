...
{
    public static class GetDatabaseAutonomousDatabaseDataguardAssociation
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testAutonomousDatabaseDataguardAssociation = Output.Create(Oci.GetDatabaseAutonomousDatabaseDataguardAssociation.InvokeAsync(new Oci.GetDatabaseAutonomousDatabaseDataguardAssociationArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseAutonomousDatabaseDataguardAssociationResult> InvokeAsync(GetDatabaseAutonomousDatabaseDataguardAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseAutonomousDatabaseDataguardAssociationResult>("oci:index/getDatabaseAutonomousDatabaseDataguardAssociation:GetDatabaseAutonomousDatabaseDataguardAssociation", args ?? new GetDatabaseAutonomousDatabaseDataguardAssociationArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseAutonomousDatabaseDataguardAssociationArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatabaseAutonomousDatabaseDataguardAssociationArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseAutonomousDatabaseDataguardAssociationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseAutonomousDatabaseDataguardAssociationResult(
            string applyLag,
