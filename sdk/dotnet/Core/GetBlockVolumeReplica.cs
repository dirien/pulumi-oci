...
namespace Pulumi.Oci.Core
{
    public static class GetBlockVolumeReplica
    {
        ...
        public static Task<GetBlockVolumeReplicaResult> InvokeAsync(GetBlockVolumeReplicaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBlockVolumeReplicaResult>("oci:core/getBlockVolumeReplica:getBlockVolumeReplica", args ?? new GetBlockVolumeReplicaArgs(), options.WithVersion());
    }
