...
namespace Pulumi.Oci.Core
{
    public static class GetDedicatedVmHost
    {
        ...
        public static Task<GetDedicatedVmHostResult> InvokeAsync(GetDedicatedVmHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedVmHostResult>("oci:core/getDedicatedVmHost:getDedicatedVmHost", args ?? new GetDedicatedVmHostArgs(), options.WithVersion());
    }
