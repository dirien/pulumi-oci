...
namespace Pulumi.Oci.Core
{
    public static class GetVolumeGroupBackups
    {
        ...
        public static Task<GetVolumeGroupBackupsResult> InvokeAsync(GetVolumeGroupBackupsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeGroupBackupsResult>("oci:core/getVolumeGroupBackups:getVolumeGroupBackups", args ?? new GetVolumeGroupBackupsArgs(), options.WithVersion());
    }
