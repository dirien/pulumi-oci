...
namespace Pulumi.Oci.Core
{
    public static class GetCrossConnect
    {
        ...
        public static Task<GetCrossConnectResult> InvokeAsync(GetCrossConnectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCrossConnectResult>("oci:core/getCrossConnect:getCrossConnect", args ?? new GetCrossConnectArgs(), options.WithVersion());
    }
