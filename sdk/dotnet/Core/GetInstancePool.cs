...
namespace Pulumi.Oci.Core
{
    public static class GetInstancePool
    {
        ...
        public static Task<GetInstancePoolResult> InvokeAsync(GetInstancePoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstancePoolResult>("oci:core/getInstancePool:getInstancePool", args ?? new GetInstancePoolArgs(), options.WithVersion());
    }
