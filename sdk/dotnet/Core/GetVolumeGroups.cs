...
namespace Pulumi.Oci.Core
{
    public static class GetVolumeGroups
    {
        ...
        public static Task<GetVolumeGroupsResult> InvokeAsync(GetVolumeGroupsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeGroupsResult>("oci:core/getVolumeGroups:getVolumeGroups", args ?? new GetVolumeGroupsArgs(), options.WithVersion());
    }
