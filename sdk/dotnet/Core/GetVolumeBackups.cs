...
namespace Pulumi.Oci.Core
{
    public static class GetVolumeBackups
    {
        ...
        public static Task<GetVolumeBackupsResult> InvokeAsync(GetVolumeBackupsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeBackupsResult>("oci:core/getVolumeBackups:getVolumeBackups", args ?? new GetVolumeBackupsArgs(), options.WithVersion());
    }
