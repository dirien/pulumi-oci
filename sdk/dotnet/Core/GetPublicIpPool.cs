...
namespace Pulumi.Oci.Core
{
    public static class GetPublicIpPool
    {
        ...
        public static Task<GetPublicIpPoolResult> InvokeAsync(GetPublicIpPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIpPoolResult>("oci:core/getPublicIpPool:getPublicIpPool", args ?? new GetPublicIpPoolArgs(), options.WithVersion());
    }
