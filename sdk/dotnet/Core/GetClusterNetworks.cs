...
namespace Pulumi.Oci.Core
{
    public static class GetClusterNetworks
    {
        ...
        public static Task<GetClusterNetworksResult> InvokeAsync(GetClusterNetworksArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClusterNetworksResult>("oci:core/getClusterNetworks:getClusterNetworks", args ?? new GetClusterNetworksArgs(), options.WithVersion());
    }
