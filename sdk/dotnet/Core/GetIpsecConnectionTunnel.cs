...
namespace Pulumi.Oci.Core
{
    public static class GetIpsecConnectionTunnel
    {
        ...
        public static Task<GetIpsecConnectionTunnelResult> InvokeAsync(GetIpsecConnectionTunnelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIpsecConnectionTunnelResult>("oci:core/getIpsecConnectionTunnel:getIpsecConnectionTunnel", args ?? new GetIpsecConnectionTunnelArgs(), options.WithVersion());
    }
    ...
    public sealed class GetIpsecConnectionTunnelResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetIpsecConnectionTunnelEncryptionDomainConfigResult EncryptionDomainConfig;
        /// <summary>
        ...
        private GetIpsecConnectionTunnelResult(
            ...
            Outputs.GetIpsecConnectionTunnelEncryptionDomainConfigResult encryptionDomainConfig,
