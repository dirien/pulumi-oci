...
namespace Pulumi.Oci.Core
{
    public static class GetComputeImageCapabilitySchema
    {
        ...
        public static Task<GetComputeImageCapabilitySchemaResult> InvokeAsync(GetComputeImageCapabilitySchemaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeImageCapabilitySchemaResult>("oci:core/getComputeImageCapabilitySchema:getComputeImageCapabilitySchema", args ?? new GetComputeImageCapabilitySchemaArgs(), options.WithVersion());
    }
