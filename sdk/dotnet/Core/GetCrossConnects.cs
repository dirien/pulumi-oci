...
namespace Pulumi.Oci.Core
{
    public static class GetCrossConnects
    {
        ...
        public static Task<GetCrossConnectsResult> InvokeAsync(GetCrossConnectsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCrossConnectsResult>("oci:core/getCrossConnects:getCrossConnects", args ?? new GetCrossConnectsArgs(), options.WithVersion());
    }
