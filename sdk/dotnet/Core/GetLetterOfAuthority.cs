...
namespace Pulumi.Oci.Core
{
    public static class GetLetterOfAuthority
    {
        ...
        public static Task<GetLetterOfAuthorityResult> InvokeAsync(GetLetterOfAuthorityArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLetterOfAuthorityResult>("oci:core/getLetterOfAuthority:getLetterOfAuthority", args ?? new GetLetterOfAuthorityArgs(), options.WithVersion());
    }
