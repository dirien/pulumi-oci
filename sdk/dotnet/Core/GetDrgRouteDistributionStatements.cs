...
namespace Pulumi.Oci.Core
{
    public static class GetDrgRouteDistributionStatements
    {
        ...
        public static Task<GetDrgRouteDistributionStatementsResult> InvokeAsync(GetDrgRouteDistributionStatementsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDrgRouteDistributionStatementsResult>("oci:core/getDrgRouteDistributionStatements:getDrgRouteDistributionStatements", args ?? new GetDrgRouteDistributionStatementsArgs(), options.WithVersion());
    }
