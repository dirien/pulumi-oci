...
namespace Pulumi.Oci.Core
{
    public static class GetComputeGlobalImageCapabilitySchemasVersions
    {
        ...
        public static Task<GetComputeGlobalImageCapabilitySchemasVersionsResult> InvokeAsync(GetComputeGlobalImageCapabilitySchemasVersionsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeGlobalImageCapabilitySchemasVersionsResult>("oci:core/getComputeGlobalImageCapabilitySchemasVersions:getComputeGlobalImageCapabilitySchemasVersions", args ?? new GetComputeGlobalImageCapabilitySchemasVersionsArgs(), options.WithVersion());
    }
