...
namespace Pulumi.Oci.Core
{
    public static class GetCrossConnectGroup
    {
        ...
        public static Task<GetCrossConnectGroupResult> InvokeAsync(GetCrossConnectGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCrossConnectGroupResult>("oci:core/getCrossConnectGroup:getCrossConnectGroup", args ?? new GetCrossConnectGroupArgs(), options.WithVersion());
    }
