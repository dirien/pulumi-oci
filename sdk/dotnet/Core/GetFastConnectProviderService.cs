...
namespace Pulumi.Oci.Core
{
    public static class GetFastConnectProviderService
    {
        ...
        public static Task<GetFastConnectProviderServiceResult> InvokeAsync(GetFastConnectProviderServiceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFastConnectProviderServiceResult>("oci:core/getFastConnectProviderService:getFastConnectProviderService", args ?? new GetFastConnectProviderServiceArgs(), options.WithVersion());
    }
