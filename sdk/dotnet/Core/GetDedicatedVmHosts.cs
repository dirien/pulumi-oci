...
namespace Pulumi.Oci.Core
{
    public static class GetDedicatedVmHosts
    {
        ...
        public static Task<GetDedicatedVmHostsResult> InvokeAsync(GetDedicatedVmHostsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedVmHostsResult>("oci:core/getDedicatedVmHosts:getDedicatedVmHosts", args ?? new GetDedicatedVmHostsArgs(), options.WithVersion());
    }
