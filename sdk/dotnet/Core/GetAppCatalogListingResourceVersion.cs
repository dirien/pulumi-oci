...
namespace Pulumi.Oci.Core
{
    public static class GetAppCatalogListingResourceVersion
    {
        ...
        public static Task<GetAppCatalogListingResourceVersionResult> InvokeAsync(GetAppCatalogListingResourceVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAppCatalogListingResourceVersionResult>("oci:core/getAppCatalogListingResourceVersion:getAppCatalogListingResourceVersion", args ?? new GetAppCatalogListingResourceVersionArgs(), options.WithVersion());
    }
