...
namespace Pulumi.Oci.Core
{
    public static class GetBootVolumeReplicas
    {
        ...
        public static Task<GetBootVolumeReplicasResult> InvokeAsync(GetBootVolumeReplicasArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBootVolumeReplicasResult>("oci:core/getBootVolumeReplicas:getBootVolumeReplicas", args ?? new GetBootVolumeReplicasArgs(), options.WithVersion());
    }
