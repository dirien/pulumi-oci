...
namespace Pulumi.Oci.Core
{
    public static class GetInstanceCredentials
    {
        ...
        public static Task<GetInstanceCredentialsResult> InvokeAsync(GetInstanceCredentialsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceCredentialsResult>("oci:core/getInstanceCredentials:getInstanceCredentials", args ?? new GetInstanceCredentialsArgs(), options.WithVersion());
    }
