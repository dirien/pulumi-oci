...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptionsResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetInstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptionsResult(bool areLegacyImdsEndpointsDisabled)
        {
