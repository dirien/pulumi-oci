...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceConfigurationInstanceDetailsLaunchDetailsAgentConfigPluginsConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetInstanceConfigurationInstanceDetailsLaunchDetailsAgentConfigPluginsConfigResult(
            string desiredState,
