...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceConfigurationsInstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptionsResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetInstanceConfigurationsInstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptionsResult(bool areLegacyImdsEndpointsDisabled)
        {
