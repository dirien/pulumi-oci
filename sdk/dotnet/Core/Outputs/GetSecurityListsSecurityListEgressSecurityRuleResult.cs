...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    public sealed class GetSecurityListsSecurityListEgressSecurityRuleResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetSecurityListsSecurityListEgressSecurityRuleIcmpOptionsResult IcmpOptions;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetSecurityListsSecurityListEgressSecurityRuleTcpOptionsResult TcpOptions;
        /// <summary>
        /// Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed. 
        /// * The following 2 attributes specify an inclusive range of allowed destination ports. Use the same number for the min and max to indicate a single port. Defaults to all ports if not specified.
        /// </summary>
        public readonly Outputs.GetSecurityListsSecurityListEgressSecurityRuleUdpOptionsResult UdpOptions;
        ...
        private GetSecurityListsSecurityListEgressSecurityRuleResult(
            ...
            Outputs.GetSecurityListsSecurityListEgressSecurityRuleIcmpOptionsResult icmpOptions,

            string protocol,

            bool stateless,

            Outputs.GetSecurityListsSecurityListEgressSecurityRuleTcpOptionsResult tcpOptions,

            Outputs.GetSecurityListsSecurityListEgressSecurityRuleUdpOptionsResult udpOptions)
        {
