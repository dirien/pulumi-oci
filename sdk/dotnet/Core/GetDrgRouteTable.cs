...
{
    public static class GetDrgRouteTable
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDrgRouteTable = Output.Create(Oci.Core.GetDrgRouteTable.InvokeAsync(new Oci.Core.GetDrgRouteTableArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDrgRouteTableResult> InvokeAsync(GetDrgRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDrgRouteTableResult>("oci:core/getDrgRouteTable:getDrgRouteTable", args ?? new GetDrgRouteTableArgs(), options.WithVersion());
    }


    public sealed class GetDrgRouteTableArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetDrgRouteTableResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDrgRouteTableResult(
