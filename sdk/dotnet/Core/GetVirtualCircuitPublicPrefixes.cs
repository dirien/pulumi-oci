...
namespace Pulumi.Oci.Core
{
    public static class GetVirtualCircuitPublicPrefixes
    {
        ...
        public static Task<GetVirtualCircuitPublicPrefixesResult> InvokeAsync(GetVirtualCircuitPublicPrefixesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualCircuitPublicPrefixesResult>("oci:core/getVirtualCircuitPublicPrefixes:getVirtualCircuitPublicPrefixes", args ?? new GetVirtualCircuitPublicPrefixesArgs(), options.WithVersion());
    }
