...
namespace Pulumi.Oci.Core
{
    public static class GetComputeGlobalImageCapabilitySchemasVersion
    {
        ...
        public static Task<GetComputeGlobalImageCapabilitySchemasVersionResult> InvokeAsync(GetComputeGlobalImageCapabilitySchemasVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeGlobalImageCapabilitySchemasVersionResult>("oci:core/getComputeGlobalImageCapabilitySchemasVersion:getComputeGlobalImageCapabilitySchemasVersion", args ?? new GetComputeGlobalImageCapabilitySchemasVersionArgs(), options.WithVersion());
    }
