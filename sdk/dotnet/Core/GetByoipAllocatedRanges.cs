...
namespace Pulumi.Oci.Core
{
    public static class GetByoipAllocatedRanges
    {
        ...
        public static Task<GetByoipAllocatedRangesResult> InvokeAsync(GetByoipAllocatedRangesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetByoipAllocatedRangesResult>("oci:core/getByoipAllocatedRanges:getByoipAllocatedRanges", args ?? new GetByoipAllocatedRangesArgs(), options.WithVersion());
    }
