...
namespace Pulumi.Oci.Core
{
    public static class GetInstancePoolLoadBalancerAttachment
    {
        ...
        public static Task<GetInstancePoolLoadBalancerAttachmentResult> InvokeAsync(GetInstancePoolLoadBalancerAttachmentArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstancePoolLoadBalancerAttachmentResult>("oci:core/getInstancePoolLoadBalancerAttachment:getInstancePoolLoadBalancerAttachment", args ?? new GetInstancePoolLoadBalancerAttachmentArgs(), options.WithVersion());
    }
