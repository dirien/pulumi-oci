...
namespace Pulumi.Oci.Core
{
    public static class GetComputeGlobalImageCapabilitySchema
    {
        ...
        public static Task<GetComputeGlobalImageCapabilitySchemaResult> InvokeAsync(GetComputeGlobalImageCapabilitySchemaArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeGlobalImageCapabilitySchemaResult>("oci:core/getComputeGlobalImageCapabilitySchema:getComputeGlobalImageCapabilitySchema", args ?? new GetComputeGlobalImageCapabilitySchemaArgs(), options.WithVersion());
    }
