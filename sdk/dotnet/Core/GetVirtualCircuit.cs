...
namespace Pulumi.Oci.Core
{
    public static class GetVirtualCircuit
    {
        ...
        public static Task<GetVirtualCircuitResult> InvokeAsync(GetVirtualCircuitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualCircuitResult>("oci:core/getVirtualCircuit:getVirtualCircuit", args ?? new GetVirtualCircuitArgs(), options.WithVersion());
    }
