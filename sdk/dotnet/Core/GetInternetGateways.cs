...
namespace Pulumi.Oci.Core
{
    public static class GetInternetGateways
    {
        ...
        public static Task<GetInternetGatewaysResult> InvokeAsync(GetInternetGatewaysArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInternetGatewaysResult>("oci:core/getInternetGateways:getInternetGateways", args ?? new GetInternetGatewaysArgs(), options.WithVersion());
    }
