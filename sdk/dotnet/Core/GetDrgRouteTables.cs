...
namespace Pulumi.Oci.Core
{
    public static class GetDrgRouteTables
    {
        ...
        public static Task<GetDrgRouteTablesResult> InvokeAsync(GetDrgRouteTablesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDrgRouteTablesResult>("oci:core/getDrgRouteTables:getDrgRouteTables", args ?? new GetDrgRouteTablesArgs(), options.WithVersion());
    }
