...
namespace Pulumi.Oci.Core
{
    public static class GetInstancePools
    {
        ...
        public static Task<GetInstancePoolsResult> InvokeAsync(GetInstancePoolsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstancePoolsResult>("oci:core/getInstancePools:getInstancePools", args ?? new GetInstancePoolsArgs(), options.WithVersion());
    }
