...
namespace Pulumi.Oci.Core
{
    public static class GetVnicAttachments
    {
        ...
        public static Task<GetVnicAttachmentsResult> InvokeAsync(GetVnicAttachmentsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVnicAttachmentsResult>("oci:core/getVnicAttachments:getVnicAttachments", args ?? new GetVnicAttachmentsArgs(), options.WithVersion());
    }
