...
namespace Pulumi.Oci.Core
{
    public static class GetFastConnectProviderServiceKey
    {
        ...
        public static Task<GetFastConnectProviderServiceKeyResult> InvokeAsync(GetFastConnectProviderServiceKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFastConnectProviderServiceKeyResult>("oci:core/getFastConnectProviderServiceKey:getFastConnectProviderServiceKey", args ?? new GetFastConnectProviderServiceKeyArgs(), options.WithVersion());
    }
