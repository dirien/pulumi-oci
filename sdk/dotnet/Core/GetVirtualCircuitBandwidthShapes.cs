...
namespace Pulumi.Oci.Core
{
    public static class GetVirtualCircuitBandwidthShapes
    {
        ...
        public static Task<GetVirtualCircuitBandwidthShapesResult> InvokeAsync(GetVirtualCircuitBandwidthShapesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualCircuitBandwidthShapesResult>("oci:core/getVirtualCircuitBandwidthShapes:getVirtualCircuitBandwidthShapes", args ?? new GetVirtualCircuitBandwidthShapesArgs(), options.WithVersion());
    }
