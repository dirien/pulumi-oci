...
namespace Pulumi.Oci.Core
{
    public static class GetDrgRouteDistribution
    {
        ...
        public static Task<GetDrgRouteDistributionResult> InvokeAsync(GetDrgRouteDistributionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDrgRouteDistributionResult>("oci:core/getDrgRouteDistribution:getDrgRouteDistribution", args ?? new GetDrgRouteDistributionArgs(), options.WithVersion());
    }
