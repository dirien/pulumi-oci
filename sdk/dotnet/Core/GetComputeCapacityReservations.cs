...
namespace Pulumi.Oci.Core
{
    public static class GetComputeCapacityReservations
    {
        ...
        public static Task<GetComputeCapacityReservationsResult> InvokeAsync(GetComputeCapacityReservationsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetComputeCapacityReservationsResult>("oci:core/getComputeCapacityReservations:getComputeCapacityReservations", args ?? new GetComputeCapacityReservationsArgs(), options.WithVersion());
    }
