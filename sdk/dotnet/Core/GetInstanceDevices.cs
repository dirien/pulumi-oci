...
namespace Pulumi.Oci.Core
{
    public static class GetInstanceDevices
    {
        ...
        public static Task<GetInstanceDevicesResult> InvokeAsync(GetInstanceDevicesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetInstanceDevicesResult>("oci:core/getInstanceDevices:getInstanceDevices", args ?? new GetInstanceDevicesArgs(), options.WithVersion());
    }
