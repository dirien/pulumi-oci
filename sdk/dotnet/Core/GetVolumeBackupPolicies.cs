...
namespace Pulumi.Oci.Core
{
    public static class GetVolumeBackupPolicies
    {
        ...
        public static Task<GetVolumeBackupPoliciesResult> InvokeAsync(GetVolumeBackupPoliciesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeBackupPoliciesResult>("oci:core/getVolumeBackupPolicies:getVolumeBackupPolicies", args ?? new GetVolumeBackupPoliciesArgs(), options.WithVersion());
    }
