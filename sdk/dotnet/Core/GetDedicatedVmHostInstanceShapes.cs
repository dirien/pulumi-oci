...
namespace Pulumi.Oci.Core
{
    public static class GetDedicatedVmHostInstanceShapes
    {
        ...
        public static Task<GetDedicatedVmHostInstanceShapesResult> InvokeAsync(GetDedicatedVmHostInstanceShapesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedVmHostInstanceShapesResult>("oci:core/getDedicatedVmHostInstanceShapes:getDedicatedVmHostInstanceShapes", args ?? new GetDedicatedVmHostInstanceShapesArgs(), options.WithVersion());
    }
