...
namespace Pulumi.Oci.Core
{
    public static class GetVolumeBackupPolicyAssignments
    {
        ...
        public static Task<GetVolumeBackupPolicyAssignmentsResult> InvokeAsync(GetVolumeBackupPolicyAssignmentsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVolumeBackupPolicyAssignmentsResult>("oci:core/getVolumeBackupPolicyAssignments:getVolumeBackupPolicyAssignments", args ?? new GetVolumeBackupPolicyAssignmentsArgs(), options.WithVersion());
    }
