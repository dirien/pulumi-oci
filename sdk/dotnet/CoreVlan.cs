...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVlan = new Oci.CoreVlan("testVlan", new Oci.CoreVlanArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreVlan:CoreVlan")]
    public partial class CoreVlan : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreVlan(string name, CoreVlanArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreVlan:CoreVlan", name, args ?? new CoreVlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreVlan(string name, Input<string> id, CoreVlanState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreVlan:CoreVlan", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreVlan Get(string name, Input<string> id, CoreVlanState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreVlan(name, id, state, options);
        }
    }

    public sealed class CoreVlanArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Controls whether the VLAN is regional or specific to an availability domain. A regional VLAN has the flexibility to implement failover across availability domains. Previously, all VLANs were AD-specific.
        /// </summary>
    ...
    public sealed class CoreVlanState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Controls whether the VLAN is regional or specific to an availability domain. A regional VLAN has the flexibility to implement failover across availability domains. Previously, all VLANs were AD-specific.
        /// </summary>
