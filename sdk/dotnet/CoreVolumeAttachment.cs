...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVolumeAttachment = new Oci.CoreVolumeAttachment("testVolumeAttachment", new Oci.CoreVolumeAttachmentArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreVolumeAttachment:CoreVolumeAttachment")]
    public partial class CoreVolumeAttachment : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CoreVolumeAttachmentMultipathDevice>> MultipathDevices { get; private set; } = null!;
        ...
        public CoreVolumeAttachment(string name, CoreVolumeAttachmentArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreVolumeAttachment:CoreVolumeAttachment", name, args ?? new CoreVolumeAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreVolumeAttachment(string name, Input<string> id, CoreVolumeAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreVolumeAttachment:CoreVolumeAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreVolumeAttachment Get(string name, Input<string> id, CoreVolumeAttachmentState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreVolumeAttachment(name, id, state, options);
        }
    }

    public sealed class CoreVolumeAttachmentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of volume. The only supported values are "iscsi" and "paravirtualized".
        /// </summary>
        ...
        public CoreVolumeAttachmentArgs()
        {
        }
    }

    public sealed class CoreVolumeAttachmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of volume. The only supported values are "iscsi" and "paravirtualized".
        /// </summary>
        ...
        private InputList<Inputs.CoreVolumeAttachmentMultipathDeviceGetArgs>? _multipathDevices;

        /// <summary>
        /// A list of secondary multipath devices
        /// </summary>
        public InputList<Inputs.CoreVolumeAttachmentMultipathDeviceGetArgs> MultipathDevices
        {
            get => _multipathDevices ?? (_multipathDevices = new InputList<Inputs.CoreVolumeAttachmentMultipathDeviceGetArgs>());
        ...
        public CoreVolumeAttachmentState()
        {
        }
    }
}
