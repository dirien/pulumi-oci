...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPrivateIp = new Oci.CorePrivateIp("testPrivateIp", new Oci.CorePrivateIpArgs
    ///         {
    ///             DefinedTags = 
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/corePrivateIp:CorePrivateIp")]
    public partial class CorePrivateIp : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CorePrivateIp(string name, CorePrivateIpArgs? args = null, CustomResourceOptions? options = null)
            : base("oci:index/corePrivateIp:CorePrivateIp", name, args ?? new CorePrivateIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CorePrivateIp(string name, Input<string> id, CorePrivateIpState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/corePrivateIp:CorePrivateIp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CorePrivateIp Get(string name, Input<string> id, CorePrivateIpState? state = null, CustomResourceOptions? options = null)
        {
            return new CorePrivateIp(name, id, state, options);
        }
    }

    public sealed class CorePrivateIpArgs : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
        ...
        public CorePrivateIpArgs()
        {
        }
    }

    public sealed class CorePrivateIpState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The private IP's availability domain. This attribute will be null if this is a *secondary* private IP assigned to a VNIC that is in a *regional* subnet.  Example: `Uocm:PHX-AD-1`
        /// </summary>
