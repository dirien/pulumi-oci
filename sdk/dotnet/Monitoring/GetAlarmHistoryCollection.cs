...
namespace Pulumi.Oci.Monitoring
{
    public static class GetAlarmHistoryCollection
    {
        ...
        public static Task<GetAlarmHistoryCollectionResult> InvokeAsync(GetAlarmHistoryCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlarmHistoryCollectionResult>("oci:monitoring/getAlarmHistoryCollection:getAlarmHistoryCollection", args ?? new GetAlarmHistoryCollectionArgs(), options.WithVersion());
    }
