...
namespace Pulumi.Oci.Monitoring
{
    public static class GetAlarm
    {
        ...
        public static Task<GetAlarmResult> InvokeAsync(GetAlarmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAlarmResult>("oci:monitoring/getAlarm:getAlarm", args ?? new GetAlarmArgs(), options.WithVersion());
    }
    ...
    public sealed class GetAlarmResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetAlarmSuppressionResult Suppression;
        /// <summary>
        ...
        private GetAlarmResult(
            ...
            Outputs.GetAlarmSuppressionResult suppression,
