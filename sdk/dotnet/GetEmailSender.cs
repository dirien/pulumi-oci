...
{
    public static class GetEmailSender
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testSender = Output.Create(Oci.GetEmailSender.InvokeAsync(new Oci.GetEmailSenderArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetEmailSenderResult> InvokeAsync(GetEmailSenderArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEmailSenderResult>("oci:index/getEmailSender:GetEmailSender", args ?? new GetEmailSenderArgs(), options.WithVersion());
    }


    public sealed class GetEmailSenderArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetEmailSenderResult
    {
        /// <summary>
