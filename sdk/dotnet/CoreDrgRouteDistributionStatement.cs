...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDrgRouteDistributionStatement = new Oci.CoreDrgRouteDistributionStatement("testDrgRouteDistributionStatement", new Oci.CoreDrgRouteDistributionStatementArgs
    ///         {
    ...
    ///             MatchCriteria = new Oci.Inputs.CoreDrgRouteDistributionStatementMatchCriteriaArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDrgRouteDistributionStatement:CoreDrgRouteDistributionStatement")]
    public partial class CoreDrgRouteDistributionStatement : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.CoreDrgRouteDistributionStatementMatchCriteria> MatchCriteria { get; private set; } = null!;
        ...
        public CoreDrgRouteDistributionStatement(string name, CoreDrgRouteDistributionStatementArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteDistributionStatement:CoreDrgRouteDistributionStatement", name, args ?? new CoreDrgRouteDistributionStatementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDrgRouteDistributionStatement(string name, Input<string> id, CoreDrgRouteDistributionStatementState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteDistributionStatement:CoreDrgRouteDistributionStatement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDrgRouteDistributionStatement Get(string name, Input<string> id, CoreDrgRouteDistributionStatementState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDrgRouteDistributionStatement(name, id, state, options);
        }
    }

    public sealed class CoreDrgRouteDistributionStatementArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept: import/export the route "as is"
        /// </summary>
        ...
        public Input<Inputs.CoreDrgRouteDistributionStatementMatchCriteriaArgs> MatchCriteria { get; set; } = null!;
        ...
        public CoreDrgRouteDistributionStatementArgs()
        {
        }
    }

    public sealed class CoreDrgRouteDistributionStatementState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Accept: import/export the route "as is"
        /// </summary>
        ...
        /// </summary>
        [Input("matchCriteria")]
        public Input<Inputs.CoreDrgRouteDistributionStatementMatchCriteriaGetArgs>? MatchCriteria { get; set; }
        ...
        public CoreDrgRouteDistributionStatementState()
        {
        }
    }
}
