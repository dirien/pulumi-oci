...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testApplication = new Oci.DataflowApplication("testApplication", new Oci.DataflowApplicationArgs
    ///         {
    ...
    ///             Parameters = 
    ///             {
    ///                 new Oci.Inputs.DataflowApplicationParameterArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/dataflowApplication:DataflowApplication")]
    public partial class DataflowApplication : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.DataflowApplicationParameter>> Parameters { get; private set; } = null!;
        ...
        public DataflowApplication(string name, DataflowApplicationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dataflowApplication:DataflowApplication", name, args ?? new DataflowApplicationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowApplication(string name, Input<string> id, DataflowApplicationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dataflowApplication:DataflowApplication", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataflowApplication Get(string name, Input<string> id, DataflowApplicationState? state = null, CustomResourceOptions? options = null)
        {
            return new DataflowApplication(name, id, state, options);
        }
    }

    public sealed class DataflowApplicationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) An Oracle Cloud Infrastructure URI of an archive.zip file containing custom dependencies that may be used to support the execution a Python, Java, or Scala application. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
        /// </summary>
        ...
        [Input("parameters")]
        private InputList<Inputs.DataflowApplicationParameterArgs>? _parameters;

        /// <summary>
        /// (Updatable) An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        /// </summary>
        public InputList<Inputs.DataflowApplicationParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.DataflowApplicationParameterArgs>());
        ...
        public DataflowApplicationArgs()
        {
        }
    }

    public sealed class DataflowApplicationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) An Oracle Cloud Infrastructure URI of an archive.zip file containing custom dependencies that may be used to support the execution a Python, Java, or Scala application. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
        /// </summary>
        ...
        [Input("parameters")]
        private InputList<Inputs.DataflowApplicationParameterGetArgs>? _parameters;

        /// <summary>
        /// (Updatable) An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        /// </summary>
        public InputList<Inputs.DataflowApplicationParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.DataflowApplicationParameterGetArgs>());
            set => _parameters = value;
        }
        ...
        public DataflowApplicationState()
        {
        }
    }
}
