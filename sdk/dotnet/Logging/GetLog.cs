...
namespace Pulumi.Oci.Logging
{
    public static class GetLog
    {
        ...
        public static Task<GetLogResult> InvokeAsync(GetLogArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLogResult>("oci:logging/getLog:getLog", args ?? new GetLogArgs(), options.WithVersion());
    }
    ...
    public sealed class GetLogResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetLogConfigurationResult Configuration;
        /// <summary>
        ...
        private GetLogResult(
            ...
            Outputs.GetLogConfigurationResult configuration,
