...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDrgRouteTable = new Oci.CoreDrgRouteTable("testDrgRouteTable", new Oci.CoreDrgRouteTableArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDrgRouteTable:CoreDrgRouteTable")]
    public partial class CoreDrgRouteTable : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreDrgRouteTable(string name, CoreDrgRouteTableArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteTable:CoreDrgRouteTable", name, args ?? new CoreDrgRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDrgRouteTable(string name, Input<string> id, CoreDrgRouteTableState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteTable:CoreDrgRouteTable", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDrgRouteTable Get(string name, Input<string> id, CoreDrgRouteTableState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDrgRouteTable(name, id, state, options);
        }
    }

    public sealed class CoreDrgRouteTableArgs : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
        ...
        public CoreDrgRouteTableArgs()
        {
        }
    }

    public sealed class CoreDrgRouteTableState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment the DRG is in. The DRG route table is always in the same compartment as the DRG.
        /// </summary>
