...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testRemotePeeringConnection = new Oci.CoreRemotePeeringConnection("testRemotePeeringConnection", new Oci.CoreRemotePeeringConnectionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreRemotePeeringConnection:CoreRemotePeeringConnection")]
    public partial class CoreRemotePeeringConnection : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreRemotePeeringConnection(string name, CoreRemotePeeringConnectionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreRemotePeeringConnection:CoreRemotePeeringConnection", name, args ?? new CoreRemotePeeringConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreRemotePeeringConnection(string name, Input<string> id, CoreRemotePeeringConnectionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreRemotePeeringConnection:CoreRemotePeeringConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreRemotePeeringConnection Get(string name, Input<string> id, CoreRemotePeeringConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreRemotePeeringConnection(name, id, state, options);
        }
    }

    public sealed class CoreRemotePeeringConnectionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the RPC.
        /// </summary>
        ...
        public CoreRemotePeeringConnectionArgs()
        {
        }
    }

    public sealed class CoreRemotePeeringConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the RPC.
        /// </summary>
        ...
        public CoreRemotePeeringConnectionState()
        {
        }
    }
}
