...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/optimizerResourceAction:OptimizerResourceAction")]
    public partial class OptimizerResourceAction : Pulumi.CustomResource
    {
        /// <summary>
        /// Details about the recommended action.
        /// </summary>
        [Output("action")]
        public Output<Outputs.OptimizerResourceActionAction> Action { get; private set; } = null!;
        ...
        public OptimizerResourceAction(string name, OptimizerResourceActionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/optimizerResourceAction:OptimizerResourceAction", name, args ?? new OptimizerResourceActionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OptimizerResourceAction(string name, Input<string> id, OptimizerResourceActionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/optimizerResourceAction:OptimizerResourceAction", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OptimizerResourceAction Get(string name, Input<string> id, OptimizerResourceActionState? state = null, CustomResourceOptions? options = null)
        {
            return new OptimizerResourceAction(name, id, state, options);
        }
    }

    public sealed class OptimizerResourceActionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique OCID associated with the resource action.
        /// </summary>
        ...
        public OptimizerResourceActionArgs()
        {
        }
    }

    public sealed class OptimizerResourceActionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Details about the recommended action.
        /// </summary>
        [Input("action")]
        public Input<Inputs.OptimizerResourceActionActionGetArgs>? Action { get; set; }
        ...
        public OptimizerResourceActionState()
        {
        }
    }
}
