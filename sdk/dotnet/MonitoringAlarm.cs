...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAlarm = new Oci.MonitoringAlarm("testAlarm", new Oci.MonitoringAlarmArgs
    ///         {
    ...
    ///             Suppression = new Oci.Inputs.MonitoringAlarmSuppressionArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/monitoringAlarm:MonitoringAlarm")]
    public partial class MonitoringAlarm : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("suppression")]
        public Output<Outputs.MonitoringAlarmSuppression> Suppression { get; private set; } = null!;
        ...
        public MonitoringAlarm(string name, MonitoringAlarmArgs args, CustomResourceOptions? options = null)
            : base("oci:index/monitoringAlarm:MonitoringAlarm", name, args ?? new MonitoringAlarmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitoringAlarm(string name, Input<string> id, MonitoringAlarmState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/monitoringAlarm:MonitoringAlarm", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MonitoringAlarm Get(string name, Input<string> id, MonitoringAlarmState? state = null, CustomResourceOptions? options = null)
        {
            return new MonitoringAlarm(name, id, state, options);
        }
    }

    public sealed class MonitoringAlarmArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The human-readable content of the notification delivered. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.  Example: `High CPU usage alert. Follow runbook instructions for resolution.`
        /// </summary>
        ...
        /// </summary>
        [Input("suppression")]
        public Input<Inputs.MonitoringAlarmSuppressionArgs>? Suppression { get; set; }

        public MonitoringAlarmArgs()
        {
        }
    }

    public sealed class MonitoringAlarmState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The human-readable content of the notification delivered. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.  Example: `High CPU usage alert. Follow runbook instructions for resolution.`
        /// </summary>
        ...
        /// </summary>
        [Input("suppression")]
        public Input<Inputs.MonitoringAlarmSuppressionGetArgs>? Suppression { get; set; }
