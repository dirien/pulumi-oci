...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDkim = new Oci.EmailDkim("testDkim", new Oci.EmailDkimArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/emailDkim:EmailDkim")]
    public partial class EmailDkim : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public EmailDkim(string name, EmailDkimArgs args, CustomResourceOptions? options = null)
            : base("oci:index/emailDkim:EmailDkim", name, args ?? new EmailDkimArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailDkim(string name, Input<string> id, EmailDkimState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/emailDkim:EmailDkim", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EmailDkim Get(string name, Input<string> id, EmailDkimState? state = null, CustomResourceOptions? options = null)
        {
            return new EmailDkim(name, id, state, options);
        }
    }

    public sealed class EmailDkimArgs : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
        ...
        public EmailDkimArgs()
        {
        }
    }

    public sealed class EmailDkimState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The DNS CNAME record value to provision to the DKIM DNS subdomain, when using the CNAME method for DKIM setup (preferred).
        /// </summary>
