...
{
    public static class GetDatascienceModelProvenance
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testModelProvenance = Output.Create(Oci.GetDatascienceModelProvenance.InvokeAsync(new Oci.GetDatascienceModelProvenanceArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatascienceModelProvenanceResult> InvokeAsync(GetDatascienceModelProvenanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatascienceModelProvenanceResult>("oci:index/getDatascienceModelProvenance:GetDatascienceModelProvenance", args ?? new GetDatascienceModelProvenanceArgs(), options.WithVersion());
    }


    public sealed class GetDatascienceModelProvenanceArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatascienceModelProvenanceArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatascienceModelProvenanceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatascienceModelProvenanceResult(
            string gitBranch,
