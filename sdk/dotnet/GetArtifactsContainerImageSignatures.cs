...
{
    public static class GetArtifactsContainerImageSignatures
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testContainerImageSignatures = Output.Create(Oci.GetArtifactsContainerImageSignatures.InvokeAsync(new Oci.GetArtifactsContainerImageSignaturesArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetArtifactsContainerImageSignaturesResult> InvokeAsync(GetArtifactsContainerImageSignaturesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArtifactsContainerImageSignaturesResult>("oci:index/getArtifactsContainerImageSignatures:GetArtifactsContainerImageSignatures", args ?? new GetArtifactsContainerImageSignaturesArgs(), options.WithVersion());
    }


    public sealed class GetArtifactsContainerImageSignaturesArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetArtifactsContainerImageSignaturesFilterArgs>? _filters;
        public List<Inputs.GetArtifactsContainerImageSignaturesFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetArtifactsContainerImageSignaturesFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetArtifactsContainerImageSignaturesArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetArtifactsContainerImageSignaturesResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetArtifactsContainerImageSignaturesContainerImageSignatureCollectionResult> ContainerImageSignatureCollections;
        /// <summary>
        ...
        public readonly ImmutableArray<Outputs.GetArtifactsContainerImageSignaturesFilterResult> Filters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetArtifactsContainerImageSignaturesResult(
            string compartmentId,

            bool? compartmentIdInSubtree,

            ImmutableArray<Outputs.GetArtifactsContainerImageSignaturesContainerImageSignatureCollectionResult> containerImageSignatureCollections,

            string? displayName,

            ImmutableArray<Outputs.GetArtifactsContainerImageSignaturesFilterResult> filters,
