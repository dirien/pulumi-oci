...
{
    public static class GetMonitoringAlarm
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testAlarm = Output.Create(Oci.GetMonitoringAlarm.InvokeAsync(new Oci.GetMonitoringAlarmArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetMonitoringAlarmResult> InvokeAsync(GetMonitoringAlarmArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMonitoringAlarmResult>("oci:index/getMonitoringAlarm:GetMonitoringAlarm", args ?? new GetMonitoringAlarmArgs(), options.WithVersion());
    }


    public sealed class GetMonitoringAlarmArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetMonitoringAlarmResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetMonitoringAlarmSuppressionResult Suppression;
        /// <summary>
        ...
        [OutputConstructor]
        private GetMonitoringAlarmResult(
            string alarmId,
            ...
            Outputs.GetMonitoringAlarmSuppressionResult suppression,
