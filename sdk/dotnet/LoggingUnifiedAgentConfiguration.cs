...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testUnifiedAgentConfiguration = new Oci.LoggingUnifiedAgentConfiguration("testUnifiedAgentConfiguration", new Oci.LoggingUnifiedAgentConfigurationArgs
    ///         {
    ...
    ///             ServiceConfiguration = new Oci.Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationArgs
    ///             {
    ///                 ConfigurationType = @var.Unified_agent_configuration_service_configuration_configuration_type,
    ///                 Destination = new Oci.Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationDestinationArgs
    ///                 {
    ///                     LogObjectId = oci_objectstorage_object.Test_object.Id,
    ///                 },
    ///                 Sources = 
    ///                 {
    ///                     new Oci.Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceArgs
    ///                     {
    ...
    ///                         Parser = new Oci.Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserArgs
    ///                         {
    ...
    ///                             Patterns = 
    ///                             {
    ///                                 new Oci.Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationSourceParserPatternArgs
    ///                                 {
    ...
    ///                 { "Department", "Finance" },
    ///             },
    ///             GroupAssociation = new Oci.Inputs.LoggingUnifiedAgentConfigurationGroupAssociationArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/loggingUnifiedAgentConfiguration:LoggingUnifiedAgentConfiguration")]
    public partial class LoggingUnifiedAgentConfiguration : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.LoggingUnifiedAgentConfigurationGroupAssociation> GroupAssociation { get; private set; } = null!;
        ...
        public Output<Outputs.LoggingUnifiedAgentConfigurationServiceConfiguration> ServiceConfiguration { get; private set; } = null!;
        ...
        public LoggingUnifiedAgentConfiguration(string name, LoggingUnifiedAgentConfigurationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/loggingUnifiedAgentConfiguration:LoggingUnifiedAgentConfiguration", name, args ?? new LoggingUnifiedAgentConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoggingUnifiedAgentConfiguration(string name, Input<string> id, LoggingUnifiedAgentConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/loggingUnifiedAgentConfiguration:LoggingUnifiedAgentConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LoggingUnifiedAgentConfiguration Get(string name, Input<string> id, LoggingUnifiedAgentConfigurationState? state = null, CustomResourceOptions? options = null)
        {
            return new LoggingUnifiedAgentConfiguration(name, id, state, options);
        }
    }

    public sealed class LoggingUnifiedAgentConfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment that the resource belongs to.
        /// </summary>
        ...
        public Input<Inputs.LoggingUnifiedAgentConfigurationGroupAssociationArgs>? GroupAssociation { get; set; }
        ...
        public Input<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationArgs> ServiceConfiguration { get; set; } = null!;

        public LoggingUnifiedAgentConfigurationArgs()
        {
        }
    }

    public sealed class LoggingUnifiedAgentConfigurationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment that the resource belongs to.
        /// </summary>
        ...
        /// </summary>
        [Input("groupAssociation")]
        public Input<Inputs.LoggingUnifiedAgentConfigurationGroupAssociationGetArgs>? GroupAssociation { get; set; }
        ...
        public Input<Inputs.LoggingUnifiedAgentConfigurationServiceConfigurationGetArgs>? ServiceConfiguration { get; set; }
        ...
        public LoggingUnifiedAgentConfigurationState()
        {
        }
    }
}
