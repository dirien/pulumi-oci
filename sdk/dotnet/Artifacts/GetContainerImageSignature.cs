...
namespace Pulumi.Oci.Artifacts
{
    public static class GetContainerImageSignature
    {
        ...
        public static Task<GetContainerImageSignatureResult> InvokeAsync(GetContainerImageSignatureArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetContainerImageSignatureResult>("oci:artifacts/getContainerImageSignature:getContainerImageSignature", args ?? new GetContainerImageSignatureArgs(), options.WithVersion());
    }
