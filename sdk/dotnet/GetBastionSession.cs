...
{
    public static class GetBastionSession
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testSession = Output.Create(Oci.GetBastionSession.InvokeAsync(new Oci.GetBastionSessionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetBastionSessionResult> InvokeAsync(GetBastionSessionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBastionSessionResult>("oci:index/getBastionSession:GetBastionSession", args ?? new GetBastionSessionArgs(), options.WithVersion());
    }


    public sealed class GetBastionSessionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetBastionSessionResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetBastionSessionKeyDetailsResult KeyDetails;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetBastionSessionTargetResourceDetailsResult TargetResourceDetails;
        /// <summary>
        ...
        [OutputConstructor]
        private GetBastionSessionResult(
            string bastionId,
            ...
            Outputs.GetBastionSessionKeyDetailsResult keyDetails,
            ...
            Outputs.GetBastionSessionTargetResourceDetailsResult targetResourceDetails,
