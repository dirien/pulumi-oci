...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSwiftPassword = new Oci.IdentitySwiftPassword("testSwiftPassword", new Oci.IdentitySwiftPasswordArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identitySwiftPassword:IdentitySwiftPassword")]
    public partial class IdentitySwiftPassword : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentitySwiftPassword(string name, IdentitySwiftPasswordArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identitySwiftPassword:IdentitySwiftPassword", name, args ?? new IdentitySwiftPasswordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentitySwiftPassword(string name, Input<string> id, IdentitySwiftPasswordState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identitySwiftPassword:IdentitySwiftPassword", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentitySwiftPassword Get(string name, Input<string> id, IdentitySwiftPasswordState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentitySwiftPassword(name, id, state, options);
        }
    }

    public sealed class IdentitySwiftPasswordArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the Swift password during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentitySwiftPasswordArgs()
        {
        }
    }

    public sealed class IdentitySwiftPasswordState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the Swift password during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentitySwiftPasswordState()
        {
        }
    }
}
