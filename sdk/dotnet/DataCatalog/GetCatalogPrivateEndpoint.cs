...
namespace Pulumi.Oci.DataCatalog
{
    public static class GetCatalogPrivateEndpoint
    {
        ...
        public static Task<GetCatalogPrivateEndpointResult> InvokeAsync(GetCatalogPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCatalogPrivateEndpointResult>("oci:datacatalog/getCatalogPrivateEndpoint:getCatalogPrivateEndpoint", args ?? new GetCatalogPrivateEndpointArgs(), options.WithVersion());
    }
