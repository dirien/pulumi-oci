...
{
    public static class GetOnsSubscription
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testSubscription = Output.Create(Oci.GetOnsSubscription.InvokeAsync(new Oci.GetOnsSubscriptionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetOnsSubscriptionResult> InvokeAsync(GetOnsSubscriptionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOnsSubscriptionResult>("oci:index/getOnsSubscription:GetOnsSubscription", args ?? new GetOnsSubscriptionArgs(), options.WithVersion());
    }


    public sealed class GetOnsSubscriptionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetOnsSubscriptionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetOnsSubscriptionResult(
