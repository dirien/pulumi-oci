...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSender = new Oci.EmailSender("testSender", new Oci.EmailSenderArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/emailSender:EmailSender")]
    public partial class EmailSender : Pulumi.CustomResource
    {
        ...
        public EmailSender(string name, EmailSenderArgs args, CustomResourceOptions? options = null)
            : base("oci:index/emailSender:EmailSender", name, args ?? new EmailSenderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailSender(string name, Input<string> id, EmailSenderState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/emailSender:EmailSender", name, state, MakeResourceOptions(options, id))
        {
        }
