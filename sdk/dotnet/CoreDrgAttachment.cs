...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDrgAttachment = new Oci.CoreDrgAttachment("testDrgAttachment", new Oci.CoreDrgAttachmentArgs
    ///         {
    ...
    ///                 { "Department", "Finance" },
    ///             },
    ///             NetworkDetails = new Oci.Inputs.CoreDrgAttachmentNetworkDetailsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDrgAttachment:CoreDrgAttachment")]
    public partial class CoreDrgAttachment : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.CoreDrgAttachmentNetworkDetails> NetworkDetails { get; private set; } = null!;
        ...
        public CoreDrgAttachment(string name, CoreDrgAttachmentArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgAttachment:CoreDrgAttachment", name, args ?? new CoreDrgAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDrgAttachment(string name, Input<string> id, CoreDrgAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgAttachment:CoreDrgAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDrgAttachment Get(string name, Input<string> id, CoreDrgAttachmentState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDrgAttachment(name, id, state, options);
        }
    }

    public sealed class CoreDrgAttachmentArgs : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
        ...
        public Input<Inputs.CoreDrgAttachmentNetworkDetailsArgs>? NetworkDetails { get; set; }
        ...
        public CoreDrgAttachmentArgs()
        {
        }
    }

    public sealed class CoreDrgAttachmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the DRG attachment.
        /// </summary>
        ...
        /// </summary>
        [Input("networkDetails")]
        public Input<Inputs.CoreDrgAttachmentNetworkDetailsGetArgs>? NetworkDetails { get; set; }
