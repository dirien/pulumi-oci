...
namespace Pulumi.Oci.NetworkLoadBalancer
{
    public static class GetNetworkLoadBalancers
    {
        ...
        public static Task<GetNetworkLoadBalancersResult> InvokeAsync(GetNetworkLoadBalancersArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkLoadBalancersResult>("oci:networkloadbalancer/getNetworkLoadBalancers:getNetworkLoadBalancers", args ?? new GetNetworkLoadBalancersArgs(), options.WithVersion());
    }
