...
{
    public static class GetJmsFleet
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testFleet = Output.Create(Oci.GetJmsFleet.InvokeAsync(new Oci.GetJmsFleetArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetJmsFleetResult> InvokeAsync(GetJmsFleetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJmsFleetResult>("oci:index/getJmsFleet:GetJmsFleet", args ?? new GetJmsFleetArgs(), options.WithVersion());
    }


    public sealed class GetJmsFleetArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetJmsFleetResult
    {
        /// <summary>
