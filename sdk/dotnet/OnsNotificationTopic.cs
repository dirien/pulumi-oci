...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testNotificationTopic = new Oci.OnsNotificationTopic("testNotificationTopic", new Oci.OnsNotificationTopicArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/onsNotificationTopic:OnsNotificationTopic")]
    public partial class OnsNotificationTopic : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OnsNotificationTopic(string name, OnsNotificationTopicArgs args, CustomResourceOptions? options = null)
            : base("oci:index/onsNotificationTopic:OnsNotificationTopic", name, args ?? new OnsNotificationTopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OnsNotificationTopic(string name, Input<string> id, OnsNotificationTopicState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/onsNotificationTopic:OnsNotificationTopic", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OnsNotificationTopic Get(string name, Input<string> id, OnsNotificationTopicState? state = null, CustomResourceOptions? options = null)
        {
            return new OnsNotificationTopic(name, id, state, options);
        }
    }

    public sealed class OnsNotificationTopicArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the topic in.
        /// </summary>
        ...
        public OnsNotificationTopicArgs()
        {
        }
    }

    public sealed class OnsNotificationTopicState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The endpoint for managing subscriptions or publishing messages to the topic.
        /// </summary>
        ...
        public OnsNotificationTopicState()
        {
        }
    }
}
