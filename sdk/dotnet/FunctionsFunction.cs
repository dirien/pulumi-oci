...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testFunction = new Oci.FunctionsFunction("testFunction", new Oci.FunctionsFunctionArgs
    ///         {
    ...
    ///             TraceConfig = new Oci.Inputs.FunctionsFunctionTraceConfigArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/functionsFunction:FunctionsFunction")]
    public partial class FunctionsFunction : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("traceConfig")]
        public Output<Outputs.FunctionsFunctionTraceConfig> TraceConfig { get; private set; } = null!;
        ...
        public FunctionsFunction(string name, FunctionsFunctionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/functionsFunction:FunctionsFunction", name, args ?? new FunctionsFunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FunctionsFunction(string name, Input<string> id, FunctionsFunctionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/functionsFunction:FunctionsFunction", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FunctionsFunction Get(string name, Input<string> id, FunctionsFunctionState? state = null, CustomResourceOptions? options = null)
        {
            return new FunctionsFunction(name, id, state, options);
        }
    }

    public sealed class FunctionsFunctionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the application this function belongs to.
        /// </summary>
        ...
        /// </summary>
        [Input("traceConfig")]
        public Input<Inputs.FunctionsFunctionTraceConfigArgs>? TraceConfig { get; set; }

        public FunctionsFunctionArgs()
        {
        }
    }

    public sealed class FunctionsFunctionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the application this function belongs to.
        /// </summary>
        ...
        /// </summary>
        [Input("traceConfig")]
        public Input<Inputs.FunctionsFunctionTraceConfigGetArgs>? TraceConfig { get; set; }

        public FunctionsFunctionState()
        {
        }
    }
}
