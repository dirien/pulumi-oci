...
{
    public static class GetHealthChecksHttpMonitor
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testHttpMonitor = Output.Create(Oci.GetHealthChecksHttpMonitor.InvokeAsync(new Oci.GetHealthChecksHttpMonitorArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetHealthChecksHttpMonitorResult> InvokeAsync(GetHealthChecksHttpMonitorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHealthChecksHttpMonitorResult>("oci:index/getHealthChecksHttpMonitor:GetHealthChecksHttpMonitor", args ?? new GetHealthChecksHttpMonitorArgs(), options.WithVersion());
    }


    public sealed class GetHealthChecksHttpMonitorArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetHealthChecksHttpMonitorArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetHealthChecksHttpMonitorResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetHealthChecksHttpMonitorResult(
