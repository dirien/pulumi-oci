...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/opsiDatabaseInsight:OpsiDatabaseInsight")]
    public partial class OpsiDatabaseInsight : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OpsiDatabaseInsight(string name, OpsiDatabaseInsightArgs args, CustomResourceOptions? options = null)
            : base("oci:index/opsiDatabaseInsight:OpsiDatabaseInsight", name, args ?? new OpsiDatabaseInsightArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpsiDatabaseInsight(string name, Input<string> id, OpsiDatabaseInsightState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/opsiDatabaseInsight:OpsiDatabaseInsight", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpsiDatabaseInsight Get(string name, Input<string> id, OpsiDatabaseInsightState? state = null, CustomResourceOptions? options = null)
        {
            return new OpsiDatabaseInsight(name, id, state, options);
        }
    }

    public sealed class OpsiDatabaseInsightArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier of database
        /// </summary>
        ...
        public OpsiDatabaseInsightArgs()
        {
        }
    }

    public sealed class OpsiDatabaseInsightState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier of database
        /// </summary>
        ...
        public OpsiDatabaseInsightState()
        {
        }
    }
}
