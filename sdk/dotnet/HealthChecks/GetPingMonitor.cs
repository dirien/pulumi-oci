...
namespace Pulumi.Oci.HealthChecks
{
    public static class GetPingMonitor
    {
        ...
        public static Task<GetPingMonitorResult> InvokeAsync(GetPingMonitorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPingMonitorResult>("oci:healthchecks/getPingMonitor:getPingMonitor", args ?? new GetPingMonitorArgs(), options.WithVersion());
    }
