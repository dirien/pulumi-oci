...
namespace Pulumi.Oci.HealthChecks
{
    public static class GetHttpMonitor
    {
        ...
        public static Task<GetHttpMonitorResult> InvokeAsync(GetHttpMonitorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetHttpMonitorResult>("oci:healthchecks/getHttpMonitor:getHttpMonitor", args ?? new GetHttpMonitorArgs(), options.WithVersion());
    }
