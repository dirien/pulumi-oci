...
namespace Pulumi.Oci.ServiceCatalog
{
    public static class GetServiceCatalogAssociation
    {
        ...
        public static Task<GetServiceCatalogAssociationResult> InvokeAsync(GetServiceCatalogAssociationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceCatalogAssociationResult>("oci:servicecatalog/getServiceCatalogAssociation:getServiceCatalogAssociation", args ?? new GetServiceCatalogAssociationArgs(), options.WithVersion());
    }
