...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDbHome = new Oci.DatabaseDbHome("testDbHome", new Oci.DatabaseDbHomeArgs
    ///         {
    ///             Database = new Oci.Inputs.DatabaseDbHomeDatabaseArgs
    ///             {
    ...
    ///                 DbBackupConfig = new Oci.Inputs.DatabaseDbHomeDatabaseDbBackupConfigArgs
    ///                 {
    ...
    ///                     {
    ///                         new Oci.Inputs.DatabaseDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs
    ///                         {
    ...
    /// </summary>
    [OciResourceType("oci:index/databaseDbHome:DatabaseDbHome")]
    public partial class DatabaseDbHome : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("database")]
        public Output<Outputs.DatabaseDbHomeDatabase> Database { get; private set; } = null!;
        ...
        public DatabaseDbHome(string name, DatabaseDbHomeArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseDbHome:DatabaseDbHome", name, args ?? new DatabaseDbHomeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseDbHome(string name, Input<string> id, DatabaseDbHomeState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseDbHome:DatabaseDbHome", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseDbHome Get(string name, Input<string> id, DatabaseDbHomeState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseDbHome(name, id, state, options);
        }
    }

    public sealed class DatabaseDbHomeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Details for creating a database.
        /// </summary>
        [Input("database", required: true)]
        public Input<Inputs.DatabaseDbHomeDatabaseArgs> Database { get; set; } = null!;
        ...
        public DatabaseDbHomeArgs()
        {
        }
    }

    public sealed class DatabaseDbHomeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        /// </summary>
        ...
        /// </summary>
        [Input("database")]
        public Input<Inputs.DatabaseDbHomeDatabaseGetArgs>? Database { get; set; }
