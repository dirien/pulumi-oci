...
namespace Pulumi.Oci.Events
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("oci:events/getRule:getRule", args ?? new GetRuleArgs(), options.WithVersion());
    }
    ...
    public sealed class GetRuleResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetRuleActionsResult Actions;
        /// <summary>
        ...
        private GetRuleResult(
            Outputs.GetRuleActionsResult actions,
