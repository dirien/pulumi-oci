...
{
    public static class GetDatacatalogDataAsset
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDataAsset = Output.Create(Oci.GetDatacatalogDataAsset.InvokeAsync(new Oci.GetDatacatalogDataAssetArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatacatalogDataAssetResult> InvokeAsync(GetDatacatalogDataAssetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatacatalogDataAssetResult>("oci:index/getDatacatalogDataAsset:GetDatacatalogDataAsset", args ?? new GetDatacatalogDataAssetArgs(), options.WithVersion());
    }


    public sealed class GetDatacatalogDataAssetArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatacatalogDataAssetArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatacatalogDataAssetResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatacatalogDataAssetResult(
            string catalogId,
