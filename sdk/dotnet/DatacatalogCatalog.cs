...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testCatalog = new Oci.DatacatalogCatalog("testCatalog", new Oci.DatacatalogCatalogArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/datacatalogCatalog:DatacatalogCatalog")]
    public partial class DatacatalogCatalog : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatacatalogCatalog(string name, DatacatalogCatalogArgs args, CustomResourceOptions? options = null)
            : base("oci:index/datacatalogCatalog:DatacatalogCatalog", name, args ?? new DatacatalogCatalogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatacatalogCatalog(string name, Input<string> id, DatacatalogCatalogState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/datacatalogCatalog:DatacatalogCatalog", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatacatalogCatalog Get(string name, Input<string> id, DatacatalogCatalogState? state = null, CustomResourceOptions? options = null)
        {
            return new DatacatalogCatalog(name, id, state, options);
        }
    }

    public sealed class DatacatalogCatalogArgs : Pulumi.ResourceArgs
    {
        ...
        public DatacatalogCatalogArgs()
        {
        }
    }

    public sealed class DatacatalogCatalogState : Pulumi.ResourceArgs
    {
        [Input("attachedCatalogPrivateEndpoints")]
        private InputList<string>? _attachedCatalogPrivateEndpoints;
        ...
        public DatacatalogCatalogState()
        {
        }
    }
}
