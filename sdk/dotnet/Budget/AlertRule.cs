...
namespace Pulumi.Oci.Budget
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAlertRule = new Oci.Budget.AlertRule("testAlertRule", new Oci.Budget.AlertRuleArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:budget/alertRule:AlertRule")]
    public partial class AlertRule : Pulumi.CustomResource
    {
        ...
        public AlertRule(string name, AlertRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:budget/alertRule:AlertRule", name, args ?? new AlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertRule(string name, Input<string> id, AlertRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:budget/alertRule:AlertRule", name, state, MakeResourceOptions(options, id))
        {
        }
