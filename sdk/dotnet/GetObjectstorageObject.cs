...
{
    public static class GetObjectstorageObject
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testObject = Output.Create(Oci.GetObjectstorageObject.InvokeAsync(new Oci.GetObjectstorageObjectArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetObjectstorageObjectResult> InvokeAsync(GetObjectstorageObjectArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetObjectstorageObjectResult>("oci:index/getObjectstorageObject:GetObjectstorageObject", args ?? new GetObjectstorageObjectArgs(), options.WithVersion());
    }


    public sealed class GetObjectstorageObjectArgs : Pulumi.InvokeArgs
    {
        ...
        public GetObjectstorageObjectArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetObjectstorageObjectResult
    {
        ...
        [OutputConstructor]
        private GetObjectstorageObjectResult(
