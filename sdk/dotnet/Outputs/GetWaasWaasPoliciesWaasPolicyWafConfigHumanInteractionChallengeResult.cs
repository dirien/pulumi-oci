...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsResult ChallengeSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderResult SetHttpHeader;

        [OutputConstructor]
        private GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeResult(
            string action,

            int actionExpirationInSeconds,

            Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsResult challengeSettings,
            ...
            Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderResult setHttpHeader)
        {
            Action = action;
