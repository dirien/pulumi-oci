...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetCoreSecurityListsSecurityListEgressSecurityRuleResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleIcmpOptionsResult IcmpOptions;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleTcpOptionsResult TcpOptions;
        /// <summary>
        /// Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed. 
        /// * The following 2 attributes specify an inclusive range of allowed destination ports. Use the same number for the min and max to indicate a single port. Defaults to all ports if not specified.
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleUdpOptionsResult UdpOptions;

        [OutputConstructor]
        private GetCoreSecurityListsSecurityListEgressSecurityRuleResult(
            string description,
            ...
            Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleIcmpOptionsResult icmpOptions,

            string protocol,

            bool stateless,

            Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleTcpOptionsResult tcpOptions,

            Outputs.GetCoreSecurityListsSecurityListEgressSecurityRuleUdpOptionsResult udpOptions)
        {
