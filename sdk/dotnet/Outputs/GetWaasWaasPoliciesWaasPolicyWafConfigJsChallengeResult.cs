...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSettingsResult ChallengeSettings;
        /// <summary>
        /// When defined, the JavaScript Challenge would be applied only for the requests that matched all the listed conditions.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeCriteriaResult> Criterias;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeSetHttpHeaderResult SetHttpHeader;

        [OutputConstructor]
        private GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeResult(
            string action,
            ...
            Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSettingsResult challengeSettings,

            ImmutableArray<Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeCriteriaResult> criterias,
            ...
            Outputs.GetWaasWaasPoliciesWaasPolicyWafConfigJsChallengeSetHttpHeaderResult setHttpHeader)
        {
            Action = action;
