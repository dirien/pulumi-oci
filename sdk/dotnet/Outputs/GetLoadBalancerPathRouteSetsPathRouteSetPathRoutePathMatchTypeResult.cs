...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetLoadBalancerPathRouteSetsPathRouteSetPathRoutePathMatchTypeResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetLoadBalancerPathRouteSetsPathRouteSetPathRoutePathMatchTypeResult(string matchType)
        {
            MatchType = matchType;
        }
    }
