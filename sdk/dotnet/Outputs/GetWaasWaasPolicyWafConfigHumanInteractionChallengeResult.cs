...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetWaasWaasPolicyWafConfigHumanInteractionChallengeResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsResult ChallengeSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderResult SetHttpHeader;

        [OutputConstructor]
        private GetWaasWaasPolicyWafConfigHumanInteractionChallengeResult(
            string action,

            int actionExpirationInSeconds,

            Outputs.GetWaasWaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsResult challengeSettings,
            ...
            Outputs.GetWaasWaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderResult setHttpHeader)
        {
            Action = action;
