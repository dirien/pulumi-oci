...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetWaasWaasPolicyWafConfigJsChallengeResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPolicyWafConfigJsChallengeChallengeSettingsResult ChallengeSettings;
        /// <summary>
        /// When defined, the JavaScript Challenge would be applied only for the requests that matched all the listed conditions.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWaasWaasPolicyWafConfigJsChallengeCriteriaResult> Criterias;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetWaasWaasPolicyWafConfigJsChallengeSetHttpHeaderResult SetHttpHeader;

        [OutputConstructor]
        private GetWaasWaasPolicyWafConfigJsChallengeResult(
            string action,
            ...
            Outputs.GetWaasWaasPolicyWafConfigJsChallengeChallengeSettingsResult challengeSettings,

            ImmutableArray<Outputs.GetWaasWaasPolicyWafConfigJsChallengeCriteriaResult> criterias,
            ...
            Outputs.GetWaasWaasPolicyWafConfigJsChallengeSetHttpHeaderResult setHttpHeader)
        {
            Action = action;
