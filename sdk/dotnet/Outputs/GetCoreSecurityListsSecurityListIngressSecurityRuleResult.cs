...
namespace Pulumi.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetCoreSecurityListsSecurityListIngressSecurityRuleResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleIcmpOptionsResult IcmpOptions;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleTcpOptionsResult TcpOptions;
        /// <summary>
        /// Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed. 
        /// * The following 2 attributes specify an inclusive range of allowed destination ports. Use the same number for the min and max to indicate a single port. Defaults to all ports if not specified.
        /// </summary>
        public readonly Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleUdpOptionsResult UdpOptions;

        [OutputConstructor]
        private GetCoreSecurityListsSecurityListIngressSecurityRuleResult(
            string description,

            Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleIcmpOptionsResult icmpOptions,
            ...
            Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleTcpOptionsResult tcpOptions,

            Outputs.GetCoreSecurityListsSecurityListIngressSecurityRuleUdpOptionsResult udpOptions)
        {
