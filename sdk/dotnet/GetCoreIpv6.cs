...
{
    public static class GetCoreIpv6
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testIpv6 = Output.Create(Oci.GetCoreIpv6.InvokeAsync(new Oci.GetCoreIpv6Args
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreIpv6Result> InvokeAsync(GetCoreIpv6Args args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreIpv6Result>("oci:index/getCoreIpv6:GetCoreIpv6", args ?? new GetCoreIpv6Args(), options.WithVersion());
    }


    public sealed class GetCoreIpv6Args : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCoreIpv6Result
    {
        /// <summary>
