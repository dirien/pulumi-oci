...
{
    public static class GetCoreDrgRouteTable
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDrgRouteTable = Output.Create(Oci.GetCoreDrgRouteTable.InvokeAsync(new Oci.GetCoreDrgRouteTableArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreDrgRouteTableResult> InvokeAsync(GetCoreDrgRouteTableArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreDrgRouteTableResult>("oci:index/getCoreDrgRouteTable:GetCoreDrgRouteTable", args ?? new GetCoreDrgRouteTableArgs(), options.WithVersion());
    }


    public sealed class GetCoreDrgRouteTableArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreDrgRouteTableArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreDrgRouteTableResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreDrgRouteTableResult(
