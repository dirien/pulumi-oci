...
{
    public static class GetNetworkLoadBalancerNetworkLoadBalancerHealth
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testNetworkLoadBalancerHealth = Output.Create(Oci.GetNetworkLoadBalancerNetworkLoadBalancerHealth.InvokeAsync(new Oci.GetNetworkLoadBalancerNetworkLoadBalancerHealthArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetNetworkLoadBalancerNetworkLoadBalancerHealthResult> InvokeAsync(GetNetworkLoadBalancerNetworkLoadBalancerHealthArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkLoadBalancerNetworkLoadBalancerHealthResult>("oci:index/getNetworkLoadBalancerNetworkLoadBalancerHealth:GetNetworkLoadBalancerNetworkLoadBalancerHealth", args ?? new GetNetworkLoadBalancerNetworkLoadBalancerHealthArgs(), options.WithVersion());
    }


    public sealed class GetNetworkLoadBalancerNetworkLoadBalancerHealthArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetNetworkLoadBalancerNetworkLoadBalancerHealthArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetNetworkLoadBalancerNetworkLoadBalancerHealthResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetNetworkLoadBalancerNetworkLoadBalancerHealthResult(
