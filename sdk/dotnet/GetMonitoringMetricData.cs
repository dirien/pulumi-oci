...
{
    public static class GetMonitoringMetricData
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testMetricData = Output.Create(Oci.GetMonitoringMetricData.InvokeAsync(new Oci.GetMonitoringMetricDataArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetMonitoringMetricDataResult> InvokeAsync(GetMonitoringMetricDataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMonitoringMetricDataResult>("oci:index/getMonitoringMetricData:GetMonitoringMetricData", args ?? new GetMonitoringMetricDataArgs(), options.WithVersion());
    }


    public sealed class GetMonitoringMetricDataArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetMonitoringMetricDataFilterArgs>? _filters;
        public List<Inputs.GetMonitoringMetricDataFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetMonitoringMetricDataFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetMonitoringMetricDataArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetMonitoringMetricDataResult
    {
        /// <summary>
        ...
        public readonly ImmutableArray<Outputs.GetMonitoringMetricDataFilterResult> Filters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetMonitoringMetricDataMetricDataResult> MetricDatas;
        /// <summary>
        ...
        [OutputConstructor]
        private GetMonitoringMetricDataResult(
            ...
            ImmutableArray<Outputs.GetMonitoringMetricDataFilterResult> filters,

            string id,

            ImmutableArray<Outputs.GetMonitoringMetricDataMetricDataResult> metricDatas,
