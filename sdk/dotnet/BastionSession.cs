...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSession = new Oci.BastionSession("testSession", new Oci.BastionSessionArgs
    ///         {
    ///             BastionId = oci_bastion_bastion.Test_bastion.Id,
    ///             KeyDetails = new Oci.Inputs.BastionSessionKeyDetailsArgs
    ///             {
    ///                 PublicKeyContent = @var.Session_key_details_public_key_content,
    ///             },
    ///             TargetResourceDetails = new Oci.Inputs.BastionSessionTargetResourceDetailsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/bastionSession:BastionSession")]
    public partial class BastionSession : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("keyDetails")]
        public Output<Outputs.BastionSessionKeyDetails> KeyDetails { get; private set; } = null!;
        ...
        public Output<Outputs.BastionSessionTargetResourceDetails> TargetResourceDetails { get; private set; } = null!;
        ...
        public BastionSession(string name, BastionSessionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/bastionSession:BastionSession", name, args ?? new BastionSessionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionSession(string name, Input<string> id, BastionSessionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/bastionSession:BastionSession", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BastionSession Get(string name, Input<string> id, BastionSessionState? state = null, CustomResourceOptions? options = null)
        {
            return new BastionSession(name, id, state, options);
        }
    }

    public sealed class BastionSessionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique identifier (OCID) of the bastion on which to create this session.
        /// </summary>
        ...
        public Input<Inputs.BastionSessionKeyDetailsArgs> KeyDetails { get; set; } = null!;
        ...
        public Input<Inputs.BastionSessionTargetResourceDetailsArgs> TargetResourceDetails { get; set; } = null!;

        public BastionSessionArgs()
        {
        }
    }

    public sealed class BastionSessionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique identifier (OCID) of the bastion on which to create this session.
        /// </summary>
        ...
        /// </summary>
        [Input("keyDetails")]
        public Input<Inputs.BastionSessionKeyDetailsGetArgs>? KeyDetails { get; set; }
        ...
        public Input<Inputs.BastionSessionTargetResourceDetailsGetArgs>? TargetResourceDetails { get; set; }
