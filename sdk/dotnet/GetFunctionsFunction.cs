...
namespace Pulumi.Oci
{
    public static class GetFunctionsFunction
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testFunction = Output.Create(Oci.GetFunctionsFunction.InvokeAsync(new Oci.GetFunctionsFunctionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetFunctionsFunctionResult> InvokeAsync(GetFunctionsFunctionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFunctionsFunctionResult>("oci:index/getFunctionsFunction:GetFunctionsFunction", args ?? new GetFunctionsFunctionArgs(), options.WithVersion());
    }


    public sealed class GetFunctionsFunctionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetFunctionsFunctionResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetFunctionsFunctionTraceConfigResult TraceConfig;
        ...
        private GetFunctionsFunctionResult(
            ...
            Outputs.GetFunctionsFunctionTraceConfigResult traceConfig)
        {
