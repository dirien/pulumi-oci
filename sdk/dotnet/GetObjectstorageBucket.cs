...
namespace Pulumi.Oci
{
    public static class GetObjectstorageBucket
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testBucket = Output.Create(Oci.GetObjectstorageBucket.InvokeAsync(new Oci.GetObjectstorageBucketArgs
        ///         {
        ...
        public static Task<GetObjectstorageBucketResult> InvokeAsync(GetObjectstorageBucketArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetObjectstorageBucketResult>("oci:index/getObjectstorageBucket:GetObjectstorageBucket", args ?? new GetObjectstorageBucketArgs(), options.WithVersion());
    }


    public sealed class GetObjectstorageBucketArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetObjectstorageBucketResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetObjectstorageBucketRetentionRuleResult> RetentionRules;
        /// <summary>
        ...
        private GetObjectstorageBucketResult(
            ...
            ImmutableArray<Outputs.GetObjectstorageBucketRetentionRuleResult> retentionRules,
