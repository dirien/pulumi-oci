...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testIpSecConnection = new Oci.CoreIpsec("testIpSecConnection", new Oci.CoreIpsecArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreIpsec:CoreIpsec")]
    public partial class CoreIpsec : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreIpsec(string name, CoreIpsecArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreIpsec:CoreIpsec", name, args ?? new CoreIpsecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreIpsec(string name, Input<string> id, CoreIpsecState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreIpsec:CoreIpsec", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreIpsec Get(string name, Input<string> id, CoreIpsecState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreIpsec(name, id, state, options);
        }
    }

    public sealed class CoreIpsecArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the IPSec connection.
        /// </summary>
        ...
        public CoreIpsecArgs()
        {
        }
    }

    public sealed class CoreIpsecState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the IPSec connection.
        /// </summary>
