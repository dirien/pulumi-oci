...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testRule = new Oci.EventsRule("testRule", new Oci.EventsRuleArgs
    ///         {
    ///             Actions = new Oci.Inputs.EventsRuleActionsArgs
    ///             {
    ///                 Actions = 
    ///                 {
    ///                     new Oci.Inputs.EventsRuleActionsActionArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/eventsRule:EventsRule")]
    public partial class EventsRule : Pulumi.CustomResource
    {
        /// <summary>
        /// (Updatable) A list of one or more ActionDetails objects.
        /// </summary>
        [Output("actions")]
        public Output<Outputs.EventsRuleActions> Actions { get; private set; } = null!;
        ...
        public EventsRule(string name, EventsRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/eventsRule:EventsRule", name, args ?? new EventsRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventsRule(string name, Input<string> id, EventsRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/eventsRule:EventsRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EventsRule Get(string name, Input<string> id, EventsRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new EventsRule(name, id, state, options);
        }
    }

    public sealed class EventsRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) A list of one or more ActionDetails objects.
        /// </summary>
        [Input("actions", required: true)]
        public Input<Inputs.EventsRuleActionsArgs> Actions { get; set; } = null!;
        ...
        public EventsRuleArgs()
        {
        }
    }

    public sealed class EventsRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) A list of one or more ActionDetails objects.
        /// </summary>
        [Input("actions")]
        public Input<Inputs.EventsRuleActionsGetArgs>? Actions { get; set; }
