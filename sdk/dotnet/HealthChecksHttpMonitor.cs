...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testHttpMonitor = new Oci.HealthChecksHttpMonitor("testHttpMonitor", new Oci.HealthChecksHttpMonitorArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/healthChecksHttpMonitor:HealthChecksHttpMonitor")]
    public partial class HealthChecksHttpMonitor : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HealthChecksHttpMonitor(string name, HealthChecksHttpMonitorArgs args, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksHttpMonitor:HealthChecksHttpMonitor", name, args ?? new HealthChecksHttpMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthChecksHttpMonitor(string name, Input<string> id, HealthChecksHttpMonitorState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksHttpMonitor:HealthChecksHttpMonitor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HealthChecksHttpMonitor Get(string name, Input<string> id, HealthChecksHttpMonitorState? state = null, CustomResourceOptions? options = null)
        {
            return new HealthChecksHttpMonitor(name, id, state, options);
        }
    }

    public sealed class HealthChecksHttpMonitorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksHttpMonitorArgs()
        {
        }
    }

    public sealed class HealthChecksHttpMonitorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksHttpMonitorState()
        {
        }
    }
}
