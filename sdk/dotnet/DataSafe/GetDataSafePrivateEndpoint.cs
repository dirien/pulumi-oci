...
namespace Pulumi.Oci.DataSafe
{
    public static class GetDataSafePrivateEndpoint
    {
        ...
        public static Task<GetDataSafePrivateEndpointResult> InvokeAsync(GetDataSafePrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataSafePrivateEndpointResult>("oci:datasafe/getDataSafePrivateEndpoint:getDataSafePrivateEndpoint", args ?? new GetDataSafePrivateEndpointArgs(), options.WithVersion());
    }
