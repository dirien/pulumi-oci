...
namespace Pulumi.Oci.DataSafe
{
    public static class GetOnPremConnector
    {
        ...
        public static Task<GetOnPremConnectorResult> InvokeAsync(GetOnPremConnectorArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOnPremConnectorResult>("oci:datasafe/getOnPremConnector:getOnPremConnector", args ?? new GetOnPremConnectorArgs(), options.WithVersion());
    }
