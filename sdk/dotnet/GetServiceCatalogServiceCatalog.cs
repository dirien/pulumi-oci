...
{
    public static class GetServiceCatalogServiceCatalog
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testServiceCatalog = Output.Create(Oci.GetServiceCatalogServiceCatalog.InvokeAsync(new Oci.GetServiceCatalogServiceCatalogArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetServiceCatalogServiceCatalogResult> InvokeAsync(GetServiceCatalogServiceCatalogArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceCatalogServiceCatalogResult>("oci:index/getServiceCatalogServiceCatalog:GetServiceCatalogServiceCatalog", args ?? new GetServiceCatalogServiceCatalogArgs(), options.WithVersion());
    }


    public sealed class GetServiceCatalogServiceCatalogArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetServiceCatalogServiceCatalogArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetServiceCatalogServiceCatalogResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetServiceCatalogServiceCatalogResult(
