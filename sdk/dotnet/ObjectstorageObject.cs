...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testObject = new Oci.ObjectstorageObject("testObject", new Oci.ObjectstorageObjectArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/objectstorageObject:ObjectstorageObject")]
    public partial class ObjectstorageObject : Pulumi.CustomResource
    {
        ...
        public ObjectstorageObject(string name, ObjectstorageObjectArgs args, CustomResourceOptions? options = null)
            : base("oci:index/objectstorageObject:ObjectstorageObject", name, args ?? new ObjectstorageObjectArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ObjectstorageObject(string name, Input<string> id, ObjectstorageObjectState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/objectstorageObject:ObjectstorageObject", name, state, MakeResourceOptions(options, id))
        {
        }
