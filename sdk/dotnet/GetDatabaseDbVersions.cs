...
{
    public static class GetDatabaseDbVersions
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDbVersions = Output.Create(Oci.GetDatabaseDbVersions.InvokeAsync(new Oci.GetDatabaseDbVersionsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseDbVersionsResult> InvokeAsync(GetDatabaseDbVersionsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseDbVersionsResult>("oci:index/getDatabaseDbVersions:GetDatabaseDbVersions", args ?? new GetDatabaseDbVersionsArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseDbVersionsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetDatabaseDbVersionsFilterArgs>? _filters;
        public List<Inputs.GetDatabaseDbVersionsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetDatabaseDbVersionsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetDatabaseDbVersionsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseDbVersionsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDatabaseDbVersionsDbVersionResult> DbVersions;
        public readonly ImmutableArray<Outputs.GetDatabaseDbVersionsFilterResult> Filters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseDbVersionsResult(
            ...
            ImmutableArray<Outputs.GetDatabaseDbVersionsDbVersionResult> dbVersions,

            ImmutableArray<Outputs.GetDatabaseDbVersionsFilterResult> filters,
