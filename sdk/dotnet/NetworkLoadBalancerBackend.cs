...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBackend = new Oci.NetworkLoadBalancerBackend("testBackend", new Oci.NetworkLoadBalancerBackendArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/networkLoadBalancerBackend:NetworkLoadBalancerBackend")]
    public partial class NetworkLoadBalancerBackend : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkLoadBalancerBackend(string name, NetworkLoadBalancerBackendArgs args, CustomResourceOptions? options = null)
            : base("oci:index/networkLoadBalancerBackend:NetworkLoadBalancerBackend", name, args ?? new NetworkLoadBalancerBackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkLoadBalancerBackend(string name, Input<string> id, NetworkLoadBalancerBackendState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/networkLoadBalancerBackend:NetworkLoadBalancerBackend", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkLoadBalancerBackend Get(string name, Input<string> id, NetworkLoadBalancerBackendState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkLoadBalancerBackend(name, id, state, options);
        }
    }

    public sealed class NetworkLoadBalancerBackendArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the backend set to which to add the backend server.  Example: `example_backend_set`
        /// </summary>
        ...
        public NetworkLoadBalancerBackendArgs()
        {
        }
    }

    public sealed class NetworkLoadBalancerBackendState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the backend set to which to add the backend server.  Example: `example_backend_set`
        /// </summary>
        ...
        public NetworkLoadBalancerBackendState()
        {
        }
    }
}
