...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreInternetGateway:CoreInternetGateway")]
    public partial class CoreInternetGateway : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreInternetGateway(string name, CoreInternetGatewayArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreInternetGateway:CoreInternetGateway", name, args ?? new CoreInternetGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreInternetGateway(string name, Input<string> id, CoreInternetGatewayState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreInternetGateway:CoreInternetGateway", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreInternetGateway Get(string name, Input<string> id, CoreInternetGatewayState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreInternetGateway(name, id, state, options);
        }
    }

    public sealed class CoreInternetGatewayArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the internet gateway.
        /// </summary>
        ...
        public CoreInternetGatewayArgs()
        {
        }
    }

    public sealed class CoreInternetGatewayState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the internet gateway.
        /// </summary>
        ...
        public CoreInternetGatewayState()
        {
        }
    }
}
