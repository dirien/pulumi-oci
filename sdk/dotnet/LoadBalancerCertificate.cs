...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/loadBalancerCertificate:LoadBalancerCertificate")]
    public partial class LoadBalancerCertificate : Pulumi.CustomResource
    {
        ...
        public LoadBalancerCertificate(string name, LoadBalancerCertificateArgs args, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerCertificate:LoadBalancerCertificate", name, args ?? new LoadBalancerCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LoadBalancerCertificate(string name, Input<string> id, LoadBalancerCertificateState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerCertificate:LoadBalancerCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
