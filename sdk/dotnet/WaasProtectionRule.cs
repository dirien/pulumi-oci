...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testProtectionRule = new Oci.WaasProtectionRule("testProtectionRule", new Oci.WaasProtectionRuleArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/waasProtectionRule:WaasProtectionRule")]
    public partial class WaasProtectionRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("exclusions")]
        public Output<ImmutableArray<Outputs.WaasProtectionRuleExclusion>> Exclusions { get; private set; } = null!;
        ...
        public WaasProtectionRule(string name, WaasProtectionRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/waasProtectionRule:WaasProtectionRule", name, args ?? new WaasProtectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WaasProtectionRule(string name, Input<string> id, WaasProtectionRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/waasProtectionRule:WaasProtectionRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WaasProtectionRule Get(string name, Input<string> id, WaasProtectionRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new WaasProtectionRule(name, id, state, options);
        }
    }

    public sealed class WaasProtectionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The action to take when the traffic is detected as malicious. If unspecified, defaults to `OFF`.
        /// </summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasProtectionRuleExclusionArgs>? _exclusions;

        /// <summary>
        /// An array of The target property of a request that would allow it to bypass the protection rule. For example, when `target` is `REQUEST_COOKIE_NAMES`, the list may include names of cookies to exclude from the protection rule. When the target is `ARGS`, the list may include strings of URL query parameters and values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from the protection rule. `Exclusions` properties must not contain whitespace, comma or |. **Note:** If protection rules have been enabled that utilize the `maxArgumentCount` or `maxTotalNameLengthOfArguments` properties, and the `target` property has been set to `ARGS`, it is important that the `exclusions` properties be defined to honor those protection rule settings in a consistent manner.
        /// </summary>
        public InputList<Inputs.WaasProtectionRuleExclusionArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasProtectionRuleExclusionArgs>());
        ...
        public WaasProtectionRuleArgs()
        {
        }
    }

    public sealed class WaasProtectionRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The action to take when the traffic is detected as malicious. If unspecified, defaults to `OFF`.
        /// </summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasProtectionRuleExclusionGetArgs>? _exclusions;

        /// <summary>
        /// An array of The target property of a request that would allow it to bypass the protection rule. For example, when `target` is `REQUEST_COOKIE_NAMES`, the list may include names of cookies to exclude from the protection rule. When the target is `ARGS`, the list may include strings of URL query parameters and values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from the protection rule. `Exclusions` properties must not contain whitespace, comma or |. **Note:** If protection rules have been enabled that utilize the `maxArgumentCount` or `maxTotalNameLengthOfArguments` properties, and the `target` property has been set to `ARGS`, it is important that the `exclusions` properties be defined to honor those protection rule settings in a consistent manner.
        /// </summary>
        public InputList<Inputs.WaasProtectionRuleExclusionGetArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasProtectionRuleExclusionGetArgs>());
            set => _exclusions = value;
        }
        ...
        public WaasProtectionRuleState()
        {
        }
    }
}
