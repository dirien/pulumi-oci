...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testIdentityProvider = new Oci.IdentityIdentityProvider("testIdentityProvider", new Oci.IdentityIdentityProviderArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityIdentityProvider:IdentityIdentityProvider")]
    public partial class IdentityIdentityProvider : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityIdentityProvider(string name, IdentityIdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityIdentityProvider:IdentityIdentityProvider", name, args ?? new IdentityIdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityIdentityProvider(string name, Input<string> id, IdentityIdentityProviderState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityIdentityProvider:IdentityIdentityProvider", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityIdentityProvider Get(string name, Input<string> id, IdentityIdentityProviderState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityIdentityProvider(name, id, state, options);
        }
    }

    public sealed class IdentityIdentityProviderArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of your tenancy.
        /// </summary>
        ...
        public IdentityIdentityProviderArgs()
        {
        }
    }

    public sealed class IdentityIdentityProviderState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of your tenancy.
        /// </summary>
        ...
        public IdentityIdentityProviderState()
        {
        }
    }
}
