...
{
    public static class GetDatacatalogConnection
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testConnection = Output.Create(Oci.GetDatacatalogConnection.InvokeAsync(new Oci.GetDatacatalogConnectionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatacatalogConnectionResult> InvokeAsync(GetDatacatalogConnectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatacatalogConnectionResult>("oci:index/getDatacatalogConnection:GetDatacatalogConnection", args ?? new GetDatacatalogConnectionArgs(), options.WithVersion());
    }


    public sealed class GetDatacatalogConnectionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatacatalogConnectionArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatacatalogConnectionResult
    {
        ...
        [OutputConstructor]
        private GetDatacatalogConnectionResult(
            string catalogId,
