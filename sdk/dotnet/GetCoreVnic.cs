...
{
    public static class GetCoreVnic
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVnic = Output.Create(Oci.GetCoreVnic.InvokeAsync(new Oci.GetCoreVnicArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreVnicResult> InvokeAsync(GetCoreVnicArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreVnicResult>("oci:index/getCoreVnic:GetCoreVnic", args ?? new GetCoreVnicArgs(), options.WithVersion());
    }


    public sealed class GetCoreVnicArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCoreVnicResult
    {
        /// <summary>
