...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDatabaseUpgrade = new Oci.DatabaseDatabaseUpgrade("testDatabaseUpgrade", new Oci.DatabaseDatabaseUpgradeArgs
    ///         {
    ///             Action = @var.Database_upgrade_action,
    ///             DatabaseId = oci_database_database.Test_database.Id,
    ///             DatabaseUpgradeSourceDetails = new Oci.Inputs.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs
    ///             {
    ...
    /// </summary>
    [OciResourceType("oci:index/databaseDatabaseUpgrade:DatabaseDatabaseUpgrade")]
    public partial class DatabaseDatabaseUpgrade : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.DatabaseDatabaseUpgradeConnectionStrings> ConnectionStrings { get; private set; } = null!;
        ...
        public Output<Outputs.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetails> DatabaseUpgradeSourceDetails { get; private set; } = null!;

        /// <summary>
        /// Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        /// </summary>
        [Output("dbBackupConfig")]
        public Output<Outputs.DatabaseDatabaseUpgradeDbBackupConfig> DbBackupConfig { get; private set; } = null!;
        ...
        public DatabaseDatabaseUpgrade(string name, DatabaseDatabaseUpgradeArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseDatabaseUpgrade:DatabaseDatabaseUpgrade", name, args ?? new DatabaseDatabaseUpgradeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseDatabaseUpgrade(string name, Input<string> id, DatabaseDatabaseUpgradeState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseDatabaseUpgrade:DatabaseDatabaseUpgrade", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseDatabaseUpgrade Get(string name, Input<string> id, DatabaseDatabaseUpgradeState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseDatabaseUpgrade(name, id, state, options);
        }
    }

    public sealed class DatabaseDatabaseUpgradeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The database upgrade action.
        /// </summary>
        ...
        public Input<Inputs.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs>? DatabaseUpgradeSourceDetails { get; set; }

        public DatabaseDatabaseUpgradeArgs()
        {
        }
    }

    public sealed class DatabaseDatabaseUpgradeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The database upgrade action.
        /// </summary>
        ...
        public Input<Inputs.DatabaseDatabaseUpgradeConnectionStringsGetArgs>? ConnectionStrings { get; set; }
        ...
        /// </summary>
        [Input("databaseUpgradeSourceDetails")]
        public Input<Inputs.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsGetArgs>? DatabaseUpgradeSourceDetails { get; set; }

        /// <summary>
        /// Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        /// </summary>
        [Input("dbBackupConfig")]
        public Input<Inputs.DatabaseDatabaseUpgradeDbBackupConfigGetArgs>? DbBackupConfig { get; set; }
        ...
        public DatabaseDatabaseUpgradeState()
        {
        }
    }
}
