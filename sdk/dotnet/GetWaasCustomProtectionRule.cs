...
{
    public static class GetWaasCustomProtectionRule
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testCustomProtectionRule = Output.Create(Oci.GetWaasCustomProtectionRule.InvokeAsync(new Oci.GetWaasCustomProtectionRuleArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetWaasCustomProtectionRuleResult> InvokeAsync(GetWaasCustomProtectionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWaasCustomProtectionRuleResult>("oci:index/getWaasCustomProtectionRule:GetWaasCustomProtectionRule", args ?? new GetWaasCustomProtectionRuleArgs(), options.WithVersion());
    }


    public sealed class GetWaasCustomProtectionRuleArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetWaasCustomProtectionRuleArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetWaasCustomProtectionRuleResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetWaasCustomProtectionRuleResult(
