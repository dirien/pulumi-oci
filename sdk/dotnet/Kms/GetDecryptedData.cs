...
namespace Pulumi.Oci.Kms
{
    public static class GetDecryptedData
    {
        ...
        public static Task<GetDecryptedDataResult> InvokeAsync(GetDecryptedDataArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDecryptedDataResult>("oci:kms/getDecryptedData:getDecryptedData", args ?? new GetDecryptedDataArgs(), options.WithVersion());
    }
