...
namespace Pulumi.Oci.Bds
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBdsInstance = new Oci.Bds.BdsInstance("testBdsInstance", new Oci.Bds.BdsInstanceArgs
    ///         {
    ...
    ///             MasterNode = new Oci.Bds.Inputs.BdsInstanceMasterNodeArgs
    ///             {
    ...
    ///             },
    ///             UtilNode = new Oci.Bds.Inputs.BdsInstanceUtilNodeArgs
    ///             {
    ///                 Shape = @var.Bds_instance_nodes_shape,
    ///                 SubnetId = oci_core_subnet.Test_subnet.Id,
    ///                 BlockVolumeSizeInGbs = @var.Bds_instance_nodes_block_volume_size_in_gbs,
    ///                 NumberOfNodes = @var.Bds_instance_number_of_nodes,
    ///             },
    ///             WorkerNode = new Oci.Bds.Inputs.BdsInstanceWorkerNodeArgs
    ///             {
    ///                 Shape = @var.Bds_instance_nodes_shape,
    ///                 SubnetId = oci_core_subnet.Test_subnet.Id,
    ///                 BlockVolumeSizeInGbs = @var.Bds_instance_nodes_block_volume_size_in_gbs,
    ...
    ///             NetworkConfig = new Oci.Bds.Inputs.BdsInstanceNetworkConfigArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:bds/bdsInstance:BdsInstance")]
    public partial class BdsInstance : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.BdsInstanceCloudSqlDetails> CloudSqlDetails { get; private set; } = null!;
        ...
        public Output<Outputs.BdsInstanceClusterDetails> ClusterDetails { get; private set; } = null!;
        ...
        public BdsInstance(string name, BdsInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:bds/bdsInstance:BdsInstance", name, args ?? new BdsInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BdsInstance(string name, Input<string> id, BdsInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:bds/bdsInstance:BdsInstance", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class BdsInstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BdsInstanceCloudSqlDetailsArgs>? CloudSqlDetails { get; set; }
    ...
    public sealed class BdsInstanceState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cloudSqlDetails")]
        public Input<Inputs.BdsInstanceCloudSqlDetailsGetArgs>? CloudSqlDetails { get; set; }
        ...
        public Input<Inputs.BdsInstanceClusterDetailsGetArgs>? ClusterDetails { get; set; }
