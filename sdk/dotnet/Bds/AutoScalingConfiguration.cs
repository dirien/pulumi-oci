...
namespace Pulumi.Oci.Bds
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAutoScalingConfiguration = new Oci.Bds.AutoScalingConfiguration("testAutoScalingConfiguration", new Oci.Bds.AutoScalingConfigurationArgs
    ///         {
    ...
    ///             Policy = new Oci.Bds.Inputs.AutoScalingConfigurationPolicyArgs
    ///             {
    ///                 PolicyType = @var.Auto_scaling_configuration_policy_policy_type,
    ///                 Rules = 
    ///                 {
    ///                     new Oci.Bds.Inputs.AutoScalingConfigurationPolicyRuleArgs
    ///                     {
    ///                         Action = @var.Auto_scaling_configuration_policy_rules_action,
    ///                         Metric = new Oci.Bds.Inputs.AutoScalingConfigurationPolicyRuleMetricArgs
    ///                         {
    ///                             MetricType = @var.Auto_scaling_configuration_policy_rules_metric_metric_type,
    ///                             Threshold = new Oci.Bds.Inputs.AutoScalingConfigurationPolicyRuleMetricThresholdArgs
    ///                             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:bds/autoScalingConfiguration:AutoScalingConfiguration")]
    public partial class AutoScalingConfiguration : Pulumi.CustomResource
    {
        ...
        public AutoScalingConfiguration(string name, AutoScalingConfigurationArgs args, CustomResourceOptions? options = null)
            : base("oci:bds/autoScalingConfiguration:AutoScalingConfiguration", name, args ?? new AutoScalingConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AutoScalingConfiguration(string name, Input<string> id, AutoScalingConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("oci:bds/autoScalingConfiguration:AutoScalingConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
