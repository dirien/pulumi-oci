...
{
    public static class GetArtifactsGenericArtifact
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testGenericArtifact = Output.Create(Oci.GetArtifactsGenericArtifact.InvokeAsync(new Oci.GetArtifactsGenericArtifactArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetArtifactsGenericArtifactResult> InvokeAsync(GetArtifactsGenericArtifactArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetArtifactsGenericArtifactResult>("oci:index/getArtifactsGenericArtifact:GetArtifactsGenericArtifact", args ?? new GetArtifactsGenericArtifactArgs(), options.WithVersion());
    }


    public sealed class GetArtifactsGenericArtifactArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetArtifactsGenericArtifactArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetArtifactsGenericArtifactResult
    {
        ...
        [OutputConstructor]
        private GetArtifactsGenericArtifactResult(
            string artifactId,
