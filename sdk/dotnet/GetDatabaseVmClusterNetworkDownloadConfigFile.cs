...
{
    public static class GetDatabaseVmClusterNetworkDownloadConfigFile
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVmClusterNetworkDownloadConfigFile = Output.Create(Oci.GetDatabaseVmClusterNetworkDownloadConfigFile.InvokeAsync(new Oci.GetDatabaseVmClusterNetworkDownloadConfigFileArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseVmClusterNetworkDownloadConfigFileResult> InvokeAsync(GetDatabaseVmClusterNetworkDownloadConfigFileArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseVmClusterNetworkDownloadConfigFileResult>("oci:index/getDatabaseVmClusterNetworkDownloadConfigFile:GetDatabaseVmClusterNetworkDownloadConfigFile", args ?? new GetDatabaseVmClusterNetworkDownloadConfigFileArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseVmClusterNetworkDownloadConfigFileArgs : Pulumi.InvokeArgs
    {
        ...
        public GetDatabaseVmClusterNetworkDownloadConfigFileArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseVmClusterNetworkDownloadConfigFileResult
    {
        ...
        [OutputConstructor]
        private GetDatabaseVmClusterNetworkDownloadConfigFileResult(
