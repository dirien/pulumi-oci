...
namespace Pulumi.Oci.Analytics
{
    public static class GetAnalyticsInstancePrivateAccessChannel
    {
        ...
        public static Task<GetAnalyticsInstancePrivateAccessChannelResult> InvokeAsync(GetAnalyticsInstancePrivateAccessChannelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAnalyticsInstancePrivateAccessChannelResult>("oci:analytics/getAnalyticsInstancePrivateAccessChannel:getAnalyticsInstancePrivateAccessChannel", args ?? new GetAnalyticsInstancePrivateAccessChannelArgs(), options.WithVersion());
    }
