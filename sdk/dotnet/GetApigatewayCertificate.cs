...
{
    public static class GetApigatewayCertificate
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testCertificate = Output.Create(Oci.GetApigatewayCertificate.InvokeAsync(new Oci.GetApigatewayCertificateArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetApigatewayCertificateResult> InvokeAsync(GetApigatewayCertificateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetApigatewayCertificateResult>("oci:index/getApigatewayCertificate:GetApigatewayCertificate", args ?? new GetApigatewayCertificateArgs(), options.WithVersion());
    }


    public sealed class GetApigatewayCertificateArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetApigatewayCertificateArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetApigatewayCertificateResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetApigatewayCertificateResult(
            string certificate,
