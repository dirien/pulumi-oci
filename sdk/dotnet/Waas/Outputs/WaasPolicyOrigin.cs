...
namespace Pulumi.Oci.Waas.Outputs
{
    ...
    [OutputType]
    public sealed class WaasPolicyOrigin
    {
        /// <summary>
        /// (Updatable) A list of HTTP headers to forward to your origin.
        /// </summary>
        public readonly ImmutableArray<Outputs.WaasPolicyOriginCustomHeader> CustomHeaders;
        /// <summary>
        ...
        [OutputConstructor]
        private WaasPolicyOrigin(
            ImmutableArray<Outputs.WaasPolicyOriginCustomHeader> customHeaders,
