...
namespace Pulumi.Oci.Waas
{
    public static class GetProtectionRule
    {
        ...
        public static Task<GetProtectionRuleResult> InvokeAsync(GetProtectionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetProtectionRuleResult>("oci:waas/getProtectionRule:getProtectionRule", args ?? new GetProtectionRuleArgs(), options.WithVersion());
    }
