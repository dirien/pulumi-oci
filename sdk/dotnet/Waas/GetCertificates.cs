...
namespace Pulumi.Oci.Waas
{
    public static class GetCertificates
    {
        ...
        public static Task<GetCertificatesResult> InvokeAsync(GetCertificatesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCertificatesResult>("oci:waas/getCertificates:getCertificates", args ?? new GetCertificatesArgs(), options.WithVersion());
    }
