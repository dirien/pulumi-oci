...
namespace Pulumi.Oci.Waas
{
    public static class GetCustomProtectionRules
    {
        ...
        public static Task<GetCustomProtectionRulesResult> InvokeAsync(GetCustomProtectionRulesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCustomProtectionRulesResult>("oci:waas/getCustomProtectionRules:getCustomProtectionRules", args ?? new GetCustomProtectionRulesArgs(), options.WithVersion());
    }
