...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyWafConfigCustomProtectionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionArgs>? _exclusions;
        ...
        /// </summary>
        public InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionArgs>());
        ...
        public WaasPolicyWafConfigCustomProtectionRuleArgs()
        {
        }
    }
}
