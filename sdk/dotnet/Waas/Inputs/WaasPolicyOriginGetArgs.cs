...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyOriginGetArgs : Pulumi.ResourceArgs
    {
        [Input("customHeaders")]
        private InputList<Inputs.WaasPolicyOriginCustomHeaderGetArgs>? _customHeaders;

        /// <summary>
        /// (Updatable) A list of HTTP headers to forward to your origin.
        /// </summary>
        public InputList<Inputs.WaasPolicyOriginCustomHeaderGetArgs> CustomHeaders
        {
            get => _customHeaders ?? (_customHeaders = new InputList<Inputs.WaasPolicyOriginCustomHeaderGetArgs>());
        ...
        public WaasPolicyOriginGetArgs()
        {
        }
    }
}
