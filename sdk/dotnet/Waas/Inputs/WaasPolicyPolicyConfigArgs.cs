...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyPolicyConfigArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("healthChecks")]
        public Input<Inputs.WaasPolicyPolicyConfigHealthChecksArgs>? HealthChecks { get; set; }
        ...
        public Input<Inputs.WaasPolicyPolicyConfigLoadBalancingMethodArgs>? LoadBalancingMethod { get; set; }
        ...
        public WaasPolicyPolicyConfigArgs()
        {
        }
    }
}
