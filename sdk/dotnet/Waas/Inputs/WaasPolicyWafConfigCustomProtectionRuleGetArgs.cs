...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyWafConfigCustomProtectionRuleGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("exclusions")]
        private InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs>? _exclusions;
        ...
        /// </summary>
        public InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs> Exclusions
        {
            get => _exclusions ?? (_exclusions = new InputList<Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionGetArgs>());
        ...
        public WaasPolicyWafConfigCustomProtectionRuleGetArgs()
        {
        }
    }
}
