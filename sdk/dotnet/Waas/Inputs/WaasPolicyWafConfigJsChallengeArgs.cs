...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyWafConfigJsChallengeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasPolicyWafConfigJsChallengeChallengeSettingsArgs>? ChallengeSettings { get; set; }

        [Input("criterias")]
        private InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaArgs>? _criterias;
        ...
        /// </summary>
        public InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaArgs>());
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasPolicyWafConfigJsChallengeSetHttpHeaderArgs>? SetHttpHeader { get; set; }

        public WaasPolicyWafConfigJsChallengeArgs()
        {
        }
    }
}
