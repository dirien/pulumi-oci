...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyWafConfigHumanInteractionChallengeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsArgs>? ChallengeSettings { get; set; }
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderArgs>? SetHttpHeader { get; set; }

        public WaasPolicyWafConfigHumanInteractionChallengeArgs()
        {
        }
    }
}
