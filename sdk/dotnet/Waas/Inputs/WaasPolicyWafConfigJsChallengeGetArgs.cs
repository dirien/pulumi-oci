...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class WaasPolicyWafConfigJsChallengeGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WaasPolicyWafConfigJsChallengeChallengeSettingsGetArgs>? ChallengeSettings { get; set; }

        [Input("criterias")]
        private InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaGetArgs>? _criterias;
        ...
        /// </summary>
        public InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaGetArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.WaasPolicyWafConfigJsChallengeCriteriaGetArgs>());
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.WaasPolicyWafConfigJsChallengeSetHttpHeaderGetArgs>? SetHttpHeader { get; set; }

        public WaasPolicyWafConfigJsChallengeGetArgs()
        {
        }
    }
}
