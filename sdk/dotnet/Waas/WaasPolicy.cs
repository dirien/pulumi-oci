...
namespace Pulumi.Oci.Waas
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testWaasPolicy = new Oci.Waas.WaasPolicy("testWaasPolicy", new Oci.Waas.WaasPolicyArgs
    ///         {
    ...
    ///             OriginGroups = 
    ///             {
    ///                 new Oci.Waas.Inputs.WaasPolicyOriginGroupArgs
    ///                 {
    ...
    ///             Origins = 
    ///             {
    ///                 new Oci.Waas.Inputs.WaasPolicyOriginArgs
    ///                 {
    ///                     Uri = @var.Waas_policy_origins_uri,
    ///                     CustomHeaders = 
    ///                     {
    ///                         new Oci.Waas.Inputs.WaasPolicyOriginCustomHeaderArgs
    ///                         {
    ...
    ///                 },
    ///             },
    ///             PolicyConfig = new Oci.Waas.Inputs.WaasPolicyPolicyConfigArgs
    ///             {
    ...
    ///                 HealthChecks = new Oci.Waas.Inputs.WaasPolicyPolicyConfigHealthChecksArgs
    ///                 {
    ...
    ///                 LoadBalancingMethod = new Oci.Waas.Inputs.WaasPolicyPolicyConfigLoadBalancingMethodArgs
    ///                 {
    ...
    ///             },
    ///             WafConfig = new Oci.Waas.Inputs.WaasPolicyWafConfigArgs
    ///             {
    ///                 AccessRules = 
    ///                 {
    ///                     new Oci.Waas.Inputs.WaasPolicyWafConfigAccessRuleArgs
    ///                     {
    ///                         Action = @var.Waas_policy_waf_config_access_rules_action,
    ///                         Criterias = 
    ///                         {
    ///                             new Oci.Waas.Inputs.WaasPolicyWafConfigAccessRuleCriteriaArgs
    ///                             {
    ...
    ///                         {
    ///                             new Oci.Waas.Inputs.WaasPolicyWafConfigAccessRuleResponseHeaderManipulationArgs
    ///                             {
    ...
    ///                     },
    ///                 },
    ///                 AddressRateLimiting = new Oci.Waas.Inputs.WaasPolicyWafConfigAddressRateLimitingArgs
    ///                 {
    ...
    ///                 CachingRules = 
    ///                 {
    ///                     new Oci.Waas.Inputs.WaasPolicyWafConfigCachingRuleArgs
    ///                     {
    ///                         Action = @var.Waas_policy_waf_config_caching_rules_action,
    ///                         Criterias = 
    ///                         {
    ///                             new Oci.Waas.Inputs.WaasPolicyWafConfigCachingRuleCriteriaArgs
    ///                             {
    ...
    ///                 Captchas = 
    ///                 {
    ///                     new Oci.Waas.Inputs.WaasPolicyWafConfigCaptchaArgs
    ///                     {
    ...
    ///                 {
    ///                     new Oci.Waas.Inputs.WaasPolicyWafConfigCustomProtectionRuleArgs
    ///                     {
    ///                         Action = @var.Waas_policy_waf_config_custom_protection_rules_action,
    ///                         Exclusions = 
    ///                         {
    ///                             new Oci.Waas.Inputs.WaasPolicyWafConfigCustomProtectionRuleExclusionArgs
    ///                             {
    ...
    ///                     },
    ///                 },
    ///                 DeviceFingerprintChallenge = new Oci.Waas.Inputs.WaasPolicyWafConfigDeviceFingerprintChallengeArgs
    ///                 {
    ...
    ///                     ChallengeSettings = new Oci.Waas.Inputs.WaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettingsArgs
    ///                     {
    ...
    ///                 },
    ///                 HumanInteractionChallenge = new Oci.Waas.Inputs.WaasPolicyWafConfigHumanInteractionChallengeArgs
    ///                 {
    ...
    ///                     ChallengeSettings = new Oci.Waas.Inputs.WaasPolicyWafConfigHumanInteractionChallengeChallengeSettingsArgs
    ///                     {
    ...
    ///                     SetHttpHeader = new Oci.Waas.Inputs.WaasPolicyWafConfigHumanInteractionChallengeSetHttpHeaderArgs
    ///                     {
    ...
    ///                     },
    ///                 },
    ///                 JsChallenge = new Oci.Waas.Inputs.WaasPolicyWafConfigJsChallengeArgs
    ///                 {
    ...
    ///                     ChallengeSettings = new Oci.Waas.Inputs.WaasPolicyWafConfigJsChallengeChallengeSettingsArgs
    ///                     {
    ...
    ///                     Criterias = 
    ///                     {
    ///                         new Oci.Waas.Inputs.WaasPolicyWafConfigJsChallengeCriteriaArgs
    ///                         {
    ...
    ///                     SetHttpHeader = new Oci.Waas.Inputs.WaasPolicyWafConfigJsChallengeSetHttpHeaderArgs
    ///                     {
    ...
    ///                 ProtectionSettings = new Oci.Waas.Inputs.WaasPolicyWafConfigProtectionSettingsArgs
    ///                 {
    ...
    ///                 Whitelists = 
    ///                 {
    ///                     new Oci.Waas.Inputs.WaasPolicyWafConfigWhitelistArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:waas/waasPolicy:WaasPolicy")]
    public partial class WaasPolicy : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("originGroups")]
        public Output<ImmutableArray<Outputs.WaasPolicyOriginGroup>> OriginGroups { get; private set; } = null!;
        ...
        /// </summary>
        [Output("origins")]
        public Output<ImmutableArray<Outputs.WaasPolicyOrigin>> Origins { get; private set; } = null!;

        /// <summary>
        /// (Updatable) The configuration details for the WAAS policy.
        /// </summary>
        [Output("policyConfig")]
        public Output<Outputs.WaasPolicyPolicyConfig> PolicyConfig { get; private set; } = null!;
        ...
        /// </summary>
        [Output("wafConfig")]
        public Output<Outputs.WaasPolicyWafConfig> WafConfig { get; private set; } = null!;
        ...
        public WaasPolicy(string name, WaasPolicyArgs args, CustomResourceOptions? options = null)
            : base("oci:waas/waasPolicy:WaasPolicy", name, args ?? new WaasPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WaasPolicy(string name, Input<string> id, WaasPolicyState? state = null, CustomResourceOptions? options = null)
            : base("oci:waas/waasPolicy:WaasPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WaasPolicy Get(string name, Input<string> id, WaasPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new WaasPolicy(name, id, state, options);
        }
    }

    public sealed class WaasPolicyArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("originGroups")]
        private InputList<Inputs.WaasPolicyOriginGroupArgs>? _originGroups;

        /// <summary>
        /// (Updatable) The map of origin groups and their keys used to associate origins to the `wafConfig`. Origin groups allow you to apply weights to groups of origins for load balancing purposes. Origins with higher weights will receive larger proportions of client requests. To add additional origins to your WAAS policy, update the `origins` field of a `UpdateWaasPolicy` request.
        /// </summary>
        public InputList<Inputs.WaasPolicyOriginGroupArgs> OriginGroups
        {
            get => _originGroups ?? (_originGroups = new InputList<Inputs.WaasPolicyOriginGroupArgs>());
            set => _originGroups = value;
        }

        [Input("origins")]
        private InputList<Inputs.WaasPolicyOriginArgs>? _origins;

        /// <summary>
        /// (Updatable) A map of host to origin for the web application. The key should be a customer friendly name for the host, ex. primary, secondary, etc.
        /// </summary>
        public InputList<Inputs.WaasPolicyOriginArgs> Origins
        {
            get => _origins ?? (_origins = new InputList<Inputs.WaasPolicyOriginArgs>());
            set => _origins = value;
        }
        ...
        /// </summary>
        [Input("policyConfig")]
        public Input<Inputs.WaasPolicyPolicyConfigArgs>? PolicyConfig { get; set; }

        /// <summary>
        /// (Updatable) The Web Application Firewall configuration for the WAAS policy creation.
        /// </summary>
        [Input("wafConfig")]
        public Input<Inputs.WaasPolicyWafConfigArgs>? WafConfig { get; set; }

        public WaasPolicyArgs()
        {
        }
    }

    public sealed class WaasPolicyState : Pulumi.ResourceArgs
    {
        [Input("additionalDomains")]
        private InputList<string>? _additionalDomains;
        ...
        [Input("originGroups")]
        private InputList<Inputs.WaasPolicyOriginGroupGetArgs>? _originGroups;

        /// <summary>
        /// (Updatable) The map of origin groups and their keys used to associate origins to the `wafConfig`. Origin groups allow you to apply weights to groups of origins for load balancing purposes. Origins with higher weights will receive larger proportions of client requests. To add additional origins to your WAAS policy, update the `origins` field of a `UpdateWaasPolicy` request.
        /// </summary>
        public InputList<Inputs.WaasPolicyOriginGroupGetArgs> OriginGroups
        {
            get => _originGroups ?? (_originGroups = new InputList<Inputs.WaasPolicyOriginGroupGetArgs>());
            set => _originGroups = value;
        }

        [Input("origins")]
        private InputList<Inputs.WaasPolicyOriginGetArgs>? _origins;

        /// <summary>
        /// (Updatable) A map of host to origin for the web application. The key should be a customer friendly name for the host, ex. primary, secondary, etc.
        /// </summary>
        public InputList<Inputs.WaasPolicyOriginGetArgs> Origins
        {
            get => _origins ?? (_origins = new InputList<Inputs.WaasPolicyOriginGetArgs>());
            set => _origins = value;
        }
        ...
        /// </summary>
        [Input("policyConfig")]
        public Input<Inputs.WaasPolicyPolicyConfigGetArgs>? PolicyConfig { get; set; }
        ...
        /// </summary>
        [Input("wafConfig")]
        public Input<Inputs.WaasPolicyWafConfigGetArgs>? WafConfig { get; set; }

        public WaasPolicyState()
        {
        }
    }
}
