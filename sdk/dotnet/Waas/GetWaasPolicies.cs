...
namespace Pulumi.Oci.Waas
{
    public static class GetWaasPolicies
    {
        ...
        public static Task<GetWaasPoliciesResult> InvokeAsync(GetWaasPoliciesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWaasPoliciesResult>("oci:waas/getWaasPolicies:getWaasPolicies", args ?? new GetWaasPoliciesArgs(), options.WithVersion());
    }
