...
namespace Pulumi.Oci.Waas
{
    public static class GetAddressLists
    {
        ...
        public static Task<GetAddressListsResult> InvokeAsync(GetAddressListsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAddressListsResult>("oci:waas/getAddressLists:getAddressLists", args ?? new GetAddressListsArgs(), options.WithVersion());
    }
