...
namespace Pulumi.Oci.Mysql
{
    public static class GetAnalyticsCluster
    {
        ...
        public static Task<GetAnalyticsClusterResult> InvokeAsync(GetAnalyticsClusterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAnalyticsClusterResult>("oci:mysql/getAnalyticsCluster:getAnalyticsCluster", args ?? new GetAnalyticsClusterArgs(), options.WithVersion());
    }
