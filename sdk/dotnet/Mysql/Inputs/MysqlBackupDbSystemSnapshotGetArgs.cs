...
namespace Pulumi.Oci.Mysql.Inputs
{
    ...
    public sealed class MysqlBackupDbSystemSnapshotGetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("backupPolicy")]
        public Input<Inputs.MysqlBackupDbSystemSnapshotBackupPolicyGetArgs>? BackupPolicy { get; set; }
        ...
        /// </summary>
        [Input("maintenance")]
        public Input<Inputs.MysqlBackupDbSystemSnapshotMaintenanceGetArgs>? Maintenance { get; set; }
