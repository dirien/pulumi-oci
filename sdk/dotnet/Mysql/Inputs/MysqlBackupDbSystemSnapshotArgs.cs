...
namespace Pulumi.Oci.Mysql.Inputs
{
    ...
    public sealed class MysqlBackupDbSystemSnapshotArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("backupPolicy")]
        public Input<Inputs.MysqlBackupDbSystemSnapshotBackupPolicyArgs>? BackupPolicy { get; set; }
        ...
        /// </summary>
        [Input("maintenance")]
        public Input<Inputs.MysqlBackupDbSystemSnapshotMaintenanceArgs>? Maintenance { get; set; }
