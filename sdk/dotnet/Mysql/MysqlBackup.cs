...
namespace Pulumi.Oci.Mysql
{
    ...
    public partial class MysqlBackup : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.MysqlBackupDbSystemSnapshot> DbSystemSnapshot { get; private set; } = null!;
    ...
    public sealed class MysqlBackupState : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.MysqlBackupDbSystemSnapshotGetArgs>? DbSystemSnapshot { get; set; }
