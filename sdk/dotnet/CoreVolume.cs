...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVolume = new Oci.CoreVolume("testVolume", new Oci.CoreVolumeArgs
    ///         {
    ...
    ///             BlockVolumeReplicas = 
    ///             {
    ///                 new Oci.Inputs.CoreVolumeBlockVolumeReplicaArgs
    ///                 {
    ...
    ///             SourceDetails = new Oci.Inputs.CoreVolumeSourceDetailsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreVolume:CoreVolume")]
    public partial class CoreVolume : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CoreVolumeBlockVolumeReplica>> BlockVolumeReplicas { get; private set; } = null!;
        ...
        public Output<Outputs.CoreVolumeSourceDetails> SourceDetails { get; private set; } = null!;
        ...
        public CoreVolume(string name, CoreVolumeArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreVolume:CoreVolume", name, args ?? new CoreVolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreVolume(string name, Input<string> id, CoreVolumeState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreVolume:CoreVolume", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreVolume Get(string name, Input<string> id, CoreVolumeState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreVolume(name, id, state, options);
        }
    }

    public sealed class CoreVolumeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The availability domain of the block volume replica.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        private InputList<Inputs.CoreVolumeBlockVolumeReplicaArgs>? _blockVolumeReplicas;

        /// <summary>
        /// (Updatable) The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
        /// </summary>
        public InputList<Inputs.CoreVolumeBlockVolumeReplicaArgs> BlockVolumeReplicas
        {
            get => _blockVolumeReplicas ?? (_blockVolumeReplicas = new InputList<Inputs.CoreVolumeBlockVolumeReplicaArgs>());
        ...
        [Input("sourceDetails")]
        public Input<Inputs.CoreVolumeSourceDetailsArgs>? SourceDetails { get; set; }
        ...
        public CoreVolumeArgs()
        {
        }
    }

    public sealed class CoreVolumeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The number of Volume Performance Units per GB that this volume is effectively tuned to when it's idle.
        /// </summary>
        ...
        [Input("blockVolumeReplicas")]
        private InputList<Inputs.CoreVolumeBlockVolumeReplicaGetArgs>? _blockVolumeReplicas;

        /// <summary>
        /// (Updatable) The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
        /// </summary>
        public InputList<Inputs.CoreVolumeBlockVolumeReplicaGetArgs> BlockVolumeReplicas
        {
            get => _blockVolumeReplicas ?? (_blockVolumeReplicas = new InputList<Inputs.CoreVolumeBlockVolumeReplicaGetArgs>());
            set => _blockVolumeReplicas = value;
        }
        ...
        [Input("sourceDetails")]
        public Input<Inputs.CoreVolumeSourceDetailsGetArgs>? SourceDetails { get; set; }
