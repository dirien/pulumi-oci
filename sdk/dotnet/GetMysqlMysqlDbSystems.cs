...
{
    public static class GetMysqlMysqlDbSystems
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testMysqlDbSystems = Output.Create(Oci.GetMysqlMysqlDbSystems.InvokeAsync(new Oci.GetMysqlMysqlDbSystemsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetMysqlMysqlDbSystemsResult> InvokeAsync(GetMysqlMysqlDbSystemsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMysqlMysqlDbSystemsResult>("oci:index/getMysqlMysqlDbSystems:GetMysqlMysqlDbSystems", args ?? new GetMysqlMysqlDbSystemsArgs(), options.WithVersion());
    }


    public sealed class GetMysqlMysqlDbSystemsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetMysqlMysqlDbSystemsFilterArgs>? _filters;
        public List<Inputs.GetMysqlMysqlDbSystemsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetMysqlMysqlDbSystemsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetMysqlMysqlDbSystemsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetMysqlMysqlDbSystemsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetMysqlMysqlDbSystemsDbSystemResult> DbSystems;
        /// <summary>
        /// The user-friendly name for the DB System. It does not have to be unique.
        /// </summary>
        public readonly string? DisplayName;
        public readonly ImmutableArray<Outputs.GetMysqlMysqlDbSystemsFilterResult> Filters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetMysqlMysqlDbSystemsResult(
            ...
            ImmutableArray<Outputs.GetMysqlMysqlDbSystemsDbSystemResult> dbSystems,

            string? displayName,

            ImmutableArray<Outputs.GetMysqlMysqlDbSystemsFilterResult> filters,
