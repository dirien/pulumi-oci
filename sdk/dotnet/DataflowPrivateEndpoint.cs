...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/dataflowPrivateEndpoint:DataflowPrivateEndpoint")]
    public partial class DataflowPrivateEndpoint : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DataflowPrivateEndpoint(string name, DataflowPrivateEndpointArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dataflowPrivateEndpoint:DataflowPrivateEndpoint", name, args ?? new DataflowPrivateEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowPrivateEndpoint(string name, Input<string> id, DataflowPrivateEndpointState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dataflowPrivateEndpoint:DataflowPrivateEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataflowPrivateEndpoint Get(string name, Input<string> id, DataflowPrivateEndpointState? state = null, CustomResourceOptions? options = null)
        {
            return new DataflowPrivateEndpoint(name, id, state, options);
        }
    }

    public sealed class DataflowPrivateEndpointArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of a compartment.
        /// </summary>
        ...
        public DataflowPrivateEndpointArgs()
        {
        }
    }

    public sealed class DataflowPrivateEndpointState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of a compartment.
        /// </summary>
        ...
        public DataflowPrivateEndpointState()
        {
        }
    }
}
