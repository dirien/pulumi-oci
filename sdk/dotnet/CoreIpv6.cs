...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testIpv6 = new Oci.CoreIpv6("testIpv6", new Oci.CoreIpv6Args
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreIpv6:CoreIpv6")]
    public partial class CoreIpv6 : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreIpv6(string name, CoreIpv6Args args, CustomResourceOptions? options = null)
            : base("oci:index/coreIpv6:CoreIpv6", name, args ?? new CoreIpv6Args(), MakeResourceOptions(options, ""))
        {
        }

        private CoreIpv6(string name, Input<string> id, CoreIpv6State? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreIpv6:CoreIpv6", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreIpv6 Get(string name, Input<string> id, CoreIpv6State? state = null, CustomResourceOptions? options = null)
        {
            return new CoreIpv6(name, id, state, options);
        }
    }

    public sealed class CoreIpv6Args : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
    ...
    public sealed class CoreIpv6State : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the IPv6. This is the same as the VNIC's compartment.
        /// </summary>
