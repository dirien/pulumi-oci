...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testMountTarget = new Oci.FileStorageMountTarget("testMountTarget", new Oci.FileStorageMountTargetArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/fileStorageMountTarget:FileStorageMountTarget")]
    public partial class FileStorageMountTarget : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FileStorageMountTarget(string name, FileStorageMountTargetArgs args, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageMountTarget:FileStorageMountTarget", name, args ?? new FileStorageMountTargetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileStorageMountTarget(string name, Input<string> id, FileStorageMountTargetState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageMountTarget:FileStorageMountTarget", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FileStorageMountTarget Get(string name, Input<string> id, FileStorageMountTargetState? state = null, CustomResourceOptions? options = null)
        {
            return new FileStorageMountTarget(name, id, state, options);
        }
    }

    public sealed class FileStorageMountTargetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain in which to create the mount target.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public FileStorageMountTargetArgs()
        {
        }
    }

    public sealed class FileStorageMountTargetState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain in which to create the mount target.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public FileStorageMountTargetState()
        {
        }
    }
}
