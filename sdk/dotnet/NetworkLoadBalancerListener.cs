...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testListener = new Oci.NetworkLoadBalancerListener("testListener", new Oci.NetworkLoadBalancerListenerArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/networkLoadBalancerListener:NetworkLoadBalancerListener")]
    public partial class NetworkLoadBalancerListener : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public NetworkLoadBalancerListener(string name, NetworkLoadBalancerListenerArgs args, CustomResourceOptions? options = null)
            : base("oci:index/networkLoadBalancerListener:NetworkLoadBalancerListener", name, args ?? new NetworkLoadBalancerListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkLoadBalancerListener(string name, Input<string> id, NetworkLoadBalancerListenerState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/networkLoadBalancerListener:NetworkLoadBalancerListener", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkLoadBalancerListener Get(string name, Input<string> id, NetworkLoadBalancerListenerState? state = null, CustomResourceOptions? options = null)
        {
            return new NetworkLoadBalancerListener(name, id, state, options);
        }
    }

    public sealed class NetworkLoadBalancerListenerArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The name of the associated backend set.  Example: `example_backend_set`
        /// </summary>
        ...
        public NetworkLoadBalancerListenerArgs()
        {
        }
    }

    public sealed class NetworkLoadBalancerListenerState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The name of the associated backend set.  Example: `example_backend_set`
        /// </summary>
        ...
        public NetworkLoadBalancerListenerState()
        {
        }
    }
}
