...
namespace Pulumi.Oci.Marketplace
{
    public static class GetAcceptedAgreement
    {
        ...
        public static Task<GetAcceptedAgreementResult> InvokeAsync(GetAcceptedAgreementArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAcceptedAgreementResult>("oci:marketplace/getAcceptedAgreement:getAcceptedAgreement", args ?? new GetAcceptedAgreementArgs(), options.WithVersion());
    }
