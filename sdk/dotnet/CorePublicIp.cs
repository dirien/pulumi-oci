...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPublicIp = new Oci.CorePublicIp("testPublicIp", new Oci.CorePublicIpArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/corePublicIp:CorePublicIp")]
    public partial class CorePublicIp : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CorePublicIp(string name, CorePublicIpArgs args, CustomResourceOptions? options = null)
            : base("oci:index/corePublicIp:CorePublicIp", name, args ?? new CorePublicIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CorePublicIp(string name, Input<string> id, CorePublicIpState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/corePublicIp:CorePublicIp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CorePublicIp Get(string name, Input<string> id, CorePublicIpState? state = null, CustomResourceOptions? options = null)
        {
            return new CorePublicIp(name, id, state, options);
        }
    }

    public sealed class CorePublicIpArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the public IP. For ephemeral public IPs, you must set this to the private IP's compartment OCID.
        /// </summary>
        ...
        public CorePublicIpArgs()
        {
        }
    }

    public sealed class CorePublicIpState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the entity the public IP is assigned to, or in the process of being assigned to.
        /// </summary>
