...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testLog = new Oci.LoggingLog("testLog", new Oci.LoggingLogArgs
    ///         {
    ///             DisplayName = @var.Log_display_name,
    ///             LogGroupId = oci_logging_log_group.Test_log_group.Id,
    ///             LogType = @var.Log_log_type,
    ///             Configuration = new Oci.Inputs.LoggingLogConfigurationArgs
    ///             {
    ///                 Source = new Oci.Inputs.LoggingLogConfigurationSourceArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/loggingLog:LoggingLog")]
    public partial class LoggingLog : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.LoggingLogConfiguration> Configuration { get; private set; } = null!;
        ...
        public LoggingLog(string name, LoggingLogArgs args, CustomResourceOptions? options = null)
            : base("oci:index/loggingLog:LoggingLog", name, args ?? new LoggingLogArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoggingLog(string name, Input<string> id, LoggingLogState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/loggingLog:LoggingLog", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LoggingLog Get(string name, Input<string> id, LoggingLogState? state = null, CustomResourceOptions? options = null)
        {
            return new LoggingLog(name, id, state, options);
        }
    }

    public sealed class LoggingLogArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Log object configuration.
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.LoggingLogConfigurationArgs>? Configuration { get; set; }
        ...
        public LoggingLogArgs()
        {
        }
    }

    public sealed class LoggingLogState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment that the resource belongs to.
        /// </summary>
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.LoggingLogConfigurationGetArgs>? Configuration { get; set; }
