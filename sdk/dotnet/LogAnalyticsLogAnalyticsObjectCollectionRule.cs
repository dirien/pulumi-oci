...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testLogAnalyticsObjectCollectionRule = new Oci.LogAnalyticsLogAnalyticsObjectCollectionRule("testLogAnalyticsObjectCollectionRule", new Oci.LogAnalyticsLogAnalyticsObjectCollectionRuleArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/logAnalyticsLogAnalyticsObjectCollectionRule:LogAnalyticsLogAnalyticsObjectCollectionRule")]
    public partial class LogAnalyticsLogAnalyticsObjectCollectionRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("overrides")]
        public Output<ImmutableArray<Outputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverride>> Overrides { get; private set; } = null!;
        ...
        public LogAnalyticsLogAnalyticsObjectCollectionRule(string name, LogAnalyticsLogAnalyticsObjectCollectionRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/logAnalyticsLogAnalyticsObjectCollectionRule:LogAnalyticsLogAnalyticsObjectCollectionRule", name, args ?? new LogAnalyticsLogAnalyticsObjectCollectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LogAnalyticsLogAnalyticsObjectCollectionRule(string name, Input<string> id, LogAnalyticsLogAnalyticsObjectCollectionRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/logAnalyticsLogAnalyticsObjectCollectionRule:LogAnalyticsLogAnalyticsObjectCollectionRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LogAnalyticsLogAnalyticsObjectCollectionRule Get(string name, Input<string> id, LogAnalyticsLogAnalyticsObjectCollectionRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new LogAnalyticsLogAnalyticsObjectCollectionRule(name, id, state, options);
        }
    }

    public sealed class LogAnalyticsLogAnalyticsObjectCollectionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) An optional character encoding to aid in detecting the character encoding of the contents of the objects while processing. It is recommended to set this value as ISO_8589_1 when configuring content of the objects having more numeric characters, and very few alphabets. For e.g. this applies when configuring VCN Flow Logs.
        /// </summary>
        ...
        [Input("overrides")]
        private InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs>? _overrides;

        /// <summary>
        /// (Updatable) The override is used to modify some important configuration properties for objects matching a specific pattern inside the bucket. Supported propeties for override are - logSourceName, charEncoding. Supported matchType for override are "contains".
        /// </summary>
        public InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs> Overrides
        {
            get => _overrides ?? (_overrides = new InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs>());
        ...
        public LogAnalyticsLogAnalyticsObjectCollectionRuleArgs()
        {
        }
    }

    public sealed class LogAnalyticsLogAnalyticsObjectCollectionRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) An optional character encoding to aid in detecting the character encoding of the contents of the objects while processing. It is recommended to set this value as ISO_8589_1 when configuring content of the objects having more numeric characters, and very few alphabets. For e.g. this applies when configuring VCN Flow Logs.
        /// </summary>
        ...
        [Input("overrides")]
        private InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideGetArgs>? _overrides;

        /// <summary>
        /// (Updatable) The override is used to modify some important configuration properties for objects matching a specific pattern inside the bucket. Supported propeties for override are - logSourceName, charEncoding. Supported matchType for override are "contains".
        /// </summary>
        public InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideGetArgs> Overrides
        {
            get => _overrides ?? (_overrides = new InputList<Inputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideGetArgs>());
            set => _overrides = value;
        }
        ...
        public LogAnalyticsLogAnalyticsObjectCollectionRuleState()
        {
        }
    }
}
