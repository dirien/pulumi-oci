...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/databaseMaintenanceRun:DatabaseMaintenanceRun")]
    public partial class DatabaseMaintenanceRun : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatabaseMaintenanceRun(string name, DatabaseMaintenanceRunArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseMaintenanceRun:DatabaseMaintenanceRun", name, args ?? new DatabaseMaintenanceRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseMaintenanceRun(string name, Input<string> id, DatabaseMaintenanceRunState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseMaintenanceRun:DatabaseMaintenanceRun", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseMaintenanceRun Get(string name, Input<string> id, DatabaseMaintenanceRunState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseMaintenanceRun(name, id, state, options);
        }
    }

    public sealed class DatabaseMaintenanceRunArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) If `FALSE`, skips the maintenance run.
        /// </summary>
        ...
        public DatabaseMaintenanceRunArgs()
        {
        }
    }

    public sealed class DatabaseMaintenanceRunState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment.
        /// </summary>
        ...
        public DatabaseMaintenanceRunState()
        {
        }
    }
}
