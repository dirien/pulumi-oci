...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAlertRule = new Oci.BudgetAlertRule("testAlertRule", new Oci.BudgetAlertRuleArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/budgetAlertRule:BudgetAlertRule")]
    public partial class BudgetAlertRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public BudgetAlertRule(string name, BudgetAlertRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/budgetAlertRule:BudgetAlertRule", name, args ?? new BudgetAlertRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BudgetAlertRule(string name, Input<string> id, BudgetAlertRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/budgetAlertRule:BudgetAlertRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BudgetAlertRule Get(string name, Input<string> id, BudgetAlertRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new BudgetAlertRule(name, id, state, options);
        }
    }

    public sealed class BudgetAlertRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique Budget OCID
        /// </summary>
        ...
        public BudgetAlertRuleArgs()
        {
        }
    }

    public sealed class BudgetAlertRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique Budget OCID
        /// </summary>
