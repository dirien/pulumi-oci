...
{
    public static class GetCoreIpv6s
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testIpv6s = Output.Create(Oci.GetCoreIpv6s.InvokeAsync(new Oci.GetCoreIpv6sArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreIpv6sResult> InvokeAsync(GetCoreIpv6sArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreIpv6sResult>("oci:index/getCoreIpv6s:GetCoreIpv6s", args ?? new GetCoreIpv6sArgs(), options.WithVersion());
    }


    public sealed class GetCoreIpv6sArgs : Pulumi.InvokeArgs
    {
        [Input("filters")]
        private List<Inputs.GetCoreIpv6sFilterArgs>? _filters;
        public List<Inputs.GetCoreIpv6sFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetCoreIpv6sFilterArgs>());
            set => _filters = value;
        }
    ...
    [OutputType]
    public sealed class GetCoreIpv6sResult
    {
        public readonly ImmutableArray<Outputs.GetCoreIpv6sFilterResult> Filters;
        /// <summary>
        ...
        /// The list of ipv6s.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreIpv6sIpv6Result> Ipv6s;
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreIpv6sResult(
            ImmutableArray<Outputs.GetCoreIpv6sFilterResult> filters,

            string id,

            string? ipAddress,

            ImmutableArray<Outputs.GetCoreIpv6sIpv6Result> ipv6s,
