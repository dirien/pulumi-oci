...
namespace Pulumi.Oci.ApiGateway
{
    public static class GetDeployments
    {
        ...
        public static Task<GetDeploymentsResult> InvokeAsync(GetDeploymentsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeploymentsResult>("oci:apigateway/getDeployments:getDeployments", args ?? new GetDeploymentsArgs(), options.WithVersion());
    }
