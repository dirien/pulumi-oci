...
{
    public static class GetDnsRrset
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testRrset = Output.Create(Oci.GetDnsRrset.InvokeAsync(new Oci.GetDnsRrsetArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDnsRrsetResult> InvokeAsync(GetDnsRrsetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDnsRrsetResult>("oci:index/getDnsRrset:GetDnsRrset", args ?? new GetDnsRrsetArgs(), options.WithVersion());
    }


    public sealed class GetDnsRrsetArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetDnsRrsetResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetDnsRrsetItemResult> Items;
        /// <summary>
        ...
        private GetDnsRrsetResult(
            ...
            ImmutableArray<Outputs.GetDnsRrsetItemResult> items,
