...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPluggableDatabasesLocalClone = new Oci.DatabasePluggableDatabasesLocalClone("testPluggableDatabasesLocalClone", new Oci.DatabasePluggableDatabasesLocalCloneArgs
    ///         {
    ...
    /// </summary>
    [OciResourceType("oci:index/databasePluggableDatabasesLocalClone:DatabasePluggableDatabasesLocalClone")]
    public partial class DatabasePluggableDatabasesLocalClone : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.DatabasePluggableDatabasesLocalCloneConnectionStrings> ConnectionStrings { get; private set; } = null!;
        ...
        public DatabasePluggableDatabasesLocalClone(string name, DatabasePluggableDatabasesLocalCloneArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databasePluggableDatabasesLocalClone:DatabasePluggableDatabasesLocalClone", name, args ?? new DatabasePluggableDatabasesLocalCloneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabasePluggableDatabasesLocalClone(string name, Input<string> id, DatabasePluggableDatabasesLocalCloneState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databasePluggableDatabasesLocalClone:DatabasePluggableDatabasesLocalClone", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabasePluggableDatabasesLocalClone Get(string name, Input<string> id, DatabasePluggableDatabasesLocalCloneState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabasePluggableDatabasesLocalClone(name, id, state, options);
        }
    }

    public sealed class DatabasePluggableDatabasesLocalCloneArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        /// </summary>
        ...
        public DatabasePluggableDatabasesLocalCloneArgs()
        {
        }
    }

    public sealed class DatabasePluggableDatabasesLocalCloneState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        /// </summary>
        ...
        public Input<Inputs.DatabasePluggableDatabasesLocalCloneConnectionStringsGetArgs>? ConnectionStrings { get; set; }
        ...
        public DatabasePluggableDatabasesLocalCloneState()
        {
        }
    }
}
