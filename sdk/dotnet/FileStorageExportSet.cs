...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/fileStorageExportSet:FileStorageExportSet")]
    public partial class FileStorageExportSet : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public FileStorageExportSet(string name, FileStorageExportSetArgs args, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageExportSet:FileStorageExportSet", name, args ?? new FileStorageExportSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileStorageExportSet(string name, Input<string> id, FileStorageExportSetState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageExportSet:FileStorageExportSet", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FileStorageExportSet Get(string name, Input<string> id, FileStorageExportSetState? state = null, CustomResourceOptions? options = null)
        {
            return new FileStorageExportSet(name, id, state, options);
        }
    }

    public sealed class FileStorageExportSetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `My export set`
        /// </summary>
        ...
        public FileStorageExportSetArgs()
        {
        }
    }

    public sealed class FileStorageExportSetState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain the export set is in. May be unset as a blank or NULL value.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public FileStorageExportSetState()
        {
        }
    }
}
