...
{
    public static class GetWaasAddressList
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testAddressList = Output.Create(Oci.GetWaasAddressList.InvokeAsync(new Oci.GetWaasAddressListArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetWaasAddressListResult> InvokeAsync(GetWaasAddressListArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWaasAddressListResult>("oci:index/getWaasAddressList:GetWaasAddressList", args ?? new GetWaasAddressListArgs(), options.WithVersion());
    }


    public sealed class GetWaasAddressListArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetWaasAddressListResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetWaasAddressListResult(
            double addressCount,
