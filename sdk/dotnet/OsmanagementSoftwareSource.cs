...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSoftwareSource = new Oci.OsmanagementSoftwareSource("testSoftwareSource", new Oci.OsmanagementSoftwareSourceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/osmanagementSoftwareSource:OsmanagementSoftwareSource")]
    public partial class OsmanagementSoftwareSource : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.OsmanagementSoftwareSourceAssociatedManagedInstance>> AssociatedManagedInstances { get; private set; } = null!;
        ...
        public OsmanagementSoftwareSource(string name, OsmanagementSoftwareSourceArgs args, CustomResourceOptions? options = null)
            : base("oci:index/osmanagementSoftwareSource:OsmanagementSoftwareSource", name, args ?? new OsmanagementSoftwareSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OsmanagementSoftwareSource(string name, Input<string> id, OsmanagementSoftwareSourceState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/osmanagementSoftwareSource:OsmanagementSoftwareSource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OsmanagementSoftwareSource Get(string name, Input<string> id, OsmanagementSoftwareSourceState? state = null, CustomResourceOptions? options = null)
        {
            return new OsmanagementSoftwareSource(name, id, state, options);
        }
    }

    public sealed class OsmanagementSoftwareSourceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The architecture type supported by the Software Source
        /// </summary>
        ...
        public OsmanagementSoftwareSourceArgs()
        {
        }
    }

    public sealed class OsmanagementSoftwareSourceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The architecture type supported by the Software Source
        /// </summary>
        ...
        private InputList<Inputs.OsmanagementSoftwareSourceAssociatedManagedInstanceGetArgs>? _associatedManagedInstances;

        /// <summary>
        /// list of the Managed Instances associated with this Software Sources
        /// </summary>
        public InputList<Inputs.OsmanagementSoftwareSourceAssociatedManagedInstanceGetArgs> AssociatedManagedInstances
        {
            get => _associatedManagedInstances ?? (_associatedManagedInstances = new InputList<Inputs.OsmanagementSoftwareSourceAssociatedManagedInstanceGetArgs>());
        ...
        public OsmanagementSoftwareSourceState()
        {
        }
    }
}
