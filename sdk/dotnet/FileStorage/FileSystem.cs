...
namespace Pulumi.Oci.FileStorage
{
    ...
    public partial class FileSystem : Pulumi.CustomResource
    {
        ...
        public Output<Outputs.FileSystemSourceDetails> SourceDetails { get; private set; } = null!;
    ...
    public sealed class FileSystemState : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sourceDetails")]
        public Input<Inputs.FileSystemSourceDetailsGetArgs>? SourceDetails { get; set; }
