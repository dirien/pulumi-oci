...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSmtpCredential = new Oci.IdentitySmtpCredential("testSmtpCredential", new Oci.IdentitySmtpCredentialArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identitySmtpCredential:IdentitySmtpCredential")]
    public partial class IdentitySmtpCredential : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentitySmtpCredential(string name, IdentitySmtpCredentialArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identitySmtpCredential:IdentitySmtpCredential", name, args ?? new IdentitySmtpCredentialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentitySmtpCredential(string name, Input<string> id, IdentitySmtpCredentialState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identitySmtpCredential:IdentitySmtpCredential", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentitySmtpCredential Get(string name, Input<string> id, IdentitySmtpCredentialState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentitySmtpCredential(name, id, state, options);
        }
    }

    public sealed class IdentitySmtpCredentialArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the SMTP credentials during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentitySmtpCredentialArgs()
        {
        }
    }

    public sealed class IdentitySmtpCredentialState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The description you assign to the SMTP credentials during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentitySmtpCredentialState()
        {
        }
    }
}
