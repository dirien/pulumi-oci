...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testContainerImageSignature = new Oci.ArtifactsContainerImageSignature("testContainerImageSignature", new Oci.ArtifactsContainerImageSignatureArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/artifactsContainerImageSignature:ArtifactsContainerImageSignature")]
    public partial class ArtifactsContainerImageSignature : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ArtifactsContainerImageSignature(string name, ArtifactsContainerImageSignatureArgs args, CustomResourceOptions? options = null)
            : base("oci:index/artifactsContainerImageSignature:ArtifactsContainerImageSignature", name, args ?? new ArtifactsContainerImageSignatureArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ArtifactsContainerImageSignature(string name, Input<string> id, ArtifactsContainerImageSignatureState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/artifactsContainerImageSignature:ArtifactsContainerImageSignature", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ArtifactsContainerImageSignature Get(string name, Input<string> id, ArtifactsContainerImageSignatureState? state = null, CustomResourceOptions? options = null)
        {
            return new ArtifactsContainerImageSignature(name, id, state, options);
        }
    }

    public sealed class ArtifactsContainerImageSignatureArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the container repository exists.
        /// </summary>
        ...
        public ArtifactsContainerImageSignatureArgs()
        {
        }
    }

    public sealed class ArtifactsContainerImageSignatureState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the container repository exists.
        /// </summary>
        ...
        public ArtifactsContainerImageSignatureState()
        {
        }
    }
}
