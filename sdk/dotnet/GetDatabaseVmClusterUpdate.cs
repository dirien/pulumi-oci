...
{
    public static class GetDatabaseVmClusterUpdate
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVmClusterUpdate = Output.Create(Oci.GetDatabaseVmClusterUpdate.InvokeAsync(new Oci.GetDatabaseVmClusterUpdateArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseVmClusterUpdateResult> InvokeAsync(GetDatabaseVmClusterUpdateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseVmClusterUpdateResult>("oci:index/getDatabaseVmClusterUpdate:GetDatabaseVmClusterUpdate", args ?? new GetDatabaseVmClusterUpdateArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseVmClusterUpdateArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatabaseVmClusterUpdateArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseVmClusterUpdateResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseVmClusterUpdateResult(
