...
namespace Pulumi.Oci.Optimizer
{
    public static class GetResourceAction
    {
        ...
        public static Task<GetResourceActionResult> InvokeAsync(GetResourceActionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetResourceActionResult>("oci:optimizer/getResourceAction:getResourceAction", args ?? new GetResourceActionArgs(), options.WithVersion());
    }
    ...
    public sealed class GetResourceActionResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetResourceActionActionResult Action;
        /// <summary>
        ...
        private GetResourceActionResult(
            Outputs.GetResourceActionActionResult action,
