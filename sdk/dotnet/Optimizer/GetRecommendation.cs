...
namespace Pulumi.Oci.Optimizer
{
    public static class GetRecommendation
    {
        ...
        public static Task<GetRecommendationResult> InvokeAsync(GetRecommendationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRecommendationResult>("oci:optimizer/getRecommendation:getRecommendation", args ?? new GetRecommendationArgs(), options.WithVersion());
    }
    ...
    public sealed class GetRecommendationResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetRecommendationSupportedLevelsResult SupportedLevels;
        /// <summary>
        ...
        private GetRecommendationResult(
            ...
            Outputs.GetRecommendationSupportedLevelsResult supportedLevels,
