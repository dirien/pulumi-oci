...
namespace Pulumi.Oci.Optimizer
{
    public static class GetEnrollmentStatus
    {
        ...
        public static Task<GetEnrollmentStatusResult> InvokeAsync(GetEnrollmentStatusArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEnrollmentStatusResult>("oci:optimizer/getEnrollmentStatus:getEnrollmentStatus", args ?? new GetEnrollmentStatusArgs(), options.WithVersion());
    }
