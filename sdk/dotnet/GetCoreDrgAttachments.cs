...
{
    public static class GetCoreDrgAttachments
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDrgAttachments = Output.Create(Oci.GetCoreDrgAttachments.InvokeAsync(new Oci.GetCoreDrgAttachmentsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreDrgAttachmentsResult> InvokeAsync(GetCoreDrgAttachmentsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreDrgAttachmentsResult>("oci:index/getCoreDrgAttachments:GetCoreDrgAttachments", args ?? new GetCoreDrgAttachmentsArgs(), options.WithVersion());
    }


    public sealed class GetCoreDrgAttachmentsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetCoreDrgAttachmentsFilterArgs>? _filters;
        public List<Inputs.GetCoreDrgAttachmentsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetCoreDrgAttachmentsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetCoreDrgAttachmentsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreDrgAttachmentsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreDrgAttachmentsDrgAttachmentResult> DrgAttachments;
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG.
        /// </summary>
        ...
        public readonly ImmutableArray<Outputs.GetCoreDrgAttachmentsFilterResult> Filters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreDrgAttachmentsResult(
            ...
            ImmutableArray<Outputs.GetCoreDrgAttachmentsDrgAttachmentResult> drgAttachments,

            string? drgId,

            string? drgRouteTableId,

            ImmutableArray<Outputs.GetCoreDrgAttachmentsFilterResult> filters,
