...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testFileSystem = new Oci.FileStorageFileSystem("testFileSystem", new Oci.FileStorageFileSystemArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/fileStorageFileSystem:FileStorageFileSystem")]
    public partial class FileStorageFileSystem : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.FileStorageFileSystemSourceDetails> SourceDetails { get; private set; } = null!;
        ...
        public FileStorageFileSystem(string name, FileStorageFileSystemArgs args, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageFileSystem:FileStorageFileSystem", name, args ?? new FileStorageFileSystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FileStorageFileSystem(string name, Input<string> id, FileStorageFileSystemState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/fileStorageFileSystem:FileStorageFileSystem", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FileStorageFileSystem Get(string name, Input<string> id, FileStorageFileSystemState? state = null, CustomResourceOptions? options = null)
        {
            return new FileStorageFileSystem(name, id, state, options);
        }
    }

    public sealed class FileStorageFileSystemArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain to create the file system in.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public FileStorageFileSystemArgs()
        {
        }
    }

    public sealed class FileStorageFileSystemState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain to create the file system in.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        /// </summary>
        [Input("sourceDetails")]
        public Input<Inputs.FileStorageFileSystemSourceDetailsGetArgs>? SourceDetails { get; set; }
        ...
        public FileStorageFileSystemState()
        {
        }
    }
}
