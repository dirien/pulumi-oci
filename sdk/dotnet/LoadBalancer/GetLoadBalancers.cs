...
namespace Pulumi.Oci.LoadBalancer
{
    public static class GetLoadBalancers
    {
        ...
        public static Task<GetLoadBalancersResult> InvokeAsync(GetLoadBalancersArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancersResult>("oci:loadbalancer/getLoadBalancers:getLoadBalancers", args ?? new GetLoadBalancersArgs(), options.WithVersion());
    }
