...
namespace Pulumi.Oci.LoadBalancer
{
    public static class GetLoadBalancerRoutingPolicy
    {
        ...
        public static Task<GetLoadBalancerRoutingPolicyResult> InvokeAsync(GetLoadBalancerRoutingPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerRoutingPolicyResult>("oci:loadbalancer/getLoadBalancerRoutingPolicy:getLoadBalancerRoutingPolicy", args ?? new GetLoadBalancerRoutingPolicyArgs(), options.WithVersion());
    }
