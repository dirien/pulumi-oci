...
namespace Pulumi.Oci.Sch
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testServiceConnector = new Oci.Sch.ServiceConnector("testServiceConnector", new Oci.Sch.ServiceConnectorArgs
    ///         {
    ///             CompartmentId = @var.Compartment_id,
    ///             DisplayName = @var.Service_connector_display_name,
    ///             Source = new Oci.Sch.Inputs.ServiceConnectorSourceArgs
    ///             {
    ///                 Kind = @var.Service_connector_source_kind,
    ///                 Cursor = new Oci.Sch.Inputs.ServiceConnectorSourceCursorArgs
    ///                 {
    ///                     Kind = @var.Service_connector_source_cursor_kind,
    ///                 },
    ///                 LogSources = 
    ///                 {
    ///                     new Oci.Sch.Inputs.ServiceConnectorSourceLogSourceArgs
    ///                     {
    ///                         CompartmentId = @var.Compartment_id,
    ...
    ///             },
    ///             Target = new Oci.Sch.Inputs.ServiceConnectorTargetArgs
    ///             {
    ...
    ///             Tasks = 
    ///             {
    ///                 new Oci.Sch.Inputs.ServiceConnectorTaskArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:sch/serviceConnector:ServiceConnector")]
    public partial class ServiceConnector : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("source")]
        public Output<Outputs.ServiceConnectorSource> Source { get; private set; } = null!;
        ...
        /// </summary>
        [Output("target")]
        public Output<Outputs.ServiceConnectorTarget> Target { get; private set; } = null!;

        /// <summary>
        /// (Updatable) The list of tasks.
        /// </summary>
        [Output("tasks")]
        public Output<ImmutableArray<Outputs.ServiceConnectorTask>> Tasks { get; private set; } = null!;
        ...
        public ServiceConnector(string name, ServiceConnectorArgs args, CustomResourceOptions? options = null)
            : base("oci:sch/serviceConnector:ServiceConnector", name, args ?? new ServiceConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceConnector(string name, Input<string> id, ServiceConnectorState? state = null, CustomResourceOptions? options = null)
            : base("oci:sch/serviceConnector:ServiceConnector", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServiceConnector Get(string name, Input<string> id, ServiceConnectorState? state = null, CustomResourceOptions? options = null)
        {
            return new ServiceConnector(name, id, state, options);
        }
    }

    public sealed class ServiceConnectorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric.
        /// </summary>
        ...
        public Input<Inputs.ServiceConnectorSourceArgs> Source { get; set; } = null!;
        ...
        public Input<Inputs.ServiceConnectorTargetArgs> Target { get; set; } = null!;

        [Input("tasks")]
        private InputList<Inputs.ServiceConnectorTaskArgs>? _tasks;

        /// <summary>
        /// (Updatable) The list of tasks.
        /// </summary>
        public InputList<Inputs.ServiceConnectorTaskArgs> Tasks
        {
            get => _tasks ?? (_tasks = new InputList<Inputs.ServiceConnectorTaskArgs>());
            set => _tasks = value;
        }

        public ServiceConnectorArgs()
        {
        }
    }

    public sealed class ServiceConnectorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric.
        /// </summary>
        ...
        /// </summary>
        [Input("source")]
        public Input<Inputs.ServiceConnectorSourceGetArgs>? Source { get; set; }
        ...
        /// </summary>
        [Input("target")]
        public Input<Inputs.ServiceConnectorTargetGetArgs>? Target { get; set; }

        [Input("tasks")]
        private InputList<Inputs.ServiceConnectorTaskGetArgs>? _tasks;

        /// <summary>
        /// (Updatable) The list of tasks.
        /// </summary>
        public InputList<Inputs.ServiceConnectorTaskGetArgs> Tasks
        {
            get => _tasks ?? (_tasks = new InputList<Inputs.ServiceConnectorTaskGetArgs>());
            set => _tasks = value;
        }
