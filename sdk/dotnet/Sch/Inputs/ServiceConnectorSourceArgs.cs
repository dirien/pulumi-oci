...
namespace Pulumi.Oci.Sch.Inputs
{
    ...
    public sealed class ServiceConnectorSourceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("cursor")]
        public Input<Inputs.ServiceConnectorSourceCursorArgs>? Cursor { get; set; }
        ...
        [Input("logSources")]
        private InputList<Inputs.ServiceConnectorSourceLogSourceArgs>? _logSources;

        /// <summary>
        /// (Updatable) The resources affected by this work request.
        /// </summary>
        public InputList<Inputs.ServiceConnectorSourceLogSourceArgs> LogSources
        {
            get => _logSources ?? (_logSources = new InputList<Inputs.ServiceConnectorSourceLogSourceArgs>());
        ...
        public ServiceConnectorSourceArgs()
        {
        }
    }
}
