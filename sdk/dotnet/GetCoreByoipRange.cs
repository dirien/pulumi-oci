...
{
    public static class GetCoreByoipRange
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testByoipRange = Output.Create(Oci.GetCoreByoipRange.InvokeAsync(new Oci.GetCoreByoipRangeArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreByoipRangeResult> InvokeAsync(GetCoreByoipRangeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreByoipRangeResult>("oci:index/getCoreByoipRange:GetCoreByoipRange", args ?? new GetCoreByoipRangeArgs(), options.WithVersion());
    }


    public sealed class GetCoreByoipRangeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCoreByoipRangeResult
    {
        ...
        [OutputConstructor]
        private GetCoreByoipRangeResult(
            string byoipRangeId,
