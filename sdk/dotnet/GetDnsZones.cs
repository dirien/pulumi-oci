...
namespace Pulumi.Oci
{
    public static class GetDnsZones
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testZones = Output.Create(Oci.GetDnsZones.InvokeAsync(new Oci.GetDnsZonesArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDnsZonesResult> InvokeAsync(GetDnsZonesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDnsZonesResult>("oci:index/getDnsZones:GetDnsZones", args ?? new GetDnsZonesArgs(), options.WithVersion());
    }


    public sealed class GetDnsZonesArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetDnsZonesFilterArgs>? _filters;
        public List<Inputs.GetDnsZonesFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetDnsZonesFilterArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetDnsZonesResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetDnsZonesFilterResult> Filters;
        /// <summary>
        ...
        private GetDnsZonesResult(
            ...
            ImmutableArray<Outputs.GetDnsZonesFilterResult> filters,
