...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAppCatalogSubscription = new Oci.CoreAppCatalogSubscription("testAppCatalogSubscription", new Oci.CoreAppCatalogSubscriptionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreAppCatalogSubscription:CoreAppCatalogSubscription")]
    public partial class CoreAppCatalogSubscription : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreAppCatalogSubscription(string name, CoreAppCatalogSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreAppCatalogSubscription:CoreAppCatalogSubscription", name, args ?? new CoreAppCatalogSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreAppCatalogSubscription(string name, Input<string> id, CoreAppCatalogSubscriptionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreAppCatalogSubscription:CoreAppCatalogSubscription", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreAppCatalogSubscription Get(string name, Input<string> id, CoreAppCatalogSubscriptionState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreAppCatalogSubscription(name, id, state, options);
        }
    }

    public sealed class CoreAppCatalogSubscriptionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The compartmentID for the subscription.
        /// </summary>
        ...
        public CoreAppCatalogSubscriptionArgs()
        {
        }
    }

    public sealed class CoreAppCatalogSubscriptionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The compartmentID for the subscription.
        /// </summary>
        ...
        public CoreAppCatalogSubscriptionState()
        {
        }
    }
}
