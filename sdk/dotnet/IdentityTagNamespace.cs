...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testTagNamespace = new Oci.IdentityTagNamespace("testTagNamespace", new Oci.IdentityTagNamespaceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityTagNamespace:IdentityTagNamespace")]
    public partial class IdentityTagNamespace : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityTagNamespace(string name, IdentityTagNamespaceArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityTagNamespace:IdentityTagNamespace", name, args ?? new IdentityTagNamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityTagNamespace(string name, Input<string> id, IdentityTagNamespaceState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityTagNamespace:IdentityTagNamespace", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityTagNamespace Get(string name, Input<string> id, IdentityTagNamespaceState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityTagNamespace(name, id, state, options);
        }
    }

    public sealed class IdentityTagNamespaceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the tenancy containing the tag namespace.
        /// </summary>
        ...
        public IdentityTagNamespaceArgs()
        {
        }
    }

    public sealed class IdentityTagNamespaceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the tenancy containing the tag namespace.
        /// </summary>
        ...
        public IdentityTagNamespaceState()
        {
        }
    }
}
