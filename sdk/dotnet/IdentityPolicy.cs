...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPolicy = new Oci.IdentityPolicy("testPolicy", new Oci.IdentityPolicyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityPolicy:IdentityPolicy")]
    public partial class IdentityPolicy : Pulumi.CustomResource
    {
        ...
        public IdentityPolicy(string name, IdentityPolicyArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityPolicy:IdentityPolicy", name, args ?? new IdentityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityPolicy(string name, Input<string> id, IdentityPolicyState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityPolicy:IdentityPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
