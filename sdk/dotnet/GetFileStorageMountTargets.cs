...
{
    public static class GetFileStorageMountTargets
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testMountTargets = Output.Create(Oci.GetFileStorageMountTargets.InvokeAsync(new Oci.GetFileStorageMountTargetsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetFileStorageMountTargetsResult> InvokeAsync(GetFileStorageMountTargetsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetFileStorageMountTargetsResult>("oci:index/getFileStorageMountTargets:GetFileStorageMountTargets", args ?? new GetFileStorageMountTargetsArgs(), options.WithVersion());
    }


    public sealed class GetFileStorageMountTargetsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetFileStorageMountTargetsFilterArgs>? _filters;
        public List<Inputs.GetFileStorageMountTargetsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetFileStorageMountTargetsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetFileStorageMountTargetsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetFileStorageMountTargetsResult
    {
        /// <summary>
        ...
        public readonly ImmutableArray<Outputs.GetFileStorageMountTargetsFilterResult> Filters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetFileStorageMountTargetsMountTargetResult> MountTargets;
        /// <summary>
        ...
        [OutputConstructor]
        private GetFileStorageMountTargetsResult(
            ...
            ImmutableArray<Outputs.GetFileStorageMountTargetsFilterResult> filters,

            string? id,

            ImmutableArray<Outputs.GetFileStorageMountTargetsMountTargetResult> mountTargets,
