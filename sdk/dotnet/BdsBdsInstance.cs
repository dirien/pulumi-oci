...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBdsInstance = new Oci.BdsBdsInstance("testBdsInstance", new Oci.BdsBdsInstanceArgs
    ///         {
    ...
    ///             MasterNode = new Oci.Inputs.BdsBdsInstanceMasterNodeArgs
    ///             {
    ...
    ///             },
    ///             UtilNode = new Oci.Inputs.BdsBdsInstanceUtilNodeArgs
    ///             {
    ///                 Shape = @var.Bds_instance_nodes_shape,
    ///                 SubnetId = oci_core_subnet.Test_subnet.Id,
    ///                 BlockVolumeSizeInGbs = @var.Bds_instance_nodes_block_volume_size_in_gbs,
    ///                 NumberOfNodes = @var.Bds_instance_number_of_nodes,
    ///             },
    ///             WorkerNode = new Oci.Inputs.BdsBdsInstanceWorkerNodeArgs
    ///             {
    ///                 Shape = @var.Bds_instance_nodes_shape,
    ///                 SubnetId = oci_core_subnet.Test_subnet.Id,
    ///                 BlockVolumeSizeInGbs = @var.Bds_instance_nodes_block_volume_size_in_gbs,
    ...
    ///             NetworkConfig = new Oci.Inputs.BdsBdsInstanceNetworkConfigArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/bdsBdsInstance:BdsBdsInstance")]
    public partial class BdsBdsInstance : Pulumi.CustomResource
    {
        /// <summary>
        /// The information about added Cloud SQL capability
        /// </summary>
        [Output("cloudSqlDetails")]
        public Output<Outputs.BdsBdsInstanceCloudSqlDetails> CloudSqlDetails { get; private set; } = null!;
        ...
        public Output<Outputs.BdsBdsInstanceClusterDetails> ClusterDetails { get; private set; } = null!;
        ...
        [Output("masterNode")]
        public Output<Outputs.BdsBdsInstanceMasterNode> MasterNode { get; private set; } = null!;

        /// <summary>
        /// Additional configuration of the user's network.
        /// </summary>
        [Output("networkConfig")]
        public Output<Outputs.BdsBdsInstanceNetworkConfig> NetworkConfig { get; private set; } = null!;

        /// <summary>
        /// The list of nodes in the Big Data Service cluster.
        /// </summary>
        [Output("nodes")]
        public Output<ImmutableArray<Outputs.BdsBdsInstanceNode>> Nodes { get; private set; } = null!;
        ...
        [Output("utilNode")]
        public Output<Outputs.BdsBdsInstanceUtilNode> UtilNode { get; private set; } = null!;

        [Output("workerNode")]
        public Output<Outputs.BdsBdsInstanceWorkerNode> WorkerNode { get; private set; } = null!;
        ...
        public BdsBdsInstance(string name, BdsBdsInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:index/bdsBdsInstance:BdsBdsInstance", name, args ?? new BdsBdsInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BdsBdsInstance(string name, Input<string> id, BdsBdsInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/bdsBdsInstance:BdsBdsInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BdsBdsInstance Get(string name, Input<string> id, BdsBdsInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new BdsBdsInstance(name, id, state, options);
        }
    }

    public sealed class BdsBdsInstanceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The information about added Cloud SQL capability
        /// </summary>
        [Input("cloudSqlDetails")]
        public Input<Inputs.BdsBdsInstanceCloudSqlDetailsArgs>? CloudSqlDetails { get; set; }
        ...
        public Input<Inputs.BdsBdsInstanceMasterNodeArgs> MasterNode { get; set; } = null!;

        /// <summary>
        /// Additional configuration of the user's network.
        /// </summary>
        [Input("networkConfig")]
        public Input<Inputs.BdsBdsInstanceNetworkConfigArgs>? NetworkConfig { get; set; }

        [Input("utilNode", required: true)]
        public Input<Inputs.BdsBdsInstanceUtilNodeArgs> UtilNode { get; set; } = null!;

        [Input("workerNode", required: true)]
        public Input<Inputs.BdsBdsInstanceWorkerNodeArgs> WorkerNode { get; set; } = null!;

        public BdsBdsInstanceArgs()
        {
        }
    }

    public sealed class BdsBdsInstanceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The information about added Cloud SQL capability
        /// </summary>
        [Input("cloudSqlDetails")]
        public Input<Inputs.BdsBdsInstanceCloudSqlDetailsGetArgs>? CloudSqlDetails { get; set; }
        ...
        public Input<Inputs.BdsBdsInstanceClusterDetailsGetArgs>? ClusterDetails { get; set; }
        ...
        [Input("masterNode")]
        public Input<Inputs.BdsBdsInstanceMasterNodeGetArgs>? MasterNode { get; set; }

        /// <summary>
        /// Additional configuration of the user's network.
        /// </summary>
        [Input("networkConfig")]
        public Input<Inputs.BdsBdsInstanceNetworkConfigGetArgs>? NetworkConfig { get; set; }

        [Input("nodes")]
        private InputList<Inputs.BdsBdsInstanceNodeGetArgs>? _nodes;

        /// <summary>
        /// The list of nodes in the Big Data Service cluster.
        /// </summary>
        public InputList<Inputs.BdsBdsInstanceNodeGetArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.BdsBdsInstanceNodeGetArgs>());
            set => _nodes = value;
        }
        ...
        [Input("utilNode")]
        public Input<Inputs.BdsBdsInstanceUtilNodeGetArgs>? UtilNode { get; set; }

        [Input("workerNode")]
        public Input<Inputs.BdsBdsInstanceWorkerNodeGetArgs>? WorkerNode { get; set; }

        public BdsBdsInstanceState()
        {
        }
    }
}
