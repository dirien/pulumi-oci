...
{
    public static class GetCoreNetworkSecurityGroup
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testNetworkSecurityGroup = Output.Create(Oci.GetCoreNetworkSecurityGroup.InvokeAsync(new Oci.GetCoreNetworkSecurityGroupArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreNetworkSecurityGroupResult> InvokeAsync(GetCoreNetworkSecurityGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreNetworkSecurityGroupResult>("oci:index/getCoreNetworkSecurityGroup:GetCoreNetworkSecurityGroup", args ?? new GetCoreNetworkSecurityGroupArgs(), options.WithVersion());
    }


    public sealed class GetCoreNetworkSecurityGroupArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreNetworkSecurityGroupArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreNetworkSecurityGroupResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreNetworkSecurityGroupResult(
