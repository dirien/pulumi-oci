...
{
    public static class GetOcvpSddc
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testSddc = Output.Create(Oci.GetOcvpSddc.InvokeAsync(new Oci.GetOcvpSddcArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetOcvpSddcResult> InvokeAsync(GetOcvpSddcArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOcvpSddcResult>("oci:index/getOcvpSddc:GetOcvpSddc", args ?? new GetOcvpSddcArgs(), options.WithVersion());
    }


    public sealed class GetOcvpSddcArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetOcvpSddcResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetOcvpSddcHcxOnPremLicenseResult> HcxOnPremLicenses;
        /// <summary>
        ...
        private GetOcvpSddcResult(
            ...
            ImmutableArray<Outputs.GetOcvpSddcHcxOnPremLicenseResult> hcxOnPremLicenses,
