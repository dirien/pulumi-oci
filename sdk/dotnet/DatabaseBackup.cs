...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBackup = new Oci.DatabaseBackup("testBackup", new Oci.DatabaseBackupArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/databaseBackup:DatabaseBackup")]
    public partial class DatabaseBackup : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatabaseBackup(string name, DatabaseBackupArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseBackup:DatabaseBackup", name, args ?? new DatabaseBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseBackup(string name, Input<string> id, DatabaseBackupState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseBackup:DatabaseBackup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatabaseBackupState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the availability domain where the database backup is stored.
        /// </summary>
