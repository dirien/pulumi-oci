...
{
    public static class GetCoreDrgRouteDistribution
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDrgRouteDistribution = Output.Create(Oci.GetCoreDrgRouteDistribution.InvokeAsync(new Oci.GetCoreDrgRouteDistributionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreDrgRouteDistributionResult> InvokeAsync(GetCoreDrgRouteDistributionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreDrgRouteDistributionResult>("oci:index/getCoreDrgRouteDistribution:GetCoreDrgRouteDistribution", args ?? new GetCoreDrgRouteDistributionArgs(), options.WithVersion());
    }


    public sealed class GetCoreDrgRouteDistributionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreDrgRouteDistributionArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreDrgRouteDistributionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreDrgRouteDistributionResult(
