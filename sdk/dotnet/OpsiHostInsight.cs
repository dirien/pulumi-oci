...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/opsiHostInsight:OpsiHostInsight")]
    public partial class OpsiHostInsight : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OpsiHostInsight(string name, OpsiHostInsightArgs args, CustomResourceOptions? options = null)
            : base("oci:index/opsiHostInsight:OpsiHostInsight", name, args ?? new OpsiHostInsightArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OpsiHostInsight(string name, Input<string> id, OpsiHostInsightState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/opsiHostInsight:OpsiHostInsight", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OpsiHostInsight Get(string name, Input<string> id, OpsiHostInsightState? state = null, CustomResourceOptions? options = null)
        {
            return new OpsiHostInsight(name, id, state, options);
        }
    }

    public sealed class OpsiHostInsightArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier of host
        /// </summary>
        ...
        public OpsiHostInsightArgs()
        {
        }
    }

    public sealed class OpsiHostInsightState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier of host
        /// </summary>
