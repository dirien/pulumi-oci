...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDeployArtifact = new Oci.DevopsDeployArtifact("testDeployArtifact", new Oci.DevopsDeployArtifactArgs
    ///         {
    ///             ArgumentSubstitutionMode = @var.Deploy_artifact_argument_substitution_mode,
    ///             DeployArtifactSource = new Oci.Inputs.DevopsDeployArtifactDeployArtifactSourceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/devopsDeployArtifact:DevopsDeployArtifact")]
    public partial class DevopsDeployArtifact : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.DevopsDeployArtifactDeployArtifactSource> DeployArtifactSource { get; private set; } = null!;
        ...
        public DevopsDeployArtifact(string name, DevopsDeployArtifactArgs args, CustomResourceOptions? options = null)
            : base("oci:index/devopsDeployArtifact:DevopsDeployArtifact", name, args ?? new DevopsDeployArtifactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DevopsDeployArtifact(string name, Input<string> id, DevopsDeployArtifactState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/devopsDeployArtifact:DevopsDeployArtifact", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DevopsDeployArtifact Get(string name, Input<string> id, DevopsDeployArtifactState? state = null, CustomResourceOptions? options = null)
        {
            return new DevopsDeployArtifact(name, id, state, options);
        }
    }

    public sealed class DevopsDeployArtifactArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Mode for artifact parameter substitution.
        /// </summary>
        ...
        public Input<Inputs.DevopsDeployArtifactDeployArtifactSourceArgs> DeployArtifactSource { get; set; } = null!;
        ...
        public DevopsDeployArtifactArgs()
        {
        }
    }

    public sealed class DevopsDeployArtifactState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Mode for artifact parameter substitution.
        /// </summary>
        ...
        public Input<Inputs.DevopsDeployArtifactDeployArtifactSourceGetArgs>? DeployArtifactSource { get; set; }
        ...
        public DevopsDeployArtifactState()
        {
        }
    }
}
