...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testEmailDomain = new Oci.EmailEmailDomain("testEmailDomain", new Oci.EmailEmailDomainArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/emailEmailDomain:EmailEmailDomain")]
    public partial class EmailEmailDomain : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public EmailEmailDomain(string name, EmailEmailDomainArgs args, CustomResourceOptions? options = null)
            : base("oci:index/emailEmailDomain:EmailEmailDomain", name, args ?? new EmailEmailDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EmailEmailDomain(string name, Input<string> id, EmailEmailDomainState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/emailEmailDomain:EmailEmailDomain", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EmailEmailDomain Get(string name, Input<string> id, EmailEmailDomainState? state = null, CustomResourceOptions? options = null)
        {
            return new EmailEmailDomain(name, id, state, options);
        }
    }

    public sealed class EmailEmailDomainArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for this email domain.
        /// </summary>
        ...
        public EmailEmailDomainArgs()
        {
        }
    }

    public sealed class EmailEmailDomainState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DKIM key that will be used to sign mail sent from this email domain.
        /// </summary>
