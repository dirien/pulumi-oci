...
{
    public static class GetVaultSecretVersion
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testSecretVersion = Output.Create(Oci.GetVaultSecretVersion.InvokeAsync(new Oci.GetVaultSecretVersionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetVaultSecretVersionResult> InvokeAsync(GetVaultSecretVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVaultSecretVersionResult>("oci:index/getVaultSecretVersion:GetVaultSecretVersion", args ?? new GetVaultSecretVersionArgs(), options.WithVersion());
    }


    public sealed class GetVaultSecretVersionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetVaultSecretVersionArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetVaultSecretVersionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetVaultSecretVersionResult(
            string contentType,
