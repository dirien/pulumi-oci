...
namespace Pulumi.Oci
{
    public static class GetIdentityGroup
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testGroup = Output.Create(Oci.GetIdentityGroup.InvokeAsync(new Oci.GetIdentityGroupArgs
        ///         {
        ...
        public static Task<GetIdentityGroupResult> InvokeAsync(GetIdentityGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityGroupResult>("oci:index/getIdentityGroup:GetIdentityGroup", args ?? new GetIdentityGroupArgs(), options.WithVersion());
    }


    public sealed class GetIdentityGroupArgs : Pulumi.InvokeArgs
    {
        /// <summary>
