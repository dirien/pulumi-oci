...
namespace Pulumi.Oci.DatabaseManagement
{
    public static class GetManagedDatabasesDatabaseParameters
    {
        ...
        public static Task<GetManagedDatabasesDatabaseParametersResult> InvokeAsync(GetManagedDatabasesDatabaseParametersArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedDatabasesDatabaseParametersResult>("oci:databasemanagement/getManagedDatabasesDatabaseParameters:getManagedDatabasesDatabaseParameters", args ?? new GetManagedDatabasesDatabaseParametersArgs(), options.WithVersion());
    }
