...
namespace Pulumi.Oci.DatabaseManagement
{
    public static class GetManagedDatabasesDatabaseParameter
    {
        ...
        public static Task<GetManagedDatabasesDatabaseParameterResult> InvokeAsync(GetManagedDatabasesDatabaseParameterArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedDatabasesDatabaseParameterResult>("oci:databasemanagement/getManagedDatabasesDatabaseParameter:getManagedDatabasesDatabaseParameter", args ?? new GetManagedDatabasesDatabaseParameterArgs(), options.WithVersion());
    }
