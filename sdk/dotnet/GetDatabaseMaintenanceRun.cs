...
{
    public static class GetDatabaseMaintenanceRun
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testMaintenanceRun = Output.Create(Oci.GetDatabaseMaintenanceRun.InvokeAsync(new Oci.GetDatabaseMaintenanceRunArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseMaintenanceRunResult> InvokeAsync(GetDatabaseMaintenanceRunArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseMaintenanceRunResult>("oci:index/getDatabaseMaintenanceRun:GetDatabaseMaintenanceRun", args ?? new GetDatabaseMaintenanceRunArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseMaintenanceRunArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatabaseMaintenanceRunArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseMaintenanceRunResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseMaintenanceRunResult(
