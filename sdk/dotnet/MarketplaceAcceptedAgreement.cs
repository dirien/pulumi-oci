...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAcceptedAgreement = new Oci.MarketplaceAcceptedAgreement("testAcceptedAgreement", new Oci.MarketplaceAcceptedAgreementArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/marketplaceAcceptedAgreement:MarketplaceAcceptedAgreement")]
    public partial class MarketplaceAcceptedAgreement : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MarketplaceAcceptedAgreement(string name, MarketplaceAcceptedAgreementArgs args, CustomResourceOptions? options = null)
            : base("oci:index/marketplaceAcceptedAgreement:MarketplaceAcceptedAgreement", name, args ?? new MarketplaceAcceptedAgreementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MarketplaceAcceptedAgreement(string name, Input<string> id, MarketplaceAcceptedAgreementState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/marketplaceAcceptedAgreement:MarketplaceAcceptedAgreement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MarketplaceAcceptedAgreement Get(string name, Input<string> id, MarketplaceAcceptedAgreementState? state = null, CustomResourceOptions? options = null)
        {
            return new MarketplaceAcceptedAgreement(name, id, state, options);
        }
    }

    public sealed class MarketplaceAcceptedAgreementArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The agreement to accept.
        /// </summary>
        ...
        public MarketplaceAcceptedAgreementArgs()
        {
        }
    }

    public sealed class MarketplaceAcceptedAgreementState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The agreement to accept.
        /// </summary>
        ...
        public MarketplaceAcceptedAgreementState()
        {
        }
    }
}
