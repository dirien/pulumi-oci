...
namespace Pulumi.Oci.ManagementAgent
{
    public static class GetManagementAgentAvailableHistories
    {
        ...
        public static Task<GetManagementAgentAvailableHistoriesResult> InvokeAsync(GetManagementAgentAvailableHistoriesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagementAgentAvailableHistoriesResult>("oci:managementagent/getManagementAgentAvailableHistories:getManagementAgentAvailableHistories", args ?? new GetManagementAgentAvailableHistoriesArgs(), options.WithVersion());
    }
