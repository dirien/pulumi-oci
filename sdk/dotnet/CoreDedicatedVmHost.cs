...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDedicatedVmHost = new Oci.CoreDedicatedVmHost("testDedicatedVmHost", new Oci.CoreDedicatedVmHostArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDedicatedVmHost:CoreDedicatedVmHost")]
    public partial class CoreDedicatedVmHost : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreDedicatedVmHost(string name, CoreDedicatedVmHostArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDedicatedVmHost:CoreDedicatedVmHost", name, args ?? new CoreDedicatedVmHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDedicatedVmHost(string name, Input<string> id, CoreDedicatedVmHostState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDedicatedVmHost:CoreDedicatedVmHost", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDedicatedVmHost Get(string name, Input<string> id, CoreDedicatedVmHostState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDedicatedVmHost(name, id, state, options);
        }
    }

    public sealed class CoreDedicatedVmHostArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain of the dedicated virtual machine host.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public CoreDedicatedVmHostArgs()
        {
        }
    }

    public sealed class CoreDedicatedVmHostState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain of the dedicated virtual machine host.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public CoreDedicatedVmHostState()
        {
        }
    }
}
