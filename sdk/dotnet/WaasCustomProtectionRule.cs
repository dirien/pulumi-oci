...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testCustomProtectionRule = new Oci.WaasCustomProtectionRule("testCustomProtectionRule", new Oci.WaasCustomProtectionRuleArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/waasCustomProtectionRule:WaasCustomProtectionRule")]
    public partial class WaasCustomProtectionRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public WaasCustomProtectionRule(string name, WaasCustomProtectionRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/waasCustomProtectionRule:WaasCustomProtectionRule", name, args ?? new WaasCustomProtectionRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WaasCustomProtectionRule(string name, Input<string> id, WaasCustomProtectionRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/waasCustomProtectionRule:WaasCustomProtectionRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WaasCustomProtectionRule Get(string name, Input<string> id, WaasCustomProtectionRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new WaasCustomProtectionRule(name, id, state, options);
        }
    }

    public sealed class WaasCustomProtectionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the custom protection rule.
        /// </summary>
        ...
        public WaasCustomProtectionRuleArgs()
        {
        }
    }

    public sealed class WaasCustomProtectionRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the custom protection rule.
        /// </summary>
        ...
        public WaasCustomProtectionRuleState()
        {
        }
    }
}
