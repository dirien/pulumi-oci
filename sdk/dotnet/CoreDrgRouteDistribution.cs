...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDrgRouteDistribution = new Oci.CoreDrgRouteDistribution("testDrgRouteDistribution", new Oci.CoreDrgRouteDistributionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreDrgRouteDistribution:CoreDrgRouteDistribution")]
    public partial class CoreDrgRouteDistribution : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreDrgRouteDistribution(string name, CoreDrgRouteDistributionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteDistribution:CoreDrgRouteDistribution", name, args ?? new CoreDrgRouteDistributionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreDrgRouteDistribution(string name, Input<string> id, CoreDrgRouteDistributionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreDrgRouteDistribution:CoreDrgRouteDistribution", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreDrgRouteDistribution Get(string name, Input<string> id, CoreDrgRouteDistributionState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreDrgRouteDistribution(name, id, state, options);
        }
    }

    public sealed class CoreDrgRouteDistributionArgs : Pulumi.ResourceArgs
    {
        [Input("definedTags")]
        ...
        public CoreDrgRouteDistributionArgs()
        {
        }
    }

    public sealed class CoreDrgRouteDistributionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the route distribution.
        /// </summary>
        ...
        public CoreDrgRouteDistributionState()
        {
        }
    }
}
