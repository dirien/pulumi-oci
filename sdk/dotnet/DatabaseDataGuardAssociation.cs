...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDataGuardAssociation = new Oci.DatabaseDataGuardAssociation("testDataGuardAssociation", new Oci.DatabaseDataGuardAssociationArgs
    ///         {
    ...
    /// </summary>
    [OciResourceType("oci:index/databaseDataGuardAssociation:DatabaseDataGuardAssociation")]
    public partial class DatabaseDataGuardAssociation : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatabaseDataGuardAssociation(string name, DatabaseDataGuardAssociationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseDataGuardAssociation:DatabaseDataGuardAssociation", name, args ?? new DatabaseDataGuardAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseDataGuardAssociation(string name, Input<string> id, DatabaseDataGuardAssociationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseDataGuardAssociation:DatabaseDataGuardAssociation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseDataGuardAssociation Get(string name, Input<string> id, DatabaseDataGuardAssociationState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseDataGuardAssociation(name, id, state, options);
        }
    }

    public sealed class DatabaseDataGuardAssociationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the availability domain that the standby database DB system will be located in. For example- "Uocm:PHX-AD-1".
        /// </summary>
        ...
        public DatabaseDataGuardAssociationArgs()
        {
        }
    }

    public sealed class DatabaseDataGuardAssociationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The lag time between updates to the primary database and application of the redo data on the standby database, as computed by the reporting database.  Example: `9 seconds`
        /// </summary>
        ...
        public DatabaseDataGuardAssociationState()
        {
        }
    }
}
