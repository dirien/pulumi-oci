...
{
    public static class GetCorePrivateIp
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testPrivateIp = Output.Create(Oci.GetCorePrivateIp.InvokeAsync(new Oci.GetCorePrivateIpArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCorePrivateIpResult> InvokeAsync(GetCorePrivateIpArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCorePrivateIpResult>("oci:index/getCorePrivateIp:GetCorePrivateIp", args ?? new GetCorePrivateIpArgs(), options.WithVersion());
    }


    public sealed class GetCorePrivateIpArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCorePrivateIpResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCorePrivateIpResult(
