...
namespace Pulumi.Oci.Autoscaling
{
    public static class GetAutoScalingConfigurations
    {
        ...
        public static Task<GetAutoScalingConfigurationsResult> InvokeAsync(GetAutoScalingConfigurationsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAutoScalingConfigurationsResult>("oci:autoscaling/getAutoScalingConfigurations:getAutoScalingConfigurations", args ?? new GetAutoScalingConfigurationsArgs(), options.WithVersion());
    }
