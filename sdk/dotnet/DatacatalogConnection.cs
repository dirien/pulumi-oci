...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testConnection = new Oci.DatacatalogConnection("testConnection", new Oci.DatacatalogConnectionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/datacatalogConnection:DatacatalogConnection")]
    public partial class DatacatalogConnection : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatacatalogConnection(string name, DatacatalogConnectionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/datacatalogConnection:DatacatalogConnection", name, args ?? new DatacatalogConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatacatalogConnection(string name, Input<string> id, DatacatalogConnectionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/datacatalogConnection:DatacatalogConnection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatacatalogConnection Get(string name, Input<string> id, DatacatalogConnectionState? state = null, CustomResourceOptions? options = null)
        {
            return new DatacatalogConnection(name, id, state, options);
        }
    }

    public sealed class DatacatalogConnectionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unique catalog identifier.
        /// </summary>
        ...
        public DatacatalogConnectionArgs()
        {
        }
    }

    public sealed class DatacatalogConnectionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Unique catalog identifier.
        /// </summary>
        ...
        public DatacatalogConnectionState()
        {
        }
    }
}
