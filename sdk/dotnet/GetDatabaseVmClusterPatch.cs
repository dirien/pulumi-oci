...
{
    public static class GetDatabaseVmClusterPatch
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVmClusterPatch = Output.Create(Oci.GetDatabaseVmClusterPatch.InvokeAsync(new Oci.GetDatabaseVmClusterPatchArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseVmClusterPatchResult> InvokeAsync(GetDatabaseVmClusterPatchArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseVmClusterPatchResult>("oci:index/getDatabaseVmClusterPatch:GetDatabaseVmClusterPatch", args ?? new GetDatabaseVmClusterPatchArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseVmClusterPatchArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatabaseVmClusterPatchArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseVmClusterPatchResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseVmClusterPatchResult(
