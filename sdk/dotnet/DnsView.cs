...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testView = new Oci.DnsView("testView", new Oci.DnsViewArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/dnsView:DnsView")]
    public partial class DnsView : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DnsView(string name, DnsViewArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dnsView:DnsView", name, args ?? new DnsViewArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsView(string name, Input<string> id, DnsViewState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dnsView:DnsView", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DnsViewArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the owning compartment.
        /// </summary>
    ...
    public sealed class DnsViewState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the owning compartment.
        /// </summary>
