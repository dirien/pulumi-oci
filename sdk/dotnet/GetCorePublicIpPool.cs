...
{
    public static class GetCorePublicIpPool
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testPublicIpPool = Output.Create(Oci.GetCorePublicIpPool.InvokeAsync(new Oci.GetCorePublicIpPoolArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCorePublicIpPoolResult> InvokeAsync(GetCorePublicIpPoolArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCorePublicIpPoolResult>("oci:index/getCorePublicIpPool:GetCorePublicIpPool", args ?? new GetCorePublicIpPoolArgs(), options.WithVersion());
    }


    public sealed class GetCorePublicIpPoolArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCorePublicIpPoolArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCorePublicIpPoolResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCorePublicIpPoolResult(
