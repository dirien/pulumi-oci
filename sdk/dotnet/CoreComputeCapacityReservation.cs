...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testComputeCapacityReservation = new Oci.CoreComputeCapacityReservation("testComputeCapacityReservation", new Oci.CoreComputeCapacityReservationArgs
    ///         {
    ...
    ///             {
    ///                 new Oci.Inputs.CoreComputeCapacityReservationInstanceReservationConfigArgs
    ///                 {
    ...
    ///                     InstanceShapeConfig = new Oci.Inputs.CoreComputeCapacityReservationInstanceReservationConfigInstanceShapeConfigArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreComputeCapacityReservation:CoreComputeCapacityReservation")]
    public partial class CoreComputeCapacityReservation : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CoreComputeCapacityReservationInstanceReservationConfig>> InstanceReservationConfigs { get; private set; } = null!;
        ...
        public CoreComputeCapacityReservation(string name, CoreComputeCapacityReservationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreComputeCapacityReservation:CoreComputeCapacityReservation", name, args ?? new CoreComputeCapacityReservationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreComputeCapacityReservation(string name, Input<string> id, CoreComputeCapacityReservationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreComputeCapacityReservation:CoreComputeCapacityReservation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreComputeCapacityReservation Get(string name, Input<string> id, CoreComputeCapacityReservationState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreComputeCapacityReservation(name, id, state, options);
        }
    }

    public sealed class CoreComputeCapacityReservationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain of this compute capacity reservation.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        private InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigArgs>? _instanceReservationConfigs;

        /// <summary>
        /// (Updatable) The reservation configurations for the capacity reservation.
        /// </summary>
        public InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigArgs> InstanceReservationConfigs
        {
            get => _instanceReservationConfigs ?? (_instanceReservationConfigs = new InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigArgs>());
        ...
        public CoreComputeCapacityReservationArgs()
        {
        }
    }

    public sealed class CoreComputeCapacityReservationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain of this compute capacity reservation.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        private InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigGetArgs>? _instanceReservationConfigs;

        /// <summary>
        /// (Updatable) The reservation configurations for the capacity reservation.
        /// </summary>
        public InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigGetArgs> InstanceReservationConfigs
        {
            get => _instanceReservationConfigs ?? (_instanceReservationConfigs = new InputList<Inputs.CoreComputeCapacityReservationInstanceReservationConfigGetArgs>());
            set => _instanceReservationConfigs = value;
        }
        ...
        public CoreComputeCapacityReservationState()
        {
        }
    }
}
