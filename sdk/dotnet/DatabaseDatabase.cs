...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDatabase = new Oci.DatabaseDatabase("testDatabase", new Oci.DatabaseDatabaseArgs
    ///         {
    ///             Database = new Oci.Inputs.DatabaseDatabaseDatabaseArgs
    ///             {
    ...
    ///                 DbBackupConfig = new Oci.Inputs.DatabaseDatabaseDatabaseDbBackupConfigArgs
    ///                 {
    ...
    ///                     {
    ///                         new Oci.Inputs.DatabaseDatabaseDatabaseDbBackupConfigBackupDestinationDetailArgs
    ///                         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/databaseDatabase:DatabaseDatabase")]
    public partial class DatabaseDatabase : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.DatabaseDatabaseConnectionStrings> ConnectionStrings { get; private set; } = null!;

        /// <summary>
        /// (Updatable) Details for creating a database.
        /// </summary>
        [Output("database")]
        public Output<Outputs.DatabaseDatabaseDatabase> Database { get; private set; } = null!;
        ...
        public Output<Outputs.DatabaseDatabaseDbBackupConfig> DbBackupConfig { get; private set; } = null!;
        ...
        public DatabaseDatabase(string name, DatabaseDatabaseArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseDatabase:DatabaseDatabase", name, args ?? new DatabaseDatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseDatabase(string name, Input<string> id, DatabaseDatabaseState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseDatabase:DatabaseDatabase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseDatabase Get(string name, Input<string> id, DatabaseDatabaseState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseDatabase(name, id, state, options);
        }
    }
    ...
    public sealed class DatabaseDatabaseArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DatabaseDatabaseDatabaseArgs> Database { get; set; } = null!;
    ...
    public sealed class DatabaseDatabaseState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The character set for the database.  The default is AL32UTF8. Allowed values are:
        /// </summary>
        ...
        public Input<Inputs.DatabaseDatabaseConnectionStringsGetArgs>? ConnectionStrings { get; set; }

        /// <summary>
        /// (Updatable) Details for creating a database.
        /// </summary>
        [Input("database")]
        public Input<Inputs.DatabaseDatabaseDatabaseGetArgs>? Database { get; set; }
