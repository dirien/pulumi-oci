...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testOceInstance = new Oci.OceOceInstance("testOceInstance", new Oci.OceOceInstanceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/oceOceInstance:OceOceInstance")]
    public partial class OceOceInstance : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OceOceInstance(string name, OceOceInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:index/oceOceInstance:OceOceInstance", name, args ?? new OceOceInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OceOceInstance(string name, Input<string> id, OceOceInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/oceOceInstance:OceOceInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OceOceInstance Get(string name, Input<string> id, OceOceInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new OceOceInstance(name, id, state, options);
        }
    }

    public sealed class OceOceInstanceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Admin Email for Notification
        /// </summary>
        ...
        public OceOceInstanceArgs()
        {
        }
    }

    public sealed class OceOceInstanceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Admin Email for Notification
        /// </summary>
