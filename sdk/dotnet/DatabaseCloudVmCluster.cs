...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testCloudVmCluster = new Oci.DatabaseCloudVmCluster("testCloudVmCluster", new Oci.DatabaseCloudVmClusterArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/databaseCloudVmCluster:DatabaseCloudVmCluster")]
    public partial class DatabaseCloudVmCluster : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.DatabaseCloudVmClusterIormConfigCache> IormConfigCache { get; private set; } = null!;
        ...
        public DatabaseCloudVmCluster(string name, DatabaseCloudVmClusterArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseCloudVmCluster:DatabaseCloudVmCluster", name, args ?? new DatabaseCloudVmClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseCloudVmCluster(string name, Input<string> id, DatabaseCloudVmClusterState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseCloudVmCluster:DatabaseCloudVmCluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseCloudVmCluster Get(string name, Input<string> id, DatabaseCloudVmClusterState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseCloudVmCluster(name, id, state, options);
        }
    }

    public sealed class DatabaseCloudVmClusterArgs : Pulumi.ResourceArgs
    {
        ...
        public DatabaseCloudVmClusterArgs()
        {
        }
    }

    public sealed class DatabaseCloudVmClusterState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the availability domain that the cloud Exadata infrastructure resource is located in.
        /// </summary>
        ...
        public Input<Inputs.DatabaseCloudVmClusterIormConfigCacheGetArgs>? IormConfigCache { get; set; }
        ...
        public DatabaseCloudVmClusterState()
        {
        }
    }
}
