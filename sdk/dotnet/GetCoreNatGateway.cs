...
{
    public static class GetCoreNatGateway
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testNatGateway = Output.Create(Oci.GetCoreNatGateway.InvokeAsync(new Oci.GetCoreNatGatewayArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreNatGatewayResult> InvokeAsync(GetCoreNatGatewayArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreNatGatewayResult>("oci:index/getCoreNatGateway:GetCoreNatGateway", args ?? new GetCoreNatGatewayArgs(), options.WithVersion());
    }


    public sealed class GetCoreNatGatewayArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCoreNatGatewayResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreNatGatewayResult(
            bool blockTraffic,
