...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testStream = new Oci.StreamingStream("testStream", new Oci.StreamingStreamArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/streamingStream:StreamingStream")]
    public partial class StreamingStream : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public StreamingStream(string name, StreamingStreamArgs args, CustomResourceOptions? options = null)
            : base("oci:index/streamingStream:StreamingStream", name, args ?? new StreamingStreamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private StreamingStream(string name, Input<string> id, StreamingStreamState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/streamingStream:StreamingStream", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static StreamingStream Get(string name, Input<string> id, StreamingStreamState? state = null, CustomResourceOptions? options = null)
        {
            return new StreamingStream(name, id, state, options);
        }
    }

    public sealed class StreamingStreamArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment that contains the stream.
        /// </summary>
        ...
        public StreamingStreamArgs()
        {
        }
    }

    public sealed class StreamingStreamState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment that contains the stream.
        /// </summary>
