...
{
    public static class GetEmailDkim
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDkim = Output.Create(Oci.GetEmailDkim.InvokeAsync(new Oci.GetEmailDkimArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetEmailDkimResult> InvokeAsync(GetEmailDkimArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEmailDkimResult>("oci:index/getEmailDkim:GetEmailDkim", args ?? new GetEmailDkimArgs(), options.WithVersion());
    }


    public sealed class GetEmailDkimArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetEmailDkimResult
    {
        /// <summary>
