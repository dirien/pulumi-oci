...
namespace Pulumi.Oci.ApmSynthetics
{
    public static class GetScript
    {
        ...
        public static Task<GetScriptResult> InvokeAsync(GetScriptArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScriptResult>("oci:apmsynthetics/getScript:getScript", args ?? new GetScriptArgs(), options.WithVersion());
    }
    ...
    public sealed class GetScriptResult
    {
        ...
        /// </summary>
        public readonly Outputs.GetScriptMonitorStatusCountMapResult MonitorStatusCountMap;
        /// <summary>
        ...
        private GetScriptResult(
            ...
            Outputs.GetScriptMonitorStatusCountMapResult monitorStatusCountMap,
