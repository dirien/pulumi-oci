...
namespace Pulumi.Oci.ApmSynthetics.Inputs
{
    ...
    public sealed class MonitorConfigurationGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.MonitorConfigurationReqAuthenticationDetailsGetArgs>? ReqAuthenticationDetails { get; set; }
        ...
        private InputList<Inputs.MonitorConfigurationRequestHeaderGetArgs>? _requestHeaders;

        /// <summary>
        /// (Updatable) List of request headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationRequestHeaderGetArgs> RequestHeaders
        {
            get => _requestHeaders ?? (_requestHeaders = new InputList<Inputs.MonitorConfigurationRequestHeaderGetArgs>());
        ...
        private InputList<Inputs.MonitorConfigurationRequestQueryParamGetArgs>? _requestQueryParams;

        /// <summary>
        /// (Updatable) List of request query params. Example: `[{"paramName": "sortOrder", "paramValue": "asc"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationRequestQueryParamGetArgs> RequestQueryParams
        {
            get => _requestQueryParams ?? (_requestQueryParams = new InputList<Inputs.MonitorConfigurationRequestQueryParamGetArgs>());
        ...
        [Input("verifyTexts")]
        private InputList<Inputs.MonitorConfigurationVerifyTextGetArgs>? _verifyTexts;
        ...
        /// </summary>
        public InputList<Inputs.MonitorConfigurationVerifyTextGetArgs> VerifyTexts
        {
            get => _verifyTexts ?? (_verifyTexts = new InputList<Inputs.MonitorConfigurationVerifyTextGetArgs>());
            set => _verifyTexts = value;
        }

        public MonitorConfigurationGetArgs()
        {
        }
    }
}
