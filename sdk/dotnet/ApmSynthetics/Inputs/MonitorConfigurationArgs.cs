...
namespace Pulumi.Oci.ApmSynthetics.Inputs
{
    ...
    public sealed class MonitorConfigurationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.MonitorConfigurationReqAuthenticationDetailsArgs>? ReqAuthenticationDetails { get; set; }
        ...
        private InputList<Inputs.MonitorConfigurationRequestHeaderArgs>? _requestHeaders;

        /// <summary>
        /// (Updatable) List of request headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationRequestHeaderArgs> RequestHeaders
        {
            get => _requestHeaders ?? (_requestHeaders = new InputList<Inputs.MonitorConfigurationRequestHeaderArgs>());
        ...
        private InputList<Inputs.MonitorConfigurationRequestQueryParamArgs>? _requestQueryParams;

        /// <summary>
        /// (Updatable) List of request query params. Example: `[{"paramName": "sortOrder", "paramValue": "asc"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationRequestQueryParamArgs> RequestQueryParams
        {
            get => _requestQueryParams ?? (_requestQueryParams = new InputList<Inputs.MonitorConfigurationRequestQueryParamArgs>());
        ...
        [Input("verifyTexts")]
        private InputList<Inputs.MonitorConfigurationVerifyTextArgs>? _verifyTexts;
        ...
        /// </summary>
        public InputList<Inputs.MonitorConfigurationVerifyTextArgs> VerifyTexts
        {
            get => _verifyTexts ?? (_verifyTexts = new InputList<Inputs.MonitorConfigurationVerifyTextArgs>());
            set => _verifyTexts = value;
        }

        public MonitorConfigurationArgs()
        {
        }
    }
}
