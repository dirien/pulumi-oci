...
namespace Pulumi.Oci.ApmSynthetics.Inputs
{
    ...
    public sealed class MonitorConfigurationReqAuthenticationDetailsArgs : Pulumi.ResourceArgs
    {
        [Input("authHeaders")]
        private InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderArgs>? _authHeaders;

        /// <summary>
        /// (Updatable) List of authentication headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderArgs> AuthHeaders
        {
            get => _authHeaders ?? (_authHeaders = new InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderArgs>());
        ...
        public MonitorConfigurationReqAuthenticationDetailsArgs()
        {
        }
    }
}
