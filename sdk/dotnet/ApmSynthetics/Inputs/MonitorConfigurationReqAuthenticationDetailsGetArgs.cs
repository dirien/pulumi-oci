...
namespace Pulumi.Oci.ApmSynthetics.Inputs
{
    ...
    public sealed class MonitorConfigurationReqAuthenticationDetailsGetArgs : Pulumi.ResourceArgs
    {
        [Input("authHeaders")]
        private InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs>? _authHeaders;

        /// <summary>
        /// (Updatable) List of authentication headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs> AuthHeaders
        {
            get => _authHeaders ?? (_authHeaders = new InputList<Inputs.MonitorConfigurationReqAuthenticationDetailsAuthHeaderGetArgs>());
        ...
        public MonitorConfigurationReqAuthenticationDetailsGetArgs()
        {
        }
    }
}
