...
{
    public static class GetLogAnalyticsLogAnalyticsLogGroup
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testLogAnalyticsLogGroup = Output.Create(Oci.GetLogAnalyticsLogAnalyticsLogGroup.InvokeAsync(new Oci.GetLogAnalyticsLogAnalyticsLogGroupArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetLogAnalyticsLogAnalyticsLogGroupResult> InvokeAsync(GetLogAnalyticsLogAnalyticsLogGroupArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLogAnalyticsLogAnalyticsLogGroupResult>("oci:index/getLogAnalyticsLogAnalyticsLogGroup:GetLogAnalyticsLogAnalyticsLogGroup", args ?? new GetLogAnalyticsLogAnalyticsLogGroupArgs(), options.WithVersion());
    }


    public sealed class GetLogAnalyticsLogAnalyticsLogGroupArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetLogAnalyticsLogAnalyticsLogGroupArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetLogAnalyticsLogAnalyticsLogGroupResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetLogAnalyticsLogAnalyticsLogGroupResult(
