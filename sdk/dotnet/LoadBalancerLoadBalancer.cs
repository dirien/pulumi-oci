...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testLoadBalancer = new Oci.LoadBalancerLoadBalancer("testLoadBalancer", new Oci.LoadBalancerLoadBalancerArgs
    ///         {
    ...
    ///             ReservedIps = 
    ///             {
    ///                 new Oci.Inputs.LoadBalancerLoadBalancerReservedIpArgs
    ///                 {
    ///                     Id = @var.Load_balancer_reserved_ips_id,
    ///                 },
    ///             },
    ///             ShapeDetails = new Oci.Inputs.LoadBalancerLoadBalancerShapeDetailsArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/loadBalancerLoadBalancer:LoadBalancerLoadBalancer")]
    public partial class LoadBalancerLoadBalancer : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.LoadBalancerLoadBalancerIpAddressDetail>> IpAddressDetails { get; private set; } = null!;
        ...
        /// </summary>
        [Output("reservedIps")]
        public Output<ImmutableArray<Outputs.LoadBalancerLoadBalancerReservedIp>> ReservedIps { get; private set; } = null!;
        ...
        /// </summary>
        [Output("shapeDetails")]
        public Output<Outputs.LoadBalancerLoadBalancerShapeDetails> ShapeDetails { get; private set; } = null!;
        ...
        public LoadBalancerLoadBalancer(string name, LoadBalancerLoadBalancerArgs args, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerLoadBalancer:LoadBalancerLoadBalancer", name, args ?? new LoadBalancerLoadBalancerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LoadBalancerLoadBalancer(string name, Input<string> id, LoadBalancerLoadBalancerState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerLoadBalancer:LoadBalancerLoadBalancer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LoadBalancerLoadBalancer Get(string name, Input<string> id, LoadBalancerLoadBalancerState? state = null, CustomResourceOptions? options = null)
        {
            return new LoadBalancerLoadBalancer(name, id, state, options);
        }
    }

    public sealed class LoadBalancerLoadBalancerArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the load balancer.
        /// </summary>
        ...
        [Input("reservedIps")]
        private InputList<Inputs.LoadBalancerLoadBalancerReservedIpArgs>? _reservedIps;

        /// <summary>
        /// An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        /// </summary>
        public InputList<Inputs.LoadBalancerLoadBalancerReservedIpArgs> ReservedIps
        {
            get => _reservedIps ?? (_reservedIps = new InputList<Inputs.LoadBalancerLoadBalancerReservedIpArgs>());
        ...
        /// </summary>
        [Input("shapeDetails")]
        public Input<Inputs.LoadBalancerLoadBalancerShapeDetailsArgs>? ShapeDetails { get; set; }
        ...
        public LoadBalancerLoadBalancerArgs()
        {
        }
    }

    public sealed class LoadBalancerLoadBalancerState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the load balancer.
        /// </summary>
        ...
        private InputList<Inputs.LoadBalancerLoadBalancerIpAddressDetailGetArgs>? _ipAddressDetails;

        /// <summary>
        /// An array of IP addresses.
        /// </summary>
        public InputList<Inputs.LoadBalancerLoadBalancerIpAddressDetailGetArgs> IpAddressDetails
        {
            get => _ipAddressDetails ?? (_ipAddressDetails = new InputList<Inputs.LoadBalancerLoadBalancerIpAddressDetailGetArgs>());
        ...
        [Input("reservedIps")]
        private InputList<Inputs.LoadBalancerLoadBalancerReservedIpGetArgs>? _reservedIps;

        /// <summary>
        /// An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        /// </summary>
        public InputList<Inputs.LoadBalancerLoadBalancerReservedIpGetArgs> ReservedIps
        {
            get => _reservedIps ?? (_reservedIps = new InputList<Inputs.LoadBalancerLoadBalancerReservedIpGetArgs>());
            set => _reservedIps = value;
        }
        ...
        /// </summary>
        [Input("shapeDetails")]
        public Input<Inputs.LoadBalancerLoadBalancerShapeDetailsGetArgs>? ShapeDetails { get; set; }
        ...
        public LoadBalancerLoadBalancerState()
        {
        }
    }
}
