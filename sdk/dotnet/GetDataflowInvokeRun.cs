...
{
    public static class GetDataflowInvokeRun
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testInvokeRun = Output.Create(Oci.GetDataflowInvokeRun.InvokeAsync(new Oci.GetDataflowInvokeRunArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDataflowInvokeRunResult> InvokeAsync(GetDataflowInvokeRunArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDataflowInvokeRunResult>("oci:index/getDataflowInvokeRun:GetDataflowInvokeRun", args ?? new GetDataflowInvokeRunArgs(), options.WithVersion());
    }


    public sealed class GetDataflowInvokeRunArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDataflowInvokeRunArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDataflowInvokeRunResult
    {
        /// <summary>
        /// The application ID.
        /// </summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDataflowInvokeRunParameterResult> Parameters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetDataflowInvokeRunResult(
            ...
            ImmutableArray<Outputs.GetDataflowInvokeRunParameterResult> parameters,
