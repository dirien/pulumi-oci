...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBastion = new Oci.BastionBastion("testBastion", new Oci.BastionBastionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/bastionBastion:BastionBastion")]
    public partial class BastionBastion : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public BastionBastion(string name, BastionBastionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/bastionBastion:BastionBastion", name, args ?? new BastionBastionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BastionBastion(string name, Input<string> id, BastionBastionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/bastionBastion:BastionBastion", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BastionBastion Get(string name, Input<string> id, BastionBastionState? state = null, CustomResourceOptions? options = null)
        {
            return new BastionBastion(name, id, state, options);
        }
    }

    public sealed class BastionBastionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of bastion. Use `standard`.
        /// </summary>
        ...
        public BastionBastionArgs()
        {
        }
    }

    public sealed class BastionBastionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The type of bastion. Use `standard`.
        /// </summary>
