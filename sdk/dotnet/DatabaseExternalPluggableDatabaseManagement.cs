...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testExternalPluggableDatabaseManagement = new Oci.DatabaseExternalPluggableDatabaseManagement("testExternalPluggableDatabaseManagement", new Oci.DatabaseExternalPluggableDatabaseManagementArgs
    ///         {
    ...
    /// </summary>
    [OciResourceType("oci:index/databaseExternalPluggableDatabaseManagement:DatabaseExternalPluggableDatabaseManagement")]
    public partial class DatabaseExternalPluggableDatabaseManagement : Pulumi.CustomResource
    {
        ...
        public DatabaseExternalPluggableDatabaseManagement(string name, DatabaseExternalPluggableDatabaseManagementArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseExternalPluggableDatabaseManagement:DatabaseExternalPluggableDatabaseManagement", name, args ?? new DatabaseExternalPluggableDatabaseManagementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseExternalPluggableDatabaseManagement(string name, Input<string> id, DatabaseExternalPluggableDatabaseManagementState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseExternalPluggableDatabaseManagement:DatabaseExternalPluggableDatabaseManagement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseExternalPluggableDatabaseManagement Get(string name, Input<string> id, DatabaseExternalPluggableDatabaseManagementState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseExternalPluggableDatabaseManagement(name, id, state, options);
        }
    }

    public sealed class DatabaseExternalPluggableDatabaseManagementArgs : Pulumi.ResourceArgs
    {
        ...
        public DatabaseExternalPluggableDatabaseManagementArgs()
        {
        }
    }

    public sealed class DatabaseExternalPluggableDatabaseManagementState : Pulumi.ResourceArgs
    {
        ...
        public DatabaseExternalPluggableDatabaseManagementState()
        {
        }
    }
}
