...
{
    public static class GetDatabaseDatabaseUpgradeHistoryEntry
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testDatabaseUpgradeHistoryEntry = Output.Create(Oci.GetDatabaseDatabaseUpgradeHistoryEntry.InvokeAsync(new Oci.GetDatabaseDatabaseUpgradeHistoryEntryArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatabaseDatabaseUpgradeHistoryEntryResult> InvokeAsync(GetDatabaseDatabaseUpgradeHistoryEntryArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatabaseDatabaseUpgradeHistoryEntryResult>("oci:index/getDatabaseDatabaseUpgradeHistoryEntry:GetDatabaseDatabaseUpgradeHistoryEntry", args ?? new GetDatabaseDatabaseUpgradeHistoryEntryArgs(), options.WithVersion());
    }


    public sealed class GetDatabaseDatabaseUpgradeHistoryEntryArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatabaseDatabaseUpgradeHistoryEntryArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatabaseDatabaseUpgradeHistoryEntryResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseDatabaseUpgradeHistoryEntryResult(
            string action,
