...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testZone = new Oci.DnsZone("testZone", new Oci.DnsZoneArgs
    ///         {
    ...
    ///             ExternalMasters = 
    ///             {
    ///                 new Oci.Inputs.DnsZoneExternalMasterArgs
    ///                 {
    ...
    /// </summary>
    [OciResourceType("oci:index/dnsZone:DnsZone")]
    public partial class DnsZone : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.DnsZoneExternalMaster>> ExternalMasters { get; private set; } = null!;
        ...
        /// </summary>
        [Output("nameservers")]
        public Output<ImmutableArray<Outputs.DnsZoneNameserver>> Nameservers { get; private set; } = null!;
        ...
        public DnsZone(string name, DnsZoneArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dnsZone:DnsZone", name, args ?? new DnsZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsZone(string name, Input<string> id, DnsZoneState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dnsZone:DnsZone", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DnsZoneArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.DnsZoneExternalMasterArgs>? _externalMasters;

        /// <summary>
        /// (Updatable) External master servers for the zone. `externalMasters` becomes a required parameter when the `zoneType` value is `SECONDARY`.
        /// </summary>
        public InputList<Inputs.DnsZoneExternalMasterArgs> ExternalMasters
        {
            get => _externalMasters ?? (_externalMasters = new InputList<Inputs.DnsZoneExternalMasterArgs>());
    ...
    public sealed class DnsZoneState : Pulumi.ResourceArgs
    {
        ...
        [Input("externalMasters")]
        private InputList<Inputs.DnsZoneExternalMasterGetArgs>? _externalMasters;

        /// <summary>
        /// (Updatable) External master servers for the zone. `externalMasters` becomes a required parameter when the `zoneType` value is `SECONDARY`.
        /// </summary>
        public InputList<Inputs.DnsZoneExternalMasterGetArgs> ExternalMasters
        {
            get => _externalMasters ?? (_externalMasters = new InputList<Inputs.DnsZoneExternalMasterGetArgs>());
            set => _externalMasters = value;
        }
        ...
        [Input("nameservers")]
        private InputList<Inputs.DnsZoneNameserverGetArgs>? _nameservers;

        /// <summary>
        /// The authoritative nameservers for the zone.
        /// </summary>
        public InputList<Inputs.DnsZoneNameserverGetArgs> Nameservers
        {
            get => _nameservers ?? (_nameservers = new InputList<Inputs.DnsZoneNameserverGetArgs>());
