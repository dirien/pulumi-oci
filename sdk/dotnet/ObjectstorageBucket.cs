...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBucket = new Oci.ObjectstorageBucket("testBucket", new Oci.ObjectstorageBucketArgs
    ///         {
    ...
    ///             RetentionRules = 
    ///             {
    ///                 new Oci.Inputs.ObjectstorageBucketRetentionRuleArgs
    ///                 {
    ///                     DisplayName = @var.Retention_rule_display_name,
    ///                     Duration = new Oci.Inputs.ObjectstorageBucketRetentionRuleDurationArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/objectstorageBucket:ObjectstorageBucket")]
    public partial class ObjectstorageBucket : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.ObjectstorageBucketRetentionRule>> RetentionRules { get; private set; } = null!;
        ...
        public ObjectstorageBucket(string name, ObjectstorageBucketArgs args, CustomResourceOptions? options = null)
            : base("oci:index/objectstorageBucket:ObjectstorageBucket", name, args ?? new ObjectstorageBucketArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ObjectstorageBucket(string name, Input<string> id, ObjectstorageBucketState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/objectstorageBucket:ObjectstorageBucket", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ObjectstorageBucketArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ObjectstorageBucketRetentionRuleArgs>? _retentionRules;

        /// <summary>
        /// (Updatable) Creates a new retention rule in the specified bucket. The new rule will take effect typically within 30 seconds. Note that a maximum of 100 rules are supported on a bucket.
        /// </summary>
        public InputList<Inputs.ObjectstorageBucketRetentionRuleArgs> RetentionRules
        {
            get => _retentionRules ?? (_retentionRules = new InputList<Inputs.ObjectstorageBucketRetentionRuleArgs>());
    ...
    public sealed class ObjectstorageBucketState : Pulumi.ResourceArgs
    {
        ...
        [Input("retentionRules")]
        private InputList<Inputs.ObjectstorageBucketRetentionRuleGetArgs>? _retentionRules;

        /// <summary>
        /// (Updatable) Creates a new retention rule in the specified bucket. The new rule will take effect typically within 30 seconds. Note that a maximum of 100 rules are supported on a bucket.
        /// </summary>
        public InputList<Inputs.ObjectstorageBucketRetentionRuleGetArgs> RetentionRules
        {
            get => _retentionRules ?? (_retentionRules = new InputList<Inputs.ObjectstorageBucketRetentionRuleGetArgs>());
            set => _retentionRules = value;
        }
