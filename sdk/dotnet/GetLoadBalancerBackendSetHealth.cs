...
{
    public static class GetLoadBalancerBackendSetHealth
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testBackendSetHealth = Output.Create(Oci.GetLoadBalancerBackendSetHealth.InvokeAsync(new Oci.GetLoadBalancerBackendSetHealthArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetLoadBalancerBackendSetHealthResult> InvokeAsync(GetLoadBalancerBackendSetHealthArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerBackendSetHealthResult>("oci:index/getLoadBalancerBackendSetHealth:GetLoadBalancerBackendSetHealth", args ?? new GetLoadBalancerBackendSetHealthArgs(), options.WithVersion());
    }


    public sealed class GetLoadBalancerBackendSetHealthArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetLoadBalancerBackendSetHealthArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetLoadBalancerBackendSetHealthResult
    {
        ...
        [OutputConstructor]
        private GetLoadBalancerBackendSetHealthResult(
