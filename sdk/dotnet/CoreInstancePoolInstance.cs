...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testInstancePoolInstance = new Oci.CoreInstancePoolInstance("testInstancePoolInstance", new Oci.CoreInstancePoolInstanceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreInstancePoolInstance:CoreInstancePoolInstance")]
    public partial class CoreInstancePoolInstance : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.CoreInstancePoolInstanceLoadBalancerBackend>> LoadBalancerBackends { get; private set; } = null!;
        ...
        public CoreInstancePoolInstance(string name, CoreInstancePoolInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreInstancePoolInstance:CoreInstancePoolInstance", name, args ?? new CoreInstancePoolInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreInstancePoolInstance(string name, Input<string> id, CoreInstancePoolInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreInstancePoolInstance:CoreInstancePoolInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreInstancePoolInstance Get(string name, Input<string> id, CoreInstancePoolInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreInstancePoolInstance(name, id, state, options);
        }
    }

    public sealed class CoreInstancePoolInstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public CoreInstancePoolInstanceArgs()
        {
        }
    }

    public sealed class CoreInstancePoolInstanceState : Pulumi.ResourceArgs
    {
        [Input("autoTerminateInstanceOnDelete")]
        public Input<bool>? AutoTerminateInstanceOnDelete { get; set; }
        ...
        private InputList<Inputs.CoreInstancePoolInstanceLoadBalancerBackendGetArgs>? _loadBalancerBackends;

        /// <summary>
        /// The load balancer backends that are configured for the instance pool instance.
        /// </summary>
        public InputList<Inputs.CoreInstancePoolInstanceLoadBalancerBackendGetArgs> LoadBalancerBackends
        {
            get => _loadBalancerBackends ?? (_loadBalancerBackends = new InputList<Inputs.CoreInstancePoolInstanceLoadBalancerBackendGetArgs>());
        ...
        public CoreInstancePoolInstanceState()
        {
        }
    }
}
