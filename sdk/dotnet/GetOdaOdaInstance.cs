...
{
    public static class GetOdaOdaInstance
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testOdaInstance = Output.Create(Oci.GetOdaOdaInstance.InvokeAsync(new Oci.GetOdaOdaInstanceArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetOdaOdaInstanceResult> InvokeAsync(GetOdaOdaInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOdaOdaInstanceResult>("oci:index/getOdaOdaInstance:GetOdaOdaInstance", args ?? new GetOdaOdaInstanceArgs(), options.WithVersion());
    }


    public sealed class GetOdaOdaInstanceArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetOdaOdaInstanceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetOdaOdaInstanceResult(
