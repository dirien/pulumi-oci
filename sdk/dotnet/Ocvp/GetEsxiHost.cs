...
{
    public static class GetEsxiHost
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testEsxiHost = Output.Create(Oci.Ocvp.GetEsxiHost.InvokeAsync(new Oci.Ocvp.GetEsxiHostArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetEsxiHostResult> InvokeAsync(GetEsxiHostArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEsxiHostResult>("oci:ocvp/getEsxiHost:getEsxiHost", args ?? new GetEsxiHostArgs(), options.WithVersion());
    }


    public sealed class GetEsxiHostArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetEsxiHostResult
    {
        /// <summary>
