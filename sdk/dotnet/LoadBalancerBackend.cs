...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBackend = new Oci.LoadBalancerBackend("testBackend", new Oci.LoadBalancerBackendArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/loadBalancerBackend:LoadBalancerBackend")]
    public partial class LoadBalancerBackend : Pulumi.CustomResource
    {
        ...
        public LoadBalancerBackend(string name, LoadBalancerBackendArgs args, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerBackend:LoadBalancerBackend", name, args ?? new LoadBalancerBackendArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LoadBalancerBackend(string name, Input<string> id, LoadBalancerBackendState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/loadBalancerBackend:LoadBalancerBackend", name, state, MakeResourceOptions(options, id))
        {
        }
