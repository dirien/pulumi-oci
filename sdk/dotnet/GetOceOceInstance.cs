...
{
    public static class GetOceOceInstance
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testOceInstance = Output.Create(Oci.GetOceOceInstance.InvokeAsync(new Oci.GetOceOceInstanceArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetOceOceInstanceResult> InvokeAsync(GetOceOceInstanceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOceOceInstanceResult>("oci:index/getOceOceInstance:GetOceOceInstance", args ?? new GetOceOceInstanceArgs(), options.WithVersion());
    }


    public sealed class GetOceOceInstanceArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetOceOceInstanceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetOceOceInstanceResult(
            string adminEmail,
