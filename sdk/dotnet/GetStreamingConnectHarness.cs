...
{
    public static class GetStreamingConnectHarness
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testConnectHarness = Output.Create(Oci.GetStreamingConnectHarness.InvokeAsync(new Oci.GetStreamingConnectHarnessArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetStreamingConnectHarnessResult> InvokeAsync(GetStreamingConnectHarnessArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetStreamingConnectHarnessResult>("oci:index/getStreamingConnectHarness:GetStreamingConnectHarness", args ?? new GetStreamingConnectHarnessArgs(), options.WithVersion());
    }


    public sealed class GetStreamingConnectHarnessArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetStreamingConnectHarnessArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetStreamingConnectHarnessResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetStreamingConnectHarnessResult(
