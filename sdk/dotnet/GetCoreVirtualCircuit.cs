...
{
    public static class GetCoreVirtualCircuit
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVirtualCircuit = Output.Create(Oci.GetCoreVirtualCircuit.InvokeAsync(new Oci.GetCoreVirtualCircuitArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreVirtualCircuitResult> InvokeAsync(GetCoreVirtualCircuitArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreVirtualCircuitResult>("oci:index/getCoreVirtualCircuit:GetCoreVirtualCircuit", args ?? new GetCoreVirtualCircuitArgs(), options.WithVersion());
    }


    public sealed class GetCoreVirtualCircuitArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreVirtualCircuitArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreVirtualCircuitResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreVirtualCircuitCrossConnectMappingResult> CrossConnectMappings;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreVirtualCircuitPublicPrefixResult> PublicPrefixes;
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreVirtualCircuitResult(
            ...
            ImmutableArray<Outputs.GetCoreVirtualCircuitCrossConnectMappingResult> crossConnectMappings,
            ...
            ImmutableArray<Outputs.GetCoreVirtualCircuitPublicPrefixResult> publicPrefixes,
