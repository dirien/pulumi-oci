...
{
    public static class GetIdentityNetworkSource
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testNetworkSource = Output.Create(Oci.GetIdentityNetworkSource.InvokeAsync(new Oci.GetIdentityNetworkSourceArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetIdentityNetworkSourceResult> InvokeAsync(GetIdentityNetworkSourceArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIdentityNetworkSourceResult>("oci:index/getIdentityNetworkSource:GetIdentityNetworkSource", args ?? new GetIdentityNetworkSourceArgs(), options.WithVersion());
    }


    public sealed class GetIdentityNetworkSourceArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetIdentityNetworkSourceArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetIdentityNetworkSourceResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetIdentityNetworkSourceVirtualSourceListResult> VirtualSourceLists;

        [OutputConstructor]
        private GetIdentityNetworkSourceResult(
            ...
            ImmutableArray<Outputs.GetIdentityNetworkSourceVirtualSourceListResult> virtualSourceLists)
        {
