...
{
    public static class GetKmsKeyVersion
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testKeyVersion = Output.Create(Oci.GetKmsKeyVersion.InvokeAsync(new Oci.GetKmsKeyVersionArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetKmsKeyVersionResult> InvokeAsync(GetKmsKeyVersionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetKmsKeyVersionResult>("oci:index/getKmsKeyVersion:GetKmsKeyVersion", args ?? new GetKmsKeyVersionArgs(), options.WithVersion());
    }


    public sealed class GetKmsKeyVersionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The OCID of the key.
        /// </summary>
    ...
    [OutputType]
    public sealed class GetKmsKeyVersionResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetKmsKeyVersionReplicaDetailsResult ReplicaDetails;
        ...
        [OutputConstructor]
        private GetKmsKeyVersionResult(
            ...
            Outputs.GetKmsKeyVersionReplicaDetailsResult replicaDetails,
