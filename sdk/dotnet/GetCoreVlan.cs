...
{
    public static class GetCoreVlan
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testVlan = Output.Create(Oci.GetCoreVlan.InvokeAsync(new Oci.GetCoreVlanArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreVlanResult> InvokeAsync(GetCoreVlanArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreVlanResult>("oci:index/getCoreVlan:GetCoreVlan", args ?? new GetCoreVlanArgs(), options.WithVersion());
    }


    public sealed class GetCoreVlanArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetCoreVlanResult
    {
        /// <summary>
