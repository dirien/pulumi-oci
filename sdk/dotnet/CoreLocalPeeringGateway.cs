...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testLocalPeeringGateway = new Oci.CoreLocalPeeringGateway("testLocalPeeringGateway", new Oci.CoreLocalPeeringGatewayArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreLocalPeeringGateway:CoreLocalPeeringGateway")]
    public partial class CoreLocalPeeringGateway : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreLocalPeeringGateway(string name, CoreLocalPeeringGatewayArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreLocalPeeringGateway:CoreLocalPeeringGateway", name, args ?? new CoreLocalPeeringGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreLocalPeeringGateway(string name, Input<string> id, CoreLocalPeeringGatewayState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreLocalPeeringGateway:CoreLocalPeeringGateway", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreLocalPeeringGateway Get(string name, Input<string> id, CoreLocalPeeringGatewayState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreLocalPeeringGateway(name, id, state, options);
        }
    }

    public sealed class CoreLocalPeeringGatewayArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment containing the local peering gateway (LPG).
        /// </summary>
        ...
        public CoreLocalPeeringGatewayArgs()
        {
        }
    }

    public sealed class CoreLocalPeeringGatewayState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment containing the local peering gateway (LPG).
        /// </summary>
        ...
        public CoreLocalPeeringGatewayState()
        {
        }
    }
}
