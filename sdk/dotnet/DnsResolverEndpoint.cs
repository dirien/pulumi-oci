...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testResolverEndpoint = new Oci.DnsResolverEndpoint("testResolverEndpoint", new Oci.DnsResolverEndpointArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/dnsResolverEndpoint:DnsResolverEndpoint")]
    public partial class DnsResolverEndpoint : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DnsResolverEndpoint(string name, DnsResolverEndpointArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dnsResolverEndpoint:DnsResolverEndpoint", name, args ?? new DnsResolverEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsResolverEndpoint(string name, Input<string> id, DnsResolverEndpointState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dnsResolverEndpoint:DnsResolverEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DnsResolverEndpoint Get(string name, Input<string> id, DnsResolverEndpointState? state = null, CustomResourceOptions? options = null)
        {
            return new DnsResolverEndpoint(name, id, state, options);
        }
    }

    public sealed class DnsResolverEndpointArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The type of resolver endpoint. VNIC is currently the only supported type.
        /// </summary>
        ...
        public DnsResolverEndpointArgs()
        {
        }
    }

    public sealed class DnsResolverEndpointState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the owning compartment. This will match the resolver that the resolver endpoint is under and will be updated if the resolver's compartment is changed.
        /// </summary>
        ...
        public DnsResolverEndpointState()
        {
        }
    }
}
