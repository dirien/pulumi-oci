...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testAnalyticsCluster = new Oci.MysqlAnalyticsCluster("testAnalyticsCluster", new Oci.MysqlAnalyticsClusterArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/mysqlAnalyticsCluster:MysqlAnalyticsCluster")]
    public partial class MysqlAnalyticsCluster : Pulumi.CustomResource
    {
        /// <summary>
        /// An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
        /// </summary>
        [Output("clusterNodes")]
        public Output<ImmutableArray<Outputs.MysqlAnalyticsClusterClusterNode>> ClusterNodes { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a MysqlAnalyticsCluster resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public MysqlAnalyticsCluster(string name, MysqlAnalyticsClusterArgs args, CustomResourceOptions? options = null)
            : base("oci:index/mysqlAnalyticsCluster:MysqlAnalyticsCluster", name, args ?? new MysqlAnalyticsClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MysqlAnalyticsCluster(string name, Input<string> id, MysqlAnalyticsClusterState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/mysqlAnalyticsCluster:MysqlAnalyticsCluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MysqlAnalyticsCluster Get(string name, Input<string> id, MysqlAnalyticsClusterState? state = null, CustomResourceOptions? options = null)
        {
            return new MysqlAnalyticsCluster(name, id, state, options);
        }
    }

    public sealed class MysqlAnalyticsClusterArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) A change to the number of nodes in the Analytics Cluster will result in the entire cluster being torn down and re-created with the new cluster of nodes. This may result in a significant downtime for the analytics capability while the Analytics Cluster is re-provisioned.
        /// </summary>
        ...
        public MysqlAnalyticsClusterArgs()
        {
        }
    }

    public sealed class MysqlAnalyticsClusterState : Pulumi.ResourceArgs
    {
        [Input("clusterNodes")]
        private InputList<Inputs.MysqlAnalyticsClusterClusterNodeGetArgs>? _clusterNodes;

        /// <summary>
        /// An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
        /// </summary>
        public InputList<Inputs.MysqlAnalyticsClusterClusterNodeGetArgs> ClusterNodes
        {
            get => _clusterNodes ?? (_clusterNodes = new InputList<Inputs.MysqlAnalyticsClusterClusterNodeGetArgs>());
        ...
        public MysqlAnalyticsClusterState()
        {
        }
    }
}
