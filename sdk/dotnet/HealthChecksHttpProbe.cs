...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testHttpProbe = new Oci.HealthChecksHttpProbe("testHttpProbe", new Oci.HealthChecksHttpProbeArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/healthChecksHttpProbe:HealthChecksHttpProbe")]
    public partial class HealthChecksHttpProbe : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HealthChecksHttpProbe(string name, HealthChecksHttpProbeArgs args, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksHttpProbe:HealthChecksHttpProbe", name, args ?? new HealthChecksHttpProbeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthChecksHttpProbe(string name, Input<string> id, HealthChecksHttpProbeState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksHttpProbe:HealthChecksHttpProbe", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HealthChecksHttpProbe Get(string name, Input<string> id, HealthChecksHttpProbeState? state = null, CustomResourceOptions? options = null)
        {
            return new HealthChecksHttpProbe(name, id, state, options);
        }
    }

    public sealed class HealthChecksHttpProbeArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksHttpProbeArgs()
        {
        }
    }

    public sealed class HealthChecksHttpProbeState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksHttpProbeState()
        {
        }
    }
}
