...
{
    public static class GetLoadBalancerHealth
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testLoadBalancerHealth = Output.Create(Oci.GetLoadBalancerHealth.InvokeAsync(new Oci.GetLoadBalancerHealthArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetLoadBalancerHealthResult> InvokeAsync(GetLoadBalancerHealthArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerHealthResult>("oci:index/getLoadBalancerHealth:GetLoadBalancerHealth", args ?? new GetLoadBalancerHealthArgs(), options.WithVersion());
    }


    public sealed class GetLoadBalancerHealthArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetLoadBalancerHealthArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetLoadBalancerHealthResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetLoadBalancerHealthResult(
