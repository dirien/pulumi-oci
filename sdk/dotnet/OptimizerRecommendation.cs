...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/optimizerRecommendation:OptimizerRecommendation")]
    public partial class OptimizerRecommendation : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.OptimizerRecommendationResourceCount>> ResourceCounts { get; private set; } = null!;
        ...
        public Output<Outputs.OptimizerRecommendationSupportedLevels> SupportedLevels { get; private set; } = null!;
        ...
        public OptimizerRecommendation(string name, OptimizerRecommendationArgs args, CustomResourceOptions? options = null)
            : base("oci:index/optimizerRecommendation:OptimizerRecommendation", name, args ?? new OptimizerRecommendationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OptimizerRecommendation(string name, Input<string> id, OptimizerRecommendationState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/optimizerRecommendation:OptimizerRecommendation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OptimizerRecommendation Get(string name, Input<string> id, OptimizerRecommendationState? state = null, CustomResourceOptions? options = null)
        {
            return new OptimizerRecommendation(name, id, state, options);
        }
    }

    public sealed class OptimizerRecommendationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique OCID associated with the recommendation.
        /// </summary>
        ...
        public OptimizerRecommendationArgs()
        {
        }
    }

    public sealed class OptimizerRecommendationState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The unique OCID associated with the category.
        /// </summary>
        ...
        private InputList<Inputs.OptimizerRecommendationResourceCountGetArgs>? _resourceCounts;

        /// <summary>
        /// An array of `ResourceCount` objects grouped by the status of the resource actions.
        /// </summary>
        public InputList<Inputs.OptimizerRecommendationResourceCountGetArgs> ResourceCounts
        {
            get => _resourceCounts ?? (_resourceCounts = new InputList<Inputs.OptimizerRecommendationResourceCountGetArgs>());
        ...
        public Input<Inputs.OptimizerRecommendationSupportedLevelsGetArgs>? SupportedLevels { get; set; }
        ...
        public OptimizerRecommendationState()
        {
        }
    }
}
