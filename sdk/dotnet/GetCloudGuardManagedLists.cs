...
{
    public static class GetCloudGuardManagedLists
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testManagedLists = Output.Create(Oci.GetCloudGuardManagedLists.InvokeAsync(new Oci.GetCloudGuardManagedListsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCloudGuardManagedListsResult> InvokeAsync(GetCloudGuardManagedListsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudGuardManagedListsResult>("oci:index/getCloudGuardManagedLists:GetCloudGuardManagedLists", args ?? new GetCloudGuardManagedListsArgs(), options.WithVersion());
    }


    public sealed class GetCloudGuardManagedListsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetCloudGuardManagedListsFilterArgs>? _filters;
        public List<Inputs.GetCloudGuardManagedListsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetCloudGuardManagedListsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetCloudGuardManagedListsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCloudGuardManagedListsResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetCloudGuardManagedListsFilterResult> Filters;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCloudGuardManagedListsManagedListCollectionResult> ManagedListCollections;
        ...
        [OutputConstructor]
        private GetCloudGuardManagedListsResult(
            string? accessLevel,
            ...
            ImmutableArray<Outputs.GetCloudGuardManagedListsFilterResult> filters,

            string id,

            string? listType,

            ImmutableArray<Outputs.GetCloudGuardManagedListsManagedListCollectionResult> managedListCollections,
