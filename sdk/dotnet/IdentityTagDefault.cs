...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testTagDefault = new Oci.IdentityTagDefault("testTagDefault", new Oci.IdentityTagDefaultArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityTagDefault:IdentityTagDefault")]
    public partial class IdentityTagDefault : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityTagDefault(string name, IdentityTagDefaultArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityTagDefault:IdentityTagDefault", name, args ?? new IdentityTagDefaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityTagDefault(string name, Input<string> id, IdentityTagDefaultState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityTagDefault:IdentityTagDefault", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityTagDefault Get(string name, Input<string> id, IdentityTagDefaultState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityTagDefault(name, id, state, options);
        }
    }

    public sealed class IdentityTagDefaultArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment. The tag default will be applied to all new resources created in this compartment.
        /// </summary>
        ...
        public IdentityTagDefaultArgs()
        {
        }
    }

    public sealed class IdentityTagDefaultState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the compartment. The tag default will be applied to all new resources created in this compartment.
        /// </summary>
        ...
        public IdentityTagDefaultState()
        {
        }
    }
}
