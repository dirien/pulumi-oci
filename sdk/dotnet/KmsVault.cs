...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVault = new Oci.KmsVault("testVault", new Oci.KmsVaultArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/kmsVault:KmsVault")]
    public partial class KmsVault : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.KmsVaultReplicaDetails> ReplicaDetails { get; private set; } = null!;

        /// <summary>
        /// (Updatable) Details where vault was backed up.
        /// </summary>
        [Output("restoreFromFile")]
        public Output<Outputs.KmsVaultRestoreFromFile?> RestoreFromFile { get; private set; } = null!;

        /// <summary>
        /// (Updatable) Details where vault was backed up
        /// </summary>
        [Output("restoreFromObjectStore")]
        public Output<Outputs.KmsVaultRestoreFromObjectStore?> RestoreFromObjectStore { get; private set; } = null!;
        ...
        public KmsVault(string name, KmsVaultArgs args, CustomResourceOptions? options = null)
            : base("oci:index/kmsVault:KmsVault", name, args ?? new KmsVaultArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KmsVault(string name, Input<string> id, KmsVaultState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/kmsVault:KmsVault", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KmsVault Get(string name, Input<string> id, KmsVaultState? state = null, CustomResourceOptions? options = null)
        {
            return new KmsVault(name, id, state, options);
        }
    }

    public sealed class KmsVaultArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment where you want to create this vault.
        /// </summary>
        ...
        public Input<Inputs.KmsVaultRestoreFromFileArgs>? RestoreFromFile { get; set; }

        /// <summary>
        /// (Updatable) Details where vault was backed up
        /// </summary>
        [Input("restoreFromObjectStore")]
        public Input<Inputs.KmsVaultRestoreFromObjectStoreArgs>? RestoreFromObjectStore { get; set; }
    ...
    public sealed class KmsVaultState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment where you want to create this vault.
        /// </summary>
        ...
        public Input<Inputs.KmsVaultReplicaDetailsGetArgs>? ReplicaDetails { get; set; }

        /// <summary>
        /// (Updatable) Details where vault was backed up.
        /// </summary>
        [Input("restoreFromFile")]
        public Input<Inputs.KmsVaultRestoreFromFileGetArgs>? RestoreFromFile { get; set; }

        /// <summary>
        /// (Updatable) Details where vault was backed up
        /// </summary>
        [Input("restoreFromObjectStore")]
        public Input<Inputs.KmsVaultRestoreFromObjectStoreGetArgs>? RestoreFromObjectStore { get; set; }
