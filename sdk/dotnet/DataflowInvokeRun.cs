...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testInvokeRun = new Oci.DataflowInvokeRun("testInvokeRun", new Oci.DataflowInvokeRunArgs
    ///         {
    ...
    ///             Parameters = 
    ///             {
    ///                 new Oci.Inputs.DataflowInvokeRunParameterArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/dataflowInvokeRun:DataflowInvokeRun")]
    public partial class DataflowInvokeRun : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.DataflowInvokeRunParameter>> Parameters { get; private set; } = null!;
        ...
        public DataflowInvokeRun(string name, DataflowInvokeRunArgs args, CustomResourceOptions? options = null)
            : base("oci:index/dataflowInvokeRun:DataflowInvokeRun", name, args ?? new DataflowInvokeRunArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataflowInvokeRun(string name, Input<string> id, DataflowInvokeRunState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/dataflowInvokeRun:DataflowInvokeRun", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataflowInvokeRun Get(string name, Input<string> id, DataflowInvokeRunState? state = null, CustomResourceOptions? options = null)
        {
            return new DataflowInvokeRun(name, id, state, options);
        }
    }

    public sealed class DataflowInvokeRunArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the associated application. If this value is set, then no value for the execute parameter is required. If this value is not set, then a value for the execute parameter is required, and a new application is created and associated with the new run.
        /// </summary>
        ...
        [Input("parameters")]
        private InputList<Inputs.DataflowInvokeRunParameterArgs>? _parameters;

        /// <summary>
        /// An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        /// </summary>
        public InputList<Inputs.DataflowInvokeRunParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.DataflowInvokeRunParameterArgs>());
        ...
        public DataflowInvokeRunArgs()
        {
        }
    }

    public sealed class DataflowInvokeRunState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the associated application. If this value is set, then no value for the execute parameter is required. If this value is not set, then a value for the execute parameter is required, and a new application is created and associated with the new run.
        /// </summary>
        ...
        [Input("parameters")]
        private InputList<Inputs.DataflowInvokeRunParameterGetArgs>? _parameters;

        /// <summary>
        /// An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        /// </summary>
        public InputList<Inputs.DataflowInvokeRunParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.DataflowInvokeRunParameterGetArgs>());
            set => _parameters = value;
        }
