...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPingMonitor = new Oci.HealthChecksPingMonitor("testPingMonitor", new Oci.HealthChecksPingMonitorArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/healthChecksPingMonitor:HealthChecksPingMonitor")]
    public partial class HealthChecksPingMonitor : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HealthChecksPingMonitor(string name, HealthChecksPingMonitorArgs args, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksPingMonitor:HealthChecksPingMonitor", name, args ?? new HealthChecksPingMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HealthChecksPingMonitor(string name, Input<string> id, HealthChecksPingMonitorState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/healthChecksPingMonitor:HealthChecksPingMonitor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HealthChecksPingMonitor Get(string name, Input<string> id, HealthChecksPingMonitorState? state = null, CustomResourceOptions? options = null)
        {
            return new HealthChecksPingMonitor(name, id, state, options);
        }
    }

    public sealed class HealthChecksPingMonitorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksPingMonitorArgs()
        {
        }
    }

    public sealed class HealthChecksPingMonitorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment.
        /// </summary>
        ...
        public HealthChecksPingMonitorState()
        {
        }
    }
}
