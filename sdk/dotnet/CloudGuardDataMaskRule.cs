...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testDataMaskRule = new Oci.CloudGuardDataMaskRule("testDataMaskRule", new Oci.CloudGuardDataMaskRuleArgs
    ///         {
    ...
    ///             TargetSelected = new Oci.Inputs.CloudGuardDataMaskRuleTargetSelectedArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/cloudGuardDataMaskRule:CloudGuardDataMaskRule")]
    public partial class CloudGuardDataMaskRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.CloudGuardDataMaskRuleTargetSelected> TargetSelected { get; private set; } = null!;
        ...
        public CloudGuardDataMaskRule(string name, CloudGuardDataMaskRuleArgs args, CustomResourceOptions? options = null)
            : base("oci:index/cloudGuardDataMaskRule:CloudGuardDataMaskRule", name, args ?? new CloudGuardDataMaskRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudGuardDataMaskRule(string name, Input<string> id, CloudGuardDataMaskRuleState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/cloudGuardDataMaskRule:CloudGuardDataMaskRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudGuardDataMaskRule Get(string name, Input<string> id, CloudGuardDataMaskRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new CloudGuardDataMaskRule(name, id, state, options);
        }
    }

    public sealed class CloudGuardDataMaskRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier where the resource is created
        /// </summary>
        ...
        public Input<Inputs.CloudGuardDataMaskRuleTargetSelectedArgs> TargetSelected { get; set; } = null!;

        public CloudGuardDataMaskRuleArgs()
        {
        }
    }

    public sealed class CloudGuardDataMaskRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Compartment Identifier where the resource is created
        /// </summary>
        ...
        public Input<Inputs.CloudGuardDataMaskRuleTargetSelectedGetArgs>? TargetSelected { get; set; }
        ...
        public CloudGuardDataMaskRuleState()
        {
        }
    }
}
