...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testCrossConnect = new Oci.CoreCrossConnect("testCrossConnect", new Oci.CoreCrossConnectArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreCrossConnect:CoreCrossConnect")]
    public partial class CoreCrossConnect : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public CoreCrossConnect(string name, CoreCrossConnectArgs args, CustomResourceOptions? options = null)
            : base("oci:index/coreCrossConnect:CoreCrossConnect", name, args ?? new CoreCrossConnectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreCrossConnect(string name, Input<string> id, CoreCrossConnectState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreCrossConnect:CoreCrossConnect", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreCrossConnect Get(string name, Input<string> id, CoreCrossConnectState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreCrossConnect(name, id, state, options);
        }
    }

    public sealed class CoreCrossConnectArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the cross-connect.
        /// </summary>
        ...
        public CoreCrossConnectArgs()
        {
        }
    }

    public sealed class CoreCrossConnectState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the compartment to contain the cross-connect.
        /// </summary>
