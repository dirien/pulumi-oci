...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testCustomerSecretKey = new Oci.IdentityCustomerSecretKey("testCustomerSecretKey", new Oci.IdentityCustomerSecretKeyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityCustomerSecretKey:IdentityCustomerSecretKey")]
    public partial class IdentityCustomerSecretKey : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityCustomerSecretKey(string name, IdentityCustomerSecretKeyArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityCustomerSecretKey:IdentityCustomerSecretKey", name, args ?? new IdentityCustomerSecretKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityCustomerSecretKey(string name, Input<string> id, IdentityCustomerSecretKeyState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityCustomerSecretKey:IdentityCustomerSecretKey", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityCustomerSecretKey Get(string name, Input<string> id, IdentityCustomerSecretKeyState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityCustomerSecretKey(name, id, state, options);
        }
    }

    public sealed class IdentityCustomerSecretKeyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The name you assign to the secret key during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentityCustomerSecretKeyArgs()
        {
        }
    }

    public sealed class IdentityCustomerSecretKeyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The name you assign to the secret key during creation. Does not have to be unique, and it's changeable.
        /// </summary>
        ...
        public IdentityCustomerSecretKeyState()
        {
        }
    }
}
