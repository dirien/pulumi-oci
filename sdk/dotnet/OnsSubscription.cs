...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testSubscription = new Oci.OnsSubscription("testSubscription", new Oci.OnsSubscriptionArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/onsSubscription:OnsSubscription")]
    public partial class OnsSubscription : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OnsSubscription(string name, OnsSubscriptionArgs args, CustomResourceOptions? options = null)
            : base("oci:index/onsSubscription:OnsSubscription", name, args ?? new OnsSubscriptionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OnsSubscription(string name, Input<string> id, OnsSubscriptionState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/onsSubscription:OnsSubscription", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OnsSubscription Get(string name, Input<string> id, OnsSubscriptionState? state = null, CustomResourceOptions? options = null)
        {
            return new OnsSubscription(name, id, state, options);
        }
    }

    public sealed class OnsSubscriptionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the subscription.
        /// </summary>
        ...
        public OnsSubscriptionArgs()
        {
        }
    }

    public sealed class OnsSubscriptionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the subscription.
        /// </summary>
