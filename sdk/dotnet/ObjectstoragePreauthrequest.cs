...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testPreauthenticatedRequest = new Oci.ObjectstoragePreauthrequest("testPreauthenticatedRequest", new Oci.ObjectstoragePreauthrequestArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/objectstoragePreauthrequest:ObjectstoragePreauthrequest")]
    public partial class ObjectstoragePreauthrequest : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ObjectstoragePreauthrequest(string name, ObjectstoragePreauthrequestArgs args, CustomResourceOptions? options = null)
            : base("oci:index/objectstoragePreauthrequest:ObjectstoragePreauthrequest", name, args ?? new ObjectstoragePreauthrequestArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ObjectstoragePreauthrequest(string name, Input<string> id, ObjectstoragePreauthrequestState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/objectstoragePreauthrequest:ObjectstoragePreauthrequest", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ObjectstoragePreauthrequest Get(string name, Input<string> id, ObjectstoragePreauthrequestState? state = null, CustomResourceOptions? options = null)
        {
            return new ObjectstoragePreauthrequest(name, id, state, options);
        }
    }

    public sealed class ObjectstoragePreauthrequestArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The operation that can be performed on this resource. Allowed Values: `ObjectRead`, `ObjectWrite`, `ObjectReadWrite`, `AnyObjectReadWrite` or `AnyObjectRead`
        /// </summary>
        ...
        public ObjectstoragePreauthrequestArgs()
        {
        }
    }

    public sealed class ObjectstoragePreauthrequestState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The operation that can be performed on this resource. Allowed Values: `ObjectRead`, `ObjectWrite`, `ObjectReadWrite`, `AnyObjectReadWrite` or `AnyObjectRead`
        /// </summary>
        ...
        public ObjectstoragePreauthrequestState()
        {
        }
    }
}
