...
{
    public static class GetCoreIpsecConnectionTunnel
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testIpSecConnectionTunnel = Output.Create(Oci.GetCoreIpsecConnectionTunnel.InvokeAsync(new Oci.GetCoreIpsecConnectionTunnelArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreIpsecConnectionTunnelResult> InvokeAsync(GetCoreIpsecConnectionTunnelArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreIpsecConnectionTunnelResult>("oci:index/getCoreIpsecConnectionTunnel:GetCoreIpsecConnectionTunnel", args ?? new GetCoreIpsecConnectionTunnelArgs(), options.WithVersion());
    }


    public sealed class GetCoreIpsecConnectionTunnelArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreIpsecConnectionTunnelArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreIpsecConnectionTunnelResult
    {
        /// <summary>
        /// Information needed to establish a BGP Session on an interface.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreIpsecConnectionTunnelBgpSessionInfoResult> BgpSessionInfos;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.GetCoreIpsecConnectionTunnelEncryptionDomainConfigResult EncryptionDomainConfig;
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreIpsecConnectionTunnelResult(
            ImmutableArray<Outputs.GetCoreIpsecConnectionTunnelBgpSessionInfoResult> bgpSessionInfos,
            ...
            Outputs.GetCoreIpsecConnectionTunnelEncryptionDomainConfigResult encryptionDomainConfig,
