...
{
    [OciResourceType("oci:index/databaseExadataInfrastructureStorage:DatabaseExadataInfrastructureStorage")]
    public partial class DatabaseExadataInfrastructureStorage : Pulumi.CustomResource
    {
        ...
        [Output("contacts")]
        public Output<ImmutableArray<Outputs.DatabaseExadataInfrastructureStorageContact>> Contacts { get; private set; } = null!;
        ...
        public Output<Outputs.DatabaseExadataInfrastructureStorageMaintenanceWindow> MaintenanceWindow { get; private set; } = null!;
        ...
        public DatabaseExadataInfrastructureStorage(string name, DatabaseExadataInfrastructureStorageArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseExadataInfrastructureStorage:DatabaseExadataInfrastructureStorage", name, args ?? new DatabaseExadataInfrastructureStorageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseExadataInfrastructureStorage(string name, Input<string> id, DatabaseExadataInfrastructureStorageState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseExadataInfrastructureStorage:DatabaseExadataInfrastructureStorage", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseExadataInfrastructureStorage Get(string name, Input<string> id, DatabaseExadataInfrastructureStorageState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseExadataInfrastructureStorage(name, id, state, options);
        }
    }

    public sealed class DatabaseExadataInfrastructureStorageArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("contacts")]
        private InputList<Inputs.DatabaseExadataInfrastructureStorageContactArgs>? _contacts;
        public InputList<Inputs.DatabaseExadataInfrastructureStorageContactArgs> Contacts
        {
            get => _contacts ?? (_contacts = new InputList<Inputs.DatabaseExadataInfrastructureStorageContactArgs>());
            set => _contacts = value;
        }
        ...
        public Input<Inputs.DatabaseExadataInfrastructureStorageMaintenanceWindowArgs>? MaintenanceWindow { get; set; }
        ...
        public DatabaseExadataInfrastructureStorageArgs()
        {
        }
    }

    public sealed class DatabaseExadataInfrastructureStorageState : Pulumi.ResourceArgs
    {
        ...
        [Input("contacts")]
        private InputList<Inputs.DatabaseExadataInfrastructureStorageContactGetArgs>? _contacts;
        public InputList<Inputs.DatabaseExadataInfrastructureStorageContactGetArgs> Contacts
        {
            get => _contacts ?? (_contacts = new InputList<Inputs.DatabaseExadataInfrastructureStorageContactGetArgs>());
            set => _contacts = value;
        }
        ...
        [Input("maintenanceWindow")]
        public Input<Inputs.DatabaseExadataInfrastructureStorageMaintenanceWindowGetArgs>? MaintenanceWindow { get; set; }
        ...
        public DatabaseExadataInfrastructureStorageState()
        {
        }
    }
}
