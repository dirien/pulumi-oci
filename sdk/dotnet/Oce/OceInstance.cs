...
namespace Pulumi.Oci.Oce
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testOceInstance = new Oci.Oce.OceInstance("testOceInstance", new Oci.Oce.OceInstanceArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:oce/oceInstance:OceInstance")]
    public partial class OceInstance : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OceInstance(string name, OceInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:oce/oceInstance:OceInstance", name, args ?? new OceInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OceInstance(string name, Input<string> id, OceInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:oce/oceInstance:OceInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OceInstance Get(string name, Input<string> id, OceInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new OceInstance(name, id, state, options);
        }
    }

    public sealed class OceInstanceArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Admin Email for Notification
        /// </summary>
        ...
        public OceInstanceArgs()
        {
        }
    }

    public sealed class OceInstanceState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Admin Email for Notification
        /// </summary>
