...
{
    public static class GetDatacatalogMetastore
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testMetastore = Output.Create(Oci.GetDatacatalogMetastore.InvokeAsync(new Oci.GetDatacatalogMetastoreArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatacatalogMetastoreResult> InvokeAsync(GetDatacatalogMetastoreArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatacatalogMetastoreResult>("oci:index/getDatacatalogMetastore:GetDatacatalogMetastore", args ?? new GetDatacatalogMetastoreArgs(), options.WithVersion());
    }


    public sealed class GetDatacatalogMetastoreArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDatacatalogMetastoreArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatacatalogMetastoreResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatacatalogMetastoreResult(
