...
{
    public static class GetCoreComputeCapacityReservation
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testComputeCapacityReservation = Output.Create(Oci.GetCoreComputeCapacityReservation.InvokeAsync(new Oci.GetCoreComputeCapacityReservationArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCoreComputeCapacityReservationResult> InvokeAsync(GetCoreComputeCapacityReservationArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCoreComputeCapacityReservationResult>("oci:index/getCoreComputeCapacityReservation:GetCoreComputeCapacityReservation", args ?? new GetCoreComputeCapacityReservationArgs(), options.WithVersion());
    }


    public sealed class GetCoreComputeCapacityReservationArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCoreComputeCapacityReservationArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCoreComputeCapacityReservationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCoreComputeCapacityReservationInstanceReservationConfigResult> InstanceReservationConfigs;
        /// <summary>
        ...
        [OutputConstructor]
        private GetCoreComputeCapacityReservationResult(
            ...
            ImmutableArray<Outputs.GetCoreComputeCapacityReservationInstanceReservationConfigResult> instanceReservationConfigs,
