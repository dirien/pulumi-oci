...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testVmCluster = new Oci.DatabaseVmCluster("testVmCluster", new Oci.DatabaseVmClusterArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/databaseVmCluster:DatabaseVmCluster")]
    public partial class DatabaseVmCluster : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DatabaseVmCluster(string name, DatabaseVmClusterArgs args, CustomResourceOptions? options = null)
            : base("oci:index/databaseVmCluster:DatabaseVmCluster", name, args ?? new DatabaseVmClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatabaseVmCluster(string name, Input<string> id, DatabaseVmClusterState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/databaseVmCluster:DatabaseVmCluster", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatabaseVmCluster Get(string name, Input<string> id, DatabaseVmClusterState? state = null, CustomResourceOptions? options = null)
        {
            return new DatabaseVmCluster(name, id, state, options);
        }
    }

    public sealed class DatabaseVmClusterArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        /// </summary>
        ...
        public DatabaseVmClusterArgs()
        {
        }
    }

    public sealed class DatabaseVmClusterState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        /// </summary>
