...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testMonitor = new Oci.ApmSyntheticsMonitor("testMonitor", new Oci.ApmSyntheticsMonitorArgs
    ///         {
    ...
    ///                 ,
    ///             },
    ///             Configuration = new Oci.Inputs.ApmSyntheticsMonitorConfigurationArgs
    ///             {
    ...
    ///                 ReqAuthenticationDetails = new Oci.Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsArgs
    ///                 {
    ///                     AuthHeaders = 
    ///                     {
    ///                         new Oci.Inputs.ApmSyntheticsMonitorConfigurationReqAuthenticationDetailsAuthHeaderArgs
    ///                         {
    ...
    ///                 RequestHeaders = 
    ///                 {
    ///                     new Oci.Inputs.ApmSyntheticsMonitorConfigurationRequestHeaderArgs
    ///                     {
    ...
    ///                 RequestQueryParams = 
    ///                 {
    ///                     new Oci.Inputs.ApmSyntheticsMonitorConfigurationRequestQueryParamArgs
    ///                     {
    ...
    ///                 VerifyTexts = 
    ///                 {
    ///                     new Oci.Inputs.ApmSyntheticsMonitorConfigurationVerifyTextArgs
    ///                     {
    ...
    ///             ScriptParameters = 
    ///             {
    ///                 new Oci.Inputs.ApmSyntheticsMonitorScriptParameterArgs
    ///                 {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/apmSyntheticsMonitor:ApmSyntheticsMonitor")]
    public partial class ApmSyntheticsMonitor : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.ApmSyntheticsMonitorConfiguration> Configuration { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ApmSyntheticsMonitorScriptParameter>> ScriptParameters { get; private set; } = null!;
        ...
        public ApmSyntheticsMonitor(string name, ApmSyntheticsMonitorArgs args, CustomResourceOptions? options = null)
            : base("oci:index/apmSyntheticsMonitor:ApmSyntheticsMonitor", name, args ?? new ApmSyntheticsMonitorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ApmSyntheticsMonitor(string name, Input<string> id, ApmSyntheticsMonitorState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/apmSyntheticsMonitor:ApmSyntheticsMonitor", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ApmSyntheticsMonitor Get(string name, Input<string> id, ApmSyntheticsMonitorState? state = null, CustomResourceOptions? options = null)
        {
            return new ApmSyntheticsMonitor(name, id, state, options);
        }
    }

    public sealed class ApmSyntheticsMonitorArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The APM domain ID the request is intended for.
        /// </summary>
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.ApmSyntheticsMonitorConfigurationArgs>? Configuration { get; set; }
        ...
        private InputList<Inputs.ApmSyntheticsMonitorScriptParameterArgs>? _scriptParameters;

        /// <summary>
        /// (Updatable) List of script parameters in the monitor. This is valid only for SCRIPTED_BROWSER and SCRIPTED_REST monitor types. For other monitor types, it should be set to null. Example: `[{"paramName": "userid", "paramValue":"testuser"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorScriptParameterArgs> ScriptParameters
        {
            get => _scriptParameters ?? (_scriptParameters = new InputList<Inputs.ApmSyntheticsMonitorScriptParameterArgs>());
        ...
        public ApmSyntheticsMonitorArgs()
        {
        }
    }

    public sealed class ApmSyntheticsMonitorState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The APM domain ID the request is intended for.
        /// </summary>
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.ApmSyntheticsMonitorConfigurationGetArgs>? Configuration { get; set; }
        ...
        [Input("scriptParameters")]
        private InputList<Inputs.ApmSyntheticsMonitorScriptParameterGetArgs>? _scriptParameters;

        /// <summary>
        /// (Updatable) List of script parameters in the monitor. This is valid only for SCRIPTED_BROWSER and SCRIPTED_REST monitor types. For other monitor types, it should be set to null. Example: `[{"paramName": "userid", "paramValue":"testuser"}]`
        /// </summary>
        public InputList<Inputs.ApmSyntheticsMonitorScriptParameterGetArgs> ScriptParameters
        {
            get => _scriptParameters ?? (_scriptParameters = new InputList<Inputs.ApmSyntheticsMonitorScriptParameterGetArgs>());
            set => _scriptParameters = value;
        }
        ...
        public ApmSyntheticsMonitorState()
        {
        }
    }
}
