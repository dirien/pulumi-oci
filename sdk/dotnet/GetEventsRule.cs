...
{
    public static class GetEventsRule
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testRule = Output.Create(Oci.GetEventsRule.InvokeAsync(new Oci.GetEventsRuleArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetEventsRuleResult> InvokeAsync(GetEventsRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetEventsRuleResult>("oci:index/getEventsRule:GetEventsRule", args ?? new GetEventsRuleArgs(), options.WithVersion());
    }


    public sealed class GetEventsRuleArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetEventsRuleResult
    {
        /// <summary>
        /// A list of one or more Action objects.
        /// </summary>
        public readonly Outputs.GetEventsRuleActionsResult Actions;
        /// <summary>
        ...
        [OutputConstructor]
        private GetEventsRuleResult(
            Outputs.GetEventsRuleActionsResult actions,
