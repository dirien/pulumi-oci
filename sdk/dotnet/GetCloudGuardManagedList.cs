...
{
    public static class GetCloudGuardManagedList
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testManagedList = Output.Create(Oci.GetCloudGuardManagedList.InvokeAsync(new Oci.GetCloudGuardManagedListArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetCloudGuardManagedListResult> InvokeAsync(GetCloudGuardManagedListArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetCloudGuardManagedListResult>("oci:index/getCloudGuardManagedList:GetCloudGuardManagedList", args ?? new GetCloudGuardManagedListArgs(), options.WithVersion());
    }


    public sealed class GetCloudGuardManagedListArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetCloudGuardManagedListArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetCloudGuardManagedListResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudGuardManagedListResult(
