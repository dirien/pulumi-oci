...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/identityCompartment:IdentityCompartment")]
    public partial class IdentityCompartment : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdentityCompartment(string name, IdentityCompartmentArgs args, CustomResourceOptions? options = null)
            : base("oci:index/identityCompartment:IdentityCompartment", name, args ?? new IdentityCompartmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdentityCompartment(string name, Input<string> id, IdentityCompartmentState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/identityCompartment:IdentityCompartment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdentityCompartment Get(string name, Input<string> id, IdentityCompartmentState? state = null, CustomResourceOptions? options = null)
        {
            return new IdentityCompartment(name, id, state, options);
        }
    }

    public sealed class IdentityCompartmentArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the parent compartment containing the compartment.
        /// </summary>
        ...
        public IdentityCompartmentArgs()
        {
        }
    }

    public sealed class IdentityCompartmentState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The OCID of the parent compartment containing the compartment.
        /// </summary>
        ...
        public IdentityCompartmentState()
        {
        }
    }
}
