...
namespace Pulumi.Oci.LogAnalytics
{
    public static class GetLogAnalyticsObjectCollectionRule
    {
        ...
        public static Task<GetLogAnalyticsObjectCollectionRuleResult> InvokeAsync(GetLogAnalyticsObjectCollectionRuleArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLogAnalyticsObjectCollectionRuleResult>("oci:loganalytics/getLogAnalyticsObjectCollectionRule:getLogAnalyticsObjectCollectionRule", args ?? new GetLogAnalyticsObjectCollectionRuleArgs(), options.WithVersion());
    }
