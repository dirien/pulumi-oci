...
namespace Pulumi.Oci.LogAnalytics
{
    public static class GetNamespaces
    {
        ...
        public static Task<GetNamespacesResult> InvokeAsync(GetNamespacesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNamespacesResult>("oci:loganalytics/getNamespaces:getNamespaces", args ?? new GetNamespacesArgs(), options.WithVersion());
    }
