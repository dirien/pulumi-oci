...
namespace Pulumi.Oci.LogAnalytics
{
    public static class GetLogAnalyticsEntity
    {
        ...
        public static Task<GetLogAnalyticsEntityResult> InvokeAsync(GetLogAnalyticsEntityArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLogAnalyticsEntityResult>("oci:loganalytics/getLogAnalyticsEntity:getLogAnalyticsEntity", args ?? new GetLogAnalyticsEntityArgs(), options.WithVersion());
    }
