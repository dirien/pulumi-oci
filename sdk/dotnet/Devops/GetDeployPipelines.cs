...
namespace Pulumi.Oci.Devops
{
    public static class GetDeployPipelines
    {
        ...
        public static Task<GetDeployPipelinesResult> InvokeAsync(GetDeployPipelinesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeployPipelinesResult>("oci:devops/getDeployPipelines:getDeployPipelines", args ?? new GetDeployPipelinesArgs(), options.WithVersion());
    }
