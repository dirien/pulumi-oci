...
namespace Pulumi.Oci.Devops
{
    public static class GetDeployEnvironments
    {
        ...
        public static Task<GetDeployEnvironmentsResult> InvokeAsync(GetDeployEnvironmentsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeployEnvironmentsResult>("oci:devops/getDeployEnvironments:getDeployEnvironments", args ?? new GetDeployEnvironmentsArgs(), options.WithVersion());
    }
