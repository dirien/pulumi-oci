...
namespace Pulumi.Oci.Devops
{
    public static class GetDeployArtifacts
    {
        ...
        public static Task<GetDeployArtifactsResult> InvokeAsync(GetDeployArtifactsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDeployArtifactsResult>("oci:devops/getDeployArtifacts:getDeployArtifacts", args ?? new GetDeployArtifactsArgs(), options.WithVersion());
    }
