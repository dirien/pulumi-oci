...
namespace Pulumi.Oci.ObjectStorage
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testReplicationPolicy = new Oci.ObjectStorage.ObjectstorageReplicationPolicy("testReplicationPolicy", new Oci.ObjectStorage.ObjectstorageReplicationPolicyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:objectstorage/objectstorageReplicationPolicy:ObjectstorageReplicationPolicy")]
    public partial class ObjectstorageReplicationPolicy : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ObjectstorageReplicationPolicy(string name, ObjectstorageReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("oci:objectstorage/objectstorageReplicationPolicy:ObjectstorageReplicationPolicy", name, args ?? new ObjectstorageReplicationPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ObjectstorageReplicationPolicy(string name, Input<string> id, ObjectstorageReplicationPolicyState? state = null, CustomResourceOptions? options = null)
            : base("oci:objectstorage/objectstorageReplicationPolicy:ObjectstorageReplicationPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ObjectstorageReplicationPolicy Get(string name, Input<string> id, ObjectstorageReplicationPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new ObjectstorageReplicationPolicy(name, id, state, options);
        }
    }

    public sealed class ObjectstorageReplicationPolicyArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the bucket. Avoid entering confidential information. Example: `my-new-bucket1`
        /// </summary>
        ...
        public ObjectstorageReplicationPolicyArgs()
        {
        }
    }

    public sealed class ObjectstorageReplicationPolicyState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the bucket. Avoid entering confidential information. Example: `my-new-bucket1`
        /// </summary>
        ...
        public ObjectstorageReplicationPolicyState()
        {
        }
    }
}
