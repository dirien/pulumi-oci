...
namespace Pulumi.Oci.ObjectStorage
{
    public static class GetPreauthrequest
    {
        ...
        public static Task<GetPreauthrequestResult> InvokeAsync(GetPreauthrequestArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPreauthrequestResult>("oci:objectstorage/getPreauthrequest:getPreauthrequest", args ?? new GetPreauthrequestArgs(), options.WithVersion());
    }
