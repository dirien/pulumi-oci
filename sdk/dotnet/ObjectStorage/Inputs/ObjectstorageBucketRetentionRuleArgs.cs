...
namespace Pulumi.Oci.ObjectStorage.Inputs
{
    ...
    public sealed class ObjectstorageBucketRetentionRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("duration")]
        public Input<Inputs.ObjectstorageBucketRetentionRuleDurationArgs>? Duration { get; set; }
        ...
        public ObjectstorageBucketRetentionRuleArgs()
        {
        }
    }
}
