...
namespace Pulumi.Oci.ObjectStorage
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBucket = new Oci.ObjectStorage.ObjectstorageBucket("testBucket", new Oci.ObjectStorage.ObjectstorageBucketArgs
    ///         {
    ...
    ///             RetentionRules = 
    ///             {
    ///                 new Oci.ObjectStorage.Inputs.ObjectstorageBucketRetentionRuleArgs
    ///                 {
    ///                     DisplayName = @var.Retention_rule_display_name,
    ///                     Duration = new Oci.ObjectStorage.Inputs.ObjectstorageBucketRetentionRuleDurationArgs
    ///                     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:objectstorage/objectstorageBucket:ObjectstorageBucket")]
    public partial class ObjectstorageBucket : Pulumi.CustomResource
    {
        ...
        public ObjectstorageBucket(string name, ObjectstorageBucketArgs args, CustomResourceOptions? options = null)
            : base("oci:objectstorage/objectstorageBucket:ObjectstorageBucket", name, args ?? new ObjectstorageBucketArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ObjectstorageBucket(string name, Input<string> id, ObjectstorageBucketState? state = null, CustomResourceOptions? options = null)
            : base("oci:objectstorage/objectstorageBucket:ObjectstorageBucket", name, state, MakeResourceOptions(options, id))
        {
        }
