...
{
    public static class GetDatacatalogConnections
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testConnections = Output.Create(Oci.GetDatacatalogConnections.InvokeAsync(new Oci.GetDatacatalogConnectionsArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDatacatalogConnectionsResult> InvokeAsync(GetDatacatalogConnectionsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDatacatalogConnectionsResult>("oci:index/getDatacatalogConnections:GetDatacatalogConnections", args ?? new GetDatacatalogConnectionsArgs(), options.WithVersion());
    }


    public sealed class GetDatacatalogConnectionsArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("filters")]
        private List<Inputs.GetDatacatalogConnectionsFilterArgs>? _filters;
        public List<Inputs.GetDatacatalogConnectionsFilterArgs> Filters
        {
            get => _filters ?? (_filters = new List<Inputs.GetDatacatalogConnectionsFilterArgs>());
            set => _filters = value;
        }
        ...
        public GetDatacatalogConnectionsArgs()
        {
        }
    }
    ...
    [OutputType]
    public sealed class GetDatacatalogConnectionsResult
    {
        public readonly string CatalogId;
        /// <summary>
        /// The list of connection_collection.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDatacatalogConnectionsConnectionCollectionResult> ConnectionCollections;
        /// <summary>
        ...
        public readonly ImmutableArray<Outputs.GetDatacatalogConnectionsFilterResult> Filters;
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatacatalogConnectionsResult(
            string catalogId,

            ImmutableArray<Outputs.GetDatacatalogConnectionsConnectionCollectionResult> connectionCollections,
            ...
            ImmutableArray<Outputs.GetDatacatalogConnectionsFilterResult> filters,
