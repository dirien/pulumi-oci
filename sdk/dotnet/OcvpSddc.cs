...
namespace Pulumi.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/ocvpSddc:OcvpSddc")]
    public partial class OcvpSddc : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.OcvpSddcHcxOnPremLicense>> HcxOnPremLicenses { get; private set; } = null!;
        ...
        public OcvpSddc(string name, OcvpSddcArgs args, CustomResourceOptions? options = null)
            : base("oci:index/ocvpSddc:OcvpSddc", name, args ?? new OcvpSddcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OcvpSddc(string name, Input<string> id, OcvpSddcState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/ocvpSddc:OcvpSddc", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OcvpSddc Get(string name, Input<string> id, OcvpSddcState? state = null, CustomResourceOptions? options = null)
        {
            return new OcvpSddc(name, id, state, options);
        }
    }

    public sealed class OcvpSddcArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the SDDC.
        /// </summary>
    ...
    public sealed class OcvpSddcState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The number of actual ESXi hosts in the SDDC on the cloud. This attribute will be different when esxi Host is added to an existing SDDC.
        /// </summary>
        ...
        private InputList<Inputs.OcvpSddcHcxOnPremLicenseGetArgs>? _hcxOnPremLicenses;

        /// <summary>
        /// The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
        /// </summary>
        public InputList<Inputs.OcvpSddcHcxOnPremLicenseGetArgs> HcxOnPremLicenses
        {
            get => _hcxOnPremLicenses ?? (_hcxOnPremLicenses = new InputList<Inputs.OcvpSddcHcxOnPremLicenseGetArgs>());
