...
{
    public static class GetBudgetBudget
    {
        /// <summary>
        ...
        ///     public MyStack()
        ///     {
        ///         var testBudget = Output.Create(Oci.GetBudgetBudget.InvokeAsync(new Oci.GetBudgetBudgetArgs
        ///         {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetBudgetBudgetResult> InvokeAsync(GetBudgetBudgetArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBudgetBudgetResult>("oci:index/getBudgetBudget:GetBudgetBudget", args ?? new GetBudgetBudgetArgs(), options.WithVersion());
    }


    public sealed class GetBudgetBudgetArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    [OutputType]
    public sealed class GetBudgetBudgetResult
    {
        /// <summary>
