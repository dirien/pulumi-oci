...
namespace Pulumi.Oci
{
    ...
    ///     public MyStack()
    ///     {
    ///         var testBootVolumeBackup = new Oci.CoreBootVolumeBackup("testBootVolumeBackup", new Oci.CoreBootVolumeBackupArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:index/coreBootVolumeBackup:CoreBootVolumeBackup")]
    public partial class CoreBootVolumeBackup : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.CoreBootVolumeBackupSourceDetails?> SourceDetails { get; private set; } = null!;
        ...
        public CoreBootVolumeBackup(string name, CoreBootVolumeBackupArgs? args = null, CustomResourceOptions? options = null)
            : base("oci:index/coreBootVolumeBackup:CoreBootVolumeBackup", name, args ?? new CoreBootVolumeBackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CoreBootVolumeBackup(string name, Input<string> id, CoreBootVolumeBackupState? state = null, CustomResourceOptions? options = null)
            : base("oci:index/coreBootVolumeBackup:CoreBootVolumeBackup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CoreBootVolumeBackup Get(string name, Input<string> id, CoreBootVolumeBackupState? state = null, CustomResourceOptions? options = null)
        {
            return new CoreBootVolumeBackup(name, id, state, options);
        }
    }

    public sealed class CoreBootVolumeBackupArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the boot volume that needs to be backed up. Cannot be defined if `source_details` is defined.
        /// </summary>
        ...
        /// </summary>
        [Input("sourceDetails")]
        public Input<Inputs.CoreBootVolumeBackupSourceDetailsArgs>? SourceDetails { get; set; }
        ...
        public CoreBootVolumeBackupArgs()
        {
        }
    }

    public sealed class CoreBootVolumeBackupState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the boot volume that needs to be backed up. Cannot be defined if `source_details` is defined.
        /// </summary>
        ...
        /// </summary>
        [Input("sourceDetails")]
        public Input<Inputs.CoreBootVolumeBackupSourceDetailsGetArgs>? SourceDetails { get; set; }
        ...
        public CoreBootVolumeBackupState()
        {
        }
    }
}
