...
namespace Pulumi.Oci.AiAnomalyDetection
{
    public static class GetModels
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testModels = Output.Create(Oci.AiAnomalyDetection.GetModels.InvokeAsync(new Oci.AiAnomalyDetection.GetModelsArgs
        ///         {
        ...
        public static Task<GetModelsResult> InvokeAsync(GetModelsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetModelsResult>("oci:aianomalydetection/getModels:getModels", args ?? new GetModelsArgs(), options.WithVersion());
    }
