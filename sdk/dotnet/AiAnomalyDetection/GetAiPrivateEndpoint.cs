...
namespace Pulumi.Oci.AiAnomalyDetection
{
    public static class GetAiPrivateEndpoint
    {
        ...
        public static Task<GetAiPrivateEndpointResult> InvokeAsync(GetAiPrivateEndpointArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetAiPrivateEndpointResult>("oci:aianomalydetection/getAiPrivateEndpoint:getAiPrivateEndpoint", args ?? new GetAiPrivateEndpointArgs(), options.WithVersion());
    }
