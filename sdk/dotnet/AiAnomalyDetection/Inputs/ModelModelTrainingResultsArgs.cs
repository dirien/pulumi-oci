...
namespace Pulumi.Oci.AiAnomalyDetection.Inputs
{
    ...
    public sealed class ModelModelTrainingResultsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ModelModelTrainingResultsRowReductionDetailsArgs>? RowReductionDetails { get; set; }

        [Input("signalDetails")]
        private InputList<Inputs.ModelModelTrainingResultsSignalDetailArgs>? _signalDetails;

        /// <summary>
        /// The list of signal details.
        /// </summary>
        public InputList<Inputs.ModelModelTrainingResultsSignalDetailArgs> SignalDetails
        {
            get => _signalDetails ?? (_signalDetails = new InputList<Inputs.ModelModelTrainingResultsSignalDetailArgs>());
        ...
        public ModelModelTrainingResultsArgs()
        {
        }
    }
}
