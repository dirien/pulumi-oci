...
func (*OdaInstance) ElementType() reflect.Type {
	return reflect.TypeOf((*OdaInstance)(nil))
}
...
func (i *OdaInstance) ToOdaInstancePtrOutput() OdaInstancePtrOutput {
	return i.ToOdaInstancePtrOutputWithContext(context.Background())
}

func (i *OdaInstance) ToOdaInstancePtrOutputWithContext(ctx context.Context) OdaInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OdaInstancePtrOutput)
}

type OdaInstancePtrInput interface {
	pulumi.Input

	ToOdaInstancePtrOutput() OdaInstancePtrOutput
	ToOdaInstancePtrOutputWithContext(ctx context.Context) OdaInstancePtrOutput
}

type odaInstancePtrType OdaInstanceArgs

func (*odaInstancePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**OdaInstance)(nil))
}

func (i *odaInstancePtrType) ToOdaInstancePtrOutput() OdaInstancePtrOutput {
	return i.ToOdaInstancePtrOutputWithContext(context.Background())
}

func (i *odaInstancePtrType) ToOdaInstancePtrOutputWithContext(ctx context.Context) OdaInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OdaInstancePtrOutput)
}
...
func (o OdaInstanceOutput) ToOdaInstancePtrOutput() OdaInstancePtrOutput {
	return o.ToOdaInstancePtrOutputWithContext(context.Background())
}

func (o OdaInstanceOutput) ToOdaInstancePtrOutputWithContext(ctx context.Context) OdaInstancePtrOutput {
	return o.ApplyT(func(v OdaInstance) *OdaInstance {
		return &v
	}).(OdaInstancePtrOutput)
}

type OdaInstancePtrOutput struct {
	*pulumi.OutputState
}

func (OdaInstancePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**OdaInstance)(nil))
}

func (o OdaInstancePtrOutput) ToOdaInstancePtrOutput() OdaInstancePtrOutput {
	return o
}

func (o OdaInstancePtrOutput) ToOdaInstancePtrOutputWithContext(ctx context.Context) OdaInstancePtrOutput {
	return o
}
...
func (OdaInstanceMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]OdaInstance)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(OdaInstancePtrOutput{})
