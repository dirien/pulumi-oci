...
// 		_, err := oci.GetDataflowApplication(ctx, &GetDataflowApplicationArgs{
...
// }
// ```
func LookupDataflowApplication(ctx *pulumi.Context, args *LookupDataflowApplicationArgs, opts ...pulumi.InvokeOption) (*LookupDataflowApplicationResult, error) {
	var rv LookupDataflowApplicationResult
	err := ctx.Invoke("oci:index/getDataflowApplication:GetDataflowApplication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDataflowApplicationResult struct {
	...
	Parameters []GetDataflowApplicationParameter `pulumi:"parameters"`
