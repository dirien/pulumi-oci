...
func (*InvokeRun) ElementType() reflect.Type {
	return reflect.TypeOf((*InvokeRun)(nil))
}
...
func (i *InvokeRun) ToInvokeRunPtrOutput() InvokeRunPtrOutput {
	return i.ToInvokeRunPtrOutputWithContext(context.Background())
}

func (i *InvokeRun) ToInvokeRunPtrOutputWithContext(ctx context.Context) InvokeRunPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InvokeRunPtrOutput)
}

type InvokeRunPtrInput interface {
	pulumi.Input

	ToInvokeRunPtrOutput() InvokeRunPtrOutput
	ToInvokeRunPtrOutputWithContext(ctx context.Context) InvokeRunPtrOutput
}

type invokeRunPtrType InvokeRunArgs

func (*invokeRunPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**InvokeRun)(nil))
}

func (i *invokeRunPtrType) ToInvokeRunPtrOutput() InvokeRunPtrOutput {
	return i.ToInvokeRunPtrOutputWithContext(context.Background())
}

func (i *invokeRunPtrType) ToInvokeRunPtrOutputWithContext(ctx context.Context) InvokeRunPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InvokeRunPtrOutput)
}
...
func (o InvokeRunOutput) ToInvokeRunPtrOutput() InvokeRunPtrOutput {
	return o.ToInvokeRunPtrOutputWithContext(context.Background())
}

func (o InvokeRunOutput) ToInvokeRunPtrOutputWithContext(ctx context.Context) InvokeRunPtrOutput {
	return o.ApplyT(func(v InvokeRun) *InvokeRun {
		return &v
	}).(InvokeRunPtrOutput)
}

type InvokeRunPtrOutput struct {
	*pulumi.OutputState
}

func (InvokeRunPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InvokeRun)(nil))
}

func (o InvokeRunPtrOutput) ToInvokeRunPtrOutput() InvokeRunPtrOutput {
	return o
}

func (o InvokeRunPtrOutput) ToInvokeRunPtrOutputWithContext(ctx context.Context) InvokeRunPtrOutput {
	return o
}
...
func (InvokeRunMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InvokeRun)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(InvokeRunPtrOutput{})
