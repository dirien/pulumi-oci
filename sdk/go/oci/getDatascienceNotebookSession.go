...
// 		_, err := oci.GetDatascienceNotebookSession(ctx, &GetDatascienceNotebookSessionArgs{
...
// }
// ```
func LookupDatascienceNotebookSession(ctx *pulumi.Context, args *LookupDatascienceNotebookSessionArgs, opts ...pulumi.InvokeOption) (*LookupDatascienceNotebookSessionResult, error) {
	var rv LookupDatascienceNotebookSessionResult
	err := ctx.Invoke("oci:index/getDatascienceNotebookSession:GetDatascienceNotebookSession", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatascienceNotebookSessionArgs struct {
...
type LookupDatascienceNotebookSessionResult struct {
	...
	NotebookSessionConfigurationDetails GetDatascienceNotebookSessionNotebookSessionConfigurationDetails `pulumi:"notebookSessionConfigurationDetails"`
	NotebookSessionId                   string                                                           `pulumi:"notebookSessionId"`
