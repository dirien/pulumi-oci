...
// 		_, err := oci.GetDatabaseDbHome(ctx, &GetDatabaseDbHomeArgs{
...
// }
// ```
func LookupDatabaseDbHome(ctx *pulumi.Context, args *LookupDatabaseDbHomeArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseDbHomeResult, error) {
	var rv LookupDatabaseDbHomeResult
	err := ctx.Invoke("oci:index/getDatabaseDbHome:GetDatabaseDbHome", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatabaseDbHomeArgs struct {
...
type LookupDatabaseDbHomeResult struct {
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
	CompartmentId string                    `pulumi:"compartmentId"`
	Database      GetDatabaseDbHomeDatabase `pulumi:"database"`
