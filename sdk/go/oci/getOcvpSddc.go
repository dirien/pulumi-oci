...
// 		_, err := oci.GetOcvpSddc(ctx, &GetOcvpSddcArgs{
...
// }
// ```
func LookupOcvpSddc(ctx *pulumi.Context, args *LookupOcvpSddcArgs, opts ...pulumi.InvokeOption) (*LookupOcvpSddcResult, error) {
	var rv LookupOcvpSddcResult
	err := ctx.Invoke("oci:index/getOcvpSddc:GetOcvpSddc", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOcvpSddcArgs struct {
...
type LookupOcvpSddcResult struct {
	...
	HcxOnPremLicenses []GetOcvpSddcHcxOnPremLicense `pulumi:"hcxOnPremLicenses"`
