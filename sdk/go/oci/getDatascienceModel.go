...
// 		_, err := oci.GetDatascienceModel(ctx, &GetDatascienceModelArgs{
...
// }
// ```
func LookupDatascienceModel(ctx *pulumi.Context, args *LookupDatascienceModelArgs, opts ...pulumi.InvokeOption) (*LookupDatascienceModelResult, error) {
	var rv LookupDatascienceModelResult
	err := ctx.Invoke("oci:index/getDatascienceModel:GetDatascienceModel", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatascienceModelArgs struct {
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model.
	ModelId string `pulumi:"modelId"`
}

// A collection of values returned by GetDatascienceModel.
type LookupDatascienceModelResult struct {
	...
	CustomMetadataLists []GetDatascienceModelCustomMetadataList `pulumi:"customMetadataLists"`
	// An array of defined metadata details for the model.
	DefinedMetadataLists []GetDatascienceModelDefinedMetadataList `pulumi:"definedMetadataLists"`
