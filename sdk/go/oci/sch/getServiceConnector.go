...
// 		_, err := sch.LookupServiceConnector(ctx, &sch.LookupServiceConnectorArgs{
...
// }
// ```
func LookupServiceConnector(ctx *pulumi.Context, args *LookupServiceConnectorArgs, opts ...pulumi.InvokeOption) (*LookupServiceConnectorResult, error) {
	var rv LookupServiceConnectorResult
...
type LookupServiceConnectorArgs struct {
...
type LookupServiceConnectorResult struct {
	...
	Source GetServiceConnectorSource `pulumi:"source"`
	...
	Target GetServiceConnectorTarget `pulumi:"target"`
	// The list of tasks.
