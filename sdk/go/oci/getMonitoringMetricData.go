...
// 		_, err := oci.GetMonitoringMetricData(ctx, &GetMonitoringMetricDataArgs{
...
// }
// ```
func GetMonitoringMetricData(ctx *pulumi.Context, args *GetMonitoringMetricDataArgs, opts ...pulumi.InvokeOption) (*GetMonitoringMetricDataResult, error) {
	var rv GetMonitoringMetricDataResult
	err := ctx.Invoke("oci:index/getMonitoringMetricData:GetMonitoringMetricData", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetMonitoringMetricDataArgs struct {
	...
	Filters []GetMonitoringMetricDataFilter `pulumi:"filters"`
...
type GetMonitoringMetricDataResult struct {
	...
	MetricDatas []GetMonitoringMetricDataMetricData `pulumi:"metricDatas"`
