...
// 		_, err := devops.LookupDeployEnvironment(ctx, &devops.LookupDeployEnvironmentArgs{
...
type LookupDeployEnvironmentResult struct {
	...
	ComputeInstanceGroupSelectors GetDeployEnvironmentComputeInstanceGroupSelectors `pulumi:"computeInstanceGroupSelectors"`
