...
func (*DeployArtifact) ElementType() reflect.Type {
	return reflect.TypeOf((*DeployArtifact)(nil))
}
...
func (i *DeployArtifact) ToDeployArtifactPtrOutput() DeployArtifactPtrOutput {
	return i.ToDeployArtifactPtrOutputWithContext(context.Background())
}

func (i *DeployArtifact) ToDeployArtifactPtrOutputWithContext(ctx context.Context) DeployArtifactPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeployArtifactPtrOutput)
}

type DeployArtifactPtrInput interface {
	pulumi.Input

	ToDeployArtifactPtrOutput() DeployArtifactPtrOutput
	ToDeployArtifactPtrOutputWithContext(ctx context.Context) DeployArtifactPtrOutput
}

type deployArtifactPtrType DeployArtifactArgs

func (*deployArtifactPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DeployArtifact)(nil))
}

func (i *deployArtifactPtrType) ToDeployArtifactPtrOutput() DeployArtifactPtrOutput {
	return i.ToDeployArtifactPtrOutputWithContext(context.Background())
}

func (i *deployArtifactPtrType) ToDeployArtifactPtrOutputWithContext(ctx context.Context) DeployArtifactPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeployArtifactPtrOutput)
}
...
func (o DeployArtifactOutput) ToDeployArtifactPtrOutput() DeployArtifactPtrOutput {
	return o.ToDeployArtifactPtrOutputWithContext(context.Background())
}

func (o DeployArtifactOutput) ToDeployArtifactPtrOutputWithContext(ctx context.Context) DeployArtifactPtrOutput {
	return o.ApplyT(func(v DeployArtifact) *DeployArtifact {
		return &v
	}).(DeployArtifactPtrOutput)
}

type DeployArtifactPtrOutput struct {
	*pulumi.OutputState
}

func (DeployArtifactPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DeployArtifact)(nil))
}

func (o DeployArtifactPtrOutput) ToDeployArtifactPtrOutput() DeployArtifactPtrOutput {
	return o
}

func (o DeployArtifactPtrOutput) ToDeployArtifactPtrOutputWithContext(ctx context.Context) DeployArtifactPtrOutput {
	return o
}
...
func (DeployArtifactMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DeployArtifact)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DeployArtifactPtrOutput{})
