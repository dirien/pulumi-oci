...
type DeployPipeline struct {
	...
	DeployPipelineArtifacts DeployPipelineDeployPipelineArtifactsOutput `pulumi:"deployPipelineArtifacts"`
	// List of all environments used in the pipeline.
	DeployPipelineEnvironments DeployPipelineDeployPipelineEnvironmentsOutput `pulumi:"deployPipelineEnvironments"`
...
type deployPipelineState struct {
	...
	// List of all artifacts used in the pipeline.
	DeployPipelineArtifacts *DeployPipelineDeployPipelineArtifacts `pulumi:"deployPipelineArtifacts"`
	// List of all environments used in the pipeline.
	DeployPipelineEnvironments *DeployPipelineDeployPipelineEnvironments `pulumi:"deployPipelineEnvironments"`
	// (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
...
type DeployPipelineState struct {
	...
	// List of all artifacts used in the pipeline.
	DeployPipelineArtifacts DeployPipelineDeployPipelineArtifactsPtrInput
	// List of all environments used in the pipeline.
	DeployPipelineEnvironments DeployPipelineDeployPipelineEnvironmentsPtrInput
	// (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
...
func (*DeployPipeline) ElementType() reflect.Type {
	return reflect.TypeOf((*DeployPipeline)(nil))
}
...
func (i *DeployPipeline) ToDeployPipelinePtrOutput() DeployPipelinePtrOutput {
	return i.ToDeployPipelinePtrOutputWithContext(context.Background())
}

func (i *DeployPipeline) ToDeployPipelinePtrOutputWithContext(ctx context.Context) DeployPipelinePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeployPipelinePtrOutput)
}

type DeployPipelinePtrInput interface {
	pulumi.Input

	ToDeployPipelinePtrOutput() DeployPipelinePtrOutput
	ToDeployPipelinePtrOutputWithContext(ctx context.Context) DeployPipelinePtrOutput
}

type deployPipelinePtrType DeployPipelineArgs

func (*deployPipelinePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DeployPipeline)(nil))
}

func (i *deployPipelinePtrType) ToDeployPipelinePtrOutput() DeployPipelinePtrOutput {
	return i.ToDeployPipelinePtrOutputWithContext(context.Background())
}

func (i *deployPipelinePtrType) ToDeployPipelinePtrOutputWithContext(ctx context.Context) DeployPipelinePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DeployPipelinePtrOutput)
}
...
func (o DeployPipelineOutput) ToDeployPipelinePtrOutput() DeployPipelinePtrOutput {
	return o.ToDeployPipelinePtrOutputWithContext(context.Background())
}

func (o DeployPipelineOutput) ToDeployPipelinePtrOutputWithContext(ctx context.Context) DeployPipelinePtrOutput {
	return o.ApplyT(func(v DeployPipeline) *DeployPipeline {
		return &v
	}).(DeployPipelinePtrOutput)
}

type DeployPipelinePtrOutput struct {
	*pulumi.OutputState
}

func (DeployPipelinePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DeployPipeline)(nil))
}

func (o DeployPipelinePtrOutput) ToDeployPipelinePtrOutput() DeployPipelinePtrOutput {
	return o
}

func (o DeployPipelinePtrOutput) ToDeployPipelinePtrOutputWithContext(ctx context.Context) DeployPipelinePtrOutput {
	return o
}
...
func (DeployPipelineMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DeployPipeline)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DeployPipelinePtrOutput{})
