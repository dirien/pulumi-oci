...
// 		_, err := devops.LookupDeployStage(ctx, &devops.LookupDeployStageArgs{
...
type LookupDeployStageResult struct {
	...
	ApprovalPolicy GetDeployStageApprovalPolicy `pulumi:"approvalPolicy"`
	// Collection of backend environment IP addresses.
	BlueBackendIps GetDeployStageBlueBackendIps `pulumi:"blueBackendIps"`
	...
	DeployStagePredecessorCollection GetDeployStageDeployStagePredecessorCollection `pulumi:"deployStagePredecessorCollection"`
	...
	FailurePolicy GetDeployStageFailurePolicy `pulumi:"failurePolicy"`
	...
	// Collection of backend environment IP addresses.
	GreenBackendIps GetDeployStageGreenBackendIps `pulumi:"greenBackendIps"`
	...
	LoadBalancerConfig GetDeployStageLoadBalancerConfig `pulumi:"loadBalancerConfig"`
	...
	RollbackPolicy GetDeployStageRollbackPolicy `pulumi:"rollbackPolicy"`
	// Description of rollout policy for load balancer traffic shift stage.
	RolloutPolicy GetDeployStageRolloutPolicy `pulumi:"rolloutPolicy"`
	...
	WaitCriteria GetDeployStageWaitCriteria `pulumi:"waitCriteria"`
}
