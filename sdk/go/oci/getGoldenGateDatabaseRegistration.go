...
// 		_, err := oci.GetGoldenGateDatabaseRegistration(ctx, &GetGoldenGateDatabaseRegistrationArgs{
...
// }
// ```
func LookupGoldenGateDatabaseRegistration(ctx *pulumi.Context, args *LookupGoldenGateDatabaseRegistrationArgs, opts ...pulumi.InvokeOption) (*LookupGoldenGateDatabaseRegistrationResult, error) {
	var rv LookupGoldenGateDatabaseRegistrationResult
	err := ctx.Invoke("oci:index/getGoldenGateDatabaseRegistration:GetGoldenGateDatabaseRegistration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupGoldenGateDatabaseRegistrationArgs struct {
...
type LookupGoldenGateDatabaseRegistrationResult struct {
