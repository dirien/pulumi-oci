...
// 		_, err := oci.GetIdentityCompartment(ctx, &GetIdentityCompartmentArgs{
...
// }
// ```
func LookupIdentityCompartment(ctx *pulumi.Context, args *LookupIdentityCompartmentArgs, opts ...pulumi.InvokeOption) (*LookupIdentityCompartmentResult, error) {
	var rv LookupIdentityCompartmentResult
	err := ctx.Invoke("oci:index/getIdentityCompartment:GetIdentityCompartment", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupIdentityCompartmentArgs struct {
	// The OCID of the compartment.
	Id string `pulumi:"id"`
}

// A collection of values returned by GetIdentityCompartment.
type LookupIdentityCompartmentResult struct {
