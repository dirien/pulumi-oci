...
func (*ProtectionRule) ElementType() reflect.Type {
	return reflect.TypeOf((*ProtectionRule)(nil))
}
...
func (i *ProtectionRule) ToProtectionRulePtrOutput() ProtectionRulePtrOutput {
	return i.ToProtectionRulePtrOutputWithContext(context.Background())
}

func (i *ProtectionRule) ToProtectionRulePtrOutputWithContext(ctx context.Context) ProtectionRulePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProtectionRulePtrOutput)
}

type ProtectionRulePtrInput interface {
	pulumi.Input

	ToProtectionRulePtrOutput() ProtectionRulePtrOutput
	ToProtectionRulePtrOutputWithContext(ctx context.Context) ProtectionRulePtrOutput
}

type protectionRulePtrType ProtectionRuleArgs

func (*protectionRulePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ProtectionRule)(nil))
}

func (i *protectionRulePtrType) ToProtectionRulePtrOutput() ProtectionRulePtrOutput {
	return i.ToProtectionRulePtrOutputWithContext(context.Background())
}

func (i *protectionRulePtrType) ToProtectionRulePtrOutputWithContext(ctx context.Context) ProtectionRulePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProtectionRulePtrOutput)
}
...
func (o ProtectionRuleOutput) ToProtectionRulePtrOutput() ProtectionRulePtrOutput {
	return o.ToProtectionRulePtrOutputWithContext(context.Background())
}

func (o ProtectionRuleOutput) ToProtectionRulePtrOutputWithContext(ctx context.Context) ProtectionRulePtrOutput {
	return o.ApplyT(func(v ProtectionRule) *ProtectionRule {
		return &v
	}).(ProtectionRulePtrOutput)
}

type ProtectionRulePtrOutput struct {
	*pulumi.OutputState
}

func (ProtectionRulePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProtectionRule)(nil))
}

func (o ProtectionRulePtrOutput) ToProtectionRulePtrOutput() ProtectionRulePtrOutput {
	return o
}

func (o ProtectionRulePtrOutput) ToProtectionRulePtrOutputWithContext(ctx context.Context) ProtectionRulePtrOutput {
	return o
}
...
func (ProtectionRuleMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ProtectionRule)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ProtectionRulePtrOutput{})
