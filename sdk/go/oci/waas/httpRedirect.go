...
func (*HttpRedirect) ElementType() reflect.Type {
	return reflect.TypeOf((*HttpRedirect)(nil))
}
...
func (i *HttpRedirect) ToHttpRedirectPtrOutput() HttpRedirectPtrOutput {
	return i.ToHttpRedirectPtrOutputWithContext(context.Background())
}

func (i *HttpRedirect) ToHttpRedirectPtrOutputWithContext(ctx context.Context) HttpRedirectPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HttpRedirectPtrOutput)
}

type HttpRedirectPtrInput interface {
	pulumi.Input

	ToHttpRedirectPtrOutput() HttpRedirectPtrOutput
	ToHttpRedirectPtrOutputWithContext(ctx context.Context) HttpRedirectPtrOutput
}

type httpRedirectPtrType HttpRedirectArgs

func (*httpRedirectPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HttpRedirect)(nil))
}

func (i *httpRedirectPtrType) ToHttpRedirectPtrOutput() HttpRedirectPtrOutput {
	return i.ToHttpRedirectPtrOutputWithContext(context.Background())
}

func (i *httpRedirectPtrType) ToHttpRedirectPtrOutputWithContext(ctx context.Context) HttpRedirectPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HttpRedirectPtrOutput)
}
...
type HttpRedirectOutput struct {
	*pulumi.OutputState
}
...
func (o HttpRedirectOutput) ToHttpRedirectPtrOutput() HttpRedirectPtrOutput {
	return o.ToHttpRedirectPtrOutputWithContext(context.Background())
}

func (o HttpRedirectOutput) ToHttpRedirectPtrOutputWithContext(ctx context.Context) HttpRedirectPtrOutput {
	return o.ApplyT(func(v HttpRedirect) *HttpRedirect {
		return &v
	}).(HttpRedirectPtrOutput)
}

type HttpRedirectPtrOutput struct {
	*pulumi.OutputState
}

func (HttpRedirectPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HttpRedirect)(nil))
}

func (o HttpRedirectPtrOutput) ToHttpRedirectPtrOutput() HttpRedirectPtrOutput {
	return o
}

func (o HttpRedirectPtrOutput) ToHttpRedirectPtrOutputWithContext(ctx context.Context) HttpRedirectPtrOutput {
	return o
}
...
func (HttpRedirectMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]HttpRedirect)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(HttpRedirectPtrOutput{})
