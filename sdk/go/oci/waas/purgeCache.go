...
func (*PurgeCache) ElementType() reflect.Type {
	return reflect.TypeOf((*PurgeCache)(nil))
}
...
func (i *PurgeCache) ToPurgeCachePtrOutput() PurgeCachePtrOutput {
	return i.ToPurgeCachePtrOutputWithContext(context.Background())
}

func (i *PurgeCache) ToPurgeCachePtrOutputWithContext(ctx context.Context) PurgeCachePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PurgeCachePtrOutput)
}

type PurgeCachePtrInput interface {
	pulumi.Input

	ToPurgeCachePtrOutput() PurgeCachePtrOutput
	ToPurgeCachePtrOutputWithContext(ctx context.Context) PurgeCachePtrOutput
}

type purgeCachePtrType PurgeCacheArgs

func (*purgeCachePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PurgeCache)(nil))
}

func (i *purgeCachePtrType) ToPurgeCachePtrOutput() PurgeCachePtrOutput {
	return i.ToPurgeCachePtrOutputWithContext(context.Background())
}

func (i *purgeCachePtrType) ToPurgeCachePtrOutputWithContext(ctx context.Context) PurgeCachePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PurgeCachePtrOutput)
}
...
func (o PurgeCacheOutput) ToPurgeCachePtrOutput() PurgeCachePtrOutput {
	return o.ToPurgeCachePtrOutputWithContext(context.Background())
}

func (o PurgeCacheOutput) ToPurgeCachePtrOutputWithContext(ctx context.Context) PurgeCachePtrOutput {
	return o.ApplyT(func(v PurgeCache) *PurgeCache {
		return &v
	}).(PurgeCachePtrOutput)
}

type PurgeCachePtrOutput struct {
	*pulumi.OutputState
}

func (PurgeCachePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PurgeCache)(nil))
}

func (o PurgeCachePtrOutput) ToPurgeCachePtrOutput() PurgeCachePtrOutput {
	return o
}

func (o PurgeCachePtrOutput) ToPurgeCachePtrOutputWithContext(ctx context.Context) PurgeCachePtrOutput {
	return o
}
...
func (PurgeCacheMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]PurgeCache)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PurgeCachePtrOutput{})
