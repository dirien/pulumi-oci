...
type Certificate struct {
	...
	IssuerName CertificateIssuerNameOutput `pulumi:"issuerName"`
	...
	PublicKeyInfo CertificatePublicKeyInfoOutput `pulumi:"publicKeyInfo"`
	...
	SubjectName CertificateSubjectNameOutput `pulumi:"subjectName"`
...
type certificateState struct {
	...
	// The issuer of the certificate.
	IssuerName *CertificateIssuerName `pulumi:"issuerName"`
	// The private key of the SSL certificate.
	PrivateKeyData *string `pulumi:"privateKeyData"`
	// Information about the public key and the algorithm used by the public key.
	PublicKeyInfo *CertificatePublicKeyInfo `pulumi:"publicKeyInfo"`
	// A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
	...
	// The entity to be secured by the certificate.
	SubjectName *CertificateSubjectName `pulumi:"subjectName"`
	// The date and time the certificate was created, expressed in RFC 3339 timestamp format.
...
type CertificateState struct {
	...
	// The issuer of the certificate.
	IssuerName CertificateIssuerNamePtrInput
	// The private key of the SSL certificate.
	PrivateKeyData pulumi.StringPtrInput
	// Information about the public key and the algorithm used by the public key.
	PublicKeyInfo CertificatePublicKeyInfoPtrInput
	// A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
	...
	// The entity to be secured by the certificate.
	SubjectName CertificateSubjectNamePtrInput
	// The date and time the certificate was created, expressed in RFC 3339 timestamp format.
