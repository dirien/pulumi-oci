...
// 		_, err := oci.GetDatabaseAutonomousPatch(ctx, &GetDatabaseAutonomousPatchArgs{
...
// }
// ```
func GetDatabaseAutonomousPatch(ctx *pulumi.Context, args *GetDatabaseAutonomousPatchArgs, opts ...pulumi.InvokeOption) (*GetDatabaseAutonomousPatchResult, error) {
	var rv GetDatabaseAutonomousPatchResult
	err := ctx.Invoke("oci:index/getDatabaseAutonomousPatch:GetDatabaseAutonomousPatch", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabaseAutonomousPatchArgs struct {
...
type GetDatabaseAutonomousPatchResult struct {
	AutonomousPatchId string `pulumi:"autonomousPatchId"`
