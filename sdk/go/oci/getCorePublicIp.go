...
// 		opt0 := _var.Test_public_ip_id
// 		_, err := oci.GetCorePublicIp(ctx, &GetCorePublicIpArgs{
// 			Id: &opt0,
// 		}, nil)
// 		if err != nil {
// 			return err
...
// func main() {
// 	pulumi.Run(func(ctx *pulumi.Context) error {
// 		opt0 := _var.Test_public_ip_private_ip_id
// 		_, err := oci.GetCorePublicIp(ctx, &GetCorePublicIpArgs{
// 			PrivateIpId: &opt0,
// 		}, nil)
// 		if err != nil {
...
// func main() {
// 	pulumi.Run(func(ctx *pulumi.Context) error {
// 		opt0 := _var.Test_public_ip_ip_address
// 		_, err := oci.GetCorePublicIp(ctx, &GetCorePublicIpArgs{
// 			IpAddress: &opt0,
// 		}, nil)
// 		if err != nil {
...
// }
// ```
func LookupCorePublicIp(ctx *pulumi.Context, args *LookupCorePublicIpArgs, opts ...pulumi.InvokeOption) (*LookupCorePublicIpResult, error) {
	var rv LookupCorePublicIpResult
	err := ctx.Invoke("oci:index/getCorePublicIp:GetCorePublicIp", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCorePublicIpArgs struct {
...
type LookupCorePublicIpResult struct {
