...
// 		_, err := oci.GetArtifactsGenericArtifacts(ctx, &GetArtifactsGenericArtifactsArgs{
...
// }
// ```
func GetArtifactsGenericArtifacts(ctx *pulumi.Context, args *GetArtifactsGenericArtifactsArgs, opts ...pulumi.InvokeOption) (*GetArtifactsGenericArtifactsResult, error) {
	var rv GetArtifactsGenericArtifactsResult
	err := ctx.Invoke("oci:index/getArtifactsGenericArtifacts:GetArtifactsGenericArtifacts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetArtifactsGenericArtifactsArgs struct {
	...
	Filters     []GetArtifactsGenericArtifactsFilter `pulumi:"filters"`
...
type GetArtifactsGenericArtifactsResult struct {
	...
	GenericArtifactCollections []GetArtifactsGenericArtifactsGenericArtifactCollection `pulumi:"genericArtifactCollections"`
