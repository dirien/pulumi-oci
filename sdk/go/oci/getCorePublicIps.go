...
// 		opt0 := _var.Public_ip_availability_domain
// 		opt1 := _var.Public_ip_lifetime
// 		opt2 := oci_core_public_ip_pool.Test_public_ip_pool.Id
// 		_, err := oci.GetCorePublicIps(ctx, &GetCorePublicIpsArgs{
...
// }
// ```
func GetCorePublicIps(ctx *pulumi.Context, args *GetCorePublicIpsArgs, opts ...pulumi.InvokeOption) (*GetCorePublicIpsResult, error) {
	var rv GetCorePublicIpsResult
	err := ctx.Invoke("oci:index/getCorePublicIps:GetCorePublicIps", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCorePublicIpsArgs struct {
	// The name of the availability domain.  Example: `Uocm:PHX-AD-1`
	AvailabilityDomain *string `pulumi:"availabilityDomain"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
	CompartmentId string                   `pulumi:"compartmentId"`
	Filters       []GetCorePublicIpsFilter `pulumi:"filters"`
...
type GetCorePublicIpsResult struct {
	...
	PublicIps []GetCorePublicIpsPublicIp `pulumi:"publicIps"`
	// Whether the public IP is regional or specific to a particular availability domain.
