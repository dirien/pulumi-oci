...
// 		_, err := oci.GetDatabaseAutonomousDatabaseDataguardAssociation(ctx, &GetDatabaseAutonomousDatabaseDataguardAssociationArgs{
...
// }
// ```
func GetDatabaseAutonomousDatabaseDataguardAssociation(ctx *pulumi.Context, args *GetDatabaseAutonomousDatabaseDataguardAssociationArgs, opts ...pulumi.InvokeOption) (*GetDatabaseAutonomousDatabaseDataguardAssociationResult, error) {
	var rv GetDatabaseAutonomousDatabaseDataguardAssociationResult
	err := ctx.Invoke("oci:index/getDatabaseAutonomousDatabaseDataguardAssociation:GetDatabaseAutonomousDatabaseDataguardAssociation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabaseAutonomousDatabaseDataguardAssociationArgs struct {
...
type GetDatabaseAutonomousDatabaseDataguardAssociationResult struct {
