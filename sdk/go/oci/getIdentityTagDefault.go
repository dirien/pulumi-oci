...
// 		_, err := oci.GetIdentityTagDefault(ctx, &GetIdentityTagDefaultArgs{
...
// }
// ```
func LookupIdentityTagDefault(ctx *pulumi.Context, args *LookupIdentityTagDefaultArgs, opts ...pulumi.InvokeOption) (*LookupIdentityTagDefaultResult, error) {
	var rv LookupIdentityTagDefaultResult
	err := ctx.Invoke("oci:index/getIdentityTagDefault:GetIdentityTagDefault", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
