...
// 		_, err := oci.GetOdaOdaInstance(ctx, &GetOdaOdaInstanceArgs{
...
// }
// ```
func LookupOdaOdaInstance(ctx *pulumi.Context, args *LookupOdaOdaInstanceArgs, opts ...pulumi.InvokeOption) (*LookupOdaOdaInstanceResult, error) {
	var rv LookupOdaOdaInstanceResult
	err := ctx.Invoke("oci:index/getOdaOdaInstance:GetOdaOdaInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
