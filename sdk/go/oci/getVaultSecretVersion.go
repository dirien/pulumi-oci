...
// 		_, err := oci.GetVaultSecretVersion(ctx, &GetVaultSecretVersionArgs{
...
// }
// ```
func GetVaultSecretVersion(ctx *pulumi.Context, args *GetVaultSecretVersionArgs, opts ...pulumi.InvokeOption) (*GetVaultSecretVersionResult, error) {
	var rv GetVaultSecretVersionResult
	err := ctx.Invoke("oci:index/getVaultSecretVersion:GetVaultSecretVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetVaultSecretVersionArgs struct {
...
type GetVaultSecretVersionResult struct {
