...
// 		_, err := oci.GetLimitsResourceAvailability(ctx, &GetLimitsResourceAvailabilityArgs{
...
// }
// ```
func GetLimitsResourceAvailability(ctx *pulumi.Context, args *GetLimitsResourceAvailabilityArgs, opts ...pulumi.InvokeOption) (*GetLimitsResourceAvailabilityResult, error) {
	var rv GetLimitsResourceAvailabilityResult
	err := ctx.Invoke("oci:index/getLimitsResourceAvailability:GetLimitsResourceAvailability", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetLimitsResourceAvailabilityArgs struct {
...
type GetLimitsResourceAvailabilityResult struct {
	AvailabilityDomain *string `pulumi:"availabilityDomain"`
