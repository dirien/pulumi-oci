...
// 		_, err := datascience.LookupModelDeployment(ctx, &datascience.LookupModelDeploymentArgs{
...
type LookupModelDeploymentResult struct {
	...
	CategoryLogDetails GetModelDeploymentCategoryLogDetails `pulumi:"categoryLogDetails"`
	...
	ModelDeploymentConfigurationDetails GetModelDeploymentModelDeploymentConfigurationDetails `pulumi:"modelDeploymentConfigurationDetails"`
	ModelDeploymentId                   string                                                `pulumi:"modelDeploymentId"`
