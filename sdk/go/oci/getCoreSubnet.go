...
// 		_, err := oci.GetCoreSubnet(ctx, &GetCoreSubnetArgs{
...
// }
// ```
func LookupCoreSubnet(ctx *pulumi.Context, args *LookupCoreSubnetArgs, opts ...pulumi.InvokeOption) (*LookupCoreSubnetResult, error) {
	var rv LookupCoreSubnetResult
	err := ctx.Invoke("oci:index/getCoreSubnet:GetCoreSubnet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
