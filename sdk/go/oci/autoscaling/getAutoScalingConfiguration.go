...
// 		_, err := autoscaling.LookupAutoScalingConfiguration(ctx, &autoscaling.LookupAutoScalingConfigurationArgs{
...
type LookupAutoScalingConfigurationResult struct {
	...
	AutoScalingResources GetAutoScalingConfigurationAutoScalingResources `pulumi:"autoScalingResources"`
