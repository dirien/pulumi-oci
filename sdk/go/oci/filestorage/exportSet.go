...
func (*ExportSet) ElementType() reflect.Type {
	return reflect.TypeOf((*ExportSet)(nil))
}
...
func (i *ExportSet) ToExportSetPtrOutput() ExportSetPtrOutput {
	return i.ToExportSetPtrOutputWithContext(context.Background())
}

func (i *ExportSet) ToExportSetPtrOutputWithContext(ctx context.Context) ExportSetPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExportSetPtrOutput)
}

type ExportSetPtrInput interface {
	pulumi.Input

	ToExportSetPtrOutput() ExportSetPtrOutput
	ToExportSetPtrOutputWithContext(ctx context.Context) ExportSetPtrOutput
}

type exportSetPtrType ExportSetArgs

func (*exportSetPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ExportSet)(nil))
}

func (i *exportSetPtrType) ToExportSetPtrOutput() ExportSetPtrOutput {
	return i.ToExportSetPtrOutputWithContext(context.Background())
}

func (i *exportSetPtrType) ToExportSetPtrOutputWithContext(ctx context.Context) ExportSetPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExportSetPtrOutput)
}
...
func (o ExportSetOutput) ToExportSetPtrOutput() ExportSetPtrOutput {
	return o.ToExportSetPtrOutputWithContext(context.Background())
}

func (o ExportSetOutput) ToExportSetPtrOutputWithContext(ctx context.Context) ExportSetPtrOutput {
	return o.ApplyT(func(v ExportSet) *ExportSet {
		return &v
	}).(ExportSetPtrOutput)
}

type ExportSetPtrOutput struct {
	*pulumi.OutputState
}

func (ExportSetPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ExportSet)(nil))
}

func (o ExportSetPtrOutput) ToExportSetPtrOutput() ExportSetPtrOutput {
	return o
}

func (o ExportSetPtrOutput) ToExportSetPtrOutputWithContext(ctx context.Context) ExportSetPtrOutput {
	return o
}
...
func (ExportSetMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ExportSet)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ExportSetPtrOutput{})
