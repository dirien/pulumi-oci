...
// 		_, err := oci.GetDatabaseAutonomousVmCluster(ctx, &GetDatabaseAutonomousVmClusterArgs{
...
// }
// ```
func LookupDatabaseAutonomousVmCluster(ctx *pulumi.Context, args *LookupDatabaseAutonomousVmClusterArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseAutonomousVmClusterResult, error) {
	var rv LookupDatabaseAutonomousVmClusterResult
	err := ctx.Invoke("oci:index/getDatabaseAutonomousVmCluster:GetDatabaseAutonomousVmCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatabaseAutonomousVmClusterArgs struct {
...
type LookupDatabaseAutonomousVmClusterResult struct {
	AutonomousVmClusterId string `pulumi:"autonomousVmClusterId"`
