...
// 		_, err := oci.GetEmailSuppression(ctx, &GetEmailSuppressionArgs{
...
// }
// ```
func LookupEmailSuppression(ctx *pulumi.Context, args *LookupEmailSuppressionArgs, opts ...pulumi.InvokeOption) (*LookupEmailSuppressionResult, error) {
	var rv LookupEmailSuppressionResult
	err := ctx.Invoke("oci:index/getEmailSuppression:GetEmailSuppression", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
