...
type Vault struct {
	...
	ReplicaDetails VaultReplicaDetailsOutput `pulumi:"replicaDetails"`
...
type vaultState struct {
	...
	// Vault replica details
	ReplicaDetails *VaultReplicaDetails `pulumi:"replicaDetails"`
	// (Updatable) Details where vault was backed up.
...
type VaultState struct {
	...
	// Vault replica details
	ReplicaDetails VaultReplicaDetailsPtrInput
	// (Updatable) Details where vault was backed up.
