...
func (*Sign) ElementType() reflect.Type {
	return reflect.TypeOf((*Sign)(nil))
}
...
func (i *Sign) ToSignPtrOutput() SignPtrOutput {
	return i.ToSignPtrOutputWithContext(context.Background())
}

func (i *Sign) ToSignPtrOutputWithContext(ctx context.Context) SignPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SignPtrOutput)
}

type SignPtrInput interface {
	pulumi.Input

	ToSignPtrOutput() SignPtrOutput
	ToSignPtrOutputWithContext(ctx context.Context) SignPtrOutput
}

type signPtrType SignArgs

func (*signPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Sign)(nil))
}

func (i *signPtrType) ToSignPtrOutput() SignPtrOutput {
	return i.ToSignPtrOutputWithContext(context.Background())
}

func (i *signPtrType) ToSignPtrOutputWithContext(ctx context.Context) SignPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SignPtrOutput)
}
...
func (o SignOutput) ToSignPtrOutput() SignPtrOutput {
	return o.ToSignPtrOutputWithContext(context.Background())
}

func (o SignOutput) ToSignPtrOutputWithContext(ctx context.Context) SignPtrOutput {
	return o.ApplyT(func(v Sign) *Sign {
		return &v
	}).(SignPtrOutput)
}

type SignPtrOutput struct {
	*pulumi.OutputState
}

func (SignPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Sign)(nil))
}

func (o SignPtrOutput) ToSignPtrOutput() SignPtrOutput {
	return o
}

func (o SignPtrOutput) ToSignPtrOutputWithContext(ctx context.Context) SignPtrOutput {
	return o
}
...
func (SignMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Sign)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(SignPtrOutput{})
