...
type Key struct {
	...
	// Key replica details
	ReplicaDetails KeyReplicaDetailsOutput `pulumi:"replicaDetails"`
...
type keyState struct {
	...
	// Key replica details
	ReplicaDetails *KeyReplicaDetails `pulumi:"replicaDetails"`
	// (Updatable) Details where key was backed up.
...
type KeyState struct {
	...
	// Key replica details
	ReplicaDetails KeyReplicaDetailsPtrInput
	// (Updatable) Details where key was backed up.
