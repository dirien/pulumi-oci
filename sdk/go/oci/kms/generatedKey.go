...
func (*GeneratedKey) ElementType() reflect.Type {
	return reflect.TypeOf((*GeneratedKey)(nil))
}
...
func (i *GeneratedKey) ToGeneratedKeyPtrOutput() GeneratedKeyPtrOutput {
	return i.ToGeneratedKeyPtrOutputWithContext(context.Background())
}

func (i *GeneratedKey) ToGeneratedKeyPtrOutputWithContext(ctx context.Context) GeneratedKeyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GeneratedKeyPtrOutput)
}

type GeneratedKeyPtrInput interface {
	pulumi.Input

	ToGeneratedKeyPtrOutput() GeneratedKeyPtrOutput
	ToGeneratedKeyPtrOutputWithContext(ctx context.Context) GeneratedKeyPtrOutput
}

type generatedKeyPtrType GeneratedKeyArgs

func (*generatedKeyPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**GeneratedKey)(nil))
}

func (i *generatedKeyPtrType) ToGeneratedKeyPtrOutput() GeneratedKeyPtrOutput {
	return i.ToGeneratedKeyPtrOutputWithContext(context.Background())
}

func (i *generatedKeyPtrType) ToGeneratedKeyPtrOutputWithContext(ctx context.Context) GeneratedKeyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GeneratedKeyPtrOutput)
}
...
func (o GeneratedKeyOutput) ToGeneratedKeyPtrOutput() GeneratedKeyPtrOutput {
	return o.ToGeneratedKeyPtrOutputWithContext(context.Background())
}

func (o GeneratedKeyOutput) ToGeneratedKeyPtrOutputWithContext(ctx context.Context) GeneratedKeyPtrOutput {
	return o.ApplyT(func(v GeneratedKey) *GeneratedKey {
		return &v
	}).(GeneratedKeyPtrOutput)
}

type GeneratedKeyPtrOutput struct {
	*pulumi.OutputState
}

func (GeneratedKeyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**GeneratedKey)(nil))
}

func (o GeneratedKeyPtrOutput) ToGeneratedKeyPtrOutput() GeneratedKeyPtrOutput {
	return o
}

func (o GeneratedKeyPtrOutput) ToGeneratedKeyPtrOutputWithContext(ctx context.Context) GeneratedKeyPtrOutput {
	return o
}
...
func (GeneratedKeyMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]GeneratedKey)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(GeneratedKeyPtrOutput{})
