...
func (*Sddc) ElementType() reflect.Type {
	return reflect.TypeOf((*Sddc)(nil))
}
...
func (i *Sddc) ToSddcPtrOutput() SddcPtrOutput {
	return i.ToSddcPtrOutputWithContext(context.Background())
}

func (i *Sddc) ToSddcPtrOutputWithContext(ctx context.Context) SddcPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SddcPtrOutput)
}

type SddcPtrInput interface {
	pulumi.Input

	ToSddcPtrOutput() SddcPtrOutput
	ToSddcPtrOutputWithContext(ctx context.Context) SddcPtrOutput
}

type sddcPtrType SddcArgs

func (*sddcPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Sddc)(nil))
}

func (i *sddcPtrType) ToSddcPtrOutput() SddcPtrOutput {
	return i.ToSddcPtrOutputWithContext(context.Background())
}

func (i *sddcPtrType) ToSddcPtrOutputWithContext(ctx context.Context) SddcPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SddcPtrOutput)
}
...
func (o SddcOutput) ToSddcPtrOutput() SddcPtrOutput {
	return o.ToSddcPtrOutputWithContext(context.Background())
}

func (o SddcOutput) ToSddcPtrOutputWithContext(ctx context.Context) SddcPtrOutput {
	return o.ApplyT(func(v Sddc) *Sddc {
		return &v
	}).(SddcPtrOutput)
}

type SddcPtrOutput struct {
	*pulumi.OutputState
}

func (SddcPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Sddc)(nil))
}

func (o SddcPtrOutput) ToSddcPtrOutput() SddcPtrOutput {
	return o
}

func (o SddcPtrOutput) ToSddcPtrOutputWithContext(ctx context.Context) SddcPtrOutput {
	return o
}
...
func (SddcMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Sddc)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(SddcPtrOutput{})
