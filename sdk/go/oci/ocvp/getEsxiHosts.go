...
// 		_, err := ocvp.GetEsxiHosts(ctx, &ocvp.GetEsxiHostsArgs{
...
// }
// ```
func GetEsxiHosts(ctx *pulumi.Context, args *GetEsxiHostsArgs, opts ...pulumi.InvokeOption) (*GetEsxiHostsResult, error) {
	var rv GetEsxiHostsResult
	err := ctx.Invoke("oci:ocvp/getEsxiHosts:getEsxiHosts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// A collection of arguments for invoking getEsxiHosts.
type GetEsxiHostsArgs struct {
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Compute instance.
	ComputeInstanceId *string `pulumi:"computeInstanceId"`
	// A filter to return only resources that match the given display name exactly.
	DisplayName *string              `pulumi:"displayName"`
	Filters     []GetEsxiHostsFilter `pulumi:"filters"`
...
type GetEsxiHostsResult struct {
	...
	EsxiHostCollections []GetEsxiHostsEsxiHostCollection `pulumi:"esxiHostCollections"`
	Filters             []GetEsxiHostsFilter             `pulumi:"filters"`
