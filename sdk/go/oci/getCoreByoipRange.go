...
// 		_, err := oci.GetCoreByoipRange(ctx, &GetCoreByoipRangeArgs{
...
// }
// ```
func GetCoreByoipRange(ctx *pulumi.Context, args *GetCoreByoipRangeArgs, opts ...pulumi.InvokeOption) (*GetCoreByoipRangeResult, error) {
	var rv GetCoreByoipRangeResult
	err := ctx.Invoke("oci:index/getCoreByoipRange:GetCoreByoipRange", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCoreByoipRangeArgs struct {
...
type GetCoreByoipRangeResult struct {
	ByoipRangeId string `pulumi:"byoipRangeId"`
