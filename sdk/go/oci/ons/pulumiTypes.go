...
type GetSubscriptionsSubscription struct {
	...
	// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
	DefinedTags    map[string]interface{}                     `pulumi:"definedTags"`
	DeliveryPolicy GetSubscriptionsSubscriptionDeliveryPolicy `pulumi:"deliveryPolicy"`
...
type GetSubscriptionsSubscriptionArgs struct {
	...
	// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
	DefinedTags    pulumi.MapInput                                 `pulumi:"definedTags"`
	DeliveryPolicy GetSubscriptionsSubscriptionDeliveryPolicyInput `pulumi:"deliveryPolicy"`
	// A locator that corresponds to the subscription protocol.  For example, an email address for a subscription that uses the `EMAIL` protocol, or a URL for a subscription that uses an HTTP-based protocol. Avoid entering confidential information.
...
func (o GetSubscriptionsSubscriptionOutput) DeliveryPolicy() GetSubscriptionsSubscriptionDeliveryPolicyOutput {
...
type GetSubscriptionsSubscriptionDeliveryPolicy struct {
	BackoffRetryPolicy GetSubscriptionsSubscriptionDeliveryPolicyBackoffRetryPolicy `pulumi:"backoffRetryPolicy"`
}
...
type GetSubscriptionsSubscriptionDeliveryPolicyArgs struct {
	BackoffRetryPolicy GetSubscriptionsSubscriptionDeliveryPolicyBackoffRetryPolicyInput `pulumi:"backoffRetryPolicy"`
}
...
func (o GetSubscriptionsSubscriptionDeliveryPolicyOutput) BackoffRetryPolicy() GetSubscriptionsSubscriptionDeliveryPolicyBackoffRetryPolicyOutput {
