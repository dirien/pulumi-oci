...
// 		_, err := oci.GetBlockchainBlockchainPlatform(ctx, &GetBlockchainBlockchainPlatformArgs{
...
// }
// ```
func LookupBlockchainBlockchainPlatform(ctx *pulumi.Context, args *LookupBlockchainBlockchainPlatformArgs, opts ...pulumi.InvokeOption) (*LookupBlockchainBlockchainPlatformResult, error) {
	var rv LookupBlockchainBlockchainPlatformResult
	err := ctx.Invoke("oci:index/getBlockchainBlockchainPlatform:GetBlockchainBlockchainPlatform", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupBlockchainBlockchainPlatformArgs struct {
...
type LookupBlockchainBlockchainPlatformResult struct {
	BlockchainPlatformId string `pulumi:"blockchainPlatformId"`
	CaCertArchiveText    string `pulumi:"caCertArchiveText"`
	// Compartment Identifier
	CompartmentId string `pulumi:"compartmentId"`
	// Blockchain Platform component details.
	ComponentDetails GetBlockchainBlockchainPlatformComponentDetails `pulumi:"componentDetails"`
	...
	HostOcpuUtilizationInfos []GetBlockchainBlockchainPlatformHostOcpuUtilizationInfo `pulumi:"hostOcpuUtilizationInfos"`
	...
	Replicas GetBlockchainBlockchainPlatformReplicas `pulumi:"replicas"`
