...
// 		_, err := oci.GetApmSyntheticsMonitors(ctx, &GetApmSyntheticsMonitorsArgs{
...
// }
// ```
func GetApmSyntheticsMonitors(ctx *pulumi.Context, args *GetApmSyntheticsMonitorsArgs, opts ...pulumi.InvokeOption) (*GetApmSyntheticsMonitorsResult, error) {
	var rv GetApmSyntheticsMonitorsResult
	err := ctx.Invoke("oci:index/getApmSyntheticsMonitors:GetApmSyntheticsMonitors", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetApmSyntheticsMonitorsArgs struct {
	// The APM domain ID the request is intended for.
	ApmDomainId string `pulumi:"apmDomainId"`
	// A filter to return only resources that match the entire display name given.
	DisplayName *string                          `pulumi:"displayName"`
	Filters     []GetApmSyntheticsMonitorsFilter `pulumi:"filters"`
...
type GetApmSyntheticsMonitorsResult struct {
	ApmDomainId string `pulumi:"apmDomainId"`
	...
	MonitorCollections []GetApmSyntheticsMonitorsMonitorCollection `pulumi:"monitorCollections"`
	// Type of the monitor.
	MonitorType *string `pulumi:"monitorType"`
