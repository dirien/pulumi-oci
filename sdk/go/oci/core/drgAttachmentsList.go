...
func (*DrgAttachmentsList) ElementType() reflect.Type {
	return reflect.TypeOf((*DrgAttachmentsList)(nil))
}
...
func (i *DrgAttachmentsList) ToDrgAttachmentsListPtrOutput() DrgAttachmentsListPtrOutput {
	return i.ToDrgAttachmentsListPtrOutputWithContext(context.Background())
}

func (i *DrgAttachmentsList) ToDrgAttachmentsListPtrOutputWithContext(ctx context.Context) DrgAttachmentsListPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DrgAttachmentsListPtrOutput)
}

type DrgAttachmentsListPtrInput interface {
	pulumi.Input

	ToDrgAttachmentsListPtrOutput() DrgAttachmentsListPtrOutput
	ToDrgAttachmentsListPtrOutputWithContext(ctx context.Context) DrgAttachmentsListPtrOutput
}

type drgAttachmentsListPtrType DrgAttachmentsListArgs

func (*drgAttachmentsListPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DrgAttachmentsList)(nil))
}

func (i *drgAttachmentsListPtrType) ToDrgAttachmentsListPtrOutput() DrgAttachmentsListPtrOutput {
	return i.ToDrgAttachmentsListPtrOutputWithContext(context.Background())
}

func (i *drgAttachmentsListPtrType) ToDrgAttachmentsListPtrOutputWithContext(ctx context.Context) DrgAttachmentsListPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DrgAttachmentsListPtrOutput)
}
...
type DrgAttachmentsListOutput struct {
	*pulumi.OutputState
}
...
func (o DrgAttachmentsListOutput) ToDrgAttachmentsListPtrOutput() DrgAttachmentsListPtrOutput {
	return o.ToDrgAttachmentsListPtrOutputWithContext(context.Background())
}

func (o DrgAttachmentsListOutput) ToDrgAttachmentsListPtrOutputWithContext(ctx context.Context) DrgAttachmentsListPtrOutput {
	return o.ApplyT(func(v DrgAttachmentsList) *DrgAttachmentsList {
		return &v
	}).(DrgAttachmentsListPtrOutput)
}

type DrgAttachmentsListPtrOutput struct {
	*pulumi.OutputState
}

func (DrgAttachmentsListPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DrgAttachmentsList)(nil))
}

func (o DrgAttachmentsListPtrOutput) ToDrgAttachmentsListPtrOutput() DrgAttachmentsListPtrOutput {
	return o
}

func (o DrgAttachmentsListPtrOutput) ToDrgAttachmentsListPtrOutputWithContext(ctx context.Context) DrgAttachmentsListPtrOutput {
	return o
}
...
func (DrgAttachmentsListMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DrgAttachmentsList)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DrgAttachmentsListPtrOutput{})
