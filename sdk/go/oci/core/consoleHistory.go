...
func (*ConsoleHistory) ElementType() reflect.Type {
	return reflect.TypeOf((*ConsoleHistory)(nil))
}
...
func (i *ConsoleHistory) ToConsoleHistoryPtrOutput() ConsoleHistoryPtrOutput {
	return i.ToConsoleHistoryPtrOutputWithContext(context.Background())
}

func (i *ConsoleHistory) ToConsoleHistoryPtrOutputWithContext(ctx context.Context) ConsoleHistoryPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConsoleHistoryPtrOutput)
}

type ConsoleHistoryPtrInput interface {
	pulumi.Input

	ToConsoleHistoryPtrOutput() ConsoleHistoryPtrOutput
	ToConsoleHistoryPtrOutputWithContext(ctx context.Context) ConsoleHistoryPtrOutput
}

type consoleHistoryPtrType ConsoleHistoryArgs

func (*consoleHistoryPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ConsoleHistory)(nil))
}

func (i *consoleHistoryPtrType) ToConsoleHistoryPtrOutput() ConsoleHistoryPtrOutput {
	return i.ToConsoleHistoryPtrOutputWithContext(context.Background())
}

func (i *consoleHistoryPtrType) ToConsoleHistoryPtrOutputWithContext(ctx context.Context) ConsoleHistoryPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConsoleHistoryPtrOutput)
}
...
func (o ConsoleHistoryOutput) ToConsoleHistoryPtrOutput() ConsoleHistoryPtrOutput {
	return o.ToConsoleHistoryPtrOutputWithContext(context.Background())
}

func (o ConsoleHistoryOutput) ToConsoleHistoryPtrOutputWithContext(ctx context.Context) ConsoleHistoryPtrOutput {
	return o.ApplyT(func(v ConsoleHistory) *ConsoleHistory {
		return &v
	}).(ConsoleHistoryPtrOutput)
}

type ConsoleHistoryPtrOutput struct {
	*pulumi.OutputState
}

func (ConsoleHistoryPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ConsoleHistory)(nil))
}

func (o ConsoleHistoryPtrOutput) ToConsoleHistoryPtrOutput() ConsoleHistoryPtrOutput {
	return o
}

func (o ConsoleHistoryPtrOutput) ToConsoleHistoryPtrOutputWithContext(ctx context.Context) ConsoleHistoryPtrOutput {
	return o
}
...
func (ConsoleHistoryMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ConsoleHistory)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ConsoleHistoryPtrOutput{})
