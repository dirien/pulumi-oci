...
func (i *DhcpOptions) ToDhcpOptionsPtrOutput() DhcpOptionsPtrOutput {
	return i.ToDhcpOptionsPtrOutputWithContext(context.Background())
}

func (i *DhcpOptions) ToDhcpOptionsPtrOutputWithContext(ctx context.Context) DhcpOptionsPtrOutput {
...
type DhcpOptionsPtrInput interface {
	...
	ToDhcpOptionsPtrOutputWithContext(ctx context.Context) DhcpOptionsPtrOutput
}
...
type DhcpOptionsPtrOutput struct {
	*pulumi.OutputState
}
...
func (DhcpOptionsMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DhcpOptions)(nil))
}
