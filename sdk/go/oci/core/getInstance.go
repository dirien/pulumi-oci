...
// 		_, err := core.LookupInstance(ctx, &core.LookupInstanceArgs{
...
type LookupInstanceResult struct {
	...
	AgentConfig GetInstanceAgentConfig `pulumi:"agentConfig"`
	// Options for defining the availabiity of a VM instance after a maintenance event that impacts the underlying hardware.
	AvailabilityConfig GetInstanceAvailabilityConfig `pulumi:"availabilityConfig"`
	...
	CreateVnicDetails GetInstanceCreateVnicDetails `pulumi:"createVnicDetails"`
	...
	InstanceOptions GetInstanceInstanceOptions `pulumi:"instanceOptions"`
	...
	LaunchOptions GetInstanceLaunchOptions `pulumi:"launchOptions"`
	// Custom metadata that you provide.
	Metadata map[string]interface{} `pulumi:"metadata"`
	// The platform configuration for the instance.
	PlatformConfig GetInstancePlatformConfig `pulumi:"platformConfig"`
	// (Optional) Configuration options for preemptible instances.
	PreemptibleInstanceConfig GetInstancePreemptibleInstanceConfig `pulumi:"preemptibleInstanceConfig"`
	...
	ShapeConfig   GetInstanceShapeConfig   `pulumi:"shapeConfig"`
	SourceDetails GetInstanceSourceDetails `pulumi:"sourceDetails"`
