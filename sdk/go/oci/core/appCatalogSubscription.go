...
func (*AppCatalogSubscription) ElementType() reflect.Type {
	return reflect.TypeOf((*AppCatalogSubscription)(nil))
}
...
func (i *AppCatalogSubscription) ToAppCatalogSubscriptionPtrOutput() AppCatalogSubscriptionPtrOutput {
	return i.ToAppCatalogSubscriptionPtrOutputWithContext(context.Background())
}

func (i *AppCatalogSubscription) ToAppCatalogSubscriptionPtrOutputWithContext(ctx context.Context) AppCatalogSubscriptionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AppCatalogSubscriptionPtrOutput)
}

type AppCatalogSubscriptionPtrInput interface {
	pulumi.Input

	ToAppCatalogSubscriptionPtrOutput() AppCatalogSubscriptionPtrOutput
	ToAppCatalogSubscriptionPtrOutputWithContext(ctx context.Context) AppCatalogSubscriptionPtrOutput
}

type appCatalogSubscriptionPtrType AppCatalogSubscriptionArgs

func (*appCatalogSubscriptionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AppCatalogSubscription)(nil))
}

func (i *appCatalogSubscriptionPtrType) ToAppCatalogSubscriptionPtrOutput() AppCatalogSubscriptionPtrOutput {
	return i.ToAppCatalogSubscriptionPtrOutputWithContext(context.Background())
}

func (i *appCatalogSubscriptionPtrType) ToAppCatalogSubscriptionPtrOutputWithContext(ctx context.Context) AppCatalogSubscriptionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AppCatalogSubscriptionPtrOutput)
}
...
type AppCatalogSubscriptionOutput struct {
	*pulumi.OutputState
}
...
func (o AppCatalogSubscriptionOutput) ToAppCatalogSubscriptionPtrOutput() AppCatalogSubscriptionPtrOutput {
	return o.ToAppCatalogSubscriptionPtrOutputWithContext(context.Background())
}

func (o AppCatalogSubscriptionOutput) ToAppCatalogSubscriptionPtrOutputWithContext(ctx context.Context) AppCatalogSubscriptionPtrOutput {
	return o.ApplyT(func(v AppCatalogSubscription) *AppCatalogSubscription {
		return &v
	}).(AppCatalogSubscriptionPtrOutput)
}

type AppCatalogSubscriptionPtrOutput struct {
	*pulumi.OutputState
}

func (AppCatalogSubscriptionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AppCatalogSubscription)(nil))
}

func (o AppCatalogSubscriptionPtrOutput) ToAppCatalogSubscriptionPtrOutput() AppCatalogSubscriptionPtrOutput {
	return o
}

func (o AppCatalogSubscriptionPtrOutput) ToAppCatalogSubscriptionPtrOutputWithContext(ctx context.Context) AppCatalogSubscriptionPtrOutput {
	return o
}
...
func (AppCatalogSubscriptionMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]AppCatalogSubscription)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(AppCatalogSubscriptionPtrOutput{})
