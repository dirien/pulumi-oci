...
func (*PublicIpPoolCapacity) ElementType() reflect.Type {
	return reflect.TypeOf((*PublicIpPoolCapacity)(nil))
}
...
func (i *PublicIpPoolCapacity) ToPublicIpPoolCapacityPtrOutput() PublicIpPoolCapacityPtrOutput {
	return i.ToPublicIpPoolCapacityPtrOutputWithContext(context.Background())
}

func (i *PublicIpPoolCapacity) ToPublicIpPoolCapacityPtrOutputWithContext(ctx context.Context) PublicIpPoolCapacityPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PublicIpPoolCapacityPtrOutput)
}

type PublicIpPoolCapacityPtrInput interface {
	pulumi.Input

	ToPublicIpPoolCapacityPtrOutput() PublicIpPoolCapacityPtrOutput
	ToPublicIpPoolCapacityPtrOutputWithContext(ctx context.Context) PublicIpPoolCapacityPtrOutput
}

type publicIpPoolCapacityPtrType PublicIpPoolCapacityArgs

func (*publicIpPoolCapacityPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PublicIpPoolCapacity)(nil))
}

func (i *publicIpPoolCapacityPtrType) ToPublicIpPoolCapacityPtrOutput() PublicIpPoolCapacityPtrOutput {
	return i.ToPublicIpPoolCapacityPtrOutputWithContext(context.Background())
}

func (i *publicIpPoolCapacityPtrType) ToPublicIpPoolCapacityPtrOutputWithContext(ctx context.Context) PublicIpPoolCapacityPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PublicIpPoolCapacityPtrOutput)
}
...
type PublicIpPoolCapacityOutput struct {
	*pulumi.OutputState
}
...
func (o PublicIpPoolCapacityOutput) ToPublicIpPoolCapacityPtrOutput() PublicIpPoolCapacityPtrOutput {
	return o.ToPublicIpPoolCapacityPtrOutputWithContext(context.Background())
}

func (o PublicIpPoolCapacityOutput) ToPublicIpPoolCapacityPtrOutputWithContext(ctx context.Context) PublicIpPoolCapacityPtrOutput {
	return o.ApplyT(func(v PublicIpPoolCapacity) *PublicIpPoolCapacity {
		return &v
	}).(PublicIpPoolCapacityPtrOutput)
}

type PublicIpPoolCapacityPtrOutput struct {
	*pulumi.OutputState
}

func (PublicIpPoolCapacityPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PublicIpPoolCapacity)(nil))
}

func (o PublicIpPoolCapacityPtrOutput) ToPublicIpPoolCapacityPtrOutput() PublicIpPoolCapacityPtrOutput {
	return o
}

func (o PublicIpPoolCapacityPtrOutput) ToPublicIpPoolCapacityPtrOutputWithContext(ctx context.Context) PublicIpPoolCapacityPtrOutput {
	return o
}
...
func (PublicIpPoolCapacityMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]PublicIpPoolCapacity)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PublicIpPoolCapacityPtrOutput{})
