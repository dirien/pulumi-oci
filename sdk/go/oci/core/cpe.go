...
func (i *Cpe) ToCpePtrOutput() CpePtrOutput {
	return i.ToCpePtrOutputWithContext(context.Background())
}

func (i *Cpe) ToCpePtrOutputWithContext(ctx context.Context) CpePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CpePtrOutput)
}

type CpePtrInput interface {
	pulumi.Input

	ToCpePtrOutput() CpePtrOutput
	ToCpePtrOutputWithContext(ctx context.Context) CpePtrOutput
}

type cpePtrType CpeArgs

func (*cpePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Cpe)(nil))
}

func (i *cpePtrType) ToCpePtrOutput() CpePtrOutput {
	return i.ToCpePtrOutputWithContext(context.Background())
}

func (i *cpePtrType) ToCpePtrOutputWithContext(ctx context.Context) CpePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CpePtrOutput)
}
...
func (o CpeOutput) ToCpePtrOutput() CpePtrOutput {
	return o.ToCpePtrOutputWithContext(context.Background())
}

func (o CpeOutput) ToCpePtrOutputWithContext(ctx context.Context) CpePtrOutput {
	return o.ApplyT(func(v Cpe) *Cpe {
		return &v
	}).(CpePtrOutput)
}

type CpePtrOutput struct {
	*pulumi.OutputState
}

func (CpePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Cpe)(nil))
}

func (o CpePtrOutput) ToCpePtrOutput() CpePtrOutput {
	return o
}

func (o CpePtrOutput) ToCpePtrOutputWithContext(ctx context.Context) CpePtrOutput {
	return o
}
...
func (CpeMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Cpe)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(CpePtrOutput{})
