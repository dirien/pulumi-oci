...
func (i *VolumeGroup) ToVolumeGroupPtrOutput() VolumeGroupPtrOutput {
	return i.ToVolumeGroupPtrOutputWithContext(context.Background())
}

func (i *VolumeGroup) ToVolumeGroupPtrOutputWithContext(ctx context.Context) VolumeGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeGroupPtrOutput)
}

type VolumeGroupPtrInput interface {
	pulumi.Input

	ToVolumeGroupPtrOutput() VolumeGroupPtrOutput
	ToVolumeGroupPtrOutputWithContext(ctx context.Context) VolumeGroupPtrOutput
}

type volumeGroupPtrType VolumeGroupArgs

func (*volumeGroupPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeGroup)(nil))
}

func (i *volumeGroupPtrType) ToVolumeGroupPtrOutput() VolumeGroupPtrOutput {
	return i.ToVolumeGroupPtrOutputWithContext(context.Background())
}

func (i *volumeGroupPtrType) ToVolumeGroupPtrOutputWithContext(ctx context.Context) VolumeGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeGroupPtrOutput)
}
...
func (o VolumeGroupOutput) ToVolumeGroupPtrOutput() VolumeGroupPtrOutput {
	return o.ToVolumeGroupPtrOutputWithContext(context.Background())
}

func (o VolumeGroupOutput) ToVolumeGroupPtrOutputWithContext(ctx context.Context) VolumeGroupPtrOutput {
	return o.ApplyT(func(v VolumeGroup) *VolumeGroup {
		return &v
	}).(VolumeGroupPtrOutput)
}

type VolumeGroupPtrOutput struct {
	*pulumi.OutputState
}

func (VolumeGroupPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeGroup)(nil))
}

func (o VolumeGroupPtrOutput) ToVolumeGroupPtrOutput() VolumeGroupPtrOutput {
	return o
}

func (o VolumeGroupPtrOutput) ToVolumeGroupPtrOutputWithContext(ctx context.Context) VolumeGroupPtrOutput {
	return o
}
...
func (VolumeGroupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]VolumeGroup)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(VolumeGroupPtrOutput{})
