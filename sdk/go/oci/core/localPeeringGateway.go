...
func (*LocalPeeringGateway) ElementType() reflect.Type {
	return reflect.TypeOf((*LocalPeeringGateway)(nil))
}
...
func (i *LocalPeeringGateway) ToLocalPeeringGatewayPtrOutput() LocalPeeringGatewayPtrOutput {
	return i.ToLocalPeeringGatewayPtrOutputWithContext(context.Background())
}

func (i *LocalPeeringGateway) ToLocalPeeringGatewayPtrOutputWithContext(ctx context.Context) LocalPeeringGatewayPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LocalPeeringGatewayPtrOutput)
}

type LocalPeeringGatewayPtrInput interface {
	pulumi.Input

	ToLocalPeeringGatewayPtrOutput() LocalPeeringGatewayPtrOutput
	ToLocalPeeringGatewayPtrOutputWithContext(ctx context.Context) LocalPeeringGatewayPtrOutput
}

type localPeeringGatewayPtrType LocalPeeringGatewayArgs

func (*localPeeringGatewayPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**LocalPeeringGateway)(nil))
}

func (i *localPeeringGatewayPtrType) ToLocalPeeringGatewayPtrOutput() LocalPeeringGatewayPtrOutput {
	return i.ToLocalPeeringGatewayPtrOutputWithContext(context.Background())
}

func (i *localPeeringGatewayPtrType) ToLocalPeeringGatewayPtrOutputWithContext(ctx context.Context) LocalPeeringGatewayPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LocalPeeringGatewayPtrOutput)
}
...
type LocalPeeringGatewayOutput struct {
	*pulumi.OutputState
}
...
func (o LocalPeeringGatewayOutput) ToLocalPeeringGatewayPtrOutput() LocalPeeringGatewayPtrOutput {
	return o.ToLocalPeeringGatewayPtrOutputWithContext(context.Background())
}

func (o LocalPeeringGatewayOutput) ToLocalPeeringGatewayPtrOutputWithContext(ctx context.Context) LocalPeeringGatewayPtrOutput {
	return o.ApplyT(func(v LocalPeeringGateway) *LocalPeeringGateway {
		return &v
	}).(LocalPeeringGatewayPtrOutput)
}

type LocalPeeringGatewayPtrOutput struct {
	*pulumi.OutputState
}

func (LocalPeeringGatewayPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**LocalPeeringGateway)(nil))
}

func (o LocalPeeringGatewayPtrOutput) ToLocalPeeringGatewayPtrOutput() LocalPeeringGatewayPtrOutput {
	return o
}

func (o LocalPeeringGatewayPtrOutput) ToLocalPeeringGatewayPtrOutputWithContext(ctx context.Context) LocalPeeringGatewayPtrOutput {
	return o
}
...
func (LocalPeeringGatewayMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]LocalPeeringGateway)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(LocalPeeringGatewayPtrOutput{})
