...
// 		_, err := core.LookupInstanceConfiguration(ctx, &core.LookupInstanceConfigurationArgs{
...
type LookupInstanceConfigurationResult struct {
	...
	Id                      string                                  `pulumi:"id"`
	InstanceConfigurationId string                                  `pulumi:"instanceConfigurationId"`
	InstanceDetails         GetInstanceConfigurationInstanceDetails `pulumi:"instanceDetails"`
