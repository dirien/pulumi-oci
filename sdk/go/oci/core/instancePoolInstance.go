...
func (*InstancePoolInstance) ElementType() reflect.Type {
	return reflect.TypeOf((*InstancePoolInstance)(nil))
}
...
func (i *InstancePoolInstance) ToInstancePoolInstancePtrOutput() InstancePoolInstancePtrOutput {
	return i.ToInstancePoolInstancePtrOutputWithContext(context.Background())
}

func (i *InstancePoolInstance) ToInstancePoolInstancePtrOutputWithContext(ctx context.Context) InstancePoolInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstancePoolInstancePtrOutput)
}

type InstancePoolInstancePtrInput interface {
	pulumi.Input

	ToInstancePoolInstancePtrOutput() InstancePoolInstancePtrOutput
	ToInstancePoolInstancePtrOutputWithContext(ctx context.Context) InstancePoolInstancePtrOutput
}

type instancePoolInstancePtrType InstancePoolInstanceArgs

func (*instancePoolInstancePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**InstancePoolInstance)(nil))
}

func (i *instancePoolInstancePtrType) ToInstancePoolInstancePtrOutput() InstancePoolInstancePtrOutput {
	return i.ToInstancePoolInstancePtrOutputWithContext(context.Background())
}

func (i *instancePoolInstancePtrType) ToInstancePoolInstancePtrOutputWithContext(ctx context.Context) InstancePoolInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstancePoolInstancePtrOutput)
}
...
type InstancePoolInstanceOutput struct {
	*pulumi.OutputState
}
...
func (o InstancePoolInstanceOutput) ToInstancePoolInstancePtrOutput() InstancePoolInstancePtrOutput {
	return o.ToInstancePoolInstancePtrOutputWithContext(context.Background())
}

func (o InstancePoolInstanceOutput) ToInstancePoolInstancePtrOutputWithContext(ctx context.Context) InstancePoolInstancePtrOutput {
	return o.ApplyT(func(v InstancePoolInstance) *InstancePoolInstance {
		return &v
	}).(InstancePoolInstancePtrOutput)
}

type InstancePoolInstancePtrOutput struct {
	*pulumi.OutputState
}

func (InstancePoolInstancePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InstancePoolInstance)(nil))
}

func (o InstancePoolInstancePtrOutput) ToInstancePoolInstancePtrOutput() InstancePoolInstancePtrOutput {
	return o
}

func (o InstancePoolInstancePtrOutput) ToInstancePoolInstancePtrOutputWithContext(ctx context.Context) InstancePoolInstancePtrOutput {
	return o
}
...
func (InstancePoolInstanceMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InstancePoolInstance)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(InstancePoolInstancePtrOutput{})
