...
func (*Ipv6) ElementType() reflect.Type {
	return reflect.TypeOf((*Ipv6)(nil))
}
...
func (i *Ipv6) ToIpv6PtrOutput() Ipv6PtrOutput {
	return i.ToIpv6PtrOutputWithContext(context.Background())
}

func (i *Ipv6) ToIpv6PtrOutputWithContext(ctx context.Context) Ipv6PtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Ipv6PtrOutput)
}

type Ipv6PtrInput interface {
	pulumi.Input

	ToIpv6PtrOutput() Ipv6PtrOutput
	ToIpv6PtrOutputWithContext(ctx context.Context) Ipv6PtrOutput
}

type ipv6PtrType Ipv6Args

func (*ipv6PtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Ipv6)(nil))
}

func (i *ipv6PtrType) ToIpv6PtrOutput() Ipv6PtrOutput {
	return i.ToIpv6PtrOutputWithContext(context.Background())
}

func (i *ipv6PtrType) ToIpv6PtrOutputWithContext(ctx context.Context) Ipv6PtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Ipv6PtrOutput)
}
...
func (o Ipv6Output) ToIpv6PtrOutput() Ipv6PtrOutput {
	return o.ToIpv6PtrOutputWithContext(context.Background())
}

func (o Ipv6Output) ToIpv6PtrOutputWithContext(ctx context.Context) Ipv6PtrOutput {
	return o.ApplyT(func(v Ipv6) *Ipv6 {
		return &v
	}).(Ipv6PtrOutput)
}

type Ipv6PtrOutput struct {
	*pulumi.OutputState
}

func (Ipv6PtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Ipv6)(nil))
}

func (o Ipv6PtrOutput) ToIpv6PtrOutput() Ipv6PtrOutput {
	return o
}

func (o Ipv6PtrOutput) ToIpv6PtrOutputWithContext(ctx context.Context) Ipv6PtrOutput {
	return o
}
...
func (Ipv6MapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Ipv6)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(Ipv6PtrOutput{})
