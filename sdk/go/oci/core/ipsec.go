...
func (*Ipsec) ElementType() reflect.Type {
	return reflect.TypeOf((*Ipsec)(nil))
}
...
func (i *Ipsec) ToIpsecPtrOutput() IpsecPtrOutput {
	return i.ToIpsecPtrOutputWithContext(context.Background())
}

func (i *Ipsec) ToIpsecPtrOutputWithContext(ctx context.Context) IpsecPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IpsecPtrOutput)
}

type IpsecPtrInput interface {
	pulumi.Input

	ToIpsecPtrOutput() IpsecPtrOutput
	ToIpsecPtrOutputWithContext(ctx context.Context) IpsecPtrOutput
}

type ipsecPtrType IpsecArgs

func (*ipsecPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Ipsec)(nil))
}

func (i *ipsecPtrType) ToIpsecPtrOutput() IpsecPtrOutput {
	return i.ToIpsecPtrOutputWithContext(context.Background())
}

func (i *ipsecPtrType) ToIpsecPtrOutputWithContext(ctx context.Context) IpsecPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(IpsecPtrOutput)
}
...
func (o IpsecOutput) ToIpsecPtrOutput() IpsecPtrOutput {
	return o.ToIpsecPtrOutputWithContext(context.Background())
}

func (o IpsecOutput) ToIpsecPtrOutputWithContext(ctx context.Context) IpsecPtrOutput {
	return o.ApplyT(func(v Ipsec) *Ipsec {
		return &v
	}).(IpsecPtrOutput)
}

type IpsecPtrOutput struct {
	*pulumi.OutputState
}

func (IpsecPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Ipsec)(nil))
}

func (o IpsecPtrOutput) ToIpsecPtrOutput() IpsecPtrOutput {
	return o
}

func (o IpsecPtrOutput) ToIpsecPtrOutputWithContext(ctx context.Context) IpsecPtrOutput {
	return o
}
...
func (IpsecMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Ipsec)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(IpsecPtrOutput{})
