...
func (*PrivateIp) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateIp)(nil))
}
...
func (i *PrivateIp) ToPrivateIpPtrOutput() PrivateIpPtrOutput {
	return i.ToPrivateIpPtrOutputWithContext(context.Background())
}

func (i *PrivateIp) ToPrivateIpPtrOutputWithContext(ctx context.Context) PrivateIpPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateIpPtrOutput)
}

type PrivateIpPtrInput interface {
	pulumi.Input

	ToPrivateIpPtrOutput() PrivateIpPtrOutput
	ToPrivateIpPtrOutputWithContext(ctx context.Context) PrivateIpPtrOutput
}

type privateIpPtrType PrivateIpArgs

func (*privateIpPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateIp)(nil))
}

func (i *privateIpPtrType) ToPrivateIpPtrOutput() PrivateIpPtrOutput {
	return i.ToPrivateIpPtrOutputWithContext(context.Background())
}

func (i *privateIpPtrType) ToPrivateIpPtrOutputWithContext(ctx context.Context) PrivateIpPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateIpPtrOutput)
}
...
func (o PrivateIpOutput) ToPrivateIpPtrOutput() PrivateIpPtrOutput {
	return o.ToPrivateIpPtrOutputWithContext(context.Background())
}

func (o PrivateIpOutput) ToPrivateIpPtrOutputWithContext(ctx context.Context) PrivateIpPtrOutput {
	return o.ApplyT(func(v PrivateIp) *PrivateIp {
		return &v
	}).(PrivateIpPtrOutput)
}

type PrivateIpPtrOutput struct {
	*pulumi.OutputState
}

func (PrivateIpPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PrivateIp)(nil))
}

func (o PrivateIpPtrOutput) ToPrivateIpPtrOutput() PrivateIpPtrOutput {
	return o
}

func (o PrivateIpPtrOutput) ToPrivateIpPtrOutputWithContext(ctx context.Context) PrivateIpPtrOutput {
	return o
}
...
func (PrivateIpMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]PrivateIp)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PrivateIpPtrOutput{})
