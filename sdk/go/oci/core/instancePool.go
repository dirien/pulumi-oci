...
func (i *InstancePool) ToInstancePoolPtrOutput() InstancePoolPtrOutput {
	return i.ToInstancePoolPtrOutputWithContext(context.Background())
}

func (i *InstancePool) ToInstancePoolPtrOutputWithContext(ctx context.Context) InstancePoolPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstancePoolPtrOutput)
}

type InstancePoolPtrInput interface {
	pulumi.Input

	ToInstancePoolPtrOutput() InstancePoolPtrOutput
	ToInstancePoolPtrOutputWithContext(ctx context.Context) InstancePoolPtrOutput
}

type instancePoolPtrType InstancePoolArgs

func (*instancePoolPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**InstancePool)(nil))
}

func (i *instancePoolPtrType) ToInstancePoolPtrOutput() InstancePoolPtrOutput {
	return i.ToInstancePoolPtrOutputWithContext(context.Background())
}

func (i *instancePoolPtrType) ToInstancePoolPtrOutputWithContext(ctx context.Context) InstancePoolPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstancePoolPtrOutput)
}
...
func (o InstancePoolOutput) ToInstancePoolPtrOutput() InstancePoolPtrOutput {
	return o.ToInstancePoolPtrOutputWithContext(context.Background())
}

func (o InstancePoolOutput) ToInstancePoolPtrOutputWithContext(ctx context.Context) InstancePoolPtrOutput {
	return o.ApplyT(func(v InstancePool) *InstancePool {
		return &v
	}).(InstancePoolPtrOutput)
}

type InstancePoolPtrOutput struct {
	*pulumi.OutputState
}

func (InstancePoolPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InstancePool)(nil))
}

func (o InstancePoolPtrOutput) ToInstancePoolPtrOutput() InstancePoolPtrOutput {
	return o
}

func (o InstancePoolPtrOutput) ToInstancePoolPtrOutputWithContext(ctx context.Context) InstancePoolPtrOutput {
	return o
}
...
func (InstancePoolMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InstancePool)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(InstancePoolPtrOutput{})
