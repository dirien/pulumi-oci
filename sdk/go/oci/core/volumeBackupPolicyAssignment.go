...
func (*VolumeBackupPolicyAssignment) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeBackupPolicyAssignment)(nil))
}
...
func (i *VolumeBackupPolicyAssignment) ToVolumeBackupPolicyAssignmentPtrOutput() VolumeBackupPolicyAssignmentPtrOutput {
	return i.ToVolumeBackupPolicyAssignmentPtrOutputWithContext(context.Background())
}

func (i *VolumeBackupPolicyAssignment) ToVolumeBackupPolicyAssignmentPtrOutputWithContext(ctx context.Context) VolumeBackupPolicyAssignmentPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeBackupPolicyAssignmentPtrOutput)
}

type VolumeBackupPolicyAssignmentPtrInput interface {
	pulumi.Input

	ToVolumeBackupPolicyAssignmentPtrOutput() VolumeBackupPolicyAssignmentPtrOutput
	ToVolumeBackupPolicyAssignmentPtrOutputWithContext(ctx context.Context) VolumeBackupPolicyAssignmentPtrOutput
}

type volumeBackupPolicyAssignmentPtrType VolumeBackupPolicyAssignmentArgs

func (*volumeBackupPolicyAssignmentPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeBackupPolicyAssignment)(nil))
}

func (i *volumeBackupPolicyAssignmentPtrType) ToVolumeBackupPolicyAssignmentPtrOutput() VolumeBackupPolicyAssignmentPtrOutput {
	return i.ToVolumeBackupPolicyAssignmentPtrOutputWithContext(context.Background())
}

func (i *volumeBackupPolicyAssignmentPtrType) ToVolumeBackupPolicyAssignmentPtrOutputWithContext(ctx context.Context) VolumeBackupPolicyAssignmentPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeBackupPolicyAssignmentPtrOutput)
}
...
type VolumeBackupPolicyAssignmentOutput struct {
	*pulumi.OutputState
}
...
func (o VolumeBackupPolicyAssignmentOutput) ToVolumeBackupPolicyAssignmentPtrOutput() VolumeBackupPolicyAssignmentPtrOutput {
	return o.ToVolumeBackupPolicyAssignmentPtrOutputWithContext(context.Background())
}

func (o VolumeBackupPolicyAssignmentOutput) ToVolumeBackupPolicyAssignmentPtrOutputWithContext(ctx context.Context) VolumeBackupPolicyAssignmentPtrOutput {
	return o.ApplyT(func(v VolumeBackupPolicyAssignment) *VolumeBackupPolicyAssignment {
		return &v
	}).(VolumeBackupPolicyAssignmentPtrOutput)
}

type VolumeBackupPolicyAssignmentPtrOutput struct {
	*pulumi.OutputState
}

func (VolumeBackupPolicyAssignmentPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeBackupPolicyAssignment)(nil))
}

func (o VolumeBackupPolicyAssignmentPtrOutput) ToVolumeBackupPolicyAssignmentPtrOutput() VolumeBackupPolicyAssignmentPtrOutput {
	return o
}

func (o VolumeBackupPolicyAssignmentPtrOutput) ToVolumeBackupPolicyAssignmentPtrOutputWithContext(ctx context.Context) VolumeBackupPolicyAssignmentPtrOutput {
	return o
}
...
func (VolumeBackupPolicyAssignmentMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]VolumeBackupPolicyAssignment)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(VolumeBackupPolicyAssignmentPtrOutput{})
