...
func (*VolumeGroupBackup) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeGroupBackup)(nil))
}
...
func (i *VolumeGroupBackup) ToVolumeGroupBackupPtrOutput() VolumeGroupBackupPtrOutput {
	return i.ToVolumeGroupBackupPtrOutputWithContext(context.Background())
}

func (i *VolumeGroupBackup) ToVolumeGroupBackupPtrOutputWithContext(ctx context.Context) VolumeGroupBackupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeGroupBackupPtrOutput)
}

type VolumeGroupBackupPtrInput interface {
	pulumi.Input

	ToVolumeGroupBackupPtrOutput() VolumeGroupBackupPtrOutput
	ToVolumeGroupBackupPtrOutputWithContext(ctx context.Context) VolumeGroupBackupPtrOutput
}

type volumeGroupBackupPtrType VolumeGroupBackupArgs

func (*volumeGroupBackupPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeGroupBackup)(nil))
}

func (i *volumeGroupBackupPtrType) ToVolumeGroupBackupPtrOutput() VolumeGroupBackupPtrOutput {
	return i.ToVolumeGroupBackupPtrOutputWithContext(context.Background())
}

func (i *volumeGroupBackupPtrType) ToVolumeGroupBackupPtrOutputWithContext(ctx context.Context) VolumeGroupBackupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeGroupBackupPtrOutput)
}
...
type VolumeGroupBackupOutput struct {
	*pulumi.OutputState
}
...
func (o VolumeGroupBackupOutput) ToVolumeGroupBackupPtrOutput() VolumeGroupBackupPtrOutput {
	return o.ToVolumeGroupBackupPtrOutputWithContext(context.Background())
}

func (o VolumeGroupBackupOutput) ToVolumeGroupBackupPtrOutputWithContext(ctx context.Context) VolumeGroupBackupPtrOutput {
	return o.ApplyT(func(v VolumeGroupBackup) *VolumeGroupBackup {
		return &v
	}).(VolumeGroupBackupPtrOutput)
}

type VolumeGroupBackupPtrOutput struct {
	*pulumi.OutputState
}

func (VolumeGroupBackupPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeGroupBackup)(nil))
}

func (o VolumeGroupBackupPtrOutput) ToVolumeGroupBackupPtrOutput() VolumeGroupBackupPtrOutput {
	return o
}

func (o VolumeGroupBackupPtrOutput) ToVolumeGroupBackupPtrOutputWithContext(ctx context.Context) VolumeGroupBackupPtrOutput {
	return o
}
...
func (VolumeGroupBackupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]VolumeGroupBackup)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(VolumeGroupBackupPtrOutput{})
