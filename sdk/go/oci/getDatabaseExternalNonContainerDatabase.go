...
// 		_, err := oci.GetDatabaseExternalNonContainerDatabase(ctx, &GetDatabaseExternalNonContainerDatabaseArgs{
...
// }
// ```
func LookupDatabaseExternalNonContainerDatabase(ctx *pulumi.Context, args *LookupDatabaseExternalNonContainerDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseExternalNonContainerDatabaseResult, error) {
	var rv LookupDatabaseExternalNonContainerDatabaseResult
	err := ctx.Invoke("oci:index/getDatabaseExternalNonContainerDatabase:GetDatabaseExternalNonContainerDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatabaseExternalNonContainerDatabaseArgs struct {
...
type LookupDatabaseExternalNonContainerDatabaseResult struct {
	...
	DatabaseManagementConfig GetDatabaseExternalNonContainerDatabaseDatabaseManagementConfig `pulumi:"databaseManagementConfig"`
	...
	OperationsInsightsConfig GetDatabaseExternalNonContainerDatabaseOperationsInsightsConfig `pulumi:"operationsInsightsConfig"`
