...
// 		_, err := oci.GetIdentityUsers(ctx, &GetIdentityUsersArgs{
...
func GetIdentityUsers(ctx *pulumi.Context, args *GetIdentityUsersArgs, opts ...pulumi.InvokeOption) (*GetIdentityUsersResult, error) {
	...
	err := ctx.Invoke("oci:index/getIdentityUsers:GetIdentityUsers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetIdentityUsersArgs struct {
	...
	Filters            []GetIdentityUsersFilter `pulumi:"filters"`
