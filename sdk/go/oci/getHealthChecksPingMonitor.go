...
// 		_, err := oci.GetHealthChecksPingMonitor(ctx, &GetHealthChecksPingMonitorArgs{
...
// }
// ```
func LookupHealthChecksPingMonitor(ctx *pulumi.Context, args *LookupHealthChecksPingMonitorArgs, opts ...pulumi.InvokeOption) (*LookupHealthChecksPingMonitorResult, error) {
	var rv LookupHealthChecksPingMonitorResult
	err := ctx.Invoke("oci:index/getHealthChecksPingMonitor:GetHealthChecksPingMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupHealthChecksPingMonitorArgs struct {
	// The OCID of a monitor.
	MonitorId string `pulumi:"monitorId"`
}

// A collection of values returned by GetHealthChecksPingMonitor.
type LookupHealthChecksPingMonitorResult struct {
