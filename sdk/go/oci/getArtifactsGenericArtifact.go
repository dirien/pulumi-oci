...
// 		_, err := oci.GetArtifactsGenericArtifact(ctx, &GetArtifactsGenericArtifactArgs{
...
// }
// ```
func LookupArtifactsGenericArtifact(ctx *pulumi.Context, args *LookupArtifactsGenericArtifactArgs, opts ...pulumi.InvokeOption) (*LookupArtifactsGenericArtifactResult, error) {
	var rv LookupArtifactsGenericArtifactResult
	err := ctx.Invoke("oci:index/getArtifactsGenericArtifact:GetArtifactsGenericArtifact", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupArtifactsGenericArtifactArgs struct {
...
type LookupArtifactsGenericArtifactResult struct {
	ArtifactId string `pulumi:"artifactId"`
