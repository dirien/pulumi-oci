...
// 		_, err := oci.GetDatascienceProject(ctx, &GetDatascienceProjectArgs{
...
// }
// ```
func LookupDatascienceProject(ctx *pulumi.Context, args *LookupDatascienceProjectArgs, opts ...pulumi.InvokeOption) (*LookupDatascienceProjectResult, error) {
	var rv LookupDatascienceProjectResult
	err := ctx.Invoke("oci:index/getDatascienceProject:GetDatascienceProject", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatascienceProjectArgs struct {
...
type LookupDatascienceProjectResult struct {
