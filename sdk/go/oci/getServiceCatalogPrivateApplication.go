...
// 		_, err := oci.GetServiceCatalogPrivateApplication(ctx, &GetServiceCatalogPrivateApplicationArgs{
...
// }
// ```
func LookupServiceCatalogPrivateApplication(ctx *pulumi.Context, args *LookupServiceCatalogPrivateApplicationArgs, opts ...pulumi.InvokeOption) (*LookupServiceCatalogPrivateApplicationResult, error) {
	var rv LookupServiceCatalogPrivateApplicationResult
	err := ctx.Invoke("oci:index/getServiceCatalogPrivateApplication:GetServiceCatalogPrivateApplication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupServiceCatalogPrivateApplicationArgs struct {
...
type LookupServiceCatalogPrivateApplicationResult struct {
	...
	Logo                  GetServiceCatalogPrivateApplicationLogo `pulumi:"logo"`
	LogoFileBase64encoded string                                  `pulumi:"logoFileBase64encoded"`
	// A long description of the private application.
	LongDescription string                                            `pulumi:"longDescription"`
	PackageDetails  GetServiceCatalogPrivateApplicationPackageDetails `pulumi:"packageDetails"`
