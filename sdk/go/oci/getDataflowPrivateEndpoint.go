...
// 		_, err := oci.GetDataflowPrivateEndpoint(ctx, &GetDataflowPrivateEndpointArgs{
...
// }
// ```
func LookupDataflowPrivateEndpoint(ctx *pulumi.Context, args *LookupDataflowPrivateEndpointArgs, opts ...pulumi.InvokeOption) (*LookupDataflowPrivateEndpointResult, error) {
	var rv LookupDataflowPrivateEndpointResult
	err := ctx.Invoke("oci:index/getDataflowPrivateEndpoint:GetDataflowPrivateEndpoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
