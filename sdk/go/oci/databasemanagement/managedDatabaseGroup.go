...
func (*ManagedDatabaseGroup) ElementType() reflect.Type {
	return reflect.TypeOf((*ManagedDatabaseGroup)(nil))
}
...
func (i *ManagedDatabaseGroup) ToManagedDatabaseGroupPtrOutput() ManagedDatabaseGroupPtrOutput {
	return i.ToManagedDatabaseGroupPtrOutputWithContext(context.Background())
}

func (i *ManagedDatabaseGroup) ToManagedDatabaseGroupPtrOutputWithContext(ctx context.Context) ManagedDatabaseGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ManagedDatabaseGroupPtrOutput)
}

type ManagedDatabaseGroupPtrInput interface {
	pulumi.Input

	ToManagedDatabaseGroupPtrOutput() ManagedDatabaseGroupPtrOutput
	ToManagedDatabaseGroupPtrOutputWithContext(ctx context.Context) ManagedDatabaseGroupPtrOutput
}

type managedDatabaseGroupPtrType ManagedDatabaseGroupArgs

func (*managedDatabaseGroupPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ManagedDatabaseGroup)(nil))
}

func (i *managedDatabaseGroupPtrType) ToManagedDatabaseGroupPtrOutput() ManagedDatabaseGroupPtrOutput {
	return i.ToManagedDatabaseGroupPtrOutputWithContext(context.Background())
}

func (i *managedDatabaseGroupPtrType) ToManagedDatabaseGroupPtrOutputWithContext(ctx context.Context) ManagedDatabaseGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ManagedDatabaseGroupPtrOutput)
}
...
type ManagedDatabaseGroupOutput struct {
	*pulumi.OutputState
}
...
func (o ManagedDatabaseGroupOutput) ToManagedDatabaseGroupPtrOutput() ManagedDatabaseGroupPtrOutput {
	return o.ToManagedDatabaseGroupPtrOutputWithContext(context.Background())
}

func (o ManagedDatabaseGroupOutput) ToManagedDatabaseGroupPtrOutputWithContext(ctx context.Context) ManagedDatabaseGroupPtrOutput {
	return o.ApplyT(func(v ManagedDatabaseGroup) *ManagedDatabaseGroup {
		return &v
	}).(ManagedDatabaseGroupPtrOutput)
}

type ManagedDatabaseGroupPtrOutput struct {
	*pulumi.OutputState
}

func (ManagedDatabaseGroupPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ManagedDatabaseGroup)(nil))
}

func (o ManagedDatabaseGroupPtrOutput) ToManagedDatabaseGroupPtrOutput() ManagedDatabaseGroupPtrOutput {
	return o
}

func (o ManagedDatabaseGroupPtrOutput) ToManagedDatabaseGroupPtrOutputWithContext(ctx context.Context) ManagedDatabaseGroupPtrOutput {
	return o
}
...
func (ManagedDatabaseGroupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ManagedDatabaseGroup)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ManagedDatabaseGroupPtrOutput{})
