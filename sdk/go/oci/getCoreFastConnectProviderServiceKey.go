...
// 		_, err := oci.GetCoreFastConnectProviderServiceKey(ctx, &GetCoreFastConnectProviderServiceKeyArgs{
...
// }
// ```
func GetCoreFastConnectProviderServiceKey(ctx *pulumi.Context, args *GetCoreFastConnectProviderServiceKeyArgs, opts ...pulumi.InvokeOption) (*GetCoreFastConnectProviderServiceKeyResult, error) {
	var rv GetCoreFastConnectProviderServiceKeyResult
	err := ctx.Invoke("oci:index/getCoreFastConnectProviderServiceKey:GetCoreFastConnectProviderServiceKey", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCoreFastConnectProviderServiceKeyArgs struct {
...
type GetCoreFastConnectProviderServiceKeyResult struct {
