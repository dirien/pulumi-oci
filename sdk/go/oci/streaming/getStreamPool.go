...
// 		_, err := streaming.LookupStreamPool(ctx, &streaming.LookupStreamPoolArgs{
...
type LookupStreamPoolResult struct {
	...
	CustomEncryptionKey GetStreamPoolCustomEncryptionKey `pulumi:"customEncryptionKey"`
	...
	KafkaSettings GetStreamPoolKafkaSettings `pulumi:"kafkaSettings"`
	...
	PrivateEndpointSettings GetStreamPoolPrivateEndpointSettings `pulumi:"privateEndpointSettings"`
