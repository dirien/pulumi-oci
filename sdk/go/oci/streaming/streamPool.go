...
func (*StreamPool) ElementType() reflect.Type {
	return reflect.TypeOf((*StreamPool)(nil))
}
...
func (i *StreamPool) ToStreamPoolPtrOutput() StreamPoolPtrOutput {
	return i.ToStreamPoolPtrOutputWithContext(context.Background())
}

func (i *StreamPool) ToStreamPoolPtrOutputWithContext(ctx context.Context) StreamPoolPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StreamPoolPtrOutput)
}

type StreamPoolPtrInput interface {
	pulumi.Input

	ToStreamPoolPtrOutput() StreamPoolPtrOutput
	ToStreamPoolPtrOutputWithContext(ctx context.Context) StreamPoolPtrOutput
}

type streamPoolPtrType StreamPoolArgs

func (*streamPoolPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**StreamPool)(nil))
}

func (i *streamPoolPtrType) ToStreamPoolPtrOutput() StreamPoolPtrOutput {
	return i.ToStreamPoolPtrOutputWithContext(context.Background())
}

func (i *streamPoolPtrType) ToStreamPoolPtrOutputWithContext(ctx context.Context) StreamPoolPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StreamPoolPtrOutput)
}
...
func (o StreamPoolOutput) ToStreamPoolPtrOutput() StreamPoolPtrOutput {
	return o.ToStreamPoolPtrOutputWithContext(context.Background())
}

func (o StreamPoolOutput) ToStreamPoolPtrOutputWithContext(ctx context.Context) StreamPoolPtrOutput {
	return o.ApplyT(func(v StreamPool) *StreamPool {
		return &v
	}).(StreamPoolPtrOutput)
}

type StreamPoolPtrOutput struct {
	*pulumi.OutputState
}

func (StreamPoolPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StreamPool)(nil))
}

func (o StreamPoolPtrOutput) ToStreamPoolPtrOutput() StreamPoolPtrOutput {
	return o
}

func (o StreamPoolPtrOutput) ToStreamPoolPtrOutputWithContext(ctx context.Context) StreamPoolPtrOutput {
	return o
}
...
func (StreamPoolMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]StreamPool)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(StreamPoolPtrOutput{})
