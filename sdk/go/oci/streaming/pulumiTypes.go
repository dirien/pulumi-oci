...
func (o StreamPoolCustomEncryptionKeyPtrOutput) Elem() StreamPoolCustomEncryptionKeyOutput {
	return o.ApplyT(func(v *StreamPoolCustomEncryptionKey) StreamPoolCustomEncryptionKey { return *v }).(StreamPoolCustomEncryptionKeyOutput)
}
...
func (o StreamPoolKafkaSettingsPtrOutput) Elem() StreamPoolKafkaSettingsOutput {
	return o.ApplyT(func(v *StreamPoolKafkaSettings) StreamPoolKafkaSettings { return *v }).(StreamPoolKafkaSettingsOutput)
}
...
func (o StreamPoolPrivateEndpointSettingsPtrOutput) Elem() StreamPoolPrivateEndpointSettingsOutput {
	return o.ApplyT(func(v *StreamPoolPrivateEndpointSettings) StreamPoolPrivateEndpointSettings { return *v }).(StreamPoolPrivateEndpointSettingsOutput)
}
...
type GetStreamPoolKafkaSettings struct {
...
// GetStreamPoolKafkaSettingsInput is an input type that accepts GetStreamPoolKafkaSettingsArgs and GetStreamPoolKafkaSettingsOutput values.
// You can construct a concrete instance of `GetStreamPoolKafkaSettingsInput` via:
//
//          GetStreamPoolKafkaSettingsArgs{...}
type GetStreamPoolKafkaSettingsInput interface {
	pulumi.Input

	ToGetStreamPoolKafkaSettingsOutput() GetStreamPoolKafkaSettingsOutput
	ToGetStreamPoolKafkaSettingsOutputWithContext(context.Context) GetStreamPoolKafkaSettingsOutput
}

type GetStreamPoolKafkaSettingsArgs struct {
	// Enable auto creation of topic on the server.
...
func (GetStreamPoolKafkaSettingsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolKafkaSettings)(nil)).Elem()
}

func (i GetStreamPoolKafkaSettingsArgs) ToGetStreamPoolKafkaSettingsOutput() GetStreamPoolKafkaSettingsOutput {
	return i.ToGetStreamPoolKafkaSettingsOutputWithContext(context.Background())
}

func (i GetStreamPoolKafkaSettingsArgs) ToGetStreamPoolKafkaSettingsOutputWithContext(ctx context.Context) GetStreamPoolKafkaSettingsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetStreamPoolKafkaSettingsOutput)
}

type GetStreamPoolKafkaSettingsOutput struct{ *pulumi.OutputState }

func (GetStreamPoolKafkaSettingsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolKafkaSettings)(nil)).Elem()
}

func (o GetStreamPoolKafkaSettingsOutput) ToGetStreamPoolKafkaSettingsOutput() GetStreamPoolKafkaSettingsOutput {
	return o
}

func (o GetStreamPoolKafkaSettingsOutput) ToGetStreamPoolKafkaSettingsOutputWithContext(ctx context.Context) GetStreamPoolKafkaSettingsOutput {
	return o
}

// Enable auto creation of topic on the server.
func (o GetStreamPoolKafkaSettingsOutput) AutoCreateTopicsEnable() pulumi.BoolOutput {
	return o.ApplyT(func(v GetStreamPoolKafkaSettings) bool { return v.AutoCreateTopicsEnable }).(pulumi.BoolOutput)
}

// Bootstrap servers.
func (o GetStreamPoolKafkaSettingsOutput) BootstrapServers() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolKafkaSettings) string { return v.BootstrapServers }).(pulumi.StringOutput)
}

// The number of hours to keep a log file before deleting it (in hours).
func (o GetStreamPoolKafkaSettingsOutput) LogRetentionHours() pulumi.IntOutput {
	return o.ApplyT(func(v GetStreamPoolKafkaSettings) int { return v.LogRetentionHours }).(pulumi.IntOutput)
}

// The default number of log partitions per topic.
func (o GetStreamPoolKafkaSettingsOutput) NumPartitions() pulumi.IntOutput {
	return o.ApplyT(func(v GetStreamPoolKafkaSettings) int { return v.NumPartitions }).(pulumi.IntOutput)
}

type GetStreamPoolPrivateEndpointSettings struct {
...
// GetStreamPoolPrivateEndpointSettingsInput is an input type that accepts GetStreamPoolPrivateEndpointSettingsArgs and GetStreamPoolPrivateEndpointSettingsOutput values.
// You can construct a concrete instance of `GetStreamPoolPrivateEndpointSettingsInput` via:
//
//          GetStreamPoolPrivateEndpointSettingsArgs{...}
type GetStreamPoolPrivateEndpointSettingsInput interface {
	pulumi.Input

	ToGetStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolPrivateEndpointSettingsOutput
	ToGetStreamPoolPrivateEndpointSettingsOutputWithContext(context.Context) GetStreamPoolPrivateEndpointSettingsOutput
}

type GetStreamPoolPrivateEndpointSettingsArgs struct {
	// The optional list of network security groups that are associated with the private endpoint of the stream pool.
	NsgIds pulumi.StringArrayInput `pulumi:"nsgIds"`
	// The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
...
func (GetStreamPoolPrivateEndpointSettingsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolPrivateEndpointSettings)(nil)).Elem()
}

func (i GetStreamPoolPrivateEndpointSettingsArgs) ToGetStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolPrivateEndpointSettingsOutput {
	return i.ToGetStreamPoolPrivateEndpointSettingsOutputWithContext(context.Background())
}

func (i GetStreamPoolPrivateEndpointSettingsArgs) ToGetStreamPoolPrivateEndpointSettingsOutputWithContext(ctx context.Context) GetStreamPoolPrivateEndpointSettingsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetStreamPoolPrivateEndpointSettingsOutput)
}

type GetStreamPoolPrivateEndpointSettingsOutput struct{ *pulumi.OutputState }

func (GetStreamPoolPrivateEndpointSettingsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolPrivateEndpointSettings)(nil)).Elem()
}

func (o GetStreamPoolPrivateEndpointSettingsOutput) ToGetStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolPrivateEndpointSettingsOutput {
	return o
}

func (o GetStreamPoolPrivateEndpointSettingsOutput) ToGetStreamPoolPrivateEndpointSettingsOutputWithContext(ctx context.Context) GetStreamPoolPrivateEndpointSettingsOutput {
	return o
}

// The optional list of network security groups that are associated with the private endpoint of the stream pool.
func (o GetStreamPoolPrivateEndpointSettingsOutput) NsgIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetStreamPoolPrivateEndpointSettings) []string { return v.NsgIds }).(pulumi.StringArrayOutput)
}

// The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
func (o GetStreamPoolPrivateEndpointSettingsOutput) PrivateEndpointIp() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolPrivateEndpointSettings) string { return v.PrivateEndpointIp }).(pulumi.StringOutput)
}

// The subnet id from which the private stream pool can be accessed. Trying to access the streams from another network location will result in an error.
func (o GetStreamPoolPrivateEndpointSettingsOutput) SubnetId() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolPrivateEndpointSettings) string { return v.SubnetId }).(pulumi.StringOutput)
}
...
type GetStreamPoolsStreamPool struct {
	...
	CustomEncryptionKey GetStreamPoolsStreamPoolCustomEncryptionKey `pulumi:"customEncryptionKey"`
	// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations": {"CostCenter": "42"}}'
	DefinedTags map[string]interface{} `pulumi:"definedTags"`
	...
	KafkaSettings GetStreamPoolsStreamPoolKafkaSettings `pulumi:"kafkaSettings"`
	// Any additional details about the current state of the stream.
	LifecycleStateDetails string `pulumi:"lifecycleStateDetails"`
	// A filter to return only resources that match the given name exactly.
	Name string `pulumi:"name"`
	// Optional settings if the stream pool is private.
	PrivateEndpointSettings GetStreamPoolsStreamPoolPrivateEndpointSettings `pulumi:"privateEndpointSettings"`
	// A filter to only return resources that match the given lifecycle state. The state value is case-insensitive.
	State string `pulumi:"state"`
...
type GetStreamPoolsStreamPoolArgs struct {
	...
	CompartmentId pulumi.StringInput `pulumi:"compartmentId"`
	// Custom Encryption Key which will be used for encryption by all the streams in the pool.
	CustomEncryptionKey GetStreamPoolsStreamPoolCustomEncryptionKeyInput `pulumi:"customEncryptionKey"`
	// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations": {"CostCenter": "42"}}'
	DefinedTags pulumi.MapInput `pulumi:"definedTags"`
	// The FQDN used to access the streams inside the stream pool (same FQDN as the messagesEndpoint attribute of a [Stream](https://docs.cloud.oracle.com/iaas/api/#/en/streaming/20180418/Stream) object). If the stream pool is private, the FQDN is customized and can only be accessed from inside the associated subnetId, otherwise the FQDN is publicly resolvable. Depending on which protocol you attempt to use, you need to either prepend https or append the Kafka port.
	...
	// Settings for the Kafka compatibility layer.
	KafkaSettings GetStreamPoolsStreamPoolKafkaSettingsInput `pulumi:"kafkaSettings"`
	// Any additional details about the current state of the stream.
	LifecycleStateDetails pulumi.StringInput `pulumi:"lifecycleStateDetails"`
	// A filter to return only resources that match the given name exactly.
	Name pulumi.StringInput `pulumi:"name"`
	// Optional settings if the stream pool is private.
	PrivateEndpointSettings GetStreamPoolsStreamPoolPrivateEndpointSettingsInput `pulumi:"privateEndpointSettings"`
	// A filter to only return resources that match the given lifecycle state. The state value is case-insensitive.
	State pulumi.StringInput `pulumi:"state"`
	// The date and time the stream pool was created, expressed in in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
	TimeCreated pulumi.StringInput `pulumi:"timeCreated"`
...
// Custom Encryption Key which will be used for encryption by all the streams in the pool.
func (o GetStreamPoolsStreamPoolOutput) CustomEncryptionKey() GetStreamPoolsStreamPoolCustomEncryptionKeyOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPool) GetStreamPoolsStreamPoolCustomEncryptionKey {
		return v.CustomEncryptionKey
...
// Settings for the Kafka compatibility layer.
func (o GetStreamPoolsStreamPoolOutput) KafkaSettings() GetStreamPoolsStreamPoolKafkaSettingsOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPool) GetStreamPoolsStreamPoolKafkaSettings { return v.KafkaSettings }).(GetStreamPoolsStreamPoolKafkaSettingsOutput)
}
...
// Optional settings if the stream pool is private.
func (o GetStreamPoolsStreamPoolOutput) PrivateEndpointSettings() GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPool) GetStreamPoolsStreamPoolPrivateEndpointSettings {
		return v.PrivateEndpointSettings
	}).(GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput)
}
...
type GetStreamPoolsStreamPoolKafkaSettings struct {
	// Enable auto creation of topic on the server.
	AutoCreateTopicsEnable bool `pulumi:"autoCreateTopicsEnable"`
	// Bootstrap servers.
	BootstrapServers string `pulumi:"bootstrapServers"`
...
// GetStreamPoolsStreamPoolKafkaSettingsInput is an input type that accepts GetStreamPoolsStreamPoolKafkaSettingsArgs and GetStreamPoolsStreamPoolKafkaSettingsOutput values.
// You can construct a concrete instance of `GetStreamPoolsStreamPoolKafkaSettingsInput` via:
//
//          GetStreamPoolsStreamPoolKafkaSettingsArgs{...}
type GetStreamPoolsStreamPoolKafkaSettingsInput interface {
	pulumi.Input

	ToGetStreamPoolsStreamPoolKafkaSettingsOutput() GetStreamPoolsStreamPoolKafkaSettingsOutput
	ToGetStreamPoolsStreamPoolKafkaSettingsOutputWithContext(context.Context) GetStreamPoolsStreamPoolKafkaSettingsOutput
}

type GetStreamPoolsStreamPoolKafkaSettingsArgs struct {
	// Enable auto creation of topic on the server.
	AutoCreateTopicsEnable pulumi.BoolInput `pulumi:"autoCreateTopicsEnable"`
	// Bootstrap servers.
	BootstrapServers pulumi.StringInput `pulumi:"bootstrapServers"`
...
func (GetStreamPoolsStreamPoolKafkaSettingsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolsStreamPoolKafkaSettings)(nil)).Elem()
}

func (i GetStreamPoolsStreamPoolKafkaSettingsArgs) ToGetStreamPoolsStreamPoolKafkaSettingsOutput() GetStreamPoolsStreamPoolKafkaSettingsOutput {
	return i.ToGetStreamPoolsStreamPoolKafkaSettingsOutputWithContext(context.Background())
}

func (i GetStreamPoolsStreamPoolKafkaSettingsArgs) ToGetStreamPoolsStreamPoolKafkaSettingsOutputWithContext(ctx context.Context) GetStreamPoolsStreamPoolKafkaSettingsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetStreamPoolsStreamPoolKafkaSettingsOutput)
}

type GetStreamPoolsStreamPoolKafkaSettingsOutput struct{ *pulumi.OutputState }

func (GetStreamPoolsStreamPoolKafkaSettingsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolsStreamPoolKafkaSettings)(nil)).Elem()
}

func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) ToGetStreamPoolsStreamPoolKafkaSettingsOutput() GetStreamPoolsStreamPoolKafkaSettingsOutput {
	return o
}

func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) ToGetStreamPoolsStreamPoolKafkaSettingsOutputWithContext(ctx context.Context) GetStreamPoolsStreamPoolKafkaSettingsOutput {
	return o
}

// Enable auto creation of topic on the server.
func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) AutoCreateTopicsEnable() pulumi.BoolOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolKafkaSettings) bool { return v.AutoCreateTopicsEnable }).(pulumi.BoolOutput)
}

// Bootstrap servers.
func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) BootstrapServers() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolKafkaSettings) string { return v.BootstrapServers }).(pulumi.StringOutput)
}

// The number of hours to keep a log file before deleting it (in hours).
func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) LogRetentionHours() pulumi.IntOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolKafkaSettings) int { return v.LogRetentionHours }).(pulumi.IntOutput)
}

// The default number of log partitions per topic.
func (o GetStreamPoolsStreamPoolKafkaSettingsOutput) NumPartitions() pulumi.IntOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolKafkaSettings) int { return v.NumPartitions }).(pulumi.IntOutput)
}

type GetStreamPoolsStreamPoolPrivateEndpointSettings struct {
	// The optional list of network security groups that are associated with the private endpoint of the stream pool.
	NsgIds []string `pulumi:"nsgIds"`
	// The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
	PrivateEndpointIp string `pulumi:"privateEndpointIp"`
...
// GetStreamPoolsStreamPoolPrivateEndpointSettingsInput is an input type that accepts GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs and GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput values.
// You can construct a concrete instance of `GetStreamPoolsStreamPoolPrivateEndpointSettingsInput` via:
//
//          GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs{...}
type GetStreamPoolsStreamPoolPrivateEndpointSettingsInput interface {
	pulumi.Input

	ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput
	ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutputWithContext(context.Context) GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput
}

type GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs struct {
	// The optional list of network security groups that are associated with the private endpoint of the stream pool.
	NsgIds pulumi.StringArrayInput `pulumi:"nsgIds"`
	// The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
	PrivateEndpointIp pulumi.StringInput `pulumi:"privateEndpointIp"`
...
func (GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolsStreamPoolPrivateEndpointSettings)(nil)).Elem()
}

func (i GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs) ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput {
	return i.ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutputWithContext(context.Background())
}

func (i GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs) ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutputWithContext(ctx context.Context) GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput)
}

type GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput struct{ *pulumi.OutputState }

func (GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetStreamPoolsStreamPoolPrivateEndpointSettings)(nil)).Elem()
}

func (o GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutput() GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput {
	return o
}

func (o GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) ToGetStreamPoolsStreamPoolPrivateEndpointSettingsOutputWithContext(ctx context.Context) GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput {
	return o
}

// The optional list of network security groups that are associated with the private endpoint of the stream pool.
func (o GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) NsgIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolPrivateEndpointSettings) []string { return v.NsgIds }).(pulumi.StringArrayOutput)
}

// The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
func (o GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) PrivateEndpointIp() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolPrivateEndpointSettings) string { return v.PrivateEndpointIp }).(pulumi.StringOutput)
}

// The subnet id from which the private stream pool can be accessed. Trying to access the streams from another network location will result in an error.
func (o GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput) SubnetId() pulumi.StringOutput {
	return o.ApplyT(func(v GetStreamPoolsStreamPoolPrivateEndpointSettings) string { return v.SubnetId }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GetStreamPoolKafkaSettingsOutput{})
	pulumi.RegisterOutputType(GetStreamPoolPrivateEndpointSettingsOutput{})
	...
	pulumi.RegisterOutputType(GetStreamPoolsStreamPoolKafkaSettingsOutput{})
	pulumi.RegisterOutputType(GetStreamPoolsStreamPoolPrivateEndpointSettingsOutput{})
