...
// 		_, err := bds.NewBdsInstance(ctx, "testBdsInstance", &bds.BdsInstanceArgs{
...
// 			MasterNode: &bds.BdsInstanceMasterNodeArgs{
...
// 			},
// 			UtilNode: &bds.BdsInstanceUtilNodeArgs{
// 				Shape:                pulumi.Any(_var.Bds_instance_nodes_shape),
// 				SubnetId:             pulumi.Any(oci_core_subnet.Test_subnet.Id),
// 				BlockVolumeSizeInGbs: pulumi.Any(_var.Bds_instance_nodes_block_volume_size_in_gbs),
// 				NumberOfNodes:        pulumi.Any(_var.Bds_instance_number_of_nodes),
// 			},
// 			WorkerNode: &bds.BdsInstanceWorkerNodeArgs{
// 				Shape:                pulumi.Any(_var.Bds_instance_nodes_shape),
// 				SubnetId:             pulumi.Any(oci_core_subnet.Test_subnet.Id),
// 				BlockVolumeSizeInGbs: pulumi.Any(_var.Bds_instance_nodes_block_volume_size_in_gbs),
// 				NumberOfNodes:        pulumi.Any(_var.Bds_instance_number_of_nodes),
...
// 			NetworkConfig: &bds.BdsInstanceNetworkConfigArgs{
...
//
// ```sh
//  $ pulumi import oci:bds/bdsInstance:BdsInstance test_bds_instance "id"
// ```
type BdsInstance struct {
	pulumi.CustomResourceState

	// The information about added Cloud SQL capability
	CloudSqlDetails BdsInstanceCloudSqlDetailsOutput `pulumi:"cloudSqlDetails"`
	// Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
	ClusterAdminPassword pulumi.StringOutput `pulumi:"clusterAdminPassword"`
	// Specific info about a Hadoop cluster
	ClusterDetails BdsInstanceClusterDetailsOutput `pulumi:"clusterDetails"`
...
func NewBdsInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("oci:bds/bdsInstance:BdsInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBdsInstance(ctx *pulumi.Context,
	...
	var resource BdsInstance
	err := ctx.ReadResource("oci:bds/bdsInstance:BdsInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type bdsInstanceState struct {
	// The information about added Cloud SQL capability
	CloudSqlDetails *BdsInstanceCloudSqlDetails `pulumi:"cloudSqlDetails"`
	// Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
	ClusterAdminPassword *string `pulumi:"clusterAdminPassword"`
	// Specific info about a Hadoop cluster
	ClusterDetails *BdsInstanceClusterDetails `pulumi:"clusterDetails"`
	// The SSH public key used to authenticate the cluster connection.
...
type BdsInstanceState struct {
	// The information about added Cloud SQL capability
	CloudSqlDetails BdsInstanceCloudSqlDetailsPtrInput
	// Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
	ClusterAdminPassword pulumi.StringPtrInput
	// Specific info about a Hadoop cluster
	ClusterDetails BdsInstanceClusterDetailsPtrInput
	// The SSH public key used to authenticate the cluster connection.
...
func (*BdsInstance) ElementType() reflect.Type {
	return reflect.TypeOf((*BdsInstance)(nil))
}
...
func (i *BdsInstance) ToBdsInstancePtrOutput() BdsInstancePtrOutput {
	return i.ToBdsInstancePtrOutputWithContext(context.Background())
}

func (i *BdsInstance) ToBdsInstancePtrOutputWithContext(ctx context.Context) BdsInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BdsInstancePtrOutput)
}

type BdsInstancePtrInput interface {
	pulumi.Input

	ToBdsInstancePtrOutput() BdsInstancePtrOutput
	ToBdsInstancePtrOutputWithContext(ctx context.Context) BdsInstancePtrOutput
}

type bdsInstancePtrType BdsInstanceArgs

func (*bdsInstancePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**BdsInstance)(nil))
}

func (i *bdsInstancePtrType) ToBdsInstancePtrOutput() BdsInstancePtrOutput {
	return i.ToBdsInstancePtrOutputWithContext(context.Background())
}

func (i *bdsInstancePtrType) ToBdsInstancePtrOutputWithContext(ctx context.Context) BdsInstancePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BdsInstancePtrOutput)
}
...
func (o BdsInstanceOutput) ToBdsInstancePtrOutput() BdsInstancePtrOutput {
	return o.ToBdsInstancePtrOutputWithContext(context.Background())
}

func (o BdsInstanceOutput) ToBdsInstancePtrOutputWithContext(ctx context.Context) BdsInstancePtrOutput {
	return o.ApplyT(func(v BdsInstance) *BdsInstance {
		return &v
	}).(BdsInstancePtrOutput)
}

type BdsInstancePtrOutput struct {
	*pulumi.OutputState
}

func (BdsInstancePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**BdsInstance)(nil))
}

func (o BdsInstancePtrOutput) ToBdsInstancePtrOutput() BdsInstancePtrOutput {
	return o
}

func (o BdsInstancePtrOutput) ToBdsInstancePtrOutputWithContext(ctx context.Context) BdsInstancePtrOutput {
	return o
}
...
func (BdsInstanceMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]BdsInstance)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(BdsInstancePtrOutput{})
