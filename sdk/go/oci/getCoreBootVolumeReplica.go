...
// 		_, err := oci.GetCoreBootVolumeReplica(ctx, &GetCoreBootVolumeReplicaArgs{
...
// }
// ```
func GetCoreBootVolumeReplica(ctx *pulumi.Context, args *GetCoreBootVolumeReplicaArgs, opts ...pulumi.InvokeOption) (*GetCoreBootVolumeReplicaResult, error) {
	var rv GetCoreBootVolumeReplicaResult
	err := ctx.Invoke("oci:index/getCoreBootVolumeReplica:GetCoreBootVolumeReplica", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
