...
// 		_, err := oci.GetDatascienceModels(ctx, &GetDatascienceModelsArgs{
...
// }
// ```
func GetDatascienceModels(ctx *pulumi.Context, args *GetDatascienceModelsArgs, opts ...pulumi.InvokeOption) (*GetDatascienceModelsResult, error) {
	var rv GetDatascienceModelsResult
	err := ctx.Invoke("oci:index/getDatascienceModels:GetDatascienceModels", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatascienceModelsArgs struct {
	...
	Filters     []GetDatascienceModelsFilter `pulumi:"filters"`
...
type GetDatascienceModelsResult struct {
	...
	Id *string `pulumi:"id"`
	// The list of models.
	Models []GetDatascienceModelsModel `pulumi:"models"`
