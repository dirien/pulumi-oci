...
// 		_, err := oci.GetObjectstorageObjects(ctx, &GetObjectstorageObjectsArgs{
...
// }
// ```
func GetObjectstorageObjects(ctx *pulumi.Context, args *GetObjectstorageObjectsArgs, opts ...pulumi.InvokeOption) (*GetObjectstorageObjectsResult, error) {
	var rv GetObjectstorageObjectsResult
	err := ctx.Invoke("oci:index/getObjectstorageObjects:GetObjectstorageObjects", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetObjectstorageObjectsArgs struct {
	...
	Filters []GetObjectstorageObjectsFilter `pulumi:"filters"`
...
type GetObjectstorageObjectsResult struct {
	Bucket    string                          `pulumi:"bucket"`
	Delimiter *string                         `pulumi:"delimiter"`
	End       *string                         `pulumi:"end"`
	Filters   []GetObjectstorageObjectsFilter `pulumi:"filters"`
	...
	Objects    []GetObjectstorageObjectsObject `pulumi:"objects"`
	Prefix     *string                         `pulumi:"prefix"`
