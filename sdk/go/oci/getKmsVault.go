...
// 		_, err := oci.GetKmsVault(ctx, &GetKmsVaultArgs{
...
// }
// ```
func LookupKmsVault(ctx *pulumi.Context, args *LookupKmsVaultArgs, opts ...pulumi.InvokeOption) (*LookupKmsVaultResult, error) {
	var rv LookupKmsVaultResult
	err := ctx.Invoke("oci:index/getKmsVault:GetKmsVault", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupKmsVaultArgs struct {
	// The OCID of the vault.
	VaultId string `pulumi:"vaultId"`
}

// A collection of values returned by GetKmsVault.
type LookupKmsVaultResult struct {
	...
	ReplicaDetails GetKmsVaultReplicaDetails `pulumi:"replicaDetails"`
	// Details where vault was backed up.
	RestoreFromFile GetKmsVaultRestoreFromFile `pulumi:"restoreFromFile"`
	// Details where vault was backed up
	RestoreFromObjectStore GetKmsVaultRestoreFromObjectStore `pulumi:"restoreFromObjectStore"`
