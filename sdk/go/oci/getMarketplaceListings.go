...
// 		_, err := oci.GetMarketplaceListings(ctx, &GetMarketplaceListingsArgs{
...
// }
// ```
func GetMarketplaceListings(ctx *pulumi.Context, args *GetMarketplaceListingsArgs, opts ...pulumi.InvokeOption) (*GetMarketplaceListingsResult, error) {
	var rv GetMarketplaceListingsResult
	err := ctx.Invoke("oci:index/getMarketplaceListings:GetMarketplaceListings", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetMarketplaceListingsArgs struct {
	...
	Filters       []GetMarketplaceListingsFilter `pulumi:"filters"`
...
type GetMarketplaceListingsResult struct {
	Categories    []string                       `pulumi:"categories"`
	CompartmentId *string                        `pulumi:"compartmentId"`
	Filters       []GetMarketplaceListingsFilter `pulumi:"filters"`
	...
	Listings []GetMarketplaceListingsListing `pulumi:"listings"`
