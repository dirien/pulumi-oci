...
// 		_, err := oci.GetCoreCpeDeviceShape(ctx, &GetCoreCpeDeviceShapeArgs{
...
// }
// ```
func GetCoreCpeDeviceShape(ctx *pulumi.Context, args *GetCoreCpeDeviceShapeArgs, opts ...pulumi.InvokeOption) (*GetCoreCpeDeviceShapeResult, error) {
	var rv GetCoreCpeDeviceShapeResult
	err := ctx.Invoke("oci:index/getCoreCpeDeviceShape:GetCoreCpeDeviceShape", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCoreCpeDeviceShapeArgs struct {
...
type GetCoreCpeDeviceShapeResult struct {
	// Basic information about a particular CPE device type.
	CpeDeviceInfos []GetCoreCpeDeviceShapeCpeDeviceInfo `pulumi:"cpeDeviceInfos"`
	...
	Parameters []GetCoreCpeDeviceShapeParameter `pulumi:"parameters"`
