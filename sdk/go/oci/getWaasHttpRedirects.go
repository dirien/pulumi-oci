...
// 		_, err := oci.GetWaasHttpRedirects(ctx, &GetWaasHttpRedirectsArgs{
...
// }
// ```
func GetWaasHttpRedirects(ctx *pulumi.Context, args *GetWaasHttpRedirectsArgs, opts ...pulumi.InvokeOption) (*GetWaasHttpRedirectsResult, error) {
	var rv GetWaasHttpRedirectsResult
	err := ctx.Invoke("oci:index/getWaasHttpRedirects:GetWaasHttpRedirects", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetWaasHttpRedirectsResult struct {
	...
	HttpRedirects []GetWaasHttpRedirectsHttpRedirect `pulumi:"httpRedirects"`
