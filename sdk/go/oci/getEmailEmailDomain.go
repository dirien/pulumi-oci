...
// 		_, err := oci.GetEmailEmailDomain(ctx, &GetEmailEmailDomainArgs{
...
// }
// ```
func LookupEmailEmailDomain(ctx *pulumi.Context, args *LookupEmailEmailDomainArgs, opts ...pulumi.InvokeOption) (*LookupEmailEmailDomainResult, error) {
	var rv LookupEmailEmailDomainResult
	err := ctx.Invoke("oci:index/getEmailEmailDomain:GetEmailEmailDomain", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupEmailEmailDomainArgs struct {
...
type LookupEmailEmailDomainResult struct {
