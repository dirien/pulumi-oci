...
// 		_, err := oci.GetWaasProtectionRule(ctx, &GetWaasProtectionRuleArgs{
...
// }
// ```
func LookupWaasProtectionRule(ctx *pulumi.Context, args *LookupWaasProtectionRuleArgs, opts ...pulumi.InvokeOption) (*LookupWaasProtectionRuleResult, error) {
	var rv LookupWaasProtectionRuleResult
	err := ctx.Invoke("oci:index/getWaasProtectionRule:GetWaasProtectionRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWaasProtectionRuleArgs struct {
...
type LookupWaasProtectionRuleResult struct {
	...
	Exclusions []GetWaasProtectionRuleExclusion `pulumi:"exclusions"`
