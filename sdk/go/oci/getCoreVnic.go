...
// 		_, err := oci.GetCoreVnic(ctx, &GetCoreVnicArgs{
...
// }
// ```
func GetCoreVnic(ctx *pulumi.Context, args *GetCoreVnicArgs, opts ...pulumi.InvokeOption) (*GetCoreVnicResult, error) {
	var rv GetCoreVnicResult
	err := ctx.Invoke("oci:index/getCoreVnic:GetCoreVnic", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
