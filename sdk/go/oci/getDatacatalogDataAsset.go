...
// 		_, err := oci.GetDatacatalogDataAsset(ctx, &GetDatacatalogDataAssetArgs{
...
// }
// ```
func LookupDatacatalogDataAsset(ctx *pulumi.Context, args *LookupDatacatalogDataAssetArgs, opts ...pulumi.InvokeOption) (*LookupDatacatalogDataAssetResult, error) {
	var rv LookupDatacatalogDataAssetResult
	err := ctx.Invoke("oci:index/getDatacatalogDataAsset:GetDatacatalogDataAsset", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatacatalogDataAssetArgs struct {
...
type LookupDatacatalogDataAssetResult struct {
