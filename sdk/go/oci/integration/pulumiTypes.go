...
func (o IntegrationInstanceCustomEndpointPtrOutput) Elem() IntegrationInstanceCustomEndpointOutput {
	return o.ApplyT(func(v *IntegrationInstanceCustomEndpoint) IntegrationInstanceCustomEndpoint { return *v }).(IntegrationInstanceCustomEndpointOutput)
}
...
type GetIntegrationInstanceNetworkEndpointDetails struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedHttpIps []string `pulumi:"allowlistedHttpIps"`
	// Virtual Cloud Networks allowed to access this network endpoint.
	AllowlistedHttpVcns []GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn `pulumi:"allowlistedHttpVcns"`
	// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
	IsIntegrationVcnAllowlisted bool `pulumi:"isIntegrationVcnAllowlisted"`
	// The type of network endpoint.
	NetworkEndpointType string `pulumi:"networkEndpointType"`
...
// GetIntegrationInstanceNetworkEndpointDetailsInput is an input type that accepts GetIntegrationInstanceNetworkEndpointDetailsArgs and GetIntegrationInstanceNetworkEndpointDetailsOutput values.
// You can construct a concrete instance of `GetIntegrationInstanceNetworkEndpointDetailsInput` via:
//
//          GetIntegrationInstanceNetworkEndpointDetailsArgs{...}
type GetIntegrationInstanceNetworkEndpointDetailsInput interface {
	pulumi.Input

	ToGetIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstanceNetworkEndpointDetailsOutput
	ToGetIntegrationInstanceNetworkEndpointDetailsOutputWithContext(context.Context) GetIntegrationInstanceNetworkEndpointDetailsOutput
}

type GetIntegrationInstanceNetworkEndpointDetailsArgs struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedHttpIps pulumi.StringArrayInput `pulumi:"allowlistedHttpIps"`
	// Virtual Cloud Networks allowed to access this network endpoint.
	AllowlistedHttpVcns GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput `pulumi:"allowlistedHttpVcns"`
	// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
...
func (GetIntegrationInstanceNetworkEndpointDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstanceNetworkEndpointDetails)(nil)).Elem()
}

func (i GetIntegrationInstanceNetworkEndpointDetailsArgs) ToGetIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstanceNetworkEndpointDetailsOutput {
	return i.ToGetIntegrationInstanceNetworkEndpointDetailsOutputWithContext(context.Background())
}

func (i GetIntegrationInstanceNetworkEndpointDetailsArgs) ToGetIntegrationInstanceNetworkEndpointDetailsOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstanceNetworkEndpointDetailsOutput)
}

type GetIntegrationInstanceNetworkEndpointDetailsOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstanceNetworkEndpointDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstanceNetworkEndpointDetails)(nil)).Elem()
}

func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) ToGetIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstanceNetworkEndpointDetailsOutput {
	return o
}

func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) ToGetIntegrationInstanceNetworkEndpointDetailsOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsOutput {
	return o
}

// Source IP addresses or IP address ranges ingress rules.
func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) AllowlistedHttpIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetails) []string { return v.AllowlistedHttpIps }).(pulumi.StringArrayOutput)
}

// Virtual Cloud Networks allowed to access this network endpoint.
func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) AllowlistedHttpVcns() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetails) []GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn {
		return v.AllowlistedHttpVcns
	}).(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput)
}

// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) IsIntegrationVcnAllowlisted() pulumi.BoolOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetails) bool { return v.IsIntegrationVcnAllowlisted }).(pulumi.BoolOutput)
}

// The type of network endpoint.
func (o GetIntegrationInstanceNetworkEndpointDetailsOutput) NetworkEndpointType() pulumi.StringOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetails) string { return v.NetworkEndpointType }).(pulumi.StringOutput)
}

type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedIps []string `pulumi:"allowlistedIps"`
	// The Virtual Cloud Network OCID.
	Id string `pulumi:"id"`
...
// GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput is an input type that accepts GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs and GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput values.
// You can construct a concrete instance of `GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput` via:
//
//          GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs{...}
type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput interface {
	pulumi.Input

	ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput
	ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput
}

type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedIps pulumi.StringArrayInput `pulumi:"allowlistedIps"`
	// The Virtual Cloud Network OCID.
	Id pulumi.StringInput `pulumi:"id"`
...
func (GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (i GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return i.ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(context.Background())
}

func (i GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput)
}

// GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput is an input type that accepts GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray and GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput values.
// You can construct a concrete instance of `GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput` via:
//
//          GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray{ GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs{...} }
type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput interface {
	pulumi.Input

	ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput
	ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput
}

type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray []GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput

func (GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (i GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return i.ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(context.Background())
}

func (i GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput)
}

type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return o
}

func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return o
}

// Source IP addresses or IP address ranges ingress rules.
func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) AllowlistedIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn) []string {
		return v.AllowlistedIps
	}).(pulumi.StringArrayOutput)
}

// The Virtual Cloud Network OCID.
func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn) string { return v.Id }).(pulumi.StringOutput)
}

type GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o
}

func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ToGetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(ctx context.Context) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o
}

func (o GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) Index(i pulumi.IntInput) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn {
		return vs[0].([]GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)[vs[1].(int)]
	}).(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput)
}
...
type GetIntegrationInstancesIntegrationInstance struct {
	...
	CustomEndpoint GetIntegrationInstancesIntegrationInstanceCustomEndpoint `pulumi:"customEndpoint"`
	...
	NetworkEndpointDetails GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails `pulumi:"networkEndpointDetails"`
...
type GetIntegrationInstancesIntegrationInstanceArgs struct {
	...
	// Details for a custom endpoint for the integration instance.
	CustomEndpoint GetIntegrationInstancesIntegrationInstanceCustomEndpointInput `pulumi:"customEndpoint"`
	// Usage of predefined tag keys. These predefined keys are scoped to namespaces. Example: `{"foo-namespace.bar-key": "value"}`
	...
	// Base representation of a network endpoint.
	NetworkEndpointDetails GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsInput `pulumi:"networkEndpointDetails"`
	// Life cycle state to query on.
...
// Details for a custom endpoint for the integration instance.
func (o GetIntegrationInstancesIntegrationInstanceOutput) CustomEndpoint() GetIntegrationInstancesIntegrationInstanceCustomEndpointOutput {
...
// Base representation of a network endpoint.
func (o GetIntegrationInstancesIntegrationInstanceOutput) NetworkEndpointDetails() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstance) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails {
		return v.NetworkEndpointDetails
	}).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput)
}
...
type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedHttpIps []string `pulumi:"allowlistedHttpIps"`
	// Virtual Cloud Networks allowed to access this network endpoint.
	AllowlistedHttpVcns []GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn `pulumi:"allowlistedHttpVcns"`
	// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
	IsIntegrationVcnAllowlisted bool `pulumi:"isIntegrationVcnAllowlisted"`
	// The type of network endpoint.
	NetworkEndpointType string `pulumi:"networkEndpointType"`
...
// GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsInput is an input type that accepts GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs and GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput values.
// You can construct a concrete instance of `GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsInput` via:
//
//          GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs{...}
type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsInput interface {
	pulumi.Input

	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput
	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutputWithContext(context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedHttpIps pulumi.StringArrayInput `pulumi:"allowlistedHttpIps"`
	// Virtual Cloud Networks allowed to access this network endpoint.
	AllowlistedHttpVcns GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput `pulumi:"allowlistedHttpVcns"`
	// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
	IsIntegrationVcnAllowlisted pulumi.BoolInput `pulumi:"isIntegrationVcnAllowlisted"`
	// The type of network endpoint.
	NetworkEndpointType pulumi.StringInput `pulumi:"networkEndpointType"`
...
func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails)(nil)).Elem()
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput {
	return i.ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutputWithContext(context.Background())
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsArgs) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput)
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails)(nil)).Elem()
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput {
	return o
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput {
	return o
}

// Source IP addresses or IP address ranges ingress rules.
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) AllowlistedHttpIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails) []string {
		return v.AllowlistedHttpIps
	}).(pulumi.StringArrayOutput)
}

// Virtual Cloud Networks allowed to access this network endpoint.
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) AllowlistedHttpVcns() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails) []GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn {
		return v.AllowlistedHttpVcns
	}).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput)
}

// The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) IsIntegrationVcnAllowlisted() pulumi.BoolOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails) bool {
		return v.IsIntegrationVcnAllowlisted
	}).(pulumi.BoolOutput)
}

// The type of network endpoint.
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput) NetworkEndpointType() pulumi.StringOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetails) string {
		return v.NetworkEndpointType
	}).(pulumi.StringOutput)
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedIps []string `pulumi:"allowlistedIps"`
	// The Virtual Cloud Network OCID.
	Id string `pulumi:"id"`
...
// GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput is an input type that accepts GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs and GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput values.
// You can construct a concrete instance of `GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput` via:
//
//          GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs{...}
type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput interface {
	pulumi.Input

	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput
	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs struct {
	// Source IP addresses or IP address ranges ingress rules.
	AllowlistedIps pulumi.StringArrayInput `pulumi:"allowlistedIps"`
	// The Virtual Cloud Network OCID.
	Id pulumi.StringInput `pulumi:"id"`
...
func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return i.ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(context.Background())
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput)
}

// GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput is an input type that accepts GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray and GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput values.
// You can construct a concrete instance of `GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput` via:
//
//          GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray{ GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs{...} }
type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayInput interface {
	pulumi.Input

	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput
	ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray []GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnInput

func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return i.ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(context.Background())
}

func (i GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArray) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput)
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return o
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return o
}

// Source IP addresses or IP address ranges ingress rules.
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) AllowlistedIps() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn) []string {
		return v.AllowlistedIps
	}).(pulumi.StringArrayOutput)
}

// The Virtual Cloud Network OCID.
func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn) string {
		return v.Id
	}).(pulumi.StringOutput)
}

type GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput struct{ *pulumi.OutputState }

func (GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)(nil)).Elem()
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput() GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) ToGetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutputWithContext(ctx context.Context) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput {
	return o
}

func (o GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput) Index(i pulumi.IntInput) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn {
		return vs[0].([]GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcn)[vs[1].(int)]
	}).(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GetIntegrationInstanceNetworkEndpointDetailsOutput{})
	pulumi.RegisterOutputType(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput{})
	pulumi.RegisterOutputType(GetIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput{})
	...
	pulumi.RegisterOutputType(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsOutput{})
	pulumi.RegisterOutputType(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnOutput{})
	pulumi.RegisterOutputType(GetIntegrationInstancesIntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArrayOutput{})
}
