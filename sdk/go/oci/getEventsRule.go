...
// 		_, err := oci.GetEventsRule(ctx, &GetEventsRuleArgs{
...
// }
// ```
func LookupEventsRule(ctx *pulumi.Context, args *LookupEventsRuleArgs, opts ...pulumi.InvokeOption) (*LookupEventsRuleResult, error) {
	var rv LookupEventsRuleResult
	err := ctx.Invoke("oci:index/getEventsRule:GetEventsRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupEventsRuleArgs struct {
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this rule.
	RuleId string `pulumi:"ruleId"`
}

// A collection of values returned by GetEventsRule.
type LookupEventsRuleResult struct {
	// A list of one or more Action objects.
	Actions GetEventsRuleActions `pulumi:"actions"`
