...
// 		_, err := oci.GetKmsKeyVersion(ctx, &GetKmsKeyVersionArgs{
...
// }
// ```
func LookupKmsKeyVersion(ctx *pulumi.Context, args *LookupKmsKeyVersionArgs, opts ...pulumi.InvokeOption) (*LookupKmsKeyVersionResult, error) {
	var rv LookupKmsKeyVersionResult
	err := ctx.Invoke("oci:index/getKmsKeyVersion:GetKmsKeyVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupKmsKeyVersionArgs struct {
	// The OCID of the key.
...
type LookupKmsKeyVersionResult struct {
	...
	ReplicaDetails    GetKmsKeyVersionReplicaDetails `pulumi:"replicaDetails"`
