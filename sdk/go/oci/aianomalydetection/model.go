...
type Model struct {
	...
	ModelTrainingResults ModelModelTrainingResultsOutput `pulumi:"modelTrainingResults"`
...
type modelState struct {
	...
	// Specifies the details for an Anomaly Detection model trained with MSET.
	ModelTrainingResults *ModelModelTrainingResults `pulumi:"modelTrainingResults"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
...
type ModelState struct {
	...
	// Specifies the details for an Anomaly Detection model trained with MSET.
	ModelTrainingResults ModelModelTrainingResultsPtrInput
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
