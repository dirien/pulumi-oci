...
// 		_, err := datasafe.LookupOnPremConnector(ctx, &datasafe.LookupOnPremConnectorArgs{
...
// }
// ```
func LookupOnPremConnector(ctx *pulumi.Context, args *LookupOnPremConnectorArgs, opts ...pulumi.InvokeOption) (*LookupOnPremConnectorResult, error) {
	var rv LookupOnPremConnectorResult
