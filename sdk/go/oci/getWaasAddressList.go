...
// 		_, err := oci.GetWaasAddressList(ctx, &GetWaasAddressListArgs{
...
// }
// ```
func LookupWaasAddressList(ctx *pulumi.Context, args *LookupWaasAddressListArgs, opts ...pulumi.InvokeOption) (*LookupWaasAddressListResult, error) {
	var rv LookupWaasAddressListResult
	err := ctx.Invoke("oci:index/getWaasAddressList:GetWaasAddressList", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWaasAddressListArgs struct {
...
type LookupWaasAddressListResult struct {
