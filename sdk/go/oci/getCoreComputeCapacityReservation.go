...
// 		_, err := oci.GetCoreComputeCapacityReservation(ctx, &GetCoreComputeCapacityReservationArgs{
...
// }
// ```
func LookupCoreComputeCapacityReservation(ctx *pulumi.Context, args *LookupCoreComputeCapacityReservationArgs, opts ...pulumi.InvokeOption) (*LookupCoreComputeCapacityReservationResult, error) {
	var rv LookupCoreComputeCapacityReservationResult
	err := ctx.Invoke("oci:index/getCoreComputeCapacityReservation:GetCoreComputeCapacityReservation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreComputeCapacityReservationArgs struct {
	// The OCID of the compute capacity reservation.
	CapacityReservationId string `pulumi:"capacityReservationId"`
}

// A collection of values returned by GetCoreComputeCapacityReservation.
type LookupCoreComputeCapacityReservationResult struct {
	...
	InstanceReservationConfigs []GetCoreComputeCapacityReservationInstanceReservationConfig `pulumi:"instanceReservationConfigs"`
