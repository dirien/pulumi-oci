...
type GetHttpProbeResultsHttpProbeResult struct {
	...
	Connection GetHttpProbeResultsHttpProbeResultConnection `pulumi:"connection"`
	// The DNS resolution results.
	Dns GetHttpProbeResultsHttpProbeResultDns `pulumi:"dns"`
...
type GetHttpProbeResultsHttpProbeResultArgs struct {
	...
	// TCP connection results.  All durations are in milliseconds.
	Connection GetHttpProbeResultsHttpProbeResultConnectionInput `pulumi:"connection"`
	// The DNS resolution results.
	Dns GetHttpProbeResultsHttpProbeResultDnsInput `pulumi:"dns"`
	// The time immediately before the vantage point finishes the domain name lookup for the resource.
...
// TCP connection results.  All durations are in milliseconds.
func (o GetHttpProbeResultsHttpProbeResultOutput) Connection() GetHttpProbeResultsHttpProbeResultConnectionOutput {
...
// The DNS resolution results.
func (o GetHttpProbeResultsHttpProbeResultOutput) Dns() GetHttpProbeResultsHttpProbeResultDnsOutput {
	return o.ApplyT(func(v GetHttpProbeResultsHttpProbeResult) GetHttpProbeResultsHttpProbeResultDns { return v.Dns }).(GetHttpProbeResultsHttpProbeResultDnsOutput)
}
...
type GetHttpProbeResultsHttpProbeResultDns struct {
...
// GetHttpProbeResultsHttpProbeResultDnsInput is an input type that accepts GetHttpProbeResultsHttpProbeResultDnsArgs and GetHttpProbeResultsHttpProbeResultDnsOutput values.
// You can construct a concrete instance of `GetHttpProbeResultsHttpProbeResultDnsInput` via:
//
//          GetHttpProbeResultsHttpProbeResultDnsArgs{...}
type GetHttpProbeResultsHttpProbeResultDnsInput interface {
	pulumi.Input

	ToGetHttpProbeResultsHttpProbeResultDnsOutput() GetHttpProbeResultsHttpProbeResultDnsOutput
	ToGetHttpProbeResultsHttpProbeResultDnsOutputWithContext(context.Context) GetHttpProbeResultsHttpProbeResultDnsOutput
}

type GetHttpProbeResultsHttpProbeResultDnsArgs struct {
	// The addresses returned by DNS resolution.
...
func (GetHttpProbeResultsHttpProbeResultDnsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetHttpProbeResultsHttpProbeResultDns)(nil)).Elem()
}

func (i GetHttpProbeResultsHttpProbeResultDnsArgs) ToGetHttpProbeResultsHttpProbeResultDnsOutput() GetHttpProbeResultsHttpProbeResultDnsOutput {
	return i.ToGetHttpProbeResultsHttpProbeResultDnsOutputWithContext(context.Background())
}

func (i GetHttpProbeResultsHttpProbeResultDnsArgs) ToGetHttpProbeResultsHttpProbeResultDnsOutputWithContext(ctx context.Context) GetHttpProbeResultsHttpProbeResultDnsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetHttpProbeResultsHttpProbeResultDnsOutput)
}

type GetHttpProbeResultsHttpProbeResultDnsOutput struct{ *pulumi.OutputState }

func (GetHttpProbeResultsHttpProbeResultDnsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetHttpProbeResultsHttpProbeResultDns)(nil)).Elem()
}

func (o GetHttpProbeResultsHttpProbeResultDnsOutput) ToGetHttpProbeResultsHttpProbeResultDnsOutput() GetHttpProbeResultsHttpProbeResultDnsOutput {
	return o
}

func (o GetHttpProbeResultsHttpProbeResultDnsOutput) ToGetHttpProbeResultsHttpProbeResultDnsOutputWithContext(ctx context.Context) GetHttpProbeResultsHttpProbeResultDnsOutput {
	return o
}

// The addresses returned by DNS resolution.
func (o GetHttpProbeResultsHttpProbeResultDnsOutput) Addresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetHttpProbeResultsHttpProbeResultDns) []string { return v.Addresses }).(pulumi.StringArrayOutput)
}

// Total DNS resolution duration, in milliseconds. Calculated using `domainLookupEnd` minus `domainLookupStart`.
func (o GetHttpProbeResultsHttpProbeResultDnsOutput) DomainLookupDuration() pulumi.Float64Output {
	return o.ApplyT(func(v GetHttpProbeResultsHttpProbeResultDns) float64 { return v.DomainLookupDuration }).(pulumi.Float64Output)
}
...
type GetPingProbeResultsPingProbeResult struct {
	...
	Connection GetPingProbeResultsPingProbeResultConnection `pulumi:"connection"`
	// The DNS resolution results.
	Dns GetPingProbeResultsPingProbeResultDns `pulumi:"dns"`
	// The time immediately before the vantage point finishes the domain name lookup for the resource.
	DomainLookupEnd float64 `pulumi:"domainLookupEnd"`
	// The time immediately before the vantage point starts the domain name lookup for the resource.
	DomainLookupStart float64 `pulumi:"domainLookupStart"`
...
type GetPingProbeResultsPingProbeResultArgs struct {
	// The network connection results.
	Connection GetPingProbeResultsPingProbeResultConnectionInput `pulumi:"connection"`
	// The DNS resolution results.
	Dns GetPingProbeResultsPingProbeResultDnsInput `pulumi:"dns"`
	// The time immediately before the vantage point finishes the domain name lookup for the resource.
	DomainLookupEnd pulumi.Float64Input `pulumi:"domainLookupEnd"`
	// The time immediately before the vantage point starts the domain name lookup for the resource.
	DomainLookupStart pulumi.Float64Input `pulumi:"domainLookupStart"`
...
// The network connection results.
func (o GetPingProbeResultsPingProbeResultOutput) Connection() GetPingProbeResultsPingProbeResultConnectionOutput {
...
// The DNS resolution results.
func (o GetPingProbeResultsPingProbeResultOutput) Dns() GetPingProbeResultsPingProbeResultDnsOutput {
	return o.ApplyT(func(v GetPingProbeResultsPingProbeResult) GetPingProbeResultsPingProbeResultDns { return v.Dns }).(GetPingProbeResultsPingProbeResultDnsOutput)
}
...
type GetPingProbeResultsPingProbeResultDns struct {
	// The addresses returned by DNS resolution.
	Addresses []string `pulumi:"addresses"`
	// Total DNS resolution duration, in milliseconds. Calculated using `domainLookupEnd` minus `domainLookupStart`.
	DomainLookupDuration float64 `pulumi:"domainLookupDuration"`
...
// GetPingProbeResultsPingProbeResultDnsInput is an input type that accepts GetPingProbeResultsPingProbeResultDnsArgs and GetPingProbeResultsPingProbeResultDnsOutput values.
// You can construct a concrete instance of `GetPingProbeResultsPingProbeResultDnsInput` via:
//
//          GetPingProbeResultsPingProbeResultDnsArgs{...}
type GetPingProbeResultsPingProbeResultDnsInput interface {
	pulumi.Input

	ToGetPingProbeResultsPingProbeResultDnsOutput() GetPingProbeResultsPingProbeResultDnsOutput
	ToGetPingProbeResultsPingProbeResultDnsOutputWithContext(context.Context) GetPingProbeResultsPingProbeResultDnsOutput
}

type GetPingProbeResultsPingProbeResultDnsArgs struct {
	// The addresses returned by DNS resolution.
	Addresses pulumi.StringArrayInput `pulumi:"addresses"`
	// Total DNS resolution duration, in milliseconds. Calculated using `domainLookupEnd` minus `domainLookupStart`.
	DomainLookupDuration pulumi.Float64Input `pulumi:"domainLookupDuration"`
...
func (GetPingProbeResultsPingProbeResultDnsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPingProbeResultsPingProbeResultDns)(nil)).Elem()
}

func (i GetPingProbeResultsPingProbeResultDnsArgs) ToGetPingProbeResultsPingProbeResultDnsOutput() GetPingProbeResultsPingProbeResultDnsOutput {
	return i.ToGetPingProbeResultsPingProbeResultDnsOutputWithContext(context.Background())
}

func (i GetPingProbeResultsPingProbeResultDnsArgs) ToGetPingProbeResultsPingProbeResultDnsOutputWithContext(ctx context.Context) GetPingProbeResultsPingProbeResultDnsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPingProbeResultsPingProbeResultDnsOutput)
}

type GetPingProbeResultsPingProbeResultDnsOutput struct{ *pulumi.OutputState }

func (GetPingProbeResultsPingProbeResultDnsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPingProbeResultsPingProbeResultDns)(nil)).Elem()
}

func (o GetPingProbeResultsPingProbeResultDnsOutput) ToGetPingProbeResultsPingProbeResultDnsOutput() GetPingProbeResultsPingProbeResultDnsOutput {
	return o
}

func (o GetPingProbeResultsPingProbeResultDnsOutput) ToGetPingProbeResultsPingProbeResultDnsOutputWithContext(ctx context.Context) GetPingProbeResultsPingProbeResultDnsOutput {
	return o
}

// The addresses returned by DNS resolution.
func (o GetPingProbeResultsPingProbeResultDnsOutput) Addresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetPingProbeResultsPingProbeResultDns) []string { return v.Addresses }).(pulumi.StringArrayOutput)
}

// Total DNS resolution duration, in milliseconds. Calculated using `domainLookupEnd` minus `domainLookupStart`.
func (o GetPingProbeResultsPingProbeResultDnsOutput) DomainLookupDuration() pulumi.Float64Output {
	return o.ApplyT(func(v GetPingProbeResultsPingProbeResultDns) float64 { return v.DomainLookupDuration }).(pulumi.Float64Output)
}
...
type GetVantagePointsHealthChecksVantagePoint struct {
	...
	Geo GetVantagePointsHealthChecksVantagePointGeo `pulumi:"geo"`
	// Filters results that exactly match the `name` field.
	Name string `pulumi:"name"`
...
type GetVantagePointsHealthChecksVantagePointArgs struct {
	...
	DisplayName pulumi.StringInput `pulumi:"displayName"`
	// Geographic information about a vantage point.
	Geo GetVantagePointsHealthChecksVantagePointGeoInput `pulumi:"geo"`
	// Filters results that exactly match the `name` field.
	Name pulumi.StringInput `pulumi:"name"`
	// The organization on whose infrastructure this vantage point resides. Provider names are not unique, as Oracle Cloud Infrastructure maintains many vantage points in each major provider.
...
// Geographic information about a vantage point.
func (o GetVantagePointsHealthChecksVantagePointOutput) Geo() GetVantagePointsHealthChecksVantagePointGeoOutput {
...
func init() {
	...
	pulumi.RegisterOutputType(GetHttpProbeResultsHttpProbeResultDnsOutput{})
	...
	pulumi.RegisterOutputType(GetPingProbeResultsPingProbeResultDnsOutput{})
