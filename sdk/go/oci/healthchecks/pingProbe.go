...
func (*PingProbe) ElementType() reflect.Type {
	return reflect.TypeOf((*PingProbe)(nil))
}
...
func (i *PingProbe) ToPingProbePtrOutput() PingProbePtrOutput {
	return i.ToPingProbePtrOutputWithContext(context.Background())
}

func (i *PingProbe) ToPingProbePtrOutputWithContext(ctx context.Context) PingProbePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PingProbePtrOutput)
}

type PingProbePtrInput interface {
	pulumi.Input

	ToPingProbePtrOutput() PingProbePtrOutput
	ToPingProbePtrOutputWithContext(ctx context.Context) PingProbePtrOutput
}

type pingProbePtrType PingProbeArgs

func (*pingProbePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PingProbe)(nil))
}

func (i *pingProbePtrType) ToPingProbePtrOutput() PingProbePtrOutput {
	return i.ToPingProbePtrOutputWithContext(context.Background())
}

func (i *pingProbePtrType) ToPingProbePtrOutputWithContext(ctx context.Context) PingProbePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PingProbePtrOutput)
}
...
func (o PingProbeOutput) ToPingProbePtrOutput() PingProbePtrOutput {
	return o.ToPingProbePtrOutputWithContext(context.Background())
}

func (o PingProbeOutput) ToPingProbePtrOutputWithContext(ctx context.Context) PingProbePtrOutput {
	return o.ApplyT(func(v PingProbe) *PingProbe {
		return &v
	}).(PingProbePtrOutput)
}

type PingProbePtrOutput struct {
	*pulumi.OutputState
}

func (PingProbePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PingProbe)(nil))
}

func (o PingProbePtrOutput) ToPingProbePtrOutput() PingProbePtrOutput {
	return o
}

func (o PingProbePtrOutput) ToPingProbePtrOutputWithContext(ctx context.Context) PingProbePtrOutput {
	return o
}
...
func (PingProbeMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]PingProbe)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PingProbePtrOutput{})
