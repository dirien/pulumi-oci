...
func (*HttpMonitor) ElementType() reflect.Type {
	return reflect.TypeOf((*HttpMonitor)(nil))
}
...
func (i *HttpMonitor) ToHttpMonitorPtrOutput() HttpMonitorPtrOutput {
	return i.ToHttpMonitorPtrOutputWithContext(context.Background())
}

func (i *HttpMonitor) ToHttpMonitorPtrOutputWithContext(ctx context.Context) HttpMonitorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HttpMonitorPtrOutput)
}

type HttpMonitorPtrInput interface {
	pulumi.Input

	ToHttpMonitorPtrOutput() HttpMonitorPtrOutput
	ToHttpMonitorPtrOutputWithContext(ctx context.Context) HttpMonitorPtrOutput
}

type httpMonitorPtrType HttpMonitorArgs

func (*httpMonitorPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HttpMonitor)(nil))
}

func (i *httpMonitorPtrType) ToHttpMonitorPtrOutput() HttpMonitorPtrOutput {
	return i.ToHttpMonitorPtrOutputWithContext(context.Background())
}

func (i *httpMonitorPtrType) ToHttpMonitorPtrOutputWithContext(ctx context.Context) HttpMonitorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HttpMonitorPtrOutput)
}
...
func (o HttpMonitorOutput) ToHttpMonitorPtrOutput() HttpMonitorPtrOutput {
	return o.ToHttpMonitorPtrOutputWithContext(context.Background())
}

func (o HttpMonitorOutput) ToHttpMonitorPtrOutputWithContext(ctx context.Context) HttpMonitorPtrOutput {
	return o.ApplyT(func(v HttpMonitor) *HttpMonitor {
		return &v
	}).(HttpMonitorPtrOutput)
}

type HttpMonitorPtrOutput struct {
	*pulumi.OutputState
}

func (HttpMonitorPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HttpMonitor)(nil))
}

func (o HttpMonitorPtrOutput) ToHttpMonitorPtrOutput() HttpMonitorPtrOutput {
	return o
}

func (o HttpMonitorPtrOutput) ToHttpMonitorPtrOutputWithContext(ctx context.Context) HttpMonitorPtrOutput {
	return o
}
...
func (HttpMonitorMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]HttpMonitor)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(HttpMonitorPtrOutput{})
