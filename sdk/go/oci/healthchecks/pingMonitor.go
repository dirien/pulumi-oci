...
func (*PingMonitor) ElementType() reflect.Type {
	return reflect.TypeOf((*PingMonitor)(nil))
}
...
func (i *PingMonitor) ToPingMonitorPtrOutput() PingMonitorPtrOutput {
	return i.ToPingMonitorPtrOutputWithContext(context.Background())
}

func (i *PingMonitor) ToPingMonitorPtrOutputWithContext(ctx context.Context) PingMonitorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PingMonitorPtrOutput)
}

type PingMonitorPtrInput interface {
	pulumi.Input

	ToPingMonitorPtrOutput() PingMonitorPtrOutput
	ToPingMonitorPtrOutputWithContext(ctx context.Context) PingMonitorPtrOutput
}

type pingMonitorPtrType PingMonitorArgs

func (*pingMonitorPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PingMonitor)(nil))
}

func (i *pingMonitorPtrType) ToPingMonitorPtrOutput() PingMonitorPtrOutput {
	return i.ToPingMonitorPtrOutputWithContext(context.Background())
}

func (i *pingMonitorPtrType) ToPingMonitorPtrOutputWithContext(ctx context.Context) PingMonitorPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PingMonitorPtrOutput)
}
...
func (o PingMonitorOutput) ToPingMonitorPtrOutput() PingMonitorPtrOutput {
	return o.ToPingMonitorPtrOutputWithContext(context.Background())
}

func (o PingMonitorOutput) ToPingMonitorPtrOutputWithContext(ctx context.Context) PingMonitorPtrOutput {
	return o.ApplyT(func(v PingMonitor) *PingMonitor {
		return &v
	}).(PingMonitorPtrOutput)
}

type PingMonitorPtrOutput struct {
	*pulumi.OutputState
}

func (PingMonitorPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PingMonitor)(nil))
}

func (o PingMonitorPtrOutput) ToPingMonitorPtrOutput() PingMonitorPtrOutput {
	return o
}

func (o PingMonitorPtrOutput) ToPingMonitorPtrOutputWithContext(ctx context.Context) PingMonitorPtrOutput {
	return o
}
...
func (PingMonitorMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]PingMonitor)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PingMonitorPtrOutput{})
