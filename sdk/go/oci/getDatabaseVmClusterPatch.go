...
// 		_, err := oci.GetDatabaseVmClusterPatch(ctx, &GetDatabaseVmClusterPatchArgs{
...
// }
// ```
func GetDatabaseVmClusterPatch(ctx *pulumi.Context, args *GetDatabaseVmClusterPatchArgs, opts ...pulumi.InvokeOption) (*GetDatabaseVmClusterPatchResult, error) {
	var rv GetDatabaseVmClusterPatchResult
	err := ctx.Invoke("oci:index/getDatabaseVmClusterPatch:GetDatabaseVmClusterPatch", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabaseVmClusterPatchArgs struct {
...
type GetDatabaseVmClusterPatchResult struct {
