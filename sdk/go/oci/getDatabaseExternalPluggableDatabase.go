...
// 		_, err := oci.GetDatabaseExternalPluggableDatabase(ctx, &GetDatabaseExternalPluggableDatabaseArgs{
...
// }
// ```
func LookupDatabaseExternalPluggableDatabase(ctx *pulumi.Context, args *LookupDatabaseExternalPluggableDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseExternalPluggableDatabaseResult, error) {
	var rv LookupDatabaseExternalPluggableDatabaseResult
	err := ctx.Invoke("oci:index/getDatabaseExternalPluggableDatabase:GetDatabaseExternalPluggableDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatabaseExternalPluggableDatabaseArgs struct {
...
type LookupDatabaseExternalPluggableDatabaseResult struct {
	...
	DatabaseManagementConfig GetDatabaseExternalPluggableDatabaseDatabaseManagementConfig `pulumi:"databaseManagementConfig"`
	...
	OperationsInsightsConfig GetDatabaseExternalPluggableDatabaseOperationsInsightsConfig `pulumi:"operationsInsightsConfig"`
