...
type Recommendation struct {
	...
	SupportedLevels RecommendationSupportedLevelsOutput `pulumi:"supportedLevels"`
...
type recommendationState struct {
	...
	// Optional. The profile levels supported by a recommendation. For example, profile level values could be `Low`, `Medium`, and `High`. Not all recommendations support this field.
	SupportedLevels *RecommendationSupportedLevels `pulumi:"supportedLevels"`
	// The date and time the recommendation details were created, in the format defined by RFC3339.
...
type RecommendationState struct {
	...
	// Optional. The profile levels supported by a recommendation. For example, profile level values could be `Low`, `Medium`, and `High`. Not all recommendations support this field.
	SupportedLevels RecommendationSupportedLevelsPtrInput
	// The date and time the recommendation details were created, in the format defined by RFC3339.
...
func (*Recommendation) ElementType() reflect.Type {
	return reflect.TypeOf((*Recommendation)(nil))
}
...
func (i *Recommendation) ToRecommendationPtrOutput() RecommendationPtrOutput {
	return i.ToRecommendationPtrOutputWithContext(context.Background())
}

func (i *Recommendation) ToRecommendationPtrOutputWithContext(ctx context.Context) RecommendationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RecommendationPtrOutput)
}

type RecommendationPtrInput interface {
	pulumi.Input

	ToRecommendationPtrOutput() RecommendationPtrOutput
	ToRecommendationPtrOutputWithContext(ctx context.Context) RecommendationPtrOutput
}

type recommendationPtrType RecommendationArgs

func (*recommendationPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Recommendation)(nil))
}

func (i *recommendationPtrType) ToRecommendationPtrOutput() RecommendationPtrOutput {
	return i.ToRecommendationPtrOutputWithContext(context.Background())
}

func (i *recommendationPtrType) ToRecommendationPtrOutputWithContext(ctx context.Context) RecommendationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RecommendationPtrOutput)
}
...
func (o RecommendationOutput) ToRecommendationPtrOutput() RecommendationPtrOutput {
	return o.ToRecommendationPtrOutputWithContext(context.Background())
}

func (o RecommendationOutput) ToRecommendationPtrOutputWithContext(ctx context.Context) RecommendationPtrOutput {
	return o.ApplyT(func(v Recommendation) *Recommendation {
		return &v
	}).(RecommendationPtrOutput)
}

type RecommendationPtrOutput struct {
	*pulumi.OutputState
}

func (RecommendationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Recommendation)(nil))
}

func (o RecommendationPtrOutput) ToRecommendationPtrOutput() RecommendationPtrOutput {
	return o
}

func (o RecommendationPtrOutput) ToRecommendationPtrOutputWithContext(ctx context.Context) RecommendationPtrOutput {
	return o
}
...
func (RecommendationMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Recommendation)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(RecommendationPtrOutput{})
