...
type ResourceAction struct {
	...
	Action ResourceActionActionOutput `pulumi:"action"`
...
type resourceActionState struct {
	// Details about the recommended action.
	Action *ResourceActionAction `pulumi:"action"`
	// The unique OCID associated with the category.
...
type ResourceActionState struct {
	// Details about the recommended action.
	Action ResourceActionActionPtrInput
	// The unique OCID associated with the category.
...
func (*ResourceAction) ElementType() reflect.Type {
	return reflect.TypeOf((*ResourceAction)(nil))
}
...
func (i *ResourceAction) ToResourceActionPtrOutput() ResourceActionPtrOutput {
	return i.ToResourceActionPtrOutputWithContext(context.Background())
}

func (i *ResourceAction) ToResourceActionPtrOutputWithContext(ctx context.Context) ResourceActionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ResourceActionPtrOutput)
}

type ResourceActionPtrInput interface {
	pulumi.Input

	ToResourceActionPtrOutput() ResourceActionPtrOutput
	ToResourceActionPtrOutputWithContext(ctx context.Context) ResourceActionPtrOutput
}

type resourceActionPtrType ResourceActionArgs

func (*resourceActionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ResourceAction)(nil))
}

func (i *resourceActionPtrType) ToResourceActionPtrOutput() ResourceActionPtrOutput {
	return i.ToResourceActionPtrOutputWithContext(context.Background())
}

func (i *resourceActionPtrType) ToResourceActionPtrOutputWithContext(ctx context.Context) ResourceActionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ResourceActionPtrOutput)
}
...
func (o ResourceActionOutput) ToResourceActionPtrOutput() ResourceActionPtrOutput {
	return o.ToResourceActionPtrOutputWithContext(context.Background())
}

func (o ResourceActionOutput) ToResourceActionPtrOutputWithContext(ctx context.Context) ResourceActionPtrOutput {
	return o.ApplyT(func(v ResourceAction) *ResourceAction {
		return &v
	}).(ResourceActionPtrOutput)
}

type ResourceActionPtrOutput struct {
	*pulumi.OutputState
}

func (ResourceActionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ResourceAction)(nil))
}

func (o ResourceActionPtrOutput) ToResourceActionPtrOutput() ResourceActionPtrOutput {
	return o
}

func (o ResourceActionPtrOutput) ToResourceActionPtrOutputWithContext(ctx context.Context) ResourceActionPtrOutput {
	return o
}
...
func (ResourceActionMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ResourceAction)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ResourceActionPtrOutput{})
