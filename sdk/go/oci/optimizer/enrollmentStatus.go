...
func (*EnrollmentStatus) ElementType() reflect.Type {
	return reflect.TypeOf((*EnrollmentStatus)(nil))
}
...
func (i *EnrollmentStatus) ToEnrollmentStatusPtrOutput() EnrollmentStatusPtrOutput {
	return i.ToEnrollmentStatusPtrOutputWithContext(context.Background())
}

func (i *EnrollmentStatus) ToEnrollmentStatusPtrOutputWithContext(ctx context.Context) EnrollmentStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EnrollmentStatusPtrOutput)
}

type EnrollmentStatusPtrInput interface {
	pulumi.Input

	ToEnrollmentStatusPtrOutput() EnrollmentStatusPtrOutput
	ToEnrollmentStatusPtrOutputWithContext(ctx context.Context) EnrollmentStatusPtrOutput
}

type enrollmentStatusPtrType EnrollmentStatusArgs

func (*enrollmentStatusPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**EnrollmentStatus)(nil))
}

func (i *enrollmentStatusPtrType) ToEnrollmentStatusPtrOutput() EnrollmentStatusPtrOutput {
	return i.ToEnrollmentStatusPtrOutputWithContext(context.Background())
}

func (i *enrollmentStatusPtrType) ToEnrollmentStatusPtrOutputWithContext(ctx context.Context) EnrollmentStatusPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EnrollmentStatusPtrOutput)
}
...
type EnrollmentStatusOutput struct {
	*pulumi.OutputState
}
...
func (o EnrollmentStatusOutput) ToEnrollmentStatusPtrOutput() EnrollmentStatusPtrOutput {
	return o.ToEnrollmentStatusPtrOutputWithContext(context.Background())
}

func (o EnrollmentStatusOutput) ToEnrollmentStatusPtrOutputWithContext(ctx context.Context) EnrollmentStatusPtrOutput {
	return o.ApplyT(func(v EnrollmentStatus) *EnrollmentStatus {
		return &v
	}).(EnrollmentStatusPtrOutput)
}

type EnrollmentStatusPtrOutput struct {
	*pulumi.OutputState
}

func (EnrollmentStatusPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**EnrollmentStatus)(nil))
}

func (o EnrollmentStatusPtrOutput) ToEnrollmentStatusPtrOutput() EnrollmentStatusPtrOutput {
	return o
}

func (o EnrollmentStatusPtrOutput) ToEnrollmentStatusPtrOutputWithContext(ctx context.Context) EnrollmentStatusPtrOutput {
	return o
}
...
func (EnrollmentStatusMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]EnrollmentStatus)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(EnrollmentStatusPtrOutput{})
