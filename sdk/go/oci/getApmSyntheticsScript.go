...
// 		_, err := oci.GetApmSyntheticsScript(ctx, &GetApmSyntheticsScriptArgs{
...
// }
// ```
func LookupApmSyntheticsScript(ctx *pulumi.Context, args *LookupApmSyntheticsScriptArgs, opts ...pulumi.InvokeOption) (*LookupApmSyntheticsScriptResult, error) {
	var rv LookupApmSyntheticsScriptResult
	err := ctx.Invoke("oci:index/getApmSyntheticsScript:GetApmSyntheticsScript", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupApmSyntheticsScriptArgs struct {
...
type LookupApmSyntheticsScriptResult struct {
	ApmDomainId string `pulumi:"apmDomainId"`
	...
	MonitorStatusCountMap GetApmSyntheticsScriptMonitorStatusCountMap `pulumi:"monitorStatusCountMap"`
	...
	Parameters []GetApmSyntheticsScriptParameter `pulumi:"parameters"`
	ScriptId   string                            `pulumi:"scriptId"`
