...
type MysqlBackup struct {
	...
	DbSystemSnapshot MysqlBackupDbSystemSnapshotOutput `pulumi:"dbSystemSnapshot"`
...
type mysqlBackupState struct {
	...
	// Snapshot of the DbSystem details at the time of the backup
	DbSystemSnapshot *MysqlBackupDbSystemSnapshot `pulumi:"dbSystemSnapshot"`
	// (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
...
type MysqlBackupState struct {
	...
	// Snapshot of the DbSystem details at the time of the backup
	DbSystemSnapshot MysqlBackupDbSystemSnapshotPtrInput
	// (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
...
func (*MysqlBackup) ElementType() reflect.Type {
	return reflect.TypeOf((*MysqlBackup)(nil))
}
...
func (i *MysqlBackup) ToMysqlBackupPtrOutput() MysqlBackupPtrOutput {
	return i.ToMysqlBackupPtrOutputWithContext(context.Background())
}

func (i *MysqlBackup) ToMysqlBackupPtrOutputWithContext(ctx context.Context) MysqlBackupPtrOutput {
...
type MysqlBackupPtrInput interface {
	...
	ToMysqlBackupPtrOutputWithContext(ctx context.Context) MysqlBackupPtrOutput
}
...
type MysqlBackupPtrOutput struct {
	*pulumi.OutputState
}
...
func (MysqlBackupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]MysqlBackup)(nil))
}
