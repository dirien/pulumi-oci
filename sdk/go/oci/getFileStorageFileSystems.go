...
// 		_, err := oci.GetFileStorageFileSystems(ctx, &GetFileStorageFileSystemsArgs{
...
// }
// ```
func GetFileStorageFileSystems(ctx *pulumi.Context, args *GetFileStorageFileSystemsArgs, opts ...pulumi.InvokeOption) (*GetFileStorageFileSystemsResult, error) {
	var rv GetFileStorageFileSystemsResult
	err := ctx.Invoke("oci:index/getFileStorageFileSystems:GetFileStorageFileSystems", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetFileStorageFileSystemsArgs struct {
	...
	Filters     []GetFileStorageFileSystemsFilter `pulumi:"filters"`
...
type GetFileStorageFileSystemsResult struct {
	...
	FileSystems []GetFileStorageFileSystemsFileSystem `pulumi:"fileSystems"`
	Filters     []GetFileStorageFileSystemsFilter     `pulumi:"filters"`
