...
// 		_, err := oci.GetMarketplaceListingPackage(ctx, &GetMarketplaceListingPackageArgs{
...
// }
// ```
func GetMarketplaceListingPackage(ctx *pulumi.Context, args *GetMarketplaceListingPackageArgs, opts ...pulumi.InvokeOption) (*GetMarketplaceListingPackageResult, error) {
	var rv GetMarketplaceListingPackageResult
	err := ctx.Invoke("oci:index/getMarketplaceListingPackage:GetMarketplaceListingPackage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetMarketplaceListingPackageArgs struct {
...
type GetMarketplaceListingPackageResult struct {
	...
	OperatingSystems []GetMarketplaceListingPackageOperatingSystem `pulumi:"operatingSystems"`
	// The specified package's type.
	PackageType    string `pulumi:"packageType"`
	PackageVersion string `pulumi:"packageVersion"`
	// The model for pricing.
	Pricings []GetMarketplaceListingPackagePricing `pulumi:"pricings"`
	// The regions where the listing is available.
	Regions []GetMarketplaceListingPackageRegion `pulumi:"regions"`
	...
	Variables []GetMarketplaceListingPackageVariable `pulumi:"variables"`
	// The package version.
