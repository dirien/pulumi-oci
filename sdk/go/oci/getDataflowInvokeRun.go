...
// 		_, err := oci.GetDataflowInvokeRun(ctx, &GetDataflowInvokeRunArgs{
...
// }
// ```
func LookupDataflowInvokeRun(ctx *pulumi.Context, args *LookupDataflowInvokeRunArgs, opts ...pulumi.InvokeOption) (*LookupDataflowInvokeRunResult, error) {
	var rv LookupDataflowInvokeRunResult
	err := ctx.Invoke("oci:index/getDataflowInvokeRun:GetDataflowInvokeRun", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDataflowInvokeRunArgs struct {
	// The unique ID for the run
	RunId string `pulumi:"runId"`
}

// A collection of values returned by GetDataflowInvokeRun.
type LookupDataflowInvokeRunResult struct {
	// The application ID.
	...
	Parameters []GetDataflowInvokeRunParameter `pulumi:"parameters"`
