...
func (*Usage) ElementType() reflect.Type {
	return reflect.TypeOf((*Usage)(nil))
}
...
func (i *Usage) ToUsagePtrOutput() UsagePtrOutput {
	return i.ToUsagePtrOutputWithContext(context.Background())
}

func (i *Usage) ToUsagePtrOutputWithContext(ctx context.Context) UsagePtrOutput {
...
type UsagePtrInput interface {
	...
	ToUsagePtrOutputWithContext(ctx context.Context) UsagePtrOutput
}
...
func (UsageMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Usage)(nil))
}
