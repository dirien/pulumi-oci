...
func (o CustomTableSavedCustomTablePtrOutput) Elem() CustomTableSavedCustomTableOutput {
	return o.ApplyT(func(v *CustomTableSavedCustomTable) CustomTableSavedCustomTable { return *v }).(CustomTableSavedCustomTableOutput)
}
...
func (o QueryQueryDefinitionPtrOutput) Elem() QueryQueryDefinitionOutput {
	return o.ApplyT(func(v *QueryQueryDefinition) QueryQueryDefinition { return *v }).(QueryQueryDefinitionOutput)
}
...
func (o QueryQueryDefinitionCostAnalysisUiPtrOutput) Elem() QueryQueryDefinitionCostAnalysisUiOutput {
	return o.ApplyT(func(v *QueryQueryDefinitionCostAnalysisUi) QueryQueryDefinitionCostAnalysisUi { return *v }).(QueryQueryDefinitionCostAnalysisUiOutput)
}
...
func (o QueryQueryDefinitionReportQueryPtrOutput) Elem() QueryQueryDefinitionReportQueryOutput {
	return o.ApplyT(func(v *QueryQueryDefinitionReportQuery) QueryQueryDefinitionReportQuery { return *v }).(QueryQueryDefinitionReportQueryOutput)
}
...
func (o QueryQueryDefinitionReportQueryForecastPtrOutput) Elem() QueryQueryDefinitionReportQueryForecastOutput {
	return o.ApplyT(func(v *QueryQueryDefinitionReportQueryForecast) QueryQueryDefinitionReportQueryForecast { return *v }).(QueryQueryDefinitionReportQueryForecastOutput)
}
...
func (o UsageForecastPtrOutput) Elem() UsageForecastOutput {
	return o.ApplyT(func(v *UsageForecast) UsageForecast { return *v }).(UsageForecastOutput)
}
...
type GetCustomTablesCustomTableCollectionItem struct {
	...
	SavedCustomTable GetCustomTablesCustomTableCollectionItemSavedCustomTable `pulumi:"savedCustomTable"`
...
type GetCustomTablesCustomTableCollectionItemArgs struct {
	...
	// The custom table for Cost Analysis UI rendering.
	SavedCustomTable GetCustomTablesCustomTableCollectionItemSavedCustomTableInput `pulumi:"savedCustomTable"`
	// The saved report ID in which to list resources.
...
// The custom table for Cost Analysis UI rendering.
func (o GetCustomTablesCustomTableCollectionItemOutput) SavedCustomTable() GetCustomTablesCustomTableCollectionItemSavedCustomTableOutput {
	return o.ApplyT(func(v GetCustomTablesCustomTableCollectionItem) GetCustomTablesCustomTableCollectionItemSavedCustomTable {
		return v.SavedCustomTable
...
type GetQueriesQueryCollectionItem struct {
	...
	QueryDefinition GetQueriesQueryCollectionItemQueryDefinition `pulumi:"queryDefinition"`
}
...
type GetQueriesQueryCollectionItemArgs struct {
	...
	Id pulumi.StringInput `pulumi:"id"`
	// The common fields for queries.
	QueryDefinition GetQueriesQueryCollectionItemQueryDefinitionInput `pulumi:"queryDefinition"`
}
...
// The common fields for queries.
func (o GetQueriesQueryCollectionItemOutput) QueryDefinition() GetQueriesQueryCollectionItemQueryDefinitionOutput {
...
type GetQueriesQueryCollectionItemQueryDefinition struct {
	...
	CostAnalysisUi GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUi `pulumi:"costAnalysisUi"`
	// The query display name. Avoid entering confidential information.
	DisplayName string `pulumi:"displayName"`
	// The request of the generated Cost Analysis report.
	ReportQuery GetQueriesQueryCollectionItemQueryDefinitionReportQuery `pulumi:"reportQuery"`
...
type GetQueriesQueryCollectionItemQueryDefinitionArgs struct {
	// The common fields for Cost Analysis UI rendering.
	CostAnalysisUi GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUiInput `pulumi:"costAnalysisUi"`
	// The query display name. Avoid entering confidential information.
	DisplayName pulumi.StringInput `pulumi:"displayName"`
	// The request of the generated Cost Analysis report.
	ReportQuery GetQueriesQueryCollectionItemQueryDefinitionReportQueryInput `pulumi:"reportQuery"`
	// The saved query version.
	Version pulumi.Float64Input `pulumi:"version"`
}
...
// The common fields for Cost Analysis UI rendering.
func (o GetQueriesQueryCollectionItemQueryDefinitionOutput) CostAnalysisUi() GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUiOutput {
...
// The request of the generated Cost Analysis report.
func (o GetQueriesQueryCollectionItemQueryDefinitionOutput) ReportQuery() GetQueriesQueryCollectionItemQueryDefinitionReportQueryOutput {
...
type GetQueriesQueryCollectionItemQueryDefinitionReportQuery struct {
	...
	Forecast GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecast `pulumi:"forecast"`
...
type GetQueriesQueryCollectionItemQueryDefinitionReportQueryArgs struct {
	...
	// Forecast configuration of usage/cost.
	Forecast GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecastInput `pulumi:"forecast"`
	// The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
	Granularity pulumi.StringInput `pulumi:"granularity"`
	// Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
	GroupBies pulumi.StringArrayInput `pulumi:"groupBies"`
...
// Forecast configuration of usage/cost.
func (o GetQueriesQueryCollectionItemQueryDefinitionReportQueryOutput) Forecast() GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecastOutput {
...
type GetQueryQueryDefinition struct {
	// The common fields for Cost Analysis UI rendering.
	CostAnalysisUi GetQueryQueryDefinitionCostAnalysisUi `pulumi:"costAnalysisUi"`
	// The query display name. Avoid entering confidential information.
	DisplayName string `pulumi:"displayName"`
	// The request of the generated Cost Analysis report.
	ReportQuery GetQueryQueryDefinitionReportQuery `pulumi:"reportQuery"`
	// The saved query version.
	Version float64 `pulumi:"version"`
}
...
type GetQueryQueryDefinitionArgs struct {
	// The common fields for Cost Analysis UI rendering.
	CostAnalysisUi GetQueryQueryDefinitionCostAnalysisUiInput `pulumi:"costAnalysisUi"`
	// The query display name. Avoid entering confidential information.
	DisplayName pulumi.StringInput `pulumi:"displayName"`
	// The request of the generated Cost Analysis report.
	ReportQuery GetQueryQueryDefinitionReportQueryInput `pulumi:"reportQuery"`
	// The saved query version.
	Version pulumi.Float64Input `pulumi:"version"`
}
...
// The common fields for Cost Analysis UI rendering.
func (o GetQueryQueryDefinitionOutput) CostAnalysisUi() GetQueryQueryDefinitionCostAnalysisUiOutput {
	return o.ApplyT(func(v GetQueryQueryDefinition) GetQueryQueryDefinitionCostAnalysisUi { return v.CostAnalysisUi }).(GetQueryQueryDefinitionCostAnalysisUiOutput)
}
...
// The request of the generated Cost Analysis report.
func (o GetQueryQueryDefinitionOutput) ReportQuery() GetQueryQueryDefinitionReportQueryOutput {
	return o.ApplyT(func(v GetQueryQueryDefinition) GetQueryQueryDefinitionReportQuery { return v.ReportQuery }).(GetQueryQueryDefinitionReportQueryOutput)
}
...
type GetQueryQueryDefinitionReportQuery struct {
	...
	Filter        string `pulumi:"filter"`
	// Forecast configuration of usage/cost.
	Forecast GetQueryQueryDefinitionReportQueryForecast `pulumi:"forecast"`
	// The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
	Granularity string `pulumi:"granularity"`
	// Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
	GroupBies []string `pulumi:"groupBies"`
...
type GetQueryQueryDefinitionReportQueryArgs struct {
	...
	Filter        pulumi.StringInput `pulumi:"filter"`
	// Forecast configuration of usage/cost.
	Forecast GetQueryQueryDefinitionReportQueryForecastInput `pulumi:"forecast"`
	// The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
	Granularity pulumi.StringInput `pulumi:"granularity"`
	// Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
	GroupBies pulumi.StringArrayInput `pulumi:"groupBies"`
...
// Forecast configuration of usage/cost.
func (o GetQueryQueryDefinitionReportQueryOutput) Forecast() GetQueryQueryDefinitionReportQueryForecastOutput {
