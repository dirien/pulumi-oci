...
func (*CustomTable) ElementType() reflect.Type {
	return reflect.TypeOf((*CustomTable)(nil))
}
...
func (i *CustomTable) ToCustomTablePtrOutput() CustomTablePtrOutput {
	return i.ToCustomTablePtrOutputWithContext(context.Background())
}

func (i *CustomTable) ToCustomTablePtrOutputWithContext(ctx context.Context) CustomTablePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CustomTablePtrOutput)
}

type CustomTablePtrInput interface {
	pulumi.Input

	ToCustomTablePtrOutput() CustomTablePtrOutput
	ToCustomTablePtrOutputWithContext(ctx context.Context) CustomTablePtrOutput
}

type customTablePtrType CustomTableArgs

func (*customTablePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CustomTable)(nil))
}

func (i *customTablePtrType) ToCustomTablePtrOutput() CustomTablePtrOutput {
	return i.ToCustomTablePtrOutputWithContext(context.Background())
}

func (i *customTablePtrType) ToCustomTablePtrOutputWithContext(ctx context.Context) CustomTablePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CustomTablePtrOutput)
}
...
func (o CustomTableOutput) ToCustomTablePtrOutput() CustomTablePtrOutput {
	return o.ToCustomTablePtrOutputWithContext(context.Background())
}

func (o CustomTableOutput) ToCustomTablePtrOutputWithContext(ctx context.Context) CustomTablePtrOutput {
	return o.ApplyT(func(v CustomTable) *CustomTable {
		return &v
	}).(CustomTablePtrOutput)
}

type CustomTablePtrOutput struct {
	*pulumi.OutputState
}

func (CustomTablePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CustomTable)(nil))
}

func (o CustomTablePtrOutput) ToCustomTablePtrOutput() CustomTablePtrOutput {
	return o
}

func (o CustomTablePtrOutput) ToCustomTablePtrOutputWithContext(ctx context.Context) CustomTablePtrOutput {
	return o
}
...
func (CustomTableMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]CustomTable)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(CustomTablePtrOutput{})
