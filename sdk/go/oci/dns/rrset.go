...
func (i *Rrset) ToRrsetPtrOutput() RrsetPtrOutput {
	return i.ToRrsetPtrOutputWithContext(context.Background())
}

func (i *Rrset) ToRrsetPtrOutputWithContext(ctx context.Context) RrsetPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RrsetPtrOutput)
}

type RrsetPtrInput interface {
	pulumi.Input

	ToRrsetPtrOutput() RrsetPtrOutput
	ToRrsetPtrOutputWithContext(ctx context.Context) RrsetPtrOutput
}

type rrsetPtrType RrsetArgs

func (*rrsetPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Rrset)(nil))
}

func (i *rrsetPtrType) ToRrsetPtrOutput() RrsetPtrOutput {
	return i.ToRrsetPtrOutputWithContext(context.Background())
}

func (i *rrsetPtrType) ToRrsetPtrOutputWithContext(ctx context.Context) RrsetPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RrsetPtrOutput)
}
...
func (o RrsetOutput) ToRrsetPtrOutput() RrsetPtrOutput {
	return o.ToRrsetPtrOutputWithContext(context.Background())
}

func (o RrsetOutput) ToRrsetPtrOutputWithContext(ctx context.Context) RrsetPtrOutput {
	return o.ApplyT(func(v Rrset) *Rrset {
		return &v
	}).(RrsetPtrOutput)
}

type RrsetPtrOutput struct {
	*pulumi.OutputState
}

func (RrsetPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Rrset)(nil))
}

func (o RrsetPtrOutput) ToRrsetPtrOutput() RrsetPtrOutput {
	return o
}

func (o RrsetPtrOutput) ToRrsetPtrOutputWithContext(ctx context.Context) RrsetPtrOutput {
	return o
}
...
func (RrsetMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Rrset)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(RrsetPtrOutput{})
