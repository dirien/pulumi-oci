...
func (*TsigKey) ElementType() reflect.Type {
	return reflect.TypeOf((*TsigKey)(nil))
}
...
func (i *TsigKey) ToTsigKeyPtrOutput() TsigKeyPtrOutput {
	return i.ToTsigKeyPtrOutputWithContext(context.Background())
}

func (i *TsigKey) ToTsigKeyPtrOutputWithContext(ctx context.Context) TsigKeyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TsigKeyPtrOutput)
}

type TsigKeyPtrInput interface {
	pulumi.Input

	ToTsigKeyPtrOutput() TsigKeyPtrOutput
	ToTsigKeyPtrOutputWithContext(ctx context.Context) TsigKeyPtrOutput
}

type tsigKeyPtrType TsigKeyArgs

func (*tsigKeyPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**TsigKey)(nil))
}

func (i *tsigKeyPtrType) ToTsigKeyPtrOutput() TsigKeyPtrOutput {
	return i.ToTsigKeyPtrOutputWithContext(context.Background())
}

func (i *tsigKeyPtrType) ToTsigKeyPtrOutputWithContext(ctx context.Context) TsigKeyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TsigKeyPtrOutput)
}
...
func (o TsigKeyOutput) ToTsigKeyPtrOutput() TsigKeyPtrOutput {
	return o.ToTsigKeyPtrOutputWithContext(context.Background())
}

func (o TsigKeyOutput) ToTsigKeyPtrOutputWithContext(ctx context.Context) TsigKeyPtrOutput {
	return o.ApplyT(func(v TsigKey) *TsigKey {
		return &v
	}).(TsigKeyPtrOutput)
}

type TsigKeyPtrOutput struct {
	*pulumi.OutputState
}

func (TsigKeyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**TsigKey)(nil))
}

func (o TsigKeyPtrOutput) ToTsigKeyPtrOutput() TsigKeyPtrOutput {
	return o
}

func (o TsigKeyPtrOutput) ToTsigKeyPtrOutputWithContext(ctx context.Context) TsigKeyPtrOutput {
	return o
}
...
func (TsigKeyMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]TsigKey)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(TsigKeyPtrOutput{})
