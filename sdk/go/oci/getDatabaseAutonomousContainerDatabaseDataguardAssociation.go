...
// 		_, err := oci.GetDatabaseAutonomousContainerDatabaseDataguardAssociation(ctx, &GetDatabaseAutonomousContainerDatabaseDataguardAssociationArgs{
...
// }
// ```
func GetDatabaseAutonomousContainerDatabaseDataguardAssociation(ctx *pulumi.Context, args *GetDatabaseAutonomousContainerDatabaseDataguardAssociationArgs, opts ...pulumi.InvokeOption) (*GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult, error) {
	var rv GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult
	err := ctx.Invoke("oci:index/getDatabaseAutonomousContainerDatabaseDataguardAssociation:GetDatabaseAutonomousContainerDatabaseDataguardAssociation", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabaseAutonomousContainerDatabaseDataguardAssociationArgs struct {
...
type GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult struct {
