...
// 		_, err := oci.GetCoreIpv6s(ctx, &GetCoreIpv6sArgs{
// 			IpAddress: &opt0,
// 			SubnetId:  &opt1,
// 			VnicId:    &opt2,
// 		}, nil)
...
// }
// ```
func GetCoreIpv6s(ctx *pulumi.Context, args *GetCoreIpv6sArgs, opts ...pulumi.InvokeOption) (*GetCoreIpv6sResult, error) {
	var rv GetCoreIpv6sResult
	err := ctx.Invoke("oci:index/getCoreIpv6s:GetCoreIpv6s", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCoreIpv6sArgs struct {
	Filters []GetCoreIpv6sFilter `pulumi:"filters"`
...
type GetCoreIpv6sResult struct {
	Filters []GetCoreIpv6sFilter `pulumi:"filters"`
	...
	IpAddress *string `pulumi:"ipAddress"`
	// The list of ipv6s.
	Ipv6s []GetCoreIpv6sIpv6 `pulumi:"ipv6s"`
