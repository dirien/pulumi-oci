...
// 		_, err := oci.GetOnsSubscription(ctx, &GetOnsSubscriptionArgs{
...
// }
// ```
func LookupOnsSubscription(ctx *pulumi.Context, args *LookupOnsSubscriptionArgs, opts ...pulumi.InvokeOption) (*LookupOnsSubscriptionResult, error) {
	var rv LookupOnsSubscriptionResult
	err := ctx.Invoke("oci:index/getOnsSubscription:GetOnsSubscription", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOnsSubscriptionArgs struct {
...
type LookupOnsSubscriptionResult struct {
