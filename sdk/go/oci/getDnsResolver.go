...
// 		_, err := oci.GetDnsResolver(ctx, &GetDnsResolverArgs{
...
func LookupDnsResolver(ctx *pulumi.Context, args *LookupDnsResolverArgs, opts ...pulumi.InvokeOption) (*LookupDnsResolverResult, error) {
	...
	err := ctx.Invoke("oci:index/getDnsResolver:GetDnsResolver", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDnsResolverResult struct {
	...
	AttachedViews []GetDnsResolverAttachedView `pulumi:"attachedViews"`
	...
	Endpoints []GetDnsResolverEndpointType `pulumi:"endpoints"`
	...
	Rules []GetDnsResolverRule `pulumi:"rules"`
	Scope string               `pulumi:"scope"`
