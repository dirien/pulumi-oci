...
func (*TagDefault) ElementType() reflect.Type {
	return reflect.TypeOf((*TagDefault)(nil))
}
...
func (i *TagDefault) ToTagDefaultPtrOutput() TagDefaultPtrOutput {
	return i.ToTagDefaultPtrOutputWithContext(context.Background())
}

func (i *TagDefault) ToTagDefaultPtrOutputWithContext(ctx context.Context) TagDefaultPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TagDefaultPtrOutput)
}

type TagDefaultPtrInput interface {
	pulumi.Input

	ToTagDefaultPtrOutput() TagDefaultPtrOutput
	ToTagDefaultPtrOutputWithContext(ctx context.Context) TagDefaultPtrOutput
}

type tagDefaultPtrType TagDefaultArgs

func (*tagDefaultPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**TagDefault)(nil))
}

func (i *tagDefaultPtrType) ToTagDefaultPtrOutput() TagDefaultPtrOutput {
	return i.ToTagDefaultPtrOutputWithContext(context.Background())
}

func (i *tagDefaultPtrType) ToTagDefaultPtrOutputWithContext(ctx context.Context) TagDefaultPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(TagDefaultPtrOutput)
}
...
func (o TagDefaultOutput) ToTagDefaultPtrOutput() TagDefaultPtrOutput {
	return o.ToTagDefaultPtrOutputWithContext(context.Background())
}

func (o TagDefaultOutput) ToTagDefaultPtrOutputWithContext(ctx context.Context) TagDefaultPtrOutput {
	return o.ApplyT(func(v TagDefault) *TagDefault {
		return &v
	}).(TagDefaultPtrOutput)
}

type TagDefaultPtrOutput struct {
	*pulumi.OutputState
}

func (TagDefaultPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**TagDefault)(nil))
}

func (o TagDefaultPtrOutput) ToTagDefaultPtrOutput() TagDefaultPtrOutput {
	return o
}

func (o TagDefaultPtrOutput) ToTagDefaultPtrOutputWithContext(ctx context.Context) TagDefaultPtrOutput {
	return o
}
...
func (TagDefaultMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]TagDefault)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(TagDefaultPtrOutput{})
