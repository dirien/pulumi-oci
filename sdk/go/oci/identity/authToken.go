...
func (*AuthToken) ElementType() reflect.Type {
	return reflect.TypeOf((*AuthToken)(nil))
}
...
func (i *AuthToken) ToAuthTokenPtrOutput() AuthTokenPtrOutput {
	return i.ToAuthTokenPtrOutputWithContext(context.Background())
}

func (i *AuthToken) ToAuthTokenPtrOutputWithContext(ctx context.Context) AuthTokenPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AuthTokenPtrOutput)
}

type AuthTokenPtrInput interface {
	pulumi.Input

	ToAuthTokenPtrOutput() AuthTokenPtrOutput
	ToAuthTokenPtrOutputWithContext(ctx context.Context) AuthTokenPtrOutput
}

type authTokenPtrType AuthTokenArgs

func (*authTokenPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**AuthToken)(nil))
}

func (i *authTokenPtrType) ToAuthTokenPtrOutput() AuthTokenPtrOutput {
	return i.ToAuthTokenPtrOutputWithContext(context.Background())
}

func (i *authTokenPtrType) ToAuthTokenPtrOutputWithContext(ctx context.Context) AuthTokenPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(AuthTokenPtrOutput)
}
...
func (o AuthTokenOutput) ToAuthTokenPtrOutput() AuthTokenPtrOutput {
	return o.ToAuthTokenPtrOutputWithContext(context.Background())
}

func (o AuthTokenOutput) ToAuthTokenPtrOutputWithContext(ctx context.Context) AuthTokenPtrOutput {
	return o.ApplyT(func(v AuthToken) *AuthToken {
		return &v
	}).(AuthTokenPtrOutput)
}

type AuthTokenPtrOutput struct {
	*pulumi.OutputState
}

func (AuthTokenPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**AuthToken)(nil))
}

func (o AuthTokenPtrOutput) ToAuthTokenPtrOutput() AuthTokenPtrOutput {
	return o
}

func (o AuthTokenPtrOutput) ToAuthTokenPtrOutputWithContext(ctx context.Context) AuthTokenPtrOutput {
	return o
}
...
func (AuthTokenMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]AuthToken)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(AuthTokenPtrOutput{})
