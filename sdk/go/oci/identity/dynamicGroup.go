...
func (*DynamicGroup) ElementType() reflect.Type {
	return reflect.TypeOf((*DynamicGroup)(nil))
}
...
func (i *DynamicGroup) ToDynamicGroupPtrOutput() DynamicGroupPtrOutput {
	return i.ToDynamicGroupPtrOutputWithContext(context.Background())
}

func (i *DynamicGroup) ToDynamicGroupPtrOutputWithContext(ctx context.Context) DynamicGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DynamicGroupPtrOutput)
}

type DynamicGroupPtrInput interface {
	pulumi.Input

	ToDynamicGroupPtrOutput() DynamicGroupPtrOutput
	ToDynamicGroupPtrOutputWithContext(ctx context.Context) DynamicGroupPtrOutput
}

type dynamicGroupPtrType DynamicGroupArgs

func (*dynamicGroupPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DynamicGroup)(nil))
}

func (i *dynamicGroupPtrType) ToDynamicGroupPtrOutput() DynamicGroupPtrOutput {
	return i.ToDynamicGroupPtrOutputWithContext(context.Background())
}

func (i *dynamicGroupPtrType) ToDynamicGroupPtrOutputWithContext(ctx context.Context) DynamicGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DynamicGroupPtrOutput)
}
...
type DynamicGroupOutput struct {
	*pulumi.OutputState
}
...
func (o DynamicGroupOutput) ToDynamicGroupPtrOutput() DynamicGroupPtrOutput {
	return o.ToDynamicGroupPtrOutputWithContext(context.Background())
}

func (o DynamicGroupOutput) ToDynamicGroupPtrOutputWithContext(ctx context.Context) DynamicGroupPtrOutput {
	return o.ApplyT(func(v DynamicGroup) *DynamicGroup {
		return &v
	}).(DynamicGroupPtrOutput)
}

type DynamicGroupPtrOutput struct {
	*pulumi.OutputState
}

func (DynamicGroupPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DynamicGroup)(nil))
}

func (o DynamicGroupPtrOutput) ToDynamicGroupPtrOutput() DynamicGroupPtrOutput {
	return o
}

func (o DynamicGroupPtrOutput) ToDynamicGroupPtrOutputWithContext(ctx context.Context) DynamicGroupPtrOutput {
	return o
}
...
func (DynamicGroupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DynamicGroup)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DynamicGroupPtrOutput{})
