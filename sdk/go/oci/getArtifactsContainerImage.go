...
// 		_, err := oci.GetArtifactsContainerImage(ctx, &GetArtifactsContainerImageArgs{
...
// }
// ```
func GetArtifactsContainerImage(ctx *pulumi.Context, args *GetArtifactsContainerImageArgs, opts ...pulumi.InvokeOption) (*GetArtifactsContainerImageResult, error) {
	var rv GetArtifactsContainerImageResult
	err := ctx.Invoke("oci:index/getArtifactsContainerImage:GetArtifactsContainerImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetArtifactsContainerImageArgs struct {
...
type GetArtifactsContainerImageResult struct {
	...
	Layers []GetArtifactsContainerImageLayer `pulumi:"layers"`
	...
	Versions []GetArtifactsContainerImageVersion `pulumi:"versions"`
}
