...
func (o AlarmSuppressionPtrOutput) Elem() AlarmSuppressionOutput {
	return o.ApplyT(func(v *AlarmSuppression) AlarmSuppression { return *v }).(AlarmSuppressionOutput)
}
...
type GetAlarmStatusesAlarmStatus struct {
	...
	Suppression GetAlarmStatusesAlarmStatusSuppression `pulumi:"suppression"`
...
type GetAlarmStatusesAlarmStatusArgs struct {
	...
	// The configuration details for suppressing an alarm.
	Suppression GetAlarmStatusesAlarmStatusSuppressionInput `pulumi:"suppression"`
	// Timestamp for the transition of the alarm state. For example, the time when the alarm transitioned from OK to Firing.  Example: `2019-02-01T01:02:29.600Z`
	TimestampTriggered pulumi.StringInput `pulumi:"timestampTriggered"`
}
...
// The configuration details for suppressing an alarm.
func (o GetAlarmStatusesAlarmStatusOutput) Suppression() GetAlarmStatusesAlarmStatusSuppressionOutput {
	return o.ApplyT(func(v GetAlarmStatusesAlarmStatus) GetAlarmStatusesAlarmStatusSuppression { return v.Suppression }).(GetAlarmStatusesAlarmStatusSuppressionOutput)
}
...
type GetAlarmsAlarm struct {
	...
	// The configuration details for suppressing an alarm.
	Suppression GetAlarmsAlarmSuppression `pulumi:"suppression"`
...
type GetAlarmsAlarmArgs struct {
	...
	// The configuration details for suppressing an alarm.
	Suppression GetAlarmsAlarmSuppressionInput `pulumi:"suppression"`
	// The date and time the alarm was created. Format defined by RFC3339.  Example: `2019-02-01T01:02:29.600Z`
...
// The configuration details for suppressing an alarm.
func (o GetAlarmsAlarmOutput) Suppression() GetAlarmsAlarmSuppressionOutput {
	return o.ApplyT(func(v GetAlarmsAlarm) GetAlarmsAlarmSuppression { return v.Suppression }).(GetAlarmsAlarmSuppressionOutput)
}
