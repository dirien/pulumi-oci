...
// 		_, err := oci.GetOcvpEsxiHost(ctx, &GetOcvpEsxiHostArgs{
...
// }
// ```
func LookupOcvpEsxiHost(ctx *pulumi.Context, args *LookupOcvpEsxiHostArgs, opts ...pulumi.InvokeOption) (*LookupOcvpEsxiHostResult, error) {
	var rv LookupOcvpEsxiHostResult
	err := ctx.Invoke("oci:index/getOcvpEsxiHost:GetOcvpEsxiHost", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOcvpEsxiHostArgs struct {
...
type LookupOcvpEsxiHostResult struct {
