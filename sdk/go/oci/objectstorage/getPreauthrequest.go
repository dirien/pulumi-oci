...
// }
// ```
func GetPreauthrequest(ctx *pulumi.Context, args *GetPreauthrequestArgs, opts ...pulumi.InvokeOption) (*GetPreauthrequestResult, error) {
	var rv GetPreauthrequestResult
...
type GetPreauthrequestArgs struct {
...
type GetPreauthrequestResult struct {
