...
type ObjectstorageBucketRetentionRule struct {
	...
	// (Updatable)
	Duration *ObjectstorageBucketRetentionRuleDuration `pulumi:"duration"`
...
// ObjectstorageBucketRetentionRuleInput is an input type that accepts ObjectstorageBucketRetentionRuleArgs and ObjectstorageBucketRetentionRuleOutput values.
// You can construct a concrete instance of `ObjectstorageBucketRetentionRuleInput` via:
//
//          ObjectstorageBucketRetentionRuleArgs{...}
type ObjectstorageBucketRetentionRuleInput interface {
	pulumi.Input

	ToObjectstorageBucketRetentionRuleOutput() ObjectstorageBucketRetentionRuleOutput
	ToObjectstorageBucketRetentionRuleOutputWithContext(context.Context) ObjectstorageBucketRetentionRuleOutput
}

type ObjectstorageBucketRetentionRuleArgs struct {
	// A user-specified name for the retention rule. Names can be helpful in identifying retention rules. The name should be unique. This attribute is a forcenew attribute
	DisplayName pulumi.StringInput `pulumi:"displayName"`
	// (Updatable)
	Duration ObjectstorageBucketRetentionRuleDurationPtrInput `pulumi:"duration"`
	// Unique identifier for the retention rule.
...
func (ObjectstorageBucketRetentionRuleArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageBucketRetentionRule)(nil)).Elem()
}

func (i ObjectstorageBucketRetentionRuleArgs) ToObjectstorageBucketRetentionRuleOutput() ObjectstorageBucketRetentionRuleOutput {
	return i.ToObjectstorageBucketRetentionRuleOutputWithContext(context.Background())
}

func (i ObjectstorageBucketRetentionRuleArgs) ToObjectstorageBucketRetentionRuleOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageBucketRetentionRuleOutput)
}

// ObjectstorageBucketRetentionRuleArrayInput is an input type that accepts ObjectstorageBucketRetentionRuleArray and ObjectstorageBucketRetentionRuleArrayOutput values.
// You can construct a concrete instance of `ObjectstorageBucketRetentionRuleArrayInput` via:
//
//          ObjectstorageBucketRetentionRuleArray{ ObjectstorageBucketRetentionRuleArgs{...} }
type ObjectstorageBucketRetentionRuleArrayInput interface {
	pulumi.Input

	ToObjectstorageBucketRetentionRuleArrayOutput() ObjectstorageBucketRetentionRuleArrayOutput
	ToObjectstorageBucketRetentionRuleArrayOutputWithContext(context.Context) ObjectstorageBucketRetentionRuleArrayOutput
}

type ObjectstorageBucketRetentionRuleArray []ObjectstorageBucketRetentionRuleInput

func (ObjectstorageBucketRetentionRuleArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ObjectstorageBucketRetentionRule)(nil)).Elem()
}

func (i ObjectstorageBucketRetentionRuleArray) ToObjectstorageBucketRetentionRuleArrayOutput() ObjectstorageBucketRetentionRuleArrayOutput {
	return i.ToObjectstorageBucketRetentionRuleArrayOutputWithContext(context.Background())
}

func (i ObjectstorageBucketRetentionRuleArray) ToObjectstorageBucketRetentionRuleArrayOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageBucketRetentionRuleArrayOutput)
}

type ObjectstorageBucketRetentionRuleOutput struct{ *pulumi.OutputState }

func (ObjectstorageBucketRetentionRuleOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageBucketRetentionRule)(nil)).Elem()
}

func (o ObjectstorageBucketRetentionRuleOutput) ToObjectstorageBucketRetentionRuleOutput() ObjectstorageBucketRetentionRuleOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleOutput) ToObjectstorageBucketRetentionRuleOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleOutput {
	return o
}

// A user-specified name for the retention rule. Names can be helpful in identifying retention rules. The name should be unique. This attribute is a forcenew attribute
func (o ObjectstorageBucketRetentionRuleOutput) DisplayName() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) string { return v.DisplayName }).(pulumi.StringOutput)
}

// (Updatable)
func (o ObjectstorageBucketRetentionRuleOutput) Duration() ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) *ObjectstorageBucketRetentionRuleDuration { return v.Duration }).(ObjectstorageBucketRetentionRuleDurationPtrOutput)
}

// Unique identifier for the retention rule.
func (o ObjectstorageBucketRetentionRuleOutput) RetentionRuleId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) *string { return v.RetentionRuleId }).(pulumi.StringPtrOutput)
}

// The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
func (o ObjectstorageBucketRetentionRuleOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The date and time that the retention rule was modified as per [RFC3339](https://tools.ietf.org/html/rfc3339).
func (o ObjectstorageBucketRetentionRuleOutput) TimeModified() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) *string { return v.TimeModified }).(pulumi.StringPtrOutput)
}

// (Updatable) The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule is locked and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
func (o ObjectstorageBucketRetentionRuleOutput) TimeRuleLocked() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRule) *string { return v.TimeRuleLocked }).(pulumi.StringPtrOutput)
}

type ObjectstorageBucketRetentionRuleArrayOutput struct{ *pulumi.OutputState }

func (ObjectstorageBucketRetentionRuleArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ObjectstorageBucketRetentionRule)(nil)).Elem()
}

func (o ObjectstorageBucketRetentionRuleArrayOutput) ToObjectstorageBucketRetentionRuleArrayOutput() ObjectstorageBucketRetentionRuleArrayOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleArrayOutput) ToObjectstorageBucketRetentionRuleArrayOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleArrayOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleArrayOutput) Index(i pulumi.IntInput) ObjectstorageBucketRetentionRuleOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ObjectstorageBucketRetentionRule {
		return vs[0].([]ObjectstorageBucketRetentionRule)[vs[1].(int)]
	}).(ObjectstorageBucketRetentionRuleOutput)
}

type ObjectstorageBucketRetentionRuleDuration struct {
...
// ObjectstorageBucketRetentionRuleDurationInput is an input type that accepts ObjectstorageBucketRetentionRuleDurationArgs and ObjectstorageBucketRetentionRuleDurationOutput values.
// You can construct a concrete instance of `ObjectstorageBucketRetentionRuleDurationInput` via:
//
//          ObjectstorageBucketRetentionRuleDurationArgs{...}
type ObjectstorageBucketRetentionRuleDurationInput interface {
	pulumi.Input

	ToObjectstorageBucketRetentionRuleDurationOutput() ObjectstorageBucketRetentionRuleDurationOutput
	ToObjectstorageBucketRetentionRuleDurationOutputWithContext(context.Context) ObjectstorageBucketRetentionRuleDurationOutput
}

type ObjectstorageBucketRetentionRuleDurationArgs struct {
	// (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
...
func (ObjectstorageBucketRetentionRuleDurationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageBucketRetentionRuleDuration)(nil)).Elem()
}

func (i ObjectstorageBucketRetentionRuleDurationArgs) ToObjectstorageBucketRetentionRuleDurationOutput() ObjectstorageBucketRetentionRuleDurationOutput {
	return i.ToObjectstorageBucketRetentionRuleDurationOutputWithContext(context.Background())
}

func (i ObjectstorageBucketRetentionRuleDurationArgs) ToObjectstorageBucketRetentionRuleDurationOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageBucketRetentionRuleDurationOutput)
}

func (i ObjectstorageBucketRetentionRuleDurationArgs) ToObjectstorageBucketRetentionRuleDurationPtrOutput() ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return i.ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(context.Background())
}

func (i ObjectstorageBucketRetentionRuleDurationArgs) ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageBucketRetentionRuleDurationOutput).ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(ctx)
}

// ObjectstorageBucketRetentionRuleDurationPtrInput is an input type that accepts ObjectstorageBucketRetentionRuleDurationArgs, ObjectstorageBucketRetentionRuleDurationPtr and ObjectstorageBucketRetentionRuleDurationPtrOutput values.
// You can construct a concrete instance of `ObjectstorageBucketRetentionRuleDurationPtrInput` via:
//
//          ObjectstorageBucketRetentionRuleDurationArgs{...}
//
//  or:
//
//          nil
type ObjectstorageBucketRetentionRuleDurationPtrInput interface {
	pulumi.Input

	ToObjectstorageBucketRetentionRuleDurationPtrOutput() ObjectstorageBucketRetentionRuleDurationPtrOutput
	ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(context.Context) ObjectstorageBucketRetentionRuleDurationPtrOutput
}

type objectstorageBucketRetentionRuleDurationPtrType ObjectstorageBucketRetentionRuleDurationArgs

func ObjectstorageBucketRetentionRuleDurationPtr(v *ObjectstorageBucketRetentionRuleDurationArgs) ObjectstorageBucketRetentionRuleDurationPtrInput {
	return (*objectstorageBucketRetentionRuleDurationPtrType)(v)
}

func (*objectstorageBucketRetentionRuleDurationPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageBucketRetentionRuleDuration)(nil)).Elem()
}

func (i *objectstorageBucketRetentionRuleDurationPtrType) ToObjectstorageBucketRetentionRuleDurationPtrOutput() ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return i.ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(context.Background())
}

func (i *objectstorageBucketRetentionRuleDurationPtrType) ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageBucketRetentionRuleDurationPtrOutput)
}

type ObjectstorageBucketRetentionRuleDurationOutput struct{ *pulumi.OutputState }

func (ObjectstorageBucketRetentionRuleDurationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageBucketRetentionRuleDuration)(nil)).Elem()
}

func (o ObjectstorageBucketRetentionRuleDurationOutput) ToObjectstorageBucketRetentionRuleDurationOutput() ObjectstorageBucketRetentionRuleDurationOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleDurationOutput) ToObjectstorageBucketRetentionRuleDurationOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleDurationOutput) ToObjectstorageBucketRetentionRuleDurationPtrOutput() ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return o.ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(context.Background())
}

func (o ObjectstorageBucketRetentionRuleDurationOutput) ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRuleDuration) *ObjectstorageBucketRetentionRuleDuration {
		return &v
	}).(ObjectstorageBucketRetentionRuleDurationPtrOutput)
}

// (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
func (o ObjectstorageBucketRetentionRuleDurationOutput) TimeAmount() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRuleDuration) string { return v.TimeAmount }).(pulumi.StringOutput)
}

// (Updatable) The unit that should be used to interpret timeAmount.
func (o ObjectstorageBucketRetentionRuleDurationOutput) TimeUnit() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageBucketRetentionRuleDuration) string { return v.TimeUnit }).(pulumi.StringOutput)
}

type ObjectstorageBucketRetentionRuleDurationPtrOutput struct{ *pulumi.OutputState }

func (ObjectstorageBucketRetentionRuleDurationPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageBucketRetentionRuleDuration)(nil)).Elem()
}

func (o ObjectstorageBucketRetentionRuleDurationPtrOutput) ToObjectstorageBucketRetentionRuleDurationPtrOutput() ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleDurationPtrOutput) ToObjectstorageBucketRetentionRuleDurationPtrOutputWithContext(ctx context.Context) ObjectstorageBucketRetentionRuleDurationPtrOutput {
	return o
}

func (o ObjectstorageBucketRetentionRuleDurationPtrOutput) Elem() ObjectstorageBucketRetentionRuleDurationOutput {
	return o.ApplyT(func(v *ObjectstorageBucketRetentionRuleDuration) ObjectstorageBucketRetentionRuleDuration { return *v }).(ObjectstorageBucketRetentionRuleDurationOutput)
}

// (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
func (o ObjectstorageBucketRetentionRuleDurationPtrOutput) TimeAmount() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageBucketRetentionRuleDuration) *string {
		if v == nil {
			return nil
		}
		return &v.TimeAmount
...
// (Updatable) The unit that should be used to interpret timeAmount.
func (o ObjectstorageBucketRetentionRuleDurationPtrOutput) TimeUnit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageBucketRetentionRuleDuration) *string {
		if v == nil {
			return nil
		}
...
type ObjectstorageObjectLifecyclePolicyRule struct {
	...
	ObjectNameFilter *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter `pulumi:"objectNameFilter"`
...
// ObjectstorageObjectLifecyclePolicyRuleInput is an input type that accepts ObjectstorageObjectLifecyclePolicyRuleArgs and ObjectstorageObjectLifecyclePolicyRuleOutput values.
// You can construct a concrete instance of `ObjectstorageObjectLifecyclePolicyRuleInput` via:
//
//          ObjectstorageObjectLifecyclePolicyRuleArgs{...}
type ObjectstorageObjectLifecyclePolicyRuleInput interface {
	pulumi.Input

	ToObjectstorageObjectLifecyclePolicyRuleOutput() ObjectstorageObjectLifecyclePolicyRuleOutput
	ToObjectstorageObjectLifecyclePolicyRuleOutputWithContext(context.Context) ObjectstorageObjectLifecyclePolicyRuleOutput
}

type ObjectstorageObjectLifecyclePolicyRuleArgs struct {
	// (Updatable) The action of the object lifecycle policy rule. Rules using the action 'ARCHIVE' move objects from Standard and InfrequentAccess storage tiers into the [Archive storage tier](https://docs.cloud.oracle.com/iaas/Content/Archive/Concepts/archivestorageoverview.htm). Rules using the action 'INFREQUENT_ACCESS' move objects from Standard storage tier into the Infrequent Access Storage tier. Objects that are already in InfrequentAccess tier or in Archive tier are left untouched. Rules using the action 'DELETE' permanently delete objects from buckets. Rules using 'ABORT' abort the uncommitted multipart-uploads and permanently delete their parts from buckets.
	...
	// (Updatable) A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
	ObjectNameFilter ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrInput `pulumi:"objectNameFilter"`
	// (Updatable) The target of the object lifecycle policy rule. The values of target can be either "objects", "multipart-uploads" or "previous-object-versions". This field when declared as "objects" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for objects. This field when declared as "previous-object-versions" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for previous versions of existing objects. This field when declared as "multipart-uploads" is used to specify the ABORT (only) rule for uncommitted multipart-uploads.
...
func (ObjectstorageObjectLifecyclePolicyRuleArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectLifecyclePolicyRule)(nil)).Elem()
}

func (i ObjectstorageObjectLifecyclePolicyRuleArgs) ToObjectstorageObjectLifecyclePolicyRuleOutput() ObjectstorageObjectLifecyclePolicyRuleOutput {
	return i.ToObjectstorageObjectLifecyclePolicyRuleOutputWithContext(context.Background())
}

func (i ObjectstorageObjectLifecyclePolicyRuleArgs) ToObjectstorageObjectLifecyclePolicyRuleOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectLifecyclePolicyRuleOutput)
}

// ObjectstorageObjectLifecyclePolicyRuleArrayInput is an input type that accepts ObjectstorageObjectLifecyclePolicyRuleArray and ObjectstorageObjectLifecyclePolicyRuleArrayOutput values.
// You can construct a concrete instance of `ObjectstorageObjectLifecyclePolicyRuleArrayInput` via:
//
//          ObjectstorageObjectLifecyclePolicyRuleArray{ ObjectstorageObjectLifecyclePolicyRuleArgs{...} }
type ObjectstorageObjectLifecyclePolicyRuleArrayInput interface {
	pulumi.Input

	ToObjectstorageObjectLifecyclePolicyRuleArrayOutput() ObjectstorageObjectLifecyclePolicyRuleArrayOutput
	ToObjectstorageObjectLifecyclePolicyRuleArrayOutputWithContext(context.Context) ObjectstorageObjectLifecyclePolicyRuleArrayOutput
}

type ObjectstorageObjectLifecyclePolicyRuleArray []ObjectstorageObjectLifecyclePolicyRuleInput

func (ObjectstorageObjectLifecyclePolicyRuleArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ObjectstorageObjectLifecyclePolicyRule)(nil)).Elem()
}

func (i ObjectstorageObjectLifecyclePolicyRuleArray) ToObjectstorageObjectLifecyclePolicyRuleArrayOutput() ObjectstorageObjectLifecyclePolicyRuleArrayOutput {
	return i.ToObjectstorageObjectLifecyclePolicyRuleArrayOutputWithContext(context.Background())
}

func (i ObjectstorageObjectLifecyclePolicyRuleArray) ToObjectstorageObjectLifecyclePolicyRuleArrayOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectLifecyclePolicyRuleArrayOutput)
}

type ObjectstorageObjectLifecyclePolicyRuleOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectLifecyclePolicyRuleOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectLifecyclePolicyRule)(nil)).Elem()
}

func (o ObjectstorageObjectLifecyclePolicyRuleOutput) ToObjectstorageObjectLifecyclePolicyRuleOutput() ObjectstorageObjectLifecyclePolicyRuleOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleOutput) ToObjectstorageObjectLifecyclePolicyRuleOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleOutput {
	return o
}

// (Updatable) The action of the object lifecycle policy rule. Rules using the action 'ARCHIVE' move objects from Standard and InfrequentAccess storage tiers into the [Archive storage tier](https://docs.cloud.oracle.com/iaas/Content/Archive/Concepts/archivestorageoverview.htm). Rules using the action 'INFREQUENT_ACCESS' move objects from Standard storage tier into the Infrequent Access Storage tier. Objects that are already in InfrequentAccess tier or in Archive tier are left untouched. Rules using the action 'DELETE' permanently delete objects from buckets. Rules using 'ABORT' abort the uncommitted multipart-uploads and permanently delete their parts from buckets.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) Action() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) string { return v.Action }).(pulumi.StringOutput)
}

// (Updatable) A Boolean that determines whether this rule is currently enabled.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) IsEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) bool { return v.IsEnabled }).(pulumi.BoolOutput)
}

// (Updatable) The name of the lifecycle rule to be applied.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) string { return v.Name }).(pulumi.StringOutput)
}

// (Updatable) A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) ObjectNameFilter() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter {
		return v.ObjectNameFilter
	}).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput)
}

// (Updatable) The target of the object lifecycle policy rule. The values of target can be either "objects", "multipart-uploads" or "previous-object-versions". This field when declared as "objects" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for objects. This field when declared as "previous-object-versions" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for previous versions of existing objects. This field when declared as "multipart-uploads" is used to specify the ABORT (only) rule for uncommitted multipart-uploads.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) Target() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) *string { return v.Target }).(pulumi.StringPtrOutput)
}

// (Updatable) Specifies the age of objects to apply the rule to. The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified time.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) TimeAmount() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) string { return v.TimeAmount }).(pulumi.StringOutput)
}

// (Updatable) The unit that should be used to interpret timeAmount.  Days are defined as starting and ending at midnight UTC. Years are defined as 365.2425 days long and likewise round up to the next midnight UTC.
func (o ObjectstorageObjectLifecyclePolicyRuleOutput) TimeUnit() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRule) string { return v.TimeUnit }).(pulumi.StringOutput)
}

type ObjectstorageObjectLifecyclePolicyRuleArrayOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectLifecyclePolicyRuleArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ObjectstorageObjectLifecyclePolicyRule)(nil)).Elem()
}

func (o ObjectstorageObjectLifecyclePolicyRuleArrayOutput) ToObjectstorageObjectLifecyclePolicyRuleArrayOutput() ObjectstorageObjectLifecyclePolicyRuleArrayOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleArrayOutput) ToObjectstorageObjectLifecyclePolicyRuleArrayOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleArrayOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleArrayOutput) Index(i pulumi.IntInput) ObjectstorageObjectLifecyclePolicyRuleOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ObjectstorageObjectLifecyclePolicyRule {
		return vs[0].([]ObjectstorageObjectLifecyclePolicyRule)[vs[1].(int)]
	}).(ObjectstorageObjectLifecyclePolicyRuleOutput)
}

type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter struct {
...
// ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterInput is an input type that accepts ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs and ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput values.
// You can construct a concrete instance of `ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterInput` via:
//
//          ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs{...}
type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterInput interface {
	pulumi.Input

	ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput
	ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutputWithContext(context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput
}

type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs struct {
	// (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
...
func (ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter)(nil)).Elem()
}

func (i ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput {
	return i.ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutputWithContext(context.Background())
}

func (i ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput)
}

func (i ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return i.ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(context.Background())
}

func (i ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput).ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(ctx)
}

// ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrInput is an input type that accepts ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs, ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtr and ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput values.
// You can construct a concrete instance of `ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrInput` via:
//
//          ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs{...}
//
//  or:
//
//          nil
type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrInput interface {
	pulumi.Input

	ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput
	ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput
}

type objectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrType ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs

func ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtr(v *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterArgs) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrInput {
	return (*objectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrType)(v)
}

func (*objectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter)(nil)).Elem()
}

func (i *objectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrType) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return i.ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(context.Background())
}

func (i *objectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrType) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput)
}

type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter)(nil)).Elem()
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return o.ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(context.Background())
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter {
		return &v
	}).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput)
}

// (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) ExclusionPatterns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string { return v.ExclusionPatterns }).(pulumi.StringArrayOutput)
}

// (Updatable) An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) InclusionPatterns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string { return v.InclusionPatterns }).(pulumi.StringArrayOutput)
}

// (Updatable) An array of object name prefixes that the rule will apply to. An empty array means to include all objects.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput) InclusionPrefixes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string { return v.InclusionPrefixes }).(pulumi.StringArrayOutput)
}

type ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter)(nil)).Elem()
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) ToObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutputWithContext(ctx context.Context) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput {
	return o
}

func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) Elem() ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput {
	return o.ApplyT(func(v *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter {
		return *v
	}).(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput)
}

// (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) ExclusionPatterns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string {
		if v == nil {
			return nil
		}
...
// (Updatable) An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) InclusionPatterns() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string {
		if v == nil {
			return nil
		}
...
// (Updatable) An array of object name prefixes that the rule will apply to. An empty array means to include all objects.
func (o ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput) InclusionPrefixes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter) []string {
		if v == nil {
			return nil
		}
...
type ObjectstorageObjectSourceUriDetails struct {
...
// ObjectstorageObjectSourceUriDetailsInput is an input type that accepts ObjectstorageObjectSourceUriDetailsArgs and ObjectstorageObjectSourceUriDetailsOutput values.
// You can construct a concrete instance of `ObjectstorageObjectSourceUriDetailsInput` via:
//
//          ObjectstorageObjectSourceUriDetailsArgs{...}
type ObjectstorageObjectSourceUriDetailsInput interface {
	pulumi.Input

	ToObjectstorageObjectSourceUriDetailsOutput() ObjectstorageObjectSourceUriDetailsOutput
	ToObjectstorageObjectSourceUriDetailsOutputWithContext(context.Context) ObjectstorageObjectSourceUriDetailsOutput
}

type ObjectstorageObjectSourceUriDetailsArgs struct {
	// The name of the bucket for the source object.
...
func (ObjectstorageObjectSourceUriDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectSourceUriDetails)(nil)).Elem()
}

func (i ObjectstorageObjectSourceUriDetailsArgs) ToObjectstorageObjectSourceUriDetailsOutput() ObjectstorageObjectSourceUriDetailsOutput {
	return i.ToObjectstorageObjectSourceUriDetailsOutputWithContext(context.Background())
}

func (i ObjectstorageObjectSourceUriDetailsArgs) ToObjectstorageObjectSourceUriDetailsOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectSourceUriDetailsOutput)
}

func (i ObjectstorageObjectSourceUriDetailsArgs) ToObjectstorageObjectSourceUriDetailsPtrOutput() ObjectstorageObjectSourceUriDetailsPtrOutput {
	return i.ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(context.Background())
}

func (i ObjectstorageObjectSourceUriDetailsArgs) ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectSourceUriDetailsOutput).ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(ctx)
}

// ObjectstorageObjectSourceUriDetailsPtrInput is an input type that accepts ObjectstorageObjectSourceUriDetailsArgs, ObjectstorageObjectSourceUriDetailsPtr and ObjectstorageObjectSourceUriDetailsPtrOutput values.
// You can construct a concrete instance of `ObjectstorageObjectSourceUriDetailsPtrInput` via:
//
//          ObjectstorageObjectSourceUriDetailsArgs{...}
//
//  or:
//
//          nil
type ObjectstorageObjectSourceUriDetailsPtrInput interface {
	pulumi.Input

	ToObjectstorageObjectSourceUriDetailsPtrOutput() ObjectstorageObjectSourceUriDetailsPtrOutput
	ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(context.Context) ObjectstorageObjectSourceUriDetailsPtrOutput
}

type objectstorageObjectSourceUriDetailsPtrType ObjectstorageObjectSourceUriDetailsArgs

func ObjectstorageObjectSourceUriDetailsPtr(v *ObjectstorageObjectSourceUriDetailsArgs) ObjectstorageObjectSourceUriDetailsPtrInput {
	return (*objectstorageObjectSourceUriDetailsPtrType)(v)
}

func (*objectstorageObjectSourceUriDetailsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageObjectSourceUriDetails)(nil)).Elem()
}

func (i *objectstorageObjectSourceUriDetailsPtrType) ToObjectstorageObjectSourceUriDetailsPtrOutput() ObjectstorageObjectSourceUriDetailsPtrOutput {
	return i.ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(context.Background())
}

func (i *objectstorageObjectSourceUriDetailsPtrType) ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ObjectstorageObjectSourceUriDetailsPtrOutput)
}

type ObjectstorageObjectSourceUriDetailsOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectSourceUriDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ObjectstorageObjectSourceUriDetails)(nil)).Elem()
}

func (o ObjectstorageObjectSourceUriDetailsOutput) ToObjectstorageObjectSourceUriDetailsOutput() ObjectstorageObjectSourceUriDetailsOutput {
	return o
}

func (o ObjectstorageObjectSourceUriDetailsOutput) ToObjectstorageObjectSourceUriDetailsOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsOutput {
	return o
}

func (o ObjectstorageObjectSourceUriDetailsOutput) ToObjectstorageObjectSourceUriDetailsPtrOutput() ObjectstorageObjectSourceUriDetailsPtrOutput {
	return o.ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(context.Background())
}

func (o ObjectstorageObjectSourceUriDetailsOutput) ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) *ObjectstorageObjectSourceUriDetails {
		return &v
	}).(ObjectstorageObjectSourceUriDetailsPtrOutput)
}

// The name of the bucket for the source object.
func (o ObjectstorageObjectSourceUriDetailsOutput) Bucket() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) string { return v.Bucket }).(pulumi.StringOutput)
}

// The entity tag to match the target object.
func (o ObjectstorageObjectSourceUriDetailsOutput) DestinationObjectIfMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) *string { return v.DestinationObjectIfMatchEtag }).(pulumi.StringPtrOutput)
}

// The entity tag to not match the target object.
func (o ObjectstorageObjectSourceUriDetailsOutput) DestinationObjectIfNoneMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) *string { return v.DestinationObjectIfNoneMatchEtag }).(pulumi.StringPtrOutput)
}

// The top-level namespace of the source object.
func (o ObjectstorageObjectSourceUriDetailsOutput) Namespace() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) string { return v.Namespace }).(pulumi.StringOutput)
}

// The name of the source object.
func (o ObjectstorageObjectSourceUriDetailsOutput) Object() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) string { return v.Object }).(pulumi.StringOutput)
}

// The region of the source object.
func (o ObjectstorageObjectSourceUriDetailsOutput) Region() pulumi.StringOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) string { return v.Region }).(pulumi.StringOutput)
}

// The entity tag to match the source object.
func (o ObjectstorageObjectSourceUriDetailsOutput) SourceObjectIfMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) *string { return v.SourceObjectIfMatchEtag }).(pulumi.StringPtrOutput)
}

// The version id of the object to be restored.
func (o ObjectstorageObjectSourceUriDetailsOutput) SourceVersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ObjectstorageObjectSourceUriDetails) *string { return v.SourceVersionId }).(pulumi.StringPtrOutput)
}

type ObjectstorageObjectSourceUriDetailsPtrOutput struct{ *pulumi.OutputState }

func (ObjectstorageObjectSourceUriDetailsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ObjectstorageObjectSourceUriDetails)(nil)).Elem()
}

func (o ObjectstorageObjectSourceUriDetailsPtrOutput) ToObjectstorageObjectSourceUriDetailsPtrOutput() ObjectstorageObjectSourceUriDetailsPtrOutput {
	return o
}

func (o ObjectstorageObjectSourceUriDetailsPtrOutput) ToObjectstorageObjectSourceUriDetailsPtrOutputWithContext(ctx context.Context) ObjectstorageObjectSourceUriDetailsPtrOutput {
	return o
}

func (o ObjectstorageObjectSourceUriDetailsPtrOutput) Elem() ObjectstorageObjectSourceUriDetailsOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) ObjectstorageObjectSourceUriDetails { return *v }).(ObjectstorageObjectSourceUriDetailsOutput)
}

// The name of the bucket for the source object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) Bucket() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
		return &v.Bucket
...
// The entity tag to match the target object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) DestinationObjectIfMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The entity tag to not match the target object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) DestinationObjectIfNoneMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The top-level namespace of the source object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) Namespace() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The name of the source object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) Object() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The region of the source object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) Region() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The entity tag to match the source object.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) SourceObjectIfMatchEtag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
// The version id of the object to be restored.
func (o ObjectstorageObjectSourceUriDetailsPtrOutput) SourceVersionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ObjectstorageObjectSourceUriDetails) *string {
		if v == nil {
			return nil
		}
...
type GetBucketRetentionRule struct {
	...
	DisplayName string                         `pulumi:"displayName"`
	Duration    GetBucketRetentionRuleDuration `pulumi:"duration"`
	// Unique identifier for the retention rule.
	RetentionRuleId string `pulumi:"retentionRuleId"`
	// The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
	TimeCreated string `pulumi:"timeCreated"`
...
type GetBucketRetentionRuleArgs struct {
	// User specified name for the retention rule.
	DisplayName pulumi.StringInput                  `pulumi:"displayName"`
	Duration    GetBucketRetentionRuleDurationInput `pulumi:"duration"`
	// Unique identifier for the retention rule.
...
func (o GetBucketRetentionRuleOutput) Duration() GetBucketRetentionRuleDurationOutput {
	return o.ApplyT(func(v GetBucketRetentionRule) GetBucketRetentionRuleDuration { return v.Duration }).(GetBucketRetentionRuleDurationOutput)
}
...
type GetBucketSummariesBucketSummaryRetentionRule struct {
	DisplayName     string                                               `pulumi:"displayName"`
	Duration        GetBucketSummariesBucketSummaryRetentionRuleDuration `pulumi:"duration"`
	RetentionRuleId string                                               `pulumi:"retentionRuleId"`
	// The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
	TimeCreated    string `pulumi:"timeCreated"`
	TimeModified   string `pulumi:"timeModified"`
...
type GetBucketSummariesBucketSummaryRetentionRuleArgs struct {
	DisplayName     pulumi.StringInput                                        `pulumi:"displayName"`
	Duration        GetBucketSummariesBucketSummaryRetentionRuleDurationInput `pulumi:"duration"`
	RetentionRuleId pulumi.StringInput                                        `pulumi:"retentionRuleId"`
	// The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
	TimeCreated    pulumi.StringInput `pulumi:"timeCreated"`
	TimeModified   pulumi.StringInput `pulumi:"timeModified"`
...
func (o GetBucketSummariesBucketSummaryRetentionRuleOutput) Duration() GetBucketSummariesBucketSummaryRetentionRuleDurationOutput {
...
type GetObjectLifecyclePolicyRule struct {
	...
	ObjectNameFilter GetObjectLifecyclePolicyRuleObjectNameFilter `pulumi:"objectNameFilter"`
...
type GetObjectLifecyclePolicyRuleArgs struct {
	...
	Name pulumi.StringInput `pulumi:"name"`
	// A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
	ObjectNameFilter GetObjectLifecyclePolicyRuleObjectNameFilterInput `pulumi:"objectNameFilter"`
	// The target of the object lifecycle policy rule. The values of target can be either "objects", "multipart-uploads" or "previous-object-versions". This field when declared as "objects" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for objects. This field when declared as "previous-object-versions" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for previous versions of existing objects. This field when declared as "multipart-uploads" is used to specify the ABORT (only) rule for uncommitted multipart-uploads.
...
// A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
func (o GetObjectLifecyclePolicyRuleOutput) ObjectNameFilter() GetObjectLifecyclePolicyRuleObjectNameFilterOutput {
...
func init() {
	pulumi.RegisterOutputType(ObjectstorageBucketRetentionRuleOutput{})
	pulumi.RegisterOutputType(ObjectstorageBucketRetentionRuleArrayOutput{})
	pulumi.RegisterOutputType(ObjectstorageBucketRetentionRuleDurationOutput{})
	pulumi.RegisterOutputType(ObjectstorageBucketRetentionRuleDurationPtrOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectLifecyclePolicyRuleOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectLifecyclePolicyRuleArrayOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectLifecyclePolicyRuleObjectNameFilterPtrOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectSourceUriDetailsOutput{})
	pulumi.RegisterOutputType(ObjectstorageObjectSourceUriDetailsPtrOutput{})
