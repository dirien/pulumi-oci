...
// 		_, err := oci.GetCloudGuardDetectorRecipes(ctx, &GetCloudGuardDetectorRecipesArgs{
...
// }
// ```
func GetCloudGuardDetectorRecipes(ctx *pulumi.Context, args *GetCloudGuardDetectorRecipesArgs, opts ...pulumi.InvokeOption) (*GetCloudGuardDetectorRecipesResult, error) {
	var rv GetCloudGuardDetectorRecipesResult
	err := ctx.Invoke("oci:index/getCloudGuardDetectorRecipes:GetCloudGuardDetectorRecipes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCloudGuardDetectorRecipesArgs struct {
	...
	Filters     []GetCloudGuardDetectorRecipesFilter `pulumi:"filters"`
...
type GetCloudGuardDetectorRecipesResult struct {
	AccessLevel *string `pulumi:"accessLevel"`
	// compartmentId of detector recipe
	CompartmentId          string `pulumi:"compartmentId"`
	CompartmentIdInSubtree *bool  `pulumi:"compartmentIdInSubtree"`
	// The list of detector_recipe_collection.
	DetectorRecipeCollections []GetCloudGuardDetectorRecipesDetectorRecipeCollection `pulumi:"detectorRecipeCollections"`
	// displayName
	DisplayName *string                              `pulumi:"displayName"`
	Filters     []GetCloudGuardDetectorRecipesFilter `pulumi:"filters"`
