...
func (i *Peer) ToPeerPtrOutput() PeerPtrOutput {
	return i.ToPeerPtrOutputWithContext(context.Background())
}

func (i *Peer) ToPeerPtrOutputWithContext(ctx context.Context) PeerPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PeerPtrOutput)
}

type PeerPtrInput interface {
	pulumi.Input

	ToPeerPtrOutput() PeerPtrOutput
	ToPeerPtrOutputWithContext(ctx context.Context) PeerPtrOutput
}

type peerPtrType PeerArgs

func (*peerPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Peer)(nil))
}

func (i *peerPtrType) ToPeerPtrOutput() PeerPtrOutput {
	return i.ToPeerPtrOutputWithContext(context.Background())
}

func (i *peerPtrType) ToPeerPtrOutputWithContext(ctx context.Context) PeerPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PeerPtrOutput)
}
...
func (o PeerOutput) ToPeerPtrOutput() PeerPtrOutput {
	return o.ToPeerPtrOutputWithContext(context.Background())
}

func (o PeerOutput) ToPeerPtrOutputWithContext(ctx context.Context) PeerPtrOutput {
	return o.ApplyT(func(v Peer) *Peer {
		return &v
	}).(PeerPtrOutput)
}

type PeerPtrOutput struct {
	*pulumi.OutputState
}

func (PeerPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Peer)(nil))
}

func (o PeerPtrOutput) ToPeerPtrOutput() PeerPtrOutput {
	return o
}

func (o PeerPtrOutput) ToPeerPtrOutputWithContext(ctx context.Context) PeerPtrOutput {
	return o
}
...
func (PeerMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Peer)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(PeerPtrOutput{})
