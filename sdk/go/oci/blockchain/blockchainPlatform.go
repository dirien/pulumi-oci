...
type BlockchainPlatform struct {
	...
	ComponentDetails BlockchainPlatformComponentDetailsOutput `pulumi:"componentDetails"`
...
type blockchainPlatformState struct {
	...
	// Blockchain Platform component details.
	ComponentDetails *BlockchainPlatformComponentDetails `pulumi:"componentDetails"`
	// Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
...
type BlockchainPlatformState struct {
	...
	// Blockchain Platform component details.
	ComponentDetails BlockchainPlatformComponentDetailsPtrInput
	// Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
...
func (*BlockchainPlatform) ElementType() reflect.Type {
	return reflect.TypeOf((*BlockchainPlatform)(nil))
}
...
func (i *BlockchainPlatform) ToBlockchainPlatformPtrOutput() BlockchainPlatformPtrOutput {
	return i.ToBlockchainPlatformPtrOutputWithContext(context.Background())
}

func (i *BlockchainPlatform) ToBlockchainPlatformPtrOutputWithContext(ctx context.Context) BlockchainPlatformPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BlockchainPlatformPtrOutput)
}

type BlockchainPlatformPtrInput interface {
	pulumi.Input

	ToBlockchainPlatformPtrOutput() BlockchainPlatformPtrOutput
	ToBlockchainPlatformPtrOutputWithContext(ctx context.Context) BlockchainPlatformPtrOutput
}

type blockchainPlatformPtrType BlockchainPlatformArgs

func (*blockchainPlatformPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**BlockchainPlatform)(nil))
}

func (i *blockchainPlatformPtrType) ToBlockchainPlatformPtrOutput() BlockchainPlatformPtrOutput {
	return i.ToBlockchainPlatformPtrOutputWithContext(context.Background())
}

func (i *blockchainPlatformPtrType) ToBlockchainPlatformPtrOutputWithContext(ctx context.Context) BlockchainPlatformPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BlockchainPlatformPtrOutput)
}
...
type BlockchainPlatformOutput struct {
	*pulumi.OutputState
}
...
func (o BlockchainPlatformOutput) ToBlockchainPlatformPtrOutput() BlockchainPlatformPtrOutput {
	return o.ToBlockchainPlatformPtrOutputWithContext(context.Background())
}

func (o BlockchainPlatformOutput) ToBlockchainPlatformPtrOutputWithContext(ctx context.Context) BlockchainPlatformPtrOutput {
	return o.ApplyT(func(v BlockchainPlatform) *BlockchainPlatform {
		return &v
	}).(BlockchainPlatformPtrOutput)
}

type BlockchainPlatformPtrOutput struct {
	*pulumi.OutputState
}

func (BlockchainPlatformPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**BlockchainPlatform)(nil))
}

func (o BlockchainPlatformPtrOutput) ToBlockchainPlatformPtrOutput() BlockchainPlatformPtrOutput {
	return o
}

func (o BlockchainPlatformPtrOutput) ToBlockchainPlatformPtrOutputWithContext(ctx context.Context) BlockchainPlatformPtrOutput {
	return o
}
...
func (BlockchainPlatformMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]BlockchainPlatform)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(BlockchainPlatformPtrOutput{})
