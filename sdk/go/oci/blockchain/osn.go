...
func (i *Osn) ToOsnPtrOutput() OsnPtrOutput {
	return i.ToOsnPtrOutputWithContext(context.Background())
}

func (i *Osn) ToOsnPtrOutputWithContext(ctx context.Context) OsnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OsnPtrOutput)
}

type OsnPtrInput interface {
	pulumi.Input

	ToOsnPtrOutput() OsnPtrOutput
	ToOsnPtrOutputWithContext(ctx context.Context) OsnPtrOutput
}

type osnPtrType OsnArgs

func (*osnPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Osn)(nil))
}

func (i *osnPtrType) ToOsnPtrOutput() OsnPtrOutput {
	return i.ToOsnPtrOutputWithContext(context.Background())
}

func (i *osnPtrType) ToOsnPtrOutputWithContext(ctx context.Context) OsnPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OsnPtrOutput)
}
...
func (o OsnOutput) ToOsnPtrOutput() OsnPtrOutput {
	return o.ToOsnPtrOutputWithContext(context.Background())
}

func (o OsnOutput) ToOsnPtrOutputWithContext(ctx context.Context) OsnPtrOutput {
	return o.ApplyT(func(v Osn) *Osn {
		return &v
	}).(OsnPtrOutput)
}

type OsnPtrOutput struct {
	*pulumi.OutputState
}

func (OsnPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Osn)(nil))
}

func (o OsnPtrOutput) ToOsnPtrOutput() OsnPtrOutput {
	return o
}

func (o OsnPtrOutput) ToOsnPtrOutputWithContext(ctx context.Context) OsnPtrOutput {
	return o
}
...
func (OsnMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Osn)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(OsnPtrOutput{})
