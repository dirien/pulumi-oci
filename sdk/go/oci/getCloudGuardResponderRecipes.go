...
// 		_, err := oci.GetCloudGuardResponderRecipes(ctx, &GetCloudGuardResponderRecipesArgs{
...
// }
// ```
func GetCloudGuardResponderRecipes(ctx *pulumi.Context, args *GetCloudGuardResponderRecipesArgs, opts ...pulumi.InvokeOption) (*GetCloudGuardResponderRecipesResult, error) {
	var rv GetCloudGuardResponderRecipesResult
	err := ctx.Invoke("oci:index/getCloudGuardResponderRecipes:GetCloudGuardResponderRecipes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCloudGuardResponderRecipesArgs struct {
	...
	Filters     []GetCloudGuardResponderRecipesFilter `pulumi:"filters"`
...
type GetCloudGuardResponderRecipesResult struct {
	AccessLevel *string `pulumi:"accessLevel"`
	...
	ResponderRecipeCollections []GetCloudGuardResponderRecipesResponderRecipeCollection `pulumi:"responderRecipeCollections"`
