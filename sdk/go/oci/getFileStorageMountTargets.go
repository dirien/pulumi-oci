...
// 		_, err := oci.GetFileStorageMountTargets(ctx, &GetFileStorageMountTargetsArgs{
...
// }
// ```
func GetFileStorageMountTargets(ctx *pulumi.Context, args *GetFileStorageMountTargetsArgs, opts ...pulumi.InvokeOption) (*GetFileStorageMountTargetsResult, error) {
	var rv GetFileStorageMountTargetsResult
	err := ctx.Invoke("oci:index/getFileStorageMountTargets:GetFileStorageMountTargets", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetFileStorageMountTargetsArgs struct {
	...
	Filters     []GetFileStorageMountTargetsFilter `pulumi:"filters"`
...
type GetFileStorageMountTargetsResult struct {
	...
	MountTargets []GetFileStorageMountTargetsMountTarget `pulumi:"mountTargets"`
