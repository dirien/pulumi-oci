...
func (*LogAnalyticsLogGroup) ElementType() reflect.Type {
	return reflect.TypeOf((*LogAnalyticsLogGroup)(nil))
}
...
func (i *LogAnalyticsLogGroup) ToLogAnalyticsLogGroupPtrOutput() LogAnalyticsLogGroupPtrOutput {
	return i.ToLogAnalyticsLogGroupPtrOutputWithContext(context.Background())
}

func (i *LogAnalyticsLogGroup) ToLogAnalyticsLogGroupPtrOutputWithContext(ctx context.Context) LogAnalyticsLogGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogAnalyticsLogGroupPtrOutput)
}

type LogAnalyticsLogGroupPtrInput interface {
	pulumi.Input

	ToLogAnalyticsLogGroupPtrOutput() LogAnalyticsLogGroupPtrOutput
	ToLogAnalyticsLogGroupPtrOutputWithContext(ctx context.Context) LogAnalyticsLogGroupPtrOutput
}

type logAnalyticsLogGroupPtrType LogAnalyticsLogGroupArgs

func (*logAnalyticsLogGroupPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**LogAnalyticsLogGroup)(nil))
}

func (i *logAnalyticsLogGroupPtrType) ToLogAnalyticsLogGroupPtrOutput() LogAnalyticsLogGroupPtrOutput {
	return i.ToLogAnalyticsLogGroupPtrOutputWithContext(context.Background())
}

func (i *logAnalyticsLogGroupPtrType) ToLogAnalyticsLogGroupPtrOutputWithContext(ctx context.Context) LogAnalyticsLogGroupPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogAnalyticsLogGroupPtrOutput)
}
...
type LogAnalyticsLogGroupOutput struct {
	*pulumi.OutputState
}
...
func (o LogAnalyticsLogGroupOutput) ToLogAnalyticsLogGroupPtrOutput() LogAnalyticsLogGroupPtrOutput {
	return o.ToLogAnalyticsLogGroupPtrOutputWithContext(context.Background())
}

func (o LogAnalyticsLogGroupOutput) ToLogAnalyticsLogGroupPtrOutputWithContext(ctx context.Context) LogAnalyticsLogGroupPtrOutput {
	return o.ApplyT(func(v LogAnalyticsLogGroup) *LogAnalyticsLogGroup {
		return &v
	}).(LogAnalyticsLogGroupPtrOutput)
}

type LogAnalyticsLogGroupPtrOutput struct {
	*pulumi.OutputState
}

func (LogAnalyticsLogGroupPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**LogAnalyticsLogGroup)(nil))
}

func (o LogAnalyticsLogGroupPtrOutput) ToLogAnalyticsLogGroupPtrOutput() LogAnalyticsLogGroupPtrOutput {
	return o
}

func (o LogAnalyticsLogGroupPtrOutput) ToLogAnalyticsLogGroupPtrOutputWithContext(ctx context.Context) LogAnalyticsLogGroupPtrOutput {
	return o
}
...
func (LogAnalyticsLogGroupMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]LogAnalyticsLogGroup)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(LogAnalyticsLogGroupPtrOutput{})
