...
func (i *Log) ToLogPtrOutput() LogPtrOutput {
	return i.ToLogPtrOutputWithContext(context.Background())
}

func (i *Log) ToLogPtrOutputWithContext(ctx context.Context) LogPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogPtrOutput)
}

type LogPtrInput interface {
	pulumi.Input

	ToLogPtrOutput() LogPtrOutput
	ToLogPtrOutputWithContext(ctx context.Context) LogPtrOutput
}

type logPtrType LogArgs

func (*logPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Log)(nil))
}

func (i *logPtrType) ToLogPtrOutput() LogPtrOutput {
	return i.ToLogPtrOutputWithContext(context.Background())
}

func (i *logPtrType) ToLogPtrOutputWithContext(ctx context.Context) LogPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogPtrOutput)
}
...
func (o LogOutput) ToLogPtrOutput() LogPtrOutput {
	return o.ToLogPtrOutputWithContext(context.Background())
}

func (o LogOutput) ToLogPtrOutputWithContext(ctx context.Context) LogPtrOutput {
	return o.ApplyT(func(v Log) *Log {
		return &v
	}).(LogPtrOutput)
}

type LogPtrOutput struct {
	*pulumi.OutputState
}

func (LogPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Log)(nil))
}

func (o LogPtrOutput) ToLogPtrOutput() LogPtrOutput {
	return o
}

func (o LogPtrOutput) ToLogPtrOutputWithContext(ctx context.Context) LogPtrOutput {
	return o
}
...
func (LogMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Log)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(LogPtrOutput{})
