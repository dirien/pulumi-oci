...
// 		_, err := oci.GetCoreImage(ctx, &GetCoreImageArgs{
...
// }
// ```
func LookupCoreImage(ctx *pulumi.Context, args *LookupCoreImageArgs, opts ...pulumi.InvokeOption) (*LookupCoreImageResult, error) {
	var rv LookupCoreImageResult
	err := ctx.Invoke("oci:index/getCoreImage:GetCoreImage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreImageArgs struct {
...
type LookupCoreImageResult struct {
	// Oracle Cloud Agent features supported on the image.
	AgentFeatures GetCoreImageAgentFeatures `pulumi:"agentFeatures"`
	...
	Id                 string                         `pulumi:"id"`
	ImageId            string                         `pulumi:"imageId"`
	ImageSourceDetails GetCoreImageImageSourceDetails `pulumi:"imageSourceDetails"`
	InstanceId         string                         `pulumi:"instanceId"`
	// Specifies the configuration mode for launching virtual machine (VM) instances. The configuration modes are:
	LaunchMode string `pulumi:"launchMode"`
	// Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
	LaunchOptions GetCoreImageLaunchOptions `pulumi:"launchOptions"`
