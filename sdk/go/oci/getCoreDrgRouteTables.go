...
// 		_, err := oci.GetCoreDrgRouteTables(ctx, &GetCoreDrgRouteTablesArgs{
...
// }
// ```
func GetCoreDrgRouteTables(ctx *pulumi.Context, args *GetCoreDrgRouteTablesArgs, opts ...pulumi.InvokeOption) (*GetCoreDrgRouteTablesResult, error) {
	var rv GetCoreDrgRouteTablesResult
	err := ctx.Invoke("oci:index/getCoreDrgRouteTables:GetCoreDrgRouteTables", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCoreDrgRouteTablesArgs struct {
	// A filter to return only resources that match the given display name exactly.
	DisplayName *string `pulumi:"displayName"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG.
	DrgId   string                        `pulumi:"drgId"`
	Filters []GetCoreDrgRouteTablesFilter `pulumi:"filters"`
...
type GetCoreDrgRouteTablesResult struct {
	...
	DrgRouteTables []GetCoreDrgRouteTablesDrgRouteTable `pulumi:"drgRouteTables"`
	Filters        []GetCoreDrgRouteTablesFilter        `pulumi:"filters"`
