...
type Script struct {
	...
	MonitorStatusCountMap ScriptMonitorStatusCountMapOutput `pulumi:"monitorStatusCountMap"`
...
type scriptState struct {
	...
	// Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
	MonitorStatusCountMap *ScriptMonitorStatusCountMap `pulumi:"monitorStatusCountMap"`
	// (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
...
type ScriptState struct {
	...
	// Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
	MonitorStatusCountMap ScriptMonitorStatusCountMapPtrInput
	// (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
