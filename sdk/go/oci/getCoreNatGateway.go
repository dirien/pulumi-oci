...
// 		_, err := oci.GetCoreNatGateway(ctx, &GetCoreNatGatewayArgs{
...
// }
// ```
func LookupCoreNatGateway(ctx *pulumi.Context, args *LookupCoreNatGatewayArgs, opts ...pulumi.InvokeOption) (*LookupCoreNatGatewayResult, error) {
	var rv LookupCoreNatGatewayResult
	err := ctx.Invoke("oci:index/getCoreNatGateway:GetCoreNatGateway", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreNatGatewayArgs struct {
...
type LookupCoreNatGatewayResult struct {
