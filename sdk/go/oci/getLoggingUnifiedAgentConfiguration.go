...
// }
// ```
func LookupLoggingUnifiedAgentConfiguration(ctx *pulumi.Context, args *LookupLoggingUnifiedAgentConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupLoggingUnifiedAgentConfigurationResult, error) {
