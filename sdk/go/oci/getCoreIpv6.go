...
// 		_, err := oci.GetCoreIpv6(ctx, &GetCoreIpv6Args{
...
// }
// ```
func LookupCoreIpv6(ctx *pulumi.Context, args *LookupCoreIpv6Args, opts ...pulumi.InvokeOption) (*LookupCoreIpv6Result, error) {
	var rv LookupCoreIpv6Result
	err := ctx.Invoke("oci:index/getCoreIpv6:GetCoreIpv6", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreIpv6Args struct {
...
type LookupCoreIpv6Result struct {
