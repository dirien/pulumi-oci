...
func (*InvokeFunction) ElementType() reflect.Type {
	return reflect.TypeOf((*InvokeFunction)(nil))
}
...
func (i *InvokeFunction) ToInvokeFunctionPtrOutput() InvokeFunctionPtrOutput {
	return i.ToInvokeFunctionPtrOutputWithContext(context.Background())
}

func (i *InvokeFunction) ToInvokeFunctionPtrOutputWithContext(ctx context.Context) InvokeFunctionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InvokeFunctionPtrOutput)
}

type InvokeFunctionPtrInput interface {
	pulumi.Input

	ToInvokeFunctionPtrOutput() InvokeFunctionPtrOutput
	ToInvokeFunctionPtrOutputWithContext(ctx context.Context) InvokeFunctionPtrOutput
}

type invokeFunctionPtrType InvokeFunctionArgs

func (*invokeFunctionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**InvokeFunction)(nil))
}

func (i *invokeFunctionPtrType) ToInvokeFunctionPtrOutput() InvokeFunctionPtrOutput {
	return i.ToInvokeFunctionPtrOutputWithContext(context.Background())
}

func (i *invokeFunctionPtrType) ToInvokeFunctionPtrOutputWithContext(ctx context.Context) InvokeFunctionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InvokeFunctionPtrOutput)
}
...
func (o InvokeFunctionOutput) ToInvokeFunctionPtrOutput() InvokeFunctionPtrOutput {
	return o.ToInvokeFunctionPtrOutputWithContext(context.Background())
}

func (o InvokeFunctionOutput) ToInvokeFunctionPtrOutputWithContext(ctx context.Context) InvokeFunctionPtrOutput {
	return o.ApplyT(func(v InvokeFunction) *InvokeFunction {
		return &v
	}).(InvokeFunctionPtrOutput)
}

type InvokeFunctionPtrOutput struct {
	*pulumi.OutputState
}

func (InvokeFunctionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InvokeFunction)(nil))
}

func (o InvokeFunctionPtrOutput) ToInvokeFunctionPtrOutput() InvokeFunctionPtrOutput {
	return o
}

func (o InvokeFunctionPtrOutput) ToInvokeFunctionPtrOutputWithContext(ctx context.Context) InvokeFunctionPtrOutput {
	return o
}
...
func (InvokeFunctionMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]InvokeFunction)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(InvokeFunctionPtrOutput{})
