...
// 		_, err := oci.GetGoldenGateDeploymentBackup(ctx, &GetGoldenGateDeploymentBackupArgs{
...
// }
// ```
func LookupGoldenGateDeploymentBackup(ctx *pulumi.Context, args *LookupGoldenGateDeploymentBackupArgs, opts ...pulumi.InvokeOption) (*LookupGoldenGateDeploymentBackupResult, error) {
	var rv LookupGoldenGateDeploymentBackupResult
	err := ctx.Invoke("oci:index/getGoldenGateDeploymentBackup:GetGoldenGateDeploymentBackup", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupGoldenGateDeploymentBackupArgs struct {
...
type LookupGoldenGateDeploymentBackupResult struct {
