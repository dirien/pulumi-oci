...
func (*DetectorRecipe) ElementType() reflect.Type {
	return reflect.TypeOf((*DetectorRecipe)(nil))
}
...
func (i *DetectorRecipe) ToDetectorRecipePtrOutput() DetectorRecipePtrOutput {
	return i.ToDetectorRecipePtrOutputWithContext(context.Background())
}

func (i *DetectorRecipe) ToDetectorRecipePtrOutputWithContext(ctx context.Context) DetectorRecipePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DetectorRecipePtrOutput)
}

type DetectorRecipePtrInput interface {
	pulumi.Input

	ToDetectorRecipePtrOutput() DetectorRecipePtrOutput
	ToDetectorRecipePtrOutputWithContext(ctx context.Context) DetectorRecipePtrOutput
}

type detectorRecipePtrType DetectorRecipeArgs

func (*detectorRecipePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DetectorRecipe)(nil))
}

func (i *detectorRecipePtrType) ToDetectorRecipePtrOutput() DetectorRecipePtrOutput {
	return i.ToDetectorRecipePtrOutputWithContext(context.Background())
}

func (i *detectorRecipePtrType) ToDetectorRecipePtrOutputWithContext(ctx context.Context) DetectorRecipePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DetectorRecipePtrOutput)
}
...
type DetectorRecipeOutput struct {
	*pulumi.OutputState
}
...
func (o DetectorRecipeOutput) ToDetectorRecipePtrOutput() DetectorRecipePtrOutput {
	return o.ToDetectorRecipePtrOutputWithContext(context.Background())
}

func (o DetectorRecipeOutput) ToDetectorRecipePtrOutputWithContext(ctx context.Context) DetectorRecipePtrOutput {
	return o.ApplyT(func(v DetectorRecipe) *DetectorRecipe {
		return &v
	}).(DetectorRecipePtrOutput)
}

type DetectorRecipePtrOutput struct {
	*pulumi.OutputState
}

func (DetectorRecipePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DetectorRecipe)(nil))
}

func (o DetectorRecipePtrOutput) ToDetectorRecipePtrOutput() DetectorRecipePtrOutput {
	return o
}

func (o DetectorRecipePtrOutput) ToDetectorRecipePtrOutputWithContext(ctx context.Context) DetectorRecipePtrOutput {
	return o
}
...
func (DetectorRecipeMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DetectorRecipe)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DetectorRecipePtrOutput{})
