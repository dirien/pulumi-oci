...
// 		_, err := cloudguard.LookupTarget(ctx, &cloudguard.LookupTargetArgs{
...
func LookupTarget(ctx *pulumi.Context, args *LookupTargetArgs, opts ...pulumi.InvokeOption) (*LookupTargetResult, error) {
	...
	err := ctx.Invoke("oci:cloudguard/getTarget:getTarget", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupTargetResult struct {
	...
	TargetDetectorRecipes []GetTargetTargetDetectorRecipe `pulumi:"targetDetectorRecipes"`
	TargetId              string                          `pulumi:"targetId"`
	...
	TargetResponderRecipes []GetTargetTargetResponderRecipe `pulumi:"targetResponderRecipes"`
