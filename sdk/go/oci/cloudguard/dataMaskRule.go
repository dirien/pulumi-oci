...
func (*DataMaskRule) ElementType() reflect.Type {
	return reflect.TypeOf((*DataMaskRule)(nil))
}
...
func (i *DataMaskRule) ToDataMaskRulePtrOutput() DataMaskRulePtrOutput {
	return i.ToDataMaskRulePtrOutputWithContext(context.Background())
}

func (i *DataMaskRule) ToDataMaskRulePtrOutputWithContext(ctx context.Context) DataMaskRulePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskRulePtrOutput)
}

type DataMaskRulePtrInput interface {
	pulumi.Input

	ToDataMaskRulePtrOutput() DataMaskRulePtrOutput
	ToDataMaskRulePtrOutputWithContext(ctx context.Context) DataMaskRulePtrOutput
}

type dataMaskRulePtrType DataMaskRuleArgs

func (*dataMaskRulePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DataMaskRule)(nil))
}

func (i *dataMaskRulePtrType) ToDataMaskRulePtrOutput() DataMaskRulePtrOutput {
	return i.ToDataMaskRulePtrOutputWithContext(context.Background())
}

func (i *dataMaskRulePtrType) ToDataMaskRulePtrOutputWithContext(ctx context.Context) DataMaskRulePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DataMaskRulePtrOutput)
}
...
type DataMaskRuleOutput struct {
	*pulumi.OutputState
}
...
func (o DataMaskRuleOutput) ToDataMaskRulePtrOutput() DataMaskRulePtrOutput {
	return o.ToDataMaskRulePtrOutputWithContext(context.Background())
}

func (o DataMaskRuleOutput) ToDataMaskRulePtrOutputWithContext(ctx context.Context) DataMaskRulePtrOutput {
	return o.ApplyT(func(v DataMaskRule) *DataMaskRule {
		return &v
	}).(DataMaskRulePtrOutput)
}

type DataMaskRulePtrOutput struct {
	*pulumi.OutputState
}

func (DataMaskRulePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DataMaskRule)(nil))
}

func (o DataMaskRulePtrOutput) ToDataMaskRulePtrOutput() DataMaskRulePtrOutput {
	return o
}

func (o DataMaskRulePtrOutput) ToDataMaskRulePtrOutputWithContext(ctx context.Context) DataMaskRulePtrOutput {
	return o
}
...
func (DataMaskRuleMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DataMaskRule)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DataMaskRulePtrOutput{})
