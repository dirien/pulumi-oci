...
// 		_, err := oci.GetNetworkLoadBalancerBackendHealth(ctx, &GetNetworkLoadBalancerBackendHealthArgs{
...
// }
// ```
func GetNetworkLoadBalancerBackendHealth(ctx *pulumi.Context, args *GetNetworkLoadBalancerBackendHealthArgs, opts ...pulumi.InvokeOption) (*GetNetworkLoadBalancerBackendHealthResult, error) {
	var rv GetNetworkLoadBalancerBackendHealthResult
	err := ctx.Invoke("oci:index/getNetworkLoadBalancerBackendHealth:GetNetworkLoadBalancerBackendHealth", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetNetworkLoadBalancerBackendHealthArgs struct {
...
type GetNetworkLoadBalancerBackendHealthResult struct {
	BackendName    string `pulumi:"backendName"`
	BackendSetName string `pulumi:"backendSetName"`
	// A list of the most recent health check results returned for the specified backend server.
	HealthCheckResults []GetNetworkLoadBalancerBackendHealthHealthCheckResult `pulumi:"healthCheckResults"`
