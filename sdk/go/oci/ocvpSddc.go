...
type OcvpSddc struct {
	...
	HcxOnPremLicenses OcvpSddcHcxOnPremLicenseArrayOutput `pulumi:"hcxOnPremLicenses"`
...
// NewOcvpSddc registers a new resource with the given unique name, arguments, and options.
func NewOcvpSddc(ctx *pulumi.Context,
	name string, args *OcvpSddcArgs, opts ...pulumi.ResourceOption) (*OcvpSddc, error) {
	if args == nil {
	...
	var resource OcvpSddc
	err := ctx.RegisterResource("oci:index/ocvpSddc:OcvpSddc", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// GetOcvpSddc gets an existing OcvpSddc resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetOcvpSddc(ctx *pulumi.Context,
	name string, id pulumi.IDInput, state *OcvpSddcState, opts ...pulumi.ResourceOption) (*OcvpSddc, error) {
	var resource OcvpSddc
	err := ctx.ReadResource("oci:index/ocvpSddc:OcvpSddc", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ocvpSddcState struct {
	...
	// The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
	HcxOnPremLicenses []OcvpSddcHcxOnPremLicense `pulumi:"hcxOnPremLicenses"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for HCX Manager. For information about `PrivateIp` objects, see the Core Services API.
...
type OcvpSddcState struct {
	...
	// The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
	HcxOnPremLicenses OcvpSddcHcxOnPremLicenseArrayInput
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for HCX Manager. For information about `PrivateIp` objects, see the Core Services API.
...
func (OcvpSddcState) ElementType() reflect.Type {
	return reflect.TypeOf((*ocvpSddcState)(nil)).Elem()
}

type ocvpSddcArgs struct {
	// (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the SDDC.
	CompartmentId string `pulumi:"compartmentId"`
	// The availability domain to create the SDDC's ESXi hosts in.
	ComputeAvailabilityDomain string `pulumi:"computeAvailabilityDomain"`
...
func (OcvpSddcArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ocvpSddcArgs)(nil)).Elem()
}

type OcvpSddcInput interface {
	pulumi.Input

	ToOcvpSddcOutput() OcvpSddcOutput
	ToOcvpSddcOutputWithContext(ctx context.Context) OcvpSddcOutput
}

func (*OcvpSddc) ElementType() reflect.Type {
	return reflect.TypeOf((*OcvpSddc)(nil))
}

func (i *OcvpSddc) ToOcvpSddcOutput() OcvpSddcOutput {
	return i.ToOcvpSddcOutputWithContext(context.Background())
}

func (i *OcvpSddc) ToOcvpSddcOutputWithContext(ctx context.Context) OcvpSddcOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OcvpSddcOutput)
}

func (i *OcvpSddc) ToOcvpSddcPtrOutput() OcvpSddcPtrOutput {
	return i.ToOcvpSddcPtrOutputWithContext(context.Background())
}

func (i *OcvpSddc) ToOcvpSddcPtrOutputWithContext(ctx context.Context) OcvpSddcPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OcvpSddcPtrOutput)
}

type OcvpSddcPtrInput interface {
	pulumi.Input

	ToOcvpSddcPtrOutput() OcvpSddcPtrOutput
	ToOcvpSddcPtrOutputWithContext(ctx context.Context) OcvpSddcPtrOutput
}

type ocvpSddcPtrType OcvpSddcArgs

func (*ocvpSddcPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**OcvpSddc)(nil))
}

func (i *ocvpSddcPtrType) ToOcvpSddcPtrOutput() OcvpSddcPtrOutput {
	return i.ToOcvpSddcPtrOutputWithContext(context.Background())
}

func (i *ocvpSddcPtrType) ToOcvpSddcPtrOutputWithContext(ctx context.Context) OcvpSddcPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OcvpSddcPtrOutput)
}

// OcvpSddcArrayInput is an input type that accepts OcvpSddcArray and OcvpSddcArrayOutput values.
// You can construct a concrete instance of `OcvpSddcArrayInput` via:
//
//          OcvpSddcArray{ OcvpSddcArgs{...} }
type OcvpSddcArrayInput interface {
	pulumi.Input

	ToOcvpSddcArrayOutput() OcvpSddcArrayOutput
	ToOcvpSddcArrayOutputWithContext(context.Context) OcvpSddcArrayOutput
}

type OcvpSddcArray []OcvpSddcInput

func (OcvpSddcArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]*OcvpSddc)(nil)).Elem()
}

func (i OcvpSddcArray) ToOcvpSddcArrayOutput() OcvpSddcArrayOutput {
	return i.ToOcvpSddcArrayOutputWithContext(context.Background())
}

func (i OcvpSddcArray) ToOcvpSddcArrayOutputWithContext(ctx context.Context) OcvpSddcArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OcvpSddcArrayOutput)
}

// OcvpSddcMapInput is an input type that accepts OcvpSddcMap and OcvpSddcMapOutput values.
// You can construct a concrete instance of `OcvpSddcMapInput` via:
//
//          OcvpSddcMap{ "key": OcvpSddcArgs{...} }
type OcvpSddcMapInput interface {
	pulumi.Input

	ToOcvpSddcMapOutput() OcvpSddcMapOutput
	ToOcvpSddcMapOutputWithContext(context.Context) OcvpSddcMapOutput
}

type OcvpSddcMap map[string]OcvpSddcInput

func (OcvpSddcMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*OcvpSddc)(nil)).Elem()
}

func (i OcvpSddcMap) ToOcvpSddcMapOutput() OcvpSddcMapOutput {
	return i.ToOcvpSddcMapOutputWithContext(context.Background())
}

func (i OcvpSddcMap) ToOcvpSddcMapOutputWithContext(ctx context.Context) OcvpSddcMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OcvpSddcMapOutput)
}

type OcvpSddcOutput struct {
	*pulumi.OutputState
}

func (OcvpSddcOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*OcvpSddc)(nil))
}

func (o OcvpSddcOutput) ToOcvpSddcOutput() OcvpSddcOutput {
	return o
}

func (o OcvpSddcOutput) ToOcvpSddcOutputWithContext(ctx context.Context) OcvpSddcOutput {
	return o
}

func (o OcvpSddcOutput) ToOcvpSddcPtrOutput() OcvpSddcPtrOutput {
	return o.ToOcvpSddcPtrOutputWithContext(context.Background())
}

func (o OcvpSddcOutput) ToOcvpSddcPtrOutputWithContext(ctx context.Context) OcvpSddcPtrOutput {
	return o.ApplyT(func(v OcvpSddc) *OcvpSddc {
		return &v
	}).(OcvpSddcPtrOutput)
}

type OcvpSddcPtrOutput struct {
	*pulumi.OutputState
}

func (OcvpSddcPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**OcvpSddc)(nil))
}

func (o OcvpSddcPtrOutput) ToOcvpSddcPtrOutput() OcvpSddcPtrOutput {
	return o
}

func (o OcvpSddcPtrOutput) ToOcvpSddcPtrOutputWithContext(ctx context.Context) OcvpSddcPtrOutput {
	return o
}

type OcvpSddcArrayOutput struct{ *pulumi.OutputState }

func (OcvpSddcArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]OcvpSddc)(nil))
}

func (o OcvpSddcArrayOutput) ToOcvpSddcArrayOutput() OcvpSddcArrayOutput {
	return o
}

func (o OcvpSddcArrayOutput) ToOcvpSddcArrayOutputWithContext(ctx context.Context) OcvpSddcArrayOutput {
	return o
}

func (o OcvpSddcArrayOutput) Index(i pulumi.IntInput) OcvpSddcOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) OcvpSddc {
		return vs[0].([]OcvpSddc)[vs[1].(int)]
	}).(OcvpSddcOutput)
}

type OcvpSddcMapOutput struct{ *pulumi.OutputState }

func (OcvpSddcMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]OcvpSddc)(nil))
}

func (o OcvpSddcMapOutput) ToOcvpSddcMapOutput() OcvpSddcMapOutput {
	return o
}

func (o OcvpSddcMapOutput) ToOcvpSddcMapOutputWithContext(ctx context.Context) OcvpSddcMapOutput {
	return o
}

func (o OcvpSddcMapOutput) MapIndex(k pulumi.StringInput) OcvpSddcOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) OcvpSddc {
		return vs[0].(map[string]OcvpSddc)[vs[1].(string)]
	}).(OcvpSddcOutput)
}

func init() {
	pulumi.RegisterOutputType(OcvpSddcOutput{})
	pulumi.RegisterOutputType(OcvpSddcPtrOutput{})
	pulumi.RegisterOutputType(OcvpSddcArrayOutput{})
	pulumi.RegisterOutputType(OcvpSddcMapOutput{})
}
