...
func (i PublicationIconArgs) ToPublicationIconPtrOutput() PublicationIconPtrOutput {
	return i.ToPublicationIconPtrOutputWithContext(context.Background())
}

func (i PublicationIconArgs) ToPublicationIconPtrOutputWithContext(ctx context.Context) PublicationIconPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PublicationIconOutput).ToPublicationIconPtrOutputWithContext(ctx)
}

// PublicationIconPtrInput is an input type that accepts PublicationIconArgs, PublicationIconPtr and PublicationIconPtrOutput values.
// You can construct a concrete instance of `PublicationIconPtrInput` via:
//
//          PublicationIconArgs{...}
//
//  or:
//
//          nil
type PublicationIconPtrInput interface {
	pulumi.Input

	ToPublicationIconPtrOutput() PublicationIconPtrOutput
	ToPublicationIconPtrOutputWithContext(context.Context) PublicationIconPtrOutput
}

type publicationIconPtrType PublicationIconArgs

func PublicationIconPtr(v *PublicationIconArgs) PublicationIconPtrInput {
	return (*publicationIconPtrType)(v)
}

func (*publicationIconPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**PublicationIcon)(nil)).Elem()
}

func (i *publicationIconPtrType) ToPublicationIconPtrOutput() PublicationIconPtrOutput {
	return i.ToPublicationIconPtrOutputWithContext(context.Background())
}

func (i *publicationIconPtrType) ToPublicationIconPtrOutputWithContext(ctx context.Context) PublicationIconPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PublicationIconPtrOutput)
}
...
func (o PublicationIconOutput) ToPublicationIconPtrOutput() PublicationIconPtrOutput {
	return o.ToPublicationIconPtrOutputWithContext(context.Background())
}

func (o PublicationIconOutput) ToPublicationIconPtrOutputWithContext(ctx context.Context) PublicationIconPtrOutput {
	return o.ApplyT(func(v PublicationIcon) *PublicationIcon {
		return &v
	}).(PublicationIconPtrOutput)
}
...
type PublicationIconPtrOutput struct{ *pulumi.OutputState }

func (PublicationIconPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**PublicationIcon)(nil)).Elem()
}

func (o PublicationIconPtrOutput) ToPublicationIconPtrOutput() PublicationIconPtrOutput {
	return o
}

func (o PublicationIconPtrOutput) ToPublicationIconPtrOutputWithContext(ctx context.Context) PublicationIconPtrOutput {
	return o
}

func (o PublicationIconPtrOutput) Elem() PublicationIconOutput {
	return o.ApplyT(func(v *PublicationIcon) PublicationIcon { return *v }).(PublicationIconOutput)
}

// The content URL of the upload data.
func (o PublicationIconPtrOutput) ContentUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicationIcon) *string {
		if v == nil {
			return nil
		}
		return v.ContentUrl
...
// The file extension of the upload data.
func (o PublicationIconPtrOutput) FileExtension() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicationIcon) *string {
		if v == nil {
			return nil
		}
...
// The MIME type of the upload data.
func (o PublicationIconPtrOutput) MimeType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicationIcon) *string {
		if v == nil {
			return nil
		}
...
// (Updatable) The name of the contact.
func (o PublicationIconPtrOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicationIcon) *string {
		if v == nil {
			return nil
		}
...
func (o PublicationPackageDetailsPtrOutput) Elem() PublicationPackageDetailsOutput {
	return o.ApplyT(func(v *PublicationPackageDetails) PublicationPackageDetails { return *v }).(PublicationPackageDetailsOutput)
}
...
func (o PublicationPackageDetailsOperatingSystemPtrOutput) Elem() PublicationPackageDetailsOperatingSystemOutput {
	return o.ApplyT(func(v *PublicationPackageDetailsOperatingSystem) PublicationPackageDetailsOperatingSystem { return *v }).(PublicationPackageDetailsOperatingSystemOutput)
}
...
type GetListingPackagesListingPackage struct {
	...
	ListingId string `pulumi:"listingId"`
	// OS used by the listing.
	OperatingSystem GetListingPackagesListingPackageOperatingSystem `pulumi:"operatingSystem"`
...
type GetListingPackagesListingPackageArgs struct {
	...
	ListingId pulumi.StringInput `pulumi:"listingId"`
	// OS used by the listing.
	OperatingSystem GetListingPackagesListingPackageOperatingSystemInput `pulumi:"operatingSystem"`
	// A filter to return only packages that match the given package type exactly.
	PackageType pulumi.StringInput `pulumi:"packageType"`
	// The version of the package. Package versions are unique within a listing.
	PackageVersion pulumi.StringInput `pulumi:"packageVersion"`
...
// OS used by the listing.
func (o GetListingPackagesListingPackageOutput) OperatingSystem() GetListingPackagesListingPackageOperatingSystemOutput {
...
type GetListingPublisher struct {
	...
	Logo GetListingPublisherLogo `pulumi:"logo"`
	// Text that describes the resource.
	Name string `pulumi:"name"`
...
type GetListingPublisherArgs struct {
	...
	// The model for upload data for images and icons.
	Logo GetListingPublisherLogoInput `pulumi:"logo"`
	// Text that describes the resource.
	Name pulumi.StringInput `pulumi:"name"`
	// The publisher's website.
...
// The model for upload data for images and icons.
func (o GetListingPublisherOutput) Logo() GetListingPublisherLogoOutput {
	return o.ApplyT(func(v GetListingPublisher) GetListingPublisherLogo { return v.Logo }).(GetListingPublisherLogoOutput)
}
...
type GetListingsListing struct {
	...
	// The model for upload data for images and icons.
	Icon GetListingsListingIcon `pulumi:"icon"`
	// Unique identifier for the publisher.
	Id string `pulumi:"id"`
...
type GetListingsListingArgs struct {
	...
	// The model for upload data for images and icons.
	Icon GetListingsListingIconInput `pulumi:"icon"`
	// Unique identifier for the publisher.
	Id pulumi.StringInput `pulumi:"id"`
	// Indicates whether to show only featured listings. If this is set to `false` or is omitted, then all listings will be returned.
...
// The model for upload data for images and icons.
func (o GetListingsListingOutput) Icon() GetListingsListingIconOutput {
	return o.ApplyT(func(v GetListingsListing) GetListingsListingIcon { return v.Icon }).(GetListingsListingIconOutput)
}
...
type GetPublicationPackageDetails struct {
	Eulas           []GetPublicationPackageDetailsEula          `pulumi:"eulas"`
	ImageId         string                                      `pulumi:"imageId"`
	OperatingSystem GetPublicationPackageDetailsOperatingSystem `pulumi:"operatingSystem"`
	// The listing's package type.
	PackageType    string `pulumi:"packageType"`
	PackageVersion string `pulumi:"packageVersion"`
}

// GetPublicationPackageDetailsInput is an input type that accepts GetPublicationPackageDetailsArgs and GetPublicationPackageDetailsOutput values.
// You can construct a concrete instance of `GetPublicationPackageDetailsInput` via:
//
//          GetPublicationPackageDetailsArgs{...}
type GetPublicationPackageDetailsInput interface {
	pulumi.Input

	ToGetPublicationPackageDetailsOutput() GetPublicationPackageDetailsOutput
	ToGetPublicationPackageDetailsOutputWithContext(context.Context) GetPublicationPackageDetailsOutput
}

type GetPublicationPackageDetailsArgs struct {
	Eulas           GetPublicationPackageDetailsEulaArrayInput       `pulumi:"eulas"`
	ImageId         pulumi.StringInput                               `pulumi:"imageId"`
	OperatingSystem GetPublicationPackageDetailsOperatingSystemInput `pulumi:"operatingSystem"`
	// The listing's package type.
	PackageType    pulumi.StringInput `pulumi:"packageType"`
	PackageVersion pulumi.StringInput `pulumi:"packageVersion"`
}

func (GetPublicationPackageDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetails)(nil)).Elem()
}

func (i GetPublicationPackageDetailsArgs) ToGetPublicationPackageDetailsOutput() GetPublicationPackageDetailsOutput {
	return i.ToGetPublicationPackageDetailsOutputWithContext(context.Background())
}

func (i GetPublicationPackageDetailsArgs) ToGetPublicationPackageDetailsOutputWithContext(ctx context.Context) GetPublicationPackageDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationPackageDetailsOutput)
}

type GetPublicationPackageDetailsOutput struct{ *pulumi.OutputState }

func (GetPublicationPackageDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetails)(nil)).Elem()
}

func (o GetPublicationPackageDetailsOutput) ToGetPublicationPackageDetailsOutput() GetPublicationPackageDetailsOutput {
	return o
}

func (o GetPublicationPackageDetailsOutput) ToGetPublicationPackageDetailsOutputWithContext(ctx context.Context) GetPublicationPackageDetailsOutput {
	return o
}

func (o GetPublicationPackageDetailsOutput) Eulas() GetPublicationPackageDetailsEulaArrayOutput {
	return o.ApplyT(func(v GetPublicationPackageDetails) []GetPublicationPackageDetailsEula { return v.Eulas }).(GetPublicationPackageDetailsEulaArrayOutput)
}

func (o GetPublicationPackageDetailsOutput) ImageId() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetails) string { return v.ImageId }).(pulumi.StringOutput)
}

func (o GetPublicationPackageDetailsOutput) OperatingSystem() GetPublicationPackageDetailsOperatingSystemOutput {
	return o.ApplyT(func(v GetPublicationPackageDetails) GetPublicationPackageDetailsOperatingSystem {
		return v.OperatingSystem
	}).(GetPublicationPackageDetailsOperatingSystemOutput)
}

// The listing's package type.
func (o GetPublicationPackageDetailsOutput) PackageType() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetails) string { return v.PackageType }).(pulumi.StringOutput)
}

func (o GetPublicationPackageDetailsOutput) PackageVersion() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetails) string { return v.PackageVersion }).(pulumi.StringOutput)
}

type GetPublicationPackageDetailsEula struct {
	EulaType    string `pulumi:"eulaType"`
	LicenseText string `pulumi:"licenseText"`
}

// GetPublicationPackageDetailsEulaInput is an input type that accepts GetPublicationPackageDetailsEulaArgs and GetPublicationPackageDetailsEulaOutput values.
// You can construct a concrete instance of `GetPublicationPackageDetailsEulaInput` via:
//
//          GetPublicationPackageDetailsEulaArgs{...}
type GetPublicationPackageDetailsEulaInput interface {
	pulumi.Input

	ToGetPublicationPackageDetailsEulaOutput() GetPublicationPackageDetailsEulaOutput
	ToGetPublicationPackageDetailsEulaOutputWithContext(context.Context) GetPublicationPackageDetailsEulaOutput
}

type GetPublicationPackageDetailsEulaArgs struct {
	EulaType    pulumi.StringInput `pulumi:"eulaType"`
	LicenseText pulumi.StringInput `pulumi:"licenseText"`
}

func (GetPublicationPackageDetailsEulaArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetailsEula)(nil)).Elem()
}

func (i GetPublicationPackageDetailsEulaArgs) ToGetPublicationPackageDetailsEulaOutput() GetPublicationPackageDetailsEulaOutput {
	return i.ToGetPublicationPackageDetailsEulaOutputWithContext(context.Background())
}

func (i GetPublicationPackageDetailsEulaArgs) ToGetPublicationPackageDetailsEulaOutputWithContext(ctx context.Context) GetPublicationPackageDetailsEulaOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationPackageDetailsEulaOutput)
}

// GetPublicationPackageDetailsEulaArrayInput is an input type that accepts GetPublicationPackageDetailsEulaArray and GetPublicationPackageDetailsEulaArrayOutput values.
// You can construct a concrete instance of `GetPublicationPackageDetailsEulaArrayInput` via:
//
//          GetPublicationPackageDetailsEulaArray{ GetPublicationPackageDetailsEulaArgs{...} }
type GetPublicationPackageDetailsEulaArrayInput interface {
	pulumi.Input

	ToGetPublicationPackageDetailsEulaArrayOutput() GetPublicationPackageDetailsEulaArrayOutput
	ToGetPublicationPackageDetailsEulaArrayOutputWithContext(context.Context) GetPublicationPackageDetailsEulaArrayOutput
}

type GetPublicationPackageDetailsEulaArray []GetPublicationPackageDetailsEulaInput

func (GetPublicationPackageDetailsEulaArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPublicationPackageDetailsEula)(nil)).Elem()
}

func (i GetPublicationPackageDetailsEulaArray) ToGetPublicationPackageDetailsEulaArrayOutput() GetPublicationPackageDetailsEulaArrayOutput {
	return i.ToGetPublicationPackageDetailsEulaArrayOutputWithContext(context.Background())
}

func (i GetPublicationPackageDetailsEulaArray) ToGetPublicationPackageDetailsEulaArrayOutputWithContext(ctx context.Context) GetPublicationPackageDetailsEulaArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationPackageDetailsEulaArrayOutput)
}

type GetPublicationPackageDetailsEulaOutput struct{ *pulumi.OutputState }

func (GetPublicationPackageDetailsEulaOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetailsEula)(nil)).Elem()
}

func (o GetPublicationPackageDetailsEulaOutput) ToGetPublicationPackageDetailsEulaOutput() GetPublicationPackageDetailsEulaOutput {
	return o
}

func (o GetPublicationPackageDetailsEulaOutput) ToGetPublicationPackageDetailsEulaOutputWithContext(ctx context.Context) GetPublicationPackageDetailsEulaOutput {
	return o
}

func (o GetPublicationPackageDetailsEulaOutput) EulaType() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetailsEula) string { return v.EulaType }).(pulumi.StringOutput)
}

func (o GetPublicationPackageDetailsEulaOutput) LicenseText() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetailsEula) string { return v.LicenseText }).(pulumi.StringOutput)
}

type GetPublicationPackageDetailsEulaArrayOutput struct{ *pulumi.OutputState }

func (GetPublicationPackageDetailsEulaArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPublicationPackageDetailsEula)(nil)).Elem()
}

func (o GetPublicationPackageDetailsEulaArrayOutput) ToGetPublicationPackageDetailsEulaArrayOutput() GetPublicationPackageDetailsEulaArrayOutput {
	return o
}

func (o GetPublicationPackageDetailsEulaArrayOutput) ToGetPublicationPackageDetailsEulaArrayOutputWithContext(ctx context.Context) GetPublicationPackageDetailsEulaArrayOutput {
	return o
}

func (o GetPublicationPackageDetailsEulaArrayOutput) Index(i pulumi.IntInput) GetPublicationPackageDetailsEulaOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetPublicationPackageDetailsEula {
		return vs[0].([]GetPublicationPackageDetailsEula)[vs[1].(int)]
	}).(GetPublicationPackageDetailsEulaOutput)
}

type GetPublicationPackageDetailsOperatingSystem struct {
	// name of the operating system
	Name string `pulumi:"name"`
}

// GetPublicationPackageDetailsOperatingSystemInput is an input type that accepts GetPublicationPackageDetailsOperatingSystemArgs and GetPublicationPackageDetailsOperatingSystemOutput values.
// You can construct a concrete instance of `GetPublicationPackageDetailsOperatingSystemInput` via:
//
//          GetPublicationPackageDetailsOperatingSystemArgs{...}
type GetPublicationPackageDetailsOperatingSystemInput interface {
	pulumi.Input

	ToGetPublicationPackageDetailsOperatingSystemOutput() GetPublicationPackageDetailsOperatingSystemOutput
	ToGetPublicationPackageDetailsOperatingSystemOutputWithContext(context.Context) GetPublicationPackageDetailsOperatingSystemOutput
}

type GetPublicationPackageDetailsOperatingSystemArgs struct {
	// name of the operating system
	Name pulumi.StringInput `pulumi:"name"`
}

func (GetPublicationPackageDetailsOperatingSystemArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetailsOperatingSystem)(nil)).Elem()
}

func (i GetPublicationPackageDetailsOperatingSystemArgs) ToGetPublicationPackageDetailsOperatingSystemOutput() GetPublicationPackageDetailsOperatingSystemOutput {
	return i.ToGetPublicationPackageDetailsOperatingSystemOutputWithContext(context.Background())
}

func (i GetPublicationPackageDetailsOperatingSystemArgs) ToGetPublicationPackageDetailsOperatingSystemOutputWithContext(ctx context.Context) GetPublicationPackageDetailsOperatingSystemOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationPackageDetailsOperatingSystemOutput)
}

type GetPublicationPackageDetailsOperatingSystemOutput struct{ *pulumi.OutputState }

func (GetPublicationPackageDetailsOperatingSystemOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationPackageDetailsOperatingSystem)(nil)).Elem()
}

func (o GetPublicationPackageDetailsOperatingSystemOutput) ToGetPublicationPackageDetailsOperatingSystemOutput() GetPublicationPackageDetailsOperatingSystemOutput {
	return o
}

func (o GetPublicationPackageDetailsOperatingSystemOutput) ToGetPublicationPackageDetailsOperatingSystemOutputWithContext(ctx context.Context) GetPublicationPackageDetailsOperatingSystemOutput {
	return o
}

// name of the operating system
func (o GetPublicationPackageDetailsOperatingSystemOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationPackageDetailsOperatingSystem) string { return v.Name }).(pulumi.StringOutput)
}
...
type GetPublicationsPublication struct {
	...
	FreeformTags map[string]interface{} `pulumi:"freeformTags"`
	// The model for upload data for images and icons.
	Icon GetPublicationsPublicationIcon `pulumi:"icon"`
	...
	// The name of the listing.
	Name           string                                   `pulumi:"name"`
	PackageDetails GetPublicationsPublicationPackageDetails `pulumi:"packageDetails"`
	// The listing's package type.
	PackageType string `pulumi:"packageType"`
	// A short description of the listing.
	ShortDescription string `pulumi:"shortDescription"`
...
type GetPublicationsPublicationArgs struct {
	...
	FreeformTags pulumi.MapInput `pulumi:"freeformTags"`
	// The model for upload data for images and icons.
	Icon GetPublicationsPublicationIconInput `pulumi:"icon"`
	// The unique identifier for the listing in Marketplace.
	Id                      pulumi.StringInput `pulumi:"id"`
	...
	// The name of the listing.
	Name           pulumi.StringInput                            `pulumi:"name"`
	PackageDetails GetPublicationsPublicationPackageDetailsInput `pulumi:"packageDetails"`
	// The listing's package type.
	PackageType pulumi.StringInput `pulumi:"packageType"`
	// A short description of the listing.
	ShortDescription pulumi.StringInput `pulumi:"shortDescription"`
...
// The model for upload data for images and icons.
func (o GetPublicationsPublicationOutput) Icon() GetPublicationsPublicationIconOutput {
	return o.ApplyT(func(v GetPublicationsPublication) GetPublicationsPublicationIcon { return v.Icon }).(GetPublicationsPublicationIconOutput)
}
...
func (o GetPublicationsPublicationOutput) PackageDetails() GetPublicationsPublicationPackageDetailsOutput {
	return o.ApplyT(func(v GetPublicationsPublication) GetPublicationsPublicationPackageDetails { return v.PackageDetails }).(GetPublicationsPublicationPackageDetailsOutput)
}
...
type GetPublicationsPublicationPackageDetails struct {
	Eulas           []GetPublicationsPublicationPackageDetailsEula          `pulumi:"eulas"`
	ImageId         string                                                  `pulumi:"imageId"`
	OperatingSystem GetPublicationsPublicationPackageDetailsOperatingSystem `pulumi:"operatingSystem"`
	// The listing's package type.
	PackageType    string `pulumi:"packageType"`
	PackageVersion string `pulumi:"packageVersion"`
}

// GetPublicationsPublicationPackageDetailsInput is an input type that accepts GetPublicationsPublicationPackageDetailsArgs and GetPublicationsPublicationPackageDetailsOutput values.
// You can construct a concrete instance of `GetPublicationsPublicationPackageDetailsInput` via:
//
//          GetPublicationsPublicationPackageDetailsArgs{...}
type GetPublicationsPublicationPackageDetailsInput interface {
	pulumi.Input

	ToGetPublicationsPublicationPackageDetailsOutput() GetPublicationsPublicationPackageDetailsOutput
	ToGetPublicationsPublicationPackageDetailsOutputWithContext(context.Context) GetPublicationsPublicationPackageDetailsOutput
}

type GetPublicationsPublicationPackageDetailsArgs struct {
	Eulas           GetPublicationsPublicationPackageDetailsEulaArrayInput       `pulumi:"eulas"`
	ImageId         pulumi.StringInput                                           `pulumi:"imageId"`
	OperatingSystem GetPublicationsPublicationPackageDetailsOperatingSystemInput `pulumi:"operatingSystem"`
	// The listing's package type.
	PackageType    pulumi.StringInput `pulumi:"packageType"`
	PackageVersion pulumi.StringInput `pulumi:"packageVersion"`
}

func (GetPublicationsPublicationPackageDetailsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetails)(nil)).Elem()
}

func (i GetPublicationsPublicationPackageDetailsArgs) ToGetPublicationsPublicationPackageDetailsOutput() GetPublicationsPublicationPackageDetailsOutput {
	return i.ToGetPublicationsPublicationPackageDetailsOutputWithContext(context.Background())
}

func (i GetPublicationsPublicationPackageDetailsArgs) ToGetPublicationsPublicationPackageDetailsOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationsPublicationPackageDetailsOutput)
}

type GetPublicationsPublicationPackageDetailsOutput struct{ *pulumi.OutputState }

func (GetPublicationsPublicationPackageDetailsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetails)(nil)).Elem()
}

func (o GetPublicationsPublicationPackageDetailsOutput) ToGetPublicationsPublicationPackageDetailsOutput() GetPublicationsPublicationPackageDetailsOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsOutput) ToGetPublicationsPublicationPackageDetailsOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsOutput) Eulas() GetPublicationsPublicationPackageDetailsEulaArrayOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetails) []GetPublicationsPublicationPackageDetailsEula {
		return v.Eulas
	}).(GetPublicationsPublicationPackageDetailsEulaArrayOutput)
}

func (o GetPublicationsPublicationPackageDetailsOutput) ImageId() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetails) string { return v.ImageId }).(pulumi.StringOutput)
}

func (o GetPublicationsPublicationPackageDetailsOutput) OperatingSystem() GetPublicationsPublicationPackageDetailsOperatingSystemOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetails) GetPublicationsPublicationPackageDetailsOperatingSystem {
		return v.OperatingSystem
	}).(GetPublicationsPublicationPackageDetailsOperatingSystemOutput)
}

// The listing's package type.
func (o GetPublicationsPublicationPackageDetailsOutput) PackageType() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetails) string { return v.PackageType }).(pulumi.StringOutput)
}

func (o GetPublicationsPublicationPackageDetailsOutput) PackageVersion() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetails) string { return v.PackageVersion }).(pulumi.StringOutput)
}

type GetPublicationsPublicationPackageDetailsEula struct {
	EulaType    string `pulumi:"eulaType"`
	LicenseText string `pulumi:"licenseText"`
}

// GetPublicationsPublicationPackageDetailsEulaInput is an input type that accepts GetPublicationsPublicationPackageDetailsEulaArgs and GetPublicationsPublicationPackageDetailsEulaOutput values.
// You can construct a concrete instance of `GetPublicationsPublicationPackageDetailsEulaInput` via:
//
//          GetPublicationsPublicationPackageDetailsEulaArgs{...}
type GetPublicationsPublicationPackageDetailsEulaInput interface {
	pulumi.Input

	ToGetPublicationsPublicationPackageDetailsEulaOutput() GetPublicationsPublicationPackageDetailsEulaOutput
	ToGetPublicationsPublicationPackageDetailsEulaOutputWithContext(context.Context) GetPublicationsPublicationPackageDetailsEulaOutput
}

type GetPublicationsPublicationPackageDetailsEulaArgs struct {
	EulaType    pulumi.StringInput `pulumi:"eulaType"`
	LicenseText pulumi.StringInput `pulumi:"licenseText"`
}

func (GetPublicationsPublicationPackageDetailsEulaArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetailsEula)(nil)).Elem()
}

func (i GetPublicationsPublicationPackageDetailsEulaArgs) ToGetPublicationsPublicationPackageDetailsEulaOutput() GetPublicationsPublicationPackageDetailsEulaOutput {
	return i.ToGetPublicationsPublicationPackageDetailsEulaOutputWithContext(context.Background())
}

func (i GetPublicationsPublicationPackageDetailsEulaArgs) ToGetPublicationsPublicationPackageDetailsEulaOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsEulaOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationsPublicationPackageDetailsEulaOutput)
}

// GetPublicationsPublicationPackageDetailsEulaArrayInput is an input type that accepts GetPublicationsPublicationPackageDetailsEulaArray and GetPublicationsPublicationPackageDetailsEulaArrayOutput values.
// You can construct a concrete instance of `GetPublicationsPublicationPackageDetailsEulaArrayInput` via:
//
//          GetPublicationsPublicationPackageDetailsEulaArray{ GetPublicationsPublicationPackageDetailsEulaArgs{...} }
type GetPublicationsPublicationPackageDetailsEulaArrayInput interface {
	pulumi.Input

	ToGetPublicationsPublicationPackageDetailsEulaArrayOutput() GetPublicationsPublicationPackageDetailsEulaArrayOutput
	ToGetPublicationsPublicationPackageDetailsEulaArrayOutputWithContext(context.Context) GetPublicationsPublicationPackageDetailsEulaArrayOutput
}

type GetPublicationsPublicationPackageDetailsEulaArray []GetPublicationsPublicationPackageDetailsEulaInput

func (GetPublicationsPublicationPackageDetailsEulaArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPublicationsPublicationPackageDetailsEula)(nil)).Elem()
}

func (i GetPublicationsPublicationPackageDetailsEulaArray) ToGetPublicationsPublicationPackageDetailsEulaArrayOutput() GetPublicationsPublicationPackageDetailsEulaArrayOutput {
	return i.ToGetPublicationsPublicationPackageDetailsEulaArrayOutputWithContext(context.Background())
}

func (i GetPublicationsPublicationPackageDetailsEulaArray) ToGetPublicationsPublicationPackageDetailsEulaArrayOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsEulaArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationsPublicationPackageDetailsEulaArrayOutput)
}

type GetPublicationsPublicationPackageDetailsEulaOutput struct{ *pulumi.OutputState }

func (GetPublicationsPublicationPackageDetailsEulaOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetailsEula)(nil)).Elem()
}

func (o GetPublicationsPublicationPackageDetailsEulaOutput) ToGetPublicationsPublicationPackageDetailsEulaOutput() GetPublicationsPublicationPackageDetailsEulaOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsEulaOutput) ToGetPublicationsPublicationPackageDetailsEulaOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsEulaOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsEulaOutput) EulaType() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetailsEula) string { return v.EulaType }).(pulumi.StringOutput)
}

func (o GetPublicationsPublicationPackageDetailsEulaOutput) LicenseText() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetailsEula) string { return v.LicenseText }).(pulumi.StringOutput)
}

type GetPublicationsPublicationPackageDetailsEulaArrayOutput struct{ *pulumi.OutputState }

func (GetPublicationsPublicationPackageDetailsEulaArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPublicationsPublicationPackageDetailsEula)(nil)).Elem()
}

func (o GetPublicationsPublicationPackageDetailsEulaArrayOutput) ToGetPublicationsPublicationPackageDetailsEulaArrayOutput() GetPublicationsPublicationPackageDetailsEulaArrayOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsEulaArrayOutput) ToGetPublicationsPublicationPackageDetailsEulaArrayOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsEulaArrayOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsEulaArrayOutput) Index(i pulumi.IntInput) GetPublicationsPublicationPackageDetailsEulaOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetPublicationsPublicationPackageDetailsEula {
		return vs[0].([]GetPublicationsPublicationPackageDetailsEula)[vs[1].(int)]
	}).(GetPublicationsPublicationPackageDetailsEulaOutput)
}

type GetPublicationsPublicationPackageDetailsOperatingSystem struct {
	// The name of the listing.
	Name string `pulumi:"name"`
}

// GetPublicationsPublicationPackageDetailsOperatingSystemInput is an input type that accepts GetPublicationsPublicationPackageDetailsOperatingSystemArgs and GetPublicationsPublicationPackageDetailsOperatingSystemOutput values.
// You can construct a concrete instance of `GetPublicationsPublicationPackageDetailsOperatingSystemInput` via:
//
//          GetPublicationsPublicationPackageDetailsOperatingSystemArgs{...}
type GetPublicationsPublicationPackageDetailsOperatingSystemInput interface {
	pulumi.Input

	ToGetPublicationsPublicationPackageDetailsOperatingSystemOutput() GetPublicationsPublicationPackageDetailsOperatingSystemOutput
	ToGetPublicationsPublicationPackageDetailsOperatingSystemOutputWithContext(context.Context) GetPublicationsPublicationPackageDetailsOperatingSystemOutput
}

type GetPublicationsPublicationPackageDetailsOperatingSystemArgs struct {
	// The name of the listing.
	Name pulumi.StringInput `pulumi:"name"`
}

func (GetPublicationsPublicationPackageDetailsOperatingSystemArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetailsOperatingSystem)(nil)).Elem()
}

func (i GetPublicationsPublicationPackageDetailsOperatingSystemArgs) ToGetPublicationsPublicationPackageDetailsOperatingSystemOutput() GetPublicationsPublicationPackageDetailsOperatingSystemOutput {
	return i.ToGetPublicationsPublicationPackageDetailsOperatingSystemOutputWithContext(context.Background())
}

func (i GetPublicationsPublicationPackageDetailsOperatingSystemArgs) ToGetPublicationsPublicationPackageDetailsOperatingSystemOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsOperatingSystemOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPublicationsPublicationPackageDetailsOperatingSystemOutput)
}

type GetPublicationsPublicationPackageDetailsOperatingSystemOutput struct{ *pulumi.OutputState }

func (GetPublicationsPublicationPackageDetailsOperatingSystemOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPublicationsPublicationPackageDetailsOperatingSystem)(nil)).Elem()
}

func (o GetPublicationsPublicationPackageDetailsOperatingSystemOutput) ToGetPublicationsPublicationPackageDetailsOperatingSystemOutput() GetPublicationsPublicationPackageDetailsOperatingSystemOutput {
	return o
}

func (o GetPublicationsPublicationPackageDetailsOperatingSystemOutput) ToGetPublicationsPublicationPackageDetailsOperatingSystemOutputWithContext(ctx context.Context) GetPublicationsPublicationPackageDetailsOperatingSystemOutput {
	return o
}

// The name of the listing.
func (o GetPublicationsPublicationPackageDetailsOperatingSystemOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetPublicationsPublicationPackageDetailsOperatingSystem) string { return v.Name }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(PublicationIconPtrOutput{})
	...
	pulumi.RegisterOutputType(GetPublicationPackageDetailsOutput{})
	pulumi.RegisterOutputType(GetPublicationPackageDetailsEulaOutput{})
	pulumi.RegisterOutputType(GetPublicationPackageDetailsEulaArrayOutput{})
	pulumi.RegisterOutputType(GetPublicationPackageDetailsOperatingSystemOutput{})
	...
	pulumi.RegisterOutputType(GetPublicationsPublicationPackageDetailsOutput{})
	pulumi.RegisterOutputType(GetPublicationsPublicationPackageDetailsEulaOutput{})
	pulumi.RegisterOutputType(GetPublicationsPublicationPackageDetailsEulaArrayOutput{})
	pulumi.RegisterOutputType(GetPublicationsPublicationPackageDetailsOperatingSystemOutput{})
