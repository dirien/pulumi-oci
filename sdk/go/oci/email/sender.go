...
func (*Sender) ElementType() reflect.Type {
	return reflect.TypeOf((*Sender)(nil))
}
...
func (i *Sender) ToSenderPtrOutput() SenderPtrOutput {
	return i.ToSenderPtrOutputWithContext(context.Background())
}

func (i *Sender) ToSenderPtrOutputWithContext(ctx context.Context) SenderPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SenderPtrOutput)
}

type SenderPtrInput interface {
	pulumi.Input

	ToSenderPtrOutput() SenderPtrOutput
	ToSenderPtrOutputWithContext(ctx context.Context) SenderPtrOutput
}

type senderPtrType SenderArgs

func (*senderPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Sender)(nil))
}

func (i *senderPtrType) ToSenderPtrOutput() SenderPtrOutput {
	return i.ToSenderPtrOutputWithContext(context.Background())
}

func (i *senderPtrType) ToSenderPtrOutputWithContext(ctx context.Context) SenderPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SenderPtrOutput)
}
...
func (o SenderOutput) ToSenderPtrOutput() SenderPtrOutput {
	return o.ToSenderPtrOutputWithContext(context.Background())
}

func (o SenderOutput) ToSenderPtrOutputWithContext(ctx context.Context) SenderPtrOutput {
	return o.ApplyT(func(v Sender) *Sender {
		return &v
	}).(SenderPtrOutput)
}

type SenderPtrOutput struct {
	*pulumi.OutputState
}

func (SenderPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Sender)(nil))
}

func (o SenderPtrOutput) ToSenderPtrOutput() SenderPtrOutput {
	return o
}

func (o SenderPtrOutput) ToSenderPtrOutputWithContext(ctx context.Context) SenderPtrOutput {
	return o
}
...
func (SenderMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Sender)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(SenderPtrOutput{})
