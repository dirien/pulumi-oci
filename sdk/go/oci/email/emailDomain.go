...
func (*EmailDomain) ElementType() reflect.Type {
	return reflect.TypeOf((*EmailDomain)(nil))
}
...
func (i *EmailDomain) ToEmailDomainPtrOutput() EmailDomainPtrOutput {
	return i.ToEmailDomainPtrOutputWithContext(context.Background())
}

func (i *EmailDomain) ToEmailDomainPtrOutputWithContext(ctx context.Context) EmailDomainPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EmailDomainPtrOutput)
}

type EmailDomainPtrInput interface {
	pulumi.Input

	ToEmailDomainPtrOutput() EmailDomainPtrOutput
	ToEmailDomainPtrOutputWithContext(ctx context.Context) EmailDomainPtrOutput
}

type emailDomainPtrType EmailDomainArgs

func (*emailDomainPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**EmailDomain)(nil))
}

func (i *emailDomainPtrType) ToEmailDomainPtrOutput() EmailDomainPtrOutput {
	return i.ToEmailDomainPtrOutputWithContext(context.Background())
}

func (i *emailDomainPtrType) ToEmailDomainPtrOutputWithContext(ctx context.Context) EmailDomainPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(EmailDomainPtrOutput)
}
...
func (o EmailDomainOutput) ToEmailDomainPtrOutput() EmailDomainPtrOutput {
	return o.ToEmailDomainPtrOutputWithContext(context.Background())
}

func (o EmailDomainOutput) ToEmailDomainPtrOutputWithContext(ctx context.Context) EmailDomainPtrOutput {
	return o.ApplyT(func(v EmailDomain) *EmailDomain {
		return &v
	}).(EmailDomainPtrOutput)
}

type EmailDomainPtrOutput struct {
	*pulumi.OutputState
}

func (EmailDomainPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**EmailDomain)(nil))
}

func (o EmailDomainPtrOutput) ToEmailDomainPtrOutput() EmailDomainPtrOutput {
	return o
}

func (o EmailDomainPtrOutput) ToEmailDomainPtrOutputWithContext(ctx context.Context) EmailDomainPtrOutput {
	return o
}
...
func (EmailDomainMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]EmailDomain)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(EmailDomainPtrOutput{})
