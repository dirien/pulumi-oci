...
// 		_, err := oci.GetDataflowInvokeRuns(ctx, &GetDataflowInvokeRunsArgs{
...
// }
// ```
func GetDataflowInvokeRuns(ctx *pulumi.Context, args *GetDataflowInvokeRunsArgs, opts ...pulumi.InvokeOption) (*GetDataflowInvokeRunsResult, error) {
	var rv GetDataflowInvokeRunsResult
	err := ctx.Invoke("oci:index/getDataflowInvokeRuns:GetDataflowInvokeRuns", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDataflowInvokeRunsArgs struct {
	...
	Filters               []GetDataflowInvokeRunsFilter `pulumi:"filters"`
...
type GetDataflowInvokeRunsResult struct {
	// The application ID.
	ApplicationId *string `pulumi:"applicationId"`
	...
	OwnerPrincipalId *string `pulumi:"ownerPrincipalId"`
	// The list of runs.
	Runs []GetDataflowInvokeRunsRun `pulumi:"runs"`
