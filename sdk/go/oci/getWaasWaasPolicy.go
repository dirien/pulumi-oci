...
// 		_, err := oci.GetWaasWaasPolicy(ctx, &GetWaasWaasPolicyArgs{
...
// }
// ```
func LookupWaasWaasPolicy(ctx *pulumi.Context, args *LookupWaasWaasPolicyArgs, opts ...pulumi.InvokeOption) (*LookupWaasWaasPolicyResult, error) {
	var rv LookupWaasWaasPolicyResult
	err := ctx.Invoke("oci:index/getWaasWaasPolicy:GetWaasWaasPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupWaasWaasPolicyArgs struct {
...
type LookupWaasWaasPolicyResult struct {
	...
	OriginGroups []GetWaasWaasPolicyOriginGroup `pulumi:"originGroups"`
	...
	Origins []GetWaasWaasPolicyOrigin `pulumi:"origins"`
	// The configuration details for the WAAS policy.
	PolicyConfigs []GetWaasWaasPolicyPolicyConfig `pulumi:"policyConfigs"`
	...
	WafConfigs []GetWaasWaasPolicyWafConfig `pulumi:"wafConfigs"`
}
