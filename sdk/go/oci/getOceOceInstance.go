...
// 		_, err := oci.GetOceOceInstance(ctx, &GetOceOceInstanceArgs{
...
// }
// ```
func LookupOceOceInstance(ctx *pulumi.Context, args *LookupOceOceInstanceArgs, opts ...pulumi.InvokeOption) (*LookupOceOceInstanceResult, error) {
	var rv LookupOceOceInstanceResult
	err := ctx.Invoke("oci:index/getOceOceInstance:GetOceOceInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupOceOceInstanceArgs struct {
...
type LookupOceOceInstanceResult struct {
