...
func (*VmCluster) ElementType() reflect.Type {
	return reflect.TypeOf((*VmCluster)(nil))
}
...
func (i *VmCluster) ToVmClusterPtrOutput() VmClusterPtrOutput {
	return i.ToVmClusterPtrOutputWithContext(context.Background())
}

func (i *VmCluster) ToVmClusterPtrOutputWithContext(ctx context.Context) VmClusterPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VmClusterPtrOutput)
}

type VmClusterPtrInput interface {
	pulumi.Input

	ToVmClusterPtrOutput() VmClusterPtrOutput
	ToVmClusterPtrOutputWithContext(ctx context.Context) VmClusterPtrOutput
}

type vmClusterPtrType VmClusterArgs

func (*vmClusterPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VmCluster)(nil))
}

func (i *vmClusterPtrType) ToVmClusterPtrOutput() VmClusterPtrOutput {
	return i.ToVmClusterPtrOutputWithContext(context.Background())
}

func (i *vmClusterPtrType) ToVmClusterPtrOutputWithContext(ctx context.Context) VmClusterPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VmClusterPtrOutput)
}
...
func (o VmClusterOutput) ToVmClusterPtrOutput() VmClusterPtrOutput {
	return o.ToVmClusterPtrOutputWithContext(context.Background())
}

func (o VmClusterOutput) ToVmClusterPtrOutputWithContext(ctx context.Context) VmClusterPtrOutput {
	return o.ApplyT(func(v VmCluster) *VmCluster {
		return &v
	}).(VmClusterPtrOutput)
}

type VmClusterPtrOutput struct {
	*pulumi.OutputState
}

func (VmClusterPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VmCluster)(nil))
}

func (o VmClusterPtrOutput) ToVmClusterPtrOutput() VmClusterPtrOutput {
	return o
}

func (o VmClusterPtrOutput) ToVmClusterPtrOutputWithContext(ctx context.Context) VmClusterPtrOutput {
	return o
}
...
func (VmClusterMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]VmCluster)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(VmClusterPtrOutput{})
