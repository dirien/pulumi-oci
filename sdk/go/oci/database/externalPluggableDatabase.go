...
type ExternalPluggableDatabase struct {
	...
	DatabaseManagementConfig ExternalPluggableDatabaseDatabaseManagementConfigOutput `pulumi:"databaseManagementConfig"`
	...
	OperationsInsightsConfig ExternalPluggableDatabaseOperationsInsightsConfigOutput `pulumi:"operationsInsightsConfig"`
...
type externalPluggableDatabaseState struct {
	...
	// The configuration of the Database Management service.
	DatabaseManagementConfig *ExternalPluggableDatabaseDatabaseManagementConfig `pulumi:"databaseManagementConfig"`
	// The Oracle Database version.
	...
	// The configuration of Operations Insights for the external database
	OperationsInsightsConfig *ExternalPluggableDatabaseOperationsInsightsConfig `pulumi:"operationsInsightsConfig"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the the non-container database that was converted to a pluggable database to create this resource.
...
type ExternalPluggableDatabaseState struct {
	...
	// The configuration of the Database Management service.
	DatabaseManagementConfig ExternalPluggableDatabaseDatabaseManagementConfigPtrInput
	// The Oracle Database version.
	...
	// The configuration of Operations Insights for the external database
	OperationsInsightsConfig ExternalPluggableDatabaseOperationsInsightsConfigPtrInput
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the the non-container database that was converted to a pluggable database to create this resource.
...
func (*ExternalPluggableDatabase) ElementType() reflect.Type {
	return reflect.TypeOf((*ExternalPluggableDatabase)(nil))
}
...
func (i *ExternalPluggableDatabase) ToExternalPluggableDatabasePtrOutput() ExternalPluggableDatabasePtrOutput {
	return i.ToExternalPluggableDatabasePtrOutputWithContext(context.Background())
}

func (i *ExternalPluggableDatabase) ToExternalPluggableDatabasePtrOutputWithContext(ctx context.Context) ExternalPluggableDatabasePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExternalPluggableDatabasePtrOutput)
}

type ExternalPluggableDatabasePtrInput interface {
	pulumi.Input

	ToExternalPluggableDatabasePtrOutput() ExternalPluggableDatabasePtrOutput
	ToExternalPluggableDatabasePtrOutputWithContext(ctx context.Context) ExternalPluggableDatabasePtrOutput
}

type externalPluggableDatabasePtrType ExternalPluggableDatabaseArgs

func (*externalPluggableDatabasePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ExternalPluggableDatabase)(nil))
}

func (i *externalPluggableDatabasePtrType) ToExternalPluggableDatabasePtrOutput() ExternalPluggableDatabasePtrOutput {
	return i.ToExternalPluggableDatabasePtrOutputWithContext(context.Background())
}

func (i *externalPluggableDatabasePtrType) ToExternalPluggableDatabasePtrOutputWithContext(ctx context.Context) ExternalPluggableDatabasePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExternalPluggableDatabasePtrOutput)
}
...
type ExternalPluggableDatabaseOutput struct {
	*pulumi.OutputState
}
...
func (o ExternalPluggableDatabaseOutput) ToExternalPluggableDatabasePtrOutput() ExternalPluggableDatabasePtrOutput {
	return o.ToExternalPluggableDatabasePtrOutputWithContext(context.Background())
}

func (o ExternalPluggableDatabaseOutput) ToExternalPluggableDatabasePtrOutputWithContext(ctx context.Context) ExternalPluggableDatabasePtrOutput {
	return o.ApplyT(func(v ExternalPluggableDatabase) *ExternalPluggableDatabase {
		return &v
	}).(ExternalPluggableDatabasePtrOutput)
}

type ExternalPluggableDatabasePtrOutput struct {
	*pulumi.OutputState
}

func (ExternalPluggableDatabasePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ExternalPluggableDatabase)(nil))
}

func (o ExternalPluggableDatabasePtrOutput) ToExternalPluggableDatabasePtrOutput() ExternalPluggableDatabasePtrOutput {
	return o
}

func (o ExternalPluggableDatabasePtrOutput) ToExternalPluggableDatabasePtrOutputWithContext(ctx context.Context) ExternalPluggableDatabasePtrOutput {
	return o
}
...
func (ExternalPluggableDatabaseMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ExternalPluggableDatabase)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ExternalPluggableDatabasePtrOutput{})
