...
// 		_, err := database.LookupDatabase(ctx, &database.LookupDatabaseArgs{
...
type LookupDatabaseResult struct {
	...
	ConnectionStrings GetDatabaseConnectionStrings `pulumi:"connectionStrings"`
	Database          GetDatabaseDatabase          `pulumi:"database"`
	DatabaseId        string                       `pulumi:"databaseId"`
	...
	DbBackupConfig GetDatabaseDbBackupConfig `pulumi:"dbBackupConfig"`
