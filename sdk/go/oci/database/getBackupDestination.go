...
// 		_, err := database.LookupBackupDestination(ctx, &database.LookupBackupDestinationArgs{
...
type LookupBackupDestinationResult struct {
	...
	MountTypeDetails    GetBackupDestinationMountTypeDetails `pulumi:"mountTypeDetails"`
