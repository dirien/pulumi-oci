...
// 		_, err := database.LookupCloudExadataInfrastructure(ctx, &database.LookupCloudExadataInfrastructureArgs{
...
type LookupCloudExadataInfrastructureResult struct {
	...
	MaintenanceWindow GetCloudExadataInfrastructureMaintenanceWindow `pulumi:"maintenanceWindow"`
