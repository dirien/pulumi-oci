...
// 		_, err := database.LookupExadataInfrastructure(ctx, &database.LookupExadataInfrastructureArgs{
...
type LookupExadataInfrastructureResult struct {
	...
	MaintenanceWindow GetExadataInfrastructureMaintenanceWindow `pulumi:"maintenanceWindow"`
