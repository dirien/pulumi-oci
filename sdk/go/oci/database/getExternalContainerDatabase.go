...
// 		_, err := database.LookupExternalContainerDatabase(ctx, &database.LookupExternalContainerDatabaseArgs{
...
type LookupExternalContainerDatabaseResult struct {
	...
	DatabaseManagementConfig GetExternalContainerDatabaseDatabaseManagementConfig `pulumi:"databaseManagementConfig"`
