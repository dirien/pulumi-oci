...
func (*ExadataIormConfig) ElementType() reflect.Type {
	return reflect.TypeOf((*ExadataIormConfig)(nil))
}
...
func (i *ExadataIormConfig) ToExadataIormConfigPtrOutput() ExadataIormConfigPtrOutput {
	return i.ToExadataIormConfigPtrOutputWithContext(context.Background())
}

func (i *ExadataIormConfig) ToExadataIormConfigPtrOutputWithContext(ctx context.Context) ExadataIormConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExadataIormConfigPtrOutput)
}

type ExadataIormConfigPtrInput interface {
	pulumi.Input

	ToExadataIormConfigPtrOutput() ExadataIormConfigPtrOutput
	ToExadataIormConfigPtrOutputWithContext(ctx context.Context) ExadataIormConfigPtrOutput
}

type exadataIormConfigPtrType ExadataIormConfigArgs

func (*exadataIormConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ExadataIormConfig)(nil))
}

func (i *exadataIormConfigPtrType) ToExadataIormConfigPtrOutput() ExadataIormConfigPtrOutput {
	return i.ToExadataIormConfigPtrOutputWithContext(context.Background())
}

func (i *exadataIormConfigPtrType) ToExadataIormConfigPtrOutputWithContext(ctx context.Context) ExadataIormConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExadataIormConfigPtrOutput)
}
...
type ExadataIormConfigOutput struct {
	*pulumi.OutputState
}
...
func (o ExadataIormConfigOutput) ToExadataIormConfigPtrOutput() ExadataIormConfigPtrOutput {
	return o.ToExadataIormConfigPtrOutputWithContext(context.Background())
}

func (o ExadataIormConfigOutput) ToExadataIormConfigPtrOutputWithContext(ctx context.Context) ExadataIormConfigPtrOutput {
	return o.ApplyT(func(v ExadataIormConfig) *ExadataIormConfig {
		return &v
	}).(ExadataIormConfigPtrOutput)
}

type ExadataIormConfigPtrOutput struct {
	*pulumi.OutputState
}

func (ExadataIormConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ExadataIormConfig)(nil))
}

func (o ExadataIormConfigPtrOutput) ToExadataIormConfigPtrOutput() ExadataIormConfigPtrOutput {
	return o
}

func (o ExadataIormConfigPtrOutput) ToExadataIormConfigPtrOutputWithContext(ctx context.Context) ExadataIormConfigPtrOutput {
	return o
}
...
func (ExadataIormConfigMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ExadataIormConfig)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ExadataIormConfigPtrOutput{})
