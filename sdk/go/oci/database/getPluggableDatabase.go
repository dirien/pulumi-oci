...
// 		_, err := database.LookupPluggableDatabase(ctx, &database.LookupPluggableDatabaseArgs{
...
type LookupPluggableDatabaseResult struct {
	...
	ConnectionStrings GetPluggableDatabaseConnectionStrings `pulumi:"connectionStrings"`
