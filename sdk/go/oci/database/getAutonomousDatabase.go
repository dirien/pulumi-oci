...
// 		_, err := database.LookupAutonomousDatabase(ctx, &database.LookupAutonomousDatabaseArgs{
...
type LookupAutonomousDatabaseResult struct {
	...
	ApexDetails GetAutonomousDatabaseApexDetails `pulumi:"apexDetails"`
	...
	BackupConfig GetAutonomousDatabaseBackupConfig `pulumi:"backupConfig"`
	CloneType    string                            `pulumi:"cloneType"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
	CompartmentId string `pulumi:"compartmentId"`
	// The connection string used to connect to the Autonomous Database. The username for the Service Console is ADMIN. Use the password you entered when creating the Autonomous Database for the password value.
	ConnectionStrings GetAutonomousDatabaseConnectionStrings `pulumi:"connectionStrings"`
	...
	ConnectionUrls GetAutonomousDatabaseConnectionUrls `pulumi:"connectionUrls"`
	...
	StandbyDb GetAutonomousDatabaseStandbyDb `pulumi:"standbyDb"`
