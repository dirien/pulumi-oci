...
// 		_, err := database.LookupExternalDatabaseConnector(ctx, &database.LookupExternalDatabaseConnectorArgs{
...
type LookupExternalDatabaseConnectorResult struct {
	...
	ConnectionCredentials GetExternalDatabaseConnectorConnectionCredentials `pulumi:"connectionCredentials"`
	// The status of connectivity to the external database.
	ConnectionStatus string `pulumi:"connectionStatus"`
	// The Oracle Database connection string.
	ConnectionString GetExternalDatabaseConnectorConnectionString `pulumi:"connectionString"`
