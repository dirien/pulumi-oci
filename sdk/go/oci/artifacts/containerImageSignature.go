...
func (*ContainerImageSignature) ElementType() reflect.Type {
	return reflect.TypeOf((*ContainerImageSignature)(nil))
}
...
func (i *ContainerImageSignature) ToContainerImageSignaturePtrOutput() ContainerImageSignaturePtrOutput {
	return i.ToContainerImageSignaturePtrOutputWithContext(context.Background())
}

func (i *ContainerImageSignature) ToContainerImageSignaturePtrOutputWithContext(ctx context.Context) ContainerImageSignaturePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContainerImageSignaturePtrOutput)
}

type ContainerImageSignaturePtrInput interface {
	pulumi.Input

	ToContainerImageSignaturePtrOutput() ContainerImageSignaturePtrOutput
	ToContainerImageSignaturePtrOutputWithContext(ctx context.Context) ContainerImageSignaturePtrOutput
}

type containerImageSignaturePtrType ContainerImageSignatureArgs

func (*containerImageSignaturePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ContainerImageSignature)(nil))
}

func (i *containerImageSignaturePtrType) ToContainerImageSignaturePtrOutput() ContainerImageSignaturePtrOutput {
	return i.ToContainerImageSignaturePtrOutputWithContext(context.Background())
}

func (i *containerImageSignaturePtrType) ToContainerImageSignaturePtrOutputWithContext(ctx context.Context) ContainerImageSignaturePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ContainerImageSignaturePtrOutput)
}
...
type ContainerImageSignatureOutput struct {
	*pulumi.OutputState
}
...
func (o ContainerImageSignatureOutput) ToContainerImageSignaturePtrOutput() ContainerImageSignaturePtrOutput {
	return o.ToContainerImageSignaturePtrOutputWithContext(context.Background())
}

func (o ContainerImageSignatureOutput) ToContainerImageSignaturePtrOutputWithContext(ctx context.Context) ContainerImageSignaturePtrOutput {
	return o.ApplyT(func(v ContainerImageSignature) *ContainerImageSignature {
		return &v
	}).(ContainerImageSignaturePtrOutput)
}

type ContainerImageSignaturePtrOutput struct {
	*pulumi.OutputState
}

func (ContainerImageSignaturePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ContainerImageSignature)(nil))
}

func (o ContainerImageSignaturePtrOutput) ToContainerImageSignaturePtrOutput() ContainerImageSignaturePtrOutput {
	return o
}

func (o ContainerImageSignaturePtrOutput) ToContainerImageSignaturePtrOutputWithContext(ctx context.Context) ContainerImageSignaturePtrOutput {
	return o
}
...
func (ContainerImageSignatureMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]ContainerImageSignature)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(ContainerImageSignaturePtrOutput{})
