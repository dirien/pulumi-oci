...
// 		_, err := oci.GetDataintegrationWorkspace(ctx, &GetDataintegrationWorkspaceArgs{
...
// }
// ```
func LookupDataintegrationWorkspace(ctx *pulumi.Context, args *LookupDataintegrationWorkspaceArgs, opts ...pulumi.InvokeOption) (*LookupDataintegrationWorkspaceResult, error) {
	var rv LookupDataintegrationWorkspaceResult
	err := ctx.Invoke("oci:index/getDataintegrationWorkspace:GetDataintegrationWorkspace", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDataintegrationWorkspaceArgs struct {
	// The workspace ID.
	WorkspaceId string `pulumi:"workspaceId"`
}

// A collection of values returned by GetDataintegrationWorkspace.
type LookupDataintegrationWorkspaceResult struct {
