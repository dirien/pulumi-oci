...
// 		_, err := oci.GetLogAnalyticsLogAnalyticsObjectCollectionRule(ctx, &GetLogAnalyticsLogAnalyticsObjectCollectionRuleArgs{
...
// }
// ```
func LookupLogAnalyticsLogAnalyticsObjectCollectionRule(ctx *pulumi.Context, args *LookupLogAnalyticsLogAnalyticsObjectCollectionRuleArgs, opts ...pulumi.InvokeOption) (*LookupLogAnalyticsLogAnalyticsObjectCollectionRuleResult, error) {
	var rv LookupLogAnalyticsLogAnalyticsObjectCollectionRuleResult
	err := ctx.Invoke("oci:index/getLogAnalyticsLogAnalyticsObjectCollectionRule:GetLogAnalyticsLogAnalyticsObjectCollectionRule", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupLogAnalyticsLogAnalyticsObjectCollectionRuleArgs struct {
...
type LookupLogAnalyticsLogAnalyticsObjectCollectionRuleResult struct {
	...
	Overrides []GetLogAnalyticsLogAnalyticsObjectCollectionRuleOverride `pulumi:"overrides"`
