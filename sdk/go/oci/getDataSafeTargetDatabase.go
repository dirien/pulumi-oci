...
// 		_, err := oci.GetDataSafeTargetDatabase(ctx, &GetDataSafeTargetDatabaseArgs{
...
// }
// ```
func LookupDataSafeTargetDatabase(ctx *pulumi.Context, args *LookupDataSafeTargetDatabaseArgs, opts ...pulumi.InvokeOption) (*LookupDataSafeTargetDatabaseResult, error) {
	var rv LookupDataSafeTargetDatabaseResult
	err := ctx.Invoke("oci:index/getDataSafeTargetDatabase:GetDataSafeTargetDatabase", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDataSafeTargetDatabaseResult struct {
	...
	ConnectionOption GetDataSafeTargetDatabaseConnectionOption `pulumi:"connectionOption"`
	// The database credentials required for Data Safe to connect to the database.
	Credentials GetDataSafeTargetDatabaseCredentials `pulumi:"credentials"`
	...
	DatabaseDetails GetDataSafeTargetDatabaseDatabaseDetails `pulumi:"databaseDetails"`
	...
	TlsConfig GetDataSafeTargetDatabaseTlsConfig `pulumi:"tlsConfig"`
}
