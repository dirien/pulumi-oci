...
// 		_, err := oci.GetMysqlMysqlDbSystem(ctx, &GetMysqlMysqlDbSystemArgs{
...
// }
// ```
func LookupMysqlMysqlDbSystem(ctx *pulumi.Context, args *LookupMysqlMysqlDbSystemArgs, opts ...pulumi.InvokeOption) (*LookupMysqlMysqlDbSystemResult, error) {
	var rv LookupMysqlMysqlDbSystemResult
	err := ctx.Invoke("oci:index/getMysqlMysqlDbSystem:GetMysqlMysqlDbSystem", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupMysqlMysqlDbSystemArgs struct {
	// The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
	DbSystemId string `pulumi:"dbSystemId"`
}

// A collection of values returned by GetMysqlMysqlDbSystem.
type LookupMysqlMysqlDbSystemResult struct {
	AdminPassword string `pulumi:"adminPassword"`
	AdminUsername string `pulumi:"adminUsername"`
	// DEPRECATED -- please use HeatWave API instead. A summary of an Analytics Cluster.
	AnalyticsCluster GetMysqlMysqlDbSystemAnalyticsCluster `pulumi:"analyticsCluster"`
	// The availability domain in which the DB System is placed.
	AvailabilityDomain string `pulumi:"availabilityDomain"`
	// The Backup policy for the DB System.
	BackupPolicy GetMysqlMysqlDbSystemBackupPolicy `pulumi:"backupPolicy"`
	// A list with a summary of all the Channels attached to the DB System.
	Channels []GetMysqlMysqlDbSystemChannel `pulumi:"channels"`
	// The OCID of the compartment the DB System belongs in.
	CompartmentId string `pulumi:"compartmentId"`
	// The OCID of the Configuration to be used for Instances in this DB System.
	ConfigurationId string `pulumi:"configurationId"`
	// The availability domain and fault domain a DB System is placed in.
	CurrentPlacement GetMysqlMysqlDbSystemCurrentPlacement `pulumi:"currentPlacement"`
	...
	Endpoints []GetMysqlMysqlDbSystemEndpoint `pulumi:"endpoints"`
	// The fault domain on which to deploy the Read/Write endpoint. This defines the preferred primary instance.
	FaultDomain string `pulumi:"faultDomain"`
	// Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
	FreeformTags map[string]interface{} `pulumi:"freeformTags"`
	// A summary of a HeatWave cluster.
	HeatWaveCluster GetMysqlMysqlDbSystemHeatWaveCluster `pulumi:"heatWaveCluster"`
	...
	Maintenance GetMysqlMysqlDbSystemMaintenance `pulumi:"maintenance"`
	...
	Source GetMysqlMysqlDbSystemSource `pulumi:"source"`
