...
// 		_, err := oci.GetCorePrivateIps(ctx, &GetCorePrivateIpsArgs{
// 			SubnetId: &opt0,
// 		}, nil)
// 		if err != nil {
// 			return err
...
// }
// ```
func GetCorePrivateIps(ctx *pulumi.Context, args *GetCorePrivateIpsArgs, opts ...pulumi.InvokeOption) (*GetCorePrivateIpsResult, error) {
	var rv GetCorePrivateIpsResult
	err := ctx.Invoke("oci:index/getCorePrivateIps:GetCorePrivateIps", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetCorePrivateIpsArgs struct {
	Filters []GetCorePrivateIpsFilter `pulumi:"filters"`
...
type GetCorePrivateIpsResult struct {
	Filters []GetCorePrivateIpsFilter `pulumi:"filters"`
	...
	PrivateIps []GetCorePrivateIpsPrivateIp `pulumi:"privateIps"`
