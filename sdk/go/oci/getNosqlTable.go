...
// 		_, err := oci.GetNosqlTable(ctx, &GetNosqlTableArgs{
...
// }
// ```
func LookupNosqlTable(ctx *pulumi.Context, args *LookupNosqlTableArgs, opts ...pulumi.InvokeOption) (*LookupNosqlTableResult, error) {
	var rv LookupNosqlTableResult
	err := ctx.Invoke("oci:index/getNosqlTable:GetNosqlTable", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupNosqlTableArgs struct {
...
type LookupNosqlTableResult struct {
