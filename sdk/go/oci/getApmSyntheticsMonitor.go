...
// 		_, err := oci.GetApmSyntheticsMonitor(ctx, &GetApmSyntheticsMonitorArgs{
...
// }
// ```
func LookupApmSyntheticsMonitor(ctx *pulumi.Context, args *LookupApmSyntheticsMonitorArgs, opts ...pulumi.InvokeOption) (*LookupApmSyntheticsMonitorResult, error) {
	var rv LookupApmSyntheticsMonitorResult
	err := ctx.Invoke("oci:index/getApmSyntheticsMonitor:GetApmSyntheticsMonitor", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupApmSyntheticsMonitorArgs struct {
...
type LookupApmSyntheticsMonitorResult struct {
	ApmDomainId string `pulumi:"apmDomainId"`
	// Details of monitor configuration.
	Configuration GetApmSyntheticsMonitorConfiguration `pulumi:"configuration"`
	...
	ScriptParameters []GetApmSyntheticsMonitorScriptParameter `pulumi:"scriptParameters"`
