...
// 		_, err := oci.GetDatabaseCloudVmCluster(ctx, &GetDatabaseCloudVmClusterArgs{
...
// }
// ```
func LookupDatabaseCloudVmCluster(ctx *pulumi.Context, args *LookupDatabaseCloudVmClusterArgs, opts ...pulumi.InvokeOption) (*LookupDatabaseCloudVmClusterResult, error) {
	var rv LookupDatabaseCloudVmClusterResult
	err := ctx.Invoke("oci:index/getDatabaseCloudVmCluster:GetDatabaseCloudVmCluster", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupDatabaseCloudVmClusterArgs struct {
...
type LookupDatabaseCloudVmClusterResult struct {
	...
	IormConfigCache GetDatabaseCloudVmClusterIormConfigCache `pulumi:"iormConfigCache"`
