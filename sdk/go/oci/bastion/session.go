...
func (i *Session) ToSessionPtrOutput() SessionPtrOutput {
	return i.ToSessionPtrOutputWithContext(context.Background())
}

func (i *Session) ToSessionPtrOutputWithContext(ctx context.Context) SessionPtrOutput {
...
type SessionPtrInput interface {
	...
	ToSessionPtrOutputWithContext(ctx context.Context) SessionPtrOutput
}
...
func (SessionMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Session)(nil))
}
