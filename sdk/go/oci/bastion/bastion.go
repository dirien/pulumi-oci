...
func (*Bastion) ElementType() reflect.Type {
	return reflect.TypeOf((*Bastion)(nil))
}
...
func (i *Bastion) ToBastionPtrOutput() BastionPtrOutput {
	return i.ToBastionPtrOutputWithContext(context.Background())
}

func (i *Bastion) ToBastionPtrOutputWithContext(ctx context.Context) BastionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BastionPtrOutput)
}

type BastionPtrInput interface {
	pulumi.Input

	ToBastionPtrOutput() BastionPtrOutput
	ToBastionPtrOutputWithContext(ctx context.Context) BastionPtrOutput
}

type bastionPtrType BastionArgs

func (*bastionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Bastion)(nil))
}

func (i *bastionPtrType) ToBastionPtrOutput() BastionPtrOutput {
	return i.ToBastionPtrOutputWithContext(context.Background())
}

func (i *bastionPtrType) ToBastionPtrOutputWithContext(ctx context.Context) BastionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(BastionPtrOutput)
}
...
func (o BastionOutput) ToBastionPtrOutput() BastionPtrOutput {
	return o.ToBastionPtrOutputWithContext(context.Background())
}

func (o BastionOutput) ToBastionPtrOutputWithContext(ctx context.Context) BastionPtrOutput {
	return o.ApplyT(func(v Bastion) *Bastion {
		return &v
	}).(BastionPtrOutput)
}

type BastionPtrOutput struct {
	*pulumi.OutputState
}

func (BastionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**Bastion)(nil))
}

func (o BastionPtrOutput) ToBastionPtrOutput() BastionPtrOutput {
	return o
}

func (o BastionPtrOutput) ToBastionPtrOutputWithContext(ctx context.Context) BastionPtrOutput {
	return o
}
...
func (BastionMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]Bastion)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(BastionPtrOutput{})
