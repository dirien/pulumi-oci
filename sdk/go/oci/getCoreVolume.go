...
// 		_, err := oci.GetCoreVolume(ctx, &GetCoreVolumeArgs{
...
// }
// ```
func LookupCoreVolume(ctx *pulumi.Context, args *LookupCoreVolumeArgs, opts ...pulumi.InvokeOption) (*LookupCoreVolumeResult, error) {
	var rv LookupCoreVolumeResult
	err := ctx.Invoke("oci:index/getCoreVolume:GetCoreVolume", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreVolumeArgs struct {
	// The OCID of the volume.
	VolumeId string `pulumi:"volumeId"`
}

// A collection of values returned by GetCoreVolume.
type LookupCoreVolumeResult struct {
	...
	BlockVolumeReplicas         []GetCoreVolumeBlockVolumeReplica `pulumi:"blockVolumeReplicas"`
	...
	SourceDetails GetCoreVolumeSourceDetails `pulumi:"sourceDetails"`
