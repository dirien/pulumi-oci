...
// 		_, err := oci.GetCorePublicIpPool(ctx, &GetCorePublicIpPoolArgs{
...
// }
// ```
func LookupCorePublicIpPool(ctx *pulumi.Context, args *LookupCorePublicIpPoolArgs, opts ...pulumi.InvokeOption) (*LookupCorePublicIpPoolResult, error) {
	var rv LookupCorePublicIpPoolResult
	err := ctx.Invoke("oci:index/getCorePublicIpPool:GetCorePublicIpPool", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCorePublicIpPoolArgs struct {
...
type LookupCorePublicIpPoolResult struct {
