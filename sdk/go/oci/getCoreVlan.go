...
// 		_, err := oci.GetCoreVlan(ctx, &GetCoreVlanArgs{
...
// }
// ```
func LookupCoreVlan(ctx *pulumi.Context, args *LookupCoreVlanArgs, opts ...pulumi.InvokeOption) (*LookupCoreVlanResult, error) {
	var rv LookupCoreVlanResult
	err := ctx.Invoke("oci:index/getCoreVlan:GetCoreVlan", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupCoreVlanArgs struct {
...
type LookupCoreVlanResult struct {
