...
// 		_, err := oci.GetMysqlMysqlConfigurations(ctx, &GetMysqlMysqlConfigurationsArgs{
...
// }
// ```
func GetMysqlMysqlConfigurations(ctx *pulumi.Context, args *GetMysqlMysqlConfigurationsArgs, opts ...pulumi.InvokeOption) (*GetMysqlMysqlConfigurationsResult, error) {
	var rv GetMysqlMysqlConfigurationsResult
	err := ctx.Invoke("oci:index/getMysqlMysqlConfigurations:GetMysqlMysqlConfigurations", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetMysqlMysqlConfigurationsArgs struct {
	...
	Filters     []GetMysqlMysqlConfigurationsFilter `pulumi:"filters"`
...
type GetMysqlMysqlConfigurationsResult struct {
	// OCID of the Compartment the Configuration exists in.
	CompartmentId   string  `pulumi:"compartmentId"`
	ConfigurationId *string `pulumi:"configurationId"`
	// The list of configurations.
	Configurations []GetMysqlMysqlConfigurationsConfiguration `pulumi:"configurations"`
