...
// 		_, err := oci.GetArtifactsContainerImageSignatures(ctx, &GetArtifactsContainerImageSignaturesArgs{
...
// }
// ```
func GetArtifactsContainerImageSignatures(ctx *pulumi.Context, args *GetArtifactsContainerImageSignaturesArgs, opts ...pulumi.InvokeOption) (*GetArtifactsContainerImageSignaturesResult, error) {
	var rv GetArtifactsContainerImageSignaturesResult
	err := ctx.Invoke("oci:index/getArtifactsContainerImageSignatures:GetArtifactsContainerImageSignatures", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetArtifactsContainerImageSignaturesArgs struct {
	...
	Filters     []GetArtifactsContainerImageSignaturesFilter `pulumi:"filters"`
...
type GetArtifactsContainerImageSignaturesResult struct {
	...
	ContainerImageSignatureCollections []GetArtifactsContainerImageSignaturesContainerImageSignatureCollection `pulumi:"containerImageSignatureCollections"`
