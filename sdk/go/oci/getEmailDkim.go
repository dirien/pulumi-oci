...
// 		_, err := oci.GetEmailDkim(ctx, &GetEmailDkimArgs{
...
// }
// ```
func LookupEmailDkim(ctx *pulumi.Context, args *LookupEmailDkimArgs, opts ...pulumi.InvokeOption) (*LookupEmailDkimResult, error) {
	var rv LookupEmailDkimResult
	err := ctx.Invoke("oci:index/getEmailDkim:GetEmailDkim", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupEmailDkimArgs struct {
...
type LookupEmailDkimResult struct {
