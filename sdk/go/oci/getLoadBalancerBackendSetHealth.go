...
// 		_, err := oci.GetLoadBalancerBackendSetHealth(ctx, &GetLoadBalancerBackendSetHealthArgs{
...
// }
// ```
func GetLoadBalancerBackendSetHealth(ctx *pulumi.Context, args *GetLoadBalancerBackendSetHealthArgs, opts ...pulumi.InvokeOption) (*GetLoadBalancerBackendSetHealthResult, error) {
	var rv GetLoadBalancerBackendSetHealthResult
	err := ctx.Invoke("oci:index/getLoadBalancerBackendSetHealth:GetLoadBalancerBackendSetHealth", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetLoadBalancerBackendSetHealthArgs struct {
...
type GetLoadBalancerBackendSetHealthResult struct {
	BackendSetName string `pulumi:"backendSetName"`
