...
// 		_, err := oci.GetMonitoringMetrics(ctx, &GetMonitoringMetricsArgs{
...
// }
// ```
func GetMonitoringMetrics(ctx *pulumi.Context, args *GetMonitoringMetricsArgs, opts ...pulumi.InvokeOption) (*GetMonitoringMetricsResult, error) {
	var rv GetMonitoringMetricsResult
	err := ctx.Invoke("oci:index/getMonitoringMetrics:GetMonitoringMetrics", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetMonitoringMetricsArgs struct {
	...
	Filters          []GetMonitoringMetricsFilter `pulumi:"filters"`
...
type GetMonitoringMetricsResult struct {
	...
	Id string `pulumi:"id"`
	// The list of metrics.
	Metrics []GetMonitoringMetricsMetric `pulumi:"metrics"`
