...
// 		_, err := oci.GetFunctionsFunction(ctx, &GetFunctionsFunctionArgs{
...
// }
// ```
func LookupFunctionsFunction(ctx *pulumi.Context, args *LookupFunctionsFunctionArgs, opts ...pulumi.InvokeOption) (*LookupFunctionsFunctionResult, error) {
	var rv LookupFunctionsFunctionResult
	err := ctx.Invoke("oci:index/getFunctionsFunction:GetFunctionsFunction", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupFunctionsFunctionArgs struct {
...
type LookupFunctionsFunctionResult struct {
