...
// 		_, err := oci.GetFunctionsApplication(ctx, &GetFunctionsApplicationArgs{
...
// }
// ```
func LookupFunctionsApplication(ctx *pulumi.Context, args *LookupFunctionsApplicationArgs, opts ...pulumi.InvokeOption) (*LookupFunctionsApplicationResult, error) {
	var rv LookupFunctionsApplicationResult
	err := ctx.Invoke("oci:index/getFunctionsApplication:GetFunctionsApplication", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type LookupFunctionsApplicationArgs struct {
...
type LookupFunctionsApplicationResult struct {
	ApplicationId string `pulumi:"applicationId"`
	...
	TraceConfig GetFunctionsApplicationTraceConfig `pulumi:"traceConfig"`
}
