...
func GetDatabaseDbHomes(ctx *pulumi.Context, args *GetDatabaseDbHomesArgs, opts ...pulumi.InvokeOption) (*GetDatabaseDbHomesResult, error) {
	var rv GetDatabaseDbHomesResult
	err := ctx.Invoke("oci:index/getDatabaseDbHomes:GetDatabaseDbHomes", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetDatabaseDbHomesArgs struct {
	...
	Filters     []GetDatabaseDbHomesFilter `pulumi:"filters"`
...
type GetDatabaseDbHomesResult struct {
	BackupId *string `pulumi:"backupId"`
	// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
	CompartmentId string `pulumi:"compartmentId"`
	// The list of db_homes.
	DbHomes []GetDatabaseDbHomesDbHome `pulumi:"dbHomes"`
