...
__all__ = ['CoreVirtualNetworkArgs', 'CoreVirtualNetwork']

@pulumi.input_type
class CoreVirtualNetworkArgs:
...
@pulumi.input_type
class _CoreVirtualNetworkState:
    def __init__(__self__, *,
                 cidr_block: Optional[pulumi.Input[str]] = None,
                 cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
...
class CoreVirtualNetwork(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CoreVirtualNetwork resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreVirtualNetworkArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CoreVirtualNetwork resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CoreVirtualNetworkArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVirtualNetworkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVirtualNetworkArgs.__new__(CoreVirtualNetworkArgs)
        ...
        super(CoreVirtualNetwork, __self__).__init__(
            'oci:index/coreVirtualNetwork:CoreVirtualNetwork',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_domain_name: Optional[pulumi.Input[str]] = None) -> 'CoreVirtualNetwork':
        """
        ...
        __props__ = _CoreVirtualNetworkState.__new__(_CoreVirtualNetworkState)
        ...
        return CoreVirtualNetwork(resource_name, opts=opts, __props__=__props__)
