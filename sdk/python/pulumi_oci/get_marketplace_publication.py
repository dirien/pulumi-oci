...
__all__ = [
    'GetMarketplacePublicationResult',
    'AwaitableGetMarketplacePublicationResult',
    'get_marketplace_publication',
]

@pulumi.output_type
class GetMarketplacePublicationResult:
    """
    ...
    @property
    @pulumi.getter
    def icon(self) -> 'outputs.GetMarketplacePublicationIconResult':
        """
    ...
    def package_details(self) -> 'outputs.GetMarketplacePublicationPackageDetailsResult':
    ...
    def support_contacts(self) -> Sequence['outputs.GetMarketplacePublicationSupportContactResult']:
        """
    ...
    def supported_operating_systems(self) -> Sequence['outputs.GetMarketplacePublicationSupportedOperatingSystemResult']:
        """
...
class AwaitableGetMarketplacePublicationResult(GetMarketplacePublicationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplacePublicationResult(
...
def get_marketplace_publication(publication_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplacePublicationResult:
    """
    ...
    test_publication = oci.get_marketplace_publication(publication_id=oci_marketplace_publication["test_publication"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplacePublication:GetMarketplacePublication', __args__, opts=opts, typ=GetMarketplacePublicationResult).value

    return AwaitableGetMarketplacePublicationResult(
