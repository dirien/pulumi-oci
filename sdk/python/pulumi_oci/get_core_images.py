...
__all__ = [
    'GetCoreImagesResult',
    'AwaitableGetCoreImagesResult',
    'get_core_images',
]

@pulumi.output_type
class GetCoreImagesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreImagesFilterResult']]:
    ...
    @property
    @pulumi.getter
    def images(self) -> Sequence['outputs.GetCoreImagesImageResult']:
        """
        The list of images.
        """
...
class AwaitableGetCoreImagesResult(GetCoreImagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreImagesResult(
...
def get_core_images(compartment_id: Optional[str] = None,
                    display_name: Optional[str] = None,
                    filters: Optional[Sequence[pulumi.InputType['GetCoreImagesFilterArgs']]] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreImagesResult:
    """
    ...
    test_images = oci.get_core_images(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreImages:GetCoreImages', __args__, opts=opts, typ=GetCoreImagesResult).value

    return AwaitableGetCoreImagesResult(
