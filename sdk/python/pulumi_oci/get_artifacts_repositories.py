...
__all__ = [
    'GetArtifactsRepositoriesResult',
    'AwaitableGetArtifactsRepositoriesResult',
    'get_artifacts_repositories',
]

@pulumi.output_type
class GetArtifactsRepositoriesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetArtifactsRepositoriesFilterResult']]:
    ...
    def repository_collections(self) -> Sequence['outputs.GetArtifactsRepositoriesRepositoryCollectionResult']:
        """
...
class AwaitableGetArtifactsRepositoriesResult(GetArtifactsRepositoriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsRepositoriesResult(
...
def get_artifacts_repositories(compartment_id: Optional[str] = None,
                               display_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetArtifactsRepositoriesFilterArgs']]] = None,
                               id: Optional[str] = None,
                               is_immutable: Optional[bool] = None,
                               state: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsRepositoriesResult:
    """
    ...
    test_repositories = oci.get_artifacts_repositories(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsRepositories:GetArtifactsRepositories', __args__, opts=opts, typ=GetArtifactsRepositoriesResult).value

    return AwaitableGetArtifactsRepositoriesResult(
