...
__all__ = [
    'GetDatabaseKeyStoreResult',
    'AwaitableGetDatabaseKeyStoreResult',
    'get_database_key_store',
]

@pulumi.output_type
class GetDatabaseKeyStoreResult:
    """
    ...
    def __init__(__self__, associated_databases=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, key_store_id=None, lifecycle_details=None, state=None, time_created=None, type_details=None):
        ...
        if type_details and not isinstance(type_details, dict):
            raise TypeError("Expected argument 'type_details' to be a dict")
        pulumi.set(__self__, "type_details", type_details)

    @property
    @pulumi.getter(name="associatedDatabases")
    def associated_databases(self) -> Sequence['outputs.GetDatabaseKeyStoreAssociatedDatabaseResult']:
        """
    ...
    def type_details(self) -> 'outputs.GetDatabaseKeyStoreTypeDetailsResult':
        """
...
class AwaitableGetDatabaseKeyStoreResult(GetDatabaseKeyStoreResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseKeyStoreResult(
...
def get_database_key_store(key_store_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseKeyStoreResult:
    """
    ...
    test_key_store = oci.get_database_key_store(key_store_id=oci_database_key_store["test_key_store"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseKeyStore:GetDatabaseKeyStore', __args__, opts=opts, typ=GetDatabaseKeyStoreResult).value

    return AwaitableGetDatabaseKeyStoreResult(
