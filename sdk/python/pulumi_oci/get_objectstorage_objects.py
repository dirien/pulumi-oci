...
__all__ = [
    'GetObjectstorageObjectsResult',
    'AwaitableGetObjectstorageObjectsResult',
    'get_objectstorage_objects',
]

@pulumi.output_type
class GetObjectstorageObjectsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetObjectstorageObjectsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def objects(self) -> Sequence['outputs.GetObjectstorageObjectsObjectResult']:
        """
...
class AwaitableGetObjectstorageObjectsResult(GetObjectstorageObjectsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageObjectsResult(
            bucket=self.bucket,
...
def get_objectstorage_objects(bucket: Optional[str] = None,
                              delimiter: Optional[str] = None,
                              end: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetObjectstorageObjectsFilterArgs']]] = None,
                              namespace: Optional[str] = None,
                              prefix: Optional[str] = None,
                              start: Optional[str] = None,
                              start_after: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageObjectsResult:
    """
    ...
    test_objects = oci.get_objectstorage_objects(bucket=var["object_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageObjects:GetObjectstorageObjects', __args__, opts=opts, typ=GetObjectstorageObjectsResult).value

    return AwaitableGetObjectstorageObjectsResult(
