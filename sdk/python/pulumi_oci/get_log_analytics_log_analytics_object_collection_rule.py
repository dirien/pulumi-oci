...
class GetLogAnalyticsLogAnalyticsObjectCollectionRuleResult:
    ...
    @property
    @pulumi.getter
    def overrides(self) -> Sequence['outputs.GetLogAnalyticsLogAnalyticsObjectCollectionRuleOverrideResult']:
        """
...
class AwaitableGetLogAnalyticsLogAnalyticsObjectCollectionRuleResult(GetLogAnalyticsLogAnalyticsObjectCollectionRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLogAnalyticsLogAnalyticsObjectCollectionRuleResult(
...
def get_log_analytics_log_analytics_object_collection_rule(log_analytics_object_collection_rule_id: Optional[str] = None,
                                                           namespace: Optional[str] = None,
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLogAnalyticsLogAnalyticsObjectCollectionRuleResult:
    """
    ...
    test_log_analytics_object_collection_rule = oci.get_log_analytics_log_analytics_object_collection_rule(log_analytics_object_collection_rule_id=oci_log_analytics_log_analytics_object_collection_rule["test_log_analytics_object_collection_rule"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLogAnalyticsLogAnalyticsObjectCollectionRule:GetLogAnalyticsLogAnalyticsObjectCollectionRule', __args__, opts=opts, typ=GetLogAnalyticsLogAnalyticsObjectCollectionRuleResult).value

    return AwaitableGetLogAnalyticsLogAnalyticsObjectCollectionRuleResult(
