...
__all__ = [
    'GetWaasCertificatesResult',
    'AwaitableGetWaasCertificatesResult',
    'get_waas_certificates',
]

@pulumi.output_type
class GetWaasCertificatesResult:
    """
    ...
    @property
    @pulumi.getter
    def certificates(self) -> Sequence['outputs.GetWaasCertificatesCertificateResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetWaasCertificatesFilterResult']]:
...
class AwaitableGetWaasCertificatesResult(GetWaasCertificatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasCertificatesResult(
...
def get_waas_certificates(compartment_id: Optional[str] = None,
                          display_names: Optional[Sequence[str]] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetWaasCertificatesFilterArgs']]] = None,
                          ids: Optional[Sequence[str]] = None,
                          states: Optional[Sequence[str]] = None,
                          time_created_greater_than_or_equal_to: Optional[str] = None,
                          time_created_less_than: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasCertificatesResult:
    """
    ...
    test_certificates = oci.get_waas_certificates(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasCertificates:GetWaasCertificates', __args__, opts=opts, typ=GetWaasCertificatesResult).value

    return AwaitableGetWaasCertificatesResult(
