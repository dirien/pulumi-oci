...
__all__ = [
    'GetWaasCertificateResult',
    'AwaitableGetWaasCertificateResult',
    'get_waas_certificate',
]

@pulumi.output_type
class GetWaasCertificateResult:
    """
    A collection of values returned by GetWaasCertificate.
    """
    def __init__(__self__, certificate_data=None, certificate_id=None, compartment_id=None, defined_tags=None, display_name=None, extensions=None, freeform_tags=None, id=None, is_trust_verification_disabled=None, issued_by=None, issuer_name=None, private_key_data=None, public_key_info=None, serial_number=None, signature_algorithm=None, state=None, subject_name=None, time_created=None, time_not_valid_after=None, time_not_valid_before=None, version=None):
        ...
        if issuer_name and not isinstance(issuer_name, dict):
            raise TypeError("Expected argument 'issuer_name' to be a dict")
        ...
        if public_key_info and not isinstance(public_key_info, dict):
            raise TypeError("Expected argument 'public_key_info' to be a dict")
        ...
        if subject_name and not isinstance(subject_name, dict):
            raise TypeError("Expected argument 'subject_name' to be a dict")
    ...
    @property
    @pulumi.getter
    def extensions(self) -> Sequence['outputs.GetWaasCertificateExtensionResult']:
        """
    ...
    def issuer_name(self) -> 'outputs.GetWaasCertificateIssuerNameResult':
        """
    ...
    def public_key_info(self) -> 'outputs.GetWaasCertificatePublicKeyInfoResult':
        """
    ...
    def subject_name(self) -> 'outputs.GetWaasCertificateSubjectNameResult':
        """
...
class AwaitableGetWaasCertificateResult(GetWaasCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasCertificateResult(
...
def get_waas_certificate(certificate_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasCertificateResult:
    """
    ...
    test_certificate = oci.get_waas_certificate(certificate_id=oci_waas_certificate["test_certificate"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasCertificate:GetWaasCertificate', __args__, opts=opts, typ=GetWaasCertificateResult).value

    return AwaitableGetWaasCertificateResult(
        ...
        public_key_info=__ret__.public_key_info,
