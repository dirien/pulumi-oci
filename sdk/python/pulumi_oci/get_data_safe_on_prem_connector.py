...
__all__ = [
    'GetDataSafeOnPremConnectorResult',
    'AwaitableGetDataSafeOnPremConnectorResult',
    'get_data_safe_on_prem_connector',
]

@pulumi.output_type
class GetDataSafeOnPremConnectorResult:
    """
...
class AwaitableGetDataSafeOnPremConnectorResult(GetDataSafeOnPremConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataSafeOnPremConnectorResult(
...
def get_data_safe_on_prem_connector(on_prem_connector_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataSafeOnPremConnectorResult:
    """
    ...
    test_on_prem_connector = oci.get_data_safe_on_prem_connector(on_prem_connector_id=oci_data_safe_on_prem_connector["test_on_prem_connector"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataSafeOnPremConnector:GetDataSafeOnPremConnector', __args__, opts=opts, typ=GetDataSafeOnPremConnectorResult).value

    return AwaitableGetDataSafeOnPremConnectorResult(
