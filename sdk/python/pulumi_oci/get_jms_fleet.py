...
class AwaitableGetJmsFleetResult(GetJmsFleetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetJmsFleetResult(
...
def get_jms_fleet(fleet_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetJmsFleetResult:
    """
    ...
    test_fleet = oci.get_jms_fleet(fleet_id=oci_jms_fleet["test_fleet"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getJmsFleet:GetJmsFleet', __args__, opts=opts, typ=GetJmsFleetResult).value

    return AwaitableGetJmsFleetResult(
