...
__all__ = [
    'GetBdsAutoScalingConfigurationResult',
    'AwaitableGetBdsAutoScalingConfigurationResult',
    'get_bds_auto_scaling_configuration',
]

@pulumi.output_type
class GetBdsAutoScalingConfigurationResult:
    """
    A collection of values returned by GetBdsAutoScalingConfiguration.
    """
    def __init__(__self__, auto_scaling_configuration_id=None, bds_instance_id=None, cluster_admin_password=None, display_name=None, id=None, is_enabled=None, node_type=None, policy=None, state=None, time_created=None, time_updated=None):
    ...
    @property
    @pulumi.getter
    def policy(self) -> 'outputs.GetBdsAutoScalingConfigurationPolicyResult':
        """
...
class AwaitableGetBdsAutoScalingConfigurationResult(GetBdsAutoScalingConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBdsAutoScalingConfigurationResult(
...
def get_bds_auto_scaling_configuration(auto_scaling_configuration_id: Optional[str] = None,
                                       bds_instance_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBdsAutoScalingConfigurationResult:
    """
    ...
    test_auto_scaling_configuration = oci.get_bds_auto_scaling_configuration(auto_scaling_configuration_id=oci_autoscaling_auto_scaling_configuration["test_auto_scaling_configuration"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBdsAutoScalingConfiguration:GetBdsAutoScalingConfiguration', __args__, opts=opts, typ=GetBdsAutoScalingConfigurationResult).value

    return AwaitableGetBdsAutoScalingConfigurationResult(
