...
class _ModelState:
    def __init__(__self__, *,
                 ...
                 model_training_results: Optional[pulumi.Input['ModelModelTrainingResultsArgs']] = None,
        ...
        :param pulumi.Input['ModelModelTrainingDetailsArgs'] model_training_details: Specifies the details of the MSET model during the create call.
        :param pulumi.Input['ModelModelTrainingResultsArgs'] model_training_results: Specifies the details for an Anomaly Detection model trained with MSET.
        :param pulumi.Input[str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
    ...
    def model_training_results(self) -> Optional[pulumi.Input['ModelModelTrainingResultsArgs']]:
        """
    ...
    def model_training_results(self, value: Optional[pulumi.Input['ModelModelTrainingResultsArgs']]):
...
class Model(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_model = oci.aianomalydetection.Model("testModel",
            compartment_id=var["compartment_id"],
            model_training_details=oci.aianomalydetection.ModelModelTrainingDetailsArgs(
    ...
    def get(resource_name: str,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            model_training_details: Optional[pulumi.Input[pulumi.InputType['ModelModelTrainingDetailsArgs']]] = None,
            model_training_results: Optional[pulumi.Input[pulumi.InputType['ModelModelTrainingResultsArgs']]] = None,
            project_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[pulumi.InputType['ModelModelTrainingDetailsArgs']] model_training_details: Specifies the details of the MSET model during the create call.
        :param pulumi.Input[pulumi.InputType['ModelModelTrainingResultsArgs']] model_training_results: Specifies the details for an Anomaly Detection model trained with MSET.
        :param pulumi.Input[str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
        :param pulumi.Input[str] state: The state of the model.
        :param pulumi.Input[Mapping[str, Any]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[str] time_created: The time the the Model was created. An RFC3339 formatted datetime string.
    ...
    @property
    @pulumi.getter(name="modelTrainingResults")
    def model_training_results(self) -> pulumi.Output['outputs.ModelModelTrainingResults']:
        """
        Specifies the details for an Anomaly Detection model trained with MSET.
        """
        return pulumi.get(self, "model_training_results")
