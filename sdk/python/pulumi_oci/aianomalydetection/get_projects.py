...
def get_projects(compartment_id: Optional[str] = None,
    ...
    test_projects = oci.aianomalydetection.get_projects(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:aianomalydetection/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult).value
