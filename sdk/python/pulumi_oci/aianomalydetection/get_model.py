...
class GetModelResult:
    ...
    def __init__(__self__, compartment_id=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, model_id=None, model_training_details=None, model_training_results=None, project_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if model_training_details and not isinstance(model_training_details, dict):
            raise TypeError("Expected argument 'model_training_details' to be a dict")
        pulumi.set(__self__, "model_training_details", model_training_details)
        if model_training_results and not isinstance(model_training_results, dict):
            raise TypeError("Expected argument 'model_training_results' to be a dict")
    ...
    def model_training_details(self) -> 'outputs.GetModelModelTrainingDetailsResult':
        """
    ...
    def model_training_results(self) -> 'outputs.GetModelModelTrainingResultsResult':
        """
...
def get_model(model_id: Optional[str] = None,
    ...
    test_model = oci.aianomalydetection.get_model(model_id=oci_ai_anomaly_detection_model["test_model"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:aianomalydetection/getModel:getModel', __args__, opts=opts, typ=GetModelResult).value
