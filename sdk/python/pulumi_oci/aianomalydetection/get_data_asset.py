...
class GetDataAssetResult:
    ...
    def __init__(__self__, compartment_id=None, data_asset_id=None, data_source_details=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, private_endpoint_id=None, project_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if data_source_details and not isinstance(data_source_details, dict):
            raise TypeError("Expected argument 'data_source_details' to be a dict")
    ...
    def data_source_details(self) -> 'outputs.GetDataAssetDataSourceDetailsResult':
        """
...
def get_data_asset(data_asset_id: Optional[str] = None,
    ...
    test_data_asset = oci.aianomalydetection.get_data_asset(data_asset_id=oci_ai_anomaly_detection_data_asset["test_data_asset"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:aianomalydetection/getDataAsset:getDataAsset', __args__, opts=opts, typ=GetDataAssetResult).value
