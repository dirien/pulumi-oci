...
@pulumi.input_type
class ModelModelTrainingResultsArgs:
    def __init__(__self__, *,
                 ...
                 row_reduction_details: Optional[pulumi.Input['ModelModelTrainingResultsRowReductionDetailsArgs']] = None,
                 signal_details: Optional[pulumi.Input[Sequence[pulumi.Input['ModelModelTrainingResultsSignalDetailArgs']]]] = None,
        ...
        :param pulumi.Input['ModelModelTrainingResultsRowReductionDetailsArgs'] row_reduction_details: Information regarding how/what row reduction methods will be applied. If this property is not present or is null, then it means row reduction is not applied.
        :param pulumi.Input[Sequence[pulumi.Input['ModelModelTrainingResultsSignalDetailArgs']]] signal_details: The list of signal details.
    ...
    def row_reduction_details(self) -> Optional[pulumi.Input['ModelModelTrainingResultsRowReductionDetailsArgs']]:
        """
    ...
    def row_reduction_details(self, value: Optional[pulumi.Input['ModelModelTrainingResultsRowReductionDetailsArgs']]):
        pulumi.set(self, "row_reduction_details", value)

    @property
    @pulumi.getter(name="signalDetails")
    def signal_details(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ModelModelTrainingResultsSignalDetailArgs']]]]:
        """
    ...
    def signal_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ModelModelTrainingResultsSignalDetailArgs']]]]):
...
@pulumi.input_type
class ModelModelTrainingResultsRowReductionDetailsArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class ModelModelTrainingResultsSignalDetailArgs:
    def __init__(__self__, *,
