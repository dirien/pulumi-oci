...
def get_project(project_id: Optional[str] = None,
    ...
    test_project = oci.aianomalydetection.get_project(project_id=oci_ai_anomaly_detection_project["test_project"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:aianomalydetection/getProject:getProject', __args__, opts=opts, typ=GetProjectResult).value
