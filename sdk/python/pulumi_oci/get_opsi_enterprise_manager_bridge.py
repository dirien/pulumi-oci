...
__all__ = [
    'GetOpsiEnterpriseManagerBridgeResult',
    'AwaitableGetOpsiEnterpriseManagerBridgeResult',
    'get_opsi_enterprise_manager_bridge',
]

@pulumi.output_type
class GetOpsiEnterpriseManagerBridgeResult:
    """
...
class AwaitableGetOpsiEnterpriseManagerBridgeResult(GetOpsiEnterpriseManagerBridgeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOpsiEnterpriseManagerBridgeResult(
...
def get_opsi_enterprise_manager_bridge(enterprise_manager_bridge_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOpsiEnterpriseManagerBridgeResult:
    """
    ...
    test_enterprise_manager_bridge = oci.get_opsi_enterprise_manager_bridge(enterprise_manager_bridge_id=oci_opsi_enterprise_manager_bridge["test_enterprise_manager_bridge"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOpsiEnterpriseManagerBridge:GetOpsiEnterpriseManagerBridge', __args__, opts=opts, typ=GetOpsiEnterpriseManagerBridgeResult).value

    return AwaitableGetOpsiEnterpriseManagerBridgeResult(
