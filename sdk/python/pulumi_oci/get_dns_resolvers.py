...
__all__ = [
    'GetDnsResolversResult',
    'AwaitableGetDnsResolversResult',
    'get_dns_resolvers',
]

@pulumi.output_type
class GetDnsResolversResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsResolversFilterResult']]:
    ...
    @property
    @pulumi.getter
    def resolvers(self) -> Sequence['outputs.GetDnsResolversResolverResult']:
        """
...
class AwaitableGetDnsResolversResult(GetDnsResolversResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsResolversResult(
...
def get_dns_resolvers(compartment_id: Optional[str] = None,
                      display_name: Optional[str] = None,
                      filters: Optional[Sequence[pulumi.InputType['GetDnsResolversFilterArgs']]] = None,
                      id: Optional[str] = None,
                      scope: Optional[str] = None,
                      state: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsResolversResult:
    """
    ...
    test_resolvers = oci.get_dns_resolvers(compartment_id=var["compartment_id"],
        scope="PRIVATE",
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsResolvers:GetDnsResolvers', __args__, opts=opts, typ=GetDnsResolversResult).value

    return AwaitableGetDnsResolversResult(
