...
__all__ = [
    'GetCoreIpv6Result',
    'AwaitableGetCoreIpv6Result',
    'get_core_ipv6',
]

@pulumi.output_type
class GetCoreIpv6Result:
    """
    A collection of values returned by GetCoreIpv6.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, ip_address=None, ipv6id=None, state=None, subnet_id=None, time_created=None, vnic_id=None):
...
class AwaitableGetCoreIpv6Result(GetCoreIpv6Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpv6Result(
...
def get_core_ipv6(ipv6id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpv6Result:
    """
    ...
    test_ipv6 = oci.get_core_ipv6(ipv6id=oci_core_ipv6["test_ipv6"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpv6:GetCoreIpv6', __args__, opts=opts, typ=GetCoreIpv6Result).value

    return AwaitableGetCoreIpv6Result(
