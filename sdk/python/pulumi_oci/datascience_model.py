...
__all__ = ['DatascienceModelArgs', 'DatascienceModel']

@pulumi.input_type
class DatascienceModelArgs:
    def __init__(__self__, *,
                 ...
                 custom_metadata_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelCustomMetadataListArgs']]]] = None,
                 defined_metadata_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelDefinedMetadataListArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DatascienceModelCustomMetadataListArgs']]] custom_metadata_lists: (Updatable) An array of custom metadata details for the model.
        :param pulumi.Input[Sequence[pulumi.Input['DatascienceModelDefinedMetadataListArgs']]] defined_metadata_lists: (Updatable) An array of defined metadata details for the model.
    ...
    def custom_metadata_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelCustomMetadataListArgs']]]]:
        """
    ...
    def custom_metadata_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelCustomMetadataListArgs']]]]):
        pulumi.set(self, "custom_metadata_lists", value)

    @property
    @pulumi.getter(name="definedMetadataLists")
    def defined_metadata_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelDefinedMetadataListArgs']]]]:
        """
    ...
    def defined_metadata_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatascienceModelDefinedMetadataListArgs']]]]):
...
class DatascienceModel(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 artifact_content_length: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 custom_metadata_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatascienceModelCustomMetadataListArgs']]]]] = None,
                 defined_metadata_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatascienceModelDefinedMetadataListArgs']]]]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        test_model = oci.DatascienceModel("testModel",
            compartment_id=var["compartment_id"],
            project_id=oci_datascience_project["test_project"]["id"],
            custom_metadata_lists=[oci.DatascienceModelCustomMetadataListArgs(
            ...
            defined_metadata_lists=[oci.DatascienceModelDefinedMetadataListArgs(
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the model in.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatascienceModelCustomMetadataListArgs']]]] custom_metadata_lists: (Updatable) An array of custom metadata details for the model.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatascienceModelDefinedMetadataListArgs']]]] defined_metadata_lists: (Updatable) An array of defined metadata details for the model.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) A short description of the model.
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly display name for the resource. It does not have to be unique and can be modified. Avoid entering confidential information. Example: `My Model`
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatascienceModelArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatascienceModelArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatascienceModelArgs.__new__(DatascienceModelArgs)
        ...
        super(DatascienceModel, __self__).__init__(
            'oci:index/datascienceModel:DatascienceModel',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'DatascienceModel':
        """
        ...
        __props__ = _DatascienceModelState.__new__(_DatascienceModelState)
        ...
        return DatascienceModel(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="customMetadataLists")
    def custom_metadata_lists(self) -> pulumi.Output[Sequence['outputs.DatascienceModelCustomMetadataList']]:
        """
        (Updatable) An array of custom metadata details for the model.
        """
        return pulumi.get(self, "custom_metadata_lists")
    ...
    @property
    @pulumi.getter(name="definedMetadataLists")
    def defined_metadata_lists(self) -> pulumi.Output[Sequence['outputs.DatascienceModelDefinedMetadataList']]:
        """
        (Updatable) An array of defined metadata details for the model.
        """
        return pulumi.get(self, "defined_metadata_lists")
