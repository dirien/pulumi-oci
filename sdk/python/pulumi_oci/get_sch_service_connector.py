...
__all__ = [
    'GetSchServiceConnectorResult',
    'AwaitableGetSchServiceConnectorResult',
    'get_sch_service_connector',
]

@pulumi.output_type
class GetSchServiceConnectorResult:
    """
    ...
    @property
    @pulumi.getter
    def source(self) -> 'outputs.GetSchServiceConnectorSourceResult':
        """
    ...
    @property
    @pulumi.getter
    def target(self) -> 'outputs.GetSchServiceConnectorTargetResult':
        """
    ...
    @property
    @pulumi.getter
    def tasks(self) -> Sequence['outputs.GetSchServiceConnectorTaskResult']:
        """
        The list of tasks.
        """
...
class AwaitableGetSchServiceConnectorResult(GetSchServiceConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSchServiceConnectorResult(
...
def get_sch_service_connector(service_connector_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchServiceConnectorResult:
    """
    ...
    test_service_connector = oci.get_sch_service_connector(service_connector_id=oci_sch_service_connector["test_service_connector"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getSchServiceConnector:GetSchServiceConnector', __args__, opts=opts, typ=GetSchServiceConnectorResult).value

    return AwaitableGetSchServiceConnectorResult(
