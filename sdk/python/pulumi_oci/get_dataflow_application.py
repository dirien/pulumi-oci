...
class GetDataflowApplicationResult:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetDataflowApplicationParameterResult']:
        """
...
class AwaitableGetDataflowApplicationResult(GetDataflowApplicationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowApplicationResult(
...
def get_dataflow_application(application_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowApplicationResult:
    """
    ...
    test_application = oci.get_dataflow_application(application_id=oci_dataflow_application["test_application"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowApplication:GetDataflowApplication', __args__, opts=opts, typ=GetDataflowApplicationResult).value

    return AwaitableGetDataflowApplicationResult(
