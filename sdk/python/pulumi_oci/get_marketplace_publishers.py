...
__all__ = [
    'GetMarketplacePublishersResult',
    'AwaitableGetMarketplacePublishersResult',
    'get_marketplace_publishers',
]

@pulumi.output_type
class GetMarketplacePublishersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMarketplacePublishersFilterResult']]:
    ...
    @property
    @pulumi.getter
    def publishers(self) -> Sequence['outputs.GetMarketplacePublishersPublisherResult']:
        """
...
class AwaitableGetMarketplacePublishersResult(GetMarketplacePublishersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplacePublishersResult(
...
def get_marketplace_publishers(compartment_id: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetMarketplacePublishersFilterArgs']]] = None,
                               publisher_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplacePublishersResult:
    """
    ...
    test_publishers = oci.get_marketplace_publishers(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplacePublishers:GetMarketplacePublishers', __args__, opts=opts, typ=GetMarketplacePublishersResult).value

    return AwaitableGetMarketplacePublishersResult(
