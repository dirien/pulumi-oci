...
__all__ = [
    'GetCoreDrgRouteDistributionResult',
    'AwaitableGetCoreDrgRouteDistributionResult',
    'get_core_drg_route_distribution',
]

@pulumi.output_type
class GetCoreDrgRouteDistributionResult:
    """
...
class AwaitableGetCoreDrgRouteDistributionResult(GetCoreDrgRouteDistributionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDrgRouteDistributionResult(
...
def get_core_drg_route_distribution(drg_route_distribution_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDrgRouteDistributionResult:
    """
    ...
    test_drg_route_distribution = oci.get_core_drg_route_distribution(drg_route_distribution_id=oci_core_drg_route_distribution["test_drg_route_distribution"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDrgRouteDistribution:GetCoreDrgRouteDistribution', __args__, opts=opts, typ=GetCoreDrgRouteDistributionResult).value

    return AwaitableGetCoreDrgRouteDistributionResult(
