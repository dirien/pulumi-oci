...
__all__ = [
    ...
    'GetStreamPoolKafkaSettingsResult',
    'GetStreamPoolPrivateEndpointSettingsResult',
    'GetStreamPoolsFilterResult',
    'GetStreamPoolsStreamPoolResult',
    'GetStreamPoolsStreamPoolCustomEncryptionKeyResult',
    'GetStreamPoolsStreamPoolKafkaSettingsResult',
    'GetStreamPoolsStreamPoolPrivateEndpointSettingsResult',
...
@pulumi.output_type
class GetStreamPoolKafkaSettingsResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class GetStreamPoolPrivateEndpointSettingsResult(dict):
    def __init__(__self__, *,
...
class GetStreamPoolsStreamPoolResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 custom_encryption_key: 'outputs.GetStreamPoolsStreamPoolCustomEncryptionKeyResult',
                 defined_tags: Mapping[str, Any],
                 endpoint_fqdn: str,
                 freeform_tags: Mapping[str, Any],
                 id: str,
                 is_private: bool,
                 kafka_settings: 'outputs.GetStreamPoolsStreamPoolKafkaSettingsResult',
                 lifecycle_state_details: str,
                 name: str,
                 private_endpoint_settings: 'outputs.GetStreamPoolsStreamPoolPrivateEndpointSettingsResult',
                 state: str,
                 time_created: str):
        """
        :param str compartment_id: The OCID of the compartment.
        :param 'GetStreamPoolsStreamPoolCustomEncryptionKeyArgs' custom_encryption_key: Custom Encryption Key which will be used for encryption by all the streams in the pool.
        :param Mapping[str, Any] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations": {"CostCenter": "42"}}'
        ...
        :param 'GetStreamPoolsStreamPoolKafkaSettingsArgs' kafka_settings: Settings for the Kafka compatibility layer.
        :param str lifecycle_state_details: Any additional details about the current state of the stream.
        :param str name: A filter to return only resources that match the given name exactly.
        :param 'GetStreamPoolsStreamPoolPrivateEndpointSettingsArgs' private_endpoint_settings: Optional settings if the stream pool is private.
        :param str state: A filter to only return resources that match the given lifecycle state. The state value is case-insensitive.
    ...
    def custom_encryption_key(self) -> 'outputs.GetStreamPoolsStreamPoolCustomEncryptionKeyResult':
        """
    ...
    def kafka_settings(self) -> 'outputs.GetStreamPoolsStreamPoolKafkaSettingsResult':
        """
    ...
    def private_endpoint_settings(self) -> 'outputs.GetStreamPoolsStreamPoolPrivateEndpointSettingsResult':
        """
...
@pulumi.output_type
class GetStreamPoolsStreamPoolKafkaSettingsResult(dict):
    def __init__(__self__, *,
                 auto_create_topics_enable: bool,
                 bootstrap_servers: str,
                 log_retention_hours: int,
...
@pulumi.output_type
class GetStreamPoolsStreamPoolPrivateEndpointSettingsResult(dict):
    def __init__(__self__, *,
                 nsg_ids: Sequence[str],
                 private_endpoint_ip: str,
                 subnet_id: str):
