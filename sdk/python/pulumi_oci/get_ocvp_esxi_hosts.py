...
__all__ = [
    'GetOcvpEsxiHostsResult',
    'AwaitableGetOcvpEsxiHostsResult',
    'get_ocvp_esxi_hosts',
]

@pulumi.output_type
class GetOcvpEsxiHostsResult:
    """
    ...
    def esxi_host_collections(self) -> Sequence['outputs.GetOcvpEsxiHostsEsxiHostCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOcvpEsxiHostsFilterResult']]:
...
class AwaitableGetOcvpEsxiHostsResult(GetOcvpEsxiHostsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOcvpEsxiHostsResult(
...
def get_ocvp_esxi_hosts(compute_instance_id: Optional[str] = None,
                        display_name: Optional[str] = None,
                        filters: Optional[Sequence[pulumi.InputType['GetOcvpEsxiHostsFilterArgs']]] = None,
                        sddc_id: Optional[str] = None,
                        state: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOcvpEsxiHostsResult:
    """
    ...
    test_esxi_hosts = oci.get_ocvp_esxi_hosts(compute_instance_id=oci_core_instance["test_instance"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOcvpEsxiHosts:GetOcvpEsxiHosts', __args__, opts=opts, typ=GetOcvpEsxiHostsResult).value

    return AwaitableGetOcvpEsxiHostsResult(
