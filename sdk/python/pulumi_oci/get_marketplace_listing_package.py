...
__all__ = [
    'GetMarketplaceListingPackageResult',
    'AwaitableGetMarketplaceListingPackageResult',
    'get_marketplace_listing_package',
]

@pulumi.output_type
class GetMarketplaceListingPackageResult:
    """
    ...
    def operating_systems(self) -> Sequence['outputs.GetMarketplaceListingPackageOperatingSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def pricings(self) -> Sequence['outputs.GetMarketplaceListingPackagePricingResult']:
        """
    ...
    @property
    @pulumi.getter
    def regions(self) -> Sequence['outputs.GetMarketplaceListingPackageRegionResult']:
        """
    ...
    @property
    @pulumi.getter
    def variables(self) -> Sequence['outputs.GetMarketplaceListingPackageVariableResult']:
        """
...
class AwaitableGetMarketplaceListingPackageResult(GetMarketplaceListingPackageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplaceListingPackageResult(
...
def get_marketplace_listing_package(compartment_id: Optional[str] = None,
                                    listing_id: Optional[str] = None,
                                    package_version: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplaceListingPackageResult:
    """
    ...
    test_listing_package = oci.get_marketplace_listing_package(listing_id=oci_marketplace_listing["test_listing"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplaceListingPackage:GetMarketplaceListingPackage', __args__, opts=opts, typ=GetMarketplaceListingPackageResult).value

    return AwaitableGetMarketplaceListingPackageResult(
