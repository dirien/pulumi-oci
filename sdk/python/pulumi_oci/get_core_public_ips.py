...
__all__ = [
    'GetCorePublicIpsResult',
    'AwaitableGetCorePublicIpsResult',
    'get_core_public_ips',
]

@pulumi.output_type
class GetCorePublicIpsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCorePublicIpsFilterResult']]:
    ...
    def public_ips(self) -> Sequence['outputs.GetCorePublicIpsPublicIpResult']:
        """
...
class AwaitableGetCorePublicIpsResult(GetCorePublicIpsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePublicIpsResult(
...
def get_core_public_ips(availability_domain: Optional[str] = None,
                        compartment_id: Optional[str] = None,
                        filters: Optional[Sequence[pulumi.InputType['GetCorePublicIpsFilterArgs']]] = None,
                        lifetime: Optional[str] = None,
                        public_ip_pool_id: Optional[str] = None,
                        scope: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePublicIpsResult:
    """
    ...
    **Note:** An ephemeral public IP assigned to a private IP
    ...
    test_public_ips = oci.get_core_public_ips(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePublicIps:GetCorePublicIps', __args__, opts=opts, typ=GetCorePublicIpsResult).value

    return AwaitableGetCorePublicIpsResult(
