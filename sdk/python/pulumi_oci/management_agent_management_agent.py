...
__all__ = ['ManagementAgentManagementAgentArgs', 'ManagementAgentManagementAgent']

@pulumi.input_type
class ManagementAgentManagementAgentArgs:
...
@pulumi.input_type
class _ManagementAgentManagementAgentState:
    def __init__(__self__, *,
                 ...
                 plugin_lists: Optional[pulumi.Input[Sequence[pulumi.Input['ManagementAgentManagementAgentPluginListArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ManagementAgentManagementAgentPluginListArgs']]] plugin_lists: list of managementAgentPlugins associated with the agent
    ...
    def plugin_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagementAgentManagementAgentPluginListArgs']]]]:
        """
    ...
    @plugin_lists.setter
    def plugin_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagementAgentManagementAgentPluginListArgs']]]]):
...
class ManagementAgentManagementAgent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_management_agent = oci.ManagementAgentManagementAgent("testManagementAgent", managed_agent_id=oci_management_agent_managed_agent["test_managed_agent"]["id"])
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ManagementAgentManagementAgentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Management Agent resource in Oracle Cloud Infrastructure Management Agent service.
        ...
        :param str resource_name: The name of the resource.
        :param ManagementAgentManagementAgentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagementAgentManagementAgentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ManagementAgentManagementAgentArgs.__new__(ManagementAgentManagementAgentArgs)
        ...
        super(ManagementAgentManagementAgent, __self__).__init__(
            'oci:index/managementAgentManagementAgent:ManagementAgentManagementAgent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            platform_type: Optional[pulumi.Input[str]] = None,
            platform_version: Optional[pulumi.Input[str]] = None,
            plugin_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ManagementAgentManagementAgentPluginListArgs']]]]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_last_heartbeat: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[str]] = None) -> 'ManagementAgentManagementAgent':
        """
        ...
        :param pulumi.Input[str] platform_type: Platform Type
        :param pulumi.Input[str] platform_version: Platform Version
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ManagementAgentManagementAgentPluginListArgs']]]] plugin_lists: list of managementAgentPlugins associated with the agent
        :param pulumi.Input[str] state: The current state of managementAgent
        :param pulumi.Input[str] time_created: The time the Management Agent was created. An RFC3339 formatted datetime string
        :param pulumi.Input[str] time_last_heartbeat: The time the Management Agent has last recorded its health status in telemetry. This value will be null if the agent has not recorded its health status in last 7 days. An RFC3339 formatted datetime string
        :param pulumi.Input[str] time_updated: The time the Management Agent was updated. An RFC3339 formatted datetime string
        ...
        __props__ = _ManagementAgentManagementAgentState.__new__(_ManagementAgentManagementAgentState)
        ...
        return ManagementAgentManagementAgent(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="pluginLists")
    def plugin_lists(self) -> pulumi.Output[Sequence['outputs.ManagementAgentManagementAgentPluginList']]:
        """
        list of managementAgentPlugins associated with the agent
        """
        return pulumi.get(self, "plugin_lists")
