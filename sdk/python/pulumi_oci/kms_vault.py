...
class KmsVaultArgs:
    def __init__(__self__, *,
                 ...
                 restore_from_file: Optional[pulumi.Input['KmsVaultRestoreFromFileArgs']] = None,
                 restore_from_object_store: Optional[pulumi.Input['KmsVaultRestoreFromObjectStoreArgs']] = None,
        ...
        :param pulumi.Input['KmsVaultRestoreFromFileArgs'] restore_from_file: (Updatable) Details where vault was backed up.
        :param pulumi.Input['KmsVaultRestoreFromObjectStoreArgs'] restore_from_object_store: (Updatable) Details where vault was backed up
    ...
    def restore_from_file(self) -> Optional[pulumi.Input['KmsVaultRestoreFromFileArgs']]:
        """
    ...
    def restore_from_file(self, value: Optional[pulumi.Input['KmsVaultRestoreFromFileArgs']]):
        pulumi.set(self, "restore_from_file", value)

    @property
    @pulumi.getter(name="restoreFromObjectStore")
    def restore_from_object_store(self) -> Optional[pulumi.Input['KmsVaultRestoreFromObjectStoreArgs']]:
        """
        (Updatable) Details where vault was backed up
        """
    ...
    def restore_from_object_store(self, value: Optional[pulumi.Input['KmsVaultRestoreFromObjectStoreArgs']]):
...
class _KmsVaultState:
    def __init__(__self__, *,
                 ...
                 replica_details: Optional[pulumi.Input['KmsVaultReplicaDetailsArgs']] = None,
                 restore_from_file: Optional[pulumi.Input['KmsVaultRestoreFromFileArgs']] = None,
                 restore_from_object_store: Optional[pulumi.Input['KmsVaultRestoreFromObjectStoreArgs']] = None,
                 restore_trigger: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input['KmsVaultReplicaDetailsArgs'] replica_details: Vault replica details
        :param pulumi.Input['KmsVaultRestoreFromFileArgs'] restore_from_file: (Updatable) Details where vault was backed up.
        :param pulumi.Input['KmsVaultRestoreFromObjectStoreArgs'] restore_from_object_store: (Updatable) Details where vault was backed up
    ...
    def replica_details(self) -> Optional[pulumi.Input['KmsVaultReplicaDetailsArgs']]:
        """
    ...
    def replica_details(self, value: Optional[pulumi.Input['KmsVaultReplicaDetailsArgs']]):
...
class KmsVault(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 restore_from_file: Optional[pulumi.Input[pulumi.InputType['KmsVaultRestoreFromFileArgs']]] = None,
                 restore_from_object_store: Optional[pulumi.Input[pulumi.InputType['KmsVaultRestoreFromObjectStoreArgs']]] = None,
                 restore_trigger: Optional[pulumi.Input[bool]] = None,
                 time_of_deletion: Optional[pulumi.Input[str]] = None,
                 vault_type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        test_vault = oci.KmsVault("testVault",
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the vault. It does not have to be unique, and it is changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['KmsVaultRestoreFromFileArgs']] restore_from_file: (Updatable) Details where vault was backed up.
        :param pulumi.Input[pulumi.InputType['KmsVaultRestoreFromObjectStoreArgs']] restore_from_object_store: (Updatable) Details where vault was backed up
        :param pulumi.Input[str] time_of_deletion: (Updatable) An optional property for the deletion time of the vault, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input[str] vault_type: The type of vault to create. Each type of vault stores the key with different degrees of isolation and has different options and pricing.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param KmsVaultArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KmsVaultArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KmsVaultArgs.__new__(KmsVaultArgs)
        ...
        super(KmsVault, __self__).__init__(
            'oci:index/kmsVault:KmsVault',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            is_primary: Optional[pulumi.Input[bool]] = None,
            management_endpoint: Optional[pulumi.Input[str]] = None,
            replica_details: Optional[pulumi.Input[pulumi.InputType['KmsVaultReplicaDetailsArgs']]] = None,
            restore_from_file: Optional[pulumi.Input[pulumi.InputType['KmsVaultRestoreFromFileArgs']]] = None,
            restore_from_object_store: Optional[pulumi.Input[pulumi.InputType['KmsVaultRestoreFromObjectStoreArgs']]] = None,
            restore_trigger: Optional[pulumi.Input[bool]] = None,
            restored_from_vault_id: Optional[pulumi.Input[str]] = None,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_of_deletion: Optional[pulumi.Input[str]] = None,
            vault_type: Optional[pulumi.Input[str]] = None) -> 'KmsVault':
        """
        ...
        :param pulumi.Input[bool] is_primary: A boolean that will be true when vault is primary, and will be false when vault is a replica from a primary vault.
        :param pulumi.Input[str] management_endpoint: The service endpoint to perform management operations against. Management operations include "Create," "Update," "List," "Get," and "Delete" operations.
        :param pulumi.Input[pulumi.InputType['KmsVaultReplicaDetailsArgs']] replica_details: Vault replica details
        :param pulumi.Input[pulumi.InputType['KmsVaultRestoreFromFileArgs']] restore_from_file: (Updatable) Details where vault was backed up.
        :param pulumi.Input[pulumi.InputType['KmsVaultRestoreFromObjectStoreArgs']] restore_from_object_store: (Updatable) Details where vault was backed up
        :param pulumi.Input[str] restored_from_vault_id: The OCID of the vault from which this vault was restored, if it was restored from a backup file.  If you restore a vault to the same region, the vault retains the same OCID that it had when you  backed up the vault.
        :param pulumi.Input[str] state: The vault's current lifecycle state.  Example: `DELETED`
        ...
        __props__ = _KmsVaultState.__new__(_KmsVaultState)
        ...
        __props__.__dict__["time_of_deletion"] = time_of_deletion
        __props__.__dict__["vault_type"] = vault_type
        return KmsVault(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="replicaDetails")
    def replica_details(self) -> pulumi.Output['outputs.KmsVaultReplicaDetails']:
        """
        Vault replica details
        """
        return pulumi.get(self, "replica_details")
    ...
    @property
    @pulumi.getter(name="restoreFromFile")
    def restore_from_file(self) -> pulumi.Output[Optional['outputs.KmsVaultRestoreFromFile']]:
        """
        (Updatable) Details where vault was backed up.
        """
        return pulumi.get(self, "restore_from_file")
    ...
    @property
    @pulumi.getter(name="restoreFromObjectStore")
    def restore_from_object_store(self) -> pulumi.Output[Optional['outputs.KmsVaultRestoreFromObjectStore']]:
        """
        (Updatable) Details where vault was backed up
        """
        return pulumi.get(self, "restore_from_object_store")
