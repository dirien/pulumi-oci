...
__all__ = ['CoreComputeCapacityReservationArgs', 'CoreComputeCapacityReservation']

@pulumi.input_type
class CoreComputeCapacityReservationArgs:
    def __init__(__self__, *,
                 availability_domain: pulumi.Input[str],
                 compartment_id: pulumi.Input[str],
                 instance_reservation_configs: pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]] instance_reservation_configs: (Updatable) The reservation configurations for the capacity reservation.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the compute capacity reservation. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    def instance_reservation_configs(self) -> pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]:
        """
    ...
    def instance_reservation_configs(self, value: pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]):
...
@pulumi.input_type
class _CoreComputeCapacityReservationState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 instance_reservation_configs: Optional[pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]] = None,
                 is_default_reservation: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] used_instance_count: The total number of instances currently consuming space in this compute capacity reservation. This number is the sum of the values of the `usedCount` fields for all of the instance reservation configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        """
    ...
    @property
    @pulumi.getter(name="instanceReservationConfigs")
    def instance_reservation_configs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]]:
        """
        (Updatable) The reservation configurations for the capacity reservation.
        """
        return pulumi.get(self, "instance_reservation_configs")
    ...
    @instance_reservation_configs.setter
    def instance_reservation_configs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]]):
        pulumi.set(self, "instance_reservation_configs", value)
...
class CoreComputeCapacityReservation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 instance_reservation_configs: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]]] = None,
                 is_default_reservation: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        """
        ...
        test_compute_capacity_reservation = oci.CoreComputeCapacityReservation("testComputeCapacityReservation",
            ...
            instance_reservation_configs=[oci.CoreComputeCapacityReservationInstanceReservationConfigArgs(
                ...
                instance_shape_config=oci.CoreComputeCapacityReservationInstanceReservationConfigInstanceShapeConfigArgs(
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the compute capacity reservation. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreComputeCapacityReservationInstanceReservationConfigArgs']]]] instance_reservation_configs: (Updatable) The reservation configurations for the capacity reservation.
        :param pulumi.Input[bool] is_default_reservation: (Updatable) Whether this capacity reservation is the default. For more information, see [Capacity Reservations](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/reserve-capacity.htm#default).
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: CoreComputeCapacityReservationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Compute Capacity Reservation resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreComputeCapacityReservationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreComputeCapacityReservationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreComputeCapacityReservationArgs.__new__(CoreComputeCapacityReservationArgs)
        ...
        super(CoreComputeCapacityReservation, __self__).__init__(
            'oci:index/coreComputeCapacityReservation:CoreComputeCapacityReservation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            used_instance_count: Optional[pulumi.Input[str]] = None) -> 'CoreComputeCapacityReservation':
        """
        ...
        __props__ = _CoreComputeCapacityReservationState.__new__(_CoreComputeCapacityReservationState)
        ...
        return CoreComputeCapacityReservation(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="instanceReservationConfigs")
    def instance_reservation_configs(self) -> pulumi.Output[Sequence['outputs.CoreComputeCapacityReservationInstanceReservationConfig']]:
        """
        (Updatable) The reservation configurations for the capacity reservation.
        """
        return pulumi.get(self, "instance_reservation_configs")
