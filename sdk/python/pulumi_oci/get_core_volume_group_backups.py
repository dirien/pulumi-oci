...
__all__ = [
    'GetCoreVolumeGroupBackupsResult',
    'AwaitableGetCoreVolumeGroupBackupsResult',
    'get_core_volume_group_backups',
]

@pulumi.output_type
class GetCoreVolumeGroupBackupsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVolumeGroupBackupsFilterResult']]:
    ...
    def volume_group_backups(self) -> Sequence['outputs.GetCoreVolumeGroupBackupsVolumeGroupBackupResult']:
        """
...
class AwaitableGetCoreVolumeGroupBackupsResult(GetCoreVolumeGroupBackupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVolumeGroupBackupsResult(
...
def get_core_volume_group_backups(compartment_id: Optional[str] = None,
                                  display_name: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetCoreVolumeGroupBackupsFilterArgs']]] = None,
                                  volume_group_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVolumeGroupBackupsResult:
    """
    ...
    test_volume_group_backups = oci.get_core_volume_group_backups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVolumeGroupBackups:GetCoreVolumeGroupBackups', __args__, opts=opts, typ=GetCoreVolumeGroupBackupsResult).value

    return AwaitableGetCoreVolumeGroupBackupsResult(
