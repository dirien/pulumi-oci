...
__all__ = [
    'GetDatabaseDatabaseSoftwareImageResult',
    'AwaitableGetDatabaseDatabaseSoftwareImageResult',
    'get_database_database_software_image',
]

@pulumi.output_type
class GetDatabaseDatabaseSoftwareImageResult:
    """
...
class AwaitableGetDatabaseDatabaseSoftwareImageResult(GetDatabaseDatabaseSoftwareImageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDatabaseSoftwareImageResult(
...
def get_database_database_software_image(database_software_image_id: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDatabaseSoftwareImageResult:
    """
    ...
    test_database_software_image = oci.get_database_database_software_image(database_software_image_id=oci_database_database_software_image["test_database_software_image"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDatabaseSoftwareImage:GetDatabaseDatabaseSoftwareImage', __args__, opts=opts, typ=GetDatabaseDatabaseSoftwareImageResult).value

    return AwaitableGetDatabaseDatabaseSoftwareImageResult(
