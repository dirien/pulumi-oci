...
__all__ = ['CoreImageArgs', 'CoreImage']
...
class CoreImageArgs:
    def __init__(__self__, *,
                 ...
                 image_source_details: Optional[pulumi.Input['CoreImageImageSourceDetailsArgs']] = None,
    ...
    def image_source_details(self) -> Optional[pulumi.Input['CoreImageImageSourceDetailsArgs']]:
        return pulumi.get(self, "image_source_details")

    @image_source_details.setter
    def image_source_details(self, value: Optional[pulumi.Input['CoreImageImageSourceDetailsArgs']]):
...
class _CoreImageState:
    def __init__(__self__, *,
                 agent_features: Optional[pulumi.Input['CoreImageAgentFeaturesArgs']] = None,
                 ...
                 instance_id: Optional[pulumi.Input[str]] = None,
                 launch_mode: Optional[pulumi.Input[str]] = None,
                 launch_options: Optional[pulumi.Input['CoreImageLaunchOptionsArgs']] = None,
        ...
        :param pulumi.Input['CoreImageAgentFeaturesArgs'] agent_features: Oracle Cloud Agent features supported on the image.
        ...
        :param pulumi.Input[str] instance_id: The OCID of the instance you want to use as the basis for the image.
        :param pulumi.Input[str] launch_mode: Specifies the configuration mode for launching virtual machine (VM) instances. The configuration modes are:
        :param pulumi.Input['CoreImageLaunchOptionsArgs'] launch_options: Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
    ...
    def agent_features(self) -> Optional[pulumi.Input['CoreImageAgentFeaturesArgs']]:
        """
    ...
    def agent_features(self, value: Optional[pulumi.Input['CoreImageAgentFeaturesArgs']]):
    ...
    def launch_options(self) -> Optional[pulumi.Input['CoreImageLaunchOptionsArgs']]:
        """
    ...
    def launch_options(self, value: Optional[pulumi.Input['CoreImageLaunchOptionsArgs']]):
...
class CoreImage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 image_source_details: Optional[pulumi.Input[pulumi.InputType['CoreImageImageSourceDetailsArgs']]] = None,
                 instance_id: Optional[pulumi.Input[str]] = None,
                 launch_mode: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_image = oci.CoreImage("testImage",
        ...
        test_image = oci.CoreImage("testImage",
            ...
            display_name=var["image_display_name"],
            launch_mode=var["image_launch_mode"],
            image_source_details=oci.CoreImageImageSourceDetailsArgs(
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreImageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreImageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreImageArgs.__new__(CoreImageArgs)
        ...
        super(CoreImage, __self__).__init__(
            'oci:index/coreImage:CoreImage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            agent_features: Optional[pulumi.Input[pulumi.InputType['CoreImageAgentFeaturesArgs']]] = None,
            base_image_id: Optional[pulumi.Input[str]] = None,
            billable_size_in_gbs: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            create_image_allowed: Optional[pulumi.Input[bool]] = None,
            ...
            instance_id: Optional[pulumi.Input[str]] = None,
            launch_mode: Optional[pulumi.Input[str]] = None,
            launch_options: Optional[pulumi.Input[pulumi.InputType['CoreImageLaunchOptionsArgs']]] = None,
            listing_type: Optional[pulumi.Input[str]] = None,
            operating_system: Optional[pulumi.Input[str]] = None,
            operating_system_version: Optional[pulumi.Input[str]] = None,
            size_in_mbs: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreImage':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['CoreImageAgentFeaturesArgs']] agent_features: Oracle Cloud Agent features supported on the image.
        :param pulumi.Input[str] base_image_id: The OCID of the image originally used to launch the instance.
        :param pulumi.Input[str] billable_size_in_gbs: The size of the internal storage for this image that is subject to billing (1 GB = 1,073,741,824 bytes).  Example: `100`
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment you want the image to be created in.
        :param pulumi.Input[bool] create_image_allowed: Whether instances launched with this image can be used to create new images. For example, you cannot create an image of an Oracle Database instance.  Example: `true`
        ...
        :param pulumi.Input[str] instance_id: The OCID of the instance you want to use as the basis for the image.
        :param pulumi.Input[str] launch_mode: Specifies the configuration mode for launching virtual machine (VM) instances. The configuration modes are:
        :param pulumi.Input[pulumi.InputType['CoreImageLaunchOptionsArgs']] launch_options: Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
        :param pulumi.Input[str] listing_type: The listing type of the image. The default value is "NONE".
        :param pulumi.Input[str] operating_system: The image's operating system.  Example: `Oracle Linux`
        :param pulumi.Input[str] operating_system_version: The image's operating system version.  Example: `7.2`
        :param pulumi.Input[str] size_in_mbs: The boot volume size for an instance launched from this image (1 MB = 1,048,576 bytes). Note this is not the same as the size of the image when it was exported or the actual size of the image.  Example: `47694`
        ...
        __props__ = _CoreImageState.__new__(_CoreImageState)
        ...
        return CoreImage(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="agentFeatures")
    def agent_features(self) -> pulumi.Output['outputs.CoreImageAgentFeatures']:
        """
        Oracle Cloud Agent features supported on the image.
        """
        return pulumi.get(self, "agent_features")
    ...
    @property
    @pulumi.getter(name="imageSourceDetails")
    def image_source_details(self) -> pulumi.Output[Optional['outputs.CoreImageImageSourceDetails']]:
        return pulumi.get(self, "image_source_details")
    ...
    @property
    @pulumi.getter(name="launchOptions")
    def launch_options(self) -> pulumi.Output['outputs.CoreImageLaunchOptions']:
        """
        Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
        """
        return pulumi.get(self, "launch_options")
