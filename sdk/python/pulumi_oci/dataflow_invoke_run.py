...
__all__ = ['DataflowInvokeRunArgs', 'DataflowInvokeRun']

@pulumi.input_type
class DataflowInvokeRunArgs:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['DataflowInvokeRunParameterArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DataflowInvokeRunParameterArgs']]] parameters: An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DataflowInvokeRunParameterArgs']]]]:
        """
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DataflowInvokeRunParameterArgs']]]]):
...
class DataflowInvokeRun(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 metastore_id: Optional[pulumi.Input[str]] = None,
                 num_executors: Optional[pulumi.Input[int]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataflowInvokeRunParameterArgs']]]]] = None,
                 spark_version: Optional[pulumi.Input[str]] = None,
                 warehouse_bucket_uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_invoke_run = oci.DataflowInvokeRun("testInvokeRun",
            ...
            parameters=[oci.DataflowInvokeRunParameterArgs(
        ...
        :param pulumi.Input[str] metastore_id: The OCID of Oracle Cloud Infrastructure Hive Metastore.
        :param pulumi.Input[int] num_executors: The number of executor VMs requested.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataflowInvokeRunParameterArgs']]]] parameters: An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        :param pulumi.Input[str] spark_version: The Spark version utilized to run the application. This value may be set if applicationId is not since the Spark version will be taken from the associated application.
        :param pulumi.Input[str] warehouse_bucket_uri: An Oracle Cloud Infrastructure URI of the bucket to be used as default warehouse directory for BATCH SQL runs. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DataflowInvokeRunArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataflowInvokeRunArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataflowInvokeRunArgs.__new__(DataflowInvokeRunArgs)
        ...
        super(DataflowInvokeRun, __self__).__init__(
            'oci:index/dataflowInvokeRun:DataflowInvokeRun',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[str]] = None,
            total_ocpu: Optional[pulumi.Input[int]] = None,
            warehouse_bucket_uri: Optional[pulumi.Input[str]] = None) -> 'DataflowInvokeRun':
        """
        ...
        __props__ = _DataflowInvokeRunState.__new__(_DataflowInvokeRunState)
        ...
        __props__.__dict__["warehouse_bucket_uri"] = warehouse_bucket_uri
        return DataflowInvokeRun(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Sequence['outputs.DataflowInvokeRunParameter']]:
        """
        An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        """
        return pulumi.get(self, "parameters")
