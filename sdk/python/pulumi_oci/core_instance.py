...
__all__ = ['CoreInstanceArgs', 'CoreInstance']

@pulumi.input_type
class CoreInstanceArgs:
    def __init__(__self__, *,
                 availability_domain: pulumi.Input[str],
                 compartment_id: pulumi.Input[str],
                 shape: pulumi.Input[str],
                 agent_config: Optional[pulumi.Input['CoreInstanceAgentConfigArgs']] = None,
                 availability_config: Optional[pulumi.Input['CoreInstanceAvailabilityConfigArgs']] = None,
                 capacity_reservation_id: Optional[pulumi.Input[str]] = None,
                 create_vnic_details: Optional[pulumi.Input['CoreInstanceCreateVnicDetailsArgs']] = None,
                 ...
                 instance_options: Optional[pulumi.Input['CoreInstanceInstanceOptionsArgs']] = None,
                 ipxe_script: Optional[pulumi.Input[str]] = None,
                 is_pv_encryption_in_transit_enabled: Optional[pulumi.Input[bool]] = None,
                 launch_options: Optional[pulumi.Input['CoreInstanceLaunchOptionsArgs']] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 platform_config: Optional[pulumi.Input['CoreInstancePlatformConfigArgs']] = None,
                 preemptible_instance_config: Optional[pulumi.Input['CoreInstancePreemptibleInstanceConfigArgs']] = None,
                 preserve_boot_volume: Optional[pulumi.Input[bool]] = None,
                 shape_config: Optional[pulumi.Input['CoreInstanceShapeConfigArgs']] = None,
                 source_details: Optional[pulumi.Input['CoreInstanceSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input['CoreInstanceAgentConfigArgs'] agent_config: (Updatable) Configuration options for the Oracle Cloud Agent software running on the instance.
        :param pulumi.Input['CoreInstanceAvailabilityConfigArgs'] availability_config: (Updatable) Options for defining the availability of a VM instance after a maintenance event that impacts the underlying hardware.  This also includes live migration preference for infrastructure maintenance.
        ...
        :param pulumi.Input['CoreInstanceCreateVnicDetailsArgs'] create_vnic_details: (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm).
        ...
        :param pulumi.Input['CoreInstanceInstanceOptionsArgs'] instance_options: (Updatable) Optional mutable instance options
        ...
        :param pulumi.Input['CoreInstanceLaunchOptionsArgs'] launch_options: (Updatable) Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
        ...
        :param pulumi.Input['CoreInstancePlatformConfigArgs'] platform_config: The platform configuration requested for the instance.
        :param pulumi.Input['CoreInstancePreemptibleInstanceConfigArgs'] preemptible_instance_config: Configuration options for preemptible instances.
        ...
        :param pulumi.Input['CoreInstanceShapeConfigArgs'] shape_config: (Updatable) The shape configuration requested for the instance.
        :param pulumi.Input['CoreInstanceSourceDetailsArgs'] source_details: (Updatable)
    ...
    def agent_config(self) -> Optional[pulumi.Input['CoreInstanceAgentConfigArgs']]:
        """
    ...
    @agent_config.setter
    def agent_config(self, value: Optional[pulumi.Input['CoreInstanceAgentConfigArgs']]):
        pulumi.set(self, "agent_config", value)

    @property
    @pulumi.getter(name="availabilityConfig")
    def availability_config(self) -> Optional[pulumi.Input['CoreInstanceAvailabilityConfigArgs']]:
        """
    ...
    def availability_config(self, value: Optional[pulumi.Input['CoreInstanceAvailabilityConfigArgs']]):
    ...
    def create_vnic_details(self) -> Optional[pulumi.Input['CoreInstanceCreateVnicDetailsArgs']]:
        """
    ...
    def create_vnic_details(self, value: Optional[pulumi.Input['CoreInstanceCreateVnicDetailsArgs']]):
    ...
    def instance_options(self) -> Optional[pulumi.Input['CoreInstanceInstanceOptionsArgs']]:
        """
    ...
    def instance_options(self, value: Optional[pulumi.Input['CoreInstanceInstanceOptionsArgs']]):
    ...
    def launch_options(self) -> Optional[pulumi.Input['CoreInstanceLaunchOptionsArgs']]:
        """
    ...
    def launch_options(self, value: Optional[pulumi.Input['CoreInstanceLaunchOptionsArgs']]):
    ...
    def platform_config(self) -> Optional[pulumi.Input['CoreInstancePlatformConfigArgs']]:
        """
    ...
    def platform_config(self, value: Optional[pulumi.Input['CoreInstancePlatformConfigArgs']]):
        pulumi.set(self, "platform_config", value)

    @property
    @pulumi.getter(name="preemptibleInstanceConfig")
    def preemptible_instance_config(self) -> Optional[pulumi.Input['CoreInstancePreemptibleInstanceConfigArgs']]:
        """
    ...
    def preemptible_instance_config(self, value: Optional[pulumi.Input['CoreInstancePreemptibleInstanceConfigArgs']]):
    ...
    def shape_config(self) -> Optional[pulumi.Input['CoreInstanceShapeConfigArgs']]:
        """
    ...
    @shape_config.setter
    def shape_config(self, value: Optional[pulumi.Input['CoreInstanceShapeConfigArgs']]):
        pulumi.set(self, "shape_config", value)

    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> Optional[pulumi.Input['CoreInstanceSourceDetailsArgs']]:
        """
        (Updatable)
        """
    ...
    def source_details(self, value: Optional[pulumi.Input['CoreInstanceSourceDetailsArgs']]):
...
class CoreInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 agent_config: Optional[pulumi.Input[pulumi.InputType['CoreInstanceAgentConfigArgs']]] = None,
                 availability_config: Optional[pulumi.Input[pulumi.InputType['CoreInstanceAvailabilityConfigArgs']]] = None,
                 availability_domain: Optional[pulumi.Input[str]] = None,
                 capacity_reservation_id: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 create_vnic_details: Optional[pulumi.Input[pulumi.InputType['CoreInstanceCreateVnicDetailsArgs']]] = None,
                 dedicated_vm_host_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 extended_metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ...
                 hostname_label: Optional[pulumi.Input[str]] = None,
                 image: Optional[pulumi.Input[str]] = None,
                 instance_options: Optional[pulumi.Input[pulumi.InputType['CoreInstanceInstanceOptionsArgs']]] = None,
                 ipxe_script: Optional[pulumi.Input[str]] = None,
                 is_pv_encryption_in_transit_enabled: Optional[pulumi.Input[bool]] = None,
                 launch_options: Optional[pulumi.Input[pulumi.InputType['CoreInstanceLaunchOptionsArgs']]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 platform_config: Optional[pulumi.Input[pulumi.InputType['CoreInstancePlatformConfigArgs']]] = None,
                 preemptible_instance_config: Optional[pulumi.Input[pulumi.InputType['CoreInstancePreemptibleInstanceConfigArgs']]] = None,
                 preserve_boot_volume: Optional[pulumi.Input[bool]] = None,
                 shape: Optional[pulumi.Input[str]] = None,
                 shape_config: Optional[pulumi.Input[pulumi.InputType['CoreInstanceShapeConfigArgs']]] = None,
                 source_details: Optional[pulumi.Input[pulumi.InputType['CoreInstanceSourceDetailsArgs']]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_instance = oci.CoreInstance("testInstance",
            availability_domain=var["instance_availability_domain"],
            compartment_id=var["compartment_id"],
            shape=var["instance_shape"],
            agent_config=oci.CoreInstanceAgentConfigArgs(
                ...
                plugins_configs=[oci.CoreInstanceAgentConfigPluginsConfigArgs(
                    desired_state=var["instance_agent_config_plugins_config_desired_state"],
                    name=var["instance_agent_config_plugins_config_name"],
                )],
            ),
            availability_config=oci.CoreInstanceAvailabilityConfigArgs(
            ...
            create_vnic_details=oci.CoreInstanceCreateVnicDetailsArgs(
            ...
            instance_options=oci.CoreInstanceInstanceOptionsArgs(
            ...
            launch_options=oci.CoreInstanceLaunchOptionsArgs(
            ...
            platform_config=oci.CoreInstancePlatformConfigArgs(
                type=var["instance_platform_config_type"],
                numa_nodes_per_socket=var["instance_platform_config_numa_nodes_per_socket"],
            ),
            preemptible_instance_config=oci.CoreInstancePreemptibleInstanceConfigArgs(
                preemption_action=oci.CoreInstancePreemptibleInstanceConfigPreemptionActionArgs(
        ...
        :param pulumi.Input[pulumi.InputType['CoreInstanceAgentConfigArgs']] agent_config: (Updatable) Configuration options for the Oracle Cloud Agent software running on the instance.
        :param pulumi.Input[pulumi.InputType['CoreInstanceAvailabilityConfigArgs']] availability_config: (Updatable) Options for defining the availability of a VM instance after a maintenance event that impacts the underlying hardware.  This also includes live migration preference for infrastructure maintenance.
        :param pulumi.Input[str] availability_domain: The availability domain of the instance.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[str] capacity_reservation_id: (Updatable) The OCID of the compute capacity reservation this instance is launched under. You can opt out of all default reservations by specifying an empty string as input for this field. For more information, see [Capacity Reservations](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/reserve-capacity.htm#default).
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
        :param pulumi.Input[pulumi.InputType['CoreInstanceCreateVnicDetailsArgs']] create_vnic_details: (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm).
        :param pulumi.Input[str] dedicated_vm_host_id: The OCID of dedicated VM host.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.  Example: `My bare metal instance`
        :param pulumi.Input[Mapping[str, Any]] extended_metadata: (Updatable) Additional metadata key/value pairs that you provide. They serve the same purpose and functionality as fields in the `metadata` object.
        ...
        :param pulumi.Input[str] hostname_label: Deprecated. Instead use `hostnameLabel` in [CreateVnicDetails](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CreateVnicDetails/). If you provide both, the values must match.
        :param pulumi.Input[str] image: Deprecated. Use `sourceDetails` with [InstanceSourceViaImageDetails](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/requests/InstanceSourceViaImageDetails) source type instead. If you specify values for both, the values must match.
        :param pulumi.Input[pulumi.InputType['CoreInstanceInstanceOptionsArgs']] instance_options: (Updatable) Optional mutable instance options
        :param pulumi.Input[str] ipxe_script: This is an advanced option.
        :param pulumi.Input[bool] is_pv_encryption_in_transit_enabled: (Updatable) Use this for update operation only. This field is  Deprecated during create. For create use `isPvEncryptionInTransitEnabled` in [LaunchInstanceDetails](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/20160918/datatypes/LaunchInstanceDetails).
        :param pulumi.Input[pulumi.InputType['CoreInstanceLaunchOptionsArgs']] launch_options: (Updatable) Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
        :param pulumi.Input[Mapping[str, Any]] metadata: (Updatable) Custom metadata key/value pairs that you provide, such as the SSH public key required to connect to the instance.
        :param pulumi.Input[pulumi.InputType['CoreInstancePlatformConfigArgs']] platform_config: The platform configuration requested for the instance.
        :param pulumi.Input[pulumi.InputType['CoreInstancePreemptibleInstanceConfigArgs']] preemptible_instance_config: Configuration options for preemptible instances.
        :param pulumi.Input[bool] preserve_boot_volume: Whether to preserve the boot volume that was used to launch the preemptible instance when the instance is terminated. Defaults to false if not specified.
        :param pulumi.Input[str] shape: (Updatable) The shape of an instance. The shape determines the number of CPUs, amount of memory, and other resources allocated to the instance.
        :param pulumi.Input[pulumi.InputType['CoreInstanceShapeConfigArgs']] shape_config: (Updatable) The shape configuration requested for the instance.
        :param pulumi.Input[pulumi.InputType['CoreInstanceSourceDetailsArgs']] source_details: (Updatable)
        :param pulumi.Input[str] state: (Updatable) The target state for the instance. Could be set to RUNNING or STOPPED.
        :param pulumi.Input[str] subnet_id: Deprecated. Instead use `subnetId` in [CreateVnicDetails](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CreateVnicDetails/). At least one of them is required; if you provide both, the values must match.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreInstanceArgs.__new__(CoreInstanceArgs)
        ...
        super(CoreInstance, __self__).__init__(
            'oci:index/coreInstance:CoreInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_maintenance_reboot_due: Optional[pulumi.Input[str]] = None) -> 'CoreInstance':
        """
        ...
        __props__ = _CoreInstanceState.__new__(_CoreInstanceState)
        ...
        return CoreInstance(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="agentConfig")
    def agent_config(self) -> pulumi.Output['outputs.CoreInstanceAgentConfig']:
        """
        (Updatable) Configuration options for the Oracle Cloud Agent software running on the instance.
        """
        return pulumi.get(self, "agent_config")
    ...
    @property
    @pulumi.getter(name="availabilityConfig")
    def availability_config(self) -> pulumi.Output['outputs.CoreInstanceAvailabilityConfig']:
        """
        (Updatable) Options for defining the availability of a VM instance after a maintenance event that impacts the underlying hardware.  This also includes live migration preference for infrastructure maintenance.
        """
        return pulumi.get(self, "availability_config")
    ...
    @property
    @pulumi.getter(name="createVnicDetails")
    def create_vnic_details(self) -> pulumi.Output['outputs.CoreInstanceCreateVnicDetails']:
        """
        (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm).
        """
        return pulumi.get(self, "create_vnic_details")
    ...
    @property
    @pulumi.getter(name="instanceOptions")
    def instance_options(self) -> pulumi.Output['outputs.CoreInstanceInstanceOptions']:
        """
        (Updatable) Optional mutable instance options
        """
        return pulumi.get(self, "instance_options")
    ...
    @property
    @pulumi.getter(name="launchOptions")
    def launch_options(self) -> pulumi.Output['outputs.CoreInstanceLaunchOptions']:
        """
        (Updatable) Options for tuning the compatibility and performance of VM shapes. The values that you specify override any default values.
        """
        return pulumi.get(self, "launch_options")
    ...
    @property
    @pulumi.getter(name="platformConfig")
    def platform_config(self) -> pulumi.Output['outputs.CoreInstancePlatformConfig']:
        """
        The platform configuration requested for the instance.
        """
        return pulumi.get(self, "platform_config")
    ...
    @property
    @pulumi.getter(name="preemptibleInstanceConfig")
    def preemptible_instance_config(self) -> pulumi.Output['outputs.CoreInstancePreemptibleInstanceConfig']:
        """
        Configuration options for preemptible instances.
        """
        return pulumi.get(self, "preemptible_instance_config")
    ...
    @property
    @pulumi.getter(name="shapeConfig")
    def shape_config(self) -> pulumi.Output['outputs.CoreInstanceShapeConfig']:
        """
        (Updatable) The shape configuration requested for the instance.
        """
        return pulumi.get(self, "shape_config")
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output['outputs.CoreInstanceSourceDetails']:
        """
        (Updatable)
        """
        return pulumi.get(self, "source_details")
