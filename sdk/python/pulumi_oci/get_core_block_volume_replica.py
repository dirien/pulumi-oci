...
__all__ = [
    'GetCoreBlockVolumeReplicaResult',
    'AwaitableGetCoreBlockVolumeReplicaResult',
    'get_core_block_volume_replica',
]

@pulumi.output_type
class GetCoreBlockVolumeReplicaResult:
    """
    A collection of values returned by GetCoreBlockVolumeReplica.
    """
    def __init__(__self__, availability_domain=None, block_volume_id=None, block_volume_replica_id=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, size_in_gbs=None, state=None, time_created=None, time_last_synced=None):
...
class AwaitableGetCoreBlockVolumeReplicaResult(GetCoreBlockVolumeReplicaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBlockVolumeReplicaResult(
...
def get_core_block_volume_replica(block_volume_replica_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBlockVolumeReplicaResult:
    """
    ...
    test_block_volume_replica = oci.get_core_block_volume_replica(block_volume_replica_id=oci_core_block_volume_replica["test_block_volume_replica"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBlockVolumeReplica:GetCoreBlockVolumeReplica', __args__, opts=opts, typ=GetCoreBlockVolumeReplicaResult).value

    return AwaitableGetCoreBlockVolumeReplicaResult(
