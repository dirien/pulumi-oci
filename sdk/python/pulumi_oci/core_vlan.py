...
class CoreVlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment to contain the VLAN.
        :param pulumi.Input[str] vcn_id: The OCID of the VCN to contain the VLAN.
        ...
        :param pulumi.Input[str] display_name: (Updatable) A descriptive name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        ...
        :param pulumi.Input[str] route_table_id: (Updatable) The OCID of the route table the VLAN will use. If you don't provide a value, the VLAN uses the VCN's default route table.
...
class CoreVlan(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_vlan = oci.CoreVlan("testVlan",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreVlanArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVlanArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVlanArgs.__new__(CoreVlanArgs)
        ...
        super(CoreVlan, __self__).__init__(
            'oci:index/coreVlan:CoreVlan',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None,
            vlan_tag: Optional[pulumi.Input[int]] = None) -> 'CoreVlan':
        """
        ...
        __props__ = _CoreVlanState.__new__(_CoreVlanState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        __props__.__dict__["vlan_tag"] = vlan_tag
        return CoreVlan(resource_name, opts=opts, __props__=__props__)
