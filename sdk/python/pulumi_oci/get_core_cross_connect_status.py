...
__all__ = [
    'GetCoreCrossConnectStatusResult',
    'AwaitableGetCoreCrossConnectStatusResult',
    'get_core_cross_connect_status',
]

@pulumi.output_type
class GetCoreCrossConnectStatusResult:
    """
    A collection of values returned by GetCoreCrossConnectStatus.
    """
    def __init__(__self__, cross_connect_id=None, id=None, interface_state=None, light_level_ind_bm=None, light_level_indicator=None):
...
class AwaitableGetCoreCrossConnectStatusResult(GetCoreCrossConnectStatusResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreCrossConnectStatusResult(
...
def get_core_cross_connect_status(cross_connect_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreCrossConnectStatusResult:
    """
    ...
    test_cross_connect_status = oci.get_core_cross_connect_status(cross_connect_id=oci_core_cross_connect["test_cross_connect"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreCrossConnectStatus:GetCoreCrossConnectStatus', __args__, opts=opts, typ=GetCoreCrossConnectStatusResult).value

    return AwaitableGetCoreCrossConnectStatusResult(
