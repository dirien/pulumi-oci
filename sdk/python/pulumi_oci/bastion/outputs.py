...
__all__ = [
    ...
    'GetSessionKeyDetailsResult',
    'GetSessionTargetResourceDetailsResult',
    'GetSessionsFilterResult',
    'GetSessionsSessionResult',
    'GetSessionsSessionKeyDetailsResult',
    'GetSessionsSessionTargetResourceDetailsResult',
]
...
class GetSessionsSessionResult(dict):
    ...
    def target_resource_details(self) -> 'outputs.GetSessionsSessionTargetResourceDetailsResult':
        """
...
@pulumi.output_type
class GetSessionsSessionKeyDetailsResult(dict):
    def __init__(__self__, *,
                 public_key_content: str):
        """
        :param str public_key_content: The public key in OpenSSH format of the SSH key pair for the session. When you connect to the session, you must provide the private key of the same SSH key pair.
...
@pulumi.output_type
class GetSessionsSessionTargetResourceDetailsResult(dict):
    def __init__(__self__, *,
                 session_type: str,
                 target_resource_display_name: str,
                 target_resource_id: str,
