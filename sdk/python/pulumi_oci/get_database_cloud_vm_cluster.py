...
class GetDatabaseCloudVmClusterResult:
    ...
    def __init__(__self__, availability_domain=None, backup_network_nsg_ids=None, backup_subnet_id=None, cloud_exadata_infrastructure_id=None, cloud_vm_cluster_id=None, cluster_name=None, compartment_id=None, cpu_core_count=None, create_async=None, data_storage_percentage=None, defined_tags=None, disk_redundancy=None, display_name=None, domain=None, freeform_tags=None, gi_version=None, hostname=None, id=None, iorm_config_cache=None, is_local_backup_enabled=None, is_sparse_diskgroup_enabled=None, last_update_history_entry_id=None, license_model=None, lifecycle_details=None, listener_port=None, node_count=None, nsg_ids=None, scan_dns_name=None, scan_dns_record_id=None, scan_ip_ids=None, shape=None, ssh_public_keys=None, state=None, storage_size_in_gbs=None, subnet_id=None, system_version=None, time_created=None, time_zone=None, vip_ids=None, zone_id=None):
        ...
        if iorm_config_cache and not isinstance(iorm_config_cache, dict):
            raise TypeError("Expected argument 'iorm_config_cache' to be a dict")
    ...
    def iorm_config_cache(self) -> 'outputs.GetDatabaseCloudVmClusterIormConfigCacheResult':
        """
...
class AwaitableGetDatabaseCloudVmClusterResult(GetDatabaseCloudVmClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseCloudVmClusterResult(
...
def get_database_cloud_vm_cluster(cloud_vm_cluster_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseCloudVmClusterResult:
    """
    ...
    test_cloud_vm_cluster = oci.get_database_cloud_vm_cluster(cloud_vm_cluster_id=oci_database_cloud_vm_cluster["test_cloud_vm_cluster"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseCloudVmCluster:GetDatabaseCloudVmCluster', __args__, opts=opts, typ=GetDatabaseCloudVmClusterResult).value

    return AwaitableGetDatabaseCloudVmClusterResult(
        ...
        id=__ret__.id,
        iorm_config_cache=__ret__.iorm_config_cache,
