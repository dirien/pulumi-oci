...
__all__ = [
    'GetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult',
    'AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult',
    'get_database_autonomous_container_database_dataguard_associations',
]

@pulumi.output_type
class GetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult:
    """
    ...
    def autonomous_container_database_dataguard_associations(self) -> Sequence['outputs.GetDatabaseAutonomousContainerDatabaseDataguardAssociationsAutonomousContainerDatabaseDataguardAssociationResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseAutonomousContainerDatabaseDataguardAssociationsFilterResult']]:
...
class AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult(GetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult(
...
def get_database_autonomous_container_database_dataguard_associations(autonomous_container_database_id: Optional[str] = None,
                                                                      filters: Optional[Sequence[pulumi.InputType['GetDatabaseAutonomousContainerDatabaseDataguardAssociationsFilterArgs']]] = None,
                                                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult:
    """
    ...
    test_autonomous_container_database_dataguard_associations = oci.get_database_autonomous_container_database_dataguard_associations(autonomous_container_database_id=oci_database_autonomous_container_database["test_autonomous_container_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousContainerDatabaseDataguardAssociations:GetDatabaseAutonomousContainerDatabaseDataguardAssociations', __args__, opts=opts, typ=GetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult).value

    return AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationsResult(
