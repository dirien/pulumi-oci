...
__all__ = [
    'GetMarketplaceAcceptedAgreementsResult',
    'AwaitableGetMarketplaceAcceptedAgreementsResult',
    'get_marketplace_accepted_agreements',
]

@pulumi.output_type
class GetMarketplaceAcceptedAgreementsResult:
    """
    ...
    def accepted_agreements(self) -> Sequence['outputs.GetMarketplaceAcceptedAgreementsAcceptedAgreementResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMarketplaceAcceptedAgreementsFilterResult']]:
...
class AwaitableGetMarketplaceAcceptedAgreementsResult(GetMarketplaceAcceptedAgreementsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplaceAcceptedAgreementsResult(
...
def get_marketplace_accepted_agreements(accepted_agreement_id: Optional[str] = None,
                                        compartment_id: Optional[str] = None,
                                        display_name: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetMarketplaceAcceptedAgreementsFilterArgs']]] = None,
                                        listing_id: Optional[str] = None,
                                        package_version: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplaceAcceptedAgreementsResult:
    """
    ...
    test_accepted_agreements = oci.get_marketplace_accepted_agreements(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplaceAcceptedAgreements:GetMarketplaceAcceptedAgreements', __args__, opts=opts, typ=GetMarketplaceAcceptedAgreementsResult).value

    return AwaitableGetMarketplaceAcceptedAgreementsResult(
