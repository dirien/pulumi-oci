...
__all__ = ['CoreIpsecConnectionTunnelManagementArgs', 'CoreIpsecConnectionTunnelManagement']

@pulumi.input_type
class CoreIpsecConnectionTunnelManagementArgs:
    def __init__(__self__, *,
                 ipsec_id: pulumi.Input[str],
                 routing: pulumi.Input[str],
                 tunnel_id: pulumi.Input[str],
                 bgp_session_infos: Optional[pulumi.Input[Sequence[pulumi.Input['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 encryption_domain_config: Optional[pulumi.Input['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]] bgp_session_infos: Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
        ...
        :param pulumi.Input['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs'] encryption_domain_config: Configuration information used by the encryption domain policy. Required if the tunnel uses POLICY routing.
    ...
    def bgp_session_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]]:
        """
    ...
    def bgp_session_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]]):
    ...
    def encryption_domain_config(self) -> Optional[pulumi.Input['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs']]:
        """
    ...
    def encryption_domain_config(self, value: Optional[pulumi.Input['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs']]):
...
@pulumi.input_type
class _CoreIpsecConnectionTunnelManagementState:
    def __init__(__self__, *,
                 bgp_session_infos: Optional[pulumi.Input[Sequence[pulumi.Input['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]] = None,
...
class CoreIpsecConnectionTunnelManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 bgp_session_infos: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 encryption_domain_config: Optional[pulumi.Input[pulumi.InputType['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs']]] = None,
                 ike_version: Optional[pulumi.Input[str]] = None,
                 ipsec_id: Optional[pulumi.Input[str]] = None,
                 routing: Optional[pulumi.Input[str]] = None,
                 shared_secret: Optional[pulumi.Input[str]] = None,
        ...
        ** IMPORTANT **
        ...
        test_ip_sec_connection_tunnel = oci.CoreIpsecConnectionTunnelManagement("testIpSecConnectionTunnel",
            ...
            bgp_session_infos=[oci.CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs(
            ...
            encryption_domain_config=oci.CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs(
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreIpsecConnectionTunnelManagementBgpSessionInfoArgs']]]] bgp_session_infos: Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
        :param pulumi.Input[str] display_name: A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[pulumi.InputType['CoreIpsecConnectionTunnelManagementEncryptionDomainConfigArgs']] encryption_domain_config: Configuration information used by the encryption domain policy. Required if the tunnel uses POLICY routing.
        :param pulumi.Input[str] ike_version: Internet Key Exchange protocol version.
        :param pulumi.Input[str] ipsec_id: The OCID of the IPSec connection.
        :param pulumi.Input[str] routing: The type of routing to use for this tunnel (either BGP dynamic routing, STATIC routing or POLICY routing).
        :param pulumi.Input[str] shared_secret: The shared secret (pre-shared key) to use for the IPSec tunnel. If you don't provide a value, Oracle generates a value for you. You can specify your own shared secret later if you like with [UpdateIPSecConnectionTunnelSharedSecret](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/20160918/IPSecConnectionTunnelSharedSecret/UpdateIPSecConnectionTunnelSharedSecret).  Example: `EXAMPLEToUis6j1c.p8G.dVQxcmdfMO0yXMLi.lZTbYCMDGu4V8o`
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreIpsecConnectionTunnelManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Ip Sec Connection Tunnel Management resource in Oracle Cloud Infrastructure Core service.
        ...
        ** IMPORTANT **
        ...
        :param str resource_name: The name of the resource.
        :param CoreIpsecConnectionTunnelManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreIpsecConnectionTunnelManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreIpsecConnectionTunnelManagementArgs.__new__(CoreIpsecConnectionTunnelManagementArgs)
        ...
        super(CoreIpsecConnectionTunnelManagement, __self__).__init__(
            'oci:index/coreIpsecConnectionTunnelManagement:CoreIpsecConnectionTunnelManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_status_updated: Optional[pulumi.Input[str]] = None,
            tunnel_id: Optional[pulumi.Input[str]] = None,
            vpn_ip: Optional[pulumi.Input[str]] = None) -> 'CoreIpsecConnectionTunnelManagement':
        """
        ...
        __props__ = _CoreIpsecConnectionTunnelManagementState.__new__(_CoreIpsecConnectionTunnelManagementState)
        ...
        return CoreIpsecConnectionTunnelManagement(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="bgpSessionInfos")
    def bgp_session_infos(self) -> pulumi.Output[Sequence['outputs.CoreIpsecConnectionTunnelManagementBgpSessionInfo']]:
        """
        Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
        """
        return pulumi.get(self, "bgp_session_infos")
    ...
    @property
    @pulumi.getter(name="encryptionDomainConfig")
    def encryption_domain_config(self) -> pulumi.Output['outputs.CoreIpsecConnectionTunnelManagementEncryptionDomainConfig']:
        """
        Configuration information used by the encryption domain policy. Required if the tunnel uses POLICY routing.
        """
        return pulumi.get(self, "encryption_domain_config")
