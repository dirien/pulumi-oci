...
__all__ = [
    'GetIntegrationIntegrationInstanceResult',
    'AwaitableGetIntegrationIntegrationInstanceResult',
    'get_integration_integration_instance',
]

@pulumi.output_type
class GetIntegrationIntegrationInstanceResult:
    """
    ...
    def alternate_custom_endpoints(self) -> Sequence['outputs.GetIntegrationIntegrationInstanceAlternateCustomEndpointResult']:
        """
    ...
    def custom_endpoint(self) -> 'outputs.GetIntegrationIntegrationInstanceCustomEndpointResult':
        """
    ...
    def network_endpoint_details(self) -> 'outputs.GetIntegrationIntegrationInstanceNetworkEndpointDetailsResult':
        """
...
class AwaitableGetIntegrationIntegrationInstanceResult(GetIntegrationIntegrationInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIntegrationIntegrationInstanceResult(
...
def get_integration_integration_instance(integration_instance_id: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIntegrationIntegrationInstanceResult:
    """
    ...
    test_integration_instance = oci.get_integration_integration_instance(integration_instance_id=oci_integration_integration_instance["test_integration_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIntegrationIntegrationInstance:GetIntegrationIntegrationInstance', __args__, opts=opts, typ=GetIntegrationIntegrationInstanceResult).value

    return AwaitableGetIntegrationIntegrationInstanceResult(
