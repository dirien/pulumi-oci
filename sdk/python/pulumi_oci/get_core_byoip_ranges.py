...
__all__ = [
    'GetCoreByoipRangesResult',
    'AwaitableGetCoreByoipRangesResult',
    'get_core_byoip_ranges',
]

@pulumi.output_type
class GetCoreByoipRangesResult:
    """
    ...
    def byoip_range_collections(self) -> Sequence['outputs.GetCoreByoipRangesByoipRangeCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreByoipRangesFilterResult']]:
...
class AwaitableGetCoreByoipRangesResult(GetCoreByoipRangesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreByoipRangesResult(
...
def get_core_byoip_ranges(compartment_id: Optional[str] = None,
                          display_name: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetCoreByoipRangesFilterArgs']]] = None,
                          state: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreByoipRangesResult:
    """
    ...
    test_byoip_ranges = oci.get_core_byoip_ranges(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreByoipRanges:GetCoreByoipRanges', __args__, opts=opts, typ=GetCoreByoipRangesResult).value

    return AwaitableGetCoreByoipRangesResult(
