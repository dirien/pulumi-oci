...
__all__ = ['BastionSessionArgs', 'BastionSession']

@pulumi.input_type
class BastionSessionArgs:
    def __init__(__self__, *,
                 bastion_id: pulumi.Input[str],
                 key_details: pulumi.Input['BastionSessionKeyDetailsArgs'],
                 target_resource_details: pulumi.Input['BastionSessionTargetResourceDetailsArgs'],
        ...
        :param pulumi.Input['BastionSessionKeyDetailsArgs'] key_details: Public key details for a bastion session.
        :param pulumi.Input['BastionSessionTargetResourceDetailsArgs'] target_resource_details: Details about a bastion session's target resource.
    ...
    def key_details(self) -> pulumi.Input['BastionSessionKeyDetailsArgs']:
        """
    ...
    @key_details.setter
    def key_details(self, value: pulumi.Input['BastionSessionKeyDetailsArgs']):
        pulumi.set(self, "key_details", value)

    @property
    @pulumi.getter(name="targetResourceDetails")
    def target_resource_details(self) -> pulumi.Input['BastionSessionTargetResourceDetailsArgs']:
        """
    ...
    def target_resource_details(self, value: pulumi.Input['BastionSessionTargetResourceDetailsArgs']):
...
class _BastionSessionState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 key_details: Optional[pulumi.Input['BastionSessionKeyDetailsArgs']] = None,
                 key_type: Optional[pulumi.Input[str]] = None,
                 lifecycle_details: Optional[pulumi.Input[str]] = None,
                 session_ttl_in_seconds: Optional[pulumi.Input[int]] = None,
                 ssh_metadata: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 target_resource_details: Optional[pulumi.Input['BastionSessionTargetResourceDetailsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="keyDetails")
    def key_details(self) -> Optional[pulumi.Input['BastionSessionKeyDetailsArgs']]:
        """
        Public key details for a bastion session.
        """
        return pulumi.get(self, "key_details")
    ...
    @key_details.setter
    def key_details(self, value: Optional[pulumi.Input['BastionSessionKeyDetailsArgs']]):
        pulumi.set(self, "key_details", value)
    ...
    @property
    @pulumi.getter(name="targetResourceDetails")
    def target_resource_details(self) -> Optional[pulumi.Input['BastionSessionTargetResourceDetailsArgs']]:
        """
        Details about a bastion session's target resource.
        """
        return pulumi.get(self, "target_resource_details")
    ...
    @target_resource_details.setter
    def target_resource_details(self, value: Optional[pulumi.Input['BastionSessionTargetResourceDetailsArgs']]):
        pulumi.set(self, "target_resource_details", value)
...
class BastionSession(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 bastion_id: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 key_details: Optional[pulumi.Input[pulumi.InputType['BastionSessionKeyDetailsArgs']]] = None,
                 key_type: Optional[pulumi.Input[str]] = None,
                 session_ttl_in_seconds: Optional[pulumi.Input[int]] = None,
                 target_resource_details: Optional[pulumi.Input[pulumi.InputType['BastionSessionTargetResourceDetailsArgs']]] = None,
                 __props__=None):
        """
        ...
        test_session = oci.BastionSession("testSession",
            bastion_id=oci_bastion_bastion["test_bastion"]["id"],
            key_details=oci.BastionSessionKeyDetailsArgs(
                public_key_content=var["session_key_details_public_key_content"],
            ),
            target_resource_details=oci.BastionSessionTargetResourceDetailsArgs(
        ...
        :param pulumi.Input[str] bastion_id: The unique identifier (OCID) of the bastion on which to create this session.
        :param pulumi.Input[str] display_name: (Updatable) The name of the session.
        :param pulumi.Input[pulumi.InputType['BastionSessionKeyDetailsArgs']] key_details: Public key details for a bastion session.
        :param pulumi.Input[str] key_type: The type of the key used to connect to the session. PUB is a standard public key in OpenSSH format.
        :param pulumi.Input[int] session_ttl_in_seconds: The amount of time the session can remain active.
        :param pulumi.Input[pulumi.InputType['BastionSessionTargetResourceDetailsArgs']] target_resource_details: Details about a bastion session's target resource.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: BastionSessionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Session resource in Oracle Cloud Infrastructure Bastion service.
        ...
        :param str resource_name: The name of the resource.
        :param BastionSessionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BastionSessionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BastionSessionArgs.__new__(BastionSessionArgs)
        ...
        super(BastionSession, __self__).__init__(
            'oci:index/bastionSession:BastionSession',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            target_resource_details: Optional[pulumi.Input[pulumi.InputType['BastionSessionTargetResourceDetailsArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'BastionSession':
        """
        ...
        __props__ = _BastionSessionState.__new__(_BastionSessionState)
        ...
        return BastionSession(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="keyDetails")
    def key_details(self) -> pulumi.Output['outputs.BastionSessionKeyDetails']:
        """
        Public key details for a bastion session.
        """
        return pulumi.get(self, "key_details")
    ...
    @property
    @pulumi.getter(name="targetResourceDetails")
    def target_resource_details(self) -> pulumi.Output['outputs.BastionSessionTargetResourceDetails']:
        """
        Details about a bastion session's target resource.
        """
        return pulumi.get(self, "target_resource_details")
