...
__all__ = [
    'GetCoreCrossConnectGroupResult',
    'AwaitableGetCoreCrossConnectGroupResult',
    'get_core_cross_connect_group',
]

@pulumi.output_type
class GetCoreCrossConnectGroupResult:
    """
    A collection of values returned by GetCoreCrossConnectGroup.
    """
    def __init__(__self__, compartment_id=None, cross_connect_group_id=None, customer_reference_name=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, state=None, time_created=None):
...
class AwaitableGetCoreCrossConnectGroupResult(GetCoreCrossConnectGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreCrossConnectGroupResult(
...
def get_core_cross_connect_group(cross_connect_group_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreCrossConnectGroupResult:
    """
    ...
    test_cross_connect_group = oci.get_core_cross_connect_group(cross_connect_group_id=oci_core_cross_connect_group["test_cross_connect_group"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreCrossConnectGroup:GetCoreCrossConnectGroup', __args__, opts=opts, typ=GetCoreCrossConnectGroupResult).value

    return AwaitableGetCoreCrossConnectGroupResult(
