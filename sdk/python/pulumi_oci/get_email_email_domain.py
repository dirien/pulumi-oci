...
__all__ = [
    'GetEmailEmailDomainResult',
    'AwaitableGetEmailEmailDomainResult',
    'get_email_email_domain',
]

@pulumi.output_type
class GetEmailEmailDomainResult:
    """
...
class AwaitableGetEmailEmailDomainResult(GetEmailEmailDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailEmailDomainResult(
...
def get_email_email_domain(email_domain_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailEmailDomainResult:
    """
    ...
    test_email_domain = oci.get_email_email_domain(email_domain_id=oci_email_email_domain["test_email_domain"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailEmailDomain:GetEmailEmailDomain', __args__, opts=opts, typ=GetEmailEmailDomainResult).value

    return AwaitableGetEmailEmailDomainResult(
