...
__all__ = [
    'GetCoreVnicResult',
    'AwaitableGetCoreVnicResult',
    'get_core_vnic',
]

@pulumi.output_type
class GetCoreVnicResult:
    """
...
class AwaitableGetCoreVnicResult(GetCoreVnicResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVnicResult(
...
def get_core_vnic(vnic_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVnicResult:
    """
    ...
    test_vnic = oci.get_core_vnic(vnic_id=oci_core_vnic["test_vnic"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVnic:GetCoreVnic', __args__, opts=opts, typ=GetCoreVnicResult).value

    return AwaitableGetCoreVnicResult(
