...
__all__ = [
    'GetBdsBdsInstanceResult',
    'AwaitableGetBdsBdsInstanceResult',
    'get_bds_bds_instance',
]

@pulumi.output_type
class GetBdsBdsInstanceResult:
    """
    ...
    def cloud_sql_details(self) -> 'outputs.GetBdsBdsInstanceCloudSqlDetailsResult':
        """
    ...
    def cluster_details(self) -> 'outputs.GetBdsBdsInstanceClusterDetailsResult':
        """
    ...
    def master_node(self) -> 'outputs.GetBdsBdsInstanceMasterNodeResult':
        return pulumi.get(self, "master_node")

    @property
    @pulumi.getter(name="networkConfig")
    def network_config(self) -> 'outputs.GetBdsBdsInstanceNetworkConfigResult':
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Sequence['outputs.GetBdsBdsInstanceNodeResult']:
        """
    ...
    def util_node(self) -> 'outputs.GetBdsBdsInstanceUtilNodeResult':
        return pulumi.get(self, "util_node")

    @property
    @pulumi.getter(name="workerNode")
    def worker_node(self) -> 'outputs.GetBdsBdsInstanceWorkerNodeResult':
        return pulumi.get(self, "worker_node")


class AwaitableGetBdsBdsInstanceResult(GetBdsBdsInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBdsBdsInstanceResult(
...
def get_bds_bds_instance(bds_instance_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBdsBdsInstanceResult:
    """
    ...
    test_bds_instance = oci.get_bds_bds_instance(bds_instance_id=oci_bds_bds_instance["test_bds_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBdsBdsInstance:GetBdsBdsInstance', __args__, opts=opts, typ=GetBdsBdsInstanceResult).value

    return AwaitableGetBdsBdsInstanceResult(
