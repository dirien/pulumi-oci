...
__all__ = ['CoreDrgRouteDistributionStatementArgs', 'CoreDrgRouteDistributionStatement']

@pulumi.input_type
class CoreDrgRouteDistributionStatementArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[str],
                 drg_route_distribution_id: pulumi.Input[str],
                 match_criteria: pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs'],
        ...
        :param pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs'] match_criteria: (Updatable) The action is applied only if all of the match criteria is met. If there are no match criteria in a statement, match ALL is implied.
    ...
    def match_criteria(self) -> pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs']:
        """
    ...
    def match_criteria(self, value: pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs']):
...
@pulumi.input_type
class _CoreDrgRouteDistributionStatementState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 drg_route_distribution_id: Optional[pulumi.Input[str]] = None,
                 match_criteria: Optional[pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs']] = None,
    ...
    @property
    @pulumi.getter(name="matchCriteria")
    def match_criteria(self) -> Optional[pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs']]:
        """
        (Updatable) The action is applied only if all of the match criteria is met. If there are no match criteria in a statement, match ALL is implied.
        """
        return pulumi.get(self, "match_criteria")
    ...
    @match_criteria.setter
    def match_criteria(self, value: Optional[pulumi.Input['CoreDrgRouteDistributionStatementMatchCriteriaArgs']]):
        pulumi.set(self, "match_criteria", value)
...
class CoreDrgRouteDistributionStatement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 action: Optional[pulumi.Input[str]] = None,
                 drg_route_distribution_id: Optional[pulumi.Input[str]] = None,
                 match_criteria: Optional[pulumi.Input[pulumi.InputType['CoreDrgRouteDistributionStatementMatchCriteriaArgs']]] = None,
                 priority: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        """
        ...
        test_drg_route_distribution_statement = oci.CoreDrgRouteDistributionStatement("testDrgRouteDistributionStatement",
            ...
            match_criteria=oci.CoreDrgRouteDistributionStatementMatchCriteriaArgs(
        ...
        :param pulumi.Input[str] action: Accept: import/export the route "as is"
        :param pulumi.Input[str] drg_route_distribution_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route distribution.
        :param pulumi.Input[pulumi.InputType['CoreDrgRouteDistributionStatementMatchCriteriaArgs']] match_criteria: (Updatable) The action is applied only if all of the match criteria is met. If there are no match criteria in a statement, match ALL is implied.
        :param pulumi.Input[int] priority: (Updatable) This field is used to specify the priority of each statement in a route distribution. The priority will be represented as a number between 0 and 65535 where a lower number indicates a higher priority. When a route is processed, statements are applied in the order defined by their priority. The first matching rule dictates the action that will be taken on the route.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: CoreDrgRouteDistributionStatementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Drg Route Distribution Statement resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreDrgRouteDistributionStatementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreDrgRouteDistributionStatementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreDrgRouteDistributionStatementArgs.__new__(CoreDrgRouteDistributionStatementArgs)
        ...
        super(CoreDrgRouteDistributionStatement, __self__).__init__(
            'oci:index/coreDrgRouteDistributionStatement:CoreDrgRouteDistributionStatement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            drg_route_distribution_id: Optional[pulumi.Input[str]] = None,
            match_criteria: Optional[pulumi.Input[pulumi.InputType['CoreDrgRouteDistributionStatementMatchCriteriaArgs']]] = None,
            priority: Optional[pulumi.Input[int]] = None) -> 'CoreDrgRouteDistributionStatement':
        """
        ...
        __props__ = _CoreDrgRouteDistributionStatementState.__new__(_CoreDrgRouteDistributionStatementState)

        __props__.__dict__["action"] = action
        __props__.__dict__["drg_route_distribution_id"] = drg_route_distribution_id
        __props__.__dict__["match_criteria"] = match_criteria
        __props__.__dict__["priority"] = priority
        return CoreDrgRouteDistributionStatement(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="matchCriteria")
    def match_criteria(self) -> pulumi.Output['outputs.CoreDrgRouteDistributionStatementMatchCriteria']:
        """
        (Updatable) The action is applied only if all of the match criteria is met. If there are no match criteria in a statement, match ALL is implied.
        """
        return pulumi.get(self, "match_criteria")
