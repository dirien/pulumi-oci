...
__all__ = [
    'GetDatabaseDbNodesResult',
    'AwaitableGetDatabaseDbNodesResult',
    'get_database_db_nodes',
]

@pulumi.output_type
class GetDatabaseDbNodesResult:
    """
    A collection of values returned by GetDatabaseDbNodes.
    """
    def __init__(__self__, compartment_id=None, db_nodes=None, db_system_id=None, filters=None, id=None, state=None, vm_cluster_id=None):
    ...
    def db_nodes(self) -> Sequence['outputs.GetDatabaseDbNodesDbNodeResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseDbNodesFilterResult']]:
...
class AwaitableGetDatabaseDbNodesResult(GetDatabaseDbNodesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbNodesResult(
...
def get_database_db_nodes(compartment_id: Optional[str] = None,
                          db_system_id: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetDatabaseDbNodesFilterArgs']]] = None,
                          state: Optional[str] = None,
                          vm_cluster_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbNodesResult:
    """
    ...
    test_db_nodes = oci.get_database_db_nodes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbNodes:GetDatabaseDbNodes', __args__, opts=opts, typ=GetDatabaseDbNodesResult).value

    return AwaitableGetDatabaseDbNodesResult(
