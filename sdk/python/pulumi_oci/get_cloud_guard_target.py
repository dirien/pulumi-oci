...
__all__ = [
    'GetCloudGuardTargetResult',
    'AwaitableGetCloudGuardTargetResult',
    'get_cloud_guard_target',
]

@pulumi.output_type
class GetCloudGuardTargetResult:
    """
    ...
    def target_detector_recipes(self) -> Sequence['outputs.GetCloudGuardTargetTargetDetectorRecipeResult']:
        """
    ...
    def target_responder_recipes(self) -> Sequence['outputs.GetCloudGuardTargetTargetResponderRecipeResult']:
        """
...
class AwaitableGetCloudGuardTargetResult(GetCloudGuardTargetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardTargetResult(
...
def get_cloud_guard_target(target_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardTargetResult:
    """
    ...
    test_target = oci.get_cloud_guard_target(target_id=oci_cloud_guard_target["test_target"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardTarget:GetCloudGuardTarget', __args__, opts=opts, typ=GetCloudGuardTargetResult).value

    return AwaitableGetCloudGuardTargetResult(
