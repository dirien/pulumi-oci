...
__all__ = [
    'GetServiceCatalogServiceCatalogResult',
    'AwaitableGetServiceCatalogServiceCatalogResult',
    'get_service_catalog_service_catalog',
]

@pulumi.output_type
class GetServiceCatalogServiceCatalogResult:
    """
...
class AwaitableGetServiceCatalogServiceCatalogResult(GetServiceCatalogServiceCatalogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceCatalogServiceCatalogResult(
...
def get_service_catalog_service_catalog(service_catalog_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceCatalogServiceCatalogResult:
    """
    ...
    test_service_catalog = oci.get_service_catalog_service_catalog(service_catalog_id=oci_service_catalog_service_catalog["test_service_catalog"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getServiceCatalogServiceCatalog:GetServiceCatalogServiceCatalog', __args__, opts=opts, typ=GetServiceCatalogServiceCatalogResult).value

    return AwaitableGetServiceCatalogServiceCatalogResult(
