...
__all__ = [
    'GetLimitsQuotaResult',
    'AwaitableGetLimitsQuotaResult',
    'get_limits_quota',
]

@pulumi.output_type
class GetLimitsQuotaResult:
    """
...
class AwaitableGetLimitsQuotaResult(GetLimitsQuotaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLimitsQuotaResult(
...
def get_limits_quota(quota_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLimitsQuotaResult:
    """
    ...
    test_quota = oci.get_limits_quota(quota_id=oci_limits_quota["test_quota"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLimitsQuota:GetLimitsQuota', __args__, opts=opts, typ=GetLimitsQuotaResult).value

    return AwaitableGetLimitsQuotaResult(
