...
__all__ = [
    'GetCoreCrossConnectsResult',
    'AwaitableGetCoreCrossConnectsResult',
    'get_core_cross_connects',
]

@pulumi.output_type
class GetCoreCrossConnectsResult:
    """
    ...
    def cross_connects(self) -> Sequence['outputs.GetCoreCrossConnectsCrossConnectResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreCrossConnectsFilterResult']]:
...
class AwaitableGetCoreCrossConnectsResult(GetCoreCrossConnectsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreCrossConnectsResult(
...
def get_core_cross_connects(compartment_id: Optional[str] = None,
                            cross_connect_group_id: Optional[str] = None,
                            display_name: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetCoreCrossConnectsFilterArgs']]] = None,
                            state: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreCrossConnectsResult:
    """
    ...
    test_cross_connects = oci.get_core_cross_connects(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreCrossConnects:GetCoreCrossConnects', __args__, opts=opts, typ=GetCoreCrossConnectsResult).value

    return AwaitableGetCoreCrossConnectsResult(
