...
__all__ = [
    'GetDatabaseMigrationMigrationResult',
    'AwaitableGetDatabaseMigrationMigrationResult',
    'get_database_migration_migration',
]

@pulumi.output_type
class GetDatabaseMigrationMigrationResult:
    """
    ...
    def data_transfer_medium_details(self) -> 'outputs.GetDatabaseMigrationMigrationDataTransferMediumDetailsResult':
        """
    ...
    def datapump_settings(self) -> 'outputs.GetDatabaseMigrationMigrationDatapumpSettingsResult':
        """
    ...
    def exclude_objects(self) -> Sequence['outputs.GetDatabaseMigrationMigrationExcludeObjectResult']:
        """
    ...
    def golden_gate_details(self) -> 'outputs.GetDatabaseMigrationMigrationGoldenGateDetailsResult':
        """
    ...
    def vault_details(self) -> 'outputs.GetDatabaseMigrationMigrationVaultDetailsResult':
        """
...
class AwaitableGetDatabaseMigrationMigrationResult(GetDatabaseMigrationMigrationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseMigrationMigrationResult(
...
def get_database_migration_migration(migration_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseMigrationMigrationResult:
    """
    ...
    test_migration = oci.get_database_migration_migration(migration_id=oci_database_migration_migration["test_migration"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseMigrationMigration:GetDatabaseMigrationMigration', __args__, opts=opts, typ=GetDatabaseMigrationMigrationResult).value

    return AwaitableGetDatabaseMigrationMigrationResult(
