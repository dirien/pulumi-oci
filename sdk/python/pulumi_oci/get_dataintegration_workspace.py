...
__all__ = [
    'GetDataintegrationWorkspaceResult',
    'AwaitableGetDataintegrationWorkspaceResult',
    'get_dataintegration_workspace',
]

@pulumi.output_type
class GetDataintegrationWorkspaceResult:
    """
...
class AwaitableGetDataintegrationWorkspaceResult(GetDataintegrationWorkspaceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataintegrationWorkspaceResult(
...
def get_dataintegration_workspace(workspace_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataintegrationWorkspaceResult:
    """
    ...
    test_workspace = oci.get_dataintegration_workspace(workspace_id=oci_dataintegration_workspace["test_workspace"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataintegrationWorkspace:GetDataintegrationWorkspace', __args__, opts=opts, typ=GetDataintegrationWorkspaceResult).value

    return AwaitableGetDataintegrationWorkspaceResult(
