...
__all__ = [
    'GetIdentityNetworkSourcesResult',
    'AwaitableGetIdentityNetworkSourcesResult',
    'get_identity_network_sources',
]

@pulumi.output_type
class GetIdentityNetworkSourcesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityNetworkSourcesFilterResult']]:
    ...
    def network_sources(self) -> Sequence['outputs.GetIdentityNetworkSourcesNetworkSourceResult']:
        """
...
class AwaitableGetIdentityNetworkSourcesResult(GetIdentityNetworkSourcesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityNetworkSourcesResult(
...
def get_identity_network_sources(compartment_id: Optional[str] = None,
                                 filters: Optional[Sequence[pulumi.InputType['GetIdentityNetworkSourcesFilterArgs']]] = None,
                                 name: Optional[str] = None,
                                 state: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityNetworkSourcesResult:
    """
    ...
    test_network_sources = oci.get_identity_network_sources(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityNetworkSources:GetIdentityNetworkSources', __args__, opts=opts, typ=GetIdentityNetworkSourcesResult).value

    return AwaitableGetIdentityNetworkSourcesResult(
