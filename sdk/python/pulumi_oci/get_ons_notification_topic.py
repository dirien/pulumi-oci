...
__all__ = [
    'GetOnsNotificationTopicResult',
    'AwaitableGetOnsNotificationTopicResult',
    'get_ons_notification_topic',
]

@pulumi.output_type
class GetOnsNotificationTopicResult:
    """
...
class AwaitableGetOnsNotificationTopicResult(GetOnsNotificationTopicResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOnsNotificationTopicResult(
...
def get_ons_notification_topic(topic_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOnsNotificationTopicResult:
    """
    ...
    test_notification_topic = oci.get_ons_notification_topic(topic_id=oci_ons_notification_topic["test_notification_topic"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOnsNotificationTopic:GetOnsNotificationTopic', __args__, opts=opts, typ=GetOnsNotificationTopicResult).value

    return AwaitableGetOnsNotificationTopicResult(
