...
__all__ = [
    'GetOsmanagementManagedInstanceResult',
    'AwaitableGetOsmanagementManagedInstanceResult',
    'get_osmanagement_managed_instance',
]

@pulumi.output_type
class GetOsmanagementManagedInstanceResult:
    """
    A collection of values returned by GetOsmanagementManagedInstance.
    """
    def __init__(__self__, bug_updates_available=None, child_software_sources=None, compartment_id=None, description=None, display_name=None, enhancement_updates_available=None, id=None, is_reboot_required=None, last_boot=None, last_checkin=None, managed_instance_groups=None, managed_instance_id=None, os_family=None, os_kernel_version=None, os_name=None, os_version=None, other_updates_available=None, parent_software_sources=None, scheduled_job_count=None, security_updates_available=None, status=None, updates_available=None, work_request_count=None):
    ...
    def child_software_sources(self) -> Sequence['outputs.GetOsmanagementManagedInstanceChildSoftwareSourceResult']:
        """
    ...
    def managed_instance_groups(self) -> Sequence['outputs.GetOsmanagementManagedInstanceManagedInstanceGroupResult']:
        """
    ...
    def parent_software_sources(self) -> Sequence['outputs.GetOsmanagementManagedInstanceParentSoftwareSourceResult']:
        """
...
class AwaitableGetOsmanagementManagedInstanceResult(GetOsmanagementManagedInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOsmanagementManagedInstanceResult(
...
def get_osmanagement_managed_instance(managed_instance_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOsmanagementManagedInstanceResult:
    """
    ...
    test_managed_instance = oci.get_osmanagement_managed_instance(managed_instance_id=oci_osmanagement_managed_instance["test_managed_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOsmanagementManagedInstance:GetOsmanagementManagedInstance', __args__, opts=opts, typ=GetOsmanagementManagedInstanceResult).value

    return AwaitableGetOsmanagementManagedInstanceResult(
