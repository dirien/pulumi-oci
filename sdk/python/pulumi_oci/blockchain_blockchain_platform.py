...
__all__ = ['BlockchainBlockchainPlatformArgs', 'BlockchainBlockchainPlatform']

@pulumi.input_type
class BlockchainBlockchainPlatformArgs:
    def __init__(__self__, *,
                 ...
                 replicas: Optional[pulumi.Input['BlockchainBlockchainPlatformReplicasArgs']] = None,
        ...
        :param pulumi.Input['BlockchainBlockchainPlatformReplicasArgs'] replicas: Number of replicas of service components like Rest Proxy, CA and Console
    ...
    @property
    @pulumi.getter
    def replicas(self) -> Optional[pulumi.Input['BlockchainBlockchainPlatformReplicasArgs']]:
        """
    ...
    @replicas.setter
    def replicas(self, value: Optional[pulumi.Input['BlockchainBlockchainPlatformReplicasArgs']]):
...
@pulumi.input_type
class _BlockchainBlockchainPlatformState:
    def __init__(__self__, *,
                 ca_cert_archive_text: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 component_details: Optional[pulumi.Input['BlockchainBlockchainPlatformComponentDetailsArgs']] = None,
                 ...
                 federated_user_id: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 host_ocpu_utilization_infos: Optional[pulumi.Input[Sequence[pulumi.Input['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]]] = None,
        ...
        :param pulumi.Input[str] ca_cert_archive_text: Base64 encoded text in ASCII character set of a Thirdparty CA Certificates archive file. The Archive file is a zip file containing third part CA Certificates, the ca key and certificate files used when issuing enrollment certificates (ECerts) and transaction certificates (TCerts). The chainfile (if it exists) contains the certificate chain which should be trusted for this CA, where the 1st in the chain is always the root CA certificate. File list in zip file [ca-cert.pem,ca-key.pem,ca-chain.pem(optional)].
        :param pulumi.Input[str] compartment_id: (Updatable) Compartment Identifier
        :param pulumi.Input['BlockchainBlockchainPlatformComponentDetailsArgs'] component_details: Blockchain Platform component details.
        :param pulumi.Input[str] compute_shape: Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] description: (Updatable) Platform Instance Description
        :param pulumi.Input[str] display_name: Platform Instance Display name, can be renamed
        :param pulumi.Input[str] federated_user_id: Identifier for a federated user
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]] host_ocpu_utilization_infos: List of OcpuUtilization for all hosts
        :param pulumi.Input[str] idcs_access_token: IDCS access token with Identity Domain Administrator role
        :param pulumi.Input[bool] is_byol: Bring your own license
    ...
    def component_details(self) -> Optional[pulumi.Input['BlockchainBlockchainPlatformComponentDetailsArgs']]:
        """
    ...
    def component_details(self, value: Optional[pulumi.Input['BlockchainBlockchainPlatformComponentDetailsArgs']]):
    ...
    def host_ocpu_utilization_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]]]:
        """
    ...
    def host_ocpu_utilization_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]]]):
...
class BlockchainBlockchainPlatform(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 load_balancer_shape: Optional[pulumi.Input[str]] = None,
                 platform_role: Optional[pulumi.Input[str]] = None,
                 replicas: Optional[pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformReplicasArgs']]] = None,
                 storage_size_in_tbs: Optional[pulumi.Input[float]] = None,
                 total_ocpu_capacity: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        """
        ...
        test_blockchain_platform = oci.BlockchainBlockchainPlatform("testBlockchainPlatform",
        ...
        :param pulumi.Input[str] load_balancer_shape: (Updatable) Type of Load Balancer shape - LB_100_MBPS or LB_400_MBPS. Default is LB_100_MBPS.
        :param pulumi.Input[str] platform_role: Role of platform - founder or participant
        :param pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformReplicasArgs']] replicas: Number of replicas of service components like Rest Proxy, CA and Console
        :param pulumi.Input[float] storage_size_in_tbs: Storage size in TBs
        :param pulumi.Input[int] total_ocpu_capacity: Number of total OCPUs allocated to the platform cluster
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: BlockchainBlockchainPlatformArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Blockchain Platform resource in Oracle Cloud Infrastructure Blockchain service.
        ...
        :param str resource_name: The name of the resource.
        :param BlockchainBlockchainPlatformArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlockchainBlockchainPlatformArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BlockchainBlockchainPlatformArgs.__new__(BlockchainBlockchainPlatformArgs)
        ...
        super(BlockchainBlockchainPlatform, __self__).__init__(
            'oci:index/blockchainBlockchainPlatform:BlockchainBlockchainPlatform',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ca_cert_archive_text: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            component_details: Optional[pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformComponentDetailsArgs']]] = None,
            compute_shape: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            description: Optional[pulumi.Input[str]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            federated_user_id: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            host_ocpu_utilization_infos: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]]]] = None,
            idcs_access_token: Optional[pulumi.Input[str]] = None,
            is_byol: Optional[pulumi.Input[bool]] = None,
            is_multi_ad: Optional[pulumi.Input[bool]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            total_ocpu_capacity: Optional[pulumi.Input[int]] = None) -> 'BlockchainBlockchainPlatform':
        """
        ...
        :param pulumi.Input[str] ca_cert_archive_text: Base64 encoded text in ASCII character set of a Thirdparty CA Certificates archive file. The Archive file is a zip file containing third part CA Certificates, the ca key and certificate files used when issuing enrollment certificates (ECerts) and transaction certificates (TCerts). The chainfile (if it exists) contains the certificate chain which should be trusted for this CA, where the 1st in the chain is always the root CA certificate. File list in zip file [ca-cert.pem,ca-key.pem,ca-chain.pem(optional)].
        :param pulumi.Input[str] compartment_id: (Updatable) Compartment Identifier
        :param pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformComponentDetailsArgs']] component_details: Blockchain Platform component details.
        :param pulumi.Input[str] compute_shape: Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] description: (Updatable) Platform Instance Description
        :param pulumi.Input[str] display_name: Platform Instance Display name, can be renamed
        :param pulumi.Input[str] federated_user_id: Identifier for a federated user
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BlockchainBlockchainPlatformHostOcpuUtilizationInfoArgs']]]] host_ocpu_utilization_infos: List of OcpuUtilization for all hosts
        :param pulumi.Input[str] idcs_access_token: IDCS access token with Identity Domain Administrator role
        :param pulumi.Input[bool] is_byol: Bring your own license
        :param pulumi.Input[bool] is_multi_ad: True for multi-AD blockchain plaforms, false for single-AD
        :param pulumi.Input[str] lifecycle_details: An message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        __props__ = _BlockchainBlockchainPlatformState.__new__(_BlockchainBlockchainPlatformState)
        ...
        __props__.__dict__["total_ocpu_capacity"] = total_ocpu_capacity
        return BlockchainBlockchainPlatform(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="componentDetails")
    def component_details(self) -> pulumi.Output['outputs.BlockchainBlockchainPlatformComponentDetails']:
        """
        Blockchain Platform component details.
        """
        return pulumi.get(self, "component_details")
    ...
    @property
    @pulumi.getter(name="hostOcpuUtilizationInfos")
    def host_ocpu_utilization_infos(self) -> pulumi.Output[Sequence['outputs.BlockchainBlockchainPlatformHostOcpuUtilizationInfo']]:
        """
        List of OcpuUtilization for all hosts
        """
        return pulumi.get(self, "host_ocpu_utilization_infos")
    ...
    @property
    @pulumi.getter
    def replicas(self) -> pulumi.Output['outputs.BlockchainBlockchainPlatformReplicas']:
        """
        Number of replicas of service components like Rest Proxy, CA and Console
        """
        return pulumi.get(self, "replicas")
