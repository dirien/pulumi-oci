...
__all__ = ['CoreDrgAttachmentArgs', 'CoreDrgAttachment']

@pulumi.input_type
class CoreDrgAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 network_details: Optional[pulumi.Input['CoreDrgAttachmentNetworkDetailsArgs']] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique. Avoid entering confidential information.
        ...
        :param pulumi.Input['CoreDrgAttachmentNetworkDetailsArgs'] network_details: (Updatable)
    ...
    def network_details(self) -> Optional[pulumi.Input['CoreDrgAttachmentNetworkDetailsArgs']]:
        """
        (Updatable)
        """
    ...
    def network_details(self, value: Optional[pulumi.Input['CoreDrgAttachmentNetworkDetailsArgs']]):
...
class CoreDrgAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 export_drg_route_distribution_id: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 network_details: Optional[pulumi.Input[pulumi.InputType['CoreDrgAttachmentNetworkDetailsArgs']]] = None,
                 remove_export_drg_route_distribution_trigger: Optional[pulumi.Input[bool]] = None,
                 route_table_id: Optional[pulumi.Input[str]] = None,
                 vcn_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        test_drg_attachment = oci.CoreDrgAttachment("testDrgAttachment",
            ...
            network_details=oci.CoreDrgAttachmentNetworkDetailsArgs(
        ...
        :param pulumi.Input[str] export_drg_route_distribution_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the export route distribution used to specify how routes in the assigned DRG route table are advertised to the attachment. If this value is null, no routes are advertised through this attachment.
               This field cannot be set by the user while creating the resource and gets a default value on creation. This can be only be updated to its default value. If this fields needs to be set to null, remove_export_drg_route_distribution_trigger needs to be used.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['CoreDrgAttachmentNetworkDetailsArgs']] network_details: (Updatable)
        :param pulumi.Input[bool] remove_export_drg_route_distribution_trigger: (Updatable) An optional property when set to true during update disables the export of route Distribution by setting export_drg_route_distribution_id to null.
        :param pulumi.Input[str] route_table_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route table used by the DRG attachment.
        :param pulumi.Input[str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN. This field is deprecated. Instead, use the `networkDetails` field to specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the attached resource.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreDrgAttachmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreDrgAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreDrgAttachmentArgs.__new__(CoreDrgAttachmentArgs)
        ...
        super(CoreDrgAttachment, __self__).__init__(
            'oci:index/coreDrgAttachment:CoreDrgAttachment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'CoreDrgAttachment':
        """
        ...
        __props__ = _CoreDrgAttachmentState.__new__(_CoreDrgAttachmentState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        return CoreDrgAttachment(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="networkDetails")
    def network_details(self) -> pulumi.Output['outputs.CoreDrgAttachmentNetworkDetails']:
        """
        (Updatable)
        """
        return pulumi.get(self, "network_details")
