...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 issuer_name: Optional[pulumi.Input['CertificateIssuerNameArgs']] = None,
                 private_key_data: Optional[pulumi.Input[str]] = None,
                 public_key_info: Optional[pulumi.Input['CertificatePublicKeyInfoArgs']] = None,
                 serial_number: Optional[pulumi.Input[str]] = None,
                 signature_algorithm: Optional[pulumi.Input[str]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 subject_name: Optional[pulumi.Input['CertificateSubjectNameArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_trust_verification_disabled: Set to `true` if the SSL certificate is self-signed.
        :param pulumi.Input['CertificateIssuerNameArgs'] issuer_name: The issuer of the certificate.
        :param pulumi.Input[str] private_key_data: The private key of the SSL certificate.
        :param pulumi.Input['CertificatePublicKeyInfoArgs'] public_key_info: Information about the public key and the algorithm used by the public key.
        ...
        :param pulumi.Input['CertificateSubjectNameArgs'] subject_name: The entity to be secured by the certificate.
    ...
    def issuer_name(self) -> Optional[pulumi.Input['CertificateIssuerNameArgs']]:
        """
    ...
    @issuer_name.setter
    def issuer_name(self, value: Optional[pulumi.Input['CertificateIssuerNameArgs']]):
    ...
    def public_key_info(self) -> Optional[pulumi.Input['CertificatePublicKeyInfoArgs']]:
        """
    ...
    def public_key_info(self, value: Optional[pulumi.Input['CertificatePublicKeyInfoArgs']]):
    ...
    def subject_name(self) -> Optional[pulumi.Input['CertificateSubjectNameArgs']]:
        """
    ...
    @subject_name.setter
    def subject_name(self, value: Optional[pulumi.Input['CertificateSubjectNameArgs']]):
...
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_trust_verification_disabled: Optional[pulumi.Input[bool]] = None,
            issued_by: Optional[pulumi.Input[str]] = None,
            issuer_name: Optional[pulumi.Input[pulumi.InputType['CertificateIssuerNameArgs']]] = None,
            private_key_data: Optional[pulumi.Input[str]] = None,
            public_key_info: Optional[pulumi.Input[pulumi.InputType['CertificatePublicKeyInfoArgs']]] = None,
            serial_number: Optional[pulumi.Input[str]] = None,
            signature_algorithm: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            subject_name: Optional[pulumi.Input[pulumi.InputType['CertificateSubjectNameArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_not_valid_after: Optional[pulumi.Input[str]] = None,
            time_not_valid_before: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_trust_verification_disabled: Set to `true` if the SSL certificate is self-signed.
        :param pulumi.Input[pulumi.InputType['CertificateIssuerNameArgs']] issuer_name: The issuer of the certificate.
        :param pulumi.Input[str] private_key_data: The private key of the SSL certificate.
        :param pulumi.Input[pulumi.InputType['CertificatePublicKeyInfoArgs']] public_key_info: Information about the public key and the algorithm used by the public key.
        :param pulumi.Input[str] serial_number: A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
        :param pulumi.Input[str] signature_algorithm: The identifier for the cryptographic algorithm used by the Certificate Authority (CA) to sign this certificate.
        :param pulumi.Input[str] state: The current lifecycle state of the SSL certificate.
        :param pulumi.Input[pulumi.InputType['CertificateSubjectNameArgs']] subject_name: The entity to be secured by the certificate.
        :param pulumi.Input[str] time_created: The date and time the certificate was created, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[str] time_not_valid_after: The date and time the certificate will expire, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[str] time_not_valid_before: The date and time the certificate will become valid, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[int] version: The version of the encoded certificate.
    ...
    @property
    @pulumi.getter(name="issuerName")
    def issuer_name(self) -> pulumi.Output['outputs.CertificateIssuerName']:
        """
        The issuer of the certificate.
        """
        return pulumi.get(self, "issuer_name")
    ...
    @property
    @pulumi.getter(name="publicKeyInfo")
    def public_key_info(self) -> pulumi.Output['outputs.CertificatePublicKeyInfo']:
        """
        Information about the public key and the algorithm used by the public key.
        """
        return pulumi.get(self, "public_key_info")
    ...
    @property
    @pulumi.getter(name="subjectName")
    def subject_name(self) -> pulumi.Output['outputs.CertificateSubjectName']:
        """
        The entity to be secured by the certificate.
        """
        return pulumi.get(self, "subject_name")
