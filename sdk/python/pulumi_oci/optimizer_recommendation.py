...
__all__ = ['OptimizerRecommendationArgs', 'OptimizerRecommendation']

@pulumi.input_type
class OptimizerRecommendationArgs:
...
@pulumi.input_type
class _OptimizerRecommendationState:
    def __init__(__self__, *,
                 ...
                 resource_counts: Optional[pulumi.Input[Sequence[pulumi.Input['OptimizerRecommendationResourceCountArgs']]]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 supported_levels: Optional[pulumi.Input['OptimizerRecommendationSupportedLevelsArgs']] = None,
        ...
        :param pulumi.Input[str] recommendation_id: The unique OCID associated with the recommendation.
        :param pulumi.Input[Sequence[pulumi.Input['OptimizerRecommendationResourceCountArgs']]] resource_counts: An array of `ResourceCount` objects grouped by the status of the resource actions.
        :param pulumi.Input[str] state: The recommendation's current state.
        :param pulumi.Input[str] status: (Updatable) The status of the recommendation.
        :param pulumi.Input['OptimizerRecommendationSupportedLevelsArgs'] supported_levels: Optional. The profile levels supported by a recommendation. For example, profile level values could be `Low`, `Medium`, and `High`. Not all recommendations support this field.
    ...
    def resource_counts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OptimizerRecommendationResourceCountArgs']]]]:
        """
    ...
    def resource_counts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OptimizerRecommendationResourceCountArgs']]]]):
    ...
    def supported_levels(self) -> Optional[pulumi.Input['OptimizerRecommendationSupportedLevelsArgs']]:
        """
    ...
    def supported_levels(self, value: Optional[pulumi.Input['OptimizerRecommendationSupportedLevelsArgs']]):
...
class OptimizerRecommendation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OptimizerRecommendationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Recommendation resource in Oracle Cloud Infrastructure Optimizer service.
        ...
        :param str resource_name: The name of the resource.
        :param OptimizerRecommendationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OptimizerRecommendationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OptimizerRecommendationArgs.__new__(OptimizerRecommendationArgs)
        ...
        super(OptimizerRecommendation, __self__).__init__(
            'oci:index/optimizerRecommendation:OptimizerRecommendation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            recommendation_id: Optional[pulumi.Input[str]] = None,
            resource_counts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OptimizerRecommendationResourceCountArgs']]]]] = None,
            state: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            supported_levels: Optional[pulumi.Input[pulumi.InputType['OptimizerRecommendationSupportedLevelsArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_status_begin: Optional[pulumi.Input[str]] = None,
            time_status_end: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'OptimizerRecommendation':
        """
        ...
        :param pulumi.Input[str] name: The name of the profile level.
        :param pulumi.Input[str] recommendation_id: The unique OCID associated with the recommendation.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OptimizerRecommendationResourceCountArgs']]]] resource_counts: An array of `ResourceCount` objects grouped by the status of the resource actions.
        :param pulumi.Input[str] state: The recommendation's current state.
        :param pulumi.Input[str] status: (Updatable) The status of the recommendation.
        :param pulumi.Input[pulumi.InputType['OptimizerRecommendationSupportedLevelsArgs']] supported_levels: Optional. The profile levels supported by a recommendation. For example, profile level values could be `Low`, `Medium`, and `High`. Not all recommendations support this field.
        :param pulumi.Input[str] time_created: The date and time the recommendation details were created, in the format defined by RFC3339.
        :param pulumi.Input[str] time_status_begin: The date and time that the recommendation entered its current status. The format is defined by RFC3339.
        :param pulumi.Input[str] time_status_end: (Updatable) The date and time the current status will change. The format is defined by RFC3339.
        :param pulumi.Input[str] time_updated: The date and time the recommendation details were last updated, in the format defined by RFC3339.
        ...
        __props__ = _OptimizerRecommendationState.__new__(_OptimizerRecommendationState)
        ...
        return OptimizerRecommendation(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="resourceCounts")
    def resource_counts(self) -> pulumi.Output[Sequence['outputs.OptimizerRecommendationResourceCount']]:
        """
        An array of `ResourceCount` objects grouped by the status of the resource actions.
        """
        return pulumi.get(self, "resource_counts")
    ...
    @property
    @pulumi.getter(name="supportedLevels")
    def supported_levels(self) -> pulumi.Output['outputs.OptimizerRecommendationSupportedLevels']:
        """
        Optional. The profile levels supported by a recommendation. For example, profile level values could be `Low`, `Medium`, and `High`. Not all recommendations support this field.
        """
        return pulumi.get(self, "supported_levels")
