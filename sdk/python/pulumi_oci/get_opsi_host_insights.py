...
__all__ = [
    'GetOpsiHostInsightsResult',
    'AwaitableGetOpsiHostInsightsResult',
    'get_opsi_host_insights',
]

@pulumi.output_type
class GetOpsiHostInsightsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOpsiHostInsightsFilterResult']]:
        return pulumi.get(self, "filters")

    @property
    @pulumi.getter(name="hostInsightSummaryCollections")
    def host_insight_summary_collections(self) -> Sequence['outputs.GetOpsiHostInsightsHostInsightSummaryCollectionResult']:
        """
...
class AwaitableGetOpsiHostInsightsResult(GetOpsiHostInsightsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOpsiHostInsightsResult(
...
def get_opsi_host_insights(compartment_id: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetOpsiHostInsightsFilterArgs']]] = None,
                           host_types: Optional[Sequence[str]] = None,
                           id: Optional[str] = None,
                           states: Optional[Sequence[str]] = None,
                           statuses: Optional[Sequence[str]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOpsiHostInsightsResult:
    """
    ...
    test_host_insights = oci.get_opsi_host_insights(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOpsiHostInsights:GetOpsiHostInsights', __args__, opts=opts, typ=GetOpsiHostInsightsResult).value

    return AwaitableGetOpsiHostInsightsResult(
