...
__all__ = [
    'GetOptimizerProfileResult',
    'AwaitableGetOptimizerProfileResult',
    'get_optimizer_profile',
]

@pulumi.output_type
class GetOptimizerProfileResult:
    """
    A collection of values returned by GetOptimizerProfile.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, description=None, freeform_tags=None, id=None, levels_configuration=None, name=None, profile_id=None, state=None, target_compartments=None, target_tags=None, time_created=None, time_updated=None):
        ...
        if levels_configuration and not isinstance(levels_configuration, dict):
            raise TypeError("Expected argument 'levels_configuration' to be a dict")
        ...
        if target_compartments and not isinstance(target_compartments, dict):
            raise TypeError("Expected argument 'target_compartments' to be a dict")
        pulumi.set(__self__, "target_compartments", target_compartments)
        if target_tags and not isinstance(target_tags, dict):
            raise TypeError("Expected argument 'target_tags' to be a dict")
    ...
    def levels_configuration(self) -> 'outputs.GetOptimizerProfileLevelsConfigurationResult':
        """
    ...
    def target_compartments(self) -> 'outputs.GetOptimizerProfileTargetCompartmentsResult':
        """
    ...
    def target_tags(self) -> 'outputs.GetOptimizerProfileTargetTagsResult':
        """
...
class AwaitableGetOptimizerProfileResult(GetOptimizerProfileResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerProfileResult(
            compartment_id=self.compartment_id,
            defined_tags=self.defined_tags,
            description=self.description,
            freeform_tags=self.freeform_tags,
            id=self.id,
            levels_configuration=self.levels_configuration,
            name=self.name,
...
def get_optimizer_profile(profile_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerProfileResult:
    """
    ...
    test_profile = oci.get_optimizer_profile(profile_id=oci_optimizer_profile["test_profile"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerProfile:GetOptimizerProfile', __args__, opts=opts, typ=GetOptimizerProfileResult).value

    return AwaitableGetOptimizerProfileResult(
        compartment_id=__ret__.compartment_id,
        defined_tags=__ret__.defined_tags,
        description=__ret__.description,
        freeform_tags=__ret__.freeform_tags,
        id=__ret__.id,
        levels_configuration=__ret__.levels_configuration,
        name=__ret__.name,
