...
class GetIdentityUsersResult:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityUsersFilterResult']]:
...
def get_identity_users(compartment_id: Optional[str] = None,
                       external_identifier: Optional[str] = None,
                       filters: Optional[Sequence[pulumi.InputType['GetIdentityUsersFilterArgs']]] = None,
    ...
    test_users = oci.get_identity_users(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityUsers:GetIdentityUsers', __args__, opts=opts, typ=GetIdentityUsersResult).value
