...
__all__ = ['DatabaseDbSystemArgs', 'DatabaseDbSystem']

@pulumi.input_type
class DatabaseDbSystemArgs:
    def __init__(__self__, *,
                 availability_domain: pulumi.Input[str],
                 compartment_id: pulumi.Input[str],
                 db_home: pulumi.Input['DatabaseDbSystemDbHomeArgs'],
                 ...
                 db_system_options: Optional[pulumi.Input['DatabaseDbSystemDbSystemOptionsArgs']] = None,
                 ...
                 maintenance_window_details: Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatabaseDbSystemDbHomeArgs'] db_home: (Updatable) Details for creating a Database Home if you are creating a database by restoring from a database backup.
        ...
        :param pulumi.Input['DatabaseDbSystemDbSystemOptionsArgs'] db_system_options: The DB system options.
        ...
        :param pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    def db_home(self) -> pulumi.Input['DatabaseDbSystemDbHomeArgs']:
        """
    ...
    @db_home.setter
    def db_home(self, value: pulumi.Input['DatabaseDbSystemDbHomeArgs']):
    ...
    def db_system_options(self) -> Optional[pulumi.Input['DatabaseDbSystemDbSystemOptionsArgs']]:
        """
    ...
    def db_system_options(self, value: Optional[pulumi.Input['DatabaseDbSystemDbSystemOptionsArgs']]):
    ...
    def maintenance_window_details(self) -> Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs']]:
        """
    ...
    def maintenance_window_details(self, value: Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs']]):
...
class _DatabaseDbSystemState:
    def __init__(__self__, *,
                 ...
                 data_storage_size_in_gb: Optional[pulumi.Input[int]] = None,
                 database_edition: Optional[pulumi.Input[str]] = None,
                 db_home: Optional[pulumi.Input['DatabaseDbSystemDbHomeArgs']] = None,
                 db_system_options: Optional[pulumi.Input['DatabaseDbSystemDbSystemOptionsArgs']] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 disk_redundancy: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 iorm_config_cache: Optional[pulumi.Input['DatabaseDbSystemIormConfigCacheArgs']] = None,
                 kms_key_id: Optional[pulumi.Input[str]] = None,
                 kms_key_version_id: Optional[pulumi.Input[str]] = None,
                 ...
                 maintenance_window: Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowArgs']] = None,
                 maintenance_window_details: Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] hostname: The hostname for the DB system. The hostname must begin with an alphabetic character, and can contain alphanumeric characters and hyphens (-). The maximum length of the hostname is 16 characters for bare metal and virtual machine DB systems, and 12 characters for Exadata DB systems.
        :param pulumi.Input['DatabaseDbSystemIormConfigCacheArgs'] iorm_config_cache: The IORM settings of the Exadata DB system.
        :param pulumi.Input[str] kms_key_id: The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.
        :param pulumi.Input[str] kms_key_version_id: The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation.
        ...
        :param pulumi.Input['DatabaseDbSystemMaintenanceWindowArgs'] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input['DatabaseDbSystemMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        ...
        if hostname is not None:
            pulumi.set(__self__, "hostname", hostname)
        if iorm_config_cache is not None:
            pulumi.set(__self__, "iorm_config_cache", iorm_config_cache)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
        if kms_key_version_id is not None:
            pulumi.set(__self__, "kms_key_version_id", kms_key_version_id)
    ...
    @property
    @pulumi.getter(name="dbHome")
    def db_home(self) -> Optional[pulumi.Input['DatabaseDbSystemDbHomeArgs']]:
        """
        (Updatable) Details for creating a Database Home if you are creating a database by restoring from a database backup.
        """
        return pulumi.get(self, "db_home")
    ...
    @db_home.setter
    def db_home(self, value: Optional[pulumi.Input['DatabaseDbSystemDbHomeArgs']]):
        pulumi.set(self, "db_home", value)
    ...
    @property
    @pulumi.getter(name="iormConfigCache")
    def iorm_config_cache(self) -> Optional[pulumi.Input['DatabaseDbSystemIormConfigCacheArgs']]:
        """
        The IORM settings of the Exadata DB system.
        """
        return pulumi.get(self, "iorm_config_cache")

    @iorm_config_cache.setter
    def iorm_config_cache(self, value: Optional[pulumi.Input['DatabaseDbSystemIormConfigCacheArgs']]):
        pulumi.set(self, "iorm_config_cache", value)
    ...
    def maintenance_window(self) -> Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: Optional[pulumi.Input['DatabaseDbSystemMaintenanceWindowArgs']]):
...
class DatabaseDbSystem(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 data_storage_size_in_gb: Optional[pulumi.Input[int]] = None,
                 database_edition: Optional[pulumi.Input[str]] = None,
                 db_home: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemDbHomeArgs']]] = None,
                 db_system_options: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemDbSystemOptionsArgs']]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 disk_redundancy: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 domain: Optional[pulumi.Input[str]] = None,
                 ...
                 kms_key_version_id: Optional[pulumi.Input[str]] = None,
                 license_model: Optional[pulumi.Input[str]] = None,
                 maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowDetailsArgs']]] = None,
                 node_count: Optional[pulumi.Input[int]] = None,
                 nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 private_ip: Optional[pulumi.Input[str]] = None,
                 shape: Optional[pulumi.Input[str]] = None,
        ...
        **Note:** Deprecated for Exadata Cloud Service systems. Use the [new resource model APIs](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model) instead.
        ...
        :param pulumi.Input[int] data_storage_size_in_gb: (Updatable) Size (in GB) of the initial data volume that will be created and attached to a virtual machine DB system. You can scale up storage after provisioning, as needed. Note that the total storage size attached will be more than the amount you specify to allow for REDO/RECO space and software volume. Required for VMDBs.
        :param pulumi.Input[str] database_edition: The Oracle Database Edition that applies to all the databases on the DB system. Exadata DB systems and 2-node RAC DB systems require ENTERPRISE_EDITION_EXTREME_PERFORMANCE.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemDbHomeArgs']] db_home: (Updatable) Details for creating a Database Home if you are creating a database by restoring from a database backup.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemDbSystemOptionsArgs']] db_system_options: The DB system options.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] disk_redundancy: The type of redundancy configured for the DB system. Normal is 2-way redundancy, recommended for test and development systems. High is 3-way redundancy, recommended for production systems.
        :param pulumi.Input[str] display_name: The user-friendly name for the DB system. The name does not have to be unique.
        :param pulumi.Input[str] domain: A domain name used for the DB system. If the Oracle-provided Internet and VCN Resolver is enabled for the specified subnet, the domain name for the subnet is used (do not provide one). Otherwise, provide a valid DNS domain name. Hyphens (-) are not permitted.
        ...
        :param pulumi.Input[str] kms_key_version_id: The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation.
        :param pulumi.Input[str] license_model: (Updatable) The Oracle license model that applies to all the databases on the DB system. The default is LICENSE_INCLUDED.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[int] node_count: The number of nodes to launch for a 2-node RAC virtual machine DB system. Specify either 1 or 2.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nsg_ids: (Updatable) A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that this resource belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * Autonomous Databases with private access require at least 1 Network Security Group (NSG). The nsgIds array cannot be empty.
        :param pulumi.Input[str] private_ip: A private IP address of your choice. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. Supported for VM BM shape.
    ...
    def __init__(__self__,
        ...
        **Note:** Deprecated for Exadata Cloud Service systems. Use the [new resource model APIs](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model) instead.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseDbSystemArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseDbSystemArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseDbSystemArgs.__new__(DatabaseDbSystemArgs)
            ...
            __props__.__dict__["iorm_config_cache"] = None
        ...
        super(DatabaseDbSystem, __self__).__init__(
            'oci:index/databaseDbSystem:DatabaseDbSystem',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            hostname: Optional[pulumi.Input[str]] = None,
            iorm_config_cache: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemIormConfigCacheArgs']]] = None,
            kms_key_id: Optional[pulumi.Input[str]] = None,
            kms_key_version_id: Optional[pulumi.Input[str]] = None,
            last_maintenance_run_id: Optional[pulumi.Input[str]] = None,
            last_patch_history_entry_id: Optional[pulumi.Input[str]] = None,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            listener_port: Optional[pulumi.Input[int]] = None,
            maintenance_window: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowArgs']]] = None,
            maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowDetailsArgs']]] = None,
            next_maintenance_run_id: Optional[pulumi.Input[str]] = None,
            node_count: Optional[pulumi.Input[int]] = None,
            nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ...
            version: Optional[pulumi.Input[str]] = None,
            vip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseDbSystem':
        """
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] hostname: The hostname for the DB system. The hostname must begin with an alphabetic character, and can contain alphanumeric characters and hyphens (-). The maximum length of the hostname is 16 characters for bare metal and virtual machine DB systems, and 12 characters for Exadata DB systems.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemIormConfigCacheArgs']] iorm_config_cache: The IORM settings of the Exadata DB system.
        :param pulumi.Input[str] kms_key_id: The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.
        :param pulumi.Input[str] kms_key_version_id: The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation.
        :param pulumi.Input[str] last_maintenance_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance run.
        :param pulumi.Input[str] last_patch_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last patch history. This value is updated as soon as a patch operation starts.
        ...
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[int] listener_port: The port number configured for the listener on the DB system.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowArgs']] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[pulumi.InputType['DatabaseDbSystemMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[str] next_maintenance_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next maintenance run.
        :param pulumi.Input[int] node_count: The number of nodes to launch for a 2-node RAC virtual machine DB system. Specify either 1 or 2.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nsg_ids: (Updatable) A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that this resource belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
        ...
        __props__ = _DatabaseDbSystemState.__new__(_DatabaseDbSystemState)
        ...
        __props__.__dict__["freeform_tags"] = freeform_tags
        __props__.__dict__["hostname"] = hostname
        __props__.__dict__["iorm_config_cache"] = iorm_config_cache
        __props__.__dict__["kms_key_id"] = kms_key_id
        __props__.__dict__["kms_key_version_id"] = kms_key_version_id
        ...
        return DatabaseDbSystem(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dbHome")
    def db_home(self) -> pulumi.Output['outputs.DatabaseDbSystemDbHome']:
        """
        (Updatable) Details for creating a Database Home if you are creating a database by restoring from a database backup.
        """
        return pulumi.get(self, "db_home")
    ...
    @property
    @pulumi.getter(name="dbSystemOptions")
    def db_system_options(self) -> pulumi.Output['outputs.DatabaseDbSystemDbSystemOptions']:
        """
        The DB system options.
        """
        return pulumi.get(self, "db_system_options")
    ...
    @property
    @pulumi.getter(name="iormConfigCache")
    def iorm_config_cache(self) -> pulumi.Output['outputs.DatabaseDbSystemIormConfigCache']:
        """
        The IORM settings of the Exadata DB system.
        """
        return pulumi.get(self, "iorm_config_cache")
    ...
    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output['outputs.DatabaseDbSystemMaintenanceWindow']:
        """
        The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window")
    ...
    @property
    @pulumi.getter(name="maintenanceWindowDetails")
    def maintenance_window_details(self) -> pulumi.Output[Optional['outputs.DatabaseDbSystemMaintenanceWindowDetails']]:
        """
        (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window_details")
