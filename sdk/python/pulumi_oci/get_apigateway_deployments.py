...
__all__ = [
    'GetApigatewayDeploymentsResult',
    'AwaitableGetApigatewayDeploymentsResult',
    'get_apigateway_deployments',
]

@pulumi.output_type
class GetApigatewayDeploymentsResult:
    """
    ...
    def deployment_collections(self) -> Sequence['outputs.GetApigatewayDeploymentsDeploymentCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetApigatewayDeploymentsFilterResult']]:
...
class AwaitableGetApigatewayDeploymentsResult(GetApigatewayDeploymentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayDeploymentsResult(
...
def get_apigateway_deployments(compartment_id: Optional[str] = None,
                               display_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetApigatewayDeploymentsFilterArgs']]] = None,
                               gateway_id: Optional[str] = None,
                               state: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayDeploymentsResult:
    """
    ...
    test_deployments = oci.get_apigateway_deployments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayDeployments:GetApigatewayDeployments', __args__, opts=opts, typ=GetApigatewayDeploymentsResult).value

    return AwaitableGetApigatewayDeploymentsResult(
