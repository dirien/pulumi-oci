...
__all__ = ['CoreNetworkSecurityGroupSecurityRuleArgs', 'CoreNetworkSecurityGroupSecurityRule']

@pulumi.input_type
class CoreNetworkSecurityGroupSecurityRuleArgs:
    def __init__(__self__, *,
                 ...
                 icmp_options: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs']] = None,
                 source: Optional[pulumi.Input[str]] = None,
                 source_type: Optional[pulumi.Input[str]] = None,
                 stateless: Optional[pulumi.Input[bool]] = None,
                 tcp_options: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']] = None,
                 udp_options: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']] = None):
        """
        ...
        :param pulumi.Input['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs'] icmp_options: Optional and valid only for ICMP and ICMPv6. Use to specify a particular ICMP type and code as defined in:
        ...
        :param pulumi.Input['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs'] tcp_options: Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If you specify TCP as the protocol but omit this object, then all destination ports are allowed.
        :param pulumi.Input['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs'] udp_options: Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        """
    ...
    def icmp_options(self) -> Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs']]:
        """
    ...
    @icmp_options.setter
    def icmp_options(self, value: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs']]):
    ...
    def tcp_options(self) -> Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']]:
        """
    ...
    @tcp_options.setter
    def tcp_options(self, value: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']]):
        pulumi.set(self, "tcp_options", value)

    @property
    @pulumi.getter(name="udpOptions")
    def udp_options(self) -> Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']]:
        """
    ...
    @udp_options.setter
    def udp_options(self, value: Optional[pulumi.Input['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']]):
        pulumi.set(self, "udp_options", value)


@pulumi.input_type
class _CoreNetworkSecurityGroupSecurityRuleState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 destination: Optional[pulumi.Input[str]] = None,
                 destination_type: Optional[pulumi.Input[str]] = None,
...
class CoreNetworkSecurityGroupSecurityRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 destination_type: Optional[pulumi.Input[str]] = None,
                 direction: Optional[pulumi.Input[str]] = None,
                 icmp_options: Optional[pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs']]] = None,
                 network_security_group_id: Optional[pulumi.Input[str]] = None,
                 protocol: Optional[pulumi.Input[str]] = None,
                 source: Optional[pulumi.Input[str]] = None,
                 source_type: Optional[pulumi.Input[str]] = None,
                 stateless: Optional[pulumi.Input[bool]] = None,
                 tcp_options: Optional[pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']]] = None,
                 udp_options: Optional[pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']]] = None,
                 __props__=None):
        """
        ...
        test_network_security_group_security_rule = oci.CoreNetworkSecurityGroupSecurityRule("testNetworkSecurityGroupSecurityRule",
            ...
            icmp_options=oci.CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs(
            ...
            tcp_options=oci.CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs(
                destination_port_range=oci.CoreNetworkSecurityGroupSecurityRuleTcpOptionsDestinationPortRangeArgs(
                ...
                source_port_range=oci.CoreNetworkSecurityGroupSecurityRuleTcpOptionsSourcePortRangeArgs(
            ...
            udp_options=oci.CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs(
                destination_port_range=oci.CoreNetworkSecurityGroupSecurityRuleUdpOptionsDestinationPortRangeArgs(
                ...
                source_port_range=oci.CoreNetworkSecurityGroupSecurityRuleUdpOptionsSourcePortRangeArgs(
        ...
        :param pulumi.Input[str] destination_type: Type of destination for the rule. Required if `direction` = `EGRESS`.
        :param pulumi.Input[str] direction: Direction of the security rule. Set to `EGRESS` for rules to allow outbound IP packets, or `INGRESS` for rules to allow inbound IP packets.
        :param pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleIcmpOptionsArgs']] icmp_options: Optional and valid only for ICMP and ICMPv6. Use to specify a particular ICMP type and code as defined in:
               * [ICMP Parameters](http://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml)
               * [ICMPv6 Parameters](https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml)
        :param pulumi.Input[str] network_security_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security group.
        :param pulumi.Input[str] protocol: The transport protocol. Specify either `all` or an IPv4 protocol number as defined in [Protocol Numbers](http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml). Options are supported only for ICMP ("1"), TCP ("6"), UDP ("17"), and ICMPv6 ("58").
        ...
        :param pulumi.Input[str] source_type: Type of source for the rule. Required if `direction` = `INGRESS`.
               ...
               * `NETWORK_SECURITY_GROUP`: If the rule's `source` is the OCID of a [NetworkSecurityGroup](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/NetworkSecurityGroup/).
        :param pulumi.Input[bool] stateless: A stateless rule allows traffic in one direction. Remember to add a corresponding stateless rule in the other direction if you need to support bidirectional traffic. For example, if egress traffic allows TCP destination port 80, there should be an ingress rule to allow TCP source port 80. Defaults to false, which means the rule is stateful and a corresponding rule is not necessary for bidirectional traffic.
        :param pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']] tcp_options: Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If you specify TCP as the protocol but omit this object, then all destination ports are allowed.
        :param pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']] udp_options: Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: CoreNetworkSecurityGroupSecurityRuleArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Network Security Group Security Rule resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreNetworkSecurityGroupSecurityRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreNetworkSecurityGroupSecurityRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreNetworkSecurityGroupSecurityRuleArgs.__new__(CoreNetworkSecurityGroupSecurityRuleArgs)
        ...
        super(CoreNetworkSecurityGroupSecurityRule, __self__).__init__(
            'oci:index/coreNetworkSecurityGroupSecurityRule:CoreNetworkSecurityGroupSecurityRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tcp_options: Optional[pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleTcpOptionsArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            udp_options: Optional[pulumi.Input[pulumi.InputType['CoreNetworkSecurityGroupSecurityRuleUdpOptionsArgs']]] = None) -> 'CoreNetworkSecurityGroupSecurityRule':
        """
        ...
        __props__ = _CoreNetworkSecurityGroupSecurityRuleState.__new__(_CoreNetworkSecurityGroupSecurityRuleState)
        ...
        __props__.__dict__["udp_options"] = udp_options
        return CoreNetworkSecurityGroupSecurityRule(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="icmpOptions")
    def icmp_options(self) -> pulumi.Output[Optional['outputs.CoreNetworkSecurityGroupSecurityRuleIcmpOptions']]:
        """
        Optional and valid only for ICMP and ICMPv6. Use to specify a particular ICMP type and code as defined in:
        * [ICMP Parameters](http://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml)
        * [ICMPv6 Parameters](https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml)
    ...
    @property
    @pulumi.getter(name="tcpOptions")
    def tcp_options(self) -> pulumi.Output[Optional['outputs.CoreNetworkSecurityGroupSecurityRuleTcpOptions']]:
        """
        Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If you specify TCP as the protocol but omit this object, then all destination ports are allowed.
        """
        return pulumi.get(self, "tcp_options")
    ...
    @property
    @pulumi.getter(name="udpOptions")
    def udp_options(self) -> pulumi.Output[Optional['outputs.CoreNetworkSecurityGroupSecurityRuleUdpOptions']]:
        """
        Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        """
        return pulumi.get(self, "udp_options")
