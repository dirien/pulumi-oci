...
class GetKmsVaultResult:
    ...
    def __init__(__self__, compartment_id=None, crypto_endpoint=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_primary=None, management_endpoint=None, replica_details=None, restore_from_file=None, restore_from_object_store=None, restore_trigger=None, restored_from_vault_id=None, state=None, time_created=None, time_of_deletion=None, vault_id=None, vault_type=None):
        ...
        if replica_details and not isinstance(replica_details, dict):
            raise TypeError("Expected argument 'replica_details' to be a dict")
        pulumi.set(__self__, "replica_details", replica_details)
        if restore_from_file and not isinstance(restore_from_file, dict):
            raise TypeError("Expected argument 'restore_from_file' to be a dict")
        pulumi.set(__self__, "restore_from_file", restore_from_file)
        if restore_from_object_store and not isinstance(restore_from_object_store, dict):
            raise TypeError("Expected argument 'restore_from_object_store' to be a dict")
    ...
    def replica_details(self) -> 'outputs.GetKmsVaultReplicaDetailsResult':
        """
    ...
    def restore_from_file(self) -> 'outputs.GetKmsVaultRestoreFromFileResult':
        """
    ...
    def restore_from_object_store(self) -> 'outputs.GetKmsVaultRestoreFromObjectStoreResult':
        """
        Details where vault was backed up
        """
...
class AwaitableGetKmsVaultResult(GetKmsVaultResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsVaultResult(
            ...
            restore_from_file=self.restore_from_file,
            restore_from_object_store=self.restore_from_object_store,
...
def get_kms_vault(vault_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsVaultResult:
    """
    ...
    test_vault = oci.get_kms_vault(vault_id=oci_kms_vault["test_vault"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsVault:GetKmsVault', __args__, opts=opts, typ=GetKmsVaultResult).value

    return AwaitableGetKmsVaultResult(
