...
__all__ = [
    'GetCloudGuardResponderRecipeResult',
    'AwaitableGetCloudGuardResponderRecipeResult',
    'get_cloud_guard_responder_recipe',
]

@pulumi.output_type
class GetCloudGuardResponderRecipeResult:
    """
    ...
    def effective_responder_rules(self) -> Sequence['outputs.GetCloudGuardResponderRecipeEffectiveResponderRuleResult']:
        """
    ...
    def responder_rules(self) -> Sequence['outputs.GetCloudGuardResponderRecipeResponderRuleResult']:
        """
        List of responder rules associated with the recipe
        """
...
class AwaitableGetCloudGuardResponderRecipeResult(GetCloudGuardResponderRecipeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardResponderRecipeResult(
...
def get_cloud_guard_responder_recipe(responder_recipe_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardResponderRecipeResult:
    """
    ...
    test_responder_recipe = oci.get_cloud_guard_responder_recipe(responder_recipe_id=oci_cloud_guard_responder_recipe["test_responder_recipe"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardResponderRecipe:GetCloudGuardResponderRecipe', __args__, opts=opts, typ=GetCloudGuardResponderRecipeResult).value

    return AwaitableGetCloudGuardResponderRecipeResult(
