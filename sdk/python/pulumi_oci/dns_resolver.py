...
class DnsResolverArgs:
    def __init__(__self__, *,
                 ...
                 attached_views: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverAttachedViewArgs']]]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverRuleArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsResolverAttachedViewArgs']]] attached_views: (Updatable) The attached views. Views are evaluated in order.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsResolverRuleArgs']]] rules: (Updatable) Rules for the resolver. Rules are evaluated in order.
        """
    ...
    def attached_views(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverAttachedViewArgs']]]]:
        """
    ...
    def attached_views(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverAttachedViewArgs']]]]):
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverRuleArgs']]]]:
        """
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverRuleArgs']]]]):
        pulumi.set(self, "rules", value)


@pulumi.input_type
class _DnsResolverState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 endpoints: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverEndpointArgs']]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) The display name of the resolver.
        :param pulumi.Input[Sequence[pulumi.Input['DnsResolverEndpointArgs']]] endpoints: Read-only array of endpoints for the resolver.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverEndpointArgs']]]]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsResolverEndpointArgs']]]]):
...
class DnsResolver(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attached_views: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverAttachedViewArgs']]]]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 resolver_id: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverRuleArgs']]]]] = None,
                 scope: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverAttachedViewArgs']]]] attached_views: (Updatable) The attached views. Views are evaluated in order.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the owning compartment.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) The display name of the resolver.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] resolver_id: The OCID of the target resolver.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverRuleArgs']]]] rules: (Updatable) Rules for the resolver. Rules are evaluated in order.
        :param pulumi.Input[str] scope: Value must be `PRIVATE` when creating private name resolvers.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        super(DnsResolver, __self__).__init__(
            'oci:index/dnsResolver:DnsResolver',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverEndpointArgs']]]]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            is_protected: Optional[pulumi.Input[bool]] = None,
            resolver_id: Optional[pulumi.Input[str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverRuleArgs']]]]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'DnsResolver':
        """
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) The display name of the resolver.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverEndpointArgs']]]] endpoints: Read-only array of endpoints for the resolver.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[bool] is_protected: A Boolean flag indicating whether or not parts of the resource are unable to be explicitly managed.
        :param pulumi.Input[str] resolver_id: The OCID of the target resolver.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsResolverRuleArgs']]]] rules: (Updatable) Rules for the resolver. Rules are evaluated in order.
        ...
        __props__ = _DnsResolverState.__new__(_DnsResolverState)
    ...
    @property
    @pulumi.getter(name="attachedViews")
    def attached_views(self) -> pulumi.Output[Optional[Sequence['outputs.DnsResolverAttachedView']]]:
        """
        (Updatable) The attached views. Views are evaluated in order.
        """
        return pulumi.get(self, "attached_views")
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> pulumi.Output[Sequence['outputs.DnsResolverEndpoint']]:
        """
        Read-only array of endpoints for the resolver.
        """
        return pulumi.get(self, "endpoints")
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Optional[Sequence['outputs.DnsResolverRule']]]:
        """
        (Updatable) Rules for the resolver. Rules are evaluated in order.
        """
        return pulumi.get(self, "rules")
