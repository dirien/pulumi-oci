...
__all__ = [
    'GetCoreDrgRouteTableRouteRulesResult',
    'AwaitableGetCoreDrgRouteTableRouteRulesResult',
    'get_core_drg_route_table_route_rules',
]

@pulumi.output_type
class GetCoreDrgRouteTableRouteRulesResult:
    """
    ...
    def drg_route_rules(self) -> Sequence['outputs.GetCoreDrgRouteTableRouteRulesDrgRouteRuleResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDrgRouteTableRouteRulesFilterResult']]:
...
class AwaitableGetCoreDrgRouteTableRouteRulesResult(GetCoreDrgRouteTableRouteRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDrgRouteTableRouteRulesResult(
...
def get_core_drg_route_table_route_rules(drg_route_table_id: Optional[str] = None,
                                         filters: Optional[Sequence[pulumi.InputType['GetCoreDrgRouteTableRouteRulesFilterArgs']]] = None,
                                         route_type: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDrgRouteTableRouteRulesResult:
    """
    ...
    test_drg_route_table_route_rules = oci.get_core_drg_route_table_route_rules(drg_route_table_id=oci_core_drg_route_table["test_drg_route_table"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDrgRouteTableRouteRules:GetCoreDrgRouteTableRouteRules', __args__, opts=opts, typ=GetCoreDrgRouteTableRouteRulesResult).value

    return AwaitableGetCoreDrgRouteTableRouteRulesResult(
