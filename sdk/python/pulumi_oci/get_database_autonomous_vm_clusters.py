...
__all__ = [
    'GetDatabaseAutonomousVmClustersResult',
    'AwaitableGetDatabaseAutonomousVmClustersResult',
    'get_database_autonomous_vm_clusters',
]

@pulumi.output_type
class GetDatabaseAutonomousVmClustersResult:
    """
    ...
    def autonomous_vm_clusters(self) -> Sequence['outputs.GetDatabaseAutonomousVmClustersAutonomousVmClusterResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseAutonomousVmClustersFilterResult']]:
...
class AwaitableGetDatabaseAutonomousVmClustersResult(GetDatabaseAutonomousVmClustersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousVmClustersResult(
...
def get_database_autonomous_vm_clusters(compartment_id: Optional[str] = None,
                                        display_name: Optional[str] = None,
                                        exadata_infrastructure_id: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDatabaseAutonomousVmClustersFilterArgs']]] = None,
                                        state: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousVmClustersResult:
    """
    ...
    test_autonomous_vm_clusters = oci.get_database_autonomous_vm_clusters(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousVmClusters:GetDatabaseAutonomousVmClusters', __args__, opts=opts, typ=GetDatabaseAutonomousVmClustersResult).value

    return AwaitableGetDatabaseAutonomousVmClustersResult(
