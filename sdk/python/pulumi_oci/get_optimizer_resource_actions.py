...
__all__ = [
    'GetOptimizerResourceActionsResult',
    'AwaitableGetOptimizerResourceActionsResult',
    'get_optimizer_resource_actions',
]

@pulumi.output_type
class GetOptimizerResourceActionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOptimizerResourceActionsFilterResult']]:
    ...
    def resource_action_collections(self) -> Sequence['outputs.GetOptimizerResourceActionsResourceActionCollectionResult']:
        """
...
class AwaitableGetOptimizerResourceActionsResult(GetOptimizerResourceActionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerResourceActionsResult(
...
def get_optimizer_resource_actions(compartment_id: Optional[str] = None,
                                   compartment_id_in_subtree: Optional[bool] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetOptimizerResourceActionsFilterArgs']]] = None,
                                   name: Optional[str] = None,
                                   recommendation_id: Optional[str] = None,
                                   resource_type: Optional[str] = None,
                                   state: Optional[str] = None,
                                   status: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerResourceActionsResult:
    """
    ...
    test_resource_actions = oci.get_optimizer_resource_actions(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerResourceActions:GetOptimizerResourceActions', __args__, opts=opts, typ=GetOptimizerResourceActionsResult).value

    return AwaitableGetOptimizerResourceActionsResult(
