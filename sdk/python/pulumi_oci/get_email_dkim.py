...
__all__ = [
    'GetEmailDkimResult',
    'AwaitableGetEmailDkimResult',
    'get_email_dkim',
]

@pulumi.output_type
class GetEmailDkimResult:
    """
...
class AwaitableGetEmailDkimResult(GetEmailDkimResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailDkimResult(
...
def get_email_dkim(dkim_id: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailDkimResult:
    """
    ...
    test_dkim = oci.get_email_dkim(dkim_id=oci_email_dkim["test_dkim"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailDkim:GetEmailDkim', __args__, opts=opts, typ=GetEmailDkimResult).value

    return AwaitableGetEmailDkimResult(
