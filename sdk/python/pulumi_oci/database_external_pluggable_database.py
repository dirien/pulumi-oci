...
__all__ = ['DatabaseExternalPluggableDatabaseArgs', 'DatabaseExternalPluggableDatabase']

@pulumi.input_type
class DatabaseExternalPluggableDatabaseArgs:
...
@pulumi.input_type
class _DatabaseExternalPluggableDatabaseState:
    def __init__(__self__, *,
                 ...
                 database_management_config: Optional[pulumi.Input['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs']] = None,
                 ...
                 operations_insights_config: Optional[pulumi.Input['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs']] = None,
                 source_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs'] database_management_config: The configuration of the Database Management service.
        ...
        :param pulumi.Input['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs'] operations_insights_config: The configuration of Operations Insights for the external database
        :param pulumi.Input[str] source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the the non-container database that was converted to a pluggable database to create this resource.
    ...
    def database_management_config(self) -> Optional[pulumi.Input['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs']]:
        """
    ...
    def database_management_config(self, value: Optional[pulumi.Input['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs']]):
    ...
    def operations_insights_config(self) -> Optional[pulumi.Input['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs']]:
        """
    ...
    def operations_insights_config(self, value: Optional[pulumi.Input['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs']]):
...
class DatabaseExternalPluggableDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_external_pluggable_database = oci.DatabaseExternalPluggableDatabase("testExternalPluggableDatabase",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseExternalPluggableDatabaseArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the External Pluggable Database resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseExternalPluggableDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseExternalPluggableDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseExternalPluggableDatabaseArgs.__new__(DatabaseExternalPluggableDatabaseArgs)
        ...
        super(DatabaseExternalPluggableDatabase, __self__).__init__(
            'oci:index/databaseExternalPluggableDatabase:DatabaseExternalPluggableDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            database_configuration: Optional[pulumi.Input[str]] = None,
            database_edition: Optional[pulumi.Input[str]] = None,
            database_management_config: Optional[pulumi.Input[pulumi.InputType['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs']]] = None,
            database_version: Optional[pulumi.Input[str]] = None,
            db_id: Optional[pulumi.Input[str]] = None,
            db_packs: Optional[pulumi.Input[str]] = None,
            db_unique_name: Optional[pulumi.Input[str]] = None,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            ncharacter_set: Optional[pulumi.Input[str]] = None,
            operations_insights_config: Optional[pulumi.Input[pulumi.InputType['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs']]] = None,
            source_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_zone: Optional[pulumi.Input[str]] = None) -> 'DatabaseExternalPluggableDatabase':
        """
        ...
        :param pulumi.Input[str] database_configuration: The Oracle Database configuration
        :param pulumi.Input[str] database_edition: The Oracle Database edition.
        :param pulumi.Input[pulumi.InputType['DatabaseExternalPluggableDatabaseDatabaseManagementConfigArgs']] database_management_config: The configuration of the Database Management service.
        :param pulumi.Input[str] database_version: The Oracle Database version.
        :param pulumi.Input[str] db_id: The Oracle Database ID, which identifies an Oracle Database located outside of Oracle Cloud.
        :param pulumi.Input[str] db_packs: The database packs licensed for the external Oracle Database.
        :param pulumi.Input[str] db_unique_name: The `DB_UNIQUE_NAME` of the external database.
        ...
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[str] ncharacter_set: The national character of the external database.
        :param pulumi.Input[pulumi.InputType['DatabaseExternalPluggableDatabaseOperationsInsightsConfigArgs']] operations_insights_config: The configuration of Operations Insights for the external database
        :param pulumi.Input[str] source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the the non-container database that was converted to a pluggable database to create this resource.
        :param pulumi.Input[str] state: The current state of the Oracle Cloud Infrastructure external database resource.
        :param pulumi.Input[str] time_created: The date and time the database was created.
        :param pulumi.Input[str] time_zone: The time zone of the external database. It is a time zone offset (a character type in the format '[+|-]TZH:TZM') or a time zone region name, depending on how the time zone value was specified when the database was created / last altered.
        ...
        __props__ = _DatabaseExternalPluggableDatabaseState.__new__(_DatabaseExternalPluggableDatabaseState)
        ...
        return DatabaseExternalPluggableDatabase(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="databaseManagementConfig")
    def database_management_config(self) -> pulumi.Output['outputs.DatabaseExternalPluggableDatabaseDatabaseManagementConfig']:
        """
        The configuration of the Database Management service.
        """
        return pulumi.get(self, "database_management_config")
    ...
    @property
    @pulumi.getter(name="operationsInsightsConfig")
    def operations_insights_config(self) -> pulumi.Output['outputs.DatabaseExternalPluggableDatabaseOperationsInsightsConfig']:
        """
        The configuration of Operations Insights for the external database
        """
        return pulumi.get(self, "operations_insights_config")
