...
class DnsZoneArgs:
    def __init__(__self__, *,
                 ...
                 external_masters: Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneExternalMasterArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsZoneExternalMasterArgs']]] external_masters: (Updatable) External master servers for the zone. `externalMasters` becomes a required parameter when the `zoneType` value is `SECONDARY`.
    ...
    def external_masters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneExternalMasterArgs']]]]:
        """
    ...
    def external_masters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneExternalMasterArgs']]]]):
...
class _DnsZoneState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 nameservers: Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneNameserverArgs']]]] = None,
                 scope: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] name: The name of the zone.
        :param pulumi.Input[Sequence[pulumi.Input['DnsZoneNameserverArgs']]] nameservers: The authoritative nameservers for the zone.
        :param pulumi.Input[str] scope: Specifies to operate only on resources that have a matching DNS scope. 
               This value will be null for zones in the global DNS and `PRIVATE` when creating a private zone.
    ...
    @property
    @pulumi.getter
    def nameservers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneNameserverArgs']]]]:
        """
    ...
    @nameservers.setter
    def nameservers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsZoneNameserverArgs']]]]):
...
class DnsZone(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 external_masters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsZoneExternalMasterArgs']]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 scope: Optional[pulumi.Input[str]] = None,
                 view_id: Optional[pulumi.Input[str]] = None,
        ...
        test_zone = oci.DnsZone("testZone",
            compartment_id=var["compartment_id"],
            zone_type=var["zone_zone_type"],
            defined_tags=var["zone_defined_tags"],
            external_masters=[oci.DnsZoneExternalMasterArgs(
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment the resource belongs to.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsZoneExternalMasterArgs']]]] external_masters: (Updatable) External master servers for the zone. `externalMasters` becomes a required parameter when the `zoneType` value is `SECONDARY`.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] name: The name of the zone.
        :param pulumi.Input[str] scope: Specifies to operate only on resources that have a matching DNS scope. 
               This value will be null for zones in the global DNS and `PRIVATE` when creating a private zone.
    ...
    def get(resource_name: str,
            ...
            is_protected: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            nameservers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsZoneNameserverArgs']]]]] = None,
            scope: Optional[pulumi.Input[str]] = None,
            self: Optional[pulumi.Input[str]] = None,
            serial: Optional[pulumi.Input[int]] = None,
            state: Optional[pulumi.Input[str]] = None,
            ...
            version: Optional[pulumi.Input[str]] = None,
            view_id: Optional[pulumi.Input[str]] = None,
            zone_type: Optional[pulumi.Input[str]] = None) -> 'DnsZone':
        """
        ...
        :param pulumi.Input[bool] is_protected: A Boolean flag indicating whether or not parts of the resource are unable to be explicitly managed.
        :param pulumi.Input[str] name: The name of the zone.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsZoneNameserverArgs']]]] nameservers: The authoritative nameservers for the zone.
        :param pulumi.Input[str] scope: Specifies to operate only on resources that have a matching DNS scope. 
               This value will be null for zones in the global DNS and `PRIVATE` when creating a private zone.
        :param pulumi.Input[str] self: The canonical absolute URL of the resource.
        :param pulumi.Input[int] serial: The current serial of the zone. As seen in the zone's SOA record.
    ...
    @property
    @pulumi.getter(name="externalMasters")
    def external_masters(self) -> pulumi.Output[Sequence['outputs.DnsZoneExternalMaster']]:
        """
        (Updatable) External master servers for the zone. `externalMasters` becomes a required parameter when the `zoneType` value is `SECONDARY`.
        """
        return pulumi.get(self, "external_masters")
    ...
    @property
    @pulumi.getter
    def nameservers(self) -> pulumi.Output[Sequence['outputs.DnsZoneNameserver']]:
        """
        The authoritative nameservers for the zone.
        """
        return pulumi.get(self, "nameservers")
