...
__all__ = [
    'GetCoreInstancesResult',
    'AwaitableGetCoreInstancesResult',
    'get_core_instances',
]

@pulumi.output_type
class GetCoreInstancesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreInstancesFilterResult']]:
    ...
    @property
    @pulumi.getter
    def instances(self) -> Sequence['outputs.GetCoreInstancesInstanceResult']:
        """
...
class AwaitableGetCoreInstancesResult(GetCoreInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstancesResult(
...
def get_core_instances(availability_domain: Optional[str] = None,
                       capacity_reservation_id: Optional[str] = None,
                       compartment_id: Optional[str] = None,
                       display_name: Optional[str] = None,
                       filters: Optional[Sequence[pulumi.InputType['GetCoreInstancesFilterArgs']]] = None,
                       state: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstancesResult:
    """
    ...
    test_instances = oci.get_core_instances(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstances:GetCoreInstances', __args__, opts=opts, typ=GetCoreInstancesResult).value

    return AwaitableGetCoreInstancesResult(
