...
__all__ = [
    'GetCoreComputeGlobalImageCapabilitySchemaResult',
    'AwaitableGetCoreComputeGlobalImageCapabilitySchemaResult',
    'get_core_compute_global_image_capability_schema',
]

@pulumi.output_type
class GetCoreComputeGlobalImageCapabilitySchemaResult:
    """
...
class AwaitableGetCoreComputeGlobalImageCapabilitySchemaResult(GetCoreComputeGlobalImageCapabilitySchemaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeGlobalImageCapabilitySchemaResult(
...
def get_core_compute_global_image_capability_schema(compute_global_image_capability_schema_id: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeGlobalImageCapabilitySchemaResult:
    """
    ...
    test_compute_global_image_capability_schema = oci.get_core_compute_global_image_capability_schema(compute_global_image_capability_schema_id=oci_core_compute_global_image_capability_schema["test_compute_global_image_capability_schema"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeGlobalImageCapabilitySchema:GetCoreComputeGlobalImageCapabilitySchema', __args__, opts=opts, typ=GetCoreComputeGlobalImageCapabilitySchemaResult).value

    return AwaitableGetCoreComputeGlobalImageCapabilitySchemaResult(
