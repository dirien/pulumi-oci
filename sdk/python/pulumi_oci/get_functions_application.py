...
__all__ = [
    'GetFunctionsApplicationResult',
    'AwaitableGetFunctionsApplicationResult',
    'get_functions_application',
]

@pulumi.output_type
class GetFunctionsApplicationResult:
    """
    A collection of values returned by GetFunctionsApplication.
    """
    def __init__(__self__, application_id=None, compartment_id=None, config=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, state=None, subnet_ids=None, syslog_url=None, time_created=None, time_updated=None, trace_config=None):
        ...
        if trace_config and not isinstance(trace_config, dict):
            raise TypeError("Expected argument 'trace_config' to be a dict")
    ...
    def trace_config(self) -> 'outputs.GetFunctionsApplicationTraceConfigResult':
        """
...
class AwaitableGetFunctionsApplicationResult(GetFunctionsApplicationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFunctionsApplicationResult(
...
def get_functions_application(application_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionsApplicationResult:
    """
    ...
    test_application = oci.get_functions_application(application_id=oci_functions_application["test_application"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getFunctionsApplication:GetFunctionsApplication', __args__, opts=opts, typ=GetFunctionsApplicationResult).value

    return AwaitableGetFunctionsApplicationResult(
        ...
        trace_config=__ret__.trace_config)
