...
__all__ = [
    'GetCoreInstancePoolResult',
    'AwaitableGetCoreInstancePoolResult',
    'get_core_instance_pool',
]

@pulumi.output_type
class GetCoreInstancePoolResult:
    """
    ...
    def load_balancers(self) -> Sequence['outputs.GetCoreInstancePoolLoadBalancerResult']:
        """
    ...
    def placement_configurations(self) -> Sequence['outputs.GetCoreInstancePoolPlacementConfigurationResult']:
        """
...
class AwaitableGetCoreInstancePoolResult(GetCoreInstancePoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstancePoolResult(
...
def get_core_instance_pool(instance_pool_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstancePoolResult:
    """
    ...
    test_instance_pool = oci.get_core_instance_pool(instance_pool_id=oci_core_instance_pool["test_instance_pool"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstancePool:GetCoreInstancePool', __args__, opts=opts, typ=GetCoreInstancePoolResult).value

    return AwaitableGetCoreInstancePoolResult(
