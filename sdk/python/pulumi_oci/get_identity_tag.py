...
__all__ = [
    'GetIdentityTagResult',
    'AwaitableGetIdentityTagResult',
    'get_identity_tag',
]

@pulumi.output_type
class GetIdentityTagResult:
    """
    A collection of values returned by GetIdentityTag.
    """
    def __init__(__self__, defined_tags=None, description=None, freeform_tags=None, id=None, is_cost_tracking=None, is_retired=None, name=None, state=None, tag_name=None, tag_namespace_id=None, time_created=None, validator=None):
    ...
    @property
    @pulumi.getter
    def validator(self) -> 'outputs.GetIdentityTagValidatorResult':
        """
...
class AwaitableGetIdentityTagResult(GetIdentityTagResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityTagResult(
...
def get_identity_tag(tag_name: Optional[str] = None,
                     tag_namespace_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityTagResult:
    """
    ...
    test_tag = oci.get_identity_tag(tag_name=oci_identity_tag["test_tag"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityTag:GetIdentityTag', __args__, opts=opts, typ=GetIdentityTagResult).value

    return AwaitableGetIdentityTagResult(
