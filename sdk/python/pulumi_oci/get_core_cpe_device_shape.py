...
__all__ = [
    'GetCoreCpeDeviceShapeResult',
    'AwaitableGetCoreCpeDeviceShapeResult',
    'get_core_cpe_device_shape',
]

@pulumi.output_type
class GetCoreCpeDeviceShapeResult:
    """
    ...
    def cpe_device_infos(self) -> Sequence['outputs.GetCoreCpeDeviceShapeCpeDeviceInfoResult']:
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetCoreCpeDeviceShapeParameterResult']:
        """
...
class AwaitableGetCoreCpeDeviceShapeResult(GetCoreCpeDeviceShapeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreCpeDeviceShapeResult(
...
def get_core_cpe_device_shape(cpe_device_shape_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreCpeDeviceShapeResult:
    """
    ...
    test_cpe_device_shape = oci.get_core_cpe_device_shape(cpe_device_shape_id=oci_core_cpe_device_shape["test_cpe_device_shape"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreCpeDeviceShape:GetCoreCpeDeviceShape', __args__, opts=opts, typ=GetCoreCpeDeviceShapeResult).value

    return AwaitableGetCoreCpeDeviceShapeResult(
