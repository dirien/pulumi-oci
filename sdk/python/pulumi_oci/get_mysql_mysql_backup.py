...
__all__ = [
    'GetMysqlMysqlBackupResult',
    'AwaitableGetMysqlMysqlBackupResult',
    'get_mysql_mysql_backup',
]

@pulumi.output_type
class GetMysqlMysqlBackupResult:
    """
    A collection of values returned by GetMysqlMysqlBackup.
    """
    def __init__(__self__, backup_id=None, backup_size_in_gbs=None, backup_type=None, compartment_id=None, creation_type=None, data_storage_size_in_gb=None, db_system_id=None, db_system_snapshot=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, mysql_version=None, retention_in_days=None, shape_name=None, state=None, time_created=None, time_updated=None):
        ...
        if db_system_snapshot and not isinstance(db_system_snapshot, dict):
            raise TypeError("Expected argument 'db_system_snapshot' to be a dict")
    ...
    def db_system_snapshot(self) -> 'outputs.GetMysqlMysqlBackupDbSystemSnapshotResult':
        """
...
class AwaitableGetMysqlMysqlBackupResult(GetMysqlMysqlBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlMysqlBackupResult(
            ...
            db_system_snapshot=self.db_system_snapshot,
...
def get_mysql_mysql_backup(backup_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlMysqlBackupResult:
    """
    ...
    test_mysql_backup = oci.get_mysql_mysql_backup(backup_id=oci_mysql_mysql_backup["test_backup"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlMysqlBackup:GetMysqlMysqlBackup', __args__, opts=opts, typ=GetMysqlMysqlBackupResult).value

    return AwaitableGetMysqlMysqlBackupResult(
        ...
        db_system_snapshot=__ret__.db_system_snapshot,
