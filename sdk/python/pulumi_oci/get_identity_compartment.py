...
__all__ = [
    'GetIdentityCompartmentResult',
    'AwaitableGetIdentityCompartmentResult',
    'get_identity_compartment',
]

@pulumi.output_type
class GetIdentityCompartmentResult:
    """
...
class AwaitableGetIdentityCompartmentResult(GetIdentityCompartmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityCompartmentResult(
...
def get_identity_compartment(id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityCompartmentResult:
    """
    ...
    test_compartment = oci.get_identity_compartment(id=var["compartment_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityCompartment:GetIdentityCompartment', __args__, opts=opts, typ=GetIdentityCompartmentResult).value

    return AwaitableGetIdentityCompartmentResult(
