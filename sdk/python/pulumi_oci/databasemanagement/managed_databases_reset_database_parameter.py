...
class ManagedDatabasesResetDatabaseParameter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_managed_databases_reset_database_parameter = oci.databasemanagement.ManagedDatabasesResetDatabaseParameter("testManagedDatabasesResetDatabaseParameter",
            credentials=oci.databasemanagement.ManagedDatabasesResetDatabaseParameterCredentialsArgs(
