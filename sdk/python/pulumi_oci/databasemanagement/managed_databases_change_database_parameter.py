...
class ManagedDatabasesChangeDatabaseParameter(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Note:** If the instance is started using a text initialization
        ...
        test_managed_databases_change_database_parameter = oci.databasemanagement.ManagedDatabasesChangeDatabaseParameter("testManagedDatabasesChangeDatabaseParameter",
            credentials=oci.databasemanagement.ManagedDatabasesChangeDatabaseParameterCredentialsArgs(
            ...
            parameters=[oci.databasemanagement.ManagedDatabasesChangeDatabaseParameterParameterArgs(
