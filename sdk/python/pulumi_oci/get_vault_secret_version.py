...
__all__ = [
    'GetVaultSecretVersionResult',
    'AwaitableGetVaultSecretVersionResult',
    'get_vault_secret_version',
]

@pulumi.output_type
class GetVaultSecretVersionResult:
    """
...
class AwaitableGetVaultSecretVersionResult(GetVaultSecretVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVaultSecretVersionResult(
...
def get_vault_secret_version(secret_id: Optional[str] = None,
                             secret_version_number: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVaultSecretVersionResult:
    """
    ...
    test_secret_version = oci.get_vault_secret_version(secret_id=oci_vault_secret["test_secret"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getVaultSecretVersion:GetVaultSecretVersion', __args__, opts=opts, typ=GetVaultSecretVersionResult).value

    return AwaitableGetVaultSecretVersionResult(
