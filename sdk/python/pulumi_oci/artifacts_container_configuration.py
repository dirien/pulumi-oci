...
__all__ = ['ArtifactsContainerConfigurationArgs', 'ArtifactsContainerConfiguration']

@pulumi.input_type
class ArtifactsContainerConfigurationArgs:
...
@pulumi.input_type
class _ArtifactsContainerConfigurationState:
    def __init__(__self__, *,
...
class ArtifactsContainerConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_container_configuration = oci.ArtifactsContainerConfiguration("testContainerConfiguration")
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ArtifactsContainerConfigurationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Container Configuration resource in Oracle Cloud Infrastructure Artifacts service.
        ...
        :param str resource_name: The name of the resource.
        :param ArtifactsContainerConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ArtifactsContainerConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ArtifactsContainerConfigurationArgs.__new__(ArtifactsContainerConfigurationArgs)
        ...
        super(ArtifactsContainerConfiguration, __self__).__init__(
            'oci:index/artifactsContainerConfiguration:ArtifactsContainerConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[str]] = None,
            is_repository_created_on_first_push: Optional[pulumi.Input[bool]] = None,
            namespace: Optional[pulumi.Input[str]] = None) -> 'ArtifactsContainerConfiguration':
        """
        ...
        __props__ = _ArtifactsContainerConfigurationState.__new__(_ArtifactsContainerConfigurationState)

        __props__.__dict__["compartment_id"] = compartment_id
        __props__.__dict__["is_repository_created_on_first_push"] = is_repository_created_on_first_push
        __props__.__dict__["namespace"] = namespace
        return ArtifactsContainerConfiguration(resource_name, opts=opts, __props__=__props__)
