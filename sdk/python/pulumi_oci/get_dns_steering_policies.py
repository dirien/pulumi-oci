...
__all__ = [
    'GetDnsSteeringPoliciesResult',
    'AwaitableGetDnsSteeringPoliciesResult',
    'get_dns_steering_policies',
]

@pulumi.output_type
class GetDnsSteeringPoliciesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsSteeringPoliciesFilterResult']]:
    ...
    def steering_policies(self) -> Sequence['outputs.GetDnsSteeringPoliciesSteeringPolicyResult']:
        """
...
class AwaitableGetDnsSteeringPoliciesResult(GetDnsSteeringPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsSteeringPoliciesResult(
...
def get_dns_steering_policies(compartment_id: Optional[str] = None,
                              display_name: Optional[str] = None,
                              display_name_contains: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetDnsSteeringPoliciesFilterArgs']]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsSteeringPoliciesResult:
    """
    ...
    test_steering_policies = oci.get_dns_steering_policies(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsSteeringPolicies:GetDnsSteeringPolicies', __args__, opts=opts, typ=GetDnsSteeringPoliciesResult).value

    return AwaitableGetDnsSteeringPoliciesResult(
