...
__all__ = [
    'GetLimitsLimitValuesResult',
    'AwaitableGetLimitsLimitValuesResult',
    'get_limits_limit_values',
]

@pulumi.output_type
class GetLimitsLimitValuesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLimitsLimitValuesFilterResult']]:
    ...
    def limit_values(self) -> Sequence['outputs.GetLimitsLimitValuesLimitValueResult']:
        """
...
class AwaitableGetLimitsLimitValuesResult(GetLimitsLimitValuesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLimitsLimitValuesResult(
...
def get_limits_limit_values(availability_domain: Optional[str] = None,
                            compartment_id: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetLimitsLimitValuesFilterArgs']]] = None,
                            name: Optional[str] = None,
                            scope_type: Optional[str] = None,
                            service_name: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLimitsLimitValuesResult:
    """
    ...
    test_limit_values = oci.get_limits_limit_values(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLimitsLimitValues:GetLimitsLimitValues', __args__, opts=opts, typ=GetLimitsLimitValuesResult).value

    return AwaitableGetLimitsLimitValuesResult(
