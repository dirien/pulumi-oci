...
__all__ = [
    'GetBastionBastionsResult',
    'AwaitableGetBastionBastionsResult',
    'get_bastion_bastions',
]

@pulumi.output_type
class GetBastionBastionsResult:
    """
    ...
    @property
    @pulumi.getter
    def bastions(self) -> Sequence['outputs.GetBastionBastionsBastionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBastionBastionsFilterResult']]:
...
class AwaitableGetBastionBastionsResult(GetBastionBastionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBastionBastionsResult(
...
def get_bastion_bastions(bastion_id: Optional[str] = None,
                         bastion_lifecycle_state: Optional[str] = None,
                         compartment_id: Optional[str] = None,
                         filters: Optional[Sequence[pulumi.InputType['GetBastionBastionsFilterArgs']]] = None,
                         name: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBastionBastionsResult:
    """
    ...
    test_bastions = oci.get_bastion_bastions(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBastionBastions:GetBastionBastions', __args__, opts=opts, typ=GetBastionBastionsResult).value

    return AwaitableGetBastionBastionsResult(
