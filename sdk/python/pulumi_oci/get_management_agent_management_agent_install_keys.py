...
__all__ = [
    'GetManagementAgentManagementAgentInstallKeysResult',
    'AwaitableGetManagementAgentManagementAgentInstallKeysResult',
    'get_management_agent_management_agent_install_keys',
]

@pulumi.output_type
class GetManagementAgentManagementAgentInstallKeysResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetManagementAgentManagementAgentInstallKeysFilterResult']]:
    ...
    def management_agent_install_keys(self) -> Sequence['outputs.GetManagementAgentManagementAgentInstallKeysManagementAgentInstallKeyResult']:
        """
...
class AwaitableGetManagementAgentManagementAgentInstallKeysResult(GetManagementAgentManagementAgentInstallKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagementAgentManagementAgentInstallKeysResult(
...
def get_management_agent_management_agent_install_keys(access_level: Optional[str] = None,
                                                       compartment_id: Optional[str] = None,
                                                       compartment_id_in_subtree: Optional[bool] = None,
                                                       display_name: Optional[str] = None,
                                                       filters: Optional[Sequence[pulumi.InputType['GetManagementAgentManagementAgentInstallKeysFilterArgs']]] = None,
                                                       state: Optional[str] = None,
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementAgentManagementAgentInstallKeysResult:
    """
    ...
    test_management_agent_install_keys = oci.get_management_agent_management_agent_install_keys(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getManagementAgentManagementAgentInstallKeys:GetManagementAgentManagementAgentInstallKeys', __args__, opts=opts, typ=GetManagementAgentManagementAgentInstallKeysResult).value

    return AwaitableGetManagementAgentManagementAgentInstallKeysResult(
