...
__all__ = ['ApmSyntheticsScriptArgs', 'ApmSyntheticsScript']

@pulumi.input_type
class ApmSyntheticsScriptArgs:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]] parameters: (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]]]:
        """
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]]]):
        pulumi.set(self, "parameters", value)


@pulumi.input_type
class _ApmSyntheticsScriptState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 monitor_status_count_map: Optional[pulumi.Input['ApmSyntheticsScriptMonitorStatusCountMapArgs']] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]]] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) Unique name that can be edited. The name should not contain any confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input['ApmSyntheticsScriptMonitorStatusCountMapArgs'] monitor_status_count_map: Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
        :param pulumi.Input[Sequence[pulumi.Input['ApmSyntheticsScriptParameterArgs']]] parameters: (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
        ...
        if freeform_tags is not None:
            pulumi.set(__self__, "freeform_tags", freeform_tags)
        if monitor_status_count_map is not None:
    ...
    def monitor_status_count_map(self) -> Optional[pulumi.Input['ApmSyntheticsScriptMonitorStatusCountMapArgs']]:
        """
    ...
    def monitor_status_count_map(self, value: Optional[pulumi.Input['ApmSyntheticsScriptMonitorStatusCountMapArgs']]):
        pulumi.set(self, "monitor_status_count_map", value)
...
class ApmSyntheticsScript(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApmSyntheticsScriptParameterArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test_script = oci.ApmSyntheticsScript("testScript",
            ...
            parameters=[oci.ApmSyntheticsScriptParameterArgs(
        ...
        :param pulumi.Input[str] display_name: (Updatable) Unique name that can be edited. The name should not contain any confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApmSyntheticsScriptParameterArgs']]]] parameters: (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: ApmSyntheticsScriptArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Script resource in Oracle Cloud Infrastructure Apm Synthetics service.
        ...
        :param str resource_name: The name of the resource.
        :param ApmSyntheticsScriptArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApmSyntheticsScriptArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApmSyntheticsScriptArgs.__new__(ApmSyntheticsScriptArgs)
            ...
            __props__.__dict__["monitor_status_count_map"] = None
            __props__.__dict__["time_created"] = None
            __props__.__dict__["time_updated"] = None
            __props__.__dict__["time_uploaded"] = None
        super(ApmSyntheticsScript, __self__).__init__(
            'oci:index/apmSyntheticsScript:ApmSyntheticsScript',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            monitor_status_count_map: Optional[pulumi.Input[pulumi.InputType['ApmSyntheticsScriptMonitorStatusCountMapArgs']]] = None,
            parameters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApmSyntheticsScriptParameterArgs']]]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            time_uploaded: Optional[pulumi.Input[str]] = None) -> 'ApmSyntheticsScript':
        """
        ...
        :param pulumi.Input[str] display_name: (Updatable) Unique name that can be edited. The name should not contain any confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['ApmSyntheticsScriptMonitorStatusCountMapArgs']] monitor_status_count_map: Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ApmSyntheticsScriptParameterArgs']]]] parameters: (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
        :param pulumi.Input[str] time_created: The time the resource was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
        :param pulumi.Input[str] time_updated: The time the resource was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-13T22:47:12.613Z`
        :param pulumi.Input[str] time_uploaded: The time when the script was uploaded.
        ...
        __props__ = _ApmSyntheticsScriptState.__new__(_ApmSyntheticsScriptState)
        ...
        __props__.__dict__["display_name"] = display_name
        __props__.__dict__["freeform_tags"] = freeform_tags
        __props__.__dict__["monitor_status_count_map"] = monitor_status_count_map
        __props__.__dict__["parameters"] = parameters
        __props__.__dict__["time_created"] = time_created
        __props__.__dict__["time_updated"] = time_updated
        __props__.__dict__["time_uploaded"] = time_uploaded
        return ApmSyntheticsScript(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="monitorStatusCountMap")
    def monitor_status_count_map(self) -> pulumi.Output['outputs.ApmSyntheticsScriptMonitorStatusCountMap']:
        """
        Details of the monitor count per state. Example: `{ "total" : 5, "enabled" : 3 , "disabled" : 2, "invalid" : 0 }`
        """
        return pulumi.get(self, "monitor_status_count_map")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Sequence['outputs.ApmSyntheticsScriptParameter']]:
        """
        (Updatable) List of script parameters. Example: `[{"paramName": "userid", "paramValue":"testuser", "isSecret": false}]`
        """
        return pulumi.get(self, "parameters")
