...
__all__ = [
    'GetManagementAgentManagementAgentResult',
    'AwaitableGetManagementAgentManagementAgentResult',
    'get_management_agent_management_agent',
]

@pulumi.output_type
class GetManagementAgentManagementAgentResult:
    """
    A collection of values returned by GetManagementAgentManagementAgent.
    """
    def __init__(__self__, availability_status=None, compartment_id=None, defined_tags=None, deploy_plugins_ids=None, display_name=None, freeform_tags=None, host=None, id=None, install_key_id=None, install_path=None, is_agent_auto_upgradable=None, lifecycle_details=None, managed_agent_id=None, management_agent_id=None, platform_name=None, platform_type=None, platform_version=None, plugin_lists=None, state=None, time_created=None, time_last_heartbeat=None, time_updated=None, version=None):
    ...
    def plugin_lists(self) -> Sequence['outputs.GetManagementAgentManagementAgentPluginListResult']:
        """
...
class AwaitableGetManagementAgentManagementAgentResult(GetManagementAgentManagementAgentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagementAgentManagementAgentResult(
...
def get_management_agent_management_agent(management_agent_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementAgentManagementAgentResult:
    """
    ...
    test_management_agent = oci.get_management_agent_management_agent(management_agent_id=oci_management_agent_management_agent["test_management_agent"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getManagementAgentManagementAgent:GetManagementAgentManagementAgent', __args__, opts=opts, typ=GetManagementAgentManagementAgentResult).value

    return AwaitableGetManagementAgentManagementAgentResult(
