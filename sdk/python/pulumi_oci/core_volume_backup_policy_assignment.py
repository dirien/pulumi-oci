...
__all__ = ['CoreVolumeBackupPolicyAssignmentArgs', 'CoreVolumeBackupPolicyAssignment']

@pulumi.input_type
class CoreVolumeBackupPolicyAssignmentArgs:
...
@pulumi.input_type
class _CoreVolumeBackupPolicyAssignmentState:
    def __init__(__self__, *,
...
class CoreVolumeBackupPolicyAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_volume_backup_policy_assignment = oci.CoreVolumeBackupPolicyAssignment("testVolumeBackupPolicyAssignment",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreVolumeBackupPolicyAssignmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Volume Backup Policy Assignment resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeBackupPolicyAssignmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeBackupPolicyAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeBackupPolicyAssignmentArgs.__new__(CoreVolumeBackupPolicyAssignmentArgs)
        ...
        super(CoreVolumeBackupPolicyAssignment, __self__).__init__(
            'oci:index/coreVolumeBackupPolicyAssignment:CoreVolumeBackupPolicyAssignment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            asset_id: Optional[pulumi.Input[str]] = None,
            policy_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreVolumeBackupPolicyAssignment':
        """
        ...
        __props__ = _CoreVolumeBackupPolicyAssignmentState.__new__(_CoreVolumeBackupPolicyAssignmentState)

        __props__.__dict__["asset_id"] = asset_id
        __props__.__dict__["policy_id"] = policy_id
        __props__.__dict__["time_created"] = time_created
        return CoreVolumeBackupPolicyAssignment(resource_name, opts=opts, __props__=__props__)
