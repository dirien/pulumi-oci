...
__all__ = ['MeteringComputationUsageArgs', 'MeteringComputationUsage']

@pulumi.input_type
class MeteringComputationUsageArgs:
    def __init__(__self__, *,
                 ...
                 forecast: Optional[pulumi.Input['MeteringComputationUsageForecastArgs']] = None,
                 group_bies: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 group_by_tags: Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]]] = None,
        ...
        :param pulumi.Input['MeteringComputationUsageForecastArgs'] forecast: Forecast configuration of usage/cost.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]] group_by_tags: GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: `[{"namespace":"oracle", "key":"createdBy"]`
    ...
    @property
    @pulumi.getter
    def forecast(self) -> Optional[pulumi.Input['MeteringComputationUsageForecastArgs']]:
        """
    ...
    @forecast.setter
    def forecast(self, value: Optional[pulumi.Input['MeteringComputationUsageForecastArgs']]):
    ...
    def group_by_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]]]:
        """
    ...
    def group_by_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]]]):
...
@pulumi.input_type
class _MeteringComputationUsageState:
    def __init__(__self__, *,
                 compartment_depth: Optional[pulumi.Input[float]] = None,
                 filter: Optional[pulumi.Input[str]] = None,
                 forecast: Optional[pulumi.Input['MeteringComputationUsageForecastArgs']] = None,
                 ...
                 group_by_tags: Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]]] = None,
                 is_aggregate_by_time: Optional[pulumi.Input[bool]] = None,
                 items: Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageItemArgs']]]] = None,
                 query_type: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageGroupByTagArgs']]] group_by_tags: GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: `[{"namespace":"oracle", "key":"createdBy"]`
        :param pulumi.Input[bool] is_aggregate_by_time: Whether aggregated by time. If isAggregateByTime is true, all usage/cost over the query time period will be added up.
        :param pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageItemArgs']]] items: A list of usage items.
        :param pulumi.Input[str] query_type: The query usage type. COST by default if it is missing. Usage - Query the usage data. Cost - Query the cost/billing data. Credit - Query the credit adjustments data. ExpiredCredit - Query the expired credits data. AllCredit - Query the credit adjustments and expired credit.
        :param pulumi.Input[str] tenant_id: Tenant ID.
        :param pulumi.Input[str] time_usage_ended: The usage end time.
        :param pulumi.Input[str] time_usage_started: The usage start time.
    ...
    @property
    @pulumi.getter
    def items(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageItemArgs']]]]:
        """
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MeteringComputationUsageItemArgs']]]]):
...
class MeteringComputationUsage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 compartment_depth: Optional[pulumi.Input[float]] = None,
                 filter: Optional[pulumi.Input[str]] = None,
                 forecast: Optional[pulumi.Input[pulumi.InputType['MeteringComputationUsageForecastArgs']]] = None,
                 granularity: Optional[pulumi.Input[str]] = None,
                 group_bies: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 group_by_tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageGroupByTagArgs']]]]] = None,
                 is_aggregate_by_time: Optional[pulumi.Input[bool]] = None,
                 query_type: Optional[pulumi.Input[str]] = None,
                 tenant_id: Optional[pulumi.Input[str]] = None,
                 time_usage_ended: Optional[pulumi.Input[str]] = None,
        ...
        test_usage = oci.MeteringComputationUsage("testUsage",
            ...
            forecast=oci.MeteringComputationUsageForecastArgs(
            ...
            group_by_tags=[oci.MeteringComputationUsageGroupByTagArgs(
        ...
        :param pulumi.Input[float] compartment_depth: The compartment depth level.
        :param pulumi.Input[pulumi.InputType['MeteringComputationUsageForecastArgs']] forecast: Forecast configuration of usage/cost.
        :param pulumi.Input[str] granularity: The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] group_bies: Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageGroupByTagArgs']]]] group_by_tags: GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: `[{"namespace":"oracle", "key":"createdBy"]`
        :param pulumi.Input[bool] is_aggregate_by_time: Whether aggregated by time. If isAggregateByTime is true, all usage/cost over the query time period will be added up.
        :param pulumi.Input[str] query_type: The query usage type. COST by default if it is missing. Usage - Query the usage data. Cost - Query the cost/billing data. Credit - Query the credit adjustments data. ExpiredCredit - Query the expired credits data. AllCredit - Query the credit adjustments and expired credit.
        :param pulumi.Input[str] tenant_id: Tenant ID.
        :param pulumi.Input[str] time_usage_ended: The usage end time.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MeteringComputationUsageArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Usage resource in Oracle Cloud Infrastructure Metering Computation service.
        ...
        :param str resource_name: The name of the resource.
        :param MeteringComputationUsageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MeteringComputationUsageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MeteringComputationUsageArgs.__new__(MeteringComputationUsageArgs)
        ...
        super(MeteringComputationUsage, __self__).__init__(
            'oci:index/meteringComputationUsage:MeteringComputationUsage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            group_by_tags: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageGroupByTagArgs']]]]] = None,
            is_aggregate_by_time: Optional[pulumi.Input[bool]] = None,
            items: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageItemArgs']]]]] = None,
            query_type: Optional[pulumi.Input[str]] = None,
            tenant_id: Optional[pulumi.Input[str]] = None,
            time_usage_ended: Optional[pulumi.Input[str]] = None,
            time_usage_started: Optional[pulumi.Input[str]] = None) -> 'MeteringComputationUsage':
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageGroupByTagArgs']]]] group_by_tags: GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: `[{"namespace":"oracle", "key":"createdBy"]`
        :param pulumi.Input[bool] is_aggregate_by_time: Whether aggregated by time. If isAggregateByTime is true, all usage/cost over the query time period will be added up.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MeteringComputationUsageItemArgs']]]] items: A list of usage items.
        :param pulumi.Input[str] query_type: The query usage type. COST by default if it is missing. Usage - Query the usage data. Cost - Query the cost/billing data. Credit - Query the credit adjustments data. ExpiredCredit - Query the expired credits data. AllCredit - Query the credit adjustments and expired credit.
        :param pulumi.Input[str] tenant_id: Tenant ID.
        :param pulumi.Input[str] time_usage_ended: The usage end time.
        :param pulumi.Input[str] time_usage_started: The usage start time.
        ...
        __props__ = _MeteringComputationUsageState.__new__(_MeteringComputationUsageState)
        ...
        __props__.__dict__["time_usage_ended"] = time_usage_ended
        __props__.__dict__["time_usage_started"] = time_usage_started
        return MeteringComputationUsage(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def forecast(self) -> pulumi.Output['outputs.MeteringComputationUsageForecast']:
        """
        Forecast configuration of usage/cost.
        """
        return pulumi.get(self, "forecast")
    ...
    @property
    @pulumi.getter(name="groupByTags")
    def group_by_tags(self) -> pulumi.Output[Sequence['outputs.MeteringComputationUsageGroupByTag']]:
        """
        GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: `[{"namespace":"oracle", "key":"createdBy"]`
        """
        return pulumi.get(self, "group_by_tags")
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.MeteringComputationUsageItem']]:
        """
        A list of usage items.
        """
        return pulumi.get(self, "items")
