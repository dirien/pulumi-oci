...
__all__ = [
    'GetArtifactsGenericArtifactResult',
    'AwaitableGetArtifactsGenericArtifactResult',
    'get_artifacts_generic_artifact',
]

@pulumi.output_type
class GetArtifactsGenericArtifactResult:
    """
...
class AwaitableGetArtifactsGenericArtifactResult(GetArtifactsGenericArtifactResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsGenericArtifactResult(
...
def get_artifacts_generic_artifact(artifact_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsGenericArtifactResult:
    """
    ...
    test_generic_artifact = oci.get_artifacts_generic_artifact(artifact_id=oci_artifacts_artifact["test_artifact"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsGenericArtifact:GetArtifactsGenericArtifact', __args__, opts=opts, typ=GetArtifactsGenericArtifactResult).value

    return AwaitableGetArtifactsGenericArtifactResult(
