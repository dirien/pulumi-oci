...
__all__ = [
    'GetMysqlMysqlConfigurationResult',
    'AwaitableGetMysqlMysqlConfigurationResult',
    'get_mysql_mysql_configuration',
]

@pulumi.output_type
class GetMysqlMysqlConfigurationResult:
    """
    ...
    @property
    @pulumi.getter
    def variables(self) -> Sequence['outputs.GetMysqlMysqlConfigurationVariableResult']:
        """
...
class AwaitableGetMysqlMysqlConfigurationResult(GetMysqlMysqlConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlMysqlConfigurationResult(
...
def get_mysql_mysql_configuration(configuration_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlMysqlConfigurationResult:
    """
    ...
    test_mysql_configuration = oci.get_mysql_mysql_configuration(configuration_id=var["mysql_configuration_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlMysqlConfiguration:GetMysqlMysqlConfiguration', __args__, opts=opts, typ=GetMysqlMysqlConfigurationResult).value

    return AwaitableGetMysqlMysqlConfigurationResult(
