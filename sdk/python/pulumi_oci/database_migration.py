...
__all__ = ['DatabaseMigrationArgs', 'DatabaseMigration']

@pulumi.input_type
class DatabaseMigrationArgs:
...
@pulumi.input_type
class _DatabaseMigrationState:
    def __init__(__self__, *,
                 additional_migrations: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseMigrationAdditionalMigrationArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DatabaseMigrationAdditionalMigrationArgs']]] additional_migrations: The details of addtional resources related to the migration.
    ...
    def additional_migrations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseMigrationAdditionalMigrationArgs']]]]:
        """
    ...
    def additional_migrations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseMigrationAdditionalMigrationArgs']]]]):
...
class DatabaseMigration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_migration = oci.DatabaseMigration("testMigration", db_system_id=oci_database_db_system["test_db_system"]["id"])
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseMigrationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseMigrationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseMigrationArgs.__new__(DatabaseMigrationArgs)
        ...
        super(DatabaseMigration, __self__).__init__(
            'oci:index/databaseMigration:DatabaseMigration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            additional_migrations: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseMigrationAdditionalMigrationArgs']]]]] = None,
            cloud_exadata_infrastructure_id: Optional[pulumi.Input[str]] = None,
            cloud_vm_cluster_id: Optional[pulumi.Input[str]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseMigration':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseMigrationAdditionalMigrationArgs']]]] additional_migrations: The details of addtional resources related to the migration.
        :param pulumi.Input[str] cloud_exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Exadata infrastructure.
        :param pulumi.Input[str] cloud_vm_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud VM cluster.
        :param pulumi.Input[str] db_system_id: The DB system [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        """
        ...
        __props__ = _DatabaseMigrationState.__new__(_DatabaseMigrationState)
        ...
        __props__.__dict__["db_system_id"] = db_system_id
        return DatabaseMigration(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="additionalMigrations")
    def additional_migrations(self) -> pulumi.Output[Sequence['outputs.DatabaseMigrationAdditionalMigration']]:
        """
        The details of addtional resources related to the migration.
        """
        return pulumi.get(self, "additional_migrations")
