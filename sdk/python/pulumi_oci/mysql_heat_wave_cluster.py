...
__all__ = ['MysqlHeatWaveClusterArgs', 'MysqlHeatWaveCluster']

@pulumi.input_type
class MysqlHeatWaveClusterArgs:
...
@pulumi.input_type
class _MysqlHeatWaveClusterState:
    def __init__(__self__, *,
                 cluster_nodes: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlHeatWaveClusterClusterNodeArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MysqlHeatWaveClusterClusterNodeArgs']]] cluster_nodes: A HeatWave node is a compute host that is part of a HeatWave cluster.
        :param pulumi.Input[int] cluster_size: (Updatable) A change to the number of nodes in the HeatWave cluster will result in the entire cluster being torn down and re-created with the new cluster of nodes. This may result in a significant downtime for the analytics capability while the HeatWave cluster is re-provisioned.
        :param pulumi.Input[str] db_system_id: The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    def cluster_nodes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MysqlHeatWaveClusterClusterNodeArgs']]]]:
        """
    ...
    def cluster_nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlHeatWaveClusterClusterNodeArgs']]]]):
...
class MysqlHeatWaveCluster(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_heat_wave_cluster = oci.MysqlHeatWaveCluster("testHeatWaveCluster",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MysqlHeatWaveClusterArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MysqlHeatWaveClusterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MysqlHeatWaveClusterArgs.__new__(MysqlHeatWaveClusterArgs)
        ...
        super(MysqlHeatWaveCluster, __self__).__init__(
            'oci:index/mysqlHeatWaveCluster:MysqlHeatWaveCluster',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_nodes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlHeatWaveClusterClusterNodeArgs']]]]] = None,
            cluster_size: Optional[pulumi.Input[int]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            shape_name: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'MysqlHeatWaveCluster':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlHeatWaveClusterClusterNodeArgs']]]] cluster_nodes: A HeatWave node is a compute host that is part of a HeatWave cluster.
        :param pulumi.Input[int] cluster_size: (Updatable) A change to the number of nodes in the HeatWave cluster will result in the entire cluster being torn down and re-created with the new cluster of nodes. This may result in a significant downtime for the analytics capability while the HeatWave cluster is re-provisioned.
        :param pulumi.Input[str] db_system_id: The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycleState.
        :param pulumi.Input[str] shape_name: (Updatable) A change to the shape of the nodes in the HeatWave cluster will result in the entire cluster being torn down and re-created with Compute instances of the new Shape. This may result in significant downtime for the analytics capability while the HeatWave cluster is re-provisioned.
        ...
        __props__ = _MysqlHeatWaveClusterState.__new__(_MysqlHeatWaveClusterState)
        ...
        return MysqlHeatWaveCluster(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="clusterNodes")
    def cluster_nodes(self) -> pulumi.Output[Sequence['outputs.MysqlHeatWaveClusterClusterNode']]:
        """
        A HeatWave node is a compute host that is part of a HeatWave cluster.
        """
        return pulumi.get(self, "cluster_nodes")
