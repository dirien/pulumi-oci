...
__all__ = [
    'GetHealthChecksPingMonitorResult',
    'AwaitableGetHealthChecksPingMonitorResult',
    'get_health_checks_ping_monitor',
]

@pulumi.output_type
class GetHealthChecksPingMonitorResult:
    """
...
class AwaitableGetHealthChecksPingMonitorResult(GetHealthChecksPingMonitorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHealthChecksPingMonitorResult(
...
def get_health_checks_ping_monitor(monitor_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthChecksPingMonitorResult:
    """
    ...
    test_ping_monitor = oci.get_health_checks_ping_monitor(monitor_id=oci_apm_synthetics_monitor["test_monitor"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getHealthChecksPingMonitor:GetHealthChecksPingMonitor', __args__, opts=opts, typ=GetHealthChecksPingMonitorResult).value

    return AwaitableGetHealthChecksPingMonitorResult(
