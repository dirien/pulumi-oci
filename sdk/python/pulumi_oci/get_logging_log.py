...
__all__ = [
    'GetLoggingLogResult',
    'AwaitableGetLoggingLogResult',
    'get_logging_log',
]

@pulumi.output_type
class GetLoggingLogResult:
    """
    A collection of values returned by GetLoggingLog.
    """
    def __init__(__self__, compartment_id=None, configuration=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_enabled=None, log_group_id=None, log_id=None, log_type=None, retention_duration=None, state=None, tenancy_id=None, time_created=None, time_last_modified=None):
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetLoggingLogConfigurationResult':
        """
...
class AwaitableGetLoggingLogResult(GetLoggingLogResult):
...
def get_logging_log(log_group_id: Optional[str] = None,
                    log_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingLogResult:
    """
    ...
    test_log = oci.get_logging_log(log_group_id=oci_logging_log_group["test_log_group"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingLog:GetLoggingLog', __args__, opts=opts, typ=GetLoggingLogResult).value

    return AwaitableGetLoggingLogResult(
