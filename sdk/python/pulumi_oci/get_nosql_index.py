...
__all__ = [
    'GetNosqlIndexResult',
    'AwaitableGetNosqlIndexResult',
    'get_nosql_index',
]

@pulumi.output_type
class GetNosqlIndexResult:
    """
    ...
    @property
    @pulumi.getter
    def keys(self) -> Sequence['outputs.GetNosqlIndexKeyResult']:
        """
...
class AwaitableGetNosqlIndexResult(GetNosqlIndexResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNosqlIndexResult(
...
def get_nosql_index(compartment_id: Optional[str] = None,
                    index_name: Optional[str] = None,
                    table_name_or_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNosqlIndexResult:
    """
    ...
    test_index = oci.get_nosql_index(index_name=oci_nosql_index["test_index"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNosqlIndex:GetNosqlIndex', __args__, opts=opts, typ=GetNosqlIndexResult).value

    return AwaitableGetNosqlIndexResult(
