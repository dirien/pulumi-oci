...
__all__ = [
    'GetArtifactsContainerImageResult',
    'AwaitableGetArtifactsContainerImageResult',
    'get_artifacts_container_image',
]

@pulumi.output_type
class GetArtifactsContainerImageResult:
    """
    ...
    @property
    @pulumi.getter
    def layers(self) -> Sequence['outputs.GetArtifactsContainerImageLayerResult']:
        """
    ...
    @property
    @pulumi.getter
    def versions(self) -> Sequence['outputs.GetArtifactsContainerImageVersionResult']:
        """
...
class AwaitableGetArtifactsContainerImageResult(GetArtifactsContainerImageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerImageResult(
...
def get_artifacts_container_image(image_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerImageResult:
    """
    ...
    test_container_image = oci.get_artifacts_container_image(image_id=var["container_image_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerImage:GetArtifactsContainerImage', __args__, opts=opts, typ=GetArtifactsContainerImageResult).value

    return AwaitableGetArtifactsContainerImageResult(
