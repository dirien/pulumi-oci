...
class GetLogConfigurationResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 source: 'outputs.GetLogConfigurationSourceResult'):
        """
        :param str compartment_id: The OCID of the compartment that the resource belongs to.
        :param 'GetLogConfigurationSourceArgs' source: The source the log object comes from.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "source", source)
    ...
    @property
    @pulumi.getter
    def source(self) -> 'outputs.GetLogConfigurationSourceResult':
        """
        The source the log object comes from.
        """
        return pulumi.get(self, "source")
...
class GetLogsLogResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 configuration: 'outputs.GetLogsLogConfigurationResult',
                 defined_tags: Mapping[str, Any],
                 display_name: str,
                 freeform_tags: Mapping[str, Any],
                 id: str,
        ...
        """
        :param str compartment_id: The OCID of the compartment that the resource belongs to.
        :param 'GetLogsLogConfigurationArgs' configuration: Log object configuration.
        :param Mapping[str, Any] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param str display_name: Resource name
        :param Mapping[str, Any] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param str id: The OCID of the resource.
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetLogsLogConfigurationResult':
        """
...
class GetLogsLogConfigurationResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 source: 'outputs.GetLogsLogConfigurationSourceResult'):
        """
        :param str compartment_id: The OCID of the compartment that the resource belongs to.
        :param 'GetLogsLogConfigurationSourceArgs' source: The source the log object comes from.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "source", source)
    ...
    @property
    @pulumi.getter
    def source(self) -> 'outputs.GetLogsLogConfigurationSourceResult':
        """
        The source the log object comes from.
        """
        return pulumi.get(self, "source")
...
class GetUnifiedAgentConfigurationServiceConfigurationResult(dict):
    def __init__(__self__, *,
                 configuration_type: str,
                 destination: 'outputs.GetUnifiedAgentConfigurationServiceConfigurationDestinationResult',
        ...
        :param 'GetUnifiedAgentConfigurationServiceConfigurationDestinationArgs' destination: Logging destination object.
        """
        pulumi.set(__self__, "configuration_type", configuration_type)
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "sources", sources)
    ...
    @property
    @pulumi.getter
    def destination(self) -> 'outputs.GetUnifiedAgentConfigurationServiceConfigurationDestinationResult':
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 name: str,
                 parser: 'outputs.GetUnifiedAgentConfigurationServiceConfigurationSourceParserResult',
                 paths: Sequence[str],
                 source_type: str):
        """
        :param str name: The name key to tag this grok pattern.
        :param 'GetUnifiedAgentConfigurationServiceConfigurationSourceParserArgs' parser: source parser object.
    ...
    @property
    @pulumi.getter
    def parser(self) -> 'outputs.GetUnifiedAgentConfigurationServiceConfigurationSourceParserResult':
        """
