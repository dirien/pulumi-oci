...
def get_on_prem_connector(on_prem_connector_id: Optional[str] = None,
    ...
    test_on_prem_connector = oci.datasafe.get_on_prem_connector(on_prem_connector_id=oci_data_safe_on_prem_connector["test_on_prem_connector"]["id"])
    ```
