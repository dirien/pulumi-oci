...
def get_on_prem_connectors(access_level: Optional[str] = None,
    ...
    test_on_prem_connectors = oci.datasafe.get_on_prem_connectors(compartment_id=var["compartment_id"],
