...
__all__ = [
    'GetWaasAddressListsResult',
    'AwaitableGetWaasAddressListsResult',
    'get_waas_address_lists',
]

@pulumi.output_type
class GetWaasAddressListsResult:
    """
    ...
    def address_lists(self) -> Sequence['outputs.GetWaasAddressListsAddressListResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetWaasAddressListsFilterResult']]:
...
class AwaitableGetWaasAddressListsResult(GetWaasAddressListsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasAddressListsResult(
...
def get_waas_address_lists(compartment_id: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetWaasAddressListsFilterArgs']]] = None,
                           ids: Optional[Sequence[str]] = None,
                           names: Optional[Sequence[str]] = None,
                           states: Optional[Sequence[str]] = None,
                           time_created_greater_than_or_equal_to: Optional[str] = None,
                           time_created_less_than: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasAddressListsResult:
    """
    ...
    test_address_lists = oci.get_waas_address_lists(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasAddressLists:GetWaasAddressLists', __args__, opts=opts, typ=GetWaasAddressListsResult).value

    return AwaitableGetWaasAddressListsResult(
