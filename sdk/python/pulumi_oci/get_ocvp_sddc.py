...
__all__ = [
    'GetOcvpSddcResult',
    'AwaitableGetOcvpSddcResult',
    'get_ocvp_sddc',
]

@pulumi.output_type
class GetOcvpSddcResult:
    """
    ...
    def hcx_on_prem_licenses(self) -> Sequence['outputs.GetOcvpSddcHcxOnPremLicenseResult']:
        """
...
class AwaitableGetOcvpSddcResult(GetOcvpSddcResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOcvpSddcResult(
...
def get_ocvp_sddc(sddc_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOcvpSddcResult:
    """
    ...
    test_sddc = oci.get_ocvp_sddc(sddc_id=oci_ocvp_sddc["test_sddc"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOcvpSddc:GetOcvpSddc', __args__, opts=opts, typ=GetOcvpSddcResult).value

    return AwaitableGetOcvpSddcResult(
