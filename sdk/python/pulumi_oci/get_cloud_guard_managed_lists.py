...
__all__ = [
    'GetCloudGuardManagedListsResult',
    'AwaitableGetCloudGuardManagedListsResult',
    'get_cloud_guard_managed_lists',
]

@pulumi.output_type
class GetCloudGuardManagedListsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudGuardManagedListsFilterResult']]:
    ...
    def managed_list_collections(self) -> Sequence['outputs.GetCloudGuardManagedListsManagedListCollectionResult']:
        """
...
class AwaitableGetCloudGuardManagedListsResult(GetCloudGuardManagedListsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardManagedListsResult(
...
def get_cloud_guard_managed_lists(access_level: Optional[str] = None,
                                  compartment_id: Optional[str] = None,
                                  compartment_id_in_subtree: Optional[bool] = None,
                                  display_name: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetCloudGuardManagedListsFilterArgs']]] = None,
                                  list_type: Optional[str] = None,
                                  resource_metadata_only: Optional[bool] = None,
                                  state: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardManagedListsResult:
    """
    ...
    test_managed_lists = oci.get_cloud_guard_managed_lists(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardManagedLists:GetCloudGuardManagedLists', __args__, opts=opts, typ=GetCloudGuardManagedListsResult).value

    return AwaitableGetCloudGuardManagedListsResult(
