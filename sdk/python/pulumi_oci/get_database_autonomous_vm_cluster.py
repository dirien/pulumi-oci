...
__all__ = [
    'GetDatabaseAutonomousVmClusterResult',
    'AwaitableGetDatabaseAutonomousVmClusterResult',
    'get_database_autonomous_vm_cluster',
]

@pulumi.output_type
class GetDatabaseAutonomousVmClusterResult:
    """
...
class AwaitableGetDatabaseAutonomousVmClusterResult(GetDatabaseAutonomousVmClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousVmClusterResult(
...
def get_database_autonomous_vm_cluster(autonomous_vm_cluster_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousVmClusterResult:
    """
    ...
    test_autonomous_vm_cluster = oci.get_database_autonomous_vm_cluster(autonomous_vm_cluster_id=oci_database_autonomous_vm_cluster["test_autonomous_vm_cluster"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousVmCluster:GetDatabaseAutonomousVmCluster', __args__, opts=opts, typ=GetDatabaseAutonomousVmClusterResult).value

    return AwaitableGetDatabaseAutonomousVmClusterResult(
