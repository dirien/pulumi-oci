...
__all__ = [
    'GetCoreBootVolumeBackupResult',
    'AwaitableGetCoreBootVolumeBackupResult',
    'get_core_boot_volume_backup',
]

@pulumi.output_type
class GetCoreBootVolumeBackupResult:
    """
    ...
    def source_details(self) -> 'outputs.GetCoreBootVolumeBackupSourceDetailsResult':
...
class AwaitableGetCoreBootVolumeBackupResult(GetCoreBootVolumeBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBootVolumeBackupResult(
...
def get_core_boot_volume_backup(boot_volume_backup_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBootVolumeBackupResult:
    """
    ...
    test_boot_volume_backup = oci.get_core_boot_volume_backup(boot_volume_backup_id=oci_core_boot_volume_backup["test_boot_volume_backup"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBootVolumeBackup:GetCoreBootVolumeBackup', __args__, opts=opts, typ=GetCoreBootVolumeBackupResult).value

    return AwaitableGetCoreBootVolumeBackupResult(
