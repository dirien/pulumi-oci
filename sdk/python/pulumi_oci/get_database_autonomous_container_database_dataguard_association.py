...
__all__ = [
    'GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult',
    'AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationResult',
    'get_database_autonomous_container_database_dataguard_association',
]

@pulumi.output_type
class GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult:
    """
    A collection of values returned by GetDatabaseAutonomousContainerDatabaseDataguardAssociation.
    """
    def __init__(__self__, apply_lag=None, apply_rate=None, autonomous_container_database_dataguard_association_id=None, autonomous_container_database_id=None, id=None, lifecycle_details=None, peer_autonomous_container_database_dataguard_association_id=None, peer_autonomous_container_database_id=None, peer_lifecycle_state=None, peer_role=None, protection_mode=None, role=None, state=None, time_created=None, time_last_role_changed=None, time_last_synced=None, transport_lag=None):
...
class AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationResult(GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult(
...
def get_database_autonomous_container_database_dataguard_association(autonomous_container_database_dataguard_association_id: Optional[str] = None,
                                                                     autonomous_container_database_id: Optional[str] = None,
                                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousContainerDatabaseDataguardAssociation:GetDatabaseAutonomousContainerDatabaseDataguardAssociation', __args__, opts=opts, typ=GetDatabaseAutonomousContainerDatabaseDataguardAssociationResult).value

    return AwaitableGetDatabaseAutonomousContainerDatabaseDataguardAssociationResult(
