...
__all__ = [
    'GetNosqlIndexesResult',
    'AwaitableGetNosqlIndexesResult',
    'get_nosql_indexes',
]

@pulumi.output_type
class GetNosqlIndexesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetNosqlIndexesFilterResult']]:
    ...
    def index_collections(self) -> Sequence['outputs.GetNosqlIndexesIndexCollectionResult']:
        """
...
class AwaitableGetNosqlIndexesResult(GetNosqlIndexesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNosqlIndexesResult(
...
def get_nosql_indexes(compartment_id: Optional[str] = None,
                      filters: Optional[Sequence[pulumi.InputType['GetNosqlIndexesFilterArgs']]] = None,
                      name: Optional[str] = None,
                      state: Optional[str] = None,
                      table_name_or_id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNosqlIndexesResult:
    """
    ...
    test_indexes = oci.get_nosql_indexes(table_name_or_id=oci_nosql_table_name_or["test_table_name_or"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNosqlIndexes:GetNosqlIndexes', __args__, opts=opts, typ=GetNosqlIndexesResult).value

    return AwaitableGetNosqlIndexesResult(
