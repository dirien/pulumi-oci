...
__all__ = ['CoreServiceGatewayArgs', 'CoreServiceGateway']

@pulumi.input_type
class CoreServiceGatewayArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 services: pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]],
    ...
    @property
    @pulumi.getter
    def services(self) -> pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]]:
        """
    ...
    @services.setter
    def services(self, value: pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]]):
...
@pulumi.input_type
class _CoreServiceGatewayState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 route_table_id: Optional[pulumi.Input[str]] = None,
                 services: Optional[pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def services(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]]]:
        """
        (Updatable) List of the OCIDs of the [Service](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Service/) objects to enable for the service gateway. This list can be empty if you don't want to enable any `Service` objects when you create the gateway. You can enable a `Service` object later by using either [AttachServiceId](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/AttachServiceId) or [UpdateServiceGateway](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/UpdateServiceGateway).
        """
        return pulumi.get(self, "services")
    ...
    @services.setter
    def services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreServiceGatewayServiceArgs']]]]):
        pulumi.set(self, "services", value)
...
class CoreServiceGateway(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 route_table_id: Optional[pulumi.Input[str]] = None,
                 services: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreServiceGatewayServiceArgs']]]]] = None,
                 vcn_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_service_gateway = oci.CoreServiceGateway("testServiceGateway",
            compartment_id=var["compartment_id"],
            services=[oci.CoreServiceGatewayServiceArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] route_table_id: (Updatable) The OCID of the route table the service gateway will use.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreServiceGatewayServiceArgs']]]] services: (Updatable) List of the OCIDs of the [Service](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Service/) objects to enable for the service gateway. This list can be empty if you don't want to enable any `Service` objects when you create the gateway. You can enable a `Service` object later by using either [AttachServiceId](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/AttachServiceId) or [UpdateServiceGateway](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/UpdateServiceGateway).
        :param pulumi.Input[str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreServiceGatewayArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreServiceGatewayArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreServiceGatewayArgs.__new__(CoreServiceGatewayArgs)
        ...
        super(CoreServiceGateway, __self__).__init__(
            'oci:index/coreServiceGateway:CoreServiceGateway',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'CoreServiceGateway':
        """
        ...
        __props__ = _CoreServiceGatewayState.__new__(_CoreServiceGatewayState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        return CoreServiceGateway(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def services(self) -> pulumi.Output[Sequence['outputs.CoreServiceGatewayService']]:
        """
        (Updatable) List of the OCIDs of the [Service](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Service/) objects to enable for the service gateway. This list can be empty if you don't want to enable any `Service` objects when you create the gateway. You can enable a `Service` object later by using either [AttachServiceId](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/AttachServiceId) or [UpdateServiceGateway](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ServiceGateway/UpdateServiceGateway).
        """
        return pulumi.get(self, "services")
