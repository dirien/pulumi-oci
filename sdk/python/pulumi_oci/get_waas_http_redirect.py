...
__all__ = [
    'GetWaasHttpRedirectResult',
    'AwaitableGetWaasHttpRedirectResult',
    'get_waas_http_redirect',
]

@pulumi.output_type
class GetWaasHttpRedirectResult:
    """
    A collection of values returned by GetWaasHttpRedirect.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, domain=None, freeform_tags=None, http_redirect_id=None, id=None, response_code=None, state=None, target=None, time_created=None):
    ...
    @property
    @pulumi.getter
    def target(self) -> 'outputs.GetWaasHttpRedirectTargetResult':
        """
...
class AwaitableGetWaasHttpRedirectResult(GetWaasHttpRedirectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasHttpRedirectResult(
...
def get_waas_http_redirect(http_redirect_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasHttpRedirectResult:
    """
    ...
    test_http_redirect = oci.get_waas_http_redirect(http_redirect_id=oci_waas_http_redirect["test_http_redirect"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasHttpRedirect:GetWaasHttpRedirect', __args__, opts=opts, typ=GetWaasHttpRedirectResult).value

    return AwaitableGetWaasHttpRedirectResult(
