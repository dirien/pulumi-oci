...
__all__ = ['CoreVirtualCircuitArgs', 'CoreVirtualCircuit']

@pulumi.input_type
class CoreVirtualCircuitArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 type: pulumi.Input[str],
                 bandwidth_shape_name: Optional[pulumi.Input[str]] = None,
                 cross_connect_mappings: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitCrossConnectMappingArgs']]]] = None,
                 ...
                 public_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitPublicPrefixArgs']]]] = None,
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment to contain the virtual circuit.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitCrossConnectMappingArgs']]] cross_connect_mappings: (Updatable) Create a `CrossConnectMapping` for each cross-connect or cross-connect group this virtual circuit will run on.
        ...
        :param pulumi.Input[str] gateway_id: (Updatable) For private virtual circuits only. The OCID of the [dynamic routing gateway (DRG)](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Drg) that this virtual circuit uses.
        :param pulumi.Input[str] provider_service_id: The OCID of the service offered by the provider (if you're connecting via a provider). To get a list of the available service offerings, see [ListFastConnectProviderServices](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/FastConnectProviderService/ListFastConnectProviderServices).
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitPublicPrefixArgs']]] public_prefixes: (Updatable) For a public virtual circuit. The public IP prefixes (CIDRs) the customer wants to advertise across the connection.
    ...
    def cross_connect_mappings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitCrossConnectMappingArgs']]]]:
        """
    ...
    def cross_connect_mappings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitCrossConnectMappingArgs']]]]):
    ...
    def public_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitPublicPrefixArgs']]]]:
        """
    ...
    def public_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVirtualCircuitPublicPrefixArgs']]]]):
...
@pulumi.input_type
class _CoreVirtualCircuitState:
    def __init__(__self__, *,
                 bandwidth_shape_name: Optional[pulumi.Input[str]] = None,
...
class CoreVirtualCircuit(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 bandwidth_shape_name: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 cross_connect_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVirtualCircuitCrossConnectMappingArgs']]]]] = None,
                 customer_asn: Optional[pulumi.Input[str]] = None,
                 customer_bgp_asn: Optional[pulumi.Input[int]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 provider_service_id: Optional[pulumi.Input[str]] = None,
                 provider_service_key_name: Optional[pulumi.Input[str]] = None,
                 public_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVirtualCircuitPublicPrefixArgs']]]]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 routing_policies: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        **Important:** When creating a virtual circuit, you specify a DRG for
        ...
        test_virtual_circuit = oci.CoreVirtualCircuit("testVirtualCircuit",
            compartment_id=var["compartment_id"],
            type=var["virtual_circuit_type"],
            bandwidth_shape_name=var["virtual_circuit_bandwidth_shape_name"],
            cross_connect_mappings=[oci.CoreVirtualCircuitCrossConnectMappingArgs(
            ...
            public_prefixes=[oci.CoreVirtualCircuitPublicPrefixArgs(
        ...
        :param pulumi.Input[str] bandwidth_shape_name: (Updatable) The provisioned data rate of the connection. To get a list of the available bandwidth levels (that is, shapes), see [ListFastConnectProviderServiceVirtualCircuitBandwidthShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/FastConnectProviderService/ListFastConnectProviderVirtualCircuitBandwidthShapes).  Example: `10 Gbps`
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment to contain the virtual circuit.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVirtualCircuitCrossConnectMappingArgs']]]] cross_connect_mappings: (Updatable) Create a `CrossConnectMapping` for each cross-connect or cross-connect group this virtual circuit will run on.
        :param pulumi.Input[str] customer_asn: (Updatable) Your BGP ASN (either public or private). Provide this value only if there's a BGP session that goes from your edge router to Oracle. Otherwise, leave this empty or null. Can be a 2-byte or 4-byte ASN. Uses "asplain" format.  Example: `12345` (2-byte) or `1587232876` (4-byte)
        :param pulumi.Input[int] customer_bgp_asn: (Updatable) Deprecated. Instead use `customerAsn`. If you specify values for both, the request will be rejected.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        ...
        :param pulumi.Input[str] provider_service_id: The OCID of the service offered by the provider (if you're connecting via a provider). To get a list of the available service offerings, see [ListFastConnectProviderServices](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/FastConnectProviderService/ListFastConnectProviderServices).
        :param pulumi.Input[str] provider_service_key_name: (Updatable) The service key name offered by the provider (if the customer is connecting via a provider).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVirtualCircuitPublicPrefixArgs']]]] public_prefixes: (Updatable) For a public virtual circuit. The public IP prefixes (CIDRs) the customer wants to advertise across the connection.
        :param pulumi.Input[str] region: The Oracle Cloud Infrastructure region where this virtual circuit is located. Example: `phx`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] routing_policies: (Updatable) The routing policy sets how routing information about the Oracle cloud is shared over a public virtual circuit. Policies available are: `ORACLE_SERVICE_NETWORK`, `REGIONAL`, `MARKET_LEVEL`, and `GLOBAL`. See [Route Filtering](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/routingonprem.htm#route_filtering) for details. By default, routing information is shared for all routes in the same market.
        :param pulumi.Input[str] type: The type of IP addresses used in this virtual circuit. PRIVATE means [RFC 1918](https://tools.ietf.org/html/rfc1918) addresses (10.0.0.0/8, 172.16/12, and 192.168/16).
        """
    ...
    def __init__(__self__,
        ...
        **Important:** When creating a virtual circuit, you specify a DRG for
        ...
        :param str resource_name: The name of the resource.
        :param CoreVirtualCircuitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVirtualCircuitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVirtualCircuitArgs.__new__(CoreVirtualCircuitArgs)
        ...
        super(CoreVirtualCircuit, __self__).__init__(
            'oci:index/coreVirtualCircuit:CoreVirtualCircuit',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'CoreVirtualCircuit':
        """
        ...
        __props__ = _CoreVirtualCircuitState.__new__(_CoreVirtualCircuitState)
        ...
        __props__.__dict__["type"] = type
        return CoreVirtualCircuit(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="crossConnectMappings")
    def cross_connect_mappings(self) -> pulumi.Output[Sequence['outputs.CoreVirtualCircuitCrossConnectMapping']]:
        """
        (Updatable) Create a `CrossConnectMapping` for each cross-connect or cross-connect group this virtual circuit will run on.
        """
        return pulumi.get(self, "cross_connect_mappings")
    ...
    @property
    @pulumi.getter(name="publicPrefixes")
    def public_prefixes(self) -> pulumi.Output[Optional[Sequence['outputs.CoreVirtualCircuitPublicPrefix']]]:
        """
        (Updatable) For a public virtual circuit. The public IP prefixes (CIDRs) the customer wants to advertise across the connection.
        """
        return pulumi.get(self, "public_prefixes")
