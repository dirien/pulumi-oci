...
__all__ = [
    'GetCoreDedicatedVmHostInstanceShapesResult',
    'AwaitableGetCoreDedicatedVmHostInstanceShapesResult',
    'get_core_dedicated_vm_host_instance_shapes',
]

@pulumi.output_type
class GetCoreDedicatedVmHostInstanceShapesResult:
    """
    ...
    def dedicated_vm_host_instance_shapes(self) -> Sequence['outputs.GetCoreDedicatedVmHostInstanceShapesDedicatedVmHostInstanceShapeResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDedicatedVmHostInstanceShapesFilterResult']]:
...
class AwaitableGetCoreDedicatedVmHostInstanceShapesResult(GetCoreDedicatedVmHostInstanceShapesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDedicatedVmHostInstanceShapesResult(
...
def get_core_dedicated_vm_host_instance_shapes(availability_domain: Optional[str] = None,
                                               compartment_id: Optional[str] = None,
                                               dedicated_vm_host_shape: Optional[str] = None,
                                               filters: Optional[Sequence[pulumi.InputType['GetCoreDedicatedVmHostInstanceShapesFilterArgs']]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDedicatedVmHostInstanceShapesResult:
    """
    ...
    test_dedicated_vm_host_instance_shapes = oci.get_core_dedicated_vm_host_instance_shapes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDedicatedVmHostInstanceShapes:GetCoreDedicatedVmHostInstanceShapes', __args__, opts=opts, typ=GetCoreDedicatedVmHostInstanceShapesResult).value

    return AwaitableGetCoreDedicatedVmHostInstanceShapesResult(
