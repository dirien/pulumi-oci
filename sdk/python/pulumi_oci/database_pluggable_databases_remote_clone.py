...
__all__ = ['DatabasePluggableDatabasesRemoteCloneArgs', 'DatabasePluggableDatabasesRemoteClone']

@pulumi.input_type
class DatabasePluggableDatabasesRemoteCloneArgs:
    def __init__(__self__, *,
                 ...
                 target_tde_wallet_password: pulumi.Input[str]):
        """
    ...
    def target_tde_wallet_password(self) -> pulumi.Input[str]:
        """
    ...
    def target_tde_wallet_password(self, value: pulumi.Input[str]):
        pulumi.set(self, "target_tde_wallet_password", value)


@pulumi.input_type
class _DatabasePluggableDatabasesRemoteCloneState:
    def __init__(__self__, *,
                 cloned_pdb_name: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 connection_strings: Optional[pulumi.Input['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs']] = None,
        ...
        :param pulumi.Input['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs'] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
    ...
    def connection_strings(self) -> Optional[pulumi.Input['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: Optional[pulumi.Input['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs']]):
...
class DatabasePluggableDatabasesRemoteClone(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_pluggable_databases_remote_clone = oci.DatabasePluggableDatabasesRemoteClone("testPluggableDatabasesRemoteClone",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabasePluggableDatabasesRemoteCloneArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Pluggable Databases Remote Clone resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabasePluggableDatabasesRemoteCloneArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabasePluggableDatabasesRemoteCloneArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabasePluggableDatabasesRemoteCloneArgs.__new__(DatabasePluggableDatabasesRemoteCloneArgs)
            ...
            if target_tde_wallet_password is None and not opts.urn:
                raise TypeError("Missing required property 'target_tde_wallet_password'")
        ...
        super(DatabasePluggableDatabasesRemoteClone, __self__).__init__(
            'oci:index/databasePluggableDatabasesRemoteClone:DatabasePluggableDatabasesRemoteClone',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            cloned_pdb_name: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_strings: Optional[pulumi.Input[pulumi.InputType['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs']]] = None,
            container_database_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            is_restricted: Optional[pulumi.Input[bool]] = None,
            ...
            target_container_database_id: Optional[pulumi.Input[str]] = None,
            target_tde_wallet_password: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'DatabasePluggableDatabasesRemoteClone':
        """
        ...
        :param pulumi.Input[str] cloned_pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[pulumi.InputType['DatabasePluggableDatabasesRemoteCloneConnectionStringsArgs']] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
        :param pulumi.Input[str] container_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_restricted: The restricted mode of the pluggable database. If a pluggable database is opened in restricted mode, the user needs both create a session and have restricted session privileges to connect to it.
        ...
        __props__ = _DatabasePluggableDatabasesRemoteCloneState.__new__(_DatabasePluggableDatabasesRemoteCloneState)
        ...
        return DatabasePluggableDatabasesRemoteClone(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Output['outputs.DatabasePluggableDatabasesRemoteCloneConnectionStrings']:
        """
        Connection strings to connect to an Oracle Pluggable Database.
        """
        return pulumi.get(self, "connection_strings")
