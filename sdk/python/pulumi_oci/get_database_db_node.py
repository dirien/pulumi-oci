...
class AwaitableGetDatabaseDbNodeResult(GetDatabaseDbNodeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbNodeResult(
...
def get_database_db_node(db_node_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbNodeResult:
    """
    ...
    test_db_node = oci.get_database_db_node(db_node_id=var["db_node_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbNode:GetDatabaseDbNode', __args__, opts=opts, typ=GetDatabaseDbNodeResult).value

    return AwaitableGetDatabaseDbNodeResult(
