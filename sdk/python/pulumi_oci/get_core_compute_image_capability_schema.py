...
__all__ = [
    'GetCoreComputeImageCapabilitySchemaResult',
    'AwaitableGetCoreComputeImageCapabilitySchemaResult',
    'get_core_compute_image_capability_schema',
]

@pulumi.output_type
class GetCoreComputeImageCapabilitySchemaResult:
    """
...
class AwaitableGetCoreComputeImageCapabilitySchemaResult(GetCoreComputeImageCapabilitySchemaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeImageCapabilitySchemaResult(
...
def get_core_compute_image_capability_schema(compute_image_capability_schema_id: Optional[str] = None,
                                             is_merge_enabled: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeImageCapabilitySchemaResult:
    """
    ...
    test_compute_image_capability_schema = oci.get_core_compute_image_capability_schema(compute_image_capability_schema_id=oci_core_compute_image_capability_schema["test_compute_image_capability_schema"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeImageCapabilitySchema:GetCoreComputeImageCapabilitySchema', __args__, opts=opts, typ=GetCoreComputeImageCapabilitySchemaResult).value

    return AwaitableGetCoreComputeImageCapabilitySchemaResult(
