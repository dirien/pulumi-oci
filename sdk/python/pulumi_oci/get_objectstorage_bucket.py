...
class GetObjectstorageBucketResult:
    ...
    def retention_rules(self) -> Sequence['outputs.GetObjectstorageBucketRetentionRuleResult']:
        """
...
def get_objectstorage_bucket(name: Optional[str] = None,
    ...
    test_bucket = oci.get_objectstorage_bucket(name=var["bucket_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageBucket:GetObjectstorageBucket', __args__, opts=opts, typ=GetObjectstorageBucketResult).value
