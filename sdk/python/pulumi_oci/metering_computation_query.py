...
__all__ = ['MeteringComputationQueryArgs', 'MeteringComputationQuery']

@pulumi.input_type
class MeteringComputationQueryArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 query_definition: pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']):
        """
        ...
        :param pulumi.Input['MeteringComputationQueryQueryDefinitionArgs'] query_definition: (Updatable) The common fields for queries.
        """
    ...
    def query_definition(self) -> pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']:
        """
    ...
    def query_definition(self, value: pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']):
        pulumi.set(self, "query_definition", value)


@pulumi.input_type
class _MeteringComputationQueryState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 query_definition: Optional[pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']] = None):
        """
    ...
    @property
    @pulumi.getter(name="queryDefinition")
    def query_definition(self) -> Optional[pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']]:
        """
        (Updatable) The common fields for queries.
        """
        return pulumi.get(self, "query_definition")
    ...
    @query_definition.setter
    def query_definition(self, value: Optional[pulumi.Input['MeteringComputationQueryQueryDefinitionArgs']]):
        pulumi.set(self, "query_definition", value)


class MeteringComputationQuery(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 query_definition: Optional[pulumi.Input[pulumi.InputType['MeteringComputationQueryQueryDefinitionArgs']]] = None,
                 __props__=None):
        """
        ...
        test_query = oci.MeteringComputationQuery("testQuery",
            compartment_id=var["compartment_id"],
            query_definition=oci.MeteringComputationQueryQueryDefinitionArgs(
                cost_analysis_ui=oci.MeteringComputationQueryQueryDefinitionCostAnalysisUiArgs(
                ...
                report_query=oci.MeteringComputationQueryQueryDefinitionReportQueryArgs(
                    ...
                    forecast=oci.MeteringComputationQueryQueryDefinitionReportQueryForecastArgs(
                    ...
                    group_by_tags=[oci.MeteringComputationQueryQueryDefinitionReportQueryGroupByTagArgs(
        ...
        :param pulumi.Input[str] compartment_id: The compartment OCID.
        :param pulumi.Input[pulumi.InputType['MeteringComputationQueryQueryDefinitionArgs']] query_definition: (Updatable) The common fields for queries.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: MeteringComputationQueryArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Query resource in Oracle Cloud Infrastructure Metering Computation service.
        ...
        :param str resource_name: The name of the resource.
        :param MeteringComputationQueryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MeteringComputationQueryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MeteringComputationQueryArgs.__new__(MeteringComputationQueryArgs)
        ...
        super(MeteringComputationQuery, __self__).__init__(
            'oci:index/meteringComputationQuery:MeteringComputationQuery',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            query_definition: Optional[pulumi.Input[pulumi.InputType['MeteringComputationQueryQueryDefinitionArgs']]] = None) -> 'MeteringComputationQuery':
        """
        ...
        __props__ = _MeteringComputationQueryState.__new__(_MeteringComputationQueryState)

        __props__.__dict__["compartment_id"] = compartment_id
        __props__.__dict__["query_definition"] = query_definition
        return MeteringComputationQuery(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="queryDefinition")
    def query_definition(self) -> pulumi.Output['outputs.MeteringComputationQueryQueryDefinition']:
        """
        (Updatable) The common fields for queries.
        """
        return pulumi.get(self, "query_definition")
