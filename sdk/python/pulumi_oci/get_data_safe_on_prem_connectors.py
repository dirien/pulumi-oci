...
__all__ = [
    'GetDataSafeOnPremConnectorsResult',
    'AwaitableGetDataSafeOnPremConnectorsResult',
    'get_data_safe_on_prem_connectors',
]

@pulumi.output_type
class GetDataSafeOnPremConnectorsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDataSafeOnPremConnectorsFilterResult']]:
    ...
    def on_prem_connectors(self) -> Sequence['outputs.GetDataSafeOnPremConnectorsOnPremConnectorResult']:
        """
...
class AwaitableGetDataSafeOnPremConnectorsResult(GetDataSafeOnPremConnectorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataSafeOnPremConnectorsResult(
...
def get_data_safe_on_prem_connectors(access_level: Optional[str] = None,
                                     compartment_id: Optional[str] = None,
                                     compartment_id_in_subtree: Optional[bool] = None,
                                     display_name: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetDataSafeOnPremConnectorsFilterArgs']]] = None,
                                     on_prem_connector_id: Optional[str] = None,
                                     on_prem_connector_lifecycle_state: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataSafeOnPremConnectorsResult:
    """
    ...
    test_on_prem_connectors = oci.get_data_safe_on_prem_connectors(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataSafeOnPremConnectors:GetDataSafeOnPremConnectors', __args__, opts=opts, typ=GetDataSafeOnPremConnectorsResult).value

    return AwaitableGetDataSafeOnPremConnectorsResult(
