...
__all__ = ['OsmanagementManagedInstanceGroupArgs', 'OsmanagementManagedInstanceGroup']

@pulumi.input_type
class OsmanagementManagedInstanceGroupArgs:
...
@pulumi.input_type
class _OsmanagementManagedInstanceGroupState:
    def __init__(__self__, *,
                 ...
                 managed_instances: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceGroupManagedInstanceArgs']]]] = None,
                 os_family: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) Managed Instance Group identifier
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceGroupManagedInstanceArgs']]] managed_instances: list of Managed Instances in the group
        :param pulumi.Input[str] os_family: The Operating System type of the managed instance(s) on which this scheduled job will operate. If not specified, this defaults to Linux.
    ...
    def managed_instances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceGroupManagedInstanceArgs']]]]:
        """
    ...
    def managed_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceGroupManagedInstanceArgs']]]]):
...
class OsmanagementManagedInstanceGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_managed_instance_group = oci.OsmanagementManagedInstanceGroup("testManagedInstanceGroup",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OsmanagementManagedInstanceGroupArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Managed Instance Group resource in Oracle Cloud Infrastructure OS Management service.
        ...
        :param str resource_name: The name of the resource.
        :param OsmanagementManagedInstanceGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OsmanagementManagedInstanceGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OsmanagementManagedInstanceGroupArgs.__new__(OsmanagementManagedInstanceGroupArgs)
        ...
        super(OsmanagementManagedInstanceGroup, __self__).__init__(
            'oci:index/osmanagementManagedInstanceGroup:OsmanagementManagedInstanceGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            managed_instance_count: Optional[pulumi.Input[int]] = None,
            managed_instances: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceGroupManagedInstanceArgs']]]]] = None,
            os_family: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'OsmanagementManagedInstanceGroup':
        """
        ...
        :param pulumi.Input[str] display_name: (Updatable) Managed Instance Group identifier
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceGroupManagedInstanceArgs']]]] managed_instances: list of Managed Instances in the group
        :param pulumi.Input[str] os_family: The Operating System type of the managed instance(s) on which this scheduled job will operate. If not specified, this defaults to Linux.
        :param pulumi.Input[str] state: The current state of the Software Source.
        """
        opts = pulumi.ResourceOptions.merge(opts, pulumi.ResourceOptions(id=id))

        __props__ = _OsmanagementManagedInstanceGroupState.__new__(_OsmanagementManagedInstanceGroupState)
        ...
        return OsmanagementManagedInstanceGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="managedInstances")
    def managed_instances(self) -> pulumi.Output[Sequence['outputs.OsmanagementManagedInstanceGroupManagedInstance']]:
        """
        list of Managed Instances in the group
        """
        return pulumi.get(self, "managed_instances")
