...
__all__ = [
    'GetCoreIpv6sResult',
    'AwaitableGetCoreIpv6sResult',
    'get_core_ipv6s',
]

@pulumi.output_type
class GetCoreIpv6sResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreIpv6sFilterResult']]:
    ...
    @property
    @pulumi.getter
    def ipv6s(self) -> Sequence['outputs.GetCoreIpv6sIpv6Result']:
        """
        The list of ipv6s.
        """
...
class AwaitableGetCoreIpv6sResult(GetCoreIpv6sResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpv6sResult(
...
def get_core_ipv6s(filters: Optional[Sequence[pulumi.InputType['GetCoreIpv6sFilterArgs']]] = None,
                   ip_address: Optional[str] = None,
                   subnet_id: Optional[str] = None,
                   vnic_id: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpv6sResult:
    """
    ...
    test_ipv6s = oci.get_core_ipv6s(ip_address=var["ipv6_ip_address"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpv6s:GetCoreIpv6s', __args__, opts=opts, typ=GetCoreIpv6sResult).value

    return AwaitableGetCoreIpv6sResult(
