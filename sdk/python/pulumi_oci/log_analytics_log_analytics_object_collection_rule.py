...
__all__ = ['LogAnalyticsLogAnalyticsObjectCollectionRuleArgs', 'LogAnalyticsLogAnalyticsObjectCollectionRule']

@pulumi.input_type
class LogAnalyticsLogAnalyticsObjectCollectionRuleArgs:
    def __init__(__self__, *,
                 ...
                 overrides: Optional[pulumi.Input[Sequence[pulumi.Input['LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def overrides(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs']]]]:
        """
    ...
    @overrides.setter
    def overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs']]]]):
...
@pulumi.input_type
class _LogAnalyticsLogAnalyticsObjectCollectionRuleState:
    def __init__(__self__, *,
                 char_encoding: Optional[pulumi.Input[str]] = None,
                 collection_type: Optional[pulumi.Input[str]] = None,
...
class LogAnalyticsLogAnalyticsObjectCollectionRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 os_bucket_name: Optional[pulumi.Input[str]] = None,
                 os_namespace: Optional[pulumi.Input[str]] = None,
                 overrides: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs']]]]] = None,
                 poll_since: Optional[pulumi.Input[str]] = None,
                 poll_till: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_log_analytics_object_collection_rule = oci.LogAnalyticsLogAnalyticsObjectCollectionRule("testLogAnalyticsObjectCollectionRule",
        ...
        :param pulumi.Input[str] os_bucket_name: Name of the Object Storage bucket.
        :param pulumi.Input[str] os_namespace: Object Storage namespace.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LogAnalyticsLogAnalyticsObjectCollectionRuleOverrideArgs']]]] overrides: (Updatable) The override is used to modify some important configuration properties for objects matching a specific pattern inside the bucket. Supported propeties for override are - logSourceName, charEncoding. Supported matchType for override are "contains".
        :param pulumi.Input[str] poll_since: The oldest time of the file in the bucket to consider for collection. Accepted values are: BEGINNING or CURRENT_TIME or RFC3339 formatted datetime string. When collectionType is LIVE, specifying pollSince value other than CURRENT_TIME will result in error.
        :param pulumi.Input[str] poll_till: The oldest time of the file in the bucket to consider for collection. Accepted values are: CURRENT_TIME or RFC3339 formatted datetime string. When collectionType is LIVE, specifying pollTill will result in error.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LogAnalyticsLogAnalyticsObjectCollectionRuleArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Log Analytics Object Collection Rule resource in Oracle Cloud Infrastructure Log Analytics service.
        ...
        :param str resource_name: The name of the resource.
        :param LogAnalyticsLogAnalyticsObjectCollectionRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LogAnalyticsLogAnalyticsObjectCollectionRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LogAnalyticsLogAnalyticsObjectCollectionRuleArgs.__new__(LogAnalyticsLogAnalyticsObjectCollectionRuleArgs)
        ...
        super(LogAnalyticsLogAnalyticsObjectCollectionRule, __self__).__init__(
            'oci:index/logAnalyticsLogAnalyticsObjectCollectionRule:LogAnalyticsLogAnalyticsObjectCollectionRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'LogAnalyticsLogAnalyticsObjectCollectionRule':
        """
        ...
        __props__ = _LogAnalyticsLogAnalyticsObjectCollectionRuleState.__new__(_LogAnalyticsLogAnalyticsObjectCollectionRuleState)
        ...
        return LogAnalyticsLogAnalyticsObjectCollectionRule(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def overrides(self) -> pulumi.Output[Sequence['outputs.LogAnalyticsLogAnalyticsObjectCollectionRuleOverride']]:
        """
        (Updatable) The override is used to modify some important configuration properties for objects matching a specific pattern inside the bucket. Supported propeties for override are - logSourceName, charEncoding. Supported matchType for override are "contains".
        """
        return pulumi.get(self, "overrides")
