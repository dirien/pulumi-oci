...
__all__ = [
    'GetDatabaseExadataIormConfigResult',
    'AwaitableGetDatabaseExadataIormConfigResult',
    'get_database_exadata_iorm_config',
]

@pulumi.output_type
class GetDatabaseExadataIormConfigResult:
    """
    ...
    def db_plans(self) -> Sequence['outputs.GetDatabaseExadataIormConfigDbPlanResult']:
        """
...
class AwaitableGetDatabaseExadataIormConfigResult(GetDatabaseExadataIormConfigResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExadataIormConfigResult(
...
def get_database_exadata_iorm_config(db_system_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExadataIormConfigResult:
    """
    ...
    **Note:** Deprecated for Exadata Cloud Service systems. Use the [new resource model APIs](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model) instead.
    ...
    test_exadata_iorm_config = oci.get_database_exadata_iorm_config(db_system_id=oci_database_db_system["test_db_system"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExadataIormConfig:GetDatabaseExadataIormConfig', __args__, opts=opts, typ=GetDatabaseExadataIormConfigResult).value

    return AwaitableGetDatabaseExadataIormConfigResult(
