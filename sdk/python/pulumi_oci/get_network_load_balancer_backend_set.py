...
__all__ = [
    'GetNetworkLoadBalancerBackendSetResult',
    'AwaitableGetNetworkLoadBalancerBackendSetResult',
    'get_network_load_balancer_backend_set',
]

@pulumi.output_type
class GetNetworkLoadBalancerBackendSetResult:
    """
    A collection of values returned by GetNetworkLoadBalancerBackendSet.
    """
    def __init__(__self__, backend_set_name=None, backends=None, health_checker=None, id=None, is_preserve_source=None, name=None, network_load_balancer_id=None, policy=None):
        ...
        if health_checker and not isinstance(health_checker, dict):
            raise TypeError("Expected argument 'health_checker' to be a dict")
    ...
    @property
    @pulumi.getter
    def backends(self) -> Sequence['outputs.GetNetworkLoadBalancerBackendSetBackendResult']:
        """
        Array of backends.
        """
    ...
    def health_checker(self) -> 'outputs.GetNetworkLoadBalancerBackendSetHealthCheckerResult':
        """
...
class AwaitableGetNetworkLoadBalancerBackendSetResult(GetNetworkLoadBalancerBackendSetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkLoadBalancerBackendSetResult(
...
def get_network_load_balancer_backend_set(backend_set_name: Optional[str] = None,
                                          network_load_balancer_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkLoadBalancerBackendSetResult:
    """
    ...
    test_backend_set = oci.get_network_load_balancer_backend_set(backend_set_name=oci_network_load_balancer_backend_set["test_backend_set"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNetworkLoadBalancerBackendSet:GetNetworkLoadBalancerBackendSet', __args__, opts=opts, typ=GetNetworkLoadBalancerBackendSetResult).value

    return AwaitableGetNetworkLoadBalancerBackendSetResult(
        backend_set_name=__ret__.backend_set_name,
        backends=__ret__.backends,
        health_checker=__ret__.health_checker,
        id=__ret__.id,
