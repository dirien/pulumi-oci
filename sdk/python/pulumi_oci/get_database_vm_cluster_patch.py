...
__all__ = [
    'GetDatabaseVmClusterPatchResult',
    'AwaitableGetDatabaseVmClusterPatchResult',
    'get_database_vm_cluster_patch',
]

@pulumi.output_type
class GetDatabaseVmClusterPatchResult:
    """
...
class AwaitableGetDatabaseVmClusterPatchResult(GetDatabaseVmClusterPatchResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterPatchResult(
...
def get_database_vm_cluster_patch(patch_id: Optional[str] = None,
                                  vm_cluster_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterPatchResult:
    """
    ...
    test_vm_cluster_patch = oci.get_database_vm_cluster_patch(patch_id=oci_database_patch["test_patch"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterPatch:GetDatabaseVmClusterPatch', __args__, opts=opts, typ=GetDatabaseVmClusterPatchResult).value

    return AwaitableGetDatabaseVmClusterPatchResult(
