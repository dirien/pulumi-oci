...
__all__ = [
    'GetOptimizerCategoriesResult',
    'AwaitableGetOptimizerCategoriesResult',
    'get_optimizer_categories',
]

@pulumi.output_type
class GetOptimizerCategoriesResult:
    """
    ...
    def category_collections(self) -> Sequence['outputs.GetOptimizerCategoriesCategoryCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOptimizerCategoriesFilterResult']]:
...
class AwaitableGetOptimizerCategoriesResult(GetOptimizerCategoriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerCategoriesResult(
...
def get_optimizer_categories(compartment_id: Optional[str] = None,
                             compartment_id_in_subtree: Optional[bool] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetOptimizerCategoriesFilterArgs']]] = None,
                             name: Optional[str] = None,
                             state: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerCategoriesResult:
    """
    ...
    test_categories = oci.get_optimizer_categories(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerCategories:GetOptimizerCategories', __args__, opts=opts, typ=GetOptimizerCategoriesResult).value

    return AwaitableGetOptimizerCategoriesResult(
