...
__all__ = ['IdentityTagArgs', 'IdentityTag']

@pulumi.input_type
class IdentityTagArgs:
    def __init__(__self__, *,
                 ...
                 validator: Optional[pulumi.Input['IdentityTagValidatorArgs']] = None):
        """
    ...
    @property
    @pulumi.getter
    def validator(self) -> Optional[pulumi.Input['IdentityTagValidatorArgs']]:
        """
    ...
    @validator.setter
    def validator(self, value: Optional[pulumi.Input['IdentityTagValidatorArgs']]):
        pulumi.set(self, "validator", value)


@pulumi.input_type
class _IdentityTagState:
    def __init__(__self__, *,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
...
class IdentityTag(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 tag_namespace_id: Optional[pulumi.Input[str]] = None,
                 validator: Optional[pulumi.Input[pulumi.InputType['IdentityTagValidatorArgs']]] = None,
                 __props__=None):
        """
        ...
        * If a `validator` is set, the user applying the tag to a resource must select from a list
        ...
        test_tag = oci.IdentityTag("testTag",
            ...
            validator=oci.IdentityTagValidatorArgs(
        ...
        :param pulumi.Input[str] name: The name you assign to the tag during creation. This is the tag key definition. The name must be unique within the tag namespace and cannot be changed.
        :param pulumi.Input[str] tag_namespace_id: The OCID of the tag namespace.
        :param pulumi.Input[pulumi.InputType['IdentityTagValidatorArgs']] validator: (Updatable) Validates a definedTag value. Each validator performs validation steps in addition to the standard validation for definedTag values. For more information, see [Limits on Tags](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/taggingoverview.htm#Limits).
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: IdentityTagArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Tag resource in Oracle Cloud Infrastructure Identity service.
        ...
        * If a `validator` is set, the user applying the tag to a resource must select from a list
        ...
        :param str resource_name: The name of the resource.
        :param IdentityTagArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdentityTagArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdentityTagArgs.__new__(IdentityTagArgs)
        ...
        super(IdentityTag, __self__).__init__(
            'oci:index/identityTag:IdentityTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tag_namespace_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            validator: Optional[pulumi.Input[pulumi.InputType['IdentityTagValidatorArgs']]] = None) -> 'IdentityTag':
        """
        ...
        __props__ = _IdentityTagState.__new__(_IdentityTagState)
        ...
        __props__.__dict__["validator"] = validator
        return IdentityTag(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def validator(self) -> pulumi.Output[Optional['outputs.IdentityTagValidator']]:
        """
        (Updatable) Validates a definedTag value. Each validator performs validation steps in addition to the standard validation for definedTag values. For more information, see [Limits on Tags](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/taggingoverview.htm#Limits).
        """
        return pulumi.get(self, "validator")
