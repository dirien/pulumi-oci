...
__all__ = ['DatabasePluggableDatabasesLocalCloneArgs', 'DatabasePluggableDatabasesLocalClone']

@pulumi.input_type
class DatabasePluggableDatabasesLocalCloneArgs:
...
@pulumi.input_type
class _DatabasePluggableDatabasesLocalCloneState:
    def __init__(__self__, *,
                 cloned_pdb_name: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 connection_strings: Optional[pulumi.Input['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs']] = None,
        ...
        :param pulumi.Input['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs'] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
    ...
    def connection_strings(self) -> Optional[pulumi.Input['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: Optional[pulumi.Input['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs']]):
...
class DatabasePluggableDatabasesLocalClone(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_pluggable_databases_local_clone = oci.DatabasePluggableDatabasesLocalClone("testPluggableDatabasesLocalClone",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabasePluggableDatabasesLocalCloneArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Pluggable Databases Local Clone resource in Oracle Cloud Infrastructure Database service. Although pluggable databases(PDB) belong to a container database(CDB), there is no change to the parent(CDB) as a result of this operation.
        ...
        :param str resource_name: The name of the resource.
        :param DatabasePluggableDatabasesLocalCloneArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabasePluggableDatabasesLocalCloneArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabasePluggableDatabasesLocalCloneArgs.__new__(DatabasePluggableDatabasesLocalCloneArgs)
        ...
        super(DatabasePluggableDatabasesLocalClone, __self__).__init__(
            'oci:index/databasePluggableDatabasesLocalClone:DatabasePluggableDatabasesLocalClone',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            cloned_pdb_name: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_strings: Optional[pulumi.Input[pulumi.InputType['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs']]] = None,
            container_database_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            is_restricted: Optional[pulumi.Input[bool]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            target_tde_wallet_password: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'DatabasePluggableDatabasesLocalClone':
        """
        ...
        :param pulumi.Input[str] cloned_pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[pulumi.InputType['DatabasePluggableDatabasesLocalCloneConnectionStringsArgs']] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
        :param pulumi.Input[str] container_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_restricted: The restricted mode of the pluggable database. If a pluggable database is opened in restricted mode, the user needs both create a session and have restricted session privileges to connect to it.
        ...
        __props__ = _DatabasePluggableDatabasesLocalCloneState.__new__(_DatabasePluggableDatabasesLocalCloneState)
        ...
        return DatabasePluggableDatabasesLocalClone(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Output['outputs.DatabasePluggableDatabasesLocalCloneConnectionStrings']:
        """
        Connection strings to connect to an Oracle Pluggable Database.
        """
        return pulumi.get(self, "connection_strings")
