...
__all__ = [
    'GetCoreDedicatedVmHostShapesResult',
    'AwaitableGetCoreDedicatedVmHostShapesResult',
    'get_core_dedicated_vm_host_shapes',
]

@pulumi.output_type
class GetCoreDedicatedVmHostShapesResult:
    """
    ...
    def dedicated_vm_host_shapes(self) -> Sequence['outputs.GetCoreDedicatedVmHostShapesDedicatedVmHostShapeResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDedicatedVmHostShapesFilterResult']]:
...
class AwaitableGetCoreDedicatedVmHostShapesResult(GetCoreDedicatedVmHostShapesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDedicatedVmHostShapesResult(
...
def get_core_dedicated_vm_host_shapes(availability_domain: Optional[str] = None,
                                      compartment_id: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetCoreDedicatedVmHostShapesFilterArgs']]] = None,
                                      instance_shape_name: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDedicatedVmHostShapesResult:
    """
    ...
    test_dedicated_vm_host_shapes = oci.get_core_dedicated_vm_host_shapes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDedicatedVmHostShapes:GetCoreDedicatedVmHostShapes', __args__, opts=opts, typ=GetCoreDedicatedVmHostShapesResult).value

    return AwaitableGetCoreDedicatedVmHostShapesResult(
