...
__all__ = [
    'GetEventsRuleResult',
    'AwaitableGetEventsRuleResult',
    'get_events_rule',
]

@pulumi.output_type
class GetEventsRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def actions(self) -> 'outputs.GetEventsRuleActionsResult':
        """
...
class AwaitableGetEventsRuleResult(GetEventsRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEventsRuleResult(
...
def get_events_rule(rule_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEventsRuleResult:
    """
    ...
    test_rule = oci.get_events_rule(rule_id=oci_events_rule["test_rule"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEventsRule:GetEventsRule', __args__, opts=opts, typ=GetEventsRuleResult).value

    return AwaitableGetEventsRuleResult(
