...
__all__ = ['DevopsDeployPipelineArgs', 'DevopsDeployPipeline']

@pulumi.input_type
class DevopsDeployPipelineArgs:
    def __init__(__self__, *,
                 project_id: pulumi.Input[str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_pipeline_parameters: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs']] = None,
        ...
        :param pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs'] deploy_pipeline_parameters: (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
    ...
    def deploy_pipeline_parameters(self) -> Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs']]:
        """
    ...
    def deploy_pipeline_parameters(self, value: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs']]):
...
@pulumi.input_type
class _DevopsDeployPipelineState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_pipeline_artifacts: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineArtifactsArgs']] = None,
                 deploy_pipeline_environments: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineEnvironmentsArgs']] = None,
                 deploy_pipeline_parameters: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs']] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input['DevopsDeployPipelineDeployPipelineArtifactsArgs'] deploy_pipeline_artifacts: List of all artifacts used in the pipeline.
        :param pulumi.Input['DevopsDeployPipelineDeployPipelineEnvironmentsArgs'] deploy_pipeline_environments: List of all environments used in the pipeline.
        :param pulumi.Input['DevopsDeployPipelineDeployPipelineParametersArgs'] deploy_pipeline_parameters: (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
        :param pulumi.Input[str] description: (Updatable) Optional description about the deployment pipeline.
        :param pulumi.Input[str] display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
    ...
    def deploy_pipeline_artifacts(self) -> Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineArtifactsArgs']]:
        """
    ...
    def deploy_pipeline_artifacts(self, value: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineArtifactsArgs']]):
        pulumi.set(self, "deploy_pipeline_artifacts", value)

    @property
    @pulumi.getter(name="deployPipelineEnvironments")
    def deploy_pipeline_environments(self) -> Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineEnvironmentsArgs']]:
        """
    ...
    def deploy_pipeline_environments(self, value: Optional[pulumi.Input['DevopsDeployPipelineDeployPipelineEnvironmentsArgs']]):
...
class DevopsDeployPipeline(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_pipeline_parameters: Optional[pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineParametersArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
        ...
        test_deploy_pipeline = oci.DevopsDeployPipeline("testDeployPipeline",
            project_id=oci_devops_project["test_project"]["id"],
            defined_tags={
                "foo-namespace.bar-key": "value",
            },
            deploy_pipeline_parameters=oci.DevopsDeployPipelineDeployPipelineParametersArgs(
                items=[oci.DevopsDeployPipelineDeployPipelineParametersItemArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineParametersArgs']] deploy_pipeline_parameters: (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
        :param pulumi.Input[str] description: (Updatable) Optional description about the deployment pipeline.
        :param pulumi.Input[str] display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[str] project_id: The OCID of a project.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DevopsDeployPipelineArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DevopsDeployPipelineArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DevopsDeployPipelineArgs.__new__(DevopsDeployPipelineArgs)
        ...
        super(DevopsDeployPipeline, __self__).__init__(
            'oci:index/devopsDeployPipeline:DevopsDeployPipeline',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            deploy_pipeline_artifacts: Optional[pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineArtifactsArgs']]] = None,
            deploy_pipeline_environments: Optional[pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineEnvironmentsArgs']]] = None,
            deploy_pipeline_parameters: Optional[pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineParametersArgs']]] = None,
            description: Optional[pulumi.Input[str]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'DevopsDeployPipeline':
        """
        ...
        :param pulumi.Input[str] compartment_id: The OCID of the compartment where the pipeline is created.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineArtifactsArgs']] deploy_pipeline_artifacts: List of all artifacts used in the pipeline.
        :param pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineEnvironmentsArgs']] deploy_pipeline_environments: List of all environments used in the pipeline.
        :param pulumi.Input[pulumi.InputType['DevopsDeployPipelineDeployPipelineParametersArgs']] deploy_pipeline_parameters: (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
        :param pulumi.Input[str] description: (Updatable) Optional description about the deployment pipeline.
        :param pulumi.Input[str] display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        ...
        __props__ = _DevopsDeployPipelineState.__new__(_DevopsDeployPipelineState)
        ...
        return DevopsDeployPipeline(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="deployPipelineArtifacts")
    def deploy_pipeline_artifacts(self) -> pulumi.Output['outputs.DevopsDeployPipelineDeployPipelineArtifacts']:
        """
        List of all artifacts used in the pipeline.
        """
        return pulumi.get(self, "deploy_pipeline_artifacts")
    ...
    @property
    @pulumi.getter(name="deployPipelineEnvironments")
    def deploy_pipeline_environments(self) -> pulumi.Output['outputs.DevopsDeployPipelineDeployPipelineEnvironments']:
        """
        List of all environments used in the pipeline.
        """
        return pulumi.get(self, "deploy_pipeline_environments")
    ...
    @property
    @pulumi.getter(name="deployPipelineParameters")
    def deploy_pipeline_parameters(self) -> pulumi.Output['outputs.DevopsDeployPipelineDeployPipelineParameters']:
        """
        (Updatable) Specifies list of parameters present in the deployment pipeline. In case of Update operation, replaces existing parameters list. Merging with existing parameters is not supported.
        """
        return pulumi.get(self, "deploy_pipeline_parameters")
