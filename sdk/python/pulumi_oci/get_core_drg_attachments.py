...
__all__ = [
    'GetCoreDrgAttachmentsResult',
    'AwaitableGetCoreDrgAttachmentsResult',
    'get_core_drg_attachments',
]

@pulumi.output_type
class GetCoreDrgAttachmentsResult:
    """
    ...
    def drg_attachments(self) -> Sequence['outputs.GetCoreDrgAttachmentsDrgAttachmentResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDrgAttachmentsFilterResult']]:
...
class AwaitableGetCoreDrgAttachmentsResult(GetCoreDrgAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDrgAttachmentsResult(
...
def get_core_drg_attachments(attachment_type: Optional[str] = None,
                             compartment_id: Optional[str] = None,
                             display_name: Optional[str] = None,
                             drg_id: Optional[str] = None,
                             drg_route_table_id: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetCoreDrgAttachmentsFilterArgs']]] = None,
                             network_id: Optional[str] = None,
                             state: Optional[str] = None,
                             vcn_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDrgAttachmentsResult:
    """
    ...
    test_drg_attachments = oci.get_core_drg_attachments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDrgAttachments:GetCoreDrgAttachments', __args__, opts=opts, typ=GetCoreDrgAttachmentsResult).value

    return AwaitableGetCoreDrgAttachmentsResult(
