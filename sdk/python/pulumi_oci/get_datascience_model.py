...
__all__ = [
    'GetDatascienceModelResult',
    'AwaitableGetDatascienceModelResult',
    'get_datascience_model',
]

@pulumi.output_type
class GetDatascienceModelResult:
    """
    ...
    def custom_metadata_lists(self) -> Sequence['outputs.GetDatascienceModelCustomMetadataListResult']:
        """
    ...
    def defined_metadata_lists(self) -> Sequence['outputs.GetDatascienceModelDefinedMetadataListResult']:
        """
...
class AwaitableGetDatascienceModelResult(GetDatascienceModelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceModelResult(
...
def get_datascience_model(model_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceModelResult:
    """
    ...
    test_model = oci.get_datascience_model(model_id=oci_datascience_model["test_model"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceModel:GetDatascienceModel', __args__, opts=opts, typ=GetDatascienceModelResult).value

    return AwaitableGetDatascienceModelResult(
