...
__all__ = [
    'GetDevopsDeployArtifactResult',
    'AwaitableGetDevopsDeployArtifactResult',
    'get_devops_deploy_artifact',
]

@pulumi.output_type
class GetDevopsDeployArtifactResult:
    """
    A collection of values returned by GetDevopsDeployArtifact.
    """
    def __init__(__self__, argument_substitution_mode=None, compartment_id=None, defined_tags=None, deploy_artifact_id=None, deploy_artifact_source=None, deploy_artifact_type=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, project_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if deploy_artifact_source and not isinstance(deploy_artifact_source, dict):
            raise TypeError("Expected argument 'deploy_artifact_source' to be a dict")
    ...
    def deploy_artifact_source(self) -> 'outputs.GetDevopsDeployArtifactDeployArtifactSourceResult':
        """
...
class AwaitableGetDevopsDeployArtifactResult(GetDevopsDeployArtifactResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployArtifactResult(
...
def get_devops_deploy_artifact(deploy_artifact_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployArtifactResult:
    """
    ...
    test_deploy_artifact = oci.get_devops_deploy_artifact(deploy_artifact_id=oci_devops_deploy_artifact["test_deploy_artifact"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployArtifact:GetDevopsDeployArtifact', __args__, opts=opts, typ=GetDevopsDeployArtifactResult).value

    return AwaitableGetDevopsDeployArtifactResult(
        argument_substitution_mode=__ret__.argument_substitution_mode,
        compartment_id=__ret__.compartment_id,
        defined_tags=__ret__.defined_tags,
        deploy_artifact_id=__ret__.deploy_artifact_id,
        deploy_artifact_source=__ret__.deploy_artifact_source,
