...
__all__ = [
    'GetIdentityUiPasswordResult',
    'AwaitableGetIdentityUiPasswordResult',
    'get_identity_ui_password',
]

@pulumi.output_type
class GetIdentityUiPasswordResult:
    """
...
class AwaitableGetIdentityUiPasswordResult(GetIdentityUiPasswordResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityUiPasswordResult(
            id=self.id,
...
def get_identity_ui_password(user_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityUiPasswordResult:
    """
    ...
    test_ui_password = oci.get_identity_ui_password(user_id=oci_identity_user["test_user"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityUiPassword:GetIdentityUiPassword', __args__, opts=opts, typ=GetIdentityUiPasswordResult).value

    return AwaitableGetIdentityUiPasswordResult(
        id=__ret__.id,
