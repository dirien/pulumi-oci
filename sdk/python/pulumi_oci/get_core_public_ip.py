...
__all__ = [
    'GetCorePublicIpResult',
    'AwaitableGetCorePublicIpResult',
    'get_core_public_ip',
]

@pulumi.output_type
class GetCorePublicIpResult:
    """
...
class AwaitableGetCorePublicIpResult(GetCorePublicIpResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePublicIpResult(
...
def get_core_public_ip(id: Optional[str] = None,
                       ip_address: Optional[str] = None,
                       private_ip_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePublicIpResult:
    """
    ...
    **Note:** If you're fetching a reserved public IP that is in the process of being
    ...
    test_oci_core_public_ip_by_id = oci.get_core_public_ip(id=var["test_public_ip_id"])
    ```
    ...
    test_oci_core_public_ip_by_private_ip_id = oci.get_core_public_ip(private_ip_id=var["test_public_ip_private_ip_id"])
    ```
    ...
    test_oci_core_public_ip_by_ip = oci.get_core_public_ip(ip_address=var["test_public_ip_ip_address"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePublicIp:GetCorePublicIp', __args__, opts=opts, typ=GetCorePublicIpResult).value

    return AwaitableGetCorePublicIpResult(
