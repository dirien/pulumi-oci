...
class AwaitableGetOceOceInstanceResult(GetOceOceInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOceOceInstanceResult(
...
def get_oce_oce_instance(oce_instance_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOceOceInstanceResult:
    """
    ...
    test_oce_instance = oci.get_oce_oce_instance(oce_instance_id=oci_oce_oce_instance["test_oce_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOceOceInstance:GetOceOceInstance', __args__, opts=opts, typ=GetOceOceInstanceResult).value

    return AwaitableGetOceOceInstanceResult(
