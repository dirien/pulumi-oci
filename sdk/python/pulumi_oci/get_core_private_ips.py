...
__all__ = [
    'GetCorePrivateIpsResult',
    'AwaitableGetCorePrivateIpsResult',
    'get_core_private_ips',
]

@pulumi.output_type
class GetCorePrivateIpsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCorePrivateIpsFilterResult']]:
    ...
    def private_ips(self) -> Sequence['outputs.GetCorePrivateIpsPrivateIpResult']:
        """
...
class AwaitableGetCorePrivateIpsResult(GetCorePrivateIpsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePrivateIpsResult(
...
def get_core_private_ips(filters: Optional[Sequence[pulumi.InputType['GetCorePrivateIpsFilterArgs']]] = None,
                         ip_address: Optional[str] = None,
                         subnet_id: Optional[str] = None,
                         vlan_id: Optional[str] = None,
                         vnic_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePrivateIpsResult:
    """
    ...
    test_private_ips_by_subnet = oci.get_core_private_ips(subnet_id=var["private_ip_subnet_id"])
    ```
    ```python
    import pulumi
    import pulumi_oci as oci

    test_private_ips_by_vnic = oci.get_core_private_ips(vnic_id=oci_core_vnic["test_vnic"]["id"])
    ```
    ```python
    import pulumi
    import pulumi_oci as oci

    test_private_ips_by_ip_address = oci.get_core_private_ips(ip_address=var["private_ip_ip_address"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePrivateIps:GetCorePrivateIps', __args__, opts=opts, typ=GetCorePrivateIpsResult).value

    return AwaitableGetCorePrivateIpsResult(
