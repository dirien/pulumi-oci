...
__all__ = [
    'GetMysqlMysqlDbSystemsResult',
    'AwaitableGetMysqlMysqlDbSystemsResult',
    'get_mysql_mysql_db_systems',
]

@pulumi.output_type
class GetMysqlMysqlDbSystemsResult:
    """
    ...
    def db_systems(self) -> Sequence['outputs.GetMysqlMysqlDbSystemsDbSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMysqlMysqlDbSystemsFilterResult']]:
...
class AwaitableGetMysqlMysqlDbSystemsResult(GetMysqlMysqlDbSystemsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlMysqlDbSystemsResult(
...
def get_mysql_mysql_db_systems(compartment_id: Optional[str] = None,
                               configuration_id: Optional[str] = None,
                               db_system_id: Optional[str] = None,
                               display_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetMysqlMysqlDbSystemsFilterArgs']]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlMysqlDbSystemsResult:
    """
    ...
    test_mysql_db_systems = oci.get_mysql_mysql_db_systems(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlMysqlDbSystems:GetMysqlMysqlDbSystems', __args__, opts=opts, typ=GetMysqlMysqlDbSystemsResult).value

    return AwaitableGetMysqlMysqlDbSystemsResult(
