...
__all__ = [
    'GetAnalyticsAnalyticsInstancePrivateAccessChannelResult',
    'AwaitableGetAnalyticsAnalyticsInstancePrivateAccessChannelResult',
    'get_analytics_analytics_instance_private_access_channel',
]

@pulumi.output_type
class GetAnalyticsAnalyticsInstancePrivateAccessChannelResult:
    """
    ...
    def private_source_dns_zones(self) -> Sequence['outputs.GetAnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneResult']:
        """
...
class AwaitableGetAnalyticsAnalyticsInstancePrivateAccessChannelResult(GetAnalyticsAnalyticsInstancePrivateAccessChannelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAnalyticsAnalyticsInstancePrivateAccessChannelResult(
...
def get_analytics_analytics_instance_private_access_channel(analytics_instance_id: Optional[str] = None,
                                                            private_access_channel_key: Optional[str] = None,
                                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnalyticsAnalyticsInstancePrivateAccessChannelResult:
    """
    ...
    test_analytics_instance_private_access_channel = oci.get_analytics_analytics_instance_private_access_channel(analytics_instance_id=oci_analytics_analytics_instance["test_analytics_instance"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getAnalyticsAnalyticsInstancePrivateAccessChannel:GetAnalyticsAnalyticsInstancePrivateAccessChannel', __args__, opts=opts, typ=GetAnalyticsAnalyticsInstancePrivateAccessChannelResult).value

    return AwaitableGetAnalyticsAnalyticsInstancePrivateAccessChannelResult(
