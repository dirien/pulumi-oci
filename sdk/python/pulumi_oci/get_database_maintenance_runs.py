...
__all__ = [
    'GetDatabaseMaintenanceRunsResult',
    'AwaitableGetDatabaseMaintenanceRunsResult',
    'get_database_maintenance_runs',
]

@pulumi.output_type
class GetDatabaseMaintenanceRunsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseMaintenanceRunsFilterResult']]:
    ...
    def maintenance_runs(self) -> Sequence['outputs.GetDatabaseMaintenanceRunsMaintenanceRunResult']:
        """
...
class AwaitableGetDatabaseMaintenanceRunsResult(GetDatabaseMaintenanceRunsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseMaintenanceRunsResult(
...
def get_database_maintenance_runs(availability_domain: Optional[str] = None,
                                  compartment_id: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetDatabaseMaintenanceRunsFilterArgs']]] = None,
                                  maintenance_type: Optional[str] = None,
                                  state: Optional[str] = None,
                                  target_resource_id: Optional[str] = None,
                                  target_resource_type: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseMaintenanceRunsResult:
    """
    ...
    test_maintenance_runs = oci.get_database_maintenance_runs(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseMaintenanceRuns:GetDatabaseMaintenanceRuns', __args__, opts=opts, typ=GetDatabaseMaintenanceRunsResult).value

    return AwaitableGetDatabaseMaintenanceRunsResult(
