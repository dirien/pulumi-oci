...
__all__ = [
    'GetAuditConfigurationResult',
    'AwaitableGetAuditConfigurationResult',
    'get_audit_configuration',
]

@pulumi.output_type
class GetAuditConfigurationResult:
    """
...
class AwaitableGetAuditConfigurationResult(GetAuditConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAuditConfigurationResult(
            compartment_id=self.compartment_id,
            id=self.id,
            retention_period_days=self.retention_period_days)


def get_audit_configuration(compartment_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuditConfigurationResult:
    """
    ...
    test_configuration = oci.get_audit_configuration(compartment_id=var["tenancy_ocid"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getAuditConfiguration:GetAuditConfiguration', __args__, opts=opts, typ=GetAuditConfigurationResult).value

    return AwaitableGetAuditConfigurationResult(
