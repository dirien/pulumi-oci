...
__all__ = ['NetworkLoadBalancerListenerArgs', 'NetworkLoadBalancerListener']

@pulumi.input_type
class NetworkLoadBalancerListenerArgs:
...
@pulumi.input_type
class _NetworkLoadBalancerListenerState:
    def __init__(__self__, *,
...
class NetworkLoadBalancerListener(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_listener = oci.NetworkLoadBalancerListener("testListener",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: NetworkLoadBalancerListenerArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Listener resource in Oracle Cloud Infrastructure Network Load Balancer service.
        ...
        :param str resource_name: The name of the resource.
        :param NetworkLoadBalancerListenerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NetworkLoadBalancerListenerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NetworkLoadBalancerListenerArgs.__new__(NetworkLoadBalancerListenerArgs)
        ...
        super(NetworkLoadBalancerListener, __self__).__init__(
            'oci:index/networkLoadBalancerListener:NetworkLoadBalancerListener',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            network_load_balancer_id: Optional[pulumi.Input[str]] = None,
            port: Optional[pulumi.Input[int]] = None,
            protocol: Optional[pulumi.Input[str]] = None) -> 'NetworkLoadBalancerListener':
        """
        ...
        __props__ = _NetworkLoadBalancerListenerState.__new__(_NetworkLoadBalancerListenerState)
        ...
        __props__.__dict__["port"] = port
        __props__.__dict__["protocol"] = protocol
        return NetworkLoadBalancerListener(resource_name, opts=opts, __props__=__props__)
