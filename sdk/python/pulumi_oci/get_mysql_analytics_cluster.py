...
__all__ = [
    'GetMysqlAnalyticsClusterResult',
    'AwaitableGetMysqlAnalyticsClusterResult',
    'get_mysql_analytics_cluster',
]

@pulumi.output_type
class GetMysqlAnalyticsClusterResult:
    """
    ...
    def cluster_nodes(self) -> Sequence['outputs.GetMysqlAnalyticsClusterClusterNodeResult']:
        """
...
class AwaitableGetMysqlAnalyticsClusterResult(GetMysqlAnalyticsClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlAnalyticsClusterResult(
...
def get_mysql_analytics_cluster(db_system_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlAnalyticsClusterResult:
    """
    ...
    test_analytics_cluster = oci.get_mysql_analytics_cluster(db_system_id=oci_database_db_system["test_db_system"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlAnalyticsCluster:GetMysqlAnalyticsCluster', __args__, opts=opts, typ=GetMysqlAnalyticsClusterResult).value

    return AwaitableGetMysqlAnalyticsClusterResult(
