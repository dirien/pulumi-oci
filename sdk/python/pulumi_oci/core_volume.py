...
__all__ = ['CoreVolumeArgs', 'CoreVolume']

@pulumi.input_type
class CoreVolumeArgs:
    def __init__(__self__, *,
                 availability_domain: pulumi.Input[str],
                 compartment_id: pulumi.Input[str],
                 backup_policy_id: Optional[pulumi.Input[str]] = None,
                 block_volume_replicas: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBlockVolumeReplicaArgs']]]] = None,
                 ...
                 source_details: Optional[pulumi.Input['CoreVolumeSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreVolumeBlockVolumeReplicaArgs']]] block_volume_replicas: (Updatable) The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
        :param pulumi.Input[bool] block_volume_replicas_deletion: (updatable) The boolean value, if you have replicas and want to disable replicas set this argument to true and remove `block_volume_replicas` in representation at the same time. If you want to enable a new replicas, remove this argument and use `block_volume_replicas` again.
        ...
        :param pulumi.Input[str] volume_backup_id: The OCID of the volume backup from which the data should be restored on the newly created volume. This field is deprecated. Use the `source_details` field instead to specify the backup for the volume.
    ...
    def block_volume_replicas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBlockVolumeReplicaArgs']]]]:
        """
    ...
    def block_volume_replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBlockVolumeReplicaArgs']]]]):
    ...
    def source_details(self) -> Optional[pulumi.Input['CoreVolumeSourceDetailsArgs']]:
        return pulumi.get(self, "source_details")

    @source_details.setter
    def source_details(self, value: Optional[pulumi.Input['CoreVolumeSourceDetailsArgs']]):
...
class CoreVolume(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 availability_domain: Optional[pulumi.Input[str]] = None,
                 backup_policy_id: Optional[pulumi.Input[str]] = None,
                 block_volume_replicas: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeBlockVolumeReplicaArgs']]]]] = None,
                 block_volume_replicas_deletion: Optional[pulumi.Input[bool]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 size_in_gbs: Optional[pulumi.Input[str]] = None,
                 size_in_mbs: Optional[pulumi.Input[str]] = None,
                 source_details: Optional[pulumi.Input[pulumi.InputType['CoreVolumeSourceDetailsArgs']]] = None,
                 volume_backup_id: Optional[pulumi.Input[str]] = None,
                 vpus_per_gb: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_volume = oci.CoreVolume("testVolume",
            compartment_id=var["compartment_id"],
            availability_domain=var["volume_availability_domain"],
            backup_policy_id=data["oci_core_volume_backup_policies"]["test_volume_backup_policies"]["volume_backup_policies"][0]["id"],
            block_volume_replicas=[oci.CoreVolumeBlockVolumeReplicaArgs(
            ...
            source_details=oci.CoreVolumeSourceDetailsArgs(
        ...
        :param pulumi.Input[str] availability_domain: (Updatable) The availability domain of the block volume replica.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[str] backup_policy_id: If provided, specifies the ID of the volume backup policy to assign to the newly created volume. If omitted, no policy will be assigned.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeBlockVolumeReplicaArgs']]]] block_volume_replicas: (Updatable) The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
        :param pulumi.Input[bool] block_volume_replicas_deletion: (updatable) The boolean value, if you have replicas and want to disable replicas set this argument to true and remove `block_volume_replicas` in representation at the same time. If you want to enable a new replicas, remove this argument and use `block_volume_replicas` again.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment that contains the volume.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeArgs.__new__(CoreVolumeArgs)
        ...
        super(CoreVolume, __self__).__init__(
            'oci:index/coreVolume:CoreVolume',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            volume_backup_id: Optional[pulumi.Input[str]] = None,
            volume_group_id: Optional[pulumi.Input[str]] = None,
            vpus_per_gb: Optional[pulumi.Input[str]] = None) -> 'CoreVolume':
        """
        ...
        __props__ = _CoreVolumeState.__new__(_CoreVolumeState)
        ...
        __props__.__dict__["vpus_per_gb"] = vpus_per_gb
        return CoreVolume(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="blockVolumeReplicas")
    def block_volume_replicas(self) -> pulumi.Output[Sequence['outputs.CoreVolumeBlockVolumeReplica']]:
        """
        (Updatable) The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
        """
        return pulumi.get(self, "block_volume_replicas")
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output['outputs.CoreVolumeSourceDetails']:
        return pulumi.get(self, "source_details")
