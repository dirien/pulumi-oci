...
__all__ = [
    'GetManagementAgentManagementAgentInstallKeyResult',
    'AwaitableGetManagementAgentManagementAgentInstallKeyResult',
    'get_management_agent_management_agent_install_key',
]

@pulumi.output_type
class GetManagementAgentManagementAgentInstallKeyResult:
    """
    A collection of values returned by GetManagementAgentManagementAgentInstallKey.
    """
    def __init__(__self__, allowed_key_install_count=None, compartment_id=None, created_by_principal_id=None, current_key_install_count=None, display_name=None, id=None, key=None, lifecycle_details=None, management_agent_install_key_id=None, state=None, time_created=None, time_expires=None, time_updated=None):
...
class AwaitableGetManagementAgentManagementAgentInstallKeyResult(GetManagementAgentManagementAgentInstallKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagementAgentManagementAgentInstallKeyResult(
...
def get_management_agent_management_agent_install_key(management_agent_install_key_id: Optional[str] = None,
                                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementAgentManagementAgentInstallKeyResult:
    """
    ...
    test_management_agent_install_key = oci.get_management_agent_management_agent_install_key(management_agent_install_key_id=oci_management_agent_management_agent_install_key["test_management_agent_install_key"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getManagementAgentManagementAgentInstallKey:GetManagementAgentManagementAgentInstallKey', __args__, opts=opts, typ=GetManagementAgentManagementAgentInstallKeyResult).value

    return AwaitableGetManagementAgentManagementAgentInstallKeyResult(
