...
__all__ = [
    'GetDatabaseDataGuardAssociationResult',
    'AwaitableGetDatabaseDataGuardAssociationResult',
    'get_database_data_guard_association',
]

@pulumi.output_type
class GetDatabaseDataGuardAssociationResult:
    """
...
class AwaitableGetDatabaseDataGuardAssociationResult(GetDatabaseDataGuardAssociationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDataGuardAssociationResult(
...
def get_database_data_guard_association(data_guard_association_id: Optional[str] = None,
                                        database_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDataGuardAssociationResult:
    """
    ...
    test_data_guard_association = oci.get_database_data_guard_association(data_guard_association_id=oci_database_data_guard_association["test_data_guard_association"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDataGuardAssociation:GetDatabaseDataGuardAssociation', __args__, opts=opts, typ=GetDatabaseDataGuardAssociationResult).value

    return AwaitableGetDatabaseDataGuardAssociationResult(
