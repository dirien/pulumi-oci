...
class _ResourceActionState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input['ResourceActionActionArgs']] = None,
        ...
        :param pulumi.Input['ResourceActionActionArgs'] action: Details about the recommended action.
    ...
    @property
    @pulumi.getter
    def action(self) -> Optional[pulumi.Input['ResourceActionActionArgs']]:
        """
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input['ResourceActionActionArgs']]):
...
class ResourceAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            action: Optional[pulumi.Input[pulumi.InputType['ResourceActionActionArgs']]] = None,
            category_id: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            compartment_name: Optional[pulumi.Input[str]] = None,
            estimated_cost_saving: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['ResourceActionActionArgs']] action: Details about the recommended action.
        :param pulumi.Input[str] category_id: The unique OCID associated with the category.
        :param pulumi.Input[str] compartment_id: The OCID of the compartment.
        :param pulumi.Input[str] compartment_name: The name associated with the compartment.
        :param pulumi.Input[float] estimated_cost_saving: The estimated cost savings, in dollars, for the resource action.
    ...
    @property
    @pulumi.getter
    def action(self) -> pulumi.Output['outputs.ResourceActionAction']:
        """
        Details about the recommended action.
        """
        return pulumi.get(self, "action")
