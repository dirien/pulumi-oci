...
class ProfileLevelsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['ProfileLevelsConfigurationItemArgs']]] items: (Updatable) The list of target tags attached to the current profile override.
        """
...
class ProfileTargetTagsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['ProfileTargetTagsItemArgs']]] items: (Updatable) The list of target tags attached to the current profile override.
        """
        pulumi.set(__self__, "items", items)
...
@pulumi.input_type
class RecommendationSupportedLevelsArgs:
    def __init__(__self__, *,
                 items: Optional[pulumi.Input[Sequence[pulumi.Input['RecommendationSupportedLevelsItemArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['RecommendationSupportedLevelsItemArgs']]] items: The list of supported levels.
        """
        if items is not None:
            pulumi.set(__self__, "items", items)
    ...
    @property
    @pulumi.getter
    def items(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RecommendationSupportedLevelsItemArgs']]]]:
        """
    ...
    @items.setter
    def items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RecommendationSupportedLevelsItemArgs']]]]):
        pulumi.set(self, "items", value)


@pulumi.input_type
class RecommendationSupportedLevelsItemArgs:
    def __init__(__self__, *,
