...
class ProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProfileTargetCompartmentsArgs'] target_compartments: (Updatable) Optional. The target compartments supported by a profile override for a recommendation.
        :param pulumi.Input['ProfileTargetTagsArgs'] target_tags: (Updatable) Optional. The target tags supported by a profile override for a recommendation.
        """
...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: (Updatable) The name assigned to the profile. Avoid entering confidential information.
        :param pulumi.Input[pulumi.InputType['ProfileTargetCompartmentsArgs']] target_compartments: (Updatable) Optional. The target compartments supported by a profile override for a recommendation.
        :param pulumi.Input[pulumi.InputType['ProfileTargetTagsArgs']] target_tags: (Updatable) Optional. The target tags supported by a profile override for a recommendation.
        """
        ...
    @overload
    def __init__(__self__,
