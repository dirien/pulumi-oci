...
__all__ = [
    'GetDataflowInvokeRunsResult',
    'AwaitableGetDataflowInvokeRunsResult',
    'get_dataflow_invoke_runs',
]

@pulumi.output_type
class GetDataflowInvokeRunsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDataflowInvokeRunsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def runs(self) -> Sequence['outputs.GetDataflowInvokeRunsRunResult']:
        """
        The list of runs.
        """
...
class AwaitableGetDataflowInvokeRunsResult(GetDataflowInvokeRunsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowInvokeRunsResult(
...
def get_dataflow_invoke_runs(application_id: Optional[str] = None,
                             compartment_id: Optional[str] = None,
                             display_name: Optional[str] = None,
                             display_name_starts_with: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetDataflowInvokeRunsFilterArgs']]] = None,
                             owner_principal_id: Optional[str] = None,
                             state: Optional[str] = None,
                             time_created_greater_than: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowInvokeRunsResult:
    """
    ...
    test_invoke_runs = oci.get_dataflow_invoke_runs(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowInvokeRuns:GetDataflowInvokeRuns', __args__, opts=opts, typ=GetDataflowInvokeRunsResult).value

    return AwaitableGetDataflowInvokeRunsResult(
