...
class GetIdentityUserResult:
    ...
    """
    def __init__(__self__, capabilities=None, compartment_id=None, defined_tags=None, description=None, email=None, email_verified=None, external_identifier=None, freeform_tags=None, id=None, identity_provider_id=None, inactive_state=None, last_successful_login_time=None, name=None, previous_successful_login_time=None, state=None, time_created=None, user_id=None):
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> 'outputs.GetIdentityUserCapabilitiesResult':
        """
...
def get_identity_user(user_id: Optional[str] = None,
    ...
    test_user = oci.get_identity_user(user_id=oci_identity_user["test_user"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityUser:GetIdentityUser', __args__, opts=opts, typ=GetIdentityUserResult).value
