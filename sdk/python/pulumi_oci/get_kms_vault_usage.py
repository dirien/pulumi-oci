...
__all__ = [
    'GetKmsVaultUsageResult',
    'AwaitableGetKmsVaultUsageResult',
    'get_kms_vault_usage',
]

@pulumi.output_type
class GetKmsVaultUsageResult:
    """
...
class AwaitableGetKmsVaultUsageResult(GetKmsVaultUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsVaultUsageResult(
            id=self.id,
...
def get_kms_vault_usage(vault_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsVaultUsageResult:
    """
    ...
    test_vault_usage = oci.get_kms_vault_usage(vault_id=oci_kms_vault["test_vault"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsVaultUsage:GetKmsVaultUsage', __args__, opts=opts, typ=GetKmsVaultUsageResult).value

    return AwaitableGetKmsVaultUsageResult(
        id=__ret__.id,
