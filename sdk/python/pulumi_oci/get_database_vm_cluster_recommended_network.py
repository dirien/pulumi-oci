...
__all__ = [
    'GetDatabaseVmClusterRecommendedNetworkResult',
    'AwaitableGetDatabaseVmClusterRecommendedNetworkResult',
    'get_database_vm_cluster_recommended_network',
]

@pulumi.output_type
class GetDatabaseVmClusterRecommendedNetworkResult:
    """
    A collection of values returned by GetDatabaseVmClusterRecommendedNetwork.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, dns=None, exadata_infrastructure_id=None, freeform_tags=None, id=None, networks=None, ntps=None, scans=None, vm_networks=None):
    ...
    @property
    @pulumi.getter
    def networks(self) -> Sequence['outputs.GetDatabaseVmClusterRecommendedNetworkNetworkResult']:
    ...
    @property
    @pulumi.getter
    def scans(self) -> Sequence['outputs.GetDatabaseVmClusterRecommendedNetworkScanResult']:
        """
        The SCAN details.
        """
    ...
    def vm_networks(self) -> Sequence['outputs.GetDatabaseVmClusterRecommendedNetworkVmNetworkResult']:
        """
...
class AwaitableGetDatabaseVmClusterRecommendedNetworkResult(GetDatabaseVmClusterRecommendedNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterRecommendedNetworkResult(
...
def get_database_vm_cluster_recommended_network(compartment_id: Optional[str] = None,
                                                defined_tags: Optional[Mapping[str, Any]] = None,
                                                display_name: Optional[str] = None,
                                                dns: Optional[Sequence[str]] = None,
                                                exadata_infrastructure_id: Optional[str] = None,
                                                freeform_tags: Optional[Mapping[str, Any]] = None,
                                                networks: Optional[Sequence[pulumi.InputType['GetDatabaseVmClusterRecommendedNetworkNetworkArgs']]] = None,
                                                ntps: Optional[Sequence[str]] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterRecommendedNetworkResult:
    """
    ...
    :param Sequence[pulumi.InputType['GetDatabaseVmClusterRecommendedNetworkNetworkArgs']] networks: List of parameters for generation of the client and backup networks.
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterRecommendedNetwork:GetDatabaseVmClusterRecommendedNetwork', __args__, opts=opts, typ=GetDatabaseVmClusterRecommendedNetworkResult).value

    return AwaitableGetDatabaseVmClusterRecommendedNetworkResult(
