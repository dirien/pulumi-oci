...
__all__ = ['AnalyticsAnalyticsInstancePrivateAccessChannelArgs', 'AnalyticsAnalyticsInstancePrivateAccessChannel']

@pulumi.input_type
class AnalyticsAnalyticsInstancePrivateAccessChannelArgs:
    def __init__(__self__, *,
                 analytics_instance_id: pulumi.Input[str],
                 display_name: pulumi.Input[str],
                 private_source_dns_zones: pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]],
    ...
    def private_source_dns_zones(self) -> pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]:
        """
    ...
    def private_source_dns_zones(self, value: pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]):
...
@pulumi.input_type
class _AnalyticsAnalyticsInstancePrivateAccessChannelState:
    def __init__(__self__, *,
                 ...
                 private_source_dns_zones: Optional[pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]] = None,
    ...
    @property
    @pulumi.getter(name="privateSourceDnsZones")
    def private_source_dns_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]]:
        """
        (Updatable) List of Private Source DNS zones registered with Private Access Channel, where datasource hostnames from these dns zones / domains will be resolved in the peered VCN for access from Analytics Instance. Min of 1 is required and Max of 30 Private Source DNS zones can be registered.
        """
        return pulumi.get(self, "private_source_dns_zones")
    ...
    @private_source_dns_zones.setter
    def private_source_dns_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]]):
        pulumi.set(self, "private_source_dns_zones", value)
...
class AnalyticsAnalyticsInstancePrivateAccessChannel(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 analytics_instance_id: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 private_source_dns_zones: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]]] = None,
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 vcn_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_analytics_instance_private_access_channel = oci.AnalyticsAnalyticsInstancePrivateAccessChannel("testAnalyticsInstancePrivateAccessChannel",
            ...
            private_source_dns_zones=[oci.AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs(
        ...
        :param pulumi.Input[str] analytics_instance_id: The OCID of the AnalyticsInstance.
        :param pulumi.Input[str] display_name: (Updatable) Display Name of the Private Access Channel.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]] private_source_dns_zones: (Updatable) List of Private Source DNS zones registered with Private Access Channel, where datasource hostnames from these dns zones / domains will be resolved in the peered VCN for access from Analytics Instance. Min of 1 is required and Max of 30 Private Source DNS zones can be registered.
        :param pulumi.Input[str] subnet_id: (Updatable) OCID of the customer subnet connected to private access channel.
        :param pulumi.Input[str] vcn_id: (Updatable) OCID of the customer VCN peered with private access channel.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AnalyticsAnalyticsInstancePrivateAccessChannelArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Analytics Instance Private Access Channel resource in Oracle Cloud Infrastructure Analytics service.
        ...
        :param str resource_name: The name of the resource.
        :param AnalyticsAnalyticsInstancePrivateAccessChannelArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AnalyticsAnalyticsInstancePrivateAccessChannelArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AnalyticsAnalyticsInstancePrivateAccessChannelArgs.__new__(AnalyticsAnalyticsInstancePrivateAccessChannelArgs)
        ...
        super(AnalyticsAnalyticsInstancePrivateAccessChannel, __self__).__init__(
            'oci:index/analyticsAnalyticsInstancePrivateAccessChannel:AnalyticsAnalyticsInstancePrivateAccessChannel',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            private_source_dns_zones: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]]]] = None,
            subnet_id: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'AnalyticsAnalyticsInstancePrivateAccessChannel':
        """
        ...
        __props__ = _AnalyticsAnalyticsInstancePrivateAccessChannelState.__new__(_AnalyticsAnalyticsInstancePrivateAccessChannelState)
        ...
        __props__.__dict__["subnet_id"] = subnet_id
        __props__.__dict__["vcn_id"] = vcn_id
        return AnalyticsAnalyticsInstancePrivateAccessChannel(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="privateSourceDnsZones")
    def private_source_dns_zones(self) -> pulumi.Output[Sequence['outputs.AnalyticsAnalyticsInstancePrivateAccessChannelPrivateSourceDnsZone']]:
        """
        (Updatable) List of Private Source DNS zones registered with Private Access Channel, where datasource hostnames from these dns zones / domains will be resolved in the peered VCN for access from Analytics Instance. Min of 1 is required and Max of 30 Private Source DNS zones can be registered.
        """
        return pulumi.get(self, "private_source_dns_zones")
