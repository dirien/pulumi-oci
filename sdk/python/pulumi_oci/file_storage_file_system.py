...
__all__ = ['FileStorageFileSystemArgs', 'FileStorageFileSystem']

@pulumi.input_type
class FileStorageFileSystemArgs:
...
@pulumi.input_type
class _FileStorageFileSystemState:
    def __init__(__self__, *,
                 ...
                 source_details: Optional[pulumi.Input['FileStorageFileSystemSourceDetailsArgs']] = None,
                 source_snapshot_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input['FileStorageFileSystemSourceDetailsArgs'] source_details: Source information for the file system.
        :param pulumi.Input[str] source_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the snapshot used to create a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningafilesystem.htm).
    ...
    def source_details(self) -> Optional[pulumi.Input['FileStorageFileSystemSourceDetailsArgs']]:
        """
    ...
    def source_details(self, value: Optional[pulumi.Input['FileStorageFileSystemSourceDetailsArgs']]):
...
class FileStorageFileSystem(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_file_system = oci.FileStorageFileSystem("testFileSystem",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FileStorageFileSystemArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the File System resource in Oracle Cloud Infrastructure File Storage service.
        ...
        :param str resource_name: The name of the resource.
        :param FileStorageFileSystemArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FileStorageFileSystemArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FileStorageFileSystemArgs.__new__(FileStorageFileSystemArgs)
        ...
        super(FileStorageFileSystem, __self__).__init__(
            'oci:index/fileStorageFileSystem:FileStorageFileSystem',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            metered_bytes: Optional[pulumi.Input[str]] = None,
            source_details: Optional[pulumi.Input[pulumi.InputType['FileStorageFileSystemSourceDetailsArgs']]] = None,
            source_snapshot_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'FileStorageFileSystem':
        """
        ...
        :param pulumi.Input[str] lifecycle_details: Additional information about the current 'lifecycleState'.
        :param pulumi.Input[str] metered_bytes: The number of bytes consumed by the file system, including any snapshots. This number reflects the metered size of the file system and is updated asynchronously with respect to updates to the file system. For more information, see [File System Usage and Metering](https://docs.cloud.oracle.com/iaas/Content/File/Concepts/FSutilization.htm).
        :param pulumi.Input[pulumi.InputType['FileStorageFileSystemSourceDetailsArgs']] source_details: Source information for the file system.
        :param pulumi.Input[str] source_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the snapshot used to create a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningafilesystem.htm).
        :param pulumi.Input[str] state: The current state of the file system.
        :param pulumi.Input[str] time_created: The date and time the file system was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
        ...
        __props__ = _FileStorageFileSystemState.__new__(_FileStorageFileSystemState)
        ...
        return FileStorageFileSystem(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output['outputs.FileStorageFileSystemSourceDetails']:
        """
        Source information for the file system.
        """
        return pulumi.get(self, "source_details")
