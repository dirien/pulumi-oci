...
class AwaitableGetGoldenGateDatabaseRegistrationResult(GetGoldenGateDatabaseRegistrationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGoldenGateDatabaseRegistrationResult(
...
def get_golden_gate_database_registration(database_registration_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGoldenGateDatabaseRegistrationResult:
    """
    ...
    test_database_registration = oci.get_golden_gate_database_registration(database_registration_id=oci_golden_gate_database_registration["test_database_registration"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getGoldenGateDatabaseRegistration:GetGoldenGateDatabaseRegistration', __args__, opts=opts, typ=GetGoldenGateDatabaseRegistrationResult).value

    return AwaitableGetGoldenGateDatabaseRegistrationResult(
