...
__all__ = [
    'GetLoadBalancerBackendSetHealthResult',
    'AwaitableGetLoadBalancerBackendSetHealthResult',
    'get_load_balancer_backend_set_health',
]

@pulumi.output_type
class GetLoadBalancerBackendSetHealthResult:
    """
...
class AwaitableGetLoadBalancerBackendSetHealthResult(GetLoadBalancerBackendSetHealthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerBackendSetHealthResult(
...
def get_load_balancer_backend_set_health(backend_set_name: Optional[str] = None,
                                         load_balancer_id: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerBackendSetHealthResult:
    """
    ...
    test_backend_set_health = oci.get_load_balancer_backend_set_health(backend_set_name=oci_load_balancer_backend_set["test_backend_set"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerBackendSetHealth:GetLoadBalancerBackendSetHealth', __args__, opts=opts, typ=GetLoadBalancerBackendSetHealthResult).value

    return AwaitableGetLoadBalancerBackendSetHealthResult(
