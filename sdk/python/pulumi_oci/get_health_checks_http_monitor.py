...
__all__ = [
    'GetHealthChecksHttpMonitorResult',
    'AwaitableGetHealthChecksHttpMonitorResult',
    'get_health_checks_http_monitor',
]

@pulumi.output_type
class GetHealthChecksHttpMonitorResult:
    """
...
class AwaitableGetHealthChecksHttpMonitorResult(GetHealthChecksHttpMonitorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHealthChecksHttpMonitorResult(
...
def get_health_checks_http_monitor(monitor_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthChecksHttpMonitorResult:
    """
    ...
    test_http_monitor = oci.get_health_checks_http_monitor(monitor_id=oci_apm_synthetics_monitor["test_monitor"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getHealthChecksHttpMonitor:GetHealthChecksHttpMonitor', __args__, opts=opts, typ=GetHealthChecksHttpMonitorResult).value

    return AwaitableGetHealthChecksHttpMonitorResult(
