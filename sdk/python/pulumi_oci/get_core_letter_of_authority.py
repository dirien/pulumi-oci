...
__all__ = [
    'GetCoreLetterOfAuthorityResult',
    'AwaitableGetCoreLetterOfAuthorityResult',
    'get_core_letter_of_authority',
]

@pulumi.output_type
class GetCoreLetterOfAuthorityResult:
    """
...
class AwaitableGetCoreLetterOfAuthorityResult(GetCoreLetterOfAuthorityResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreLetterOfAuthorityResult(
...
def get_core_letter_of_authority(cross_connect_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreLetterOfAuthorityResult:
    """
    ...
    test_letter_of_authority = oci.get_core_letter_of_authority(cross_connect_id=oci_core_cross_connect["test_cross_connect"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreLetterOfAuthority:GetCoreLetterOfAuthority', __args__, opts=opts, typ=GetCoreLetterOfAuthorityResult).value

    return AwaitableGetCoreLetterOfAuthorityResult(
