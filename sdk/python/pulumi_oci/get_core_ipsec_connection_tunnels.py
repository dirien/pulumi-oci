...
__all__ = [
    'GetCoreIpsecConnectionTunnelsResult',
    'AwaitableGetCoreIpsecConnectionTunnelsResult',
    'get_core_ipsec_connection_tunnels',
]

@pulumi.output_type
class GetCoreIpsecConnectionTunnelsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreIpsecConnectionTunnelsFilterResult']]:
    ...
    def ip_sec_connection_tunnels(self) -> Sequence['outputs.GetCoreIpsecConnectionTunnelsIpSecConnectionTunnelResult']:
        """
...
class AwaitableGetCoreIpsecConnectionTunnelsResult(GetCoreIpsecConnectionTunnelsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpsecConnectionTunnelsResult(
...
def get_core_ipsec_connection_tunnels(filters: Optional[Sequence[pulumi.InputType['GetCoreIpsecConnectionTunnelsFilterArgs']]] = None,
                                      ipsec_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpsecConnectionTunnelsResult:
    """
    ...
    test_ip_sec_connection_tunnels = oci.get_core_ipsec_connection_tunnels(ipsec_id=oci_core_ipsec["test_ipsec"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpsecConnectionTunnels:GetCoreIpsecConnectionTunnels', __args__, opts=opts, typ=GetCoreIpsecConnectionTunnelsResult).value

    return AwaitableGetCoreIpsecConnectionTunnelsResult(
