...
__all__ = ['DatabaseExadataInfrastructureArgs', 'DatabaseExadataInfrastructure']

@pulumi.input_type
class DatabaseExadataInfrastructureArgs:
    def __init__(__self__, *,
                 ...
                 contacts: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseExadataInfrastructureContactArgs']]]] = None,
                 corporate_proxy: Optional[pulumi.Input[str]] = None,
                 create_async: Optional[pulumi.Input[bool]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 maintenance_window: Optional[pulumi.Input['DatabaseExadataInfrastructureMaintenanceWindowArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DatabaseExadataInfrastructureContactArgs']]] contacts: (Updatable) The list of contacts for the Exadata infrastructure.
        ...
        :param pulumi.Input['DatabaseExadataInfrastructureMaintenanceWindowArgs'] maintenance_window: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    @property
    @pulumi.getter
    def contacts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseExadataInfrastructureContactArgs']]]]:
        """
    ...
    @contacts.setter
    def contacts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseExadataInfrastructureContactArgs']]]]):
    ...
    def maintenance_window(self) -> Optional[pulumi.Input['DatabaseExadataInfrastructureMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: Optional[pulumi.Input['DatabaseExadataInfrastructureMaintenanceWindowArgs']]):
...
@pulumi.input_type
class _DatabaseExadataInfrastructureState:
    def __init__(__self__, *,
...
class DatabaseExadataInfrastructure(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 compute_count: Optional[pulumi.Input[int]] = None,
                 contacts: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseExadataInfrastructureContactArgs']]]]] = None,
                 corporate_proxy: Optional[pulumi.Input[str]] = None,
                 create_async: Optional[pulumi.Input[bool]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 gateway: Optional[pulumi.Input[str]] = None,
                 infini_band_network_cidr: Optional[pulumi.Input[str]] = None,
                 maintenance_window: Optional[pulumi.Input[pulumi.InputType['DatabaseExadataInfrastructureMaintenanceWindowArgs']]] = None,
                 netmask: Optional[pulumi.Input[str]] = None,
                 ntp_servers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 shape: Optional[pulumi.Input[str]] = None,
                 storage_count: Optional[pulumi.Input[int]] = None,
        ...
        test_exadata_infrastructure = oci.DatabaseExadataInfrastructure("testExadataInfrastructure",
            ...
            contacts=[oci.DatabaseExadataInfrastructureContactArgs(
            ...
            maintenance_window=oci.DatabaseExadataInfrastructureMaintenanceWindowArgs(
                preference=var["exadata_infrastructure_maintenance_window_preference"],
                days_of_weeks=[oci.DatabaseExadataInfrastructureMaintenanceWindowDaysOfWeekArgs(
                ...
                months=[oci.DatabaseExadataInfrastructureMaintenanceWindowMonthArgs(
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[int] compute_count: The number of compute servers for the Exadata infrastructure.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseExadataInfrastructureContactArgs']]]] contacts: (Updatable) The list of contacts for the Exadata infrastructure.
        :param pulumi.Input[str] corporate_proxy: (Updatable) The corporate network proxy for access to the control plane network. Oracle recommends using an HTTPS proxy when possible for enhanced security.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: The user-friendly name for the Exadata infrastructure. The name does not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] dns_servers: (Updatable) The list of DNS server IP addresses. Maximum of 3 allowed.
        ...
        :param pulumi.Input[str] gateway: (Updatable) The gateway for the control plane network.
        :param pulumi.Input[str] infini_band_network_cidr: (Updatable) The CIDR block for the Exadata InfiniBand interconnect.
        :param pulumi.Input[pulumi.InputType['DatabaseExadataInfrastructureMaintenanceWindowArgs']] maintenance_window: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[str] netmask: (Updatable) The netmask for the control plane network.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ntp_servers: (Updatable) The list of NTP server IP addresses. Maximum of 3 allowed.
        :param pulumi.Input[str] shape: The shape of the Exadata infrastructure. The shape determines the amount of CPU, storage, and memory resources allocated to the instance.
        :param pulumi.Input[int] storage_count: The number of storage servers for the Exadata infrastructure.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseExadataInfrastructureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Exadata Infrastructure resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseExadataInfrastructureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseExadataInfrastructureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseExadataInfrastructureArgs.__new__(DatabaseExadataInfrastructureArgs)
        ...
        super(DatabaseExadataInfrastructure, __self__).__init__(
            'oci:index/databaseExadataInfrastructure:DatabaseExadataInfrastructure',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            storage_count: Optional[pulumi.Input[int]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_zone: Optional[pulumi.Input[str]] = None) -> 'DatabaseExadataInfrastructure':
        """
        ...
        __props__ = _DatabaseExadataInfrastructureState.__new__(_DatabaseExadataInfrastructureState)
        ...
        __props__.__dict__["time_zone"] = time_zone
        return DatabaseExadataInfrastructure(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def contacts(self) -> pulumi.Output[Optional[Sequence['outputs.DatabaseExadataInfrastructureContact']]]:
        """
        (Updatable) The list of contacts for the Exadata infrastructure.
        """
        return pulumi.get(self, "contacts")
    ...
    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output['outputs.DatabaseExadataInfrastructureMaintenanceWindow']:
        """
        (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window")
