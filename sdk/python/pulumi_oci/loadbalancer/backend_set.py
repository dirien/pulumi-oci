...
class BackendSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `oci_load_balancer_backendset`
        ...
        test_backend_set = oci.loadbalancer.BackendSet("testBackendSet",
            ...
            lb_cookie_session_persistence_configuration=oci.loadbalancer.BackendSetLbCookieSessionPersistenceConfigurationArgs(
            ...
            session_persistence_configuration=oci.loadbalancer.BackendSetSessionPersistenceConfigurationArgs(
            ...
            ssl_configuration=oci.loadbalancer.BackendSetSslConfigurationArgs(
