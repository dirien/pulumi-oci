...
__all__ = [
    ...
    'GetLoadBalancersLoadBalancerShapeDetailsResult',
...
class LoadBalancerIpAddressDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reserved_ip: Optional['outputs.LoadBalancerIpAddressDetailReservedIp'] = None):
        """
        :param str ip_address: An IP address.  Example: `192.168.0.3`
        :param bool is_public: Whether the IP address is public or private.
        :param 'LoadBalancerIpAddressDetailReservedIpArgs' reserved_ip: Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        """
    ...
    def reserved_ip(self) -> Optional['outputs.LoadBalancerIpAddressDetailReservedIp']:
        """
...
class GetBackendSetsBackendsetResult(dict):
    def __init__(__self__, *,
                 ...
                 health_checker: 'outputs.GetBackendSetsBackendsetHealthCheckerResult',
                 id: str,
                 lb_cookie_session_persistence_configuration: 'outputs.GetBackendSetsBackendsetLbCookieSessionPersistenceConfigurationResult',
                 load_balancer_id: str,
                 name: str,
                 policy: str,
                 session_persistence_configuration: 'outputs.GetBackendSetsBackendsetSessionPersistenceConfigurationResult',
                 ssl_configuration: 'outputs.GetBackendSetsBackendsetSslConfigurationResult',
                 state: str):
        """
        :param 'GetBackendSetsBackendsetHealthCheckerArgs' health_checker: The health check policy configuration. For more information, see [Editing Health Check Policies](https://docs.cloud.oracle.com/iaas/Content/Balance/Tasks/editinghealthcheck.htm).
        :param 'GetBackendSetsBackendsetLbCookieSessionPersistenceConfigurationArgs' lb_cookie_session_persistence_configuration: The configuration details for implementing load balancer cookie session persistence (LB cookie stickiness).
        ...
        :param 'GetBackendSetsBackendsetSessionPersistenceConfigurationArgs' session_persistence_configuration: The configuration details for implementing session persistence based on a user-specified cookie name (application cookie stickiness).
        :param 'GetBackendSetsBackendsetSslConfigurationArgs' ssl_configuration: A listener's SSL handling configuration.
        """
    ...
    def health_checker(self) -> 'outputs.GetBackendSetsBackendsetHealthCheckerResult':
        """
    ...
    def lb_cookie_session_persistence_configuration(self) -> 'outputs.GetBackendSetsBackendsetLbCookieSessionPersistenceConfigurationResult':
        """
    ...
    def session_persistence_configuration(self) -> 'outputs.GetBackendSetsBackendsetSessionPersistenceConfigurationResult':
        """
    ...
    def ssl_configuration(self) -> 'outputs.GetBackendSetsBackendsetSslConfigurationResult':
        """
...
class GetListenerRulesListenerRuleResult(dict):
    def __init__(__self__, *,
                 name: str,
                 rule: 'outputs.GetListenerRulesListenerRuleRuleResult',
                 state: str):
        """
        :param str name: The name of the rule set that the rule belongs to.
        :param 'GetListenerRulesListenerRuleRuleArgs' rule: A rule object that applies to the listener.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def rule(self) -> 'outputs.GetListenerRulesListenerRuleRuleResult':
        """
...
class GetListenerRulesListenerRuleRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 prefix: str,
                 redirect_uri: 'outputs.GetListenerRulesListenerRuleRuleRedirectUriResult',
                 response_code: int,
                 status_code: int,
                 suffix: str,
                 value: str):
        ...
        :param str prefix: A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        :param 'GetListenerRulesListenerRuleRuleRedirectUriArgs' redirect_uri: An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
    ...
    @property
    @pulumi.getter(name="redirectUri")
    def redirect_uri(self) -> 'outputs.GetListenerRulesListenerRuleRuleRedirectUriResult':
        """
...
class GetLoadBalancersLoadBalancerResult(dict):
    def __init__(__self__, *,
                 ...
                 shape: str,
                 shape_details: 'outputs.GetLoadBalancersLoadBalancerShapeDetailsResult',
                 state: str,
        ...
        :param 'GetLoadBalancersLoadBalancerShapeDetailsArgs' shape_details: The configuration details to update load balancer to a different shape.
    ...
    def shape_details(self) -> 'outputs.GetLoadBalancersLoadBalancerShapeDetailsResult':
        """
...
class GetLoadBalancersLoadBalancerIpAddressDetailResult(dict):
    def __init__(__self__, *,
                 ip_address: str,
                 is_public: bool,
                 reserved_ip: 'outputs.GetLoadBalancersLoadBalancerIpAddressDetailReservedIpResult'):
        """
        :param str ip_address: An IP address.  Example: `192.168.0.3`
        :param bool is_public: Whether the IP address is public or private.
        :param 'GetLoadBalancersLoadBalancerIpAddressDetailReservedIpArgs' reserved_ip: Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "is_public", is_public)
        pulumi.set(__self__, "reserved_ip", reserved_ip)
    ...
    @property
    @pulumi.getter(name="reservedIp")
    def reserved_ip(self) -> 'outputs.GetLoadBalancersLoadBalancerIpAddressDetailReservedIpResult':
        """
        Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        """
        return pulumi.get(self, "reserved_ip")
...
@pulumi.output_type
class GetLoadBalancersLoadBalancerShapeDetailsResult(dict):
    def __init__(__self__, *,
                 maximum_bandwidth_in_mbps: int,
                 minimum_bandwidth_in_mbps: int):
        """
...
class GetRuleSetItemResult(dict):
    def __init__(__self__, *,
                 ...
                 http_large_header_size_in_kb: int,
                 prefix: str,
                 redirect_uri: 'outputs.GetRuleSetItemRedirectUriResult',
                 response_code: int,
                 status_code: int,
                 suffix: str,
                 value: str):
        ...
        :param str prefix: A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        :param 'GetRuleSetItemRedirectUriArgs' redirect_uri: An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
        :param int response_code: The HTTP status code to return when the incoming request is redirected.
        :param int status_code: The HTTP status code to return when the requested HTTP method is not in the list of allowed methods. The associated status line returned with the code is mapped from the standard HTTP specification. The default value is `405 (Method Not Allowed)`.  Example: 403
        :param str suffix: A string to append to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
    ...
    @property
    @pulumi.getter(name="redirectUri")
    def redirect_uri(self) -> 'outputs.GetRuleSetItemRedirectUriResult':
        """
        An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
        """
        return pulumi.get(self, "redirect_uri")
...
class GetRuleSetsRuleSetItemResult(dict):
    def __init__(__self__, *,
                 ...
                 http_large_header_size_in_kb: int,
                 prefix: str,
                 redirect_uri: 'outputs.GetRuleSetsRuleSetItemRedirectUriResult',
                 response_code: int,
                 status_code: int,
                 suffix: str,
                 value: str):
        ...
        :param str prefix: A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        :param 'GetRuleSetsRuleSetItemRedirectUriArgs' redirect_uri: An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
        :param int response_code: The HTTP status code to return when the incoming request is redirected.
        :param int status_code: The HTTP status code to return when the requested HTTP method is not in the list of allowed methods. The associated status line returned with the code is mapped from the standard HTTP specification. The default value is `405 (Method Not Allowed)`.  Example: 403
        :param str suffix: A string to append to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
    ...
    @property
    @pulumi.getter(name="redirectUri")
    def redirect_uri(self) -> 'outputs.GetRuleSetsRuleSetItemRedirectUriResult':
        """
        An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
        """
        return pulumi.get(self, "redirect_uri")
