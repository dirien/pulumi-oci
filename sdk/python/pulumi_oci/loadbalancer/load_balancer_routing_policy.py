...
class LoadBalancerRoutingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_load_balancer_routing_policy = oci.loadbalancer.LoadBalancerRoutingPolicy("testLoadBalancerRoutingPolicy",
            condition_language_version=var["load_balancer_routing_policy_condition_language_version"],
            load_balancer_id=oci_load_balancer_load_balancer["test_load_balancer"]["id"],
            rules=[oci.loadbalancer.LoadBalancerRoutingPolicyRuleArgs(
                actions=[oci.loadbalancer.LoadBalancerRoutingPolicyRuleActionArgs(
