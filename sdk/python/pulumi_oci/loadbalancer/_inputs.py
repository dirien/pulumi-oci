...
class LoadBalancerIpAddressDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LoadBalancerIpAddressDetailReservedIpArgs'] reserved_ip: Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        """
