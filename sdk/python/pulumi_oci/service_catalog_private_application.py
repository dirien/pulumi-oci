...
__all__ = ['ServiceCatalogPrivateApplicationArgs', 'ServiceCatalogPrivateApplication']

@pulumi.input_type
class ServiceCatalogPrivateApplicationArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 display_name: pulumi.Input[str],
                 package_details: pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs'],
        ...
        :param pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs'] package_details: A base object for creating a private application package.
    ...
    def package_details(self) -> pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs']:
        """
    ...
    def package_details(self, value: pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs']):
...
@pulumi.input_type
class _ServiceCatalogPrivateApplicationState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 logo: Optional[pulumi.Input['ServiceCatalogPrivateApplicationLogoArgs']] = None,
                 logo_file_base64encoded: Optional[pulumi.Input[str]] = None,
                 long_description: Optional[pulumi.Input[str]] = None,
                 package_details: Optional[pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs']] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) The name of the private application.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input['ServiceCatalogPrivateApplicationLogoArgs'] logo: The model for uploaded binary data, like logos and images.
        :param pulumi.Input[str] logo_file_base64encoded: (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
        :param pulumi.Input[str] long_description: (Updatable) A long description of the private application.
        :param pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs'] package_details: A base object for creating a private application package.
    ...
    @property
    @pulumi.getter
    def logo(self) -> Optional[pulumi.Input['ServiceCatalogPrivateApplicationLogoArgs']]:
        """
    ...
    @logo.setter
    def logo(self, value: Optional[pulumi.Input['ServiceCatalogPrivateApplicationLogoArgs']]):
    ...
    @property
    @pulumi.getter(name="packageDetails")
    def package_details(self) -> Optional[pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs']]:
        """
        A base object for creating a private application package.
        """
        return pulumi.get(self, "package_details")
    ...
    @package_details.setter
    def package_details(self, value: Optional[pulumi.Input['ServiceCatalogPrivateApplicationPackageDetailsArgs']]):
        pulumi.set(self, "package_details", value)
...
class ServiceCatalogPrivateApplication(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 logo_file_base64encoded: Optional[pulumi.Input[str]] = None,
                 long_description: Optional[pulumi.Input[str]] = None,
                 package_details: Optional[pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationPackageDetailsArgs']]] = None,
                 short_description: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_private_application = oci.ServiceCatalogPrivateApplication("testPrivateApplication",
            compartment_id=var["compartment_id"],
            display_name=var["private_application_display_name"],
            package_details=oci.ServiceCatalogPrivateApplicationPackageDetailsArgs(
        ...
        :param pulumi.Input[str] logo_file_base64encoded: (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
        :param pulumi.Input[str] long_description: (Updatable) A long description of the private application.
        :param pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationPackageDetailsArgs']] package_details: A base object for creating a private application package.
        :param pulumi.Input[str] short_description: (Updatable) A short description of the private application.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: ServiceCatalogPrivateApplicationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Private Application resource in Oracle Cloud Infrastructure Service Catalog service.
        ...
        :param str resource_name: The name of the resource.
        :param ServiceCatalogPrivateApplicationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServiceCatalogPrivateApplicationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServiceCatalogPrivateApplicationArgs.__new__(ServiceCatalogPrivateApplicationArgs)
        ...
        super(ServiceCatalogPrivateApplication, __self__).__init__(
            'oci:index/serviceCatalogPrivateApplication:ServiceCatalogPrivateApplication',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            logo: Optional[pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationLogoArgs']]] = None,
            logo_file_base64encoded: Optional[pulumi.Input[str]] = None,
            long_description: Optional[pulumi.Input[str]] = None,
            package_details: Optional[pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationPackageDetailsArgs']]] = None,
            package_type: Optional[pulumi.Input[str]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'ServiceCatalogPrivateApplication':
        """
        ...
        :param pulumi.Input[str] display_name: (Updatable) The name of the private application.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationLogoArgs']] logo: The model for uploaded binary data, like logos and images.
        :param pulumi.Input[str] logo_file_base64encoded: (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
        :param pulumi.Input[str] long_description: (Updatable) A long description of the private application.
        :param pulumi.Input[pulumi.InputType['ServiceCatalogPrivateApplicationPackageDetailsArgs']] package_details: A base object for creating a private application package.
        :param pulumi.Input[str] package_type: The package's type.
        ...
        __props__ = _ServiceCatalogPrivateApplicationState.__new__(_ServiceCatalogPrivateApplicationState)
        ...
        return ServiceCatalogPrivateApplication(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def logo(self) -> pulumi.Output['outputs.ServiceCatalogPrivateApplicationLogo']:
        """
        The model for uploaded binary data, like logos and images.
        """
        return pulumi.get(self, "logo")
    ...
    @property
    @pulumi.getter(name="packageDetails")
    def package_details(self) -> pulumi.Output['outputs.ServiceCatalogPrivateApplicationPackageDetails']:
        """
        A base object for creating a private application package.
        """
        return pulumi.get(self, "package_details")
