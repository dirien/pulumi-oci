...
__all__ = [
    'GetFileStorageMountTargetsResult',
    'AwaitableGetFileStorageMountTargetsResult',
    'get_file_storage_mount_targets',
]

@pulumi.output_type
class GetFileStorageMountTargetsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetFileStorageMountTargetsFilterResult']]:
    ...
    def mount_targets(self) -> Sequence['outputs.GetFileStorageMountTargetsMountTargetResult']:
        """
...
class AwaitableGetFileStorageMountTargetsResult(GetFileStorageMountTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFileStorageMountTargetsResult(
...
def get_file_storage_mount_targets(availability_domain: Optional[str] = None,
                                   compartment_id: Optional[str] = None,
                                   display_name: Optional[str] = None,
                                   export_set_id: Optional[str] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetFileStorageMountTargetsFilterArgs']]] = None,
                                   id: Optional[str] = None,
                                   state: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFileStorageMountTargetsResult:
    """
    ...
    test_mount_targets = oci.get_file_storage_mount_targets(availability_domain=var["mount_target_availability_domain"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getFileStorageMountTargets:GetFileStorageMountTargets', __args__, opts=opts, typ=GetFileStorageMountTargetsResult).value

    return AwaitableGetFileStorageMountTargetsResult(
