...
__all__ = [
    'GetDevopsDeploymentResult',
    'AwaitableGetDevopsDeploymentResult',
    'get_devops_deployment',
]

@pulumi.output_type
class GetDevopsDeploymentResult:
    """
    ...
    def deploy_artifact_override_arguments(self) -> 'outputs.GetDevopsDeploymentDeployArtifactOverrideArgumentsResult':
        """
    ...
    def deploy_pipeline_artifacts(self) -> 'outputs.GetDevopsDeploymentDeployPipelineArtifactsResult':
        """
    ...
    def deploy_pipeline_environments(self) -> 'outputs.GetDevopsDeploymentDeployPipelineEnvironmentsResult':
        """
    ...
    def deployment_arguments(self) -> 'outputs.GetDevopsDeploymentDeploymentArgumentsResult':
        """
    ...
    def deployment_execution_progress(self) -> 'outputs.GetDevopsDeploymentDeploymentExecutionProgressResult':
        """
...
class AwaitableGetDevopsDeploymentResult(GetDevopsDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeploymentResult(
...
def get_devops_deployment(deployment_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeploymentResult:
    """
    ...
    test_deployment = oci.get_devops_deployment(deployment_id=oci_devops_deployment["test_deployment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployment:GetDevopsDeployment', __args__, opts=opts, typ=GetDevopsDeploymentResult).value

    return AwaitableGetDevopsDeploymentResult(
