...
__all__ = [
    'GetApigatewayApiResult',
    'AwaitableGetApigatewayApiResult',
    'get_apigateway_api',
]

@pulumi.output_type
class GetApigatewayApiResult:
    """
    ...
    def validation_results(self) -> Sequence['outputs.GetApigatewayApiValidationResultResult']:
        """
...
class AwaitableGetApigatewayApiResult(GetApigatewayApiResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayApiResult(
            api_id=self.api_id,
...
def get_apigateway_api(api_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayApiResult:
    """
    ...
    test_api = oci.get_apigateway_api(api_id=oci_apigateway_api["test_api"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayApi:GetApigatewayApi', __args__, opts=opts, typ=GetApigatewayApiResult).value

    return AwaitableGetApigatewayApiResult(
