...
__all__ = [
    'GetCoreFastConnectProviderServiceResult',
    'AwaitableGetCoreFastConnectProviderServiceResult',
    'get_core_fast_connect_provider_service',
]

@pulumi.output_type
class GetCoreFastConnectProviderServiceResult:
    """
...
class AwaitableGetCoreFastConnectProviderServiceResult(GetCoreFastConnectProviderServiceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreFastConnectProviderServiceResult(
...
def get_core_fast_connect_provider_service(provider_service_id: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreFastConnectProviderServiceResult:
    """
    ...
    test_fast_connect_provider_service = oci.get_core_fast_connect_provider_service(provider_service_id=data["oci_core_fast_connect_provider_services"]["test_fast_connect_provider_services"]["fast_connect_provider_services"][0]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreFastConnectProviderService:GetCoreFastConnectProviderService', __args__, opts=opts, typ=GetCoreFastConnectProviderServiceResult).value

    return AwaitableGetCoreFastConnectProviderServiceResult(
