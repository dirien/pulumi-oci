...
__all__ = [
    'GetSchServiceConnectorsResult',
    'AwaitableGetSchServiceConnectorsResult',
    'get_sch_service_connectors',
]

@pulumi.output_type
class GetSchServiceConnectorsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetSchServiceConnectorsFilterResult']]:
    ...
    def service_connector_collections(self) -> Sequence['outputs.GetSchServiceConnectorsServiceConnectorCollectionResult']:
        """
...
class AwaitableGetSchServiceConnectorsResult(GetSchServiceConnectorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSchServiceConnectorsResult(
...
def get_sch_service_connectors(compartment_id: Optional[str] = None,
                               display_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetSchServiceConnectorsFilterArgs']]] = None,
                               state: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSchServiceConnectorsResult:
    """
    ...
    test_service_connectors = oci.get_sch_service_connectors(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getSchServiceConnectors:GetSchServiceConnectors', __args__, opts=opts, typ=GetSchServiceConnectorsResult).value

    return AwaitableGetSchServiceConnectorsResult(
