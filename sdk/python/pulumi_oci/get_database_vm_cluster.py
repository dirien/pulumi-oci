...
__all__ = [
    'GetDatabaseVmClusterResult',
    'AwaitableGetDatabaseVmClusterResult',
    'get_database_vm_cluster',
]

@pulumi.output_type
class GetDatabaseVmClusterResult:
    """
...
class AwaitableGetDatabaseVmClusterResult(GetDatabaseVmClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterResult(
...
def get_database_vm_cluster(vm_cluster_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterResult:
    """
    ...
    test_vm_cluster = oci.get_database_vm_cluster(vm_cluster_id=oci_database_vm_cluster["test_vm_cluster"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmCluster:GetDatabaseVmCluster', __args__, opts=opts, typ=GetDatabaseVmClusterResult).value

    return AwaitableGetDatabaseVmClusterResult(
