...
__all__ = [
    'GetDatabaseDbHomeResult',
    'AwaitableGetDatabaseDbHomeResult',
    'get_database_db_home',
]

@pulumi.output_type
class GetDatabaseDbHomeResult:
    """
    A collection of values returned by GetDatabaseDbHome.
    """
    def __init__(__self__, compartment_id=None, database=None, database_software_image_id=None, db_home_id=None, db_home_location=None, db_system_id=None, db_version=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_desupported_version=None, kms_key_id=None, kms_key_version_id=None, last_patch_history_entry_id=None, lifecycle_details=None, source=None, state=None, time_created=None, vm_cluster_id=None):
    ...
    @property
    @pulumi.getter
    def database(self) -> 'outputs.GetDatabaseDbHomeDatabaseResult':
...
class AwaitableGetDatabaseDbHomeResult(GetDatabaseDbHomeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbHomeResult(
...
def get_database_db_home(db_home_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbHomeResult:
    """
    ...
    test_db_home = oci.get_database_db_home(db_home_id=var["db_home_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbHome:GetDatabaseDbHome', __args__, opts=opts, typ=GetDatabaseDbHomeResult).value

    return AwaitableGetDatabaseDbHomeResult(
