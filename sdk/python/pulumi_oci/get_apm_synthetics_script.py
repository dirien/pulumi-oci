...
__all__ = [
    'GetApmSyntheticsScriptResult',
    'AwaitableGetApmSyntheticsScriptResult',
    'get_apm_synthetics_script',
]

@pulumi.output_type
class GetApmSyntheticsScriptResult:
    """
    A collection of values returned by GetApmSyntheticsScript.
    """
    def __init__(__self__, apm_domain_id=None, content=None, content_file_name=None, content_size_in_bytes=None, content_type=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, monitor_status_count_map=None, parameters=None, script_id=None, time_created=None, time_updated=None, time_uploaded=None):
        ...
        if monitor_status_count_map and not isinstance(monitor_status_count_map, dict):
            raise TypeError("Expected argument 'monitor_status_count_map' to be a dict")
    ...
    def monitor_status_count_map(self) -> 'outputs.GetApmSyntheticsScriptMonitorStatusCountMapResult':
        """
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetApmSyntheticsScriptParameterResult']:
        """
...
class AwaitableGetApmSyntheticsScriptResult(GetApmSyntheticsScriptResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApmSyntheticsScriptResult(
            ...
            id=self.id,
            monitor_status_count_map=self.monitor_status_count_map,
...
def get_apm_synthetics_script(apm_domain_id: Optional[str] = None,
                              script_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApmSyntheticsScriptResult:
    """
    ...
    test_script = oci.get_apm_synthetics_script(apm_domain_id=oci_apm_synthetics_apm_domain["test_apm_domain"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApmSyntheticsScript:GetApmSyntheticsScript', __args__, opts=opts, typ=GetApmSyntheticsScriptResult).value

    return AwaitableGetApmSyntheticsScriptResult(
        ...
        id=__ret__.id,
        monitor_status_count_map=__ret__.monitor_status_count_map,
