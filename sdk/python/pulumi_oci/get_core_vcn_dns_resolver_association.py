...
__all__ = [
    'GetCoreVcnDnsResolverAssociationResult',
    'AwaitableGetCoreVcnDnsResolverAssociationResult',
    'get_core_vcn_dns_resolver_association',
]

@pulumi.output_type
class GetCoreVcnDnsResolverAssociationResult:
    """
...
class AwaitableGetCoreVcnDnsResolverAssociationResult(GetCoreVcnDnsResolverAssociationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVcnDnsResolverAssociationResult(
...
def get_core_vcn_dns_resolver_association(vcn_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVcnDnsResolverAssociationResult:
    """
    ...
    test_vcn_dns_resolver_association = oci.get_core_vcn_dns_resolver_association(vcn_id=oci_core_vcn["test_vcn"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVcnDnsResolverAssociation:GetCoreVcnDnsResolverAssociation', __args__, opts=opts, typ=GetCoreVcnDnsResolverAssociationResult).value

    return AwaitableGetCoreVcnDnsResolverAssociationResult(
