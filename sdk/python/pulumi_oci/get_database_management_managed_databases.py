...
__all__ = [
    'GetDatabaseManagementManagedDatabasesResult',
    'AwaitableGetDatabaseManagementManagedDatabasesResult',
    'get_database_management_managed_databases',
]

@pulumi.output_type
class GetDatabaseManagementManagedDatabasesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseManagementManagedDatabasesFilterResult']]:
    ...
    def managed_database_collections(self) -> Sequence['outputs.GetDatabaseManagementManagedDatabasesManagedDatabaseCollectionResult']:
        """
...
class AwaitableGetDatabaseManagementManagedDatabasesResult(GetDatabaseManagementManagedDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseManagementManagedDatabasesResult(
...
def get_database_management_managed_databases(compartment_id: Optional[str] = None,
                                              filters: Optional[Sequence[pulumi.InputType['GetDatabaseManagementManagedDatabasesFilterArgs']]] = None,
                                              id: Optional[str] = None,
                                              name: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseManagementManagedDatabasesResult:
    """
    ...
    test_managed_databases = oci.get_database_management_managed_databases(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseManagementManagedDatabases:GetDatabaseManagementManagedDatabases', __args__, opts=opts, typ=GetDatabaseManagementManagedDatabasesResult).value

    return AwaitableGetDatabaseManagementManagedDatabasesResult(
