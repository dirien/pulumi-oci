...
__all__ = [
    'GetDatacatalogConnectionsResult',
    'AwaitableGetDatacatalogConnectionsResult',
    'get_datacatalog_connections',
]

@pulumi.output_type
class GetDatacatalogConnectionsResult:
    """
    ...
    def connection_collections(self) -> Sequence['outputs.GetDatacatalogConnectionsConnectionCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatacatalogConnectionsFilterResult']]:
...
class AwaitableGetDatacatalogConnectionsResult(GetDatacatalogConnectionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogConnectionsResult(
...
def get_datacatalog_connections(catalog_id: Optional[str] = None,
                                ...
                                filters: Optional[Sequence[pulumi.InputType['GetDatacatalogConnectionsFilterArgs']]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogConnectionsResult:
    """
    ...
    test_connections = oci.get_datacatalog_connections(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogConnections:GetDatacatalogConnections', __args__, opts=opts, typ=GetDatacatalogConnectionsResult).value

    return AwaitableGetDatacatalogConnectionsResult(
