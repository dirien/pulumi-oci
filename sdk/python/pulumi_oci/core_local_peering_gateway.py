...
__all__ = ['CoreLocalPeeringGatewayArgs', 'CoreLocalPeeringGateway']

@pulumi.input_type
class CoreLocalPeeringGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment containing the local peering gateway (LPG).
        :param pulumi.Input[str] vcn_id: The OCID of the VCN the LPG belongs to.
        ...
        :param pulumi.Input[str] route_table_id: (Updatable) The OCID of the route table the LPG will use.
        """
...
@pulumi.input_type
class _CoreLocalPeeringGatewayState:
    def __init__(__self__, *,
...
class CoreLocalPeeringGateway(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_local_peering_gateway = oci.CoreLocalPeeringGateway("testLocalPeeringGateway",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreLocalPeeringGatewayArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Local Peering Gateway resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreLocalPeeringGatewayArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreLocalPeeringGatewayArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreLocalPeeringGatewayArgs.__new__(CoreLocalPeeringGatewayArgs)
        ...
        super(CoreLocalPeeringGateway, __self__).__init__(
            'oci:index/coreLocalPeeringGateway:CoreLocalPeeringGateway',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'CoreLocalPeeringGateway':
        """
        ...
        __props__ = _CoreLocalPeeringGatewayState.__new__(_CoreLocalPeeringGatewayState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        return CoreLocalPeeringGateway(resource_name, opts=opts, __props__=__props__)
