...
__all__ = [
    'GetDatabaseMaintenanceRunResult',
    'AwaitableGetDatabaseMaintenanceRunResult',
    'get_database_maintenance_run',
]

@pulumi.output_type
class GetDatabaseMaintenanceRunResult:
    """
...
class AwaitableGetDatabaseMaintenanceRunResult(GetDatabaseMaintenanceRunResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseMaintenanceRunResult(
...
def get_database_maintenance_run(maintenance_run_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseMaintenanceRunResult:
    """
    ...
    test_maintenance_run = oci.get_database_maintenance_run(maintenance_run_id=oci_database_maintenance_run["test_maintenance_run"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseMaintenanceRun:GetDatabaseMaintenanceRun', __args__, opts=opts, typ=GetDatabaseMaintenanceRunResult).value

    return AwaitableGetDatabaseMaintenanceRunResult(
