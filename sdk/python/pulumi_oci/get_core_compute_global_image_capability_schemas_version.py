...
__all__ = [
    'GetCoreComputeGlobalImageCapabilitySchemasVersionResult',
    'AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionResult',
    'get_core_compute_global_image_capability_schemas_version',
]

@pulumi.output_type
class GetCoreComputeGlobalImageCapabilitySchemasVersionResult:
    """
...
class AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionResult(GetCoreComputeGlobalImageCapabilitySchemasVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeGlobalImageCapabilitySchemasVersionResult(
...
def get_core_compute_global_image_capability_schemas_version(compute_global_image_capability_schema_id: Optional[str] = None,
                                                             compute_global_image_capability_schema_version_name: Optional[str] = None,
                                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionResult:
    """
    ...
    test_compute_global_image_capability_schemas_version = oci.get_core_compute_global_image_capability_schemas_version(compute_global_image_capability_schema_id=oci_core_compute_global_image_capability_schema["test_compute_global_image_capability_schema"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeGlobalImageCapabilitySchemasVersion:GetCoreComputeGlobalImageCapabilitySchemasVersion', __args__, opts=opts, typ=GetCoreComputeGlobalImageCapabilitySchemasVersionResult).value

    return AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionResult(
