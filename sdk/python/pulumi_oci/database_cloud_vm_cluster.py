...
__all__ = ['DatabaseCloudVmClusterArgs', 'DatabaseCloudVmCluster']

@pulumi.input_type
class DatabaseCloudVmClusterArgs:
...
@pulumi.input_type
class _DatabaseCloudVmClusterState:
    def __init__(__self__, *,
                 ...
                 iorm_config_cache: Optional[pulumi.Input['DatabaseCloudVmClusterIormConfigCacheArgs']] = None,
                 is_local_backup_enabled: Optional[pulumi.Input[bool]] = None,
                 is_sparse_diskgroup_enabled: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] gi_version: A valid Oracle Grid Infrastructure (GI) software version.
        :param pulumi.Input[str] hostname: The hostname for the cloud VM cluster. The hostname must begin with an alphabetic character, and can contain alphanumeric characters and hyphens (-). The maximum length of the hostname is 16 characters for bare metal and virtual machine DB systems, and 12 characters for Exadata systems.
        :param pulumi.Input['DatabaseCloudVmClusterIormConfigCacheArgs'] iorm_config_cache: The IORM settings of the Exadata DB system.
        :param pulumi.Input[bool] is_local_backup_enabled: If true, database backup on local Exadata storage is configured for the cloud VM cluster. If false, database backup on local Exadata storage is not available in the cloud VM cluster.
        :param pulumi.Input[bool] is_sparse_diskgroup_enabled: If true, the sparse disk group is configured for the cloud VM cluster. If false, the sparse disk group is not created.
    ...
    def iorm_config_cache(self) -> Optional[pulumi.Input['DatabaseCloudVmClusterIormConfigCacheArgs']]:
        """
    ...
    def iorm_config_cache(self, value: Optional[pulumi.Input['DatabaseCloudVmClusterIormConfigCacheArgs']]):
...
class DatabaseCloudVmCluster(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_cloud_vm_cluster = oci.DatabaseCloudVmCluster("testCloudVmCluster",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseCloudVmClusterArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Cloud Vm Cluster resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseCloudVmClusterArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseCloudVmClusterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseCloudVmClusterArgs.__new__(DatabaseCloudVmClusterArgs)
        ...
        super(DatabaseCloudVmCluster, __self__).__init__(
            'oci:index/databaseCloudVmCluster:DatabaseCloudVmCluster',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            gi_version: Optional[pulumi.Input[str]] = None,
            hostname: Optional[pulumi.Input[str]] = None,
            iorm_config_cache: Optional[pulumi.Input[pulumi.InputType['DatabaseCloudVmClusterIormConfigCacheArgs']]] = None,
            is_local_backup_enabled: Optional[pulumi.Input[bool]] = None,
            is_sparse_diskgroup_enabled: Optional[pulumi.Input[bool]] = None,
            last_update_history_entry_id: Optional[pulumi.Input[str]] = None,
            license_model: Optional[pulumi.Input[str]] = None,
            ...
            time_zone: Optional[pulumi.Input[str]] = None,
            vip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseCloudVmCluster':
        """
        ...
        :param pulumi.Input[str] gi_version: A valid Oracle Grid Infrastructure (GI) software version.
        :param pulumi.Input[str] hostname: The hostname for the cloud VM cluster. The hostname must begin with an alphabetic character, and can contain alphanumeric characters and hyphens (-). The maximum length of the hostname is 16 characters for bare metal and virtual machine DB systems, and 12 characters for Exadata systems.
        :param pulumi.Input[pulumi.InputType['DatabaseCloudVmClusterIormConfigCacheArgs']] iorm_config_cache: The IORM settings of the Exadata DB system.
        :param pulumi.Input[bool] is_local_backup_enabled: If true, database backup on local Exadata storage is configured for the cloud VM cluster. If false, database backup on local Exadata storage is not available in the cloud VM cluster.
        :param pulumi.Input[bool] is_sparse_diskgroup_enabled: If true, the sparse disk group is configured for the cloud VM cluster. If false, the sparse disk group is not created.
        :param pulumi.Input[str] last_update_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance update history entry. This value is updated when a maintenance update starts.
        :param pulumi.Input[str] license_model: (Updatable) The Oracle license model that applies to the cloud VM cluster. The default is BRING_YOUR_OWN_LICENSE.
        ...
        __props__ = _DatabaseCloudVmClusterState.__new__(_DatabaseCloudVmClusterState)
        ...
        return DatabaseCloudVmCluster(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="iormConfigCache")
    def iorm_config_cache(self) -> pulumi.Output['outputs.DatabaseCloudVmClusterIormConfigCache']:
        """
        The IORM settings of the Exadata DB system.
        """
        return pulumi.get(self, "iorm_config_cache")
