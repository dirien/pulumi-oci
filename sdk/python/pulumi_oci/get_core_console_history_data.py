...
__all__ = [
    'GetCoreConsoleHistoryDataResult',
    'AwaitableGetCoreConsoleHistoryDataResult',
    'get_core_console_history_data',
]

@pulumi.output_type
class GetCoreConsoleHistoryDataResult:
    """
...
class AwaitableGetCoreConsoleHistoryDataResult(GetCoreConsoleHistoryDataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreConsoleHistoryDataResult(
...
def get_core_console_history_data(console_history_id: Optional[str] = None,
                                  length: Optional[int] = None,
                                  offset: Optional[int] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreConsoleHistoryDataResult:
    """
    ...
    test_console_history_data = oci.get_core_console_history_data(console_history_id=oci_core_console_history["test_console_history"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreConsoleHistoryData:GetCoreConsoleHistoryData', __args__, opts=opts, typ=GetCoreConsoleHistoryDataResult).value

    return AwaitableGetCoreConsoleHistoryDataResult(
