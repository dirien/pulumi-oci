...
__all__ = [
    'GetCloudGuardManagedListResult',
    'AwaitableGetCloudGuardManagedListResult',
    'get_cloud_guard_managed_list',
]

@pulumi.output_type
class GetCloudGuardManagedListResult:
    """
...
class AwaitableGetCloudGuardManagedListResult(GetCloudGuardManagedListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardManagedListResult(
...
def get_cloud_guard_managed_list(managed_list_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardManagedListResult:
    """
    ...
    test_managed_list = oci.get_cloud_guard_managed_list(managed_list_id=oci_cloud_guard_managed_list["test_managed_list"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardManagedList:GetCloudGuardManagedList', __args__, opts=opts, typ=GetCloudGuardManagedListResult).value

    return AwaitableGetCloudGuardManagedListResult(
