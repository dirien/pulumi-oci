...
__all__ = [
    ...
    'AwaitableGetMarketplaceListingResult',
    'get_marketplace_listing',
]

@pulumi.output_type
class GetMarketplaceListingResult:
    """
    A collection of values returned by GetMarketplaceListing.
    """
    def __init__(__self__, banners=None, categories=None, compartment_id=None, default_package_version=None, documentation_links=None, icons=None, id=None, is_featured=None, keywords=None, languages=None, license_model_description=None, links=None, listing_id=None, listing_type=None, long_description=None, name=None, package_type=None, publishers=None, regions=None, release_notes=None, screenshots=None, short_description=None, support_contacts=None, support_links=None, supported_operating_systems=None, system_requirements=None, tagline=None, time_released=None, usage_information=None, version=None, videos=None):
    ...
    @property
    @pulumi.getter
    def banners(self) -> Sequence['outputs.GetMarketplaceListingBannerResult']:
        """
    ...
    def documentation_links(self) -> Sequence['outputs.GetMarketplaceListingDocumentationLinkResult']:
        """
    ...
    @property
    @pulumi.getter
    def icons(self) -> Sequence['outputs.GetMarketplaceListingIconResult']:
        """
        The model for upload data for images and icons.
        """
    ...
    @property
    @pulumi.getter
    def languages(self) -> Sequence['outputs.GetMarketplaceListingLanguageResult']:
        """
    ...
    @property
    @pulumi.getter
    def links(self) -> Sequence['outputs.GetMarketplaceListingLinkResult']:
        """
        Reference links.
        """
    ...
    @property
    @pulumi.getter
    def publishers(self) -> Sequence['outputs.GetMarketplaceListingPublisherResult']:
        """
    ...
    @property
    @pulumi.getter
    def regions(self) -> Sequence['outputs.GetMarketplaceListingRegionResult']:
        """
    ...
    @property
    @pulumi.getter
    def screenshots(self) -> Sequence['outputs.GetMarketplaceListingScreenshotResult']:
        """
    ...
    def support_contacts(self) -> Sequence['outputs.GetMarketplaceListingSupportContactResult']:
        """
    ...
    def support_links(self) -> Sequence['outputs.GetMarketplaceListingSupportLinkResult']:
        """
    ...
    def supported_operating_systems(self) -> Sequence['outputs.GetMarketplaceListingSupportedOperatingSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def videos(self) -> Sequence['outputs.GetMarketplaceListingVideoResult']:
        """
...
class AwaitableGetMarketplaceListingResult(GetMarketplaceListingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplaceListingResult(
...
def get_marketplace_listing(compartment_id: Optional[str] = None,
                            listing_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplaceListingResult:
    """
    ...
    test_listing = oci.get_marketplace_listing(listing_id=oci_marketplace_listing["test_listing"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplaceListing:GetMarketplaceListing', __args__, opts=opts, typ=GetMarketplaceListingResult).value

    return AwaitableGetMarketplaceListingResult(
