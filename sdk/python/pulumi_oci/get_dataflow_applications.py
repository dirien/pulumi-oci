...
__all__ = [
    'GetDataflowApplicationsResult',
    'AwaitableGetDataflowApplicationsResult',
    'get_dataflow_applications',
]

@pulumi.output_type
class GetDataflowApplicationsResult:
    """
    ...
    @property
    @pulumi.getter
    def applications(self) -> Sequence['outputs.GetDataflowApplicationsApplicationResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDataflowApplicationsFilterResult']]:
...
class AwaitableGetDataflowApplicationsResult(GetDataflowApplicationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowApplicationsResult(
...
def get_dataflow_applications(compartment_id: Optional[str] = None,
                              display_name: Optional[str] = None,
                              display_name_starts_with: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetDataflowApplicationsFilterArgs']]] = None,
                              owner_principal_id: Optional[str] = None,
                              spark_version: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowApplicationsResult:
    """
    ...
    test_applications = oci.get_dataflow_applications(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowApplications:GetDataflowApplications', __args__, opts=opts, typ=GetDataflowApplicationsResult).value

    return AwaitableGetDataflowApplicationsResult(
