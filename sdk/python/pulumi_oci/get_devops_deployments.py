...
__all__ = [
    'GetDevopsDeploymentsResult',
    'AwaitableGetDevopsDeploymentsResult',
    'get_devops_deployments',
]

@pulumi.output_type
class GetDevopsDeploymentsResult:
    """
    ...
    def deployment_collections(self) -> Sequence['outputs.GetDevopsDeploymentsDeploymentCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDevopsDeploymentsFilterResult']]:
...
class AwaitableGetDevopsDeploymentsResult(GetDevopsDeploymentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeploymentsResult(
...
def get_devops_deployments(compartment_id: Optional[str] = None,
                           deploy_pipeline_id: Optional[str] = None,
                           display_name: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetDevopsDeploymentsFilterArgs']]] = None,
                           id: Optional[str] = None,
                           project_id: Optional[str] = None,
                           state: Optional[str] = None,
                           time_created_greater_than_or_equal_to: Optional[str] = None,
                           time_created_less_than: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeploymentsResult:
    """
    ...
    test_deployments = oci.get_devops_deployments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployments:GetDevopsDeployments', __args__, opts=opts, typ=GetDevopsDeploymentsResult).value

    return AwaitableGetDevopsDeploymentsResult(
