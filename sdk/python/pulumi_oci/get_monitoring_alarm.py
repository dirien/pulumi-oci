...
__all__ = [
    'GetMonitoringAlarmResult',
    'AwaitableGetMonitoringAlarmResult',
    'get_monitoring_alarm',
]

@pulumi.output_type
class GetMonitoringAlarmResult:
    """
    ...
    @property
    @pulumi.getter
    def suppression(self) -> 'outputs.GetMonitoringAlarmSuppressionResult':
        """
...
class AwaitableGetMonitoringAlarmResult(GetMonitoringAlarmResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMonitoringAlarmResult(
...
def get_monitoring_alarm(alarm_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringAlarmResult:
    """
    ...
    test_alarm = oci.get_monitoring_alarm(alarm_id=oci_monitoring_alarm["test_alarm"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMonitoringAlarm:GetMonitoringAlarm', __args__, opts=opts, typ=GetMonitoringAlarmResult).value

    return AwaitableGetMonitoringAlarmResult(
        ...
        state=__ret__.state,
        suppression=__ret__.suppression,
