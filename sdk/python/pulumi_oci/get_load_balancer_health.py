...
__all__ = [
    'GetLoadBalancerHealthResult',
    'AwaitableGetLoadBalancerHealthResult',
    'get_load_balancer_health',
]

@pulumi.output_type
class GetLoadBalancerHealthResult:
    """
...
class AwaitableGetLoadBalancerHealthResult(GetLoadBalancerHealthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerHealthResult(
...
def get_load_balancer_health(load_balancer_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerHealthResult:
    """
    ...
    test_load_balancer_health = oci.get_load_balancer_health(load_balancer_id=oci_load_balancer_load_balancer["test_load_balancer"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerHealth:GetLoadBalancerHealth', __args__, opts=opts, typ=GetLoadBalancerHealthResult).value

    return AwaitableGetLoadBalancerHealthResult(
