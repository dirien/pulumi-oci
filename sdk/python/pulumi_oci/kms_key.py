...
class KmsKeyArgs:
    def __init__(__self__, *,
                 ...
                 key_shape: pulumi.Input['KmsKeyKeyShapeArgs'],
                 management_endpoint: pulumi.Input[str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 desired_state: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 protection_mode: Optional[pulumi.Input[str]] = None,
                 restore_from_file: Optional[pulumi.Input['KmsKeyRestoreFromFileArgs']] = None,
                 restore_from_object_store: Optional[pulumi.Input['KmsKeyRestoreFromObjectStoreArgs']] = None,
        ...
        :param pulumi.Input['KmsKeyKeyShapeArgs'] key_shape: The cryptographic properties of a key.
        ...
        :param pulumi.Input['KmsKeyRestoreFromFileArgs'] restore_from_file: (Updatable) Details where key was backed up.
        :param pulumi.Input['KmsKeyRestoreFromObjectStoreArgs'] restore_from_object_store: (Updatable) Details where key was backed up
    ...
    def key_shape(self) -> pulumi.Input['KmsKeyKeyShapeArgs']:
        """
    ...
    @key_shape.setter
    def key_shape(self, value: pulumi.Input['KmsKeyKeyShapeArgs']):
    ...
    def restore_from_file(self) -> Optional[pulumi.Input['KmsKeyRestoreFromFileArgs']]:
        """
    ...
    def restore_from_file(self, value: Optional[pulumi.Input['KmsKeyRestoreFromFileArgs']]):
        pulumi.set(self, "restore_from_file", value)

    @property
    @pulumi.getter(name="restoreFromObjectStore")
    def restore_from_object_store(self) -> Optional[pulumi.Input['KmsKeyRestoreFromObjectStoreArgs']]:
        """
        (Updatable) Details where key was backed up
        """
    ...
    def restore_from_object_store(self, value: Optional[pulumi.Input['KmsKeyRestoreFromObjectStoreArgs']]):
...
class _KmsKeyState:
    def __init__(__self__, *,
                 ...
                 key_shape: Optional[pulumi.Input['KmsKeyKeyShapeArgs']] = None,
                 management_endpoint: Optional[pulumi.Input[str]] = None,
                 protection_mode: Optional[pulumi.Input[str]] = None,
                 replica_details: Optional[pulumi.Input['KmsKeyReplicaDetailsArgs']] = None,
                 restore_from_file: Optional[pulumi.Input['KmsKeyRestoreFromFileArgs']] = None,
                 restore_from_object_store: Optional[pulumi.Input['KmsKeyRestoreFromObjectStoreArgs']] = None,
                 restore_trigger: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] management_endpoint: The service endpoint to perform management operations against. Management operations include 'Create,' 'Update,' 'List,' 'Get,' and 'Delete' operations. See Vault Management endpoint.
        :param pulumi.Input[str] protection_mode: The key's protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of `HSM` means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of `SOFTWARE` means that the key persists on the server, protected by the vault's RSA wrapping key which persists  on the HSM. All cryptographic operations that use a key with a protection mode of `SOFTWARE` are performed on the server. By default,  a key's protection mode is set to `HSM`. You can't change a key's protection mode after the key is created or imported.
        :param pulumi.Input['KmsKeyReplicaDetailsArgs'] replica_details: Key replica details
        :param pulumi.Input['KmsKeyRestoreFromFileArgs'] restore_from_file: (Updatable) Details where key was backed up.
        :param pulumi.Input['KmsKeyRestoreFromObjectStoreArgs'] restore_from_object_store: (Updatable) Details where key was backed up
        :param pulumi.Input[bool] restore_trigger: (Updatable) An optional property when flipped triggers restore from restore option provided in config file.
    ...
    @property
    @pulumi.getter(name="keyShape")
    def key_shape(self) -> Optional[pulumi.Input['KmsKeyKeyShapeArgs']]:
        """
        The cryptographic properties of a key.
        """
        return pulumi.get(self, "key_shape")
    ...
    @key_shape.setter
    def key_shape(self, value: Optional[pulumi.Input['KmsKeyKeyShapeArgs']]):
        pulumi.set(self, "key_shape", value)
    ...
    def replica_details(self) -> Optional[pulumi.Input['KmsKeyReplicaDetailsArgs']]:
        """
        Key replica details
        """
    ...
    def replica_details(self, value: Optional[pulumi.Input['KmsKeyReplicaDetailsArgs']]):
...
class KmsKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 key_shape: Optional[pulumi.Input[pulumi.InputType['KmsKeyKeyShapeArgs']]] = None,
                 management_endpoint: Optional[pulumi.Input[str]] = None,
                 protection_mode: Optional[pulumi.Input[str]] = None,
                 restore_from_file: Optional[pulumi.Input[pulumi.InputType['KmsKeyRestoreFromFileArgs']]] = None,
                 restore_from_object_store: Optional[pulumi.Input[pulumi.InputType['KmsKeyRestoreFromObjectStoreArgs']]] = None,
                 restore_trigger: Optional[pulumi.Input[bool]] = None,
                 time_of_deletion: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_key = oci.KmsKey("testKey",
            compartment_id=var["compartment_id"],
            display_name=var["key_display_name"],
            key_shape=oci.KmsKeyKeyShapeArgs(
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the key. It does not have to be unique, and it is changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['KmsKeyKeyShapeArgs']] key_shape: The cryptographic properties of a key.
        :param pulumi.Input[str] management_endpoint: The service endpoint to perform management operations against. Management operations include 'Create,' 'Update,' 'List,' 'Get,' and 'Delete' operations. See Vault Management endpoint.
        :param pulumi.Input[str] protection_mode: The key's protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of `HSM` means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of `SOFTWARE` means that the key persists on the server, protected by the vault's RSA wrapping key which persists  on the HSM. All cryptographic operations that use a key with a protection mode of `SOFTWARE` are performed on the server. By default,  a key's protection mode is set to `HSM`. You can't change a key's protection mode after the key is created or imported.
        :param pulumi.Input[pulumi.InputType['KmsKeyRestoreFromFileArgs']] restore_from_file: (Updatable) Details where key was backed up.
        :param pulumi.Input[pulumi.InputType['KmsKeyRestoreFromObjectStoreArgs']] restore_from_object_store: (Updatable) Details where key was backed up
        :param pulumi.Input[bool] restore_trigger: (Updatable) An optional property when flipped triggers restore from restore option provided in config file.
        :param pulumi.Input[str] time_of_deletion: (Updatable) An optional property for the deletion time of the key, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        """
        ...
    ...
    def get(resource_name: str,
            ...
            management_endpoint: Optional[pulumi.Input[str]] = None,
            protection_mode: Optional[pulumi.Input[str]] = None,
            replica_details: Optional[pulumi.Input[pulumi.InputType['KmsKeyReplicaDetailsArgs']]] = None,
            restore_from_file: Optional[pulumi.Input[pulumi.InputType['KmsKeyRestoreFromFileArgs']]] = None,
            restore_from_object_store: Optional[pulumi.Input[pulumi.InputType['KmsKeyRestoreFromObjectStoreArgs']]] = None,
            restore_trigger: Optional[pulumi.Input[bool]] = None,
            restored_from_key_id: Optional[pulumi.Input[str]] = None,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_of_deletion: Optional[pulumi.Input[str]] = None,
            vault_id: Optional[pulumi.Input[str]] = None) -> 'KmsKey':
        """
        ...
        :param pulumi.Input[str] management_endpoint: The service endpoint to perform management operations against. Management operations include 'Create,' 'Update,' 'List,' 'Get,' and 'Delete' operations. See Vault Management endpoint.
        :param pulumi.Input[str] protection_mode: The key's protection mode indicates how the key persists and where cryptographic operations that use the key are performed. A protection mode of `HSM` means that the key persists on a hardware security module (HSM) and all cryptographic operations are performed inside the HSM. A protection mode of `SOFTWARE` means that the key persists on the server, protected by the vault's RSA wrapping key which persists  on the HSM. All cryptographic operations that use a key with a protection mode of `SOFTWARE` are performed on the server. By default,  a key's protection mode is set to `HSM`. You can't change a key's protection mode after the key is created or imported.
        :param pulumi.Input[pulumi.InputType['KmsKeyReplicaDetailsArgs']] replica_details: Key replica details
        :param pulumi.Input[pulumi.InputType['KmsKeyRestoreFromFileArgs']] restore_from_file: (Updatable) Details where key was backed up.
        :param pulumi.Input[pulumi.InputType['KmsKeyRestoreFromObjectStoreArgs']] restore_from_object_store: (Updatable) Details where key was backed up
        :param pulumi.Input[bool] restore_trigger: (Updatable) An optional property when flipped triggers restore from restore option provided in config file.
        :param pulumi.Input[str] restored_from_key_id: The OCID of the key from which this key was restored.
    ...
    @property
    @pulumi.getter(name="keyShape")
    def key_shape(self) -> pulumi.Output['outputs.KmsKeyKeyShape']:
        """
        The cryptographic properties of a key.
        """
        return pulumi.get(self, "key_shape")
    ...
    @property
    @pulumi.getter(name="replicaDetails")
    def replica_details(self) -> pulumi.Output['outputs.KmsKeyReplicaDetails']:
        """
        Key replica details
        """
        return pulumi.get(self, "replica_details")
    ...
    @property
    @pulumi.getter(name="restoreFromFile")
    def restore_from_file(self) -> pulumi.Output[Optional['outputs.KmsKeyRestoreFromFile']]:
        """
        (Updatable) Details where key was backed up.
        """
        return pulumi.get(self, "restore_from_file")
    ...
    @property
    @pulumi.getter(name="restoreFromObjectStore")
    def restore_from_object_store(self) -> pulumi.Output[Optional['outputs.KmsKeyRestoreFromObjectStore']]:
        """
        (Updatable) Details where key was backed up
        """
        return pulumi.get(self, "restore_from_object_store")
