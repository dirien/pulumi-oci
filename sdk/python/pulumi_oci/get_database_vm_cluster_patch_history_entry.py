...
__all__ = [
    'GetDatabaseVmClusterPatchHistoryEntryResult',
    'AwaitableGetDatabaseVmClusterPatchHistoryEntryResult',
    'get_database_vm_cluster_patch_history_entry',
]

@pulumi.output_type
class GetDatabaseVmClusterPatchHistoryEntryResult:
    """
...
class AwaitableGetDatabaseVmClusterPatchHistoryEntryResult(GetDatabaseVmClusterPatchHistoryEntryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterPatchHistoryEntryResult(
            action=self.action,
            id=self.id,
...
def get_database_vm_cluster_patch_history_entry(patch_history_entry_id: Optional[str] = None,
                                                vm_cluster_id: Optional[str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterPatchHistoryEntryResult:
    """
    ...
    test_vm_cluster_patch_history_entry = oci.get_database_vm_cluster_patch_history_entry(patch_history_entry_id=oci_database_patch_history_entry["test_patch_history_entry"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterPatchHistoryEntry:GetDatabaseVmClusterPatchHistoryEntry', __args__, opts=opts, typ=GetDatabaseVmClusterPatchHistoryEntryResult).value

    return AwaitableGetDatabaseVmClusterPatchHistoryEntryResult(
