...
__all__ = [
    'GetCoreInstanceDevicesResult',
    'AwaitableGetCoreInstanceDevicesResult',
    'get_core_instance_devices',
]

@pulumi.output_type
class GetCoreInstanceDevicesResult:
    """
    ...
    @property
    @pulumi.getter
    def devices(self) -> Sequence['outputs.GetCoreInstanceDevicesDeviceResult']:
        """
        The list of devices.
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreInstanceDevicesFilterResult']]:
...
class AwaitableGetCoreInstanceDevicesResult(GetCoreInstanceDevicesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstanceDevicesResult(
...
def get_core_instance_devices(filters: Optional[Sequence[pulumi.InputType['GetCoreInstanceDevicesFilterArgs']]] = None,
                              instance_id: Optional[str] = None,
                              is_available: Optional[bool] = None,
                              name: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstanceDevicesResult:
    """
    ...
    test_instance_devices = oci.get_core_instance_devices(instance_id=oci_core_instance["test_instance"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstanceDevices:GetCoreInstanceDevices', __args__, opts=opts, typ=GetCoreInstanceDevicesResult).value

    return AwaitableGetCoreInstanceDevicesResult(
