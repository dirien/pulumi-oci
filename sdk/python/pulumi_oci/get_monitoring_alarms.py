...
__all__ = [
    'GetMonitoringAlarmsResult',
    'AwaitableGetMonitoringAlarmsResult',
    'get_monitoring_alarms',
]

@pulumi.output_type
class GetMonitoringAlarmsResult:
    """
    ...
    @property
    @pulumi.getter
    def alarms(self) -> Sequence['outputs.GetMonitoringAlarmsAlarmResult']:
        """
        The list of alarms.
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMonitoringAlarmsFilterResult']]:
...
class AwaitableGetMonitoringAlarmsResult(GetMonitoringAlarmsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMonitoringAlarmsResult(
            alarms=self.alarms,
...
def get_monitoring_alarms(compartment_id: Optional[str] = None,
                          compartment_id_in_subtree: Optional[bool] = None,
                          display_name: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetMonitoringAlarmsFilterArgs']]] = None,
                          state: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringAlarmsResult:
    """
    ...
    test_alarms = oci.get_monitoring_alarms(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMonitoringAlarms:GetMonitoringAlarms', __args__, opts=opts, typ=GetMonitoringAlarmsResult).value

    return AwaitableGetMonitoringAlarmsResult(
