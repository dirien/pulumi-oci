...
__all__ = [
    'GetDatabaseAutonomousDatabaseWalletResult',
    'AwaitableGetDatabaseAutonomousDatabaseWalletResult',
    'get_database_autonomous_database_wallet',
]

@pulumi.output_type
class GetDatabaseAutonomousDatabaseWalletResult:
    """
...
class AwaitableGetDatabaseAutonomousDatabaseWalletResult(GetDatabaseAutonomousDatabaseWalletResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousDatabaseWalletResult(
...
def get_database_autonomous_database_wallet(autonomous_database_id: Optional[str] = None,
                                            base64_encode_content: Optional[bool] = None,
                                            generate_type: Optional[str] = None,
                                            password: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousDatabaseWalletResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousDatabaseWallet:GetDatabaseAutonomousDatabaseWallet', __args__, opts=opts, typ=GetDatabaseAutonomousDatabaseWalletResult).value

    return AwaitableGetDatabaseAutonomousDatabaseWalletResult(
