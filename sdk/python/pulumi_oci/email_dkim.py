...
__all__ = ['EmailDkimArgs', 'EmailDkim']
...
class EmailDkim(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_dkim = oci.EmailDkim("testDkim",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EmailDkimArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EmailDkimArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EmailDkimArgs.__new__(EmailDkimArgs)
        ...
        super(EmailDkim, __self__).__init__(
            'oci:index/emailDkim:EmailDkim',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            txt_record_value: Optional[pulumi.Input[str]] = None) -> 'EmailDkim':
        """
        ...
        __props__ = _EmailDkimState.__new__(_EmailDkimState)
        ...
        return EmailDkim(resource_name, opts=opts, __props__=__props__)
