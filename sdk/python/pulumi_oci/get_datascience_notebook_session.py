...
__all__ = [
    'GetDatascienceNotebookSessionResult',
    'AwaitableGetDatascienceNotebookSessionResult',
    'get_datascience_notebook_session',
]

@pulumi.output_type
class GetDatascienceNotebookSessionResult:
    """
    ...
    def notebook_session_configuration_details(self) -> 'outputs.GetDatascienceNotebookSessionNotebookSessionConfigurationDetailsResult':
        """
...
class AwaitableGetDatascienceNotebookSessionResult(GetDatascienceNotebookSessionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceNotebookSessionResult(
...
def get_datascience_notebook_session(notebook_session_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceNotebookSessionResult:
    """
    ...
    test_notebook_session = oci.get_datascience_notebook_session(notebook_session_id=oci_datascience_notebook_session["test_notebook_session"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceNotebookSession:GetDatascienceNotebookSession', __args__, opts=opts, typ=GetDatascienceNotebookSessionResult).value

    return AwaitableGetDatascienceNotebookSessionResult(
