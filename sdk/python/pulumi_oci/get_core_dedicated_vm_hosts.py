...
__all__ = [
    'GetCoreDedicatedVmHostsResult',
    'AwaitableGetCoreDedicatedVmHostsResult',
    'get_core_dedicated_vm_hosts',
]

@pulumi.output_type
class GetCoreDedicatedVmHostsResult:
    """
    ...
    def dedicated_vm_hosts(self) -> Sequence['outputs.GetCoreDedicatedVmHostsDedicatedVmHostResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDedicatedVmHostsFilterResult']]:
...
class AwaitableGetCoreDedicatedVmHostsResult(GetCoreDedicatedVmHostsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDedicatedVmHostsResult(
...
def get_core_dedicated_vm_hosts(availability_domain: Optional[str] = None,
                                compartment_id: Optional[str] = None,
                                display_name: Optional[str] = None,
                                filters: Optional[Sequence[pulumi.InputType['GetCoreDedicatedVmHostsFilterArgs']]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDedicatedVmHostsResult:
    """
    ...
    test_dedicated_vm_hosts = oci.get_core_dedicated_vm_hosts(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDedicatedVmHosts:GetCoreDedicatedVmHosts', __args__, opts=opts, typ=GetCoreDedicatedVmHostsResult).value

    return AwaitableGetCoreDedicatedVmHostsResult(
