...
__all__ = [
    'GetOdaOdaInstanceResult',
    'AwaitableGetOdaOdaInstanceResult',
    'get_oda_oda_instance',
]

@pulumi.output_type
class GetOdaOdaInstanceResult:
    """
...
class AwaitableGetOdaOdaInstanceResult(GetOdaOdaInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOdaOdaInstanceResult(
...
def get_oda_oda_instance(oda_instance_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOdaOdaInstanceResult:
    """
    ...
    test_oda_instance = oci.get_oda_oda_instance(oda_instance_id=oci_oda_oda_instance["test_oda_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOdaOdaInstance:GetOdaOdaInstance', __args__, opts=opts, typ=GetOdaOdaInstanceResult).value

    return AwaitableGetOdaOdaInstanceResult(
