...
__all__ = [
    ...
    'AwaitableGetMarketplaceListingsResult',
    'get_marketplace_listings',
]

@pulumi.output_type
class GetMarketplaceListingsResult:
    """
    A collection of values returned by GetMarketplaceListings.
    """
    def __init__(__self__, categories=None, compartment_id=None, filters=None, id=None, is_featured=None, listing_id=None, listing_types=None, listings=None, names=None, operating_systems=None, package_type=None, pricings=None, publisher_id=None):
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMarketplaceListingsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def listings(self) -> Sequence['outputs.GetMarketplaceListingsListingResult']:
        """
...
class AwaitableGetMarketplaceListingsResult(GetMarketplaceListingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplaceListingsResult(
...
def get_marketplace_listings(categories: Optional[Sequence[str]] = None,
                             compartment_id: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetMarketplaceListingsFilterArgs']]] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplaceListingsResult:
    """
    ...
    test_listings = oci.get_marketplace_listings(categories=var["listing_category"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplaceListings:GetMarketplaceListings', __args__, opts=opts, typ=GetMarketplaceListingsResult).value

    return AwaitableGetMarketplaceListingsResult(
