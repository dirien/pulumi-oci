...
__all__ = [
    'GetApmDataKeysResult',
    'AwaitableGetApmDataKeysResult',
    'get_apm_data_keys',
]

@pulumi.output_type
class GetApmDataKeysResult:
    """
    ...
    def data_keys(self) -> Sequence['outputs.GetApmDataKeysDataKeyResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetApmDataKeysFilterResult']]:
...
class AwaitableGetApmDataKeysResult(GetApmDataKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApmDataKeysResult(
...
def get_apm_data_keys(apm_domain_id: Optional[str] = None,
                      data_key_type: Optional[str] = None,
                      filters: Optional[Sequence[pulumi.InputType['GetApmDataKeysFilterArgs']]] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApmDataKeysResult:
    """
    ...
    test_data_keys = oci.get_apm_data_keys(apm_domain_id=oci_apm_apm_domain["test_apm_domain"]["id"],
        data_key_type=var["data_key_data_key_type"])
    ```


    :param str apm_domain_id: OCID of the APM Domain
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApmDataKeys:GetApmDataKeys', __args__, opts=opts, typ=GetApmDataKeysResult).value

    return AwaitableGetApmDataKeysResult(
