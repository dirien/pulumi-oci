...
__all__ = [
    'GetWaasCustomProtectionRuleResult',
    'AwaitableGetWaasCustomProtectionRuleResult',
    'get_waas_custom_protection_rule',
]

@pulumi.output_type
class GetWaasCustomProtectionRuleResult:
    """
...
class AwaitableGetWaasCustomProtectionRuleResult(GetWaasCustomProtectionRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasCustomProtectionRuleResult(
...
def get_waas_custom_protection_rule(custom_protection_rule_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasCustomProtectionRuleResult:
    """
    ...
    test_custom_protection_rule = oci.get_waas_custom_protection_rule(custom_protection_rule_id=oci_waas_custom_protection_rule["test_custom_protection_rule"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasCustomProtectionRule:GetWaasCustomProtectionRule', __args__, opts=opts, typ=GetWaasCustomProtectionRuleResult).value

    return AwaitableGetWaasCustomProtectionRuleResult(
