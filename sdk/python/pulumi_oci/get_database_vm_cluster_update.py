...
__all__ = [
    'GetDatabaseVmClusterUpdateResult',
    'AwaitableGetDatabaseVmClusterUpdateResult',
    'get_database_vm_cluster_update',
]

@pulumi.output_type
class GetDatabaseVmClusterUpdateResult:
    """
...
class AwaitableGetDatabaseVmClusterUpdateResult(GetDatabaseVmClusterUpdateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterUpdateResult(
...
def get_database_vm_cluster_update(update_id: Optional[str] = None,
                                   vm_cluster_id: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterUpdateResult:
    """
    ...
    test_vm_cluster_update = oci.get_database_vm_cluster_update(update_id=oci_database_update["test_update"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterUpdate:GetDatabaseVmClusterUpdate', __args__, opts=opts, typ=GetDatabaseVmClusterUpdateResult).value

    return AwaitableGetDatabaseVmClusterUpdateResult(
