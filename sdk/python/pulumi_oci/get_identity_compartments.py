...
__all__ = [
    'GetIdentityCompartmentsResult',
    'AwaitableGetIdentityCompartmentsResult',
    'get_identity_compartments',
]

@pulumi.output_type
class GetIdentityCompartmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def compartments(self) -> Sequence['outputs.GetIdentityCompartmentsCompartmentResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityCompartmentsFilterResult']]:
...
class AwaitableGetIdentityCompartmentsResult(GetIdentityCompartmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityCompartmentsResult(
...
def get_identity_compartments(access_level: Optional[str] = None,
                              compartment_id: Optional[str] = None,
                              compartment_id_in_subtree: Optional[bool] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetIdentityCompartmentsFilterArgs']]] = None,
                              name: Optional[str] = None,
                              state: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityCompartmentsResult:
    """
    ...
    test_compartments = oci.get_identity_compartments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityCompartments:GetIdentityCompartments', __args__, opts=opts, typ=GetIdentityCompartmentsResult).value

    return AwaitableGetIdentityCompartmentsResult(
