...
__all__ = [
    'GetArtifactsContainerConfigurationResult',
    'AwaitableGetArtifactsContainerConfigurationResult',
    'get_artifacts_container_configuration',
]

@pulumi.output_type
class GetArtifactsContainerConfigurationResult:
    """
...
class AwaitableGetArtifactsContainerConfigurationResult(GetArtifactsContainerConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerConfigurationResult(
...
def get_artifacts_container_configuration(compartment_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerConfigurationResult:
    """
    ...
    test_container_configuration = oci.get_artifacts_container_configuration(compartment_id=var["compartment_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerConfiguration:GetArtifactsContainerConfiguration', __args__, opts=opts, typ=GetArtifactsContainerConfigurationResult).value

    return AwaitableGetArtifactsContainerConfigurationResult(
