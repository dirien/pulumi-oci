...
__all__ = [
    'GetCoreByoipRangeResult',
    'AwaitableGetCoreByoipRangeResult',
    'get_core_byoip_range',
]

@pulumi.output_type
class GetCoreByoipRangeResult:
    """
    A collection of values returned by GetCoreByoipRange.
    """
    def __init__(__self__, byoip_range_id=None, cidr_block=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, state=None, time_advertised=None, time_created=None, time_validated=None, time_withdrawn=None, validation_token=None):
...
class AwaitableGetCoreByoipRangeResult(GetCoreByoipRangeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreByoipRangeResult(
...
def get_core_byoip_range(byoip_range_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreByoipRangeResult:
    """
    ...
    test_byoip_range = oci.get_core_byoip_range(byoip_range_id=oci_core_byoip_range["test_byoip_range"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreByoipRange:GetCoreByoipRange', __args__, opts=opts, typ=GetCoreByoipRangeResult).value

    return AwaitableGetCoreByoipRangeResult(
