...
__all__ = [
    'GetArtifactsContainerImageSignaturesResult',
    'AwaitableGetArtifactsContainerImageSignaturesResult',
    'get_artifacts_container_image_signatures',
]

@pulumi.output_type
class GetArtifactsContainerImageSignaturesResult:
    """
    ...
    def container_image_signature_collections(self) -> Sequence['outputs.GetArtifactsContainerImageSignaturesContainerImageSignatureCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetArtifactsContainerImageSignaturesFilterResult']]:
...
class AwaitableGetArtifactsContainerImageSignaturesResult(GetArtifactsContainerImageSignaturesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerImageSignaturesResult(
...
def get_artifacts_container_image_signatures(compartment_id: Optional[str] = None,
                                             compartment_id_in_subtree: Optional[bool] = None,
                                             display_name: Optional[str] = None,
                                             filters: Optional[Sequence[pulumi.InputType['GetArtifactsContainerImageSignaturesFilterArgs']]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerImageSignaturesResult:
    """
    ...
    test_container_image_signatures = oci.get_artifacts_container_image_signatures(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerImageSignatures:GetArtifactsContainerImageSignatures', __args__, opts=opts, typ=GetArtifactsContainerImageSignaturesResult).value

    return AwaitableGetArtifactsContainerImageSignaturesResult(
