...
__all__ = ['DatascienceModelDeploymentArgs', 'DatascienceModelDeployment']

@pulumi.input_type
class DatascienceModelDeploymentArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 model_deployment_configuration_details: pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs'],
                 project_id: pulumi.Input[str],
                 category_log_details: Optional[pulumi.Input['DatascienceModelDeploymentCategoryLogDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs'] model_deployment_configuration_details: (Updatable) The model deployment configuration details.
        ...
        :param pulumi.Input['DatascienceModelDeploymentCategoryLogDetailsArgs'] category_log_details: (Updatable) The log details for each category.
    ...
    def model_deployment_configuration_details(self) -> pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']:
        """
    ...
    def model_deployment_configuration_details(self, value: pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']):
    ...
    def category_log_details(self) -> Optional[pulumi.Input['DatascienceModelDeploymentCategoryLogDetailsArgs']]:
        """
    ...
    def category_log_details(self, value: Optional[pulumi.Input['DatascienceModelDeploymentCategoryLogDetailsArgs']]):
...
@pulumi.input_type
class _DatascienceModelDeploymentState:
    def __init__(__self__, *,
                 category_log_details: Optional[pulumi.Input['DatascienceModelDeploymentCategoryLogDetailsArgs']] = None,
                 ...
                 model_deployment_configuration_details: Optional[pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="modelDeploymentConfigurationDetails")
    def model_deployment_configuration_details(self) -> Optional[pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']]:
        """
        (Updatable) The model deployment configuration details.
        """
        return pulumi.get(self, "model_deployment_configuration_details")
    ...
    @model_deployment_configuration_details.setter
    def model_deployment_configuration_details(self, value: Optional[pulumi.Input['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']]):
        pulumi.set(self, "model_deployment_configuration_details", value)
...
class DatascienceModelDeployment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 category_log_details: Optional[pulumi.Input[pulumi.InputType['DatascienceModelDeploymentCategoryLogDetailsArgs']]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 model_deployment_configuration_details: Optional[pulumi.Input[pulumi.InputType['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_model_deployment = oci.DatascienceModelDeployment("testModelDeployment",
            compartment_id=var["compartment_id"],
            model_deployment_configuration_details=oci.DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs(
                deployment_type=var["model_deployment_model_deployment_configuration_details_deployment_type"],
                model_configuration_details=oci.DatascienceModelDeploymentModelDeploymentConfigurationDetailsModelConfigurationDetailsArgs(
                    instance_configuration=oci.DatascienceModelDeploymentModelDeploymentConfigurationDetailsModelConfigurationDetailsInstanceConfigurationArgs(
                    ...
                    scaling_policy=oci.DatascienceModelDeploymentModelDeploymentConfigurationDetailsModelConfigurationDetailsScalingPolicyArgs(
            ...
            category_log_details=oci.DatascienceModelDeploymentCategoryLogDetailsArgs(
                access=oci.DatascienceModelDeploymentCategoryLogDetailsAccessArgs(
                    log_group_id=oci_logging_log_group["test_log_group"]["id"],
                    log_id=oci_logging_log["test_log"]["id"],
                ),
                predict=oci.DatascienceModelDeploymentCategoryLogDetailsPredictArgs(
                    log_group_id=oci_logging_log_group["test_log_group"]["id"],
                    log_id=oci_logging_log["test_log"]["id"],
                ),
            ),
        ...
        :param pulumi.Input[pulumi.InputType['DatascienceModelDeploymentCategoryLogDetailsArgs']] category_log_details: (Updatable) The log details for each category.
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the model deployment.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) A short description of the model deployment.
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly display name for the resource. Does not have to be unique, and can be modified. Avoid entering confidential information. Example: `My ModelDeployment`
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['DatascienceModelDeploymentModelDeploymentConfigurationDetailsArgs']] model_deployment_configuration_details: (Updatable) The model deployment configuration details.
        :param pulumi.Input[str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model deployment.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: DatascienceModelDeploymentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Model Deployment resource in Oracle Cloud Infrastructure Datascience service.
        ...
        :param str resource_name: The name of the resource.
        :param DatascienceModelDeploymentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatascienceModelDeploymentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatascienceModelDeploymentArgs.__new__(DatascienceModelDeploymentArgs)
        ...
        super(DatascienceModelDeployment, __self__).__init__(
            'oci:index/datascienceModelDeployment:DatascienceModelDeployment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            project_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'DatascienceModelDeployment':
        """
        ...
        __props__ = _DatascienceModelDeploymentState.__new__(_DatascienceModelDeploymentState)
        ...
        return DatascienceModelDeployment(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="categoryLogDetails")
    def category_log_details(self) -> pulumi.Output['outputs.DatascienceModelDeploymentCategoryLogDetails']:
        """
        (Updatable) The log details for each category.
        """
        return pulumi.get(self, "category_log_details")
    ...
    @property
    @pulumi.getter(name="modelDeploymentConfigurationDetails")
    def model_deployment_configuration_details(self) -> pulumi.Output['outputs.DatascienceModelDeploymentModelDeploymentConfigurationDetails']:
        """
        (Updatable) The model deployment configuration details.
        """
        return pulumi.get(self, "model_deployment_configuration_details")
