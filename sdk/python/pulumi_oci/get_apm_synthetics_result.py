...
__all__ = [
    'GetApmSyntheticsResultResult',
    'AwaitableGetApmSyntheticsResultResult',
    'get_apm_synthetics_result',
]

@pulumi.output_type
class GetApmSyntheticsResultResult:
    """
    ...
    def result_data_sets(self) -> Sequence['outputs.GetApmSyntheticsResultResultDataSetResult']:
        """
...
class AwaitableGetApmSyntheticsResultResult(GetApmSyntheticsResultResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApmSyntheticsResultResult(
...
def get_apm_synthetics_result(apm_domain_id: Optional[str] = None,
                              execution_time: Optional[str] = None,
                              monitor_id: Optional[str] = None,
                              result_content_type: Optional[str] = None,
                              result_type: Optional[str] = None,
                              vantage_point: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApmSyntheticsResultResult:
    """
    ...
    test_result = oci.get_apm_synthetics_result(apm_domain_id=oci_apm_synthetics_apm_domain["test_apm_domain"]["id"],
    ...
    :param str result_type: The result type har or screenshot or log.
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApmSyntheticsResult:GetApmSyntheticsResult', __args__, opts=opts, typ=GetApmSyntheticsResultResult).value

    return AwaitableGetApmSyntheticsResultResult(
