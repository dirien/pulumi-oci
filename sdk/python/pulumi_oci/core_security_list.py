...
__all__ = ['CoreSecurityListArgs', 'CoreSecurityList']

@pulumi.input_type
class CoreSecurityListArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 vcn_id: pulumi.Input[str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 egress_security_rules: Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListEgressSecurityRuleArgs']]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ingress_security_rules: Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListIngressSecurityRuleArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreSecurityListEgressSecurityRuleArgs']]] egress_security_rules: (Updatable) Rules for allowing egress IP packets.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input['CoreSecurityListIngressSecurityRuleArgs']]] ingress_security_rules: (Updatable) Rules for allowing ingress IP packets.
        """
    ...
    def egress_security_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListEgressSecurityRuleArgs']]]]:
        """
    ...
    def egress_security_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListEgressSecurityRuleArgs']]]]):
    ...
    def ingress_security_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListIngressSecurityRuleArgs']]]]:
        """
    ...
    def ingress_security_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreSecurityListIngressSecurityRuleArgs']]]]):
        pulumi.set(self, "ingress_security_rules", value)


@pulumi.input_type
class _CoreSecurityListState:
    def __init__(__self__, *,
...
class CoreSecurityList(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 egress_security_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreSecurityListEgressSecurityRuleArgs']]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ingress_security_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreSecurityListIngressSecurityRuleArgs']]]]] = None,
                 vcn_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_security_list = oci.CoreSecurityList("testSecurityList",
            ...
            egress_security_rules=[oci.CoreSecurityListEgressSecurityRuleArgs(
                ...
                icmp_options=oci.CoreSecurityListEgressSecurityRuleIcmpOptionsArgs(
                ...
                tcp_options=oci.CoreSecurityListEgressSecurityRuleTcpOptionsArgs(
                    ...
                    source_port_range=oci.CoreSecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs(
                ...
                udp_options=oci.CoreSecurityListEgressSecurityRuleUdpOptionsArgs(
                    ...
                    source_port_range=oci.CoreSecurityListEgressSecurityRuleUdpOptionsSourcePortRangeArgs(
            ...
            ingress_security_rules=[oci.CoreSecurityListIngressSecurityRuleArgs(
                ...
                icmp_options=oci.CoreSecurityListIngressSecurityRuleIcmpOptionsArgs(
                ...
                tcp_options=oci.CoreSecurityListIngressSecurityRuleTcpOptionsArgs(
                    ...
                    source_port_range=oci.CoreSecurityListIngressSecurityRuleTcpOptionsSourcePortRangeArgs(
                ...
                udp_options=oci.CoreSecurityListIngressSecurityRuleUdpOptionsArgs(
                    ...
                    source_port_range=oci.CoreSecurityListIngressSecurityRuleUdpOptionsSourcePortRangeArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreSecurityListEgressSecurityRuleArgs']]]] egress_security_rules: (Updatable) Rules for allowing egress IP packets.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreSecurityListIngressSecurityRuleArgs']]]] ingress_security_rules: (Updatable) Rules for allowing ingress IP packets.
        :param pulumi.Input[str] vcn_id: The OCID of the VCN the security list belongs to.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreSecurityListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreSecurityListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreSecurityListArgs.__new__(CoreSecurityListArgs)
        ...
        super(CoreSecurityList, __self__).__init__(
            'oci:index/coreSecurityList:CoreSecurityList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'CoreSecurityList':
        """
        ...
        __props__ = _CoreSecurityListState.__new__(_CoreSecurityListState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        return CoreSecurityList(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="egressSecurityRules")
    def egress_security_rules(self) -> pulumi.Output[Optional[Sequence['outputs.CoreSecurityListEgressSecurityRule']]]:
        """
        (Updatable) Rules for allowing egress IP packets.
        """
        return pulumi.get(self, "egress_security_rules")
    ...
    @property
    @pulumi.getter(name="ingressSecurityRules")
    def ingress_security_rules(self) -> pulumi.Output[Optional[Sequence['outputs.CoreSecurityListIngressSecurityRule']]]:
        """
        (Updatable) Rules for allowing ingress IP packets.
        """
        return pulumi.get(self, "ingress_security_rules")
