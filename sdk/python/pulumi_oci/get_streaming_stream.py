...
__all__ = [
    'GetStreamingStreamResult',
    'AwaitableGetStreamingStreamResult',
    'get_streaming_stream',
]

@pulumi.output_type
class GetStreamingStreamResult:
    """
...
class AwaitableGetStreamingStreamResult(GetStreamingStreamResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStreamingStreamResult(
...
def get_streaming_stream(stream_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamingStreamResult:
    """
    ...
    test_stream = oci.get_streaming_stream(stream_id=oci_streaming_stream["test_stream"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getStreamingStream:GetStreamingStream', __args__, opts=opts, typ=GetStreamingStreamResult).value

    return AwaitableGetStreamingStreamResult(
