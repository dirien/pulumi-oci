...
__all__ = [
    'GetArtifactsContainerRepositoryResult',
    'AwaitableGetArtifactsContainerRepositoryResult',
    'get_artifacts_container_repository',
]

@pulumi.output_type
class GetArtifactsContainerRepositoryResult:
    """
    A collection of values returned by GetArtifactsContainerRepository.
    """
    def __init__(__self__, billable_size_in_gbs=None, compartment_id=None, created_by=None, display_name=None, id=None, image_count=None, is_immutable=None, is_public=None, layer_count=None, layers_size_in_bytes=None, readme=None, repository_id=None, state=None, time_created=None, time_last_pushed=None):
        ...
        if readme and not isinstance(readme, dict):
            raise TypeError("Expected argument 'readme' to be a dict")
    ...
    @property
    @pulumi.getter
    def readme(self) -> 'outputs.GetArtifactsContainerRepositoryReadmeResult':
        """
...
class AwaitableGetArtifactsContainerRepositoryResult(GetArtifactsContainerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerRepositoryResult(
...
def get_artifacts_container_repository(repository_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerRepositoryResult:
    """
    ...
    test_container_repository = oci.get_artifacts_container_repository(repository_id=oci_artifacts_repository["test_repository"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerRepository:GetArtifactsContainerRepository', __args__, opts=opts, typ=GetArtifactsContainerRepositoryResult).value

    return AwaitableGetArtifactsContainerRepositoryResult(
