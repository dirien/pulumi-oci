...
__all__ = [
    'GetCoreNetworkSecurityGroupsResult',
    'AwaitableGetCoreNetworkSecurityGroupsResult',
    'get_core_network_security_groups',
]

@pulumi.output_type
class GetCoreNetworkSecurityGroupsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreNetworkSecurityGroupsFilterResult']]:
    ...
    def network_security_groups(self) -> Sequence['outputs.GetCoreNetworkSecurityGroupsNetworkSecurityGroupResult']:
        """
...
class AwaitableGetCoreNetworkSecurityGroupsResult(GetCoreNetworkSecurityGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreNetworkSecurityGroupsResult(
...
def get_core_network_security_groups(compartment_id: Optional[str] = None,
                                     display_name: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetCoreNetworkSecurityGroupsFilterArgs']]] = None,
                                     state: Optional[str] = None,
                                     vcn_id: Optional[str] = None,
                                     vlan_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreNetworkSecurityGroupsResult:
    """
    ...
    test_network_security_groups = oci.get_core_network_security_groups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreNetworkSecurityGroups:GetCoreNetworkSecurityGroups', __args__, opts=opts, typ=GetCoreNetworkSecurityGroupsResult).value

    return AwaitableGetCoreNetworkSecurityGroupsResult(
