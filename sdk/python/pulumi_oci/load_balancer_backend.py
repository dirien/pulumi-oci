...
class LoadBalancerBackend(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_backend = oci.LoadBalancerBackend("testBackend",
    ...
    def _internal_init(__self__,
        ...
        super(LoadBalancerBackend, __self__).__init__(
            'oci:index/loadBalancerBackend:LoadBalancerBackend',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[int]] = None,
            state: Optional[pulumi.Input[str]] = None,
            weight: Optional[pulumi.Input[int]] = None) -> 'LoadBalancerBackend':
        """
