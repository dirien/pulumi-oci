...
__all__ = [
    'GetDnsSteeringPolicyResult',
    'AwaitableGetDnsSteeringPolicyResult',
    'get_dns_steering_policy',
]

@pulumi.output_type
class GetDnsSteeringPolicyResult:
    """
    ...
    @property
    @pulumi.getter
    def answers(self) -> Sequence['outputs.GetDnsSteeringPolicyAnswerResult']:
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetDnsSteeringPolicyRuleResult']:
        """
...
class AwaitableGetDnsSteeringPolicyResult(GetDnsSteeringPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsSteeringPolicyResult(
...
def get_dns_steering_policy(steering_policy_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsSteeringPolicyResult:
    """
    ...
    test_steering_policy = oci.get_dns_steering_policy(steering_policy_id=oci_dns_steering_policy["test_steering_policy"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsSteeringPolicy:GetDnsSteeringPolicy', __args__, opts=opts, typ=GetDnsSteeringPolicyResult).value

    return AwaitableGetDnsSteeringPolicyResult(
