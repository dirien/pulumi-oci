...
class AwaitableGetCoreSubnetResult(GetCoreSubnetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreSubnetResult(
...
def get_core_subnet(subnet_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreSubnetResult:
    """
    ...
    test_subnet = oci.get_core_subnet(subnet_id=oci_core_subnet["test_subnet"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreSubnet:GetCoreSubnet', __args__, opts=opts, typ=GetCoreSubnetResult).value

    return AwaitableGetCoreSubnetResult(
