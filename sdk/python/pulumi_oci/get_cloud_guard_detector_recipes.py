...
__all__ = [
    'GetCloudGuardDetectorRecipesResult',
    'AwaitableGetCloudGuardDetectorRecipesResult',
    'get_cloud_guard_detector_recipes',
]

@pulumi.output_type
class GetCloudGuardDetectorRecipesResult:
    """
    ...
    def detector_recipe_collections(self) -> Sequence['outputs.GetCloudGuardDetectorRecipesDetectorRecipeCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudGuardDetectorRecipesFilterResult']]:
...
class AwaitableGetCloudGuardDetectorRecipesResult(GetCloudGuardDetectorRecipesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardDetectorRecipesResult(
...
def get_cloud_guard_detector_recipes(access_level: Optional[str] = None,
                                     compartment_id: Optional[str] = None,
                                     compartment_id_in_subtree: Optional[bool] = None,
                                     display_name: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetCloudGuardDetectorRecipesFilterArgs']]] = None,
                                     resource_metadata_only: Optional[bool] = None,
                                     state: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardDetectorRecipesResult:
    """
    ...
    test_detector_recipes = oci.get_cloud_guard_detector_recipes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardDetectorRecipes:GetCloudGuardDetectorRecipes', __args__, opts=opts, typ=GetCloudGuardDetectorRecipesResult).value

    return AwaitableGetCloudGuardDetectorRecipesResult(
