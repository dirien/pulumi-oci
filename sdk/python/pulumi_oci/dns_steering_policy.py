...
__all__ = ['DnsSteeringPolicyArgs', 'DnsSteeringPolicy']

@pulumi.input_type
class DnsSteeringPolicyArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 display_name: pulumi.Input[str],
                 template: pulumi.Input[str],
                 answers: Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyAnswerArgs']]]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 health_check_monitor_id: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyRuleArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyAnswerArgs']]] answers: The set of all answers that can potentially issue from the steering policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyRuleArgs']]] rules: The series of rules that will be processed in sequence to reduce the pool of answers to a response for any given request.
    ...
    @property
    @pulumi.getter
    def answers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyAnswerArgs']]]]:
        """
    ...
    @answers.setter
    def answers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyAnswerArgs']]]]):
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyRuleArgs']]]]:
        """
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsSteeringPolicyRuleArgs']]]]):
...
class DnsSteeringPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 answers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsSteeringPolicyAnswerArgs']]]]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 health_check_monitor_id: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsSteeringPolicyRuleArgs']]]]] = None,
                 template: Optional[pulumi.Input[str]] = None,
                 ttl: Optional[pulumi.Input[int]] = None,
                 __props__=None):
        """
        ...
        test_steering_policy = oci.DnsSteeringPolicy("testSteeringPolicy",
            compartment_id=var["compartment_id"],
            display_name=var["steering_policy_display_name"],
            template=var["steering_policy_template"],
            answers=[oci.DnsSteeringPolicyAnswerArgs(
            ...
            rules=[oci.DnsSteeringPolicyRuleArgs(
                rule_type=var["steering_policy_rules_rule_type"],
                cases=[oci.DnsSteeringPolicyRuleCaseArgs(
                    answer_datas=[oci.DnsSteeringPolicyRuleCaseAnswerDataArgs(
                ...
                default_answer_datas=[oci.DnsSteeringPolicyRuleDefaultAnswerDataArgs(
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsSteeringPolicyAnswerArgs']]]] answers: The set of all answers that can potentially issue from the steering policy.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment containing the steering policy.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the steering policy. Does not have to be unique and can be changed. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] health_check_monitor_id: (Updatable) The OCID of the health check monitor providing health data about the answers of the steering policy. A steering policy answer with `rdata` matching a monitored endpoint will use the health data of that endpoint. A steering policy answer with `rdata` not matching any monitored endpoint will be assumed healthy.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DnsSteeringPolicyRuleArgs']]]] rules: The series of rules that will be processed in sequence to reduce the pool of answers to a response for any given request.
        :param pulumi.Input[str] template: (Updatable) A set of predefined rules based on the desired purpose of the steering policy. Each template utilizes Traffic Management's rules in a different order to produce the desired results when answering DNS queries.
        :param pulumi.Input[int] ttl: (Updatable) The Time To Live (TTL) for responses from the steering policy, in seconds. If not specified during creation, a value of 30 seconds will be used.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DnsSteeringPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsSteeringPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnsSteeringPolicyArgs.__new__(DnsSteeringPolicyArgs)
        ...
        super(DnsSteeringPolicy, __self__).__init__(
            'oci:index/dnsSteeringPolicy:DnsSteeringPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            template: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            ttl: Optional[pulumi.Input[int]] = None) -> 'DnsSteeringPolicy':
        """
        ...
        __props__ = _DnsSteeringPolicyState.__new__(_DnsSteeringPolicyState)
        ...
        __props__.__dict__["ttl"] = ttl
        return DnsSteeringPolicy(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def answers(self) -> pulumi.Output[Sequence['outputs.DnsSteeringPolicyAnswer']]:
        """
        The set of all answers that can potentially issue from the steering policy.
        """
        return pulumi.get(self, "answers")
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.DnsSteeringPolicyRule']]:
        """
        The series of rules that will be processed in sequence to reduce the pool of answers to a response for any given request.
        """
        return pulumi.get(self, "rules")
