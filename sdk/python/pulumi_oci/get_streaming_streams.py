...
__all__ = [
    'GetStreamingStreamsResult',
    'AwaitableGetStreamingStreamsResult',
    'get_streaming_streams',
]

@pulumi.output_type
class GetStreamingStreamsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetStreamingStreamsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def streams(self) -> Sequence['outputs.GetStreamingStreamsStreamResult']:
        """
        The list of streams.
        """
...
class AwaitableGetStreamingStreamsResult(GetStreamingStreamsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStreamingStreamsResult(
...
def get_streaming_streams(compartment_id: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetStreamingStreamsFilterArgs']]] = None,
                          id: Optional[str] = None,
                          name: Optional[str] = None,
                          state: Optional[str] = None,
                          stream_pool_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamingStreamsResult:
    """
    ...
    test_streams = oci.get_streaming_streams(compartment_id=var["compartment_id"],
        id=var["stream_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getStreamingStreams:GetStreamingStreams', __args__, opts=opts, typ=GetStreamingStreamsResult).value

    return AwaitableGetStreamingStreamsResult(
