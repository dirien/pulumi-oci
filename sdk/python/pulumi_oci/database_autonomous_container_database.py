...
__all__ = ['DatabaseAutonomousContainerDatabaseArgs', 'DatabaseAutonomousContainerDatabase']

@pulumi.input_type
class DatabaseAutonomousContainerDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 backup_config: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseBackupConfigArgs']] = None,
                 ...
                 maintenance_window_details: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']] = None,
                 peer_autonomous_container_database_backup_config: Optional[pulumi.Input['DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigArgs']] = None,
        ...
        :param pulumi.Input['DatabaseAutonomousContainerDatabaseBackupConfigArgs'] backup_config: (Updatable) Backup options for the Autonomous Container Database.
        ...
        :param pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    def backup_config(self) -> Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseBackupConfigArgs']]:
        """
    ...
    def backup_config(self, value: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseBackupConfigArgs']]):
    ...
    def maintenance_window_details(self) -> Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']]:
        """
    ...
    def maintenance_window_details(self, value: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']]):
        pulumi.set(self, "maintenance_window_details", value)

    @property
    @pulumi.getter(name="peerAutonomousContainerDatabaseBackupConfig")
    def peer_autonomous_container_database_backup_config(self) -> Optional[pulumi.Input['DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigArgs']]:
    ...
    def peer_autonomous_container_database_backup_config(self, value: Optional[pulumi.Input['DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigArgs']]):
...
@pulumi.input_type
class _DatabaseAutonomousContainerDatabaseState:
    def __init__(__self__, *,
                 autonomous_exadata_infrastructure_id: Optional[pulumi.Input[str]] = None,
                 autonomous_vm_cluster_id: Optional[pulumi.Input[str]] = None,
                 ...
                 maintenance_window: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs']] = None,
                 maintenance_window_details: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs'] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    def maintenance_window(self) -> Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: Optional[pulumi.Input['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs']]):
...
class DatabaseAutonomousContainerDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 autonomous_exadata_infrastructure_id: Optional[pulumi.Input[str]] = None,
                 autonomous_vm_cluster_id: Optional[pulumi.Input[str]] = None,
                 backup_config: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseBackupConfigArgs']]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 db_unique_name: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 key_store_id: Optional[pulumi.Input[str]] = None,
                 kms_key_id: Optional[pulumi.Input[str]] = None,
                 maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']]] = None,
                 patch_model: Optional[pulumi.Input[str]] = None,
                 peer_autonomous_container_database_backup_config: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigArgs']]] = None,
                 peer_autonomous_container_database_compartment_id: Optional[pulumi.Input[str]] = None,
                 peer_autonomous_container_database_display_name: Optional[pulumi.Input[str]] = None,
                 peer_autonomous_exadata_infrastructure_id: Optional[pulumi.Input[str]] = None,
                 peer_autonomous_vm_cluster_id: Optional[pulumi.Input[str]] = None,
        ...
        test_autonomous_container_database = oci.DatabaseAutonomousContainerDatabase("testAutonomousContainerDatabase",
            ...
            backup_config=oci.DatabaseAutonomousContainerDatabaseBackupConfigArgs(
                backup_destination_details=oci.DatabaseAutonomousContainerDatabaseBackupConfigBackupDestinationDetailsArgs(
            ...
            maintenance_window_details=oci.DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs(
                preference=var["autonomous_container_database_maintenance_window_details_preference"],
                days_of_weeks=[oci.DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs(
                ...
                months=[oci.DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs(
            ...
            peer_autonomous_container_database_backup_config=oci.DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigArgs(
                backup_destination_details=[oci.DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfigBackupDestinationDetailArgs(
        ...
        :param pulumi.Input[str] autonomous_exadata_infrastructure_id: The OCID of the Autonomous Exadata Infrastructure.
        :param pulumi.Input[str] autonomous_vm_cluster_id: The OCID of the Autonomous VM Cluster.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseBackupConfigArgs']] backup_config: (Updatable) Backup options for the Autonomous Container Database.
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Autonomous Container Database.
        :param pulumi.Input[str] db_unique_name: The `DB_UNIQUE_NAME` of the Oracle Database being backed up.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) The display name for the Autonomous Container Database.
        ...
        :param pulumi.Input[str] key_store_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the key store.
        :param pulumi.Input[str] kms_key_id: The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[str] patch_model: (Updatable) Database Patch model preference.
        :param pulumi.Input[str] peer_autonomous_container_database_compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where the standby Autonomous Container Database will be created.
        :param pulumi.Input[str] peer_autonomous_container_database_display_name: The display name for the peer Autonomous Container Database.
        :param pulumi.Input[str] peer_autonomous_exadata_infrastructure_id: The OCID of the peer Autonomous Exadata Infrastructure for autonomous dataguard.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseAutonomousContainerDatabaseArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Autonomous Container Database resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseAutonomousContainerDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseAutonomousContainerDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseAutonomousContainerDatabaseArgs.__new__(DatabaseAutonomousContainerDatabaseArgs)
        ...
        super(DatabaseAutonomousContainerDatabase, __self__).__init__(
            'oci:index/databaseAutonomousContainerDatabase:DatabaseAutonomousContainerDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            last_maintenance_run_id: Optional[pulumi.Input[str]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            maintenance_window: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs']]] = None,
            maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']]] = None,
            next_maintenance_run_id: Optional[pulumi.Input[str]] = None,
            patch_id: Optional[pulumi.Input[str]] = None,
            patch_model: Optional[pulumi.Input[str]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vault_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseAutonomousContainerDatabase':
        """
        ...
        :param pulumi.Input[str] last_maintenance_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance run.
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowArgs']] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousContainerDatabaseMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[str] next_maintenance_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next maintenance run.
        :param pulumi.Input[str] patch_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last patch applied on the system.
        :param pulumi.Input[str] patch_model: (Updatable) Database Patch model preference.
        ...
        __props__ = _DatabaseAutonomousContainerDatabaseState.__new__(_DatabaseAutonomousContainerDatabaseState)
        ...
        __props__.__dict__["vault_id"] = vault_id
        return DatabaseAutonomousContainerDatabase(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="backupConfig")
    def backup_config(self) -> pulumi.Output['outputs.DatabaseAutonomousContainerDatabaseBackupConfig']:
        """
        (Updatable) Backup options for the Autonomous Container Database.
        """
        return pulumi.get(self, "backup_config")
    ...
    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output['outputs.DatabaseAutonomousContainerDatabaseMaintenanceWindow']:
        """
        The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window")
    ...
    @property
    @pulumi.getter(name="maintenanceWindowDetails")
    def maintenance_window_details(self) -> pulumi.Output[Optional['outputs.DatabaseAutonomousContainerDatabaseMaintenanceWindowDetails']]:
        """
        (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window_details")
    ...
    @property
    @pulumi.getter(name="peerAutonomousContainerDatabaseBackupConfig")
    def peer_autonomous_container_database_backup_config(self) -> pulumi.Output['outputs.DatabaseAutonomousContainerDatabasePeerAutonomousContainerDatabaseBackupConfig']:
        return pulumi.get(self, "peer_autonomous_container_database_backup_config")
