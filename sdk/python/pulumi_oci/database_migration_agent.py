...
__all__ = ['DatabaseMigrationAgentArgs', 'DatabaseMigrationAgent']

@pulumi.input_type
class DatabaseMigrationAgentArgs:
...
@pulumi.input_type
class _DatabaseMigrationAgentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] public_key: (Updatable) ODMS Agent public key.
        :param pulumi.Input[str] state: The current state of the ODMS On Prem Agent.
        :param pulumi.Input[str] stream_id: (Updatable) The OCID of the Stream
...
class DatabaseMigrationAgent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseMigrationAgentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Agent resource in Oracle Cloud Infrastructure Database Migration service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseMigrationAgentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseMigrationAgentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseMigrationAgentArgs.__new__(DatabaseMigrationAgentArgs)
        ...
        super(DatabaseMigrationAgent, __self__).__init__(
            'oci:index/databaseMigrationAgent:DatabaseMigrationAgent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[str]] = None) -> 'DatabaseMigrationAgent':
        """
        ...
        __props__ = _DatabaseMigrationAgentState.__new__(_DatabaseMigrationAgentState)
        ...
        __props__.__dict__["version"] = version
        return DatabaseMigrationAgent(resource_name, opts=opts, __props__=__props__)
