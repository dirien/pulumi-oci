...
def get_identity_group(group_id: Optional[str] = None,
    ...
    test_group = oci.get_identity_group(group_id=oci_identity_group["test_group"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityGroup:GetIdentityGroup', __args__, opts=opts, typ=GetIdentityGroupResult).value
