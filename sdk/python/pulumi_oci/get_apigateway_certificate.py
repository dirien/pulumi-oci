...
__all__ = [
    'GetApigatewayCertificateResult',
    'AwaitableGetApigatewayCertificateResult',
    'get_apigateway_certificate',
]

@pulumi.output_type
class GetApigatewayCertificateResult:
    """
...
class AwaitableGetApigatewayCertificateResult(GetApigatewayCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayCertificateResult(
...
def get_apigateway_certificate(certificate_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayCertificateResult:
    """
    ...
    test_certificate = oci.get_apigateway_certificate(certificate_id=oci_apigateway_certificate["test_certificate"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayCertificate:GetApigatewayCertificate', __args__, opts=opts, typ=GetApigatewayCertificateResult).value

    return AwaitableGetApigatewayCertificateResult(
