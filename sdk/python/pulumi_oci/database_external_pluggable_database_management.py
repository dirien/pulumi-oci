...
__all__ = ['DatabaseExternalPluggableDatabaseManagementArgs', 'DatabaseExternalPluggableDatabaseManagement']

@pulumi.input_type
class DatabaseExternalPluggableDatabaseManagementArgs:
...
@pulumi.input_type
class _DatabaseExternalPluggableDatabaseManagementState:
    def __init__(__self__, *,
...
class DatabaseExternalPluggableDatabaseManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_external_pluggable_database_management = oci.DatabaseExternalPluggableDatabaseManagement("testExternalPluggableDatabaseManagement",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseExternalPluggableDatabaseManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the External Pluggable Database Management resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseExternalPluggableDatabaseManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseExternalPluggableDatabaseManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseExternalPluggableDatabaseManagementArgs.__new__(DatabaseExternalPluggableDatabaseManagementArgs)
        ...
        super(DatabaseExternalPluggableDatabaseManagement, __self__).__init__(
            'oci:index/databaseExternalPluggableDatabaseManagement:DatabaseExternalPluggableDatabaseManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enable_management: Optional[pulumi.Input[bool]] = None,
            external_database_connector_id: Optional[pulumi.Input[str]] = None,
            external_pluggable_database_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseExternalPluggableDatabaseManagement':
        """
        ...
        __props__ = _DatabaseExternalPluggableDatabaseManagementState.__new__(_DatabaseExternalPluggableDatabaseManagementState)

        __props__.__dict__["enable_management"] = enable_management
        __props__.__dict__["external_database_connector_id"] = external_database_connector_id
        __props__.__dict__["external_pluggable_database_id"] = external_pluggable_database_id
        return DatabaseExternalPluggableDatabaseManagement(resource_name, opts=opts, __props__=__props__)
