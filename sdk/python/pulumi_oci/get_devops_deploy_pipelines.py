...
__all__ = [
    'GetDevopsDeployPipelinesResult',
    'AwaitableGetDevopsDeployPipelinesResult',
    'get_devops_deploy_pipelines',
]

@pulumi.output_type
class GetDevopsDeployPipelinesResult:
    """
    ...
    def deploy_pipeline_collections(self) -> Sequence['outputs.GetDevopsDeployPipelinesDeployPipelineCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDevopsDeployPipelinesFilterResult']]:
...
class AwaitableGetDevopsDeployPipelinesResult(GetDevopsDeployPipelinesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployPipelinesResult(
...
def get_devops_deploy_pipelines(compartment_id: Optional[str] = None,
                                display_name: Optional[str] = None,
                                filters: Optional[Sequence[pulumi.InputType['GetDevopsDeployPipelinesFilterArgs']]] = None,
                                id: Optional[str] = None,
                                project_id: Optional[str] = None,
                                state: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployPipelinesResult:
    """
    ...
    test_deploy_pipelines = oci.get_devops_deploy_pipelines(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployPipelines:GetDevopsDeployPipelines', __args__, opts=opts, typ=GetDevopsDeployPipelinesResult).value

    return AwaitableGetDevopsDeployPipelinesResult(
