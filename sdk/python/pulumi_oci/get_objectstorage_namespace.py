...
__all__ = [
    'GetObjectstorageNamespaceResult',
    'AwaitableGetObjectstorageNamespaceResult',
    'get_objectstorage_namespace',
]

@pulumi.output_type
class GetObjectstorageNamespaceResult:
    """
...
class AwaitableGetObjectstorageNamespaceResult(GetObjectstorageNamespaceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageNamespaceResult(
            compartment_id=self.compartment_id,
            id=self.id,
            namespace=self.namespace)


def get_objectstorage_namespace(compartment_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageNamespaceResult:
    """
    ...
    test_namespace = oci.get_objectstorage_namespace(compartment_id=var["compartment_id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageNamespace:GetObjectstorageNamespace', __args__, opts=opts, typ=GetObjectstorageNamespaceResult).value

    return AwaitableGetObjectstorageNamespaceResult(
