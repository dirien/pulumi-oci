...
__all__ = [
    'GetIdentityIdentityProvidersResult',
    'AwaitableGetIdentityIdentityProvidersResult',
    'get_identity_identity_providers',
]

@pulumi.output_type
class GetIdentityIdentityProvidersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityIdentityProvidersFilterResult']]:
    ...
    def identity_providers(self) -> Sequence['outputs.GetIdentityIdentityProvidersIdentityProviderResult']:
        """
...
class AwaitableGetIdentityIdentityProvidersResult(GetIdentityIdentityProvidersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityIdentityProvidersResult(
...
def get_identity_identity_providers(compartment_id: Optional[str] = None,
                                    filters: Optional[Sequence[pulumi.InputType['GetIdentityIdentityProvidersFilterArgs']]] = None,
                                    name: Optional[str] = None,
                                    protocol: Optional[str] = None,
                                    state: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityIdentityProvidersResult:
    """
    ...
    test_identity_providers = oci.get_identity_identity_providers(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityIdentityProviders:GetIdentityIdentityProviders', __args__, opts=opts, typ=GetIdentityIdentityProvidersResult).value

    return AwaitableGetIdentityIdentityProvidersResult(
