...
__all__ = ['DatabaseAutonomousDatabaseInstanceWalletManagementArgs', 'DatabaseAutonomousDatabaseInstanceWalletManagement']

@pulumi.input_type
class DatabaseAutonomousDatabaseInstanceWalletManagementArgs:
...
@pulumi.input_type
class _DatabaseAutonomousDatabaseInstanceWalletManagementState:
    def __init__(__self__, *,
...
class DatabaseAutonomousDatabaseInstanceWalletManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_autonomous_database_instance_wallet_management = oci.DatabaseAutonomousDatabaseInstanceWalletManagement("testAutonomousDatabaseInstanceWalletManagement",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseAutonomousDatabaseInstanceWalletManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Autonomous Database Instance Wallet Management resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseAutonomousDatabaseInstanceWalletManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseAutonomousDatabaseInstanceWalletManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseAutonomousDatabaseInstanceWalletManagementArgs.__new__(DatabaseAutonomousDatabaseInstanceWalletManagementArgs)
        ...
        super(DatabaseAutonomousDatabaseInstanceWalletManagement, __self__).__init__(
            'oci:index/databaseAutonomousDatabaseInstanceWalletManagement:DatabaseAutonomousDatabaseInstanceWalletManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_rotate: Optional[pulumi.Input[bool]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_rotated: Optional[pulumi.Input[str]] = None) -> 'DatabaseAutonomousDatabaseInstanceWalletManagement':
        """
        ...
        __props__ = _DatabaseAutonomousDatabaseInstanceWalletManagementState.__new__(_DatabaseAutonomousDatabaseInstanceWalletManagementState)

        __props__.__dict__["autonomous_database_id"] = autonomous_database_id
        __props__.__dict__["should_rotate"] = should_rotate
        __props__.__dict__["state"] = state
        __props__.__dict__["time_rotated"] = time_rotated
        return DatabaseAutonomousDatabaseInstanceWalletManagement(resource_name, opts=opts, __props__=__props__)
