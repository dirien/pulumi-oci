...
__all__ = [
    'GetServiceCatalogPrivateApplicationResult',
    'AwaitableGetServiceCatalogPrivateApplicationResult',
    'get_service_catalog_private_application',
]

@pulumi.output_type
class GetServiceCatalogPrivateApplicationResult:
    """
    ...
    @property
    @pulumi.getter
    def logo(self) -> 'outputs.GetServiceCatalogPrivateApplicationLogoResult':
        """
    ...
    def package_details(self) -> 'outputs.GetServiceCatalogPrivateApplicationPackageDetailsResult':
...
class AwaitableGetServiceCatalogPrivateApplicationResult(GetServiceCatalogPrivateApplicationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceCatalogPrivateApplicationResult(
...
def get_service_catalog_private_application(private_application_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceCatalogPrivateApplicationResult:
    """
    ...
    test_private_application = oci.get_service_catalog_private_application(private_application_id=oci_service_catalog_private_application["test_private_application"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getServiceCatalogPrivateApplication:GetServiceCatalogPrivateApplication', __args__, opts=opts, typ=GetServiceCatalogPrivateApplicationResult).value

    return AwaitableGetServiceCatalogPrivateApplicationResult(
