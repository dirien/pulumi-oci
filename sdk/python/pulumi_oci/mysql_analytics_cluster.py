...
__all__ = ['MysqlAnalyticsClusterArgs', 'MysqlAnalyticsCluster']

@pulumi.input_type
class MysqlAnalyticsClusterArgs:
...
@pulumi.input_type
class _MysqlAnalyticsClusterState:
    def __init__(__self__, *,
                 cluster_nodes: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlAnalyticsClusterClusterNodeArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MysqlAnalyticsClusterClusterNodeArgs']]] cluster_nodes: An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
        :param pulumi.Input[int] cluster_size: (Updatable) A change to the number of nodes in the Analytics Cluster will result in the entire cluster being torn down and re-created with the new cluster of nodes. This may result in a significant downtime for the analytics capability while the Analytics Cluster is re-provisioned.
        :param pulumi.Input[str] db_system_id: The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    def cluster_nodes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['MysqlAnalyticsClusterClusterNodeArgs']]]]:
        """
    ...
    def cluster_nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['MysqlAnalyticsClusterClusterNodeArgs']]]]):
...
class MysqlAnalyticsCluster(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_analytics_cluster = oci.MysqlAnalyticsCluster("testAnalyticsCluster",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MysqlAnalyticsClusterArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Analytics Cluster resource in Oracle Cloud Infrastructure MySQL Database service.
        ...
        :param str resource_name: The name of the resource.
        :param MysqlAnalyticsClusterArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MysqlAnalyticsClusterArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MysqlAnalyticsClusterArgs.__new__(MysqlAnalyticsClusterArgs)
        ...
        super(MysqlAnalyticsCluster, __self__).__init__(
            'oci:index/mysqlAnalyticsCluster:MysqlAnalyticsCluster',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_nodes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlAnalyticsClusterClusterNodeArgs']]]]] = None,
            cluster_size: Optional[pulumi.Input[int]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            shape_name: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'MysqlAnalyticsCluster':
        """
        Get an existing MysqlAnalyticsCluster resource's state with the given name, id, and optional extra
        properties used to qualify the lookup.

        :param str resource_name: The unique name of the resulting resource.
        :param pulumi.Input[str] id: The unique provider ID of the resource to lookup.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MysqlAnalyticsClusterClusterNodeArgs']]]] cluster_nodes: An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
        :param pulumi.Input[int] cluster_size: (Updatable) A change to the number of nodes in the Analytics Cluster will result in the entire cluster being torn down and re-created with the new cluster of nodes. This may result in a significant downtime for the analytics capability while the Analytics Cluster is re-provisioned.
        :param pulumi.Input[str] db_system_id: The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycleState.
        :param pulumi.Input[str] shape_name: (Updatable) A change to the shape of the nodes in the Analytics Cluster will result in the entire cluster being torn down and re-created with Compute instances of the new Shape. This may result in significant downtime for the analytics capability while the Analytics Cluster is re-provisioned.
        ...
        __props__ = _MysqlAnalyticsClusterState.__new__(_MysqlAnalyticsClusterState)
        ...
        return MysqlAnalyticsCluster(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="clusterNodes")
    def cluster_nodes(self) -> pulumi.Output[Sequence['outputs.MysqlAnalyticsClusterClusterNode']]:
        """
        An Analytics Cluster Node is a compute host that is part of an Analytics Cluster.
        """
        return pulumi.get(self, "cluster_nodes")
