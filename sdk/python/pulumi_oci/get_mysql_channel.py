...
__all__ = [
    'GetMysqlChannelResult',
    'AwaitableGetMysqlChannelResult',
    'get_mysql_channel',
]

@pulumi.output_type
class GetMysqlChannelResult:
    """
    A collection of values returned by GetMysqlChannel.
    """
    def __init__(__self__, channel_id=None, compartment_id=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, is_enabled=None, lifecycle_details=None, source=None, state=None, target=None, time_created=None, time_updated=None):
    ...
    @property
    @pulumi.getter
    def source(self) -> 'outputs.GetMysqlChannelSourceResult':
        """
    ...
    @property
    @pulumi.getter
    def target(self) -> 'outputs.GetMysqlChannelTargetResult':
        """
...
class AwaitableGetMysqlChannelResult(GetMysqlChannelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlChannelResult(
...
def get_mysql_channel(channel_id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlChannelResult:
    """
    ...
    test_channel = oci.get_mysql_channel(channel_id=oci_mysql_channel["test_channel"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlChannel:GetMysqlChannel', __args__, opts=opts, typ=GetMysqlChannelResult).value

    return AwaitableGetMysqlChannelResult(
