...
class GetTargetsResult:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetTargetsFilterResult']]:
    ...
    def target_collections(self) -> Sequence['outputs.GetTargetsTargetCollectionResult']:
        """
...
class AwaitableGetTargetsResult(GetTargetsResult):
...
def get_targets(access_level: Optional[str] = None,
                compartment_id: Optional[str] = None,
                compartment_id_in_subtree: Optional[bool] = None,
                display_name: Optional[str] = None,
                filters: Optional[Sequence[pulumi.InputType['GetTargetsFilterArgs']]] = None,
                state: Optional[str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTargetsResult:
    """
    ...
    test_targets = oci.cloudguard.get_targets(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:cloudguard/getTargets:getTargets', __args__, opts=opts, typ=GetTargetsResult).value

    return AwaitableGetTargetsResult(
