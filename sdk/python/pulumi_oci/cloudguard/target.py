...
class Target(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_target = oci.cloudguard.Target("testTarget",
            ...
            target_detector_recipes=[oci.cloudguard.TargetTargetDetectorRecipeArgs(
                detector_recipe_id=oci_cloud_guard_detector_recipe["test_detector_recipe"]["id"],
                detector_rules=[oci.cloudguard.TargetTargetDetectorRecipeDetectorRuleArgs(
                    details=oci.cloudguard.TargetTargetDetectorRecipeDetectorRuleDetailsArgs(
                        condition_groups=[oci.cloudguard.TargetTargetDetectorRecipeDetectorRuleDetailsConditionGroupArgs(
                            compartment_id=var["compartment_id"],
            ...
            target_responder_recipes=[oci.cloudguard.TargetTargetResponderRecipeArgs(
                responder_recipe_id=oci_cloud_guard_responder_recipe["test_responder_recipe"]["id"],
                responder_rules=[oci.cloudguard.TargetTargetResponderRecipeResponderRuleArgs(
                    details=oci.cloudguard.TargetTargetResponderRecipeResponderRuleDetailsArgs(
                        condition=var["target_target_responder_recipes_responder_rules_details_condition"],
                        configurations=[oci.cloudguard.TargetTargetResponderRecipeResponderRuleDetailsConfigurationArgs(
