...
__all__ = [
    'GetWaasProtectionRuleResult',
    'AwaitableGetWaasProtectionRuleResult',
    'get_waas_protection_rule',
]

@pulumi.output_type
class GetWaasProtectionRuleResult:
    """
    ...
    @property
    @pulumi.getter
    def exclusions(self) -> Sequence['outputs.GetWaasProtectionRuleExclusionResult']:
        """
...
class AwaitableGetWaasProtectionRuleResult(GetWaasProtectionRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasProtectionRuleResult(
            action=self.action,
...
def get_waas_protection_rule(protection_rule_key: Optional[str] = None,
                             waas_policy_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasProtectionRuleResult:
    """
    ...
    test_protection_rule = oci.get_waas_protection_rule(protection_rule_key=var["protection_rule_protection_rule_key"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasProtectionRule:GetWaasProtectionRule', __args__, opts=opts, typ=GetWaasProtectionRuleResult).value

    return AwaitableGetWaasProtectionRuleResult(
