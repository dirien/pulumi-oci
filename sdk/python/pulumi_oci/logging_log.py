...
__all__ = ['LoggingLogArgs', 'LoggingLog']

@pulumi.input_type
class LoggingLogArgs:
    def __init__(__self__, *,
                 display_name: pulumi.Input[str],
                 log_group_id: pulumi.Input[str],
                 log_type: pulumi.Input[str],
                 configuration: Optional[pulumi.Input['LoggingLogConfigurationArgs']] = None,
        ...
        :param pulumi.Input['LoggingLogConfigurationArgs'] configuration: Log object configuration.
    ...
    @property
    @pulumi.getter
    def configuration(self) -> Optional[pulumi.Input['LoggingLogConfigurationArgs']]:
        """
    ...
    def configuration(self, value: Optional[pulumi.Input['LoggingLogConfigurationArgs']]):
...
class LoggingLog(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 configuration: Optional[pulumi.Input[pulumi.InputType['LoggingLogConfigurationArgs']]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 is_enabled: Optional[pulumi.Input[bool]] = None,
        ...
        test_log = oci.LoggingLog("testLog",
            display_name=var["log_display_name"],
            log_group_id=oci_logging_log_group["test_log_group"]["id"],
            log_type=var["log_log_type"],
            configuration=oci.LoggingLogConfigurationArgs(
                source=oci.LoggingLogConfigurationSourceArgs(
        ...
        :param pulumi.Input[pulumi.InputType['LoggingLogConfigurationArgs']] configuration: Log object configuration.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) The user-friendly display name. This must be unique within the enclosing resource, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_enabled: (Updatable) Whether or not this resource is currently enabled.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LoggingLogArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoggingLogArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LoggingLogArgs.__new__(LoggingLogArgs)
        ...
        super(LoggingLog, __self__).__init__(
            'oci:index/loggingLog:LoggingLog',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tenancy_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_last_modified: Optional[pulumi.Input[str]] = None) -> 'LoggingLog':
        """
        ...
        __props__ = _LoggingLogState.__new__(_LoggingLogState)
        ...
        return LoggingLog(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def configuration(self) -> pulumi.Output['outputs.LoggingLogConfiguration']:
        """
        Log object configuration.
        """
        return pulumi.get(self, "configuration")
