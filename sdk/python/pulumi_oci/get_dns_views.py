...
__all__ = [
    'GetDnsViewsResult',
    'AwaitableGetDnsViewsResult',
    'get_dns_views',
]

@pulumi.output_type
class GetDnsViewsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsViewsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def views(self) -> Sequence['outputs.GetDnsViewsViewResult']:
        """
        The list of views.
        """
...
class AwaitableGetDnsViewsResult(GetDnsViewsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsViewsResult(
...
def get_dns_views(compartment_id: Optional[str] = None,
                  display_name: Optional[str] = None,
                  filters: Optional[Sequence[pulumi.InputType['GetDnsViewsFilterArgs']]] = None,
                  id: Optional[str] = None,
                  scope: Optional[str] = None,
                  state: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsViewsResult:
    """
    ...
    test_views = oci.get_dns_views(compartment_id=var["compartment_id"],
        scope="PRIVATE",
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsViews:GetDnsViews', __args__, opts=opts, typ=GetDnsViewsResult).value

    return AwaitableGetDnsViewsResult(
