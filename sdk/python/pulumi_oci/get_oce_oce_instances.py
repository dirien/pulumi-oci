...
__all__ = [
    'GetOceOceInstancesResult',
    'AwaitableGetOceOceInstancesResult',
    'get_oce_oce_instances',
]

@pulumi.output_type
class GetOceOceInstancesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOceOceInstancesFilterResult']]:
    ...
    def oce_instances(self) -> Sequence['outputs.GetOceOceInstancesOceInstanceResult']:
        """
...
class AwaitableGetOceOceInstancesResult(GetOceOceInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOceOceInstancesResult(
...
def get_oce_oce_instances(compartment_id: Optional[str] = None,
                          display_name: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetOceOceInstancesFilterArgs']]] = None,
                          state: Optional[str] = None,
                          tenancy_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOceOceInstancesResult:
    """
    ...
    test_oce_instances = oci.get_oce_oce_instances(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOceOceInstances:GetOceOceInstances', __args__, opts=opts, typ=GetOceOceInstancesResult).value

    return AwaitableGetOceOceInstancesResult(
