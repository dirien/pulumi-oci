...
__all__ = [
    'GetDevopsDeployStageResult',
    'AwaitableGetDevopsDeployStageResult',
    'get_devops_deploy_stage',
]

@pulumi.output_type
class GetDevopsDeployStageResult:
    """
    ...
    def approval_policy(self) -> 'outputs.GetDevopsDeployStageApprovalPolicyResult':
        """
    ...
    def blue_backend_ips(self) -> 'outputs.GetDevopsDeployStageBlueBackendIpsResult':
        """
    ...
    def deploy_stage_predecessor_collection(self) -> 'outputs.GetDevopsDeployStageDeployStagePredecessorCollectionResult':
        """
    ...
    def failure_policy(self) -> 'outputs.GetDevopsDeployStageFailurePolicyResult':
        """
    ...
    def green_backend_ips(self) -> 'outputs.GetDevopsDeployStageGreenBackendIpsResult':
        """
        Collection of backend environment IP addresses.
        """
    ...
    def load_balancer_config(self) -> 'outputs.GetDevopsDeployStageLoadBalancerConfigResult':
        """
    ...
    def rollback_policy(self) -> 'outputs.GetDevopsDeployStageRollbackPolicyResult':
        """
    ...
    def rollout_policy(self) -> 'outputs.GetDevopsDeployStageRolloutPolicyResult':
        """
    ...
    def wait_criteria(self) -> 'outputs.GetDevopsDeployStageWaitCriteriaResult':
        """
...
class AwaitableGetDevopsDeployStageResult(GetDevopsDeployStageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployStageResult(
...
def get_devops_deploy_stage(deploy_stage_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployStageResult:
    """
    ...
    test_deploy_stage = oci.get_devops_deploy_stage(deploy_stage_id=oci_devops_deploy_stage["test_deploy_stage"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployStage:GetDevopsDeployStage', __args__, opts=opts, typ=GetDevopsDeployStageResult).value

    return AwaitableGetDevopsDeployStageResult(
