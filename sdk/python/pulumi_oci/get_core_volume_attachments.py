...
__all__ = [
    'GetCoreVolumeAttachmentsResult',
    'AwaitableGetCoreVolumeAttachmentsResult',
    'get_core_volume_attachments',
]

@pulumi.output_type
class GetCoreVolumeAttachmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVolumeAttachmentsFilterResult']]:
    ...
    def volume_attachments(self) -> Sequence['outputs.GetCoreVolumeAttachmentsVolumeAttachmentResult']:
        """
...
class AwaitableGetCoreVolumeAttachmentsResult(GetCoreVolumeAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVolumeAttachmentsResult(
...
def get_core_volume_attachments(availability_domain: Optional[str] = None,
                                compartment_id: Optional[str] = None,
                                filters: Optional[Sequence[pulumi.InputType['GetCoreVolumeAttachmentsFilterArgs']]] = None,
                                instance_id: Optional[str] = None,
                                volume_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVolumeAttachmentsResult:
    """
    ...
    test_volume_attachments = oci.get_core_volume_attachments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVolumeAttachments:GetCoreVolumeAttachments', __args__, opts=opts, typ=GetCoreVolumeAttachmentsResult).value

    return AwaitableGetCoreVolumeAttachmentsResult(
