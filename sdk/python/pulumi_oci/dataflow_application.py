...
__all__ = ['DataflowApplicationArgs', 'DataflowApplication']

@pulumi.input_type
class DataflowApplicationArgs:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['DataflowApplicationParameterArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DataflowApplicationParameterArgs']]]]:
        """
    ...
    @parameters.setter
    def parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DataflowApplicationParameterArgs']]]]):
...
@pulumi.input_type
class _DataflowApplicationState:
    def __init__(__self__, *,
                 archive_uri: Optional[pulumi.Input[str]] = None,
                 arguments: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 class_name: Optional[pulumi.Input[str]] = None,
...
class DataflowApplication(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 metastore_id: Optional[pulumi.Input[str]] = None,
                 num_executors: Optional[pulumi.Input[int]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataflowApplicationParameterArgs']]]]] = None,
                 private_endpoint_id: Optional[pulumi.Input[str]] = None,
                 spark_version: Optional[pulumi.Input[str]] = None,
                 warehouse_bucket_uri: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        test_application = oci.DataflowApplication("testApplication",
            ...
            parameters=[oci.DataflowApplicationParameterArgs(
        ...
        :param pulumi.Input[str] metastore_id: (Updatable) The OCID of Oracle Cloud Infrastructure Hive Metastore.
        :param pulumi.Input[int] num_executors: (Updatable) The number of executor VMs requested.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DataflowApplicationParameterArgs']]]] parameters: (Updatable) An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        :param pulumi.Input[str] private_endpoint_id: (Updatable) The OCID of a private endpoint.
        :param pulumi.Input[str] spark_version: (Updatable) The Spark version utilized to run the application.
        :param pulumi.Input[str] warehouse_bucket_uri: (Updatable) An Oracle Cloud Infrastructure URI of the bucket to be used as default warehouse directory for BATCH SQL runs. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DataflowApplicationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataflowApplicationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataflowApplicationArgs.__new__(DataflowApplicationArgs)
        ...
        super(DataflowApplication, __self__).__init__(
            'oci:index/dataflowApplication:DataflowApplication',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            warehouse_bucket_uri: Optional[pulumi.Input[str]] = None) -> 'DataflowApplication':
        """
        ...
        __props__ = _DataflowApplicationState.__new__(_DataflowApplicationState)
        ...
        __props__.__dict__["warehouse_bucket_uri"] = warehouse_bucket_uri
        return DataflowApplication(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Sequence['outputs.DataflowApplicationParameter']]:
        """
        (Updatable) An array of name/value pairs used to fill placeholders found in properties like `Application.arguments`.  The name must be a string of one or more word characters (a-z, A-Z, 0-9, _).  The value can be a string of 0 or more characters of any kind. Example:  [ { name: "iterations", value: "10"}, { name: "input_file", value: "mydata.xml" }, { name: "variable_x", value: "${x}"} ]
        """
        return pulumi.get(self, "parameters")
