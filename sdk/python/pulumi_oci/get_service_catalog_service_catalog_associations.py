...
__all__ = [
    'GetServiceCatalogServiceCatalogAssociationsResult',
    'AwaitableGetServiceCatalogServiceCatalogAssociationsResult',
    'get_service_catalog_service_catalog_associations',
]

@pulumi.output_type
class GetServiceCatalogServiceCatalogAssociationsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetServiceCatalogServiceCatalogAssociationsFilterResult']]:
    ...
    def service_catalog_association_collections(self) -> Sequence['outputs.GetServiceCatalogServiceCatalogAssociationsServiceCatalogAssociationCollectionResult']:
        """
...
class AwaitableGetServiceCatalogServiceCatalogAssociationsResult(GetServiceCatalogServiceCatalogAssociationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceCatalogServiceCatalogAssociationsResult(
...
def get_service_catalog_service_catalog_associations(entity_id: Optional[str] = None,
                                                     entity_type: Optional[str] = None,
                                                     filters: Optional[Sequence[pulumi.InputType['GetServiceCatalogServiceCatalogAssociationsFilterArgs']]] = None,
                                                     service_catalog_association_id: Optional[str] = None,
                                                     service_catalog_id: Optional[str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceCatalogServiceCatalogAssociationsResult:
    """
    ...
    test_service_catalog_associations = oci.get_service_catalog_service_catalog_associations(entity_id=oci_service_catalog_entity["test_entity"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getServiceCatalogServiceCatalogAssociations:GetServiceCatalogServiceCatalogAssociations', __args__, opts=opts, typ=GetServiceCatalogServiceCatalogAssociationsResult).value

    return AwaitableGetServiceCatalogServiceCatalogAssociationsResult(
