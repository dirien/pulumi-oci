...
__all__ = [
    'GetDatabaseExternalNonContainerDatabaseResult',
    'AwaitableGetDatabaseExternalNonContainerDatabaseResult',
    'get_database_external_non_container_database',
]

@pulumi.output_type
class GetDatabaseExternalNonContainerDatabaseResult:
    """
    ...
    def database_management_config(self) -> 'outputs.GetDatabaseExternalNonContainerDatabaseDatabaseManagementConfigResult':
        """
    ...
    def operations_insights_config(self) -> 'outputs.GetDatabaseExternalNonContainerDatabaseOperationsInsightsConfigResult':
        """
...
class AwaitableGetDatabaseExternalNonContainerDatabaseResult(GetDatabaseExternalNonContainerDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExternalNonContainerDatabaseResult(
...
def get_database_external_non_container_database(external_non_container_database_id: Optional[str] = None,
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExternalNonContainerDatabaseResult:
    """
    ...
    test_external_non_container_database = oci.get_database_external_non_container_database(external_non_container_database_id=oci_database_external_non_container_database["test_external_non_container_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExternalNonContainerDatabase:GetDatabaseExternalNonContainerDatabase', __args__, opts=opts, typ=GetDatabaseExternalNonContainerDatabaseResult).value

    return AwaitableGetDatabaseExternalNonContainerDatabaseResult(
