...
__all__ = [
    'GetNetworkLoadBalancerNetworkLoadBalancersResult',
    'AwaitableGetNetworkLoadBalancerNetworkLoadBalancersResult',
    'get_network_load_balancer_network_load_balancers',
]

@pulumi.output_type
class GetNetworkLoadBalancerNetworkLoadBalancersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetNetworkLoadBalancerNetworkLoadBalancersFilterResult']]:
    ...
    def network_load_balancer_collections(self) -> Sequence['outputs.GetNetworkLoadBalancerNetworkLoadBalancersNetworkLoadBalancerCollectionResult']:
        """
...
class AwaitableGetNetworkLoadBalancerNetworkLoadBalancersResult(GetNetworkLoadBalancerNetworkLoadBalancersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkLoadBalancerNetworkLoadBalancersResult(
...
def get_network_load_balancer_network_load_balancers(compartment_id: Optional[str] = None,
                                                     display_name: Optional[str] = None,
                                                     filters: Optional[Sequence[pulumi.InputType['GetNetworkLoadBalancerNetworkLoadBalancersFilterArgs']]] = None,
                                                     state: Optional[str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkLoadBalancerNetworkLoadBalancersResult:
    """
    ...
    test_network_load_balancers = oci.get_network_load_balancer_network_load_balancers(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNetworkLoadBalancerNetworkLoadBalancers:GetNetworkLoadBalancerNetworkLoadBalancers', __args__, opts=opts, typ=GetNetworkLoadBalancerNetworkLoadBalancersResult).value

    return AwaitableGetNetworkLoadBalancerNetworkLoadBalancersResult(
