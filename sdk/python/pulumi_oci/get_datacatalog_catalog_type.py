...
__all__ = [
    'GetDatacatalogCatalogTypeResult',
    'AwaitableGetDatacatalogCatalogTypeResult',
    'get_datacatalog_catalog_type',
]

@pulumi.output_type
class GetDatacatalogCatalogTypeResult:
    """
...
class AwaitableGetDatacatalogCatalogTypeResult(GetDatacatalogCatalogTypeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogCatalogTypeResult(
...
def get_datacatalog_catalog_type(catalog_id: Optional[str] = None,
                                 fields: Optional[Sequence[str]] = None,
                                 type_key: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogCatalogTypeResult:
    """
    ...
    test_catalog_type = oci.get_datacatalog_catalog_type(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogCatalogType:GetDatacatalogCatalogType', __args__, opts=opts, typ=GetDatacatalogCatalogTypeResult).value

    return AwaitableGetDatacatalogCatalogTypeResult(
