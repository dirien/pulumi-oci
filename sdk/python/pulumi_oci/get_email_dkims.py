...
__all__ = [
    'GetEmailDkimsResult',
    'AwaitableGetEmailDkimsResult',
    'get_email_dkims',
]

@pulumi.output_type
class GetEmailDkimsResult:
    """
    ...
    def dkim_collections(self) -> Sequence['outputs.GetEmailDkimsDkimCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetEmailDkimsFilterResult']]:
...
class AwaitableGetEmailDkimsResult(GetEmailDkimsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailDkimsResult(
...
def get_email_dkims(email_domain_id: Optional[str] = None,
                    filters: Optional[Sequence[pulumi.InputType['GetEmailDkimsFilterArgs']]] = None,
                    id: Optional[str] = None,
                    name: Optional[str] = None,
                    state: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailDkimsResult:
    """
    ...
    test_dkims = oci.get_email_dkims(email_domain_id=oci_email_email_domain["test_email_domain"]["id"],
        id=var["dkim_id"],
        name=var["dkim_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailDkims:GetEmailDkims', __args__, opts=opts, typ=GetEmailDkimsResult).value

    return AwaitableGetEmailDkimsResult(
