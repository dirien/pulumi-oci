...
__all__ = [
    'GetDatacatalogCatalogResult',
    'AwaitableGetDatacatalogCatalogResult',
    'get_datacatalog_catalog',
]

@pulumi.output_type
class GetDatacatalogCatalogResult:
    """
...
class AwaitableGetDatacatalogCatalogResult(GetDatacatalogCatalogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogCatalogResult(
...
def get_datacatalog_catalog(catalog_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogCatalogResult:
    """
    ...
    test_catalog = oci.get_datacatalog_catalog(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogCatalog:GetDatacatalogCatalog', __args__, opts=opts, typ=GetDatacatalogCatalogResult).value

    return AwaitableGetDatacatalogCatalogResult(
