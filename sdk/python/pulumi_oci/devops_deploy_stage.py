...
__all__ = ['DevopsDeployStageArgs', 'DevopsDeployStage']

@pulumi.input_type
class DevopsDeployStageArgs:
    def __init__(__self__, *,
                 deploy_pipeline_id: pulumi.Input[str],
                 deploy_stage_predecessor_collection: pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs'],
                 deploy_stage_type: pulumi.Input[str],
                 approval_policy: Optional[pulumi.Input['DevopsDeployStageApprovalPolicyArgs']] = None,
                 blue_backend_ips: Optional[pulumi.Input['DevopsDeployStageBlueBackendIpsArgs']] = None,
                 ...
                 failure_policy: Optional[pulumi.Input['DevopsDeployStageFailurePolicyArgs']] = None,
                 ...
                 green_backend_ips: Optional[pulumi.Input['DevopsDeployStageGreenBackendIpsArgs']] = None,
                 ...
                 load_balancer_config: Optional[pulumi.Input['DevopsDeployStageLoadBalancerConfigArgs']] = None,
                 max_memory_in_mbs: Optional[pulumi.Input[str]] = None,
                 namespace: Optional[pulumi.Input[str]] = None,
                 oke_cluster_deploy_environment_id: Optional[pulumi.Input[str]] = None,
                 rollback_policy: Optional[pulumi.Input['DevopsDeployStageRollbackPolicyArgs']] = None,
                 rollout_policy: Optional[pulumi.Input['DevopsDeployStageRolloutPolicyArgs']] = None,
                 traffic_shift_target: Optional[pulumi.Input[str]] = None,
                 wait_criteria: Optional[pulumi.Input['DevopsDeployStageWaitCriteriaArgs']] = None):
        """
        ...
        :param pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs'] deploy_stage_predecessor_collection: (Updatable) Collection containing the predecessors of a stage.
        :param pulumi.Input[str] deploy_stage_type: (Updatable) Deployment stage type.
        :param pulumi.Input['DevopsDeployStageApprovalPolicyArgs'] approval_policy: (Updatable) Specifies the approval policy.
        :param pulumi.Input['DevopsDeployStageBlueBackendIpsArgs'] blue_backend_ips: (Updatable) Collection of backend environment IP addresses.
        ...
        :param pulumi.Input['DevopsDeployStageFailurePolicyArgs'] failure_policy: (Updatable) Specifies a failure policy for a compute instance group rolling deployment stage.
        ...
        :param pulumi.Input['DevopsDeployStageGreenBackendIpsArgs'] green_backend_ips: (Updatable) Collection of backend environment IP addresses.
        ...
        :param pulumi.Input['DevopsDeployStageLoadBalancerConfigArgs'] load_balancer_config: (Updatable) Specifies config for load balancer traffic shift stages.
        ...
        :param pulumi.Input['DevopsDeployStageRollbackPolicyArgs'] rollback_policy: (Updatable) Specifies the rollback policy. This is initiated on the failure of certain stage types.
        :param pulumi.Input['DevopsDeployStageRolloutPolicyArgs'] rollout_policy: (Updatable) Description of rollout policy for load balancer traffic shift stage.
        :param pulumi.Input[str] traffic_shift_target: (Updatable) Specifies the target or destination backend set.
        :param pulumi.Input['DevopsDeployStageWaitCriteriaArgs'] wait_criteria: (Updatable) Specifies wait criteria for the Wait stage.
        """
    ...
    def deploy_stage_predecessor_collection(self) -> pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs']:
        """
    ...
    def deploy_stage_predecessor_collection(self, value: pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs']):
    ...
    def approval_policy(self) -> Optional[pulumi.Input['DevopsDeployStageApprovalPolicyArgs']]:
        """
    ...
    def approval_policy(self, value: Optional[pulumi.Input['DevopsDeployStageApprovalPolicyArgs']]):
        pulumi.set(self, "approval_policy", value)

    @property
    @pulumi.getter(name="blueBackendIps")
    def blue_backend_ips(self) -> Optional[pulumi.Input['DevopsDeployStageBlueBackendIpsArgs']]:
        """
    ...
    def blue_backend_ips(self, value: Optional[pulumi.Input['DevopsDeployStageBlueBackendIpsArgs']]):
    ...
    def failure_policy(self) -> Optional[pulumi.Input['DevopsDeployStageFailurePolicyArgs']]:
        """
    ...
    def failure_policy(self, value: Optional[pulumi.Input['DevopsDeployStageFailurePolicyArgs']]):
    ...
    def green_backend_ips(self) -> Optional[pulumi.Input['DevopsDeployStageGreenBackendIpsArgs']]:
        """
        (Updatable) Collection of backend environment IP addresses.
        """
    ...
    def green_backend_ips(self, value: Optional[pulumi.Input['DevopsDeployStageGreenBackendIpsArgs']]):
    ...
    def load_balancer_config(self) -> Optional[pulumi.Input['DevopsDeployStageLoadBalancerConfigArgs']]:
        """
    ...
    def load_balancer_config(self, value: Optional[pulumi.Input['DevopsDeployStageLoadBalancerConfigArgs']]):
    ...
    def rollback_policy(self) -> Optional[pulumi.Input['DevopsDeployStageRollbackPolicyArgs']]:
        """
    ...
    def rollback_policy(self, value: Optional[pulumi.Input['DevopsDeployStageRollbackPolicyArgs']]):
        pulumi.set(self, "rollback_policy", value)

    @property
    @pulumi.getter(name="rolloutPolicy")
    def rollout_policy(self) -> Optional[pulumi.Input['DevopsDeployStageRolloutPolicyArgs']]:
        """
    ...
    def rollout_policy(self, value: Optional[pulumi.Input['DevopsDeployStageRolloutPolicyArgs']]):
    ...
    def wait_criteria(self) -> Optional[pulumi.Input['DevopsDeployStageWaitCriteriaArgs']]:
        """
    ...
    def wait_criteria(self, value: Optional[pulumi.Input['DevopsDeployStageWaitCriteriaArgs']]):
        pulumi.set(self, "wait_criteria", value)


@pulumi.input_type
class _DevopsDeployStageState:
    def __init__(__self__, *,
                 approval_policy: Optional[pulumi.Input['DevopsDeployStageApprovalPolicyArgs']] = None,
                 blue_backend_ips: Optional[pulumi.Input['DevopsDeployStageBlueBackendIpsArgs']] = None,
                 ...
                 deploy_stage_predecessor_collection: Optional[pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs']] = None,
    ...
    @property
    @pulumi.getter(name="deployStagePredecessorCollection")
    def deploy_stage_predecessor_collection(self) -> Optional[pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs']]:
        """
        (Updatable) Collection containing the predecessors of a stage.
        """
        return pulumi.get(self, "deploy_stage_predecessor_collection")
    ...
    @deploy_stage_predecessor_collection.setter
    def deploy_stage_predecessor_collection(self, value: Optional[pulumi.Input['DevopsDeployStageDeployStagePredecessorCollectionArgs']]):
        pulumi.set(self, "deploy_stage_predecessor_collection", value)
...
class DevopsDeployStage(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 approval_policy: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageApprovalPolicyArgs']]] = None,
                 blue_backend_ips: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageBlueBackendIpsArgs']]] = None,
                 compute_instance_group_deploy_environment_id: Optional[pulumi.Input[str]] = None,
                 config: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_artifact_id: Optional[pulumi.Input[str]] = None,
                 deploy_artifact_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 deploy_pipeline_id: Optional[pulumi.Input[str]] = None,
                 deploy_stage_predecessor_collection: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageDeployStagePredecessorCollectionArgs']]] = None,
                 deploy_stage_type: Optional[pulumi.Input[str]] = None,
                 deployment_spec_deploy_artifact_id: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 docker_image_deploy_artifact_id: Optional[pulumi.Input[str]] = None,
                 failure_policy: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageFailurePolicyArgs']]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 function_deploy_environment_id: Optional[pulumi.Input[str]] = None,
                 function_timeout_in_seconds: Optional[pulumi.Input[int]] = None,
                 green_backend_ips: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageGreenBackendIpsArgs']]] = None,
                 is_async: Optional[pulumi.Input[bool]] = None,
                 is_validation_enabled: Optional[pulumi.Input[bool]] = None,
                 kubernetes_manifest_deploy_artifact_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 load_balancer_config: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageLoadBalancerConfigArgs']]] = None,
                 max_memory_in_mbs: Optional[pulumi.Input[str]] = None,
                 namespace: Optional[pulumi.Input[str]] = None,
                 oke_cluster_deploy_environment_id: Optional[pulumi.Input[str]] = None,
                 rollback_policy: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageRollbackPolicyArgs']]] = None,
                 rollout_policy: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageRolloutPolicyArgs']]] = None,
                 traffic_shift_target: Optional[pulumi.Input[str]] = None,
                 wait_criteria: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageWaitCriteriaArgs']]] = None,
                 __props__=None):
        """
        ...
        test_deploy_stage = oci.DevopsDeployStage("testDeployStage",
            deploy_pipeline_id=oci_devops_deploy_pipeline["test_deploy_pipeline"]["id"],
            deploy_stage_predecessor_collection=oci.DevopsDeployStageDeployStagePredecessorCollectionArgs(
                items=[oci.DevopsDeployStageDeployStagePredecessorCollectionItemArgs(
                    id=var["deploy_stage_deploy_stage_predecessor_collection_items_id"],
                )],
            ),
            deploy_stage_type=var["deploy_stage_deploy_stage_type"],
            approval_policy=oci.DevopsDeployStageApprovalPolicyArgs(
            ...
            blue_backend_ips=oci.DevopsDeployStageBlueBackendIpsArgs(
            ...
            failure_policy=oci.DevopsDeployStageFailurePolicyArgs(
            ...
            green_backend_ips=oci.DevopsDeployStageGreenBackendIpsArgs(
            ...
            load_balancer_config=oci.DevopsDeployStageLoadBalancerConfigArgs(
            ...
            rollback_policy=oci.DevopsDeployStageRollbackPolicyArgs(
                policy_type=var["deploy_stage_rollback_policy_policy_type"],
            ),
            rollout_policy=oci.DevopsDeployStageRolloutPolicyArgs(
            ...
            wait_criteria=oci.DevopsDeployStageWaitCriteriaArgs(
        ...
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageApprovalPolicyArgs']] approval_policy: (Updatable) Specifies the approval policy.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageBlueBackendIpsArgs']] blue_backend_ips: (Updatable) Collection of backend environment IP addresses.
        :param pulumi.Input[str] compute_instance_group_deploy_environment_id: (Updatable) A compute instance group environment OCID for rolling deployment.
        :param pulumi.Input[Mapping[str, Any]] config: (Updatable) User provided key and value pair configuration, which is assigned through constants or parameter.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] deploy_artifact_id: (Updatable) Optional binary artifact OCID user may provide to this stage.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] deploy_artifact_ids: (Updatable) Additional file artifact OCIDs.
        :param pulumi.Input[str] deploy_pipeline_id: The OCID of a pipeline.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageDeployStagePredecessorCollectionArgs']] deploy_stage_predecessor_collection: (Updatable) Collection containing the predecessors of a stage.
        :param pulumi.Input[str] deploy_stage_type: (Updatable) Deployment stage type.
        :param pulumi.Input[str] deployment_spec_deploy_artifact_id: (Updatable) The OCID of the artifact that contains the deployment specification.
        :param pulumi.Input[str] description: (Updatable) Optional description about the deployment stage.
        :param pulumi.Input[str] display_name: (Updatable) Deployment stage display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        :param pulumi.Input[str] docker_image_deploy_artifact_id: (Updatable) A Docker image artifact OCID.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageFailurePolicyArgs']] failure_policy: (Updatable) Specifies a failure policy for a compute instance group rolling deployment stage.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[str] function_deploy_environment_id: (Updatable) Function environment OCID.
        :param pulumi.Input[int] function_timeout_in_seconds: (Updatable) Timeout for execution of the Function. Value in seconds.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageGreenBackendIpsArgs']] green_backend_ips: (Updatable) Collection of backend environment IP addresses.
        :param pulumi.Input[bool] is_async: (Updatable) A boolean flag specifies whether this stage executes asynchronously.
        :param pulumi.Input[bool] is_validation_enabled: (Updatable) A boolean flag specifies whether the invoked function should be validated.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] kubernetes_manifest_deploy_artifact_ids: (Updatable) List of Kubernetes manifest artifact OCIDs, the manifests should not include any job resource.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageLoadBalancerConfigArgs']] load_balancer_config: (Updatable) Specifies config for load balancer traffic shift stages.
        :param pulumi.Input[str] max_memory_in_mbs: (Updatable) Maximum usable memory for the Function (in MB).
        :param pulumi.Input[str] namespace: (Updatable) Default namespace to be used for Kubernetes deployment when not specified in the manifest.
        :param pulumi.Input[str] oke_cluster_deploy_environment_id: (Updatable) Kubernetes cluster environment OCID for deployment.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageRollbackPolicyArgs']] rollback_policy: (Updatable) Specifies the rollback policy. This is initiated on the failure of certain stage types.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageRolloutPolicyArgs']] rollout_policy: (Updatable) Description of rollout policy for load balancer traffic shift stage.
        :param pulumi.Input[str] traffic_shift_target: (Updatable) Specifies the target or destination backend set.
        :param pulumi.Input[pulumi.InputType['DevopsDeployStageWaitCriteriaArgs']] wait_criteria: (Updatable) Specifies wait criteria for the Wait stage.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: DevopsDeployStageArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Deploy Stage resource in Oracle Cloud Infrastructure Devops service.
        ...
        :param str resource_name: The name of the resource.
        :param DevopsDeployStageArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DevopsDeployStageArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DevopsDeployStageArgs.__new__(DevopsDeployStageArgs)
        ...
        super(DevopsDeployStage, __self__).__init__(
            'oci:index/devopsDeployStage:DevopsDeployStage',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[str]] = None,
            traffic_shift_target: Optional[pulumi.Input[str]] = None,
            wait_criteria: Optional[pulumi.Input[pulumi.InputType['DevopsDeployStageWaitCriteriaArgs']]] = None) -> 'DevopsDeployStage':
        """
        ...
        __props__ = _DevopsDeployStageState.__new__(_DevopsDeployStageState)
        ...
        __props__.__dict__["traffic_shift_target"] = traffic_shift_target
        __props__.__dict__["wait_criteria"] = wait_criteria
        return DevopsDeployStage(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="approvalPolicy")
    def approval_policy(self) -> pulumi.Output['outputs.DevopsDeployStageApprovalPolicy']:
        """
        (Updatable) Specifies the approval policy.
        """
        return pulumi.get(self, "approval_policy")
    ...
    @property
    @pulumi.getter(name="blueBackendIps")
    def blue_backend_ips(self) -> pulumi.Output['outputs.DevopsDeployStageBlueBackendIps']:
        """
        (Updatable) Collection of backend environment IP addresses.
        """
        return pulumi.get(self, "blue_backend_ips")
    ...
    @property
    @pulumi.getter(name="deployStagePredecessorCollection")
    def deploy_stage_predecessor_collection(self) -> pulumi.Output['outputs.DevopsDeployStageDeployStagePredecessorCollection']:
        """
        (Updatable) Collection containing the predecessors of a stage.
        """
        return pulumi.get(self, "deploy_stage_predecessor_collection")
    ...
    @property
    @pulumi.getter(name="failurePolicy")
    def failure_policy(self) -> pulumi.Output['outputs.DevopsDeployStageFailurePolicy']:
        """
        (Updatable) Specifies a failure policy for a compute instance group rolling deployment stage.
        """
        return pulumi.get(self, "failure_policy")
    ...
    @property
    @pulumi.getter(name="greenBackendIps")
    def green_backend_ips(self) -> pulumi.Output['outputs.DevopsDeployStageGreenBackendIps']:
        """
        (Updatable) Collection of backend environment IP addresses.
        """
        return pulumi.get(self, "green_backend_ips")
    ...
    @property
    @pulumi.getter(name="loadBalancerConfig")
    def load_balancer_config(self) -> pulumi.Output['outputs.DevopsDeployStageLoadBalancerConfig']:
        """
        (Updatable) Specifies config for load balancer traffic shift stages.
        """
        return pulumi.get(self, "load_balancer_config")
    ...
    @property
    @pulumi.getter(name="rollbackPolicy")
    def rollback_policy(self) -> pulumi.Output['outputs.DevopsDeployStageRollbackPolicy']:
        """
        (Updatable) Specifies the rollback policy. This is initiated on the failure of certain stage types.
        """
        return pulumi.get(self, "rollback_policy")
    ...
    @property
    @pulumi.getter(name="rolloutPolicy")
    def rollout_policy(self) -> pulumi.Output['outputs.DevopsDeployStageRolloutPolicy']:
        """
        (Updatable) Description of rollout policy for load balancer traffic shift stage.
        """
        return pulumi.get(self, "rollout_policy")
    ...
    @property
    @pulumi.getter(name="waitCriteria")
    def wait_criteria(self) -> pulumi.Output['outputs.DevopsDeployStageWaitCriteria']:
        """
        (Updatable) Specifies wait criteria for the Wait stage.
        """
        return pulumi.get(self, "wait_criteria")
