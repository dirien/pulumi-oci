...
class AwaitableGetOpsiHostInsightResult(GetOpsiHostInsightResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOpsiHostInsightResult(
...
def get_opsi_host_insight(host_insight_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOpsiHostInsightResult:
    """
    ...
    test_host_insight = oci.get_opsi_host_insight(host_insight_id=oci_opsi_host_insight["test_host_insight"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOpsiHostInsight:GetOpsiHostInsight', __args__, opts=opts, typ=GetOpsiHostInsightResult).value

    return AwaitableGetOpsiHostInsightResult(
