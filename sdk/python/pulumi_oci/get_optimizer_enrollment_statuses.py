...
__all__ = [
    'GetOptimizerEnrollmentStatusesResult',
    'AwaitableGetOptimizerEnrollmentStatusesResult',
    'get_optimizer_enrollment_statuses',
]

@pulumi.output_type
class GetOptimizerEnrollmentStatusesResult:
    """
    ...
    def enrollment_status_collections(self) -> Sequence['outputs.GetOptimizerEnrollmentStatusesEnrollmentStatusCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOptimizerEnrollmentStatusesFilterResult']]:
...
class AwaitableGetOptimizerEnrollmentStatusesResult(GetOptimizerEnrollmentStatusesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerEnrollmentStatusesResult(
...
def get_optimizer_enrollment_statuses(compartment_id: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetOptimizerEnrollmentStatusesFilterArgs']]] = None,
                                      state: Optional[str] = None,
                                      status: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerEnrollmentStatusesResult:
    """
    ...
    test_enrollment_statuses = oci.get_optimizer_enrollment_statuses(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerEnrollmentStatuses:GetOptimizerEnrollmentStatuses', __args__, opts=opts, typ=GetOptimizerEnrollmentStatusesResult).value

    return AwaitableGetOptimizerEnrollmentStatusesResult(
