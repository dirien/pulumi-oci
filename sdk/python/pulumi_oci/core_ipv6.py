...
class CoreIpv6(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_ipv6 = oci.CoreIpv6("testIpv6",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreIpv6Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreIpv6Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreIpv6Args.__new__(CoreIpv6Args)
        ...
        super(CoreIpv6, __self__).__init__(
            'oci:index/coreIpv6:CoreIpv6',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vnic_id: Optional[pulumi.Input[str]] = None) -> 'CoreIpv6':
        """
        ...
        __props__ = _CoreIpv6State.__new__(_CoreIpv6State)
        ...
        __props__.__dict__["vnic_id"] = vnic_id
        return CoreIpv6(resource_name, opts=opts, __props__=__props__)
