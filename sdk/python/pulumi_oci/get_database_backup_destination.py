...
__all__ = [
    'GetDatabaseBackupDestinationResult',
    'AwaitableGetDatabaseBackupDestinationResult',
    'get_database_backup_destination',
]

@pulumi.output_type
class GetDatabaseBackupDestinationResult:
    """
    ...
    def __init__(__self__, associated_databases=None, backup_destination_id=None, compartment_id=None, connection_string=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, local_mount_point_path=None, mount_type_details=None, nfs_mount_type=None, nfs_server_export=None, nfs_servers=None, state=None, time_created=None, type=None, vpc_users=None):
        ...
        if mount_type_details and not isinstance(mount_type_details, dict):
            raise TypeError("Expected argument 'mount_type_details' to be a dict")
    ...
    def associated_databases(self) -> Sequence['outputs.GetDatabaseBackupDestinationAssociatedDatabaseResult']:
        """
    ...
    def mount_type_details(self) -> 'outputs.GetDatabaseBackupDestinationMountTypeDetailsResult':
...
class AwaitableGetDatabaseBackupDestinationResult(GetDatabaseBackupDestinationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseBackupDestinationResult(
...
def get_database_backup_destination(backup_destination_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseBackupDestinationResult:
    """
    ...
    test_backup_destination = oci.get_database_backup_destination(backup_destination_id=oci_database_backup_destination["test_backup_destination"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseBackupDestination:GetDatabaseBackupDestination', __args__, opts=opts, typ=GetDatabaseBackupDestinationResult).value

    return AwaitableGetDatabaseBackupDestinationResult(
