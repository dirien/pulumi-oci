...
__all__ = [
    'GetEmailSenderResult',
    'AwaitableGetEmailSenderResult',
    'get_email_sender',
]

@pulumi.output_type
class GetEmailSenderResult:
    """
...
class AwaitableGetEmailSenderResult(GetEmailSenderResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailSenderResult(
...
def get_email_sender(sender_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailSenderResult:
    """
    ...
    test_sender = oci.get_email_sender(sender_id=oci_email_sender["test_sender"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailSender:GetEmailSender', __args__, opts=opts, typ=GetEmailSenderResult).value

    return AwaitableGetEmailSenderResult(
