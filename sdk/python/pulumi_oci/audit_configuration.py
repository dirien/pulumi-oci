...
__all__ = ['AuditConfigurationArgs', 'AuditConfiguration']

@pulumi.input_type
class AuditConfigurationArgs:
...
@pulumi.input_type
class _AuditConfigurationState:
    def __init__(__self__, *,
...
class AuditConfiguration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_configuration = oci.AuditConfiguration("testConfiguration",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param AuditConfigurationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AuditConfigurationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AuditConfigurationArgs.__new__(AuditConfigurationArgs)
        ...
        super(AuditConfiguration, __self__).__init__(
            'oci:index/auditConfiguration:AuditConfiguration',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            retention_period_days: Optional[pulumi.Input[int]] = None) -> 'AuditConfiguration':
        """
        ...
        __props__ = _AuditConfigurationState.__new__(_AuditConfigurationState)

        __props__.__dict__["compartment_id"] = compartment_id
        __props__.__dict__["retention_period_days"] = retention_period_days
        return AuditConfiguration(resource_name, opts=opts, __props__=__props__)
