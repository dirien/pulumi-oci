...
__all__ = [
    'GetOsmanagementManagedInstanceGroupResult',
    'AwaitableGetOsmanagementManagedInstanceGroupResult',
    'get_osmanagement_managed_instance_group',
]

@pulumi.output_type
class GetOsmanagementManagedInstanceGroupResult:
    """
    ...
    def managed_instances(self) -> Sequence['outputs.GetOsmanagementManagedInstanceGroupManagedInstanceResult']:
        """
...
class AwaitableGetOsmanagementManagedInstanceGroupResult(GetOsmanagementManagedInstanceGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOsmanagementManagedInstanceGroupResult(
...
def get_osmanagement_managed_instance_group(managed_instance_group_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOsmanagementManagedInstanceGroupResult:
    """
    ...
    test_managed_instance_group = oci.get_osmanagement_managed_instance_group(managed_instance_group_id=oci_osmanagement_managed_instance_group["test_managed_instance_group"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOsmanagementManagedInstanceGroup:GetOsmanagementManagedInstanceGroup', __args__, opts=opts, typ=GetOsmanagementManagedInstanceGroupResult).value

    return AwaitableGetOsmanagementManagedInstanceGroupResult(
