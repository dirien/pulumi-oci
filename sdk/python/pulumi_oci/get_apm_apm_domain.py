...
__all__ = [
    'GetApmApmDomainResult',
    'AwaitableGetApmApmDomainResult',
    'get_apm_apm_domain',
]

@pulumi.output_type
class GetApmApmDomainResult:
    """
...
class AwaitableGetApmApmDomainResult(GetApmApmDomainResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApmApmDomainResult(
...
def get_apm_apm_domain(apm_domain_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApmApmDomainResult:
    """
    ...
    test_apm_domain = oci.get_apm_apm_domain(apm_domain_id=oci_apm_apm_domain["test_apm_domain"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApmApmDomain:GetApmApmDomain', __args__, opts=opts, typ=GetApmApmDomainResult).value

    return AwaitableGetApmApmDomainResult(
