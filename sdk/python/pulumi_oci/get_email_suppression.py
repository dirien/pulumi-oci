...
__all__ = [
    'GetEmailSuppressionResult',
    'AwaitableGetEmailSuppressionResult',
    'get_email_suppression',
]

@pulumi.output_type
class GetEmailSuppressionResult:
    """
...
class AwaitableGetEmailSuppressionResult(GetEmailSuppressionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailSuppressionResult(
...
def get_email_suppression(suppression_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailSuppressionResult:
    """
    ...
    test_suppression = oci.get_email_suppression(suppression_id=oci_email_suppression["test_suppression"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailSuppression:GetEmailSuppression', __args__, opts=opts, typ=GetEmailSuppressionResult).value

    return AwaitableGetEmailSuppressionResult(
