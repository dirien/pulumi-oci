...
class GetDnsResolverResult:
    ...
    def attached_views(self) -> Sequence['outputs.GetDnsResolverAttachedViewResult']:
        """
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Sequence['outputs.GetDnsResolverEndpointResult']:
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetDnsResolverRuleResult']:
        """
...
def get_dns_resolver(resolver_id: Optional[str] = None,
    ...
    test_resolver = oci.get_dns_resolver(resolver_id=oci_dns_resolver["test_resolver"]["id"],
        scope="PRIVATE")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsResolver:GetDnsResolver', __args__, opts=opts, typ=GetDnsResolverResult).value
