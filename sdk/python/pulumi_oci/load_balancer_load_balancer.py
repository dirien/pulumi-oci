...
__all__ = ['LoadBalancerLoadBalancerArgs', 'LoadBalancerLoadBalancer']

@pulumi.input_type
class LoadBalancerLoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 reserved_ips: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerReservedIpArgs']]]] = None,
                 shape_details: Optional[pulumi.Input['LoadBalancerLoadBalancerShapeDetailsArgs']] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerReservedIpArgs']]] reserved_ips: An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        :param pulumi.Input['LoadBalancerLoadBalancerShapeDetailsArgs'] shape_details: (Updatable) The configuration details to create load balancer using Flexible shape. This is required only if shapeName is `Flexible`.
        """
    ...
    def reserved_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerReservedIpArgs']]]]:
        """
    ...
    @reserved_ips.setter
    def reserved_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerReservedIpArgs']]]]):
        pulumi.set(self, "reserved_ips", value)

    @property
    @pulumi.getter(name="shapeDetails")
    def shape_details(self) -> Optional[pulumi.Input['LoadBalancerLoadBalancerShapeDetailsArgs']]:
        """
    ...
    def shape_details(self, value: Optional[pulumi.Input['LoadBalancerLoadBalancerShapeDetailsArgs']]):
        pulumi.set(self, "shape_details", value)


@pulumi.input_type
class _LoadBalancerLoadBalancerState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ip_address_details: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerIpAddressDetailArgs']]]] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `example_load_balancer`
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerIpAddressDetailArgs']]] ip_address_details: An array of IP addresses.
    ...
    def ip_address_details(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerIpAddressDetailArgs']]]]:
        """
    ...
    def ip_address_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerIpAddressDetailArgs']]]]):
...
class LoadBalancerLoadBalancer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 is_private: Optional[pulumi.Input[bool]] = None,
                 network_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 reserved_ips: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerReservedIpArgs']]]]] = None,
                 shape: Optional[pulumi.Input[str]] = None,
                 shape_details: Optional[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerShapeDetailsArgs']]] = None,
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        * `LoadBalancer`
        ...
        test_load_balancer = oci.LoadBalancerLoadBalancer("testLoadBalancer",
            ...
            reserved_ips=[oci.LoadBalancerLoadBalancerReservedIpArgs(
                id=var["load_balancer_reserved_ips_id"],
            )],
            shape_details=oci.LoadBalancerLoadBalancerShapeDetailsArgs(
        ...
        :param pulumi.Input[bool] is_private: Whether the load balancer has a VCN-local (private) IP address.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] network_security_group_ids: (Updatable) An array of NSG [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with this load balancer.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerReservedIpArgs']]]] reserved_ips: An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        :param pulumi.Input[str] shape: (Updatable) A template that determines the total pre-provisioned bandwidth (ingress plus egress). To get a list of available shapes, use the [ListShapes](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/LoadBalancerShape/ListShapes) operation.  Example: `100Mbps` *Note: When updating shape for a load balancer, all existing connections to the load balancer will be reset during the update process. Also `10Mbps-Micro` shape cannot be updated to any other shape nor can any other shape be updated to `10Mbps-Micro`.
        :param pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerShapeDetailsArgs']] shape_details: (Updatable) The configuration details to create load balancer using Flexible shape. This is required only if shapeName is `Flexible`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] subnet_ids: An array of subnet [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: LoadBalancerLoadBalancerArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Load Balancer resource in Oracle Cloud Infrastructure Load Balancer service.
        ...
        * `LoadBalancer`
        ...
        :param str resource_name: The name of the resource.
        :param LoadBalancerLoadBalancerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoadBalancerLoadBalancerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LoadBalancerLoadBalancerArgs.__new__(LoadBalancerLoadBalancerArgs)
        ...
        super(LoadBalancerLoadBalancer, __self__).__init__(
            'oci:index/loadBalancerLoadBalancer:LoadBalancerLoadBalancer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            ip_address_details: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerIpAddressDetailArgs']]]]] = None,
            ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ip_mode: Optional[pulumi.Input[str]] = None,
            is_private: Optional[pulumi.Input[bool]] = None,
            network_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ...
            subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'LoadBalancerLoadBalancer':
        """
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `example_load_balancer`
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerIpAddressDetailArgs']]]] ip_address_details: An array of IP addresses.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ip_addresses: An array of IP addresses. Deprecated: use ip_address_details instead
        :param pulumi.Input[str] ip_mode: IPv6 is currently supported only in the Government Cloud. Whether the load balancer has an IPv4 or IPv6 IP address.
        :param pulumi.Input[bool] is_private: Whether the load balancer has a VCN-local (private) IP address.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] network_security_group_ids: (Updatable) An array of NSG [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with this load balancer.
        ...
        __props__ = _LoadBalancerLoadBalancerState.__new__(_LoadBalancerLoadBalancerState)
        ...
        return LoadBalancerLoadBalancer(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="ipAddressDetails")
    def ip_address_details(self) -> pulumi.Output[Sequence['outputs.LoadBalancerLoadBalancerIpAddressDetail']]:
        """
        An array of IP addresses.
        """
        return pulumi.get(self, "ip_address_details")
    ...
    @property
    @pulumi.getter(name="reservedIps")
    def reserved_ips(self) -> pulumi.Output[Optional[Sequence['outputs.LoadBalancerLoadBalancerReservedIp']]]:
        """
        An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        """
        return pulumi.get(self, "reserved_ips")
    ...
    @property
    @pulumi.getter(name="shapeDetails")
    def shape_details(self) -> pulumi.Output['outputs.LoadBalancerLoadBalancerShapeDetails']:
        """
        (Updatable) The configuration details to create load balancer using Flexible shape. This is required only if shapeName is `Flexible`.
        """
        return pulumi.get(self, "shape_details")
