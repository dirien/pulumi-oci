...
__all__ = ['CoreInstancePoolArgs', 'CoreInstancePool']

@pulumi.input_type
class CoreInstancePoolArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 instance_configuration_id: pulumi.Input[str],
                 placement_configurations: pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]],
                 size: pulumi.Input[int],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 load_balancers: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolLoadBalancerArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]] placement_configurations: (Updatable) The placement configurations for the instance pool. Provide one placement configuration for each availability domain.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolLoadBalancerArgs']]] load_balancers: The load balancers to attach to the instance pool.
    ...
    def placement_configurations(self) -> pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]]:
        """
    ...
    def placement_configurations(self, value: pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]]):
    ...
    def load_balancers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolLoadBalancerArgs']]]]:
        """
    ...
    def load_balancers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolLoadBalancerArgs']]]]):
...
class _CoreInstancePoolState:
    def __init__(__self__, *,
                 ...
                 load_balancers: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolLoadBalancerArgs']]]] = None,
                 placement_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]]] = None,
    ...
    @property
    @pulumi.getter(name="placementConfigurations")
    def placement_configurations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]]]:
        """
        (Updatable) The placement configurations for the instance pool. Provide one placement configuration for each availability domain.
        """
        return pulumi.get(self, "placement_configurations")
    ...
    @placement_configurations.setter
    def placement_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolPlacementConfigurationArgs']]]]):
        pulumi.set(self, "placement_configurations", value)
...
class CoreInstancePool(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 instance_configuration_id: Optional[pulumi.Input[str]] = None,
                 load_balancers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolLoadBalancerArgs']]]]] = None,
                 placement_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolPlacementConfigurationArgs']]]]] = None,
                 size: Optional[pulumi.Input[int]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_instance_pool = oci.CoreInstancePool("testInstancePool",
            compartment_id=var["compartment_id"],
            instance_configuration_id=oci_core_instance_configuration["test_instance_configuration"]["id"],
            placement_configurations=[oci.CoreInstancePoolPlacementConfigurationArgs(
                ...
                secondary_vnic_subnets=[oci.CoreInstancePoolPlacementConfigurationSecondaryVnicSubnetArgs(
            ...
            load_balancers=[oci.CoreInstancePoolLoadBalancerArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] instance_configuration_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance configuration associated with the instance pool.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolLoadBalancerArgs']]]] load_balancers: The load balancers to attach to the instance pool.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolPlacementConfigurationArgs']]]] placement_configurations: (Updatable) The placement configurations for the instance pool. Provide one placement configuration for each availability domain.
        :param pulumi.Input[int] size: (Updatable) The number of instances that should be in the instance pool. Modifying this value will override the size of the instance pool. If the instance pool is linked with autoscaling configuration, autoscaling configuration could resize the instance pool at a later point. The instance pool's actual size may differ from the configured size if it is associated with an autoscaling configuration. For the actual size of the instance pool, refer to the `actual_size` attribute.
        :param pulumi.Input[str] state: (Updatable) The target state for the instance pool update operation (ignored at create time and should not be set). Could be set to RUNNING or STOPPED.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreInstancePoolArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreInstancePoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreInstancePoolArgs.__new__(CoreInstancePoolArgs)
        ...
        super(CoreInstancePool, __self__).__init__(
            'oci:index/coreInstancePool:CoreInstancePool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[int]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreInstancePool':
        """
        ...
        __props__ = _CoreInstancePoolState.__new__(_CoreInstancePoolState)
        ...
        return CoreInstancePool(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="loadBalancers")
    def load_balancers(self) -> pulumi.Output[Sequence['outputs.CoreInstancePoolLoadBalancer']]:
        """
        The load balancers to attach to the instance pool.
        """
        return pulumi.get(self, "load_balancers")
    ...
    @property
    @pulumi.getter(name="placementConfigurations")
    def placement_configurations(self) -> pulumi.Output[Sequence['outputs.CoreInstancePoolPlacementConfiguration']]:
        """
        (Updatable) The placement configurations for the instance pool. Provide one placement configuration for each availability domain.
        """
        return pulumi.get(self, "placement_configurations")
