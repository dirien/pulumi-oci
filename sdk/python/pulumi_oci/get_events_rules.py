...
__all__ = [
    'GetEventsRulesResult',
    'AwaitableGetEventsRulesResult',
    'get_events_rules',
]

@pulumi.output_type
class GetEventsRulesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetEventsRulesFilterResult']]:
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetEventsRulesRuleResult']:
        """
        The list of rules.
        """
...
class AwaitableGetEventsRulesResult(GetEventsRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEventsRulesResult(
...
def get_events_rules(compartment_id: Optional[str] = None,
                     display_name: Optional[str] = None,
                     filters: Optional[Sequence[pulumi.InputType['GetEventsRulesFilterArgs']]] = None,
                     state: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEventsRulesResult:
    """
    ...
    test_rules = oci.get_events_rules(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEventsRules:GetEventsRules', __args__, opts=opts, typ=GetEventsRulesResult).value

    return AwaitableGetEventsRulesResult(
