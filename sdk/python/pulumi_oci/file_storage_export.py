...
__all__ = ['FileStorageExportArgs', 'FileStorageExport']

@pulumi.input_type
class FileStorageExportArgs:
    def __init__(__self__, *,
                 export_set_id: pulumi.Input[str],
                 file_system_id: pulumi.Input[str],
                 path: pulumi.Input[str],
                 export_options: Optional[pulumi.Input[Sequence[pulumi.Input['FileStorageExportExportOptionArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FileStorageExportExportOptionArgs']]] export_options: (Updatable) Export options for the new export. If left unspecified, defaults to:
        """
    ...
    def export_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FileStorageExportExportOptionArgs']]]]:
        """
    ...
    def export_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FileStorageExportExportOptionArgs']]]]):
        pulumi.set(self, "export_options", value)


@pulumi.input_type
class _FileStorageExportState:
    def __init__(__self__, *,
                 export_options: Optional[pulumi.Input[Sequence[pulumi.Input['FileStorageExportExportOptionArgs']]]] = None,
...
class FileStorageExport(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 export_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FileStorageExportExportOptionArgs']]]]] = None,
                 export_set_id: Optional[pulumi.Input[str]] = None,
                 file_system_id: Optional[pulumi.Input[str]] = None,
                 path: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        test_export = oci.FileStorageExport("testExport",
            export_set_id=oci_file_storage_export_set["test_export_set"]["id"],
            file_system_id=oci_file_storage_file_system["test_file_system"]["id"],
            path=var["export_path"],
            export_options=[oci.FileStorageExportExportOptionArgs(
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FileStorageExportExportOptionArgs']]]] export_options: (Updatable) Export options for the new export. If left unspecified, defaults to:
        :param pulumi.Input[str] export_set_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this export's export set.
        :param pulumi.Input[str] file_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this export's file system.
        :param pulumi.Input[str] path: Path used to access the associated file system.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param FileStorageExportArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FileStorageExportArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FileStorageExportArgs.__new__(FileStorageExportArgs)
        ...
        super(FileStorageExport, __self__).__init__(
            'oci:index/fileStorageExport:FileStorageExport',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            path: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'FileStorageExport':
        """
        ...
        __props__ = _FileStorageExportState.__new__(_FileStorageExportState)
        ...
        return FileStorageExport(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="exportOptions")
    def export_options(self) -> pulumi.Output[Sequence['outputs.FileStorageExportExportOption']]:
        """
        (Updatable) Export options for the new export. If left unspecified, defaults to:
        """
        return pulumi.get(self, "export_options")
