...
__all__ = [
    'GetMysqlMysqlBackupsResult',
    'AwaitableGetMysqlMysqlBackupsResult',
    'get_mysql_mysql_backups',
]

@pulumi.output_type
class GetMysqlMysqlBackupsResult:
    """
    ...
    @property
    @pulumi.getter
    def backups(self) -> Sequence['outputs.GetMysqlMysqlBackupsBackupResult']:
        """
        The list of backups.
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMysqlMysqlBackupsFilterResult']]:
...
class AwaitableGetMysqlMysqlBackupsResult(GetMysqlMysqlBackupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlMysqlBackupsResult(
...
def get_mysql_mysql_backups(backup_id: Optional[str] = None,
                            compartment_id: Optional[str] = None,
                            creation_type: Optional[str] = None,
                            db_system_id: Optional[str] = None,
                            display_name: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetMysqlMysqlBackupsFilterArgs']]] = None,
                            state: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlMysqlBackupsResult:
    """
    ...
    test_mysql_backups = oci.get_mysql_mysql_backups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlMysqlBackups:GetMysqlMysqlBackups', __args__, opts=opts, typ=GetMysqlMysqlBackupsResult).value

    return AwaitableGetMysqlMysqlBackupsResult(
