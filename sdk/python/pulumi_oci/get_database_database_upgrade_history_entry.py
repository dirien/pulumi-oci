...
__all__ = [
    'GetDatabaseDatabaseUpgradeHistoryEntryResult',
    'AwaitableGetDatabaseDatabaseUpgradeHistoryEntryResult',
    'get_database_database_upgrade_history_entry',
]

@pulumi.output_type
class GetDatabaseDatabaseUpgradeHistoryEntryResult:
    """
...
class AwaitableGetDatabaseDatabaseUpgradeHistoryEntryResult(GetDatabaseDatabaseUpgradeHistoryEntryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDatabaseUpgradeHistoryEntryResult(
            action=self.action,
...
def get_database_database_upgrade_history_entry(database_id: Optional[str] = None,
                                                upgrade_history_entry_id: Optional[str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDatabaseUpgradeHistoryEntryResult:
    """
    ...
    test_database_upgrade_history_entry = oci.get_database_database_upgrade_history_entry(database_id=oci_database_database["test_database"]["id"],
    ...
    :param str upgrade_history_entry_id: The database upgrade History [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDatabaseUpgradeHistoryEntry:GetDatabaseDatabaseUpgradeHistoryEntry', __args__, opts=opts, typ=GetDatabaseDatabaseUpgradeHistoryEntryResult).value

    return AwaitableGetDatabaseDatabaseUpgradeHistoryEntryResult(
