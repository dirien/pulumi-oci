...
__all__ = [
    'GetDatabaseAutonomousExadataInfrastructureOcpuResult',
    'AwaitableGetDatabaseAutonomousExadataInfrastructureOcpuResult',
    'get_database_autonomous_exadata_infrastructure_ocpu',
]

@pulumi.output_type
class GetDatabaseAutonomousExadataInfrastructureOcpuResult:
    """
    ...
    def by_workload_types(self) -> Sequence['outputs.GetDatabaseAutonomousExadataInfrastructureOcpuByWorkloadTypeResult']:
        """
...
class AwaitableGetDatabaseAutonomousExadataInfrastructureOcpuResult(GetDatabaseAutonomousExadataInfrastructureOcpuResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousExadataInfrastructureOcpuResult(
...
def get_database_autonomous_exadata_infrastructure_ocpu(autonomous_exadata_infrastructure_id: Optional[str] = None,
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousExadataInfrastructureOcpuResult:
    """
    ...
    test_autonomous_exadata_infrastructure_ocpu = oci.get_database_autonomous_exadata_infrastructure_ocpu(autonomous_exadata_infrastructure_id=oci_database_autonomous_exadata_infrastructure["test_autonomous_exadata_infrastructure"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousExadataInfrastructureOcpu:GetDatabaseAutonomousExadataInfrastructureOcpu', __args__, opts=opts, typ=GetDatabaseAutonomousExadataInfrastructureOcpuResult).value

    return AwaitableGetDatabaseAutonomousExadataInfrastructureOcpuResult(
