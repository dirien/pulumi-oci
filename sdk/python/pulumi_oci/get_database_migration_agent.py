...
__all__ = [
    'GetDatabaseMigrationAgentResult',
    'AwaitableGetDatabaseMigrationAgentResult',
    'get_database_migration_agent',
]

@pulumi.output_type
class GetDatabaseMigrationAgentResult:
    """
...
class AwaitableGetDatabaseMigrationAgentResult(GetDatabaseMigrationAgentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseMigrationAgentResult(
...
def get_database_migration_agent(agent_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseMigrationAgentResult:
    """
    ...
    test_agent = oci.get_database_migration_agent(agent_id=oci_database_migration_agent["test_agent"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseMigrationAgent:GetDatabaseMigrationAgent', __args__, opts=opts, typ=GetDatabaseMigrationAgentResult).value

    return AwaitableGetDatabaseMigrationAgentResult(
