...
__all__ = ['FunctionsFunctionArgs', 'FunctionsFunction']

@pulumi.input_type
class FunctionsFunctionArgs:
    def __init__(__self__, *,
                 ...
                 trace_config: Optional[pulumi.Input['FunctionsFunctionTraceConfigArgs']] = None):
        """
        ...
        :param pulumi.Input['FunctionsFunctionTraceConfigArgs'] trace_config: (Updatable) Define the tracing configuration for a function.
        """
    ...
    def trace_config(self) -> Optional[pulumi.Input['FunctionsFunctionTraceConfigArgs']]:
        """
    ...
    @trace_config.setter
    def trace_config(self, value: Optional[pulumi.Input['FunctionsFunctionTraceConfigArgs']]):
        pulumi.set(self, "trace_config", value)


@pulumi.input_type
class _FunctionsFunctionState:
    def __init__(__self__, *,
...
class FunctionsFunction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 memory_in_mbs: Optional[pulumi.Input[str]] = None,
                 timeout_in_seconds: Optional[pulumi.Input[int]] = None,
                 trace_config: Optional[pulumi.Input[pulumi.InputType['FunctionsFunctionTraceConfigArgs']]] = None,
                 __props__=None):
        """
        ...
        test_function = oci.FunctionsFunction("testFunction",
            ...
            trace_config=oci.FunctionsFunctionTraceConfigArgs(
        ...
        :param pulumi.Input[str] memory_in_mbs: (Updatable) Maximum usable memory for the function (MiB).
        :param pulumi.Input[int] timeout_in_seconds: (Updatable) Timeout for executions of the function. Value in seconds.
        :param pulumi.Input[pulumi.InputType['FunctionsFunctionTraceConfigArgs']] trace_config: (Updatable) Define the tracing configuration for a function.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: FunctionsFunctionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Function resource in Oracle Cloud Infrastructure Functions service.
        ...
        :param str resource_name: The name of the resource.
        :param FunctionsFunctionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FunctionsFunctionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FunctionsFunctionArgs.__new__(FunctionsFunctionArgs)
        ...
        super(FunctionsFunction, __self__).__init__(
            'oci:index/functionsFunction:FunctionsFunction',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[str]] = None,
            timeout_in_seconds: Optional[pulumi.Input[int]] = None,
            trace_config: Optional[pulumi.Input[pulumi.InputType['FunctionsFunctionTraceConfigArgs']]] = None) -> 'FunctionsFunction':
        """
        ...
        __props__ = _FunctionsFunctionState.__new__(_FunctionsFunctionState)
        ...
        __props__.__dict__["timeout_in_seconds"] = timeout_in_seconds
        __props__.__dict__["trace_config"] = trace_config
        return FunctionsFunction(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="traceConfig")
    def trace_config(self) -> pulumi.Output['outputs.FunctionsFunctionTraceConfig']:
        """
        (Updatable) Define the tracing configuration for a function.
        """
        return pulumi.get(self, "trace_config")
