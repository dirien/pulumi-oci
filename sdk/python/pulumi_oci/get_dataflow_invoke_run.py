...
class GetDataflowInvokeRunResult:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Sequence['outputs.GetDataflowInvokeRunParameterResult']:
        """
...
class AwaitableGetDataflowInvokeRunResult(GetDataflowInvokeRunResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowInvokeRunResult(
...
def get_dataflow_invoke_run(run_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowInvokeRunResult:
    """
    ...
    test_invoke_run = oci.get_dataflow_invoke_run(run_id=oci_dataflow_run["test_run"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowInvokeRun:GetDataflowInvokeRun', __args__, opts=opts, typ=GetDataflowInvokeRunResult).value

    return AwaitableGetDataflowInvokeRunResult(
