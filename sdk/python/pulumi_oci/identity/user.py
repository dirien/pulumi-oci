...
class _UserState:
    def __init__(__self__, *,
                 capabilities: Optional[pulumi.Input['UserCapabilitiesArgs']] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input['UserCapabilitiesArgs'] capabilities: Properties indicating how the user is allowed to authenticate.
        :param pulumi.Input[str] compartment_id: The OCID of the tenancy containing the user.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) The description you assign to the user during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> Optional[pulumi.Input['UserCapabilitiesArgs']]:
        """
    ...
    @capabilities.setter
    def capabilities(self, value: Optional[pulumi.Input['UserCapabilitiesArgs']]):
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            capabilities: Optional[pulumi.Input[pulumi.InputType['UserCapabilitiesArgs']]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            description: Optional[pulumi.Input[str]] = None,
            email: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['UserCapabilitiesArgs']] capabilities: Properties indicating how the user is allowed to authenticate.
        :param pulumi.Input[str] compartment_id: The OCID of the tenancy containing the user.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) The description you assign to the user during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> pulumi.Output['outputs.UserCapabilities']:
        """
        Properties indicating how the user is allowed to authenticate.
        """
        return pulumi.get(self, "capabilities")
