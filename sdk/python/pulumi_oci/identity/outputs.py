...
__all__ = [
    ...
    'GetUsersUserResult',
    'GetUsersUserCapabilitiesResult',
]
...
class UserCapabilities(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in UserCapabilities. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        UserCapabilities.__key_warning(key)
        return super().__getitem__(key)
...
class GetCostTrackingTagsTagResult(dict):
    def __init__(__self__, *,
                 ...
                 time_created: str,
                 validator: 'outputs.GetCostTrackingTagsTagValidatorResult'):
        """
        :param str compartment_id: The OCID of the compartment (remember that the tenancy is simply the root compartment).
        :param Mapping[str, Any] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
    ...
    @property
    @pulumi.getter
    def validator(self) -> 'outputs.GetCostTrackingTagsTagValidatorResult':
        """
...
class GetTagsTagResult(dict):
    def __init__(__self__, *,
                 ...
                 tag_namespace_id: str,
                 time_created: str,
                 validator: 'outputs.GetTagsTagValidatorResult'):
        """
        :param Mapping[str, Any] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param str description: The description you assign to the tag.
        :param Mapping[str, Any] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        ...
        :param str time_created: Date and time the tag was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param 'GetTagsTagValidatorArgs' validator: Validates a definedTag value. Each validator performs validation steps in addition to the standard validation for definedTag values. For more information, see [Limits on Tags](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/taggingoverview.htm#Limits).
        """
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "freeform_tags", freeform_tags)
    ...
    @property
    @pulumi.getter
    def validator(self) -> 'outputs.GetTagsTagValidatorResult':
        """
        Validates a definedTag value. Each validator performs validation steps in addition to the standard validation for definedTag values. For more information, see [Limits on Tags](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/taggingoverview.htm#Limits).
        """
        return pulumi.get(self, "validator")
...
@pulumi.output_type
class GetUserCapabilitiesResult(dict):
    def __init__(__self__, *,
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
                 capabilities: 'outputs.GetUsersUserCapabilitiesResult',
                 compartment_id: str,
                 defined_tags: Mapping[str, Any],
                 description: str,
                 email: str,
                 ...
                 time_created: str):
        """
        :param 'GetUsersUserCapabilitiesArgs' capabilities: Properties indicating how the user is allowed to authenticate.
        :param str compartment_id: The OCID of the compartment (remember that the tenancy is simply the root compartment).
        :param Mapping[str, Any] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> 'outputs.GetUsersUserCapabilitiesResult':
        """
...
@pulumi.output_type
class GetUsersUserCapabilitiesResult(dict):
    def __init__(__self__, *,
                 can_use_api_keys: bool,
                 can_use_auth_tokens: bool,
                 can_use_console_password: bool,
