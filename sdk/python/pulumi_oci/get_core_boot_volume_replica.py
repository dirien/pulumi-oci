...
__all__ = [
    'GetCoreBootVolumeReplicaResult',
    'AwaitableGetCoreBootVolumeReplicaResult',
    'get_core_boot_volume_replica',
]

@pulumi.output_type
class GetCoreBootVolumeReplicaResult:
    """
    A collection of values returned by GetCoreBootVolumeReplica.
    """
    def __init__(__self__, availability_domain=None, boot_volume_id=None, boot_volume_replica_id=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, image_id=None, size_in_gbs=None, state=None, time_created=None, time_last_synced=None):
...
class AwaitableGetCoreBootVolumeReplicaResult(GetCoreBootVolumeReplicaResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBootVolumeReplicaResult(
...
def get_core_boot_volume_replica(boot_volume_replica_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBootVolumeReplicaResult:
    """
    ...
    test_boot_volume_replica = oci.get_core_boot_volume_replica(boot_volume_replica_id=oci_core_boot_volume_replica["test_boot_volume_replica"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBootVolumeReplica:GetCoreBootVolumeReplica', __args__, opts=opts, typ=GetCoreBootVolumeReplicaResult).value

    return AwaitableGetCoreBootVolumeReplicaResult(
