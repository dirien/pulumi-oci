...
__all__ = [
    'GetStreamingStreamPoolResult',
    'AwaitableGetStreamingStreamPoolResult',
    'get_streaming_stream_pool',
]

@pulumi.output_type
class GetStreamingStreamPoolResult:
    """
    A collection of values returned by GetStreamingStreamPool.
    """
    def __init__(__self__, compartment_id=None, custom_encryption_key=None, defined_tags=None, endpoint_fqdn=None, freeform_tags=None, id=None, is_private=None, kafka_settings=None, lifecycle_state_details=None, name=None, private_endpoint_settings=None, state=None, stream_pool_id=None, time_created=None):
        if compartment_id and not isinstance(compartment_id, str):
            raise TypeError("Expected argument 'compartment_id' to be a str")
        pulumi.set(__self__, "compartment_id", compartment_id)
        if custom_encryption_key and not isinstance(custom_encryption_key, dict):
            raise TypeError("Expected argument 'custom_encryption_key' to be a dict")
        ...
        if private_endpoint_settings and not isinstance(private_endpoint_settings, dict):
            raise TypeError("Expected argument 'private_endpoint_settings' to be a dict")
    ...
    def custom_encryption_key(self) -> 'outputs.GetStreamingStreamPoolCustomEncryptionKeyResult':
        """
    ...
    def kafka_settings(self) -> 'outputs.GetStreamingStreamPoolKafkaSettingsResult':
        """
    ...
    def private_endpoint_settings(self) -> 'outputs.GetStreamingStreamPoolPrivateEndpointSettingsResult':
        """
...
class AwaitableGetStreamingStreamPoolResult(GetStreamingStreamPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStreamingStreamPoolResult(
...
def get_streaming_stream_pool(stream_pool_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamingStreamPoolResult:
    """
    ...
    test_stream_pool = oci.get_streaming_stream_pool(stream_pool_id=oci_streaming_stream_pool["test_stream_pool"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getStreamingStreamPool:GetStreamingStreamPool', __args__, opts=opts, typ=GetStreamingStreamPoolResult).value

    return AwaitableGetStreamingStreamPoolResult(
        compartment_id=__ret__.compartment_id,
        custom_encryption_key=__ret__.custom_encryption_key,
