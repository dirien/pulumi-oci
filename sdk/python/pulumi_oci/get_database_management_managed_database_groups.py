...
__all__ = [
    'GetDatabaseManagementManagedDatabaseGroupsResult',
    'AwaitableGetDatabaseManagementManagedDatabaseGroupsResult',
    'get_database_management_managed_database_groups',
]

@pulumi.output_type
class GetDatabaseManagementManagedDatabaseGroupsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseManagementManagedDatabaseGroupsFilterResult']]:
    ...
    def managed_database_group_collections(self) -> Sequence['outputs.GetDatabaseManagementManagedDatabaseGroupsManagedDatabaseGroupCollectionResult']:
        """
...
class AwaitableGetDatabaseManagementManagedDatabaseGroupsResult(GetDatabaseManagementManagedDatabaseGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseManagementManagedDatabaseGroupsResult(
...
def get_database_management_managed_database_groups(compartment_id: Optional[str] = None,
                                                    filters: Optional[Sequence[pulumi.InputType['GetDatabaseManagementManagedDatabaseGroupsFilterArgs']]] = None,
                                                    id: Optional[str] = None,
                                                    name: Optional[str] = None,
                                                    state: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseManagementManagedDatabaseGroupsResult:
    """
    ...
    test_managed_database_groups = oci.get_database_management_managed_database_groups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseManagementManagedDatabaseGroups:GetDatabaseManagementManagedDatabaseGroups', __args__, opts=opts, typ=GetDatabaseManagementManagedDatabaseGroupsResult).value

    return AwaitableGetDatabaseManagementManagedDatabaseGroupsResult(
