...
__all__ = [
    'GetCloudGuardDataMaskRulesResult',
    'AwaitableGetCloudGuardDataMaskRulesResult',
    'get_cloud_guard_data_mask_rules',
]

@pulumi.output_type
class GetCloudGuardDataMaskRulesResult:
    """
    ...
    def data_mask_rule_collections(self) -> Sequence['outputs.GetCloudGuardDataMaskRulesDataMaskRuleCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudGuardDataMaskRulesFilterResult']]:
...
class AwaitableGetCloudGuardDataMaskRulesResult(GetCloudGuardDataMaskRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardDataMaskRulesResult(
...
def get_cloud_guard_data_mask_rules(access_level: Optional[str] = None,
                                    compartment_id: Optional[str] = None,
                                    data_mask_rule_status: Optional[str] = None,
                                    display_name: Optional[str] = None,
                                    filters: Optional[Sequence[pulumi.InputType['GetCloudGuardDataMaskRulesFilterArgs']]] = None,
                                    iam_group_id: Optional[str] = None,
                                    state: Optional[str] = None,
                                    target_id: Optional[str] = None,
                                    target_type: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardDataMaskRulesResult:
    """
    ...
    test_data_mask_rules = oci.get_cloud_guard_data_mask_rules(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardDataMaskRules:GetCloudGuardDataMaskRules', __args__, opts=opts, typ=GetCloudGuardDataMaskRulesResult).value

    return AwaitableGetCloudGuardDataMaskRulesResult(
