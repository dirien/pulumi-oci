...
__all__ = [
    'GetApigatewayGatewaysResult',
    'AwaitableGetApigatewayGatewaysResult',
    'get_apigateway_gateways',
]

@pulumi.output_type
class GetApigatewayGatewaysResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetApigatewayGatewaysFilterResult']]:
        return pulumi.get(self, "filters")

    @property
    @pulumi.getter(name="gatewayCollections")
    def gateway_collections(self) -> Sequence['outputs.GetApigatewayGatewaysGatewayCollectionResult']:
        """
...
class AwaitableGetApigatewayGatewaysResult(GetApigatewayGatewaysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayGatewaysResult(
...
def get_apigateway_gateways(certificate_id: Optional[str] = None,
                            compartment_id: Optional[str] = None,
                            display_name: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetApigatewayGatewaysFilterArgs']]] = None,
                            state: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayGatewaysResult:
    """
    ...
    test_gateways = oci.get_apigateway_gateways(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayGateways:GetApigatewayGateways', __args__, opts=opts, typ=GetApigatewayGatewaysResult).value

    return AwaitableGetApigatewayGatewaysResult(
