...
__all__ = [
    'GetCoreCrossConnectResult',
    'AwaitableGetCoreCrossConnectResult',
    'get_core_cross_connect',
]

@pulumi.output_type
class GetCoreCrossConnectResult:
    """
    A collection of values returned by GetCoreCrossConnect.
    """
    def __init__(__self__, compartment_id=None, cross_connect_group_id=None, cross_connect_id=None, customer_reference_name=None, defined_tags=None, display_name=None, far_cross_connect_or_cross_connect_group_id=None, freeform_tags=None, id=None, is_active=None, location_name=None, near_cross_connect_or_cross_connect_group_id=None, port_name=None, port_speed_shape_name=None, state=None, time_created=None):
...
class AwaitableGetCoreCrossConnectResult(GetCoreCrossConnectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreCrossConnectResult(
...
def get_core_cross_connect(cross_connect_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreCrossConnectResult:
    """
    ...
    test_cross_connect = oci.get_core_cross_connect(cross_connect_id=oci_core_cross_connect["test_cross_connect"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreCrossConnect:GetCoreCrossConnect', __args__, opts=opts, typ=GetCoreCrossConnectResult).value

    return AwaitableGetCoreCrossConnectResult(
