...
__all__ = [
    'GetDatascienceModelDeploymentsResult',
    'AwaitableGetDatascienceModelDeploymentsResult',
    'get_datascience_model_deployments',
]

@pulumi.output_type
class GetDatascienceModelDeploymentsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatascienceModelDeploymentsFilterResult']]:
    ...
    def model_deployments(self) -> Sequence['outputs.GetDatascienceModelDeploymentsModelDeploymentResult']:
        """
...
class AwaitableGetDatascienceModelDeploymentsResult(GetDatascienceModelDeploymentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceModelDeploymentsResult(
...
def get_datascience_model_deployments(compartment_id: Optional[str] = None,
                                      created_by: Optional[str] = None,
                                      display_name: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetDatascienceModelDeploymentsFilterArgs']]] = None,
                                      id: Optional[str] = None,
                                      project_id: Optional[str] = None,
                                      state: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceModelDeploymentsResult:
    """
    ...
    test_model_deployments = oci.get_datascience_model_deployments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceModelDeployments:GetDatascienceModelDeployments', __args__, opts=opts, typ=GetDatascienceModelDeploymentsResult).value

    return AwaitableGetDatascienceModelDeploymentsResult(
