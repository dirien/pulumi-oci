...
__all__ = [
    'GetCoreVlanResult',
    'AwaitableGetCoreVlanResult',
    'get_core_vlan',
]

@pulumi.output_type
class GetCoreVlanResult:
    """
...
class AwaitableGetCoreVlanResult(GetCoreVlanResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVlanResult(
...
def get_core_vlan(vlan_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVlanResult:
    """
    ...
    test_vlan = oci.get_core_vlan(vlan_id=oci_core_vlan["test_vlan"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVlan:GetCoreVlan', __args__, opts=opts, typ=GetCoreVlanResult).value

    return AwaitableGetCoreVlanResult(
