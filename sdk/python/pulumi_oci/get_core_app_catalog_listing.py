...
__all__ = [
    'GetCoreAppCatalogListingResult',
    'AwaitableGetCoreAppCatalogListingResult',
    'get_core_app_catalog_listing',
]

@pulumi.output_type
class GetCoreAppCatalogListingResult:
    """
...
class AwaitableGetCoreAppCatalogListingResult(GetCoreAppCatalogListingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreAppCatalogListingResult(
...
def get_core_app_catalog_listing(listing_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreAppCatalogListingResult:
    """
    ...
    test_app_catalog_listing = oci.get_core_app_catalog_listing(listing_id=data["oci_core_app_catalog_listing"]["test_listing"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreAppCatalogListing:GetCoreAppCatalogListing', __args__, opts=opts, typ=GetCoreAppCatalogListingResult).value

    return AwaitableGetCoreAppCatalogListingResult(
