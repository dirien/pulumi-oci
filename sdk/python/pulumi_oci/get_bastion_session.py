...
__all__ = [
    'GetBastionSessionResult',
    'AwaitableGetBastionSessionResult',
    'get_bastion_session',
]

@pulumi.output_type
class GetBastionSessionResult:
    """
    ...
    def __init__(__self__, bastion_id=None, bastion_name=None, bastion_public_host_key_info=None, bastion_user_name=None, display_name=None, id=None, key_details=None, key_type=None, lifecycle_details=None, session_id=None, session_ttl_in_seconds=None, ssh_metadata=None, state=None, target_resource_details=None, time_created=None, time_updated=None):
        ...
        if key_details and not isinstance(key_details, dict):
            raise TypeError("Expected argument 'key_details' to be a dict")
        ...
        if target_resource_details and not isinstance(target_resource_details, dict):
            raise TypeError("Expected argument 'target_resource_details' to be a dict")
    ...
    def key_details(self) -> 'outputs.GetBastionSessionKeyDetailsResult':
        """
    ...
    def target_resource_details(self) -> 'outputs.GetBastionSessionTargetResourceDetailsResult':
        """
...
class AwaitableGetBastionSessionResult(GetBastionSessionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBastionSessionResult(
...
def get_bastion_session(session_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBastionSessionResult:
    """
    ...
    test_session = oci.get_bastion_session(session_id=oci_bastion_session["test_session"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBastionSession:GetBastionSession', __args__, opts=opts, typ=GetBastionSessionResult).value

    return AwaitableGetBastionSessionResult(
