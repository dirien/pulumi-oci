...
__all__ = [
    'GetLoadBalancerBackendsResult',
    'AwaitableGetLoadBalancerBackendsResult',
    'get_load_balancer_backends',
]

@pulumi.output_type
class GetLoadBalancerBackendsResult:
    """
    ...
    @property
    @pulumi.getter
    def backends(self) -> Sequence['outputs.GetLoadBalancerBackendsBackendResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLoadBalancerBackendsFilterResult']]:
...
class AwaitableGetLoadBalancerBackendsResult(GetLoadBalancerBackendsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerBackendsResult(
...
def get_load_balancer_backends(backendset_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetLoadBalancerBackendsFilterArgs']]] = None,
                               load_balancer_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerBackendsResult:
    """
    ...
    test_backends = oci.get_load_balancer_backends(backendset_name=oci_load_balancer_backend_set["test_backend_set"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerBackends:GetLoadBalancerBackends', __args__, opts=opts, typ=GetLoadBalancerBackendsResult).value

    return AwaitableGetLoadBalancerBackendsResult(
