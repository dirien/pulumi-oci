...
__all__ = [
    ...
    'GetTablesTableCollectionTableLimitsResult',
]
...
@pulumi.output_type
class GetTableTableLimitsResult(dict):
    def __init__(__self__, *,
                 max_read_units: int,
                 max_storage_in_gbs: int,
                 max_write_units: int):
...
class GetTablesTableCollectionResult(dict):
    def __init__(__self__, *,
                 ...
                 lifecycle_details: str,
                 name: str,
                 schema: 'outputs.GetTablesTableCollectionSchemaResult',
                 state: str,
                 system_tags: Mapping[str, Any],
                 table_limits: 'outputs.GetTablesTableCollectionTableLimitsResult',
                 time_created: str,
        ...
        :param str lifecycle_details: A message describing the current state in more detail.
        :param str name: A shell-globbing-style (*?[]) filter for names.
        :param 'GetTablesTableCollectionSchemaArgs' schema: The table schema information as a JSON object.
        :param str state: Filter list by the lifecycle state of the item.
        ...
        :param 'GetTablesTableCollectionTableLimitsArgs' table_limits: Throughput and storage limits configuration of a table.
    ...
    @property
    @pulumi.getter
    def schema(self) -> 'outputs.GetTablesTableCollectionSchemaResult':
        """
    ...
    def table_limits(self) -> 'outputs.GetTablesTableCollectionTableLimitsResult':
        """
...
@pulumi.output_type
class GetTablesTableCollectionTableLimitsResult(dict):
    def __init__(__self__, *,
                 max_read_units: int,
                 max_storage_in_gbs: int,
                 max_write_units: int):
