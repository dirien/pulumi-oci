...
__all__ = [
    'GetServiceCatalogPrivateApplicationPackageResult',
    'AwaitableGetServiceCatalogPrivateApplicationPackageResult',
    'get_service_catalog_private_application_package',
]

@pulumi.output_type
class GetServiceCatalogPrivateApplicationPackageResult:
    """
...
class AwaitableGetServiceCatalogPrivateApplicationPackageResult(GetServiceCatalogPrivateApplicationPackageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceCatalogPrivateApplicationPackageResult(
...
def get_service_catalog_private_application_package(private_application_package_id: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceCatalogPrivateApplicationPackageResult:
    """
    ...
    test_private_application_package = oci.get_service_catalog_private_application_package(private_application_package_id=oci_service_catalog_private_application_package["test_private_application_package"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getServiceCatalogPrivateApplicationPackage:GetServiceCatalogPrivateApplicationPackage', __args__, opts=opts, typ=GetServiceCatalogPrivateApplicationPackageResult).value

    return AwaitableGetServiceCatalogPrivateApplicationPackageResult(
