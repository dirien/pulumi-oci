...
__all__ = [
    'GetDatabaseAutonomousDatabaseResult',
    'AwaitableGetDatabaseAutonomousDatabaseResult',
    'get_database_autonomous_database',
]

@pulumi.output_type
class GetDatabaseAutonomousDatabaseResult:
    """
    A collection of values returned by GetDatabaseAutonomousDatabase.
    """
    def __init__(__self__, admin_password=None, apex_details=None, are_primary_whitelisted_ips_used=None, autonomous_container_database_id=None, autonomous_database_backup_id=None, autonomous_database_id=None, autonomous_maintenance_schedule_type=None, available_upgrade_versions=None, backup_config=None, clone_type=None, compartment_id=None, connection_strings=None, connection_urls=None, cpu_core_count=None, customer_contacts=None, data_safe_status=None, data_storage_size_in_gb=None, data_storage_size_in_tbs=None, db_name=None, db_version=None, db_workload=None, defined_tags=None, display_name=None, failed_data_recovery_in_seconds=None, freeform_tags=None, id=None, infrastructure_type=None, is_access_control_enabled=None, is_auto_scaling_enabled=None, is_data_guard_enabled=None, is_dedicated=None, is_free_tier=None, is_preview=None, is_preview_version_with_service_terms_accepted=None, is_refreshable_clone=None, key_history_entries=None, key_store_id=None, key_store_wallet_name=None, kms_key_id=None, kms_key_lifecycle_details=None, license_model=None, lifecycle_details=None, nsg_ids=None, ocpu_count=None, open_mode=None, operations_insights_status=None, permission_level=None, private_endpoint=None, private_endpoint_ip=None, private_endpoint_label=None, refreshable_mode=None, refreshable_status=None, role=None, rotate_key_trigger=None, service_console_url=None, source=None, source_id=None, standby_db=None, standby_whitelisted_ips=None, state=None, subnet_id=None, switchover_to=None, system_tags=None, time_created=None, time_deletion_of_free_autonomous_database=None, time_maintenance_begin=None, time_maintenance_end=None, time_of_last_failover=None, time_of_last_refresh=None, time_of_last_refresh_point=None, time_of_last_switchover=None, time_of_next_refresh=None, time_reclamation_of_free_autonomous_database=None, timestamp=None, used_data_storage_size_in_tbs=None, vault_id=None, whitelisted_ips=None):
        ...
        if apex_details and not isinstance(apex_details, dict):
            raise TypeError("Expected argument 'apex_details' to be a dict")
        ...
        if connection_urls and not isinstance(connection_urls, dict):
            raise TypeError("Expected argument 'connection_urls' to be a dict")
        ...
        if standby_db and not isinstance(standby_db, dict):
            raise TypeError("Expected argument 'standby_db' to be a dict")
    ...
    def apex_details(self) -> 'outputs.GetDatabaseAutonomousDatabaseApexDetailsResult':
        """
    ...
    def backup_config(self) -> 'outputs.GetDatabaseAutonomousDatabaseBackupConfigResult':
        """
    ...
    def connection_strings(self) -> 'outputs.GetDatabaseAutonomousDatabaseConnectionStringsResult':
        """
    ...
    def connection_urls(self) -> 'outputs.GetDatabaseAutonomousDatabaseConnectionUrlsResult':
        """
    ...
    def customer_contacts(self) -> Sequence['outputs.GetDatabaseAutonomousDatabaseCustomerContactResult']:
        """
        Customer Contacts.
        """
    ...
    def key_history_entries(self) -> Sequence['outputs.GetDatabaseAutonomousDatabaseKeyHistoryEntryResult']:
        """
        Key History Entry.
        """
    ...
    def standby_db(self) -> 'outputs.GetDatabaseAutonomousDatabaseStandbyDbResult':
        """
...
class AwaitableGetDatabaseAutonomousDatabaseResult(GetDatabaseAutonomousDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousDatabaseResult(
...
def get_database_autonomous_database(autonomous_database_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousDatabaseResult:
    """
    ...
    test_autonomous_database = oci.get_database_autonomous_database(autonomous_database_id=oci_database_autonomous_database["test_autonomous_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousDatabase:GetDatabaseAutonomousDatabase', __args__, opts=opts, typ=GetDatabaseAutonomousDatabaseResult).value

    return AwaitableGetDatabaseAutonomousDatabaseResult(
