...
__all__ = [
    'GetCoreInstancePoolLoadBalancerAttachmentResult',
    'AwaitableGetCoreInstancePoolLoadBalancerAttachmentResult',
    'get_core_instance_pool_load_balancer_attachment',
]

@pulumi.output_type
class GetCoreInstancePoolLoadBalancerAttachmentResult:
    """
...
class AwaitableGetCoreInstancePoolLoadBalancerAttachmentResult(GetCoreInstancePoolLoadBalancerAttachmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstancePoolLoadBalancerAttachmentResult(
...
def get_core_instance_pool_load_balancer_attachment(instance_pool_id: Optional[str] = None,
                                                    instance_pool_load_balancer_attachment_id: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstancePoolLoadBalancerAttachmentResult:
    """
    ...
    test_instance_pool_load_balancer_attachment = oci.get_core_instance_pool_load_balancer_attachment(instance_pool_id=oci_core_instance_pool["test_instance_pool"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstancePoolLoadBalancerAttachment:GetCoreInstancePoolLoadBalancerAttachment', __args__, opts=opts, typ=GetCoreInstancePoolLoadBalancerAttachmentResult).value

    return AwaitableGetCoreInstancePoolLoadBalancerAttachmentResult(
