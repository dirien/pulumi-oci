...
__all__ = [
    'GetMonitoringAlarmHistoryCollectionResult',
    'AwaitableGetMonitoringAlarmHistoryCollectionResult',
    'get_monitoring_alarm_history_collection',
]

@pulumi.output_type
class GetMonitoringAlarmHistoryCollectionResult:
    """
    ...
    @property
    @pulumi.getter
    def entries(self) -> Sequence['outputs.GetMonitoringAlarmHistoryCollectionEntryResult']:
        """
...
class AwaitableGetMonitoringAlarmHistoryCollectionResult(GetMonitoringAlarmHistoryCollectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMonitoringAlarmHistoryCollectionResult(
...
def get_monitoring_alarm_history_collection(alarm_historytype: Optional[str] = None,
                                            alarm_id: Optional[str] = None,
                                            timestamp_greater_than_or_equal_to: Optional[str] = None,
                                            timestamp_less_than: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringAlarmHistoryCollectionResult:
    """
    ...
    test_alarm_history_collection = oci.get_monitoring_alarm_history_collection(alarm_id=oci_monitoring_alarm["test_alarm"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMonitoringAlarmHistoryCollection:GetMonitoringAlarmHistoryCollection', __args__, opts=opts, typ=GetMonitoringAlarmHistoryCollectionResult).value

    return AwaitableGetMonitoringAlarmHistoryCollectionResult(
