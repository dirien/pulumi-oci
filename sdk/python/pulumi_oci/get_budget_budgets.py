...
__all__ = [
    'GetBudgetBudgetsResult',
    'AwaitableGetBudgetBudgetsResult',
    'get_budget_budgets',
]

@pulumi.output_type
class GetBudgetBudgetsResult:
    """
    ...
    @property
    @pulumi.getter
    def budgets(self) -> Sequence['outputs.GetBudgetBudgetsBudgetResult']:
        """
        The list of budgets.
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBudgetBudgetsFilterResult']]:
...
class AwaitableGetBudgetBudgetsResult(GetBudgetBudgetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBudgetBudgetsResult(
...
def get_budget_budgets(compartment_id: Optional[str] = None,
                       display_name: Optional[str] = None,
                       filters: Optional[Sequence[pulumi.InputType['GetBudgetBudgetsFilterArgs']]] = None,
                       state: Optional[str] = None,
                       target_type: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBudgetBudgetsResult:
    """
    ...
    test_budgets = oci.get_budget_budgets(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBudgetBudgets:GetBudgetBudgets', __args__, opts=opts, typ=GetBudgetBudgetsResult).value

    return AwaitableGetBudgetBudgetsResult(
