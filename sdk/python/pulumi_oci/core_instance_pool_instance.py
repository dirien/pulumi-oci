...
__all__ = ['CoreInstancePoolInstanceArgs', 'CoreInstancePoolInstance']

@pulumi.input_type
class CoreInstancePoolInstanceArgs:
...
@pulumi.input_type
class _CoreInstancePoolInstanceState:
    def __init__(__self__, *,
                 auto_terminate_instance_on_delete: Optional[pulumi.Input[bool]] = None,
                 ...
                 load_balancer_backends: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolInstanceLoadBalancerBackendArgs']]]] = None,
        ...
        :param pulumi.Input[str] display_name: The user-friendly name. Does not have to be unique.
        ...
        :param pulumi.Input[str] instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
        :param pulumi.Input[str] instance_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
        :param pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolInstanceLoadBalancerBackendArgs']]] load_balancer_backends: The load balancer backends that are configured for the instance pool instance.
    ...
    def load_balancer_backends(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolInstanceLoadBalancerBackendArgs']]]]:
        """
    ...
    def load_balancer_backends(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreInstancePoolInstanceLoadBalancerBackendArgs']]]]):
...
class CoreInstancePoolInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_instance_pool_instance = oci.CoreInstancePoolInstance("testInstancePoolInstance",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreInstancePoolInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Instance Pool Instance resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreInstancePoolInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreInstancePoolInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreInstancePoolInstanceArgs.__new__(CoreInstancePoolInstanceArgs)
        ...
        super(CoreInstancePoolInstance, __self__).__init__(
            'oci:index/coreInstancePoolInstance:CoreInstancePoolInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[str]] = None,
            instance_pool_id: Optional[pulumi.Input[str]] = None,
            load_balancer_backends: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolInstanceLoadBalancerBackendArgs']]]]] = None,
            region: Optional[pulumi.Input[str]] = None,
            shape: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreInstancePoolInstance':
        """
        ...
        :param pulumi.Input[str] instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
        :param pulumi.Input[str] instance_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreInstancePoolInstanceLoadBalancerBackendArgs']]]] load_balancer_backends: The load balancer backends that are configured for the instance pool instance.
        :param pulumi.Input[str] region: The region that contains the availability domain the instance is running in.
        :param pulumi.Input[str] shape: The shape of an instance. The shape determines the number of CPUs, amount of memory, and other resources allocated to the instance.
        :param pulumi.Input[str] state: The lifecycle state of the instance. Refer to `lifecycleState` in the [Instance](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Instance) resource.
        :param pulumi.Input[str] time_created: The date and time the instance pool instance was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        ...
        __props__ = _CoreInstancePoolInstanceState.__new__(_CoreInstancePoolInstanceState)
        ...
        return CoreInstancePoolInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="loadBalancerBackends")
    def load_balancer_backends(self) -> pulumi.Output[Sequence['outputs.CoreInstancePoolInstanceLoadBalancerBackend']]:
        """
        The load balancer backends that are configured for the instance pool instance.
        """
        return pulumi.get(self, "load_balancer_backends")
