...
__all__ = [
    'GetLoadBalancerLoadBalancersResult',
    'AwaitableGetLoadBalancerLoadBalancersResult',
    'get_load_balancer_load_balancers',
]

@pulumi.output_type
class GetLoadBalancerLoadBalancersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLoadBalancerLoadBalancersFilterResult']]:
    ...
    def load_balancers(self) -> Sequence['outputs.GetLoadBalancerLoadBalancersLoadBalancerResult']:
        """
...
class AwaitableGetLoadBalancerLoadBalancersResult(GetLoadBalancerLoadBalancersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerLoadBalancersResult(
...
def get_load_balancer_load_balancers(compartment_id: Optional[str] = None,
                                     detail: Optional[str] = None,
                                     display_name: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetLoadBalancerLoadBalancersFilterArgs']]] = None,
                                     state: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerLoadBalancersResult:
    """
    ...
    * `GetLoadBalancers`
    ...
    test_load_balancers = oci.get_load_balancer_load_balancers(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerLoadBalancers:GetLoadBalancerLoadBalancers', __args__, opts=opts, typ=GetLoadBalancerLoadBalancersResult).value

    return AwaitableGetLoadBalancerLoadBalancersResult(
