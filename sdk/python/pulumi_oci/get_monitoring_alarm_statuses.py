...
__all__ = [
    'GetMonitoringAlarmStatusesResult',
    'AwaitableGetMonitoringAlarmStatusesResult',
    'get_monitoring_alarm_statuses',
]

@pulumi.output_type
class GetMonitoringAlarmStatusesResult:
    """
    ...
    def alarm_statuses(self) -> Sequence['outputs.GetMonitoringAlarmStatusesAlarmStatusResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMonitoringAlarmStatusesFilterResult']]:
...
class AwaitableGetMonitoringAlarmStatusesResult(GetMonitoringAlarmStatusesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMonitoringAlarmStatusesResult(
...
def get_monitoring_alarm_statuses(compartment_id: Optional[str] = None,
                                  compartment_id_in_subtree: Optional[bool] = None,
                                  display_name: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetMonitoringAlarmStatusesFilterArgs']]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringAlarmStatusesResult:
    """
    ...
    test_alarm_statuses = oci.get_monitoring_alarm_statuses(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMonitoringAlarmStatuses:GetMonitoringAlarmStatuses', __args__, opts=opts, typ=GetMonitoringAlarmStatusesResult).value

    return AwaitableGetMonitoringAlarmStatusesResult(
