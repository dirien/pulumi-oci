...
__all__ = [
    'GetDataSafeDataSafePrivateEndpointsResult',
    'AwaitableGetDataSafeDataSafePrivateEndpointsResult',
    'get_data_safe_data_safe_private_endpoints',
]

@pulumi.output_type
class GetDataSafeDataSafePrivateEndpointsResult:
    """
    ...
    def data_safe_private_endpoints(self) -> Sequence['outputs.GetDataSafeDataSafePrivateEndpointsDataSafePrivateEndpointResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDataSafeDataSafePrivateEndpointsFilterResult']]:
...
class AwaitableGetDataSafeDataSafePrivateEndpointsResult(GetDataSafeDataSafePrivateEndpointsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataSafeDataSafePrivateEndpointsResult(
...
def get_data_safe_data_safe_private_endpoints(access_level: Optional[str] = None,
                                              compartment_id: Optional[str] = None,
                                              compartment_id_in_subtree: Optional[bool] = None,
                                              display_name: Optional[str] = None,
                                              filters: Optional[Sequence[pulumi.InputType['GetDataSafeDataSafePrivateEndpointsFilterArgs']]] = None,
                                              state: Optional[str] = None,
                                              vcn_id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataSafeDataSafePrivateEndpointsResult:
    """
    ...
    test_data_safe_private_endpoints = oci.get_data_safe_data_safe_private_endpoints(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataSafeDataSafePrivateEndpoints:GetDataSafeDataSafePrivateEndpoints', __args__, opts=opts, typ=GetDataSafeDataSafePrivateEndpointsResult).value

    return AwaitableGetDataSafeDataSafePrivateEndpointsResult(
