...
class GetSubscriptionsSubscriptionResult(dict):
    def __init__(__self__, *,
                 ...
                 created_time: str,
                 defined_tags: Mapping[str, Any],
                 delivery_policy: 'outputs.GetSubscriptionsSubscriptionDeliveryPolicyResult',
                 endpoint: str,
                 etag: str,
                 freeform_tags: Mapping[str, Any],
                 id: str,
    ...
    def delivery_policy(self) -> 'outputs.GetSubscriptionsSubscriptionDeliveryPolicyResult':
...
class GetSubscriptionsSubscriptionDeliveryPolicyResult(dict):
    def __init__(__self__, *,
                 backoff_retry_policy: 'outputs.GetSubscriptionsSubscriptionDeliveryPolicyBackoffRetryPolicyResult'):
        pulumi.set(__self__, "backoff_retry_policy", backoff_retry_policy)

    @property
    @pulumi.getter(name="backoffRetryPolicy")
    def backoff_retry_policy(self) -> 'outputs.GetSubscriptionsSubscriptionDeliveryPolicyBackoffRetryPolicyResult':
        return pulumi.get(self, "backoff_retry_policy")
