...
__all__ = [
    'GetOcvpSddcsResult',
    'AwaitableGetOcvpSddcsResult',
    'get_ocvp_sddcs',
]

@pulumi.output_type
class GetOcvpSddcsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOcvpSddcsFilterResult']]:
    ...
    def sddc_collections(self) -> Sequence['outputs.GetOcvpSddcsSddcCollectionResult']:
        """
...
class AwaitableGetOcvpSddcsResult(GetOcvpSddcsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOcvpSddcsResult(
...
def get_ocvp_sddcs(compartment_id: Optional[str] = None,
                   compute_availability_domain: Optional[str] = None,
                   display_name: Optional[str] = None,
                   filters: Optional[Sequence[pulumi.InputType['GetOcvpSddcsFilterArgs']]] = None,
                   state: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOcvpSddcsResult:
    """
    ...
    test_sddcs = oci.get_ocvp_sddcs(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOcvpSddcs:GetOcvpSddcs', __args__, opts=opts, typ=GetOcvpSddcsResult).value

    return AwaitableGetOcvpSddcsResult(
