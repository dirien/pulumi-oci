...
__all__ = [
    'GetDatabaseExternalPluggableDatabasesResult',
    'AwaitableGetDatabaseExternalPluggableDatabasesResult',
    'get_database_external_pluggable_databases',
]

@pulumi.output_type
class GetDatabaseExternalPluggableDatabasesResult:
    """
    ...
    def external_pluggable_databases(self) -> Sequence['outputs.GetDatabaseExternalPluggableDatabasesExternalPluggableDatabaseResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseExternalPluggableDatabasesFilterResult']]:
...
class AwaitableGetDatabaseExternalPluggableDatabasesResult(GetDatabaseExternalPluggableDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExternalPluggableDatabasesResult(
...
def get_database_external_pluggable_databases(compartment_id: Optional[str] = None,
                                              display_name: Optional[str] = None,
                                              external_container_database_id: Optional[str] = None,
                                              filters: Optional[Sequence[pulumi.InputType['GetDatabaseExternalPluggableDatabasesFilterArgs']]] = None,
                                              state: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExternalPluggableDatabasesResult:
    """
    ...
    test_external_pluggable_databases = oci.get_database_external_pluggable_databases(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExternalPluggableDatabases:GetDatabaseExternalPluggableDatabases', __args__, opts=opts, typ=GetDatabaseExternalPluggableDatabasesResult).value

    return AwaitableGetDatabaseExternalPluggableDatabasesResult(
