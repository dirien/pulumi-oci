...
class AwaitableGetFunctionsFunctionResult(GetFunctionsFunctionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFunctionsFunctionResult(
...
def get_functions_function(function_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionsFunctionResult:
    """
    ...
    test_function = oci.get_functions_function(function_id=oci_functions_function["test_function"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getFunctionsFunction:GetFunctionsFunction', __args__, opts=opts, typ=GetFunctionsFunctionResult).value

    return AwaitableGetFunctionsFunctionResult(
