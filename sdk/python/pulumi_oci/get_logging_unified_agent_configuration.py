...
__all__ = [
    'GetLoggingUnifiedAgentConfigurationResult',
    'AwaitableGetLoggingUnifiedAgentConfigurationResult',
    'get_logging_unified_agent_configuration',
]

@pulumi.output_type
class GetLoggingUnifiedAgentConfigurationResult:
    """
    A collection of values returned by GetLoggingUnifiedAgentConfiguration.
    """
    def __init__(__self__, compartment_id=None, configuration_state=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, group_association=None, id=None, is_enabled=None, service_configuration=None, state=None, time_created=None, time_last_modified=None, unified_agent_configuration_id=None):
        ...
        if group_association and not isinstance(group_association, dict):
            raise TypeError("Expected argument 'group_association' to be a dict")
        ...
        if service_configuration and not isinstance(service_configuration, dict):
            raise TypeError("Expected argument 'service_configuration' to be a dict")
    ...
    def group_association(self) -> 'outputs.GetLoggingUnifiedAgentConfigurationGroupAssociationResult':
        """
    ...
    def service_configuration(self) -> 'outputs.GetLoggingUnifiedAgentConfigurationServiceConfigurationResult':
        """
...
class AwaitableGetLoggingUnifiedAgentConfigurationResult(GetLoggingUnifiedAgentConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingUnifiedAgentConfigurationResult(
            ...
            group_association=self.group_association,
            id=self.id,
...
def get_logging_unified_agent_configuration(unified_agent_configuration_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingUnifiedAgentConfigurationResult:
    """
    ...
    test_unified_agent_configuration = oci.get_logging_unified_agent_configuration(unified_agent_configuration_id=oci_logging_unified_agent_configuration["test_unified_agent_configuration"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingUnifiedAgentConfiguration:GetLoggingUnifiedAgentConfiguration', __args__, opts=opts, typ=GetLoggingUnifiedAgentConfigurationResult).value

    return AwaitableGetLoggingUnifiedAgentConfigurationResult(
        ...
        group_association=__ret__.group_association,
        id=__ret__.id,
        is_enabled=__ret__.is_enabled,
        service_configuration=__ret__.service_configuration,
        state=__ret__.state,
