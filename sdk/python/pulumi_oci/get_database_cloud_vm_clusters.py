...
__all__ = [
    'GetDatabaseCloudVmClustersResult',
    'AwaitableGetDatabaseCloudVmClustersResult',
    'get_database_cloud_vm_clusters',
]

@pulumi.output_type
class GetDatabaseCloudVmClustersResult:
    """
    ...
    def cloud_vm_clusters(self) -> Sequence['outputs.GetDatabaseCloudVmClustersCloudVmClusterResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseCloudVmClustersFilterResult']]:
...
class AwaitableGetDatabaseCloudVmClustersResult(GetDatabaseCloudVmClustersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseCloudVmClustersResult(
...
def get_database_cloud_vm_clusters(cloud_exadata_infrastructure_id: Optional[str] = None,
                                   compartment_id: Optional[str] = None,
                                   display_name: Optional[str] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetDatabaseCloudVmClustersFilterArgs']]] = None,
                                   state: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseCloudVmClustersResult:
    """
    ...
    test_cloud_vm_clusters = oci.get_database_cloud_vm_clusters(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseCloudVmClusters:GetDatabaseCloudVmClusters', __args__, opts=opts, typ=GetDatabaseCloudVmClustersResult).value

    return AwaitableGetDatabaseCloudVmClustersResult(
