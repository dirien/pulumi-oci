...
__all__ = [
    'GetLoggingLogSavedSearchResult',
    'AwaitableGetLoggingLogSavedSearchResult',
    'get_logging_log_saved_search',
]

@pulumi.output_type
class GetLoggingLogSavedSearchResult:
    """
...
class AwaitableGetLoggingLogSavedSearchResult(GetLoggingLogSavedSearchResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingLogSavedSearchResult(
...
def get_logging_log_saved_search(log_saved_search_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingLogSavedSearchResult:
    """
    ...
    test_log_saved_search = oci.get_logging_log_saved_search(log_saved_search_id=oci_logging_log_saved_search["test_log_saved_search"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingLogSavedSearch:GetLoggingLogSavedSearch', __args__, opts=opts, typ=GetLoggingLogSavedSearchResult).value

    return AwaitableGetLoggingLogSavedSearchResult(
