...
__all__ = [
    'GetOpsiDatabaseInsightsResult',
    'AwaitableGetOpsiDatabaseInsightsResult',
    'get_opsi_database_insights',
]

@pulumi.output_type
class GetOpsiDatabaseInsightsResult:
    """
    ...
    def database_insights_collections(self) -> Sequence['outputs.GetOpsiDatabaseInsightsDatabaseInsightsCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOpsiDatabaseInsightsFilterResult']]:
...
class AwaitableGetOpsiDatabaseInsightsResult(GetOpsiDatabaseInsightsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOpsiDatabaseInsightsResult(
...
def get_opsi_database_insights(compartment_id: Optional[str] = None,
                               ...
                               filters: Optional[Sequence[pulumi.InputType['GetOpsiDatabaseInsightsFilterArgs']]] = None,
                               id: Optional[str] = None,
                               states: Optional[Sequence[str]] = None,
                               statuses: Optional[Sequence[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOpsiDatabaseInsightsResult:
    """
    ...
    test_database_insights = oci.get_opsi_database_insights(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOpsiDatabaseInsights:GetOpsiDatabaseInsights', __args__, opts=opts, typ=GetOpsiDatabaseInsightsResult).value

    return AwaitableGetOpsiDatabaseInsightsResult(
