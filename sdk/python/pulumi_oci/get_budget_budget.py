...
__all__ = [
    'GetBudgetBudgetResult',
    'AwaitableGetBudgetBudgetResult',
    'get_budget_budget',
]

@pulumi.output_type
class GetBudgetBudgetResult:
    """
...
class AwaitableGetBudgetBudgetResult(GetBudgetBudgetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBudgetBudgetResult(
...
def get_budget_budget(budget_id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBudgetBudgetResult:
    """
    ...
    test_budget = oci.get_budget_budget(budget_id=oci_budget_budget["test_budget"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBudgetBudget:GetBudgetBudget', __args__, opts=opts, typ=GetBudgetBudgetResult).value

    return AwaitableGetBudgetBudgetResult(
