...
__all__ = [
    'GetHealthChecksPingMonitorsResult',
    'AwaitableGetHealthChecksPingMonitorsResult',
    'get_health_checks_ping_monitors',
]

@pulumi.output_type
class GetHealthChecksPingMonitorsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetHealthChecksPingMonitorsFilterResult']]:
    ...
    def ping_monitors(self) -> Sequence['outputs.GetHealthChecksPingMonitorsPingMonitorResult']:
        """
...
class AwaitableGetHealthChecksPingMonitorsResult(GetHealthChecksPingMonitorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHealthChecksPingMonitorsResult(
...
def get_health_checks_ping_monitors(compartment_id: Optional[str] = None,
                                    display_name: Optional[str] = None,
                                    filters: Optional[Sequence[pulumi.InputType['GetHealthChecksPingMonitorsFilterArgs']]] = None,
                                    home_region: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthChecksPingMonitorsResult:
    """
    ...
    test_ping_monitors = oci.get_health_checks_ping_monitors(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getHealthChecksPingMonitors:GetHealthChecksPingMonitors', __args__, opts=opts, typ=GetHealthChecksPingMonitorsResult).value

    return AwaitableGetHealthChecksPingMonitorsResult(
