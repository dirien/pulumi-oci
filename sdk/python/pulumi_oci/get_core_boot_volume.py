...
__all__ = [
    'GetCoreBootVolumeResult',
    'AwaitableGetCoreBootVolumeResult',
    'get_core_boot_volume',
]

@pulumi.output_type
class GetCoreBootVolumeResult:
    """
    ...
    def boot_volume_replicas(self) -> Sequence['outputs.GetCoreBootVolumeBootVolumeReplicaResult']:
        """
    ...
    def source_details(self) -> 'outputs.GetCoreBootVolumeSourceDetailsResult':
...
class AwaitableGetCoreBootVolumeResult(GetCoreBootVolumeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBootVolumeResult(
...
def get_core_boot_volume(boot_volume_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBootVolumeResult:
    """
    ...
    test_boot_volume = oci.get_core_boot_volume(boot_volume_id=oci_core_boot_volume["test_boot_volume"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBootVolume:GetCoreBootVolume', __args__, opts=opts, typ=GetCoreBootVolumeResult).value

    return AwaitableGetCoreBootVolumeResult(
