...
__all__ = [
    'GetBlockchainOsnsResult',
    'AwaitableGetBlockchainOsnsResult',
    'get_blockchain_osns',
]

@pulumi.output_type
class GetBlockchainOsnsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBlockchainOsnsFilterResult']]:
    ...
    def osn_collections(self) -> Sequence['outputs.GetBlockchainOsnsOsnCollectionResult']:
        """
...
class AwaitableGetBlockchainOsnsResult(GetBlockchainOsnsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBlockchainOsnsResult(
...
def get_blockchain_osns(blockchain_platform_id: Optional[str] = None,
                        display_name: Optional[str] = None,
                        filters: Optional[Sequence[pulumi.InputType['GetBlockchainOsnsFilterArgs']]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBlockchainOsnsResult:
    """
    ...
    test_osns = oci.get_blockchain_osns(blockchain_platform_id=oci_blockchain_blockchain_platform["test_blockchain_platform"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBlockchainOsns:GetBlockchainOsns', __args__, opts=opts, typ=GetBlockchainOsnsResult).value

    return AwaitableGetBlockchainOsnsResult(
