...
__all__ = [
    'GetDatacatalogCatalogPrivateEndpointResult',
    'AwaitableGetDatacatalogCatalogPrivateEndpointResult',
    'get_datacatalog_catalog_private_endpoint',
]

@pulumi.output_type
class GetDatacatalogCatalogPrivateEndpointResult:
    """
...
class AwaitableGetDatacatalogCatalogPrivateEndpointResult(GetDatacatalogCatalogPrivateEndpointResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogCatalogPrivateEndpointResult(
...
def get_datacatalog_catalog_private_endpoint(catalog_private_endpoint_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogCatalogPrivateEndpointResult:
    """
    ...
    test_catalog_private_endpoint = oci.get_datacatalog_catalog_private_endpoint(catalog_private_endpoint_id=oci_datacatalog_catalog_private_endpoint["test_catalog_private_endpoint"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogCatalogPrivateEndpoint:GetDatacatalogCatalogPrivateEndpoint', __args__, opts=opts, typ=GetDatacatalogCatalogPrivateEndpointResult).value

    return AwaitableGetDatacatalogCatalogPrivateEndpointResult(
