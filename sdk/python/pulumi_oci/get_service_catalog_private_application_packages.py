...
__all__ = [
    'GetServiceCatalogPrivateApplicationPackagesResult',
    'AwaitableGetServiceCatalogPrivateApplicationPackagesResult',
    'get_service_catalog_private_application_packages',
]

@pulumi.output_type
class GetServiceCatalogPrivateApplicationPackagesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetServiceCatalogPrivateApplicationPackagesFilterResult']]:
    ...
    def private_application_package_collections(self) -> Sequence['outputs.GetServiceCatalogPrivateApplicationPackagesPrivateApplicationPackageCollectionResult']:
        """
...
class AwaitableGetServiceCatalogPrivateApplicationPackagesResult(GetServiceCatalogPrivateApplicationPackagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetServiceCatalogPrivateApplicationPackagesResult(
...
def get_service_catalog_private_application_packages(display_name: Optional[str] = None,
                                                     filters: Optional[Sequence[pulumi.InputType['GetServiceCatalogPrivateApplicationPackagesFilterArgs']]] = None,
                                                     ...
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceCatalogPrivateApplicationPackagesResult:
    """
    ...
    test_private_application_packages = oci.get_service_catalog_private_application_packages(private_application_id=oci_service_catalog_private_application["test_private_application"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getServiceCatalogPrivateApplicationPackages:GetServiceCatalogPrivateApplicationPackages', __args__, opts=opts, typ=GetServiceCatalogPrivateApplicationPackagesResult).value

    return AwaitableGetServiceCatalogPrivateApplicationPackagesResult(
