...
__all__ = [
    'GetCoreFastConnectProviderServiceKeyResult',
    'AwaitableGetCoreFastConnectProviderServiceKeyResult',
    'get_core_fast_connect_provider_service_key',
]

@pulumi.output_type
class GetCoreFastConnectProviderServiceKeyResult:
    """
...
class AwaitableGetCoreFastConnectProviderServiceKeyResult(GetCoreFastConnectProviderServiceKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreFastConnectProviderServiceKeyResult(
...
def get_core_fast_connect_provider_service_key(provider_service_id: Optional[str] = None,
                                               provider_service_key_name: Optional[str] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreFastConnectProviderServiceKeyResult:
    """
    ...
    test_fast_connect_provider_service_key = oci.get_core_fast_connect_provider_service_key(provider_service_id=data["oci_core_fast_connect_provider_services"]["test_fast_connect_provider_services"]["fast_connect_provider_services"][0]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreFastConnectProviderServiceKey:GetCoreFastConnectProviderServiceKey', __args__, opts=opts, typ=GetCoreFastConnectProviderServiceKeyResult).value

    return AwaitableGetCoreFastConnectProviderServiceKeyResult(
