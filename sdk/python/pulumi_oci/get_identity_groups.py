...
class GetIdentityGroupsResult:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityGroupsFilterResult']]:
...
def get_identity_groups(compartment_id: Optional[str] = None,
                        filters: Optional[Sequence[pulumi.InputType['GetIdentityGroupsFilterArgs']]] = None,
    ...
    test_groups = oci.get_identity_groups(compartment_id=var["tenancy_ocid"],
        name=var["group_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityGroups:GetIdentityGroups', __args__, opts=opts, typ=GetIdentityGroupsResult).value
