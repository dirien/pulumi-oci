...
__all__ = [
    'GetCloudGuardResponderRecipesResult',
    'AwaitableGetCloudGuardResponderRecipesResult',
    'get_cloud_guard_responder_recipes',
]

@pulumi.output_type
class GetCloudGuardResponderRecipesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudGuardResponderRecipesFilterResult']]:
    ...
    def responder_recipe_collections(self) -> Sequence['outputs.GetCloudGuardResponderRecipesResponderRecipeCollectionResult']:
        """
...
class AwaitableGetCloudGuardResponderRecipesResult(GetCloudGuardResponderRecipesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardResponderRecipesResult(
...
def get_cloud_guard_responder_recipes(access_level: Optional[str] = None,
                                      compartment_id: Optional[str] = None,
                                      compartment_id_in_subtree: Optional[bool] = None,
                                      display_name: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetCloudGuardResponderRecipesFilterArgs']]] = None,
                                      resource_metadata_only: Optional[bool] = None,
                                      state: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardResponderRecipesResult:
    """
    ...
    test_responder_recipes = oci.get_cloud_guard_responder_recipes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardResponderRecipes:GetCloudGuardResponderRecipes', __args__, opts=opts, typ=GetCloudGuardResponderRecipesResult).value

    return AwaitableGetCloudGuardResponderRecipesResult(
