...
__all__ = ['WaasHttpRedirectArgs', 'WaasHttpRedirect']

@pulumi.input_type
class WaasHttpRedirectArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 domain: pulumi.Input[str],
                 target: pulumi.Input['WaasHttpRedirectTargetArgs'],
        ...
        :param pulumi.Input['WaasHttpRedirectTargetArgs'] target: (Updatable) The redirect target object including all the redirect data.
    ...
    @property
    @pulumi.getter
    def target(self) -> pulumi.Input['WaasHttpRedirectTargetArgs']:
        """
    ...
    @target.setter
    def target(self, value: pulumi.Input['WaasHttpRedirectTargetArgs']):
...
class _WaasHttpRedirectState:
    def __init__(__self__, *,
                 ...
                 target: Optional[pulumi.Input['WaasHttpRedirectTargetArgs']] = None,
    ...
    @property
    @pulumi.getter
    def target(self) -> Optional[pulumi.Input['WaasHttpRedirectTargetArgs']]:
        """
        (Updatable) The redirect target object including all the redirect data.
        """
        return pulumi.get(self, "target")
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input['WaasHttpRedirectTargetArgs']]):
        pulumi.set(self, "target", value)
...
class WaasHttpRedirect(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 response_code: Optional[pulumi.Input[int]] = None,
                 target: Optional[pulumi.Input[pulumi.InputType['WaasHttpRedirectTargetArgs']]] = None,
                 __props__=None):
        """
        ...
        test_http_redirect = oci.WaasHttpRedirect("testHttpRedirect",
            compartment_id=var["compartment_id"],
            domain=var["http_redirect_domain"],
            target=oci.WaasHttpRedirectTargetArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[int] response_code: (Updatable) The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        :param pulumi.Input[pulumi.InputType['WaasHttpRedirectTargetArgs']] target: (Updatable) The redirect target object including all the redirect data.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: WaasHttpRedirectArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Http Redirect resource in Oracle Cloud Infrastructure Web Application Acceleration and Security service.
        ...
        :param str resource_name: The name of the resource.
        :param WaasHttpRedirectArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WaasHttpRedirectArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WaasHttpRedirectArgs.__new__(WaasHttpRedirectArgs)
        ...
        super(WaasHttpRedirect, __self__).__init__(
            'oci:index/waasHttpRedirect:WaasHttpRedirect',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            target: Optional[pulumi.Input[pulumi.InputType['WaasHttpRedirectTargetArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'WaasHttpRedirect':
        """
        ...
        __props__ = _WaasHttpRedirectState.__new__(_WaasHttpRedirectState)
        ...
        return WaasHttpRedirect(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def target(self) -> pulumi.Output['outputs.WaasHttpRedirectTarget']:
        """
        (Updatable) The redirect target object including all the redirect data.
        """
        return pulumi.get(self, "target")
