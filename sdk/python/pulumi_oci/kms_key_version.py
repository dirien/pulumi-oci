...
__all__ = ['KmsKeyVersionArgs', 'KmsKeyVersion']

@pulumi.input_type
class KmsKeyVersionArgs:
...
class _KmsKeyVersionState:
    def __init__(__self__, *,
                 ...
                 replica_details: Optional[pulumi.Input['KmsKeyVersionReplicaDetailsArgs']] = None,
        ...
        :param pulumi.Input['KmsKeyVersionReplicaDetailsArgs'] replica_details: KeyVersion replica details
    ...
    def replica_details(self) -> Optional[pulumi.Input['KmsKeyVersionReplicaDetailsArgs']]:
        """
    ...
    def replica_details(self, value: Optional[pulumi.Input['KmsKeyVersionReplicaDetailsArgs']]):
...
class KmsKeyVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_key_version = oci.KmsKeyVersion("testKeyVersion",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param KmsKeyVersionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KmsKeyVersionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KmsKeyVersionArgs.__new__(KmsKeyVersionArgs)
        ...
        super(KmsKeyVersion, __self__).__init__(
            'oci:index/kmsKeyVersion:KmsKeyVersion',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            management_endpoint: Optional[pulumi.Input[str]] = None,
            public_key: Optional[pulumi.Input[str]] = None,
            replica_details: Optional[pulumi.Input[pulumi.InputType['KmsKeyVersionReplicaDetailsArgs']]] = None,
            restored_from_key_id: Optional[pulumi.Input[str]] = None,
            restored_from_key_version_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_of_deletion: Optional[pulumi.Input[str]] = None,
            vault_id: Optional[pulumi.Input[str]] = None) -> 'KmsKeyVersion':
        """
        ...
        :param pulumi.Input[str] management_endpoint: The service endpoint to perform management operations against. Management operations include 'Create,' 'Update,' 'List,' 'Get,' and 'Delete' operations. See Vault Management endpoint.
        :param pulumi.Input[str] public_key: The public key in PEM format. (This value pertains only to RSA and ECDSA keys.)
        :param pulumi.Input[pulumi.InputType['KmsKeyVersionReplicaDetailsArgs']] replica_details: KeyVersion replica details
        :param pulumi.Input[str] restored_from_key_version_id: The OCID of the key version from which this key version was restored.
        :param pulumi.Input[str] state: The key version's current lifecycle state.  Example: `ENABLED`
        :param pulumi.Input[str] time_created: The date and time this key version was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: "2018-04-03T21:10:29.600Z"
        :param pulumi.Input[str] time_of_deletion: (Updatable) An optional property for the deletion time of the key version, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        ...
        __props__ = _KmsKeyVersionState.__new__(_KmsKeyVersionState)
        ...
        return KmsKeyVersion(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="replicaDetails")
    def replica_details(self) -> pulumi.Output['outputs.KmsKeyVersionReplicaDetails']:
        """
        KeyVersion replica details
        """
        return pulumi.get(self, "replica_details")
