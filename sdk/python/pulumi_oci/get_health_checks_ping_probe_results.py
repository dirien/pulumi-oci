...
__all__ = [
    'GetHealthChecksPingProbeResultsResult',
    'AwaitableGetHealthChecksPingProbeResultsResult',
    'get_health_checks_ping_probe_results',
]

@pulumi.output_type
class GetHealthChecksPingProbeResultsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetHealthChecksPingProbeResultsFilterResult']]:
    ...
    def ping_probe_results(self) -> Sequence['outputs.GetHealthChecksPingProbeResultsPingProbeResultResult']:
        """
...
class AwaitableGetHealthChecksPingProbeResultsResult(GetHealthChecksPingProbeResultsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHealthChecksPingProbeResultsResult(
...
def get_health_checks_ping_probe_results(filters: Optional[Sequence[pulumi.InputType['GetHealthChecksPingProbeResultsFilterArgs']]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthChecksPingProbeResultsResult:
    """
    ...
    test_ping_probe_results = oci.get_health_checks_ping_probe_results(probe_configuration_id=oci_health_checks_probe_configuration["test_probe_configuration"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getHealthChecksPingProbeResults:GetHealthChecksPingProbeResults', __args__, opts=opts, typ=GetHealthChecksPingProbeResultsResult).value

    return AwaitableGetHealthChecksPingProbeResultsResult(
