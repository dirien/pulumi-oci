...
__all__ = [
    'GetDevopsDeployEnvironmentResult',
    'AwaitableGetDevopsDeployEnvironmentResult',
    'get_devops_deploy_environment',
]

@pulumi.output_type
class GetDevopsDeployEnvironmentResult:
    """
    A collection of values returned by GetDevopsDeployEnvironment.
    """
    def __init__(__self__, cluster_id=None, compartment_id=None, compute_instance_group_selectors=None, defined_tags=None, deploy_environment_id=None, deploy_environment_type=None, description=None, display_name=None, freeform_tags=None, function_id=None, id=None, lifecycle_details=None, project_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if compute_instance_group_selectors and not isinstance(compute_instance_group_selectors, dict):
            raise TypeError("Expected argument 'compute_instance_group_selectors' to be a dict")
    ...
    def compute_instance_group_selectors(self) -> 'outputs.GetDevopsDeployEnvironmentComputeInstanceGroupSelectorsResult':
        """
...
class AwaitableGetDevopsDeployEnvironmentResult(GetDevopsDeployEnvironmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployEnvironmentResult(
...
def get_devops_deploy_environment(deploy_environment_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployEnvironmentResult:
    """
    ...
    test_deploy_environment = oci.get_devops_deploy_environment(deploy_environment_id=oci_devops_deploy_environment["test_deploy_environment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployEnvironment:GetDevopsDeployEnvironment', __args__, opts=opts, typ=GetDevopsDeployEnvironmentResult).value

    return AwaitableGetDevopsDeployEnvironmentResult(
