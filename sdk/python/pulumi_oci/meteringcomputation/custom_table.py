...
class CustomTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_custom_table = oci.meteringcomputation.CustomTable("testCustomTable",
            compartment_id=var["compartment_id"],
            saved_custom_table=oci.meteringcomputation.CustomTableSavedCustomTableArgs(
                ...
                group_by_tags=[oci.meteringcomputation.CustomTableSavedCustomTableGroupByTagArgs(
