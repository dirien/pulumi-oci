...
class GetCustomTablesCustomTableCollectionItemResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 id: str,
                 saved_custom_table: 'outputs.GetCustomTablesCustomTableCollectionItemSavedCustomTableResult',
                 saved_report_id: str):
        """
        :param str compartment_id: The compartment ID in which to list resources.
        :param str id: The custom table OCID.
        :param 'GetCustomTablesCustomTableCollectionItemSavedCustomTableArgs' saved_custom_table: The custom table for Cost Analysis UI rendering.
    ...
    def saved_custom_table(self) -> 'outputs.GetCustomTablesCustomTableCollectionItemSavedCustomTableResult':
        """
...
class GetQueriesQueryCollectionItemResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 id: str,
                 query_definition: 'outputs.GetQueriesQueryCollectionItemQueryDefinitionResult'):
        """
        :param str compartment_id: The compartment ID in which to list resources.
        :param str id: The query OCID.
        :param 'GetQueriesQueryCollectionItemQueryDefinitionArgs' query_definition: The common fields for queries.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "id", id)
    ...
    def query_definition(self) -> 'outputs.GetQueriesQueryCollectionItemQueryDefinitionResult':
        """
...
class GetQueriesQueryCollectionItemQueryDefinitionResult(dict):
    def __init__(__self__, *,
                 cost_analysis_ui: 'outputs.GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUiResult',
                 display_name: str,
                 report_query: 'outputs.GetQueriesQueryCollectionItemQueryDefinitionReportQueryResult',
                 version: float):
        """
        :param 'GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUiArgs' cost_analysis_ui: The common fields for Cost Analysis UI rendering.
        :param str display_name: The query display name. Avoid entering confidential information.
        :param 'GetQueriesQueryCollectionItemQueryDefinitionReportQueryArgs' report_query: The request of the generated Cost Analysis report.
    ...
    @property
    @pulumi.getter(name="costAnalysisUi")
    def cost_analysis_ui(self) -> 'outputs.GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUiResult':
        """
    ...
    @property
    @pulumi.getter(name="reportQuery")
    def report_query(self) -> 'outputs.GetQueriesQueryCollectionItemQueryDefinitionReportQueryResult':
        """
...
class GetQueriesQueryCollectionItemQueryDefinitionReportQueryResult(dict):
    def __init__(__self__, *,
                 ...
                 date_range_name: str,
                 filter: str,
                 forecast: 'outputs.GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecastResult',
                 granularity: str,
        ...
        :param 'GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecastArgs' forecast: Forecast configuration of usage/cost.
    ...
    @property
    @pulumi.getter
    def forecast(self) -> 'outputs.GetQueriesQueryCollectionItemQueryDefinitionReportQueryForecastResult':
        """
...
class GetQueryQueryDefinitionResult(dict):
    def __init__(__self__, *,
                 cost_analysis_ui: 'outputs.GetQueryQueryDefinitionCostAnalysisUiResult',
                 display_name: str,
                 report_query: 'outputs.GetQueryQueryDefinitionReportQueryResult',
                 version: float):
        """
        :param 'GetQueryQueryDefinitionCostAnalysisUiArgs' cost_analysis_ui: The common fields for Cost Analysis UI rendering.
        :param str display_name: The query display name. Avoid entering confidential information.
        :param 'GetQueryQueryDefinitionReportQueryArgs' report_query: The request of the generated Cost Analysis report.
        :param float version: The saved query version.
        """
        pulumi.set(__self__, "cost_analysis_ui", cost_analysis_ui)
        pulumi.set(__self__, "display_name", display_name)
    ...
    @property
    @pulumi.getter(name="costAnalysisUi")
    def cost_analysis_ui(self) -> 'outputs.GetQueryQueryDefinitionCostAnalysisUiResult':
        """
        The common fields for Cost Analysis UI rendering.
        """
        return pulumi.get(self, "cost_analysis_ui")
    ...
    @property
    @pulumi.getter(name="reportQuery")
    def report_query(self) -> 'outputs.GetQueryQueryDefinitionReportQueryResult':
        """
        The request of the generated Cost Analysis report.
        """
        return pulumi.get(self, "report_query")
...
class GetQueryQueryDefinitionReportQueryResult(dict):
    def __init__(__self__, *,
                 ...
                 date_range_name: str,
                 filter: str,
                 forecast: 'outputs.GetQueryQueryDefinitionReportQueryForecastResult',
                 granularity: str,
                 group_bies: Sequence[str],
        ...
        :param float compartment_depth: The compartment depth level.
        :param str date_range_name: The UI date range, for example, LAST_THREE_MONTHS. Conflicts with timeUsageStarted and timeUsageEnded.
        :param 'GetQueryQueryDefinitionReportQueryForecastArgs' forecast: Forecast configuration of usage/cost.
        :param str granularity: The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
        :param Sequence[str] group_bies: Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
    ...
    @property
    @pulumi.getter
    def forecast(self) -> 'outputs.GetQueryQueryDefinitionReportQueryForecastResult':
        """
        Forecast configuration of usage/cost.
        """
        return pulumi.get(self, "forecast")
