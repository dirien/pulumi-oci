...
class GetKmsKeyResult:
    ...
    def __init__(__self__, compartment_id=None, current_key_version=None, defined_tags=None, desired_state=None, display_name=None, freeform_tags=None, id=None, is_primary=None, key_id=None, key_shape=None, management_endpoint=None, protection_mode=None, replica_details=None, restore_from_file=None, restore_from_object_store=None, restore_trigger=None, restored_from_key_id=None, state=None, time_created=None, time_of_deletion=None, vault_id=None):
        ...
        if key_shape and not isinstance(key_shape, dict):
            raise TypeError("Expected argument 'key_shape' to be a dict")
    ...
    def key_shape(self) -> 'outputs.GetKmsKeyKeyShapeResult':
        """
    ...
    def replica_details(self) -> 'outputs.GetKmsKeyReplicaDetailsResult':
        """
        Key replica details
        """
    ...
    def restore_from_file(self) -> 'outputs.GetKmsKeyRestoreFromFileResult':
        """
    ...
    def restore_from_object_store(self) -> 'outputs.GetKmsKeyRestoreFromObjectStoreResult':
        """
        Details where key was backed up
        """
...
def get_kms_key(key_id: Optional[str] = None,
    ...
    test_key = oci.get_kms_key(key_id=oci_kms_key["test_key"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsKey:GetKmsKey', __args__, opts=opts, typ=GetKmsKeyResult).value
