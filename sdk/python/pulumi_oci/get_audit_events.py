...
class GetAuditEventsResult:
    ...
    def audit_events(self) -> Sequence['outputs.GetAuditEventsAuditEventResult']:
        """
...
def get_audit_events(compartment_id: Optional[str] = None,
    ...
    test_audit_events = oci.get_audit_events(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getAuditEvents:GetAuditEvents', __args__, opts=opts, typ=GetAuditEventsResult).value
