...
__all__ = [
    'GetDevopsDeployPipelineResult',
    'AwaitableGetDevopsDeployPipelineResult',
    'get_devops_deploy_pipeline',
]

@pulumi.output_type
class GetDevopsDeployPipelineResult:
    """
    ...
    def __init__(__self__, compartment_id=None, defined_tags=None, deploy_pipeline_artifacts=None, deploy_pipeline_environments=None, deploy_pipeline_id=None, deploy_pipeline_parameters=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, project_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if deploy_pipeline_parameters and not isinstance(deploy_pipeline_parameters, dict):
            raise TypeError("Expected argument 'deploy_pipeline_parameters' to be a dict")
    ...
    def deploy_pipeline_artifacts(self) -> 'outputs.GetDevopsDeployPipelineDeployPipelineArtifactsResult':
        """
    ...
    def deploy_pipeline_environments(self) -> 'outputs.GetDevopsDeployPipelineDeployPipelineEnvironmentsResult':
        """
    ...
    def deploy_pipeline_parameters(self) -> 'outputs.GetDevopsDeployPipelineDeployPipelineParametersResult':
        """
...
class AwaitableGetDevopsDeployPipelineResult(GetDevopsDeployPipelineResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployPipelineResult(
...
def get_devops_deploy_pipeline(deploy_pipeline_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployPipelineResult:
    """
    ...
    test_deploy_pipeline = oci.get_devops_deploy_pipeline(deploy_pipeline_id=oci_devops_deploy_pipeline["test_deploy_pipeline"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployPipeline:GetDevopsDeployPipeline', __args__, opts=opts, typ=GetDevopsDeployPipelineResult).value

    return AwaitableGetDevopsDeployPipelineResult(
