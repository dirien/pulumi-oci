...
class KmsSign(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_sign = oci.KmsSign("testSign",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param KmsSignArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KmsSignArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KmsSignArgs.__new__(KmsSignArgs)
        ...
        super(KmsSign, __self__).__init__(
            'oci:index/kmsSign:KmsSign',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            message_type: Optional[pulumi.Input[str]] = None,
            signature: Optional[pulumi.Input[str]] = None,
            signing_algorithm: Optional[pulumi.Input[str]] = None) -> 'KmsSign':
        """
        ...
        __props__ = _KmsSignState.__new__(_KmsSignState)
        ...
        __props__.__dict__["signing_algorithm"] = signing_algorithm
        return KmsSign(resource_name, opts=opts, __props__=__props__)
