...
__all__ = [
    'GetIdentityTagDefaultResult',
    'AwaitableGetIdentityTagDefaultResult',
    'get_identity_tag_default',
]

@pulumi.output_type
class GetIdentityTagDefaultResult:
    """
...
class AwaitableGetIdentityTagDefaultResult(GetIdentityTagDefaultResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityTagDefaultResult(
...
def get_identity_tag_default(tag_default_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityTagDefaultResult:
    """
    ...
    test_tag_default = oci.get_identity_tag_default(tag_default_id=oci_identity_tag_default["test_tag_default"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityTagDefault:GetIdentityTagDefault', __args__, opts=opts, typ=GetIdentityTagDefaultResult).value

    return AwaitableGetIdentityTagDefaultResult(
