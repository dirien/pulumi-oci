...
__all__ = [
    'GetAutoscalingAutoScalingConfigurationResult',
    'AwaitableGetAutoscalingAutoScalingConfigurationResult',
    'get_autoscaling_auto_scaling_configuration',
]

@pulumi.output_type
class GetAutoscalingAutoScalingConfigurationResult:
    """
    ...
    def __init__(__self__, auto_scaling_configuration_id=None, auto_scaling_resources=None, compartment_id=None, cool_down_in_seconds=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_enabled=None, max_resource_count=None, min_resource_count=None, policies=None, time_created=None):
        ...
        if auto_scaling_resources and not isinstance(auto_scaling_resources, dict):
            raise TypeError("Expected argument 'auto_scaling_resources' to be a dict")
    ...
    def auto_scaling_resources(self) -> 'outputs.GetAutoscalingAutoScalingConfigurationAutoScalingResourcesResult':
        """
    ...
    @property
    @pulumi.getter
    def policies(self) -> Sequence['outputs.GetAutoscalingAutoScalingConfigurationPolicyResult']:
        """
...
class AwaitableGetAutoscalingAutoScalingConfigurationResult(GetAutoscalingAutoScalingConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAutoscalingAutoScalingConfigurationResult(
...
def get_autoscaling_auto_scaling_configuration(auto_scaling_configuration_id: Optional[str] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAutoscalingAutoScalingConfigurationResult:
    """
    ...
    test_auto_scaling_configuration = oci.get_autoscaling_auto_scaling_configuration(auto_scaling_configuration_id=oci_autoscaling_auto_scaling_configuration["test_auto_scaling_configuration"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getAutoscalingAutoScalingConfiguration:GetAutoscalingAutoScalingConfiguration', __args__, opts=opts, typ=GetAutoscalingAutoScalingConfigurationResult).value

    return AwaitableGetAutoscalingAutoScalingConfigurationResult(
