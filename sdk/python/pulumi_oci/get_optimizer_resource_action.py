...
class GetOptimizerResourceActionResult:
    ...
    @property
    @pulumi.getter
    def action(self) -> 'outputs.GetOptimizerResourceActionActionResult':
        """
...
class AwaitableGetOptimizerResourceActionResult(GetOptimizerResourceActionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerResourceActionResult(
            action=self.action,
...
def get_optimizer_resource_action(resource_action_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerResourceActionResult:
    """
    ...
    test_resource_action = oci.get_optimizer_resource_action(resource_action_id=oci_optimizer_resource_action["test_resource_action"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerResourceAction:GetOptimizerResourceAction', __args__, opts=opts, typ=GetOptimizerResourceActionResult).value

    return AwaitableGetOptimizerResourceActionResult(
