...
__all__ = [
    'GetDedicatedVmHostsInstancesResult',
    'AwaitableGetDedicatedVmHostsInstancesResult',
    'get_dedicated_vm_hosts_instances',
]

@pulumi.output_type
class GetDedicatedVmHostsInstancesResult:
    """
    ...
    def dedicated_vm_host_instances(self) -> Sequence['outputs.GetDedicatedVmHostsInstancesDedicatedVmHostInstanceResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDedicatedVmHostsInstancesFilterResult']]:
...
class AwaitableGetDedicatedVmHostsInstancesResult(GetDedicatedVmHostsInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDedicatedVmHostsInstancesResult(
...
def get_dedicated_vm_hosts_instances(availability_domain: Optional[str] = None,
                                     compartment_id: Optional[str] = None,
                                     dedicated_vm_host_id: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetDedicatedVmHostsInstancesFilterArgs']]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDedicatedVmHostsInstancesResult:
    """
    ...
    test_dedicated_vm_hosts_instances = oci.core.get_dedicated_vm_hosts_instances(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:core/getDedicatedVmHostsInstances:getDedicatedVmHostsInstances', __args__, opts=opts, typ=GetDedicatedVmHostsInstancesResult).value

    return AwaitableGetDedicatedVmHostsInstancesResult(
