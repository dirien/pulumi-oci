...
__all__ = [
    ...
    'GetCrossConnectPortSpeedShapesFilterArgs',
    ...
    'GetDedicatedVmHostsInstancesFilterArgs',
...
@pulumi.input_type
class DrgDefaultDrgRouteTablesArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class GetCrossConnectPortSpeedShapesFilterArgs:
    def __init__(__self__, *,
                 name: str,
                 values: Sequence[str],
                 regex: Optional[bool] = None):
...
@pulumi.input_type
class GetDedicatedVmHostsInstancesFilterArgs:
    def __init__(__self__, *,
                 name: str,
                 values: Sequence[str],
                 regex: Optional[bool] = None):
