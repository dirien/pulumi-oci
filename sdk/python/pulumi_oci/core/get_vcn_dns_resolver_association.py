...
__all__ = [
    'GetVcnDnsResolverAssociationResult',
    'AwaitableGetVcnDnsResolverAssociationResult',
    'get_vcn_dns_resolver_association',
]

@pulumi.output_type
class GetVcnDnsResolverAssociationResult:
    """
...
class AwaitableGetVcnDnsResolverAssociationResult(GetVcnDnsResolverAssociationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVcnDnsResolverAssociationResult(
...
def get_vcn_dns_resolver_association(vcn_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVcnDnsResolverAssociationResult:
    """
    ...
    test_vcn_dns_resolver_association = oci.core.get_vcn_dns_resolver_association(vcn_id=oci_core_vcn["test_vcn"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:core/getVcnDnsResolverAssociation:getVcnDnsResolverAssociation', __args__, opts=opts, typ=GetVcnDnsResolverAssociationResult).value

    return AwaitableGetVcnDnsResolverAssociationResult(
