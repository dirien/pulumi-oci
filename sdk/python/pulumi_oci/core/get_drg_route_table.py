...
__all__ = [
    'GetDrgRouteTableResult',
    'AwaitableGetDrgRouteTableResult',
    'get_drg_route_table',
]

@pulumi.output_type
class GetDrgRouteTableResult:
    """
...
class AwaitableGetDrgRouteTableResult(GetDrgRouteTableResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDrgRouteTableResult(
...
def get_drg_route_table(drg_route_table_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDrgRouteTableResult:
    """
    ...
    test_drg_route_table = oci.core.get_drg_route_table(drg_route_table_id=oci_core_drg_route_table["test_drg_route_table"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:core/getDrgRouteTable:getDrgRouteTable', __args__, opts=opts, typ=GetDrgRouteTableResult).value

    return AwaitableGetDrgRouteTableResult(
