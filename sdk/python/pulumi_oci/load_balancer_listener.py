...
class LoadBalancerListenerArgs:
    def __init__(__self__, *,
                 ...
                 connection_configuration: Optional[pulumi.Input['LoadBalancerListenerConnectionConfigurationArgs']] = None,
                 ...
                 ssl_configuration: Optional[pulumi.Input['LoadBalancerListenerSslConfigurationArgs']] = None):
        """
        ...
        :param pulumi.Input['LoadBalancerListenerConnectionConfigurationArgs'] connection_configuration: (Updatable) Configuration details for the connection between the client and backend servers.
        ...
        :param pulumi.Input['LoadBalancerListenerSslConfigurationArgs'] ssl_configuration: (Updatable) The load balancer's SSL handling configuration details.
        """
    ...
    def connection_configuration(self) -> Optional[pulumi.Input['LoadBalancerListenerConnectionConfigurationArgs']]:
        """
    ...
    def connection_configuration(self, value: Optional[pulumi.Input['LoadBalancerListenerConnectionConfigurationArgs']]):
    ...
    def ssl_configuration(self) -> Optional[pulumi.Input['LoadBalancerListenerSslConfigurationArgs']]:
        """
    ...
    def ssl_configuration(self, value: Optional[pulumi.Input['LoadBalancerListenerSslConfigurationArgs']]):
...
class LoadBalancerListener(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connection_configuration: Optional[pulumi.Input[pulumi.InputType['LoadBalancerListenerConnectionConfigurationArgs']]] = None,
                 default_backend_set_name: Optional[pulumi.Input[str]] = None,
                 hostname_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 load_balancer_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 ...
                 routing_policy_name: Optional[pulumi.Input[str]] = None,
                 rule_set_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ssl_configuration: Optional[pulumi.Input[pulumi.InputType['LoadBalancerListenerSslConfigurationArgs']]] = None,
                 __props__=None):
        """
        ...
        test_listener = oci.LoadBalancerListener("testListener",
            default_backend_set_name=oci_load_balancer_backend_set["test_backend_set"]["name"],
            load_balancer_id=oci_load_balancer_load_balancer["test_load_balancer"]["id"],
            port=var["listener_port"],
            protocol=var["listener_protocol"],
            connection_configuration=oci.LoadBalancerListenerConnectionConfigurationArgs(
            ...
            ssl_configuration=oci.LoadBalancerListenerSslConfigurationArgs(
        ...
        :param pulumi.Input[pulumi.InputType['LoadBalancerListenerConnectionConfigurationArgs']] connection_configuration: (Updatable) Configuration details for the connection between the client and backend servers.
        :param pulumi.Input[str] default_backend_set_name: (Updatable) The name of the associated backend set.  Example: `example_backend_set`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] hostname_names: (Updatable) An array of hostname resource names.
        :param pulumi.Input[str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer on which to add a listener.
        :param pulumi.Input[str] name: A friendly name for the listener. It must be unique and it cannot be changed. Avoid entering confidential information.  Example: `example_listener`
        ...
        :param pulumi.Input[str] routing_policy_name: (Updatable) The name of the routing policy applied to this listener's traffic.  Example: `example_routing_policy`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] rule_set_names: (Updatable) The names of the [rule sets](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/RuleSet/) to apply to the listener.  Example: ["example_rule_set"]
        :param pulumi.Input[pulumi.InputType['LoadBalancerListenerSslConfigurationArgs']] ssl_configuration: (Updatable) The load balancer's SSL handling configuration details.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(LoadBalancerListener, __self__).__init__(
            'oci:index/loadBalancerListener:LoadBalancerListener',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            rule_set_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            ssl_configuration: Optional[pulumi.Input[pulumi.InputType['LoadBalancerListenerSslConfigurationArgs']]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'LoadBalancerListener':
        """
    ...
    @property
    @pulumi.getter(name="connectionConfiguration")
    def connection_configuration(self) -> pulumi.Output['outputs.LoadBalancerListenerConnectionConfiguration']:
        """
        (Updatable) Configuration details for the connection between the client and backend servers.
        """
        return pulumi.get(self, "connection_configuration")
    ...
    @property
    @pulumi.getter(name="sslConfiguration")
    def ssl_configuration(self) -> pulumi.Output[Optional['outputs.LoadBalancerListenerSslConfiguration']]:
        """
        (Updatable) The load balancer's SSL handling configuration details.
        """
        return pulumi.get(self, "ssl_configuration")
