...
__all__ = [
    'GetLogAnalyticsLogAnalyticsEntitiesResult',
    'AwaitableGetLogAnalyticsLogAnalyticsEntitiesResult',
    'get_log_analytics_log_analytics_entities',
]

@pulumi.output_type
class GetLogAnalyticsLogAnalyticsEntitiesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLogAnalyticsLogAnalyticsEntitiesFilterResult']]:
    ...
    def log_analytics_entity_collections(self) -> Sequence['outputs.GetLogAnalyticsLogAnalyticsEntitiesLogAnalyticsEntityCollectionResult']:
        """
...
class AwaitableGetLogAnalyticsLogAnalyticsEntitiesResult(GetLogAnalyticsLogAnalyticsEntitiesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLogAnalyticsLogAnalyticsEntitiesResult(
...
def get_log_analytics_log_analytics_entities(cloud_resource_id: Optional[str] = None,
                                             compartment_id: Optional[str] = None,
                                             entity_type_names: Optional[Sequence[str]] = None,
                                             filters: Optional[Sequence[pulumi.InputType['GetLogAnalyticsLogAnalyticsEntitiesFilterArgs']]] = None,
                                             ...
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLogAnalyticsLogAnalyticsEntitiesResult:
    """
    ...
    test_log_analytics_entities = oci.get_log_analytics_log_analytics_entities(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLogAnalyticsLogAnalyticsEntities:GetLogAnalyticsLogAnalyticsEntities', __args__, opts=opts, typ=GetLogAnalyticsLogAnalyticsEntitiesResult).value

    return AwaitableGetLogAnalyticsLogAnalyticsEntitiesResult(
