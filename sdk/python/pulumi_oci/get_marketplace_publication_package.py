...
__all__ = [
    'GetMarketplacePublicationPackageResult',
    'AwaitableGetMarketplacePublicationPackageResult',
    'get_marketplace_publication_package',
]

@pulumi.output_type
class GetMarketplacePublicationPackageResult:
    """
    ...
    def operating_systems(self) -> Sequence['outputs.GetMarketplacePublicationPackageOperatingSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def variables(self) -> Sequence['outputs.GetMarketplacePublicationPackageVariableResult']:
        """
...
class AwaitableGetMarketplacePublicationPackageResult(GetMarketplacePublicationPackageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplacePublicationPackageResult(
...
def get_marketplace_publication_package(package_version: Optional[str] = None,
                                        publication_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplacePublicationPackageResult:
    """
    ...
    test_publication_package = oci.get_marketplace_publication_package(package_version=var["publication_package_package_version"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplacePublicationPackage:GetMarketplacePublicationPackage', __args__, opts=opts, typ=GetMarketplacePublicationPackageResult).value

    return AwaitableGetMarketplacePublicationPackageResult(
