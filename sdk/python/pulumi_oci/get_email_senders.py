...
__all__ = [
    'GetEmailSendersResult',
    'AwaitableGetEmailSendersResult',
    'get_email_senders',
]

@pulumi.output_type
class GetEmailSendersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetEmailSendersFilterResult']]:
    ...
    @property
    @pulumi.getter
    def senders(self) -> Sequence['outputs.GetEmailSendersSenderResult']:
        """
        The list of senders.
        """
...
class AwaitableGetEmailSendersResult(GetEmailSendersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailSendersResult(
...
def get_email_senders(compartment_id: Optional[str] = None,
                      domain: Optional[str] = None,
                      email_address: Optional[str] = None,
                      filters: Optional[Sequence[pulumi.InputType['GetEmailSendersFilterArgs']]] = None,
                      state: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailSendersResult:
    """
    ...
    test_senders = oci.get_email_senders(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailSenders:GetEmailSenders', __args__, opts=opts, typ=GetEmailSendersResult).value

    return AwaitableGetEmailSendersResult(
