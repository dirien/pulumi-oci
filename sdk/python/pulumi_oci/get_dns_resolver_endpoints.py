...
__all__ = [
    'GetDnsResolverEndpointsResult',
    'AwaitableGetDnsResolverEndpointsResult',
    'get_dns_resolver_endpoints',
]

@pulumi.output_type
class GetDnsResolverEndpointsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsResolverEndpointsFilterResult']]:
    ...
    def resolver_endpoints(self) -> Sequence['outputs.GetDnsResolverEndpointsResolverEndpointResult']:
        """
...
class AwaitableGetDnsResolverEndpointsResult(GetDnsResolverEndpointsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsResolverEndpointsResult(
...
def get_dns_resolver_endpoints(filters: Optional[Sequence[pulumi.InputType['GetDnsResolverEndpointsFilterArgs']]] = None,
                               name: Optional[str] = None,
                               resolver_id: Optional[str] = None,
                               scope: Optional[str] = None,
                               state: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsResolverEndpointsResult:
    """
    ...
    test_resolver_endpoints = oci.get_dns_resolver_endpoints(resolver_id=oci_dns_resolver["test_resolver"]["id"],
        scope="PRIVATE",
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsResolverEndpoints:GetDnsResolverEndpoints', __args__, opts=opts, typ=GetDnsResolverEndpointsResult).value

    return AwaitableGetDnsResolverEndpointsResult(
