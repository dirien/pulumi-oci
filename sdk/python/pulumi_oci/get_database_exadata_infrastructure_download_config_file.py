...
__all__ = [
    'GetDatabaseExadataInfrastructureDownloadConfigFileResult',
    'AwaitableGetDatabaseExadataInfrastructureDownloadConfigFileResult',
    'get_database_exadata_infrastructure_download_config_file',
]

@pulumi.output_type
class GetDatabaseExadataInfrastructureDownloadConfigFileResult:
    """
...
class AwaitableGetDatabaseExadataInfrastructureDownloadConfigFileResult(GetDatabaseExadataInfrastructureDownloadConfigFileResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExadataInfrastructureDownloadConfigFileResult(
...
def get_database_exadata_infrastructure_download_config_file(base64_encode_content: Optional[bool] = None,
                                                             exadata_infrastructure_id: Optional[str] = None,
                                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExadataInfrastructureDownloadConfigFileResult:
    """
    ...
    test_exadata_infrastructure_download_config_file = oci.get_database_exadata_infrastructure_download_config_file(exadata_infrastructure_id=oci_database_exadata_infrastructure["test_exadata_infrastructure"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExadataInfrastructureDownloadConfigFile:GetDatabaseExadataInfrastructureDownloadConfigFile', __args__, opts=opts, typ=GetDatabaseExadataInfrastructureDownloadConfigFileResult).value

    return AwaitableGetDatabaseExadataInfrastructureDownloadConfigFileResult(
