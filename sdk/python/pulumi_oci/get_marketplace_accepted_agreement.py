...
__all__ = [
    'GetMarketplaceAcceptedAgreementResult',
    'AwaitableGetMarketplaceAcceptedAgreementResult',
    'get_marketplace_accepted_agreement',
]

@pulumi.output_type
class GetMarketplaceAcceptedAgreementResult:
    """
...
class AwaitableGetMarketplaceAcceptedAgreementResult(GetMarketplaceAcceptedAgreementResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMarketplaceAcceptedAgreementResult(
...
def get_marketplace_accepted_agreement(accepted_agreement_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMarketplaceAcceptedAgreementResult:
    """
    ...
    test_accepted_agreement = oci.get_marketplace_accepted_agreement(accepted_agreement_id=oci_marketplace_accepted_agreement["test_accepted_agreement"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMarketplaceAcceptedAgreement:GetMarketplaceAcceptedAgreement', __args__, opts=opts, typ=GetMarketplaceAcceptedAgreementResult).value

    return AwaitableGetMarketplaceAcceptedAgreementResult(
