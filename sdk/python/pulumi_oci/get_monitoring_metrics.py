...
__all__ = [
    'GetMonitoringMetricsResult',
    'AwaitableGetMonitoringMetricsResult',
    'get_monitoring_metrics',
]

@pulumi.output_type
class GetMonitoringMetricsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMonitoringMetricsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def metrics(self) -> Sequence['outputs.GetMonitoringMetricsMetricResult']:
        """
        The list of metrics.
        """
...
class AwaitableGetMonitoringMetricsResult(GetMonitoringMetricsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMonitoringMetricsResult(
...
def get_monitoring_metrics(compartment_id: Optional[str] = None,
                           compartment_id_in_subtree: Optional[bool] = None,
                           dimension_filters: Optional[Mapping[str, Any]] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetMonitoringMetricsFilterArgs']]] = None,
                           group_bies: Optional[Sequence[str]] = None,
                           name: Optional[str] = None,
                           namespace: Optional[str] = None,
                           resource_group: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMonitoringMetricsResult:
    """
    ...
    test_metrics = oci.get_monitoring_metrics(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMonitoringMetrics:GetMonitoringMetrics', __args__, opts=opts, typ=GetMonitoringMetricsResult).value

    return AwaitableGetMonitoringMetricsResult(
