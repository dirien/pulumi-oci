...
__all__ = ['DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs', 'DatabaseExternalPluggableDatabaseOperationsInsightsManagement']

@pulumi.input_type
class DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs:
...
@pulumi.input_type
class _DatabaseExternalPluggableDatabaseOperationsInsightsManagementState:
    def __init__(__self__, *,
...
class DatabaseExternalPluggableDatabaseOperationsInsightsManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_external_pluggable_database_operations_insights_management = oci.DatabaseExternalPluggableDatabaseOperationsInsightsManagement("testExternalPluggableDatabaseOperationsInsightsManagement",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the External Pluggable Database Operations Insights Management resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs.__new__(DatabaseExternalPluggableDatabaseOperationsInsightsManagementArgs)
        ...
        super(DatabaseExternalPluggableDatabaseOperationsInsightsManagement, __self__).__init__(
            'oci:index/databaseExternalPluggableDatabaseOperationsInsightsManagement:DatabaseExternalPluggableDatabaseOperationsInsightsManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            enable_operations_insights: Optional[pulumi.Input[bool]] = None,
            external_database_connector_id: Optional[pulumi.Input[str]] = None,
            external_pluggable_database_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseExternalPluggableDatabaseOperationsInsightsManagement':
        """
        ...
        __props__ = _DatabaseExternalPluggableDatabaseOperationsInsightsManagementState.__new__(_DatabaseExternalPluggableDatabaseOperationsInsightsManagementState)

        __props__.__dict__["enable_operations_insights"] = enable_operations_insights
        __props__.__dict__["external_database_connector_id"] = external_database_connector_id
        __props__.__dict__["external_pluggable_database_id"] = external_pluggable_database_id
        return DatabaseExternalPluggableDatabaseOperationsInsightsManagement(resource_name, opts=opts, __props__=__props__)
