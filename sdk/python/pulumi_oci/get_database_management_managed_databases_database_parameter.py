...
__all__ = [
    'GetDatabaseManagementManagedDatabasesDatabaseParameterResult',
    'AwaitableGetDatabaseManagementManagedDatabasesDatabaseParameterResult',
    'get_database_management_managed_databases_database_parameter',
]

@pulumi.output_type
class GetDatabaseManagementManagedDatabasesDatabaseParameterResult:
    """
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetDatabaseManagementManagedDatabasesDatabaseParameterItemResult']:
        """
...
class AwaitableGetDatabaseManagementManagedDatabasesDatabaseParameterResult(GetDatabaseManagementManagedDatabasesDatabaseParameterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseManagementManagedDatabasesDatabaseParameterResult(
...
def get_database_management_managed_databases_database_parameter(is_allowed_values_included: Optional[bool] = None,
                                                                 managed_database_id: Optional[str] = None,
                                                                 name: Optional[str] = None,
                                                                 source: Optional[str] = None,
                                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseManagementManagedDatabasesDatabaseParameterResult:
    """
    ...
    test_managed_databases_database_parameter = oci.get_database_management_managed_databases_database_parameter(managed_database_id=oci_database_management_managed_database["test_managed_database"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseManagementManagedDatabasesDatabaseParameter:GetDatabaseManagementManagedDatabasesDatabaseParameter', __args__, opts=opts, typ=GetDatabaseManagementManagedDatabasesDatabaseParameterResult).value

    return AwaitableGetDatabaseManagementManagedDatabasesDatabaseParameterResult(
