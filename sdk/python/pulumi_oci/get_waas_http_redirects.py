...
__all__ = [
    'GetWaasHttpRedirectsResult',
    'AwaitableGetWaasHttpRedirectsResult',
    'get_waas_http_redirects',
]

@pulumi.output_type
class GetWaasHttpRedirectsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetWaasHttpRedirectsFilterResult']]:
        return pulumi.get(self, "filters")

    @property
    @pulumi.getter(name="httpRedirects")
    def http_redirects(self) -> Sequence['outputs.GetWaasHttpRedirectsHttpRedirectResult']:
        """
...
class AwaitableGetWaasHttpRedirectsResult(GetWaasHttpRedirectsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasHttpRedirectsResult(
...
def get_waas_http_redirects(compartment_id: Optional[str] = None,
                            display_names: Optional[Sequence[str]] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetWaasHttpRedirectsFilterArgs']]] = None,
                            ids: Optional[Sequence[str]] = None,
                            states: Optional[Sequence[str]] = None,
                            time_created_greater_than_or_equal_to: Optional[str] = None,
                            time_created_less_than: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasHttpRedirectsResult:
    """
    ...
    test_http_redirects = oci.get_waas_http_redirects(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasHttpRedirects:GetWaasHttpRedirects', __args__, opts=opts, typ=GetWaasHttpRedirectsResult).value

    return AwaitableGetWaasHttpRedirectsResult(
