...
__all__ = [
    'GetOnsSubscriptionsResult',
    'AwaitableGetOnsSubscriptionsResult',
    'get_ons_subscriptions',
]

@pulumi.output_type
class GetOnsSubscriptionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetOnsSubscriptionsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def subscriptions(self) -> Sequence['outputs.GetOnsSubscriptionsSubscriptionResult']:
        """
...
class AwaitableGetOnsSubscriptionsResult(GetOnsSubscriptionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOnsSubscriptionsResult(
...
def get_ons_subscriptions(compartment_id: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetOnsSubscriptionsFilterArgs']]] = None,
                          topic_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOnsSubscriptionsResult:
    """
    ...
    test_subscriptions = oci.get_ons_subscriptions(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOnsSubscriptions:GetOnsSubscriptions', __args__, opts=opts, typ=GetOnsSubscriptionsResult).value

    return AwaitableGetOnsSubscriptionsResult(
