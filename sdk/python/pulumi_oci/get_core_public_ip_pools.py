...
__all__ = [
    'GetCorePublicIpPoolsResult',
    'AwaitableGetCorePublicIpPoolsResult',
    'get_core_public_ip_pools',
]

@pulumi.output_type
class GetCorePublicIpPoolsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCorePublicIpPoolsFilterResult']]:
    ...
    def public_ip_pool_collections(self) -> Sequence['outputs.GetCorePublicIpPoolsPublicIpPoolCollectionResult']:
        """
...
class AwaitableGetCorePublicIpPoolsResult(GetCorePublicIpPoolsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePublicIpPoolsResult(
...
def get_core_public_ip_pools(byoip_range_id: Optional[str] = None,
                             compartment_id: Optional[str] = None,
                             display_name: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetCorePublicIpPoolsFilterArgs']]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePublicIpPoolsResult:
    """
    ...
    test_public_ip_pools = oci.get_core_public_ip_pools(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePublicIpPools:GetCorePublicIpPools', __args__, opts=opts, typ=GetCorePublicIpPoolsResult).value

    return AwaitableGetCorePublicIpPoolsResult(
