...
__all__ = [
    'GetDatabaseExternalContainerDatabaseResult',
    'AwaitableGetDatabaseExternalContainerDatabaseResult',
    'get_database_external_container_database',
]

@pulumi.output_type
class GetDatabaseExternalContainerDatabaseResult:
    """
    ...
    def database_management_config(self) -> 'outputs.GetDatabaseExternalContainerDatabaseDatabaseManagementConfigResult':
        """
...
class AwaitableGetDatabaseExternalContainerDatabaseResult(GetDatabaseExternalContainerDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExternalContainerDatabaseResult(
...
def get_database_external_container_database(external_container_database_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExternalContainerDatabaseResult:
    """
    ...
    test_external_container_database = oci.get_database_external_container_database(external_container_database_id=oci_database_external_container_database["test_external_container_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExternalContainerDatabase:GetDatabaseExternalContainerDatabase', __args__, opts=opts, typ=GetDatabaseExternalContainerDatabaseResult).value

    return AwaitableGetDatabaseExternalContainerDatabaseResult(
