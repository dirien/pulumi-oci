...
__all__ = [
    'GetKmsKeyVersionResult',
    'AwaitableGetKmsKeyVersionResult',
    'get_kms_key_version',
]

@pulumi.output_type
class GetKmsKeyVersionResult:
    """
    ...
    def replica_details(self) -> 'outputs.GetKmsKeyVersionReplicaDetailsResult':
        """
...
class AwaitableGetKmsKeyVersionResult(GetKmsKeyVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsKeyVersionResult(
...
def get_kms_key_version(key_id: Optional[str] = None,
                        key_version_id: Optional[str] = None,
                        management_endpoint: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsKeyVersionResult:
    """
    ...
    test_key_version = oci.get_kms_key_version(key_id=oci_kms_key["test_key"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsKeyVersion:GetKmsKeyVersion', __args__, opts=opts, typ=GetKmsKeyVersionResult).value

    return AwaitableGetKmsKeyVersionResult(
