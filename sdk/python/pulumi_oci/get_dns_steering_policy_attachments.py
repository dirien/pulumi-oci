...
__all__ = [
    'GetDnsSteeringPolicyAttachmentsResult',
    'AwaitableGetDnsSteeringPolicyAttachmentsResult',
    'get_dns_steering_policy_attachments',
]

@pulumi.output_type
class GetDnsSteeringPolicyAttachmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsSteeringPolicyAttachmentsFilterResult']]:
    ...
    def steering_policy_attachments(self) -> Sequence['outputs.GetDnsSteeringPolicyAttachmentsSteeringPolicyAttachmentResult']:
        """
...
class AwaitableGetDnsSteeringPolicyAttachmentsResult(GetDnsSteeringPolicyAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsSteeringPolicyAttachmentsResult(
...
def get_dns_steering_policy_attachments(compartment_id: Optional[str] = None,
                                        display_name: Optional[str] = None,
                                        domain: Optional[str] = None,
                                        domain_contains: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDnsSteeringPolicyAttachmentsFilterArgs']]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsSteeringPolicyAttachmentsResult:
    """
    ...
    test_steering_policy_attachments = oci.get_dns_steering_policy_attachments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsSteeringPolicyAttachments:GetDnsSteeringPolicyAttachments', __args__, opts=opts, typ=GetDnsSteeringPolicyAttachmentsResult).value

    return AwaitableGetDnsSteeringPolicyAttachmentsResult(
