...
__all__ = [
    'GetDatascienceModelsResult',
    'AwaitableGetDatascienceModelsResult',
    'get_datascience_models',
]

@pulumi.output_type
class GetDatascienceModelsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatascienceModelsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def models(self) -> Sequence['outputs.GetDatascienceModelsModelResult']:
        """
        The list of models.
        """
...
class AwaitableGetDatascienceModelsResult(GetDatascienceModelsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceModelsResult(
...
def get_datascience_models(compartment_id: Optional[str] = None,
                           created_by: Optional[str] = None,
                           display_name: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetDatascienceModelsFilterArgs']]] = None,
                           id: Optional[str] = None,
                           project_id: Optional[str] = None,
                           state: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceModelsResult:
    """
    ...
    test_models = oci.get_datascience_models(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceModels:GetDatascienceModels', __args__, opts=opts, typ=GetDatascienceModelsResult).value

    return AwaitableGetDatascienceModelsResult(
