...
__all__ = [
    'GetCoreVolumesResult',
    'AwaitableGetCoreVolumesResult',
    'get_core_volumes',
]

@pulumi.output_type
class GetCoreVolumesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVolumesFilterResult']]:
    ...
    @property
    @pulumi.getter
    def volumes(self) -> Sequence['outputs.GetCoreVolumesVolumeResult']:
        """
        The list of volumes.
        """
...
class AwaitableGetCoreVolumesResult(GetCoreVolumesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVolumesResult(
...
def get_core_volumes(availability_domain: Optional[str] = None,
                     compartment_id: Optional[str] = None,
                     display_name: Optional[str] = None,
                     filters: Optional[Sequence[pulumi.InputType['GetCoreVolumesFilterArgs']]] = None,
                     state: Optional[str] = None,
                     volume_group_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVolumesResult:
    """
    ...
    test_volumes = oci.get_core_volumes(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVolumes:GetCoreVolumes', __args__, opts=opts, typ=GetCoreVolumesResult).value

    return AwaitableGetCoreVolumesResult(
