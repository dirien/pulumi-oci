...
__all__ = [
    'GetCoreVirtualCircuitResult',
    'AwaitableGetCoreVirtualCircuitResult',
    'get_core_virtual_circuit',
]

@pulumi.output_type
class GetCoreVirtualCircuitResult:
    """
    ...
    def cross_connect_mappings(self) -> Sequence['outputs.GetCoreVirtualCircuitCrossConnectMappingResult']:
        """
    ...
    def public_prefixes(self) -> Sequence['outputs.GetCoreVirtualCircuitPublicPrefixResult']:
        """
...
class AwaitableGetCoreVirtualCircuitResult(GetCoreVirtualCircuitResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVirtualCircuitResult(
...
def get_core_virtual_circuit(virtual_circuit_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVirtualCircuitResult:
    """
    ...
    test_virtual_circuit = oci.get_core_virtual_circuit(virtual_circuit_id=oci_core_virtual_circuit["test_virtual_circuit"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVirtualCircuit:GetCoreVirtualCircuit', __args__, opts=opts, typ=GetCoreVirtualCircuitResult).value

    return AwaitableGetCoreVirtualCircuitResult(
