...
__all__ = [
    'GetCoreComputeCapacityReservationsResult',
    'AwaitableGetCoreComputeCapacityReservationsResult',
    'get_core_compute_capacity_reservations',
]

@pulumi.output_type
class GetCoreComputeCapacityReservationsResult:
    """
    ...
    def compute_capacity_reservations(self) -> Sequence['outputs.GetCoreComputeCapacityReservationsComputeCapacityReservationResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreComputeCapacityReservationsFilterResult']]:
...
class AwaitableGetCoreComputeCapacityReservationsResult(GetCoreComputeCapacityReservationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeCapacityReservationsResult(
...
def get_core_compute_capacity_reservations(availability_domain: Optional[str] = None,
                                           compartment_id: Optional[str] = None,
                                           display_name: Optional[str] = None,
                                           filters: Optional[Sequence[pulumi.InputType['GetCoreComputeCapacityReservationsFilterArgs']]] = None,
                                           state: Optional[str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeCapacityReservationsResult:
    """
    ...
    test_compute_capacity_reservations = oci.get_core_compute_capacity_reservations(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeCapacityReservations:GetCoreComputeCapacityReservations', __args__, opts=opts, typ=GetCoreComputeCapacityReservationsResult).value

    return AwaitableGetCoreComputeCapacityReservationsResult(
