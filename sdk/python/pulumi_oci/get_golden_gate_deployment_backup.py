...
__all__ = [
    'GetGoldenGateDeploymentBackupResult',
    'AwaitableGetGoldenGateDeploymentBackupResult',
    'get_golden_gate_deployment_backup',
]

@pulumi.output_type
class GetGoldenGateDeploymentBackupResult:
    """
...
class AwaitableGetGoldenGateDeploymentBackupResult(GetGoldenGateDeploymentBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGoldenGateDeploymentBackupResult(
...
def get_golden_gate_deployment_backup(deployment_backup_id: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGoldenGateDeploymentBackupResult:
    """
    ...
    test_deployment_backup = oci.get_golden_gate_deployment_backup(deployment_backup_id=oci_golden_gate_deployment_backup["test_deployment_backup"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getGoldenGateDeploymentBackup:GetGoldenGateDeploymentBackup', __args__, opts=opts, typ=GetGoldenGateDeploymentBackupResult).value

    return AwaitableGetGoldenGateDeploymentBackupResult(
