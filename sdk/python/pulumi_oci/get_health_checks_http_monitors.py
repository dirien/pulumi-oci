...
__all__ = [
    'GetHealthChecksHttpMonitorsResult',
    'AwaitableGetHealthChecksHttpMonitorsResult',
    'get_health_checks_http_monitors',
]

@pulumi.output_type
class GetHealthChecksHttpMonitorsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetHealthChecksHttpMonitorsFilterResult']]:
    ...
    def http_monitors(self) -> Sequence['outputs.GetHealthChecksHttpMonitorsHttpMonitorResult']:
        """
...
class AwaitableGetHealthChecksHttpMonitorsResult(GetHealthChecksHttpMonitorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetHealthChecksHttpMonitorsResult(
...
def get_health_checks_http_monitors(compartment_id: Optional[str] = None,
                                    display_name: Optional[str] = None,
                                    filters: Optional[Sequence[pulumi.InputType['GetHealthChecksHttpMonitorsFilterArgs']]] = None,
                                    home_region: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHealthChecksHttpMonitorsResult:
    """
    ...
    test_http_monitors = oci.get_health_checks_http_monitors(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getHealthChecksHttpMonitors:GetHealthChecksHttpMonitors', __args__, opts=opts, typ=GetHealthChecksHttpMonitorsResult).value

    return AwaitableGetHealthChecksHttpMonitorsResult(
