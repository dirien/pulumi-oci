...
__all__ = [
    'GetCloudGuardDetectorRecipeResult',
    'AwaitableGetCloudGuardDetectorRecipeResult',
    'get_cloud_guard_detector_recipe',
]

@pulumi.output_type
class GetCloudGuardDetectorRecipeResult:
    """
    ...
    def detector_rules(self) -> Sequence['outputs.GetCloudGuardDetectorRecipeDetectorRuleResult']:
        """
    ...
    def effective_detector_rules(self) -> Sequence['outputs.GetCloudGuardDetectorRecipeEffectiveDetectorRuleResult']:
        """
...
class AwaitableGetCloudGuardDetectorRecipeResult(GetCloudGuardDetectorRecipeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudGuardDetectorRecipeResult(
...
def get_cloud_guard_detector_recipe(detector_recipe_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudGuardDetectorRecipeResult:
    """
    ...
    test_detector_recipe = oci.get_cloud_guard_detector_recipe(detector_recipe_id=oci_cloud_guard_detector_recipe["test_detector_recipe"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCloudGuardDetectorRecipe:GetCloudGuardDetectorRecipe', __args__, opts=opts, typ=GetCloudGuardDetectorRecipeResult).value

    return AwaitableGetCloudGuardDetectorRecipeResult(
