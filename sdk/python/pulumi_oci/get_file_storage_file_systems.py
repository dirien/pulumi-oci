...
__all__ = [
    'GetFileStorageFileSystemsResult',
    'AwaitableGetFileStorageFileSystemsResult',
    'get_file_storage_file_systems',
]

@pulumi.output_type
class GetFileStorageFileSystemsResult:
    """
    ...
    def file_systems(self) -> Sequence['outputs.GetFileStorageFileSystemsFileSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetFileStorageFileSystemsFilterResult']]:
...
class AwaitableGetFileStorageFileSystemsResult(GetFileStorageFileSystemsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFileStorageFileSystemsResult(
...
def get_file_storage_file_systems(availability_domain: Optional[str] = None,
                                  compartment_id: Optional[str] = None,
                                  display_name: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetFileStorageFileSystemsFilterArgs']]] = None,
                                  id: Optional[str] = None,
                                  parent_file_system_id: Optional[str] = None,
                                  source_snapshot_id: Optional[str] = None,
                                  state: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFileStorageFileSystemsResult:
    """
    ...
    test_file_systems = oci.get_file_storage_file_systems(availability_domain=var["file_system_availability_domain"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getFileStorageFileSystems:GetFileStorageFileSystems', __args__, opts=opts, typ=GetFileStorageFileSystemsResult).value

    return AwaitableGetFileStorageFileSystemsResult(
