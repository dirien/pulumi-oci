...
__all__ = [
    'GetFileStorageSnapshotResult',
    'AwaitableGetFileStorageSnapshotResult',
    'get_file_storage_snapshot',
]

@pulumi.output_type
class GetFileStorageSnapshotResult:
    """
...
class AwaitableGetFileStorageSnapshotResult(GetFileStorageSnapshotResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFileStorageSnapshotResult(
...
def get_file_storage_snapshot(snapshot_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFileStorageSnapshotResult:
    """
    ...
    test_snapshot = oci.get_file_storage_snapshot(snapshot_id=oci_file_storage_snapshot["test_snapshot"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getFileStorageSnapshot:GetFileStorageSnapshot', __args__, opts=opts, typ=GetFileStorageSnapshotResult).value

    return AwaitableGetFileStorageSnapshotResult(
