...
__all__ = [
    'GetEsxiHostsResult',
    'AwaitableGetEsxiHostsResult',
    'get_esxi_hosts',
]

@pulumi.output_type
class GetEsxiHostsResult:
    """
    A collection of values returned by getEsxiHosts.
    """
    ...
    def esxi_host_collections(self) -> Sequence['outputs.GetEsxiHostsEsxiHostCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetEsxiHostsFilterResult']]:
...
class AwaitableGetEsxiHostsResult(GetEsxiHostsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEsxiHostsResult(
...
def get_esxi_hosts(compute_instance_id: Optional[str] = None,
                   display_name: Optional[str] = None,
                   filters: Optional[Sequence[pulumi.InputType['GetEsxiHostsFilterArgs']]] = None,
                   sddc_id: Optional[str] = None,
                   state: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEsxiHostsResult:
    """
    ...
    test_esxi_hosts = oci.ocvp.get_esxi_hosts(compute_instance_id=oci_core_instance["test_instance"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:ocvp/getEsxiHosts:getEsxiHosts', __args__, opts=opts, typ=GetEsxiHostsResult).value

    return AwaitableGetEsxiHostsResult(
