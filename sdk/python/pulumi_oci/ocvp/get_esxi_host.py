...
__all__ = [
    'GetEsxiHostResult',
    'AwaitableGetEsxiHostResult',
    'get_esxi_host',
]

@pulumi.output_type
class GetEsxiHostResult:
    """
...
class AwaitableGetEsxiHostResult(GetEsxiHostResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEsxiHostResult(
...
def get_esxi_host(esxi_host_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEsxiHostResult:
    """
    ...
    test_esxi_host = oci.ocvp.get_esxi_host(esxi_host_id=oci_ocvp_esxi_host["test_esxi_host"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:ocvp/getEsxiHost:getEsxiHost', __args__, opts=opts, typ=GetEsxiHostResult).value

    return AwaitableGetEsxiHostResult(
