...
__all__ = [
    'GetDatabaseDatabaseSoftwareImagesResult',
    'AwaitableGetDatabaseDatabaseSoftwareImagesResult',
    'get_database_database_software_images',
]

@pulumi.output_type
class GetDatabaseDatabaseSoftwareImagesResult:
    """
    ...
    def database_software_images(self) -> Sequence['outputs.GetDatabaseDatabaseSoftwareImagesDatabaseSoftwareImageResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseDatabaseSoftwareImagesFilterResult']]:
...
class AwaitableGetDatabaseDatabaseSoftwareImagesResult(GetDatabaseDatabaseSoftwareImagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDatabaseSoftwareImagesResult(
...
def get_database_database_software_images(compartment_id: Optional[str] = None,
                                          display_name: Optional[str] = None,
                                          filters: Optional[Sequence[pulumi.InputType['GetDatabaseDatabaseSoftwareImagesFilterArgs']]] = None,
                                          image_shape_family: Optional[str] = None,
                                          image_type: Optional[str] = None,
                                          is_upgrade_supported: Optional[bool] = None,
                                          state: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDatabaseSoftwareImagesResult:
    """
    ...
    test_database_software_images = oci.get_database_database_software_images(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDatabaseSoftwareImages:GetDatabaseDatabaseSoftwareImages', __args__, opts=opts, typ=GetDatabaseDatabaseSoftwareImagesResult).value

    return AwaitableGetDatabaseDatabaseSoftwareImagesResult(
