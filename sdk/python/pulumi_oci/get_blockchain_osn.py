...
__all__ = [
    'GetBlockchainOsnResult',
    'AwaitableGetBlockchainOsnResult',
    'get_blockchain_osn',
]

@pulumi.output_type
class GetBlockchainOsnResult:
    """
    ...
    def ocpu_allocation_param(self) -> 'outputs.GetBlockchainOsnOcpuAllocationParamResult':
        """
...
class AwaitableGetBlockchainOsnResult(GetBlockchainOsnResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBlockchainOsnResult(
            ad=self.ad,
...
def get_blockchain_osn(blockchain_platform_id: Optional[str] = None,
                       osn_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBlockchainOsnResult:
    """
    ...
    test_osn = oci.get_blockchain_osn(blockchain_platform_id=oci_blockchain_blockchain_platform["test_blockchain_platform"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBlockchainOsn:GetBlockchainOsn', __args__, opts=opts, typ=GetBlockchainOsnResult).value

    return AwaitableGetBlockchainOsnResult(
        ad=__ret__.ad,
