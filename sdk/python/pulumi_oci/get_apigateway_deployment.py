...
__all__ = [
    'GetApigatewayDeploymentResult',
    'AwaitableGetApigatewayDeploymentResult',
    'get_apigateway_deployment',
]

@pulumi.output_type
class GetApigatewayDeploymentResult:
    """
    ...
    @property
    @pulumi.getter
    def specification(self) -> 'outputs.GetApigatewayDeploymentSpecificationResult':
        """
...
class AwaitableGetApigatewayDeploymentResult(GetApigatewayDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayDeploymentResult(
...
def get_apigateway_deployment(deployment_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayDeploymentResult:
    """
    ...
    test_deployment = oci.get_apigateway_deployment(deployment_id=oci_apigateway_deployment["test_deployment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayDeployment:GetApigatewayDeployment', __args__, opts=opts, typ=GetApigatewayDeploymentResult).value

    return AwaitableGetApigatewayDeploymentResult(
