...
__all__ = [
    'GetDatabaseExternalDatabaseConnectorResult',
    'AwaitableGetDatabaseExternalDatabaseConnectorResult',
    'get_database_external_database_connector',
]

@pulumi.output_type
class GetDatabaseExternalDatabaseConnectorResult:
    """
    ...
    def connection_credentials(self) -> 'outputs.GetDatabaseExternalDatabaseConnectorConnectionCredentialsResult':
        """
    ...
    def connection_string(self) -> 'outputs.GetDatabaseExternalDatabaseConnectorConnectionStringResult':
        """
...
class AwaitableGetDatabaseExternalDatabaseConnectorResult(GetDatabaseExternalDatabaseConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExternalDatabaseConnectorResult(
...
def get_database_external_database_connector(external_database_connector_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExternalDatabaseConnectorResult:
    """
    ...
    test_external_database_connector = oci.get_database_external_database_connector(external_database_connector_id=oci_database_external_database_connector["test_external_database_connector"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExternalDatabaseConnector:GetDatabaseExternalDatabaseConnector', __args__, opts=opts, typ=GetDatabaseExternalDatabaseConnectorResult).value

    return AwaitableGetDatabaseExternalDatabaseConnectorResult(
