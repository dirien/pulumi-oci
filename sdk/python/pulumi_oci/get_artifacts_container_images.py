...
__all__ = [
    'GetArtifactsContainerImagesResult',
    'AwaitableGetArtifactsContainerImagesResult',
    'get_artifacts_container_images',
]

@pulumi.output_type
class GetArtifactsContainerImagesResult:
    """
    ...
    def container_image_collections(self) -> Sequence['outputs.GetArtifactsContainerImagesContainerImageCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetArtifactsContainerImagesFilterResult']]:
...
class AwaitableGetArtifactsContainerImagesResult(GetArtifactsContainerImagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerImagesResult(
...
def get_artifacts_container_images(compartment_id: Optional[str] = None,
                                   compartment_id_in_subtree: Optional[bool] = None,
                                   display_name: Optional[str] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetArtifactsContainerImagesFilterArgs']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerImagesResult:
    """
    ...
    test_container_images = oci.get_artifacts_container_images(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerImages:GetArtifactsContainerImages', __args__, opts=opts, typ=GetArtifactsContainerImagesResult).value

    return AwaitableGetArtifactsContainerImagesResult(
