...
__all__ = ['AnalyticsAnalyticsInstanceArgs', 'AnalyticsAnalyticsInstance']

@pulumi.input_type
class AnalyticsAnalyticsInstanceArgs:
    def __init__(__self__, *,
                 capacity: pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs'],
                 ...
                 network_endpoint_details: Optional[pulumi.Input['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs']] = None,
                 state: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a AnalyticsAnalyticsInstance resource.
        :param pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs'] capacity: Service instance capacity metadata (e.g.: OLPU count, number of users, ...etc...).
        ...
        :param pulumi.Input['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs'] network_endpoint_details: Base representation of a network endpoint.
    ...
    @property
    @pulumi.getter
    def capacity(self) -> pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs']:
        """
    ...
    @capacity.setter
    def capacity(self, value: pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs']):
    ...
    def network_endpoint_details(self) -> Optional[pulumi.Input['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs']]:
        """
    ...
    def network_endpoint_details(self, value: Optional[pulumi.Input['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs']]):
...
@pulumi.input_type
class _AnalyticsAnalyticsInstanceState:
    def __init__(__self__, *,
                 capacity: Optional[pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs']] = None,
    ...
    @property
    @pulumi.getter
    def capacity(self) -> Optional[pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs']]:
        """
        Service instance capacity metadata (e.g.: OLPU count, number of users, ...etc...).
        """
        return pulumi.get(self, "capacity")
    ...
    @capacity.setter
    def capacity(self, value: Optional[pulumi.Input['AnalyticsAnalyticsInstanceCapacityArgs']]):
        pulumi.set(self, "capacity", value)
...
class AnalyticsAnalyticsInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 capacity: Optional[pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstanceCapacityArgs']]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 email_notification: Optional[pulumi.Input[str]] = None,
                 ...
                 license_type: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 network_endpoint_details: Optional[pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs']]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_analytics_instance = oci.AnalyticsAnalyticsInstance("testAnalyticsInstance",
            capacity=oci.AnalyticsAnalyticsInstanceCapacityArgs(
            ...
            network_endpoint_details=oci.AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs(
                ...
                whitelisted_vcns=[oci.AnalyticsAnalyticsInstanceNetworkEndpointDetailsWhitelistedVcnArgs(
        ...
        :param pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstanceCapacityArgs']] capacity: Service instance capacity metadata (e.g.: OLPU count, number of users, ...etc...).
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) Optional description.
        :param pulumi.Input[str] email_notification: (Updatable) Email address receiving notifications.
        ...
        :param pulumi.Input[str] license_type: (Updatable) The license used for the service.
        :param pulumi.Input[str] name: The name of the Analytics instance. This name must be unique in the tenancy and cannot be changed.
        :param pulumi.Input[pulumi.InputType['AnalyticsAnalyticsInstanceNetworkEndpointDetailsArgs']] network_endpoint_details: Base representation of a network endpoint.
        :param pulumi.Input[str] state: (Updatable) The target state for the Analytics Instance. Could be set to `ACTIVE` or `INACTIVE`.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: AnalyticsAnalyticsInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Analytics Instance resource in Oracle Cloud Infrastructure Analytics service.
        ...
        :param str resource_name: The name of the resource.
        :param AnalyticsAnalyticsInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AnalyticsAnalyticsInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AnalyticsAnalyticsInstanceArgs.__new__(AnalyticsAnalyticsInstanceArgs)
        ...
        super(AnalyticsAnalyticsInstance, __self__).__init__(
            'oci:index/analyticsAnalyticsInstance:AnalyticsAnalyticsInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            vanity_url_details: Optional[pulumi.Input[Mapping[str, Any]]] = None) -> 'AnalyticsAnalyticsInstance':
        """
        ...
        __props__ = _AnalyticsAnalyticsInstanceState.__new__(_AnalyticsAnalyticsInstanceState)
        ...
        return AnalyticsAnalyticsInstance(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def capacity(self) -> pulumi.Output['outputs.AnalyticsAnalyticsInstanceCapacity']:
        """
        Service instance capacity metadata (e.g.: OLPU count, number of users, ...etc...).
        """
        return pulumi.get(self, "capacity")
    ...
    @property
    @pulumi.getter(name="networkEndpointDetails")
    def network_endpoint_details(self) -> pulumi.Output['outputs.AnalyticsAnalyticsInstanceNetworkEndpointDetails']:
        """
        Base representation of a network endpoint.
        """
        return pulumi.get(self, "network_endpoint_details")
