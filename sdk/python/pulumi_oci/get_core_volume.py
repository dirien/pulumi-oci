...
__all__ = [
    'GetCoreVolumeResult',
    'AwaitableGetCoreVolumeResult',
    'get_core_volume',
]

@pulumi.output_type
class GetCoreVolumeResult:
    """
    ...
    def block_volume_replicas(self) -> Sequence['outputs.GetCoreVolumeBlockVolumeReplicaResult']:
        """
    ...
    def source_details(self) -> 'outputs.GetCoreVolumeSourceDetailsResult':
...
class AwaitableGetCoreVolumeResult(GetCoreVolumeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVolumeResult(
...
def get_core_volume(volume_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVolumeResult:
    """
    ...
    test_volume = oci.get_core_volume(volume_id=oci_core_volume["test_volume"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVolume:GetCoreVolume', __args__, opts=opts, typ=GetCoreVolumeResult).value

    return AwaitableGetCoreVolumeResult(
