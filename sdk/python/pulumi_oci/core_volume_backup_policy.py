...
__all__ = ['CoreVolumeBackupPolicyArgs', 'CoreVolumeBackupPolicy']

@pulumi.input_type
class CoreVolumeBackupPolicyArgs:
    def __init__(__self__, *,
                 ...
                 schedules: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBackupPolicyScheduleArgs']]]] = None):
        """
    ...
    @property
    @pulumi.getter
    def schedules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBackupPolicyScheduleArgs']]]]:
        """
        (Updatable) The collection of schedules for the volume backup policy. See see [Schedules](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm#schedules) in [Policy-Based Backups](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm) for more information.
        """
    ...
    @schedules.setter
    def schedules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeBackupPolicyScheduleArgs']]]]):
        pulumi.set(self, "schedules", value)


@pulumi.input_type
class _CoreVolumeBackupPolicyState:
    def __init__(__self__, *,
...
class CoreVolumeBackupPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 schedules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeBackupPolicyScheduleArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test_volume_backup_policy = oci.CoreVolumeBackupPolicy("testVolumeBackupPolicy",
            ...
            schedules=[oci.CoreVolumeBackupPolicyScheduleArgs(
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the volume backup policy. Does not have to be unique and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeBackupPolicyScheduleArgs']]]] schedules: (Updatable) The collection of schedules for the volume backup policy. See see [Schedules](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm#schedules) in [Policy-Based Backups](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm) for more information.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: CoreVolumeBackupPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Volume Backup Policy resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeBackupPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeBackupPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeBackupPolicyArgs.__new__(CoreVolumeBackupPolicyArgs)
        ...
        super(CoreVolumeBackupPolicy, __self__).__init__(
            'oci:index/coreVolumeBackupPolicy:CoreVolumeBackupPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            schedules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeBackupPolicyScheduleArgs']]]]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreVolumeBackupPolicy':
        """
        ...
        __props__ = _CoreVolumeBackupPolicyState.__new__(_CoreVolumeBackupPolicyState)
        ...
        return CoreVolumeBackupPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def schedules(self) -> pulumi.Output[Optional[Sequence['outputs.CoreVolumeBackupPolicySchedule']]]:
        """
        (Updatable) The collection of schedules for the volume backup policy. See see [Schedules](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm#schedules) in [Policy-Based Backups](https://docs.cloud.oracle.com/iaas/Content/Block/Tasks/schedulingvolumebackups.htm) for more information.
        """
        return pulumi.get(self, "schedules")
