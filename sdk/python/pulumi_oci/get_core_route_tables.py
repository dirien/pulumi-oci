...
__all__ = [
    'GetCoreRouteTablesResult',
    'AwaitableGetCoreRouteTablesResult',
    'get_core_route_tables',
]

@pulumi.output_type
class GetCoreRouteTablesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreRouteTablesFilterResult']]:
    ...
    def route_tables(self) -> Sequence['outputs.GetCoreRouteTablesRouteTableResult']:
        """
...
class AwaitableGetCoreRouteTablesResult(GetCoreRouteTablesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreRouteTablesResult(
...
def get_core_route_tables(compartment_id: Optional[str] = None,
                          display_name: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetCoreRouteTablesFilterArgs']]] = None,
                          state: Optional[str] = None,
                          vcn_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreRouteTablesResult:
    """
    ...
    test_route_tables = oci.get_core_route_tables(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreRouteTables:GetCoreRouteTables', __args__, opts=opts, typ=GetCoreRouteTablesResult).value

    return AwaitableGetCoreRouteTablesResult(
