...
class ServiceConnectorArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input['ServiceConnectorSourceArgs'],
                 target: pulumi.Input['ServiceConnectorTargetArgs'],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 tasks: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorTaskArgs']]]] = None):
        """
        ...
        :param pulumi.Input['ServiceConnectorSourceArgs'] source: (Updatable) An object that represents the source of the flow defined by the service connector. An example source is the VCNFlow logs within the NetworkLogs group. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        :param pulumi.Input['ServiceConnectorTargetArgs'] target: (Updatable) An object that represents the target of the flow defined by the service connector. An example target is a stream. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceConnectorTaskArgs']]] tasks: (Updatable) The list of tasks.
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> pulumi.Input['ServiceConnectorSourceArgs']:
        """
    ...
    @source.setter
    def source(self, value: pulumi.Input['ServiceConnectorSourceArgs']):
        pulumi.set(self, "source", value)

    @property
    @pulumi.getter
    def target(self) -> pulumi.Input['ServiceConnectorTargetArgs']:
        """
    ...
    @target.setter
    def target(self, value: pulumi.Input['ServiceConnectorTargetArgs']):
    ...
    @property
    @pulumi.getter
    def tasks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorTaskArgs']]]]:
        """
    ...
    @tasks.setter
    def tasks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorTaskArgs']]]]):
...
class _ServiceConnectorState:
    def __init__(__self__, *,
                 ...
                 source: Optional[pulumi.Input['ServiceConnectorSourceArgs']] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 target: Optional[pulumi.Input['ServiceConnectorTargetArgs']] = None,
                 tasks: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorTaskArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def source(self) -> Optional[pulumi.Input['ServiceConnectorSourceArgs']]:
        """
        (Updatable) An object that represents the source of the flow defined by the service connector. An example source is the VCNFlow logs within the NetworkLogs group. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        """
        return pulumi.get(self, "source")
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input['ServiceConnectorSourceArgs']]):
        pulumi.set(self, "source", value)
    ...
    @property
    @pulumi.getter
    def target(self) -> Optional[pulumi.Input['ServiceConnectorTargetArgs']]:
        """
        (Updatable) An object that represents the target of the flow defined by the service connector. An example target is a stream. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        """
        return pulumi.get(self, "target")
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input['ServiceConnectorTargetArgs']]):
        pulumi.set(self, "target", value)
...
class ServiceConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 source: Optional[pulumi.Input[pulumi.InputType['ServiceConnectorSourceArgs']]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 target: Optional[pulumi.Input[pulumi.InputType['ServiceConnectorTargetArgs']]] = None,
                 tasks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServiceConnectorTaskArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test_service_connector = oci.sch.ServiceConnector("testServiceConnector",
            compartment_id=var["compartment_id"],
            display_name=var["service_connector_display_name"],
            source=oci.sch.ServiceConnectorSourceArgs(
                kind=var["service_connector_source_kind"],
                cursor=oci.sch.ServiceConnectorSourceCursorArgs(
                    kind=var["service_connector_source_cursor_kind"],
                ),
                log_sources=[oci.sch.ServiceConnectorSourceLogSourceArgs(
                    compartment_id=var["compartment_id"],
            ...
            target=oci.sch.ServiceConnectorTargetArgs(
            ...
            tasks=[oci.sch.ServiceConnectorTaskArgs(
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['ServiceConnectorSourceArgs']] source: (Updatable) An object that represents the source of the flow defined by the service connector. An example source is the VCNFlow logs within the NetworkLogs group. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        :param pulumi.Input[str] state: (Updatable) The target state for the service connector. Could be set to `ACTIVE` or `INACTIVE`.
        :param pulumi.Input[pulumi.InputType['ServiceConnectorTargetArgs']] target: (Updatable) An object that represents the target of the flow defined by the service connector. An example target is a stream. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServiceConnectorTaskArgs']]]] tasks: (Updatable) The list of tasks.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def _internal_init(__self__,
        ...
        super(ServiceConnector, __self__).__init__(
            'oci:sch/serviceConnector:ServiceConnector',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tasks: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServiceConnectorTaskArgs']]]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'ServiceConnector':
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> pulumi.Output['outputs.ServiceConnectorSource']:
        """
        (Updatable) An object that represents the source of the flow defined by the service connector. An example source is the VCNFlow logs within the NetworkLogs group. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        """
        return pulumi.get(self, "source")
    ...
    @property
    @pulumi.getter
    def target(self) -> pulumi.Output['outputs.ServiceConnectorTarget']:
        """
        (Updatable) An object that represents the target of the flow defined by the service connector. An example target is a stream. For more information about flows defined by service connectors, see [Service Connector Hub Overview](https://docs.cloud.oracle.com/iaas/Content/service-connector-hub/overview.htm).
        """
        return pulumi.get(self, "target")
    ...
    @property
    @pulumi.getter
    def tasks(self) -> pulumi.Output[Sequence['outputs.ServiceConnectorTask']]:
        """
        (Updatable) The list of tasks.
        """
        return pulumi.get(self, "tasks")
