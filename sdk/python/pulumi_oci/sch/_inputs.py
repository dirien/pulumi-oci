...
@pulumi.input_type
class ServiceConnectorSourceArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[str],
                 cursor: Optional[pulumi.Input['ServiceConnectorSourceCursorArgs']] = None,
                 log_sources: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorSourceLogSourceArgs']]]] = None,
                 stream_id: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] kind: (Updatable) The type descriminator.
        :param pulumi.Input['ServiceConnectorSourceCursorArgs'] cursor: (Updatable) The type of [cursor](https://docs.cloud.oracle.com/iaas/Content/Streaming/Tasks/using_a_single_consumer.htm#usingcursors), which determines the starting point from which the stream will be consumed.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceConnectorSourceLogSourceArgs']]] log_sources: (Updatable) The resources affected by this work request.
    ...
    @property
    @pulumi.getter
    def cursor(self) -> Optional[pulumi.Input['ServiceConnectorSourceCursorArgs']]:
        """
    ...
    @cursor.setter
    def cursor(self, value: Optional[pulumi.Input['ServiceConnectorSourceCursorArgs']]):
        pulumi.set(self, "cursor", value)

    @property
    @pulumi.getter(name="logSources")
    def log_sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorSourceLogSourceArgs']]]]:
        """
    ...
    @log_sources.setter
    def log_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ServiceConnectorSourceLogSourceArgs']]]]):
...
@pulumi.input_type
class ServiceConnectorSourceCursorArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class ServiceConnectorSourceLogSourceArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class ServiceConnectorTargetArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[str],
...
@pulumi.input_type
class ServiceConnectorTaskArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[str],
