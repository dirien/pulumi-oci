...
__all__ = ['CorePrivateIpArgs', 'CorePrivateIp']

@pulumi.input_type
class CorePrivateIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vnic_id: (Updatable) The OCID of the VNIC to assign the private IP to. The VNIC and private IP must be in the same subnet.
        """
...
class _CorePrivateIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compartment_id: The OCID of the compartment containing the private IP.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] hostname_label: (Updatable) The hostname for the private IP. Used for DNS. The value is the hostname portion of the private IP's fully qualified domain name (FQDN) (for example, `bminstance-1` in FQDN `bminstance-1.subnet123.vcn1.oraclevcn.com`). Must be unique across all VNICs in the subnet and comply with [RFC 952](https://tools.ietf.org/html/rfc952) and [RFC 1123](https://tools.ietf.org/html/rfc1123).
        ...
        :param pulumi.Input[str] subnet_id: The OCID of the subnet the VNIC is in.
...
class CorePrivateIp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_private_ip = oci.CorePrivateIp("testPrivateIp",
            defined_tags={
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CorePrivateIpArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Private Ip resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CorePrivateIpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CorePrivateIpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CorePrivateIpArgs.__new__(CorePrivateIpArgs)
        ...
        super(CorePrivateIp, __self__).__init__(
            'oci:index/corePrivateIp:CorePrivateIp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            vlan_id: Optional[pulumi.Input[str]] = None,
            vnic_id: Optional[pulumi.Input[str]] = None) -> 'CorePrivateIp':
        """
        ...
        __props__ = _CorePrivateIpState.__new__(_CorePrivateIpState)
        ...
        __props__.__dict__["vlan_id"] = vlan_id
        __props__.__dict__["vnic_id"] = vnic_id
        return CorePrivateIp(resource_name, opts=opts, __props__=__props__)
