...
__all__ = [
    'GetNosqlTablesResult',
    'AwaitableGetNosqlTablesResult',
    'get_nosql_tables',
]

@pulumi.output_type
class GetNosqlTablesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetNosqlTablesFilterResult']]:
    ...
    def table_collections(self) -> Sequence['outputs.GetNosqlTablesTableCollectionResult']:
        """
...
class AwaitableGetNosqlTablesResult(GetNosqlTablesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNosqlTablesResult(
...
def get_nosql_tables(compartment_id: Optional[str] = None,
                     filters: Optional[Sequence[pulumi.InputType['GetNosqlTablesFilterArgs']]] = None,
                     name: Optional[str] = None,
                     state: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNosqlTablesResult:
    """
    ...
    test_tables = oci.get_nosql_tables(compartment_id=var["compartment_id"],
        name=var["table_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNosqlTables:GetNosqlTables', __args__, opts=opts, typ=GetNosqlTablesResult).value

    return AwaitableGetNosqlTablesResult(
