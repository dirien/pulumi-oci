...
__all__ = [
    'GetCoreServiceGatewaysResult',
    'AwaitableGetCoreServiceGatewaysResult',
    'get_core_service_gateways',
]

@pulumi.output_type
class GetCoreServiceGatewaysResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreServiceGatewaysFilterResult']]:
    ...
    def service_gateways(self) -> Sequence['outputs.GetCoreServiceGatewaysServiceGatewayResult']:
        """
...
class AwaitableGetCoreServiceGatewaysResult(GetCoreServiceGatewaysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreServiceGatewaysResult(
...
def get_core_service_gateways(compartment_id: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetCoreServiceGatewaysFilterArgs']]] = None,
                              state: Optional[str] = None,
                              vcn_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreServiceGatewaysResult:
    """
    ...
    test_service_gateways = oci.get_core_service_gateways(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreServiceGateways:GetCoreServiceGateways', __args__, opts=opts, typ=GetCoreServiceGatewaysResult).value

    return AwaitableGetCoreServiceGatewaysResult(
