...
__all__ = ['CoreIpsecArgs', 'CoreIpsec']
...
class CoreIpsec(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_ip_sec_connection = oci.CoreIpsec("testIpSecConnection",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreIpsecArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreIpsecArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreIpsecArgs.__new__(CoreIpsecArgs)
        ...
        super(CoreIpsec, __self__).__init__(
            'oci:index/coreIpsec:CoreIpsec',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            static_routes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'CoreIpsec':
        """
        ...
        __props__ = _CoreIpsecState.__new__(_CoreIpsecState)
        ...
        return CoreIpsec(resource_name, opts=opts, __props__=__props__)
