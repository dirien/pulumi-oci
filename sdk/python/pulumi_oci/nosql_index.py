...
__all__ = ['NosqlIndexArgs', 'NosqlIndex']

@pulumi.input_type
class NosqlIndexArgs:
    def __init__(__self__, *,
                 keys: pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]] keys: A set of keys for a secondary index.
    ...
    @property
    @pulumi.getter
    def keys(self) -> pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]]:
        """
    ...
    @keys.setter
    def keys(self, value: pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]]):
...
@pulumi.input_type
class _NosqlIndexState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 is_if_not_exists: Optional[pulumi.Input[bool]] = None,
                 keys: Optional[pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]]]:
        """
        A set of keys for a secondary index.
        """
        return pulumi.get(self, "keys")
    ...
    @keys.setter
    def keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NosqlIndexKeyArgs']]]]):
        pulumi.set(self, "keys", value)
...
class NosqlIndex(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 is_if_not_exists: Optional[pulumi.Input[bool]] = None,
                 keys: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NosqlIndexKeyArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 table_name_or_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_index = oci.NosqlIndex("testIndex",
            keys=[oci.NosqlIndexKeyArgs(
        ...
        :param pulumi.Input[str] compartment_id: The OCID of the table's compartment.  Required if the tableNameOrId path parameter is a table name. Optional if tableNameOrId is an OCID.  If tableNameOrId is an OCID, and compartmentId is supplied, the latter must match the identified table's compartmentId.
        :param pulumi.Input[bool] is_if_not_exists: If true, the operation completes successfully even when the index exists.  Otherwise, an attempt to create an index that already exists will return an error.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NosqlIndexKeyArgs']]]] keys: A set of keys for a secondary index.
        :param pulumi.Input[str] name: Index name.
        :param pulumi.Input[str] table_name_or_id: A table name within the compartment, or a table OCID.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NosqlIndexArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NosqlIndexArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NosqlIndexArgs.__new__(NosqlIndexArgs)
        ...
        super(NosqlIndex, __self__).__init__(
            'oci:index/nosqlIndex:NosqlIndex',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            table_id: Optional[pulumi.Input[str]] = None,
            table_name: Optional[pulumi.Input[str]] = None,
            table_name_or_id: Optional[pulumi.Input[str]] = None) -> 'NosqlIndex':
        """
        ...
        __props__ = _NosqlIndexState.__new__(_NosqlIndexState)
        ...
        __props__.__dict__["table_name_or_id"] = table_name_or_id
        return NosqlIndex(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def keys(self) -> pulumi.Output[Sequence['outputs.NosqlIndexKey']]:
        """
        A set of keys for a secondary index.
        """
        return pulumi.get(self, "keys")
