...
__all__ = [
    'GetDatabaseVmClusterNetworkResult',
    'AwaitableGetDatabaseVmClusterNetworkResult',
    'get_database_vm_cluster_network',
]

@pulumi.output_type
class GetDatabaseVmClusterNetworkResult:
    """
    ...
    @property
    @pulumi.getter
    def scans(self) -> Sequence['outputs.GetDatabaseVmClusterNetworkScanResult']:
        """
        The SCAN details.
        """
    ...
    def vm_networks(self) -> Sequence['outputs.GetDatabaseVmClusterNetworkVmNetworkResult']:
        """
...
class AwaitableGetDatabaseVmClusterNetworkResult(GetDatabaseVmClusterNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterNetworkResult(
...
def get_database_vm_cluster_network(exadata_infrastructure_id: Optional[str] = None,
                                    vm_cluster_network_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterNetworkResult:
    """
    ...
    test_vm_cluster_network = oci.get_database_vm_cluster_network(exadata_infrastructure_id=oci_database_exadata_infrastructure["test_exadata_infrastructure"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterNetwork:GetDatabaseVmClusterNetwork', __args__, opts=opts, typ=GetDatabaseVmClusterNetworkResult).value

    return AwaitableGetDatabaseVmClusterNetworkResult(
