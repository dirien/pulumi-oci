...
__all__ = [
    'GetContainerengineClusterKubeConfigResult',
    'AwaitableGetContainerengineClusterKubeConfigResult',
    'get_containerengine_cluster_kube_config',
]

@pulumi.output_type
class GetContainerengineClusterKubeConfigResult:
    """
...
class AwaitableGetContainerengineClusterKubeConfigResult(GetContainerengineClusterKubeConfigResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetContainerengineClusterKubeConfigResult(
...
def get_containerengine_cluster_kube_config(cluster_id: Optional[str] = None,
                                            endpoint: Optional[str] = None,
                                            expiration: Optional[int] = None,
                                            token_version: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContainerengineClusterKubeConfigResult:
    """
    ...
    test_cluster_kube_config = oci.get_containerengine_cluster_kube_config(cluster_id=oci_containerengine_cluster["test_cluster"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getContainerengineClusterKubeConfig:GetContainerengineClusterKubeConfig', __args__, opts=opts, typ=GetContainerengineClusterKubeConfigResult).value

    return AwaitableGetContainerengineClusterKubeConfigResult(
