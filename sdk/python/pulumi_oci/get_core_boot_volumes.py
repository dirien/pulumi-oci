...
__all__ = [
    'GetCoreBootVolumesResult',
    'AwaitableGetCoreBootVolumesResult',
    'get_core_boot_volumes',
]

@pulumi.output_type
class GetCoreBootVolumesResult:
    """
    ...
    def boot_volumes(self) -> Sequence['outputs.GetCoreBootVolumesBootVolumeResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreBootVolumesFilterResult']]:
...
class AwaitableGetCoreBootVolumesResult(GetCoreBootVolumesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBootVolumesResult(
...
def get_core_boot_volumes(availability_domain: Optional[str] = None,
                          compartment_id: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetCoreBootVolumesFilterArgs']]] = None,
                          volume_group_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBootVolumesResult:
    """
    ...
    test_boot_volumes = oci.get_core_boot_volumes(availability_domain=var["boot_volume_availability_domain"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBootVolumes:GetCoreBootVolumes', __args__, opts=opts, typ=GetCoreBootVolumesResult).value

    return AwaitableGetCoreBootVolumesResult(
