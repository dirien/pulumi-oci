...
__all__ = [
    'GetBudgetAlertRuleResult',
    'AwaitableGetBudgetAlertRuleResult',
    'get_budget_alert_rule',
]

@pulumi.output_type
class GetBudgetAlertRuleResult:
    """
...
class AwaitableGetBudgetAlertRuleResult(GetBudgetAlertRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBudgetAlertRuleResult(
...
def get_budget_alert_rule(alert_rule_id: Optional[str] = None,
                          budget_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBudgetAlertRuleResult:
    """
    ...
    test_alert_rule = oci.get_budget_alert_rule(alert_rule_id=oci_budget_alert_rule["test_alert_rule"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBudgetAlertRule:GetBudgetAlertRule', __args__, opts=opts, typ=GetBudgetAlertRuleResult).value

    return AwaitableGetBudgetAlertRuleResult(
