...
__all__ = [
    'GetDatabaseDbNodeConsoleConnectionResult',
    'AwaitableGetDatabaseDbNodeConsoleConnectionResult',
    'get_database_db_node_console_connection',
]

@pulumi.output_type
class GetDatabaseDbNodeConsoleConnectionResult:
    """
...
class AwaitableGetDatabaseDbNodeConsoleConnectionResult(GetDatabaseDbNodeConsoleConnectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbNodeConsoleConnectionResult(
...
def get_database_db_node_console_connection(db_node_id: Optional[str] = None,
                                            id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbNodeConsoleConnectionResult:
    """
    ...
    test_db_node_console_connection = oci.get_database_db_node_console_connection(db_node_id=oci_database_db_node["test_db_node"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbNodeConsoleConnection:GetDatabaseDbNodeConsoleConnection', __args__, opts=opts, typ=GetDatabaseDbNodeConsoleConnectionResult).value

    return AwaitableGetDatabaseDbNodeConsoleConnectionResult(
