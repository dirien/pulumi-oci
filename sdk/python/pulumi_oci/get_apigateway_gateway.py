...
__all__ = [
    'GetApigatewayGatewayResult',
    'AwaitableGetApigatewayGatewayResult',
    'get_apigateway_gateway',
]

@pulumi.output_type
class GetApigatewayGatewayResult:
    """
    ...
    def ip_addresses(self) -> Sequence['outputs.GetApigatewayGatewayIpAddressResult']:
        """
    ...
    def response_cache_details(self) -> 'outputs.GetApigatewayGatewayResponseCacheDetailsResult':
        """
...
class AwaitableGetApigatewayGatewayResult(GetApigatewayGatewayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApigatewayGatewayResult(
...
def get_apigateway_gateway(gateway_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApigatewayGatewayResult:
    """
    ...
    test_gateway = oci.get_apigateway_gateway(gateway_id=oci_apigateway_gateway["test_gateway"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApigatewayGateway:GetApigatewayGateway', __args__, opts=opts, typ=GetApigatewayGatewayResult).value

    return AwaitableGetApigatewayGatewayResult(
