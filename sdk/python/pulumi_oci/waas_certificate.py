...
__all__ = ['WaasCertificateArgs', 'WaasCertificate']

@pulumi.input_type
class WaasCertificateArgs:
...
@pulumi.input_type
class _WaasCertificateState:
    def __init__(__self__, *,
                 certificate_data: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 extensions: Optional[pulumi.Input[Sequence[pulumi.Input['WaasCertificateExtensionArgs']]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 is_trust_verification_disabled: Optional[pulumi.Input[bool]] = None,
                 issued_by: Optional[pulumi.Input[str]] = None,
                 issuer_name: Optional[pulumi.Input['WaasCertificateIssuerNameArgs']] = None,
                 private_key_data: Optional[pulumi.Input[str]] = None,
                 public_key_info: Optional[pulumi.Input['WaasCertificatePublicKeyInfoArgs']] = None,
                 serial_number: Optional[pulumi.Input[str]] = None,
                 signature_algorithm: Optional[pulumi.Input[str]] = None,
                 state: Optional[pulumi.Input[str]] = None,
                 subject_name: Optional[pulumi.Input['WaasCertificateSubjectNameArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the SSL certificate. The name can be changed and does not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input['WaasCertificateExtensionArgs']]] extensions: Additional attributes associated with users or public keys for managing relationships between Certificate Authorities.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_trust_verification_disabled: Set to `true` if the SSL certificate is self-signed.
        :param pulumi.Input['WaasCertificateIssuerNameArgs'] issuer_name: The issuer of the certificate.
        :param pulumi.Input[str] private_key_data: The private key of the SSL certificate.
        :param pulumi.Input['WaasCertificatePublicKeyInfoArgs'] public_key_info: Information about the public key and the algorithm used by the public key.
        ...
        :param pulumi.Input['WaasCertificateSubjectNameArgs'] subject_name: The entity to be secured by the certificate.
    ...
    @property
    @pulumi.getter
    def extensions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['WaasCertificateExtensionArgs']]]]:
        """
    ...
    @extensions.setter
    def extensions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['WaasCertificateExtensionArgs']]]]):
    ...
    def issuer_name(self) -> Optional[pulumi.Input['WaasCertificateIssuerNameArgs']]:
        """
    ...
    @issuer_name.setter
    def issuer_name(self, value: Optional[pulumi.Input['WaasCertificateIssuerNameArgs']]):
    ...
    def public_key_info(self) -> Optional[pulumi.Input['WaasCertificatePublicKeyInfoArgs']]:
        """
    ...
    def public_key_info(self, value: Optional[pulumi.Input['WaasCertificatePublicKeyInfoArgs']]):
        pulumi.set(self, "public_key_info", value)
    ...
    def subject_name(self) -> Optional[pulumi.Input['WaasCertificateSubjectNameArgs']]:
        """
    ...
    @subject_name.setter
    def subject_name(self, value: Optional[pulumi.Input['WaasCertificateSubjectNameArgs']]):
...
class WaasCertificate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_certificate = oci.WaasCertificate("testCertificate",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param WaasCertificateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WaasCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WaasCertificateArgs.__new__(WaasCertificateArgs)
            ...
            __props__.__dict__["public_key_info"] = None
        ...
        super(WaasCertificate, __self__).__init__(
            'oci:index/waasCertificate:WaasCertificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            extensions: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WaasCertificateExtensionArgs']]]]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            is_trust_verification_disabled: Optional[pulumi.Input[bool]] = None,
            issued_by: Optional[pulumi.Input[str]] = None,
            issuer_name: Optional[pulumi.Input[pulumi.InputType['WaasCertificateIssuerNameArgs']]] = None,
            private_key_data: Optional[pulumi.Input[str]] = None,
            public_key_info: Optional[pulumi.Input[pulumi.InputType['WaasCertificatePublicKeyInfoArgs']]] = None,
            serial_number: Optional[pulumi.Input[str]] = None,
            signature_algorithm: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            subject_name: Optional[pulumi.Input[pulumi.InputType['WaasCertificateSubjectNameArgs']]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_not_valid_after: Optional[pulumi.Input[str]] = None,
            time_not_valid_before: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[int]] = None) -> 'WaasCertificate':
        """
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the SSL certificate. The name can be changed and does not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['WaasCertificateExtensionArgs']]]] extensions: Additional attributes associated with users or public keys for managing relationships between Certificate Authorities.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[bool] is_trust_verification_disabled: Set to `true` if the SSL certificate is self-signed.
        :param pulumi.Input[pulumi.InputType['WaasCertificateIssuerNameArgs']] issuer_name: The issuer of the certificate.
        :param pulumi.Input[str] private_key_data: The private key of the SSL certificate.
        :param pulumi.Input[pulumi.InputType['WaasCertificatePublicKeyInfoArgs']] public_key_info: Information about the public key and the algorithm used by the public key.
        :param pulumi.Input[str] serial_number: A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
        :param pulumi.Input[str] signature_algorithm: The identifier for the cryptographic algorithm used by the Certificate Authority (CA) to sign this certificate.
        :param pulumi.Input[str] state: The current lifecycle state of the SSL certificate.
        :param pulumi.Input[pulumi.InputType['WaasCertificateSubjectNameArgs']] subject_name: The entity to be secured by the certificate.
        :param pulumi.Input[str] time_created: The date and time the certificate was created, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[str] time_not_valid_after: The date and time the certificate will expire, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[str] time_not_valid_before: The date and time the certificate will become valid, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[int] version: The version of the encoded certificate.
        ...
        __props__ = _WaasCertificateState.__new__(_WaasCertificateState)
        ...
        __props__.__dict__["private_key_data"] = private_key_data
        __props__.__dict__["public_key_info"] = public_key_info
        ...
        return WaasCertificate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def extensions(self) -> pulumi.Output[Sequence['outputs.WaasCertificateExtension']]:
        """
        Additional attributes associated with users or public keys for managing relationships between Certificate Authorities.
        """
        return pulumi.get(self, "extensions")
    ...
    @property
    @pulumi.getter(name="issuerName")
    def issuer_name(self) -> pulumi.Output['outputs.WaasCertificateIssuerName']:
        """
        The issuer of the certificate.
        """
        return pulumi.get(self, "issuer_name")
    ...
    @property
    @pulumi.getter(name="publicKeyInfo")
    def public_key_info(self) -> pulumi.Output['outputs.WaasCertificatePublicKeyInfo']:
        """
        Information about the public key and the algorithm used by the public key.
        """
        return pulumi.get(self, "public_key_info")
    ...
    @property
    @pulumi.getter(name="subjectName")
    def subject_name(self) -> pulumi.Output['outputs.WaasCertificateSubjectName']:
        """
        The entity to be secured by the certificate.
        """
        return pulumi.get(self, "subject_name")
