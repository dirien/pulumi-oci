...
__all__ = [
    'GetCoreComputeGlobalImageCapabilitySchemasVersionsResult',
    'AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionsResult',
    'get_core_compute_global_image_capability_schemas_versions',
]

@pulumi.output_type
class GetCoreComputeGlobalImageCapabilitySchemasVersionsResult:
    """
    ...
    def compute_global_image_capability_schema_versions(self) -> Sequence['outputs.GetCoreComputeGlobalImageCapabilitySchemasVersionsComputeGlobalImageCapabilitySchemaVersionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreComputeGlobalImageCapabilitySchemasVersionsFilterResult']]:
...
class AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionsResult(GetCoreComputeGlobalImageCapabilitySchemasVersionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeGlobalImageCapabilitySchemasVersionsResult(
...
def get_core_compute_global_image_capability_schemas_versions(compute_global_image_capability_schema_id: Optional[str] = None,
                                                              display_name: Optional[str] = None,
                                                              filters: Optional[Sequence[pulumi.InputType['GetCoreComputeGlobalImageCapabilitySchemasVersionsFilterArgs']]] = None,
                                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionsResult:
    """
    ...
    test_compute_global_image_capability_schemas_versions = oci.get_core_compute_global_image_capability_schemas_versions(compute_global_image_capability_schema_id=oci_core_compute_global_image_capability_schema["test_compute_global_image_capability_schema"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeGlobalImageCapabilitySchemasVersions:GetCoreComputeGlobalImageCapabilitySchemasVersions', __args__, opts=opts, typ=GetCoreComputeGlobalImageCapabilitySchemasVersionsResult).value

    return AwaitableGetCoreComputeGlobalImageCapabilitySchemasVersionsResult(
