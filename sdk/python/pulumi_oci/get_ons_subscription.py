...
__all__ = [
    'GetOnsSubscriptionResult',
    'AwaitableGetOnsSubscriptionResult',
    'get_ons_subscription',
]

@pulumi.output_type
class GetOnsSubscriptionResult:
    """
...
class AwaitableGetOnsSubscriptionResult(GetOnsSubscriptionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOnsSubscriptionResult(
...
def get_ons_subscription(subscription_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOnsSubscriptionResult:
    """
    ...
    test_subscription = oci.get_ons_subscription(subscription_id=oci_ons_subscription["test_subscription"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOnsSubscription:GetOnsSubscription', __args__, opts=opts, typ=GetOnsSubscriptionResult).value

    return AwaitableGetOnsSubscriptionResult(
