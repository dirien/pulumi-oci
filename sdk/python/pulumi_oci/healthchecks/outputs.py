...
__all__ = [
    ...
    'GetHttpProbeResultsHttpProbeResultDnsResult',
    ...
    'GetPingProbeResultsPingProbeResultDnsResult',
...
class GetHttpProbeResultsHttpProbeResultResult(dict):
    def __init__(__self__, *,
                 connect_end: float,
                 connect_start: float,
                 connection: 'outputs.GetHttpProbeResultsHttpProbeResultConnectionResult',
                 dns: 'outputs.GetHttpProbeResultsHttpProbeResultDnsResult',
        ...
        :param 'GetHttpProbeResultsHttpProbeResultConnectionArgs' connection: TCP connection results.  All durations are in milliseconds.
        :param 'GetHttpProbeResultsHttpProbeResultDnsArgs' dns: The DNS resolution results.
    ...
    @property
    @pulumi.getter
    def connection(self) -> 'outputs.GetHttpProbeResultsHttpProbeResultConnectionResult':
        """
    ...
    @property
    @pulumi.getter
    def dns(self) -> 'outputs.GetHttpProbeResultsHttpProbeResultDnsResult':
        """
...
@pulumi.output_type
class GetHttpProbeResultsHttpProbeResultDnsResult(dict):
    def __init__(__self__, *,
...
class GetPingProbeResultsPingProbeResultResult(dict):
    def __init__(__self__, *,
                 connection: 'outputs.GetPingProbeResultsPingProbeResultConnectionResult',
                 dns: 'outputs.GetPingProbeResultsPingProbeResultDnsResult',
                 domain_lookup_end: float,
                 domain_lookup_start: float,
                 error_category: str,
                 error_message: str,
                 ...
                 vantage_point_name: str):
        """
        :param 'GetPingProbeResultsPingProbeResultConnectionArgs' connection: The network connection results.
        :param 'GetPingProbeResultsPingProbeResultDnsArgs' dns: The DNS resolution results.
        :param float domain_lookup_end: The time immediately before the vantage point finishes the domain name lookup for the resource.
        :param float domain_lookup_start: The time immediately before the vantage point starts the domain name lookup for the resource.
        :param str error_category: The category of error if an error occurs executing the probe. The `errorMessage` field provides a message with the error details.
               * NONE - No error
    ...
    @property
    @pulumi.getter
    def connection(self) -> 'outputs.GetPingProbeResultsPingProbeResultConnectionResult':
        """
    ...
    @property
    @pulumi.getter
    def dns(self) -> 'outputs.GetPingProbeResultsPingProbeResultDnsResult':
        """
        The DNS resolution results.
        """
        return pulumi.get(self, "dns")
...
@pulumi.output_type
class GetPingProbeResultsPingProbeResultDnsResult(dict):
    def __init__(__self__, *,
                 addresses: Sequence[str],
                 domain_lookup_duration: float):
        """
...
class GetVantagePointsHealthChecksVantagePointResult(dict):
    def __init__(__self__, *,
                 display_name: str,
                 geo: 'outputs.GetVantagePointsHealthChecksVantagePointGeoResult',
                 name: str,
                 provider_name: str,
                 routings: Sequence['outputs.GetVantagePointsHealthChecksVantagePointRoutingResult']):
        """
        :param str display_name: Filters results that exactly match the `displayName` field.
        :param 'GetVantagePointsHealthChecksVantagePointGeoArgs' geo: Geographic information about a vantage point.
        :param str name: Filters results that exactly match the `name` field.
    ...
    @property
    @pulumi.getter
    def geo(self) -> 'outputs.GetVantagePointsHealthChecksVantagePointGeoResult':
        """
