...
__all__ = ['BlockchainPeerArgs', 'BlockchainPeer']

@pulumi.input_type
class BlockchainPeerArgs:
    def __init__(__self__, *,
                 ad: pulumi.Input[str],
                 blockchain_platform_id: pulumi.Input[str],
                 ocpu_allocation_param: pulumi.Input['BlockchainPeerOcpuAllocationParamArgs'],
        ...
        :param pulumi.Input['BlockchainPeerOcpuAllocationParamArgs'] ocpu_allocation_param: (Updatable) OCPU allocation parameter
    ...
    def ocpu_allocation_param(self) -> pulumi.Input['BlockchainPeerOcpuAllocationParamArgs']:
        """
    ...
    def ocpu_allocation_param(self, value: pulumi.Input['BlockchainPeerOcpuAllocationParamArgs']):
...
@pulumi.input_type
class _BlockchainPeerState:
    def __init__(__self__, *,
                 ad: Optional[pulumi.Input[str]] = None,
                 alias: Optional[pulumi.Input[str]] = None,
                 blockchain_platform_id: Optional[pulumi.Input[str]] = None,
                 host: Optional[pulumi.Input[str]] = None,
                 ocpu_allocation_param: Optional[pulumi.Input['BlockchainPeerOcpuAllocationParamArgs']] = None,
    ...
    @property
    @pulumi.getter(name="ocpuAllocationParam")
    def ocpu_allocation_param(self) -> Optional[pulumi.Input['BlockchainPeerOcpuAllocationParamArgs']]:
        """
        (Updatable) OCPU allocation parameter
        """
        return pulumi.get(self, "ocpu_allocation_param")
    ...
    @ocpu_allocation_param.setter
    def ocpu_allocation_param(self, value: Optional[pulumi.Input['BlockchainPeerOcpuAllocationParamArgs']]):
        pulumi.set(self, "ocpu_allocation_param", value)
...
class BlockchainPeer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 alias: Optional[pulumi.Input[str]] = None,
                 blockchain_platform_id: Optional[pulumi.Input[str]] = None,
                 ocpu_allocation_param: Optional[pulumi.Input[pulumi.InputType['BlockchainPeerOcpuAllocationParamArgs']]] = None,
                 role: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_peer = oci.BlockchainPeer("testPeer",
            ad=var["peer_ad"],
            blockchain_platform_id=oci_blockchain_blockchain_platform["test_blockchain_platform"]["id"],
            ocpu_allocation_param=oci.BlockchainPeerOcpuAllocationParamArgs(
        ...
        :param pulumi.Input[str] alias: peer alias
        :param pulumi.Input[str] blockchain_platform_id: Unique service identifier.
        :param pulumi.Input[pulumi.InputType['BlockchainPeerOcpuAllocationParamArgs']] ocpu_allocation_param: (Updatable) OCPU allocation parameter
        :param pulumi.Input[str] role: Peer role
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BlockchainPeerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlockchainPeerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BlockchainPeerArgs.__new__(BlockchainPeerArgs)
        ...
        super(BlockchainPeer, __self__).__init__(
            'oci:index/blockchainPeer:BlockchainPeer',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            peer_key: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'BlockchainPeer':
        """
        ...
        __props__ = _BlockchainPeerState.__new__(_BlockchainPeerState)
        ...
        return BlockchainPeer(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="ocpuAllocationParam")
    def ocpu_allocation_param(self) -> pulumi.Output['outputs.BlockchainPeerOcpuAllocationParam']:
        """
        (Updatable) OCPU allocation parameter
        """
        return pulumi.get(self, "ocpu_allocation_param")
