...
__all__ = [
    'GetObjectstoragePreauthrequestResult',
    'AwaitableGetObjectstoragePreauthrequestResult',
    'get_objectstorage_preauthrequest',
]

@pulumi.output_type
class GetObjectstoragePreauthrequestResult:
    """
...
class AwaitableGetObjectstoragePreauthrequestResult(GetObjectstoragePreauthrequestResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstoragePreauthrequestResult(
...
def get_objectstorage_preauthrequest(bucket: Optional[str] = None,
                                     namespace: Optional[str] = None,
                                     par_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstoragePreauthrequestResult:
    """
    ...
    test_preauthenticated_request = oci.get_objectstorage_preauthrequest(bucket=var["preauthenticated_request_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstoragePreauthrequest:GetObjectstoragePreauthrequest', __args__, opts=opts, typ=GetObjectstoragePreauthrequestResult).value

    return AwaitableGetObjectstoragePreauthrequestResult(
