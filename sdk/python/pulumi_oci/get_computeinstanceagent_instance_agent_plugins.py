...
__all__ = [
    'GetComputeinstanceagentInstanceAgentPluginsResult',
    'AwaitableGetComputeinstanceagentInstanceAgentPluginsResult',
    'get_computeinstanceagent_instance_agent_plugins',
]

@pulumi.output_type
class GetComputeinstanceagentInstanceAgentPluginsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetComputeinstanceagentInstanceAgentPluginsFilterResult']]:
    ...
    def instance_agent_plugins(self) -> Sequence['outputs.GetComputeinstanceagentInstanceAgentPluginsInstanceAgentPluginResult']:
        """
...
class AwaitableGetComputeinstanceagentInstanceAgentPluginsResult(GetComputeinstanceagentInstanceAgentPluginsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeinstanceagentInstanceAgentPluginsResult(
...
def get_computeinstanceagent_instance_agent_plugins(compartment_id: Optional[str] = None,
                                                    filters: Optional[Sequence[pulumi.InputType['GetComputeinstanceagentInstanceAgentPluginsFilterArgs']]] = None,
                                                    instanceagent_id: Optional[str] = None,
                                                    name: Optional[str] = None,
                                                    status: Optional[str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeinstanceagentInstanceAgentPluginsResult:
    """
    ...
    test_instance_agent_plugins = oci.get_computeinstanceagent_instance_agent_plugins(instanceagent_id=oci_computeinstanceagent_instanceagent["test_instanceagent"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getComputeinstanceagentInstanceAgentPlugins:GetComputeinstanceagentInstanceAgentPlugins', __args__, opts=opts, typ=GetComputeinstanceagentInstanceAgentPluginsResult).value

    return AwaitableGetComputeinstanceagentInstanceAgentPluginsResult(
