...
__all__ = ['MysqlMysqlBackupArgs', 'MysqlMysqlBackup']

@pulumi.input_type
class MysqlMysqlBackupArgs:
...
class _MysqlMysqlBackupState:
    def __init__(__self__, *,
                 ...
                 db_system_snapshot: Optional[pulumi.Input['MysqlMysqlBackupDbSystemSnapshotArgs']] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input[str] backup_type: The type of backup.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
        :param pulumi.Input[str] creation_type: If the backup was created automatically, or by a manual request.
        :param pulumi.Input[int] data_storage_size_in_gb: Initial size of the data volume in GiBs that will be created and attached.
        :param pulumi.Input[str] db_system_id: The OCID of the DB System the Backup is associated with.
        :param pulumi.Input['MysqlMysqlBackupDbSystemSnapshotArgs'] db_system_snapshot: Snapshot of the DbSystem details at the time of the backup
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] description: (Updatable) A user-supplied description for the backup.
        :param pulumi.Input[str] display_name: (Updatable) A user-supplied display name for the backup.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        if db_system_id is not None:
            pulumi.set(__self__, "db_system_id", db_system_id)
        if db_system_snapshot is not None:
    ...
    def db_system_snapshot(self) -> Optional[pulumi.Input['MysqlMysqlBackupDbSystemSnapshotArgs']]:
        """
    ...
    def db_system_snapshot(self, value: Optional[pulumi.Input['MysqlMysqlBackupDbSystemSnapshotArgs']]):
        pulumi.set(self, "db_system_snapshot", value)
...
class MysqlMysqlBackup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_mysql_backup = oci.MysqlMysqlBackup("testMysqlBackup",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MysqlMysqlBackupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MysqlMysqlBackupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MysqlMysqlBackupArgs.__new__(MysqlMysqlBackupArgs)
            ...
            __props__.__dict__["db_system_snapshot"] = None
        ...
        super(MysqlMysqlBackup, __self__).__init__(
            'oci:index/mysqlMysqlBackup:MysqlMysqlBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            data_storage_size_in_gb: Optional[pulumi.Input[int]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            db_system_snapshot: Optional[pulumi.Input[pulumi.InputType['MysqlMysqlBackupDbSystemSnapshotArgs']]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            description: Optional[pulumi.Input[str]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'MysqlMysqlBackup':
        """
        ...
        :param pulumi.Input[int] data_storage_size_in_gb: Initial size of the data volume in GiBs that will be created and attached.
        :param pulumi.Input[str] db_system_id: The OCID of the DB System the Backup is associated with.
        :param pulumi.Input[pulumi.InputType['MysqlMysqlBackupDbSystemSnapshotArgs']] db_system_snapshot: Snapshot of the DbSystem details at the time of the backup
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] description: (Updatable) A user-supplied description for the backup.
        :param pulumi.Input[str] display_name: (Updatable) A user-supplied display name for the backup.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        __props__ = _MysqlMysqlBackupState.__new__(_MysqlMysqlBackupState)
        ...
        __props__.__dict__["db_system_id"] = db_system_id
        __props__.__dict__["db_system_snapshot"] = db_system_snapshot
        __props__.__dict__["defined_tags"] = defined_tags
        __props__.__dict__["description"] = description
        __props__.__dict__["display_name"] = display_name
        __props__.__dict__["freeform_tags"] = freeform_tags
        ...
        return MysqlMysqlBackup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dbSystemSnapshot")
    def db_system_snapshot(self) -> pulumi.Output['outputs.MysqlMysqlBackupDbSystemSnapshot']:
        """
        Snapshot of the DbSystem details at the time of the backup
        """
        return pulumi.get(self, "db_system_snapshot")
