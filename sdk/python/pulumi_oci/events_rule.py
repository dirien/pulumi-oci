...
__all__ = ['EventsRuleArgs', 'EventsRule']

@pulumi.input_type
class EventsRuleArgs:
    def __init__(__self__, *,
                 actions: pulumi.Input['EventsRuleActionsArgs'],
        ...
        :param pulumi.Input['EventsRuleActionsArgs'] actions: (Updatable) A list of one or more ActionDetails objects.
    ...
    @property
    @pulumi.getter
    def actions(self) -> pulumi.Input['EventsRuleActionsArgs']:
        """
    ...
    @actions.setter
    def actions(self, value: pulumi.Input['EventsRuleActionsArgs']):
...
@pulumi.input_type
class _EventsRuleState:
    def __init__(__self__, *,
                 actions: Optional[pulumi.Input['EventsRuleActionsArgs']] = None,
    ...
    @property
    @pulumi.getter
    def actions(self) -> Optional[pulumi.Input['EventsRuleActionsArgs']]:
        """
        (Updatable) A list of one or more ActionDetails objects.
        """
        return pulumi.get(self, "actions")
    ...
    @actions.setter
    def actions(self, value: Optional[pulumi.Input['EventsRuleActionsArgs']]):
        pulumi.set(self, "actions", value)
...
class EventsRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 actions: Optional[pulumi.Input[pulumi.InputType['EventsRuleActionsArgs']]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 condition: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
        ...
        test_rule = oci.EventsRule("testRule",
            actions=oci.EventsRuleActionsArgs(
                actions=[oci.EventsRuleActionsActionArgs(
        ...
        :param pulumi.Input[pulumi.InputType['EventsRuleActionsArgs']] actions: (Updatable) A list of one or more ActionDetails objects.
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to which this rule belongs.
        :param pulumi.Input[str] condition: (Updatable) A filter that specifies the event that will trigger actions associated with this rule. A few  important things to remember about filters:
               * Fields not mentioned in the condition are ignored. You can create a valid filter that matches all events with two curly brackets: `{}`
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EventsRuleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EventsRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EventsRuleArgs.__new__(EventsRuleArgs)
        ...
        super(EventsRule, __self__).__init__(
            'oci:index/eventsRule:EventsRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            lifecycle_message: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'EventsRule':
        """
        ...
        __props__ = _EventsRuleState.__new__(_EventsRuleState)
        ...
        return EventsRule(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def actions(self) -> pulumi.Output['outputs.EventsRuleActions']:
        """
        (Updatable) A list of one or more ActionDetails objects.
        """
        return pulumi.get(self, "actions")
