...
def get_dns_view(scope: Optional[str] = None,
    ...
    test_view = oci.get_dns_view(view_id=oci_dns_view["test_view"]["id"],
        scope="PRIVATE")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsView:GetDnsView', __args__, opts=opts, typ=GetDnsViewResult).value
