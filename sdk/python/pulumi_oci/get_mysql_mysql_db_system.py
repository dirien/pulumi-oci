...
__all__ = [
    'GetMysqlMysqlDbSystemResult',
    'AwaitableGetMysqlMysqlDbSystemResult',
    'get_mysql_mysql_db_system',
]

@pulumi.output_type
class GetMysqlMysqlDbSystemResult:
    """
    A collection of values returned by GetMysqlMysqlDbSystem.
    """
    def __init__(__self__, admin_password=None, admin_username=None, analytics_cluster=None, availability_domain=None, backup_policy=None, channels=None, compartment_id=None, configuration_id=None, current_placement=None, data_storage_size_in_gb=None, db_system_id=None, defined_tags=None, description=None, display_name=None, endpoints=None, fault_domain=None, freeform_tags=None, heat_wave_cluster=None, hostname_label=None, id=None, ip_address=None, is_analytics_cluster_attached=None, is_heat_wave_cluster_attached=None, is_highly_available=None, lifecycle_details=None, maintenance=None, mysql_version=None, port=None, port_x=None, shape_name=None, shutdown_type=None, source=None, state=None, subnet_id=None, time_created=None, time_updated=None):
        ...
        if analytics_cluster and not isinstance(analytics_cluster, dict):
            raise TypeError("Expected argument 'analytics_cluster' to be a dict")
        ...
        if current_placement and not isinstance(current_placement, dict):
            raise TypeError("Expected argument 'current_placement' to be a dict")
        ...
        if heat_wave_cluster and not isinstance(heat_wave_cluster, dict):
            raise TypeError("Expected argument 'heat_wave_cluster' to be a dict")
    ...
    def analytics_cluster(self) -> 'outputs.GetMysqlMysqlDbSystemAnalyticsClusterResult':
        """
    ...
    def backup_policy(self) -> 'outputs.GetMysqlMysqlDbSystemBackupPolicyResult':
        """
    ...
    @property
    @pulumi.getter
    def channels(self) -> Sequence['outputs.GetMysqlMysqlDbSystemChannelResult']:
        """
    ...
    def current_placement(self) -> 'outputs.GetMysqlMysqlDbSystemCurrentPlacementResult':
        """
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Sequence['outputs.GetMysqlMysqlDbSystemEndpointResult']:
        """
    ...
    def heat_wave_cluster(self) -> 'outputs.GetMysqlMysqlDbSystemHeatWaveClusterResult':
        """
    ...
    @property
    @pulumi.getter
    def maintenance(self) -> 'outputs.GetMysqlMysqlDbSystemMaintenanceResult':
        """
    ...
    @property
    @pulumi.getter
    def source(self) -> 'outputs.GetMysqlMysqlDbSystemSourceResult':
        """
...
class AwaitableGetMysqlMysqlDbSystemResult(GetMysqlMysqlDbSystemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlMysqlDbSystemResult(
            admin_password=self.admin_password,
            admin_username=self.admin_username,
            analytics_cluster=self.analytics_cluster,
            ...
            heat_wave_cluster=self.heat_wave_cluster,
...
def get_mysql_mysql_db_system(db_system_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlMysqlDbSystemResult:
    """
    ...
    test_mysql_db_system = oci.get_mysql_mysql_db_system(db_system_id=oci_mysql_mysql_db_system["test_db_system"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlMysqlDbSystem:GetMysqlMysqlDbSystem', __args__, opts=opts, typ=GetMysqlMysqlDbSystemResult).value

    return AwaitableGetMysqlMysqlDbSystemResult(
        admin_password=__ret__.admin_password,
        admin_username=__ret__.admin_username,
        analytics_cluster=__ret__.analytics_cluster,
        availability_domain=__ret__.availability_domain,
        backup_policy=__ret__.backup_policy,
        channels=__ret__.channels,
        compartment_id=__ret__.compartment_id,
        configuration_id=__ret__.configuration_id,
        current_placement=__ret__.current_placement,
        ...
        heat_wave_cluster=__ret__.heat_wave_cluster,
