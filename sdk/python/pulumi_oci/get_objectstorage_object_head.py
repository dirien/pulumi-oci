...
__all__ = [
    'GetObjectstorageObjectHeadResult',
    'AwaitableGetObjectstorageObjectHeadResult',
    'get_objectstorage_object_head',
]

@pulumi.output_type
class GetObjectstorageObjectHeadResult:
    """
...
class AwaitableGetObjectstorageObjectHeadResult(GetObjectstorageObjectHeadResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageObjectHeadResult(
...
def get_objectstorage_object_head(bucket: Optional[str] = None,
                                  namespace: Optional[str] = None,
                                  object: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageObjectHeadResult:
    """
    ...
    test_object_head = oci.get_objectstorage_object_head(bucket=var["object_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageObjectHead:GetObjectstorageObjectHead', __args__, opts=opts, typ=GetObjectstorageObjectHeadResult).value

    return AwaitableGetObjectstorageObjectHeadResult(
