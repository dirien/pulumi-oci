...
__all__ = [
    'GetWaasCustomProtectionRulesResult',
    'AwaitableGetWaasCustomProtectionRulesResult',
    'get_waas_custom_protection_rules',
]

@pulumi.output_type
class GetWaasCustomProtectionRulesResult:
    """
    ...
    def custom_protection_rules(self) -> Sequence['outputs.GetWaasCustomProtectionRulesCustomProtectionRuleResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetWaasCustomProtectionRulesFilterResult']]:
...
class AwaitableGetWaasCustomProtectionRulesResult(GetWaasCustomProtectionRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasCustomProtectionRulesResult(
...
def get_waas_custom_protection_rules(compartment_id: Optional[str] = None,
                                     display_names: Optional[Sequence[str]] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetWaasCustomProtectionRulesFilterArgs']]] = None,
                                     ids: Optional[Sequence[str]] = None,
                                     states: Optional[Sequence[str]] = None,
                                     time_created_greater_than_or_equal_to: Optional[str] = None,
                                     time_created_less_than: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasCustomProtectionRulesResult:
    """
    ...
    test_custom_protection_rules = oci.get_waas_custom_protection_rules(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasCustomProtectionRules:GetWaasCustomProtectionRules', __args__, opts=opts, typ=GetWaasCustomProtectionRulesResult).value

    return AwaitableGetWaasCustomProtectionRulesResult(
