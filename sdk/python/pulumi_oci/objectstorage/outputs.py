...
__all__ = [
    'ObjectstorageBucketRetentionRule',
    'ObjectstorageBucketRetentionRuleDuration',
    'ObjectstorageObjectLifecyclePolicyRule',
    'ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter',
    'ObjectstorageObjectSourceUriDetails',
...
@pulumi.output_type
class ObjectstorageBucketRetentionRule(dict):
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ObjectstorageBucketRetentionRule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ObjectstorageBucketRetentionRule.__key_warning(key)
    ...
    def __init__(__self__, *,
                 display_name: str,
                 duration: Optional['outputs.ObjectstorageBucketRetentionRuleDuration'] = None,
        ...
        :param 'ObjectstorageBucketRetentionRuleDurationArgs' duration: (Updatable)
    ...
    @property
    @pulumi.getter
    def duration(self) -> Optional['outputs.ObjectstorageBucketRetentionRuleDuration']:
        """
        (Updatable)
        """
...
@pulumi.output_type
class ObjectstorageBucketRetentionRuleDuration(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "timeAmount":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ObjectstorageBucketRetentionRuleDuration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ObjectstorageBucketRetentionRuleDuration.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class ObjectstorageObjectLifecyclePolicyRule(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "isEnabled":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ObjectstorageObjectLifecyclePolicyRule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ObjectstorageObjectLifecyclePolicyRule.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 time_amount: str,
                 time_unit: str,
                 object_name_filter: Optional['outputs.ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter'] = None,
    ...
    def object_name_filter(self) -> Optional['outputs.ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter']:
        """
        (Updatable) A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
        """
...
@pulumi.output_type
class ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ObjectstorageObjectLifecyclePolicyRuleObjectNameFilter.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class ObjectstorageObjectSourceUriDetails(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ObjectstorageObjectSourceUriDetails. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ObjectstorageObjectSourceUriDetails.__key_warning(key)
        return super().__getitem__(key)
...
class GetBucketRetentionRuleResult(dict):
    def __init__(__self__, *,
                 display_name: str,
                 duration: 'outputs.GetBucketRetentionRuleDurationResult',
    ...
    @property
    @pulumi.getter
    def duration(self) -> 'outputs.GetBucketRetentionRuleDurationResult':
        return pulumi.get(self, "duration")
...
class GetBucketSummariesBucketSummaryRetentionRuleResult(dict):
    def __init__(__self__, *,
                 display_name: str,
                 duration: 'outputs.GetBucketSummariesBucketSummaryRetentionRuleDurationResult',
                 retention_rule_id: str,
                 time_created: str,
                 time_modified: str,
                 time_rule_locked: str):
    ...
    @property
    @pulumi.getter
    def duration(self) -> 'outputs.GetBucketSummariesBucketSummaryRetentionRuleDurationResult':
        return pulumi.get(self, "duration")
...
class GetObjectLifecyclePolicyRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 is_enabled: bool,
                 name: str,
                 object_name_filter: 'outputs.GetObjectLifecyclePolicyRuleObjectNameFilterResult',
                 target: str,
                 time_amount: str,
                 time_unit: str):
        """
        ...
        :param 'GetObjectLifecyclePolicyRuleObjectNameFilterArgs' object_name_filter: A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
    ...
    @property
    @pulumi.getter(name="objectNameFilter")
    def object_name_filter(self) -> 'outputs.GetObjectLifecyclePolicyRuleObjectNameFilterResult':
        """
