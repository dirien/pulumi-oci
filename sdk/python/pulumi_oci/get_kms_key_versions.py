...
__all__ = [
    'GetKmsKeyVersionsResult',
    'AwaitableGetKmsKeyVersionsResult',
    'get_kms_key_versions',
]

@pulumi.output_type
class GetKmsKeyVersionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetKmsKeyVersionsFilterResult']]:
    ...
    def key_versions(self) -> Sequence['outputs.GetKmsKeyVersionsKeyVersionResult']:
        """
...
class AwaitableGetKmsKeyVersionsResult(GetKmsKeyVersionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsKeyVersionsResult(
...
def get_kms_key_versions(filters: Optional[Sequence[pulumi.InputType['GetKmsKeyVersionsFilterArgs']]] = None,
                         key_id: Optional[str] = None,
                         management_endpoint: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsKeyVersionsResult:
    """
    ...
    test_key_versions = oci.get_kms_key_versions(key_id=oci_kms_key["test_key"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsKeyVersions:GetKmsKeyVersions', __args__, opts=opts, typ=GetKmsKeyVersionsResult).value

    return AwaitableGetKmsKeyVersionsResult(
