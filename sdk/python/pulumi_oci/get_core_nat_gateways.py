...
__all__ = [
    'GetCoreNatGatewaysResult',
    'AwaitableGetCoreNatGatewaysResult',
    'get_core_nat_gateways',
]

@pulumi.output_type
class GetCoreNatGatewaysResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreNatGatewaysFilterResult']]:
    ...
    def nat_gateways(self) -> Sequence['outputs.GetCoreNatGatewaysNatGatewayResult']:
        """
...
class AwaitableGetCoreNatGatewaysResult(GetCoreNatGatewaysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreNatGatewaysResult(
...
def get_core_nat_gateways(compartment_id: Optional[str] = None,
                          display_name: Optional[str] = None,
                          filters: Optional[Sequence[pulumi.InputType['GetCoreNatGatewaysFilterArgs']]] = None,
                          state: Optional[str] = None,
                          vcn_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreNatGatewaysResult:
    """
    ...
    test_nat_gateways = oci.get_core_nat_gateways(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreNatGateways:GetCoreNatGateways', __args__, opts=opts, typ=GetCoreNatGatewaysResult).value

    return AwaitableGetCoreNatGatewaysResult(
