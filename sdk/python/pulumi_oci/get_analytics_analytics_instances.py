...
__all__ = [
    'GetAnalyticsAnalyticsInstancesResult',
    'AwaitableGetAnalyticsAnalyticsInstancesResult',
    'get_analytics_analytics_instances',
]

@pulumi.output_type
class GetAnalyticsAnalyticsInstancesResult:
    """
    ...
    def analytics_instances(self) -> Sequence['outputs.GetAnalyticsAnalyticsInstancesAnalyticsInstanceResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetAnalyticsAnalyticsInstancesFilterResult']]:
...
class AwaitableGetAnalyticsAnalyticsInstancesResult(GetAnalyticsAnalyticsInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAnalyticsAnalyticsInstancesResult(
...
def get_analytics_analytics_instances(capacity_type: Optional[str] = None,
                                      compartment_id: Optional[str] = None,
                                      feature_set: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetAnalyticsAnalyticsInstancesFilterArgs']]] = None,
                                      name: Optional[str] = None,
                                      state: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAnalyticsAnalyticsInstancesResult:
    """
    ...
    test_analytics_instances = oci.get_analytics_analytics_instances(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getAnalyticsAnalyticsInstances:GetAnalyticsAnalyticsInstances', __args__, opts=opts, typ=GetAnalyticsAnalyticsInstancesResult).value

    return AwaitableGetAnalyticsAnalyticsInstancesResult(
