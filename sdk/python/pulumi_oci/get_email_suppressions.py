...
__all__ = [
    'GetEmailSuppressionsResult',
    'AwaitableGetEmailSuppressionsResult',
    'get_email_suppressions',
]

@pulumi.output_type
class GetEmailSuppressionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetEmailSuppressionsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def suppressions(self) -> Sequence['outputs.GetEmailSuppressionsSuppressionResult']:
        """
...
class AwaitableGetEmailSuppressionsResult(GetEmailSuppressionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEmailSuppressionsResult(
...
def get_email_suppressions(compartment_id: Optional[str] = None,
                           email_address: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetEmailSuppressionsFilterArgs']]] = None,
                           time_created_greater_than_or_equal_to: Optional[str] = None,
                           time_created_less_than: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEmailSuppressionsResult:
    """
    ...
    test_suppressions = oci.get_email_suppressions(compartment_id=var["tenancy_ocid"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getEmailSuppressions:GetEmailSuppressions', __args__, opts=opts, typ=GetEmailSuppressionsResult).value

    return AwaitableGetEmailSuppressionsResult(
