...
__all__ = ['DatabaseBackupDestinationArgs', 'DatabaseBackupDestination']

@pulumi.input_type
class DatabaseBackupDestinationArgs:
    def __init__(__self__, *,
                 ...
                 mount_type_details: Optional[pulumi.Input['DatabaseBackupDestinationMountTypeDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatabaseBackupDestinationMountTypeDetailsArgs'] mount_type_details: Mount type details for backup destination.
    ...
    def mount_type_details(self) -> Optional[pulumi.Input['DatabaseBackupDestinationMountTypeDetailsArgs']]:
        """
    ...
    def mount_type_details(self, value: Optional[pulumi.Input['DatabaseBackupDestinationMountTypeDetailsArgs']]):
...
@pulumi.input_type
class _DatabaseBackupDestinationState:
    def __init__(__self__, *,
                 associated_databases: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseBackupDestinationAssociatedDatabaseArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DatabaseBackupDestinationAssociatedDatabaseArgs']]] associated_databases: List of databases associated with the backup destination.
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[str] connection_string: (Updatable) The connection string for connecting to the Recovery Appliance.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: The user-provided name of the backup destination.
    ...
    def associated_databases(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseBackupDestinationAssociatedDatabaseArgs']]]]:
        """
    ...
    def associated_databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseBackupDestinationAssociatedDatabaseArgs']]]]):
...
class DatabaseBackupDestination(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 local_mount_point_path: Optional[pulumi.Input[str]] = None,
                 mount_type_details: Optional[pulumi.Input[pulumi.InputType['DatabaseBackupDestinationMountTypeDetailsArgs']]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 vpc_users: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        test_backup_destination = oci.DatabaseBackupDestination("testBackupDestination",
            ...
            mount_type_details=oci.DatabaseBackupDestinationMountTypeDetailsArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] local_mount_point_path: The local directory path on each VM cluster node where the NFS server location is mounted. The local directory path and the NFS server location must each be the same across all of the VM cluster nodes. Ensure that the NFS mount is maintained continuously on all of the VM cluster nodes.
        :param pulumi.Input[pulumi.InputType['DatabaseBackupDestinationMountTypeDetailsArgs']] mount_type_details: Mount type details for backup destination.
        :param pulumi.Input[str] type: Type of the backup destination.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] vpc_users: (Updatable) The Virtual Private Catalog (VPC) users that are used to access the Recovery Appliance.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseBackupDestinationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Backup Destination resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseBackupDestinationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseBackupDestinationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseBackupDestinationArgs.__new__(DatabaseBackupDestinationArgs)
        ...
        super(DatabaseBackupDestination, __self__).__init__(
            'oci:index/databaseBackupDestination:DatabaseBackupDestination',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            associated_databases: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseBackupDestinationAssociatedDatabaseArgs']]]]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_string: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            vpc_users: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'DatabaseBackupDestination':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DatabaseBackupDestinationAssociatedDatabaseArgs']]]] associated_databases: List of databases associated with the backup destination.
        :param pulumi.Input[str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[str] connection_string: (Updatable) The connection string for connecting to the Recovery Appliance.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: The user-provided name of the backup destination.
        ...
        __props__ = _DatabaseBackupDestinationState.__new__(_DatabaseBackupDestinationState)
        ...
        __props__.__dict__["type"] = type
        __props__.__dict__["vpc_users"] = vpc_users
        return DatabaseBackupDestination(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="associatedDatabases")
    def associated_databases(self) -> pulumi.Output[Sequence['outputs.DatabaseBackupDestinationAssociatedDatabase']]:
        """
        List of databases associated with the backup destination.
        """
        return pulumi.get(self, "associated_databases")
    ...
    @property
    @pulumi.getter(name="mountTypeDetails")
    def mount_type_details(self) -> pulumi.Output['outputs.DatabaseBackupDestinationMountTypeDetails']:
        """
        Mount type details for backup destination.
        """
        return pulumi.get(self, "mount_type_details")
