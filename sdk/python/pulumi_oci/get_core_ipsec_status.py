...
__all__ = [
    'GetCoreIpsecStatusResult',
    'AwaitableGetCoreIpsecStatusResult',
    'get_core_ipsec_status',
]

@pulumi.output_type
class GetCoreIpsecStatusResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreIpsecStatusFilterResult']]:
    ...
    @property
    @pulumi.getter
    def tunnels(self) -> Sequence['outputs.GetCoreIpsecStatusTunnelResult']:
        """
...
class AwaitableGetCoreIpsecStatusResult(GetCoreIpsecStatusResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpsecStatusResult(
...
def get_core_ipsec_status(filters: Optional[Sequence[pulumi.InputType['GetCoreIpsecStatusFilterArgs']]] = None,
                          ipsec_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpsecStatusResult:
    """
    ...
    test_ip_sec_connection_device_status = oci.get_core_ipsec_status(ipsec_id=oci_core_ipsec["test_ipsec"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpsecStatus:GetCoreIpsecStatus', __args__, opts=opts, typ=GetCoreIpsecStatusResult).value

    return AwaitableGetCoreIpsecStatusResult(
