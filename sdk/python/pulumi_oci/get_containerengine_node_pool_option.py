...
__all__ = [
    'GetContainerengineNodePoolOptionResult',
    'AwaitableGetContainerengineNodePoolOptionResult',
    'get_containerengine_node_pool_option',
]

@pulumi.output_type
class GetContainerengineNodePoolOptionResult:
    """
    ...
    @property
    @pulumi.getter
    def sources(self) -> Sequence['outputs.GetContainerengineNodePoolOptionSourceResult']:
        """
...
class AwaitableGetContainerengineNodePoolOptionResult(GetContainerengineNodePoolOptionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetContainerengineNodePoolOptionResult(
...
def get_containerengine_node_pool_option(compartment_id: Optional[str] = None,
                                         node_pool_option_id: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContainerengineNodePoolOptionResult:
    """
    ...
    test_node_pool_option = oci.get_containerengine_node_pool_option(node_pool_option_id=oci_containerengine_node_pool_option["test_node_pool_option"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getContainerengineNodePoolOption:GetContainerengineNodePoolOption', __args__, opts=opts, typ=GetContainerengineNodePoolOptionResult).value

    return AwaitableGetContainerengineNodePoolOptionResult(
