...
__all__ = ['CoreDrgAttachmentManagementArgs', 'CoreDrgAttachmentManagement']

@pulumi.input_type
class CoreDrgAttachmentManagementArgs:
    def __init__(__self__, *,
                 ...
                 network_details: Optional[pulumi.Input['CoreDrgAttachmentManagementNetworkDetailsArgs']] = None,
        ...
        :param pulumi.Input['CoreDrgAttachmentManagementNetworkDetailsArgs'] network_details: (Updatable)
    ...
    def network_details(self) -> Optional[pulumi.Input['CoreDrgAttachmentManagementNetworkDetailsArgs']]:
        """
        (Updatable)
        """
    ...
    def network_details(self, value: Optional[pulumi.Input['CoreDrgAttachmentManagementNetworkDetailsArgs']]):
...
@pulumi.input_type
class _CoreDrgAttachmentManagementState:
    def __init__(__self__, *,
...
class CoreDrgAttachmentManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 export_drg_route_distribution_id: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 network_details: Optional[pulumi.Input[pulumi.InputType['CoreDrgAttachmentManagementNetworkDetailsArgs']]] = None,
                 network_id: Optional[pulumi.Input[str]] = None,
                 remove_export_drg_route_distribution_trigger: Optional[pulumi.Input[bool]] = None,
                 route_table_id: Optional[pulumi.Input[str]] = None,
                 vcn_id: Optional[pulumi.Input[str]] = None,
        ...
        test_drg_rpc_attachment = oci.CoreDrgAttachmentManagement("testDrgRpcAttachment",
        ...
        :param pulumi.Input[str] export_drg_route_distribution_id: - The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the export route distribution used to specify how routes in the assigned DRG route table are advertised to the attachment. If this value is null, no routes are advertised through this attachment.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['CoreDrgAttachmentManagementNetworkDetailsArgs']] network_details: (Updatable)
        :param pulumi.Input[str] network_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource (virtual circuit, VCN, IPSec tunnel, or remote peering connection) attached to the DRG.
        :param pulumi.Input[bool] remove_export_drg_route_distribution_trigger: (Updatable) An optional property when set to true during update disables the export of route Distribution by setting export_drg_route_distribution_id to null.
        :param pulumi.Input[str] route_table_id: (Updatable)- The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route table the DRG attachment is using.
        :param pulumi.Input[str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreDrgAttachmentManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Drg Attachment Management resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreDrgAttachmentManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreDrgAttachmentManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreDrgAttachmentManagementArgs.__new__(CoreDrgAttachmentManagementArgs)
        ...
        super(CoreDrgAttachmentManagement, __self__).__init__(
            'oci:index/coreDrgAttachmentManagement:CoreDrgAttachmentManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vcn_id: Optional[pulumi.Input[str]] = None) -> 'CoreDrgAttachmentManagement':
        """
        ...
        __props__ = _CoreDrgAttachmentManagementState.__new__(_CoreDrgAttachmentManagementState)
        ...
        __props__.__dict__["vcn_id"] = vcn_id
        return CoreDrgAttachmentManagement(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="networkDetails")
    def network_details(self) -> pulumi.Output['outputs.CoreDrgAttachmentManagementNetworkDetails']:
        """
        (Updatable)
        """
        return pulumi.get(self, "network_details")
