...
__all__ = [
    'GetDataflowPrivateEndpointsResult',
    'AwaitableGetDataflowPrivateEndpointsResult',
    'get_dataflow_private_endpoints',
]

@pulumi.output_type
class GetDataflowPrivateEndpointsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDataflowPrivateEndpointsFilterResult']]:
    ...
    def private_endpoint_collections(self) -> Sequence['outputs.GetDataflowPrivateEndpointsPrivateEndpointCollectionResult']:
        """
...
class AwaitableGetDataflowPrivateEndpointsResult(GetDataflowPrivateEndpointsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowPrivateEndpointsResult(
...
def get_dataflow_private_endpoints(compartment_id: Optional[str] = None,
                                   display_name: Optional[str] = None,
                                   display_name_starts_with: Optional[str] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetDataflowPrivateEndpointsFilterArgs']]] = None,
                                   owner_principal_id: Optional[str] = None,
                                   state: Optional[str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowPrivateEndpointsResult:
    """
    ...
    test_private_endpoints = oci.get_dataflow_private_endpoints(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowPrivateEndpoints:GetDataflowPrivateEndpoints', __args__, opts=opts, typ=GetDataflowPrivateEndpointsResult).value

    return AwaitableGetDataflowPrivateEndpointsResult(
