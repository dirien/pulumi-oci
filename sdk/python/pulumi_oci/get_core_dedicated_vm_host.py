...
__all__ = [
    'GetCoreDedicatedVmHostResult',
    'AwaitableGetCoreDedicatedVmHostResult',
    'get_core_dedicated_vm_host',
]

@pulumi.output_type
class GetCoreDedicatedVmHostResult:
    """
...
class AwaitableGetCoreDedicatedVmHostResult(GetCoreDedicatedVmHostResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDedicatedVmHostResult(
...
def get_core_dedicated_vm_host(dedicated_vm_host_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDedicatedVmHostResult:
    """
    ...
    test_dedicated_vm_host = oci.get_core_dedicated_vm_host(dedicated_vm_host_id=oci_core_dedicated_vm_host["test_dedicated_vm_host"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDedicatedVmHost:GetCoreDedicatedVmHost', __args__, opts=opts, typ=GetCoreDedicatedVmHostResult).value

    return AwaitableGetCoreDedicatedVmHostResult(
