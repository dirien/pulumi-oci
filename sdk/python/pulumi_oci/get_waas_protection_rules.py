...
__all__ = [
    'GetWaasProtectionRulesResult',
    'AwaitableGetWaasProtectionRulesResult',
    'get_waas_protection_rules',
]

@pulumi.output_type
class GetWaasProtectionRulesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetWaasProtectionRulesFilterResult']]:
    ...
    def protection_rules(self) -> Sequence['outputs.GetWaasProtectionRulesProtectionRuleResult']:
        """
...
class AwaitableGetWaasProtectionRulesResult(GetWaasProtectionRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasProtectionRulesResult(
...
def get_waas_protection_rules(actions: Optional[Sequence[str]] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetWaasProtectionRulesFilterArgs']]] = None,
                              mod_security_rule_ids: Optional[Sequence[str]] = None,
                              waas_policy_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasProtectionRulesResult:
    """
    ...
    test_protection_rules = oci.get_waas_protection_rules(waas_policy_id=oci_waas_waas_policy["test_waas_policy"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasProtectionRules:GetWaasProtectionRules', __args__, opts=opts, typ=GetWaasProtectionRulesResult).value

    return AwaitableGetWaasProtectionRulesResult(
