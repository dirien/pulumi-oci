...
__all__ = [
    'GetLoggingUnifiedAgentConfigurationsResult',
    'AwaitableGetLoggingUnifiedAgentConfigurationsResult',
    'get_logging_unified_agent_configurations',
]

@pulumi.output_type
class GetLoggingUnifiedAgentConfigurationsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLoggingUnifiedAgentConfigurationsFilterResult']]:
    ...
    def unified_agent_configuration_collections(self) -> Sequence['outputs.GetLoggingUnifiedAgentConfigurationsUnifiedAgentConfigurationCollectionResult']:
        """
...
class AwaitableGetLoggingUnifiedAgentConfigurationsResult(GetLoggingUnifiedAgentConfigurationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingUnifiedAgentConfigurationsResult(
...
def get_logging_unified_agent_configurations(compartment_id: Optional[str] = None,
                                             display_name: Optional[str] = None,
                                             filters: Optional[Sequence[pulumi.InputType['GetLoggingUnifiedAgentConfigurationsFilterArgs']]] = None,
                                             group_id: Optional[str] = None,
                                             is_compartment_id_in_subtree: Optional[bool] = None,
                                             log_id: Optional[str] = None,
                                             state: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingUnifiedAgentConfigurationsResult:
    """
    ...
    test_unified_agent_configurations = oci.get_logging_unified_agent_configurations(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingUnifiedAgentConfigurations:GetLoggingUnifiedAgentConfigurations', __args__, opts=opts, typ=GetLoggingUnifiedAgentConfigurationsResult).value

    return AwaitableGetLoggingUnifiedAgentConfigurationsResult(
