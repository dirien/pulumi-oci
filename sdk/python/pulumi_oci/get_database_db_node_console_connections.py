...
__all__ = [
    'GetDatabaseDbNodeConsoleConnectionsResult',
    'AwaitableGetDatabaseDbNodeConsoleConnectionsResult',
    'get_database_db_node_console_connections',
]

@pulumi.output_type
class GetDatabaseDbNodeConsoleConnectionsResult:
    """
    ...
    def console_connections(self) -> Sequence['outputs.GetDatabaseDbNodeConsoleConnectionsConsoleConnectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseDbNodeConsoleConnectionsFilterResult']]:
...
class AwaitableGetDatabaseDbNodeConsoleConnectionsResult(GetDatabaseDbNodeConsoleConnectionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbNodeConsoleConnectionsResult(
...
def get_database_db_node_console_connections(db_node_id: Optional[str] = None,
                                             filters: Optional[Sequence[pulumi.InputType['GetDatabaseDbNodeConsoleConnectionsFilterArgs']]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbNodeConsoleConnectionsResult:
    """
    ...
    test_db_node_console_connections = oci.get_database_db_node_console_connections(db_node_id=oci_database_db_node["test_db_node"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbNodeConsoleConnections:GetDatabaseDbNodeConsoleConnections', __args__, opts=opts, typ=GetDatabaseDbNodeConsoleConnectionsResult).value

    return AwaitableGetDatabaseDbNodeConsoleConnectionsResult(
