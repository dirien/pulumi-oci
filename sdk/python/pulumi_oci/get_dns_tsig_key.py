...
__all__ = [
    'GetDnsTsigKeyResult',
    'AwaitableGetDnsTsigKeyResult',
    'get_dns_tsig_key',
]

@pulumi.output_type
class GetDnsTsigKeyResult:
    """
...
class AwaitableGetDnsTsigKeyResult(GetDnsTsigKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsTsigKeyResult(
...
def get_dns_tsig_key(tsig_key_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsTsigKeyResult:
    """
    ...
    test_tsig_key = oci.get_dns_tsig_key(tsig_key_id=oci_dns_tsig_key["test_tsig_key"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsTsigKey:GetDnsTsigKey', __args__, opts=opts, typ=GetDnsTsigKeyResult).value

    return AwaitableGetDnsTsigKeyResult(
