...
__all__ = [
    'GetDatabaseAutonomousDatabasesResult',
    'AwaitableGetDatabaseAutonomousDatabasesResult',
    'get_database_autonomous_databases',
]

@pulumi.output_type
class GetDatabaseAutonomousDatabasesResult:
    """
    ...
    def autonomous_databases(self) -> Sequence['outputs.GetDatabaseAutonomousDatabasesAutonomousDatabaseResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseAutonomousDatabasesFilterResult']]:
...
class AwaitableGetDatabaseAutonomousDatabasesResult(GetDatabaseAutonomousDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousDatabasesResult(
...
def get_database_autonomous_databases(autonomous_container_database_id: Optional[str] = None,
                                      compartment_id: Optional[str] = None,
                                      db_version: Optional[str] = None,
                                      db_workload: Optional[str] = None,
                                      display_name: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetDatabaseAutonomousDatabasesFilterArgs']]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousDatabasesResult:
    """
    ...
    test_autonomous_databases = oci.get_database_autonomous_databases(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousDatabases:GetDatabaseAutonomousDatabases', __args__, opts=opts, typ=GetDatabaseAutonomousDatabasesResult).value

    return AwaitableGetDatabaseAutonomousDatabasesResult(
