...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConnectionAdminCredentialsArgs'] admin_credentials: (Updatable) Database Admin Credentials details.
...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_connection = oci.databasemigration.Connection("testConnection",
            admin_credentials=oci.databasemigration.ConnectionAdminCredentialsArgs(
            ...
            vault_details=oci.databasemigration.ConnectionVaultDetailsArgs(
                compartment_id=var["compartment_id"],
                key_id=oci_kms_key["test_key"]["id"],
                vault_id=oci_kms_vault["test_vault"]["id"],
            ),
            certificate_tdn=var["connection_certificate_tdn"],
            connect_descriptor=oci.databasemigration.ConnectionConnectDescriptorArgs(
            ...
            private_endpoint=oci.databasemigration.ConnectionPrivateEndpointArgs(
                compartment_id=var["compartment_id"],
                subnet_id=oci_core_subnet["test_subnet"]["id"],
                vcn_id=oci_core_vcn["test_vcn"]["id"],
            ),
            ssh_details=oci.databasemigration.ConnectionSshDetailsArgs(
        ...
        :param pulumi.Input[pulumi.InputType['ConnectionAdminCredentialsArgs']] admin_credentials: (Updatable) Database Admin Credentials details.
        :param pulumi.Input[str] certificate_tdn: (Updatable) This name is the distinguished name used while creating the certificate on target database. Requires a TLS wallet to be specified. Not required for source container database connections.
        :param pulumi.Input[str] compartment_id: (Updatable) OCID of the compartment where the secret containing the credentials will be created.
