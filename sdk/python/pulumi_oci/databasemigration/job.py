...
class _JobState:
    def __init__(__self__, *,
                 ...
                 progress: Optional[pulumi.Input['JobProgressArgs']] = None,
        ...
        :param pulumi.Input['JobProgressArgs'] progress: Percent progress of job phase.
    ...
    @property
    @pulumi.getter
    def progress(self) -> Optional[pulumi.Input['JobProgressArgs']]:
        """
    ...
    @progress.setter
    def progress(self, value: Optional[pulumi.Input['JobProgressArgs']]):
...
class Job(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            migration_id: Optional[pulumi.Input[str]] = None,
            progress: Optional[pulumi.Input[pulumi.InputType['JobProgressArgs']]] = None,
            state: Optional[pulumi.Input[str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[str] migration_id: The OCID of the Migration that this job belongs to.
        :param pulumi.Input[pulumi.InputType['JobProgressArgs']] progress: Percent progress of job phase.
        :param pulumi.Input[str] state: The current state of the migration job.
        :param pulumi.Input[Mapping[str, Any]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[str] time_created: The time the DB Migration Job was created. An RFC3339 formatted datetime string
        :param pulumi.Input[str] time_updated: The time the DB Migration Job was last updated. An RFC3339 formatted datetime string
    ...
    @property
    @pulumi.getter
    def progress(self) -> pulumi.Output['outputs.JobProgress']:
        """
        Percent progress of job phase.
        """
        return pulumi.get(self, "progress")
