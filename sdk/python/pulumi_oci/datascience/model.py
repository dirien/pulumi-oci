...
class Model(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_model = oci.datascience.Model("testModel",
            compartment_id=var["compartment_id"],
            project_id=oci_datascience_project["test_project"]["id"],
            custom_metadata_lists=[oci.datascience.ModelCustomMetadataListArgs(
            ...
            defined_metadata_lists=[oci.datascience.ModelDefinedMetadataListArgs(
