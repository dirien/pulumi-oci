...
__all__ = [
    'GetCoreNatGatewayResult',
    'AwaitableGetCoreNatGatewayResult',
    'get_core_nat_gateway',
]

@pulumi.output_type
class GetCoreNatGatewayResult:
    """
...
class AwaitableGetCoreNatGatewayResult(GetCoreNatGatewayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreNatGatewayResult(
...
def get_core_nat_gateway(nat_gateway_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreNatGatewayResult:
    """
    ...
    test_nat_gateway = oci.get_core_nat_gateway(nat_gateway_id=oci_core_nat_gateway["test_nat_gateway"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreNatGateway:GetCoreNatGateway', __args__, opts=opts, typ=GetCoreNatGatewayResult).value

    return AwaitableGetCoreNatGatewayResult(
