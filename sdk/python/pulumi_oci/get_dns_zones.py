...
class GetDnsZonesResult:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDnsZonesFilterResult']]:
...
def get_dns_zones(compartment_id: Optional[str] = None,
                  filters: Optional[Sequence[pulumi.InputType['GetDnsZonesFilterArgs']]] = None,
    ...
    test_zones = oci.get_dns_zones(compartment_id=var["compartment_id"],
        name=var["zone_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsZones:GetDnsZones', __args__, opts=opts, typ=GetDnsZonesResult).value
