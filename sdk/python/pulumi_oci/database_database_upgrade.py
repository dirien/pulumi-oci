...
__all__ = ['DatabaseDatabaseUpgradeArgs', 'DatabaseDatabaseUpgrade']

@pulumi.input_type
class DatabaseDatabaseUpgradeArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[str],
                 database_id: pulumi.Input[str],
                 database_upgrade_source_details: Optional[pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']] = None):
        """
        ...
        :param pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs'] database_upgrade_source_details: Details for the database upgrade source.
        """
    ...
    def database_upgrade_source_details(self) -> Optional[pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']]:
        """
    ...
    def database_upgrade_source_details(self, value: Optional[pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']]):
        pulumi.set(self, "database_upgrade_source_details", value)


@pulumi.input_type
class _DatabaseDatabaseUpgradeState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[str]] = None,
                 character_set: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 connection_strings: Optional[pulumi.Input['DatabaseDatabaseUpgradeConnectionStringsArgs']] = None,
                 database_id: Optional[pulumi.Input[str]] = None,
                 database_software_image_id: Optional[pulumi.Input[str]] = None,
                 database_upgrade_source_details: Optional[pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']] = None,
                 db_backup_config: Optional[pulumi.Input['DatabaseDatabaseUpgradeDbBackupConfigArgs']] = None,
        ...
        :param pulumi.Input['DatabaseDatabaseUpgradeConnectionStringsArgs'] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input[str] database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param pulumi.Input['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs'] database_upgrade_source_details: Details for the database upgrade source.
        :param pulumi.Input['DatabaseDatabaseUpgradeDbBackupConfigArgs'] db_backup_config: Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
    ...
    def connection_strings(self) -> Optional[pulumi.Input['DatabaseDatabaseUpgradeConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: Optional[pulumi.Input['DatabaseDatabaseUpgradeConnectionStringsArgs']]):
    ...
    def db_backup_config(self) -> Optional[pulumi.Input['DatabaseDatabaseUpgradeDbBackupConfigArgs']]:
        """
    ...
    def db_backup_config(self, value: Optional[pulumi.Input['DatabaseDatabaseUpgradeDbBackupConfigArgs']]):
...
class DatabaseDatabaseUpgrade(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 action: Optional[pulumi.Input[str]] = None,
                 database_id: Optional[pulumi.Input[str]] = None,
                 database_upgrade_source_details: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']]] = None,
                 __props__=None):
        """
        ...
        test_database_upgrade = oci.DatabaseDatabaseUpgrade("testDatabaseUpgrade",
            action=var["database_upgrade_action"],
            database_id=oci_database_database["test_database"]["id"],
            database_upgrade_source_details=oci.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs(
        ...
        :param pulumi.Input[str] action: The database upgrade action.
        :param pulumi.Input[str] database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']] database_upgrade_source_details: Details for the database upgrade source.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseDatabaseUpgradeArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Database Upgrade resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseDatabaseUpgradeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseDatabaseUpgradeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseDatabaseUpgradeArgs.__new__(DatabaseDatabaseUpgradeArgs)
            ...
            __props__.__dict__["db_backup_config"] = None
        ...
        super(DatabaseDatabaseUpgrade, __self__).__init__(
            'oci:index/databaseDatabaseUpgrade:DatabaseDatabaseUpgrade',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            character_set: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_strings: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeConnectionStringsArgs']]] = None,
            database_id: Optional[pulumi.Input[str]] = None,
            database_software_image_id: Optional[pulumi.Input[str]] = None,
            database_upgrade_source_details: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']]] = None,
            db_backup_config: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDbBackupConfigArgs']]] = None,
            db_home_id: Optional[pulumi.Input[str]] = None,
            db_name: Optional[pulumi.Input[str]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            db_unique_name: Optional[pulumi.Input[str]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vm_cluster_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseDatabaseUpgrade':
        """
        ...
        :param pulumi.Input[str] character_set: The character set for the database.
        :param pulumi.Input[str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeConnectionStringsArgs']] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input[str] database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[str] database_software_image_id: The database software image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the image to be used to upgrade a database.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetailsArgs']] database_upgrade_source_details: Details for the database upgrade source.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseUpgradeDbBackupConfigArgs']] db_backup_config: Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        :param pulumi.Input[str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        :param pulumi.Input[str] db_name: The database name.
        :param pulumi.Input[str] db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        :param pulumi.Input[str] db_unique_name: A system-generated name for the database to ensure uniqueness within an Oracle Data Guard group (a primary database and its standby databases). The unique name cannot be changed.
        ...
        __props__ = _DatabaseDatabaseUpgradeState.__new__(_DatabaseDatabaseUpgradeState)
        ...
        return DatabaseDatabaseUpgrade(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Output['outputs.DatabaseDatabaseUpgradeConnectionStrings']:
        """
        The Connection strings used to connect to the Oracle Database.
        """
        return pulumi.get(self, "connection_strings")
    ...
    @property
    @pulumi.getter(name="databaseUpgradeSourceDetails")
    def database_upgrade_source_details(self) -> pulumi.Output['outputs.DatabaseDatabaseUpgradeDatabaseUpgradeSourceDetails']:
        """
        Details for the database upgrade source.
        """
        return pulumi.get(self, "database_upgrade_source_details")
    ...
    @property
    @pulumi.getter(name="dbBackupConfig")
    def db_backup_config(self) -> pulumi.Output['outputs.DatabaseDatabaseUpgradeDbBackupConfig']:
        """
        Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        """
        return pulumi.get(self, "db_backup_config")
