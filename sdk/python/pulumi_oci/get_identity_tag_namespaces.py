...
__all__ = [
    'GetIdentityTagNamespacesResult',
    'AwaitableGetIdentityTagNamespacesResult',
    'get_identity_tag_namespaces',
]

@pulumi.output_type
class GetIdentityTagNamespacesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityTagNamespacesFilterResult']]:
    ...
    def tag_namespaces(self) -> Sequence['outputs.GetIdentityTagNamespacesTagNamespaceResult']:
        """
...
class AwaitableGetIdentityTagNamespacesResult(GetIdentityTagNamespacesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityTagNamespacesResult(
...
def get_identity_tag_namespaces(compartment_id: Optional[str] = None,
                                filters: Optional[Sequence[pulumi.InputType['GetIdentityTagNamespacesFilterArgs']]] = None,
                                include_subcompartments: Optional[bool] = None,
                                state: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityTagNamespacesResult:
    """
    ...
    test_tag_namespaces = oci.get_identity_tag_namespaces(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityTagNamespaces:GetIdentityTagNamespaces', __args__, opts=opts, typ=GetIdentityTagNamespacesResult).value

    return AwaitableGetIdentityTagNamespacesResult(
