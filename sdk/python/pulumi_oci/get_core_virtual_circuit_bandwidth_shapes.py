...
__all__ = [
    'GetCoreVirtualCircuitBandwidthShapesResult',
    'AwaitableGetCoreVirtualCircuitBandwidthShapesResult',
    'get_core_virtual_circuit_bandwidth_shapes',
]

@pulumi.output_type
class GetCoreVirtualCircuitBandwidthShapesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVirtualCircuitBandwidthShapesFilterResult']]:
    ...
    def virtual_circuit_bandwidth_shapes(self) -> Sequence['outputs.GetCoreVirtualCircuitBandwidthShapesVirtualCircuitBandwidthShapeResult']:
        """
...
class AwaitableGetCoreVirtualCircuitBandwidthShapesResult(GetCoreVirtualCircuitBandwidthShapesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVirtualCircuitBandwidthShapesResult(
...
def get_core_virtual_circuit_bandwidth_shapes(filters: Optional[Sequence[pulumi.InputType['GetCoreVirtualCircuitBandwidthShapesFilterArgs']]] = None,
                                              provider_service_id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVirtualCircuitBandwidthShapesResult:
    """
    ...
    test_virtual_circuit_bandwidth_shapes = oci.get_core_virtual_circuit_bandwidth_shapes(provider_service_id=data["oci_core_fast_connect_provider_services"]["test_fast_connect_provider_services"]["fast_connect_provider_services"][0]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVirtualCircuitBandwidthShapes:GetCoreVirtualCircuitBandwidthShapes', __args__, opts=opts, typ=GetCoreVirtualCircuitBandwidthShapesResult).value

    return AwaitableGetCoreVirtualCircuitBandwidthShapesResult(
