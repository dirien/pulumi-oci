...
__all__ = [
    'GetCoreIpsecConfigResult',
    'AwaitableGetCoreIpsecConfigResult',
    'get_core_ipsec_config',
]

@pulumi.output_type
class GetCoreIpsecConfigResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreIpsecConfigFilterResult']]:
    ...
    @property
    @pulumi.getter
    def tunnels(self) -> Sequence['outputs.GetCoreIpsecConfigTunnelResult']:
        """
...
class AwaitableGetCoreIpsecConfigResult(GetCoreIpsecConfigResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpsecConfigResult(
...
def get_core_ipsec_config(filters: Optional[Sequence[pulumi.InputType['GetCoreIpsecConfigFilterArgs']]] = None,
                          ipsec_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpsecConfigResult:
    """
    ...
    * [GetIPSecConnectionTunnelSharedSecret](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/IPSecConnectionTunnelSharedSecret/GetIPSecConnectionTunnelSharedSecret)
    ...
    test_ip_sec_connection_device_config = oci.get_core_ipsec_config(ipsec_id=oci_core_ipsec["test_ipsec"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpsecConfig:GetCoreIpsecConfig', __args__, opts=opts, typ=GetCoreIpsecConfigResult).value

    return AwaitableGetCoreIpsecConfigResult(
