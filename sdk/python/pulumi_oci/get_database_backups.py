...
def get_database_backups(compartment_id: Optional[str] = None,
    ...
    test_backups = oci.get_database_backups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseBackups:GetDatabaseBackups', __args__, opts=opts, typ=GetDatabaseBackupsResult).value
