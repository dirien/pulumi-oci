...
__all__ = [
    'GetGoldenGateDeploymentResult',
    'AwaitableGetGoldenGateDeploymentResult',
    'get_golden_gate_deployment',
]

@pulumi.output_type
class GetGoldenGateDeploymentResult:
    """
    ...
    def ogg_data(self) -> 'outputs.GetGoldenGateDeploymentOggDataResult':
        """
...
class AwaitableGetGoldenGateDeploymentResult(GetGoldenGateDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGoldenGateDeploymentResult(
...
def get_golden_gate_deployment(deployment_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGoldenGateDeploymentResult:
    """
    ...
    test_deployment = oci.get_golden_gate_deployment(deployment_id=oci_golden_gate_deployment["test_deployment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getGoldenGateDeployment:GetGoldenGateDeployment', __args__, opts=opts, typ=GetGoldenGateDeploymentResult).value

    return AwaitableGetGoldenGateDeploymentResult(
