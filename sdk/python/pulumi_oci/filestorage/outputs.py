...
__all__ = [
    ...
    'GetFileSystemsFileSystemSourceDetailsResult',
...
@pulumi.output_type
class FileSystemSourceDetails(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FileSystemSourceDetails. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FileSystemSourceDetails.__key_warning(key)
        return super().__getitem__(key)
...
class GetFileSystemsFileSystemResult(dict):
    def __init__(__self__, *,
                 ...
                 metered_bytes: str,
                 source_details: 'outputs.GetFileSystemsFileSystemSourceDetailsResult',
        ...
        :param 'GetFileSystemsFileSystemSourceDetailsArgs' source_details: Source information for the file system.
        :param str source_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the snapshot used to create a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningafilesystem.htm).
        :param str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
    ...
    def source_details(self) -> 'outputs.GetFileSystemsFileSystemSourceDetailsResult':
        """
...
@pulumi.output_type
class GetFileSystemsFileSystemSourceDetailsResult(dict):
    def __init__(__self__, *,
