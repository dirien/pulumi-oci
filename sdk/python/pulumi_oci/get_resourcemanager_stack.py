...
__all__ = [
    'GetResourcemanagerStackResult',
    'AwaitableGetResourcemanagerStackResult',
    'get_resourcemanager_stack',
]

@pulumi.output_type
class GetResourcemanagerStackResult:
    """
    ...
    def config_sources(self) -> Sequence['outputs.GetResourcemanagerStackConfigSourceResult']:
...
class AwaitableGetResourcemanagerStackResult(GetResourcemanagerStackResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetResourcemanagerStackResult(
...
def get_resourcemanager_stack(stack_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourcemanagerStackResult:
    """
    ...
    test_stack = oci.get_resourcemanager_stack(stack_id=oci_resourcemanager_stack["test_stack"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getResourcemanagerStack:GetResourcemanagerStack', __args__, opts=opts, typ=GetResourcemanagerStackResult).value

    return AwaitableGetResourcemanagerStackResult(
