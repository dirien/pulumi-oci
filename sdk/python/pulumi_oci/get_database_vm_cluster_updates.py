...
__all__ = [
    'GetDatabaseVmClusterUpdatesResult',
    'AwaitableGetDatabaseVmClusterUpdatesResult',
    'get_database_vm_cluster_updates',
]

@pulumi.output_type
class GetDatabaseVmClusterUpdatesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseVmClusterUpdatesFilterResult']]:
    ...
    def vm_cluster_updates(self) -> Sequence['outputs.GetDatabaseVmClusterUpdatesVmClusterUpdateResult']:
        """
...
class AwaitableGetDatabaseVmClusterUpdatesResult(GetDatabaseVmClusterUpdatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterUpdatesResult(
...
def get_database_vm_cluster_updates(filters: Optional[Sequence[pulumi.InputType['GetDatabaseVmClusterUpdatesFilterArgs']]] = None,
                                    state: Optional[str] = None,
                                    update_type: Optional[str] = None,
                                    vm_cluster_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterUpdatesResult:
    """
    ...
    test_vm_cluster_updates = oci.get_database_vm_cluster_updates(vm_cluster_id=oci_database_vm_cluster["test_vm_cluster"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterUpdates:GetDatabaseVmClusterUpdates', __args__, opts=opts, typ=GetDatabaseVmClusterUpdatesResult).value

    return AwaitableGetDatabaseVmClusterUpdatesResult(
