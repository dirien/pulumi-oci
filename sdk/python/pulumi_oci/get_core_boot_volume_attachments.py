...
__all__ = [
    'GetCoreBootVolumeAttachmentsResult',
    'AwaitableGetCoreBootVolumeAttachmentsResult',
    'get_core_boot_volume_attachments',
]

@pulumi.output_type
class GetCoreBootVolumeAttachmentsResult:
    """
    ...
    def boot_volume_attachments(self) -> Sequence['outputs.GetCoreBootVolumeAttachmentsBootVolumeAttachmentResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreBootVolumeAttachmentsFilterResult']]:
...
class AwaitableGetCoreBootVolumeAttachmentsResult(GetCoreBootVolumeAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreBootVolumeAttachmentsResult(
...
def get_core_boot_volume_attachments(availability_domain: Optional[str] = None,
                                     boot_volume_id: Optional[str] = None,
                                     compartment_id: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetCoreBootVolumeAttachmentsFilterArgs']]] = None,
                                     instance_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreBootVolumeAttachmentsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreBootVolumeAttachments:GetCoreBootVolumeAttachments', __args__, opts=opts, typ=GetCoreBootVolumeAttachmentsResult).value

    return AwaitableGetCoreBootVolumeAttachmentsResult(
