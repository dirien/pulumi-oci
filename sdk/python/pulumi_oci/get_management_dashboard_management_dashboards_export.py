...
__all__ = [
    'GetManagementDashboardManagementDashboardsExportResult',
    'AwaitableGetManagementDashboardManagementDashboardsExportResult',
    'get_management_dashboard_management_dashboards_export',
]

@pulumi.output_type
class GetManagementDashboardManagementDashboardsExportResult:
    """
    ...
    def export_details(self) -> str:
        """
        String containing Array of Dashboards exported, check [ManagementDashboardExportDetails](https://docs.cloud.oracle.com/en-us/iaas/api/#/en/managementdashboard/20200901/datatypes/ManagementDashboardExportDetails) for exact contents in the string value. The value of `export_details` can be used to pass as `import_details` (CompartmentIds may have to be changed) in `ManagementDashboardManagementDashboardsImport` resource.
        """
...
class AwaitableGetManagementDashboardManagementDashboardsExportResult(GetManagementDashboardManagementDashboardsExportResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagementDashboardManagementDashboardsExportResult(
            export_dashboard_id=self.export_dashboard_id,
            export_details=self.export_details,
            id=self.id)


def get_management_dashboard_management_dashboards_export(export_dashboard_id: Optional[str] = None,
                                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementDashboardManagementDashboardsExportResult:
    """
    ...
    test_management_dashboards_export = oci.get_management_dashboard_management_dashboards_export(export_dashboard_id=oci_management_dashboard_export_dashboard["test_export_dashboard"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getManagementDashboardManagementDashboardsExport:GetManagementDashboardManagementDashboardsExport', __args__, opts=opts, typ=GetManagementDashboardManagementDashboardsExportResult).value

    return AwaitableGetManagementDashboardManagementDashboardsExportResult(
