...
__all__ = [
    ...
    'GetContainerImageSignaturesContainerImageSignatureCollectionResult',
    'GetContainerImageSignaturesContainerImageSignatureCollectionItemResult',
    'GetContainerImageSignaturesFilterResult',
...
@pulumi.output_type
class GetContainerImageSignaturesContainerImageSignatureCollectionResult(dict):
    def __init__(__self__, *,
                 items: Sequence['outputs.GetContainerImageSignaturesContainerImageSignatureCollectionItemResult'],
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetContainerImageSignaturesContainerImageSignatureCollectionItemResult']:
...
@pulumi.output_type
class GetContainerImageSignaturesContainerImageSignatureCollectionItemResult(dict):
    def __init__(__self__, *,
                 compartment_id: str,
                 created_by: str,
                 display_name: str,
...
@pulumi.output_type
class GetContainerImageSignaturesFilterResult(dict):
    def __init__(__self__, *,
                 name: str,
                 values: Sequence[str],
...
class GetContainerRepositoriesContainerRepositoryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 layer_count: int,
                 layers_size_in_bytes: str,
                 readme: 'outputs.GetContainerRepositoriesContainerRepositoryCollectionItemReadmeResult',
                 state: str,
                 time_created: str,
        ...
        :param int layer_count: Total number of layers.
        :param str layers_size_in_bytes: Total storage in bytes consumed by layers.
        :param 'GetContainerRepositoriesContainerRepositoryCollectionItemReadmeArgs' readme: Container repository readme.
        :param str state: A filter to return only resources that match the given lifecycle state name exactly.
    ...
    @property
    @pulumi.getter
    def readme(self) -> 'outputs.GetContainerRepositoriesContainerRepositoryCollectionItemReadmeResult':
        """
