...
__all__ = [
    'GetContainerImageSignaturesResult',
    'AwaitableGetContainerImageSignaturesResult',
    'get_container_image_signatures',
]

@pulumi.output_type
class GetContainerImageSignaturesResult:
    """
    ...
    def container_image_signature_collections(self) -> Sequence['outputs.GetContainerImageSignaturesContainerImageSignatureCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetContainerImageSignaturesFilterResult']]:
...
class AwaitableGetContainerImageSignaturesResult(GetContainerImageSignaturesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetContainerImageSignaturesResult(
...
def get_container_image_signatures(compartment_id: Optional[str] = None,
                                   compartment_id_in_subtree: Optional[bool] = None,
                                   display_name: Optional[str] = None,
                                   filters: Optional[Sequence[pulumi.InputType['GetContainerImageSignaturesFilterArgs']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetContainerImageSignaturesResult:
    """
    ...
    test_container_image_signatures = oci.artifacts.get_container_image_signatures(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:artifacts/getContainerImageSignatures:getContainerImageSignatures', __args__, opts=opts, typ=GetContainerImageSignaturesResult).value

    return AwaitableGetContainerImageSignaturesResult(
