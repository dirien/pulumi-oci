...
__all__ = [
    'GetDatabaseAutonomousContainerDatabasesResult',
    'AwaitableGetDatabaseAutonomousContainerDatabasesResult',
    'get_database_autonomous_container_databases',
]

@pulumi.output_type
class GetDatabaseAutonomousContainerDatabasesResult:
    """
    A collection of values returned by GetDatabaseAutonomousContainerDatabases.
    """
    def __init__(__self__, autonomous_container_databases=None, autonomous_exadata_infrastructure_id=None, autonomous_vm_cluster_id=None, availability_domain=None, compartment_id=None, display_name=None, filters=None, id=None, infrastructure_type=None, service_level_agreement_type=None, state=None):
    ...
    def autonomous_container_databases(self) -> Sequence['outputs.GetDatabaseAutonomousContainerDatabasesAutonomousContainerDatabaseResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseAutonomousContainerDatabasesFilterResult']]:
...
class AwaitableGetDatabaseAutonomousContainerDatabasesResult(GetDatabaseAutonomousContainerDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousContainerDatabasesResult(
...
def get_database_autonomous_container_databases(autonomous_exadata_infrastructure_id: Optional[str] = None,
                                                autonomous_vm_cluster_id: Optional[str] = None,
                                                availability_domain: Optional[str] = None,
                                                compartment_id: Optional[str] = None,
                                                display_name: Optional[str] = None,
                                                filters: Optional[Sequence[pulumi.InputType['GetDatabaseAutonomousContainerDatabasesFilterArgs']]] = None,
                                                infrastructure_type: Optional[str] = None,
                                                service_level_agreement_type: Optional[str] = None,
                                                state: Optional[str] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousContainerDatabasesResult:
    """
    ...
    test_autonomous_container_databases = oci.get_database_autonomous_container_databases(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousContainerDatabases:GetDatabaseAutonomousContainerDatabases', __args__, opts=opts, typ=GetDatabaseAutonomousContainerDatabasesResult).value

    return AwaitableGetDatabaseAutonomousContainerDatabasesResult(
