...
__all__ = [
    'GetCoreVolumeBackupsResult',
    'AwaitableGetCoreVolumeBackupsResult',
    'get_core_volume_backups',
]

@pulumi.output_type
class GetCoreVolumeBackupsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVolumeBackupsFilterResult']]:
    ...
    def volume_backups(self) -> Sequence['outputs.GetCoreVolumeBackupsVolumeBackupResult']:
        """
...
class AwaitableGetCoreVolumeBackupsResult(GetCoreVolumeBackupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVolumeBackupsResult(
...
def get_core_volume_backups(compartment_id: Optional[str] = None,
                            display_name: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetCoreVolumeBackupsFilterArgs']]] = None,
                            source_volume_backup_id: Optional[str] = None,
                            state: Optional[str] = None,
                            volume_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVolumeBackupsResult:
    """
    ...
    test_volume_backups = oci.get_core_volume_backups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVolumeBackups:GetCoreVolumeBackups', __args__, opts=opts, typ=GetCoreVolumeBackupsResult).value

    return AwaitableGetCoreVolumeBackupsResult(
