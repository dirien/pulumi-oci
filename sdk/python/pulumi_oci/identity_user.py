...
class _IdentityUserState:
    def __init__(__self__, *,
                 capabilities: Optional[pulumi.Input['IdentityUserCapabilitiesArgs']] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        :param pulumi.Input['IdentityUserCapabilitiesArgs'] capabilities: Properties indicating how the user is allowed to authenticate.
        :param pulumi.Input[str] compartment_id: The OCID of the tenancy containing the user.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) The description you assign to the user during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> Optional[pulumi.Input['IdentityUserCapabilitiesArgs']]:
        """
    ...
    @capabilities.setter
    def capabilities(self, value: Optional[pulumi.Input['IdentityUserCapabilitiesArgs']]):
...
class IdentityUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Important:** Make sure to inform the new user which compartment(s) they have access to.
        ...
        test_user = oci.IdentityUser("testUser",
    ...
    def _internal_init(__self__,
        ...
        super(IdentityUser, __self__).__init__(
            'oci:index/identityUser:IdentityUser',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            capabilities: Optional[pulumi.Input[pulumi.InputType['IdentityUserCapabilitiesArgs']]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            description: Optional[pulumi.Input[str]] = None,
            email: Optional[pulumi.Input[str]] = None,
            ...
            previous_successful_login_time: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'IdentityUser':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['IdentityUserCapabilitiesArgs']] capabilities: Properties indicating how the user is allowed to authenticate.
        :param pulumi.Input[str] compartment_id: The OCID of the tenancy containing the user.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] description: (Updatable) The description you assign to the user during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
    ...
    @property
    @pulumi.getter
    def capabilities(self) -> pulumi.Output['outputs.IdentityUserCapabilities']:
        """
        Properties indicating how the user is allowed to authenticate.
        """
        return pulumi.get(self, "capabilities")
