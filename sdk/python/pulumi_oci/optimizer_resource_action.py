...
__all__ = ['OptimizerResourceActionArgs', 'OptimizerResourceAction']

@pulumi.input_type
class OptimizerResourceActionArgs:
...
@pulumi.input_type
class _OptimizerResourceActionState:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input['OptimizerResourceActionActionArgs']] = None,
        ...
        :param pulumi.Input['OptimizerResourceActionActionArgs'] action: Details about the recommended action.
    ...
    @property
    @pulumi.getter
    def action(self) -> Optional[pulumi.Input['OptimizerResourceActionActionArgs']]:
        """
    ...
    @action.setter
    def action(self, value: Optional[pulumi.Input['OptimizerResourceActionActionArgs']]):
...
class OptimizerResourceAction(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: OptimizerResourceActionArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Resource Action resource in Oracle Cloud Infrastructure Optimizer service.
        ...
        :param str resource_name: The name of the resource.
        :param OptimizerResourceActionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OptimizerResourceActionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OptimizerResourceActionArgs.__new__(OptimizerResourceActionArgs)
        ...
        super(OptimizerResourceAction, __self__).__init__(
            'oci:index/optimizerResourceAction:OptimizerResourceAction',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            action: Optional[pulumi.Input[pulumi.InputType['OptimizerResourceActionActionArgs']]] = None,
            category_id: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            compartment_name: Optional[pulumi.Input[str]] = None,
            estimated_cost_saving: Optional[pulumi.Input[float]] = None,
            ...
            time_status_begin: Optional[pulumi.Input[str]] = None,
            time_status_end: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'OptimizerResourceAction':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['OptimizerResourceActionActionArgs']] action: Details about the recommended action.
        :param pulumi.Input[str] category_id: The unique OCID associated with the category.
        :param pulumi.Input[str] compartment_id: The OCID of the compartment.
        :param pulumi.Input[str] compartment_name: The name associated with the compartment.
        :param pulumi.Input[float] estimated_cost_saving: The estimated cost savings, in dollars, for the resource action.
        ...
        __props__ = _OptimizerResourceActionState.__new__(_OptimizerResourceActionState)
        ...
        return OptimizerResourceAction(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def action(self) -> pulumi.Output['outputs.OptimizerResourceActionAction']:
        """
        Details about the recommended action.
        """
        return pulumi.get(self, "action")
