...
class GetDatabaseExadataInfrastructureResult:
    ...
    @property
    @pulumi.getter
    def contacts(self) -> Sequence['outputs.GetDatabaseExadataInfrastructureContactResult']:
        """
    ...
    def maintenance_window(self) -> 'outputs.GetDatabaseExadataInfrastructureMaintenanceWindowResult':
        """
...
class AwaitableGetDatabaseExadataInfrastructureResult(GetDatabaseExadataInfrastructureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExadataInfrastructureResult(
...
def get_database_exadata_infrastructure(exadata_infrastructure_id: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExadataInfrastructureResult:
    """
    ...
    test_exadata_infrastructure = oci.get_database_exadata_infrastructure(exadata_infrastructure_id=oci_database_exadata_infrastructure["test_exadata_infrastructure"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExadataInfrastructure:GetDatabaseExadataInfrastructure', __args__, opts=opts, typ=GetDatabaseExadataInfrastructureResult).value

    return AwaitableGetDatabaseExadataInfrastructureResult(
