...
class BdsInstanceArgs:
    def __init__(__self__, *,
                 ...
                 cloud_sql_details: Optional[pulumi.Input['BdsInstanceCloudSqlDetailsArgs']] = None,
        ...
        :param pulumi.Input['BdsInstanceCloudSqlDetailsArgs'] cloud_sql_details: The information about added Cloud SQL capability
    ...
    def cloud_sql_details(self) -> Optional[pulumi.Input['BdsInstanceCloudSqlDetailsArgs']]:
        """
    ...
    def cloud_sql_details(self, value: Optional[pulumi.Input['BdsInstanceCloudSqlDetailsArgs']]):
...
class _BdsInstanceState:
    def __init__(__self__, *,
                 ...
                 cluster_details: Optional[pulumi.Input['BdsInstanceClusterDetailsArgs']] = None,
        ...
        :param pulumi.Input['BdsInstanceCloudSqlDetailsArgs'] cloud_sql_details: The information about added Cloud SQL capability
        :param pulumi.Input[str] cluster_admin_password: Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
        :param pulumi.Input['BdsInstanceClusterDetailsArgs'] cluster_details: Specific info about a Hadoop cluster
        :param pulumi.Input[str] cluster_public_key: The SSH public key used to authenticate the cluster connection.
        :param pulumi.Input[str] cluster_version: Version of the Hadoop distribution.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
    ...
    def cluster_details(self) -> Optional[pulumi.Input['BdsInstanceClusterDetailsArgs']]:
        """
    ...
    def cluster_details(self, value: Optional[pulumi.Input['BdsInstanceClusterDetailsArgs']]):
...
class BdsInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cloud_sql_details: Optional[pulumi.Input[pulumi.InputType['BdsInstanceCloudSqlDetailsArgs']]] = None,
                 cluster_admin_password: Optional[pulumi.Input[str]] = None,
                 cluster_public_key: Optional[pulumi.Input[str]] = None,
                 cluster_version: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
        ...
        test_bds_instance = oci.bds.BdsInstance("testBdsInstance",
            ...
            master_node=oci.bds.BdsInstanceMasterNodeArgs(
            ...
            util_node=oci.bds.BdsInstanceUtilNodeArgs(
                shape=var["bds_instance_nodes_shape"],
                subnet_id=oci_core_subnet["test_subnet"]["id"],
                block_volume_size_in_gbs=var["bds_instance_nodes_block_volume_size_in_gbs"],
                number_of_nodes=var["bds_instance_number_of_nodes"],
            ),
            worker_node=oci.bds.BdsInstanceWorkerNodeArgs(
                shape=var["bds_instance_nodes_shape"],
                subnet_id=oci_core_subnet["test_subnet"]["id"],
                block_volume_size_in_gbs=var["bds_instance_nodes_block_volume_size_in_gbs"],
                number_of_nodes=var["bds_instance_number_of_nodes"],
            ...
            network_config=oci.bds.BdsInstanceNetworkConfigArgs(
        ...
        :param pulumi.Input[pulumi.InputType['BdsInstanceCloudSqlDetailsArgs']] cloud_sql_details: The information about added Cloud SQL capability
        :param pulumi.Input[str] cluster_admin_password: Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
        :param pulumi.Input[str] cluster_public_key: The SSH public key used to authenticate the cluster connection.
        :param pulumi.Input[str] cluster_version: Version of the Hadoop distribution.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
    ...
    def _internal_init(__self__,
        ...
        super(BdsInstance, __self__).__init__(
            'oci:bds/bdsInstance:BdsInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            cloud_sql_details: Optional[pulumi.Input[pulumi.InputType['BdsInstanceCloudSqlDetailsArgs']]] = None,
            cluster_admin_password: Optional[pulumi.Input[str]] = None,
            cluster_details: Optional[pulumi.Input[pulumi.InputType['BdsInstanceClusterDetailsArgs']]] = None,
            cluster_public_key: Optional[pulumi.Input[str]] = None,
            cluster_version: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            created_by: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['BdsInstanceCloudSqlDetailsArgs']] cloud_sql_details: The information about added Cloud SQL capability
        :param pulumi.Input[str] cluster_admin_password: Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
        :param pulumi.Input[pulumi.InputType['BdsInstanceClusterDetailsArgs']] cluster_details: Specific info about a Hadoop cluster
        :param pulumi.Input[str] cluster_public_key: The SSH public key used to authenticate the cluster connection.
        :param pulumi.Input[str] cluster_version: Version of the Hadoop distribution.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment.
        :param pulumi.Input[str] created_by: The user who created the cluster.
    ...
    @property
    @pulumi.getter(name="cloudSqlDetails")
    def cloud_sql_details(self) -> pulumi.Output['outputs.BdsInstanceCloudSqlDetails']:
        """
        The information about added Cloud SQL capability
        """
        return pulumi.get(self, "cloud_sql_details")
    ...
    @property
    @pulumi.getter(name="clusterDetails")
    def cluster_details(self) -> pulumi.Output['outputs.BdsInstanceClusterDetails']:
        """
        Specific info about a Hadoop cluster
        """
        return pulumi.get(self, "cluster_details")
