...
class GetAutoScalingConfigurationResult:
    ...
    @property
    @pulumi.getter
    def policy(self) -> 'outputs.GetAutoScalingConfigurationPolicyResult':
        """
...
def get_auto_scaling_configuration(auto_scaling_configuration_id: Optional[str] = None,
    ...
    test_auto_scaling_configuration = oci.bds.get_auto_scaling_configuration(auto_scaling_configuration_id=oci_autoscaling_auto_scaling_configuration["test_auto_scaling_configuration"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:bds/getAutoScalingConfiguration:getAutoScalingConfiguration', __args__, opts=opts, typ=GetAutoScalingConfigurationResult).value
