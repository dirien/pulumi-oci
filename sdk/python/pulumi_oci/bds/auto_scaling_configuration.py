...
class AutoScalingConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_auto_scaling_configuration = oci.bds.AutoScalingConfiguration("testAutoScalingConfiguration",
            ...
            policy=oci.bds.AutoScalingConfigurationPolicyArgs(
                policy_type=var["auto_scaling_configuration_policy_policy_type"],
                rules=[oci.bds.AutoScalingConfigurationPolicyRuleArgs(
                    action=var["auto_scaling_configuration_policy_rules_action"],
                    metric=oci.bds.AutoScalingConfigurationPolicyRuleMetricArgs(
                        metric_type=var["auto_scaling_configuration_policy_rules_metric_metric_type"],
                        threshold=oci.bds.AutoScalingConfigurationPolicyRuleMetricThresholdArgs(
    ...
    def _internal_init(__self__,
        ...
        super(AutoScalingConfiguration, __self__).__init__(
            'oci:bds/autoScalingConfiguration:AutoScalingConfiguration',
            resource_name,
            __props__,
            opts)
