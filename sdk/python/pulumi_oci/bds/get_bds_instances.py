...
def get_bds_instances(compartment_id: Optional[str] = None,
    ...
    test_bds_instances = oci.bds.get_bds_instances(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:bds/getBdsInstances:getBdsInstances', __args__, opts=opts, typ=GetBdsInstancesResult).value
