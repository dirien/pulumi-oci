...
@pulumi.input_type
class BdsInstanceCloudSqlDetailsArgs:
    def __init__(__self__, *,
                 ...
                 kerberos_details: Optional[pulumi.Input[Sequence[pulumi.Input['BdsInstanceCloudSqlDetailsKerberosDetailArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BdsInstanceCloudSqlDetailsKerberosDetailArgs']]] kerberos_details: Details about the Kerberos principals.
        """
    ...
    def kerberos_details(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BdsInstanceCloudSqlDetailsKerberosDetailArgs']]]]:
        """
    ...
    def kerberos_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BdsInstanceCloudSqlDetailsKerberosDetailArgs']]]]):
        pulumi.set(self, "kerberos_details", value)


@pulumi.input_type
class BdsInstanceCloudSqlDetailsKerberosDetailArgs:
    def __init__(__self__, *,
...
@pulumi.input_type
class BdsInstanceClusterDetailsArgs:
    def __init__(__self__, *,
