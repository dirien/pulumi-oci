...
__all__ = ['LoadBalancerLoadBalancerRoutingPolicyArgs', 'LoadBalancerLoadBalancerRoutingPolicy']

@pulumi.input_type
class LoadBalancerLoadBalancerRoutingPolicyArgs:
    def __init__(__self__, *,
                 condition_language_version: pulumi.Input[str],
                 load_balancer_id: pulumi.Input[str],
                 rules: pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]] rules: (Updatable) The list of routing rules.
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]:
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]):
...
@pulumi.input_type
class _LoadBalancerLoadBalancerRoutingPolicyState:
    def __init__(__self__, *,
                 condition_language_version: Optional[pulumi.Input[str]] = None,
                 load_balancer_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]]:
        """
        (Updatable) The list of routing rules.
        """
        return pulumi.get(self, "rules")
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]]):
        pulumi.set(self, "rules", value)
...
class LoadBalancerLoadBalancerRoutingPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 load_balancer_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]]] = None,
                 __props__=None):
        """
        ...
        test_load_balancer_routing_policy = oci.LoadBalancerLoadBalancerRoutingPolicy("testLoadBalancerRoutingPolicy",
            condition_language_version=var["load_balancer_routing_policy_condition_language_version"],
            load_balancer_id=oci_load_balancer_load_balancer["test_load_balancer"]["id"],
            rules=[oci.LoadBalancerLoadBalancerRoutingPolicyRuleArgs(
                actions=[oci.LoadBalancerLoadBalancerRoutingPolicyRuleActionArgs(
        ...
        :param pulumi.Input[str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer to add the routing policy rule list to.
        :param pulumi.Input[str] name: (Updatable) A unique name for the routing policy rule. Avoid entering confidential information.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]] rules: (Updatable) The list of routing rules.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: LoadBalancerLoadBalancerRoutingPolicyArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Load Balancer Routing Policy resource in Oracle Cloud Infrastructure Load Balancer service.
        ...
        :param str resource_name: The name of the resource.
        :param LoadBalancerLoadBalancerRoutingPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LoadBalancerLoadBalancerRoutingPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LoadBalancerLoadBalancerRoutingPolicyArgs.__new__(LoadBalancerLoadBalancerRoutingPolicyArgs)
        ...
        super(LoadBalancerLoadBalancerRoutingPolicy, __self__).__init__(
            'oci:index/loadBalancerLoadBalancerRoutingPolicy:LoadBalancerLoadBalancerRoutingPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LoadBalancerLoadBalancerRoutingPolicyRuleArgs']]]]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'LoadBalancerLoadBalancerRoutingPolicy':
        """
        ...
        __props__ = _LoadBalancerLoadBalancerRoutingPolicyState.__new__(_LoadBalancerLoadBalancerRoutingPolicyState)
        ...
        return LoadBalancerLoadBalancerRoutingPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.LoadBalancerLoadBalancerRoutingPolicyRule']]:
        """
        (Updatable) The list of routing rules.
        """
        return pulumi.get(self, "rules")
