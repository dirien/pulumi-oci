...
__all__ = ['CoreListingResourceVersionAgreementArgs', 'CoreListingResourceVersionAgreement']

@pulumi.input_type
class CoreListingResourceVersionAgreementArgs:
...
@pulumi.input_type
class _CoreListingResourceVersionAgreementState:
    def __init__(__self__, *,
...
class CoreListingResourceVersionAgreement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CoreListingResourceVersionAgreement resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreListingResourceVersionAgreementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CoreListingResourceVersionAgreement resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CoreListingResourceVersionAgreementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreListingResourceVersionAgreementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreListingResourceVersionAgreementArgs.__new__(CoreListingResourceVersionAgreementArgs)
        ...
        super(CoreListingResourceVersionAgreement, __self__).__init__(
            'oci:index/coreListingResourceVersionAgreement:CoreListingResourceVersionAgreement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            oracle_terms_of_use_link: Optional[pulumi.Input[str]] = None,
            signature: Optional[pulumi.Input[str]] = None,
            time_retrieved: Optional[pulumi.Input[str]] = None) -> 'CoreListingResourceVersionAgreement':
        """
        ...
        __props__ = _CoreListingResourceVersionAgreementState.__new__(_CoreListingResourceVersionAgreementState)
        ...
        return CoreListingResourceVersionAgreement(resource_name, opts=opts, __props__=__props__)
