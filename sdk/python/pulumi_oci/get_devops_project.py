...
__all__ = [
    'GetDevopsProjectResult',
    'AwaitableGetDevopsProjectResult',
    'get_devops_project',
]

@pulumi.output_type
class GetDevopsProjectResult:
    """
    ...
    def notification_config(self) -> 'outputs.GetDevopsProjectNotificationConfigResult':
        """
...
class AwaitableGetDevopsProjectResult(GetDevopsProjectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsProjectResult(
...
def get_devops_project(project_id: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsProjectResult:
    """
    ...
    test_project = oci.get_devops_project(project_id=oci_devops_project["test_project"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsProject:GetDevopsProject', __args__, opts=opts, typ=GetDevopsProjectResult).value

    return AwaitableGetDevopsProjectResult(
