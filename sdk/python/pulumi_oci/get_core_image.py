...
__all__ = [
    'GetCoreImageResult',
    'AwaitableGetCoreImageResult',
    'get_core_image',
]

@pulumi.output_type
class GetCoreImageResult:
    """
    ...
    def __init__(__self__, agent_features=None, base_image_id=None, billable_size_in_gbs=None, compartment_id=None, create_image_allowed=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, image_id=None, image_source_details=None, instance_id=None, launch_mode=None, launch_options=None, listing_type=None, operating_system=None, operating_system_version=None, size_in_mbs=None, state=None, time_created=None):
        if agent_features and not isinstance(agent_features, dict):
            raise TypeError("Expected argument 'agent_features' to be a dict")
        ...
        if image_source_details and not isinstance(image_source_details, dict):
            raise TypeError("Expected argument 'image_source_details' to be a dict")
    ...
    def agent_features(self) -> 'outputs.GetCoreImageAgentFeaturesResult':
        """
    ...
    def image_source_details(self) -> 'outputs.GetCoreImageImageSourceDetailsResult':
    ...
    def launch_options(self) -> 'outputs.GetCoreImageLaunchOptionsResult':
        """
...
class AwaitableGetCoreImageResult(GetCoreImageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreImageResult(
...
def get_core_image(image_id: Optional[str] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreImageResult:
    """
    ...
    test_image = oci.get_core_image(image_id=oci_core_image["test_image"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreImage:GetCoreImage', __args__, opts=opts, typ=GetCoreImageResult).value

    return AwaitableGetCoreImageResult(
