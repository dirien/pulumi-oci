...
__all__ = ['DatabaseDatabaseArgs', 'DatabaseDatabase']

@pulumi.input_type
class DatabaseDatabaseArgs:
    def __init__(__self__, *,
                 database: pulumi.Input['DatabaseDatabaseDatabaseArgs'],
        ...
        :param pulumi.Input['DatabaseDatabaseDatabaseArgs'] database: (Updatable) Details for creating a database.
    ...
    @property
    @pulumi.getter
    def database(self) -> pulumi.Input['DatabaseDatabaseDatabaseArgs']:
        """
    ...
    @database.setter
    def database(self, value: pulumi.Input['DatabaseDatabaseDatabaseArgs']):
...
@pulumi.input_type
class _DatabaseDatabaseState:
    def __init__(__self__, *,
                 character_set: Optional[pulumi.Input[str]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 connection_strings: Optional[pulumi.Input['DatabaseDatabaseConnectionStringsArgs']] = None,
                 database: Optional[pulumi.Input['DatabaseDatabaseDatabaseArgs']] = None,
        ...
        :param pulumi.Input['DatabaseDatabaseConnectionStringsArgs'] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input['DatabaseDatabaseDatabaseArgs'] database: (Updatable) Details for creating a database.
    ...
    def connection_strings(self) -> Optional[pulumi.Input['DatabaseDatabaseConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: Optional[pulumi.Input['DatabaseDatabaseConnectionStringsArgs']]):
        pulumi.set(self, "connection_strings", value)

    @property
    @pulumi.getter
    def database(self) -> Optional[pulumi.Input['DatabaseDatabaseDatabaseArgs']]:
        """
        (Updatable) Details for creating a database.
        """
        return pulumi.get(self, "database")
    ...
    @database.setter
    def database(self, value: Optional[pulumi.Input['DatabaseDatabaseDatabaseArgs']]):
        pulumi.set(self, "database", value)
...
class DatabaseDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 database: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseDatabaseArgs']]] = None,
                 db_home_id: Optional[pulumi.Input[str]] = None,
                 db_version: Optional[pulumi.Input[str]] = None,
                 kms_key_id: Optional[pulumi.Input[str]] = None,
                 kms_key_migration: Optional[pulumi.Input[bool]] = None,
        ...
        test_database = oci.DatabaseDatabase("testDatabase",
            database=oci.DatabaseDatabaseDatabaseArgs(
                ...
                db_backup_config=oci.DatabaseDatabaseDatabaseDbBackupConfigArgs(
                    ...
                    backup_destination_details=[oci.DatabaseDatabaseDatabaseDbBackupConfigBackupDestinationDetailArgs(
        ...
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseDatabaseArgs']] database: (Updatable) Details for creating a database.
        :param pulumi.Input[str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        :param pulumi.Input[str] db_version: A valid Oracle Database version. To get a list of supported versions, use the [ListDbVersions](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/DbVersionSummary/ListDbVersions) operation.
        :param pulumi.Input[str] kms_key_id: The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.
        :param pulumi.Input[bool] kms_key_migration: The value to migrate to the kms version from none. Can only use once by setting value to true. You can not switch back to non-kms once you created or migrated.(https://www.oracle.com/security/cloud-security/key-management/faq/)
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseDatabaseArgs.__new__(DatabaseDatabaseArgs)
        ...
        super(DatabaseDatabase, __self__).__init__(
            'oci:index/databaseDatabase:DatabaseDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            character_set: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_strings: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseConnectionStringsArgs']]] = None,
            database: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseDatabaseArgs']]] = None,
            database_software_image_id: Optional[pulumi.Input[str]] = None,
            db_backup_config: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseDbBackupConfigArgs']]] = None,
            db_home_id: Optional[pulumi.Input[str]] = None,
            db_name: Optional[pulumi.Input[str]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            db_unique_name: Optional[pulumi.Input[str]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vm_cluster_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseDatabase':
        """
        ...
        :param pulumi.Input[str] character_set: The character set for the database.  The default is AL32UTF8. Allowed values are:
        :param pulumi.Input[str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseConnectionStringsArgs']] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseDatabaseArgs']] database: (Updatable) Details for creating a database.
        :param pulumi.Input[str] database_software_image_id: The database software image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseDbBackupConfigArgs']] db_backup_config: (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        :param pulumi.Input[str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        :param pulumi.Input[str] db_name: The display name of the database to be created from the backup. It must begin with an alphabetic character and can contain a maximum of eight alphanumeric characters. Special characters are not permitted.
        :param pulumi.Input[str] db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        :param pulumi.Input[str] db_unique_name: The `DB_UNIQUE_NAME` of the Oracle Database being backed up.
        ...
        __props__ = _DatabaseDatabaseState.__new__(_DatabaseDatabaseState)
        ...
        return DatabaseDatabase(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Output['outputs.DatabaseDatabaseConnectionStrings']:
        """
        The Connection strings used to connect to the Oracle Database.
        """
        return pulumi.get(self, "connection_strings")
    ...
    @property
    @pulumi.getter
    def database(self) -> pulumi.Output['outputs.DatabaseDatabaseDatabase']:
        """
        (Updatable) Details for creating a database.
        """
        return pulumi.get(self, "database")
    ...
    @property
    @pulumi.getter(name="dbBackupConfig")
    def db_backup_config(self) -> pulumi.Output['outputs.DatabaseDatabaseDbBackupConfig']:
        """
        (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        """
        return pulumi.get(self, "db_backup_config")
