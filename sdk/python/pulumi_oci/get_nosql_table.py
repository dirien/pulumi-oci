...
__all__ = [
    'GetNosqlTableResult',
    'AwaitableGetNosqlTableResult',
    'get_nosql_table',
]

@pulumi.output_type
class GetNosqlTableResult:
    """
    A collection of values returned by GetNosqlTable.
    """
    def __init__(__self__, compartment_id=None, ddl_statement=None, defined_tags=None, freeform_tags=None, id=None, is_auto_reclaimable=None, lifecycle_details=None, name=None, schema=None, state=None, system_tags=None, table_limits=None, table_name_or_id=None, time_created=None, time_of_expiration=None, time_updated=None):
        ...
        if table_limits and not isinstance(table_limits, dict):
            raise TypeError("Expected argument 'table_limits' to be a dict")
    ...
    @property
    @pulumi.getter
    def schema(self) -> 'outputs.GetNosqlTableSchemaResult':
        """
    ...
    def table_limits(self) -> 'outputs.GetNosqlTableTableLimitsResult':
        """
...
class AwaitableGetNosqlTableResult(GetNosqlTableResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNosqlTableResult(
...
def get_nosql_table(compartment_id: Optional[str] = None,
                    table_name_or_id: Optional[str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNosqlTableResult:
    """
    ...
    test_table = oci.get_nosql_table(table_name_or_id=oci_nosql_table_name_or["test_table_name_or"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNosqlTable:GetNosqlTable', __args__, opts=opts, typ=GetNosqlTableResult).value

    return AwaitableGetNosqlTableResult(
