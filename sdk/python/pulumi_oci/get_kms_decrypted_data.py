...
__all__ = [
    'GetKmsDecryptedDataResult',
    'AwaitableGetKmsDecryptedDataResult',
    'get_kms_decrypted_data',
]

@pulumi.output_type
class GetKmsDecryptedDataResult:
    """
...
class AwaitableGetKmsDecryptedDataResult(GetKmsDecryptedDataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsDecryptedDataResult(
...
def get_kms_decrypted_data(associated_data: Optional[Mapping[str, Any]] = None,
                           ciphertext: Optional[str] = None,
                           crypto_endpoint: Optional[str] = None,
                           key_id: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsDecryptedDataResult:
    """
    ...
    test_decrypted_data = oci.get_kms_decrypted_data(ciphertext=var["decrypted_data_ciphertext"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsDecryptedData:GetKmsDecryptedData', __args__, opts=opts, typ=GetKmsDecryptedDataResult).value

    return AwaitableGetKmsDecryptedDataResult(
