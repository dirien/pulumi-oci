...
__all__ = [
    'GetLoggingLogGroupResult',
    'AwaitableGetLoggingLogGroupResult',
    'get_logging_log_group',
]

@pulumi.output_type
class GetLoggingLogGroupResult:
    """
...
class AwaitableGetLoggingLogGroupResult(GetLoggingLogGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingLogGroupResult(
...
def get_logging_log_group(log_group_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingLogGroupResult:
    """
    ...
    test_log_group = oci.get_logging_log_group(log_group_id=oci_logging_log_group["test_log_group"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingLogGroup:GetLoggingLogGroup', __args__, opts=opts, typ=GetLoggingLogGroupResult).value

    return AwaitableGetLoggingLogGroupResult(
