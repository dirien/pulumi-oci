...
__all__ = [
    'GetLoggingLogsResult',
    'AwaitableGetLoggingLogsResult',
    'get_logging_logs',
]

@pulumi.output_type
class GetLoggingLogsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLoggingLogsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def logs(self) -> Sequence['outputs.GetLoggingLogsLogResult']:
        """
        The list of logs.
        """
...
class AwaitableGetLoggingLogsResult(GetLoggingLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingLogsResult(
...
def get_logging_logs(display_name: Optional[str] = None,
                     filters: Optional[Sequence[pulumi.InputType['GetLoggingLogsFilterArgs']]] = None,
                     log_group_id: Optional[str] = None,
                     log_type: Optional[str] = None,
                     source_resource: Optional[str] = None,
                     source_service: Optional[str] = None,
                     state: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingLogsResult:
    """
    ...
    test_logs = oci.get_logging_logs(log_group_id=oci_logging_log_group["test_log_group"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingLogs:GetLoggingLogs', __args__, opts=opts, typ=GetLoggingLogsResult).value

    return AwaitableGetLoggingLogsResult(
