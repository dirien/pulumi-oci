...
__all__ = [
    'GetDatabaseVmClustersResult',
    'AwaitableGetDatabaseVmClustersResult',
    'get_database_vm_clusters',
]

@pulumi.output_type
class GetDatabaseVmClustersResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseVmClustersFilterResult']]:
    ...
    def vm_clusters(self) -> Sequence['outputs.GetDatabaseVmClustersVmClusterResult']:
        """
...
class AwaitableGetDatabaseVmClustersResult(GetDatabaseVmClustersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClustersResult(
...
def get_database_vm_clusters(compartment_id: Optional[str] = None,
                             display_name: Optional[str] = None,
                             exadata_infrastructure_id: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetDatabaseVmClustersFilterArgs']]] = None,
                             state: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClustersResult:
    """
    ...
    test_vm_clusters = oci.get_database_vm_clusters(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusters:GetDatabaseVmClusters', __args__, opts=opts, typ=GetDatabaseVmClustersResult).value

    return AwaitableGetDatabaseVmClustersResult(
