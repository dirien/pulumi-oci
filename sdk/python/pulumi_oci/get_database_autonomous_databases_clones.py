...
__all__ = [
    'GetDatabaseAutonomousDatabasesClonesResult',
    'AwaitableGetDatabaseAutonomousDatabasesClonesResult',
    'get_database_autonomous_databases_clones',
]

@pulumi.output_type
class GetDatabaseAutonomousDatabasesClonesResult:
    """
    ...
    def autonomous_databases(self) -> Sequence['outputs.GetDatabaseAutonomousDatabasesClonesAutonomousDatabaseResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseAutonomousDatabasesClonesFilterResult']]:
...
class AwaitableGetDatabaseAutonomousDatabasesClonesResult(GetDatabaseAutonomousDatabasesClonesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousDatabasesClonesResult(
...
def get_database_autonomous_databases_clones(autonomous_database_id: Optional[str] = None,
                                             clone_type: Optional[str] = None,
                                             compartment_id: Optional[str] = None,
                                             display_name: Optional[str] = None,
                                             filters: Optional[Sequence[pulumi.InputType['GetDatabaseAutonomousDatabasesClonesFilterArgs']]] = None,
                                             state: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousDatabasesClonesResult:
    """
    ...
    test_autonomous_databases_clones = oci.get_database_autonomous_databases_clones(autonomous_database_id=oci_database_autonomous_database["test_autonomous_database"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousDatabasesClones:GetDatabaseAutonomousDatabasesClones', __args__, opts=opts, typ=GetDatabaseAutonomousDatabasesClonesResult).value

    return AwaitableGetDatabaseAutonomousDatabasesClonesResult(
