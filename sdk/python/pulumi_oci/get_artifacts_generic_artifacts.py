...
__all__ = [
    'GetArtifactsGenericArtifactsResult',
    'AwaitableGetArtifactsGenericArtifactsResult',
    'get_artifacts_generic_artifacts',
]

@pulumi.output_type
class GetArtifactsGenericArtifactsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetArtifactsGenericArtifactsFilterResult']]:
        return pulumi.get(self, "filters")

    @property
    @pulumi.getter(name="genericArtifactCollections")
    def generic_artifact_collections(self) -> Sequence['outputs.GetArtifactsGenericArtifactsGenericArtifactCollectionResult']:
        """
...
class AwaitableGetArtifactsGenericArtifactsResult(GetArtifactsGenericArtifactsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsGenericArtifactsResult(
...
def get_artifacts_generic_artifacts(artifact_path: Optional[str] = None,
                                    compartment_id: Optional[str] = None,
                                    display_name: Optional[str] = None,
                                    filters: Optional[Sequence[pulumi.InputType['GetArtifactsGenericArtifactsFilterArgs']]] = None,
                                    id: Optional[str] = None,
                                    repository_id: Optional[str] = None,
                                    sha256: Optional[str] = None,
                                    state: Optional[str] = None,
                                    version: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsGenericArtifactsResult:
    """
    ...
    test_generic_artifacts = oci.get_artifacts_generic_artifacts(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsGenericArtifacts:GetArtifactsGenericArtifacts', __args__, opts=opts, typ=GetArtifactsGenericArtifactsResult).value

    return AwaitableGetArtifactsGenericArtifactsResult(
