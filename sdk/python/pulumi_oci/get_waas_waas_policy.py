...
__all__ = [
    'GetWaasWaasPolicyResult',
    'AwaitableGetWaasWaasPolicyResult',
    'get_waas_waas_policy',
]

@pulumi.output_type
class GetWaasWaasPolicyResult:
    """
    ...
    def origin_groups(self) -> Sequence['outputs.GetWaasWaasPolicyOriginGroupResult']:
        """
    ...
    @property
    @pulumi.getter
    def origins(self) -> Sequence['outputs.GetWaasWaasPolicyOriginResult']:
        """
    ...
    def policy_configs(self) -> Sequence['outputs.GetWaasWaasPolicyPolicyConfigResult']:
        """
    ...
    def waf_configs(self) -> Sequence['outputs.GetWaasWaasPolicyWafConfigResult']:
        """
...
class AwaitableGetWaasWaasPolicyResult(GetWaasWaasPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasWaasPolicyResult(
...
def get_waas_waas_policy(waas_policy_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasWaasPolicyResult:
    """
    ...
    test_waas_policy = oci.get_waas_waas_policy(waas_policy_id=oci_waas_waas_policy["test_waas_policy"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasWaasPolicy:GetWaasWaasPolicy', __args__, opts=opts, typ=GetWaasWaasPolicyResult).value

    return AwaitableGetWaasWaasPolicyResult(
