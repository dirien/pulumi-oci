...
__all__ = [
    'GetDatascienceModelProvenanceResult',
    'AwaitableGetDatascienceModelProvenanceResult',
    'get_datascience_model_provenance',
]

@pulumi.output_type
class GetDatascienceModelProvenanceResult:
    """
...
class AwaitableGetDatascienceModelProvenanceResult(GetDatascienceModelProvenanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceModelProvenanceResult(
...
def get_datascience_model_provenance(model_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceModelProvenanceResult:
    """
    ...
    test_model_provenance = oci.get_datascience_model_provenance(model_id=oci_datascience_model["test_model"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceModelProvenance:GetDatascienceModelProvenance', __args__, opts=opts, typ=GetDatascienceModelProvenanceResult).value

    return AwaitableGetDatascienceModelProvenanceResult(
