...
__all__ = [
    'GetOsmanagementSoftwareSourceResult',
    'AwaitableGetOsmanagementSoftwareSourceResult',
    'get_osmanagement_software_source',
]

@pulumi.output_type
class GetOsmanagementSoftwareSourceResult:
    """
    ...
    def associated_managed_instances(self) -> Sequence['outputs.GetOsmanagementSoftwareSourceAssociatedManagedInstanceResult']:
        """
...
class AwaitableGetOsmanagementSoftwareSourceResult(GetOsmanagementSoftwareSourceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOsmanagementSoftwareSourceResult(
...
def get_osmanagement_software_source(software_source_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOsmanagementSoftwareSourceResult:
    """
    ...
    test_software_source = oci.get_osmanagement_software_source(software_source_id=oci_osmanagement_software_source["test_software_source"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOsmanagementSoftwareSource:GetOsmanagementSoftwareSource', __args__, opts=opts, typ=GetOsmanagementSoftwareSourceResult).value

    return AwaitableGetOsmanagementSoftwareSourceResult(
