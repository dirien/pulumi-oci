...
class JmsFleet(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_fleet = oci.JmsFleet("testFleet",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param JmsFleetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(JmsFleetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = JmsFleetArgs.__new__(JmsFleetArgs)
        ...
        super(JmsFleet, __self__).__init__(
            'oci:index/jmsFleet:JmsFleet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'JmsFleet':
        """
        ...
        __props__ = _JmsFleetState.__new__(_JmsFleetState)
        ...
        return JmsFleet(resource_name, opts=opts, __props__=__props__)
