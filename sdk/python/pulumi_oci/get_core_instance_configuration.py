...
__all__ = [
    'GetCoreInstanceConfigurationResult',
    'AwaitableGetCoreInstanceConfigurationResult',
    'get_core_instance_configuration',
]

@pulumi.output_type
class GetCoreInstanceConfigurationResult:
    """
    ...
    def __init__(__self__, compartment_id=None, deferred_fields=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, instance_configuration_id=None, instance_details=None, instance_id=None, source=None, time_created=None):
        ...
        if instance_details and not isinstance(instance_details, dict):
            raise TypeError("Expected argument 'instance_details' to be a dict")
    ...
    def instance_details(self) -> 'outputs.GetCoreInstanceConfigurationInstanceDetailsResult':
...
class AwaitableGetCoreInstanceConfigurationResult(GetCoreInstanceConfigurationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstanceConfigurationResult(
...
def get_core_instance_configuration(instance_configuration_id: Optional[str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstanceConfigurationResult:
    """
    ...
    test_instance_configuration = oci.get_core_instance_configuration(instance_configuration_id=oci_core_instance_configuration["test_instance_configuration"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstanceConfiguration:GetCoreInstanceConfiguration', __args__, opts=opts, typ=GetCoreInstanceConfigurationResult).value

    return AwaitableGetCoreInstanceConfigurationResult(
