...
__all__ = ['CoreRouteTableAttachmentArgs', 'CoreRouteTableAttachment']

@pulumi.input_type
class CoreRouteTableAttachmentArgs:
...
@pulumi.input_type
class _CoreRouteTableAttachmentState:
    def __init__(__self__, *,
...
class CoreRouteTableAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_route_table_attachment = oci.CoreRouteTableAttachment("testRouteTableAttachment",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CoreRouteTableAttachmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the ability to associate a route table for a subnet in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreRouteTableAttachmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreRouteTableAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreRouteTableAttachmentArgs.__new__(CoreRouteTableAttachmentArgs)
        ...
        super(CoreRouteTableAttachment, __self__).__init__(
            'oci:index/coreRouteTableAttachment:CoreRouteTableAttachment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            route_table_id: Optional[pulumi.Input[str]] = None,
            subnet_id: Optional[pulumi.Input[str]] = None) -> 'CoreRouteTableAttachment':
        """
        ...
        __props__ = _CoreRouteTableAttachmentState.__new__(_CoreRouteTableAttachmentState)

        __props__.__dict__["route_table_id"] = route_table_id
        __props__.__dict__["subnet_id"] = subnet_id
        return CoreRouteTableAttachment(resource_name, opts=opts, __props__=__props__)
