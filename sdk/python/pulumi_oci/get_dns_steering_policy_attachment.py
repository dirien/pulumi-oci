...
__all__ = [
    'GetDnsSteeringPolicyAttachmentResult',
    'AwaitableGetDnsSteeringPolicyAttachmentResult',
    'get_dns_steering_policy_attachment',
]

@pulumi.output_type
class GetDnsSteeringPolicyAttachmentResult:
    """
...
class AwaitableGetDnsSteeringPolicyAttachmentResult(GetDnsSteeringPolicyAttachmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsSteeringPolicyAttachmentResult(
...
def get_dns_steering_policy_attachment(steering_policy_attachment_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsSteeringPolicyAttachmentResult:
    """
    ...
    test_steering_policy_attachment = oci.get_dns_steering_policy_attachment(steering_policy_attachment_id=oci_dns_steering_policy_attachment["test_steering_policy_attachment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsSteeringPolicyAttachment:GetDnsSteeringPolicyAttachment', __args__, opts=opts, typ=GetDnsSteeringPolicyAttachmentResult).value

    return AwaitableGetDnsSteeringPolicyAttachmentResult(
