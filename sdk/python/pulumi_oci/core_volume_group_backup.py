...
__all__ = ['CoreVolumeGroupBackupArgs', 'CoreVolumeGroupBackup']

@pulumi.input_type
class CoreVolumeGroupBackupArgs:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 source_details: Optional[pulumi.Input['CoreVolumeGroupBackupSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the volume group backup. Does not have to be unique and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input['CoreVolumeGroupBackupSourceDetailsArgs'] source_details: Details of the volume group backup source in the cloud.
    ...
    def source_details(self) -> Optional[pulumi.Input['CoreVolumeGroupBackupSourceDetailsArgs']]:
        """
    ...
    def source_details(self, value: Optional[pulumi.Input['CoreVolumeGroupBackupSourceDetailsArgs']]):
...
@pulumi.input_type
class _CoreVolumeGroupBackupState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
...
class CoreVolumeGroupBackup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 source_details: Optional[pulumi.Input[pulumi.InputType['CoreVolumeGroupBackupSourceDetailsArgs']]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 volume_group_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_volume_group_backup = oci.CoreVolumeGroupBackup("testVolumeGroupBackup",
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the volume group backup. Does not have to be unique and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['CoreVolumeGroupBackupSourceDetailsArgs']] source_details: Details of the volume group backup source in the cloud.
        :param pulumi.Input[str] type: The type of backup to create. If omitted, defaults to incremental.
               * Allowed values are :
               * FULL
               * INCREMENTAL
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CoreVolumeGroupBackupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Volume Group Backup resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeGroupBackupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeGroupBackupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeGroupBackupArgs.__new__(CoreVolumeGroupBackupArgs)
        ...
        super(CoreVolumeGroupBackup, __self__).__init__(
            'oci:index/coreVolumeGroupBackup:CoreVolumeGroupBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            unique_size_in_mbs: Optional[pulumi.Input[str]] = None,
            volume_backup_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            volume_group_id: Optional[pulumi.Input[str]] = None) -> 'CoreVolumeGroupBackup':
        """
        ...
        __props__ = _CoreVolumeGroupBackupState.__new__(_CoreVolumeGroupBackupState)
        ...
        __props__.__dict__["volume_group_id"] = volume_group_id
        return CoreVolumeGroupBackup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output[Optional['outputs.CoreVolumeGroupBackupSourceDetails']]:
        """
        Details of the volume group backup source in the cloud.
        """
        return pulumi.get(self, "source_details")
