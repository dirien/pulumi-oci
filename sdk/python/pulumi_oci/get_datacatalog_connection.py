...
__all__ = [
    'GetDatacatalogConnectionResult',
    'AwaitableGetDatacatalogConnectionResult',
    'get_datacatalog_connection',
]

@pulumi.output_type
class GetDatacatalogConnectionResult:
    """
...
class AwaitableGetDatacatalogConnectionResult(GetDatacatalogConnectionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogConnectionResult(
...
def get_datacatalog_connection(catalog_id: Optional[str] = None,
                               connection_key: Optional[str] = None,
                               data_asset_key: Optional[str] = None,
                               fields: Optional[Sequence[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogConnectionResult:
    """
    ...
    test_connection = oci.get_datacatalog_connection(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogConnection:GetDatacatalogConnection', __args__, opts=opts, typ=GetDatacatalogConnectionResult).value

    return AwaitableGetDatacatalogConnectionResult(
