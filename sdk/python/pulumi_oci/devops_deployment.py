...
__all__ = ['DevopsDeploymentArgs', 'DevopsDeployment']

@pulumi.input_type
class DevopsDeploymentArgs:
    def __init__(__self__, *,
                 deploy_pipeline_id: pulumi.Input[str],
                 deployment_type: pulumi.Input[str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_artifact_override_arguments: Optional[pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']] = None,
                 deploy_stage_id: Optional[pulumi.Input[str]] = None,
                 deployment_arguments: Optional[pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs']] = None,
        ...
        :param pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs'] deploy_artifact_override_arguments: Specifies the list of artifact override arguments at the time of deployment.
        :param pulumi.Input[str] deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        :param pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs'] deployment_arguments: Specifies list of arguments passed along with the deployment.
    ...
    def deploy_artifact_override_arguments(self) -> Optional[pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']]:
        """
    ...
    def deploy_artifact_override_arguments(self, value: Optional[pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']]):
    ...
    def deployment_arguments(self) -> Optional[pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs']]:
        """
    ...
    def deployment_arguments(self, value: Optional[pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs']]):
...
@pulumi.input_type
class _DevopsDeploymentState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_artifact_override_arguments: Optional[pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']] = None,
                 deploy_pipeline_artifacts: Optional[pulumi.Input['DevopsDeploymentDeployPipelineArtifactsArgs']] = None,
                 deploy_pipeline_environments: Optional[pulumi.Input['DevopsDeploymentDeployPipelineEnvironmentsArgs']] = None,
                 deploy_pipeline_id: Optional[pulumi.Input[str]] = None,
                 deploy_stage_id: Optional[pulumi.Input[str]] = None,
                 deployment_arguments: Optional[pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs']] = None,
                 deployment_execution_progress: Optional[pulumi.Input['DevopsDeploymentDeploymentExecutionProgressArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input['DevopsDeploymentDeployArtifactOverrideArgumentsArgs'] deploy_artifact_override_arguments: Specifies the list of artifact override arguments at the time of deployment.
        :param pulumi.Input['DevopsDeploymentDeployPipelineArtifactsArgs'] deploy_pipeline_artifacts: List of all artifacts used in the pipeline.
        :param pulumi.Input['DevopsDeploymentDeployPipelineEnvironmentsArgs'] deploy_pipeline_environments: List of all environments used in the pipeline.
        :param pulumi.Input[str] deploy_pipeline_id: The OCID of a pipeline.
        :param pulumi.Input[str] deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        :param pulumi.Input['DevopsDeploymentDeploymentArgumentsArgs'] deployment_arguments: Specifies list of arguments passed along with the deployment.
        :param pulumi.Input['DevopsDeploymentDeploymentExecutionProgressArgs'] deployment_execution_progress: The execution progress details of a deployment.
        :param pulumi.Input[str] deployment_type: (Updatable) Specifies type for this deployment.
        :param pulumi.Input[str] display_name: (Updatable) Deployment display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        ...
        if deployment_arguments is not None:
            pulumi.set(__self__, "deployment_arguments", deployment_arguments)
        if deployment_execution_progress is not None:
    ...
    def deploy_pipeline_artifacts(self) -> Optional[pulumi.Input['DevopsDeploymentDeployPipelineArtifactsArgs']]:
        """
    ...
    def deploy_pipeline_artifacts(self, value: Optional[pulumi.Input['DevopsDeploymentDeployPipelineArtifactsArgs']]):
        pulumi.set(self, "deploy_pipeline_artifacts", value)

    @property
    @pulumi.getter(name="deployPipelineEnvironments")
    def deploy_pipeline_environments(self) -> Optional[pulumi.Input['DevopsDeploymentDeployPipelineEnvironmentsArgs']]:
        """
    ...
    def deploy_pipeline_environments(self, value: Optional[pulumi.Input['DevopsDeploymentDeployPipelineEnvironmentsArgs']]):
    ...
    def deployment_execution_progress(self) -> Optional[pulumi.Input['DevopsDeploymentDeploymentExecutionProgressArgs']]:
        """
    ...
    def deployment_execution_progress(self, value: Optional[pulumi.Input['DevopsDeploymentDeploymentExecutionProgressArgs']]):
...
class DevopsDeployment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 deploy_artifact_override_arguments: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']]] = None,
                 deploy_pipeline_id: Optional[pulumi.Input[str]] = None,
                 deploy_stage_id: Optional[pulumi.Input[str]] = None,
                 deployment_arguments: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentArgumentsArgs']]] = None,
                 deployment_type: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 previous_deployment_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']] deploy_artifact_override_arguments: Specifies the list of artifact override arguments at the time of deployment.
        :param pulumi.Input[str] deploy_pipeline_id: The OCID of a pipeline.
        :param pulumi.Input[str] deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentArgumentsArgs']] deployment_arguments: Specifies list of arguments passed along with the deployment.
        :param pulumi.Input[str] deployment_type: (Updatable) Specifies type for this deployment.
        :param pulumi.Input[str] display_name: (Updatable) Deployment display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[str] previous_deployment_id: Specifies the OCID of the previous deployment to be redeployed.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DevopsDeploymentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DevopsDeploymentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DevopsDeploymentArgs.__new__(DevopsDeploymentArgs)
        ...
        super(DevopsDeployment, __self__).__init__(
            'oci:index/devopsDeployment:DevopsDeployment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            deploy_artifact_override_arguments: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']]] = None,
            deploy_pipeline_artifacts: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeployPipelineArtifactsArgs']]] = None,
            deploy_pipeline_environments: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeployPipelineEnvironmentsArgs']]] = None,
            deploy_pipeline_id: Optional[pulumi.Input[str]] = None,
            deploy_stage_id: Optional[pulumi.Input[str]] = None,
            deployment_arguments: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentArgumentsArgs']]] = None,
            deployment_execution_progress: Optional[pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentExecutionProgressArgs']]] = None,
            deployment_type: Optional[pulumi.Input[str]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'DevopsDeployment':
        """
        ...
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeployArtifactOverrideArgumentsArgs']] deploy_artifact_override_arguments: Specifies the list of artifact override arguments at the time of deployment.
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeployPipelineArtifactsArgs']] deploy_pipeline_artifacts: List of all artifacts used in the pipeline.
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeployPipelineEnvironmentsArgs']] deploy_pipeline_environments: List of all environments used in the pipeline.
        :param pulumi.Input[str] deploy_pipeline_id: The OCID of a pipeline.
        :param pulumi.Input[str] deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentArgumentsArgs']] deployment_arguments: Specifies list of arguments passed along with the deployment.
        :param pulumi.Input[pulumi.InputType['DevopsDeploymentDeploymentExecutionProgressArgs']] deployment_execution_progress: The execution progress details of a deployment.
        :param pulumi.Input[str] deployment_type: (Updatable) Specifies type for this deployment.
        :param pulumi.Input[str] display_name: (Updatable) Deployment display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        __props__ = _DevopsDeploymentState.__new__(_DevopsDeploymentState)
        ...
        __props__.__dict__["deploy_stage_id"] = deploy_stage_id
        __props__.__dict__["deployment_arguments"] = deployment_arguments
        __props__.__dict__["deployment_execution_progress"] = deployment_execution_progress
        __props__.__dict__["deployment_type"] = deployment_type
        __props__.__dict__["display_name"] = display_name
        __props__.__dict__["freeform_tags"] = freeform_tags
        ...
        return DevopsDeployment(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="deployArtifactOverrideArguments")
    def deploy_artifact_override_arguments(self) -> pulumi.Output['outputs.DevopsDeploymentDeployArtifactOverrideArguments']:
        """
        Specifies the list of artifact override arguments at the time of deployment.
        """
        return pulumi.get(self, "deploy_artifact_override_arguments")
    ...
    @property
    @pulumi.getter(name="deployPipelineArtifacts")
    def deploy_pipeline_artifacts(self) -> pulumi.Output['outputs.DevopsDeploymentDeployPipelineArtifacts']:
        """
        List of all artifacts used in the pipeline.
        """
        return pulumi.get(self, "deploy_pipeline_artifacts")
    ...
    @property
    @pulumi.getter(name="deployPipelineEnvironments")
    def deploy_pipeline_environments(self) -> pulumi.Output['outputs.DevopsDeploymentDeployPipelineEnvironments']:
        """
        List of all environments used in the pipeline.
        """
        return pulumi.get(self, "deploy_pipeline_environments")
    ...
    @property
    @pulumi.getter(name="deploymentArguments")
    def deployment_arguments(self) -> pulumi.Output['outputs.DevopsDeploymentDeploymentArguments']:
        """
        Specifies list of arguments passed along with the deployment.
        """
        return pulumi.get(self, "deployment_arguments")
    ...
    @property
    @pulumi.getter(name="deploymentExecutionProgress")
    def deployment_execution_progress(self) -> pulumi.Output['outputs.DevopsDeploymentDeploymentExecutionProgress']:
        """
        The execution progress details of a deployment.
        """
        return pulumi.get(self, "deployment_execution_progress")
