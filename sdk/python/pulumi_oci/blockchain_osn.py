...
__all__ = ['BlockchainOsnArgs', 'BlockchainOsn']

@pulumi.input_type
class BlockchainOsnArgs:
    def __init__(__self__, *,
                 ad: pulumi.Input[str],
                 blockchain_platform_id: pulumi.Input[str],
                 ocpu_allocation_param: Optional[pulumi.Input['BlockchainOsnOcpuAllocationParamArgs']] = None):
        """
        ...
        :param pulumi.Input['BlockchainOsnOcpuAllocationParamArgs'] ocpu_allocation_param: (Updatable) OCPU allocation parameter
        """
    ...
    def ocpu_allocation_param(self) -> Optional[pulumi.Input['BlockchainOsnOcpuAllocationParamArgs']]:
        """
    ...
    def ocpu_allocation_param(self, value: Optional[pulumi.Input['BlockchainOsnOcpuAllocationParamArgs']]):
        pulumi.set(self, "ocpu_allocation_param", value)


@pulumi.input_type
class _BlockchainOsnState:
    def __init__(__self__, *,
...
class BlockchainOsn(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ad: Optional[pulumi.Input[str]] = None,
                 blockchain_platform_id: Optional[pulumi.Input[str]] = None,
                 ocpu_allocation_param: Optional[pulumi.Input[pulumi.InputType['BlockchainOsnOcpuAllocationParamArgs']]] = None,
                 __props__=None):
        """
        ...
        test_osn = oci.BlockchainOsn("testOsn",
            ad=var["osn_ad"],
            blockchain_platform_id=oci_blockchain_blockchain_platform["test_blockchain_platform"]["id"],
            ocpu_allocation_param=oci.BlockchainOsnOcpuAllocationParamArgs(
        ...
        :param pulumi.Input[str] ad: Availability Domain to place new OSN
        :param pulumi.Input[str] blockchain_platform_id: Unique service identifier.
        :param pulumi.Input[pulumi.InputType['BlockchainOsnOcpuAllocationParamArgs']] ocpu_allocation_param: (Updatable) OCPU allocation parameter
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: BlockchainOsnArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Osn resource in Oracle Cloud Infrastructure Blockchain service.
        ...
        :param str resource_name: The name of the resource.
        :param BlockchainOsnArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BlockchainOsnArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BlockchainOsnArgs.__new__(BlockchainOsnArgs)
        ...
        super(BlockchainOsn, __self__).__init__(
            'oci:index/blockchainOsn:BlockchainOsn',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ocpu_allocation_param: Optional[pulumi.Input[pulumi.InputType['BlockchainOsnOcpuAllocationParamArgs']]] = None,
            osn_key: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'BlockchainOsn':
        """
        ...
        __props__ = _BlockchainOsnState.__new__(_BlockchainOsnState)
        ...
        return BlockchainOsn(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="ocpuAllocationParam")
    def ocpu_allocation_param(self) -> pulumi.Output['outputs.BlockchainOsnOcpuAllocationParam']:
        """
        (Updatable) OCPU allocation parameter
        """
        return pulumi.get(self, "ocpu_allocation_param")
