...
__all__ = [
    'GetComputeinstanceagentInstanceAgentPluginResult',
    'AwaitableGetComputeinstanceagentInstanceAgentPluginResult',
    'get_computeinstanceagent_instance_agent_plugin',
]

@pulumi.output_type
class GetComputeinstanceagentInstanceAgentPluginResult:
    """
...
class AwaitableGetComputeinstanceagentInstanceAgentPluginResult(GetComputeinstanceagentInstanceAgentPluginResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeinstanceagentInstanceAgentPluginResult(
...
def get_computeinstanceagent_instance_agent_plugin(compartment_id: Optional[str] = None,
                                                   instanceagent_id: Optional[str] = None,
                                                   plugin_name: Optional[str] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeinstanceagentInstanceAgentPluginResult:
    """
    ...
    test_instance_agent_plugin = oci.get_computeinstanceagent_instance_agent_plugin(instanceagent_id=oci_computeinstanceagent_instanceagent["test_instanceagent"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getComputeinstanceagentInstanceAgentPlugin:GetComputeinstanceagentInstanceAgentPlugin', __args__, opts=opts, typ=GetComputeinstanceagentInstanceAgentPluginResult).value

    return AwaitableGetComputeinstanceagentInstanceAgentPluginResult(
