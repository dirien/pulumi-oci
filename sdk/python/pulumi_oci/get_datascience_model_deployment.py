...
__all__ = [
    'GetDatascienceModelDeploymentResult',
    'AwaitableGetDatascienceModelDeploymentResult',
    'get_datascience_model_deployment',
]

@pulumi.output_type
class GetDatascienceModelDeploymentResult:
    """
    ...
    def __init__(__self__, category_log_details=None, compartment_id=None, created_by=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, model_deployment_configuration_details=None, model_deployment_id=None, model_deployment_url=None, project_id=None, state=None, time_created=None):
        if category_log_details and not isinstance(category_log_details, dict):
            raise TypeError("Expected argument 'category_log_details' to be a dict")
        ...
        if model_deployment_configuration_details and not isinstance(model_deployment_configuration_details, dict):
            raise TypeError("Expected argument 'model_deployment_configuration_details' to be a dict")
    ...
    def category_log_details(self) -> 'outputs.GetDatascienceModelDeploymentCategoryLogDetailsResult':
        """
    ...
    def model_deployment_configuration_details(self) -> 'outputs.GetDatascienceModelDeploymentModelDeploymentConfigurationDetailsResult':
        """
...
class AwaitableGetDatascienceModelDeploymentResult(GetDatascienceModelDeploymentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceModelDeploymentResult(
...
def get_datascience_model_deployment(model_deployment_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceModelDeploymentResult:
    """
    ...
    test_model_deployment = oci.get_datascience_model_deployment(model_deployment_id=oci_datascience_model_deployment["test_model_deployment"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceModelDeployment:GetDatascienceModelDeployment', __args__, opts=opts, typ=GetDatascienceModelDeploymentResult).value

    return AwaitableGetDatascienceModelDeploymentResult(
