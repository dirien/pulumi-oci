...
__all__ = [
    'GetBlockchainBlockchainPlatformResult',
    'AwaitableGetBlockchainBlockchainPlatformResult',
    'get_blockchain_blockchain_platform',
]

@pulumi.output_type
class GetBlockchainBlockchainPlatformResult:
    """
    ...
    def component_details(self) -> 'outputs.GetBlockchainBlockchainPlatformComponentDetailsResult':
        """
    ...
    def host_ocpu_utilization_infos(self) -> Sequence['outputs.GetBlockchainBlockchainPlatformHostOcpuUtilizationInfoResult']:
        """
    ...
    @property
    @pulumi.getter
    def replicas(self) -> 'outputs.GetBlockchainBlockchainPlatformReplicasResult':
        """
...
class AwaitableGetBlockchainBlockchainPlatformResult(GetBlockchainBlockchainPlatformResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBlockchainBlockchainPlatformResult(
...
def get_blockchain_blockchain_platform(blockchain_platform_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBlockchainBlockchainPlatformResult:
    """
    ...
    test_blockchain_platform = oci.get_blockchain_blockchain_platform(blockchain_platform_id=oci_blockchain_blockchain_platform["test_blockchain_platform"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBlockchainBlockchainPlatform:GetBlockchainBlockchainPlatform', __args__, opts=opts, typ=GetBlockchainBlockchainPlatformResult).value

    return AwaitableGetBlockchainBlockchainPlatformResult(
