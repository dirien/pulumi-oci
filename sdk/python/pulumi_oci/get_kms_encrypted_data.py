...
__all__ = [
    'GetKmsEncryptedDataResult',
    'AwaitableGetKmsEncryptedDataResult',
    'get_kms_encrypted_data',
]

@pulumi.output_type
class GetKmsEncryptedDataResult:
    """
...
class AwaitableGetKmsEncryptedDataResult(GetKmsEncryptedDataResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKmsEncryptedDataResult(
...
def get_kms_encrypted_data(associated_data: Optional[Mapping[str, Any]] = None,
                           crypto_endpoint: Optional[str] = None,
                           key_id: Optional[str] = None,
                           plaintext: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKmsEncryptedDataResult:
    """
    ...
    test_encrypted_data = oci.get_kms_encrypted_data(crypto_endpoint=var["encrypted_data_crypto_endpoint"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsEncryptedData:GetKmsEncryptedData', __args__, opts=opts, typ=GetKmsEncryptedDataResult).value

    return AwaitableGetKmsEncryptedDataResult(
