...
__all__ = ['KmsGeneratedKeyArgs', 'KmsGeneratedKey']

@pulumi.input_type
class KmsGeneratedKeyArgs:
    def __init__(__self__, *,
                 crypto_endpoint: pulumi.Input[str],
                 include_plaintext_key: pulumi.Input[bool],
                 key_id: pulumi.Input[str],
                 key_shape: pulumi.Input['KmsGeneratedKeyKeyShapeArgs'],
        ...
        :param pulumi.Input['KmsGeneratedKeyKeyShapeArgs'] key_shape: The cryptographic properties of a key.
    ...
    def key_shape(self) -> pulumi.Input['KmsGeneratedKeyKeyShapeArgs']:
        """
    ...
    @key_shape.setter
    def key_shape(self, value: pulumi.Input['KmsGeneratedKeyKeyShapeArgs']):
...
class _KmsGeneratedKeyState:
    def __init__(__self__, *,
                 ...
                 key_shape: Optional[pulumi.Input['KmsGeneratedKeyKeyShapeArgs']] = None,
                 logging_context: Optional[pulumi.Input[Mapping[str, Any]]] = None,
    ...
    @property
    @pulumi.getter(name="keyShape")
    def key_shape(self) -> Optional[pulumi.Input['KmsGeneratedKeyKeyShapeArgs']]:
        """
        The cryptographic properties of a key.
        """
        return pulumi.get(self, "key_shape")
    ...
    @key_shape.setter
    def key_shape(self, value: Optional[pulumi.Input['KmsGeneratedKeyKeyShapeArgs']]):
        pulumi.set(self, "key_shape", value)
...
class KmsGeneratedKey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 include_plaintext_key: Optional[pulumi.Input[bool]] = None,
                 key_id: Optional[pulumi.Input[str]] = None,
                 key_shape: Optional[pulumi.Input[pulumi.InputType['KmsGeneratedKeyKeyShapeArgs']]] = None,
                 logging_context: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[bool] include_plaintext_key: If true, the generated key is also returned unencrypted.
        :param pulumi.Input[str] key_id: The OCID of the master encryption key to encrypt the generated data encryption key with.
        :param pulumi.Input[pulumi.InputType['KmsGeneratedKeyKeyShapeArgs']] key_shape: The cryptographic properties of a key.
        :param pulumi.Input[Mapping[str, Any]] logging_context: Information that provides context for audit logging. You can provide this additional data by formatting it as key-value pairs to include in audit logs when audit logging is enabled.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param KmsGeneratedKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KmsGeneratedKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KmsGeneratedKeyArgs.__new__(KmsGeneratedKeyArgs)
        ...
        super(KmsGeneratedKey, __self__).__init__(
            'oci:index/kmsGeneratedKey:KmsGeneratedKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            logging_context: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            plaintext: Optional[pulumi.Input[str]] = None,
            plaintext_checksum: Optional[pulumi.Input[str]] = None) -> 'KmsGeneratedKey':
        """
        ...
        __props__ = _KmsGeneratedKeyState.__new__(_KmsGeneratedKeyState)
        ...
        return KmsGeneratedKey(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="keyShape")
    def key_shape(self) -> pulumi.Output['outputs.KmsGeneratedKeyKeyShape']:
        """
        The cryptographic properties of a key.
        """
        return pulumi.get(self, "key_shape")
