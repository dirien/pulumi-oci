...
__all__ = [
    'GetDatabaseAutonomousExadataInfrastructureResult',
    'AwaitableGetDatabaseAutonomousExadataInfrastructureResult',
    'get_database_autonomous_exadata_infrastructure',
]

@pulumi.output_type
class GetDatabaseAutonomousExadataInfrastructureResult:
    """
    A collection of values returned by GetDatabaseAutonomousExadataInfrastructure.
    """
    def __init__(__self__, autonomous_exadata_infrastructure_id=None, availability_domain=None, compartment_id=None, create_async=None, defined_tags=None, display_name=None, domain=None, freeform_tags=None, hostname=None, id=None, last_maintenance_run_id=None, license_model=None, lifecycle_details=None, maintenance_window=None, maintenance_window_details=None, next_maintenance_run_id=None, nsg_ids=None, scan_dns_name=None, shape=None, state=None, subnet_id=None, time_created=None, zone_id=None):
    ...
    def maintenance_window(self) -> 'outputs.GetDatabaseAutonomousExadataInfrastructureMaintenanceWindowResult':
        """
    ...
    def maintenance_window_details(self) -> 'outputs.GetDatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsResult':
...
class AwaitableGetDatabaseAutonomousExadataInfrastructureResult(GetDatabaseAutonomousExadataInfrastructureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousExadataInfrastructureResult(
...
def get_database_autonomous_exadata_infrastructure(autonomous_exadata_infrastructure_id: Optional[str] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousExadataInfrastructureResult:
    """
    ...
    test_autonomous_exadata_infrastructure = oci.get_database_autonomous_exadata_infrastructure(autonomous_exadata_infrastructure_id=oci_database_autonomous_exadata_infrastructure["test_autonomous_exadata_infrastructure"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousExadataInfrastructure:GetDatabaseAutonomousExadataInfrastructure', __args__, opts=opts, typ=GetDatabaseAutonomousExadataInfrastructureResult).value

    return AwaitableGetDatabaseAutonomousExadataInfrastructureResult(
