...
__all__ = [
    'GetDatacatalogDataAssetResult',
    'AwaitableGetDatacatalogDataAssetResult',
    'get_datacatalog_data_asset',
]

@pulumi.output_type
class GetDatacatalogDataAssetResult:
    """
    A collection of values returned by GetDatacatalogDataAsset.
    """
    def __init__(__self__, catalog_id=None, created_by_id=None, data_asset_key=None, description=None, display_name=None, external_key=None, fields=None, id=None, key=None, properties=None, state=None, time_created=None, time_updated=None, type_key=None, updated_by_id=None, uri=None):
...
class AwaitableGetDatacatalogDataAssetResult(GetDatacatalogDataAssetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogDataAssetResult(
...
def get_datacatalog_data_asset(catalog_id: Optional[str] = None,
                               data_asset_key: Optional[str] = None,
                               fields: Optional[Sequence[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogDataAssetResult:
    """
    ...
    test_data_asset = oci.get_datacatalog_data_asset(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogDataAsset:GetDatacatalogDataAsset', __args__, opts=opts, typ=GetDatacatalogDataAssetResult).value

    return AwaitableGetDatacatalogDataAssetResult(
