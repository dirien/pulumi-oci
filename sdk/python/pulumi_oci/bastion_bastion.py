...
__all__ = ['BastionBastionArgs', 'BastionBastion']

@pulumi.input_type
class BastionBastionArgs:
...
class BastionBastion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_bastion = oci.BastionBastion("testBastion",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BastionBastionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BastionBastionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BastionBastionArgs.__new__(BastionBastionArgs)
        ...
        super(BastionBastion, __self__).__init__(
            'oci:index/bastionBastion:BastionBastion',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            target_vcn_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'BastionBastion':
        """
        ...
        __props__ = _BastionBastionState.__new__(_BastionBastionState)
        ...
        return BastionBastion(resource_name, opts=opts, __props__=__props__)
