...
class _DatabaseState:
    def __init__(__self__, *,
                 ...
                 connection_strings: Optional[pulumi.Input['DatabaseConnectionStringsArgs']] = None,
                 database: Optional[pulumi.Input['DatabaseDatabaseArgs']] = None,
                 database_software_image_id: Optional[pulumi.Input[str]] = None,
                 db_backup_config: Optional[pulumi.Input['DatabaseDbBackupConfigArgs']] = None,
        ...
        :param pulumi.Input['DatabaseConnectionStringsArgs'] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input['DatabaseDatabaseArgs'] database: (Updatable) Details for creating a database.
        ...
        :param pulumi.Input['DatabaseDbBackupConfigArgs'] db_backup_config: (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        :param pulumi.Input[str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
    ...
    def connection_strings(self) -> Optional[pulumi.Input['DatabaseConnectionStringsArgs']]:
        """
    ...
    def connection_strings(self, value: Optional[pulumi.Input['DatabaseConnectionStringsArgs']]):
    ...
    def db_backup_config(self) -> Optional[pulumi.Input['DatabaseDbBackupConfigArgs']]:
        """
    ...
    def db_backup_config(self, value: Optional[pulumi.Input['DatabaseDbBackupConfigArgs']]):
...
class Database(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            character_set: Optional[pulumi.Input[str]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            connection_strings: Optional[pulumi.Input[pulumi.InputType['DatabaseConnectionStringsArgs']]] = None,
            database: Optional[pulumi.Input[pulumi.InputType['DatabaseDatabaseArgs']]] = None,
            database_software_image_id: Optional[pulumi.Input[str]] = None,
            db_backup_config: Optional[pulumi.Input[pulumi.InputType['DatabaseDbBackupConfigArgs']]] = None,
            db_home_id: Optional[pulumi.Input[str]] = None,
            db_name: Optional[pulumi.Input[str]] = None,
            db_system_id: Optional[pulumi.Input[str]] = None,
            db_unique_name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] character_set: The character set for the database.  The default is AL32UTF8. Allowed values are:
        :param pulumi.Input[str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[pulumi.InputType['DatabaseConnectionStringsArgs']] connection_strings: The Connection strings used to connect to the Oracle Database.
        :param pulumi.Input[pulumi.InputType['DatabaseDatabaseArgs']] database: (Updatable) Details for creating a database.
        :param pulumi.Input[str] database_software_image_id: The database software image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param pulumi.Input[pulumi.InputType['DatabaseDbBackupConfigArgs']] db_backup_config: (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        :param pulumi.Input[str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        :param pulumi.Input[str] db_name: The display name of the database to be created from the backup. It must begin with an alphabetic character and can contain a maximum of eight alphanumeric characters. Special characters are not permitted.
        :param pulumi.Input[str] db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        :param pulumi.Input[str] db_unique_name: The `DB_UNIQUE_NAME` of the Oracle Database being backed up.
    ...
    @property
    @pulumi.getter(name="connectionStrings")
    def connection_strings(self) -> pulumi.Output['outputs.DatabaseConnectionStrings']:
        """
        The Connection strings used to connect to the Oracle Database.
        """
        return pulumi.get(self, "connection_strings")
    ...
    @property
    @pulumi.getter(name="dbBackupConfig")
    def db_backup_config(self) -> pulumi.Output['outputs.DatabaseDbBackupConfig']:
        """
        (Updatable) Backup Options To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
        """
        return pulumi.get(self, "db_backup_config")
