...
class GetVaultSecretResult:
    ...
    def secret_rules(self) -> Sequence['outputs.GetVaultSecretSecretRuleResult']:
        """
...
class AwaitableGetVaultSecretResult(GetVaultSecretResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVaultSecretResult(
...
def get_vault_secret(secret_id: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVaultSecretResult:
    """
    ...
    test_secret = oci.get_vault_secret(secret_id=oci_vault_secret["test_secret"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getVaultSecret:GetVaultSecret', __args__, opts=opts, typ=GetVaultSecretResult).value

    return AwaitableGetVaultSecretResult(
