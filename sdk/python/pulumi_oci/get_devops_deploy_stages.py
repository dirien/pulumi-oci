...
__all__ = [
    'GetDevopsDeployStagesResult',
    'AwaitableGetDevopsDeployStagesResult',
    'get_devops_deploy_stages',
]

@pulumi.output_type
class GetDevopsDeployStagesResult:
    """
    ...
    def deploy_stage_collections(self) -> Sequence['outputs.GetDevopsDeployStagesDeployStageCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDevopsDeployStagesFilterResult']]:
...
class AwaitableGetDevopsDeployStagesResult(GetDevopsDeployStagesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsDeployStagesResult(
...
def get_devops_deploy_stages(compartment_id: Optional[str] = None,
                             deploy_pipeline_id: Optional[str] = None,
                             display_name: Optional[str] = None,
                             filters: Optional[Sequence[pulumi.InputType['GetDevopsDeployStagesFilterArgs']]] = None,
                             id: Optional[str] = None,
                             state: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsDeployStagesResult:
    """
    ...
    test_deploy_stages = oci.get_devops_deploy_stages(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsDeployStages:GetDevopsDeployStages', __args__, opts=opts, typ=GetDevopsDeployStagesResult).value

    return AwaitableGetDevopsDeployStagesResult(
