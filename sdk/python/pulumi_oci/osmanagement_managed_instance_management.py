...
__all__ = ['OsmanagementManagedInstanceManagementArgs', 'OsmanagementManagedInstanceManagement']

@pulumi.input_type
class OsmanagementManagedInstanceManagementArgs:
    def __init__(__self__, *,
                 managed_instance_id: pulumi.Input[str],
                 child_software_sources: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]] = None,
                 managed_instance_groups: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]]] = None,
                 parent_software_source: Optional[pulumi.Input['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]] child_software_sources: (Updatable) list of child Software Sources attached to the Managed Instance
        :param pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]] managed_instance_groups: (Updatable) The ids of the managed instance groups of which this instance is a member.
        :param pulumi.Input['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs'] parent_software_source: (Updatable) the parent (base) Software Source attached to the Managed Instance
        """
    ...
    def child_software_sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]]:
        """
    ...
    def child_software_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]]):
        pulumi.set(self, "child_software_sources", value)

    @property
    @pulumi.getter(name="managedInstanceGroups")
    def managed_instance_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]]]:
        """
    ...
    def managed_instance_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]]]):
        pulumi.set(self, "managed_instance_groups", value)

    @property
    @pulumi.getter(name="parentSoftwareSource")
    def parent_software_source(self) -> Optional[pulumi.Input['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']]:
        """
    ...
    def parent_software_source(self, value: Optional[pulumi.Input['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']]):
        pulumi.set(self, "parent_software_source", value)


@pulumi.input_type
class _OsmanagementManagedInstanceManagementState:
    def __init__(__self__, *,
                 child_software_sources: Optional[pulumi.Input[Sequence[pulumi.Input['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]] = None,
...
class OsmanagementManagedInstanceManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 child_software_sources: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]]] = None,
                 managed_instance_groups: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]]]] = None,
                 managed_instance_id: Optional[pulumi.Input[str]] = None,
                 parent_software_source: Optional[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']]] = None,
                 __props__=None):
        """
        ...
        **NOTE** The resource on CREATE will detach any already attached parent software source, child software sources, managed instance groups to the managed instance.
        ...
        test_managed_instance_management = oci.OsmanagementManagedInstanceManagement("testManagedInstanceManagement",
            managed_instance_id=oci_osmanagement_managed_instance["test_managed_instance"]["id"],
            parent_software_source=oci.OsmanagementManagedInstanceManagementParentSoftwareSourceArgs(
            ...
            managed_instance_groups=[oci.OsmanagementManagedInstanceManagementManagedInstanceGroupArgs(
            ...
            child_software_sources=[oci.OsmanagementManagedInstanceManagementChildSoftwareSourceArgs(
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementChildSoftwareSourceArgs']]]] child_software_sources: (Updatable) list of child Software Sources attached to the Managed Instance
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementManagedInstanceGroupArgs']]]] managed_instance_groups: (Updatable) The ids of the managed instance groups of which this instance is a member.
        :param pulumi.Input[str] managed_instance_id: OCID for the managed instance
        :param pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']] parent_software_source: (Updatable) the parent (base) Software Source attached to the Managed Instance
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: OsmanagementManagedInstanceManagementArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Managed Instance Management in Oracle Cloud Infrastructure OS Management service.
        The resource can be used to attach/detach parent software source, child software sources and managed instance groups from managed instances.
        ...
        **NOTE** The resource on CREATE will detach any already attached parent software source, child software sources, managed instance groups to the managed instance.
        ...
        :param str resource_name: The name of the resource.
        :param OsmanagementManagedInstanceManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OsmanagementManagedInstanceManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OsmanagementManagedInstanceManagementArgs.__new__(OsmanagementManagedInstanceManagementArgs)
        ...
        super(OsmanagementManagedInstanceManagement, __self__).__init__(
            'oci:index/osmanagementManagedInstanceManagement:OsmanagementManagedInstanceManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            parent_software_source: Optional[pulumi.Input[pulumi.InputType['OsmanagementManagedInstanceManagementParentSoftwareSourceArgs']]] = None,
            status: Optional[pulumi.Input[str]] = None,
            updates_available: Optional[pulumi.Input[int]] = None) -> 'OsmanagementManagedInstanceManagement':
        """
        ...
        __props__ = _OsmanagementManagedInstanceManagementState.__new__(_OsmanagementManagedInstanceManagementState)
        ...
        return OsmanagementManagedInstanceManagement(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="childSoftwareSources")
    def child_software_sources(self) -> pulumi.Output[Sequence['outputs.OsmanagementManagedInstanceManagementChildSoftwareSource']]:
        """
        (Updatable) list of child Software Sources attached to the Managed Instance
        """
        return pulumi.get(self, "child_software_sources")
    ...
    @property
    @pulumi.getter(name="managedInstanceGroups")
    def managed_instance_groups(self) -> pulumi.Output[Sequence['outputs.OsmanagementManagedInstanceManagementManagedInstanceGroup']]:
        """
        (Updatable) The ids of the managed instance groups of which this instance is a member.
        """
        return pulumi.get(self, "managed_instance_groups")
    ...
    @property
    @pulumi.getter(name="parentSoftwareSource")
    def parent_software_source(self) -> pulumi.Output['outputs.OsmanagementManagedInstanceManagementParentSoftwareSource']:
        """
        (Updatable) the parent (base) Software Source attached to the Managed Instance
        """
        return pulumi.get(self, "parent_software_source")
