...
__all__ = [
    'GetCoreClusterNetworkResult',
    'AwaitableGetCoreClusterNetworkResult',
    'get_core_cluster_network',
]

@pulumi.output_type
class GetCoreClusterNetworkResult:
    """
    A collection of values returned by GetCoreClusterNetwork.
    """
    def __init__(__self__, cluster_network_id=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, instance_pools=None, placement_configuration=None, state=None, time_created=None, time_updated=None):
        ...
        if placement_configuration and not isinstance(placement_configuration, dict):
            raise TypeError("Expected argument 'placement_configuration' to be a dict")
    ...
    def instance_pools(self) -> Sequence['outputs.GetCoreClusterNetworkInstancePoolResult']:
        """
    ...
    def placement_configuration(self) -> 'outputs.GetCoreClusterNetworkPlacementConfigurationResult':
        """
...
class AwaitableGetCoreClusterNetworkResult(GetCoreClusterNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreClusterNetworkResult(
...
def get_core_cluster_network(cluster_network_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreClusterNetworkResult:
    """
    ...
    test_cluster_network = oci.get_core_cluster_network(cluster_network_id=oci_core_cluster_network["test_cluster_network"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreClusterNetwork:GetCoreClusterNetwork', __args__, opts=opts, typ=GetCoreClusterNetworkResult).value

    return AwaitableGetCoreClusterNetworkResult(
        ...
        placement_configuration=__ret__.placement_configuration,
        state=__ret__.state,
