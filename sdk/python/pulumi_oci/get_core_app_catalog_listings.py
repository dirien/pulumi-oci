...
__all__ = [
    'GetCoreAppCatalogListingsResult',
    'AwaitableGetCoreAppCatalogListingsResult',
    'get_core_app_catalog_listings',
]

@pulumi.output_type
class GetCoreAppCatalogListingsResult:
    """
    ...
    def app_catalog_listings(self) -> Sequence['outputs.GetCoreAppCatalogListingsAppCatalogListingResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreAppCatalogListingsFilterResult']]:
...
class AwaitableGetCoreAppCatalogListingsResult(GetCoreAppCatalogListingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreAppCatalogListingsResult(
...
def get_core_app_catalog_listings(display_name: Optional[str] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetCoreAppCatalogListingsFilterArgs']]] = None,
                                  publisher_name: Optional[str] = None,
                                  publisher_type: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreAppCatalogListingsResult:
    """
    ...
    test_app_catalog_listings = oci.get_core_app_catalog_listings(display_name=var["app_catalog_listing_display_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreAppCatalogListings:GetCoreAppCatalogListings', __args__, opts=opts, typ=GetCoreAppCatalogListingsResult).value

    return AwaitableGetCoreAppCatalogListingsResult(
