...
__all__ = ['CoreVolumeAttachmentArgs', 'CoreVolumeAttachment']

@pulumi.input_type
class CoreVolumeAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_name: A user-friendly name. Does not have to be unique, and it cannot be changed. Avoid entering confidential information.
...
@pulumi.input_type
class _CoreVolumeAttachmentState:
    def __init__(__self__, *,
                 ...
                 multipath_devices: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeAttachmentMultipathDeviceArgs']]]] = None,
        ...
        :param pulumi.Input[bool] is_multipath: Whether the attachment is multipath or not.
        :param pulumi.Input[bool] is_pv_encryption_in_transit_enabled: Whether to enable in-transit encryption for the data volume's paravirtualized attachment. The default value is false.
        :param pulumi.Input[bool] is_read_only: Whether the attachment was created in read-only mode.
        :param pulumi.Input[bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[str] iscsi_login_state: The iscsi login state of the volume attachment. For a multipath volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        :param pulumi.Input[Sequence[pulumi.Input['CoreVolumeAttachmentMultipathDeviceArgs']]] multipath_devices: A list of secondary multipath devices
    ...
    def multipath_devices(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeAttachmentMultipathDeviceArgs']]]]:
        """
    ...
    def multipath_devices(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreVolumeAttachmentMultipathDeviceArgs']]]]):
...
class CoreVolumeAttachment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_volume_attachment = oci.CoreVolumeAttachment("testVolumeAttachment",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeAttachmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeAttachmentArgs.__new__(CoreVolumeAttachmentArgs)
        ...
        super(CoreVolumeAttachment, __self__).__init__(
            'oci:index/coreVolumeAttachment:CoreVolumeAttachment',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            is_shareable: Optional[pulumi.Input[bool]] = None,
            iscsi_login_state: Optional[pulumi.Input[str]] = None,
            multipath_devices: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeAttachmentMultipathDeviceArgs']]]]] = None,
            port: Optional[pulumi.Input[int]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            use_chap: Optional[pulumi.Input[bool]] = None,
            volume_id: Optional[pulumi.Input[str]] = None) -> 'CoreVolumeAttachment':
        """
        ...
        :param pulumi.Input[bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[str] iscsi_login_state: The iscsi login state of the volume attachment. For a multipath volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreVolumeAttachmentMultipathDeviceArgs']]]] multipath_devices: A list of secondary multipath devices
        :param pulumi.Input[int] port: The volume's iSCSI port, usually port 860 or 3260.  Example: `3260`
        :param pulumi.Input[str] state: The current state of the volume attachment.
        :param pulumi.Input[str] time_created: The date and time the volume was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
        ...
        __props__ = _CoreVolumeAttachmentState.__new__(_CoreVolumeAttachmentState)
        ...
        __props__.__dict__["use_chap"] = use_chap
        __props__.__dict__["volume_id"] = volume_id
        return CoreVolumeAttachment(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="multipathDevices")
    def multipath_devices(self) -> pulumi.Output[Sequence['outputs.CoreVolumeAttachmentMultipathDevice']]:
        """
        A list of secondary multipath devices
        """
        return pulumi.get(self, "multipath_devices")
