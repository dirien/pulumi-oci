...
__all__ = [
    'GetApmSyntheticsMonitorResult',
    'AwaitableGetApmSyntheticsMonitorResult',
    'get_apm_synthetics_monitor',
]

@pulumi.output_type
class GetApmSyntheticsMonitorResult:
    """
    A collection of values returned by GetApmSyntheticsMonitor.
    """
    def __init__(__self__, apm_domain_id=None, configuration=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, monitor_id=None, monitor_type=None, repeat_interval_in_seconds=None, script_id=None, script_name=None, script_parameters=None, status=None, target=None, time_created=None, time_updated=None, timeout_in_seconds=None, vantage_point_count=None, vantage_points=None):
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetApmSyntheticsMonitorConfigurationResult':
        """
    ...
    def script_parameters(self) -> Sequence['outputs.GetApmSyntheticsMonitorScriptParameterResult']:
        """
...
class AwaitableGetApmSyntheticsMonitorResult(GetApmSyntheticsMonitorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApmSyntheticsMonitorResult(
...
def get_apm_synthetics_monitor(apm_domain_id: Optional[str] = None,
                               monitor_id: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApmSyntheticsMonitorResult:
    """
    ...
    test_monitor = oci.get_apm_synthetics_monitor(apm_domain_id=oci_apm_synthetics_apm_domain["test_apm_domain"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getApmSyntheticsMonitor:GetApmSyntheticsMonitor', __args__, opts=opts, typ=GetApmSyntheticsMonitorResult).value

    return AwaitableGetApmSyntheticsMonitorResult(
