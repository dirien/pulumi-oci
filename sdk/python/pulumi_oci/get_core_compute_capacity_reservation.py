...
__all__ = [
    'GetCoreComputeCapacityReservationResult',
    'AwaitableGetCoreComputeCapacityReservationResult',
    'get_core_compute_capacity_reservation',
]

@pulumi.output_type
class GetCoreComputeCapacityReservationResult:
    """
    ...
    def instance_reservation_configs(self) -> Sequence['outputs.GetCoreComputeCapacityReservationInstanceReservationConfigResult']:
        """
...
class AwaitableGetCoreComputeCapacityReservationResult(GetCoreComputeCapacityReservationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeCapacityReservationResult(
...
def get_core_compute_capacity_reservation(capacity_reservation_id: Optional[str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeCapacityReservationResult:
    """
    ...
    test_compute_capacity_reservation = oci.get_core_compute_capacity_reservation(capacity_reservation_id=oci_core_capacity_reservation["test_capacity_reservation"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeCapacityReservation:GetCoreComputeCapacityReservation', __args__, opts=opts, typ=GetCoreComputeCapacityReservationResult).value

    return AwaitableGetCoreComputeCapacityReservationResult(
