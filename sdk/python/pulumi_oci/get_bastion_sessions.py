...
__all__ = [
    'GetBastionSessionsResult',
    'AwaitableGetBastionSessionsResult',
    'get_bastion_sessions',
]

@pulumi.output_type
class GetBastionSessionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBastionSessionsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def sessions(self) -> Sequence['outputs.GetBastionSessionsSessionResult']:
        """
...
class AwaitableGetBastionSessionsResult(GetBastionSessionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBastionSessionsResult(
...
def get_bastion_sessions(bastion_id: Optional[str] = None,
                         display_name: Optional[str] = None,
                         filters: Optional[Sequence[pulumi.InputType['GetBastionSessionsFilterArgs']]] = None,
                         session_id: Optional[str] = None,
                         session_lifecycle_state: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBastionSessionsResult:
    """
    ...
    test_sessions = oci.get_bastion_sessions(bastion_id=oci_bastion_bastion["test_bastion"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBastionSessions:GetBastionSessions', __args__, opts=opts, typ=GetBastionSessionsResult).value

    return AwaitableGetBastionSessionsResult(
