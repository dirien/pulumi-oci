...
__all__ = [
    'GetCoreDrgRouteTablesResult',
    'AwaitableGetCoreDrgRouteTablesResult',
    'get_core_drg_route_tables',
]

@pulumi.output_type
class GetCoreDrgRouteTablesResult:
    """
    ...
    def drg_route_tables(self) -> Sequence['outputs.GetCoreDrgRouteTablesDrgRouteTableResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreDrgRouteTablesFilterResult']]:
...
class AwaitableGetCoreDrgRouteTablesResult(GetCoreDrgRouteTablesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreDrgRouteTablesResult(
...
def get_core_drg_route_tables(display_name: Optional[str] = None,
                              drg_id: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetCoreDrgRouteTablesFilterArgs']]] = None,
                              import_drg_route_distribution_id: Optional[str] = None,
                              state: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreDrgRouteTablesResult:
    """
    ...
    test_drg_route_tables = oci.get_core_drg_route_tables(drg_id=oci_core_drg["test_drg"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreDrgRouteTables:GetCoreDrgRouteTables', __args__, opts=opts, typ=GetCoreDrgRouteTablesResult).value

    return AwaitableGetCoreDrgRouteTablesResult(
