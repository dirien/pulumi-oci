...
__all__ = ['StreamingStreamPoolArgs', 'StreamingStreamPool']

@pulumi.input_type
class StreamingStreamPoolArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[str],
                 custom_encryption_key: Optional[pulumi.Input['StreamingStreamPoolCustomEncryptionKeyArgs']] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 kafka_settings: Optional[pulumi.Input['StreamingStreamPoolKafkaSettingsArgs']] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 private_endpoint_settings: Optional[pulumi.Input['StreamingStreamPoolPrivateEndpointSettingsArgs']] = None):
        """
        ...
        :param pulumi.Input['StreamingStreamPoolCustomEncryptionKeyArgs'] custom_encryption_key: (Updatable) The OCID of the custom encryption key to be used or deleted if currently being used.
        ...
        :param pulumi.Input['StreamingStreamPoolKafkaSettingsArgs'] kafka_settings: (Updatable) Settings for the Kafka compatibility layer.
        ...
        :param pulumi.Input['StreamingStreamPoolPrivateEndpointSettingsArgs'] private_endpoint_settings: Optional parameters if a private stream pool is requested.
        """
    ...
    def custom_encryption_key(self) -> Optional[pulumi.Input['StreamingStreamPoolCustomEncryptionKeyArgs']]:
        """
    ...
    def custom_encryption_key(self, value: Optional[pulumi.Input['StreamingStreamPoolCustomEncryptionKeyArgs']]):
    ...
    def kafka_settings(self) -> Optional[pulumi.Input['StreamingStreamPoolKafkaSettingsArgs']]:
        """
    ...
    def kafka_settings(self, value: Optional[pulumi.Input['StreamingStreamPoolKafkaSettingsArgs']]):
    ...
    def private_endpoint_settings(self) -> Optional[pulumi.Input['StreamingStreamPoolPrivateEndpointSettingsArgs']]:
        """
    ...
    def private_endpoint_settings(self, value: Optional[pulumi.Input['StreamingStreamPoolPrivateEndpointSettingsArgs']]):
        pulumi.set(self, "private_endpoint_settings", value)


@pulumi.input_type
class _StreamingStreamPoolState:
    def __init__(__self__, *,
...
class StreamingStreamPool(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 custom_encryption_key: Optional[pulumi.Input[pulumi.InputType['StreamingStreamPoolCustomEncryptionKeyArgs']]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 kafka_settings: Optional[pulumi.Input[pulumi.InputType['StreamingStreamPoolKafkaSettingsArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 private_endpoint_settings: Optional[pulumi.Input[pulumi.InputType['StreamingStreamPoolPrivateEndpointSettingsArgs']]] = None,
                 __props__=None):
        """
        ...
        test_stream_pool = oci.StreamingStreamPool("testStreamPool",
            compartment_id=var["compartment_id"],
            custom_encryption_key=oci.StreamingStreamPoolCustomEncryptionKeyArgs(
            ...
            kafka_settings=oci.StreamingStreamPoolKafkaSettingsArgs(
            ...
            private_endpoint_settings=oci.StreamingStreamPoolPrivateEndpointSettingsArgs(
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment that contains the stream.
        :param pulumi.Input[pulumi.InputType['StreamingStreamPoolCustomEncryptionKeyArgs']] custom_encryption_key: (Updatable) The OCID of the custom encryption key to be used or deleted if currently being used.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair that is applied with no predefined name, type, or namespace. Exists for cross-compatibility only. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['StreamingStreamPoolKafkaSettingsArgs']] kafka_settings: (Updatable) Settings for the Kafka compatibility layer.
        :param pulumi.Input[str] name: (Updatable) The name of the stream pool. Avoid entering confidential information.  Example: `MyStreamPool`
        :param pulumi.Input[pulumi.InputType['StreamingStreamPoolPrivateEndpointSettingsArgs']] private_endpoint_settings: Optional parameters if a private stream pool is requested.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: StreamingStreamPoolArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Stream Pool resource in Oracle Cloud Infrastructure Streaming service.
        ...
        :param str resource_name: The name of the resource.
        :param StreamingStreamPoolArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(StreamingStreamPoolArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StreamingStreamPoolArgs.__new__(StreamingStreamPoolArgs)
        ...
        super(StreamingStreamPool, __self__).__init__(
            'oci:index/streamingStreamPool:StreamingStreamPool',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            private_endpoint_settings: Optional[pulumi.Input[pulumi.InputType['StreamingStreamPoolPrivateEndpointSettingsArgs']]] = None,
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'StreamingStreamPool':
        """
        ...
        __props__ = _StreamingStreamPoolState.__new__(_StreamingStreamPoolState)
        ...
        return StreamingStreamPool(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="customEncryptionKey")
    def custom_encryption_key(self) -> pulumi.Output['outputs.StreamingStreamPoolCustomEncryptionKey']:
        """
        (Updatable) The OCID of the custom encryption key to be used or deleted if currently being used.
        """
        return pulumi.get(self, "custom_encryption_key")
    ...
    @property
    @pulumi.getter(name="kafkaSettings")
    def kafka_settings(self) -> pulumi.Output['outputs.StreamingStreamPoolKafkaSettings']:
        """
        (Updatable) Settings for the Kafka compatibility layer.
        """
        return pulumi.get(self, "kafka_settings")
    ...
    @property
    @pulumi.getter(name="privateEndpointSettings")
    def private_endpoint_settings(self) -> pulumi.Output['outputs.StreamingStreamPoolPrivateEndpointSettings']:
        """
        Optional parameters if a private stream pool is requested.
        """
        return pulumi.get(self, "private_endpoint_settings")
