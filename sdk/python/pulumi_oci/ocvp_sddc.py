...
class OcvpSddcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compute_availability_domain: The availability domain to create the SDDC's ESXi hosts in.
...
class _OcvpSddcState:
    def __init__(__self__, *,
                 ...
                 hcx_on_prem_licenses: Optional[pulumi.Input[Sequence[pulumi.Input['OcvpSddcHcxOnPremLicenseArgs']]]] = None,
        ...
        :param pulumi.Input[str] hcx_on_prem_key: The activation key to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution. Your implementation might need more than one activation key. To obtain additional keys, contact Oracle Support.
        :param pulumi.Input[Sequence[pulumi.Input['OcvpSddcHcxOnPremLicenseArgs']]] hcx_on_prem_licenses: The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
    ...
    def hcx_on_prem_licenses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OcvpSddcHcxOnPremLicenseArgs']]]]:
        """
    ...
    def hcx_on_prem_licenses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OcvpSddcHcxOnPremLicenseArgs']]]]):
...
class OcvpSddc(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        **Important:** You must configure the SDDC's networking resources with the security rules detailed in [Security Rules for Oracle Cloud VMware Solution SDDCs](https://docs.cloud.oracle.com/iaas/Content/VMware/Reference/ocvssecurityrules.htm). Otherwise, provisioning the SDDC will fail. The rules are based on the requirements set by VMware.
        ...
        :param str resource_name: The name of the resource.
        :param OcvpSddcArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(OcvpSddcArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = OcvpSddcArgs.__new__(OcvpSddcArgs)
        ...
        super(OcvpSddc, __self__).__init__(
            'oci:index/ocvpSddc:OcvpSddc',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            hcx_initial_password: Optional[pulumi.Input[str]] = None,
            hcx_on_prem_key: Optional[pulumi.Input[str]] = None,
            hcx_on_prem_licenses: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OcvpSddcHcxOnPremLicenseArgs']]]]] = None,
            hcx_private_ip_id: Optional[pulumi.Input[str]] = None,
            hcx_vlan_id: Optional[pulumi.Input[str]] = None,
            initial_sku: Optional[pulumi.Input[str]] = None,
            instance_display_name_prefix: Optional[pulumi.Input[str]] = None,
            ...
            vsan_vlan_id: Optional[pulumi.Input[str]] = None,
            vsphere_vlan_id: Optional[pulumi.Input[str]] = None,
            workload_network_cidr: Optional[pulumi.Input[str]] = None) -> 'OcvpSddc':
        """
        ...
        :param pulumi.Input[str] hcx_initial_password: The SDDC includes an administrator username and initial password for HCX Manager. Make sure to change this initial HCX Manager password to a different value.
        :param pulumi.Input[str] hcx_on_prem_key: The activation key to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution. Your implementation might need more than one activation key. To obtain additional keys, contact Oracle Support.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OcvpSddcHcxOnPremLicenseArgs']]]] hcx_on_prem_licenses: The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
        :param pulumi.Input[str] hcx_private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for HCX Manager. For information about `PrivateIp` objects, see the Core Services API.
        :param pulumi.Input[str] hcx_vlan_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the HCX component of the VMware environment. This value is required only when `isHcxEnabled` is true.
        :param pulumi.Input[str] initial_sku: Billing option selected during SDDC creation. Oracle Cloud Infrastructure VMware Solution supports the following billing interval SKUs: HOUR, MONTH, ONE_YEAR, and THREE_YEARS. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus).
        :param pulumi.Input[str] instance_display_name_prefix: A prefix used in the name of each ESXi host and Compute instance in the SDDC. If this isn't set, the SDDC's `displayName` is used as the prefix.
        ...
        __props__ = _OcvpSddcState.__new__(_OcvpSddcState)
        ...
        __props__.__dict__["vsphere_vlan_id"] = vsphere_vlan_id
        __props__.__dict__["workload_network_cidr"] = workload_network_cidr
        return OcvpSddc(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="hcxOnPremLicenses")
    def hcx_on_prem_licenses(self) -> pulumi.Output[Sequence['outputs.OcvpSddcHcxOnPremLicense']]:
        """
        The activation licenses to use on the on-premises HCX Enterprise appliance you site pair with HCX Manager in your VMware Solution.
        """
        return pulumi.get(self, "hcx_on_prem_licenses")
