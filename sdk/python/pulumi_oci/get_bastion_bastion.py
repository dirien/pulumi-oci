...
__all__ = [
    'GetBastionBastionResult',
    'AwaitableGetBastionBastionResult',
    'get_bastion_bastion',
]

@pulumi.output_type
class GetBastionBastionResult:
    """
...
class AwaitableGetBastionBastionResult(GetBastionBastionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBastionBastionResult(
...
def get_bastion_bastion(bastion_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBastionBastionResult:
    """
    ...
    test_bastion = oci.get_bastion_bastion(bastion_id=oci_bastion_bastion["test_bastion"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBastionBastion:GetBastionBastion', __args__, opts=opts, typ=GetBastionBastionResult).value

    return AwaitableGetBastionBastionResult(
