...
__all__ = [
    'GetObjectstoragePreauthrequestsResult',
    'AwaitableGetObjectstoragePreauthrequestsResult',
    'get_objectstorage_preauthrequests',
]

@pulumi.output_type
class GetObjectstoragePreauthrequestsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetObjectstoragePreauthrequestsFilterResult']]:
    ...
    def preauthenticated_requests(self) -> Sequence['outputs.GetObjectstoragePreauthrequestsPreauthenticatedRequestResult']:
        """
...
class AwaitableGetObjectstoragePreauthrequestsResult(GetObjectstoragePreauthrequestsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstoragePreauthrequestsResult(
            bucket=self.bucket,
...
def get_objectstorage_preauthrequests(bucket: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetObjectstoragePreauthrequestsFilterArgs']]] = None,
                                      namespace: Optional[str] = None,
                                      object_name_prefix: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstoragePreauthrequestsResult:
    """
    ...
    test_preauthenticated_requests = oci.get_objectstorage_preauthrequests(bucket=var["preauthenticated_request_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstoragePreauthrequests:GetObjectstoragePreauthrequests', __args__, opts=opts, typ=GetObjectstoragePreauthrequestsResult).value

    return AwaitableGetObjectstoragePreauthrequestsResult(
