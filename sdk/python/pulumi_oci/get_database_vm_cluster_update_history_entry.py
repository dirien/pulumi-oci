...
__all__ = [
    'GetDatabaseVmClusterUpdateHistoryEntryResult',
    'AwaitableGetDatabaseVmClusterUpdateHistoryEntryResult',
    'get_database_vm_cluster_update_history_entry',
]

@pulumi.output_type
class GetDatabaseVmClusterUpdateHistoryEntryResult:
    """
...
class AwaitableGetDatabaseVmClusterUpdateHistoryEntryResult(GetDatabaseVmClusterUpdateHistoryEntryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterUpdateHistoryEntryResult(
            id=self.id,
...
def get_database_vm_cluster_update_history_entry(update_history_entry_id: Optional[str] = None,
                                                 vm_cluster_id: Optional[str] = None,
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterUpdateHistoryEntryResult:
    """
    ...
    test_vm_cluster_update_history_entry = oci.get_database_vm_cluster_update_history_entry(update_history_entry_id=oci_database_update_history_entry["test_update_history_entry"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterUpdateHistoryEntry:GetDatabaseVmClusterUpdateHistoryEntry', __args__, opts=opts, typ=GetDatabaseVmClusterUpdateHistoryEntryResult).value

    return AwaitableGetDatabaseVmClusterUpdateHistoryEntryResult(
        id=__ret__.id,
