...
__all__ = [
    'GetDatacatalogMetastoreResult',
    'AwaitableGetDatacatalogMetastoreResult',
    'get_datacatalog_metastore',
]

@pulumi.output_type
class GetDatacatalogMetastoreResult:
    """
...
class AwaitableGetDatacatalogMetastoreResult(GetDatacatalogMetastoreResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogMetastoreResult(
...
def get_datacatalog_metastore(metastore_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogMetastoreResult:
    """
    ...
    test_metastore = oci.get_datacatalog_metastore(metastore_id=oci_datacatalog_metastore["test_metastore"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogMetastore:GetDatacatalogMetastore', __args__, opts=opts, typ=GetDatacatalogMetastoreResult).value

    return AwaitableGetDatacatalogMetastoreResult(
