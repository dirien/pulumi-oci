...
__all__ = ['CoreSubnetArgs', 'CoreSubnet']

@pulumi.input_type
class CoreSubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment to contain the subnet.
        :param pulumi.Input[str] vcn_id: The OCID of the VCN to contain the subnet.
        ...
        :param pulumi.Input[str] dhcp_options_id: (Updatable) The OCID of the set of DHCP options the subnet will use. If you don't provide a value, the subnet uses the VCN's default set of DHCP options.
        ...
        :param pulumi.Input[str] route_table_id: (Updatable) The OCID of the route table the subnet will use. If you don't provide a value, the subnet uses the VCN's default route table.
...
class CoreSubnet(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_subnet = oci.CoreSubnet("testSubnet",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreSubnetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreSubnetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreSubnetArgs.__new__(CoreSubnetArgs)
        ...
        super(CoreSubnet, __self__).__init__(
            'oci:index/coreSubnet:CoreSubnet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            vcn_id: Optional[pulumi.Input[str]] = None,
            virtual_router_ip: Optional[pulumi.Input[str]] = None,
            virtual_router_mac: Optional[pulumi.Input[str]] = None) -> 'CoreSubnet':
        """
        ...
        __props__ = _CoreSubnetState.__new__(_CoreSubnetState)
        ...
        return CoreSubnet(resource_name, opts=opts, __props__=__props__)
