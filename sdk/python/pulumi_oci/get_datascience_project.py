...
__all__ = [
    'GetDatascienceProjectResult',
    'AwaitableGetDatascienceProjectResult',
    'get_datascience_project',
]

@pulumi.output_type
class GetDatascienceProjectResult:
    """
...
class AwaitableGetDatascienceProjectResult(GetDatascienceProjectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatascienceProjectResult(
...
def get_datascience_project(project_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatascienceProjectResult:
    """
    ...
    test_project = oci.get_datascience_project(project_id=oci_datascience_project["test_project"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatascienceProject:GetDatascienceProject', __args__, opts=opts, typ=GetDatascienceProjectResult).value

    return AwaitableGetDatascienceProjectResult(
