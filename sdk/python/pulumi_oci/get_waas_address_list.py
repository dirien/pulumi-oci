...
__all__ = [
    'GetWaasAddressListResult',
    'AwaitableGetWaasAddressListResult',
    'get_waas_address_list',
]

@pulumi.output_type
class GetWaasAddressListResult:
    """
...
class AwaitableGetWaasAddressListResult(GetWaasAddressListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWaasAddressListResult(
...
def get_waas_address_list(address_list_id: Optional[str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWaasAddressListResult:
    """
    ...
    test_address_list = oci.get_waas_address_list(address_list_id=oci_waas_address_list["test_address_list"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getWaasAddressList:GetWaasAddressList', __args__, opts=opts, typ=GetWaasAddressListResult).value

    return AwaitableGetWaasAddressListResult(
