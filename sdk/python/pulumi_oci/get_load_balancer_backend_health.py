...
__all__ = [
    'GetLoadBalancerBackendHealthResult',
    'AwaitableGetLoadBalancerBackendHealthResult',
    'get_load_balancer_backend_health',
]

@pulumi.output_type
class GetLoadBalancerBackendHealthResult:
    """
    ...
    def health_check_results(self) -> Sequence['outputs.GetLoadBalancerBackendHealthHealthCheckResultResult']:
        """
...
class AwaitableGetLoadBalancerBackendHealthResult(GetLoadBalancerBackendHealthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerBackendHealthResult(
...
def get_load_balancer_backend_health(backend_name: Optional[str] = None,
                                     backend_set_name: Optional[str] = None,
                                     load_balancer_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerBackendHealthResult:
    """
    ...
    test_backend_health = oci.get_load_balancer_backend_health(backend_name=oci_load_balancer_backend["test_backend"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerBackendHealth:GetLoadBalancerBackendHealth', __args__, opts=opts, typ=GetLoadBalancerBackendHealthResult).value

    return AwaitableGetLoadBalancerBackendHealthResult(
