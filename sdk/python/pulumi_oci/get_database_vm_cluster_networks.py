...
__all__ = [
    'GetDatabaseVmClusterNetworksResult',
    'AwaitableGetDatabaseVmClusterNetworksResult',
    'get_database_vm_cluster_networks',
]

@pulumi.output_type
class GetDatabaseVmClusterNetworksResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseVmClusterNetworksFilterResult']]:
    ...
    def vm_cluster_networks(self) -> Sequence['outputs.GetDatabaseVmClusterNetworksVmClusterNetworkResult']:
        """
...
class AwaitableGetDatabaseVmClusterNetworksResult(GetDatabaseVmClusterNetworksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseVmClusterNetworksResult(
...
def get_database_vm_cluster_networks(compartment_id: Optional[str] = None,
                                     display_name: Optional[str] = None,
                                     exadata_infrastructure_id: Optional[str] = None,
                                     filters: Optional[Sequence[pulumi.InputType['GetDatabaseVmClusterNetworksFilterArgs']]] = None,
                                     state: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseVmClusterNetworksResult:
    """
    ...
    test_vm_cluster_networks = oci.get_database_vm_cluster_networks(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseVmClusterNetworks:GetDatabaseVmClusterNetworks', __args__, opts=opts, typ=GetDatabaseVmClusterNetworksResult).value

    return AwaitableGetDatabaseVmClusterNetworksResult(
