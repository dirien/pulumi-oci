...
__all__ = [
    'GetNetworkLoadBalancerBackendHealthResult',
    'AwaitableGetNetworkLoadBalancerBackendHealthResult',
    'get_network_load_balancer_backend_health',
]

@pulumi.output_type
class GetNetworkLoadBalancerBackendHealthResult:
    """
    ...
    def health_check_results(self) -> Sequence['outputs.GetNetworkLoadBalancerBackendHealthHealthCheckResultResult']:
        """
...
class AwaitableGetNetworkLoadBalancerBackendHealthResult(GetNetworkLoadBalancerBackendHealthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkLoadBalancerBackendHealthResult(
...
def get_network_load_balancer_backend_health(backend_name: Optional[str] = None,
                                             backend_set_name: Optional[str] = None,
                                             network_load_balancer_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkLoadBalancerBackendHealthResult:
    """
    ...
    test_backend_health = oci.get_network_load_balancer_backend_health(backend_name=oci_network_load_balancer_backend["test_backend"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNetworkLoadBalancerBackendHealth:GetNetworkLoadBalancerBackendHealth', __args__, opts=opts, typ=GetNetworkLoadBalancerBackendHealthResult).value

    return AwaitableGetNetworkLoadBalancerBackendHealthResult(
