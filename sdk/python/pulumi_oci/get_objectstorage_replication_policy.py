...
__all__ = [
    'GetObjectstorageReplicationPolicyResult',
    'AwaitableGetObjectstorageReplicationPolicyResult',
    'get_objectstorage_replication_policy',
]

@pulumi.output_type
class GetObjectstorageReplicationPolicyResult:
    """
...
class AwaitableGetObjectstorageReplicationPolicyResult(GetObjectstorageReplicationPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageReplicationPolicyResult(
            bucket=self.bucket,
...
def get_objectstorage_replication_policy(bucket: Optional[str] = None,
                                         namespace: Optional[str] = None,
                                         replication_id: Optional[str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageReplicationPolicyResult:
    """
    ...
    test_replication_policy = oci.get_objectstorage_replication_policy(bucket=var["replication_policy_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageReplicationPolicy:GetObjectstorageReplicationPolicy', __args__, opts=opts, typ=GetObjectstorageReplicationPolicyResult).value

    return AwaitableGetObjectstorageReplicationPolicyResult(
