...
__all__ = [
    'GetCoreVnicAttachmentsResult',
    'AwaitableGetCoreVnicAttachmentsResult',
    'get_core_vnic_attachments',
]

@pulumi.output_type
class GetCoreVnicAttachmentsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreVnicAttachmentsFilterResult']]:
    ...
    def vnic_attachments(self) -> Sequence['outputs.GetCoreVnicAttachmentsVnicAttachmentResult']:
        """
...
class AwaitableGetCoreVnicAttachmentsResult(GetCoreVnicAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreVnicAttachmentsResult(
...
def get_core_vnic_attachments(availability_domain: Optional[str] = None,
                              compartment_id: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetCoreVnicAttachmentsFilterArgs']]] = None,
                              instance_id: Optional[str] = None,
                              vnic_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreVnicAttachmentsResult:
    """
    ...
    test_vnic_attachments = oci.get_core_vnic_attachments(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreVnicAttachments:GetCoreVnicAttachments', __args__, opts=opts, typ=GetCoreVnicAttachmentsResult).value

    return AwaitableGetCoreVnicAttachmentsResult(
