...
class GetOptimizerRecommendationResult:
    ...
    def __init__(__self__, category_id=None, compartment_id=None, description=None, estimated_cost_saving=None, id=None, importance=None, name=None, recommendation_id=None, resource_counts=None, state=None, status=None, supported_levels=None, time_created=None, time_status_begin=None, time_status_end=None, time_updated=None):
        ...
        if supported_levels and not isinstance(supported_levels, dict):
            raise TypeError("Expected argument 'supported_levels' to be a dict")
    ...
    def resource_counts(self) -> Sequence['outputs.GetOptimizerRecommendationResourceCountResult']:
        """
    ...
    def supported_levels(self) -> 'outputs.GetOptimizerRecommendationSupportedLevelsResult':
        """
...
class AwaitableGetOptimizerRecommendationResult(GetOptimizerRecommendationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOptimizerRecommendationResult(
...
def get_optimizer_recommendation(recommendation_id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOptimizerRecommendationResult:
    """
    ...
    test_recommendation = oci.get_optimizer_recommendation(recommendation_id=oci_optimizer_recommendation["test_recommendation"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getOptimizerRecommendation:GetOptimizerRecommendation', __args__, opts=opts, typ=GetOptimizerRecommendationResult).value

    return AwaitableGetOptimizerRecommendationResult(
