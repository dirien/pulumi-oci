...
class GetKmsKeysResult:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetKmsKeysFilterResult']]:
...
def get_kms_keys(algorithm: Optional[str] = None,
                 compartment_id: Optional[str] = None,
                 curve_id: Optional[str] = None,
                 filters: Optional[Sequence[pulumi.InputType['GetKmsKeysFilterArgs']]] = None,
    ...
    test_keys = oci.get_kms_keys(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getKmsKeys:GetKmsKeys', __args__, opts=opts, typ=GetKmsKeysResult).value
