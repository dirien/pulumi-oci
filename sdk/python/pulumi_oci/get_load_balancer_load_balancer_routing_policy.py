...
__all__ = [
    'GetLoadBalancerLoadBalancerRoutingPolicyResult',
    'AwaitableGetLoadBalancerLoadBalancerRoutingPolicyResult',
    'get_load_balancer_load_balancer_routing_policy',
]

@pulumi.output_type
class GetLoadBalancerLoadBalancerRoutingPolicyResult:
    """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetLoadBalancerLoadBalancerRoutingPolicyRuleResult']:
        """
...
class AwaitableGetLoadBalancerLoadBalancerRoutingPolicyResult(GetLoadBalancerLoadBalancerRoutingPolicyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoadBalancerLoadBalancerRoutingPolicyResult(
...
def get_load_balancer_load_balancer_routing_policy(load_balancer_id: Optional[str] = None,
                                                   routing_policy_name: Optional[str] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoadBalancerLoadBalancerRoutingPolicyResult:
    """
    ...
    test_load_balancer_routing_policy = oci.get_load_balancer_load_balancer_routing_policy(load_balancer_id=oci_load_balancer_load_balancer["test_load_balancer"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoadBalancerLoadBalancerRoutingPolicy:GetLoadBalancerLoadBalancerRoutingPolicy', __args__, opts=opts, typ=GetLoadBalancerLoadBalancerRoutingPolicyResult).value

    return AwaitableGetLoadBalancerLoadBalancerRoutingPolicyResult(
