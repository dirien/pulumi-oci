...
__all__ = ['CoreVolumeBackupArgs', 'CoreVolumeBackup']

@pulumi.input_type
class CoreVolumeBackupArgs:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 source_details: Optional[pulumi.Input['CoreVolumeBackupSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the volume backup. Does not have to be unique and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input['CoreVolumeBackupSourceDetailsArgs'] source_details: Details of the volume backup source in the cloud.
    ...
    def source_details(self) -> Optional[pulumi.Input['CoreVolumeBackupSourceDetailsArgs']]:
        """
    ...
    def source_details(self, value: Optional[pulumi.Input['CoreVolumeBackupSourceDetailsArgs']]):
...
class CoreVolumeBackup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 source_details: Optional[pulumi.Input[pulumi.InputType['CoreVolumeBackupSourceDetailsArgs']]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 volume_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_volume_backup = oci.CoreVolumeBackup("testVolumeBackup",
        ...
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name for the volume backup. Does not have to be unique and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[pulumi.InputType['CoreVolumeBackupSourceDetailsArgs']] source_details: Details of the volume backup source in the cloud.
        :param pulumi.Input[str] type: The type of backup to create. If omitted, defaults to INCREMENTAL. Supported values are 'FULL' or 'INCREMENTAL'.
        :param pulumi.Input[str] volume_id: The OCID of the volume that needs to be backed up.**Note: To create the resource either `volume_id` or `source_details` is required to be set.
        """
        ...
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CoreVolumeBackupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Volume Backup resource in Oracle Cloud Infrastructure Core service.
        ...
        :param str resource_name: The name of the resource.
        :param CoreVolumeBackupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreVolumeBackupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreVolumeBackupArgs.__new__(CoreVolumeBackupArgs)
        ...
        super(CoreVolumeBackup, __self__).__init__(
            'oci:index/coreVolumeBackup:CoreVolumeBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            unique_size_in_gbs: Optional[pulumi.Input[str]] = None,
            unique_size_in_mbs: Optional[pulumi.Input[str]] = None,
            volume_id: Optional[pulumi.Input[str]] = None) -> 'CoreVolumeBackup':
        """
        ...
        __props__ = _CoreVolumeBackupState.__new__(_CoreVolumeBackupState)
        ...
        __props__.__dict__["volume_id"] = volume_id
        return CoreVolumeBackup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output[Optional['outputs.CoreVolumeBackupSourceDetails']]:
        """
        Details of the volume backup source in the cloud.
        """
        return pulumi.get(self, "source_details")
