...
__all__ = [
    'GetLogAnalyticsLogAnalyticsEntitiesSummaryResult',
    'AwaitableGetLogAnalyticsLogAnalyticsEntitiesSummaryResult',
    'get_log_analytics_log_analytics_entities_summary',
]

@pulumi.output_type
class GetLogAnalyticsLogAnalyticsEntitiesSummaryResult:
    """
...
class AwaitableGetLogAnalyticsLogAnalyticsEntitiesSummaryResult(GetLogAnalyticsLogAnalyticsEntitiesSummaryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLogAnalyticsLogAnalyticsEntitiesSummaryResult(
...
def get_log_analytics_log_analytics_entities_summary(compartment_id: Optional[str] = None,
                                                     namespace: Optional[str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLogAnalyticsLogAnalyticsEntitiesSummaryResult:
    """
    ...
    test_log_analytics_entities_summary = oci.get_log_analytics_log_analytics_entities_summary(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLogAnalyticsLogAnalyticsEntitiesSummary:GetLogAnalyticsLogAnalyticsEntitiesSummary', __args__, opts=opts, typ=GetLogAnalyticsLogAnalyticsEntitiesSummaryResult).value

    return AwaitableGetLogAnalyticsLogAnalyticsEntitiesSummaryResult(
