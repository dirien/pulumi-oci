...
__all__ = [
    'GetNetworkLoadBalancerBackendsResult',
    'AwaitableGetNetworkLoadBalancerBackendsResult',
    'get_network_load_balancer_backends',
]

@pulumi.output_type
class GetNetworkLoadBalancerBackendsResult:
    """
    ...
    def backend_collections(self) -> Sequence['outputs.GetNetworkLoadBalancerBackendsBackendCollectionResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetNetworkLoadBalancerBackendsFilterResult']]:
...
class AwaitableGetNetworkLoadBalancerBackendsResult(GetNetworkLoadBalancerBackendsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkLoadBalancerBackendsResult(
...
def get_network_load_balancer_backends(backend_set_name: Optional[str] = None,
                                       filters: Optional[Sequence[pulumi.InputType['GetNetworkLoadBalancerBackendsFilterArgs']]] = None,
                                       network_load_balancer_id: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkLoadBalancerBackendsResult:
    """
    ...
    test_backends = oci.get_network_load_balancer_backends(backend_set_name=oci_network_load_balancer_backend_set["test_backend_set"]["name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNetworkLoadBalancerBackends:GetNetworkLoadBalancerBackends', __args__, opts=opts, typ=GetNetworkLoadBalancerBackendsResult).value

    return AwaitableGetNetworkLoadBalancerBackendsResult(
