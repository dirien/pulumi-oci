...
__all__ = [
    'GetDataSafeTargetDatabaseResult',
    'AwaitableGetDataSafeTargetDatabaseResult',
    'get_data_safe_target_database',
]

@pulumi.output_type
class GetDataSafeTargetDatabaseResult:
    """
    A collection of values returned by GetDataSafeTargetDatabase.
    """
    def __init__(__self__, compartment_id=None, connection_option=None, credentials=None, database_details=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, state=None, system_tags=None, target_database_id=None, time_created=None, time_updated=None, tls_config=None):
        if compartment_id and not isinstance(compartment_id, str):
            raise TypeError("Expected argument 'compartment_id' to be a str")
        pulumi.set(__self__, "compartment_id", compartment_id)
        if connection_option and not isinstance(connection_option, dict):
            raise TypeError("Expected argument 'connection_option' to be a dict")
        pulumi.set(__self__, "connection_option", connection_option)
        if credentials and not isinstance(credentials, dict):
            raise TypeError("Expected argument 'credentials' to be a dict")
        pulumi.set(__self__, "credentials", credentials)
        if database_details and not isinstance(database_details, dict):
            raise TypeError("Expected argument 'database_details' to be a dict")
    ...
    def connection_option(self) -> 'outputs.GetDataSafeTargetDatabaseConnectionOptionResult':
        """
    ...
    @property
    @pulumi.getter
    def credentials(self) -> 'outputs.GetDataSafeTargetDatabaseCredentialsResult':
        """
    ...
    def database_details(self) -> 'outputs.GetDataSafeTargetDatabaseDatabaseDetailsResult':
        """
    ...
    def tls_config(self) -> 'outputs.GetDataSafeTargetDatabaseTlsConfigResult':
        """
...
class AwaitableGetDataSafeTargetDatabaseResult(GetDataSafeTargetDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataSafeTargetDatabaseResult(
            compartment_id=self.compartment_id,
            connection_option=self.connection_option,
...
def get_data_safe_target_database(target_database_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataSafeTargetDatabaseResult:
    """
    ...
    test_target_database = oci.get_data_safe_target_database(target_database_id=oci_data_safe_target_database["test_target_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataSafeTargetDatabase:GetDataSafeTargetDatabase', __args__, opts=opts, typ=GetDataSafeTargetDatabaseResult).value

    return AwaitableGetDataSafeTargetDatabaseResult(
        compartment_id=__ret__.compartment_id,
        connection_option=__ret__.connection_option,
