...
__all__ = [
    'GetObjectstorageObjectVersionsResult',
    'AwaitableGetObjectstorageObjectVersionsResult',
    'get_objectstorage_object_versions',
]

@pulumi.output_type
class GetObjectstorageObjectVersionsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetObjectstorageObjectVersionsFilterResult']]:
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetObjectstorageObjectVersionsItemResult']:
        """
...
class AwaitableGetObjectstorageObjectVersionsResult(GetObjectstorageObjectVersionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageObjectVersionsResult(
            bucket=self.bucket,
...
def get_objectstorage_object_versions(bucket: Optional[str] = None,
                                      delimiter: Optional[str] = None,
                                      end: Optional[str] = None,
                                      fields: Optional[str] = None,
                                      filters: Optional[Sequence[pulumi.InputType['GetObjectstorageObjectVersionsFilterArgs']]] = None,
                                      namespace: Optional[str] = None,
                                      prefix: Optional[str] = None,
                                      start: Optional[str] = None,
                                      start_after: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageObjectVersionsResult:
    """
    ...
    test_object_versions = oci.get_objectstorage_object_versions(bucket=var["object_version_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageObjectVersions:GetObjectstorageObjectVersions', __args__, opts=opts, typ=GetObjectstorageObjectVersionsResult).value

    return AwaitableGetObjectstorageObjectVersionsResult(
