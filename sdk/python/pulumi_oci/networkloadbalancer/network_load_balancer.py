...
class NetworkLoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_network_load_balancer = oci.networkloadbalancer.NetworkLoadBalancer("testNetworkLoadBalancer",
            ...
            reserved_ips=[oci.networkloadbalancer.NetworkLoadBalancerReservedIpArgs(
