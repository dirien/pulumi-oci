...
class NetworkLoadBalancerIpAddress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reserved_ip: Optional['outputs.NetworkLoadBalancerIpAddressReservedIp'] = None):
        """
        :param str ip_address: An IP address.  Example: `192.168.0.3`
        :param bool is_public: Whether the IP address is public or private.
        :param 'NetworkLoadBalancerIpAddressReservedIpArgs' reserved_ip: An object representing a reserved IP address to be attached or that is already attached to a network load balancer.
        """
        if ip_address is not None:
            pulumi.set(__self__, "ip_address", ip_address)
    ...
    def reserved_ip(self) -> Optional['outputs.NetworkLoadBalancerIpAddressReservedIp']:
        """
...
class GetBackendSetsBackendSetCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 health_checker: 'outputs.GetBackendSetsBackendSetCollectionItemHealthCheckerResult',
                 id: str,
        ...
        :param 'GetBackendSetsBackendSetCollectionItemHealthCheckerArgs' health_checker: The health check policy configuration. For more information, see [Editing Health Check Policies](https://docs.cloud.oracle.com/iaas/Content/Balance/Tasks/editinghealthcheck.htm).
    ...
    def health_checker(self) -> 'outputs.GetBackendSetsBackendSetCollectionItemHealthCheckerResult':
        """
...
class GetNetworkLoadBalancerIpAddressResult(dict):
    def __init__(__self__, *,
                 ip_address: str,
                 is_public: bool,
                 reserved_ip: 'outputs.GetNetworkLoadBalancerIpAddressReservedIpResult'):
        """
        :param str ip_address: An IP address.  Example: `192.168.0.3`
        :param bool is_public: Whether the IP address is public or private.
        :param 'GetNetworkLoadBalancerIpAddressReservedIpArgs' reserved_ip: An object representing a reserved IP address to be attached or that is already attached to a network load balancer.
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "is_public", is_public)
        pulumi.set(__self__, "reserved_ip", reserved_ip)
    ...
    @property
    @pulumi.getter(name="reservedIp")
    def reserved_ip(self) -> 'outputs.GetNetworkLoadBalancerIpAddressReservedIpResult':
        """
        An object representing a reserved IP address to be attached or that is already attached to a network load balancer.
        """
        return pulumi.get(self, "reserved_ip")
