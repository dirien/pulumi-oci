...
__all__ = ['DatabaseDbHomeArgs', 'DatabaseDbHome']

@pulumi.input_type
class DatabaseDbHomeArgs:
    def __init__(__self__, *,
                 database: pulumi.Input['DatabaseDbHomeDatabaseArgs'],
        ...
        :param pulumi.Input['DatabaseDbHomeDatabaseArgs'] database: (Updatable) Details for creating a database.
    ...
    @property
    @pulumi.getter
    def database(self) -> pulumi.Input['DatabaseDbHomeDatabaseArgs']:
        """
    ...
    @database.setter
    def database(self, value: pulumi.Input['DatabaseDbHomeDatabaseArgs']):
...
@pulumi.input_type
class _DatabaseDbHomeState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 database: Optional[pulumi.Input['DatabaseDbHomeDatabaseArgs']] = None,
                 database_software_image_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def database(self) -> Optional[pulumi.Input['DatabaseDbHomeDatabaseArgs']]:
        """
        (Updatable) Details for creating a database.
        """
        return pulumi.get(self, "database")
    ...
    @database.setter
    def database(self, value: Optional[pulumi.Input['DatabaseDbHomeDatabaseArgs']]):
        pulumi.set(self, "database", value)
...
class DatabaseDbHome(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 database: Optional[pulumi.Input[pulumi.InputType['DatabaseDbHomeDatabaseArgs']]] = None,
                 database_software_image_id: Optional[pulumi.Input[str]] = None,
                 db_system_id: Optional[pulumi.Input[str]] = None,
                 db_version: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
        ...
        test_db_home = oci.DatabaseDbHome("testDbHome",
            database=oci.DatabaseDbHomeDatabaseArgs(
                ...
                db_backup_config=oci.DatabaseDbHomeDatabaseDbBackupConfigArgs(
                    ...
                    backup_destination_details=[oci.DatabaseDbHomeDatabaseDbBackupConfigBackupDestinationDetailArgs(
        ...
        :param pulumi.Input[pulumi.InputType['DatabaseDbHomeDatabaseArgs']] database: (Updatable) Details for creating a database.
        :param pulumi.Input[str] database_software_image_id: The database software image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param pulumi.Input[str] db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        :param pulumi.Input[str] db_version: A valid Oracle Database version. To get a list of supported versions, use the [ListDbVersions](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/DbVersionSummary/ListDbVersions) operation.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseDbHomeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseDbHomeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseDbHomeArgs.__new__(DatabaseDbHomeArgs)
        ...
        super(DatabaseDbHome, __self__).__init__(
            'oci:index/databaseDbHome:DatabaseDbHome',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            vm_cluster_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseDbHome':
        """
        ...
        __props__ = _DatabaseDbHomeState.__new__(_DatabaseDbHomeState)
        ...
        __props__.__dict__["vm_cluster_id"] = vm_cluster_id
        return DatabaseDbHome(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def database(self) -> pulumi.Output['outputs.DatabaseDbHomeDatabase']:
        """
        (Updatable) Details for creating a database.
        """
        return pulumi.get(self, "database")
