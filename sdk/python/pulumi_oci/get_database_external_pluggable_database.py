...
__all__ = [
    'GetDatabaseExternalPluggableDatabaseResult',
    'AwaitableGetDatabaseExternalPluggableDatabaseResult',
    'get_database_external_pluggable_database',
]

@pulumi.output_type
class GetDatabaseExternalPluggableDatabaseResult:
    """
    A collection of values returned by GetDatabaseExternalPluggableDatabase.
    """
    def __init__(__self__, character_set=None, compartment_id=None, database_configuration=None, database_edition=None, database_management_config=None, database_version=None, db_id=None, db_packs=None, db_unique_name=None, defined_tags=None, display_name=None, external_container_database_id=None, external_pluggable_database_id=None, freeform_tags=None, id=None, lifecycle_details=None, ncharacter_set=None, operations_insights_config=None, source_id=None, state=None, time_created=None, time_zone=None):
    ...
    def database_management_config(self) -> 'outputs.GetDatabaseExternalPluggableDatabaseDatabaseManagementConfigResult':
        """
    ...
    def operations_insights_config(self) -> 'outputs.GetDatabaseExternalPluggableDatabaseOperationsInsightsConfigResult':
        """
...
class AwaitableGetDatabaseExternalPluggableDatabaseResult(GetDatabaseExternalPluggableDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseExternalPluggableDatabaseResult(
...
def get_database_external_pluggable_database(external_pluggable_database_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseExternalPluggableDatabaseResult:
    """
    ...
    test_external_pluggable_database = oci.get_database_external_pluggable_database(external_pluggable_database_id=oci_database_external_pluggable_database["test_external_pluggable_database"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseExternalPluggableDatabase:GetDatabaseExternalPluggableDatabase', __args__, opts=opts, typ=GetDatabaseExternalPluggableDatabaseResult).value

    return AwaitableGetDatabaseExternalPluggableDatabaseResult(
