...
__all__ = [
    'GetIdentityTagDefaultsResult',
    'AwaitableGetIdentityTagDefaultsResult',
    'get_identity_tag_defaults',
]

@pulumi.output_type
class GetIdentityTagDefaultsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetIdentityTagDefaultsFilterResult']]:
    ...
    def tag_defaults(self) -> Sequence['outputs.GetIdentityTagDefaultsTagDefaultResult']:
        """
...
class AwaitableGetIdentityTagDefaultsResult(GetIdentityTagDefaultsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityTagDefaultsResult(
...
def get_identity_tag_defaults(compartment_id: Optional[str] = None,
                              filters: Optional[Sequence[pulumi.InputType['GetIdentityTagDefaultsFilterArgs']]] = None,
                              id: Optional[str] = None,
                              state: Optional[str] = None,
                              tag_definition_id: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityTagDefaultsResult:
    """
    ...
    test_tag_defaults = oci.get_identity_tag_defaults(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityTagDefaults:GetIdentityTagDefaults', __args__, opts=opts, typ=GetIdentityTagDefaultsResult).value

    return AwaitableGetIdentityTagDefaultsResult(
