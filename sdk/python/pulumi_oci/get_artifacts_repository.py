...
__all__ = [
    'GetArtifactsRepositoryResult',
    'AwaitableGetArtifactsRepositoryResult',
    'get_artifacts_repository',
]

@pulumi.output_type
class GetArtifactsRepositoryResult:
    """
...
class AwaitableGetArtifactsRepositoryResult(GetArtifactsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsRepositoryResult(
...
def get_artifacts_repository(repository_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsRepositoryResult:
    """
    ...
    test_repository = oci.get_artifacts_repository(repository_id=oci_artifacts_repository["test_repository"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsRepository:GetArtifactsRepository', __args__, opts=opts, typ=GetArtifactsRepositoryResult).value

    return AwaitableGetArtifactsRepositoryResult(
