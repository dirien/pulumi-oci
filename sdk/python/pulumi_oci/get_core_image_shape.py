...
__all__ = [
    'GetCoreImageShapeResult',
    'AwaitableGetCoreImageShapeResult',
    'get_core_image_shape',
]

@pulumi.output_type
class GetCoreImageShapeResult:
    """
    ...
    def memory_constraints(self) -> Sequence['outputs.GetCoreImageShapeMemoryConstraintResult']:
        """
    ...
    def ocpu_constraints(self) -> Sequence['outputs.GetCoreImageShapeOcpuConstraintResult']:
        """
...
class AwaitableGetCoreImageShapeResult(GetCoreImageShapeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreImageShapeResult(
            id=self.id,
...
def get_core_image_shape(image_id: Optional[str] = None,
                         shape_name: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreImageShapeResult:
    """
    ...
    test_image_shape = oci.get_core_image_shape(image_id=oci_core_image["test_image"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreImageShape:GetCoreImageShape', __args__, opts=opts, typ=GetCoreImageShapeResult).value

    return AwaitableGetCoreImageShapeResult(
        id=__ret__.id,
