...
__all__ = [
    'GetDatacatalogCatalogTypesResult',
    'AwaitableGetDatacatalogCatalogTypesResult',
    'get_datacatalog_catalog_types',
]

@pulumi.output_type
class GetDatacatalogCatalogTypesResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatacatalogCatalogTypesFilterResult']]:
    ...
    def type_collections(self) -> Sequence['outputs.GetDatacatalogCatalogTypesTypeCollectionResult']:
        """
...
class AwaitableGetDatacatalogCatalogTypesResult(GetDatacatalogCatalogTypesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatacatalogCatalogTypesResult(
...
def get_datacatalog_catalog_types(catalog_id: Optional[str] = None,
                                  external_type_name: Optional[str] = None,
                                  fields: Optional[Sequence[str]] = None,
                                  filters: Optional[Sequence[pulumi.InputType['GetDatacatalogCatalogTypesFilterArgs']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatacatalogCatalogTypesResult:
    """
    ...
    test_catalog_types = oci.get_datacatalog_catalog_types(catalog_id=oci_datacatalog_catalog["test_catalog"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatacatalogCatalogTypes:GetDatacatalogCatalogTypes', __args__, opts=opts, typ=GetDatacatalogCatalogTypesResult).value

    return AwaitableGetDatacatalogCatalogTypesResult(
