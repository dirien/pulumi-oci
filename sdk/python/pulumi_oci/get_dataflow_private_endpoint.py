...
__all__ = [
    'GetDataflowPrivateEndpointResult',
    'AwaitableGetDataflowPrivateEndpointResult',
    'get_dataflow_private_endpoint',
]

@pulumi.output_type
class GetDataflowPrivateEndpointResult:
    """
...
class AwaitableGetDataflowPrivateEndpointResult(GetDataflowPrivateEndpointResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowPrivateEndpointResult(
...
def get_dataflow_private_endpoint(private_endpoint_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowPrivateEndpointResult:
    """
    ...
    test_private_endpoint = oci.get_dataflow_private_endpoint(private_endpoint_id=oci_dataflow_private_endpoint["test_private_endpoint"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowPrivateEndpoint:GetDataflowPrivateEndpoint', __args__, opts=opts, typ=GetDataflowPrivateEndpointResult).value

    return AwaitableGetDataflowPrivateEndpointResult(
