...
class AwaitableGetDatabaseAutonomousDatabaseBackupResult(GetDatabaseAutonomousDatabaseBackupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseAutonomousDatabaseBackupResult(
...
def get_database_autonomous_database_backup(autonomous_database_backup_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseAutonomousDatabaseBackupResult:
    """
    ...
    test_autonomous_database_backup = oci.get_database_autonomous_database_backup(autonomous_database_backup_id=oci_database_autonomous_database_backup["test_autonomous_database_backup"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseAutonomousDatabaseBackup:GetDatabaseAutonomousDatabaseBackup', __args__, opts=opts, typ=GetDatabaseAutonomousDatabaseBackupResult).value

    return AwaitableGetDatabaseAutonomousDatabaseBackupResult(
