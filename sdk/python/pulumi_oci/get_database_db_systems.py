...
__all__ = [
    'GetDatabaseDbSystemsResult',
    'AwaitableGetDatabaseDbSystemsResult',
    'get_database_db_systems',
]

@pulumi.output_type
class GetDatabaseDbSystemsResult:
    """
    ...
    def db_systems(self) -> Sequence['outputs.GetDatabaseDbSystemsDbSystemResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDatabaseDbSystemsFilterResult']]:
...
class AwaitableGetDatabaseDbSystemsResult(GetDatabaseDbSystemsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseDbSystemsResult(
...
def get_database_db_systems(availability_domain: Optional[str] = None,
                            backup_id: Optional[str] = None,
                            compartment_id: Optional[str] = None,
                            display_name: Optional[str] = None,
                            filters: Optional[Sequence[pulumi.InputType['GetDatabaseDbSystemsFilterArgs']]] = None,
                            state: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseDbSystemsResult:
    """
    ...
    **Note:** Deprecated for Exadata Cloud Service systems. Use the [new resource model APIs](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaflexsystem.htm#exaflexsystem_topic-resource_model) instead.
    ...
    test_db_systems = oci.get_database_db_systems(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseDbSystems:GetDatabaseDbSystems', __args__, opts=opts, typ=GetDatabaseDbSystemsResult).value

    return AwaitableGetDatabaseDbSystemsResult(
