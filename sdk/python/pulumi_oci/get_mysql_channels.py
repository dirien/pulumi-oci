...
__all__ = [
    'GetMysqlChannelsResult',
    'AwaitableGetMysqlChannelsResult',
    'get_mysql_channels',
]

@pulumi.output_type
class GetMysqlChannelsResult:
    """
    ...
    @property
    @pulumi.getter
    def channels(self) -> Sequence['outputs.GetMysqlChannelsChannelResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetMysqlChannelsFilterResult']]:
...
class AwaitableGetMysqlChannelsResult(GetMysqlChannelsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetMysqlChannelsResult(
...
def get_mysql_channels(channel_id: Optional[str] = None,
                       compartment_id: Optional[str] = None,
                       db_system_id: Optional[str] = None,
                       display_name: Optional[str] = None,
                       filters: Optional[Sequence[pulumi.InputType['GetMysqlChannelsFilterArgs']]] = None,
                       is_enabled: Optional[bool] = None,
                       state: Optional[str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMysqlChannelsResult:
    """
    ...
    test_channels = oci.get_mysql_channels(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getMysqlChannels:GetMysqlChannels', __args__, opts=opts, typ=GetMysqlChannelsResult).value

    return AwaitableGetMysqlChannelsResult(
