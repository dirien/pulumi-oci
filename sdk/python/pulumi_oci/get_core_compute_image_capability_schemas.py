...
__all__ = [
    'GetCoreComputeImageCapabilitySchemasResult',
    'AwaitableGetCoreComputeImageCapabilitySchemasResult',
    'get_core_compute_image_capability_schemas',
]

@pulumi.output_type
class GetCoreComputeImageCapabilitySchemasResult:
    """
    ...
    def compute_image_capability_schemas(self) -> Sequence['outputs.GetCoreComputeImageCapabilitySchemasComputeImageCapabilitySchemaResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCoreComputeImageCapabilitySchemasFilterResult']]:
...
class AwaitableGetCoreComputeImageCapabilitySchemasResult(GetCoreComputeImageCapabilitySchemasResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreComputeImageCapabilitySchemasResult(
...
def get_core_compute_image_capability_schemas(compartment_id: Optional[str] = None,
                                              display_name: Optional[str] = None,
                                              filters: Optional[Sequence[pulumi.InputType['GetCoreComputeImageCapabilitySchemasFilterArgs']]] = None,
                                              image_id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreComputeImageCapabilitySchemasResult:
    """
    ...
    test_compute_image_capability_schemas = oci.get_core_compute_image_capability_schemas(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreComputeImageCapabilitySchemas:GetCoreComputeImageCapabilitySchemas', __args__, opts=opts, typ=GetCoreComputeImageCapabilitySchemasResult).value

    return AwaitableGetCoreComputeImageCapabilitySchemasResult(
