...
__all__ = [
    'GetObjectstorageObjectResult',
    'AwaitableGetObjectstorageObjectResult',
    'get_objectstorage_object',
]

@pulumi.output_type
class GetObjectstorageObjectResult:
    """
...
class AwaitableGetObjectstorageObjectResult(GetObjectstorageObjectResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetObjectstorageObjectResult(
...
def get_objectstorage_object(base64_encode_content: Optional[bool] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetObjectstorageObjectResult:
    """
    ...
    test_object = oci.get_objectstorage_object(bucket=var["object_bucket"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getObjectstorageObject:GetObjectstorageObject', __args__, opts=opts, typ=GetObjectstorageObjectResult).value

    return AwaitableGetObjectstorageObjectResult(
