...
__all__ = [
    'GetDnsRrsetResult',
    'AwaitableGetDnsRrsetResult',
    'get_dns_rrset',
]

@pulumi.output_type
class GetDnsRrsetResult:
    """
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetDnsRrsetItemResult']:
...
class AwaitableGetDnsRrsetResult(GetDnsRrsetResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnsRrsetResult(
...
def get_dns_rrset(compartment_id: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnsRrsetResult:
    """
    ...
    test_rrset = oci.get_dns_rrset(domain=var["rrset_domain"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDnsRrset:GetDnsRrset', __args__, opts=opts, typ=GetDnsRrsetResult).value

    return AwaitableGetDnsRrsetResult(
