...
__all__ = [
    'GetCoreInstanceResult',
    'AwaitableGetCoreInstanceResult',
    'get_core_instance',
]

@pulumi.output_type
class GetCoreInstanceResult:
    """
    A collection of values returned by GetCoreInstance.
    """
    def __init__(__self__, agent_config=None, availability_config=None, availability_domain=None, boot_volume_id=None, capacity_reservation_id=None, compartment_id=None, create_vnic_details=None, dedicated_vm_host_id=None, defined_tags=None, display_name=None, extended_metadata=None, fault_domain=None, freeform_tags=None, hostname_label=None, id=None, image=None, instance_id=None, instance_options=None, ipxe_script=None, is_pv_encryption_in_transit_enabled=None, launch_mode=None, launch_options=None, metadata=None, platform_config=None, preemptible_instance_config=None, preserve_boot_volume=None, private_ip=None, public_ip=None, region=None, shape=None, shape_config=None, source_details=None, state=None, subnet_id=None, system_tags=None, time_created=None, time_maintenance_reboot_due=None):
        if agent_config and not isinstance(agent_config, dict):
            raise TypeError("Expected argument 'agent_config' to be a dict")
        pulumi.set(__self__, "agent_config", agent_config)
        if availability_config and not isinstance(availability_config, dict):
            raise TypeError("Expected argument 'availability_config' to be a dict")
        ...
        if create_vnic_details and not isinstance(create_vnic_details, dict):
            raise TypeError("Expected argument 'create_vnic_details' to be a dict")
        ...
        if instance_options and not isinstance(instance_options, dict):
            raise TypeError("Expected argument 'instance_options' to be a dict")
        ...
        if launch_options and not isinstance(launch_options, dict):
            raise TypeError("Expected argument 'launch_options' to be a dict")
        pulumi.set(__self__, "launch_options", launch_options)
        if metadata and not isinstance(metadata, dict):
            raise TypeError("Expected argument 'metadata' to be a dict")
        pulumi.set(__self__, "metadata", metadata)
        if platform_config and not isinstance(platform_config, dict):
            raise TypeError("Expected argument 'platform_config' to be a dict")
        pulumi.set(__self__, "platform_config", platform_config)
        if preemptible_instance_config and not isinstance(preemptible_instance_config, dict):
            raise TypeError("Expected argument 'preemptible_instance_config' to be a dict")
        ...
        if shape_config and not isinstance(shape_config, dict):
            raise TypeError("Expected argument 'shape_config' to be a dict")
        pulumi.set(__self__, "shape_config", shape_config)
        if source_details and not isinstance(source_details, dict):
            raise TypeError("Expected argument 'source_details' to be a dict")
    ...
    def agent_config(self) -> 'outputs.GetCoreInstanceAgentConfigResult':
        """
    ...
    def availability_config(self) -> 'outputs.GetCoreInstanceAvailabilityConfigResult':
        """
    ...
    def create_vnic_details(self) -> 'outputs.GetCoreInstanceCreateVnicDetailsResult':
    ...
    def instance_options(self) -> 'outputs.GetCoreInstanceInstanceOptionsResult':
        """
    ...
    def launch_options(self) -> 'outputs.GetCoreInstanceLaunchOptionsResult':
        """
    ...
    def platform_config(self) -> 'outputs.GetCoreInstancePlatformConfigResult':
        """
    ...
    def preemptible_instance_config(self) -> 'outputs.GetCoreInstancePreemptibleInstanceConfigResult':
        """
    ...
    def shape_config(self) -> 'outputs.GetCoreInstanceShapeConfigResult':
        """
    ...
    def source_details(self) -> 'outputs.GetCoreInstanceSourceDetailsResult':
...
class AwaitableGetCoreInstanceResult(GetCoreInstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreInstanceResult(
            ...
            preemptible_instance_config=self.preemptible_instance_config,
...
def get_core_instance(instance_id: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreInstanceResult:
    """
    ...
    test_instance = oci.get_core_instance(instance_id=oci_core_instance["test_instance"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreInstance:GetCoreInstance', __args__, opts=opts, typ=GetCoreInstanceResult).value

    return AwaitableGetCoreInstanceResult(
        agent_config=__ret__.agent_config,
        availability_config=__ret__.availability_config,
        ...
        platform_config=__ret__.platform_config,
        preemptible_instance_config=__ret__.preemptible_instance_config,
        preserve_boot_volume=__ret__.preserve_boot_volume,
        private_ip=__ret__.private_ip,
        public_ip=__ret__.public_ip,
        region=__ret__.region,
        shape=__ret__.shape,
        shape_config=__ret__.shape_config,
