...
__all__ = [
    'GetManagementAgentManagementAgentAvailableHistoriesResult',
    'AwaitableGetManagementAgentManagementAgentAvailableHistoriesResult',
    'get_management_agent_management_agent_available_histories',
]

@pulumi.output_type
class GetManagementAgentManagementAgentAvailableHistoriesResult:
    """
    ...
    def availability_histories(self) -> Sequence['outputs.GetManagementAgentManagementAgentAvailableHistoriesAvailabilityHistoryResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetManagementAgentManagementAgentAvailableHistoriesFilterResult']]:
...
class AwaitableGetManagementAgentManagementAgentAvailableHistoriesResult(GetManagementAgentManagementAgentAvailableHistoriesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagementAgentManagementAgentAvailableHistoriesResult(
...
def get_management_agent_management_agent_available_histories(filters: Optional[Sequence[pulumi.InputType['GetManagementAgentManagementAgentAvailableHistoriesFilterArgs']]] = None,
                                                              ...
                                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagementAgentManagementAgentAvailableHistoriesResult:
    """
    ...
    test_management_agent_available_histories = oci.get_management_agent_management_agent_available_histories(management_agent_id=oci_management_agent_management_agent["test_management_agent"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getManagementAgentManagementAgentAvailableHistories:GetManagementAgentManagementAgentAvailableHistories', __args__, opts=opts, typ=GetManagementAgentManagementAgentAvailableHistoriesResult).value

    return AwaitableGetManagementAgentManagementAgentAvailableHistoriesResult(
