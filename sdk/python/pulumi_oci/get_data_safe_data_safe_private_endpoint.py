...
__all__ = [
    'GetDataSafeDataSafePrivateEndpointResult',
    'AwaitableGetDataSafeDataSafePrivateEndpointResult',
    'get_data_safe_data_safe_private_endpoint',
]

@pulumi.output_type
class GetDataSafeDataSafePrivateEndpointResult:
    """
...
class AwaitableGetDataSafeDataSafePrivateEndpointResult(GetDataSafeDataSafePrivateEndpointResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataSafeDataSafePrivateEndpointResult(
...
def get_data_safe_data_safe_private_endpoint(data_safe_private_endpoint_id: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataSafeDataSafePrivateEndpointResult:
    """
    ...
    test_data_safe_private_endpoint = oci.get_data_safe_data_safe_private_endpoint(data_safe_private_endpoint_id=oci_data_safe_data_safe_private_endpoint["test_data_safe_private_endpoint"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataSafeDataSafePrivateEndpoint:GetDataSafeDataSafePrivateEndpoint', __args__, opts=opts, typ=GetDataSafeDataSafePrivateEndpointResult).value

    return AwaitableGetDataSafeDataSafePrivateEndpointResult(
