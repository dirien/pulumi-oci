...
__all__ = [
    'GetIdentityNetworkSourceResult',
    'AwaitableGetIdentityNetworkSourceResult',
    'get_identity_network_source',
]

@pulumi.output_type
class GetIdentityNetworkSourceResult:
    """
    ...
    def virtual_source_lists(self) -> Sequence['outputs.GetIdentityNetworkSourceVirtualSourceListResult']:
        """
...
class AwaitableGetIdentityNetworkSourceResult(GetIdentityNetworkSourceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdentityNetworkSourceResult(
...
def get_identity_network_source(network_source_id: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdentityNetworkSourceResult:
    """
    ...
    test_network_source = oci.get_identity_network_source(network_source_id=oci_identity_network_source["test_network_source"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getIdentityNetworkSource:GetIdentityNetworkSource', __args__, opts=opts, typ=GetIdentityNetworkSourceResult).value

    return AwaitableGetIdentityNetworkSourceResult(
