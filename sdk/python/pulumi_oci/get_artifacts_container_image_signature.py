...
__all__ = [
    'GetArtifactsContainerImageSignatureResult',
    'AwaitableGetArtifactsContainerImageSignatureResult',
    'get_artifacts_container_image_signature',
]

@pulumi.output_type
class GetArtifactsContainerImageSignatureResult:
    """
...
class AwaitableGetArtifactsContainerImageSignatureResult(GetArtifactsContainerImageSignatureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetArtifactsContainerImageSignatureResult(
...
def get_artifacts_container_image_signature(image_signature_id: Optional[str] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetArtifactsContainerImageSignatureResult:
    """
    ...
    test_container_image_signature = oci.get_artifacts_container_image_signature(image_signature_id=oci_artifacts_image_signature["test_image_signature"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getArtifactsContainerImageSignature:GetArtifactsContainerImageSignature', __args__, opts=opts, typ=GetArtifactsContainerImageSignatureResult).value

    return AwaitableGetArtifactsContainerImageSignatureResult(
