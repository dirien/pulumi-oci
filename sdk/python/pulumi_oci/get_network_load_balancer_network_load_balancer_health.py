...
__all__ = [
    'GetNetworkLoadBalancerNetworkLoadBalancerHealthResult',
    'AwaitableGetNetworkLoadBalancerNetworkLoadBalancerHealthResult',
    'get_network_load_balancer_network_load_balancer_health',
]

@pulumi.output_type
class GetNetworkLoadBalancerNetworkLoadBalancerHealthResult:
    """
...
class AwaitableGetNetworkLoadBalancerNetworkLoadBalancerHealthResult(GetNetworkLoadBalancerNetworkLoadBalancerHealthResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkLoadBalancerNetworkLoadBalancerHealthResult(
...
def get_network_load_balancer_network_load_balancer_health(network_load_balancer_id: Optional[str] = None,
                                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkLoadBalancerNetworkLoadBalancerHealthResult:
    """
    ...
    test_network_load_balancer_health = oci.get_network_load_balancer_network_load_balancer_health(network_load_balancer_id=oci_network_load_balancer_network_load_balancer["test_network_load_balancer"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getNetworkLoadBalancerNetworkLoadBalancerHealth:GetNetworkLoadBalancerNetworkLoadBalancerHealth', __args__, opts=opts, typ=GetNetworkLoadBalancerNetworkLoadBalancerHealthResult).value

    return AwaitableGetNetworkLoadBalancerNetworkLoadBalancerHealthResult(
