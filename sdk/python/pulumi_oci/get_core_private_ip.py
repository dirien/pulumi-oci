...
__all__ = [
    'GetCorePrivateIpResult',
    'AwaitableGetCorePrivateIpResult',
    'get_core_private_ip',
]

@pulumi.output_type
class GetCorePrivateIpResult:
    """
...
class AwaitableGetCorePrivateIpResult(GetCorePrivateIpResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePrivateIpResult(
...
def get_core_private_ip(private_ip_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePrivateIpResult:
    """
    ...
    test_private_ip = oci.get_core_private_ip(private_ip_id=oci_core_private_ip["test_private_ip"]["id"])
    ```


    :param str private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private IP.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePrivateIp:GetCorePrivateIp', __args__, opts=opts, typ=GetCorePrivateIpResult).value

    return AwaitableGetCorePrivateIpResult(
