...
__all__ = [
    'GetCoreAppCatalogListingResourceVersionResult',
    'AwaitableGetCoreAppCatalogListingResourceVersionResult',
    'get_core_app_catalog_listing_resource_version',
]

@pulumi.output_type
class GetCoreAppCatalogListingResourceVersionResult:
    """
...
class AwaitableGetCoreAppCatalogListingResourceVersionResult(GetCoreAppCatalogListingResourceVersionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreAppCatalogListingResourceVersionResult(
...
def get_core_app_catalog_listing_resource_version(listing_id: Optional[str] = None,
                                                  resource_version: Optional[str] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreAppCatalogListingResourceVersionResult:
    """
    ...
    test_app_catalog_listing_resource_version = oci.get_core_app_catalog_listing_resource_version(listing_id=data["oci_core_app_catalog_listing"]["test_listing"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreAppCatalogListingResourceVersion:GetCoreAppCatalogListingResourceVersion', __args__, opts=opts, typ=GetCoreAppCatalogListingResourceVersionResult).value

    return AwaitableGetCoreAppCatalogListingResourceVersionResult(
