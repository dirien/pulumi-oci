...
__all__ = [
    'GetCorePublicIpPoolResult',
    'AwaitableGetCorePublicIpPoolResult',
    'get_core_public_ip_pool',
]

@pulumi.output_type
class GetCorePublicIpPoolResult:
    """
...
class AwaitableGetCorePublicIpPoolResult(GetCorePublicIpPoolResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCorePublicIpPoolResult(
...
def get_core_public_ip_pool(public_ip_pool_id: Optional[str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCorePublicIpPoolResult:
    """
    ...
    test_public_ip_pool = oci.get_core_public_ip_pool(public_ip_pool_id=oci_core_public_ip_pool["test_public_ip_pool"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCorePublicIpPool:GetCorePublicIpPool', __args__, opts=opts, typ=GetCorePublicIpPoolResult).value

    return AwaitableGetCorePublicIpPoolResult(
