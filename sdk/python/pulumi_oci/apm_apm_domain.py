...
__all__ = ['ApmApmDomainArgs', 'ApmApmDomain']

@pulumi.input_type
class ApmApmDomainArgs:
...
class _ApmApmDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment corresponding to the APM Domain.
        :param pulumi.Input[str] data_upload_endpoint: Where APM Agents upload their observations and metrics.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[str] description: (Updatable) Description of the APM Domain
        :param pulumi.Input[str] display_name: (Updatable) Display name of the APM Domain
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[str] time_created: The time the the APM Domain was created. An RFC3339 formatted datetime string
        :param pulumi.Input[str] time_updated: The time the APM Domain was updated. An RFC3339 formatted datetime string
        """
...
class ApmApmDomain(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        test_apm_domain = oci.ApmApmDomain("testApmDomain",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ApmApmDomainArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApmApmDomainArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApmApmDomainArgs.__new__(ApmApmDomainArgs)
        ...
        super(ApmApmDomain, __self__).__init__(
            'oci:index/apmApmDomain:ApmApmDomain',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'ApmApmDomain':
        """
        ...
        __props__ = _ApmApmDomainState.__new__(_ApmApmDomainState)
        ...
        return ApmApmDomain(resource_name, opts=opts, __props__=__props__)
