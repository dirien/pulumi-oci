...
__all__ = [
    'GetDatabaseCloudExadataInfrastructureResult',
    'AwaitableGetDatabaseCloudExadataInfrastructureResult',
    'get_database_cloud_exadata_infrastructure',
]

@pulumi.output_type
class GetDatabaseCloudExadataInfrastructureResult:
    """
    ...
    def customer_contacts(self) -> Sequence['outputs.GetDatabaseCloudExadataInfrastructureCustomerContactResult']:
        """
    ...
    def maintenance_window(self) -> 'outputs.GetDatabaseCloudExadataInfrastructureMaintenanceWindowResult':
        """
...
class AwaitableGetDatabaseCloudExadataInfrastructureResult(GetDatabaseCloudExadataInfrastructureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabaseCloudExadataInfrastructureResult(
...
def get_database_cloud_exadata_infrastructure(cloud_exadata_infrastructure_id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabaseCloudExadataInfrastructureResult:
    """
    ...
    test_cloud_exadata_infrastructure = oci.get_database_cloud_exadata_infrastructure(cloud_exadata_infrastructure_id=oci_database_cloud_exadata_infrastructure["test_cloud_exadata_infrastructure"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDatabaseCloudExadataInfrastructure:GetDatabaseCloudExadataInfrastructure', __args__, opts=opts, typ=GetDatabaseCloudExadataInfrastructureResult).value

    return AwaitableGetDatabaseCloudExadataInfrastructureResult(
