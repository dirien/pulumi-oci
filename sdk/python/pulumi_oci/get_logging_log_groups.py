...
__all__ = [
    'GetLoggingLogGroupsResult',
    'AwaitableGetLoggingLogGroupsResult',
    'get_logging_log_groups',
]

@pulumi.output_type
class GetLoggingLogGroupsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetLoggingLogGroupsFilterResult']]:
    ...
    def log_groups(self) -> Sequence['outputs.GetLoggingLogGroupsLogGroupResult']:
        """
...
class AwaitableGetLoggingLogGroupsResult(GetLoggingLogGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLoggingLogGroupsResult(
...
def get_logging_log_groups(compartment_id: Optional[str] = None,
                           display_name: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetLoggingLogGroupsFilterArgs']]] = None,
                           is_compartment_id_in_subtree: Optional[bool] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLoggingLogGroupsResult:
    """
    ...
    test_log_groups = oci.get_logging_log_groups(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getLoggingLogGroups:GetLoggingLogGroups', __args__, opts=opts, typ=GetLoggingLogGroupsResult).value

    return AwaitableGetLoggingLogGroupsResult(
