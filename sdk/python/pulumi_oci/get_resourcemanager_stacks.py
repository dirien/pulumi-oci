...
__all__ = [
    'GetResourcemanagerStacksResult',
    'AwaitableGetResourcemanagerStacksResult',
    'get_resourcemanager_stacks',
]

@pulumi.output_type
class GetResourcemanagerStacksResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetResourcemanagerStacksFilterResult']]:
    ...
    @property
    @pulumi.getter
    def stacks(self) -> Sequence['outputs.GetResourcemanagerStacksStackResult']:
        """
        The list of stacks.
        """
...
class AwaitableGetResourcemanagerStacksResult(GetResourcemanagerStacksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetResourcemanagerStacksResult(
...
def get_resourcemanager_stacks(compartment_id: Optional[str] = None,
                               display_name: Optional[str] = None,
                               filters: Optional[Sequence[pulumi.InputType['GetResourcemanagerStacksFilterArgs']]] = None,
                               id: Optional[str] = None,
                               state: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourcemanagerStacksResult:
    """
    ...
    test_stacks = oci.get_resourcemanager_stacks(compartment_id=var["compartment_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getResourcemanagerStacks:GetResourcemanagerStacks', __args__, opts=opts, typ=GetResourcemanagerStacksResult).value

    return AwaitableGetResourcemanagerStacksResult(
