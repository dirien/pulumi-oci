...
__all__ = ['CoreBootVolumeArgs', 'CoreBootVolume']

@pulumi.input_type
class CoreBootVolumeArgs:
    def __init__(__self__, *,
                 availability_domain: pulumi.Input[str],
                 compartment_id: pulumi.Input[str],
                 source_details: pulumi.Input['CoreBootVolumeSourceDetailsArgs'],
                 backup_policy_id: Optional[pulumi.Input[str]] = None,
                 boot_volume_replicas: Optional[pulumi.Input[Sequence[pulumi.Input['CoreBootVolumeBootVolumeReplicaArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CoreBootVolumeBootVolumeReplicaArgs']]] boot_volume_replicas: (Updatable) The list of boot volume replicas to be enabled for this boot volume in the specified destination availability domains.
        :param pulumi.Input[bool] boot_volume_replicas_deletion: (updatable) The boolean value, if you have replicas and want to disable replicas set this argument to true and remove `boot_volume_replicas` in representation at the same time. If you want to enable a new replicas, remove this argument and use `boot_volume_replicas` again.
    ...
    def source_details(self) -> pulumi.Input['CoreBootVolumeSourceDetailsArgs']:
        return pulumi.get(self, "source_details")

    @source_details.setter
    def source_details(self, value: pulumi.Input['CoreBootVolumeSourceDetailsArgs']):
    ...
    def boot_volume_replicas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CoreBootVolumeBootVolumeReplicaArgs']]]]:
        """
    ...
    def boot_volume_replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CoreBootVolumeBootVolumeReplicaArgs']]]]):
...
class _CoreBootVolumeState:
    def __init__(__self__, *,
                 ...
                 source_details: Optional[pulumi.Input['CoreBootVolumeSourceDetailsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> Optional[pulumi.Input['CoreBootVolumeSourceDetailsArgs']]:
        return pulumi.get(self, "source_details")

    @source_details.setter
    def source_details(self, value: Optional[pulumi.Input['CoreBootVolumeSourceDetailsArgs']]):
        pulumi.set(self, "source_details", value)
...
class CoreBootVolume(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 availability_domain: Optional[pulumi.Input[str]] = None,
                 backup_policy_id: Optional[pulumi.Input[str]] = None,
                 boot_volume_replicas: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreBootVolumeBootVolumeReplicaArgs']]]]] = None,
                 boot_volume_replicas_deletion: Optional[pulumi.Input[bool]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 kms_key_id: Optional[pulumi.Input[str]] = None,
                 size_in_gbs: Optional[pulumi.Input[str]] = None,
                 source_details: Optional[pulumi.Input[pulumi.InputType['CoreBootVolumeSourceDetailsArgs']]] = None,
                 vpus_per_gb: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        test_boot_volume = oci.CoreBootVolume("testBootVolume",
            compartment_id=var["compartment_id"],
            source_details=oci.CoreBootVolumeSourceDetailsArgs(
            ...
            boot_volume_replicas=[oci.CoreBootVolumeBootVolumeReplicaArgs(
        ...
        :param pulumi.Input[str] availability_domain: (Updatable) The availability domain of the boot volume replica.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[str] backup_policy_id: If provided, specifies the ID of the boot volume backup policy to assign to the newly created boot volume. If omitted, no policy will be assigned.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CoreBootVolumeBootVolumeReplicaArgs']]]] boot_volume_replicas: (Updatable) The list of boot volume replicas to be enabled for this boot volume in the specified destination availability domains.
        :param pulumi.Input[bool] boot_volume_replicas_deletion: (updatable) The boolean value, if you have replicas and want to disable replicas set this argument to true and remove `boot_volume_replicas` in representation at the same time. If you want to enable a new replicas, remove this argument and use `boot_volume_replicas` again.
        :param pulumi.Input[str] compartment_id: (Updatable) The OCID of the compartment that contains the boot volume.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param CoreBootVolumeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CoreBootVolumeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CoreBootVolumeArgs.__new__(CoreBootVolumeArgs)
        ...
        super(CoreBootVolume, __self__).__init__(
            'oci:index/coreBootVolume:CoreBootVolume',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            volume_group_id: Optional[pulumi.Input[str]] = None,
            vpus_per_gb: Optional[pulumi.Input[str]] = None) -> 'CoreBootVolume':
        """
        ...
        __props__ = _CoreBootVolumeState.__new__(_CoreBootVolumeState)
        ...
        __props__.__dict__["vpus_per_gb"] = vpus_per_gb
        return CoreBootVolume(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="bootVolumeReplicas")
    def boot_volume_replicas(self) -> pulumi.Output[Sequence['outputs.CoreBootVolumeBootVolumeReplica']]:
        """
        (Updatable) The list of boot volume replicas to be enabled for this boot volume in the specified destination availability domains.
        """
        return pulumi.get(self, "boot_volume_replicas")
    ...
    @property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Output['outputs.CoreBootVolumeSourceDetails']:
        return pulumi.get(self, "source_details")
