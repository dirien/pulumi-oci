...
__all__ = [
    'GetDataflowRunLogResult',
    'AwaitableGetDataflowRunLogResult',
    'get_dataflow_run_log',
]

@pulumi.output_type
class GetDataflowRunLogResult:
    """
...
class AwaitableGetDataflowRunLogResult(GetDataflowRunLogResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDataflowRunLogResult(
...
def get_dataflow_run_log(base64_encode_content: Optional[bool] = None,
                         name: Optional[str] = None,
                         run_id: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDataflowRunLogResult:
    """
    ...
    test_run_log = oci.get_dataflow_run_log(name=var["run_log_name"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDataflowRunLog:GetDataflowRunLog', __args__, opts=opts, typ=GetDataflowRunLogResult).value

    return AwaitableGetDataflowRunLogResult(
