...
__all__ = ['DatabaseAutonomousExadataInfrastructureArgs', 'DatabaseAutonomousExadataInfrastructure']

@pulumi.input_type
class DatabaseAutonomousExadataInfrastructureArgs:
    def __init__(__self__, *,
                 ...
                 maintenance_window_details: Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    def maintenance_window_details(self) -> Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']]:
        """
    ...
    def maintenance_window_details(self, value: Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']]):
...
@pulumi.input_type
class _DatabaseAutonomousExadataInfrastructureState:
    def __init__(__self__, *,
                 ...
                 maintenance_window: Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs']] = None,
                 maintenance_window_details: Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']] = None,
        ...
        :param pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs'] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs'] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
    ...
    def maintenance_window(self) -> Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: Optional[pulumi.Input['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs']]):
...
class DatabaseAutonomousExadataInfrastructure(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 license_model: Optional[pulumi.Input[str]] = None,
                 maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']]] = None,
                 nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 shape: Optional[pulumi.Input[str]] = None,
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        test_autonomous_exadata_infrastructure = oci.DatabaseAutonomousExadataInfrastructure("testAutonomousExadataInfrastructure",
            ...
            maintenance_window_details=oci.DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs(
                preference=var["autonomous_exadata_infrastructure_maintenance_window_details_preference"],
                days_of_weeks=[oci.DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs(
                ...
                months=[oci.DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs(
        ...
        :param pulumi.Input[Mapping[str, Any]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[str] license_model: The Oracle license model that applies to all the databases in the Autonomous Exadata Infrastructure. The default is BRING_YOUR_OWN_LICENSE.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nsg_ids: (Updatable) A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that this resource belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * Autonomous Databases with private access require at least 1 Network Security Group (NSG). The nsgIds array cannot be empty.
        :param pulumi.Input[str] shape: The shape of the Autonomous Exadata Infrastructure. The shape determines resources allocated to the Autonomous Exadata Infrastructure (CPU cores, memory and storage). To get a list of shapes, use the ListDbSystemShapes operation.
        :param pulumi.Input[str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet the Autonomous Exadata Infrastructure is associated with.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseAutonomousExadataInfrastructureArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the Autonomous Exadata Infrastructure resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseAutonomousExadataInfrastructureArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseAutonomousExadataInfrastructureArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseAutonomousExadataInfrastructureArgs.__new__(DatabaseAutonomousExadataInfrastructureArgs)
        ...
        super(DatabaseAutonomousExadataInfrastructure, __self__).__init__(
            'oci:index/databaseAutonomousExadataInfrastructure:DatabaseAutonomousExadataInfrastructure',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            license_model: Optional[pulumi.Input[str]] = None,
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            maintenance_window: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs']]] = None,
            maintenance_window_details: Optional[pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']]] = None,
            next_maintenance_run_id: Optional[pulumi.Input[str]] = None,
            nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            scan_dns_name: Optional[pulumi.Input[str]] = None,
            ...
            subnet_id: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseAutonomousExadataInfrastructure':
        """
        ...
        :param pulumi.Input[str] license_model: The Oracle license model that applies to all the databases in the Autonomous Exadata Infrastructure. The default is BRING_YOUR_OWN_LICENSE.
        :param pulumi.Input[str] lifecycle_details: Additional information about the current lifecycle state of the Autonomous Exadata Infrastructure.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowArgs']] maintenance_window: The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[pulumi.InputType['DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetailsArgs']] maintenance_window_details: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[str] next_maintenance_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next maintenance run.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] nsg_ids: (Updatable) A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that this resource belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * Autonomous Databases with private access require at least 1 Network Security Group (NSG). The nsgIds array cannot be empty.
        ...
        __props__ = _DatabaseAutonomousExadataInfrastructureState.__new__(_DatabaseAutonomousExadataInfrastructureState)
        ...
        return DatabaseAutonomousExadataInfrastructure(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output['outputs.DatabaseAutonomousExadataInfrastructureMaintenanceWindow']:
        """
        The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window")
    ...
    @property
    @pulumi.getter(name="maintenanceWindowDetails")
    def maintenance_window_details(self) -> pulumi.Output[Optional['outputs.DatabaseAutonomousExadataInfrastructureMaintenanceWindowDetails']]:
        """
        (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        """
        return pulumi.get(self, "maintenance_window_details")
