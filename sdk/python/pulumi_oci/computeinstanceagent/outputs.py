...
__all__ = [
    ...
    'GetInstanceAvailablePluginsAvailablePluginResult',
    'GetInstanceAvailablePluginsFilterResult',
]
...
@pulumi.output_type
class GetInstanceAvailablePluginsAvailablePluginResult(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class GetInstanceAvailablePluginsFilterResult(dict):
    def __init__(__self__, *,
                 name: str,
                 values: Sequence[str],
                 regex: Optional[bool] = None):
