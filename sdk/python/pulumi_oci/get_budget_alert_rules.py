...
__all__ = [
    'GetBudgetAlertRulesResult',
    'AwaitableGetBudgetAlertRulesResult',
    'get_budget_alert_rules',
]

@pulumi.output_type
class GetBudgetAlertRulesResult:
    """
    ...
    def alert_rules(self) -> Sequence['outputs.GetBudgetAlertRulesAlertRuleResult']:
        """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBudgetAlertRulesFilterResult']]:
...
class AwaitableGetBudgetAlertRulesResult(GetBudgetAlertRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBudgetAlertRulesResult(
...
def get_budget_alert_rules(budget_id: Optional[str] = None,
                           display_name: Optional[str] = None,
                           filters: Optional[Sequence[pulumi.InputType['GetBudgetAlertRulesFilterArgs']]] = None,
                           state: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBudgetAlertRulesResult:
    """
    ...
    test_alert_rules = oci.get_budget_alert_rules(budget_id=oci_budget_budget["test_budget"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getBudgetAlertRules:GetBudgetAlertRules', __args__, opts=opts, typ=GetBudgetAlertRulesResult).value

    return AwaitableGetBudgetAlertRulesResult(
