...
__all__ = ['DatabaseExternalDatabaseConnectorArgs', 'DatabaseExternalDatabaseConnector']

@pulumi.input_type
class DatabaseExternalDatabaseConnectorArgs:
    def __init__(__self__, *,
                 connection_credentials: pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs'],
                 connection_string: pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs'],
        ...
        :param pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs'] connection_credentials: (Updatable) Credentials used to connect to the database. Currently only the `DETAILS` type is supported for creating MACS connector crendentials.
        :param pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs'] connection_string: (Updatable) The Oracle Database connection string.
    ...
    def connection_credentials(self) -> pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']:
        """
    ...
    def connection_credentials(self, value: pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']):
        pulumi.set(self, "connection_credentials", value)

    @property
    @pulumi.getter(name="connectionString")
    def connection_string(self) -> pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs']:
        """
    ...
    def connection_string(self, value: pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs']):
...
@pulumi.input_type
class _DatabaseExternalDatabaseConnectorState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 connection_credentials: Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']] = None,
                 connection_status: Optional[pulumi.Input[str]] = None,
                 connection_string: Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs']] = None,
    ...
    @property
    @pulumi.getter(name="connectionCredentials")
    def connection_credentials(self) -> Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']]:
        """
        (Updatable) Credentials used to connect to the database. Currently only the `DETAILS` type is supported for creating MACS connector crendentials.
        """
        return pulumi.get(self, "connection_credentials")
    ...
    @connection_credentials.setter
    def connection_credentials(self, value: Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']]):
        pulumi.set(self, "connection_credentials", value)
    ...
    @property
    @pulumi.getter(name="connectionString")
    def connection_string(self) -> Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs']]:
        """
        (Updatable) The Oracle Database connection string.
        """
        return pulumi.get(self, "connection_string")
    ...
    @connection_string.setter
    def connection_string(self, value: Optional[pulumi.Input['DatabaseExternalDatabaseConnectorConnectionStringArgs']]):
        pulumi.set(self, "connection_string", value)
...
class DatabaseExternalDatabaseConnector(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 connection_credentials: Optional[pulumi.Input[pulumi.InputType['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']]] = None,
                 connection_string: Optional[pulumi.Input[pulumi.InputType['DatabaseExternalDatabaseConnectorConnectionStringArgs']]] = None,
                 connector_agent_id: Optional[pulumi.Input[str]] = None,
                 connector_type: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
        ...
        test_external_database_connector = oci.DatabaseExternalDatabaseConnector("testExternalDatabaseConnector",
            connection_credentials=oci.DatabaseExternalDatabaseConnectorConnectionCredentialsArgs(
            ...
            connection_string=oci.DatabaseExternalDatabaseConnectorConnectionStringArgs(
        ...
        :param pulumi.Input[pulumi.InputType['DatabaseExternalDatabaseConnectorConnectionCredentialsArgs']] connection_credentials: (Updatable) Credentials used to connect to the database. Currently only the `DETAILS` type is supported for creating MACS connector crendentials.
        :param pulumi.Input[pulumi.InputType['DatabaseExternalDatabaseConnectorConnectionStringArgs']] connection_string: (Updatable) The Oracle Database connection string.
        :param pulumi.Input[str] connector_agent_id: The ID of the agent used for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
        :param pulumi.Input[str] connector_type: (Updatable) The type of connector used by the external database resource.
        :param pulumi.Input[Mapping[str, Any]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[str] display_name: (Updatable) The user-friendly name for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails). The name does not have to be unique.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DatabaseExternalDatabaseConnectorArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        This resource provides the External Database Connector resource in Oracle Cloud Infrastructure Database service.
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseExternalDatabaseConnectorArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatabaseExternalDatabaseConnectorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseExternalDatabaseConnectorArgs.__new__(DatabaseExternalDatabaseConnectorArgs)
        ...
        super(DatabaseExternalDatabaseConnector, __self__).__init__(
            'oci:index/databaseExternalDatabaseConnector:DatabaseExternalDatabaseConnector',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[str]] = None,
            time_connection_status_last_updated: Optional[pulumi.Input[str]] = None,
            time_created: Optional[pulumi.Input[str]] = None) -> 'DatabaseExternalDatabaseConnector':
        """
        ...
        __props__ = _DatabaseExternalDatabaseConnectorState.__new__(_DatabaseExternalDatabaseConnectorState)
        ...
        return DatabaseExternalDatabaseConnector(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="connectionCredentials")
    def connection_credentials(self) -> pulumi.Output['outputs.DatabaseExternalDatabaseConnectorConnectionCredentials']:
        """
        (Updatable) Credentials used to connect to the database. Currently only the `DETAILS` type is supported for creating MACS connector crendentials.
        """
        return pulumi.get(self, "connection_credentials")
    ...
    @property
    @pulumi.getter(name="connectionString")
    def connection_string(self) -> pulumi.Output['outputs.DatabaseExternalDatabaseConnectorConnectionString']:
        """
        (Updatable) The Oracle Database connection string.
        """
        return pulumi.get(self, "connection_string")
