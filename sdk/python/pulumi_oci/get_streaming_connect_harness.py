...
__all__ = [
    'GetStreamingConnectHarnessResult',
    'AwaitableGetStreamingConnectHarnessResult',
    'get_streaming_connect_harness',
]

@pulumi.output_type
class GetStreamingConnectHarnessResult:
    """
...
class AwaitableGetStreamingConnectHarnessResult(GetStreamingConnectHarnessResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStreamingConnectHarnessResult(
...
def get_streaming_connect_harness(connect_harness_id: Optional[str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStreamingConnectHarnessResult:
    """
    ...
    test_connect_harness = oci.get_streaming_connect_harness(connect_harness_id=oci_streaming_connect_harnes["test_connect_harnes"]["id"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getStreamingConnectHarness:GetStreamingConnectHarness', __args__, opts=opts, typ=GetStreamingConnectHarnessResult).value

    return AwaitableGetStreamingConnectHarnessResult(
