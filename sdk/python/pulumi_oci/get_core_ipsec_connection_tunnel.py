...
__all__ = [
    'GetCoreIpsecConnectionTunnelResult',
    'AwaitableGetCoreIpsecConnectionTunnelResult',
    'get_core_ipsec_connection_tunnel',
]

@pulumi.output_type
class GetCoreIpsecConnectionTunnelResult:
    """
    A collection of values returned by GetCoreIpsecConnectionTunnel.
    """
    def __init__(__self__, bgp_session_infos=None, compartment_id=None, cpe_ip=None, display_name=None, encryption_domain_config=None, id=None, ike_version=None, ipsec_id=None, routing=None, state=None, status=None, time_created=None, time_status_updated=None, tunnel_id=None, vpn_ip=None):
        ...
        if encryption_domain_config and not isinstance(encryption_domain_config, dict):
            raise TypeError("Expected argument 'encryption_domain_config' to be a dict")
    ...
    def bgp_session_infos(self) -> Sequence['outputs.GetCoreIpsecConnectionTunnelBgpSessionInfoResult']:
        """
    ...
    def encryption_domain_config(self) -> 'outputs.GetCoreIpsecConnectionTunnelEncryptionDomainConfigResult':
        """
...
class AwaitableGetCoreIpsecConnectionTunnelResult(GetCoreIpsecConnectionTunnelResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCoreIpsecConnectionTunnelResult(
            bgp_session_infos=self.bgp_session_infos,
            compartment_id=self.compartment_id,
            cpe_ip=self.cpe_ip,
            display_name=self.display_name,
            encryption_domain_config=self.encryption_domain_config,
            id=self.id,
...
def get_core_ipsec_connection_tunnel(ipsec_id: Optional[str] = None,
                                     tunnel_id: Optional[str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCoreIpsecConnectionTunnelResult:
    """
    ...
    test_ip_sec_connection_tunnel = oci.get_core_ipsec_connection_tunnel(ipsec_id=oci_core_ipsec["test_ipsec"]["id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getCoreIpsecConnectionTunnel:GetCoreIpsecConnectionTunnel', __args__, opts=opts, typ=GetCoreIpsecConnectionTunnelResult).value

    return AwaitableGetCoreIpsecConnectionTunnelResult(
        bgp_session_infos=__ret__.bgp_session_infos,
        compartment_id=__ret__.compartment_id,
        cpe_ip=__ret__.cpe_ip,
        display_name=__ret__.display_name,
        encryption_domain_config=__ret__.encryption_domain_config,
        id=__ret__.id,
