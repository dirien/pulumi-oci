...
__all__ = [
    'GetDevopsProjectsResult',
    'AwaitableGetDevopsProjectsResult',
    'get_devops_projects',
]

@pulumi.output_type
class GetDevopsProjectsResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDevopsProjectsFilterResult']]:
    ...
    def project_collections(self) -> Sequence['outputs.GetDevopsProjectsProjectCollectionResult']:
        """
...
class AwaitableGetDevopsProjectsResult(GetDevopsProjectsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevopsProjectsResult(
...
def get_devops_projects(compartment_id: Optional[str] = None,
                        filters: Optional[Sequence[pulumi.InputType['GetDevopsProjectsFilterArgs']]] = None,
                        id: Optional[str] = None,
                        name: Optional[str] = None,
                        state: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevopsProjectsResult:
    """
    ...
    test_projects = oci.get_devops_projects(compartment_id=var["compartment_id"],
        id=var["project_id"],
    ...
    __ret__ = pulumi.runtime.invoke('oci:index/getDevopsProjects:GetDevopsProjects', __args__, opts=opts, typ=GetDevopsProjectsResult).value

    return AwaitableGetDevopsProjectsResult(
